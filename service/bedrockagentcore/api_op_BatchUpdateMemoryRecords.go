...
func (c *Client) addOperationBatchUpdateMemoryRecordsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchUpdateMemoryRecords", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
