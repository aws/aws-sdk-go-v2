...
func (c *Client) addOperationGetPaymentInstrumentBalanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPaymentInstrumentBalance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
