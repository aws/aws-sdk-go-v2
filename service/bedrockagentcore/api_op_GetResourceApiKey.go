...
func (c *Client) GetResourceApiKey(ctx context.Context, params *GetResourceApiKeyInput, optFns ...func(*Options)) (*GetResourceApiKeyOutput, error) {
	if params == nil { params = &GetResourceApiKeyInput{} }
...
func (c *Client) addOperationGetResourceApiKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetResourceApiKey(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opGetResourceApiKey(region string) *awsmiddleware.RegisterServiceMetadata {
