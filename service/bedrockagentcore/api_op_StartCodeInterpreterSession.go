...
func (c *Client) addOperationStartCodeInterpreterSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartCodeInterpreterSession", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
