...
func (c *Client) addOperationListMemoryExtractionJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMemoryExtractionJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
