...
func (c *Client) addOperationCompleteResourceTokenAuthMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CompleteResourceTokenAuth", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
