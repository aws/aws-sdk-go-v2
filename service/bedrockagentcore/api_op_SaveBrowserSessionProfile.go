...
func (c *Client) addOperationSaveBrowserSessionProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SaveBrowserSessionProfile", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
