...
func (c *Client) addOperationCreateIdMappingWorkflowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateIdMappingWorkflow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
