...
func (c *Client) GetSchemaMapping(ctx context.Context, params *GetSchemaMappingInput, optFns ...func(*Options)) (*GetSchemaMappingOutput, error) {
	if params == nil { params = &GetSchemaMappingInput{} }
...
func (c *Client) addOperationGetSchemaMappingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSchemaMappingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSchemaMappingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSchemaMappingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSchemaMappingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSchemaMappingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSchemaMappingResolveEndpointMiddleware{
