...
func (c *Client) addOperationGetIdMappingJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetIdMappingJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetIdMappingJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetIdMappingJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetIdMappingJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetIdMappingJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetIdMappingJobResolveEndpointMiddleware{
