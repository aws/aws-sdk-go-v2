...
func (c *Client) addOperationUpdateIdMappingWorkflowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateIdMappingWorkflow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
