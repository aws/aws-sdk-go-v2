...
func (c *Client) addOperationGetIdMappingWorkflowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetIdMappingWorkflowResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetIdMappingWorkflowResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetIdMappingWorkflowResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetIdMappingWorkflowResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetIdMappingWorkflowResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetIdMappingWorkflowResolveEndpointMiddleware{
