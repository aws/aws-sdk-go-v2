...
func (c *Client) addOperationListProviderServicesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListProviderServicesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListProviderServicesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListProviderServicesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListProviderServicesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListProviderServicesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListProviderServicesResolveEndpointMiddleware{
