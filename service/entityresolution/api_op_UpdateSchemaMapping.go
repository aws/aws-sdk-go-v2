...
func (c *Client) addOperationUpdateSchemaMappingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateSchemaMappingResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateSchemaMappingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateSchemaMappingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateSchemaMappingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateSchemaMappingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateSchemaMappingResolveEndpointMiddleware{
