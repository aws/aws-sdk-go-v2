...
func (c *Client) addOperationListIdMappingWorkflowsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListIdMappingWorkflowsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListIdMappingWorkflowsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListIdMappingWorkflowsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListIdMappingWorkflowsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListIdMappingWorkflowsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListIdMappingWorkflowsResolveEndpointMiddleware{
