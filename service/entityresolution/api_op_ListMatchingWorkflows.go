...
func (c *Client) ListMatchingWorkflows(ctx context.Context, params *ListMatchingWorkflowsInput, optFns ...func(*Options)) (*ListMatchingWorkflowsOutput, error) {
	if params == nil { params = &ListMatchingWorkflowsInput{} }
...
func (c *Client) addOperationListMatchingWorkflowsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMatchingWorkflowsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListMatchingWorkflowsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListMatchingWorkflowsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMatchingWorkflowsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListMatchingWorkflowsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListMatchingWorkflowsResolveEndpointMiddleware{
