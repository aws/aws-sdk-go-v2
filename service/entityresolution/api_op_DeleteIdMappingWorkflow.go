...
func (c *Client) addOperationDeleteIdMappingWorkflowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteIdMappingWorkflow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
