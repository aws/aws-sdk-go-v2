...
func (c *Client) GetMatchId(ctx context.Context, params *GetMatchIdInput, optFns ...func(*Options)) (*GetMatchIdOutput, error) {
	if params == nil { params = &GetMatchIdInput{} }
...
func (c *Client) addOperationGetMatchIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMatchIdResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetMatchIdResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetMatchIdResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMatchIdResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMatchIdResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetMatchIdResolveEndpointMiddleware{
