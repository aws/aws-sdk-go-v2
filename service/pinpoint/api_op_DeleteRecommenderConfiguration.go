...
func addOperationDeleteRecommenderConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteRecommenderConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteRecommenderConfigurationStackSlots(stack); err != nil {
		return err
	}
