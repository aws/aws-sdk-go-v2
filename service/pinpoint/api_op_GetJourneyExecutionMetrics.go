...
func (*GetJourneyExecutionMetricsInput) operationName() string {
...
func (c *Client) addOperationGetJourneyExecutionMetricsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetJourneyExecutionMetricsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetJourneyExecutionMetricsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetJourneyExecutionMetricsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetJourneyExecutionMetricsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetJourneyExecutionMetricsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetJourneyExecutionMetricsResolveEndpointMiddleware{
