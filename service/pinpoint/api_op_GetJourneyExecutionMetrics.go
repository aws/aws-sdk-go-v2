...
func (c *Client) addOperationGetJourneyExecutionMetricsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetJourneyExecutionMetrics", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
