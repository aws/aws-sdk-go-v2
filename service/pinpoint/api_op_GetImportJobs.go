...
func (*GetImportJobsInput) operationName() string {
...
func (c *Client) addOperationGetImportJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetImportJobsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetImportJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetImportJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetImportJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetImportJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetImportJobsResolveEndpointMiddleware{
