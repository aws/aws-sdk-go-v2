...
func (*DeletePushTemplateInput) operationName() string {
...
func (c *Client) addOperationDeletePushTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeletePushTemplateResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeletePushTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeletePushTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeletePushTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeletePushTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeletePushTemplateResolveEndpointMiddleware{
