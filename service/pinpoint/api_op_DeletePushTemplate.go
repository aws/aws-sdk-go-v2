...
func (c *Client) DeletePushTemplate(ctx context.Context, params *DeletePushTemplateInput, optFns ...func(*Options)) (*DeletePushTemplateOutput, error) {
	stack := middleware.NewStack("DeletePushTemplate", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpDeletePushTemplateMiddlewares(stack)
	...
	addOpDeletePushTemplateValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opDeletePushTemplate(options.Region), middleware.Before)
...
func addawsRestjson1_serdeOpDeletePushTemplateMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpDeletePushTemplate{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpDeletePushTemplate{}, middleware.After)
}
