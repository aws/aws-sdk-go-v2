...
func (c *Client) GetUserEndpoints(ctx context.Context, params *GetUserEndpointsInput, optFns ...func(*Options)) (*GetUserEndpointsOutput, error) {
	if params == nil { params = &GetUserEndpointsInput{} }
...
func (c *Client) addOperationGetUserEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetUserEndpointsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetUserEndpointsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetUserEndpointsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetUserEndpointsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetUserEndpointsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetUserEndpointsResolveEndpointMiddleware{
