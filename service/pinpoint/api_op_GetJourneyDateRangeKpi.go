...
func (c *Client) GetJourneyDateRangeKpi(ctx context.Context, params *GetJourneyDateRangeKpiInput, optFns ...func(*Options)) (*GetJourneyDateRangeKpiOutput, error) {
	if params == nil { params = &GetJourneyDateRangeKpiInput{} }
...
func (c *Client) addOperationGetJourneyDateRangeKpiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetJourneyDateRangeKpiResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetJourneyDateRangeKpiResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetJourneyDateRangeKpiResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetJourneyDateRangeKpiResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetJourneyDateRangeKpiResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetJourneyDateRangeKpiResolveEndpointMiddleware{
