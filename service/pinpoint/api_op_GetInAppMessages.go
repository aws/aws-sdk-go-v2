...
func (c *Client) GetInAppMessages(ctx context.Context, params *GetInAppMessagesInput, optFns ...func(*Options)) (*GetInAppMessagesOutput, error) {
	if params == nil { params = &GetInAppMessagesInput{} }
...
func (c *Client) addOperationGetInAppMessagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetInAppMessagesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetInAppMessagesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetInAppMessagesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetInAppMessagesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetInAppMessagesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetInAppMessagesResolveEndpointMiddleware{
