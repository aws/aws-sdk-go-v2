...
func (c *Client) GetJourneyRuns(ctx context.Context, params *GetJourneyRunsInput, optFns ...func(*Options)) (*GetJourneyRunsOutput, error) {
	if params == nil { params = &GetJourneyRunsInput{} }
...
func (c *Client) addOperationGetJourneyRunsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetJourneyRunsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetJourneyRunsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetJourneyRunsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetJourneyRunsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetJourneyRunsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetJourneyRunsResolveEndpointMiddleware{
