...
func (c *Client) DeleteSmsTemplate(ctx context.Context, params *DeleteSmsTemplateInput, optFns ...func(*Options)) (*DeleteSmsTemplateOutput, error) {
	if params == nil { params = &DeleteSmsTemplateInput{} }
...
func (c *Client) addOperationDeleteSmsTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteSmsTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteSmsTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteSmsTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteSmsTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteSmsTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteSmsTemplateResolveEndpointMiddleware{
