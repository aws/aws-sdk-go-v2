...
func (v *DeleteSmsTemplateInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DeleteSmsTemplateRequest)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DeleteSmsTemplateInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.TemplateName != nil {
		s.WriteString(schemas.DeleteSmsTemplateRequest_TemplateName, *v.TemplateName)
	}
	if v.Version != nil {
		s.WriteString(schemas.DeleteSmsTemplateRequest_Version, *v.Version)
	}
}
...
func (v *DeleteSmsTemplateOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DeleteSmsTemplateResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DeleteSmsTemplateOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.MessageBody != nil {
		s.WriteStruct(schemas.DeleteSmsTemplateResponse_MessageBody)
		v.MessageBody.SerializeMembers(s)
		s.CloseStruct()
	}
}
func (v *DeleteSmsTemplateOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.DeleteSmsTemplateResponse, func(s *smithy.Schema) error {
		switch s {
		case schemas.DeleteSmsTemplateResponse_MessageBody:
...
func (c *Client) addOperationDeleteSmsTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.DeleteSmsTemplate, schemas.DeleteSmsTemplateRequest, schemas.DeleteSmsTemplateResponse)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.DeleteSmsTemplate, schemas.DeleteSmsTemplateRequest, schemas.DeleteSmsTemplateResponse), output: &DeleteSmsTemplateOutput{}}, middleware.After); err != nil {
		return err
	}
