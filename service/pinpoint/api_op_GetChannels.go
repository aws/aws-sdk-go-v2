...
func (c *Client) GetChannels(ctx context.Context, params *GetChannelsInput, optFns ...func(*Options)) (*GetChannelsOutput, error) {
	stack := middleware.NewStack("GetChannels", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpGetChannelsMiddlewares(stack)
	...
	addOpGetChannelsValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opGetChannels(options.Region), middleware.Before)
...
func addawsRestjson1_serdeOpGetChannelsMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpGetChannels{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpGetChannels{}, middleware.After)
}
