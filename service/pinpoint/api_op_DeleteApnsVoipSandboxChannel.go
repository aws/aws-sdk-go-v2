...
func (c *Client) addOperationDeleteApnsVoipSandboxChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteApnsVoipSandboxChannel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
