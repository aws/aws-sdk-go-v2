...
func (*DeleteApnsVoipSandboxChannelInput) operationName() string {
...
func (c *Client) addOperationDeleteApnsVoipSandboxChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteApnsVoipSandboxChannelResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteApnsVoipSandboxChannelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteApnsVoipSandboxChannelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteApnsVoipSandboxChannelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteApnsVoipSandboxChannelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteApnsVoipSandboxChannelResolveEndpointMiddleware{
