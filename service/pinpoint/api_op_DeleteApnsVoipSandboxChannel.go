...
func addOperationDeleteApnsVoipSandboxChannelStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteApnsVoipSandboxChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteApnsVoipSandboxChannelStackSlots(stack); err != nil {
		return err
	}
