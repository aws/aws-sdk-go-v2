...
func (c *Client) GetCampaigns(ctx context.Context, params *GetCampaignsInput, optFns ...func(*Options)) (*GetCampaignsOutput, error) {
	if params == nil { params = &GetCampaignsInput{} }
...
func (c *Client) addOperationGetCampaignsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCampaignsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCampaignsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCampaignsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCampaignsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCampaignsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCampaignsResolveEndpointMiddleware{
