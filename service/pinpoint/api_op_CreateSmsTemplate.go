...
func (*CreateSmsTemplateInput) operationName() string {
...
func (c *Client) addOperationCreateSmsTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateSmsTemplateResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateSmsTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateSmsTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateSmsTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateSmsTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateSmsTemplateResolveEndpointMiddleware{
