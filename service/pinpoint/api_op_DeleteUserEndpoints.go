...
func (c *Client) DeleteUserEndpoints(ctx context.Context, params *DeleteUserEndpointsInput, optFns ...func(*Options)) (*DeleteUserEndpointsOutput, error) {
	if params == nil { params = &DeleteUserEndpointsInput{} }
...
func (c *Client) addOperationDeleteUserEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteUserEndpointsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteUserEndpointsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteUserEndpointsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteUserEndpointsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteUserEndpointsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteUserEndpointsResolveEndpointMiddleware{
