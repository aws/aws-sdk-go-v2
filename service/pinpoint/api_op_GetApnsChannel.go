...
func (*GetApnsChannelInput) operationName() string {
	return "GetApnsChannel"
}
...
func (c *Client) addOperationGetApnsChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetApnsChannelResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetApnsChannelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetApnsChannelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetApnsChannelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetApnsChannelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetApnsChannelResolveEndpointMiddleware{
