...
func (c *Client) CreateSegment(ctx context.Context, params *CreateSegmentInput, optFns ...func(*Options)) (*CreateSegmentOutput, error) {
	stack := middleware.NewStack("CreateSegment", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpCreateSegmentMiddlewares(stack)
...
func addawsRestjson1_serdeOpCreateSegmentMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpCreateSegment{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpCreateSegment{}, middleware.After)
}
