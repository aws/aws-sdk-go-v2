...
func (c *Client) UpdateSmsTemplate(ctx context.Context, params *UpdateSmsTemplateInput, optFns ...func(*Options)) (*UpdateSmsTemplateOutput, error) {
	stack := middleware.NewStack("UpdateSmsTemplate", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpUpdateSmsTemplateMiddlewares(stack)
	...
	addOpUpdateSmsTemplateValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opUpdateSmsTemplate(options.Region), middleware.Before)
...
func addawsRestjson1_serdeOpUpdateSmsTemplateMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpUpdateSmsTemplate{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpUpdateSmsTemplate{}, middleware.After)
}
