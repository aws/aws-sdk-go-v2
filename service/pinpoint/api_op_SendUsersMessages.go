...
func (c *Client) SendUsersMessages(ctx context.Context, params *SendUsersMessagesInput, optFns ...func(*Options)) (*SendUsersMessagesOutput, error) {
	if params == nil { params = &SendUsersMessagesInput{} }
...
func (c *Client) addOperationSendUsersMessagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendUsersMessagesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSendUsersMessagesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSendUsersMessagesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendUsersMessagesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendUsersMessagesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSendUsersMessagesResolveEndpointMiddleware{
