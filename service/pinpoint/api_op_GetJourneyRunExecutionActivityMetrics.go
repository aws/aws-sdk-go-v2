...
func (*GetJourneyRunExecutionActivityMetricsInput) operationName() string {
...
func (c *Client) addOperationGetJourneyRunExecutionActivityMetricsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetJourneyRunExecutionActivityMetricsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetJourneyRunExecutionActivityMetricsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetJourneyRunExecutionActivityMetricsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetJourneyRunExecutionActivityMetricsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetJourneyRunExecutionActivityMetricsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetJourneyRunExecutionActivityMetricsResolveEndpointMiddleware{
