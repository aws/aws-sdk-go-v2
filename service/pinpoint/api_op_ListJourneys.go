...
func (c *Client) ListJourneys(ctx context.Context, params *ListJourneysInput, optFns ...func(*Options)) (*ListJourneysOutput, error) {
	if params == nil { params = &ListJourneysInput{} }
...
func (c *Client) addOperationListJourneysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListJourneysResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListJourneysResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListJourneysResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListJourneysResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListJourneysResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListJourneysResolveEndpointMiddleware{
