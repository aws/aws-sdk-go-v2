...
func (c *Client) GetSmsTemplate(ctx context.Context, params *GetSmsTemplateInput, optFns ...func(*Options)) (*GetSmsTemplateOutput, error) {
	stack := middleware.NewStack("GetSmsTemplate", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpGetSmsTemplateMiddlewares(stack)
	...
	addOpGetSmsTemplateValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opGetSmsTemplate(options.Region), middleware.Before)
...
func addawsRestjson1_serdeOpGetSmsTemplateMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpGetSmsTemplate{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpGetSmsTemplate{}, middleware.After)
}
