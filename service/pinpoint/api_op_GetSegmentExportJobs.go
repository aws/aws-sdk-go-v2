...
func (*GetSegmentExportJobsInput) operationName() string {
...
func (c *Client) addOperationGetSegmentExportJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSegmentExportJobsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetSegmentExportJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetSegmentExportJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSegmentExportJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSegmentExportJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetSegmentExportJobsResolveEndpointMiddleware{
