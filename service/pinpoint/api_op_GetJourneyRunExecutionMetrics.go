...
func (c *Client) GetJourneyRunExecutionMetrics(ctx context.Context, params *GetJourneyRunExecutionMetricsInput, optFns ...func(*Options)) (*GetJourneyRunExecutionMetricsOutput, error) {
	if params == nil { params = &GetJourneyRunExecutionMetricsInput{} }
...
func (c *Client) addOperationGetJourneyRunExecutionMetricsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetJourneyRunExecutionMetricsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetJourneyRunExecutionMetricsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetJourneyRunExecutionMetricsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetJourneyRunExecutionMetricsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetJourneyRunExecutionMetricsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetJourneyRunExecutionMetricsResolveEndpointMiddleware{
