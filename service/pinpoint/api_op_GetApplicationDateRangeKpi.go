...
func addOperationGetApplicationDateRangeKpiStackSlots(stack *middleware.Stack) error {
...
func addOperationGetApplicationDateRangeKpiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetApplicationDateRangeKpiStackSlots(stack); err != nil {
		return err
	}
