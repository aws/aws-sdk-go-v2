...
func (*UpdateJourneyStateInput) operationName() string {
...
func (c *Client) addOperationUpdateJourneyStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateJourneyStateResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateJourneyStateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateJourneyStateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateJourneyStateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateJourneyStateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateJourneyStateResolveEndpointMiddleware{
