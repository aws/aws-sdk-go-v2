...
func (c *Client) GetBaiduChannel(ctx context.Context, params *GetBaiduChannelInput, optFns ...func(*Options)) (*GetBaiduChannelOutput, error) {
	if params == nil { params = &GetBaiduChannelInput{} }
...
func (c *Client) addOperationGetBaiduChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBaiduChannelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetBaiduChannelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetBaiduChannelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetBaiduChannelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBaiduChannelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetBaiduChannelResolveEndpointMiddleware{
