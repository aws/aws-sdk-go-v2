...
func (c *Client) GetApps(ctx context.Context, params *GetAppsInput, optFns ...func(*Options)) (*GetAppsOutput, error) {
	if params == nil { params = &GetAppsInput{} }
...
func (c *Client) addOperationGetAppsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAppsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAppsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAppsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAppsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAppsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAppsResolveEndpointMiddleware{
