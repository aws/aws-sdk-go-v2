...
func addOperationUpdateRecommenderConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateRecommenderConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateRecommenderConfigurationStackSlots(stack); err != nil {
		return err
	}
