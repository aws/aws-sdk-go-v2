...
func (*GetApnsVoipSandboxChannelInput) operationName() string {
	return "GetApnsVoipSandboxChannel"
}
...
func (c *Client) addOperationGetApnsVoipSandboxChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetApnsVoipSandboxChannelResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetApnsVoipSandboxChannelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetApnsVoipSandboxChannelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetApnsVoipSandboxChannelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetApnsVoipSandboxChannelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetApnsVoipSandboxChannelResolveEndpointMiddleware{
