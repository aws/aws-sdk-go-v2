...
func (c *Client) UpdateApnsChannel(ctx context.Context, params *UpdateApnsChannelInput, optFns ...func(*Options)) (*UpdateApnsChannelOutput, error) {
	if params == nil { params = &UpdateApnsChannelInput{} }
...
func (c *Client) addOperationUpdateApnsChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateApnsChannelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateApnsChannelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateApnsChannelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateApnsChannelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateApnsChannelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateApnsChannelResolveEndpointMiddleware{
