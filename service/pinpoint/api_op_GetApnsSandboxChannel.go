...
func (*GetApnsSandboxChannelInput) operationName() string {
	return "GetApnsSandboxChannel"
}
...
func (c *Client) addOperationGetApnsSandboxChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetApnsSandboxChannelResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetApnsSandboxChannelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetApnsSandboxChannelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetApnsSandboxChannelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetApnsSandboxChannelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetApnsSandboxChannelResolveEndpointMiddleware{
