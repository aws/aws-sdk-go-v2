...
func (c *Client) GetApplicationSettings(ctx context.Context, params *GetApplicationSettingsInput, optFns ...func(*Options)) (*GetApplicationSettingsOutput, error) {
	if params == nil { params = &GetApplicationSettingsInput{} }
...
func (c *Client) addOperationGetApplicationSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetApplicationSettingsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetApplicationSettingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetApplicationSettingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetApplicationSettingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetApplicationSettingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetApplicationSettingsResolveEndpointMiddleware{
