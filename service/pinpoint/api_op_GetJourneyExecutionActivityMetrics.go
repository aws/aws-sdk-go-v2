...
func (*GetJourneyExecutionActivityMetricsInput) operationName() string {
...
func (c *Client) addOperationGetJourneyExecutionActivityMetricsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetJourneyExecutionActivityMetricsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetJourneyExecutionActivityMetricsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetJourneyExecutionActivityMetricsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetJourneyExecutionActivityMetricsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetJourneyExecutionActivityMetricsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetJourneyExecutionActivityMetricsResolveEndpointMiddleware{
