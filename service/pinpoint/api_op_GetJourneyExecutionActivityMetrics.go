...
func addOperationGetJourneyExecutionActivityMetricsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetJourneyExecutionActivityMetricsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetJourneyExecutionActivityMetricsStackSlots(stack); err != nil {
		return err
	}
