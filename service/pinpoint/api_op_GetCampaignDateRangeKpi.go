...
func (c *Client) addOperationGetCampaignDateRangeKpiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCampaignDateRangeKpi", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
