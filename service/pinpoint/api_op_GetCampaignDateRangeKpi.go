...
func (c *Client) GetCampaignDateRangeKpi(ctx context.Context, params *GetCampaignDateRangeKpiInput, optFns ...func(*Options)) (*GetCampaignDateRangeKpiOutput, error) {
	if params == nil { params = &GetCampaignDateRangeKpiInput{} }
...
func (c *Client) addOperationGetCampaignDateRangeKpiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCampaignDateRangeKpiResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCampaignDateRangeKpiResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCampaignDateRangeKpiResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCampaignDateRangeKpiResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCampaignDateRangeKpiResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCampaignDateRangeKpiResolveEndpointMiddleware{
