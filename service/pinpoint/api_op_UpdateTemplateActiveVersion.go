...
func addOperationUpdateTemplateActiveVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateTemplateActiveVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateTemplateActiveVersionStackSlots(stack); err != nil {
		return err
	}
