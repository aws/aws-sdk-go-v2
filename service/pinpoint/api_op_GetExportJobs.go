...
func (c *Client) GetExportJobs(ctx context.Context, params *GetExportJobsInput, optFns ...func(*Options)) (*GetExportJobsOutput, error) {
	if params == nil { params = &GetExportJobsInput{} }
...
func (c *Client) addOperationGetExportJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetExportJobsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetExportJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetExportJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetExportJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetExportJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetExportJobsResolveEndpointMiddleware{
