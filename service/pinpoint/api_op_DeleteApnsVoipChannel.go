...
func (*DeleteApnsVoipChannelInput) operationName() string {
...
func (c *Client) addOperationDeleteApnsVoipChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteApnsVoipChannelResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteApnsVoipChannelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteApnsVoipChannelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteApnsVoipChannelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteApnsVoipChannelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteApnsVoipChannelResolveEndpointMiddleware{
