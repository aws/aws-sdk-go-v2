...
func (c *Client) PutEventStream(ctx context.Context, params *PutEventStreamInput, optFns ...func(*Options)) (*PutEventStreamOutput, error) {
	if params == nil { params = &PutEventStreamInput{} }
...
func (c *Client) addOperationPutEventStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutEventStreamResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutEventStreamResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutEventStreamResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutEventStreamResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutEventStreamResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutEventStreamResolveEndpointMiddleware{
