...
func (c *Client) UpdateInAppTemplate(ctx context.Context, params *UpdateInAppTemplateInput, optFns ...func(*Options)) (*UpdateInAppTemplateOutput, error) {
	if params == nil { params = &UpdateInAppTemplateInput{} }
...
func (c *Client) addOperationUpdateInAppTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateInAppTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateInAppTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateInAppTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateInAppTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateInAppTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateInAppTemplateResolveEndpointMiddleware{
