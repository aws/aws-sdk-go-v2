...
func addOperationCreateRecommenderConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateRecommenderConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateRecommenderConfigurationStackSlots(stack); err != nil {
		return err
	}
