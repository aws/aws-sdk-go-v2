...
func (c *Client) PhoneNumberValidate(ctx context.Context, params *PhoneNumberValidateInput, optFns ...func(*Options)) (*PhoneNumberValidateOutput, error) {
	if params == nil { params = &PhoneNumberValidateInput{} }
...
func (c *Client) addOperationPhoneNumberValidateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPhoneNumberValidateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPhoneNumberValidateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPhoneNumberValidateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPhoneNumberValidateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPhoneNumberValidateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPhoneNumberValidateResolveEndpointMiddleware{
