...
func (c *Client) addOperationGetRecommenderConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRecommenderConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
