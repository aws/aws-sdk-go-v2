...
func (c *Client) DeleteVoiceTemplate(ctx context.Context, params *DeleteVoiceTemplateInput, optFns ...func(*Options)) (*DeleteVoiceTemplateOutput, error) {
	if params == nil { params = &DeleteVoiceTemplateInput{} }
...
func (c *Client) addOperationDeleteVoiceTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteVoiceTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteVoiceTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteVoiceTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteVoiceTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteVoiceTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteVoiceTemplateResolveEndpointMiddleware{
