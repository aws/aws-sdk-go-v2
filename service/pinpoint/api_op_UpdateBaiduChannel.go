...
func (c *Client) UpdateBaiduChannel(ctx context.Context, params *UpdateBaiduChannelInput, optFns ...func(*Options)) (*UpdateBaiduChannelOutput, error) {
	if params == nil { params = &UpdateBaiduChannelInput{} }
...
func (c *Client) addOperationUpdateBaiduChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateBaiduChannelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateBaiduChannelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateBaiduChannelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateBaiduChannelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateBaiduChannelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateBaiduChannelResolveEndpointMiddleware{
