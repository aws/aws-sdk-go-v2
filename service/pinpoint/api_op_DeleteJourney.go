...
func (c *Client) DeleteJourney(ctx context.Context, params *DeleteJourneyInput, optFns ...func(*Options)) (*DeleteJourneyOutput, error) {
	if params == nil { params = &DeleteJourneyInput{} }
...
func (c *Client) addOperationDeleteJourneyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteJourneyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteJourneyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteJourneyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteJourneyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteJourneyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteJourneyResolveEndpointMiddleware{
