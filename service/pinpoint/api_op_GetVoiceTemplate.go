...
func (c *Client) GetVoiceTemplate(ctx context.Context, params *GetVoiceTemplateInput, optFns ...func(*Options)) (*GetVoiceTemplateOutput, error) {
	if params == nil { params = &GetVoiceTemplateInput{} }
...
func (c *Client) addOperationGetVoiceTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetVoiceTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetVoiceTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetVoiceTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetVoiceTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetVoiceTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetVoiceTemplateResolveEndpointMiddleware{
