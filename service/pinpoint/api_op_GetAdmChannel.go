...
func (c *Client) GetAdmChannel(ctx context.Context, params *GetAdmChannelInput, optFns ...func(*Options)) (*GetAdmChannelOutput, error) {
	if params == nil { params = &GetAdmChannelInput{} }
...
func (c *Client) addOperationGetAdmChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAdmChannelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAdmChannelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAdmChannelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAdmChannelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAdmChannelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAdmChannelResolveEndpointMiddleware{
