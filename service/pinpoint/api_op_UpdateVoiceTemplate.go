...
func (c *Client) UpdateVoiceTemplate(ctx context.Context, params *UpdateVoiceTemplateInput, optFns ...func(*Options)) (*UpdateVoiceTemplateOutput, error) {
	if params == nil { params = &UpdateVoiceTemplateInput{} }
...
func (c *Client) addOperationUpdateVoiceTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateVoiceTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateVoiceTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateVoiceTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateVoiceTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateVoiceTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateVoiceTemplateResolveEndpointMiddleware{
