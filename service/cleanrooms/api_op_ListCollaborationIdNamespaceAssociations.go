...
func (c *Client) addOperationListCollaborationIdNamespaceAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCollaborationIdNamespaceAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
