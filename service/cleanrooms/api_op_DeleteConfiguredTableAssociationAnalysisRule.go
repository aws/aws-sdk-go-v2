...
func (c *Client) addOperationDeleteConfiguredTableAssociationAnalysisRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteConfiguredTableAssociationAnalysisRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
