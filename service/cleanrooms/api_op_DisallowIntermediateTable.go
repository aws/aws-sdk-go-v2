...
func (c *Client) addOperationDisallowIntermediateTableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisallowIntermediateTable", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
