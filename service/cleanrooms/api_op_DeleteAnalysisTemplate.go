...
func (c *Client) DeleteAnalysisTemplate(ctx context.Context, params *DeleteAnalysisTemplateInput, optFns ...func(*Options)) (*DeleteAnalysisTemplateOutput, error) {
	if params == nil { params = &DeleteAnalysisTemplateInput{} }
...
func (c *Client) addOperationDeleteAnalysisTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAnalysisTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteAnalysisTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteAnalysisTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteAnalysisTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAnalysisTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteAnalysisTemplateResolveEndpointMiddleware{
