...
func (c *Client) addOperationListCollaborationPrivacyBudgetTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCollaborationPrivacyBudgetTemplates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
