...
func (c *Client) addOperationDeleteIntermediateTableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteIntermediateTable", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
