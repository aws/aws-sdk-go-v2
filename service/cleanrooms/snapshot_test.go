...
func TestCheckSnapshot_UpdateCollaborationChangeRequest(t *testing.T) {
	svc := New(Options{})
	_, err := svc.UpdateCollaborationChangeRequest(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "UpdateCollaborationChangeRequest")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_UpdateCollaborationChangeRequest(t *testing.T) {
	svc := New(Options{})
	_, err := svc.UpdateCollaborationChangeRequest(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return updateSnapshot(stack, "UpdateCollaborationChangeRequest")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
