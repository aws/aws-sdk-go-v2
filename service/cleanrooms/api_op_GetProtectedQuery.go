...
func (c *Client) GetProtectedQuery(ctx context.Context, params *GetProtectedQueryInput, optFns ...func(*Options)) (*GetProtectedQueryOutput, error) {
	if params == nil { params = &GetProtectedQueryInput{} }
...
func (c *Client) addOperationGetProtectedQueryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetProtectedQueryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetProtectedQueryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetProtectedQueryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetProtectedQueryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetProtectedQueryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetProtectedQueryResolveEndpointMiddleware{
