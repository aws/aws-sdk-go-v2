...
func (c *Client) UpdateConfiguredTable(ctx context.Context, params *UpdateConfiguredTableInput, optFns ...func(*Options)) (*UpdateConfiguredTableOutput, error) {
	if params == nil { params = &UpdateConfiguredTableInput{} }
...
func (c *Client) addOperationUpdateConfiguredTableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateConfiguredTableResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateConfiguredTableResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateConfiguredTableResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateConfiguredTableResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateConfiguredTableResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateConfiguredTableResolveEndpointMiddleware{
