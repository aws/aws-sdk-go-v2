...
func (c *Client) addOperationUpdateConfiguredTableAssociationAnalysisRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateConfiguredTableAssociationAnalysisRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
