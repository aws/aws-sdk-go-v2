...
func (c *Client) GetMembership(ctx context.Context, params *GetMembershipInput, optFns ...func(*Options)) (*GetMembershipOutput, error) {
	if params == nil { params = &GetMembershipInput{} }
...
func (c *Client) addOperationGetMembershipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMembershipResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetMembershipResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetMembershipResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMembershipResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMembershipResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetMembershipResolveEndpointMiddleware{
