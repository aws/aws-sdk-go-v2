...
func (c *Client) GetCollaboration(ctx context.Context, params *GetCollaborationInput, optFns ...func(*Options)) (*GetCollaborationOutput, error) {
	if params == nil { params = &GetCollaborationInput{} }
...
func (c *Client) addOperationGetCollaborationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCollaborationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCollaborationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCollaborationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCollaborationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCollaborationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCollaborationResolveEndpointMiddleware{
