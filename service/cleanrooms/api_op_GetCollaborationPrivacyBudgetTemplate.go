...
func (c *Client) addOperationGetCollaborationPrivacyBudgetTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCollaborationPrivacyBudgetTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
