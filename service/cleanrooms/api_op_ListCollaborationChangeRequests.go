...
func (c *Client) addOperationListCollaborationChangeRequestsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCollaborationChangeRequests", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
