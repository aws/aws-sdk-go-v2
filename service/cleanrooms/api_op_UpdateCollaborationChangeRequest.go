...
func (c *Client) addOperationUpdateCollaborationChangeRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCollaborationChangeRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
