...
func (c *Client) GetConfiguredTableAssociation(ctx context.Context, params *GetConfiguredTableAssociationInput, optFns ...func(*Options)) (*GetConfiguredTableAssociationOutput, error) {
	if params == nil { params = &GetConfiguredTableAssociationInput{} }
...
func (c *Client) addOperationGetConfiguredTableAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetConfiguredTableAssociationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetConfiguredTableAssociationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetConfiguredTableAssociationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetConfiguredTableAssociationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetConfiguredTableAssociationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetConfiguredTableAssociationResolveEndpointMiddleware{
