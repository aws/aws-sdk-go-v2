...
func (c *Client) addOperationListPrivacyBudgetTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPrivacyBudgetTemplates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
