...
func (c *Client) DeleteConfiguredTable(ctx context.Context, params *DeleteConfiguredTableInput, optFns ...func(*Options)) (*DeleteConfiguredTableOutput, error) {
	if params == nil { params = &DeleteConfiguredTableInput{} }
...
func (c *Client) addOperationDeleteConfiguredTableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteConfiguredTableResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteConfiguredTableResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteConfiguredTableResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteConfiguredTableResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteConfiguredTableResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteConfiguredTableResolveEndpointMiddleware{
