...
func (c *Client) DeleteConfiguredTableAnalysisRule(ctx context.Context, params *DeleteConfiguredTableAnalysisRuleInput, optFns ...func(*Options)) (*DeleteConfiguredTableAnalysisRuleOutput, error) {
	if params == nil { params = &DeleteConfiguredTableAnalysisRuleInput{} }
...
func (c *Client) addOperationDeleteConfiguredTableAnalysisRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteConfiguredTableAnalysisRuleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteConfiguredTableAnalysisRuleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteConfiguredTableAnalysisRuleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteConfiguredTableAnalysisRuleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteConfiguredTableAnalysisRuleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteConfiguredTableAnalysisRuleResolveEndpointMiddleware{
