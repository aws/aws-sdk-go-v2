...
func (c *Client) addOperationDeleteConfiguredTableAnalysisRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteConfiguredTableAnalysisRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
