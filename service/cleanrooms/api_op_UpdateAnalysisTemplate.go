...
func (c *Client) UpdateAnalysisTemplate(ctx context.Context, params *UpdateAnalysisTemplateInput, optFns ...func(*Options)) (*UpdateAnalysisTemplateOutput, error) {
	if params == nil { params = &UpdateAnalysisTemplateInput{} }
...
func (c *Client) addOperationUpdateAnalysisTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateAnalysisTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateAnalysisTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateAnalysisTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateAnalysisTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateAnalysisTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateAnalysisTemplateResolveEndpointMiddleware{
