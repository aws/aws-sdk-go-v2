...
func (c *Client) DeleteConfiguredTableAssociation(ctx context.Context, params *DeleteConfiguredTableAssociationInput, optFns ...func(*Options)) (*DeleteConfiguredTableAssociationOutput, error) {
	if params == nil { params = &DeleteConfiguredTableAssociationInput{} }
...
func (c *Client) addOperationDeleteConfiguredTableAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteConfiguredTableAssociationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteConfiguredTableAssociationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteConfiguredTableAssociationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteConfiguredTableAssociationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteConfiguredTableAssociationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteConfiguredTableAssociationResolveEndpointMiddleware{
