...
func (c *Client) CreateConfiguredTableAnalysisRule(ctx context.Context, params *CreateConfiguredTableAnalysisRuleInput, optFns ...func(*Options)) (*CreateConfiguredTableAnalysisRuleOutput, error) {
	if params == nil { params = &CreateConfiguredTableAnalysisRuleInput{} }
...
func (c *Client) addOperationCreateConfiguredTableAnalysisRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateConfiguredTableAnalysisRuleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateConfiguredTableAnalysisRuleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateConfiguredTableAnalysisRuleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateConfiguredTableAnalysisRuleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateConfiguredTableAnalysisRuleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateConfiguredTableAnalysisRuleResolveEndpointMiddleware{
