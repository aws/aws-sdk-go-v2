...
func (c *Client) addOperationPopulateIntermediateTableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PopulateIntermediateTable", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
