...
func (c *Client) ListConfiguredTableAssociations(ctx context.Context, params *ListConfiguredTableAssociationsInput, optFns ...func(*Options)) (*ListConfiguredTableAssociationsOutput, error) {
	if params == nil { params = &ListConfiguredTableAssociationsInput{} }
...
func (c *Client) addOperationListConfiguredTableAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListConfiguredTableAssociationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListConfiguredTableAssociationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListConfiguredTableAssociationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListConfiguredTableAssociationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListConfiguredTableAssociationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListConfiguredTableAssociationsResolveEndpointMiddleware{
