...
func (c *Client) addOperationCreateCollaborationChangeRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCollaborationChangeRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
