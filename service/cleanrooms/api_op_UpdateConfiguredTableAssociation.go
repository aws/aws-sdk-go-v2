...
func (c *Client) UpdateConfiguredTableAssociation(ctx context.Context, params *UpdateConfiguredTableAssociationInput, optFns ...func(*Options)) (*UpdateConfiguredTableAssociationOutput, error) {
	if params == nil { params = &UpdateConfiguredTableAssociationInput{} }
...
func (c *Client) addOperationUpdateConfiguredTableAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateConfiguredTableAssociationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateConfiguredTableAssociationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateConfiguredTableAssociationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateConfiguredTableAssociationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateConfiguredTableAssociationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateConfiguredTableAssociationResolveEndpointMiddleware{
