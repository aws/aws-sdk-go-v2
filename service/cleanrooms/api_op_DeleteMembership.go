...
func (*DeleteMembershipInput) operationName() string {
...
func (c *Client) addOperationDeleteMembershipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteMembershipResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteMembershipResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteMembershipResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteMembershipResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteMembershipResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteMembershipResolveEndpointMiddleware{
