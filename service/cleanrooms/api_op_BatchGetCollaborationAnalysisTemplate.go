...
func (c *Client) BatchGetCollaborationAnalysisTemplate(ctx context.Context, params *BatchGetCollaborationAnalysisTemplateInput, optFns ...func(*Options)) (*BatchGetCollaborationAnalysisTemplateOutput, error) {
	if params == nil { params = &BatchGetCollaborationAnalysisTemplateInput{} }
...
func (c *Client) addOperationBatchGetCollaborationAnalysisTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchGetCollaborationAnalysisTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchGetCollaborationAnalysisTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchGetCollaborationAnalysisTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchGetCollaborationAnalysisTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchGetCollaborationAnalysisTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchGetCollaborationAnalysisTemplateResolveEndpointMiddleware{
