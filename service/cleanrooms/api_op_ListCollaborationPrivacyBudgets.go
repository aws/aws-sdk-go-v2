...
func (c *Client) addOperationListCollaborationPrivacyBudgetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCollaborationPrivacyBudgets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
