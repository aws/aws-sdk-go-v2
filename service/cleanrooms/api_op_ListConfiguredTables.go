...
func (c *Client) ListConfiguredTables(ctx context.Context, params *ListConfiguredTablesInput, optFns ...func(*Options)) (*ListConfiguredTablesOutput, error) {
	if params == nil { params = &ListConfiguredTablesInput{} }
...
func (c *Client) addOperationListConfiguredTablesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListConfiguredTablesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListConfiguredTablesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListConfiguredTablesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListConfiguredTablesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListConfiguredTablesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListConfiguredTablesResolveEndpointMiddleware{
