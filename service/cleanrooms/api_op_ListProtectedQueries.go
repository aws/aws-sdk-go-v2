...
func (c *Client) ListProtectedQueries(ctx context.Context, params *ListProtectedQueriesInput, optFns ...func(*Options)) (*ListProtectedQueriesOutput, error) {
	if params == nil { params = &ListProtectedQueriesInput{} }
...
func (c *Client) addOperationListProtectedQueriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListProtectedQueriesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListProtectedQueriesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListProtectedQueriesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListProtectedQueriesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListProtectedQueriesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListProtectedQueriesResolveEndpointMiddleware{
