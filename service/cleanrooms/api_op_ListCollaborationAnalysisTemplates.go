...
func (c *Client) addOperationListCollaborationAnalysisTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCollaborationAnalysisTemplates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
