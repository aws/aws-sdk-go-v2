...
func (c *Client) UpdateConfiguredTableAnalysisRule(ctx context.Context, params *UpdateConfiguredTableAnalysisRuleInput, optFns ...func(*Options)) (*UpdateConfiguredTableAnalysisRuleOutput, error) {
	if params == nil { params = &UpdateConfiguredTableAnalysisRuleInput{} }
...
func (c *Client) addOperationUpdateConfiguredTableAnalysisRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateConfiguredTableAnalysisRuleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateConfiguredTableAnalysisRuleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateConfiguredTableAnalysisRuleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateConfiguredTableAnalysisRuleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateConfiguredTableAnalysisRuleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateConfiguredTableAnalysisRuleResolveEndpointMiddleware{
