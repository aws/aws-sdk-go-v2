...
func (c *Client) addOperationUpdateConfiguredTableAnalysisRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateConfiguredTableAnalysisRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
