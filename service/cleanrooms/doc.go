...
// Package cleanrooms provides the API client, operations, and parameter types
// for AWS Clean Rooms Service.
//
// Welcome to the AWS Clean Rooms API Reference. AWS Clean Rooms is an AWS
