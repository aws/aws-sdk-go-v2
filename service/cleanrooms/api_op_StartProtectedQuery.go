...
func (c *Client) StartProtectedQuery(ctx context.Context, params *StartProtectedQueryInput, optFns ...func(*Options)) (*StartProtectedQueryOutput, error) {
	if params == nil { params = &StartProtectedQueryInput{} }
...
func (c *Client) addOperationStartProtectedQueryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartProtectedQueryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartProtectedQueryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartProtectedQueryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartProtectedQueryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartProtectedQueryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartProtectedQueryResolveEndpointMiddleware{
