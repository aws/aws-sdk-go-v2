...
func (c *Client) CreateAnalysisTemplate(ctx context.Context, params *CreateAnalysisTemplateInput, optFns ...func(*Options)) (*CreateAnalysisTemplateOutput, error) {
	if params == nil { params = &CreateAnalysisTemplateInput{} }
...
func (c *Client) addOperationCreateAnalysisTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateAnalysisTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateAnalysisTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateAnalysisTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateAnalysisTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateAnalysisTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateAnalysisTemplateResolveEndpointMiddleware{
