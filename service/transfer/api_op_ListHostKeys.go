...
func (c *Client) ListHostKeys(ctx context.Context, params *ListHostKeysInput, optFns ...func(*Options)) (*ListHostKeysOutput, error) {
	if params == nil { params = &ListHostKeysInput{} }
...
func (c *Client) addOperationListHostKeysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListHostKeysResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListHostKeysResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListHostKeysResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListHostKeysResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListHostKeysResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListHostKeysResolveEndpointMiddleware{
