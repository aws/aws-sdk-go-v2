...
// you specify. The response returns the ServerId  and the UserName for the
// updated user.
...
type UpdateUserInput struct {
	...
	// access to your Amazon Elastic File Systems (Amazon EFS). The POSIX permissions
	// that are set on files and directories in your file system determines the level
	// of access your users get when transferring files into and out of your Amazon EFS
	// file systems.
