...
func (c *Client) addOperationListFileTransferResultsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFileTransferResults", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
