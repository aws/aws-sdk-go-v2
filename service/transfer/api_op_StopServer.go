...
func (*StopServerInput) operationName() string {
	return "StopServer"
}
...
func (c *Client) addOperationStopServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopServerResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopServerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopServerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopServerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopServerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopServerResolveEndpointMiddleware{
