...
type CreateServerInput struct {
	...
	// The RSA or ECDSA private key to use for your server. Use the following command
	// to generate an RSA 2048 bit key with no passphrase: ssh-keygen -t rsa -b 2048 -N
	// "" -m PEM -f my-new-server-key. Use a minimum value of 2048 for the -b option:
	// you can create a stronger key using 3072 or 4096. Use the following command to
	...
	// 256, 384, and 521. For both of these commands, you can replace my-new-server-key
	// with a string of your choice. If you aren't planning to migrate existing users
	// from an existing SFTP-enabled server to a new server, don't update the host key.
