...
type CreateServerInput struct {
	...
	// resources only within your VPC. It is recommended that you use VPC as the
	// EndpointType. With this endpoint type, you have the option to directly associate
	// up to three Elastic IPv4 addresses (BYO IP included) with your server's endpoint
	// and use VPC security groups to restrict traffic by the client's public IP
...
func addOperationCreateServerStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateServerStackSlots(stack); err != nil {
		return err
	}
