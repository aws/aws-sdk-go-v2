...
type UpdateAccessInput struct {
	...
	// down policy. For scope-down policies, Amazon Web ServicesTransfer Family stores
	// the policy as a JSON blob, instead of the Amazon Resource Name (ARN) of the
	// policy. You save the policy as a JSON blob and pass it in the Policy argument.
