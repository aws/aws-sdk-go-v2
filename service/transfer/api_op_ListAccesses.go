...
func (c *Client) ListAccesses(ctx context.Context, params *ListAccessesInput, optFns ...func(*Options)) (*ListAccessesOutput, error) {
	if params == nil { params = &ListAccessesInput{} }
...
func (c *Client) addOperationListAccessesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAccessesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAccessesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAccessesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAccessesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAccessesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAccessesResolveEndpointMiddleware{
