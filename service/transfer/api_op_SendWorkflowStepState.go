...
func (c *Client) SendWorkflowStepState(ctx context.Context, params *SendWorkflowStepStateInput, optFns ...func(*Options)) (*SendWorkflowStepStateOutput, error) {
	if params == nil { params = &SendWorkflowStepStateInput{} }
...
func (c *Client) addOperationSendWorkflowStepStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendWorkflowStepStateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSendWorkflowStepStateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSendWorkflowStepStateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendWorkflowStepStateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendWorkflowStepStateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSendWorkflowStepStateResolveEndpointMiddleware{
