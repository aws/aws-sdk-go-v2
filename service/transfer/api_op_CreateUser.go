...
// that have the IdentityProviderType  set to SERVICE_MANAGED. Using parameters
// for CreateUser, you can specify the user name, set the home directory, store
// the user's public key, and assign the user's Identity and Access Management
...
type CreateUserInput struct {
	...
	// and any secondary groups IDs ( SecondaryGids), that controls your users'
	// access to your Amazon EFS file systems. The POSIX permissions that are set on
	// files and directories in Amazon EFS determine the level of access your users get
	...
	// to the server. The three standard SSH public key format elements are , , and
	// an optional , with spaces between each element. Transfer Family accepts RSA,
