...
type UpdateServerInput struct {
	...
	// partial upload occurs when a file is open when the session disconnects. To
	// remove an associated workflow from a server, you can provide an empty OnUpload
	// object, as in the following example. aws transfer update-server --server-id
