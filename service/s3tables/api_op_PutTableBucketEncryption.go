...
func (c *Client) addOperationPutTableBucketEncryptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutTableBucketEncryption", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
