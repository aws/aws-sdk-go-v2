...
func (c *Client) addOperationGetTableMaintenanceJobStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetTableMaintenanceJobStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
