...
type ListTagsForResourceInput struct {
	...
	// The Amazon Resource Name (ARN) of the Amazon S3 Tables resource that you want
...
type ListTagsForResourceOutput struct {
	...
	// The user-defined tags that are applied to the resource. For more information,
