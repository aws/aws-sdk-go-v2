...
func (c *Client) addOperationUpdateTableMetadataLocationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateTableMetadataLocation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
