...
func (c *Client) addOperationGetTableRecordExpirationJobStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetTableRecordExpirationJobStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
