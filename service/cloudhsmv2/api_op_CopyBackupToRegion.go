...
func (c *Client) CopyBackupToRegion(ctx context.Context, params *CopyBackupToRegionInput, optFns ...func(*Options)) (*CopyBackupToRegionOutput, error) {
	if params == nil { params = &CopyBackupToRegionInput{} }
...
func (c *Client) addOperationCopyBackupToRegionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCopyBackupToRegionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCopyBackupToRegionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCopyBackupToRegionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCopyBackupToRegionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCopyBackupToRegionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCopyBackupToRegionResolveEndpointMiddleware{
