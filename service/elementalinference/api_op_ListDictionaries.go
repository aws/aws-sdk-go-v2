...
func (c *Client) addOperationListDictionariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListDictionaries(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opListDictionaries(region string) *awsmiddleware.RegisterServiceMetadata {
