...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-elementalinference.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elementalinference.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elementalinference.dev",
			expectURL:     aws.String("https://env-elementalinference.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-elementalinference.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elementalinference.dev",
			expectURL:     aws.String("http://config-elementalinference.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-elementalinference.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-elementalinference.dev",
			clientEndpoint: aws.String("https://client-elementalinference.dev"),
			expectURL:      aws.String("https://client-elementalinference.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ELEMENTALINFERENCE", c.envService)
			}
