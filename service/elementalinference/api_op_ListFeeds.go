...
func (c *Client) ListFeeds(ctx context.Context, params *ListFeedsInput, optFns ...func(*Options)) (*ListFeedsOutput, error) {
	if params == nil {
		params = &ListFeedsInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "ListFeeds", params, optFns, c.addOperationListFeedsMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*ListFeedsOutput)
...
func (c *Client) addOperationListFeedsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFeeds", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
...
type ListFeedsPaginator struct {
	options   ListFeedsPaginatorOptions
	client    ListFeedsAPIClient
	params    *ListFeedsInput
	nextToken *string
	firstPage bool
}
...
func (p *ListFeedsPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*ListFeedsOutput, error) {
	...
	result, err := p.client.ListFeeds(ctx, &params, optFns...)
	if err != nil {
		return nil, err
	}
	p.firstPage = false
