...
// DisableProactiveEngagement and EnableProactiveEngagement. This call defines
// the list of email addresses and phone numbers that the SRT can use to contact
// you for escalations to the SRT and to initiate proactive customer support. The
...
type AssociateProactiveEngagementDetailsInput struct {
	...
	// proactive customer support. To enable proactive engagement, the contact list
	// must include at least one phone number. The contacts that you provide here
	// replace any contacts that were already defined. If you already have contacts
	// defined and want to use them, retrieve the list using
