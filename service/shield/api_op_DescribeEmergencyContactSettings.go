...
func addOperationDescribeEmergencyContactSettingsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeEmergencyContactSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeEmergencyContactSettingsStackSlots(stack); err != nil {
		return err
	}
