...
func (c *Client) DisableApplicationLayerAutomaticResponse(ctx context.Context, params *DisableApplicationLayerAutomaticResponseInput, optFns ...func(*Options)) (*DisableApplicationLayerAutomaticResponseOutput, error) {
	if params == nil { params = &DisableApplicationLayerAutomaticResponseInput{} }
...
func (c *Client) addOperationDisableApplicationLayerAutomaticResponseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableApplicationLayerAutomaticResponseResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisableApplicationLayerAutomaticResponseResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisableApplicationLayerAutomaticResponseResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableApplicationLayerAutomaticResponseResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableApplicationLayerAutomaticResponseResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisableApplicationLayerAutomaticResponseResolveEndpointMiddleware{
