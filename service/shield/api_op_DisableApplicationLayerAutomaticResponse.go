...
func (c *Client) addOperationDisableApplicationLayerAutomaticResponseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisableApplicationLayerAutomaticResponse", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
