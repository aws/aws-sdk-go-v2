...
func (*DisableProactiveEngagementInput) operationName() string {
...
func (c *Client) addOperationDisableProactiveEngagementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableProactiveEngagementResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDisableProactiveEngagementResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDisableProactiveEngagementResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableProactiveEngagementResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableProactiveEngagementResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDisableProactiveEngagementResolveEndpointMiddleware{
