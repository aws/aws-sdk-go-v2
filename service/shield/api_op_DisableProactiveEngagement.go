...
func addOperationDisableProactiveEngagementStackSlots(stack *middleware.Stack) error {
...
func addOperationDisableProactiveEngagementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisableProactiveEngagementStackSlots(stack); err != nil {
		return err
	}
