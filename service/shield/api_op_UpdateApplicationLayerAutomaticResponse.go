...
func (c *Client) addOperationUpdateApplicationLayerAutomaticResponseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateApplicationLayerAutomaticResponse", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
