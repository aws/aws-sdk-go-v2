...
func (c *Client) UpdateApplicationLayerAutomaticResponse(ctx context.Context, params *UpdateApplicationLayerAutomaticResponseInput, optFns ...func(*Options)) (*UpdateApplicationLayerAutomaticResponseOutput, error) {
	if params == nil { params = &UpdateApplicationLayerAutomaticResponseInput{} }
...
func (c *Client) addOperationUpdateApplicationLayerAutomaticResponseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateApplicationLayerAutomaticResponseResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateApplicationLayerAutomaticResponseResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateApplicationLayerAutomaticResponseResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateApplicationLayerAutomaticResponseResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateApplicationLayerAutomaticResponseResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateApplicationLayerAutomaticResponseResolveEndpointMiddleware{
