...
func (c *Client) addOperationDisassociateHealthCheckMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateHealthCheck", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
