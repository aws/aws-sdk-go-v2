...
func (c *Client) addOperationListResourcesInProtectionGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListResourcesInProtectionGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
