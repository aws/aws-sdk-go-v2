...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-shield.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-shield.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-shield.dev",
			expectURL:     aws.String("https://env-shield.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-shield.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-shield.dev",
			expectURL:     aws.String("http://config-shield.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-shield.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-shield.dev",
			clientEndpoint: aws.String("https://client-shield.dev"),
			expectURL:      aws.String("https://client-shield.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SHIELD", c.envService)
			}
