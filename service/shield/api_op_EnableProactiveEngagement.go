...
func (c *Client) EnableProactiveEngagement(ctx context.Context, params *EnableProactiveEngagementInput, optFns ...func(*Options)) (*EnableProactiveEngagementOutput, error) {
	if params == nil { params = &EnableProactiveEngagementInput{} }
...
func (c *Client) addOperationEnableProactiveEngagementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableProactiveEngagementResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEnableProactiveEngagementResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEnableProactiveEngagementResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableProactiveEngagementResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableProactiveEngagementResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEnableProactiveEngagementResolveEndpointMiddleware{
