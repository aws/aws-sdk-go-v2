...
func addOperationUpdateEmergencyContactSettingsStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateEmergencyContactSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateEmergencyContactSettingsStackSlots(stack); err != nil {
		return err
	}
