...
func (c *Client) addOperationGetInstancesHealthStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetInstancesHealthStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
