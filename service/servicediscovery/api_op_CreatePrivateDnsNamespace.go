...
// using either a DiscoverInstances request or using DNS. For the current quota
...
type CreatePrivateDnsNamespaceInput struct {
	...
	// CreatePrivateDnsNamespacerequests to be retried without the risk of running
