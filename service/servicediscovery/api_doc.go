...
// Using the Client
//
// To use ServiceDiscovery with the SDK use the New function to create
...
//
// See the ServiceDiscovery client for more information on
