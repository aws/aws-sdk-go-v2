...
type RegisterInstanceInput struct {
	...
	// settings for the instance. For services created in a shared namespace, specify
...
func (c *Client) addOperationRegisterInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
