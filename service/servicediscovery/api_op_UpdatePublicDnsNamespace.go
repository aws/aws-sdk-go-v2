...
func (c *Client) addOperationUpdatePublicDnsNamespaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdatePublicDnsNamespace", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
