...
func (c *Client) CreateWorkspaceInstance(ctx context.Context, params *CreateWorkspaceInstanceInput, optFns ...func(*Options)) (*CreateWorkspaceInstanceOutput, error) {
	if params == nil { params = &CreateWorkspaceInstanceInput{} }
...
func (m *idempotencyToken_initializeOpCreateWorkspaceInstance) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *CreateWorkspaceInstanceInput ")}
