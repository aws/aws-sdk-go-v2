...
func (c *Client) addOperationListConnectorDestinationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListConnectorDestinations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
