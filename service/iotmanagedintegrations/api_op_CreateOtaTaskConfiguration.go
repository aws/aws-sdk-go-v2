...
func (c *Client) addOperationCreateOtaTaskConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateOtaTaskConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
