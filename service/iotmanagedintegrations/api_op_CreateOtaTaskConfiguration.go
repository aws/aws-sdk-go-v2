...
func (c *Client) CreateOtaTaskConfiguration(ctx context.Context, params *CreateOtaTaskConfigurationInput, optFns ...func(*Options)) (*CreateOtaTaskConfigurationOutput, error) {
	if params == nil { params = &CreateOtaTaskConfigurationInput{} }
...
func (m *idempotencyToken_initializeOpCreateOtaTaskConfiguration) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *CreateOtaTaskConfigurationInput ")}
