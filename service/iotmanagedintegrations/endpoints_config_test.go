...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iot-managed-integrations.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-managed-integrations.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-managed-integrations.dev",
			expectURL:     aws.String("https://env-iot-managed-integrations.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iot-managed-integrations.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-managed-integrations.dev",
			expectURL:     aws.String("http://config-iot-managed-integrations.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iot-managed-integrations.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iot-managed-integrations.dev",
			clientEndpoint: aws.String("https://client-iot-managed-integrations.dev"),
			expectURL:      aws.String("https://client-iot-managed-integrations.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IOT_MANAGED_INTEGRATIONS", c.envService)
			}
