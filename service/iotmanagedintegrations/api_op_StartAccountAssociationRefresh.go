...
func (c *Client) addOperationStartAccountAssociationRefreshMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartAccountAssociationRefresh", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
