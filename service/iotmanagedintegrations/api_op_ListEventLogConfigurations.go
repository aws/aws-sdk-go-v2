...
func (c *Client) addOperationListEventLogConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEventLogConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
