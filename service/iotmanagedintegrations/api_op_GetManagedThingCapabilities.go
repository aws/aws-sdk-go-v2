...
func (c *Client) addOperationGetManagedThingCapabilitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetManagedThingCapabilities", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
