...
func (c *Client) addOperationGetDefaultEncryptionConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDefaultEncryptionConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
