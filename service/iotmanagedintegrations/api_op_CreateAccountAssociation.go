...
func (c *Client) CreateAccountAssociation(ctx context.Context, params *CreateAccountAssociationInput, optFns ...func(*Options)) (*CreateAccountAssociationOutput, error) {
	if params == nil { params = &CreateAccountAssociationInput{} }
...
func (m *idempotencyToken_initializeOpCreateAccountAssociation) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *CreateAccountAssociationInput ")}
