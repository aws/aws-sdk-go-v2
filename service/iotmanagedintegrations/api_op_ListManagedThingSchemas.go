...
func (c *Client) addOperationListManagedThingSchemasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListManagedThingSchemas", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
