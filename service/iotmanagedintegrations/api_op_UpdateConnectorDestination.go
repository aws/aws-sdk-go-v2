...
func (c *Client) addOperationUpdateConnectorDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateConnectorDestination", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
