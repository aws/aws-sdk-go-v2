...
func (c *Client) addOperationListManagedThingAccountAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListManagedThingAccountAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
