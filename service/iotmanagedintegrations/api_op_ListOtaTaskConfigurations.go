...
func (c *Client) addOperationListOtaTaskConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOtaTaskConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
