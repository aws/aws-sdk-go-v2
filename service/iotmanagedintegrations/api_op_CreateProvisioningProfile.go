...
func (c *Client) addOperationCreateProvisioningProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateProvisioningProfile", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
