...
func (c *Client) addOperationSetIdentityPoolConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SetIdentityPoolConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
