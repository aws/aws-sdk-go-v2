...
func addOperationSetIdentityPoolConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationSetIdentityPoolConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationSetIdentityPoolConfigurationStackSlots(stack); err != nil {
		return err
	}
