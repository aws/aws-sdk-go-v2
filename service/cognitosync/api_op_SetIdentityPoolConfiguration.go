...
func (*SetIdentityPoolConfigurationInput) operationName() string {
	return "SetIdentityPoolConfiguration"
}
...
func (c *Client) addOperationSetIdentityPoolConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetIdentityPoolConfigurationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opSetIdentityPoolConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opSetIdentityPoolConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetIdentityPoolConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetIdentityPoolConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opSetIdentityPoolConfigurationResolveEndpointMiddleware{
