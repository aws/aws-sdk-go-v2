...
func (*SetCognitoEventsInput) operationName() string {
	return "SetCognitoEvents"
}
...
func (c *Client) addOperationSetCognitoEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetCognitoEventsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opSetCognitoEventsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opSetCognitoEventsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetCognitoEventsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetCognitoEventsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opSetCognitoEventsResolveEndpointMiddleware{
