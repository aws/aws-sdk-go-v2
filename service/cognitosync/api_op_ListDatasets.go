...
func (v *ListDatasetsInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.IdentityId != nil {
		s.WriteString(schemas.ListDatasetsRequest_IdentityId, *v.IdentityId)
	}
	if v.IdentityPoolId != nil {
		s.WriteString(schemas.ListDatasetsRequest_IdentityPoolId, *v.IdentityPoolId)
	}
	if v.MaxResults != nil {
...
func (v *ListDatasetsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Count != 0 {
		s.WriteInt32(schemas.ListDatasetsResponse_Count, v.Count)
	}
	serializeDatasetList(s, schemas.ListDatasetsResponse_Datasets, v.Datasets)
	if v.NextToken != nil {
...
func (v *ListDatasetsOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListDatasetsResponse, func(s *smithy.Schema) error {
		switch s {
		case schemas.ListDatasetsResponse_Count:
			return d.ReadInt32(schemas.ListDatasetsResponse_Count, &v.Count)
