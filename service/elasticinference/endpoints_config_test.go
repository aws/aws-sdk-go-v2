...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-elastic-inference.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elastic-inference.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elastic-inference.dev",
			expectURL:     aws.String("https://env-elastic-inference.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-elastic-inference.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elastic-inference.dev",
			expectURL:     aws.String("http://config-elastic-inference.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-elastic-inference.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-elastic-inference.dev",
			clientEndpoint: aws.String("https://client-elastic-inference.dev"),
			expectURL:      aws.String("https://client-elastic-inference.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ELASTIC_INFERENCE", c.envService)
			}
