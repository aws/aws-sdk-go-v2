...
func (*DescribeAcceleratorTypesInput) operationName() string {
	return "DescribeAcceleratorTypes"
}
...
func (c *Client) addOperationDescribeAcceleratorTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeAcceleratorTypesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeAcceleratorTypesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeAcceleratorTypesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeAcceleratorTypesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeAcceleratorTypesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeAcceleratorTypesResolveEndpointMiddleware{
