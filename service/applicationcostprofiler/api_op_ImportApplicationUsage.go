...
func (c *Client) ImportApplicationUsage(ctx context.Context, params *ImportApplicationUsageInput, optFns ...func(*Options)) (*ImportApplicationUsageOutput, error) {
	if params == nil { params = &ImportApplicationUsageInput{} }
...
func (c *Client) addOperationImportApplicationUsageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addImportApplicationUsageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opImportApplicationUsageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opImportApplicationUsageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opImportApplicationUsageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addImportApplicationUsageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opImportApplicationUsageResolveEndpointMiddleware{
