...
func (v *ListReportDefinitionsOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListReportDefinitionsResult)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ListReportDefinitionsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.NextToken != nil {
		s.WriteString(schemas.ListReportDefinitionsResult_nextToken, *v.NextToken)
	}
	serializeReportDefinitionList(s, schemas.ListReportDefinitionsResult_reportDefinitions, v.ReportDefinitions)
}
