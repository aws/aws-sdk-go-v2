...
func (c *Client) StartSourceNetworkReplication(ctx context.Context, params *StartSourceNetworkReplicationInput, optFns ...func(*Options)) (*StartSourceNetworkReplicationOutput, error) {
	if params == nil { params = &StartSourceNetworkReplicationInput{} }
...
func (c *Client) addOperationStartSourceNetworkReplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartSourceNetworkReplicationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartSourceNetworkReplicationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartSourceNetworkReplicationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartSourceNetworkReplicationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartSourceNetworkReplicationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartSourceNetworkReplicationResolveEndpointMiddleware{
