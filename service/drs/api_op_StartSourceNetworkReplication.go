...
func (c *Client) addOperationStartSourceNetworkReplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartSourceNetworkReplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
