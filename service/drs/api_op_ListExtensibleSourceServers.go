...
func (c *Client) addOperationListExtensibleSourceServersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListExtensibleSourceServers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
