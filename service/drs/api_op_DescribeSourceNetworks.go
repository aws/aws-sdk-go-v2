...
func (c *Client) DescribeSourceNetworks(ctx context.Context, params *DescribeSourceNetworksInput, optFns ...func(*Options)) (*DescribeSourceNetworksOutput, error) {
	if params == nil { params = &DescribeSourceNetworksInput{} }
...
func (c *Client) addOperationDescribeSourceNetworksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeSourceNetworksResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeSourceNetworksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeSourceNetworksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeSourceNetworksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeSourceNetworksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeSourceNetworksResolveEndpointMiddleware{
