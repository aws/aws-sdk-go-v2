...
func (c *Client) StartSourceNetworkRecovery(ctx context.Context, params *StartSourceNetworkRecoveryInput, optFns ...func(*Options)) (*StartSourceNetworkRecoveryOutput, error) {
	if params == nil { params = &StartSourceNetworkRecoveryInput{} }
...
func (c *Client) addOperationStartSourceNetworkRecoveryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartSourceNetworkRecoveryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartSourceNetworkRecoveryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartSourceNetworkRecoveryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartSourceNetworkRecoveryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartSourceNetworkRecoveryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartSourceNetworkRecoveryResolveEndpointMiddleware{
