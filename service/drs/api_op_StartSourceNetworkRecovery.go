...
func (c *Client) addOperationStartSourceNetworkRecoveryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartSourceNetworkRecovery", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
