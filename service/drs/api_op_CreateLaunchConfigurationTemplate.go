...
func (*CreateLaunchConfigurationTemplateInput) operationName() string {
...
func (c *Client) addOperationCreateLaunchConfigurationTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateLaunchConfigurationTemplateResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateLaunchConfigurationTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateLaunchConfigurationTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateLaunchConfigurationTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateLaunchConfigurationTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateLaunchConfigurationTemplateResolveEndpointMiddleware{
