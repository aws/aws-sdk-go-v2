...
func (c *Client) addOperationCreateLaunchConfigurationTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateLaunchConfigurationTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
