...
func (c *Client) addOperationTerminateRecoveryInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "TerminateRecoveryInstances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
