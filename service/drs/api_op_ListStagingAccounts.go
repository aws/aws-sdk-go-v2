...
func (c *Client) ListStagingAccounts(ctx context.Context, params *ListStagingAccountsInput, optFns ...func(*Options)) (*ListStagingAccountsOutput, error) {
	if params == nil { params = &ListStagingAccountsInput{} }
...
func (c *Client) addOperationListStagingAccountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListStagingAccountsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListStagingAccountsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListStagingAccountsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListStagingAccountsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListStagingAccountsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListStagingAccountsResolveEndpointMiddleware{
