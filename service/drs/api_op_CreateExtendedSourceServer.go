...
func (c *Client) CreateExtendedSourceServer(ctx context.Context, params *CreateExtendedSourceServerInput, optFns ...func(*Options)) (*CreateExtendedSourceServerOutput, error) {
	if params == nil { params = &CreateExtendedSourceServerInput{} }
...
func (c *Client) addOperationCreateExtendedSourceServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateExtendedSourceServerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateExtendedSourceServerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateExtendedSourceServerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateExtendedSourceServerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateExtendedSourceServerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateExtendedSourceServerResolveEndpointMiddleware{
