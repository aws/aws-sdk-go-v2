...
func (c *Client) StartRecovery(ctx context.Context, params *StartRecoveryInput, optFns ...func(*Options)) (*StartRecoveryOutput, error) {
	if params == nil { params = &StartRecoveryInput{} }
...
func (c *Client) addOperationStartRecoveryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartRecoveryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartRecoveryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartRecoveryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartRecoveryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartRecoveryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartRecoveryResolveEndpointMiddleware{
