...
func (c *Client) addOperationUpdateLaunchConfigurationTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateLaunchConfigurationTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
