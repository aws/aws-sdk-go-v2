...
func (*DeleteRecoveryInstanceInput) operationName() string {
...
func (c *Client) addOperationDeleteRecoveryInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteRecoveryInstanceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteRecoveryInstanceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteRecoveryInstanceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteRecoveryInstanceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteRecoveryInstanceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteRecoveryInstanceResolveEndpointMiddleware{
