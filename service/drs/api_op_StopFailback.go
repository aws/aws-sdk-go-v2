...
func (c *Client) StopFailback(ctx context.Context, params *StopFailbackInput, optFns ...func(*Options)) (*StopFailbackOutput, error) {
	if params == nil { params = &StopFailbackInput{} }
...
func (c *Client) addOperationStopFailbackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopFailbackResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopFailbackResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopFailbackResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopFailbackResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopFailbackResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopFailbackResolveEndpointMiddleware{
