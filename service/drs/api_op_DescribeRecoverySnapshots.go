...
func (c *Client) DescribeRecoverySnapshots(ctx context.Context, params *DescribeRecoverySnapshotsInput, optFns ...func(*Options)) (*DescribeRecoverySnapshotsOutput, error) {
	if params == nil { params = &DescribeRecoverySnapshotsInput{} }
...
func (c *Client) addOperationDescribeRecoverySnapshotsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeRecoverySnapshotsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeRecoverySnapshotsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeRecoverySnapshotsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeRecoverySnapshotsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeRecoverySnapshotsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeRecoverySnapshotsResolveEndpointMiddleware{
