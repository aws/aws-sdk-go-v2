...
func (c *Client) addOperationAssociateSourceNetworkStackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateSourceNetworkStack", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
