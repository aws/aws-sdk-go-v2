...
func (c *Client) DeleteSourceNetwork(ctx context.Context, params *DeleteSourceNetworkInput, optFns ...func(*Options)) (*DeleteSourceNetworkOutput, error) {
	if params == nil { params = &DeleteSourceNetworkInput{} }
...
func (c *Client) addOperationDeleteSourceNetworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteSourceNetworkResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteSourceNetworkResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteSourceNetworkResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteSourceNetworkResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteSourceNetworkResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteSourceNetworkResolveEndpointMiddleware{
