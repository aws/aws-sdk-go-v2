...
func (c *Client) DescribeRecoveryInstances(ctx context.Context, params *DescribeRecoveryInstancesInput, optFns ...func(*Options)) (*DescribeRecoveryInstancesOutput, error) {
	if params == nil { params = &DescribeRecoveryInstancesInput{} }
...
func (c *Client) addOperationDescribeRecoveryInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeRecoveryInstancesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeRecoveryInstancesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeRecoveryInstancesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeRecoveryInstancesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeRecoveryInstancesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeRecoveryInstancesResolveEndpointMiddleware{
