...
func (c *Client) addOperationDescribeRecoveryInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRecoveryInstances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
