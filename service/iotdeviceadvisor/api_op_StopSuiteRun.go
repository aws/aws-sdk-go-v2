...
func (c *Client) StopSuiteRun(ctx context.Context, params *StopSuiteRunInput, optFns ...func(*Options)) (*StopSuiteRunOutput, error) {
	if params == nil { params = &StopSuiteRunInput{} }
...
func (c *Client) addOperationStopSuiteRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopSuiteRunResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopSuiteRunResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopSuiteRunResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopSuiteRunResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopSuiteRunResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopSuiteRunResolveEndpointMiddleware{
