...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iotdeviceadvisor.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotdeviceadvisor.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotdeviceadvisor.dev",
			expectURL:     aws.String("https://env-iotdeviceadvisor.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iotdeviceadvisor.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotdeviceadvisor.dev",
			expectURL:     aws.String("http://config-iotdeviceadvisor.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iotdeviceadvisor.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iotdeviceadvisor.dev",
			clientEndpoint: aws.String("https://client-iotdeviceadvisor.dev"),
			expectURL:      aws.String("https://client-iotdeviceadvisor.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IOTDEVICEADVISOR", c.envService)
			}
