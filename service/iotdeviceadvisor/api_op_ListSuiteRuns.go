...
func (c *Client) ListSuiteRuns(ctx context.Context, params *ListSuiteRunsInput, optFns ...func(*Options)) (*ListSuiteRunsOutput, error) {
	if params == nil { params = &ListSuiteRunsInput{} }
...
func (c *Client) addOperationListSuiteRunsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSuiteRunsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSuiteRunsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSuiteRunsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSuiteRunsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSuiteRunsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSuiteRunsResolveEndpointMiddleware{
