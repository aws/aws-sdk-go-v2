...
func (c *Client) GetSuiteRun(ctx context.Context, params *GetSuiteRunInput, optFns ...func(*Options)) (*GetSuiteRunOutput, error) {
	if params == nil { params = &GetSuiteRunInput{} }
...
func (c *Client) addOperationGetSuiteRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSuiteRunResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSuiteRunResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSuiteRunResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSuiteRunResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSuiteRunResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSuiteRunResolveEndpointMiddleware{
