...
type SendMessageInput struct {
	...
	// 256 KB. A message can include only XML, JSON, and unformatted text. The
	...
	// MessageDeduplicationIdare accepted successfully but aren't delivered during
	...
	// length of MessageDeduplicationId  is 128 characters. MessageDeduplicationId
