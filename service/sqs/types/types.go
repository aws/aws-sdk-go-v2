...
type ChangeMessageVisibilityBatchRequestEntry struct {
	...
	// result. The Ids of a batch request need to be unique within a request. This
...
type DeleteMessageBatchRequestEntry struct {
	...
	// the result. The Ids of a batch request need to be unique within a request.
...
// , and Value, are part of the message size restriction (256 KB or 262,144
// bytes).
...
// Valueattribute has the same restrictions on the content as the message body.
