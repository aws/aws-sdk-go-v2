...
// than once, the ReceiptHandle is different each time you receive a message.
// When you use the DeleteMessage action, you must provide the most recently
// received ReceiptHandle for the message (otherwise, the request succeeds, but
// the message might not be deleted). For standard queues, it is possible to
