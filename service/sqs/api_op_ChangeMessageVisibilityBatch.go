...
func (c *Client) addOperationChangeMessageVisibilityBatchMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ChangeMessageVisibilityBatch", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
