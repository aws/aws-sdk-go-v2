...
func addOperationChangeMessageVisibilityBatchStackSlots(stack *middleware.Stack) error {
...
func addOperationChangeMessageVisibilityBatchMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationChangeMessageVisibilityBatchStackSlots(stack); err != nil {
		return err
	}
