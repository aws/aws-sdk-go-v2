...
type SetQueueAttributesInput struct {
	...
	// uses:
	// - DelaySeconds – The length of time, in seconds, for which the delivery of
	// all messages in the queue is delayed. Valid values: An integer from 0 to 900 (15
	// minutes). Default: 0.
	...
	// retains a message. Valid values: An integer representing seconds, from 60 (1
	// minute) to 1,209,600 (14 days). Default: 345,600 (4 days).
	// - Policy – The
	// queue's policy. A valid Amazon Web Services policy. For more information about
	// policy structure, see Overview of Amazon Web Services IAM Policies
	// (https://docs.aws.amazon.com/IAM/latest/UserGuide/PoliciesOverview.html) in the
	// Identity and Access Management User Guide.
	// - ReceiveMessageWaitTimeSeconds – The
	// length of time, in seconds, for which a ReceiveMessage action waits for a
