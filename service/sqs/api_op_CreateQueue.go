...
// -
// If the queue name, attribute names, or attribute values don't match an existing
// queue, CreateQueue returns an error.
//
...
// this: &AttributeName.1=first&AttributeName.2=second Cross-account permissions
