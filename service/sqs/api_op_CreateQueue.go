...
//
// To successfully create a new queue, you
// must provide a queue name that adheres to the limits related to queues
...
type CreateQueueInput struct {
	...
	// specify the FifoQueue attribute, Amazon SQS creates a standard queue. You can
	// provide this attribute only during queue creation. You can't change it for an
	...
	// – Enables content-based deduplication. Valid values: true, false. For more
