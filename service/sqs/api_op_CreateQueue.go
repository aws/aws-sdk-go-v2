...
type CreateQueueInput struct {
	...
	// If you set these
	// attributes to anything other than the values shown for enabling high throughput,
	// normal throughput is in effect and deduplication occurs as specified. For
	// information on throughput quotas, see Quotas related to messages (https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/quotas-messages.html)
	// in the Amazon SQS Developer Guide.
