...
type GetQueueAttributesInput struct {
	...
	// – Returns the approximate number of messages available for retrieval from the
	// queue.
	...
	// of the source queue as a JSON object. For more information about the redrive
