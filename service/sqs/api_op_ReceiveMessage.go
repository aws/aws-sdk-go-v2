...
//
// The receipt handle is the identifier
// you must provide when deleting the message. For more information, see Queue and
// Message Identifiers
...
type ReceiveMessageInput struct {
	...
	// - AWSTraceHeader – Returns
	// the X-Ray trace header string.
	// - SenderId
	// - For an IAM user, returns the IAM
	// user ID, for example ABCDEFGHI1JKLMNOPQ23R.
	// - For an IAM role, returns the IAM
	// role ID, for example ABCDE1F2GH3I4JK5LMNOP:i-a123b456.
	//
	// - SentTimestamp –
	...
	// - While messages
	// with a particular MessageGroupId are invisible, no more messages belonging to
	// the same MessageGroupId are returned until the visibility timeout expires. You
	// can still receive messages with another MessageGroupId as long as it is also
	// visible.
