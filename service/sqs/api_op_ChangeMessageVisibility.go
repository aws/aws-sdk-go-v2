...
// ChangeMessageVisibilityto extend the visibility timeout to the maximum allowed
...
//
// A message is considered to be stored after it is
// sent to a queue by a producer, but not yet received from the queue by a consumer
...
// VisibilityTimeoutto a value greater than the maximum time left, Amazon SQS
