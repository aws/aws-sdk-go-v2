...
func (c *Client) addOperationChangeMessageVisibilityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ChangeMessageVisibility", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
