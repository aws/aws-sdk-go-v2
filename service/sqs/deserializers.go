...
func (m *awsAwsquery_deserializeOpChangeMessageVisibility) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorChangeMessageVisibility(response)
	}
...
func awsAwsquery_deserializeOpErrorChangeMessageVisibility(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpChangeMessageVisibilityBatch) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorChangeMessageVisibilityBatch(response)
	}
...
func awsAwsquery_deserializeOpErrorChangeMessageVisibilityBatch(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpCreateQueue) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorCreateQueue(response)
	}
...
func awsAwsquery_deserializeOpErrorCreateQueue(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpDeleteMessage) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorDeleteMessage(response)
	}
...
func awsAwsquery_deserializeOpErrorDeleteMessage(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpDeleteMessageBatch) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorDeleteMessageBatch(response)
	}
...
func awsAwsquery_deserializeOpErrorDeleteMessageBatch(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpDeleteQueue) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorDeleteQueue(response)
	}
...
func awsAwsquery_deserializeOpErrorDeleteQueue(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpGetQueueAttributes) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorGetQueueAttributes(response)
	}
...
func awsAwsquery_deserializeOpErrorGetQueueAttributes(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpGetQueueUrl) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorGetQueueUrl(response)
	}
...
func awsAwsquery_deserializeOpErrorGetQueueUrl(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpListDeadLetterSourceQueues) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorListDeadLetterSourceQueues(response)
	}
...
func awsAwsquery_deserializeOpErrorListDeadLetterSourceQueues(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpListQueues) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorListQueues(response)
	}
...
func awsAwsquery_deserializeOpErrorListQueues(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpListQueueTags) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorListQueueTags(response)
	}
...
func awsAwsquery_deserializeOpErrorListQueueTags(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpPurgeQueue) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorPurgeQueue(response)
	}
...
func awsAwsquery_deserializeOpErrorPurgeQueue(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpReceiveMessage) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorReceiveMessage(response)
	}
...
func awsAwsquery_deserializeOpErrorReceiveMessage(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpSendMessage) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorSendMessage(response)
	}
...
func awsAwsquery_deserializeOpErrorSendMessage(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpSendMessageBatch) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorSendMessageBatch(response)
	}
...
func awsAwsquery_deserializeOpErrorSendMessageBatch(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpSetQueueAttributes) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorSetQueueAttributes(response)
	}
...
func awsAwsquery_deserializeOpErrorSetQueueAttributes(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpTagQueue) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorTagQueue(response)
	}
...
func awsAwsquery_deserializeOpErrorTagQueue(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func (m *awsAwsquery_deserializeOpUntagQueue) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsquery_deserializeOpErrorUntagQueue(response)
	}
...
func awsAwsquery_deserializeOpErrorUntagQueue(response *smithyhttp.Response) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
	...
	for {
		...
		for {
			if strings.EqualFold("member", t.Name.Local) {
				...
				if err := awsAwsquery_deserializeDocumentBatchResultErrorEntry(&col, nodeDecoder); err != nil {
					return err
				}
				sv = append(sv, col)
				break
...
func awsAwsquery_deserializeDocumentBatchResultErrorEntryListUnwrapped(v *[]*types.BatchResultErrorEntry, decoder smithyxml.NodeDecoder) error {
	...
	default:
		...
		_ = t
		nodeDecoder := smithyxml.WrapNodeDecoder(decoder.Decoder, t)
		if err := awsAwsquery_deserializeDocumentBatchResultErrorEntry(&mv, nodeDecoder); err != nil {
			return err
		}
		sv = append(sv, mv)
	}
	...
	for {
		...
		for {
			if strings.EqualFold("member", t.Name.Local) {
				...
				nodeDecoder := smithyxml.WrapNodeDecoder(decoder.Decoder, t)
				if err := awsAwsquery_deserializeDocumentChangeMessageVisibilityBatchResultEntry(&col, nodeDecoder); err != nil {
					return err
				}
				sv = append(sv, col)
				break
...
func awsAwsquery_deserializeDocumentChangeMessageVisibilityBatchResultEntryListUnwrapped(v *[]*types.ChangeMessageVisibilityBatchResultEntry, decoder smithyxml.NodeDecoder) error {
	...
	default:
		...
		_ = t
		nodeDecoder := smithyxml.WrapNodeDecoder(decoder.Decoder, t)
		if err := awsAwsquery_deserializeDocumentChangeMessageVisibilityBatchResultEntry(&mv, nodeDecoder); err != nil {
			return err
		}
		sv = append(sv, mv)
	}
	...
	for {
		...
		for {
			if strings.EqualFold("member", t.Name.Local) {
				...
				nodeDecoder := smithyxml.WrapNodeDecoder(decoder.Decoder, t)
				if err := awsAwsquery_deserializeDocumentDeleteMessageBatchResultEntry(&col, nodeDecoder); err != nil {
					return err
				}
				sv = append(sv, col)
				break
...
func awsAwsquery_deserializeDocumentDeleteMessageBatchResultEntryListUnwrapped(v *[]*types.DeleteMessageBatchResultEntry, decoder smithyxml.NodeDecoder) error {
	...
	default:
		...
		_ = t
		nodeDecoder := smithyxml.WrapNodeDecoder(decoder.Decoder, t)
		if err := awsAwsquery_deserializeDocumentDeleteMessageBatchResultEntry(&mv, nodeDecoder); err != nil {
			return err
		}
		sv = append(sv, mv)
	}
...
func awsAwsquery_deserializeDocumentMessage(v **types.Message, decoder smithyxml.NodeDecoder) error {
	...
	for {
		...
		case strings.EqualFold("MD5OfMessageAttributes", t.Name.Local):
			...
			if done {
				if val == nil {
					sv.MD5OfMessageAttributes = ptr.String("")
				}
				break
			}
			if val != nil {
				xtv := string(val)
				sv.MD5OfMessageAttributes = &xtv
			}
		...
		case strings.EqualFold("ReceiptHandle", t.Name.Local):
			...
			if done {
				if val == nil {
					sv.ReceiptHandle = ptr.String("")
				}
				break
			}
			if val != nil {
				xtv := string(val)
				sv.ReceiptHandle = &xtv
			}
...
func awsAwsquery_deserializeDocumentMessageBodyAttributeMapUnwrapped(v *map[string]*types.MessageAttributeValue, decoder smithyxml.NodeDecoder) error {
	...
	for {
		...
		case strings.EqualFold("Value", t.Name.Local):
			nodeDecoder := smithyxml.WrapNodeDecoder(decoder.Decoder, t)
			if err := awsAwsquery_deserializeDocumentMessageAttributeValue(&ev, nodeDecoder); err != nil {
				return err
			}
	...
	for {
		...
		for {
			if strings.EqualFold("member", t.Name.Local) {
				...
				nodeDecoder := smithyxml.WrapNodeDecoder(decoder.Decoder, t)
				if err := awsAwsquery_deserializeDocumentMessage(&col, nodeDecoder); err != nil {
					return err
				}
				sv = append(sv, col)
				break
...
func awsAwsquery_deserializeDocumentMessageListUnwrapped(v *[]*types.Message, decoder smithyxml.NodeDecoder) error {
	...
	default:
		...
		_ = t
		nodeDecoder := smithyxml.WrapNodeDecoder(decoder.Decoder, t)
		if err := awsAwsquery_deserializeDocumentMessage(&mv, nodeDecoder); err != nil {
			return err
		}
		sv = append(sv, mv)
	}
...
func awsAwsquery_deserializeDocumentSendMessageBatchResultEntry(v **types.SendMessageBatchResultEntry, decoder smithyxml.NodeDecoder) error {
	...
	for {
		...
		case strings.EqualFold("MD5OfMessageBody", t.Name.Local):
			...
			if done {
				if val == nil {
					sv.MD5OfMessageBody = ptr.String("")
				}
				break
			}
			if val != nil {
				xtv := string(val)
				sv.MD5OfMessageBody = &xtv
			}
		...
		case strings.EqualFold("MD5OfMessageSystemAttributes", t.Name.Local):
			...
			if done {
				if val == nil {
					sv.MD5OfMessageSystemAttributes = ptr.String("")
				}
				break
			}
			if val != nil {
				xtv := string(val)
				sv.MD5OfMessageSystemAttributes = &xtv
			}
	...
	for {
		...
		for {
			if strings.EqualFold("member", t.Name.Local) {
				...
				nodeDecoder := smithyxml.WrapNodeDecoder(decoder.Decoder, t)
				if err := awsAwsquery_deserializeDocumentSendMessageBatchResultEntry(&col, nodeDecoder); err != nil {
					return err
				}
				sv = append(sv, col)
				break
...
func awsAwsquery_deserializeDocumentSendMessageBatchResultEntryListUnwrapped(v *[]*types.SendMessageBatchResultEntry, decoder smithyxml.NodeDecoder) error {
	...
	default:
		...
		_ = t
		nodeDecoder := smithyxml.WrapNodeDecoder(decoder.Decoder, t)
		if err := awsAwsquery_deserializeDocumentSendMessageBatchResultEntry(&mv, nodeDecoder); err != nil {
			return err
		}
		sv = append(sv, mv)
	}
...
func awsAwsquery_deserializeDocumentStringList(v *[]*string, decoder smithyxml.NodeDecoder) error {
	...
	for {
		...
		decoder = memberDecoder
		for {
			if strings.EqualFold("StringListValue", t.Name.Local) {
				var col *string
				val, done, err := decoder.Value()
				if err != nil {
					return err
