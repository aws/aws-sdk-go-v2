...
func (*DeletePerformanceAnalysisReportInput) operationName() string {
...
func (c *Client) addOperationDeletePerformanceAnalysisReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeletePerformanceAnalysisReportResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeletePerformanceAnalysisReportResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeletePerformanceAnalysisReportResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeletePerformanceAnalysisReportResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeletePerformanceAnalysisReportResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeletePerformanceAnalysisReportResolveEndpointMiddleware{
