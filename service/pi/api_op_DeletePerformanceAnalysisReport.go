...
func (c *Client) addOperationDeletePerformanceAnalysisReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeletePerformanceAnalysisReport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
