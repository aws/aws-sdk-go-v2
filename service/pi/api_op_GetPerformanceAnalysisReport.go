...
func (c *Client) addOperationGetPerformanceAnalysisReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPerformanceAnalysisReport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
