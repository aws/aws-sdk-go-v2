...
type DimensionGroup struct {
	...
	// - db - The name of
	// the database to which the client is connected. The following values are
	// permitted:
	// - Aurora PostgreSQL
	...
	// of the application that is connected to the database. The following values are
	// permitted:
	// - Aurora PostgreSQL
	// - Amazon RDS PostgreSQL
	// - Amazon DocumentDB
	...
	// - db.query - The
	// query that is currently running (only Amazon DocumentDB).
	// - db.query_tokenized -
	...
	// - db.sql - The text
	// of the SQL statement that is currently running (all engines except Amazon
	// DocumentDB).
	// - db.sql_tokenized - The SQL digest (all engines except Amazon
	// DocumentDB).
	// - db.user - The user logged in to the database (all engines except
	// Amazon DocumentDB).
	// - db.wait_event - The event for which the database backend
	// is waiting (all engines except Amazon DocumentDB).
	// - db.wait_event_type - The
	// type of event for which the database backend is waiting (all engines except
	// Amazon DocumentDB).
	// - db.wait_state - The event for which the database backend
	// is waiting (only Amazon DocumentDB).
	//
	// This member is required.
	Group *string
	...
	// - db.host.name - The host name of the connected
	// client (all engines).
	// - db.name - The name of the database to which the client
	...
	// Amazon DocumentDB).
	// - db.query.db_id - The query ID generated by the database
	// (only Amazon DocumentDB).
	// - db.query.statement - The text of the query that is
	// being run (only Amazon DocumentDB).
	// - db.query.tokenized_id
	// -
	// db.query.tokenized.id - The query digest ID generated by Performance Insights
	// (only Amazon DocumentDB).
	// - db.query.tokenized.db_id - The query digest ID
	...
	// Amazon DocumentDB).
	// - db.sql.id - The hash of the full, non-tokenized SQL
	// statement generated by Performance Insights (all engines except Amazon
	// DocumentDB).
	// - db.sql.db_id - Either the SQL ID generated by the database
	// engine, or a value generated by Performance Insights that begins with pi- (all
	// engines except Amazon DocumentDB).
	// - db.sql.statement - The full text of the SQL
	// statement that is running, as in SELECT * FROM employees (all engines except
	// Amazon DocumentDB)
	// - db.sql.tokenized_id
	// - db.sql_tokenized.id - The hash of the
	// SQL digest generated by Performance Insights (all engines except Amazon
	// DocumentDB). In the console, db.sql_tokenized.id is called the Support ID
	...
	// event for which the backend is waiting (all engines except Amazon DocumentDB).
	// -
	// db.wait_event.type - The type of event for which the backend is waiting (all
	// engines except Amazon DocumentDB).
	// - db.wait_event_type.name - The name of the
	// event type for which the backend is waiting (all engines except Amazon
	// DocumentDB).
...
type MetricQuery struct {
	...
	// - A single
	// filter for any other dimension in this dimension group.
