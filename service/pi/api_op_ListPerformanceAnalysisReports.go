...
func (c *Client) addOperationListPerformanceAnalysisReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPerformanceAnalysisReports", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
