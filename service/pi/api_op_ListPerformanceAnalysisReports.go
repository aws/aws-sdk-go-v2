...
func (c *Client) ListPerformanceAnalysisReports(ctx context.Context, params *ListPerformanceAnalysisReportsInput, optFns ...func(*Options)) (*ListPerformanceAnalysisReportsOutput, error) {
	if params == nil { params = &ListPerformanceAnalysisReportsInput{} }
...
func (c *Client) addOperationListPerformanceAnalysisReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPerformanceAnalysisReportsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPerformanceAnalysisReportsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPerformanceAnalysisReportsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPerformanceAnalysisReportsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPerformanceAnalysisReportsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPerformanceAnalysisReportsResolveEndpointMiddleware{
