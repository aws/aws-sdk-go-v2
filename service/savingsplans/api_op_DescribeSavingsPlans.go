...
func (*DescribeSavingsPlansInput) operationName() string {
...
func (c *Client) addOperationDescribeSavingsPlansMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeSavingsPlansResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeSavingsPlansResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeSavingsPlansResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeSavingsPlansResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeSavingsPlansResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeSavingsPlansResolveEndpointMiddleware{
