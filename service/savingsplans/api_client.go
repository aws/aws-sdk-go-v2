...
// AWSSavingsPlans. See this package's package overview docs
...
const (
	ServiceName = "AWSSavingsPlans" // Service's name
	ServiceID   = "Savingsplans"    // Service's identifier
	EndpointsID = "savingsplans"    // Service's Endpoint identifier
)
