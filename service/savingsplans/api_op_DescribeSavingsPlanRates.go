...
func (c *Client) addOperationDescribeSavingsPlanRatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSavingsPlanRates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
