...
func (c *Client) addOperationDeleteQueuedSavingsPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteQueuedSavingsPlan", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
