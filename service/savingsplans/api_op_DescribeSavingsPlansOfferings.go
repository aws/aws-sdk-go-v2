...
func (c *Client) addOperationDescribeSavingsPlansOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSavingsPlansOfferings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
