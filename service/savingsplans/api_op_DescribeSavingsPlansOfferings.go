...
func addOperationDescribeSavingsPlansOfferingsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeSavingsPlansOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeSavingsPlansOfferingsStackSlots(stack); err != nil {
		return err
	}
