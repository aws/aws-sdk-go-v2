...
func (c *Client) DescribeSavingsPlansOfferingRates(ctx context.Context, params *DescribeSavingsPlansOfferingRatesInput, optFns ...func(*Options)) (*DescribeSavingsPlansOfferingRatesOutput, error) {
	if params == nil { params = &DescribeSavingsPlansOfferingRatesInput{} }
...
func (c *Client) addOperationDescribeSavingsPlansOfferingRatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeSavingsPlansOfferingRatesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeSavingsPlansOfferingRatesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeSavingsPlansOfferingRatesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeSavingsPlansOfferingRatesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeSavingsPlansOfferingRatesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeSavingsPlansOfferingRatesResolveEndpointMiddleware{
