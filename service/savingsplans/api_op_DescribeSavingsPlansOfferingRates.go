...
func addOperationDescribeSavingsPlansOfferingRatesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeSavingsPlansOfferingRatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeSavingsPlansOfferingRatesStackSlots(stack); err != nil {
		return err
	}
