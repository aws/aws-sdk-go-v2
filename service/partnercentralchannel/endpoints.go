...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/partnercentralchannel/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_PARTNERCENTRAL_CHANNEL")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "PartnerCentral Channel", cfg.ConfigSources)
	if found && err == nil {
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 3:
		uriString := func() string {
			...
			out.WriteString("https://partnercentral-channel.us-gov.")
	...
	case 4:
		uriString := func() string {
			var out strings.Builder
			out.WriteString("https://partnercentral-channel-fips.us-gov.")
			out.WriteString(c.PartitionResult.DualStackDnsSuffix)
			return out.String()
		}()
		uri, err := url.Parse(uriString)
	...
	case 5:
		uriString := func() string {
			var out strings.Builder
			out.WriteString("https://partnercentral-channel-fips.global.")
			out.WriteString(c.PartitionResult.DualStackDnsSuffix)
			return out.String()
		}()
		uri, err := url.Parse(uriString)
	...
	case 6:
		uriString := func() string {
			var out strings.Builder
			out.WriteString("https://partnercentral-channel.global.")
			out.WriteString(c.PartitionResult.DualStackDnsSuffix)
			return out.String()
		}()
		uri, err := url.Parse(uriString)
