...
func (c *Client) addOperationListProgramManagementAccountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListProgramManagementAccounts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
