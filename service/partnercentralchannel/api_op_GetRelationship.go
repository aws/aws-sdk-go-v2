...
func (c *Client) GetRelationship(ctx context.Context, params *GetRelationshipInput, optFns ...func(*Options)) (*GetRelationshipOutput, error) {
	if params == nil { params = &GetRelationshipInput{} }
	
	result, metadata, err := c.invokeOperation(ctx, "GetRelationship", params, optFns, c.addOperationGetRelationshipMiddlewares)
	if err != nil { return nil, err }
	
	out := result.(*GetRelationshipOutput)
...
func (c *Client) addOperationGetRelationshipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addOpGetRelationshipValidationMiddleware(stack); err != nil {
	return err
	}
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetRelationship(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opGetRelationship(region string) *awsmiddleware.RegisterServiceMetadata {
