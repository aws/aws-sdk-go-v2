...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-partnercentral-channel.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-partnercentral-channel.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-partnercentral-channel.dev",
			expectURL:     aws.String("https://env-partnercentral-channel.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-partnercentral-channel.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-partnercentral-channel.dev",
			expectURL:     aws.String("http://config-partnercentral-channel.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-partnercentral-channel.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-partnercentral-channel.dev",
			clientEndpoint: aws.String("https://client-partnercentral-channel.dev"),
			expectURL:      aws.String("https://client-partnercentral-channel.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PARTNERCENTRAL_CHANNEL", c.envService)
			}
