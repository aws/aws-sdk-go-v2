...
func (c *Client) addOperationDescribeEnvironmentResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEnvironmentResources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
