...
func (c *Client) ListAvailableSolutionStacks(ctx context.Context, params *ListAvailableSolutionStacksInput, optFns ...func(*Options)) (*ListAvailableSolutionStacksOutput, error) {
	if params == nil { params = &ListAvailableSolutionStacksInput{} }
...
func (c *Client) addOperationListAvailableSolutionStacksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAvailableSolutionStacksResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAvailableSolutionStacksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAvailableSolutionStacksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAvailableSolutionStacksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAvailableSolutionStacksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAvailableSolutionStacksResolveEndpointMiddleware{
