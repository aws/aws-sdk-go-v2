...
// in an AWS CodeCommit repository with SourceBuildInformation. Specify a build
// in an AWS CodeBuild with SourceBuildInformation  and BuildConfiguration.
// Specify a source bundle in S3 with SourceBundle  Omit both
// SourceBuildInformation and SourceBundle to use the default sample application.
...
type CreateApplicationVersionInput struct {
	...
	// deploying the application version to an environment. You must turn processing on
	// for application versions that you create using AWS CodeBuild or AWS CodeCommit.
	// For application versions built from a source bundle in Amazon S3, processing is
	...
	// SourceBundle nor SourceBuildInformation are provided, Elastic Beanstalk uses a
	// sample application.
