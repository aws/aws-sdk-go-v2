...
func addOperationDescribeApplicationVersionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeApplicationVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeApplicationVersionsStackSlots(stack); err != nil {
		return err
	}
