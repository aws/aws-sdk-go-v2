...
func (c *Client) addOperationDescribeApplicationVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeApplicationVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
