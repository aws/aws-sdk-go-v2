...
func (c *Client) AssociateEnvironmentOperationsRole(ctx context.Context, params *AssociateEnvironmentOperationsRoleInput, optFns ...func(*Options)) (*AssociateEnvironmentOperationsRoleOutput, error) {
	if params == nil { params = &AssociateEnvironmentOperationsRoleInput{} }
...
func (c *Client) addOperationAssociateEnvironmentOperationsRoleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateEnvironmentOperationsRoleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateEnvironmentOperationsRoleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateEnvironmentOperationsRoleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateEnvironmentOperationsRoleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateEnvironmentOperationsRoleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateEnvironmentOperationsRoleResolveEndpointMiddleware{
