...
func addOperationAssociateEnvironmentOperationsRoleStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociateEnvironmentOperationsRoleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociateEnvironmentOperationsRoleStackSlots(stack); err != nil {
		return err
	}
