...
func (c *Client) ComposeEnvironments(ctx context.Context, params *ComposeEnvironmentsInput, optFns ...func(*Options)) (*ComposeEnvironmentsOutput, error) {
	if params == nil { params = &ComposeEnvironmentsInput{} }
...
func (c *Client) addOperationComposeEnvironmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addComposeEnvironmentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opComposeEnvironmentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opComposeEnvironmentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opComposeEnvironmentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addComposeEnvironmentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opComposeEnvironmentsResolveEndpointMiddleware{
