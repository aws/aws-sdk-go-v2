...
func (c *Client) addOperationDescribeConfigurationOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConfigurationOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
