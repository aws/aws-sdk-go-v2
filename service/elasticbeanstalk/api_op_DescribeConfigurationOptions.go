...
func addOperationDescribeConfigurationOptionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeConfigurationOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeConfigurationOptionsStackSlots(stack); err != nil {
		return err
	}
