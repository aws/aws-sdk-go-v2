...
func addOperationDescribeEnvironmentManagedActionHistoryStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeEnvironmentManagedActionHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeEnvironmentManagedActionHistoryStackSlots(stack); err != nil {
		return err
	}
