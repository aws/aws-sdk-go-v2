...
func (c *Client) addOperationDescribeEnvironmentManagedActionHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEnvironmentManagedActionHistory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
