...
func (c *Client) addOperationDescribePlatformVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribePlatformVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
