...
func (c *Client) addOperationApplyEnvironmentManagedActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ApplyEnvironmentManagedAction", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
