...
func addOperationApplyEnvironmentManagedActionStackSlots(stack *middleware.Stack) error {
...
func addOperationApplyEnvironmentManagedActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationApplyEnvironmentManagedActionStackSlots(stack); err != nil {
		return err
	}
