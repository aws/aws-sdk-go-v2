...
// Elastic Beanstalk application. You define application configuration settings in
// a configuration template. You can then use the configuration template to deploy
...
type CreateConfigurationTemplateInput struct {
	...
	// Beanstalk configuration options, see [Option Values]in the Elastic Beanstalk Developer Guide.
	//
	...
	// see [Custom Platforms]in the Elastic Beanstalk Developer Guide.
	//
	...
	// information, see [Supported Platforms]in the Elastic Beanstalk Developer Guide.
	//
