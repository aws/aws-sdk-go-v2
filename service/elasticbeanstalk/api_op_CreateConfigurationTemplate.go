...
func addOperationCreateConfigurationTemplateStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateConfigurationTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateConfigurationTemplateStackSlots(stack); err != nil {
		return err
	}
