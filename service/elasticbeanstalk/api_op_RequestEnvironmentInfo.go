...
// logs from your environment and sends them to Amazon Bedrock in your account to
...
func (c *Client) addOperationRequestEnvironmentInfoMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RequestEnvironmentInfo", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
