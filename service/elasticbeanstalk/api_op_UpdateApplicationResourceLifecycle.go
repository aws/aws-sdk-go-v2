...
func addOperationUpdateApplicationResourceLifecycleStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateApplicationResourceLifecycleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateApplicationResourceLifecycleStackSlots(stack); err != nil {
		return err
	}
