...
func (c *Client) addOperationUpdateApplicationResourceLifecycleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateApplicationResourceLifecycle", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
