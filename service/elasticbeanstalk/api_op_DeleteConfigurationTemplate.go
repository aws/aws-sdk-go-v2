...
func (*DeleteConfigurationTemplateInput) operationName() string {
...
func (c *Client) addOperationDeleteConfigurationTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteConfigurationTemplateResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteConfigurationTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteConfigurationTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteConfigurationTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteConfigurationTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteConfigurationTemplateResolveEndpointMiddleware{
