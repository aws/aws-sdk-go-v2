...
func (c *Client) DeleteApplication(ctx context.Context, params *DeleteApplicationInput, optFns ...func(*Options)) (*DeleteApplicationOutput, error) {
	...
	addawsAwsquery_serdeOpDeleteApplicationMiddlewares(stack)
...
func addawsAwsquery_serdeOpDeleteApplicationMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpDeleteApplication{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpDeleteApplication{}, middleware.After)
}
