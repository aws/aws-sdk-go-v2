...
func (c *Client) SwapEnvironmentCNAMEs(ctx context.Context, params *SwapEnvironmentCNAMEsInput, optFns ...func(*Options)) (*SwapEnvironmentCNAMEsOutput, error) {
	if params == nil { params = &SwapEnvironmentCNAMEsInput{} }
...
func (c *Client) addOperationSwapEnvironmentCNAMEsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSwapEnvironmentCNAMEsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSwapEnvironmentCNAMEsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSwapEnvironmentCNAMEsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSwapEnvironmentCNAMEsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSwapEnvironmentCNAMEsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSwapEnvironmentCNAMEsResolveEndpointMiddleware{
