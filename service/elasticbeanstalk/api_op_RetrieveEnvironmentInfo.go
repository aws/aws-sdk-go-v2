...
func (c *Client) addOperationRetrieveEnvironmentInfoMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RetrieveEnvironmentInfo", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
