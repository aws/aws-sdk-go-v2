...
func (c *Client) addOperationDescribeEnvironmentHealthMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEnvironmentHealth", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
