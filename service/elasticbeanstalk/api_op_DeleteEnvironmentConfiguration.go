...
func addOperationDeleteEnvironmentConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteEnvironmentConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteEnvironmentConfigurationStackSlots(stack); err != nil {
		return err
	}
