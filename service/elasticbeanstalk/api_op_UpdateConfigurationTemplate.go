...
func addOperationUpdateConfigurationTemplateStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateConfigurationTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateConfigurationTemplateStackSlots(stack); err != nil {
		return err
	}
