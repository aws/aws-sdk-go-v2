...
func (c *Client) RestartAppServer(ctx context.Context, params *RestartAppServerInput, optFns ...func(*Options)) (*RestartAppServerOutput, error) {
	if params == nil { params = &RestartAppServerInput{} }
...
func (c *Client) addOperationRestartAppServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRestartAppServerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRestartAppServerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRestartAppServerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRestartAppServerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRestartAppServerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRestartAppServerResolveEndpointMiddleware{
