...
func addOperationDescribeConfigurationSettingsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeConfigurationSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeConfigurationSettingsStackSlots(stack); err != nil {
		return err
	}
