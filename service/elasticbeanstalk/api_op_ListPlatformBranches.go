...
func (c *Client) ListPlatformBranches(ctx context.Context, params *ListPlatformBranchesInput, optFns ...func(*Options)) (*ListPlatformBranchesOutput, error) {
	if params == nil { params = &ListPlatformBranchesInput{} }
...
func (c *Client) addOperationListPlatformBranchesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPlatformBranchesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPlatformBranchesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPlatformBranchesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPlatformBranchesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPlatformBranchesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPlatformBranchesResolveEndpointMiddleware{
