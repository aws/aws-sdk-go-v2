...
// Using the Client
//
// To use Amazon Lex Model Building Service with the SDK use the New function to create
...
//
// See the Amazon Lex Model Building Service client for more information on
