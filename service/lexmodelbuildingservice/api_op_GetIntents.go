...
func (c *Client) GetIntents(ctx context.Context, params *GetIntentsInput, optFns ...func(*Options)) (*GetIntentsOutput, error) {
	if params == nil { params = &GetIntentsInput{} }
...
func (c *Client) addOperationGetIntentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetIntentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetIntentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetIntentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetIntentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetIntentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetIntentsResolveEndpointMiddleware{
