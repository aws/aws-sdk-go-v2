...
func (c *Client) GetBotAlias(ctx context.Context, params *GetBotAliasInput, optFns ...func(*Options)) (*GetBotAliasOutput, error) {
	stack := middleware.NewStack("GetBotAlias", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpGetBotAliasMiddlewares(stack)
...
func addawsRestjson1_serdeOpGetBotAliasMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpGetBotAlias{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpGetBotAlias{}, middleware.After)
}
