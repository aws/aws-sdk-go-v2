...
// a channel association, the DeleteBot  operation returns a
// ResourceInUseExceptionexception that includes a reference to the channel
// association that refers to the bot. You can remove the reference to the alias by
// deleting the channel association. If you get the same exception again, delete
// the referring association until the DeleteBotAlias  operation is successful.
