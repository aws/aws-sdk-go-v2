...
func (c *Client) PutBot(ctx context.Context, params *PutBotInput, optFns ...func(*Options)) (*PutBotOutput, error) {
	if params == nil { params = &PutBotInput{} }
...
func (c *Client) addOperationPutBotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutBotResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutBotResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutBotResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutBotResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutBotResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutBotResolveEndpointMiddleware{
