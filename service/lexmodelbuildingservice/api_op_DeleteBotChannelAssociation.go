...
func addOperationDeleteBotChannelAssociationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteBotChannelAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteBotChannelAssociationStackSlots(stack); err != nil {
		return err
	}
