...
func (*GetBuiltinSlotTypesInput) operationName() string {
	return "GetBuiltinSlotTypes"
}
...
func (c *Client) addOperationGetBuiltinSlotTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBuiltinSlotTypesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetBuiltinSlotTypesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetBuiltinSlotTypesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetBuiltinSlotTypesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBuiltinSlotTypesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetBuiltinSlotTypesResolveEndpointMiddleware{
