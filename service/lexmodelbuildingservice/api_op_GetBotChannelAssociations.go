...
func (c *Client) addOperationGetBotChannelAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetBotChannelAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
