...
const (
	ServiceName = "Amazon Lex Model Building Service" // Service's name
	ServiceID   = "LexModelBuildingService"           // Service's identifier
	EndpointsID = "models.lex"                        // Service's Endpoint identifier
)
