...
// execution with a running callback step, Amazon SageMaker Pipelines sends an
...
// Amazon SageMaker Pipelines receives one of these calls will it stop the pipeline
