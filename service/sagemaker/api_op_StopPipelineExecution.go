...
// Stops a pipeline execution. Callback Step A pipeline execution won't stop
// while a callback step is running. When you call StopPipelineExecution on a
...
// message contains a "Status" field which is set to "Stopping". You should add
// logic to your Amazon SQS message consumer to take any needed action (for
// example, resource cleanup) upon receipt of the message followed by a call to
// SendPipelineExecutionStepSuccess or SendPipelineExecutionStepFailure. Only
// when SageMaker Pipelines receives one of these calls will it stop the pipeline
