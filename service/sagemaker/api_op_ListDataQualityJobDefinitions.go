...
func (c *Client) addOperationListDataQualityJobDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDataQualityJobDefinitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
