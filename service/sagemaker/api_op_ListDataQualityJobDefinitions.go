...
func (c *Client) ListDataQualityJobDefinitions(ctx context.Context, params *ListDataQualityJobDefinitionsInput, optFns ...func(*Options)) (*ListDataQualityJobDefinitionsOutput, error) {
	if params == nil { params = &ListDataQualityJobDefinitionsInput{} }
...
func (c *Client) addOperationListDataQualityJobDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDataQualityJobDefinitionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDataQualityJobDefinitionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDataQualityJobDefinitionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDataQualityJobDefinitionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDataQualityJobDefinitionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDataQualityJobDefinitionsResolveEndpointMiddleware{
