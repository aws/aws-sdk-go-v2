...
func (c *Client) addOperationListHyperParameterTuningJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListHyperParameterTuningJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
