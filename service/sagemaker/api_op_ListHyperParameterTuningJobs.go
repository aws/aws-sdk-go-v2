...
func addOperationListHyperParameterTuningJobsStackSlots(stack *middleware.Stack) error {
...
func addOperationListHyperParameterTuningJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListHyperParameterTuningJobsStackSlots(stack); err != nil {
		return err
	}
