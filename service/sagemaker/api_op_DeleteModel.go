...
func (c *Client) DeleteModel(ctx context.Context, params *DeleteModelInput, optFns ...func(*Options)) (*DeleteModelOutput, error) {
	...
	addawsAwsjson11_serdeOpDeleteModelMiddlewares(stack)
...
func addawsAwsjson11_serdeOpDeleteModelMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpDeleteModel{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpDeleteModel{}, middleware.After)
}
