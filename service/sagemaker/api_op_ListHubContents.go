...
func (c *Client) ListHubContents(ctx context.Context, params *ListHubContentsInput, optFns ...func(*Options)) (*ListHubContentsOutput, error) {
	if params == nil { params = &ListHubContentsInput{} }
...
func (c *Client) addOperationListHubContentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListHubContentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListHubContentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListHubContentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListHubContentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListHubContentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListHubContentsResolveEndpointMiddleware{
