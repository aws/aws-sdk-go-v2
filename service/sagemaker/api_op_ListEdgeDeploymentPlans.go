...
func (c *Client) addOperationListEdgeDeploymentPlansMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEdgeDeploymentPlans", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
