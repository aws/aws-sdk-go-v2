...
func (c *Client) addOperationUpdateMonitoringScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateMonitoringSchedule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
