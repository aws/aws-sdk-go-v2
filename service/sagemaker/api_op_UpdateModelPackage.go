...
func (c *Client) UpdateModelPackage(ctx context.Context, params *UpdateModelPackageInput, optFns ...func(*Options)) (*UpdateModelPackageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateModelPackage", params, optFns, addOperationUpdateModelPackageMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateModelPackageMiddlewares(stack *middleware.Stack, options Options) (err error) {
