...
func (c *Client) addOperationDisassociateTrialComponentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateTrialComponent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
