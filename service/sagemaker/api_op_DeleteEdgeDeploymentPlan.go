...
func (c *Client) addOperationDeleteEdgeDeploymentPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteEdgeDeploymentPlan", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
