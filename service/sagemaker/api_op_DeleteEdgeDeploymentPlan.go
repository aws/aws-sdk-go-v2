...
func (c *Client) DeleteEdgeDeploymentPlan(ctx context.Context, params *DeleteEdgeDeploymentPlanInput, optFns ...func(*Options)) (*DeleteEdgeDeploymentPlanOutput, error) {
	if params == nil { params = &DeleteEdgeDeploymentPlanInput{} }
...
func (c *Client) addOperationDeleteEdgeDeploymentPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteEdgeDeploymentPlanResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteEdgeDeploymentPlanResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteEdgeDeploymentPlanResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteEdgeDeploymentPlanResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteEdgeDeploymentPlanResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteEdgeDeploymentPlanResolveEndpointMiddleware{
