...
func (*DeleteCodeRepositoryInput) operationName() string {
...
func (c *Client) addOperationDeleteCodeRepositoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCodeRepositoryResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteCodeRepositoryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteCodeRepositoryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCodeRepositoryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCodeRepositoryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteCodeRepositoryResolveEndpointMiddleware{
