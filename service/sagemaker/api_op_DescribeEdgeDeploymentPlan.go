...
func (c *Client) addOperationDescribeEdgeDeploymentPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEdgeDeploymentPlan", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
