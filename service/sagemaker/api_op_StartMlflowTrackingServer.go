...
func (c *Client) addOperationStartMlflowTrackingServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartMlflowTrackingServer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
