...
func (c *Client) addOperationSendPipelineExecutionStepFailureMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SendPipelineExecutionStepFailure", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
