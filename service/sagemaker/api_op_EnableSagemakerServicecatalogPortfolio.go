...
func (c *Client) EnableSagemakerServicecatalogPortfolio(ctx context.Context, params *EnableSagemakerServicecatalogPortfolioInput, optFns ...func(*Options)) (*EnableSagemakerServicecatalogPortfolioOutput, error) {
	if params == nil { params = &EnableSagemakerServicecatalogPortfolioInput{} }
...
func (c *Client) addOperationEnableSagemakerServicecatalogPortfolioMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableSagemakerServicecatalogPortfolioResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEnableSagemakerServicecatalogPortfolioResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEnableSagemakerServicecatalogPortfolioResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableSagemakerServicecatalogPortfolioResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableSagemakerServicecatalogPortfolioResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEnableSagemakerServicecatalogPortfolioResolveEndpointMiddleware{
