...
func (c *Client) addOperationEnableSagemakerServicecatalogPortfolioMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableSagemakerServicecatalogPortfolio", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
