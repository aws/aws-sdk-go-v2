...
func (c *Client) addOperationUpdateClusterSchedulerConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateClusterSchedulerConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
