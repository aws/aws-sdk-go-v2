...
func (*DeleteAlgorithmInput) operationName() string {
...
func (c *Client) addOperationDeleteAlgorithmMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAlgorithmResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteAlgorithmResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteAlgorithmResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteAlgorithmResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAlgorithmResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteAlgorithmResolveEndpointMiddleware{
