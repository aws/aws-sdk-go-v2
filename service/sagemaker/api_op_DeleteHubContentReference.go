...
func (c *Client) addOperationDeleteHubContentReferenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteHubContentReference", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
