...
func (c *Client) addOperationDescribeNotebookInstanceLifecycleConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeNotebookInstanceLifecycleConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
