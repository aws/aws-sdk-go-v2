...
func (c *Client) addOperationDescribeNotebookInstanceLifecycleConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeNotebookInstanceLifecycleConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeNotebookInstanceLifecycleConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeNotebookInstanceLifecycleConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeNotebookInstanceLifecycleConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeNotebookInstanceLifecycleConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeNotebookInstanceLifecycleConfigResolveEndpointMiddleware{
