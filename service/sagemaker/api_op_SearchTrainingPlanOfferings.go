...
func (c *Client) addOperationSearchTrainingPlanOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SearchTrainingPlanOfferings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
