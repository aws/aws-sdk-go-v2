...
func (c *Client) DeleteModelCard(ctx context.Context, params *DeleteModelCardInput, optFns ...func(*Options)) (*DeleteModelCardOutput, error) {
	if params == nil { params = &DeleteModelCardInput{} }
...
func (c *Client) addOperationDeleteModelCardMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteModelCardResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteModelCardResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteModelCardResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteModelCardResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteModelCardResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteModelCardResolveEndpointMiddleware{
