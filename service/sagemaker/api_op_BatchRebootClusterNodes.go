...
func (c *Client) addOperationBatchRebootClusterNodesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchRebootClusterNodes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
