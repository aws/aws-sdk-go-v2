...
func (c *Client) SendPipelineExecutionStepSuccess(ctx context.Context, params *SendPipelineExecutionStepSuccessInput, optFns ...func(*Options)) (*SendPipelineExecutionStepSuccessOutput, error) {
	if params == nil { params = &SendPipelineExecutionStepSuccessInput{} }
...
func (c *Client) addOperationSendPipelineExecutionStepSuccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendPipelineExecutionStepSuccessResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
func (m *idempotencyToken_initializeOpSendPipelineExecutionStepSuccess) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *SendPipelineExecutionStepSuccessInput ")}
...
type opSendPipelineExecutionStepSuccessResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSendPipelineExecutionStepSuccessResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendPipelineExecutionStepSuccessResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendPipelineExecutionStepSuccessResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSendPipelineExecutionStepSuccessResolveEndpointMiddleware{
