...
func (c *Client) addOperationUpdateHubContentReferenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateHubContentReference", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
