...
func (c *Client) ListStageDevices(ctx context.Context, params *ListStageDevicesInput, optFns ...func(*Options)) (*ListStageDevicesOutput, error) {
	if params == nil { params = &ListStageDevicesInput{} }
...
func (c *Client) addOperationListStageDevicesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListStageDevicesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListStageDevicesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListStageDevicesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListStageDevicesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListStageDevicesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListStageDevicesResolveEndpointMiddleware{
