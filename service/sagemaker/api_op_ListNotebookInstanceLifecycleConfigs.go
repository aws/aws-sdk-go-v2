...
func (c *Client) addOperationListNotebookInstanceLifecycleConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListNotebookInstanceLifecycleConfigs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
