...
func (c *Client) ListNotebookInstanceLifecycleConfigs(ctx context.Context, params *ListNotebookInstanceLifecycleConfigsInput, optFns ...func(*Options)) (*ListNotebookInstanceLifecycleConfigsOutput, error) {
	if params == nil { params = &ListNotebookInstanceLifecycleConfigsInput{} }
...
func (c *Client) addOperationListNotebookInstanceLifecycleConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListNotebookInstanceLifecycleConfigsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListNotebookInstanceLifecycleConfigsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListNotebookInstanceLifecycleConfigsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListNotebookInstanceLifecycleConfigsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListNotebookInstanceLifecycleConfigsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListNotebookInstanceLifecycleConfigsResolveEndpointMiddleware{
