...
func addOperationListNotebookInstanceLifecycleConfigsStackSlots(stack *middleware.Stack) error {
...
func addOperationListNotebookInstanceLifecycleConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListNotebookInstanceLifecycleConfigsStackSlots(stack); err != nil {
		return err
	}
