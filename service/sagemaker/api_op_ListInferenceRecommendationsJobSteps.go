...
func (c *Client) ListInferenceRecommendationsJobSteps(ctx context.Context, params *ListInferenceRecommendationsJobStepsInput, optFns ...func(*Options)) (*ListInferenceRecommendationsJobStepsOutput, error) {
	if params == nil { params = &ListInferenceRecommendationsJobStepsInput{} }
...
func (c *Client) addOperationListInferenceRecommendationsJobStepsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListInferenceRecommendationsJobStepsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListInferenceRecommendationsJobStepsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListInferenceRecommendationsJobStepsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListInferenceRecommendationsJobStepsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListInferenceRecommendationsJobStepsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListInferenceRecommendationsJobStepsResolveEndpointMiddleware{
