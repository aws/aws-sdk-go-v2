...
func (c *Client) addOperationDescribeModelPackageGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeModelPackageGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
