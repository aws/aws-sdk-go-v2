...
func (c *Client) addOperationDescribePipelineExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribePipelineExecution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
