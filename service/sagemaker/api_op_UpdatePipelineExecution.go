...
func (c *Client) addOperationUpdatePipelineExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdatePipelineExecution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
