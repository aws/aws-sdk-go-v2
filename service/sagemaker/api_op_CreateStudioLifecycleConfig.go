...
func (c *Client) addOperationCreateStudioLifecycleConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateStudioLifecycleConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
