...
func (c *Client) UpdateFeatureMetadata(ctx context.Context, params *UpdateFeatureMetadataInput, optFns ...func(*Options)) (*UpdateFeatureMetadataOutput, error) {
	if params == nil { params = &UpdateFeatureMetadataInput{} }
...
func (c *Client) addOperationUpdateFeatureMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateFeatureMetadataResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateFeatureMetadataResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateFeatureMetadataResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateFeatureMetadataResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateFeatureMetadataResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateFeatureMetadataResolveEndpointMiddleware{
