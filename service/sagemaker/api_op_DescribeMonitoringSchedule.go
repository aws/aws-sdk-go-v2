...
func (c *Client) addOperationDescribeMonitoringScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMonitoringSchedule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
