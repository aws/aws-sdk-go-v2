...
func addOperationDescribeMonitoringScheduleStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeMonitoringScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeMonitoringScheduleStackSlots(stack); err != nil {
		return err
	}
