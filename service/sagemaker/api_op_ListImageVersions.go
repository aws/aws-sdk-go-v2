...
func addOperationListImageVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpListImageVersionsValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opListImageVersions(options.Region), middleware.Before)
