...
func (c *Client) ListMonitoringAlertHistory(ctx context.Context, params *ListMonitoringAlertHistoryInput, optFns ...func(*Options)) (*ListMonitoringAlertHistoryOutput, error) {
	if params == nil { params = &ListMonitoringAlertHistoryInput{} }
...
func (c *Client) addOperationListMonitoringAlertHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMonitoringAlertHistoryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListMonitoringAlertHistoryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListMonitoringAlertHistoryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMonitoringAlertHistoryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListMonitoringAlertHistoryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListMonitoringAlertHistoryResolveEndpointMiddleware{
