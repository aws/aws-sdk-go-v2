...
func (c *Client) StopEdgeDeploymentStage(ctx context.Context, params *StopEdgeDeploymentStageInput, optFns ...func(*Options)) (*StopEdgeDeploymentStageOutput, error) {
	if params == nil { params = &StopEdgeDeploymentStageInput{} }
...
func (c *Client) addOperationStopEdgeDeploymentStageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopEdgeDeploymentStageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopEdgeDeploymentStageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopEdgeDeploymentStageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopEdgeDeploymentStageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopEdgeDeploymentStageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopEdgeDeploymentStageResolveEndpointMiddleware{
