...
func (c *Client) addOperationStopEdgeDeploymentStageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopEdgeDeploymentStage", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
