...
func (c *Client) addOperationStartEdgeDeploymentStageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartEdgeDeploymentStage", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
