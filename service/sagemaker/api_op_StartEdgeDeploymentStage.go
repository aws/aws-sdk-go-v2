...
func (*StartEdgeDeploymentStageInput) operationName() string {
...
func (c *Client) addOperationStartEdgeDeploymentStageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartEdgeDeploymentStageResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStartEdgeDeploymentStageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStartEdgeDeploymentStageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartEdgeDeploymentStageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartEdgeDeploymentStageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStartEdgeDeploymentStageResolveEndpointMiddleware{
