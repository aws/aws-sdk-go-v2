...
func (c *Client) addOperationUpdateInferenceComponentRuntimeConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateInferenceComponentRuntimeConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
