...
func (*StopMonitoringScheduleInput) operationName() string {
...
func (c *Client) addOperationStopMonitoringScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopMonitoringScheduleResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopMonitoringScheduleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopMonitoringScheduleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopMonitoringScheduleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopMonitoringScheduleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopMonitoringScheduleResolveEndpointMiddleware{
