...
type CreateLabelingJobInput struct {
	...
	// labeling job that stops after all data objects in the input manifest file have
	// been labeled.
	// - Use S3DataSource to specify an input manifest file for both
	// streaming and one-time labeling jobs. Adding an S3DataSource is optional if you
	// use SnsDataSource to create a streaming labeling job.
	//
	// If you use the Amazon
	// Mechanical Turk workforce, your input data should not include confidential
	// information, personal information or protected health information. Use
	...
	// - Video frame
	// object tracking (VideoObjectTracking), and adjustment and verification
	...
	// - Each
	// label category must be unique, you cannot specify duplicate label categories.
	// -
	...
	// configuration. Use this parameter to enter the LabelAttributeName
