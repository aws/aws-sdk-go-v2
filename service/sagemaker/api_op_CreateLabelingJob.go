...
// stops if all data objects in the input manifest file identified in
// ManifestS3Urihave been labeled. A streaming labeling job runs perpetually
// until it is manually stopped, or remains idle for 10 days. You can send new data
// objects to an active ( InProgress) streaming labeling job in real time. To
// learn how to create a static labeling job, see Create a Labeling Job (API)  (https://docs.aws.amazon.com/sagemaker/latest/dg/sms-create-labeling-job-api.html)
