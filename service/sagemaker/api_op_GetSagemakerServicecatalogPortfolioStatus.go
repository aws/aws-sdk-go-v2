...
func (c *Client) GetSagemakerServicecatalogPortfolioStatus(ctx context.Context, params *GetSagemakerServicecatalogPortfolioStatusInput, optFns ...func(*Options)) (*GetSagemakerServicecatalogPortfolioStatusOutput, error) {
	if params == nil { params = &GetSagemakerServicecatalogPortfolioStatusInput{} }
...
func (c *Client) addOperationGetSagemakerServicecatalogPortfolioStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSagemakerServicecatalogPortfolioStatusResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSagemakerServicecatalogPortfolioStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSagemakerServicecatalogPortfolioStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSagemakerServicecatalogPortfolioStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSagemakerServicecatalogPortfolioStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSagemakerServicecatalogPortfolioStatusResolveEndpointMiddleware{
