...
func (c *Client) addOperationGetSagemakerServicecatalogPortfolioStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSagemakerServicecatalogPortfolioStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
