...
func (c *Client) StartInferenceExperiment(ctx context.Context, params *StartInferenceExperimentInput, optFns ...func(*Options)) (*StartInferenceExperimentOutput, error) {
	if params == nil { params = &StartInferenceExperimentInput{} }
...
func (c *Client) addOperationStartInferenceExperimentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartInferenceExperimentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartInferenceExperimentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartInferenceExperimentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartInferenceExperimentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartInferenceExperimentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartInferenceExperimentResolveEndpointMiddleware{
