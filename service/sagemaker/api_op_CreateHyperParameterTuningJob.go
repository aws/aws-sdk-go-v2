...
func addOperationCreateHyperParameterTuningJobStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateHyperParameterTuningJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateHyperParameterTuningJobStackSlots(stack); err != nil {
		return err
	}
