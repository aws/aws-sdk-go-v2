...
func (c *Client) addOperationListMonitoringSchedulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMonitoringSchedules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
