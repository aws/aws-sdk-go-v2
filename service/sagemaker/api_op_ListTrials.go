...
func (c *Client) ListTrials(ctx context.Context, params *ListTrialsInput, optFns ...func(*Options)) (*ListTrialsOutput, error) {
	if params == nil { params = &ListTrialsInput{} }
...
func (c *Client) addOperationListTrialsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTrialsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTrialsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTrialsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTrialsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTrialsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTrialsResolveEndpointMiddleware{
