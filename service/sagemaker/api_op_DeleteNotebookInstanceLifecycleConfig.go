...
func (*DeleteNotebookInstanceLifecycleConfigInput) operationName() string {
...
func (c *Client) addOperationDeleteNotebookInstanceLifecycleConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteNotebookInstanceLifecycleConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteNotebookInstanceLifecycleConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteNotebookInstanceLifecycleConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteNotebookInstanceLifecycleConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteNotebookInstanceLifecycleConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteNotebookInstanceLifecycleConfigResolveEndpointMiddleware{
