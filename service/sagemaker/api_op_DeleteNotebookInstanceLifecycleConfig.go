...
func (c *Client) addOperationDeleteNotebookInstanceLifecycleConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteNotebookInstanceLifecycleConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
