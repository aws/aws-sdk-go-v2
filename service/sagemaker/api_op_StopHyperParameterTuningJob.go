...
func addOperationStopHyperParameterTuningJobStackSlots(stack *middleware.Stack) error {
...
func addOperationStopHyperParameterTuningJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStopHyperParameterTuningJobStackSlots(stack); err != nil {
		return err
	}
