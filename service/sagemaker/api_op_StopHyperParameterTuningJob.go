...
func (c *Client) addOperationStopHyperParameterTuningJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopHyperParameterTuningJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
