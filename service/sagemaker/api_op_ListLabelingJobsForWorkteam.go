...
func addOperationListLabelingJobsForWorkteamStackSlots(stack *middleware.Stack) error {
...
func addOperationListLabelingJobsForWorkteamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListLabelingJobsForWorkteamStackSlots(stack); err != nil {
		return err
	}
