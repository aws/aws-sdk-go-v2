...
func (c *Client) addOperationListLabelingJobsForWorkteamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListLabelingJobsForWorkteam", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
