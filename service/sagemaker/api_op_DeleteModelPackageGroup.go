...
func (*DeleteModelPackageGroupInput) operationName() string {
...
func (c *Client) addOperationDeleteModelPackageGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteModelPackageGroupResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteModelPackageGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteModelPackageGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteModelPackageGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteModelPackageGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteModelPackageGroupResolveEndpointMiddleware{
