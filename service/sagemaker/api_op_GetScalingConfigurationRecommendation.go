...
func (c *Client) addOperationGetScalingConfigurationRecommendationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetScalingConfigurationRecommendation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
