...
func (c *Client) addOperationCreatePresignedNotebookInstanceUrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreatePresignedNotebookInstanceUrl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
