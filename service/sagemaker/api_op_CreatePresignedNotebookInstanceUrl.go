...
func addOperationCreatePresignedNotebookInstanceUrlStackSlots(stack *middleware.Stack) error {
...
func addOperationCreatePresignedNotebookInstanceUrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreatePresignedNotebookInstanceUrlStackSlots(stack); err != nil {
		return err
	}
