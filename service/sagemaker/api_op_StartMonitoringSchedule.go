...
func (c *Client) addOperationStartMonitoringScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartMonitoringSchedule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
