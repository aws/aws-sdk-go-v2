...
func (c *Client) UpdateMonitoringAlert(ctx context.Context, params *UpdateMonitoringAlertInput, optFns ...func(*Options)) (*UpdateMonitoringAlertOutput, error) {
	if params == nil { params = &UpdateMonitoringAlertInput{} }
...
func (c *Client) addOperationUpdateMonitoringAlertMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateMonitoringAlertResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateMonitoringAlertResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateMonitoringAlertResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateMonitoringAlertResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateMonitoringAlertResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateMonitoringAlertResolveEndpointMiddleware{
