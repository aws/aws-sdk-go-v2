...
func (c *Client) addOperationListTrainingJobsForHyperParameterTuningJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTrainingJobsForHyperParameterTuningJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
