...
func addOperationListTrainingJobsForHyperParameterTuningJobStackSlots(stack *middleware.Stack) error {
...
func addOperationListTrainingJobsForHyperParameterTuningJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListTrainingJobsForHyperParameterTuningJobStackSlots(stack); err != nil {
		return err
	}
