...
func (c *Client) ListMonitoringAlerts(ctx context.Context, params *ListMonitoringAlertsInput, optFns ...func(*Options)) (*ListMonitoringAlertsOutput, error) {
	if params == nil { params = &ListMonitoringAlertsInput{} }
...
func (c *Client) addOperationListMonitoringAlertsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMonitoringAlertsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListMonitoringAlertsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListMonitoringAlertsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMonitoringAlertsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListMonitoringAlertsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListMonitoringAlertsResolveEndpointMiddleware{
