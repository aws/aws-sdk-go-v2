...
func addOperationCreateNotebookInstanceLifecycleConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateNotebookInstanceLifecycleConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateNotebookInstanceLifecycleConfigStackSlots(stack); err != nil {
		return err
	}
