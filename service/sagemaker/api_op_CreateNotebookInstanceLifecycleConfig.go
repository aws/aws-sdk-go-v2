...
func (c *Client) addOperationCreateNotebookInstanceLifecycleConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateNotebookInstanceLifecycleConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
