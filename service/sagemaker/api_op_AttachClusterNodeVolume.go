...
func (c *Client) addOperationAttachClusterNodeVolumeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AttachClusterNodeVolume", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
