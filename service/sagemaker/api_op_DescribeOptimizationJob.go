...
func (c *Client) addOperationDescribeOptimizationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeOptimizationJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
