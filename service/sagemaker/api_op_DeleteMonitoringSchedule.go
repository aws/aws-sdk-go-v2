...
func (*DeleteMonitoringScheduleInput) operationName() string {
...
func (c *Client) addOperationDeleteMonitoringScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteMonitoringScheduleResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteMonitoringScheduleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteMonitoringScheduleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteMonitoringScheduleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteMonitoringScheduleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteMonitoringScheduleResolveEndpointMiddleware{
