...
func (c *Client) addOperationDescribeHyperParameterTuningJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeHyperParameterTuningJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
