...
func (c *Client) addOperationListSubscribedWorkteamsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSubscribedWorkteams", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
