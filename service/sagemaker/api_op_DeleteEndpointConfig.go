...
// configuration. You must not delete an EndpointConfig in use by an endpoint
// that is live or while the UpdateEndpoint  or CreateEndpoint operations are
// being performed on the endpoint. If you delete the EndpointConfig of an
