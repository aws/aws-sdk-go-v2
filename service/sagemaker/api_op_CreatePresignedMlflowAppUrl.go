...
func (c *Client) addOperationCreatePresignedMlflowAppUrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreatePresignedMlflowAppUrl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
