...
func (c *Client) addOperationDescribeClusterSchedulerConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeClusterSchedulerConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
