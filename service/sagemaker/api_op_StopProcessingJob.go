...
func (c *Client) StopProcessingJob(ctx context.Context, params *StopProcessingJobInput, optFns ...func(*Options)) (*StopProcessingJobOutput, error) {
	stack := middleware.NewStack("StopProcessingJob", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpStopProcessingJobMiddlewares(stack)
...
func addawsAwsjson11_serdeOpStopProcessingJobMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpStopProcessingJob{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpStopProcessingJob{}, middleware.After)
}
