...
func (c *Client) addOperationBatchDescribeModelPackageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDescribeModelPackage", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
