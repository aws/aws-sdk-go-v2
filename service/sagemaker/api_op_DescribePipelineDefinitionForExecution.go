...
func (c *Client) DescribePipelineDefinitionForExecution(ctx context.Context, params *DescribePipelineDefinitionForExecutionInput, optFns ...func(*Options)) (*DescribePipelineDefinitionForExecutionOutput, error) {
	if params == nil { params = &DescribePipelineDefinitionForExecutionInput{} }
...
func (c *Client) addOperationDescribePipelineDefinitionForExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribePipelineDefinitionForExecutionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribePipelineDefinitionForExecutionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribePipelineDefinitionForExecutionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribePipelineDefinitionForExecutionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribePipelineDefinitionForExecutionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribePipelineDefinitionForExecutionResolveEndpointMiddleware{
