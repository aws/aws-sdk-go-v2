...
func (c *Client) addOperationCreateHubContentPresignedUrlsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateHubContentPresignedUrls", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
