...
func (c *Client) addOperationCreateEdgeDeploymentPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateEdgeDeploymentPlan", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
