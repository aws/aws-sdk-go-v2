...
func (c *Client) CreateEdgeDeploymentPlan(ctx context.Context, params *CreateEdgeDeploymentPlanInput, optFns ...func(*Options)) (*CreateEdgeDeploymentPlanOutput, error) {
	if params == nil { params = &CreateEdgeDeploymentPlanInput{} }
...
func (c *Client) addOperationCreateEdgeDeploymentPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateEdgeDeploymentPlanResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateEdgeDeploymentPlanResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateEdgeDeploymentPlanResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateEdgeDeploymentPlanResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateEdgeDeploymentPlanResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateEdgeDeploymentPlanResolveEndpointMiddleware{
