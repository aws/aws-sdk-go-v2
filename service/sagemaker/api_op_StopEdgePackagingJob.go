...
func (*StopEdgePackagingJobInput) operationName() string {
...
func (c *Client) addOperationStopEdgePackagingJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopEdgePackagingJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopEdgePackagingJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopEdgePackagingJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopEdgePackagingJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopEdgePackagingJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopEdgePackagingJobResolveEndpointMiddleware{
