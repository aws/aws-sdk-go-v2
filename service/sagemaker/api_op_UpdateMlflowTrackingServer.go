...
func (c *Client) addOperationUpdateMlflowTrackingServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateMlflowTrackingServer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
