...
func (c *Client) StopCompilationJob(ctx context.Context, params *StopCompilationJobInput, optFns ...func(*Options)) (*StopCompilationJobOutput, error) {
	if params == nil { params = &StopCompilationJobInput{} }
...
func (c *Client) addOperationStopCompilationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopCompilationJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopCompilationJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopCompilationJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopCompilationJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopCompilationJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopCompilationJobResolveEndpointMiddleware{
