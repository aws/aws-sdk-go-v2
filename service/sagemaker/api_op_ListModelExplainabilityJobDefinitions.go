...
func (c *Client) ListModelExplainabilityJobDefinitions(ctx context.Context, params *ListModelExplainabilityJobDefinitionsInput, optFns ...func(*Options)) (*ListModelExplainabilityJobDefinitionsOutput, error) {
	if params == nil { params = &ListModelExplainabilityJobDefinitionsInput{} }
...
func (c *Client) addOperationListModelExplainabilityJobDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListModelExplainabilityJobDefinitionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListModelExplainabilityJobDefinitionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListModelExplainabilityJobDefinitionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListModelExplainabilityJobDefinitionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListModelExplainabilityJobDefinitionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListModelExplainabilityJobDefinitionsResolveEndpointMiddleware{
