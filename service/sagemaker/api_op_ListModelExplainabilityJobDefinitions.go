...
func (c *Client) addOperationListModelExplainabilityJobDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListModelExplainabilityJobDefinitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
