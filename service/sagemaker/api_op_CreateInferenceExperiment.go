...
func (c *Client) addOperationCreateInferenceExperimentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateInferenceExperiment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
