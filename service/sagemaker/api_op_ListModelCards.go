...
func (c *Client) ListModelCards(ctx context.Context, params *ListModelCardsInput, optFns ...func(*Options)) (*ListModelCardsOutput, error) {
	if params == nil { params = &ListModelCardsInput{} }
...
func (c *Client) addOperationListModelCardsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListModelCardsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListModelCardsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListModelCardsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListModelCardsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListModelCardsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListModelCardsResolveEndpointMiddleware{
