...
func (c *Client) addOperationDescribeMlflowTrackingServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMlflowTrackingServer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
