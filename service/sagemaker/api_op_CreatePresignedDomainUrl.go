...
func (c *Client) addOperationCreatePresignedDomainUrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreatePresignedDomainUrl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
