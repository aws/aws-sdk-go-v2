...
func (*DeleteHubInput) operationName() string {
	return "DeleteHub"
}
...
func (c *Client) addOperationDeleteHubMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteHubResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteHubResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteHubResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteHubResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteHubResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteHubResolveEndpointMiddleware{
