...
func (c *Client) addOperationListStudioLifecycleConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListStudioLifecycleConfigs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
