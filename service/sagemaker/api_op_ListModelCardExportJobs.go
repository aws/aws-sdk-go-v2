...
func (c *Client) addOperationListModelCardExportJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListModelCardExportJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
