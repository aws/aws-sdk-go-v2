...
func (c *Client) addOperationBatchReplaceClusterNodesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchReplaceClusterNodes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
