...
func (c *Client) UpdateAppImageConfig(ctx context.Context, params *UpdateAppImageConfigInput, optFns ...func(*Options)) (*UpdateAppImageConfigOutput, error) {
	if params == nil { params = &UpdateAppImageConfigInput{} }
...
func (c *Client) addOperationUpdateAppImageConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateAppImageConfigResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateAppImageConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateAppImageConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateAppImageConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateAppImageConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateAppImageConfigResolveEndpointMiddleware{
