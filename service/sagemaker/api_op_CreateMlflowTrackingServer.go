...
func (c *Client) addOperationCreateMlflowTrackingServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMlflowTrackingServer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
