...
func (c *Client) addOperationListMlflowTrackingServersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMlflowTrackingServers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
