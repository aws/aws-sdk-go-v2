...
func (c *Client) ListFlowDefinitions(ctx context.Context, params *ListFlowDefinitionsInput, optFns ...func(*Options)) (*ListFlowDefinitionsOutput, error) {
	if params == nil { params = &ListFlowDefinitionsInput{} }
...
func (c *Client) addOperationListFlowDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFlowDefinitionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListFlowDefinitionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListFlowDefinitionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFlowDefinitionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFlowDefinitionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListFlowDefinitionsResolveEndpointMiddleware{
