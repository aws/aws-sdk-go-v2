...
func (c *Client) StopInferenceRecommendationsJob(ctx context.Context, params *StopInferenceRecommendationsJobInput, optFns ...func(*Options)) (*StopInferenceRecommendationsJobOutput, error) {
	if params == nil { params = &StopInferenceRecommendationsJobInput{} }
...
func (c *Client) addOperationStopInferenceRecommendationsJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopInferenceRecommendationsJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopInferenceRecommendationsJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopInferenceRecommendationsJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopInferenceRecommendationsJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopInferenceRecommendationsJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopInferenceRecommendationsJobResolveEndpointMiddleware{
