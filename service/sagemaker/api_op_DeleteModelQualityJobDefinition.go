...
func (c *Client) DeleteModelQualityJobDefinition(ctx context.Context, params *DeleteModelQualityJobDefinitionInput, optFns ...func(*Options)) (*DeleteModelQualityJobDefinitionOutput, error) {
	if params == nil { params = &DeleteModelQualityJobDefinitionInput{} }
...
func (c *Client) addOperationDeleteModelQualityJobDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteModelQualityJobDefinitionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteModelQualityJobDefinitionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteModelQualityJobDefinitionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteModelQualityJobDefinitionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteModelQualityJobDefinitionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteModelQualityJobDefinitionResolveEndpointMiddleware{
