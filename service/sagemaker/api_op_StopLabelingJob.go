...
func (c *Client) StopLabelingJob(ctx context.Context, params *StopLabelingJobInput, optFns ...func(*Options)) (*StopLabelingJobOutput, error) {
	if params == nil { params = &StopLabelingJobInput{} }
...
func (c *Client) addOperationStopLabelingJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopLabelingJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopLabelingJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopLabelingJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopLabelingJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopLabelingJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopLabelingJobResolveEndpointMiddleware{
