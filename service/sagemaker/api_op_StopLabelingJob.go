...
func (c *Client) StopLabelingJob(ctx context.Context, params *StopLabelingJobInput, optFns ...func(*Options)) (*StopLabelingJobOutput, error) {
	stack := middleware.NewStack("StopLabelingJob", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpStopLabelingJobMiddlewares(stack)
...
func addawsAwsjson11_serdeOpStopLabelingJobMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpStopLabelingJob{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpStopLabelingJob{}, middleware.After)
}
