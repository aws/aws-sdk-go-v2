...
func (*DeleteModelExplainabilityJobDefinitionInput) operationName() string {
...
func (c *Client) addOperationDeleteModelExplainabilityJobDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteModelExplainabilityJobDefinitionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteModelExplainabilityJobDefinitionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteModelExplainabilityJobDefinitionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteModelExplainabilityJobDefinitionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteModelExplainabilityJobDefinitionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteModelExplainabilityJobDefinitionResolveEndpointMiddleware{
