...
func (c *Client) addOperationCreateAIRecommendationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateAIRecommendationJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
