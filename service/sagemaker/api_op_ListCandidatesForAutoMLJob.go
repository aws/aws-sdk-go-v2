...
func (c *Client) addOperationListCandidatesForAutoMLJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCandidatesForAutoMLJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
