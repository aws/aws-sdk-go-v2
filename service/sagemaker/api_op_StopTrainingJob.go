...
func (*StopTrainingJobInput) operationName() string {
...
func (c *Client) addOperationStopTrainingJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopTrainingJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopTrainingJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopTrainingJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopTrainingJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopTrainingJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopTrainingJobResolveEndpointMiddleware{
