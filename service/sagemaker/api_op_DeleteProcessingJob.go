...
func (c *Client) DeleteProcessingJob(ctx context.Context, params *DeleteProcessingJobInput, optFns ...func(*Options)) (*DeleteProcessingJobOutput, error) {
	if params == nil { params = &DeleteProcessingJobInput{} }
...
func (c *Client) addOperationDeleteProcessingJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err != nil { return err }
	if err := addProtocolFinalizerMiddlewares(stack, options, "DeleteProcessingJob"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteProcessingJob(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opDeleteProcessingJob(region string) *awsmiddleware.RegisterServiceMetadata {
