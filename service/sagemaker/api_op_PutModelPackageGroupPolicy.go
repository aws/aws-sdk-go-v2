...
func (c *Client) addOperationPutModelPackageGroupPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutModelPackageGroupPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
