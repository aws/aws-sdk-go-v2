...
func (c *Client) addOperationDescribeNotebookInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeNotebookInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
