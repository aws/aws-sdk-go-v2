...
func (c *Client) addOperationStopInferenceExperimentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopInferenceExperiment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
