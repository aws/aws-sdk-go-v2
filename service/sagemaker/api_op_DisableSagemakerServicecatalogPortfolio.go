...
func (*DisableSagemakerServicecatalogPortfolioInput) operationName() string {
...
func (c *Client) addOperationDisableSagemakerServicecatalogPortfolioMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableSagemakerServicecatalogPortfolioResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDisableSagemakerServicecatalogPortfolioResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDisableSagemakerServicecatalogPortfolioResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableSagemakerServicecatalogPortfolioResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableSagemakerServicecatalogPortfolioResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDisableSagemakerServicecatalogPortfolioResolveEndpointMiddleware{
