...
func (c *Client) addOperationCreateModelPackageGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateModelPackageGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
