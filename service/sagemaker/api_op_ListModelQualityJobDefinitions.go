...
func (*ListModelQualityJobDefinitionsInput) operationName() string {
...
func (c *Client) addOperationListModelQualityJobDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListModelQualityJobDefinitionsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListModelQualityJobDefinitionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListModelQualityJobDefinitionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListModelQualityJobDefinitionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListModelQualityJobDefinitionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListModelQualityJobDefinitionsResolveEndpointMiddleware{
