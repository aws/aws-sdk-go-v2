...
func (c *Client) addOperationDescribeSubscribedWorkteamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSubscribedWorkteam", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
