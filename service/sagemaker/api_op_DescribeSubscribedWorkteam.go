...
func (*DescribeSubscribedWorkteamInput) operationName() string {
...
func (c *Client) addOperationDescribeSubscribedWorkteamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeSubscribedWorkteamResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeSubscribedWorkteamResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeSubscribedWorkteamResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeSubscribedWorkteamResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeSubscribedWorkteamResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeSubscribedWorkteamResolveEndpointMiddleware{
