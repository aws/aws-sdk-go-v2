...
func (c *Client) addOperationListClusterSchedulerConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListClusterSchedulerConfigs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
