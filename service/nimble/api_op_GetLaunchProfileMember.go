...
func (c *Client) GetLaunchProfileMember(ctx context.Context, params *GetLaunchProfileMemberInput, optFns ...func(*Options)) (*GetLaunchProfileMemberOutput, error) {
	if params == nil { params = &GetLaunchProfileMemberInput{} }
...
func (c *Client) addOperationGetLaunchProfileMemberMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetLaunchProfileMemberResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetLaunchProfileMemberResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetLaunchProfileMemberResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetLaunchProfileMemberResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetLaunchProfileMemberResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetLaunchProfileMemberResolveEndpointMiddleware{
