...
func (c *Client) ListStudioComponents(ctx context.Context, params *ListStudioComponentsInput, optFns ...func(*Options)) (*ListStudioComponentsOutput, error) {
	if params == nil { params = &ListStudioComponentsInput{} }
...
func (c *Client) addOperationListStudioComponentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListStudioComponentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListStudioComponentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListStudioComponentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListStudioComponentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListStudioComponentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListStudioComponentsResolveEndpointMiddleware{
