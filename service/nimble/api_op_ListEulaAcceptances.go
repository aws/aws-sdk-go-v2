...
func (c *Client) ListEulaAcceptances(ctx context.Context, params *ListEulaAcceptancesInput, optFns ...func(*Options)) (*ListEulaAcceptancesOutput, error) {
	if params == nil { params = &ListEulaAcceptancesInput{} }
...
func (c *Client) addOperationListEulaAcceptancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEulaAcceptancesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListEulaAcceptancesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListEulaAcceptancesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEulaAcceptancesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEulaAcceptancesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListEulaAcceptancesResolveEndpointMiddleware{
