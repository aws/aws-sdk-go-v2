...
func (c *Client) GetStudio(ctx context.Context, params *GetStudioInput, optFns ...func(*Options)) (*GetStudioOutput, error) {
	if params == nil { params = &GetStudioInput{} }
...
func (c *Client) addOperationGetStudioMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetStudioResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetStudioResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetStudioResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetStudioResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetStudioResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetStudioResolveEndpointMiddleware{
