...
func (*ListEulasInput) operationName() string {
	return "ListEulas"
}
...
func (c *Client) addOperationListEulasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEulasResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListEulasResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListEulasResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEulasResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEulasResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListEulasResolveEndpointMiddleware{
