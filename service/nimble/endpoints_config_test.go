...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-nimble.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-nimble.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-nimble.dev",
			expectURL:     aws.String("https://env-nimble.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-nimble.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-nimble.dev",
			expectURL:     aws.String("http://config-nimble.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-nimble.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-nimble.dev",
			clientEndpoint: aws.String("https://client-nimble.dev"),
			expectURL:      aws.String("https://client-nimble.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_NIMBLE", c.envService)
			}
