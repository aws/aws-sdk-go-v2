...
func (*GetStreamingSessionStreamInput) operationName() string {
	return "GetStreamingSessionStream"
}
...
func (c *Client) addOperationGetStreamingSessionStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetStreamingSessionStreamResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetStreamingSessionStreamResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetStreamingSessionStreamResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetStreamingSessionStreamResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetStreamingSessionStreamResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetStreamingSessionStreamResolveEndpointMiddleware{
