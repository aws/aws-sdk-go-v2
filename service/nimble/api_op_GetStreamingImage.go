...
func (c *Client) GetStreamingImage(ctx context.Context, params *GetStreamingImageInput, optFns ...func(*Options)) (*GetStreamingImageOutput, error) {
	if params == nil { params = &GetStreamingImageInput{} }
...
func (c *Client) addOperationGetStreamingImageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetStreamingImageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetStreamingImageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetStreamingImageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetStreamingImageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetStreamingImageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetStreamingImageResolveEndpointMiddleware{
