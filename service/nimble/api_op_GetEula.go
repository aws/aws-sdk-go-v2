...
func (c *Client) GetEula(ctx context.Context, params *GetEulaInput, optFns ...func(*Options)) (*GetEulaOutput, error) {
	if params == nil { params = &GetEulaInput{} }
...
func (c *Client) addOperationGetEulaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetEulaResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetEulaResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetEulaResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetEulaResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetEulaResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetEulaResolveEndpointMiddleware{
