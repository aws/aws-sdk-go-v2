...
func (*ListReceivedGrantsInput) operationName() string {
...
func (c *Client) addOperationListReceivedGrantsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListReceivedGrantsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListReceivedGrantsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListReceivedGrantsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListReceivedGrantsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListReceivedGrantsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListReceivedGrantsResolveEndpointMiddleware{
