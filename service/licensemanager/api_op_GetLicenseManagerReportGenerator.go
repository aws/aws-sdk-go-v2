...
func (c *Client) addOperationGetLicenseManagerReportGeneratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetLicenseManagerReportGenerator", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
