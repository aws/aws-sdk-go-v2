...
func (c *Client) GetLicenseManagerReportGenerator(ctx context.Context, params *GetLicenseManagerReportGeneratorInput, optFns ...func(*Options)) (*GetLicenseManagerReportGeneratorOutput, error) {
	if params == nil { params = &GetLicenseManagerReportGeneratorInput{} }
...
func (c *Client) addOperationGetLicenseManagerReportGeneratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetLicenseManagerReportGeneratorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetLicenseManagerReportGeneratorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetLicenseManagerReportGeneratorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetLicenseManagerReportGeneratorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetLicenseManagerReportGeneratorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetLicenseManagerReportGeneratorResolveEndpointMiddleware{
