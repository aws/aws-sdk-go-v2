...
func (c *Client) ListLicenses(ctx context.Context, params *ListLicensesInput, optFns ...func(*Options)) (*ListLicensesOutput, error) {
	if params == nil { params = &ListLicensesInput{} }
...
func (c *Client) addOperationListLicensesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLicensesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListLicensesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListLicensesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLicensesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLicensesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListLicensesResolveEndpointMiddleware{
