...
func (c *Client) ListLicenses(ctx context.Context, params *ListLicensesInput, optFns ...func(*Options)) (*ListLicensesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLicenses", params, optFns, addOperationListLicensesMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationListLicensesMiddlewares(stack *middleware.Stack, options Options) (err error) {
