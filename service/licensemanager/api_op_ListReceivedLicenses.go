...
func (*ListReceivedLicensesInput) operationName() string {
...
func (c *Client) addOperationListReceivedLicensesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListReceivedLicensesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListReceivedLicensesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListReceivedLicensesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListReceivedLicensesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListReceivedLicensesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListReceivedLicensesResolveEndpointMiddleware{
