...
func (c *Client) DeleteGrant(ctx context.Context, params *DeleteGrantInput, optFns ...func(*Options)) (*DeleteGrantOutput, error) {
	if params == nil { params = &DeleteGrantInput{} }
...
func (c *Client) addOperationDeleteGrantMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteGrantResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteGrantResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteGrantResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteGrantResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteGrantResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteGrantResolveEndpointMiddleware{
