...
func (c *Client) addOperationUpdateLicenseSpecificationsForResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateLicenseSpecificationsForResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
