...
func (*UpdateLicenseSpecificationsForResourceInput) operationName() string {
...
func (c *Client) addOperationUpdateLicenseSpecificationsForResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateLicenseSpecificationsForResourceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateLicenseSpecificationsForResourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateLicenseSpecificationsForResourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateLicenseSpecificationsForResourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateLicenseSpecificationsForResourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateLicenseSpecificationsForResourceResolveEndpointMiddleware{
