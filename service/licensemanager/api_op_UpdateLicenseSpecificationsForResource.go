...
func addOperationUpdateLicenseSpecificationsForResourceStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateLicenseSpecificationsForResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateLicenseSpecificationsForResourceStackSlots(stack); err != nil {
		return err
	}
