...
func (c *Client) addOperationCreateLicenseConversionTaskForResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateLicenseConversionTaskForResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
