...
func (c *Client) addOperationListLicenseManagerReportGeneratorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListLicenseManagerReportGenerators", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
