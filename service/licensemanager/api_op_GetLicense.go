...
func (*GetLicenseInput) operationName() string {
	return "GetLicense"
}
...
func (c *Client) addOperationGetLicenseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetLicenseResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetLicenseResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetLicenseResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetLicenseResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetLicenseResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetLicenseResolveEndpointMiddleware{
