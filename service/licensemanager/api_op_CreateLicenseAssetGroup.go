...
func (c *Client) addOperationCreateLicenseAssetGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateLicenseAssetGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
