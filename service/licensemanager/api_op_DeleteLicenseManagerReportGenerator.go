...
func (c *Client) DeleteLicenseManagerReportGenerator(ctx context.Context, params *DeleteLicenseManagerReportGeneratorInput, optFns ...func(*Options)) (*DeleteLicenseManagerReportGeneratorOutput, error) {
	if params == nil { params = &DeleteLicenseManagerReportGeneratorInput{} }
...
func (c *Client) addOperationDeleteLicenseManagerReportGeneratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteLicenseManagerReportGeneratorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteLicenseManagerReportGeneratorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteLicenseManagerReportGeneratorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteLicenseManagerReportGeneratorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteLicenseManagerReportGeneratorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteLicenseManagerReportGeneratorResolveEndpointMiddleware{
