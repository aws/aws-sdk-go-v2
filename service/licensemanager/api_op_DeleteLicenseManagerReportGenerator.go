...
func (c *Client) addOperationDeleteLicenseManagerReportGeneratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteLicenseManagerReportGenerator", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
