...
func (c *Client) addOperationExtendLicenseConsumptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ExtendLicenseConsumption", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
