...
func addOperationListAssociationsForLicenseConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationListAssociationsForLicenseConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListAssociationsForLicenseConfigurationStackSlots(stack); err != nil {
		return err
	}
