...
func (c *Client) addOperationListFailuresForLicenseConfigurationOperationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFailuresForLicenseConfigurationOperations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
