...
func addOperationListFailuresForLicenseConfigurationOperationsStackSlots(stack *middleware.Stack) error {
...
func addOperationListFailuresForLicenseConfigurationOperationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListFailuresForLicenseConfigurationOperationsStackSlots(stack); err != nil {
		return err
	}
