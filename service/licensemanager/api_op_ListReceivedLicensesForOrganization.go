...
func (c *Client) ListReceivedLicensesForOrganization(ctx context.Context, params *ListReceivedLicensesForOrganizationInput, optFns ...func(*Options)) (*ListReceivedLicensesForOrganizationOutput, error) {
	if params == nil { params = &ListReceivedLicensesForOrganizationInput{} }
...
func (c *Client) addOperationListReceivedLicensesForOrganizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListReceivedLicensesForOrganizationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListReceivedLicensesForOrganizationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListReceivedLicensesForOrganizationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListReceivedLicensesForOrganizationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListReceivedLicensesForOrganizationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListReceivedLicensesForOrganizationResolveEndpointMiddleware{
