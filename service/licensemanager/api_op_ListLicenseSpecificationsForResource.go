...
func (c *Client) ListLicenseSpecificationsForResource(ctx context.Context, params *ListLicenseSpecificationsForResourceInput, optFns ...func(*Options)) (*ListLicenseSpecificationsForResourceOutput, error) {
	if params == nil { params = &ListLicenseSpecificationsForResourceInput{} }
...
func (c *Client) addOperationListLicenseSpecificationsForResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLicenseSpecificationsForResourceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListLicenseSpecificationsForResourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListLicenseSpecificationsForResourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLicenseSpecificationsForResourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLicenseSpecificationsForResourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListLicenseSpecificationsForResourceResolveEndpointMiddleware{
