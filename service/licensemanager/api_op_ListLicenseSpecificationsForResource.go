...
func addOperationListLicenseSpecificationsForResourceStackSlots(stack *middleware.Stack) error {
...
func addOperationListLicenseSpecificationsForResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListLicenseSpecificationsForResourceStackSlots(stack); err != nil {
		return err
	}
