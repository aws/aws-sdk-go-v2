...
func (c *Client) addOperationListLicenseSpecificationsForResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListLicenseSpecificationsForResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
