...
func (c *Client) addOperationUpdateLicenseManagerReportGeneratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateLicenseManagerReportGenerator", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
