...
func (c *Client) UpdateLicenseManagerReportGenerator(ctx context.Context, params *UpdateLicenseManagerReportGeneratorInput, optFns ...func(*Options)) (*UpdateLicenseManagerReportGeneratorOutput, error) {
	if params == nil { params = &UpdateLicenseManagerReportGeneratorInput{} }
...
func (c *Client) addOperationUpdateLicenseManagerReportGeneratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateLicenseManagerReportGeneratorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateLicenseManagerReportGeneratorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateLicenseManagerReportGeneratorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateLicenseManagerReportGeneratorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateLicenseManagerReportGeneratorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateLicenseManagerReportGeneratorResolveEndpointMiddleware{
