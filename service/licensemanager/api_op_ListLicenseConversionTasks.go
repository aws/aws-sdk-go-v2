...
func (c *Client) ListLicenseConversionTasks(ctx context.Context, params *ListLicenseConversionTasksInput, optFns ...func(*Options)) (*ListLicenseConversionTasksOutput, error) {
	if params == nil { params = &ListLicenseConversionTasksInput{} }
...
func (c *Client) addOperationListLicenseConversionTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLicenseConversionTasksResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListLicenseConversionTasksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListLicenseConversionTasksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLicenseConversionTasksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLicenseConversionTasksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListLicenseConversionTasksResolveEndpointMiddleware{
