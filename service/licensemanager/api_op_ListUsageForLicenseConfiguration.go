...
func addOperationListUsageForLicenseConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationListUsageForLicenseConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListUsageForLicenseConfigurationStackSlots(stack); err != nil {
		return err
	}
