...
func (c *Client) GetGrant(ctx context.Context, params *GetGrantInput, optFns ...func(*Options)) (*GetGrantOutput, error) {
	if params == nil { params = &GetGrantInput{} }
...
func (c *Client) addOperationGetGrantMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetGrantResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetGrantResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetGrantResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetGrantResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetGrantResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetGrantResolveEndpointMiddleware{
