...
func (c *Client) addOperationListLicenseConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListLicenseConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
