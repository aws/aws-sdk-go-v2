...
func (*ListLicenseVersionsInput) operationName() string {
...
func (c *Client) addOperationListLicenseVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLicenseVersionsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListLicenseVersionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListLicenseVersionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLicenseVersionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLicenseVersionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListLicenseVersionsResolveEndpointMiddleware{
