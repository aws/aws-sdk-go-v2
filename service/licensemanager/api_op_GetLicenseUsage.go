...
func (c *Client) GetLicenseUsage(ctx context.Context, params *GetLicenseUsageInput, optFns ...func(*Options)) (*GetLicenseUsageOutput, error) {
	if params == nil { params = &GetLicenseUsageInput{} }
...
func (c *Client) addOperationGetLicenseUsageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetLicenseUsageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetLicenseUsageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetLicenseUsageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetLicenseUsageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetLicenseUsageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetLicenseUsageResolveEndpointMiddleware{
