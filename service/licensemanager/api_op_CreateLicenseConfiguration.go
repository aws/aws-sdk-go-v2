...
func (c *Client) addOperationCreateLicenseConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateLicenseConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
