...
func (*RejectGrantInput) operationName() string {
	return "RejectGrant"
}
...
func (c *Client) addOperationRejectGrantMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRejectGrantResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRejectGrantResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRejectGrantResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRejectGrantResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRejectGrantResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRejectGrantResolveEndpointMiddleware{
