...
// that are being hosted on instances in the fleet. To update settings, specify the
...
// fleet is returned. For fleets with remote locations, port setting updates can
// take time to propagate across all locations. You can check the status of updates
// in each location by calling DescribeFleetPortSettings with a location name.
