...
func (c *Client) addOperationDescribeVpcPeeringAuthorizationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeVpcPeeringAuthorizations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
