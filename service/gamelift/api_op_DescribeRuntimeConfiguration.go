...
func (c *Client) addOperationDescribeRuntimeConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRuntimeConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
