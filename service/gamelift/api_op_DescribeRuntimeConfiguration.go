...
func addOperationDescribeRuntimeConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeRuntimeConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeRuntimeConfigurationStackSlots(stack); err != nil {
		return err
	}
