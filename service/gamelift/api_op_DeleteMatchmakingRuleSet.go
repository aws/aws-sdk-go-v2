...
func (c *Client) addOperationDeleteMatchmakingRuleSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteMatchmakingRuleSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
