...
func (*DeleteMatchmakingRuleSetInput) operationName() string {
...
func (c *Client) addOperationDeleteMatchmakingRuleSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteMatchmakingRuleSetResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteMatchmakingRuleSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteMatchmakingRuleSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteMatchmakingRuleSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteMatchmakingRuleSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteMatchmakingRuleSetResolveEndpointMiddleware{
