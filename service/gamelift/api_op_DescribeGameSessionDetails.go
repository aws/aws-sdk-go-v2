...
func (c *Client) addOperationDescribeGameSessionDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeGameSessionDetails", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
