...
func addOperationDescribeGameSessionDetailsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeGameSessionDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeGameSessionDetailsStackSlots(stack); err != nil {
		return err
	}
