...
func (c *Client) addOperationGetPlayerConnectionDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPlayerConnectionDetails", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
