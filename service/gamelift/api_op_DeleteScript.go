...
func (*DeleteScriptInput) operationName() string {
	return "DeleteScript"
}
...
func (c *Client) addOperationDeleteScriptMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteScriptResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteScriptResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteScriptResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteScriptResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteScriptResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteScriptResolveEndpointMiddleware{
