...
func (c *Client) ListGameServers(ctx context.Context, params *ListGameServersInput, optFns ...func(*Options)) (*ListGameServersOutput, error) {
	stack := middleware.NewStack("ListGameServers", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpListGameServersMiddlewares(stack)
...
func addawsAwsjson11_serdeOpListGameServersMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpListGameServers{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpListGameServers{}, middleware.After)
}
