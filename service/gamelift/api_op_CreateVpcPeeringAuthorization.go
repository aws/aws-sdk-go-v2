...
func addOperationCreateVpcPeeringAuthorizationStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateVpcPeeringAuthorizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateVpcPeeringAuthorizationStackSlots(stack); err != nil {
		return err
	}
