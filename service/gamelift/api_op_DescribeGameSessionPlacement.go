...
func addOperationDescribeGameSessionPlacementStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeGameSessionPlacementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeGameSessionPlacementStackSlots(stack); err != nil {
		return err
	}
