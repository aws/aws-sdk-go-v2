...
func (c *Client) addOperationDescribeGameSessionPlacementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeGameSessionPlacement", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
