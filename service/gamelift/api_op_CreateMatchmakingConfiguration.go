...
func addOperationCreateMatchmakingConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateMatchmakingConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateMatchmakingConfigurationStackSlots(stack); err != nil {
		return err
	}
