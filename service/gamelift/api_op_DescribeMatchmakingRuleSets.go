...
func (c *Client) addOperationDescribeMatchmakingRuleSetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMatchmakingRuleSets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
