...
func (c *Client) addOperationDescribeFleetPortSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeFleetPortSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
