...
func (c *Client) addOperationDescribeFleetLocationCapacityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeFleetLocationCapacity", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
