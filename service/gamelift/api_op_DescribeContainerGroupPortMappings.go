...
func (c *Client) addOperationDescribeContainerGroupPortMappingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeContainerGroupPortMappings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
