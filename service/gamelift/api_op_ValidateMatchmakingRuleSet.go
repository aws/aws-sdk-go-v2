...
func (c *Client) addOperationValidateMatchmakingRuleSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ValidateMatchmakingRuleSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
