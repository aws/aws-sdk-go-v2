...
func (c *Client) ValidateMatchmakingRuleSet(ctx context.Context, params *ValidateMatchmakingRuleSetInput, optFns ...func(*Options)) (*ValidateMatchmakingRuleSetOutput, error) {
	if params == nil { params = &ValidateMatchmakingRuleSetInput{} }
...
func (c *Client) addOperationValidateMatchmakingRuleSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addValidateMatchmakingRuleSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opValidateMatchmakingRuleSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opValidateMatchmakingRuleSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opValidateMatchmakingRuleSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addValidateMatchmakingRuleSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opValidateMatchmakingRuleSetResolveEndpointMiddleware{
