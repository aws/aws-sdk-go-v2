...
func addOperationValidateMatchmakingRuleSetStackSlots(stack *middleware.Stack) error {
...
func addOperationValidateMatchmakingRuleSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationValidateMatchmakingRuleSetStackSlots(stack); err != nil {
		return err
	}
