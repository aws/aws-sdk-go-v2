...
func addOperationDeleteMatchmakingConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteMatchmakingConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteMatchmakingConfigurationStackSlots(stack); err != nil {
		return err
	}
