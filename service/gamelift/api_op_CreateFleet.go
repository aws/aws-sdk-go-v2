...
// initiate the fleet creation workflow (https://docs.aws.amazon.com/gamelift/latest/developerguide/fleets-creation-workflow.html)
...
type CreateFleetInput struct {
	...
	// Prompts GameLift to generate a TLS/SSL certificate for the fleet. GameLift
	// uses the certificates to encrypt traffic between game clients and the game
	// servers running on GameLift. By default, the CertificateConfiguration  is
	...
	// consider using fleet aliases for a smooth transition. ACM isn't available in all
	// Amazon Web Services regions. A fleet creation request with certificate
	// generation enabled in an unsupported Region, fails with a 4xx error. For more
	// information about the supported Regions, see Supported Regions (https://docs.aws.amazon.com/acm/latest/userguide/acm-regions.html)
	...
	// of an Amazon Web Services Region code such as us-west-2. To create a fleet
	...
	// RuntimeConfigurationparameter is required unless the fleet is being configured
	...
	// RuntimeConfigurationparameter. Requests that use this parameter instead
