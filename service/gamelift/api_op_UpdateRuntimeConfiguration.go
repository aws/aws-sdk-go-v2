...
func (c *Client) addOperationUpdateRuntimeConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRuntimeConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
