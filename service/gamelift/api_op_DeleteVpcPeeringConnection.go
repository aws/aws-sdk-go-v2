...
func addOperationDeleteVpcPeeringConnectionStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteVpcPeeringConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteVpcPeeringConnectionStackSlots(stack); err != nil {
		return err
	}
