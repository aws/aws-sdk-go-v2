...
func (c *Client) addOperationListContainerGroupDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListContainerGroupDefinitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
