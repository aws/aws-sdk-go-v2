...
func (c *Client) ListScripts(ctx context.Context, params *ListScriptsInput, optFns ...func(*Options)) (*ListScriptsOutput, error) {
	stack := middleware.NewStack("ListScripts", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpListScriptsMiddlewares(stack)
...
func addawsAwsjson11_serdeOpListScriptsMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpListScripts{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpListScripts{}, middleware.After)
}
