...
func addOperationDeleteVpcPeeringAuthorizationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteVpcPeeringAuthorizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteVpcPeeringAuthorizationStackSlots(stack); err != nil {
		return err
	}
