...
func (c *Client) addOperationCreateMatchmakingRuleSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMatchmakingRuleSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
