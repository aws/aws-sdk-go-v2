...
func addOperationUpdateMatchmakingConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateMatchmakingConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateMatchmakingConfigurationStackSlots(stack); err != nil {
		return err
	}
