...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-sagemakerjobruntime.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemakerjobruntime.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemakerjobruntime.dev",
			expectURL:     aws.String("https://env-sagemakerjobruntime.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-sagemakerjobruntime.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemakerjobruntime.dev",
			expectURL:     aws.String("http://config-sagemakerjobruntime.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-sagemakerjobruntime.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-sagemakerjobruntime.dev",
			clientEndpoint: aws.String("https://client-sagemakerjobruntime.dev"),
			expectURL:      aws.String("https://client-sagemakerjobruntime.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SAGEMAKERJOBRUNTIME", c.envService)
			}
