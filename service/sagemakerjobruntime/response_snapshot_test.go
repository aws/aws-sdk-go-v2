...
func TestCheckResponseSnapshot_CompleteRollout(t *testing.T) {
	want := &CompleteRolloutOutput{}
	status, header, body, err := serdeRespReadSnapshot("CompleteRollout.response")
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "CompleteRollout.response", err)
	}
}

func TestCheckResponseSnapshot_Sample(t *testing.T) {
	want := &SampleOutput{
		ContentType: ptr.String("__ContentType__"),
		Body:        []byte("blob"),
	}
	status, header, body, err := serdeRespReadSnapshot("Sample.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "Sample.response", err)
	}
}
...
func TestCheckResponseSnapshot_SampleWithResponseStream(t *testing.T) {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "SampleWithResponseStream.response", err)
	}
}

func TestCheckResponseSnapshot_UpdateReward(t *testing.T) {
	want := &UpdateRewardOutput{}
	status, header, body, err := serdeRespReadSnapshot("UpdateReward.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "UpdateReward.response", err)
	}
}
