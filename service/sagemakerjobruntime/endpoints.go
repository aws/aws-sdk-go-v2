...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/sagemakerjobruntime/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_SAGEMAKERJOBRUNTIME")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "SagemakerJobRuntime", cfg.ConfigSources)
	if found && err == nil {
...
var bddNodes = [18]int32{
	-1, 1, -1, 0, 6, 3, 1, 4, 100000005, 2, 5, 100000005, 3, 100000004, 100000003, 3, 100000001, 100000002}
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 3:
		uriString := func() string {
			...
			out.WriteString("https://job-runtime.sagemaker.")
	...
	case 4:
		uriString := func() string {
			var out strings.Builder
			out.WriteString("https://job-runtime.sagemaker-fips.")
			out.WriteString(*params.Region)
			out.WriteString(".")
			out.WriteString(c.PartitionResult.DualStackDnsSuffix)
			return out.String()
