...
// about SimSpace Weaver, see the Amazon Web Services SimSpace Weaver User Guide (https://docs.aws.amazon.com/simspaceweaver/latest/userguide/)
...
// documentation, which is part of the SimSpace Weaver app SDK distributable
// package.
