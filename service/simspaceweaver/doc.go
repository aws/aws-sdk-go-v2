...
// Package simspaceweaver provides the API client, operations, and parameter
// types for AWS SimSpace Weaver.
//
...
// For more information about SimSpace Weaver, see the Amazon Web Services
