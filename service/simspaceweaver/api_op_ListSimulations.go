...
func (c *Client) ListSimulations(ctx context.Context, params *ListSimulationsInput, optFns ...func(*Options)) (*ListSimulationsOutput, error) {
	if params == nil { params = &ListSimulationsInput{} }
...
func (c *Client) addOperationListSimulationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSimulationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSimulationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSimulationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSimulationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSimulationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSimulationsResolveEndpointMiddleware{
