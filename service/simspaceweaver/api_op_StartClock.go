...
func (*StartClockInput) operationName() string {
	return "StartClock"
}
...
func (c *Client) addOperationStartClockMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartClockResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStartClockResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStartClockResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartClockResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartClockResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStartClockResolveEndpointMiddleware{
