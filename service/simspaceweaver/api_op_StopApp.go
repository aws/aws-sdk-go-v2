...
func (*StopAppInput) operationName() string {
	return "StopApp"
}
...
func (c *Client) addOperationStopAppMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopAppResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopAppResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopAppResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopAppResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopAppResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopAppResolveEndpointMiddleware{
