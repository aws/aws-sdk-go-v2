...
func TestCheckResponseSnapshot_JoinStorageSession(t *testing.T) {
	want := &JoinStorageSessionOutput{}
	status, header, body, err := serdeRespReadSnapshot("JoinStorageSession.response")
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "JoinStorageSession.response", err)
	}
}

func TestCheckResponseSnapshot_JoinStorageSessionAsViewer(t *testing.T) {
	want := &JoinStorageSessionAsViewerOutput{}
	status, header, body, err := serdeRespReadSnapshot("JoinStorageSessionAsViewer.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "JoinStorageSessionAsViewer.response", err)
	}
}
