...
// Resource Name (ARN) of the signaling channel must be provided. Currently for the
//
// SINGLE_MASTERtype, a video producing device is able to ingest both audio and
