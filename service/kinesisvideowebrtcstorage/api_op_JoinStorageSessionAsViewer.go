...
func (c *Client) addOperationJoinStorageSessionAsViewerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "JoinStorageSessionAsViewer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
