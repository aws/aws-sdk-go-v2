...
func (c *Client) addOperationCreateServiceLevelObjectiveMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateServiceLevelObjective", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
