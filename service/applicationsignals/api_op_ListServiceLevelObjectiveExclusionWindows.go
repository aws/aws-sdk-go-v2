...
func (c *Client) addOperationListServiceLevelObjectiveExclusionWindowsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListServiceLevelObjectiveExclusionWindows", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
