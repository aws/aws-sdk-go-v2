...
func (c *Client) addOperationListServiceDependenciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListServiceDependencies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
