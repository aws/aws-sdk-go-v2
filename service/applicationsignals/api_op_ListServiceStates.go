...
func (v *ListServiceStatesOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListServiceStatesOutput)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ListServiceStatesOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.EndTime != nil {
		s.WriteTime(schemas.ListServiceStatesOutput_EndTime, *v.EndTime)
	}
	if v.NextToken != nil {
		s.WriteString(schemas.ListServiceStatesOutput_NextToken, *v.NextToken)
	}
	serializeServiceStates(s, schemas.ListServiceStatesOutput_ServiceStates, v.ServiceStates)
	if v.StartTime != nil {
		s.WriteTime(schemas.ListServiceStatesOutput_StartTime, *v.StartTime)
	}
}
