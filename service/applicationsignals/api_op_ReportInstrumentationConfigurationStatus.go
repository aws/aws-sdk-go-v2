...
func (c *Client) addOperationReportInstrumentationConfigurationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ReportInstrumentationConfigurationStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
