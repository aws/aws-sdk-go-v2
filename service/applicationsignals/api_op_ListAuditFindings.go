...
func (v *ListAuditFindingsOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListAuditFindingsOutput)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ListAuditFindingsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	serializeAuditFindings(s, schemas.ListAuditFindingsOutput_AuditFindings, v.AuditFindings)
	if v.EndTime != nil {
		s.WriteTime(schemas.ListAuditFindingsOutput_EndTime, *v.EndTime)
	}
	if v.NextToken != nil {
		s.WriteString(schemas.ListAuditFindingsOutput_NextToken, *v.NextToken)
	}
	if v.StartTime != nil {
		s.WriteTime(schemas.ListAuditFindingsOutput_StartTime, *v.StartTime)
	}
}
