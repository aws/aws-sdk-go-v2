...
func (c *Client) addOperationCreateInstrumentationConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateInstrumentationConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
