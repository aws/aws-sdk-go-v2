...
func (c *Client) addOperationCreateInstrumentationConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "CreateInstrumentationConfiguration"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opCreateInstrumentationConfiguration(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opCreateInstrumentationConfiguration(region string) *awsmiddleware.RegisterServiceMetadata {
