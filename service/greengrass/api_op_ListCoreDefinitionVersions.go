...
func addOperationListCoreDefinitionVersionsStackSlots(stack *middleware.Stack) error {
...
func addOperationListCoreDefinitionVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListCoreDefinitionVersionsStackSlots(stack); err != nil {
		return err
	}
