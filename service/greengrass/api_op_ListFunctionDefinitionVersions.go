...
func addOperationListFunctionDefinitionVersionsStackSlots(stack *middleware.Stack) error {
...
func addOperationListFunctionDefinitionVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListFunctionDefinitionVersionsStackSlots(stack); err != nil {
		return err
	}
