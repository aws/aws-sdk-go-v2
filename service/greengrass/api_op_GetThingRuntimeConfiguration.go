...
func (c *Client) GetThingRuntimeConfiguration(ctx context.Context, params *GetThingRuntimeConfigurationInput, optFns ...func(*Options)) (*GetThingRuntimeConfigurationOutput, error) {
	if params == nil { params = &GetThingRuntimeConfigurationInput{} }
...
func (c *Client) addOperationGetThingRuntimeConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetThingRuntimeConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetThingRuntimeConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetThingRuntimeConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetThingRuntimeConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetThingRuntimeConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetThingRuntimeConfigurationResolveEndpointMiddleware{
