...
func addOperationListDeviceDefinitionVersionsStackSlots(stack *middleware.Stack) error {
...
func addOperationListDeviceDefinitionVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListDeviceDefinitionVersionsStackSlots(stack); err != nil {
		return err
	}
