...
func (*GetGroupCertificateAuthorityInput) operationName() string {
	return "GetGroupCertificateAuthority"
}
...
func (c *Client) addOperationGetGroupCertificateAuthorityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetGroupCertificateAuthorityResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetGroupCertificateAuthorityResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetGroupCertificateAuthorityResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetGroupCertificateAuthorityResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetGroupCertificateAuthorityResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetGroupCertificateAuthorityResolveEndpointMiddleware{
