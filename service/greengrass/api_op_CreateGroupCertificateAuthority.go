...
func addOperationCreateGroupCertificateAuthorityStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateGroupCertificateAuthorityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateGroupCertificateAuthorityStackSlots(stack); err != nil {
		return err
	}
