...
func addOperationUpdateGroupCertificateConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateGroupCertificateConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateGroupCertificateConfigurationStackSlots(stack); err != nil {
		return err
	}
