...
func (c *Client) addOperationDisassociateRoleFromGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateRoleFromGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
