...
func addOperationGetResourceDefinitionVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationGetResourceDefinitionVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetResourceDefinitionVersionStackSlots(stack); err != nil {
		return err
	}
