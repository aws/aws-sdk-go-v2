...
func (c *Client) ListGroupCertificateAuthorities(ctx context.Context, params *ListGroupCertificateAuthoritiesInput, optFns ...func(*Options)) (*ListGroupCertificateAuthoritiesOutput, error) {
	if params == nil { params = &ListGroupCertificateAuthoritiesInput{} }
...
func (c *Client) addOperationListGroupCertificateAuthoritiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListGroupCertificateAuthoritiesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListGroupCertificateAuthoritiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListGroupCertificateAuthoritiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListGroupCertificateAuthoritiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListGroupCertificateAuthoritiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListGroupCertificateAuthoritiesResolveEndpointMiddleware{
