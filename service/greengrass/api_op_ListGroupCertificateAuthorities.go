...
func addOperationListGroupCertificateAuthoritiesStackSlots(stack *middleware.Stack) error {
...
func addOperationListGroupCertificateAuthoritiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListGroupCertificateAuthoritiesStackSlots(stack); err != nil {
		return err
	}
