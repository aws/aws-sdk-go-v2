...
func (c *Client) ListConnectorDefinitionVersions(ctx context.Context, params *ListConnectorDefinitionVersionsInput, optFns ...func(*Options)) (*ListConnectorDefinitionVersionsOutput, error) {
	if params == nil { params = &ListConnectorDefinitionVersionsInput{} }
...
func (c *Client) addOperationListConnectorDefinitionVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListConnectorDefinitionVersionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListConnectorDefinitionVersionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListConnectorDefinitionVersionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListConnectorDefinitionVersionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListConnectorDefinitionVersionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListConnectorDefinitionVersionsResolveEndpointMiddleware{
