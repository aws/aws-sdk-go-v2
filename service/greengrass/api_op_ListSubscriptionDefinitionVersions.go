...
func (c *Client) ListSubscriptionDefinitionVersions(ctx context.Context, params *ListSubscriptionDefinitionVersionsInput, optFns ...func(*Options)) (*ListSubscriptionDefinitionVersionsOutput, error) {
	if params == nil { params = &ListSubscriptionDefinitionVersionsInput{} }
...
func (c *Client) addOperationListSubscriptionDefinitionVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSubscriptionDefinitionVersionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSubscriptionDefinitionVersionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSubscriptionDefinitionVersionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSubscriptionDefinitionVersionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSubscriptionDefinitionVersionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSubscriptionDefinitionVersionsResolveEndpointMiddleware{
