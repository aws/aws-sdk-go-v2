...
func addOperationCreateCoreDefinitionVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateCoreDefinitionVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateCoreDefinitionVersionStackSlots(stack); err != nil {
		return err
	}
