...
func addOperationGetConnectorDefinitionVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationGetConnectorDefinitionVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetConnectorDefinitionVersionStackSlots(stack); err != nil {
		return err
	}
