...
func (c *Client) ListCoreDefinitions(ctx context.Context, params *ListCoreDefinitionsInput, optFns ...func(*Options)) (*ListCoreDefinitionsOutput, error) {
	if params == nil { params = &ListCoreDefinitionsInput{} }
...
func (c *Client) addOperationListCoreDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCoreDefinitionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCoreDefinitionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCoreDefinitionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCoreDefinitionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCoreDefinitionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCoreDefinitionsResolveEndpointMiddleware{
