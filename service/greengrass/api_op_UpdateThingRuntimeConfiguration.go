...
func (c *Client) addOperationUpdateThingRuntimeConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateThingRuntimeConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
