...
func addOperationListLoggerDefinitionVersionsStackSlots(stack *middleware.Stack) error {
...
func addOperationListLoggerDefinitionVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListLoggerDefinitionVersionsStackSlots(stack); err != nil {
		return err
	}
