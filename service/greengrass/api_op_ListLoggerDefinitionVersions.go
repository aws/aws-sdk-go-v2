...
func (*ListLoggerDefinitionVersionsInput) operationName() string {
...
func (c *Client) addOperationListLoggerDefinitionVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLoggerDefinitionVersionsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListLoggerDefinitionVersionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListLoggerDefinitionVersionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLoggerDefinitionVersionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLoggerDefinitionVersionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListLoggerDefinitionVersionsResolveEndpointMiddleware{
