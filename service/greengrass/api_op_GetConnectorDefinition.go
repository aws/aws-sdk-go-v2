...
func (*GetConnectorDefinitionInput) operationName() string {
...
func (c *Client) addOperationGetConnectorDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetConnectorDefinitionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetConnectorDefinitionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetConnectorDefinitionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetConnectorDefinitionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetConnectorDefinitionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetConnectorDefinitionResolveEndpointMiddleware{
