...
// Package greengrass provides the API client, operations, and parameter types
// for AWS Greengrass.
//
...
// connectivity. AWS IoT Greengrass minimizes the cost of transmitting data to the
