...
func addOperationCreateConnectorDefinitionVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateConnectorDefinitionVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateConnectorDefinitionVersionStackSlots(stack); err != nil {
		return err
	}
