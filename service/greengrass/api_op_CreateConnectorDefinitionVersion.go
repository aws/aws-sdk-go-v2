...
func (c *Client) CreateConnectorDefinitionVersion(ctx context.Context, params *CreateConnectorDefinitionVersionInput, optFns ...func(*Options)) (*CreateConnectorDefinitionVersionOutput, error) {
	if params == nil { params = &CreateConnectorDefinitionVersionInput{} }
...
func (c *Client) addOperationCreateConnectorDefinitionVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateConnectorDefinitionVersionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateConnectorDefinitionVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateConnectorDefinitionVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateConnectorDefinitionVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateConnectorDefinitionVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateConnectorDefinitionVersionResolveEndpointMiddleware{
