...
func (c *Client) ListSubscriptionDefinitions(ctx context.Context, params *ListSubscriptionDefinitionsInput, optFns ...func(*Options)) (*ListSubscriptionDefinitionsOutput, error) {
	if params == nil { params = &ListSubscriptionDefinitionsInput{} }
...
func (c *Client) addOperationListSubscriptionDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSubscriptionDefinitionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSubscriptionDefinitionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSubscriptionDefinitionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSubscriptionDefinitionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSubscriptionDefinitionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSubscriptionDefinitionsResolveEndpointMiddleware{
