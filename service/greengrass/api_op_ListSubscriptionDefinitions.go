...
func addOperationListSubscriptionDefinitionsStackSlots(stack *middleware.Stack) error {
...
func addOperationListSubscriptionDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListSubscriptionDefinitionsStackSlots(stack); err != nil {
		return err
	}
