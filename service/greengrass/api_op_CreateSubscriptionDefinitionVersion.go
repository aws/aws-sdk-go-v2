...
func (c *Client) CreateSubscriptionDefinitionVersion(ctx context.Context, params *CreateSubscriptionDefinitionVersionInput, optFns ...func(*Options)) (*CreateSubscriptionDefinitionVersionOutput, error) {
	if params == nil { params = &CreateSubscriptionDefinitionVersionInput{} }
...
func (c *Client) addOperationCreateSubscriptionDefinitionVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateSubscriptionDefinitionVersionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateSubscriptionDefinitionVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateSubscriptionDefinitionVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateSubscriptionDefinitionVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateSubscriptionDefinitionVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateSubscriptionDefinitionVersionResolveEndpointMiddleware{
