...
func (c *Client) GetAssociatedRole(ctx context.Context, params *GetAssociatedRoleInput, optFns ...func(*Options)) (*GetAssociatedRoleOutput, error) {
	if params == nil { params = &GetAssociatedRoleInput{} }
...
func (c *Client) addOperationGetAssociatedRoleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAssociatedRoleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAssociatedRoleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAssociatedRoleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAssociatedRoleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAssociatedRoleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAssociatedRoleResolveEndpointMiddleware{
