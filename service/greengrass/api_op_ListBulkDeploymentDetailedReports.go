...
func (c *Client) ListBulkDeploymentDetailedReports(ctx context.Context, params *ListBulkDeploymentDetailedReportsInput, optFns ...func(*Options)) (*ListBulkDeploymentDetailedReportsOutput, error) {
	if params == nil { params = &ListBulkDeploymentDetailedReportsInput{} }
...
func (c *Client) addOperationListBulkDeploymentDetailedReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBulkDeploymentDetailedReportsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListBulkDeploymentDetailedReportsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListBulkDeploymentDetailedReportsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBulkDeploymentDetailedReportsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListBulkDeploymentDetailedReportsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListBulkDeploymentDetailedReportsResolveEndpointMiddleware{
