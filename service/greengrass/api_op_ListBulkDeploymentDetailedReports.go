...
func (c *Client) addOperationListBulkDeploymentDetailedReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListBulkDeploymentDetailedReports", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
