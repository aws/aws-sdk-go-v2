...
func addOperationListBulkDeploymentDetailedReportsStackSlots(stack *middleware.Stack) error {
...
func addOperationListBulkDeploymentDetailedReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListBulkDeploymentDetailedReportsStackSlots(stack); err != nil {
		return err
	}
