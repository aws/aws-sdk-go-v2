...
func addOperationCreateSubscriptionDefinitionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateSubscriptionDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateSubscriptionDefinitionStackSlots(stack); err != nil {
		return err
	}
