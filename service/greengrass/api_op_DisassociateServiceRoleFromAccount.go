...
func (c *Client) addOperationDisassociateServiceRoleFromAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateServiceRoleFromAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
