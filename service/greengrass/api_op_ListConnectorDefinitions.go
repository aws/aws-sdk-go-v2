...
func (c *Client) addOperationListConnectorDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListConnectorDefinitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
