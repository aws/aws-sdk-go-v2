...
func addOperationGetSubscriptionDefinitionVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationGetSubscriptionDefinitionVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetSubscriptionDefinitionVersionStackSlots(stack); err != nil {
		return err
	}
