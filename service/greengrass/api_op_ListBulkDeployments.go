...
func (c *Client) ListBulkDeployments(ctx context.Context, params *ListBulkDeploymentsInput, optFns ...func(*Options)) (*ListBulkDeploymentsOutput, error) {
	if params == nil { params = &ListBulkDeploymentsInput{} }
...
func (c *Client) addOperationListBulkDeploymentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBulkDeploymentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListBulkDeploymentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListBulkDeploymentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBulkDeploymentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListBulkDeploymentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListBulkDeploymentsResolveEndpointMiddleware{
