...
func (c *Client) ResetDeployments(ctx context.Context, params *ResetDeploymentsInput, optFns ...func(*Options)) (*ResetDeploymentsOutput, error) {
	if params == nil { params = &ResetDeploymentsInput{} }
...
func (c *Client) addOperationResetDeploymentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResetDeploymentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opResetDeploymentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opResetDeploymentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResetDeploymentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResetDeploymentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opResetDeploymentsResolveEndpointMiddleware{
