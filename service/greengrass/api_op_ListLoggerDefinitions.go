...
func (c *Client) ListLoggerDefinitions(ctx context.Context, params *ListLoggerDefinitionsInput, optFns ...func(*Options)) (*ListLoggerDefinitionsOutput, error) {
	if params == nil { params = &ListLoggerDefinitionsInput{} }
...
func (c *Client) addOperationListLoggerDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLoggerDefinitionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListLoggerDefinitionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListLoggerDefinitionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLoggerDefinitionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLoggerDefinitionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListLoggerDefinitionsResolveEndpointMiddleware{
