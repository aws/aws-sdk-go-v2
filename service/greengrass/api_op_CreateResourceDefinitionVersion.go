...
func addOperationCreateResourceDefinitionVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateResourceDefinitionVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateResourceDefinitionVersionStackSlots(stack); err != nil {
		return err
	}
