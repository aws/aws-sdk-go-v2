...
func (c *Client) CreateDeviceDefinition(ctx context.Context, params *CreateDeviceDefinitionInput, optFns ...func(*Options)) (*CreateDeviceDefinitionOutput, error) {
	if params == nil { params = &CreateDeviceDefinitionInput{} }
...
func (c *Client) addOperationCreateDeviceDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateDeviceDefinitionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateDeviceDefinitionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateDeviceDefinitionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateDeviceDefinitionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateDeviceDefinitionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateDeviceDefinitionResolveEndpointMiddleware{
