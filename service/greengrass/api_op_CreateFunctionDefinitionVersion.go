...
func addOperationCreateFunctionDefinitionVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateFunctionDefinitionVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateFunctionDefinitionVersionStackSlots(stack); err != nil {
		return err
	}
