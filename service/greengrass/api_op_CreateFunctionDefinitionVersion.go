...
func (c *Client) addOperationCreateFunctionDefinitionVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateFunctionDefinitionVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
