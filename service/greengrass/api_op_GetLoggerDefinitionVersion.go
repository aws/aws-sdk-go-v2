...
func addOperationGetLoggerDefinitionVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationGetLoggerDefinitionVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetLoggerDefinitionVersionStackSlots(stack); err != nil {
		return err
	}
