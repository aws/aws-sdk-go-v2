...
func addOperationCreateLoggerDefinitionVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateLoggerDefinitionVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateLoggerDefinitionVersionStackSlots(stack); err != nil {
		return err
	}
