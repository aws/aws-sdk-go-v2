...
func (c *Client) addOperationGetServiceRoleForAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetServiceRoleForAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
