...
//
// This exception occurs when your IAM user or role lacks the required permissions
// to access the Amazon Keyspaces resource or perform the requested action. Check
// your IAM policies and ensure they grant the necessary permissions.
...
// The Amazon Keyspaces service encountered an unexpected error while processing
// the request.
//
...
// Services Support with details of your request to help identify and resolve the
// problem.
...
//
// This exception occurs when you attempt to access a keyspace, table, stream, or
// other Amazon Keyspaces resource that doesn't exist or that has been deleted.
// Verify that the resource identifier is correct and that the resource exists in
// your account.
...
// constraints are violated, or required parameters are missing. To help you fix
// the issue, the exception message provides details about which parameter failed
// and why.
...
func (v *ValidationException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ValidationException, func(s *smithy.Schema) error {
		...
		case schemas.ValidationException_errorCode:
			...
			v.ErrorCode_ = ValidationExceptionType(ev)
			return nil
