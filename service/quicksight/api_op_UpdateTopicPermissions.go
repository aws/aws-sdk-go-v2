...
func (c *Client) UpdateTopicPermissions(ctx context.Context, params *UpdateTopicPermissionsInput, optFns ...func(*Options)) (*UpdateTopicPermissionsOutput, error) {
	if params == nil { params = &UpdateTopicPermissionsInput{} }
...
func (c *Client) addOperationUpdateTopicPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateTopicPermissionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateTopicPermissionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateTopicPermissionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateTopicPermissionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateTopicPermissionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateTopicPermissionsResolveEndpointMiddleware{
