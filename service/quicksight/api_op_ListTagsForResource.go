...
func (v *ListTagsForResourceOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.RequestId != nil {
		s.WriteString(schemas.ListTagsForResourceResponse_RequestId, *v.RequestId)
	}
	if v.Status != 0 {
		s.WriteInt32(schemas.ListTagsForResourceResponse_Status, v.Status)
	}
...
func (v *ListTagsForResourceOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListTagsForResourceResponse, func(s *smithy.Schema) error {
		switch s {
		case schemas.ListTagsForResourceResponse_RequestId:
			v.RequestId = new(string)
			return d.ReadString(schemas.ListTagsForResourceResponse_RequestId, v.RequestId)
		case schemas.ListTagsForResourceResponse_Status:
			return d.ReadInt32(schemas.ListTagsForResourceResponse_Status, &v.Status)
