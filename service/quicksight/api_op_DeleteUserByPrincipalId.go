...
func (c *Client) addOperationDeleteUserByPrincipalIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteUserByPrincipalId", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
