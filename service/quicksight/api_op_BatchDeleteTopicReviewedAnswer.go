...
func (c *Client) addOperationBatchDeleteTopicReviewedAnswerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDeleteTopicReviewedAnswer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
