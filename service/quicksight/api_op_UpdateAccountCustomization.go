...
func (c *Client) addOperationUpdateAccountCustomizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAccountCustomization", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
