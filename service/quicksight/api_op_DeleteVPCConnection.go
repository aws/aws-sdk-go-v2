...
func (c *Client) DeleteVPCConnection(ctx context.Context, params *DeleteVPCConnectionInput, optFns ...func(*Options)) (*DeleteVPCConnectionOutput, error) {
	if params == nil { params = &DeleteVPCConnectionInput{} }
...
func (c *Client) addOperationDeleteVPCConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteVPCConnectionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteVPCConnectionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteVPCConnectionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteVPCConnectionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteVPCConnectionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteVPCConnectionResolveEndpointMiddleware{
