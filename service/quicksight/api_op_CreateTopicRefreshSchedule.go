...
func (c *Client) addOperationCreateTopicRefreshScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateTopicRefreshSchedule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
