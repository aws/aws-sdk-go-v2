...
func (c *Client) addOperationDescribeDataSetPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDataSetPermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
