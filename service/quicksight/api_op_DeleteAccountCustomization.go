...
func addOperationDeleteAccountCustomizationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteAccountCustomizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteAccountCustomizationStackSlots(stack); err != nil {
		return err
	}
