...
func addOperationDescribeTemplatePermissionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeTemplatePermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeTemplatePermissionsStackSlots(stack); err != nil {
		return err
	}
