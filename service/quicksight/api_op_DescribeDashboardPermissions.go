...
func (c *Client) addOperationDescribeDashboardPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDashboardPermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
