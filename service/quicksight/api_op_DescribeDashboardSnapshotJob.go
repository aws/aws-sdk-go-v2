...
func (c *Client) addOperationDescribeDashboardSnapshotJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDashboardSnapshotJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
