...
func (c *Client) addOperationDescribeBrandAssignmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeBrandAssignment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
