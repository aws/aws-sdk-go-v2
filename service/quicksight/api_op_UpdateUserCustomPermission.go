...
func (c *Client) addOperationUpdateUserCustomPermissionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateUserCustomPermission", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
