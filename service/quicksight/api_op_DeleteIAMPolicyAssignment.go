...
func (c *Client) addOperationDeleteIAMPolicyAssignmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteIAMPolicyAssignment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
