...
func (c *Client) addOperationUpdateDefaultQBusinessApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDefaultQBusinessApplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
