...
func (c *Client) addOperationDescribeFolderResolvedPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeFolderResolvedPermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
