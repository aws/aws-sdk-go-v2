...
func (c *Client) addOperationDescribeCustomPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCustomPermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
