...
func (c *Client) addOperationUpdateIdentityPropagationConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateIdentityPropagationConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
