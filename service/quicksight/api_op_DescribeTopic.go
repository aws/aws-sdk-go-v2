...
func (c *Client) DescribeTopic(ctx context.Context, params *DescribeTopicInput, optFns ...func(*Options)) (*DescribeTopicOutput, error) {
	if params == nil { params = &DescribeTopicInput{} }
...
func (c *Client) addOperationDescribeTopicMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeTopicResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeTopicResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeTopicResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeTopicResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeTopicResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeTopicResolveEndpointMiddleware{
