...
// Provides a detailed description of the definition of an analysis. If you do
// not need to know details about the content of an Analysis, for instance if you
// are trying to check the status of a recently created or updated Analysis, use
// the DescribeAnalysis (https://docs.aws.amazon.com/quicksight/latest/APIReference/API_DescribeAnalysis.html)
// instead.
