...
type UpdateDashboardInput struct {
	...
	// only update a dashboard from a template, so you use a SourceTemplate entity.
	// If you need to update a dashboard from an analysis, first convert the analysis
	...
	// the source template. The SourceTemplate ARN can contain any Amazon Web
