...
func (c *Client) SearchFolders(ctx context.Context, params *SearchFoldersInput, optFns ...func(*Options)) (*SearchFoldersOutput, error) {
	if params == nil { params = &SearchFoldersInput{} }
...
func (c *Client) addOperationSearchFoldersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSearchFoldersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSearchFoldersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSearchFoldersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSearchFoldersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSearchFoldersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSearchFoldersResolveEndpointMiddleware{
