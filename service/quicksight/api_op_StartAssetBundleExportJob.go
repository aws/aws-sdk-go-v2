...
func (c *Client) addOperationStartAssetBundleExportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartAssetBundleExportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
