...
func (c *Client) addOperationListIAMPolicyAssignmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListIAMPolicyAssignments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
