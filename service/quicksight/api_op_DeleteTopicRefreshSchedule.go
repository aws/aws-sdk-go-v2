...
func (c *Client) addOperationDeleteTopicRefreshScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteTopicRefreshSchedule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
