...
func (c *Client) addOperationDescribeAssetBundleImportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAssetBundleImportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
