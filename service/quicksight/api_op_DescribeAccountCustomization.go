...
// potential to use all of the Amazon Web Services Regions and AWS Services. When
// you subscribe to Amazon QuickSight, you choose one Amazon Web Services Region to
// use as your home Region. That's where your free SPICE capacity is located. You
// can use Amazon QuickSight in any supported Amazon Web Services Region.
//
// * Amazon
// Web Services Region - In each Amazon Web Services Region where you sign in to
// Amazon QuickSight at least once, Amazon QuickSight acts as a separate instance
// of the same service. If you have a user directory, it resides in us-east-1,
// which is the US East (N. Virginia). Generally speaking, these users have access
// to Amazon QuickSight in any Amazon Web Services Region, unless they are
// constrained to a namespace. To run the command in a different Amazon Web
// Services Region, you change your Region settings. If you're using the AWS CLI,
...
//
// *
// Namespace - A Amazon QuickSight namespace is a partition that contains users and
...
//
// * Applied customizations - Within an
// Amazon Web Services Region, a set of Amazon QuickSight customizations can apply
// to an Amazon Web Services account or to a namespace. Settings that you apply to
// a namespace override settings that you apply to an Amazon Web Services account.
