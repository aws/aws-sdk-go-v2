...
func (c *Client) addOperationCreateOAuthClientApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateOAuthClientApplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
