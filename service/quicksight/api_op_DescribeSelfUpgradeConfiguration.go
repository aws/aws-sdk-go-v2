...
func (c *Client) addOperationDescribeSelfUpgradeConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSelfUpgradeConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
