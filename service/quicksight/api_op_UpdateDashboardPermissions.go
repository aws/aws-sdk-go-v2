...
func addOperationUpdateDashboardPermissionsStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateDashboardPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateDashboardPermissionsStackSlots(stack); err != nil {
		return err
	}
