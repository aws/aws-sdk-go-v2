...
func (c *Client) DescribeDataSource(ctx context.Context, params *DescribeDataSourceInput, optFns ...func(*Options)) (*DescribeDataSourceOutput, error) {
	...
	addawsRestjson1_serdeOpDescribeDataSourceMiddlewares(stack)
...
func addawsRestjson1_serdeOpDescribeDataSourceMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpDescribeDataSource{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpDescribeDataSource{}, middleware.After)
}
