...
func (v *ListDataSourcesInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AwsAccountId != nil {
		s.WriteString(schemas.ListDataSourcesRequest_AwsAccountId, *v.AwsAccountId)
	}
	if v.MaxResults != nil {
...
func (v *ListDataSourcesOutput) SerializeMembers(s smithy.ShapeSerializer) {
	serializeDataSourceList(s, schemas.ListDataSourcesResponse_DataSources, v.DataSources)
	if v.NextToken != nil {
		s.WriteString(schemas.ListDataSourcesResponse_NextToken, *v.NextToken)
	}
	if v.RequestId != nil {
		s.WriteString(schemas.ListDataSourcesResponse_RequestId, *v.RequestId)
	}
	if v.Status != 0 {
		s.WriteInt32(schemas.ListDataSourcesResponse_Status, v.Status)
	}
}
func (v *ListDataSourcesOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListDataSourcesResponse, func(s *smithy.Schema) error {
		...
		case schemas.ListDataSourcesResponse_RequestId:
			v.RequestId = new(string)
			return d.ReadString(schemas.ListDataSourcesResponse_RequestId, v.RequestId)
		case schemas.ListDataSourcesResponse_Status:
			return d.ReadInt32(schemas.ListDataSourcesResponse_Status, &v.Status)
		}
		return nil
	})
}
