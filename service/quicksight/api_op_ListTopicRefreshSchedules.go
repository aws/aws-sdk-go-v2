...
func (c *Client) addOperationListTopicRefreshSchedulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTopicRefreshSchedules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
