...
func (c *Client) ListTopicRefreshSchedules(ctx context.Context, params *ListTopicRefreshSchedulesInput, optFns ...func(*Options)) (*ListTopicRefreshSchedulesOutput, error) {
	if params == nil { params = &ListTopicRefreshSchedulesInput{} }
...
func (c *Client) addOperationListTopicRefreshSchedulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTopicRefreshSchedulesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTopicRefreshSchedulesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTopicRefreshSchedulesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTopicRefreshSchedulesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTopicRefreshSchedulesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTopicRefreshSchedulesResolveEndpointMiddleware{
