...
func (c *Client) addOperationBatchCreateTopicReviewedAnswerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchCreateTopicReviewedAnswer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
