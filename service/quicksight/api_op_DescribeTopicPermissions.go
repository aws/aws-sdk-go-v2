...
func (c *Client) addOperationDescribeTopicPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeTopicPermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
