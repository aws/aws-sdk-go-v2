...
func (c *Client) ListAssetBundleExportJobs(ctx context.Context, params *ListAssetBundleExportJobsInput, optFns ...func(*Options)) (*ListAssetBundleExportJobsOutput, error) {
	if params == nil { params = &ListAssetBundleExportJobsInput{} }
...
func (c *Client) addOperationListAssetBundleExportJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAssetBundleExportJobsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAssetBundleExportJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAssetBundleExportJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAssetBundleExportJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAssetBundleExportJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAssetBundleExportJobsResolveEndpointMiddleware{
