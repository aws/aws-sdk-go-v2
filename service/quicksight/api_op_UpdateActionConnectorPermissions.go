...
func (c *Client) addOperationUpdateActionConnectorPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateActionConnectorPermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
