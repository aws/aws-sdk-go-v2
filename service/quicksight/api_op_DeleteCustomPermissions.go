...
func (c *Client) addOperationDeleteCustomPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteCustomPermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
