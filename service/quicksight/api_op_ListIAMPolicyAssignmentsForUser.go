...
func addOperationListIAMPolicyAssignmentsForUserStackSlots(stack *middleware.Stack) error {
...
func addOperationListIAMPolicyAssignmentsForUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListIAMPolicyAssignmentsForUserStackSlots(stack); err != nil {
		return err
	}
