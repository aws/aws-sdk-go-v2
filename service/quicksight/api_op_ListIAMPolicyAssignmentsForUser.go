...
func (c *Client) addOperationListIAMPolicyAssignmentsForUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListIAMPolicyAssignmentsForUserResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListIAMPolicyAssignmentsForUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListIAMPolicyAssignmentsForUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListIAMPolicyAssignmentsForUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListIAMPolicyAssignmentsForUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListIAMPolicyAssignmentsForUserResolveEndpointMiddleware{
