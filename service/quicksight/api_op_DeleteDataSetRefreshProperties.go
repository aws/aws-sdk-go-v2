...
func (c *Client) addOperationDeleteDataSetRefreshPropertiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDataSetRefreshProperties", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
