...
func (c *Client) DeleteDataSetRefreshProperties(ctx context.Context, params *DeleteDataSetRefreshPropertiesInput, optFns ...func(*Options)) (*DeleteDataSetRefreshPropertiesOutput, error) {
	if params == nil { params = &DeleteDataSetRefreshPropertiesInput{} }
...
func (c *Client) addOperationDeleteDataSetRefreshPropertiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteDataSetRefreshPropertiesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteDataSetRefreshPropertiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteDataSetRefreshPropertiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteDataSetRefreshPropertiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteDataSetRefreshPropertiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteDataSetRefreshPropertiesResolveEndpointMiddleware{
