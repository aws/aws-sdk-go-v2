...
func (c *Client) ListFolderMembers(ctx context.Context, params *ListFolderMembersInput, optFns ...func(*Options)) (*ListFolderMembersOutput, error) {
	if params == nil { params = &ListFolderMembersInput{} }
...
func (c *Client) addOperationListFolderMembersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFolderMembersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListFolderMembersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListFolderMembersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFolderMembersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFolderMembersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListFolderMembersResolveEndpointMiddleware{
