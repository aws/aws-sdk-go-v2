...
func (c *Client) addOperationGenerateEmbedUrlForRegisteredUserWithIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GenerateEmbedUrlForRegisteredUserWithIdentity", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
