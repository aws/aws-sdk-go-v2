...
func (c *Client) CancelIngestion(ctx context.Context, params *CancelIngestionInput, optFns ...func(*Options)) (*CancelIngestionOutput, error) {
	if params == nil { params = &CancelIngestionInput{} }
...
func (c *Client) addOperationCancelIngestionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelIngestionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelIngestionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelIngestionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelIngestionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelIngestionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelIngestionResolveEndpointMiddleware{
