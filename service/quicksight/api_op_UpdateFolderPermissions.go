...
func (c *Client) addOperationUpdateFolderPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateFolderPermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
