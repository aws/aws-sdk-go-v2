...
func (c *Client) addOperationUpdateAnalysisPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAnalysisPermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
