...
func (c *Client) addOperationDescribeAssetBundleExportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAssetBundleExportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
