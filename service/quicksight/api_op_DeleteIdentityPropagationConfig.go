...
func (c *Client) addOperationDeleteIdentityPropagationConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteIdentityPropagationConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
