...
func (c *Client) addOperationDescribeRoleCustomPermissionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRoleCustomPermission", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
