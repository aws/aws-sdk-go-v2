...
func addOperationDescribeIAMPolicyAssignmentStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeIAMPolicyAssignmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeIAMPolicyAssignmentStackSlots(stack); err != nil {
		return err
	}
