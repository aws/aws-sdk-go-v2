...
func (c *Client) DescribeIAMPolicyAssignment(ctx context.Context, params *DescribeIAMPolicyAssignmentInput, optFns ...func(*Options)) (*DescribeIAMPolicyAssignmentOutput, error) {
	if params == nil { params = &DescribeIAMPolicyAssignmentInput{} }
...
func (c *Client) addOperationDescribeIAMPolicyAssignmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeIAMPolicyAssignmentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeIAMPolicyAssignmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeIAMPolicyAssignmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeIAMPolicyAssignmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeIAMPolicyAssignmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeIAMPolicyAssignmentResolveEndpointMiddleware{
