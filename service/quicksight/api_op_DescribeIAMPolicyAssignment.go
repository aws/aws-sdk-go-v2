...
func (c *Client) addOperationDescribeIAMPolicyAssignmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeIAMPolicyAssignment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
