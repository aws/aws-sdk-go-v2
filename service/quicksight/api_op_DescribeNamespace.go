...
type DescribeNamespaceOutput struct {
	...
	// DescribeNamespace also works for namespaces that are in the process of being
	// created. For incomplete namespaces, this API operation lists the namespace error
