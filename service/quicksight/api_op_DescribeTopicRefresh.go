...
func (c *Client) DescribeTopicRefresh(ctx context.Context, params *DescribeTopicRefreshInput, optFns ...func(*Options)) (*DescribeTopicRefreshOutput, error) {
	if params == nil { params = &DescribeTopicRefreshInput{} }
...
func (c *Client) addOperationDescribeTopicRefreshMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeTopicRefreshResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeTopicRefreshResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeTopicRefreshResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeTopicRefreshResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeTopicRefreshResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeTopicRefreshResolveEndpointMiddleware{
