...
func (c *Client) addOperationDescribeRefreshScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRefreshSchedule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
