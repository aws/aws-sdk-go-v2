...
func (*UpdateIAMPolicyAssignmentInput) operationName() string {
...
func (c *Client) addOperationUpdateIAMPolicyAssignmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateIAMPolicyAssignmentResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateIAMPolicyAssignmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateIAMPolicyAssignmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateIAMPolicyAssignmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateIAMPolicyAssignmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateIAMPolicyAssignmentResolveEndpointMiddleware{
