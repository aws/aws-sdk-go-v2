...
func (c *Client) addOperationUpdateIAMPolicyAssignmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateIAMPolicyAssignment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
