...
func (c *Client) addOperationCreateIAMPolicyAssignmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateIAMPolicyAssignment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
