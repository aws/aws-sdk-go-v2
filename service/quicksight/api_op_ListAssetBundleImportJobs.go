...
func (c *Client) ListAssetBundleImportJobs(ctx context.Context, params *ListAssetBundleImportJobsInput, optFns ...func(*Options)) (*ListAssetBundleImportJobsOutput, error) {
	if params == nil { params = &ListAssetBundleImportJobsInput{} }
...
func (c *Client) addOperationListAssetBundleImportJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAssetBundleImportJobsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAssetBundleImportJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAssetBundleImportJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAssetBundleImportJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAssetBundleImportJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAssetBundleImportJobsResolveEndpointMiddleware{
