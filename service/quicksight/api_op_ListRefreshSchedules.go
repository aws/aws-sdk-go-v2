...
func (c *Client) ListRefreshSchedules(ctx context.Context, params *ListRefreshSchedulesInput, optFns ...func(*Options)) (*ListRefreshSchedulesOutput, error) {
	if params == nil { params = &ListRefreshSchedulesInput{} }
...
func (c *Client) addOperationListRefreshSchedulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRefreshSchedulesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRefreshSchedulesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRefreshSchedulesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRefreshSchedulesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRefreshSchedulesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRefreshSchedulesResolveEndpointMiddleware{
