...
func (c *Client) addOperationListIdentityPropagationConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListIdentityPropagationConfigs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
