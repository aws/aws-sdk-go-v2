...
func (c *Client) ListAnalyses(ctx context.Context, params *ListAnalysesInput, optFns ...func(*Options)) (*ListAnalysesOutput, error) {
	if params == nil { params = &ListAnalysesInput{} }
...
func (c *Client) addOperationListAnalysesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAnalysesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAnalysesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAnalysesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAnalysesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAnalysesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAnalysesResolveEndpointMiddleware{
