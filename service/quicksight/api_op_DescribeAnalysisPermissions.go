...
func (c *Client) addOperationDescribeAnalysisPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAnalysisPermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
