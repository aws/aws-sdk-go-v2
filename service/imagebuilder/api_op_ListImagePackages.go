...
func (c *Client) ListImagePackages(ctx context.Context, params *ListImagePackagesInput, optFns ...func(*Options)) (*ListImagePackagesOutput, error) {
	if params == nil { params = &ListImagePackagesInput{} }
...
func (c *Client) addOperationListImagePackagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListImagePackagesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListImagePackagesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListImagePackagesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListImagePackagesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListImagePackagesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListImagePackagesResolveEndpointMiddleware{
