...
func addOperationUpdateInfrastructureConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateInfrastructureConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateInfrastructureConfigurationStackSlots(stack); err != nil {
		return err
	}
