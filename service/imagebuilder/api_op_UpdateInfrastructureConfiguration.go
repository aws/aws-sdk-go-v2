...
func (c *Client) addOperationUpdateInfrastructureConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateInfrastructureConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
