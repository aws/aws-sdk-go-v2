...
func addOperationCreateDistributionConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateDistributionConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateDistributionConfigurationStackSlots(stack); err != nil {
		return err
	}
