...
func (c *Client) GetContainerRecipe(ctx context.Context, params *GetContainerRecipeInput, optFns ...func(*Options)) (*GetContainerRecipeOutput, error) {
	if params == nil { params = &GetContainerRecipeInput{} }
...
func (c *Client) addOperationGetContainerRecipeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetContainerRecipeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetContainerRecipeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetContainerRecipeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetContainerRecipeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetContainerRecipeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetContainerRecipeResolveEndpointMiddleware{
