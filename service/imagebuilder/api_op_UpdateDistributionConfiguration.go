...
func addOperationUpdateDistributionConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateDistributionConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateDistributionConfigurationStackSlots(stack); err != nil {
		return err
	}
