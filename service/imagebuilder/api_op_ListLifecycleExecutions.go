...
func (c *Client) addOperationListLifecycleExecutionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListLifecycleExecutions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
