...
func addOperationStartImagePipelineExecutionStackSlots(stack *middleware.Stack) error {
...
func addOperationStartImagePipelineExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartImagePipelineExecutionStackSlots(stack); err != nil {
		return err
	}
