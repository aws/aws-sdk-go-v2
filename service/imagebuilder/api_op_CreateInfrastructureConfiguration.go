...
func addOperationCreateInfrastructureConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateInfrastructureConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateInfrastructureConfigurationStackSlots(stack); err != nil {
		return err
	}
