...
// Applies a policy to a container recipe. The preferred way to share resources is
// with the RAM API [CreateResourceShare]. If you use the PutContainerRecipePolicy operation instead,
// you must also call the RAM API [PromoteResourceShareCreatedFromPolicy]. Otherwise, the resource isn't visible to the
