...
func (*ListImageRecipesInput) operationName() string {
...
func (c *Client) addOperationListImageRecipesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListImageRecipesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListImageRecipesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListImageRecipesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListImageRecipesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListImageRecipesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListImageRecipesResolveEndpointMiddleware{
