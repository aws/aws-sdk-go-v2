...
func (c *Client) addOperationListWorkflowBuildVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListWorkflowBuildVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
