...
func addOperationDeleteDistributionConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteDistributionConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteDistributionConfigurationStackSlots(stack); err != nil {
		return err
	}
