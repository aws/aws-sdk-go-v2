...
func (*ListImagePipelinesInput) operationName() string {
...
func (c *Client) addOperationListImagePipelinesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListImagePipelinesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListImagePipelinesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListImagePipelinesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListImagePipelinesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListImagePipelinesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListImagePipelinesResolveEndpointMiddleware{
