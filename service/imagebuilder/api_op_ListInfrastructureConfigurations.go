...
func addOperationListInfrastructureConfigurationsStackSlots(stack *middleware.Stack) error {
...
func addOperationListInfrastructureConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListInfrastructureConfigurationsStackSlots(stack); err != nil {
		return err
	}
