...
func addOperationListDistributionConfigurationsStackSlots(stack *middleware.Stack) error {
...
func addOperationListDistributionConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListDistributionConfigurationsStackSlots(stack); err != nil {
		return err
	}
