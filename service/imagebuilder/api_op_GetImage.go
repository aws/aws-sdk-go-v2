...
func (c *Client) GetImage(ctx context.Context, params *GetImageInput, optFns ...func(*Options)) (*GetImageOutput, error) {
	if params == nil { params = &GetImageInput{} }
...
func (c *Client) addOperationGetImageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetImageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetImageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetImageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetImageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetImageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetImageResolveEndpointMiddleware{
