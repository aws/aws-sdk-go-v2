...
func (c *Client) addOperationListComponentBuildVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListComponentBuildVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
