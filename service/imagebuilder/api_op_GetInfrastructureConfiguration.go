...
func addOperationGetInfrastructureConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetInfrastructureConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetInfrastructureConfigurationStackSlots(stack); err != nil {
		return err
	}
