...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-sagemaker-featurestore-runtime.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker-featurestore-runtime.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker-featurestore-runtime.dev",
			expectURL:     aws.String("https://env-sagemaker-featurestore-runtime.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-sagemaker-featurestore-runtime.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker-featurestore-runtime.dev",
			expectURL:     aws.String("http://config-sagemaker-featurestore-runtime.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-sagemaker-featurestore-runtime.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-sagemaker-featurestore-runtime.dev",
			clientEndpoint: aws.String("https://client-sagemaker-featurestore-runtime.dev"),
			expectURL:      aws.String("https://client-sagemaker-featurestore-runtime.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SAGEMAKER_FEATURESTORE_RUNTIME", c.envService)
			}
