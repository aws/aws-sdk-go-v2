...
func TestSerdeCheckSnapshot_BatchGetRecord(t *testing.T) {
...
func TestSerdeCheckSnapshot_GetRecord(t *testing.T) {
...
func TestSerdeUpdateSnapshot_BatchGetRecord(t *testing.T) {
	input := &BatchGetRecordInput{
		Identifiers: []types.BatchGetRecordIdentifier{
			{
				FeatureGroupName: ptr.String("__FeatureGroupName__"),
...
func TestSerdeUpdateSnapshot_GetRecord(t *testing.T) {
	input := &GetRecordInput{
		FeatureGroupName:              ptr.String("__FeatureGroupName__"),
		RecordIdentifierValueAsString: ptr.String("__RecordIdentifierValueAsString__"),
		FeatureNames: []string{
