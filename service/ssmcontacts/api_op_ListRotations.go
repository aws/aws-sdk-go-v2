...
func (c *Client) ListRotations(ctx context.Context, params *ListRotationsInput, optFns ...func(*Options)) (*ListRotationsOutput, error) {
	if params == nil { params = &ListRotationsInput{} }
...
func (c *Client) addOperationListRotationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRotationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRotationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRotationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRotationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRotationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRotationsResolveEndpointMiddleware{
