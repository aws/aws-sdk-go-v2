...
func (c *Client) SendActivationCode(ctx context.Context, params *SendActivationCodeInput, optFns ...func(*Options)) (*SendActivationCodeOutput, error) {
	if params == nil { params = &SendActivationCodeInput{} }
...
func (c *Client) addOperationSendActivationCodeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendActivationCodeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSendActivationCodeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSendActivationCodeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendActivationCodeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendActivationCodeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSendActivationCodeResolveEndpointMiddleware{
