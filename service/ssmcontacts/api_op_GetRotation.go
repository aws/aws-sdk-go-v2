...
func (c *Client) GetRotation(ctx context.Context, params *GetRotationInput, optFns ...func(*Options)) (*GetRotationOutput, error) {
	if params == nil { params = &GetRotationInput{} }
...
func (c *Client) addOperationGetRotationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRotationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRotationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRotationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRotationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRotationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRotationResolveEndpointMiddleware{
