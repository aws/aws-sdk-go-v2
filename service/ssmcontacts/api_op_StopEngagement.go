...
func (c *Client) StopEngagement(ctx context.Context, params *StopEngagementInput, optFns ...func(*Options)) (*StopEngagementOutput, error) {
	if params == nil { params = &StopEngagementInput{} }
...
func (c *Client) addOperationStopEngagementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopEngagementResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopEngagementResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopEngagementResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopEngagementResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopEngagementResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopEngagementResolveEndpointMiddleware{
