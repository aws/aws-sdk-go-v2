...
func (c *Client) addOperationDeactivateContactChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeactivateContactChannel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
