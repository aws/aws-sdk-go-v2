...
func (c *Client) ListContactChannels(ctx context.Context, params *ListContactChannelsInput, optFns ...func(*Options)) (*ListContactChannelsOutput, error) {
	if params == nil { params = &ListContactChannelsInput{} }
...
func (c *Client) addOperationListContactChannelsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListContactChannelsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListContactChannelsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListContactChannelsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListContactChannelsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListContactChannelsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListContactChannelsResolveEndpointMiddleware{
