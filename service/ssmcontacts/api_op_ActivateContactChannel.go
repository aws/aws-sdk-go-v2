...
func (c *Client) ActivateContactChannel(ctx context.Context, params *ActivateContactChannelInput, optFns ...func(*Options)) (*ActivateContactChannelOutput, error) {
	if params == nil { params = &ActivateContactChannelInput{} }
...
func (c *Client) addOperationActivateContactChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addActivateContactChannelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opActivateContactChannelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opActivateContactChannelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opActivateContactChannelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addActivateContactChannelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opActivateContactChannelResolveEndpointMiddleware{
