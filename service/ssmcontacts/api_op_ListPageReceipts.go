...
func (c *Client) ListPageReceipts(ctx context.Context, params *ListPageReceiptsInput, optFns ...func(*Options)) (*ListPageReceiptsOutput, error) {
	if params == nil { params = &ListPageReceiptsInput{} }
...
func (c *Client) addOperationListPageReceiptsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPageReceiptsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPageReceiptsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPageReceiptsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPageReceiptsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPageReceiptsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPageReceiptsResolveEndpointMiddleware{
