...
func (c *Client) GetContactChannel(ctx context.Context, params *GetContactChannelInput, optFns ...func(*Options)) (*GetContactChannelOutput, error) {
	if params == nil { params = &GetContactChannelInput{} }
...
func (c *Client) addOperationGetContactChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetContactChannelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetContactChannelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetContactChannelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetContactChannelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetContactChannelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetContactChannelResolveEndpointMiddleware{
