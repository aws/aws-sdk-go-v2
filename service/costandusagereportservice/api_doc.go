...
// Using the Client
//
// To use AWS Cost and Usage Report Service with the SDK use the New function to create
...
//
// See the AWS Cost and Usage Report Service client for more information on
