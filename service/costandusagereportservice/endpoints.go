...
import (
	...
	internalendpoints "github.com/Enflick/aws-sdk-go-v2/service/costandusagereportservice/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_COST_AND_USAGE_REPORT_SERVICE")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Cost and Usage Report Service", cfg.ConfigSources)
	if found && err == nil {
					...
					if true == _PartitionResult.SupportsFIPS {
						if true == _PartitionResult.SupportsDualStack {
							uriString := func() string {
								...
								out.WriteString("https://cur-fips.")
