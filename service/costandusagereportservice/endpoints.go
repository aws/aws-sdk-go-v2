...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/costandusagereportservice/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "Cost and Usage Report Service", cfg.ConfigSources)
	if found && err == nil {
