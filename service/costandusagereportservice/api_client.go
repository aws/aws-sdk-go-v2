...
// Usage API.</p> <p>Service Endpoint</p> <p>The AWS Cost and Usage Report API
// provides the following endpoint:</p> <ul> <li>
...
func addClientUserAgent(stack *middleware.Stack) {
	awsmiddleware.AddUserAgentKey("costandusagereportservice")(stack)
}
