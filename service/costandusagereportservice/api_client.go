...
const (
	ServiceName = "AWS Cost and Usage Report Service" // Service's name
	ServiceID   = "CostAndUsageReportService"         // Service's identifier
	EndpointsID = "cur"                               // Service's Endpoint identifier
)
