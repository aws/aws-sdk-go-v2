...
func (c *Client) GetNode(ctx context.Context, params *GetNodeInput, optFns ...func(*Options)) (*GetNodeOutput, error) {
	if params == nil { params = &GetNodeInput{} }
...
func (c *Client) addOperationGetNodeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetNodeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetNodeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetNodeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetNodeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetNodeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetNodeResolveEndpointMiddleware{
