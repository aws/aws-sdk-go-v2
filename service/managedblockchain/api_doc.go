...
// Using the Client
//
// To use ManagedBlockchain with the SDK use the New function to create
...
//
// See the ManagedBlockchain client for more information on
