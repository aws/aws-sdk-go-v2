...
func (c *Client) GetAccessor(ctx context.Context, params *GetAccessorInput, optFns ...func(*Options)) (*GetAccessorOutput, error) {
	if params == nil { params = &GetAccessorInput{} }
...
func (c *Client) addOperationGetAccessorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAccessorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAccessorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAccessorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAccessorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAccessorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAccessorResolveEndpointMiddleware{
