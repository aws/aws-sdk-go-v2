...
func (*RejectInvitationInput) operationName() string {
...
func (c *Client) addOperationRejectInvitationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRejectInvitationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRejectInvitationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRejectInvitationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRejectInvitationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRejectInvitationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRejectInvitationResolveEndpointMiddleware{
