...
func (c *Client) VoteOnProposal(ctx context.Context, params *VoteOnProposalInput, optFns ...func(*Options)) (*VoteOnProposalOutput, error) {
	if params == nil { params = &VoteOnProposalInput{} }
...
func (c *Client) addOperationVoteOnProposalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addVoteOnProposalResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opVoteOnProposalResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opVoteOnProposalResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opVoteOnProposalResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addVoteOnProposalResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opVoteOnProposalResolveEndpointMiddleware{
