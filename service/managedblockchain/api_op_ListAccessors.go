...
func (c *Client) ListAccessors(ctx context.Context, params *ListAccessorsInput, optFns ...func(*Options)) (*ListAccessorsOutput, error) {
	if params == nil { params = &ListAccessorsInput{} }
...
func (c *Client) addOperationListAccessorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAccessorsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAccessorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAccessorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAccessorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAccessorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAccessorsResolveEndpointMiddleware{
