...
func (c *Client) GetServiceGraph(ctx context.Context, params *GetServiceGraphInput, optFns ...func(*Options)) (*GetServiceGraphOutput, error) {
	if params == nil { params = &GetServiceGraphInput{} }
...
func (c *Client) addOperationGetServiceGraphMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetServiceGraphResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetServiceGraphResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetServiceGraphResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetServiceGraphResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetServiceGraphResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetServiceGraphResolveEndpointMiddleware{
