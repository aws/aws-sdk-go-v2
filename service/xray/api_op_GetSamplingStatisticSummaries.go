...
func (c *Client) addOperationGetSamplingStatisticSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSamplingStatisticSummaries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
