...
func (c *Client) GetSamplingStatisticSummaries(ctx context.Context, params *GetSamplingStatisticSummariesInput, optFns ...func(*Options)) (*GetSamplingStatisticSummariesOutput, error) {
	if params == nil { params = &GetSamplingStatisticSummariesInput{} }
...
func (c *Client) addOperationGetSamplingStatisticSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSamplingStatisticSummariesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSamplingStatisticSummariesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSamplingStatisticSummariesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSamplingStatisticSummariesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSamplingStatisticSummariesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSamplingStatisticSummariesResolveEndpointMiddleware{
