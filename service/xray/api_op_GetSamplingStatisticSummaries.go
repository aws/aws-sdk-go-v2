...
func addOperationGetSamplingStatisticSummariesStackSlots(stack *middleware.Stack) error {
...
func addOperationGetSamplingStatisticSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetSamplingStatisticSummariesStackSlots(stack); err != nil {
		return err
	}
