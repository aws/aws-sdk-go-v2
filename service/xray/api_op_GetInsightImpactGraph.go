...
func (c *Client) GetInsightImpactGraph(ctx context.Context, params *GetInsightImpactGraphInput, optFns ...func(*Options)) (*GetInsightImpactGraphOutput, error) {
	if params == nil { params = &GetInsightImpactGraphInput{} }
...
func (c *Client) addOperationGetInsightImpactGraphMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetInsightImpactGraphResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetInsightImpactGraphResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetInsightImpactGraphResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetInsightImpactGraphResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetInsightImpactGraphResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetInsightImpactGraphResolveEndpointMiddleware{
