...
func (c *Client) addOperationGetRetrievedTracesGraphMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRetrievedTracesGraph", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
