...
func (c *Client) GetSamplingRules(ctx context.Context, params *GetSamplingRulesInput, optFns ...func(*Options)) (*GetSamplingRulesOutput, error) {
	if params == nil { params = &GetSamplingRulesInput{} }
...
func (c *Client) addOperationGetSamplingRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSamplingRulesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSamplingRulesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSamplingRulesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSamplingRulesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSamplingRulesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSamplingRulesResolveEndpointMiddleware{
