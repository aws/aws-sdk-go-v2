...
// by this update request. If you call the RegisterScalableTarget API operation
// to create a scalable target, there might be a brief delay until the operation
...
type RegisterScalableTargetInput struct {
	...
	//     - Spot Fleets
	//     - custom resources
	// It's strongly recommended that you specify a value
	...
	// average CPU utilization. For all other resources, the minimum allowed value
	// depends on the type of resource that you are using. If you provide a value that
	// is lower than what a resource can accept, an error occurs. In which case, the
	...
	// TagResourceoperation. Each tag consists of a tag key and a tag value. Both the
