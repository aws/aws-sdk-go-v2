...
type RegisterScalableTargetInput struct {
	...
	// - custom resources
	//
	// It's strongly recommended that you specify a
	// value greater than 0. A value greater than 0 means that data points are
	// continuously reported to CloudWatch that scaling policies can use to scale on a
	// metric like average CPU utilization. For all other resources, the minimum
