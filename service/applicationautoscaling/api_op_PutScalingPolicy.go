...
type PutScalingPolicyInput struct {
	...
	// The name of the scaling policy. You cannot change the name of a scaling
	// policy, but you can delete the original scaling policy and create a new scaling
	// policy with the same settings and a different name.
	//
	...
	// customized metrics. This parameter is required if you are creating a policy and
	// the policy type is TargetTrackingScaling .
