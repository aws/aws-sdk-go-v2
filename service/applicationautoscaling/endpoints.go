...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/applicationautoscaling/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "Application Auto Scaling", cfg.ConfigSources)
	if found && err == nil {
