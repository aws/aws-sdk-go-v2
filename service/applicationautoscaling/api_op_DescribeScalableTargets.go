...
// Gets information about the scalable targets in the specified namespace. You
// can filter the results using ResourceIds  and ScalableDimension .
...
type DescribeScalableTargetsInput struct {
	...
	// The default value is 50. If this parameter is used, the operation returns up to
