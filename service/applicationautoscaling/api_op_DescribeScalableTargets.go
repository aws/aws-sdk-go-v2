...
func (c *Client) addOperationDescribeScalableTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeScalableTargets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
