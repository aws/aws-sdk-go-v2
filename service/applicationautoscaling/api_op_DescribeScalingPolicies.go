...
// ScalableDimension , and PolicyNames . For more information, see Target
// tracking scaling policies (https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-target-tracking.html)
...
type DescribeScalingPoliciesInput struct {
	...
	// The default value is 10. If this parameter is used, the operation returns up to
	// MaxResults results at a time, along with a NextToken value. To get the next
	// set of results, include the NextToken value in a subsequent call. If this
	// parameter is not used, the operation returns up to 10 results and a NextToken
	// value, if applicable.
	MaxResults *int32
