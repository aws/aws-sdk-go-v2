...
func (c *Client) PutScheduledAction(ctx context.Context, params *PutScheduledActionInput, optFns ...func(*Options)) (*PutScheduledActionOutput, error) {
	if params == nil { params = &PutScheduledActionInput{} }
...
func (c *Client) addOperationPutScheduledActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutScheduledActionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutScheduledActionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutScheduledActionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutScheduledActionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutScheduledActionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutScheduledActionResolveEndpointMiddleware{
