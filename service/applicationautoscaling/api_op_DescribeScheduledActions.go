...
type DescribeScheduledActionsInput struct {
	...
	// and 50. The default value is 50. If this parameter is used, the operation
	// returns up to MaxResults  results at a time, along with a NextToken value. To
	// get the next set of results, include the NextToken value in a subsequent call.
	// If this parameter is not used, the operation returns up to 50 results and a
