...
func (c *Client) DescribeScheduledActions(ctx context.Context, params *DescribeScheduledActionsInput, optFns ...func(*Options)) (*DescribeScheduledActionsOutput, error) {
	...
	addawsAwsjson11_serdeOpDescribeScheduledActionsMiddlewares(stack)
...
func addawsAwsjson11_serdeOpDescribeScheduledActionsMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpDescribeScheduledActions{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpDescribeScheduledActions{}, middleware.After)
}
