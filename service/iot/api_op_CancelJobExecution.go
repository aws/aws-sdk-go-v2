...
// Cancels the execution of a job for a given thing. Requires permission to
// access the CancelJobExecution (https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsiot.html#awsiot-actions-as-permissions)
// action.
...
type CancelJobExecutionInput struct {
	...
	// and you do not set force  to true , then an InvalidStateTransitionException
	// will be thrown. The default is false. Canceling a job execution which is
