...
func (c *Client) RejectCertificateTransfer(ctx context.Context, params *RejectCertificateTransferInput, optFns ...func(*Options)) (*RejectCertificateTransferOutput, error) {
	if params == nil { params = &RejectCertificateTransferInput{} }
...
func (c *Client) addOperationRejectCertificateTransferMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRejectCertificateTransferResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRejectCertificateTransferResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRejectCertificateTransferResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRejectCertificateTransferResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRejectCertificateTransferResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRejectCertificateTransferResolveEndpointMiddleware{
