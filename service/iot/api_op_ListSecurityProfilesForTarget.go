...
func addOperationListSecurityProfilesForTargetStackSlots(stack *middleware.Stack) error {
...
func addOperationListSecurityProfilesForTargetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListSecurityProfilesForTargetStackSlots(stack); err != nil {
		return err
	}
