...
func (c *Client) addOperationDescribeAuditSuppressionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAuditSuppression", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
