...
func (c *Client) addOperationDescribeAccountAuditConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAccountAuditConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
