...
func (c *Client) addOperationListAuditMitigationActionsTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAuditMitigationActionsTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
