...
func (c *Client) ListAuditMitigationActionsTasks(ctx context.Context, params *ListAuditMitigationActionsTasksInput, optFns ...func(*Options)) (*ListAuditMitigationActionsTasksOutput, error) {
	if params == nil { params = &ListAuditMitigationActionsTasksInput{} }
...
func (c *Client) addOperationListAuditMitigationActionsTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAuditMitigationActionsTasksResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAuditMitigationActionsTasksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAuditMitigationActionsTasksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAuditMitigationActionsTasksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAuditMitigationActionsTasksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAuditMitigationActionsTasksResolveEndpointMiddleware{
