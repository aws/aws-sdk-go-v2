...
func (c *Client) SetLoggingOptions(ctx context.Context, params *SetLoggingOptionsInput, optFns ...func(*Options)) (*SetLoggingOptionsOutput, error) {
	stack := middleware.NewStack("SetLoggingOptions", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpSetLoggingOptionsMiddlewares(stack)
...
func addawsRestjson1_serdeOpSetLoggingOptionsMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpSetLoggingOptions{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpSetLoggingOptions{}, middleware.After)
}
