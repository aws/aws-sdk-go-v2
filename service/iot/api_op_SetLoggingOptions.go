...
func (*SetLoggingOptionsInput) operationName() string {
...
func (c *Client) addOperationSetLoggingOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetLoggingOptionsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opSetLoggingOptionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opSetLoggingOptionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetLoggingOptionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetLoggingOptionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opSetLoggingOptionsResolveEndpointMiddleware{
