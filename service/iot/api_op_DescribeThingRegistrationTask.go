...
func addOperationDescribeThingRegistrationTaskStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeThingRegistrationTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeThingRegistrationTaskStackSlots(stack); err != nil {
		return err
	}
