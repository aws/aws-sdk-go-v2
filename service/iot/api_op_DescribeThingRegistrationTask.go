...
func (c *Client) addOperationDescribeThingRegistrationTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeThingRegistrationTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
