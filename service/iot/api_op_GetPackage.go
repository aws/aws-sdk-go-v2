...
func (c *Client) GetPackage(ctx context.Context, params *GetPackageInput, optFns ...func(*Options)) (*GetPackageOutput, error) {
	if params == nil { params = &GetPackageInput{} }
...
func (c *Client) addOperationGetPackageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPackageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPackageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPackageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPackageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPackageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPackageResolveEndpointMiddleware{
