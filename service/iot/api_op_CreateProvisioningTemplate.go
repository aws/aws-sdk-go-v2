...
func (c *Client) addOperationCreateProvisioningTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateProvisioningTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
