...
func (c *Client) addOperationUpdateThingGroupsForThingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateThingGroupsForThing", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
