...
func (c *Client) addOperationListOutgoingCertificatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOutgoingCertificates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
