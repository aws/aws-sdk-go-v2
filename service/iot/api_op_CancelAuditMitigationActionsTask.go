...
func addOperationCancelAuditMitigationActionsTaskStackSlots(stack *middleware.Stack) error {
...
func addOperationCancelAuditMitigationActionsTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCancelAuditMitigationActionsTaskStackSlots(stack); err != nil {
		return err
	}
