...
func (c *Client) addOperationCancelAuditMitigationActionsTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelAuditMitigationActionsTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
