...
func (*CancelAuditMitigationActionsTaskInput) operationName() string {
...
func (c *Client) addOperationCancelAuditMitigationActionsTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelAuditMitigationActionsTaskResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCancelAuditMitigationActionsTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCancelAuditMitigationActionsTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelAuditMitigationActionsTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelAuditMitigationActionsTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCancelAuditMitigationActionsTaskResolveEndpointMiddleware{
