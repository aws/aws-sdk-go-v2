...
func (*AcceptCertificateTransferInput) operationName() string {
...
func (c *Client) addOperationAcceptCertificateTransferMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAcceptCertificateTransferResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAcceptCertificateTransferResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAcceptCertificateTransferResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAcceptCertificateTransferResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAcceptCertificateTransferResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAcceptCertificateTransferResolveEndpointMiddleware{
