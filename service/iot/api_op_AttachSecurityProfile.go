...
func (c *Client) AttachSecurityProfile(ctx context.Context, params *AttachSecurityProfileInput, optFns ...func(*Options)) (*AttachSecurityProfileOutput, error) {
	if params == nil { params = &AttachSecurityProfileInput{} }
...
func (c *Client) addOperationAttachSecurityProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAttachSecurityProfileResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAttachSecurityProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAttachSecurityProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAttachSecurityProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAttachSecurityProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAttachSecurityProfileResolveEndpointMiddleware{
