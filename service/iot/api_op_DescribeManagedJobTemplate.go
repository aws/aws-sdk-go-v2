...
func (c *Client) addOperationDescribeManagedJobTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeManagedJobTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
