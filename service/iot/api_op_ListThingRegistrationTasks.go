...
func (c *Client) addOperationListThingRegistrationTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListThingRegistrationTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
