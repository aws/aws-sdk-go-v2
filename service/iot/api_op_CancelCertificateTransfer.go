...
func (*CancelCertificateTransferInput) operationName() string {
...
func (c *Client) addOperationCancelCertificateTransferMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelCertificateTransferResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCancelCertificateTransferResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCancelCertificateTransferResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelCertificateTransferResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelCertificateTransferResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCancelCertificateTransferResolveEndpointMiddleware{
