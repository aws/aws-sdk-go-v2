...
func (*ConfirmTopicRuleDestinationInput) operationName() string {
...
func (c *Client) addOperationConfirmTopicRuleDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addConfirmTopicRuleDestinationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opConfirmTopicRuleDestinationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opConfirmTopicRuleDestinationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opConfirmTopicRuleDestinationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addConfirmTopicRuleDestinationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opConfirmTopicRuleDestinationResolveEndpointMiddleware{
