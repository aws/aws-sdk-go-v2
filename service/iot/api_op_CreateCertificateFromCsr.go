...
// to create a batch of certificates given a batch of CSRs. In the following
// commands, we assume that a set of CSRs are located inside of the directory
// my-csr-directory: On Linux and OS X, the command is: $ ls my-csr-directory/ |
...
// create-certificate-from-csrAmazon Web Services CLI command to create a
// certificate for the corresponding CSR. You can also run the aws iot
// create-certificate-from-csrpart of the command in parallel to speed up the
