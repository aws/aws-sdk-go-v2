...
func (c *Client) addOperationCreateCertificateFromCsrMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCertificateFromCsr", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
