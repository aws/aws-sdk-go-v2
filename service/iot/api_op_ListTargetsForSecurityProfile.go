...
func addOperationListTargetsForSecurityProfileStackSlots(stack *middleware.Stack) error {
...
func addOperationListTargetsForSecurityProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListTargetsForSecurityProfileStackSlots(stack); err != nil {
		return err
	}
