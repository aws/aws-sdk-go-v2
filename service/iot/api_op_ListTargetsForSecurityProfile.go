...
func (c *Client) addOperationListTargetsForSecurityProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTargetsForSecurityProfile", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
