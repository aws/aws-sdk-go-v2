...
func (*ListTargetsForSecurityProfileInput) operationName() string {
...
func (c *Client) addOperationListTargetsForSecurityProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTargetsForSecurityProfileResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListTargetsForSecurityProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListTargetsForSecurityProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTargetsForSecurityProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTargetsForSecurityProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListTargetsForSecurityProfileResolveEndpointMiddleware{
