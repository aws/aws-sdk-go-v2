...
func (c *Client) GetTopicRule(ctx context.Context, params *GetTopicRuleInput, optFns ...func(*Options)) (*GetTopicRuleOutput, error) {
	if params == nil { params = &GetTopicRuleInput{} }
...
func (c *Client) addOperationGetTopicRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTopicRuleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetTopicRuleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetTopicRuleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTopicRuleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTopicRuleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetTopicRuleResolveEndpointMiddleware{
