...
func (c *Client) addOperationListDomainConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDomainConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
