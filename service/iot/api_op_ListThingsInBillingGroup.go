...
func (c *Client) addOperationListThingsInBillingGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListThingsInBillingGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
