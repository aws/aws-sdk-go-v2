...
func (*DeleteCustomMetricInput) operationName() string {
...
func (c *Client) addOperationDeleteCustomMetricMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCustomMetricResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteCustomMetricResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteCustomMetricResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCustomMetricResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCustomMetricResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteCustomMetricResolveEndpointMiddleware{
