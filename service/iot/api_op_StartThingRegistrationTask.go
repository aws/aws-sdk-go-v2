...
func (c *Client) addOperationStartThingRegistrationTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartThingRegistrationTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
