...
func (c *Client) EnableTopicRule(ctx context.Context, params *EnableTopicRuleInput, optFns ...func(*Options)) (*EnableTopicRuleOutput, error) {
	if params == nil { params = &EnableTopicRuleInput{} }
...
func (c *Client) addOperationEnableTopicRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableTopicRuleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEnableTopicRuleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEnableTopicRuleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableTopicRuleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableTopicRuleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEnableTopicRuleResolveEndpointMiddleware{
