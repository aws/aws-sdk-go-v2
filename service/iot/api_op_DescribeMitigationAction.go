...
func (c *Client) addOperationDescribeMitigationActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMitigationAction", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
