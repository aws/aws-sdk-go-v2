...
func (c *Client) addOperationDescribeProvisioningTemplateVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeProvisioningTemplateVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
