...
func (c *Client) addOperationListCertificateProvidersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCertificateProviders", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
