...
func (c *Client) addOperationUpdateEventConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateEventConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
