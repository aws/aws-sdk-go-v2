...
func addOperationListAuditMitigationActionsExecutionsStackSlots(stack *middleware.Stack) error {
...
func addOperationListAuditMitigationActionsExecutionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListAuditMitigationActionsExecutionsStackSlots(stack); err != nil {
		return err
	}
