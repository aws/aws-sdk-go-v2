...
func (c *Client) addOperationUpdateAccountAuditConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAccountAuditConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
