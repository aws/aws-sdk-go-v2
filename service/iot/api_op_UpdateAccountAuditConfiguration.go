...
func addOperationUpdateAccountAuditConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateAccountAuditConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateAccountAuditConfigurationStackSlots(stack); err != nil {
		return err
	}
