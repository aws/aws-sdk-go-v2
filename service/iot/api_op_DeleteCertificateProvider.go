...
func (c *Client) addOperationDeleteCertificateProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteCertificateProvider", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
