...
func (c *Client) ListActiveViolations(ctx context.Context, params *ListActiveViolationsInput, optFns ...func(*Options)) (*ListActiveViolationsOutput, error) {
	if params == nil { params = &ListActiveViolationsInput{} }
...
func (c *Client) addOperationListActiveViolationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListActiveViolationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListActiveViolationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListActiveViolationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListActiveViolationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListActiveViolationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListActiveViolationsResolveEndpointMiddleware{
