...
func (c *Client) addOperationListRelatedResourcesForAuditFindingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRelatedResourcesForAuditFinding", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
