...
func (c *Client) addOperationListManagedJobTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListManagedJobTemplates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
