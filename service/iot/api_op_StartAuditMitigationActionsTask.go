...
func (c *Client) addOperationStartAuditMitigationActionsTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartAuditMitigationActionsTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
