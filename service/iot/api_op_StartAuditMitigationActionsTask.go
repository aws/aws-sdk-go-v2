...
func addOperationStartAuditMitigationActionsTaskStackSlots(stack *middleware.Stack) error {
...
func addOperationStartAuditMitigationActionsTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartAuditMitigationActionsTaskStackSlots(stack); err != nil {
		return err
	}
