...
func (c *Client) DeleteDimension(ctx context.Context, params *DeleteDimensionInput, optFns ...func(*Options)) (*DeleteDimensionOutput, error) {
	if params == nil { params = &DeleteDimensionInput{} }
...
func (c *Client) addOperationDeleteDimensionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteDimensionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteDimensionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteDimensionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteDimensionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteDimensionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteDimensionResolveEndpointMiddleware{
