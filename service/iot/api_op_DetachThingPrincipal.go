...
func (c *Client) DetachThingPrincipal(ctx context.Context, params *DetachThingPrincipalInput, optFns ...func(*Options)) (*DetachThingPrincipalOutput, error) {
	if params == nil { params = &DetachThingPrincipalInput{} }
...
func (c *Client) addOperationDetachThingPrincipalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDetachThingPrincipalResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDetachThingPrincipalResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDetachThingPrincipalResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDetachThingPrincipalResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDetachThingPrincipalResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDetachThingPrincipalResolveEndpointMiddleware{
