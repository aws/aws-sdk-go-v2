...
func addOperationDeleteAccountAuditConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteAccountAuditConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteAccountAuditConfigurationStackSlots(stack); err != nil {
		return err
	}
