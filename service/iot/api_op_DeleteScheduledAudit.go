...
func (*DeleteScheduledAuditInput) operationName() string {
...
func (c *Client) addOperationDeleteScheduledAuditMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteScheduledAuditResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteScheduledAuditResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteScheduledAuditResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteScheduledAuditResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteScheduledAuditResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteScheduledAuditResolveEndpointMiddleware{
