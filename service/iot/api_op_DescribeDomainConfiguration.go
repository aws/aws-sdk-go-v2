...
func addOperationDescribeDomainConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeDomainConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeDomainConfigurationStackSlots(stack); err != nil {
		return err
	}
