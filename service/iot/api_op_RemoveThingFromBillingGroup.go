...
func addOperationRemoveThingFromBillingGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationRemoveThingFromBillingGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRemoveThingFromBillingGroupStackSlots(stack); err != nil {
		return err
	}
