...
func (c *Client) addOperationRemoveThingFromBillingGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RemoveThingFromBillingGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
