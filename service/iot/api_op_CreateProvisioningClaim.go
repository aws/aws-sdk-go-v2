...
func (c *Client) addOperationCreateProvisioningClaimMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateProvisioningClaim", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
