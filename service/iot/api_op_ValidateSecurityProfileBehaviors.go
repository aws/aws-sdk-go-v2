...
func (c *Client) addOperationValidateSecurityProfileBehaviorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ValidateSecurityProfileBehaviors", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
