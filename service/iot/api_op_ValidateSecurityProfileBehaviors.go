...
func (c *Client) ValidateSecurityProfileBehaviors(ctx context.Context, params *ValidateSecurityProfileBehaviorsInput, optFns ...func(*Options)) (*ValidateSecurityProfileBehaviorsOutput, error) {
	if params == nil { params = &ValidateSecurityProfileBehaviorsInput{} }
...
func (c *Client) addOperationValidateSecurityProfileBehaviorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addValidateSecurityProfileBehaviorsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opValidateSecurityProfileBehaviorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opValidateSecurityProfileBehaviorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opValidateSecurityProfileBehaviorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addValidateSecurityProfileBehaviorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opValidateSecurityProfileBehaviorsResolveEndpointMiddleware{
