...
func addOperationDescribeEventConfigurationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeEventConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeEventConfigurationsStackSlots(stack); err != nil {
		return err
	}
