...
func addOperationUpdateProvisioningTemplateStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateProvisioningTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateProvisioningTemplateStackSlots(stack); err != nil {
		return err
	}
