...
func (c *Client) addOperationUpdateProvisioningTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateProvisioningTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
