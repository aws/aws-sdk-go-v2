...
func (c *Client) addOperationListProvisioningTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListProvisioningTemplates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
