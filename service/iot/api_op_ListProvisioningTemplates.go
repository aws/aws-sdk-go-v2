...
func (c *Client) ListProvisioningTemplates(ctx context.Context, params *ListProvisioningTemplatesInput, optFns ...func(*Options)) (*ListProvisioningTemplatesOutput, error) {
	if params == nil { params = &ListProvisioningTemplatesInput{} }
...
func (c *Client) addOperationListProvisioningTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListProvisioningTemplatesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListProvisioningTemplatesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListProvisioningTemplatesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListProvisioningTemplatesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListProvisioningTemplatesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListProvisioningTemplatesResolveEndpointMiddleware{
