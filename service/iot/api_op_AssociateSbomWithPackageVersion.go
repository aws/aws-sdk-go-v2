...
func (c *Client) AssociateSbomWithPackageVersion(ctx context.Context, params *AssociateSbomWithPackageVersionInput, optFns ...func(*Options)) (*AssociateSbomWithPackageVersionOutput, error) {
	if params == nil { params = &AssociateSbomWithPackageVersionInput{} }
...
func (m *idempotencyToken_initializeOpAssociateSbomWithPackageVersion) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *AssociateSbomWithPackageVersionInput ")}
