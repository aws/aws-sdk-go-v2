...
func (c *Client) ListMitigationActions(ctx context.Context, params *ListMitigationActionsInput, optFns ...func(*Options)) (*ListMitigationActionsOutput, error) {
	stack := middleware.NewStack("ListMitigationActions", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpListMitigationActionsMiddlewares(stack)
...
func addawsRestjson1_serdeOpListMitigationActionsMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpListMitigationActions{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpListMitigationActions{}, middleware.After)
}
