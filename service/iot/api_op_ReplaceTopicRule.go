...
func (c *Client) ReplaceTopicRule(ctx context.Context, params *ReplaceTopicRuleInput, optFns ...func(*Options)) (*ReplaceTopicRuleOutput, error) {
	if params == nil { params = &ReplaceTopicRuleInput{} }
...
func (c *Client) addOperationReplaceTopicRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addReplaceTopicRuleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opReplaceTopicRuleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opReplaceTopicRuleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opReplaceTopicRuleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addReplaceTopicRuleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opReplaceTopicRuleResolveEndpointMiddleware{
