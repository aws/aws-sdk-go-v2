...
func (*DetachPrincipalPolicyInput) operationName() string {
...
func (c *Client) addOperationDetachPrincipalPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDetachPrincipalPolicyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDetachPrincipalPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDetachPrincipalPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDetachPrincipalPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDetachPrincipalPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDetachPrincipalPolicyResolveEndpointMiddleware{
