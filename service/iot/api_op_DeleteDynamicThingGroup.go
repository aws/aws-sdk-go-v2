...
func (c *Client) addOperationDeleteDynamicThingGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDynamicThingGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
