...
func (c *Client) AttachThingPrincipal(ctx context.Context, params *AttachThingPrincipalInput, optFns ...func(*Options)) (*AttachThingPrincipalOutput, error) {
	if params == nil { params = &AttachThingPrincipalInput{} }
...
func (c *Client) addOperationAttachThingPrincipalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAttachThingPrincipalResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAttachThingPrincipalResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAttachThingPrincipalResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAttachThingPrincipalResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAttachThingPrincipalResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAttachThingPrincipalResolveEndpointMiddleware{
