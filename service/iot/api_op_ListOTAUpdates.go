...
func (c *Client) ListOTAUpdates(ctx context.Context, params *ListOTAUpdatesInput, optFns ...func(*Options)) (*ListOTAUpdatesOutput, error) {
	if params == nil { params = &ListOTAUpdatesInput{} }
...
func (c *Client) addOperationListOTAUpdatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListOTAUpdatesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListOTAUpdatesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListOTAUpdatesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListOTAUpdatesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListOTAUpdatesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListOTAUpdatesResolveEndpointMiddleware{
