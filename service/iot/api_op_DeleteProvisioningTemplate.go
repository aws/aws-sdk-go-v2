...
func (c *Client) addOperationDeleteProvisioningTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteProvisioningTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
