...
func (c *Client) addOperationStartDetectMitigationActionsTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartDetectMitigationActionsTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
