...
func (c *Client) addOperationCreateDynamicThingGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateDynamicThingGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
