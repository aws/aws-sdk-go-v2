...
func (c *Client) DescribeDetectMitigationActionsTask(ctx context.Context, params *DescribeDetectMitigationActionsTaskInput, optFns ...func(*Options)) (*DescribeDetectMitigationActionsTaskOutput, error) {
	if params == nil { params = &DescribeDetectMitigationActionsTaskInput{} }
...
func (c *Client) addOperationDescribeDetectMitigationActionsTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeDetectMitigationActionsTaskResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeDetectMitigationActionsTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeDetectMitigationActionsTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeDetectMitigationActionsTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeDetectMitigationActionsTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeDetectMitigationActionsTaskResolveEndpointMiddleware{
