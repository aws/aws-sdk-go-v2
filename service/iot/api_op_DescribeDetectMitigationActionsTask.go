...
func (c *Client) addOperationDescribeDetectMitigationActionsTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDetectMitigationActionsTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
