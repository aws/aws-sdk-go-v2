...
func (c *Client) addOperationPutVerificationStateOnViolationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutVerificationStateOnViolation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
