...
func (c *Client) PutVerificationStateOnViolation(ctx context.Context, params *PutVerificationStateOnViolationInput, optFns ...func(*Options)) (*PutVerificationStateOnViolationOutput, error) {
	if params == nil { params = &PutVerificationStateOnViolationInput{} }
...
func (c *Client) addOperationPutVerificationStateOnViolationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutVerificationStateOnViolationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutVerificationStateOnViolationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutVerificationStateOnViolationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutVerificationStateOnViolationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutVerificationStateOnViolationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutVerificationStateOnViolationResolveEndpointMiddleware{
