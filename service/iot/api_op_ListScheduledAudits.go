...
func (c *Client) ListScheduledAudits(ctx context.Context, params *ListScheduledAuditsInput, optFns ...func(*Options)) (*ListScheduledAuditsOutput, error) {
	if params == nil { params = &ListScheduledAuditsInput{} }
...
func (c *Client) addOperationListScheduledAuditsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListScheduledAuditsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListScheduledAuditsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListScheduledAuditsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListScheduledAuditsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListScheduledAuditsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListScheduledAuditsResolveEndpointMiddleware{
