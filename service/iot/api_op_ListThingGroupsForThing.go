...
func (c *Client) addOperationListThingGroupsForThingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListThingGroupsForThing", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
