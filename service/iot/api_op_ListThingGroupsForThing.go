...
func (*ListThingGroupsForThingInput) operationName() string {
...
func (c *Client) addOperationListThingGroupsForThingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListThingGroupsForThingResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListThingGroupsForThingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListThingGroupsForThingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListThingGroupsForThingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListThingGroupsForThingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListThingGroupsForThingResolveEndpointMiddleware{
