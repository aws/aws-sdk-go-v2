...
func (c *Client) ListDetectMitigationActionsTasks(ctx context.Context, params *ListDetectMitigationActionsTasksInput, optFns ...func(*Options)) (*ListDetectMitigationActionsTasksOutput, error) {
	if params == nil { params = &ListDetectMitigationActionsTasksInput{} }
...
func (c *Client) addOperationListDetectMitigationActionsTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDetectMitigationActionsTasksResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDetectMitigationActionsTasksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDetectMitigationActionsTasksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDetectMitigationActionsTasksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDetectMitigationActionsTasksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDetectMitigationActionsTasksResolveEndpointMiddleware{
