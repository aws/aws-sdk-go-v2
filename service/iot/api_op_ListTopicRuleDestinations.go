...
func (c *Client) addOperationListTopicRuleDestinationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTopicRuleDestinations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
