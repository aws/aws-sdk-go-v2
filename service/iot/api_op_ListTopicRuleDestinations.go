...
func (*ListTopicRuleDestinationsInput) operationName() string {
...
func (c *Client) addOperationListTopicRuleDestinationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTopicRuleDestinationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListTopicRuleDestinationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListTopicRuleDestinationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTopicRuleDestinationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTopicRuleDestinationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListTopicRuleDestinationsResolveEndpointMiddleware{
