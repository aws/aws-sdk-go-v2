...
func addOperationDeleteProvisioningTemplateVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteProvisioningTemplateVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteProvisioningTemplateVersionStackSlots(stack); err != nil {
		return err
	}
