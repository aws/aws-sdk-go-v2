...
func (c *Client) DeleteProvisioningTemplateVersion(ctx context.Context, params *DeleteProvisioningTemplateVersionInput, optFns ...func(*Options)) (*DeleteProvisioningTemplateVersionOutput, error) {
	if params == nil { params = &DeleteProvisioningTemplateVersionInput{} }
...
func (c *Client) addOperationDeleteProvisioningTemplateVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteProvisioningTemplateVersionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteProvisioningTemplateVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteProvisioningTemplateVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteProvisioningTemplateVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteProvisioningTemplateVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteProvisioningTemplateVersionResolveEndpointMiddleware{
