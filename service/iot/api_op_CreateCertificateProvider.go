...
func (c *Client) addOperationCreateCertificateProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCertificateProvider", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
