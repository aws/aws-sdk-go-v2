...
func (c *Client) GetRegistrationCode(ctx context.Context, params *GetRegistrationCodeInput, optFns ...func(*Options)) (*GetRegistrationCodeOutput, error) {
	if params == nil { params = &GetRegistrationCodeInput{} }
...
func (c *Client) addOperationGetRegistrationCodeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRegistrationCodeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRegistrationCodeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRegistrationCodeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRegistrationCodeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRegistrationCodeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRegistrationCodeResolveEndpointMiddleware{
