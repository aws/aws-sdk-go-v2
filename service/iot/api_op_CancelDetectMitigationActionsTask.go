...
func (*CancelDetectMitigationActionsTaskInput) operationName() string {
...
func (c *Client) addOperationCancelDetectMitigationActionsTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelDetectMitigationActionsTaskResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCancelDetectMitigationActionsTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCancelDetectMitigationActionsTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelDetectMitigationActionsTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelDetectMitigationActionsTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCancelDetectMitigationActionsTaskResolveEndpointMiddleware{
