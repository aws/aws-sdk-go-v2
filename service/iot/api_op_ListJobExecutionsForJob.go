...
func (*ListJobExecutionsForJobInput) operationName() string {
...
func (c *Client) addOperationListJobExecutionsForJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListJobExecutionsForJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListJobExecutionsForJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListJobExecutionsForJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListJobExecutionsForJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListJobExecutionsForJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListJobExecutionsForJobResolveEndpointMiddleware{
