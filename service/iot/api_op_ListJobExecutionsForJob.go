...
func (c *Client) addOperationListJobExecutionsForJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListJobExecutionsForJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
