...
func (c *Client) addOperationGetThingConnectivityDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetThingConnectivityData", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
