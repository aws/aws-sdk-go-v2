...
func addOperationRegisterCertificateWithoutCAStackSlots(stack *middleware.Stack) error {
...
func addOperationRegisterCertificateWithoutCAMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRegisterCertificateWithoutCAStackSlots(stack); err != nil {
		return err
	}
