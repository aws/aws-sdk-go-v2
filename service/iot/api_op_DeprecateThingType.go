...
func (c *Client) DeprecateThingType(ctx context.Context, params *DeprecateThingTypeInput, optFns ...func(*Options)) (*DeprecateThingTypeOutput, error) {
	if params == nil { params = &DeprecateThingTypeInput{} }
...
func (c *Client) addOperationDeprecateThingTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeprecateThingTypeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeprecateThingTypeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeprecateThingTypeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeprecateThingTypeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeprecateThingTypeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeprecateThingTypeResolveEndpointMiddleware{
