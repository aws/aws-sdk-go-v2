...
func (*DeleteAuditSuppressionInput) operationName() string {
...
func (c *Client) addOperationDeleteAuditSuppressionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAuditSuppressionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteAuditSuppressionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteAuditSuppressionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteAuditSuppressionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAuditSuppressionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteAuditSuppressionResolveEndpointMiddleware{
