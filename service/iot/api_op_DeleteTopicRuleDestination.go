...
func (*DeleteTopicRuleDestinationInput) operationName() string {
...
func (c *Client) addOperationDeleteTopicRuleDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteTopicRuleDestinationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteTopicRuleDestinationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteTopicRuleDestinationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteTopicRuleDestinationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteTopicRuleDestinationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteTopicRuleDestinationResolveEndpointMiddleware{
