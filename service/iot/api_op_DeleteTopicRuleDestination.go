...
func addOperationDeleteTopicRuleDestinationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteTopicRuleDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteTopicRuleDestinationStackSlots(stack); err != nil {
		return err
	}
