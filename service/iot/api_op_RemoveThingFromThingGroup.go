...
func (*RemoveThingFromThingGroupInput) operationName() string {
...
func (c *Client) addOperationRemoveThingFromThingGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRemoveThingFromThingGroupResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRemoveThingFromThingGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRemoveThingFromThingGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRemoveThingFromThingGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRemoveThingFromThingGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRemoveThingFromThingGroupResolveEndpointMiddleware{
