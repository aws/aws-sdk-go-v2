...
func (*ListPrincipalThingsInput) operationName() string {
...
func (c *Client) addOperationListPrincipalThingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPrincipalThingsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListPrincipalThingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListPrincipalThingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPrincipalThingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPrincipalThingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListPrincipalThingsResolveEndpointMiddleware{
