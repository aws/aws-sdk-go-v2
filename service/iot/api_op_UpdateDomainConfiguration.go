...
func (c *Client) addOperationUpdateDomainConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDomainConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
