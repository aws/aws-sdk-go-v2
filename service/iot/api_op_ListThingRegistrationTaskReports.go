...
func (*ListThingRegistrationTaskReportsInput) operationName() string {
...
func (c *Client) addOperationListThingRegistrationTaskReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListThingRegistrationTaskReportsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListThingRegistrationTaskReportsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListThingRegistrationTaskReportsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListThingRegistrationTaskReportsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListThingRegistrationTaskReportsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListThingRegistrationTaskReportsResolveEndpointMiddleware{
