...
func (c *Client) addOperationListThingRegistrationTaskReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListThingRegistrationTaskReports", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
