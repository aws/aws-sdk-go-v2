...
// The service endpoints that expose this API are listed in Amazon Web Services IoT
// Core Endpoints and Quotas
...
// name used by Amazon Web Services Signature Version 4
// (https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html) to sign
// the request is: execute-api. For more information about how IoT works, see the
// Developer Guide
