...
func (c *Client) addOperationUpdateDynamicThingGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDynamicThingGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
