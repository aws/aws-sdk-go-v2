...
func (*GetTopicRuleDestinationInput) operationName() string {
...
func (c *Client) addOperationGetTopicRuleDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTopicRuleDestinationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetTopicRuleDestinationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetTopicRuleDestinationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTopicRuleDestinationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTopicRuleDestinationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetTopicRuleDestinationResolveEndpointMiddleware{
