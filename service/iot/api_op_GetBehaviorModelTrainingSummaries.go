...
func (c *Client) GetBehaviorModelTrainingSummaries(ctx context.Context, params *GetBehaviorModelTrainingSummariesInput, optFns ...func(*Options)) (*GetBehaviorModelTrainingSummariesOutput, error) {
	if params == nil { params = &GetBehaviorModelTrainingSummariesInput{} }
...
func (c *Client) addOperationGetBehaviorModelTrainingSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBehaviorModelTrainingSummariesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetBehaviorModelTrainingSummariesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetBehaviorModelTrainingSummariesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetBehaviorModelTrainingSummariesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBehaviorModelTrainingSummariesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetBehaviorModelTrainingSummariesResolveEndpointMiddleware{
