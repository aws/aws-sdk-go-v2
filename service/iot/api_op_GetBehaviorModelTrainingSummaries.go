...
func (c *Client) addOperationGetBehaviorModelTrainingSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetBehaviorModelTrainingSummaries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
