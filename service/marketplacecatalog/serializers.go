...
type awsRestjson1_serializeOpDescribeAssessment struct {
}

func (*awsRestjson1_serializeOpDescribeAssessment) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpDescribeAssessment) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/DescribeAssessment")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "POST"
	var restEncoder *httpbinding.Encoder
	...
	jsonEncoder := smithyjson.NewEncoder()
	if err := awsRestjson1_serializeOpDocumentDescribeAssessmentInput(input, jsonEncoder.Value); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsDescribeAssessmentInput(v *DescribeAssessmentInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
func awsRestjson1_serializeOpDocumentDescribeAssessmentInput(v *DescribeAssessmentInput, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.AssessmentIdentifier != nil {
		ok := object.Key("AssessmentIdentifier")
		ok.String(*v.AssessmentIdentifier)
	}
...
func (m *awsRestjson1_serializeOpListAssessments) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	...
	opPath, opQuery := httpbinding.SplitURI("/ListAssessments")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "POST"
	var restEncoder *httpbinding.Encoder
	...
	jsonEncoder := smithyjson.NewEncoder()
	if err := awsRestjson1_serializeOpDocumentListAssessmentsInput(input, jsonEncoder.Value); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpDocumentListAssessmentsInput(v *ListAssessmentsInput, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.AssessmentTargetFilter != nil {
		ok := object.Key("AssessmentTargetFilter")
		if err := awsRestjson1_serializeDocumentAssessmentTargetFilter(v.AssessmentTargetFilter, ok); err != nil {
			return err
		}
	}
	...
	if v.FrameworkFilters != nil {
		ok := object.Key("FrameworkFilters")
		if err := awsRestjson1_serializeDocumentFrameworkFilters(v.FrameworkFilters, ok); err != nil {
			return err
		}
	}
...
func awsRestjson1_serializeDocumentAMISecurityFilters(v *types.AMISecurityFilters, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.DeliveryOptionId != nil {
		ok := object.Key("DeliveryOptionId")
		ok.String(*v.DeliveryOptionId)
	}

	return nil
}

func awsRestjson1_serializeDocumentAssessmentTargetFilter(v *types.AssessmentTargetFilter, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
...
func awsRestjson1_serializeDocumentContainerSecurityFilters(v *types.ContainerSecurityFilters, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
...
func awsRestjson1_serializeDocumentEntityTypeFilters(v types.EntityTypeFilters, value smithyjson.Value) error {
	...
	case *types.EntityTypeFiltersMemberOfferSetFilters:
		av := object.Key("OfferSetFilters")
		if err := awsRestjson1_serializeDocumentOfferSetFilters(&uv.Value, av); err != nil {
			return err
		}
...
func awsRestjson1_serializeDocumentEntityTypeSort(v types.EntityTypeSort, value smithyjson.Value) error {
	...
	case *types.EntityTypeSortMemberOfferSetSort:
		av := object.Key("OfferSetSort")
		if err := awsRestjson1_serializeDocumentOfferSetSort(&uv.Value, av); err != nil {
			return err
		}
...
func awsRestjson1_serializeDocumentFrameworkFilters(v types.FrameworkFilters, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	switch uv := v.(type) {
	case *types.FrameworkFiltersMemberAMISecurityFilters:
		av := object.Key("AMISecurityFilters")
		if err := awsRestjson1_serializeDocumentAMISecurityFilters(&uv.Value, av); err != nil {
			return err
		}

	case *types.FrameworkFiltersMemberContainerSecurityFilters:
		av := object.Key("ContainerSecurityFilters")
		if err := awsRestjson1_serializeDocumentContainerSecurityFilters(&uv.Value, av); err != nil {
			return err
		}
...
func awsRestjson1_serializeDocumentOfferFilters(v *types.OfferFilters, value smithyjson.Value) error {
	...
	if v.OfferSetId != nil {
		...
		if err := awsRestjson1_serializeDocumentOfferSetIdFilter(v.OfferSetId, ok); err != nil {
			return err
		}
	}
...
func awsRestjson1_serializeDocumentOfferSetAssociatedOfferIdsFilter(v *types.OfferSetAssociatedOfferIdsFilter, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.ValueList != nil {
		ok := object.Key("ValueList")
		if err := awsRestjson1_serializeDocumentOfferSetAssociatedOfferIdsFilterValueList(v.ValueList, ok); err != nil {
			return err
		}
	}
...
func awsRestjson1_serializeDocumentOfferSetAssociatedOfferIdsFilterValueList(v []string, value smithyjson.Value) error {
	array := value.Array()
	defer array.Close()
...
func awsRestjson1_serializeDocumentOfferSetEntityIdFilter(v *types.OfferSetEntityIdFilter, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.ValueList != nil {
		ok := object.Key("ValueList")
		if err := awsRestjson1_serializeDocumentOfferSetEntityIdFilterValueList(v.ValueList, ok); err != nil {
			return err
		}
	}
...
func awsRestjson1_serializeDocumentOfferSetEntityIdFilterValueList(v []string, value smithyjson.Value) error {
	array := value.Array()
	defer array.Close()
...
func awsRestjson1_serializeDocumentOfferSetFilters(v *types.OfferSetFilters, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.AssociatedOfferIds != nil {
		ok := object.Key("AssociatedOfferIds")
		if err := awsRestjson1_serializeDocumentOfferSetAssociatedOfferIdsFilter(v.AssociatedOfferIds, ok); err != nil {
			return err
		}
	}
	...
	if v.EntityId != nil {
		ok := object.Key("EntityId")
		if err := awsRestjson1_serializeDocumentOfferSetEntityIdFilter(v.EntityId, ok); err != nil {
			return err
		}
	}
	...
	if v.LastModifiedDate != nil {
		ok := object.Key("LastModifiedDate")
		if err := awsRestjson1_serializeDocumentOfferSetLastModifiedDateFilter(v.LastModifiedDate, ok); err != nil {
			return err
		}
	}
	...
	if v.Name != nil {
		ok := object.Key("Name")
		if err := awsRestjson1_serializeDocumentOfferSetNameFilter(v.Name, ok); err != nil {
			return err
		}
	}
	...
	if v.ReleaseDate != nil {
		ok := object.Key("ReleaseDate")
		if err := awsRestjson1_serializeDocumentOfferSetReleaseDateFilter(v.ReleaseDate, ok); err != nil {
			return err
		}
	}

	if v.SolutionId != nil {
		ok := object.Key("SolutionId")
		if err := awsRestjson1_serializeDocumentOfferSetSolutionIdFilter(v.SolutionId, ok); err != nil {
			return err
		}
	}
	...
	if v.State != nil {
		ok := object.Key("State")
		if err := awsRestjson1_serializeDocumentOfferSetStateFilter(v.State, ok); err != nil {
			return err
		}
	}
...
func awsRestjson1_serializeDocumentOfferSetIdFilter(v *types.OfferSetIdFilter, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.ValueList != nil {
		ok := object.Key("ValueList")
		if err := awsRestjson1_serializeDocumentOfferSetIdFilterValueList(v.ValueList, ok); err != nil {
			return err
		}
	}
...
func awsRestjson1_serializeDocumentOfferSetIdFilterValueList(v []string, value smithyjson.Value) error {
	array := value.Array()
	defer array.Close()
...
func awsRestjson1_serializeDocumentOfferSetLastModifiedDateFilter(v *types.OfferSetLastModifiedDateFilter, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.DateRange != nil {
		ok := object.Key("DateRange")
		if err := awsRestjson1_serializeDocumentOfferSetLastModifiedDateFilterDateRange(v.DateRange, ok); err != nil {
			return err
		}
	}
...
func awsRestjson1_serializeDocumentOfferSetLastModifiedDateFilterDateRange(v *types.OfferSetLastModifiedDateFilterDateRange, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
...
func awsRestjson1_serializeDocumentOfferSetNameFilter(v *types.OfferSetNameFilter, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.ValueList != nil {
		ok := object.Key("ValueList")
		if err := awsRestjson1_serializeDocumentOfferSetNameFilterValueList(v.ValueList, ok); err != nil {
			return err
		}
	}
...
func awsRestjson1_serializeDocumentOfferSetNameFilterValueList(v []string, value smithyjson.Value) error {
	array := value.Array()
	defer array.Close()
...
func awsRestjson1_serializeDocumentOfferSetReleaseDateFilter(v *types.OfferSetReleaseDateFilter, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.DateRange != nil {
		ok := object.Key("DateRange")
		if err := awsRestjson1_serializeDocumentOfferSetReleaseDateFilterDateRange(v.DateRange, ok); err != nil {
			return err
		}
	}
...
func awsRestjson1_serializeDocumentOfferSetReleaseDateFilterDateRange(v *types.OfferSetReleaseDateFilterDateRange, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
...
func awsRestjson1_serializeDocumentOfferSetSolutionIdFilter(v *types.OfferSetSolutionIdFilter, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.ValueList != nil {
		ok := object.Key("ValueList")
		if err := awsRestjson1_serializeDocumentOfferSetSolutionIdFilterValueList(v.ValueList, ok); err != nil {
			return err
		}
	}
...
func awsRestjson1_serializeDocumentOfferSetSolutionIdFilterValueList(v []string, value smithyjson.Value) error {
	array := value.Array()
	defer array.Close()
...
func awsRestjson1_serializeDocumentOfferSetSort(v *types.OfferSetSort, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
...
func awsRestjson1_serializeDocumentOfferSetStateFilter(v *types.OfferSetStateFilter, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.ValueList != nil {
		ok := object.Key("ValueList")
		if err := awsRestjson1_serializeDocumentOfferSetStateFilterValueList(v.ValueList, ok); err != nil {
			return err
		}
	}
...
func awsRestjson1_serializeDocumentOfferSetStateFilterValueList(v []types.OfferSetStateString, value smithyjson.Value) error {
	array := value.Array()
	defer array.Close()
