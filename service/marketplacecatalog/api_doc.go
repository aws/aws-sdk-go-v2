...
// requests to AWS Marketplace Catalog.
//
...
// Using the Client
//
// To use AWS Marketplace Catalog with the SDK use the New function to create
...
//
// See the AWS Marketplace Catalog client for more information on
