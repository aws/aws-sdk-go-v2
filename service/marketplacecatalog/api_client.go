...
// AWS Marketplace Catalog. See this package's package overview docs
...
const (
	ServiceName = "AWS Marketplace Catalog" // Service's name
	ServiceID   = "MarketplaceCatalog"      // Service's identifier
	EndpointsID = "catalog.marketplace"     // Service's Endpoint identifier
)
...
//     svc := marketplacecatalog.New(myConfig)
