...
func (c *Client) addOperationManagePropertygraphStatisticsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ManagePropertygraphStatistics", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
