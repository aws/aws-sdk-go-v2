...
// inquiry, and machine learning. It supports all three Neptune query languages
// (Gremlin, openCypher and SPARQL), and is available in all SDK languages. It
// automatically signs API requests and greatly simplifies integrating Neptune into
// your applications.
package neptunedata
