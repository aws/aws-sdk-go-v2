...
func (*CancelMLModelTransformJobInput) operationName() string {
...
func (c *Client) addOperationCancelMLModelTransformJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelMLModelTransformJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCancelMLModelTransformJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCancelMLModelTransformJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelMLModelTransformJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelMLModelTransformJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCancelMLModelTransformJobResolveEndpointMiddleware{
