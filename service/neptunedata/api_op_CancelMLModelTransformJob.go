...
func (c *Client) addOperationCancelMLModelTransformJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelMLModelTransformJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
