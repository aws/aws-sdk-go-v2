...
func (c *Client) addOperationGetMLDataProcessingJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMLDataProcessingJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetMLDataProcessingJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetMLDataProcessingJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMLDataProcessingJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMLDataProcessingJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetMLDataProcessingJobResolveEndpointMiddleware{
