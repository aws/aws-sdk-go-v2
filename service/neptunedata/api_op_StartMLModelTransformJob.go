...
func (c *Client) addOperationStartMLModelTransformJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartMLModelTransformJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
