...
func (c *Client) addOperationGetMLEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMLEndpointResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetMLEndpointResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetMLEndpointResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMLEndpointResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMLEndpointResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetMLEndpointResolveEndpointMiddleware{
