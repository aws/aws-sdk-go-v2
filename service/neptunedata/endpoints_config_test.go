...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-neptunedata.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-neptunedata.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-neptunedata.dev",
			expectURL:     aws.String("https://env-neptunedata.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-neptunedata.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-neptunedata.dev",
			expectURL:     aws.String("http://config-neptunedata.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-neptunedata.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-neptunedata.dev",
			clientEndpoint: aws.String("https://client-neptunedata.dev"),
			expectURL:      aws.String("https://client-neptunedata.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_NEPTUNEDATA", c.envService)
			}
