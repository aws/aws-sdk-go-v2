...
func (c *Client) addOperationCancelGremlinQueryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelGremlinQueryResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCancelGremlinQueryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCancelGremlinQueryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelGremlinQueryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelGremlinQueryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCancelGremlinQueryResolveEndpointMiddleware{
