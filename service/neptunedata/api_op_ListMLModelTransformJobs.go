...
func (c *Client) addOperationListMLModelTransformJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMLModelTransformJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
