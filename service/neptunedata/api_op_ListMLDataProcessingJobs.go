...
func (c *Client) addOperationListMLDataProcessingJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMLDataProcessingJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
