...
func (c *Client) addOperationListMLDataProcessingJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMLDataProcessingJobsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListMLDataProcessingJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListMLDataProcessingJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMLDataProcessingJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListMLDataProcessingJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListMLDataProcessingJobsResolveEndpointMiddleware{
