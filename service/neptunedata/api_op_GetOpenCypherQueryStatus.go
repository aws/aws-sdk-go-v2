...
func (c *Client) addOperationGetOpenCypherQueryStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetOpenCypherQueryStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
