...
func (c *Client) addOperationListMLModelTrainingJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMLModelTrainingJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
