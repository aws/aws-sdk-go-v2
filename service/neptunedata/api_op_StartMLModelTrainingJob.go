...
func (c *Client) addOperationStartMLModelTrainingJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartMLModelTrainingJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
