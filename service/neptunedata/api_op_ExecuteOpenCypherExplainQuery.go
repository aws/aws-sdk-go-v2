...
func (c *Client) addOperationExecuteOpenCypherExplainQueryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addExecuteOpenCypherExplainQueryResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opExecuteOpenCypherExplainQueryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opExecuteOpenCypherExplainQueryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opExecuteOpenCypherExplainQueryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addExecuteOpenCypherExplainQueryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opExecuteOpenCypherExplainQueryResolveEndpointMiddleware{
