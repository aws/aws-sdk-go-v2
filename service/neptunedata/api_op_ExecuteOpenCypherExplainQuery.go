...
func (c *Client) addOperationExecuteOpenCypherExplainQueryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ExecuteOpenCypherExplainQuery", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
