...
func (c *Client) addOperationCancelLoaderJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelLoaderJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCancelLoaderJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCancelLoaderJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelLoaderJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelLoaderJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCancelLoaderJobResolveEndpointMiddleware{
