...
func (c *Client) addOperationGetGremlinQueryStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetGremlinQueryStatusResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetGremlinQueryStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetGremlinQueryStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetGremlinQueryStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetGremlinQueryStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetGremlinQueryStatusResolveEndpointMiddleware{
