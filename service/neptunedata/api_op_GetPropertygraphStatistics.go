...
func (c *Client) addOperationGetPropertygraphStatisticsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPropertygraphStatisticsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetPropertygraphStatisticsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetPropertygraphStatisticsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPropertygraphStatisticsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPropertygraphStatisticsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetPropertygraphStatisticsResolveEndpointMiddleware{
