...
const (
	ServiceName = "Amazon Elastic Transcoder" // Service's name
	ServiceID   = "ElasticTranscoder"         // Service's identifier
	EndpointsID = "elastictranscoder"         // Service's Endpoint identifier
)
