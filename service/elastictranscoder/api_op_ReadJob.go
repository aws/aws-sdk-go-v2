...
func (c *Client) ReadJob(ctx context.Context, params *ReadJobInput, optFns ...func(*Options)) (*ReadJobOutput, error) {
	if params == nil { params = &ReadJobInput{} }
...
func (c *Client) addOperationReadJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addReadJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opReadJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opReadJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opReadJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addReadJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opReadJobResolveEndpointMiddleware{
