...
func (c *Client) ReadPreset(ctx context.Context, params *ReadPresetInput, optFns ...func(*Options)) (*ReadPresetOutput, error) {
	if params == nil { params = &ReadPresetInput{} }
...
func (c *Client) addOperationReadPresetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addReadPresetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opReadPresetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opReadPresetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opReadPresetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addReadPresetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opReadPresetResolveEndpointMiddleware{
