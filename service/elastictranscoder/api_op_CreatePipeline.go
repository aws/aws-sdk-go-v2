...
type CreatePipelineInput struct {
	...
	// - Progressing: The topic ARN for the
	// Amazon Simple Notification Service (Amazon SNS) topic that you want to notify
	// when Elastic Transcoder has started to process a job in this pipeline. This is
	// the ARN that Amazon SNS returned when you created the topic. For more
