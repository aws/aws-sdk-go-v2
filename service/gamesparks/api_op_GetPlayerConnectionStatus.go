...
func (c *Client) GetPlayerConnectionStatus(ctx context.Context, params *GetPlayerConnectionStatusInput, optFns ...func(*Options)) (*GetPlayerConnectionStatusOutput, error) {
	if params == nil { params = &GetPlayerConnectionStatusInput{} }
...
func (c *Client) addOperationGetPlayerConnectionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPlayerConnectionStatusResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPlayerConnectionStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPlayerConnectionStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPlayerConnectionStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPlayerConnectionStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPlayerConnectionStatusResolveEndpointMiddleware{
