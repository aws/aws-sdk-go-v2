...
func (c *Client) GetExtensionVersion(ctx context.Context, params *GetExtensionVersionInput, optFns ...func(*Options)) (*GetExtensionVersionOutput, error) {
	if params == nil { params = &GetExtensionVersionInput{} }
...
func (c *Client) addOperationGetExtensionVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetExtensionVersionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetExtensionVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetExtensionVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetExtensionVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetExtensionVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetExtensionVersionResolveEndpointMiddleware{
