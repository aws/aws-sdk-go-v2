...
func (c *Client) GetGeneratedCodeJob(ctx context.Context, params *GetGeneratedCodeJobInput, optFns ...func(*Options)) (*GetGeneratedCodeJobOutput, error) {
	if params == nil { params = &GetGeneratedCodeJobInput{} }
...
func (c *Client) addOperationGetGeneratedCodeJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetGeneratedCodeJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetGeneratedCodeJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetGeneratedCodeJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetGeneratedCodeJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetGeneratedCodeJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetGeneratedCodeJobResolveEndpointMiddleware{
