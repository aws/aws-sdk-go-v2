...
func (*StartStageDeploymentInput) operationName() string {
...
func (c *Client) addOperationStartStageDeploymentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartStageDeploymentResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStartStageDeploymentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStartStageDeploymentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartStageDeploymentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartStageDeploymentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStartStageDeploymentResolveEndpointMiddleware{
