...
func (c *Client) GetGameConfiguration(ctx context.Context, params *GetGameConfigurationInput, optFns ...func(*Options)) (*GetGameConfigurationOutput, error) {
	if params == nil { params = &GetGameConfigurationInput{} }
...
func (c *Client) addOperationGetGameConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetGameConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetGameConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetGameConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetGameConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetGameConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetGameConfigurationResolveEndpointMiddleware{
