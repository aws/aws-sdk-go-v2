...
func (*DeleteGameInput) operationName() string {
	return "DeleteGame"
}
...
func (c *Client) addOperationDeleteGameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteGameResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteGameResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteGameResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteGameResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteGameResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteGameResolveEndpointMiddleware{
