...
func (c *Client) StartGeneratedCodeJob(ctx context.Context, params *StartGeneratedCodeJobInput, optFns ...func(*Options)) (*StartGeneratedCodeJobOutput, error) {
	if params == nil { params = &StartGeneratedCodeJobInput{} }
...
func (c *Client) addOperationStartGeneratedCodeJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartGeneratedCodeJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartGeneratedCodeJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartGeneratedCodeJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartGeneratedCodeJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartGeneratedCodeJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartGeneratedCodeJobResolveEndpointMiddleware{
