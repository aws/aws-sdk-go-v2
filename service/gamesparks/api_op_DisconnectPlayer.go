...
func (c *Client) DisconnectPlayer(ctx context.Context, params *DisconnectPlayerInput, optFns ...func(*Options)) (*DisconnectPlayerOutput, error) {
	if params == nil { params = &DisconnectPlayerInput{} }
...
func (c *Client) addOperationDisconnectPlayerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisconnectPlayerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisconnectPlayerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisconnectPlayerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisconnectPlayerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisconnectPlayerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisconnectPlayerResolveEndpointMiddleware{
