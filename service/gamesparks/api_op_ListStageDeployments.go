...
func (c *Client) ListStageDeployments(ctx context.Context, params *ListStageDeploymentsInput, optFns ...func(*Options)) (*ListStageDeploymentsOutput, error) {
	if params == nil { params = &ListStageDeploymentsInput{} }
...
func (c *Client) addOperationListStageDeploymentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListStageDeploymentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListStageDeploymentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListStageDeploymentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListStageDeploymentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListStageDeploymentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListStageDeploymentsResolveEndpointMiddleware{
