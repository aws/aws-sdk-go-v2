...
func (c *Client) GetGame(ctx context.Context, params *GetGameInput, optFns ...func(*Options)) (*GetGameOutput, error) {
	if params == nil { params = &GetGameInput{} }
...
func (c *Client) addOperationGetGameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetGameResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetGameResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetGameResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetGameResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetGameResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetGameResolveEndpointMiddleware{
