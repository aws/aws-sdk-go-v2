...
func (c *Client) ImportGameConfiguration(ctx context.Context, params *ImportGameConfigurationInput, optFns ...func(*Options)) (*ImportGameConfigurationOutput, error) {
	if params == nil { params = &ImportGameConfigurationInput{} }
...
func (c *Client) addOperationImportGameConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addImportGameConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opImportGameConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opImportGameConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opImportGameConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addImportGameConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opImportGameConfigurationResolveEndpointMiddleware{
