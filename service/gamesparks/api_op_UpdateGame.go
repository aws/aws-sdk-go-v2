...
func (c *Client) UpdateGame(ctx context.Context, params *UpdateGameInput, optFns ...func(*Options)) (*UpdateGameOutput, error) {
	if params == nil { params = &UpdateGameInput{} }
...
func (c *Client) addOperationUpdateGameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateGameResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateGameResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateGameResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateGameResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateGameResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateGameResolveEndpointMiddleware{
