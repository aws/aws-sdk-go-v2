...
func (c *Client) ListExtensionVersions(ctx context.Context, params *ListExtensionVersionsInput, optFns ...func(*Options)) (*ListExtensionVersionsOutput, error) {
	if params == nil { params = &ListExtensionVersionsInput{} }
...
func (c *Client) addOperationListExtensionVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListExtensionVersionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListExtensionVersionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListExtensionVersionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListExtensionVersionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListExtensionVersionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListExtensionVersionsResolveEndpointMiddleware{
