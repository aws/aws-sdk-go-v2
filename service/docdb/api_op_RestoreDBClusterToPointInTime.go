...
func addOperationRestoreDBClusterToPointInTimeStackSlots(stack *middleware.Stack) error {
...
func addOperationRestoreDBClusterToPointInTimeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRestoreDBClusterToPointInTimeStackSlots(stack); err != nil {
		return err
	}
