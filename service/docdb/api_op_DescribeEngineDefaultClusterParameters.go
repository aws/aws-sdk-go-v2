...
func addOperationDescribeEngineDefaultClusterParametersStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeEngineDefaultClusterParametersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeEngineDefaultClusterParametersStackSlots(stack); err != nil {
		return err
	}
