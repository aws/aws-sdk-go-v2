...
func (c *Client) addOperationCreateEventSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateEventSubscription", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
