...
// of source ( SourceType) that you want to be notified of. You can also provide
// a list of Amazon DocumentDB sources ( SourceIds) that trigger the events, and
// you can provide a list of event categories ( EventCategories) for events that
...
// Availability, Backup . If you specify both the SourceType  and SourceIds (such
// as SourceType = db-instance  and SourceIdentifier = myDBInstance1), you are
...
// notice of the events for that source type for all your Amazon DocumentDB
// sources. If you do not specify either the SourceType  or the SourceIdentifier,
