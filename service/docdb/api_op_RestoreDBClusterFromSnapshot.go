...
func addOperationRestoreDBClusterFromSnapshotStackSlots(stack *middleware.Stack) error {
...
func addOperationRestoreDBClusterFromSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRestoreDBClusterFromSnapshotStackSlots(stack); err != nil {
		return err
	}
