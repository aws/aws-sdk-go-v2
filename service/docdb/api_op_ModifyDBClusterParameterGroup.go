...
func (c *Client) addOperationModifyDBClusterParameterGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyDBClusterParameterGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
