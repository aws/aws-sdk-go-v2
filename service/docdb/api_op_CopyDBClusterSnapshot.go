...
// Copies a snapshot of a cluster. To copy a cluster snapshot from a shared
// manual cluster snapshot, SourceDBClusterSnapshotIdentifier must be the Amazon
...
// Region. To cancel the copy operation after it is in progress, delete the target
...
type CopyDBClusterSnapshotInput struct {
	...
	// source cluster snapshot. If you copy an encrypted cluster snapshot that is
	// shared from another Amazon Web Services account, then you must specify a value
	// for KmsKeyId. To copy an encrypted cluster snapshot to another Amazon Web
	// Services Region, set KmsKeyId to the KMS key ID that you want to use to
	// encrypt the copy of the cluster snapshot in the destination Region. KMS
	// encryption keys are specific to the Amazon Web Services Region that they are
	// created in, and you can't use encryption keys from one Amazon Web Services
	// Region in another Amazon Web Services Region. If you copy an unencrypted cluster
	// snapshot and specify a value for the KmsKeyId  parameter, an error is returned.
	KmsKeyId *string

	// The URL that contains a Signature Version 4 signed request for the
	// CopyDBClusterSnapshotAPI action in the Amazon Web Services Region that
	...
	// CopyDBClusterSnapshotAPI action that can be executed in the source Amazon Web
