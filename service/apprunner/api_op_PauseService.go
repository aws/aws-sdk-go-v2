...
func (c *Client) PauseService(ctx context.Context, params *PauseServiceInput, optFns ...func(*Options)) (*PauseServiceOutput, error) {
	if params == nil { params = &PauseServiceInput{} }
...
func (c *Client) addOperationPauseServiceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPauseServiceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPauseServiceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPauseServiceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPauseServiceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPauseServiceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPauseServiceResolveEndpointMiddleware{
