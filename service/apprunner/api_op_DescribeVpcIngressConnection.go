...
func (c *Client) DescribeVpcIngressConnection(ctx context.Context, params *DescribeVpcIngressConnectionInput, optFns ...func(*Options)) (*DescribeVpcIngressConnectionOutput, error) {
	if params == nil { params = &DescribeVpcIngressConnectionInput{} }
...
func (c *Client) addOperationDescribeVpcIngressConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeVpcIngressConnectionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeVpcIngressConnectionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeVpcIngressConnectionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeVpcIngressConnectionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeVpcIngressConnectionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeVpcIngressConnectionResolveEndpointMiddleware{
