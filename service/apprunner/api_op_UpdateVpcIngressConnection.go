...
func (c *Client) UpdateVpcIngressConnection(ctx context.Context, params *UpdateVpcIngressConnectionInput, optFns ...func(*Options)) (*UpdateVpcIngressConnectionOutput, error) {
	if params == nil { params = &UpdateVpcIngressConnectionInput{} }
...
func (c *Client) addOperationUpdateVpcIngressConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateVpcIngressConnectionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateVpcIngressConnectionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateVpcIngressConnectionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateVpcIngressConnectionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateVpcIngressConnectionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateVpcIngressConnectionResolveEndpointMiddleware{
