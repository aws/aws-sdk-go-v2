...
func (c *Client) addOperationListServicesForAutoScalingConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListServicesForAutoScalingConfigurationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListServicesForAutoScalingConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListServicesForAutoScalingConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListServicesForAutoScalingConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListServicesForAutoScalingConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListServicesForAutoScalingConfigurationResolveEndpointMiddleware{
