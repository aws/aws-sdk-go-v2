...
func (c *Client) addOperationCreateObservabilityConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateObservabilityConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
