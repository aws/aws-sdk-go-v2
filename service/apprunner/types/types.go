...
type NetworkConfiguration struct {
	...
	// IpAddressType , it defaults to select IPv4. Currently, App Runner supports
	// dual-stack for only Public endpoint. Only IPv4 is supported for Private
	// endpoint. If you update a service that's using dual-stack Public endpoint to a
	// Private endpoint, your App Runner service will default to support only IPv4 for
	// Private endpoint and fail to receive traffic originating from IPv6 endpoint.
