...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-apprunner.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-apprunner.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-apprunner.dev",
			expectURL:     aws.String("https://env-apprunner.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-apprunner.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-apprunner.dev",
			expectURL:     aws.String("http://config-apprunner.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-apprunner.dev",
			...
			expectURL:      aws.String("https://client-apprunner.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APPRUNNER", c.envService)
			}
