...
func (c *Client) DescribeObservabilityConfiguration(ctx context.Context, params *DescribeObservabilityConfigurationInput, optFns ...func(*Options)) (*DescribeObservabilityConfigurationOutput, error) {
	if params == nil { params = &DescribeObservabilityConfigurationInput{} }
...
func (c *Client) addOperationDescribeObservabilityConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeObservabilityConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeObservabilityConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeObservabilityConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeObservabilityConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeObservabilityConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeObservabilityConfigurationResolveEndpointMiddleware{
