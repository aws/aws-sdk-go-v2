...
func (c *Client) ListVpcConnectors(ctx context.Context, params *ListVpcConnectorsInput, optFns ...func(*Options)) (*ListVpcConnectorsOutput, error) {
	if params == nil { params = &ListVpcConnectorsInput{} }
...
func (c *Client) addOperationListVpcConnectorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListVpcConnectorsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListVpcConnectorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListVpcConnectorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListVpcConnectorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListVpcConnectorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListVpcConnectorsResolveEndpointMiddleware{
