...
func (c *Client) addOperationListObservabilityConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListObservabilityConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
