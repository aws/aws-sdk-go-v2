...
func (c *Client) ListVpcIngressConnections(ctx context.Context, params *ListVpcIngressConnectionsInput, optFns ...func(*Options)) (*ListVpcIngressConnectionsOutput, error) {
	if params == nil { params = &ListVpcIngressConnectionsInput{} }
...
func (c *Client) addOperationListVpcIngressConnectionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListVpcIngressConnectionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListVpcIngressConnectionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListVpcIngressConnectionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListVpcIngressConnectionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListVpcIngressConnectionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListVpcIngressConnectionsResolveEndpointMiddleware{
