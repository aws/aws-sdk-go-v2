...
func (c *Client) addOperationDisassociateCustomDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateCustomDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
