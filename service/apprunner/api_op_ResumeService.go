...
func (c *Client) ResumeService(ctx context.Context, params *ResumeServiceInput, optFns ...func(*Options)) (*ResumeServiceOutput, error) {
	if params == nil { params = &ResumeServiceInput{} }
...
func (c *Client) addOperationResumeServiceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResumeServiceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opResumeServiceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opResumeServiceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResumeServiceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResumeServiceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opResumeServiceResolveEndpointMiddleware{
