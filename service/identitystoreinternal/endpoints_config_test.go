...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-identitystoreinternal.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-identitystoreinternal.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-identitystoreinternal.dev",
			expectURL:     aws.String("https://env-identitystoreinternal.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-identitystoreinternal.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-identitystoreinternal.dev",
			expectURL:     aws.String("http://config-identitystoreinternal.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-identitystoreinternal.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-identitystoreinternal.dev",
			clientEndpoint: aws.String("https://client-identitystoreinternal.dev"),
			expectURL:      aws.String("https://client-identitystoreinternal.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IDENTITYSTOREINTERNAL", c.envService)
			}
