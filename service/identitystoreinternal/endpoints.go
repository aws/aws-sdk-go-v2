...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/identitystoreinternal/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_IDENTITYSTOREINTERNAL")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "identitystoreinternal", cfg.ConfigSources)
	if found && err == nil {
							...
							if _Region == "us-west-1" {
								if _Region == "eu-north-1" {
									uriString := func() string {
										...
										out.WriteString("https://up-sso-fips.")
										out.WriteString(_Region)
										out.WriteString(".")
										out.WriteString(_PartitionResult.DualStackDnsSuffix)
										out.WriteString("/identitystore/")
										return out.String()
									}()
			...
			if _UseFIPS == true {
				if true == _PartitionResult.SupportsFIPS {
					if "aws-us-gov" == _PartitionResult.Name {
						if _Region == "us-west-1" {
							uriString := "https://up-sso.us-west-1.amazonaws.com/identitystore"
						...
						if _Region == "eu-north-1" {
							uriString := "https://up-sso.eu-north-1.amazonaws.com/identitystore/"
						...
						uriString := func() string {
							var out strings.Builder
							out.WriteString("https://up.sso.")
							out.WriteString(_Region)
							out.WriteString(".amazonaws.com/identitystore/")
							return out.String()
						}()
			...
			if _UseDualStack == true {
				if true == _PartitionResult.SupportsDualStack {
					if _Region == "us-west-1" {
						uriString := func() string {
							var out strings.Builder
							out.WriteString("https://up-sso.us-west-1.")
							out.WriteString(_PartitionResult.DualStackDnsSuffix)
							out.WriteString("/identitystore/")
							return out.String()
						}()
					...
					if _Region == "eu-north-1" {
						uriString := func() string {
							var out strings.Builder
							out.WriteString("https://up-sso.eu-north-1.")
							out.WriteString(_PartitionResult.DualStackDnsSuffix)
							out.WriteString("/identitystore/")
							return out.String()
						}()
