...
func (c *Client) addOperationDeleteKnowledgeBaseDocumentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteKnowledgeBaseDocuments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
