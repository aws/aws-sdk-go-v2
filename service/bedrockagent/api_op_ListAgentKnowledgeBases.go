...
func (c *Client) addOperationListAgentKnowledgeBasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAgentKnowledgeBases", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
