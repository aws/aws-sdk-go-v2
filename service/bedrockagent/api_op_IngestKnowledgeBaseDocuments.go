...
func (c *Client) addOperationIngestKnowledgeBaseDocumentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "IngestKnowledgeBaseDocuments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
