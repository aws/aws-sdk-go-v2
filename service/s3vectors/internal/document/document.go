...
// github.com/aws/aws-sdk-go-v2/service/s3vectors/internal/document.smithyDocument
// is an interface which is used to bind a document type to its service client.
type smithyDocument interface {
	isSmithyDocument()
}

// github.com/aws/aws-sdk-go-v2/service/s3vectors/internal/document.Interface is a
...
// github.com/aws/aws-sdk-go-v2/service/s3vectors/internal/document.IsInterface
