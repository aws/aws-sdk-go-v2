...
func (c *Client) addOperationListComponentProvisionedResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListComponentProvisionedResources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
