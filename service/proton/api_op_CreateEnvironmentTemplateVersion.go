...
func (c *Client) addOperationCreateEnvironmentTemplateVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateEnvironmentTemplateVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
