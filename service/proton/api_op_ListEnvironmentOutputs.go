...
func (c *Client) ListEnvironmentOutputs(ctx context.Context, params *ListEnvironmentOutputsInput, optFns ...func(*Options)) (*ListEnvironmentOutputsOutput, error) {
	if params == nil { params = &ListEnvironmentOutputsInput{} }
...
func (c *Client) addOperationListEnvironmentOutputsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEnvironmentOutputsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListEnvironmentOutputsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListEnvironmentOutputsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEnvironmentOutputsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEnvironmentOutputsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListEnvironmentOutputsResolveEndpointMiddleware{
