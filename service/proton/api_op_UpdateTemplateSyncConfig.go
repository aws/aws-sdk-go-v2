...
func (c *Client) addOperationUpdateTemplateSyncConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateTemplateSyncConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
