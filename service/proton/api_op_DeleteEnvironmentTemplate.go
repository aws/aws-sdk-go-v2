...
func (c *Client) addOperationDeleteEnvironmentTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteEnvironmentTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
