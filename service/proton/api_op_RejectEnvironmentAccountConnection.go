...
func (c *Client) RejectEnvironmentAccountConnection(ctx context.Context, params *RejectEnvironmentAccountConnectionInput, optFns ...func(*Options)) (*RejectEnvironmentAccountConnectionOutput, error) {
	if params == nil { params = &RejectEnvironmentAccountConnectionInput{} }
...
func (c *Client) addOperationRejectEnvironmentAccountConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRejectEnvironmentAccountConnectionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRejectEnvironmentAccountConnectionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRejectEnvironmentAccountConnectionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRejectEnvironmentAccountConnectionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRejectEnvironmentAccountConnectionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRejectEnvironmentAccountConnectionResolveEndpointMiddleware{
