...
func (c *Client) addOperationListServiceTemplateVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListServiceTemplateVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
