...
func (c *Client) addOperationGetServiceSyncBlockerSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetServiceSyncBlockerSummary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
