...
func (c *Client) addOperationGetServiceSyncBlockerSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetServiceSyncBlockerSummaryResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetServiceSyncBlockerSummaryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetServiceSyncBlockerSummaryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetServiceSyncBlockerSummaryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetServiceSyncBlockerSummaryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetServiceSyncBlockerSummaryResolveEndpointMiddleware{
