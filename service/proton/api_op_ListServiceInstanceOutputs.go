...
func (c *Client) addOperationListServiceInstanceOutputsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListServiceInstanceOutputs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
