...
// service pipeline in the AWS Proton Administration guide
...
func (c *Client) CancelServicePipelineDeployment(ctx context.Context, params *CancelServicePipelineDeploymentInput, optFns ...func(*Options)) (*CancelServicePipelineDeploymentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelServicePipelineDeployment", params, optFns, addOperationCancelServicePipelineDeploymentMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelServicePipelineDeploymentMiddlewares(stack *middleware.Stack, options Options) (err error) {
