...
func (*CreateTemplateSyncConfigInput) operationName() string {
...
func (c *Client) addOperationCreateTemplateSyncConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateTemplateSyncConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateTemplateSyncConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateTemplateSyncConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateTemplateSyncConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateTemplateSyncConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateTemplateSyncConfigResolveEndpointMiddleware{
