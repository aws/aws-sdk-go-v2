...
func (c *Client) addOperationUpdateServiceSyncConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateServiceSyncConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
