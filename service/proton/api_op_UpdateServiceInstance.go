...
// CURRENT_VERSION In this mode, the service instance is deployed and updated with
...
// MINOR_VERSION In this mode, the service instance is deployed and updated with
...
// current major version in use. MAJOR_VERSION In this mode, the service instance
...
// major version that's higher than the major version in use and a minor version.
...
type UpdateServiceInstanceInput struct {
	...
	// The deployment type. There are four modes for updating a service instance. The
	...
	// mode, the service instance is deployed and updated with the published,
