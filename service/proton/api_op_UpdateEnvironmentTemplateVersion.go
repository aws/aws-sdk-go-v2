...
func (*UpdateEnvironmentTemplateVersionInput) operationName() string {
...
func (c *Client) addOperationUpdateEnvironmentTemplateVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateEnvironmentTemplateVersionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateEnvironmentTemplateVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateEnvironmentTemplateVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateEnvironmentTemplateVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateEnvironmentTemplateVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateEnvironmentTemplateVersionResolveEndpointMiddleware{
