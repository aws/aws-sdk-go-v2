...
func (*DeleteServiceTemplateVersionInput) operationName() string {
...
func (c *Client) addOperationDeleteServiceTemplateVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteServiceTemplateVersionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteServiceTemplateVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteServiceTemplateVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteServiceTemplateVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteServiceTemplateVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteServiceTemplateVersionResolveEndpointMiddleware{
