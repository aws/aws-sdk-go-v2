...
func (c *Client) ListComponentOutputs(ctx context.Context, params *ListComponentOutputsInput, optFns ...func(*Options)) (*ListComponentOutputsOutput, error) {
	if params == nil { params = &ListComponentOutputsInput{} }
...
func (c *Client) addOperationListComponentOutputsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListComponentOutputsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListComponentOutputsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListComponentOutputsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListComponentOutputsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListComponentOutputsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListComponentOutputsResolveEndpointMiddleware{
