...
func (c *Client) addOperationDeleteTemplateSyncConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteTemplateSyncConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
