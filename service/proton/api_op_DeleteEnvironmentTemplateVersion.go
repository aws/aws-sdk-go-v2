...
// an environment template is a version that's not backward compatible. Delete a
// minor version of an environment template if it isn't the Recommended version.
// Delete a Recommended minor version of the environment template if no other
