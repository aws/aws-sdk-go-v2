...
func (c *Client) addOperationListEnvironmentTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEnvironmentTemplates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
