...
func (c *Client) ListEnvironmentTemplates(ctx context.Context, params *ListEnvironmentTemplatesInput, optFns ...func(*Options)) (*ListEnvironmentTemplatesOutput, error) {
	if params == nil { params = &ListEnvironmentTemplatesInput{} }
...
func (c *Client) addOperationListEnvironmentTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEnvironmentTemplatesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListEnvironmentTemplatesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListEnvironmentTemplatesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEnvironmentTemplatesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEnvironmentTemplatesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListEnvironmentTemplatesResolveEndpointMiddleware{
