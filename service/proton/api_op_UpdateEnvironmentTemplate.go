...
func (c *Client) addOperationUpdateEnvironmentTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateEnvironmentTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
