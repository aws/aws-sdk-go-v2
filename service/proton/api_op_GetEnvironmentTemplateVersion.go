...
func (c *Client) addOperationGetEnvironmentTemplateVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetEnvironmentTemplateVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
