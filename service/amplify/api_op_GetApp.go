...
func (c *Client) GetApp(ctx context.Context, params *GetAppInput, optFns ...func(*Options)) (*GetAppOutput, error) {
	if params == nil { params = &GetAppInput{} }
...
func (c *Client) addOperationGetAppMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAppResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAppResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAppResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAppResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAppResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAppResolveEndpointMiddleware{
