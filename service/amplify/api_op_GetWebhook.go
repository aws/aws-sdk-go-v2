...
func (c *Client) GetWebhook(ctx context.Context, params *GetWebhookInput, optFns ...func(*Options)) (*GetWebhookOutput, error) {
	if params == nil { params = &GetWebhookInput{} }
...
func (c *Client) addOperationGetWebhookMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetWebhookResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetWebhookResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetWebhookResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetWebhookResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetWebhookResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetWebhookResolveEndpointMiddleware{
