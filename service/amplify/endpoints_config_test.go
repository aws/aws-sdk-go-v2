...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-amplify.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-amplify.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-amplify.dev",
			expectURL:     aws.String("https://env-amplify.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-amplify.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-amplify.dev",
			expectURL:     aws.String("http://config-amplify.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-amplify.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-amplify.dev",
			clientEndpoint: aws.String("https://client-amplify.dev"),
			expectURL:      aws.String("https://client-amplify.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_AMPLIFY", c.envService)
			}
