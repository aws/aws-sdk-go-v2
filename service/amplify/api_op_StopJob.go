...
func (c *Client) StopJob(ctx context.Context, params *StopJobInput, optFns ...func(*Options)) (*StopJobOutput, error) {
	if params == nil { params = &StopJobInput{} }
...
func (c *Client) addOperationStopJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopJobResolveEndpointMiddleware{
