...
func (c *Client) addOperationListBackendEnvironmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListBackendEnvironments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
