...
func (c *Client) GetArtifactUrl(ctx context.Context, params *GetArtifactUrlInput, optFns ...func(*Options)) (*GetArtifactUrlOutput, error) {
	if params == nil { params = &GetArtifactUrlInput{} }
...
func (c *Client) addOperationGetArtifactUrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetArtifactUrlResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetArtifactUrlResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetArtifactUrlResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetArtifactUrlResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetArtifactUrlResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetArtifactUrlResolveEndpointMiddleware{
