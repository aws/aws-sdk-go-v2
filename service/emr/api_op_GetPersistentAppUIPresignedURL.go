...
func (c *Client) addOperationGetPersistentAppUIPresignedURLMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPersistentAppUIPresignedURL", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
