...
func addOperationListSecurityConfigurationsStackSlots(stack *middleware.Stack) error {
...
func addOperationListSecurityConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListSecurityConfigurationsStackSlots(stack); err != nil {
		return err
	}
