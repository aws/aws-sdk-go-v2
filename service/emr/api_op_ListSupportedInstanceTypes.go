...
func (c *Client) addOperationListSupportedInstanceTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSupportedInstanceTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
