...
func (c *Client) addOperationSetUnhealthyNodeReplacementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SetUnhealthyNodeReplacement", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
