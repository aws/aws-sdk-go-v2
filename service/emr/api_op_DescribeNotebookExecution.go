...
func (c *Client) addOperationDescribeNotebookExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeNotebookExecution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
