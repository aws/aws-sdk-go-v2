...
func (c *Client) GetStudioSessionMapping(ctx context.Context, params *GetStudioSessionMappingInput, optFns ...func(*Options)) (*GetStudioSessionMappingOutput, error) {
	if params == nil { params = &GetStudioSessionMappingInput{} }
...
func (c *Client) addOperationGetStudioSessionMappingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetStudioSessionMappingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetStudioSessionMappingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetStudioSessionMappingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetStudioSessionMappingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetStudioSessionMappingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetStudioSessionMappingResolveEndpointMiddleware{
