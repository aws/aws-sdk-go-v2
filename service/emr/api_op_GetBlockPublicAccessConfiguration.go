...
type GetBlockPublicAccessConfigurationOutput struct {
	...
	// public access is allowed on this port. To change this, update the block public
	// access configuration to remove the exception. For accounts that created clusters
	// in a Region before November 25, 2019, block public access is disabled by default
	// in that Region. To use this feature, you must manually enable and configure it.
	// For accounts that did not create an Amazon EMR cluster in a Region before this
...
func (c *Client) addOperationGetBlockPublicAccessConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBlockPublicAccessConfigurationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetBlockPublicAccessConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetBlockPublicAccessConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetBlockPublicAccessConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBlockPublicAccessConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetBlockPublicAccessConfigurationResolveEndpointMiddleware{
