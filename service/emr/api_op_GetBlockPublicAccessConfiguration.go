...
func addOperationGetBlockPublicAccessConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetBlockPublicAccessConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetBlockPublicAccessConfigurationStackSlots(stack); err != nil {
		return err
	}
