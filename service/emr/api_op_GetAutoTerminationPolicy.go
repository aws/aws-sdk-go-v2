...
func (c *Client) addOperationGetAutoTerminationPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAutoTerminationPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
