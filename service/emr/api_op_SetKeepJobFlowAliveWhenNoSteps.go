...
func (c *Client) addOperationSetKeepJobFlowAliveWhenNoStepsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SetKeepJobFlowAliveWhenNoSteps", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
