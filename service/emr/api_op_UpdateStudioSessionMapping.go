...
func (c *Client) addOperationUpdateStudioSessionMappingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateStudioSessionMapping", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
