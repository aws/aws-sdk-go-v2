...
func (c *Client) addOperationDescribePersistentAppUIMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribePersistentAppUI", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
