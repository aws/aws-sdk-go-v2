...
// similar to calling the Amazon EC2 DisableAPITermination API on all EC2
...
// false . For more information, see Managing Cluster Termination (https://docs.aws.amazon.com/emr/latest/ManagementGuide/UsingEMR_TerminationProtection.html)
