...
func (c *Client) RemoveAutoTerminationPolicy(ctx context.Context, params *RemoveAutoTerminationPolicyInput, optFns ...func(*Options)) (*RemoveAutoTerminationPolicyOutput, error) {
	if params == nil { params = &RemoveAutoTerminationPolicyInput{} }
...
func (c *Client) addOperationRemoveAutoTerminationPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRemoveAutoTerminationPolicyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRemoveAutoTerminationPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRemoveAutoTerminationPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRemoveAutoTerminationPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRemoveAutoTerminationPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRemoveAutoTerminationPolicyResolveEndpointMiddleware{
