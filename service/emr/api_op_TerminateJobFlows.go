...
func (*TerminateJobFlowsInput) operationName() string {
...
func (c *Client) addOperationTerminateJobFlowsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addTerminateJobFlowsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opTerminateJobFlowsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opTerminateJobFlowsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opTerminateJobFlowsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addTerminateJobFlowsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opTerminateJobFlowsResolveEndpointMiddleware{
