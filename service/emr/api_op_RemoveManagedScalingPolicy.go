...
func (*RemoveManagedScalingPolicyInput) operationName() string {
...
func (c *Client) addOperationRemoveManagedScalingPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRemoveManagedScalingPolicyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRemoveManagedScalingPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRemoveManagedScalingPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRemoveManagedScalingPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRemoveManagedScalingPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRemoveManagedScalingPolicyResolveEndpointMiddleware{
