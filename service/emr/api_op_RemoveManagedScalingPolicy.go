...
func addOperationRemoveManagedScalingPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationRemoveManagedScalingPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRemoveManagedScalingPolicyStackSlots(stack); err != nil {
		return err
	}
