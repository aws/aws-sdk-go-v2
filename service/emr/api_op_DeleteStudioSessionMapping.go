...
func (c *Client) addOperationDeleteStudioSessionMappingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteStudioSessionMapping", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
