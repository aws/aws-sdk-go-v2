...
func addOperationPutBlockPublicAccessConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationPutBlockPublicAccessConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutBlockPublicAccessConfigurationStackSlots(stack); err != nil {
		return err
	}
