...
func (c *Client) addOperationListStudioSessionMappingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListStudioSessionMappings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
