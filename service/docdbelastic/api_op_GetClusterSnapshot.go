...
func (c *Client) GetClusterSnapshot(ctx context.Context, params *GetClusterSnapshotInput, optFns ...func(*Options)) (*GetClusterSnapshotOutput, error) {
	if params == nil { params = &GetClusterSnapshotInput{} }
...
func (c *Client) addOperationGetClusterSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetClusterSnapshotResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetClusterSnapshotResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetClusterSnapshotResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetClusterSnapshotResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetClusterSnapshotResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetClusterSnapshotResolveEndpointMiddleware{
