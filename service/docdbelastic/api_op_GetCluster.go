...
func (c *Client) GetCluster(ctx context.Context, params *GetClusterInput, optFns ...func(*Options)) (*GetClusterOutput, error) {
	if params == nil { params = &GetClusterInput{} }
...
func (c *Client) addOperationGetClusterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetClusterResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetClusterResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetClusterResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetClusterResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetClusterResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetClusterResolveEndpointMiddleware{
