...
func (c *Client) addOperationListPendingMaintenanceActionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPendingMaintenanceActions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
