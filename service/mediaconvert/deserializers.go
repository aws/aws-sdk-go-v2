	...
	for key, value := range shape {
		...
		case "externalAudioFileInput":
			if value != nil {
				jtv, ok := value.(string)
				if !ok {
					return fmt.Errorf("expected __ to be of type string, got %T instead", value)
				}
	...
	for key, value := range shape {
		...
		case "fileInput":
			if value != nil {
				jtv, ok := value.(string)
				if !ok {
					return fmt.Errorf("expected __ to be of type string, got %T instead", value)
				}
