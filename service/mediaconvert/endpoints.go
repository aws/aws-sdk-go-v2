...
var bddNodes = [45]int32{
	-1, 1, -1, 0, 14, 3, 1, 4, 100000013, 2, 5, 100000013, 3, 9, 6, 4, 8, 7, 8, 100000011, 100000012, 5, 100000009, 100000010, 4, 12, 10, 6, 11, 100000008, 7, 100000006, 100000007, 5, 13, 100000005, 6, 100000004, 100000005, 3, 100000001, 15, 4, 100000002, 100000003}
...
func evalCondition(idx int, params *EndpointParameters, c *conditionContext) bool {
	...
	case 8:
		return *params.Region == "cn-northwest-1"
	}
	return false
}
