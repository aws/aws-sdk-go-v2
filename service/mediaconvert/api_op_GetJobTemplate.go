...
func (*GetJobTemplateInput) operationName() string {
...
func (c *Client) addOperationGetJobTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetJobTemplateResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetJobTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetJobTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetJobTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetJobTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetJobTemplateResolveEndpointMiddleware{
