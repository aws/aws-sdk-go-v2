...
func (c *Client) GetPreset(ctx context.Context, params *GetPresetInput, optFns ...func(*Options)) (*GetPresetOutput, error) {
	if params == nil { params = &GetPresetInput{} }
...
func (c *Client) addOperationGetPresetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPresetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPresetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPresetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPresetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPresetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPresetResolveEndpointMiddleware{
