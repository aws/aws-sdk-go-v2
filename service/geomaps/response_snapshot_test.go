...
func TestCheckResponseSnapshot_GetGlyphs(t *testing.T) {
	want := &GetGlyphsOutput{
		Blob:         []byte("blob"),
		ContentType:  ptr.String("__ContentType__"),
		CacheControl: ptr.String("__CacheControl__"),
		ETag:         ptr.String("__ETag__"),
	}
	status, header, body, err := serdeRespReadSnapshot("GetGlyphs.response")
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "GetGlyphs.response", err)
	}
}

func TestCheckResponseSnapshot_GetSprites(t *testing.T) {
	want := &GetSpritesOutput{
		Blob:         []byte("blob"),
		ContentType:  ptr.String("__ContentType__"),
		CacheControl: ptr.String("__CacheControl__"),
		ETag:         ptr.String("__ETag__"),
	}
	status, header, body, err := serdeRespReadSnapshot("GetSprites.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "GetSprites.response", err)
	}
}

func TestCheckResponseSnapshot_GetStaticMap(t *testing.T) {
	want := &GetStaticMapOutput{
		Blob:          []byte("blob"),
		ContentType:   ptr.String("__ContentType__"),
		CacheControl:  ptr.String("__CacheControl__"),
		ETag:          ptr.String("__ETag__"),
	...
	status, header, body, err := serdeRespReadSnapshot("GetStaticMap.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "GetStaticMap.response", err)
	}
}

func TestCheckResponseSnapshot_GetStyleDescriptor(t *testing.T) {
	want := &GetStyleDescriptorOutput{
		Blob:         []byte("blob"),
		ContentType:  ptr.String("__ContentType__"),
		CacheControl: ptr.String("__CacheControl__"),
		ETag:         ptr.String("__ETag__"),
	}
	status, header, body, err := serdeRespReadSnapshot("GetStyleDescriptor.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "GetStyleDescriptor.response", err)
	}
}
