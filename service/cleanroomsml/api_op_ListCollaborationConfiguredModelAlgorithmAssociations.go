...
func (c *Client) addOperationListCollaborationConfiguredModelAlgorithmAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCollaborationConfiguredModelAlgorithmAssociations"), middleware.Before); err != nil {
		return err
	}
