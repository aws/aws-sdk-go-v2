...
func (c *Client) addOperationListTrainedModelInferenceJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTrainedModelInferenceJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
