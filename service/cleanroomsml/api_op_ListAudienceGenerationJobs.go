...
func (c *Client) addOperationListAudienceGenerationJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAudienceGenerationJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
