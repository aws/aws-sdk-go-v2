...
func (c *Client) addOperationListTrainedModelVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTrainedModelVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
