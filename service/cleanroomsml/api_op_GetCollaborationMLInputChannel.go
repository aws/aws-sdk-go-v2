...
func (c *Client) addOperationGetCollaborationMLInputChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCollaborationMLInputChannel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
