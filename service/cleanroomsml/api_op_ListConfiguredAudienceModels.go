...
func (c *Client) addOperationListConfiguredAudienceModelsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListConfiguredAudienceModels", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
