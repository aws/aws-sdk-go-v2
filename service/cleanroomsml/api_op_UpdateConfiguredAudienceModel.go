...
func (c *Client) addOperationUpdateConfiguredAudienceModelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateConfiguredAudienceModel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
