...
func (c *Client) addOperationDeleteConfiguredAudienceModelPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteConfiguredAudienceModelPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
