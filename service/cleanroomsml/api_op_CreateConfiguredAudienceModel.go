...
func (c *Client) addOperationCreateConfiguredAudienceModelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateConfiguredAudienceModel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
