...
func (c *Client) addOperationListCollaborationTrainedModelExportJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCollaborationTrainedModelExportJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
