...
func (c *Client) addOperationGetAudienceGenerationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAudienceGenerationJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
