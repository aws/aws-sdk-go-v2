...
func (c *Client) addOperationGetCollaborationTrainedModelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCollaborationTrainedModel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
