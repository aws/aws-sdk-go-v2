...
func (c *Client) addOperationDeleteTrainedModelOutputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteTrainedModelOutput", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
