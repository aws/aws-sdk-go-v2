...
func (c *Client) addOperationStartTrainedModelExportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartTrainedModelExportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
