...
func (c *Client) addOperationGetTrainedModelInferenceJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetTrainedModelInferenceJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
