...
func (c *Client) addOperationListCollaborationTrainedModelInferenceJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCollaborationTrainedModelInferenceJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
