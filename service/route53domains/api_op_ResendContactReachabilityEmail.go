...
func addOperationResendContactReachabilityEmailStackSlots(stack *middleware.Stack) error {
...
func addOperationResendContactReachabilityEmailMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationResendContactReachabilityEmailStackSlots(stack); err != nil {
		return err
	}
