...
func (c *Client) ResendContactReachabilityEmail(ctx context.Context, params *ResendContactReachabilityEmailInput, optFns ...func(*Options)) (*ResendContactReachabilityEmailOutput, error) {
	if params == nil { params = &ResendContactReachabilityEmailInput{} }
...
func (c *Client) addOperationResendContactReachabilityEmailMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResendContactReachabilityEmailResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opResendContactReachabilityEmailResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opResendContactReachabilityEmailResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResendContactReachabilityEmailResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResendContactReachabilityEmailResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opResendContactReachabilityEmailResolveEndpointMiddleware{
