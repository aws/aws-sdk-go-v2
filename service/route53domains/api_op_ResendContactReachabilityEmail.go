...
func (c *Client) addOperationResendContactReachabilityEmailMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ResendContactReachabilityEmail", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
