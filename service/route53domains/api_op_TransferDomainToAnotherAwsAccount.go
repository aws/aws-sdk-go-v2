...
func (c *Client) addOperationTransferDomainToAnotherAwsAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "TransferDomainToAnotherAwsAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
