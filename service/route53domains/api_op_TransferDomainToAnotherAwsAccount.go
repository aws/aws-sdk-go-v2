...
func addOperationTransferDomainToAnotherAwsAccountStackSlots(stack *middleware.Stack) error {
...
func addOperationTransferDomainToAnotherAwsAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationTransferDomainToAnotherAwsAccountStackSlots(stack); err != nil {
		return err
	}
