...
func (c *Client) RetrieveDomainAuthCode(ctx context.Context, params *RetrieveDomainAuthCodeInput, optFns ...func(*Options)) (*RetrieveDomainAuthCodeOutput, error) {
	if params == nil { params = &RetrieveDomainAuthCodeInput{} }
...
func (c *Client) addOperationRetrieveDomainAuthCodeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRetrieveDomainAuthCodeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRetrieveDomainAuthCodeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRetrieveDomainAuthCodeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRetrieveDomainAuthCodeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRetrieveDomainAuthCodeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRetrieveDomainAuthCodeResolveEndpointMiddleware{
