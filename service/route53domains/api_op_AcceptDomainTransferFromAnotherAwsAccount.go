...
func addOperationAcceptDomainTransferFromAnotherAwsAccountStackSlots(stack *middleware.Stack) error {
...
func addOperationAcceptDomainTransferFromAnotherAwsAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAcceptDomainTransferFromAnotherAwsAccountStackSlots(stack); err != nil {
		return err
	}
