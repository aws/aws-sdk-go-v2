...
func (c *Client) EnableDomainAutoRenew(ctx context.Context, params *EnableDomainAutoRenewInput, optFns ...func(*Options)) (*EnableDomainAutoRenewOutput, error) {
	if params == nil { params = &EnableDomainAutoRenewInput{} }
...
func (c *Client) addOperationEnableDomainAutoRenewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableDomainAutoRenewResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEnableDomainAutoRenewResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEnableDomainAutoRenewResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableDomainAutoRenewResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableDomainAutoRenewResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEnableDomainAutoRenewResolveEndpointMiddleware{
