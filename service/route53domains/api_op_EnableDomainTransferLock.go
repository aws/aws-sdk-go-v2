...
func (c *Client) addOperationEnableDomainTransferLockMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableDomainTransferLock", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
