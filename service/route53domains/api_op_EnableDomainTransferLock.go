...
func (*EnableDomainTransferLockInput) operationName() string {
...
func (c *Client) addOperationEnableDomainTransferLockMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableDomainTransferLockResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opEnableDomainTransferLockResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opEnableDomainTransferLockResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableDomainTransferLockResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableDomainTransferLockResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opEnableDomainTransferLockResolveEndpointMiddleware{
