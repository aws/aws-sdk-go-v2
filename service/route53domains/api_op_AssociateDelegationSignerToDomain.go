...
func (c *Client) addOperationAssociateDelegationSignerToDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateDelegationSignerToDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
