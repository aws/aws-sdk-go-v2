...
func addOperationCancelDomainTransferToAnotherAwsAccountStackSlots(stack *middleware.Stack) error {
...
func addOperationCancelDomainTransferToAnotherAwsAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCancelDomainTransferToAnotherAwsAccountStackSlots(stack); err != nil {
		return err
	}
