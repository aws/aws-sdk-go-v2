...
func (c *Client) PushDomain(ctx context.Context, params *PushDomainInput, optFns ...func(*Options)) (*PushDomainOutput, error) {
	if params == nil { params = &PushDomainInput{} }
...
func (c *Client) addOperationPushDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPushDomainResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPushDomainResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPushDomainResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPushDomainResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPushDomainResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPushDomainResolveEndpointMiddleware{
