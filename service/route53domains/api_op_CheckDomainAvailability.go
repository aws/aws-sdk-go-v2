...
func (c *Client) addOperationCheckDomainAvailabilityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CheckDomainAvailability", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
