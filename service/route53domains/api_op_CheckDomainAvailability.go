...
func (c *Client) CheckDomainAvailability(ctx context.Context, params *CheckDomainAvailabilityInput, optFns ...func(*Options)) (*CheckDomainAvailabilityOutput, error) {
	if params == nil { params = &CheckDomainAvailabilityInput{} }
...
func (c *Client) addOperationCheckDomainAvailabilityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCheckDomainAvailabilityResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCheckDomainAvailabilityResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCheckDomainAvailabilityResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCheckDomainAvailabilityResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCheckDomainAvailabilityResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCheckDomainAvailabilityResolveEndpointMiddleware{
