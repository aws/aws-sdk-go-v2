...
func addOperationRejectDomainTransferFromAnotherAwsAccountStackSlots(stack *middleware.Stack) error {
...
func addOperationRejectDomainTransferFromAnotherAwsAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRejectDomainTransferFromAnotherAwsAccountStackSlots(stack); err != nil {
		return err
	}
