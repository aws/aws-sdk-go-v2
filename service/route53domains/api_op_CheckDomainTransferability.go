...
func (c *Client) addOperationCheckDomainTransferabilityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CheckDomainTransferability", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
