...
func addOperationCheckDomainTransferabilityStackSlots(stack *middleware.Stack) error {
...
func addOperationCheckDomainTransferabilityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCheckDomainTransferabilityStackSlots(stack); err != nil {
		return err
	}
