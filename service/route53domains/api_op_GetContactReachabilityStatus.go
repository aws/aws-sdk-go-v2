...
func addOperationGetContactReachabilityStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationGetContactReachabilityStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetContactReachabilityStatusStackSlots(stack); err != nil {
		return err
	}
