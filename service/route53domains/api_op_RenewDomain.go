...
func (c *Client) RenewDomain(ctx context.Context, params *RenewDomainInput, optFns ...func(*Options)) (*RenewDomainOutput, error) {
	if params == nil { params = &RenewDomainInput{} }
...
func (c *Client) addOperationRenewDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRenewDomainResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRenewDomainResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRenewDomainResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRenewDomainResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRenewDomainResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRenewDomainResolveEndpointMiddleware{
