...
func (c *Client) addOperationUpdateDomainNameserversMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDomainNameservers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
