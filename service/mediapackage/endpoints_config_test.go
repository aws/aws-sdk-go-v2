...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-mediapackage.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediapackage.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediapackage.dev",
			expectURL:     aws.String("https://env-mediapackage.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-mediapackage.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediapackage.dev",
			expectURL:     aws.String("http://config-mediapackage.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-mediapackage.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-mediapackage.dev",
			clientEndpoint: aws.String("https://client-mediapackage.dev"),
			expectURL:      aws.String("https://client-mediapackage.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MEDIAPACKAGE", c.envService)
			}
