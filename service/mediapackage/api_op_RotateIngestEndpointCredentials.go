...
func (*RotateIngestEndpointCredentialsInput) operationName() string {
...
func (c *Client) addOperationRotateIngestEndpointCredentialsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRotateIngestEndpointCredentialsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRotateIngestEndpointCredentialsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRotateIngestEndpointCredentialsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRotateIngestEndpointCredentialsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRotateIngestEndpointCredentialsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRotateIngestEndpointCredentialsResolveEndpointMiddleware{
