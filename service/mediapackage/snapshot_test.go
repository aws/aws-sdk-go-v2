...
func TestCheckSnapshot_ConfigureLogs(t *testing.T) {
	svc := New(Options{})
	_, err := svc.ConfigureLogs(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "ConfigureLogs")
		})
	})
...
func TestCheckSnapshot_DescribeHarvestJob(t *testing.T) {
	svc := New(Options{})
	_, err := svc.DescribeHarvestJob(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "DescribeHarvestJob")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestCheckSnapshot_DescribeOriginEndpoint(t *testing.T) {
	svc := New(Options{})
	_, err := svc.DescribeOriginEndpoint(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "DescribeOriginEndpoint")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestCheckSnapshot_RotateChannelCredentials(t *testing.T) {
	svc := New(Options{})
	_, err := svc.RotateChannelCredentials(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "RotateChannelCredentials")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestCheckSnapshot_RotateIngestEndpointCredentials(t *testing.T) {
	svc := New(Options{})
	_, err := svc.RotateIngestEndpointCredentials(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "RotateIngestEndpointCredentials")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_ConfigureLogs(t *testing.T) {
	svc := New(Options{})
	_, err := svc.ConfigureLogs(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return updateSnapshot(stack, "ConfigureLogs")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_DescribeHarvestJob(t *testing.T) {
	svc := New(Options{})
	_, err := svc.DescribeHarvestJob(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return updateSnapshot(stack, "DescribeHarvestJob")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_DescribeOriginEndpoint(t *testing.T) {
	svc := New(Options{})
	_, err := svc.DescribeOriginEndpoint(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return updateSnapshot(stack, "DescribeOriginEndpoint")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_RotateChannelCredentials(t *testing.T) {
	svc := New(Options{})
	_, err := svc.RotateChannelCredentials(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return updateSnapshot(stack, "RotateChannelCredentials")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_RotateIngestEndpointCredentials(t *testing.T) {
	svc := New(Options{})
	_, err := svc.RotateIngestEndpointCredentials(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return updateSnapshot(stack, "RotateIngestEndpointCredentials")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
