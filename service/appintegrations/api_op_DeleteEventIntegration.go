...
func (*DeleteEventIntegrationInput) operationName() string {
...
func (c *Client) addOperationDeleteEventIntegrationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteEventIntegrationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteEventIntegrationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteEventIntegrationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteEventIntegrationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteEventIntegrationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteEventIntegrationResolveEndpointMiddleware{
