...
func (*ListEventIntegrationAssociationsInput) operationName() string {
...
func (c *Client) addOperationListEventIntegrationAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEventIntegrationAssociationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListEventIntegrationAssociationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListEventIntegrationAssociationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEventIntegrationAssociationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEventIntegrationAssociationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListEventIntegrationAssociationsResolveEndpointMiddleware{
