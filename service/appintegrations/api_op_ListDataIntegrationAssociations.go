...
func (c *Client) addOperationListDataIntegrationAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDataIntegrationAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
