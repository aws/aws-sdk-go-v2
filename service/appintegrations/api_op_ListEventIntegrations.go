...
func (c *Client) ListEventIntegrations(ctx context.Context, params *ListEventIntegrationsInput, optFns ...func(*Options)) (*ListEventIntegrationsOutput, error) {
	if params == nil { params = &ListEventIntegrationsInput{} }
...
func (c *Client) addOperationListEventIntegrationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEventIntegrationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListEventIntegrationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListEventIntegrationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEventIntegrationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEventIntegrationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListEventIntegrationsResolveEndpointMiddleware{
