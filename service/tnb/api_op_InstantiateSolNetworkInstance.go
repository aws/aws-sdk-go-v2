...
func (c *Client) addOperationInstantiateSolNetworkInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "InstantiateSolNetworkInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
