...
func (c *Client) addOperationCreateSolFunctionPackageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateSolFunctionPackage", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
