...
func (*CreateSolNetworkPackageInput) operationName() string {
...
func (c *Client) addOperationCreateSolNetworkPackageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateSolNetworkPackageResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateSolNetworkPackageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateSolNetworkPackageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateSolNetworkPackageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateSolNetworkPackageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateSolNetworkPackageResolveEndpointMiddleware{
