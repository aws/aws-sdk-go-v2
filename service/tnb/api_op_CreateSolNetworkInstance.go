...
func (c *Client) addOperationCreateSolNetworkInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateSolNetworkInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
