...
func (c *Client) TerminateSolNetworkInstance(ctx context.Context, params *TerminateSolNetworkInstanceInput, optFns ...func(*Options)) (*TerminateSolNetworkInstanceOutput, error) {
	if params == nil { params = &TerminateSolNetworkInstanceInput{} }
...
func (c *Client) addOperationTerminateSolNetworkInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addTerminateSolNetworkInstanceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opTerminateSolNetworkInstanceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opTerminateSolNetworkInstanceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opTerminateSolNetworkInstanceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addTerminateSolNetworkInstanceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opTerminateSolNetworkInstanceResolveEndpointMiddleware{
