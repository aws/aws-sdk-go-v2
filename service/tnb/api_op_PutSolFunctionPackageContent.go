...
func (c *Client) addOperationPutSolFunctionPackageContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutSolFunctionPackageContent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
