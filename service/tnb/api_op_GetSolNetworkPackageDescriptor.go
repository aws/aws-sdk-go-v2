...
func (c *Client) addOperationGetSolNetworkPackageDescriptorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSolNetworkPackageDescriptor", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
