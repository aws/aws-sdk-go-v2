...
func (*GetSolNetworkPackageDescriptorInput) operationName() string {
	return "GetSolNetworkPackageDescriptor"
}
...
func (c *Client) addOperationGetSolNetworkPackageDescriptorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSolNetworkPackageDescriptorResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetSolNetworkPackageDescriptorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetSolNetworkPackageDescriptorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSolNetworkPackageDescriptorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSolNetworkPackageDescriptorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetSolNetworkPackageDescriptorResolveEndpointMiddleware{
