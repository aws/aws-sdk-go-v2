...
func (c *Client) addOperationListSolNetworkPackagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSolNetworkPackagesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListSolNetworkPackagesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListSolNetworkPackagesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSolNetworkPackagesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSolNetworkPackagesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListSolNetworkPackagesResolveEndpointMiddleware{
