...
func (*ListSolFunctionInstancesInput) operationName() string {
...
func (c *Client) addOperationListSolFunctionInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSolFunctionInstancesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListSolFunctionInstancesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListSolFunctionInstancesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSolFunctionInstancesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSolFunctionInstancesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListSolFunctionInstancesResolveEndpointMiddleware{
