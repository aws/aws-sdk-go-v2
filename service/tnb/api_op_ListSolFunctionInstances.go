...
func (c *Client) addOperationListSolFunctionInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSolFunctionInstances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
