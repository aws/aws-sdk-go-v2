...
func (*DeleteSolFunctionPackageInput) operationName() string {
...
func (c *Client) addOperationDeleteSolFunctionPackageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteSolFunctionPackageResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteSolFunctionPackageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteSolFunctionPackageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteSolFunctionPackageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteSolFunctionPackageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteSolFunctionPackageResolveEndpointMiddleware{
