...
func (c *Client) addOperationDeleteSolFunctionPackageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteSolFunctionPackage", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
