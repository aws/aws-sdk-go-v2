...
func (c *Client) addOperationValidateSolNetworkPackageContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ValidateSolNetworkPackageContent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
