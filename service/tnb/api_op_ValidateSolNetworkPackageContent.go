...
func (c *Client) ValidateSolNetworkPackageContent(ctx context.Context, params *ValidateSolNetworkPackageContentInput, optFns ...func(*Options)) (*ValidateSolNetworkPackageContentOutput, error) {
	if params == nil { params = &ValidateSolNetworkPackageContentInput{} }
...
func (c *Client) addOperationValidateSolNetworkPackageContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addValidateSolNetworkPackageContentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opValidateSolNetworkPackageContentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opValidateSolNetworkPackageContentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opValidateSolNetworkPackageContentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addValidateSolNetworkPackageContentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opValidateSolNetworkPackageContentResolveEndpointMiddleware{
