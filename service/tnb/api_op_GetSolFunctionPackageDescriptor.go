...
func (c *Client) GetSolFunctionPackageDescriptor(ctx context.Context, params *GetSolFunctionPackageDescriptorInput, optFns ...func(*Options)) (*GetSolFunctionPackageDescriptorOutput, error) {
	if params == nil { params = &GetSolFunctionPackageDescriptorInput{} }
...
func (c *Client) addOperationGetSolFunctionPackageDescriptorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSolFunctionPackageDescriptorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSolFunctionPackageDescriptorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSolFunctionPackageDescriptorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSolFunctionPackageDescriptorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSolFunctionPackageDescriptorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSolFunctionPackageDescriptorResolveEndpointMiddleware{
