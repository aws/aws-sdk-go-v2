...
func (c *Client) addOperationGetSolFunctionPackageDescriptorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSolFunctionPackageDescriptor", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
