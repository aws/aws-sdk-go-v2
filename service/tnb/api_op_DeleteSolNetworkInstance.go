...
func (c *Client) addOperationDeleteSolNetworkInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteSolNetworkInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
