...
func (c *Client) ValidateSolFunctionPackageContent(ctx context.Context, params *ValidateSolFunctionPackageContentInput, optFns ...func(*Options)) (*ValidateSolFunctionPackageContentOutput, error) {
	if params == nil { params = &ValidateSolFunctionPackageContentInput{} }
...
func (c *Client) addOperationValidateSolFunctionPackageContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addValidateSolFunctionPackageContentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opValidateSolFunctionPackageContentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opValidateSolFunctionPackageContentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opValidateSolFunctionPackageContentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addValidateSolFunctionPackageContentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opValidateSolFunctionPackageContentResolveEndpointMiddleware{
