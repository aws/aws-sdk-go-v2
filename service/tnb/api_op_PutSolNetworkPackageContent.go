...
func (c *Client) PutSolNetworkPackageContent(ctx context.Context, params *PutSolNetworkPackageContentInput, optFns ...func(*Options)) (*PutSolNetworkPackageContentOutput, error) {
	if params == nil { params = &PutSolNetworkPackageContentInput{} }
...
func (c *Client) addOperationPutSolNetworkPackageContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutSolNetworkPackageContentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutSolNetworkPackageContentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutSolNetworkPackageContentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutSolNetworkPackageContentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutSolNetworkPackageContentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutSolNetworkPackageContentResolveEndpointMiddleware{
