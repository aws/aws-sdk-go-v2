...
func (c *Client) addOperationListSolNetworkOperationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSolNetworkOperations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
