...
func (c *Client) addOperationGetSolNetworkPackageContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSolNetworkPackageContent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
