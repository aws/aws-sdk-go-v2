...
func (c *Client) ListSolFunctionPackages(ctx context.Context, params *ListSolFunctionPackagesInput, optFns ...func(*Options)) (*ListSolFunctionPackagesOutput, error) {
	if params == nil { params = &ListSolFunctionPackagesInput{} }
...
func (c *Client) addOperationListSolFunctionPackagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSolFunctionPackagesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSolFunctionPackagesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSolFunctionPackagesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSolFunctionPackagesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSolFunctionPackagesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSolFunctionPackagesResolveEndpointMiddleware{
