...
func addOperationListClosedWorkflowExecutionsStackSlots(stack *middleware.Stack) error {
...
func addOperationListClosedWorkflowExecutionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListClosedWorkflowExecutionsStackSlots(stack); err != nil {
		return err
	}
