...
func addOperationCountClosedWorkflowExecutionsStackSlots(stack *middleware.Stack) error {
...
func addOperationCountClosedWorkflowExecutionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCountClosedWorkflowExecutionsStackSlots(stack); err != nil {
		return err
	}
