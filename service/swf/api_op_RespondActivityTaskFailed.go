...
func (c *Client) addOperationRespondActivityTaskFailedMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RespondActivityTaskFailed", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
