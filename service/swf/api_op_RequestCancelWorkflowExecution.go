...
func (c *Client) addOperationRequestCancelWorkflowExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RequestCancelWorkflowExecution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
