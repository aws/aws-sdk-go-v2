...
func addOperationRequestCancelWorkflowExecutionStackSlots(stack *middleware.Stack) error {
...
func addOperationRequestCancelWorkflowExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRequestCancelWorkflowExecutionStackSlots(stack); err != nil {
		return err
	}
