...
func addOperationListOpenWorkflowExecutionsStackSlots(stack *middleware.Stack) error {
...
func addOperationListOpenWorkflowExecutionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListOpenWorkflowExecutionsStackSlots(stack); err != nil {
		return err
	}
