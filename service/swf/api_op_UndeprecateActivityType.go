...
func (c *Client) UndeprecateActivityType(ctx context.Context, params *UndeprecateActivityTypeInput, optFns ...func(*Options)) (*UndeprecateActivityTypeOutput, error) {
	if params == nil { params = &UndeprecateActivityTypeInput{} }
...
func (c *Client) addOperationUndeprecateActivityTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUndeprecateActivityTypeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUndeprecateActivityTypeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUndeprecateActivityTypeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUndeprecateActivityTypeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUndeprecateActivityTypeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUndeprecateActivityTypeResolveEndpointMiddleware{
