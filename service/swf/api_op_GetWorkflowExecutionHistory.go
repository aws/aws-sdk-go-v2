...
func (c *Client) addOperationGetWorkflowExecutionHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetWorkflowExecutionHistory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
