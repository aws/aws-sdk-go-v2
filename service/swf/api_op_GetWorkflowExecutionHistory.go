...
func (*GetWorkflowExecutionHistoryInput) operationName() string {
...
func (c *Client) addOperationGetWorkflowExecutionHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetWorkflowExecutionHistoryResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetWorkflowExecutionHistoryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetWorkflowExecutionHistoryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetWorkflowExecutionHistoryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetWorkflowExecutionHistoryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetWorkflowExecutionHistoryResolveEndpointMiddleware{
