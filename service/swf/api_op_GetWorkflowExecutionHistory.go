...
func addOperationGetWorkflowExecutionHistoryStackSlots(stack *middleware.Stack) error {
...
func addOperationGetWorkflowExecutionHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetWorkflowExecutionHistoryStackSlots(stack); err != nil {
		return err
	}
