...
func (c *Client) addOperationDescribeWorkflowExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeWorkflowExecution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
