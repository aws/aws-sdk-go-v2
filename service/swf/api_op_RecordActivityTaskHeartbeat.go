...
// resets the taskHeartbeatTimeout  clock. The taskHeartbeatTimeout is specified
// in RegisterActivityType. This action doesn't in itself create an event in the
...
// taskStartToCloseTimeoutof an activity type is the maximum duration of an
