...
func addOperationRecordActivityTaskHeartbeatStackSlots(stack *middleware.Stack) error {
...
func addOperationRecordActivityTaskHeartbeatMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRecordActivityTaskHeartbeatStackSlots(stack); err != nil {
		return err
	}
