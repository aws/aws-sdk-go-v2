...
func addOperationCountOpenWorkflowExecutionsStackSlots(stack *middleware.Stack) error {
...
func addOperationCountOpenWorkflowExecutionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCountOpenWorkflowExecutionsStackSlots(stack); err != nil {
		return err
	}
