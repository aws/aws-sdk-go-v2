...
// Amazon Simple Workflow Service  <p>The Amazon Simple Workflow Service (Amazon
// SWF) makes it easy to build applications that use Amazon's cloud to coordinate
// work across distributed components. In Amazon SWF, a <i>task</i> represents a
...
// application.</p> <p>Amazon SWF gives you full control over implementing tasks
// and coordinating them without worrying about underlying complexities such as
// tracking their progress and maintaining their state.</p> <p>This documentation
...
func addClientUserAgent(stack *middleware.Stack) {
	awsmiddleware.AddUserAgentKey("swf")(stack)
}
