...
// Amazon SWF. See this package's package overview docs
...
const (
	ServiceName = "Amazon SWF" // Service's name
	ServiceID   = "SWF"        // Service's identifier
	EndpointsID = "swf"        // Service's Endpoint identifier
)
