...
// event attribute's cause  parameter is set to OPERATION_NOT_PERMITTED. For
...
type RegisterActivityTypeInput struct {
	...
	// UnknownResourcefault. In this case, Amazon SWF no longer considers the
	// activity task to be valid; the activity worker should clean up the activity
	...
	// ScheduleActivityTask Decision. The duration is specified in seconds, an
