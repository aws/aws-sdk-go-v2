...
func (c *Client) DeprecateWorkflowType(ctx context.Context, params *DeprecateWorkflowTypeInput, optFns ...func(*Options)) (*DeprecateWorkflowTypeOutput, error) {
	if params == nil { params = &DeprecateWorkflowTypeInput{} }
...
func (c *Client) addOperationDeprecateWorkflowTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeprecateWorkflowTypeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeprecateWorkflowTypeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeprecateWorkflowTypeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeprecateWorkflowTypeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeprecateWorkflowTypeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeprecateWorkflowTypeResolveEndpointMiddleware{
