...
func (c *Client) RespondActivityTaskCanceled(ctx context.Context, params *RespondActivityTaskCanceledInput, optFns ...func(*Options)) (*RespondActivityTaskCanceledOutput, error) {
	if params == nil { params = &RespondActivityTaskCanceledInput{} }
...
func (c *Client) addOperationRespondActivityTaskCanceledMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRespondActivityTaskCanceledResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRespondActivityTaskCanceledResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRespondActivityTaskCanceledResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRespondActivityTaskCanceledResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRespondActivityTaskCanceledResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRespondActivityTaskCanceledResolveEndpointMiddleware{
