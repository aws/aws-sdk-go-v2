...
func (c *Client) addOperationRespondActivityTaskCanceledMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RespondActivityTaskCanceled", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
