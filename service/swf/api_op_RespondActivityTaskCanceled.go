...
func addOperationRespondActivityTaskCanceledStackSlots(stack *middleware.Stack) error {
...
func addOperationRespondActivityTaskCanceledMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRespondActivityTaskCanceledStackSlots(stack); err != nil {
		return err
	}
