...
func (c *Client) addOperationCountPendingActivityTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CountPendingActivityTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
