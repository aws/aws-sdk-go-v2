...
func (c *Client) addOperationSignalWorkflowExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SignalWorkflowExecution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
