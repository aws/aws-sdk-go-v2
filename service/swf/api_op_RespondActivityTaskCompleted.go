...
func (c *Client) addOperationRespondActivityTaskCompletedMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RespondActivityTaskCompleted", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
