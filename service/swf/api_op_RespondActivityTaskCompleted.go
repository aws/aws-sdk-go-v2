...
func addOperationRespondActivityTaskCompletedStackSlots(stack *middleware.Stack) error {
...
func addOperationRespondActivityTaskCompletedMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRespondActivityTaskCompletedStackSlots(stack); err != nil {
		return err
	}
