...
func (c *Client) addOperationRespondDecisionTaskCompletedMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RespondDecisionTaskCompleted", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
