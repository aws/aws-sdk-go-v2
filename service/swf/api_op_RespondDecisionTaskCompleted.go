...
func addOperationRespondDecisionTaskCompletedStackSlots(stack *middleware.Stack) error {
...
func addOperationRespondDecisionTaskCompletedMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRespondDecisionTaskCompletedStackSlots(stack); err != nil {
		return err
	}
