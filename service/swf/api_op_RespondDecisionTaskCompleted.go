...
// attached to the event in the workflow execution history. Access Control If an
// IAM policy grants permission to use RespondDecisionTaskCompleted, it can
...
// some parameters. For more information, see Using IAM to Manage Access to
