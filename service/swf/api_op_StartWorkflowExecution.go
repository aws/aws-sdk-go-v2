...
type StartWorkflowExecutionInput struct {
	...
	// workflowIdat the same time within the same domain. The specified string must
	...
	// TerminateWorkflowExecutionaction explicitly or due to an expired timeout. This
