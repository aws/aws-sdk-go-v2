...
func (c *Client) addOperationCountPendingDecisionTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CountPendingDecisionTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
