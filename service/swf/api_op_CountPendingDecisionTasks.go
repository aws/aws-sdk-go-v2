...
func (c *Client) CountPendingDecisionTasks(ctx context.Context, params *CountPendingDecisionTasksInput, optFns ...func(*Options)) (*CountPendingDecisionTasksOutput, error) {
	if params == nil { params = &CountPendingDecisionTasksInput{} }
...
func (c *Client) addOperationCountPendingDecisionTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCountPendingDecisionTasksResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCountPendingDecisionTasksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCountPendingDecisionTasksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCountPendingDecisionTasksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCountPendingDecisionTasksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCountPendingDecisionTasksResolveEndpointMiddleware{
