...
func addOperationTerminateWorkflowExecutionStackSlots(stack *middleware.Stack) error {
...
func addOperationTerminateWorkflowExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationTerminateWorkflowExecutionStackSlots(stack); err != nil {
		return err
	}
