...
// WorkflowExecutionTerminatedevent is recorded in the history of the current
// open workflow with the matching workflowId in the domain. You should consider
// using RequestCancelWorkflowExecution action instead because it allows the
// workflow to gracefully close while TerminateWorkflowExecution doesn't. Access
