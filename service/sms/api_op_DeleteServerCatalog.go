...
func (c *Client) DeleteServerCatalog(ctx context.Context, params *DeleteServerCatalogInput, optFns ...func(*Options)) (*DeleteServerCatalogOutput, error) {
	if params == nil { params = &DeleteServerCatalogInput{} }
...
func (c *Client) addOperationDeleteServerCatalogMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteServerCatalogResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteServerCatalogResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteServerCatalogResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteServerCatalogResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteServerCatalogResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteServerCatalogResolveEndpointMiddleware{
