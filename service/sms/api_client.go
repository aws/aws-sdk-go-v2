...
// SMS. See this package's package overview docs
...
const (
	ServiceName = "SMS" // Service's name
	ServiceID   = "SMS" // Service's identifier
	EndpointsID = "sms" // Service's Endpoint identifier
)
