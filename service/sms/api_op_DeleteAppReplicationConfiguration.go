...
func addOperationDeleteAppReplicationConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteAppReplicationConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteAppReplicationConfigurationStackSlots(stack); err != nil {
		return err
	}
