...
func (c *Client) StopAppReplication(ctx context.Context, params *StopAppReplicationInput, optFns ...func(*Options)) (*StopAppReplicationOutput, error) {
	if params == nil { params = &StopAppReplicationInput{} }
...
func (c *Client) addOperationStopAppReplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopAppReplicationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopAppReplicationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopAppReplicationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopAppReplicationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopAppReplicationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopAppReplicationResolveEndpointMiddleware{
