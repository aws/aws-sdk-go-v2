...
func (c *Client) ImportServerCatalog(ctx context.Context, params *ImportServerCatalogInput, optFns ...func(*Options)) (*ImportServerCatalogOutput, error) {
	if params == nil { params = &ImportServerCatalogInput{} }
...
func (c *Client) addOperationImportServerCatalogMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addImportServerCatalogResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opImportServerCatalogResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opImportServerCatalogResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opImportServerCatalogResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addImportServerCatalogResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opImportServerCatalogResolveEndpointMiddleware{
