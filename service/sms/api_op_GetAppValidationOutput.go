...
func (c *Client) GetAppValidationOutput(ctx context.Context, params *GetAppValidationOutputInput, optFns ...func(*Options)) (*GetAppValidationOutputOutput, error) {
	if params == nil { params = &GetAppValidationOutputInput{} }
...
func (c *Client) addOperationGetAppValidationOutputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAppValidationOutputResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAppValidationOutputResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAppValidationOutputResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAppValidationOutputResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAppValidationOutputResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAppValidationOutputResolveEndpointMiddleware{
