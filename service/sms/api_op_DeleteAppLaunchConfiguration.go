...
func addOperationDeleteAppLaunchConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteAppLaunchConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteAppLaunchConfigurationStackSlots(stack); err != nil {
		return err
	}
