...
func (c *Client) GetConnectors(ctx context.Context, params *GetConnectorsInput, optFns ...func(*Options)) (*GetConnectorsOutput, error) {
	if params == nil { params = &GetConnectorsInput{} }
...
func (c *Client) addOperationGetConnectorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetConnectorsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetConnectorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetConnectorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetConnectorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetConnectorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetConnectorsResolveEndpointMiddleware{
