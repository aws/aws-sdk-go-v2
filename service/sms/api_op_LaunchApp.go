...
func (c *Client) LaunchApp(ctx context.Context, params *LaunchAppInput, optFns ...func(*Options)) (*LaunchAppOutput, error) {
	if params == nil { params = &LaunchAppInput{} }
...
func (c *Client) addOperationLaunchAppMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addLaunchAppResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opLaunchAppResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opLaunchAppResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opLaunchAppResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addLaunchAppResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opLaunchAppResolveEndpointMiddleware{
