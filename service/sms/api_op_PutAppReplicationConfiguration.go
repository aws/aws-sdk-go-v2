...
func addOperationPutAppReplicationConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationPutAppReplicationConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutAppReplicationConfigurationStackSlots(stack); err != nil {
		return err
	}
