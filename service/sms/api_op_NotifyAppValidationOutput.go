...
func (c *Client) NotifyAppValidationOutput(ctx context.Context, params *NotifyAppValidationOutputInput, optFns ...func(*Options)) (*NotifyAppValidationOutputOutput, error) {
	if params == nil { params = &NotifyAppValidationOutputInput{} }
...
func (c *Client) addOperationNotifyAppValidationOutputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addNotifyAppValidationOutputResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opNotifyAppValidationOutputResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opNotifyAppValidationOutputResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opNotifyAppValidationOutputResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addNotifyAppValidationOutputResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opNotifyAppValidationOutputResolveEndpointMiddleware{
