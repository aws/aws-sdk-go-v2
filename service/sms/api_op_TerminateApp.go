...
func (c *Client) TerminateApp(ctx context.Context, params *TerminateAppInput, optFns ...func(*Options)) (*TerminateAppOutput, error) {
	if params == nil { params = &TerminateAppInput{} }
...
func (c *Client) addOperationTerminateAppMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addTerminateAppResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opTerminateAppResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opTerminateAppResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opTerminateAppResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addTerminateAppResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opTerminateAppResolveEndpointMiddleware{
