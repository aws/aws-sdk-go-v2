...
func (c *Client) addOperationDescribeBatchPredictionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeBatchPredictions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
