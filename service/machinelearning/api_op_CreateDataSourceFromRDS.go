...
// Amazon ML cannot accept the input source, it sets the Status  parameter to
...
// CreateDataSourceFromRDS> operation is asynchronous. You can poll for updates
// by using the GetBatchPrediction  operation and checking the Status parameter.
// You can inspect the Message  when Status  shows up as FAILED. You can also
// check the progress of the copy operation by going to the DataPipeline console
// and looking up the pipeline using the pipelineId  from the describe call.
