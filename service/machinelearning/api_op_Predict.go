...
func addOperationPredictStackSlots(stack *middleware.Stack) error {
	...
	if err := stack.Serialize.InsertSlot(awsid.ResolveEndpoint, middleware.After,
		mlcust.PredictEndpointMiddlewareID,
	); err != nil {
		return err
	}
...
func addOperationPredictMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPredictStackSlots(stack); err != nil {
		return err
	}
