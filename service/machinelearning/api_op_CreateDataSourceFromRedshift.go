...
type CreateDataSourceFromRedshiftInput struct {
	...
	//
	// - DatabaseCredentials - The
	// AWS Identity and Access Management (IAM) credentials that are used to connect to
	// the Amazon Redshift database.
	// - SelectSqlQuery - The query that is used to
	// retrieve the observation data for the Datasource.
	// - S3StagingLocation - The
	// Amazon Simple Storage Service (Amazon S3) location for staging Amazon Redshift
	// data. The data retrieved from Amazon Redshift using the SelectSqlQuery query is
	// stored in this location.
	// - DataSchemaUri - The Amazon S3 location of the
	// DataSchema.
	// - DataSchema - A JSON string representing the schema. This is not
	// required if DataSchemaUri is specified.
	// - DataRearrangement - A JSON string that
	// represents the splitting and rearrangement requirements for the DataSource.
	...
	// - An Amazon
	// S3 bucket policy to grant Amazon ML read/write permissions on the
	// S3StagingLocation
	//
	// This member is required.
	RoleARN *string
