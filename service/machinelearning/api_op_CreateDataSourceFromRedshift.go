...
func addOperationCreateDataSourceFromRedshiftStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateDataSourceFromRedshiftMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateDataSourceFromRedshiftStackSlots(stack); err != nil {
		return err
	}
