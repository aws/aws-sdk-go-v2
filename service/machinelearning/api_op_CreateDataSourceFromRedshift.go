...
// Amazon ML can't accept the input source, it sets the Status  parameter to
// FAILED and includes an error message in the Message  attribute of the
// GetDataSourceoperation response. The observations should be contained in the
// database hosted on an Amazon Redshift cluster and should be specified by a
// SelectSqlQuery query. Amazon ML executes an Unload command in Amazon Redshift
// to transfer the result set of the SelectSqlQuery  query to S3StagingLocation.
...
// DataSourcealso requires a recipe. A recipe describes how each input variable
...
// CreateDataSourceFromRedshiftoperation is asynchronous. You can poll for
