...
//
// Deprecated: This API has been deprecated in favor of the
// GetLatestConfiguration API used in conjunction with StartConfigurationSession.
...
type GetConfigurationInput struct {
	...
	// ConfigurationVersion attribute returned by GetConfiguration when there is new
	// or updated data, and should be saved for subsequent calls to GetConfiguration.
...
type GetConfigurationOutput struct {
	...
	// matches the version of the current configuration, AppConfig returns a 204 No
	// Content HTTP response code and the Content  value will be empty.
	Content []byte
