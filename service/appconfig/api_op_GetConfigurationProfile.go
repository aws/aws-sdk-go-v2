...
func (c *Client) addOperationGetConfigurationProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetConfigurationProfile", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
