...
func (s *ListDeploymentStrategiesInput) Validate() error {
	invalidParams := aws.ErrInvalidParams{Context: "ListDeploymentStrategiesInput"}
...
func (s ListDeploymentStrategiesInput) MarshalFields(e protocol.FieldEncoder) error {
...
// MarshalFields encodes the AWS API shape using the passed in protocol encoder.
func (s ListDeploymentStrategiesOutput) MarshalFields(e protocol.FieldEncoder) error {
	if s.Items != nil {
		v := s.Items
...
// ListDeploymentStrategiesRequest returns a request value for making API operation for
// Amazon AppConfig.
//
...
// ListDeploymentStrategiesRequest is the request type for the
// ListDeploymentStrategies API operation.
...
func (r ListDeploymentStrategiesRequest) Send(ctx context.Context) (*ListDeploymentStrategiesResponse, error) {
	...
	resp := &ListDeploymentStrategiesResponse{
		ListDeploymentStrategiesOutput: r.Request.Data.(*ListDeploymentStrategiesOutput),
...
// NewListDeploymentStrategiesRequestPaginator returns a paginator for ListDeploymentStrategies.
...
// ListDeploymentStrategiesPaginator is used to paginate the request. This can be done by
// calling Next and CurrentPage.
type ListDeploymentStrategiesPaginator struct {
	aws.Pager
}

func (p *ListDeploymentStrategiesPaginator) CurrentPage() *ListDeploymentStrategiesOutput {
	return p.Pager.CurrentPage().(*ListDeploymentStrategiesOutput)
}

// ListDeploymentStrategiesResponse is the response type for the
// ListDeploymentStrategies API operation.
...
// ListDeploymentStrategies request.
