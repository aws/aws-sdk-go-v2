...
func (*ListDeploymentStrategiesInput) operationName() string {
...
func (c *Client) addOperationListDeploymentStrategiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDeploymentStrategiesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListDeploymentStrategiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListDeploymentStrategiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDeploymentStrategiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDeploymentStrategiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListDeploymentStrategiesResolveEndpointMiddleware{
