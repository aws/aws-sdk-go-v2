...
func (c *Client) addOperationUpdateDeploymentStrategyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDeploymentStrategy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
