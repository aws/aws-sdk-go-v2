...
type UpdateDeploymentStrategyInput struct {
	...
	// formula, G  is the growth factor specified by the user and N is the number of
	// steps until the configuration is deployed to all targets. For example, if you
