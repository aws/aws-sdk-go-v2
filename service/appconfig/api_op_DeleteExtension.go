...
func (*DeleteExtensionInput) operationName() string {
...
func (c *Client) addOperationDeleteExtensionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteExtensionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteExtensionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteExtensionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteExtensionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteExtensionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteExtensionResolveEndpointMiddleware{
