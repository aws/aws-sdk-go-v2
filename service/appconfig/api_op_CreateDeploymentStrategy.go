...
func (c *Client) addOperationCreateDeploymentStrategyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateDeploymentStrategy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
