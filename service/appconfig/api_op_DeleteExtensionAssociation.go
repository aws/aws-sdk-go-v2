...
func (c *Client) DeleteExtensionAssociation(ctx context.Context, params *DeleteExtensionAssociationInput, optFns ...func(*Options)) (*DeleteExtensionAssociationOutput, error) {
	if params == nil { params = &DeleteExtensionAssociationInput{} }
...
func (c *Client) addOperationDeleteExtensionAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteExtensionAssociationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteExtensionAssociationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteExtensionAssociationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteExtensionAssociationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteExtensionAssociationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteExtensionAssociationResolveEndpointMiddleware{
