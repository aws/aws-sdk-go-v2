...
func (c *Client) addOperationDeleteExtensionAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteExtensionAssociation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
