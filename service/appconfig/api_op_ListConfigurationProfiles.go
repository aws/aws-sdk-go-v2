...
func (c *Client) addOperationListConfigurationProfilesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListConfigurationProfiles", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
