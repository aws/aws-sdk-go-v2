...
func (s *ListConfigurationProfilesInput) Validate() error {
	invalidParams := aws.ErrInvalidParams{Context: "ListConfigurationProfilesInput"}
...
func (s ListConfigurationProfilesInput) MarshalFields(e protocol.FieldEncoder) error {
...
// MarshalFields encodes the AWS API shape using the passed in protocol encoder.
func (s ListConfigurationProfilesOutput) MarshalFields(e protocol.FieldEncoder) error {
	if s.Items != nil {
		v := s.Items
...
// ListConfigurationProfilesRequest returns a request value for making API operation for
// Amazon AppConfig.
//
...
// ListConfigurationProfilesRequest is the request type for the
// ListConfigurationProfiles API operation.
...
func (r ListConfigurationProfilesRequest) Send(ctx context.Context) (*ListConfigurationProfilesResponse, error) {
	...
	resp := &ListConfigurationProfilesResponse{
		ListConfigurationProfilesOutput: r.Request.Data.(*ListConfigurationProfilesOutput),
...
// NewListConfigurationProfilesRequestPaginator returns a paginator for ListConfigurationProfiles.
...
// ListConfigurationProfilesPaginator is used to paginate the request. This can be done by
// calling Next and CurrentPage.
type ListConfigurationProfilesPaginator struct {
	aws.Pager
}

func (p *ListConfigurationProfilesPaginator) CurrentPage() *ListConfigurationProfilesOutput {
	return p.Pager.CurrentPage().(*ListConfigurationProfilesOutput)
}

// ListConfigurationProfilesResponse is the response type for the
// ListConfigurationProfiles API operation.
...
// ListConfigurationProfiles request.
