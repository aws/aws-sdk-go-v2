...
func addOperationDeleteHostedConfigurationVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteHostedConfigurationVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteHostedConfigurationVersionStackSlots(stack); err != nil {
		return err
	}
