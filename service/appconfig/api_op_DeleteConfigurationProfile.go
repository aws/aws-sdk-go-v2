...
func addOperationDeleteConfigurationProfileStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteConfigurationProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteConfigurationProfileStackSlots(stack); err != nil {
		return err
	}
