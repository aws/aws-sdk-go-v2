...
func (c *Client) addOperationListExtensionAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListExtensionAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
