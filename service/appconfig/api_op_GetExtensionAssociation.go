...
func (*GetExtensionAssociationInput) operationName() string {
...
func (c *Client) addOperationGetExtensionAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetExtensionAssociationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetExtensionAssociationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetExtensionAssociationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetExtensionAssociationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetExtensionAssociationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetExtensionAssociationResolveEndpointMiddleware{
