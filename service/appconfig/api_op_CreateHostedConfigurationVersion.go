...
func addOperationCreateHostedConfigurationVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateHostedConfigurationVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateHostedConfigurationVersionStackSlots(stack); err != nil {
		return err
	}
