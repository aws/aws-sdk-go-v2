...
func (*DeleteDeploymentStrategyInput) operationName() string {
...
func (c *Client) addOperationDeleteDeploymentStrategyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteDeploymentStrategyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteDeploymentStrategyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteDeploymentStrategyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteDeploymentStrategyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteDeploymentStrategyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteDeploymentStrategyResolveEndpointMiddleware{
