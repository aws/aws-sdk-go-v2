...
func (c *Client) addOperationUpdateImageStorageClassMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateImageStorageClass", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
