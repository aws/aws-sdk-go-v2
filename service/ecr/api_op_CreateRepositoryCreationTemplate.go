...
func (c *Client) addOperationCreateRepositoryCreationTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateRepositoryCreationTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
