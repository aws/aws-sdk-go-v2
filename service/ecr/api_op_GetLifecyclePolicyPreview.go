...
func (c *Client) addOperationGetLifecyclePolicyPreviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetLifecyclePolicyPreview", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
