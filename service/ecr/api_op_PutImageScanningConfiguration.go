...
func addOperationPutImageScanningConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationPutImageScanningConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutImageScanningConfigurationStackSlots(stack); err != nil {
		return err
	}
