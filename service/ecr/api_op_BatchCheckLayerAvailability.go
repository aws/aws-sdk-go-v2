...
func addOperationBatchCheckLayerAvailabilityStackSlots(stack *middleware.Stack) error {
...
func addOperationBatchCheckLayerAvailabilityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationBatchCheckLayerAvailabilityStackSlots(stack); err != nil {
		return err
	}
