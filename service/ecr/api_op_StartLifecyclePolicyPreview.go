...
func (c *Client) addOperationStartLifecyclePolicyPreviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartLifecyclePolicyPreview", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
