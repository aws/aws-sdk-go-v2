...
func addOperationStartLifecyclePolicyPreviewStackSlots(stack *middleware.Stack) error {
...
func addOperationStartLifecyclePolicyPreviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartLifecyclePolicyPreviewStackSlots(stack); err != nil {
		return err
	}
