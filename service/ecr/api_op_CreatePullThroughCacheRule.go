...
func (c *Client) addOperationCreatePullThroughCacheRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreatePullThroughCacheRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
