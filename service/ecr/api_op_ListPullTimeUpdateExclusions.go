...
func (c *Client) addOperationListPullTimeUpdateExclusionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPullTimeUpdateExclusions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
