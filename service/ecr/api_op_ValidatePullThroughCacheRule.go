...
func (c *Client) addOperationValidatePullThroughCacheRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ValidatePullThroughCacheRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
