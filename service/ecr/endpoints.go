	...
	if exprVal := params.Region; exprVal != nil {
		...
		if exprVal := awsrulesfn.GetPartition(_Region); exprVal != nil {
			...
			if _Region == "af-south-1" {
				uriString := "https://api.ecr.af-south-1.amazonaws.com"
			...
			if _Region == "ap-east-1" {
				uriString := "https://api.ecr.ap-east-1.amazonaws.com"
			...
			if _Region == "ap-northeast-1" {
				uriString := "https://api.ecr.ap-northeast-1.amazonaws.com"
			...
			if _Region == "ap-northeast-2" {
				uriString := "https://api.ecr.ap-northeast-2.amazonaws.com"
			...
			if _Region == "ap-northeast-3" {
				uriString := "https://api.ecr.ap-northeast-3.amazonaws.com"
			...
			if _Region == "ap-south-1" {
				uriString := "https://api.ecr.ap-south-1.amazonaws.com"
			...
			if _Region == "ap-southeast-1" {
				uriString := "https://api.ecr.ap-southeast-1.amazonaws.com"
			...
			if _Region == "ap-southeast-2" {
				uriString := "https://api.ecr.ap-southeast-2.amazonaws.com"
			...
			if _Region == "ap-southeast-3" {
				uriString := "https://api.ecr.ap-southeast-3.amazonaws.com"
			...
			if _Region == "ca-central-1" {
				uriString := "https://api.ecr.ca-central-1.amazonaws.com"
			...
			if _Region == "eu-central-1" {
				uriString := "https://api.ecr.eu-central-1.amazonaws.com"
			...
			if _Region == "eu-north-1" {
				uriString := "https://api.ecr.eu-north-1.amazonaws.com"
			...
			if _Region == "eu-south-1" {
				uriString := "https://api.ecr.eu-south-1.amazonaws.com"
			...
			if _Region == "eu-west-1" {
				uriString := "https://api.ecr.eu-west-1.amazonaws.com"
			...
			if _Region == "eu-west-2" {
				uriString := "https://api.ecr.eu-west-2.amazonaws.com"
			...
			if _Region == "eu-west-3" {
				uriString := "https://api.ecr.eu-west-3.amazonaws.com"
			...
			if _Region == "me-south-1" {
				uriString := "https://api.ecr.me-south-1.amazonaws.com"
			...
			if _Region == "sa-east-1" {
				uriString := "https://api.ecr.sa-east-1.amazonaws.com"
			...
			if _Region == "us-east-1" {
				uriString := "https://api.ecr.us-east-1.amazonaws.com"
			...
			if _Region == "us-east-2" {
				uriString := "https://api.ecr.us-east-2.amazonaws.com"
			...
			if _Region == "us-west-1" {
				uriString := "https://api.ecr.us-west-1.amazonaws.com"
			...
			if _Region == "us-west-2" {
				uriString := "https://api.ecr.us-west-2.amazonaws.com"
			...
			if _Region == "cn-north-1" {
				uriString := "https://api.ecr.cn-north-1.amazonaws.com.cn"
			...
			if _Region == "cn-northwest-1" {
				uriString := "https://api.ecr.cn-northwest-1.amazonaws.com.cn"
			...
			if _Region == "us-gov-east-1" {
				uriString := "https://api.ecr.us-gov-east-1.amazonaws.com"
			...
			if _Region == "us-gov-west-1" {
				uriString := "https://api.ecr.us-gov-west-1.amazonaws.com"
			...
			if _Region == "us-iso-east-1" {
				uriString := "https://api.ecr.us-iso-east-1.c2s.ic.gov"
			...
			if _Region == "us-iso-west-1" {
				uriString := "https://api.ecr.us-iso-west-1.c2s.ic.gov"
			...
			if _Region == "us-isob-east-1" {
				uriString := "https://api.ecr.us-isob-east-1.sc2s.sgov.gov"
