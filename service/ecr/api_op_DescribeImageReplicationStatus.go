...
func (c *Client) addOperationDescribeImageReplicationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeImageReplicationStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
