...
func (c *Client) addOperationDescribeImageSigningStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeImageSigningStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
