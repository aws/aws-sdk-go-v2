...
func (c *Client) addOperationDescribeImageScanFindingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeImageScanFindings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
