...
func (c *Client) addOperationDescribePullThroughCacheRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribePullThroughCacheRules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
