...
func (c *Client) addOperationRegisterPullTimeUpdateExclusionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterPullTimeUpdateExclusion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
