...
func (c *Client) addOperationDeregisterPullTimeUpdateExclusionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterPullTimeUpdateExclusion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
