...
func (c *Client) RollbackTransaction(ctx context.Context, params *RollbackTransactionInput, optFns ...func(*Options)) (*RollbackTransactionOutput, error) {
	if params == nil { params = &RollbackTransactionInput{} }
...
func (c *Client) addOperationRollbackTransactionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRollbackTransactionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRollbackTransactionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRollbackTransactionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRollbackTransactionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRollbackTransactionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRollbackTransactionResolveEndpointMiddleware{
