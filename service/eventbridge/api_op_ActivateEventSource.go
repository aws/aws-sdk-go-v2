...
func (c *Client) ActivateEventSource(ctx context.Context, params *ActivateEventSourceInput, optFns ...func(*Options)) (*ActivateEventSourceOutput, error) {
	stack := middleware.NewStack("ActivateEventSource", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpActivateEventSourceMiddlewares(stack)
...
func addawsAwsjson11_serdeOpActivateEventSourceMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpActivateEventSource{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpActivateEventSource{}, middleware.After)
}
