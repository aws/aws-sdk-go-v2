...
func (c *Client) addOperationActivateEventSourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addActivateEventSourceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opActivateEventSourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  BuiltInParameterResolver
}

func (*opActivateEventSourceResolveEndpointMiddleware) ID() string {
	return "opActivateEventSourceResolveEndpointMiddleware"
}

func (m *opActivateEventSourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addActivateEventSourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opActivateEventSourceResolveEndpointMiddleware{
