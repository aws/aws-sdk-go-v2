...
func (c *Client) addOperationListTargetsByRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTargetsByRuleResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListTargetsByRuleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  BuiltInParameterResolver
}

func (*opListTargetsByRuleResolveEndpointMiddleware) ID() string {
	return "opListTargetsByRuleResolveEndpointMiddleware"
}

func (m *opListTargetsByRuleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTargetsByRuleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListTargetsByRuleResolveEndpointMiddleware{
