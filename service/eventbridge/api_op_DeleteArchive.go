...
func (c *Client) addOperationDeleteArchiveMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteArchiveResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
func (*opDeleteArchiveResolveEndpointMiddleware) ID() string {
	return "opDeleteArchiveResolveEndpointMiddleware"
}

func (m *opDeleteArchiveResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
