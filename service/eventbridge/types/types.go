...
type Connection struct {
	...
	// The authorization type specified for the connection. OAUTH tokens are
...
type InputTransformer struct {
	...
	// target. Enclose each InputPathsMaps  value in brackets: <value> If
	// InputTemplateis a JSON object (surrounded by curly braces), the following
	// restrictions apply:
