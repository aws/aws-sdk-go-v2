...
func (c *Client) addOperationListRuleNamesByTargetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRuleNamesByTargetResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListRuleNamesByTargetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  BuiltInParameterResolver
}

func (*opListRuleNamesByTargetResolveEndpointMiddleware) ID() string {
	return "opListRuleNamesByTargetResolveEndpointMiddleware"
}

func (m *opListRuleNamesByTargetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRuleNamesByTargetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListRuleNamesByTargetResolveEndpointMiddleware{
