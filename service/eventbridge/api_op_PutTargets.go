...
// instances with one rule, you can use the RunCommandParameters field. To be
// able to make API calls against the resources that you own, Amazon EventBridge
// needs the appropriate permissions. For Lambda and Amazon SNS resources,
// EventBridge relies on resource-based policies. For EC2 instances, Kinesis Data
// Streams, Step Functions state machines and API Gateway APIs, EventBridge relies
// on IAM roles that you specify in the RoleARN  argument in PutTargets. For more
