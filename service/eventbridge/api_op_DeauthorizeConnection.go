...
func (c *Client) addOperationDeauthorizeConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeauthorizeConnectionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeauthorizeConnectionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  BuiltInParameterResolver
}

func (*opDeauthorizeConnectionResolveEndpointMiddleware) ID() string {
	return "opDeauthorizeConnectionResolveEndpointMiddleware"
}

func (m *opDeauthorizeConnectionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeauthorizeConnectionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeauthorizeConnectionResolveEndpointMiddleware{
