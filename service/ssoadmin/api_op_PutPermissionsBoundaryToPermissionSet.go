...
func (c *Client) addOperationPutPermissionsBoundaryToPermissionSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutPermissionsBoundaryToPermissionSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
