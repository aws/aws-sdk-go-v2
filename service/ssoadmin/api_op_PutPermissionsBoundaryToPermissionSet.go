...
func (*PutPermissionsBoundaryToPermissionSetInput) operationName() string {
...
func (c *Client) addOperationPutPermissionsBoundaryToPermissionSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutPermissionsBoundaryToPermissionSetResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opPutPermissionsBoundaryToPermissionSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opPutPermissionsBoundaryToPermissionSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutPermissionsBoundaryToPermissionSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutPermissionsBoundaryToPermissionSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opPutPermissionsBoundaryToPermissionSetResolveEndpointMiddleware{
