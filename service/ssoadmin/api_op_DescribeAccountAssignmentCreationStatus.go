...
func (c *Client) addOperationDescribeAccountAssignmentCreationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAccountAssignmentCreationStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
