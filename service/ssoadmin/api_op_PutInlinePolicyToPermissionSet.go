...
func (c *Client) addOperationPutInlinePolicyToPermissionSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutInlinePolicyToPermissionSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
