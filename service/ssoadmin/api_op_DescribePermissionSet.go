...
func addOperationDescribePermissionSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpDescribePermissionSetValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opDescribePermissionSet(options.Region), middleware.Before)
