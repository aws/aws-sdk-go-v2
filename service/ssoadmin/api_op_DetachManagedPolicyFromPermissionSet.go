...
func (c *Client) DetachManagedPolicyFromPermissionSet(ctx context.Context, params *DetachManagedPolicyFromPermissionSetInput, optFns ...func(*Options)) (*DetachManagedPolicyFromPermissionSetOutput, error) {
	if params == nil { params = &DetachManagedPolicyFromPermissionSetInput{} }
...
func (c *Client) addOperationDetachManagedPolicyFromPermissionSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDetachManagedPolicyFromPermissionSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDetachManagedPolicyFromPermissionSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDetachManagedPolicyFromPermissionSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDetachManagedPolicyFromPermissionSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDetachManagedPolicyFromPermissionSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDetachManagedPolicyFromPermissionSetResolveEndpointMiddleware{
