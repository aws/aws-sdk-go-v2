...
func (c *Client) addOperationListPermissionSetProvisioningStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPermissionSetProvisioningStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
