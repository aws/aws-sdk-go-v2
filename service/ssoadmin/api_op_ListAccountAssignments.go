...
func addOperationListAccountAssignmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpListAccountAssignmentsValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opListAccountAssignments(options.Region), middleware.Before)
