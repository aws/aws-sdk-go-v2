...
func (c *Client) addOperationDescribePermissionSetProvisioningStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribePermissionSetProvisioningStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
