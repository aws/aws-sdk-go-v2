...
func (c *Client) DescribePermissionSetProvisioningStatus(ctx context.Context, params *DescribePermissionSetProvisioningStatusInput, optFns ...func(*Options)) (*DescribePermissionSetProvisioningStatusOutput, error) {
	if params == nil { params = &DescribePermissionSetProvisioningStatusInput{} }
...
func (c *Client) addOperationDescribePermissionSetProvisioningStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribePermissionSetProvisioningStatusResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribePermissionSetProvisioningStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribePermissionSetProvisioningStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribePermissionSetProvisioningStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribePermissionSetProvisioningStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribePermissionSetProvisioningStatusResolveEndpointMiddleware{
