...
func (c *Client) DetachCustomerManagedPolicyReferenceFromPermissionSet(ctx context.Context, params *DetachCustomerManagedPolicyReferenceFromPermissionSetInput, optFns ...func(*Options)) (*DetachCustomerManagedPolicyReferenceFromPermissionSetOutput, error) {
	if params == nil { params = &DetachCustomerManagedPolicyReferenceFromPermissionSetInput{} }
...
func (c *Client) addOperationDetachCustomerManagedPolicyReferenceFromPermissionSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDetachCustomerManagedPolicyReferenceFromPermissionSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDetachCustomerManagedPolicyReferenceFromPermissionSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDetachCustomerManagedPolicyReferenceFromPermissionSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDetachCustomerManagedPolicyReferenceFromPermissionSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDetachCustomerManagedPolicyReferenceFromPermissionSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDetachCustomerManagedPolicyReferenceFromPermissionSetResolveEndpointMiddleware{
