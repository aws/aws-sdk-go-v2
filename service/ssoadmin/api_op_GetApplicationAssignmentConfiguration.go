...
func (c *Client) addOperationGetApplicationAssignmentConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetApplicationAssignmentConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
