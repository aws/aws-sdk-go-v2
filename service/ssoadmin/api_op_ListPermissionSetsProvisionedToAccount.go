...
func (c *Client) ListPermissionSetsProvisionedToAccount(ctx context.Context, params *ListPermissionSetsProvisionedToAccountInput, optFns ...func(*Options)) (*ListPermissionSetsProvisionedToAccountOutput, error) {
	if params == nil { params = &ListPermissionSetsProvisionedToAccountInput{} }
...
func (c *Client) addOperationListPermissionSetsProvisionedToAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPermissionSetsProvisionedToAccountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPermissionSetsProvisionedToAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPermissionSetsProvisionedToAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPermissionSetsProvisionedToAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPermissionSetsProvisionedToAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPermissionSetsProvisionedToAccountResolveEndpointMiddleware{
