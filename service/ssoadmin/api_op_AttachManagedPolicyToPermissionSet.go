...
// Attaches an AWS managed policy ARN to a permission set. If the permission set
// is already referenced by one or more account assignments, you will need to call
...
func (c *Client) AttachManagedPolicyToPermissionSet(ctx context.Context, params *AttachManagedPolicyToPermissionSetInput, optFns ...func(*Options)) (*AttachManagedPolicyToPermissionSetOutput, error) {
	if params == nil { params = &AttachManagedPolicyToPermissionSetInput{} }
...
func (c *Client) addOperationAttachManagedPolicyToPermissionSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAttachManagedPolicyToPermissionSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAttachManagedPolicyToPermissionSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAttachManagedPolicyToPermissionSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAttachManagedPolicyToPermissionSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAttachManagedPolicyToPermissionSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAttachManagedPolicyToPermissionSetResolveEndpointMiddleware{
