...
func (c *Client) addOperationListApplicationAuthenticationMethodsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListApplicationAuthenticationMethods", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
