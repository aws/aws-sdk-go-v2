...
func (c *Client) DeleteInlinePolicyFromPermissionSet(ctx context.Context, params *DeleteInlinePolicyFromPermissionSetInput, optFns ...func(*Options)) (*DeleteInlinePolicyFromPermissionSetOutput, error) {
	if params == nil { params = &DeleteInlinePolicyFromPermissionSetInput{} }
...
func (c *Client) addOperationDeleteInlinePolicyFromPermissionSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteInlinePolicyFromPermissionSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteInlinePolicyFromPermissionSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteInlinePolicyFromPermissionSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteInlinePolicyFromPermissionSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteInlinePolicyFromPermissionSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteInlinePolicyFromPermissionSetResolveEndpointMiddleware{
