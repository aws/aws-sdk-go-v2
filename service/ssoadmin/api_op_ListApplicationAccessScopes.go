...
func (c *Client) addOperationListApplicationAccessScopesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListApplicationAccessScopes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
