...
func (c *Client) addOperationListApplicationProvidersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListApplicationProviders", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
