...
func (c *Client) addOperationAttachCustomerManagedPolicyReferenceToPermissionSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AttachCustomerManagedPolicyReferenceToPermissionSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
