...
func (c *Client) addOperationCreateApplicationAssignmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateApplicationAssignment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
