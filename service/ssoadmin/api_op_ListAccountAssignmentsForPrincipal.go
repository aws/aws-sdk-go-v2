...
func (c *Client) addOperationListAccountAssignmentsForPrincipalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAccountAssignmentsForPrincipal", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
