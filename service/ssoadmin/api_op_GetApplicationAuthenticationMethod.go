...
func (c *Client) addOperationGetApplicationAuthenticationMethodMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetApplicationAuthenticationMethod", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
