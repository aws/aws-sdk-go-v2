...
func (c *Client) addOperationDeleteInstanceAccessControlAttributeConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteInstanceAccessControlAttributeConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
