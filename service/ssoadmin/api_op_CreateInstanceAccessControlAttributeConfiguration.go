...
func (c *Client) CreateInstanceAccessControlAttributeConfiguration(ctx context.Context, params *CreateInstanceAccessControlAttributeConfigurationInput, optFns ...func(*Options)) (*CreateInstanceAccessControlAttributeConfigurationOutput, error) {
	if params == nil { params = &CreateInstanceAccessControlAttributeConfigurationInput{} }
...
func (c *Client) addOperationCreateInstanceAccessControlAttributeConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateInstanceAccessControlAttributeConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateInstanceAccessControlAttributeConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateInstanceAccessControlAttributeConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateInstanceAccessControlAttributeConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateInstanceAccessControlAttributeConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateInstanceAccessControlAttributeConfigurationResolveEndpointMiddleware{
