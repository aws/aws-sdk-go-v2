...
func (c *Client) addOperationCreateInstanceAccessControlAttributeConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateInstanceAccessControlAttributeConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
