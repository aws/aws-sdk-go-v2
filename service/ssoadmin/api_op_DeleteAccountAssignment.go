...
func addOperationDeleteAccountAssignmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpDeleteAccountAssignmentValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteAccountAssignment(options.Region), middleware.Before)
