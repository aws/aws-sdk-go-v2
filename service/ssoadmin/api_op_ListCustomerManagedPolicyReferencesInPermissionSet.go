...
func (c *Client) ListCustomerManagedPolicyReferencesInPermissionSet(ctx context.Context, params *ListCustomerManagedPolicyReferencesInPermissionSetInput, optFns ...func(*Options)) (*ListCustomerManagedPolicyReferencesInPermissionSetOutput, error) {
	if params == nil { params = &ListCustomerManagedPolicyReferencesInPermissionSetInput{} }
...
func (c *Client) addOperationListCustomerManagedPolicyReferencesInPermissionSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCustomerManagedPolicyReferencesInPermissionSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCustomerManagedPolicyReferencesInPermissionSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCustomerManagedPolicyReferencesInPermissionSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCustomerManagedPolicyReferencesInPermissionSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCustomerManagedPolicyReferencesInPermissionSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCustomerManagedPolicyReferencesInPermissionSetResolveEndpointMiddleware{
