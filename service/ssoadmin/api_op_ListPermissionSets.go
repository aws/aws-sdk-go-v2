...
func (*ListPermissionSetsInput) operationName() string {
...
func (c *Client) addOperationListPermissionSetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPermissionSetsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListPermissionSetsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListPermissionSetsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPermissionSetsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPermissionSetsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListPermissionSetsResolveEndpointMiddleware{
