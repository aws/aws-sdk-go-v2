...
func (c *Client) addOperationListApplicationAssignmentsForPrincipalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListApplicationAssignmentsForPrincipal", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
