...
func (c *Client) DeletePermissionsBoundaryFromPermissionSet(ctx context.Context, params *DeletePermissionsBoundaryFromPermissionSetInput, optFns ...func(*Options)) (*DeletePermissionsBoundaryFromPermissionSetOutput, error) {
	if params == nil { params = &DeletePermissionsBoundaryFromPermissionSetInput{} }
...
func (c *Client) addOperationDeletePermissionsBoundaryFromPermissionSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeletePermissionsBoundaryFromPermissionSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeletePermissionsBoundaryFromPermissionSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeletePermissionsBoundaryFromPermissionSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeletePermissionsBoundaryFromPermissionSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeletePermissionsBoundaryFromPermissionSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeletePermissionsBoundaryFromPermissionSetResolveEndpointMiddleware{
