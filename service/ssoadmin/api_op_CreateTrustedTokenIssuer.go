...
func (c *Client) addOperationCreateTrustedTokenIssuerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateTrustedTokenIssuer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
