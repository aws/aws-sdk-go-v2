...
func (*DescribeAccountAssignmentDeletionStatusInput) operationName() string {
...
func (c *Client) addOperationDescribeAccountAssignmentDeletionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeAccountAssignmentDeletionStatusResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeAccountAssignmentDeletionStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeAccountAssignmentDeletionStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeAccountAssignmentDeletionStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeAccountAssignmentDeletionStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeAccountAssignmentDeletionStatusResolveEndpointMiddleware{
