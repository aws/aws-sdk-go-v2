...
func (c *Client) addOperationDescribeAccountAssignmentDeletionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAccountAssignmentDeletionStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
