...
func (c *Client) addOperationListApplicationAssignmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListApplicationAssignments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
