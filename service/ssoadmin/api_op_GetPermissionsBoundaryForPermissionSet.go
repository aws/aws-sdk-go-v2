...
func (c *Client) addOperationGetPermissionsBoundaryForPermissionSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPermissionsBoundaryForPermissionSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
