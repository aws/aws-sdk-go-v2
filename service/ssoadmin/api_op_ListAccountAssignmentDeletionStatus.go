...
func (c *Client) addOperationListAccountAssignmentDeletionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAccountAssignmentDeletionStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
