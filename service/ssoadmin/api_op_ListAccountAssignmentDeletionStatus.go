...
func (*ListAccountAssignmentDeletionStatusInput) operationName() string {
...
func (c *Client) addOperationListAccountAssignmentDeletionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAccountAssignmentDeletionStatusResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListAccountAssignmentDeletionStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListAccountAssignmentDeletionStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAccountAssignmentDeletionStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAccountAssignmentDeletionStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListAccountAssignmentDeletionStatusResolveEndpointMiddleware{
