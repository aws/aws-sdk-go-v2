...
func (c *Client) GetInlinePolicyForPermissionSet(ctx context.Context, params *GetInlinePolicyForPermissionSetInput, optFns ...func(*Options)) (*GetInlinePolicyForPermissionSetOutput, error) {
	if params == nil { params = &GetInlinePolicyForPermissionSetInput{} }
...
func (c *Client) addOperationGetInlinePolicyForPermissionSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetInlinePolicyForPermissionSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetInlinePolicyForPermissionSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetInlinePolicyForPermissionSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetInlinePolicyForPermissionSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetInlinePolicyForPermissionSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetInlinePolicyForPermissionSetResolveEndpointMiddleware{
