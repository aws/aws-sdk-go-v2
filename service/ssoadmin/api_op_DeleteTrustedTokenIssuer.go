...
func (c *Client) addOperationDeleteTrustedTokenIssuerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteTrustedTokenIssuer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
