...
func (*ListAccountAssignmentCreationStatusInput) operationName() string {
...
func (c *Client) addOperationListAccountAssignmentCreationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAccountAssignmentCreationStatusResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListAccountAssignmentCreationStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListAccountAssignmentCreationStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAccountAssignmentCreationStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAccountAssignmentCreationStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListAccountAssignmentCreationStatusResolveEndpointMiddleware{
