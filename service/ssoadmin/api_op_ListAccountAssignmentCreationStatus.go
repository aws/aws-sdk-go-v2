...
func (c *Client) addOperationListAccountAssignmentCreationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAccountAssignmentCreationStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
