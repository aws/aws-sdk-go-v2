...
func (c *Client) addOperationGetApplicationAccessScopeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetApplicationAccessScope", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
