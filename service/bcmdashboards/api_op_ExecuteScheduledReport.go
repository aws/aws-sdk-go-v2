...
func (c *Client) ExecuteScheduledReport(ctx context.Context, params *ExecuteScheduledReportInput, optFns ...func(*Options)) (*ExecuteScheduledReportOutput, error) {
	if params == nil { params = &ExecuteScheduledReportInput{} }
...
func (m *idempotencyToken_initializeOpExecuteScheduledReport) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *ExecuteScheduledReportInput ")}
