...
func (v *ListScheduledReportsOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListScheduledReportsResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ListScheduledReportsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.NextToken != nil {
		s.WriteString(schemas.ListScheduledReportsResponse_nextToken, *v.NextToken)
	}
	serializeScheduledReportSummaryList(s, schemas.ListScheduledReportsResponse_scheduledReports, v.ScheduledReports)
}
