...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-bcm-dashboards.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bcm-dashboards.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bcm-dashboards.dev",
			expectURL:     aws.String("https://env-bcm-dashboards.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-bcm-dashboards.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bcm-dashboards.dev",
			expectURL:     aws.String("http://config-bcm-dashboards.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-bcm-dashboards.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-bcm-dashboards.dev",
			clientEndpoint: aws.String("https://client-bcm-dashboards.dev"),
			expectURL:      aws.String("https://client-bcm-dashboards.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BCM_DASHBOARDS", c.envService)
			}
