...
// such as SourceType  = db-instance  and SourceIds  = myDBInstance1, you are
// notified of all the db-instance events for the specified source. If you
// specify a SourceType  but do not specify SourceIds, you receive notice of the
// events for that source type for all your RDS sources. If you don't specify
// either the SourceType or the SourceIds, you are notified of events generated
// from all RDS sources belonging to your customer account. For more information
// about subscribing to an event for RDS DB engines, see Subscribing to Amazon
// RDS event notification (https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Events.Subscribing.html)
