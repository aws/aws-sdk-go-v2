...
func addOperationAuthorizeDBSecurityGroupIngressStackSlots(stack *middleware.Stack) error {
...
func addOperationAuthorizeDBSecurityGroupIngressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAuthorizeDBSecurityGroupIngressStackSlots(stack); err != nil {
		return err
	}
