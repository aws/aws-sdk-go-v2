...
func (c *Client) addOperationModifyDBSnapshotAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyDBSnapshotAttribute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
