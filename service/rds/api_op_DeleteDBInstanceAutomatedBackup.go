...
func addOperationDeleteDBInstanceAutomatedBackupStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteDBInstanceAutomatedBackupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteDBInstanceAutomatedBackupStackSlots(stack); err != nil {
		return err
	}
