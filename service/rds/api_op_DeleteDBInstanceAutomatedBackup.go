...
func (c *Client) DeleteDBInstanceAutomatedBackup(ctx context.Context, params *DeleteDBInstanceAutomatedBackupInput, optFns ...func(*Options)) (*DeleteDBInstanceAutomatedBackupOutput, error) {
	if params == nil { params = &DeleteDBInstanceAutomatedBackupInput{} }
...
func (c *Client) addOperationDeleteDBInstanceAutomatedBackupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteDBInstanceAutomatedBackupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteDBInstanceAutomatedBackupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteDBInstanceAutomatedBackupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteDBInstanceAutomatedBackupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteDBInstanceAutomatedBackupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteDBInstanceAutomatedBackupResolveEndpointMiddleware{
