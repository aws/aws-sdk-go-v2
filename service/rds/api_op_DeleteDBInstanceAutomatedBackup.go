...
func (c *Client) addOperationDeleteDBInstanceAutomatedBackupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDBInstanceAutomatedBackup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
