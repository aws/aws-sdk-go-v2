...
func addOperationRestoreDBInstanceFromDBSnapshotStackSlots(stack *middleware.Stack) error {
...
func addOperationRestoreDBInstanceFromDBSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRestoreDBInstanceFromDBSnapshotStackSlots(stack); err != nil {
		return err
	}
