...
func addOperationRevokeDBSecurityGroupIngressStackSlots(stack *middleware.Stack) error {
...
func addOperationRevokeDBSecurityGroupIngressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRevokeDBSecurityGroupIngressStackSlots(stack); err != nil {
		return err
	}
