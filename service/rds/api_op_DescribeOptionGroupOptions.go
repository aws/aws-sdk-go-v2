...
func (c *Client) addOperationDescribeOptionGroupOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeOptionGroupOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
