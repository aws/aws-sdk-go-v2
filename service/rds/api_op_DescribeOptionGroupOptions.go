...
func addOperationDescribeOptionGroupOptionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeOptionGroupOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeOptionGroupOptionsStackSlots(stack); err != nil {
		return err
	}
