...
func (c *Client) addOperationDeregisterDBProxyTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterDBProxyTargets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
