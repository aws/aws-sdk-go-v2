...
func (c *Client) addOperationRemoveRoleFromDBClusterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RemoveRoleFromDBCluster", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
