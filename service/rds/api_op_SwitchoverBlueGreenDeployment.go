...
func (c *Client) addOperationSwitchoverBlueGreenDeploymentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SwitchoverBlueGreenDeployment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
