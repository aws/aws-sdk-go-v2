...
func (c *Client) SwitchoverBlueGreenDeployment(ctx context.Context, params *SwitchoverBlueGreenDeploymentInput, optFns ...func(*Options)) (*SwitchoverBlueGreenDeploymentOutput, error) {
	if params == nil { params = &SwitchoverBlueGreenDeploymentInput{} }
...
func (c *Client) addOperationSwitchoverBlueGreenDeploymentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSwitchoverBlueGreenDeploymentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSwitchoverBlueGreenDeploymentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSwitchoverBlueGreenDeploymentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSwitchoverBlueGreenDeploymentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSwitchoverBlueGreenDeploymentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSwitchoverBlueGreenDeploymentResolveEndpointMiddleware{
