...
func (c *Client) addOperationCreateDBClusterSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateDBClusterSnapshot", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
