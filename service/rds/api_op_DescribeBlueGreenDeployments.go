...
func (c *Client) addOperationDescribeBlueGreenDeploymentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeBlueGreenDeployments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
