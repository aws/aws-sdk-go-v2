...
func (c *Client) addOperationDescribeDBInstanceAutomatedBackupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDBInstanceAutomatedBackups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
