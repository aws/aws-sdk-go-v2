...
func (c *Client) addOperationDescribeDBMajorEngineVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDBMajorEngineVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
