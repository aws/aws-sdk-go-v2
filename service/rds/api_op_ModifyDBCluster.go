...
type ModifyDBClusterInput struct {
	...
	// the Multi-AZ DB cluster. Type: Integer Valid for: Multi-AZ DB clusters only
	...
	// cluster's current version. Valid for: Aurora DB clusters only
	...
	// maintenance window. The ApplyImmediately  parameter only affects the
	// EnableIAMDatabaseAuthentication , MasterUserPassword , and
	// NewDBClusterIdentifier values. If the ApplyImmediately parameter is disabled,
	// then changes to the EnableIAMDatabaseAuthentication , MasterUserPassword , and
	// NewDBClusterIdentifiervalues are applied during the next maintenance window.
	// All other changes are applied immediately, regardless of the value of the
	// ApplyImmediatelyparameter. By default, this parameter is disabled. Valid for:
	...
	// slowquery . RDS for PostgreSQL Possible values are postgresql  and upgrade.
	// Aurora MySQL Possible values are audit , error , general , and slowquery.
	// Aurora PostgreSQL Possible value is postgresql. For more information about
	// exporting CloudWatch Logs for Amazon RDS, see Publishing Database Logs to
	// Amazon CloudWatch Logs (https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_LogAccess.html#USER_LogAccess.Procedural.UploadtoCloudWatch)
	...
	// The name of the DB cluster parameter group to use for the DB cluster. Valid
	// for: Aurora DB clusters and Multi-AZ DB clusters
	DBClusterParameterGroupName *string

	// The name of the DB parameter group to apply to all instances of the DB
	// cluster. When you apply a parameter group using the
	// DBInstanceParameterGroupNameparameter, the DB cluster isn't rebooted
	// automatically. Also, parameter changes are applied immediately rather than
	// during the next maintenance window. Default: The existing name setting
	// Constraints:
	...
	// next maintenance window unless ApplyImmediately is enabled. If the cluster
	// that you're modifying has one or more read replicas, all replicas must be
	// running an engine version that's the same or later than the version you specify.
	...
	// "DBEngineVersions[].EngineVersion"Valid for: Aurora DB clusters and Multi-AZ
	// DB clusters
	...
	// set MonitoringInterval  to a value other than 0. Valid Values: 0, 1, 5, 10,
	// 15, 30, 60 Valid for: Multi-AZ DB clusters only
	...
	// value, RDS issues an error. Valid for: Multi-AZ DB clusters only
	...
	// properties for DB clusters in serverless DB engine mode. Valid for: Aurora DB
	// clusters only
