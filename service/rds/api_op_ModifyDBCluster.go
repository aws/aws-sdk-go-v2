...
type ModifyDBClusterInput struct {
	...
	// ApplyImmediately parameter. By default, this parameter is disabled. Valid for:
	...
	// different default KMS key for each Amazon Web Services Region. Valid for: Aurora
	// DB clusters and Multi-AZ DB clusters
	...
	// must be 1150-65535 Default: The same port as the original DB cluster. Valid
