...
type CreateDBInstanceInput struct {
	...
	// MariaDB Constraints to the amount of storage for each storage type are the
	// following:
	//   - General Purpose (SSD) storage (gp2, gp3): Must be an integer from 20 to
	//   65536.
	//   - Provisioned IOPS storage (io1): Must be an integer from 100 to 65536.
	...
	// SQL Server Constraints to the amount of storage for each storage type are the
	// following:
	...
	// null , the default value ORCL is used. You can't specify the string NULL, or
	// any other reserved word, for DBName . Default: ORCL Constraints:
	//   - Can't be longer than 8 characters
	// Amazon RDS Custom for Oracle The Oracle System ID (SID) of the created RDS
	// Custom DB instance. If you don't specify a value, the default value is ORCL .
	...
	// listener , trace , and oemagent . PostgreSQL Possible values are postgresql and
	// upgrade .
	...
	// Type: Integer Oracle Default: 1521 Valid values: 1150-65535 SQL Server Default:
	// 1433 Valid values: 1150-65535 except 1234 , 1434 , 3260 , 3343 , 3389 , 47001 ,
	// and 49152-49156 . Amazon Aurora Default: 3306 Valid values: 1150-65535 Type:
	// Integer
	Port *int32
	...
	// leave it unset. If you set this parameter to false , RDS reports an error.
