...
// Creates a new DB instance. The new DB instance can be an RDS DB instance, or
// it can be a DB instance in an Aurora DB cluster. For an Aurora DB cluster, you
...
type CreateDBInstanceInput struct {
	...
	// Type: Integer Amazon Aurora Not applicable. Aurora cluster volumes automatically
	// grow as the amount of data in your database increases, though you are only
	// charged for the space that you use in an Aurora cluster volume. Amazon RDS
	// Custom Constraints to the amount of storage for each storage type are the
	// following:
	...
	//
	// MySQL Constraints to the amount of storage for each storage type are the
	// following:
	...
	//     - Magnetic storage (standard): Must be an integer from 5 to 3072.
	//
	// PostgreSQL Constraints to the amount of storage for each storage type are the
	// following:
	//     - General Purpose (SSD) storage (gp2, gp3): Must be an integer from 20 to 65536.
	//     - Provisioned IOPS storage (io1): Must be an integer from 100 to 65536.
	//     - Magnetic storage (standard): Must be an integer from 5 to 3072.
	...
	// Services Region. Example: us-east-1d  Constraint: The AvailabilityZone
	...
	// Services Region). The default is region . For more information, see Working
	// with Amazon RDS on Amazon Web Services Outposts (https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/rds-on-outposts.html)
	...
	// of the DB instance. By default, tags are not copied. Amazon Aurora Not
	...
	// The identifier of the DB cluster that the instance will belong to. This
	// setting doesn't apply to RDS Custom.
	DBClusterIdentifier *string

	// The meaning of this parameter differs according to the database engine you
	// use. MySQL The name of the database to create when the DB instance is created.
	...
	//     - Can't be a word reserved by the specified database engine
	// Oracle The
	// Oracle System ID (SID) of the created DB instance. If you specify null, the
	// default value ORCL is used. You can't specify the string NULL, or any other
	// reserved word, for DBName . Default: ORCL  Constraints:
	//     - Can't be longer than 8 characters
	// Amazon RDS Custom for Oracle The
	// Oracle System ID (SID) of the created RDS Custom DB instance. If you don't
	// specify a value, the default value is ORCL . Default: ORCL  Constraints:
	//     - It must contain 1 to 8 alphanumeric characters.
	//     - It must contain a letter.
	//     - It can't be a word reserved by the database engine.
	// Amazon RDS Custom
	// for SQL Server Not applicable. Must be null. SQL Server Not applicable. Must be
	// null. Amazon Aurora MySQL The name of the database to create when the primary DB
	...
	//     - It can't be a word reserved by the database engine.
	// Amazon Aurora
	// PostgreSQL The name of the database to create when the primary DB instance of
	// the Aurora PostgreSQL DB cluster is created. If this parameter isn't specified
	// for an Aurora PostgreSQL DB cluster, a database named postgres is created in
	// the DB cluster. Constraints:
	...
	// . Amazon Aurora Not applicable. You can enable or disable deletion protection
	// for the DB cluster. For more information, see CreateDBCluster. DB instances in
	// a DB cluster can be deleted even when deletion protection is enabled for the DB
	// cluster.
	...
	// Possible values are audit , error , general , and slowquery. Microsoft SQL
	// Server Possible values are agent  and error . MySQL Possible values are audit ,
	// error , general , and slowquery . Oracle Possible values are alert , audit ,
	// listener , trace , and oemagent . PostgreSQL Possible values are postgresql
	// and upgrade .
	EnableCloudwatchLogsExports []string

	// A value that indicates whether to enable a customer-owned IP address (CoIP)
	// for an RDS on Outposts DB instance. A CoIP provides local or external
	...
	// mapping isn't enabled. For more information, see IAM Database Authentication
	...
	// in the Amazon RDS User Guide. Oracle For information, see Oracle Database
	...
	// PostgreSQL versions and extensions (https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_PostgreSQL.html#PostgreSQL.Concepts)
	// in the Amazon RDS User Guide.
	...
	// information, see CreateDBCluster . If StorageEncrypted is enabled, and you do
	// not specify a value for the KmsKeyId parameter, then Amazon RDS uses your
	...
	// each Amazon Web Services Region. Amazon RDS Custom A KMS key is required for RDS
	// Custom instances. For most RDS engines, if you leave this parameter empty while
	...
	// | bring-your-own-license  | general-public-license This setting doesn't apply
	// to RDS Custom. Amazon Aurora Not applicable.
	LicenseModel *string
	...
	// 1150-65535 Type: Integer PostgreSQL Default: 5432  Valid values: 1150-65535
	// Type: Integer Oracle Default: 1521  Valid values: 1150-65535 SQL Server
	// Default: 1433  Valid values: 1150-65535  except 1234 , 1434 , 3260 , 3343 ,
	...
	// . Format: ddd:hh24:mi-ddd:hh24:mi The default is a 30-minute window selected
	// at random from an 8-hour block of time for each Amazon Web Services Region,
	...
	// the DB instance is publicly accessible, its Domain Name System (DNS) endpoint
	...
	// isn't encrypted. For RDS Custom instances, either set this parameter to true
	// or leave it unset. If you set this parameter to false, RDS reports an error.
	// Amazon Aurora Not applicable. The encryption for DB instances is managed by the
	// DB cluster.
	...
	// Specifies the storage type to be associated with the DB instance. Valid
	...
	// is specified, otherwise gp2 Amazon Aurora Not applicable. Storage is managed
	// by the DB cluster.
	StorageType *string
