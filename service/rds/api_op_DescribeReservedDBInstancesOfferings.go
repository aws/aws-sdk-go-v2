...
func (c *Client) addOperationDescribeReservedDBInstancesOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReservedDBInstancesOfferings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
