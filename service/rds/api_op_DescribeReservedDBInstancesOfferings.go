...
func addOperationDescribeReservedDBInstancesOfferingsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeReservedDBInstancesOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeReservedDBInstancesOfferingsStackSlots(stack); err != nil {
		return err
	}
