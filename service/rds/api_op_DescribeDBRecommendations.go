...
func (c *Client) addOperationDescribeDBRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDBRecommendations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
