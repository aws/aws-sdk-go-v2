...
type RestoreDBInstanceToPointInTimeInput struct {
	...
	// automatically to the DB instance during the maintenance window. This setting
	...
	// DBParameterGroupfor the specified DB engine is used. This setting doesn't
	...
	// Active Directory Domain. This setting doesn't apply to RDS Custom. For more
	...
	// mapping isn't enabled. This setting doesn't apply to RDS Custom. For more
