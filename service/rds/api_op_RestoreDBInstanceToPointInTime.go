...
func addOperationRestoreDBInstanceToPointInTimeStackSlots(stack *middleware.Stack) error {
...
func addOperationRestoreDBInstanceToPointInTimeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRestoreDBInstanceToPointInTimeStackSlots(stack); err != nil {
		return err
	}
