...
func (c *Client) PurchaseReservedDBInstancesOffering(ctx context.Context, params *PurchaseReservedDBInstancesOfferingInput, optFns ...func(*Options)) (*PurchaseReservedDBInstancesOfferingOutput, error) {
	if params == nil { params = &PurchaseReservedDBInstancesOfferingInput{} }
...
func (c *Client) addOperationPurchaseReservedDBInstancesOfferingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPurchaseReservedDBInstancesOfferingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPurchaseReservedDBInstancesOfferingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPurchaseReservedDBInstancesOfferingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPurchaseReservedDBInstancesOfferingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPurchaseReservedDBInstancesOfferingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPurchaseReservedDBInstancesOfferingResolveEndpointMiddleware{
