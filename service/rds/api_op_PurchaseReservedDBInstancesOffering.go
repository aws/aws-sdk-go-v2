...
func (c *Client) addOperationPurchaseReservedDBInstancesOfferingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PurchaseReservedDBInstancesOffering", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
