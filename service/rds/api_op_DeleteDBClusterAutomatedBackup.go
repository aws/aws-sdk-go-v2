...
func (c *Client) addOperationDeleteDBClusterAutomatedBackupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDBClusterAutomatedBackup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
