...
func addOperationDescribeDBClusterBacktracksStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeDBClusterBacktracksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeDBClusterBacktracksStackSlots(stack); err != nil {
		return err
	}
