...
func (c *Client) addOperationStopDBInstanceAutomatedBackupsReplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopDBInstanceAutomatedBackupsReplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
