...
func (c *Client) StopDBInstanceAutomatedBackupsReplication(ctx context.Context, params *StopDBInstanceAutomatedBackupsReplicationInput, optFns ...func(*Options)) (*StopDBInstanceAutomatedBackupsReplicationOutput, error) {
	if params == nil { params = &StopDBInstanceAutomatedBackupsReplicationInput{} }
...
func (c *Client) addOperationStopDBInstanceAutomatedBackupsReplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopDBInstanceAutomatedBackupsReplicationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopDBInstanceAutomatedBackupsReplicationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopDBInstanceAutomatedBackupsReplicationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopDBInstanceAutomatedBackupsReplicationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopDBInstanceAutomatedBackupsReplicationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopDBInstanceAutomatedBackupsReplicationResolveEndpointMiddleware{
