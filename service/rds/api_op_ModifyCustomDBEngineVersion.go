...
func (c *Client) addOperationModifyCustomDBEngineVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyCustomDBEngineVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
