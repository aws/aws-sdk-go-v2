...
func addOperationDescribeReservedDBInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeReservedDBInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeReservedDBInstancesStackSlots(stack); err != nil {
		return err
	}
