...
func (c *Client) addOperationDescribeReservedDBInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReservedDBInstances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
