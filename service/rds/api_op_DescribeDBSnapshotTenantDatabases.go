...
func (c *Client) addOperationDescribeDBSnapshotTenantDatabasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDBSnapshotTenantDatabases", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
