...
func addOperationDescribeCustomAvailabilityZonesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeCustomAvailabilityZonesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeCustomAvailabilityZonesStackSlots(stack); err != nil {
		return err
	}
