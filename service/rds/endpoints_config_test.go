...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-rds.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rds.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rds.dev",
			expectURL:     aws.String("https://env-rds.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-rds.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rds.dev",
			expectURL:     aws.String("http://config-rds.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-rds.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-rds.dev",
			clientEndpoint: aws.String("https://client-rds.dev"),
			expectURL:      aws.String("https://client-rds.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_RDS", c.envService)
			}
