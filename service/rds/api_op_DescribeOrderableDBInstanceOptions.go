...
func addOperationDescribeOrderableDBInstanceOptionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeOrderableDBInstanceOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeOrderableDBInstanceOptionsStackSlots(stack); err != nil {
		return err
	}
