...
func (c *Client) addOperationDeleteBlueGreenDeploymentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteBlueGreenDeployment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
