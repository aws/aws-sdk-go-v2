...
func addOperationPromoteReadReplicaDBClusterStackSlots(stack *middleware.Stack) error {
...
func addOperationPromoteReadReplicaDBClusterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPromoteReadReplicaDBClusterStackSlots(stack); err != nil {
		return err
	}
