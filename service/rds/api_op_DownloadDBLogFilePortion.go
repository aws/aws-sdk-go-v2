...
func (c *Client) addOperationDownloadDBLogFilePortionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DownloadDBLogFilePortion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
