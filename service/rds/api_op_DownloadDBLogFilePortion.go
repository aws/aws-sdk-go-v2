...
type DownloadDBLogFilePortionInput struct {
	...
	// log file is returned up to a maximum of 10000 lines, starting with the most
	...
	// in blocks of lines by specifying the size of the block using the NumberOfLines
	// parameter, and by specifying a value of "0" for the Marker parameter in your
	// first request. Include the Marker value returned in the response as the Marker
	// value for the next request, continuing until the AdditionalDataPending response
