...
func addOperationDescribeDBSnapshotAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeDBSnapshotAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeDBSnapshotAttributesStackSlots(stack); err != nil {
		return err
	}
