...
func (c *Client) SwitchoverReadReplica(ctx context.Context, params *SwitchoverReadReplicaInput, optFns ...func(*Options)) (*SwitchoverReadReplicaOutput, error) {
	if params == nil { params = &SwitchoverReadReplicaInput{} }
...
func (c *Client) addOperationSwitchoverReadReplicaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSwitchoverReadReplicaResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSwitchoverReadReplicaResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSwitchoverReadReplicaResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSwitchoverReadReplicaResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSwitchoverReadReplicaResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSwitchoverReadReplicaResolveEndpointMiddleware{
