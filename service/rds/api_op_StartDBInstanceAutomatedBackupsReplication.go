...
func (c *Client) addOperationStartDBInstanceAutomatedBackupsReplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartDBInstanceAutomatedBackupsReplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
