...
func addOperationModifyCurrentDBClusterCapacityStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyCurrentDBClusterCapacityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyCurrentDBClusterCapacityStackSlots(stack); err != nil {
		return err
	}
