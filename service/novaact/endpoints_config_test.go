...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-nova-act.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-nova-act.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-nova-act.dev",
			expectURL:     aws.String("https://env-nova-act.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-nova-act.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-nova-act.dev",
			expectURL:     aws.String("http://config-nova-act.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-nova-act.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-nova-act.dev",
			clientEndpoint: aws.String("https://client-nova-act.dev"),
			expectURL:      aws.String("https://client-nova-act.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_NOVA_ACT", c.envService)
			}
