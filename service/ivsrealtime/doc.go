...
// (see Getting Started with Amazon IVS (https://docs.aws.amazon.com/ivs/latest/userguide/getting-started.html)
// ):
...
// as topic:nature  to label a particular video category. See Tagging AWS
