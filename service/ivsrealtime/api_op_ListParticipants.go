...
func (v *ListParticipantsOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListParticipantsResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ListParticipantsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.NextToken != nil {
		s.WriteString(schemas.ListParticipantsResponse_nextToken, *v.NextToken)
	}
	serializeParticipantList(s, schemas.ListParticipantsResponse_participants, v.Participants)
}
