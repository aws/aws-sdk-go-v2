...
func (c *Client) addOperationStartParticipantReplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartParticipantReplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
