...
func (c *Client) addOperationListParticipantReplicasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListParticipantReplicas", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
