...
func (c *Client) addOperationStopParticipantReplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopParticipantReplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
