...
func (c *Client) GetParticipant(ctx context.Context, params *GetParticipantInput, optFns ...func(*Options)) (*GetParticipantOutput, error) {
	if params == nil { params = &GetParticipantInput{} }
...
func (c *Client) addOperationGetParticipantMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetParticipantResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetParticipantResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetParticipantResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetParticipantResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetParticipantResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetParticipantResolveEndpointMiddleware{
