...
func (c *Client) addOperationCreateIngestConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateIngestConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
