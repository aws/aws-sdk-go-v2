...
type TagResourceInput struct {
	...
	// string:string (key:value) . See [Tagging AWS Resources] for details, including restrictions that apply
	// to tags and "Tag naming limits and requirements"; Amazon IVS has no constraints
