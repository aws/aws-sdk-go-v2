...
func (c *Client) addOperationListEncoderConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEncoderConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
