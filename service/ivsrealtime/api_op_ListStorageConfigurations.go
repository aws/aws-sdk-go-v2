...
func (c *Client) addOperationListStorageConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListStorageConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
