...
func (c *Client) GetStageSession(ctx context.Context, params *GetStageSessionInput, optFns ...func(*Options)) (*GetStageSessionOutput, error) {
	if params == nil { params = &GetStageSessionInput{} }
...
func (c *Client) addOperationGetStageSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetStageSessionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetStageSessionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetStageSessionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetStageSessionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetStageSessionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetStageSessionResolveEndpointMiddleware{
