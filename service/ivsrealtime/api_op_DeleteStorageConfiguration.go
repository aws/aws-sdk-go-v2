...
func (c *Client) addOperationDeleteStorageConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteStorageConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
