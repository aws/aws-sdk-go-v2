...
const (
	ServiceName = "AWS Marketplace Commerce Analytics" // Service's name
	ServiceID   = "MarketplaceCommerceAnalytics"       // Service's identifier
	EndpointsID = "marketplacecommerceanalytics"       // Service's Endpoint identifier
)
...
//     svc := marketplacecommerceanalytics.New(myConfig)
