...
func (c *Client) addOperationAssociateBenefitApplicationResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateBenefitApplicationResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
