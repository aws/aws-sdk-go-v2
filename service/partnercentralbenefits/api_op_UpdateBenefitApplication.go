...
func (c *Client) addOperationUpdateBenefitApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateBenefitApplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
