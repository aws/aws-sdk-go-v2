...
func (v *UpdateBenefitApplicationOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.UpdateBenefitApplicationOutput)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *UpdateBenefitApplicationOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Arn != nil {
		s.WriteString(schemas.UpdateBenefitApplicationOutput_Arn, *v.Arn)
	}
	if v.Id != nil {
		s.WriteString(schemas.UpdateBenefitApplicationOutput_Id, *v.Id)
	}
	if v.Revision != nil {
		s.WriteString(schemas.UpdateBenefitApplicationOutput_Revision, *v.Revision)
	}
}
