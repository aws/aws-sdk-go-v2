...
func (c *Client) addOperationRecallBenefitApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RecallBenefitApplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
