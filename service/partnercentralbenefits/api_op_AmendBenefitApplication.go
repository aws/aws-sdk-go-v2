...
func (c *Client) addOperationAmendBenefitApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AmendBenefitApplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
