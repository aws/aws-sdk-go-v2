...
func (v *AmendBenefitApplicationOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.AmendBenefitApplicationOutput)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *AmendBenefitApplicationOutput) SerializeMembers(s smithy.ShapeSerializer) {
}
