...
func (c *Client) addOperationCreateReplicatorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateReplicatorResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateReplicatorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateReplicatorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateReplicatorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateReplicatorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateReplicatorResolveEndpointMiddleware{
