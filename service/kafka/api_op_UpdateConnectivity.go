...
func (c *Client) UpdateConnectivity(ctx context.Context, params *UpdateConnectivityInput, optFns ...func(*Options)) (*UpdateConnectivityOutput, error) {
	if params == nil { params = &UpdateConnectivityInput{} }
...
func (c *Client) addOperationUpdateConnectivityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateConnectivityResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateConnectivityResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateConnectivityResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateConnectivityResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateConnectivityResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateConnectivityResolveEndpointMiddleware{
