...
func (c *Client) addOperationDescribeTopicPartitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeTopicPartitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
