...
func (*BatchDisassociateScramSecretInput) operationName() string {
...
func (c *Client) addOperationBatchDisassociateScramSecretMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchDisassociateScramSecretResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opBatchDisassociateScramSecretResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opBatchDisassociateScramSecretResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchDisassociateScramSecretResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchDisassociateScramSecretResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opBatchDisassociateScramSecretResolveEndpointMiddleware{
