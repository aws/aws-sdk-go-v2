...
func (c *Client) addOperationBatchDisassociateScramSecretMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDisassociateScramSecret", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
