...
func (*CreateClusterV2Input) operationName() string {
...
func (c *Client) addOperationCreateClusterV2Middlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateClusterV2ResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateClusterV2ResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateClusterV2ResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateClusterV2ResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateClusterV2ResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateClusterV2ResolveEndpointMiddleware{
