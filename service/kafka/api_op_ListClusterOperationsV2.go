...
func (c *Client) addOperationListClusterOperationsV2Middlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListClusterOperationsV2", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
