...
func (c *Client) addOperationListReplicatorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListReplicatorsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListReplicatorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListReplicatorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListReplicatorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListReplicatorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListReplicatorsResolveEndpointMiddleware{
