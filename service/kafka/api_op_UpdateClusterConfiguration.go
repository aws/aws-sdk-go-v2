...
func (c *Client) addOperationUpdateClusterConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateClusterConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
