...
func (*UpdateBrokerCountInput) operationName() string {
...
func (c *Client) addOperationUpdateBrokerCountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateBrokerCountResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateBrokerCountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateBrokerCountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateBrokerCountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateBrokerCountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateBrokerCountResolveEndpointMiddleware{
