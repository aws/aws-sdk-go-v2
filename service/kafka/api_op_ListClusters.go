...
func (v *ListClustersInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ClusterNameFilter != nil {
		s.WriteString(schemas.ListClustersRequest_ClusterNameFilter, *v.ClusterNameFilter)
	}
	if v.MaxResults != nil {
...
func (v *ListClustersOutput) SerializeMembers(s smithy.ShapeSerializer) {
	serialize__listOfClusterInfo(s, schemas.ListClustersResponse_ClusterInfoList, v.ClusterInfoList)
	if v.NextToken != nil {
...
func (v *ListClustersOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListClustersResponse, func(s *smithy.Schema) error {
		switch s {
		case schemas.ListClustersResponse_ClusterInfoList:
			return deserialize__listOfClusterInfo(d, schemas.ListClustersResponse_ClusterInfoList, &v.ClusterInfoList)
