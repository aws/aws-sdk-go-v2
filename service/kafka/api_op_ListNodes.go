...
func (v *ListNodesInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ClusterArn != nil {
		s.WriteString(schemas.ListNodesRequest_ClusterArn, *v.ClusterArn)
	}
	if v.MaxResults != nil {
...
func (v *ListNodesOutput) SerializeMembers(s smithy.ShapeSerializer) {
	...
	serialize__listOfNodeInfo(s, schemas.ListNodesResponse_NodeInfoList, v.NodeInfoList)
}
func (v *ListNodesOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListNodesResponse, func(s *smithy.Schema) error {
		...
		case schemas.ListNodesResponse_NodeInfoList:
			return deserialize__listOfNodeInfo(d, schemas.ListNodesResponse_NodeInfoList, &v.NodeInfoList)
		}
		return nil
	})
}
