...
func (*UpdateBrokerStorageInput) operationName() string {
...
func (c *Client) addOperationUpdateBrokerStorageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateBrokerStorageResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateBrokerStorageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateBrokerStorageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateBrokerStorageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateBrokerStorageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateBrokerStorageResolveEndpointMiddleware{
