...
func (c *Client) addOperationBatchAssociateScramSecretMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchAssociateScramSecret", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
