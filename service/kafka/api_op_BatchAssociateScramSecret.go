...
func addOperationBatchAssociateScramSecretMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpBatchAssociateScramSecretValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opBatchAssociateScramSecret(options.Region), middleware.Before)
