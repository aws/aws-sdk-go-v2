...
func (c *Client) DetachTypedLink(ctx context.Context, params *DetachTypedLinkInput, optFns ...func(*Options)) (*DetachTypedLinkOutput, error) {
	if params == nil { params = &DetachTypedLinkInput{} }
...
func (c *Client) addOperationDetachTypedLinkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDetachTypedLinkResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDetachTypedLinkResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDetachTypedLinkResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDetachTypedLinkResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDetachTypedLinkResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDetachTypedLinkResolveEndpointMiddleware{
