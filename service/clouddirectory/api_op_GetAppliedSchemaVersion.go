...
func (c *Client) GetAppliedSchemaVersion(ctx context.Context, params *GetAppliedSchemaVersionInput, optFns ...func(*Options)) (*GetAppliedSchemaVersionOutput, error) {
	if params == nil { params = &GetAppliedSchemaVersionInput{} }
...
func (c *Client) addOperationGetAppliedSchemaVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAppliedSchemaVersionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAppliedSchemaVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAppliedSchemaVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAppliedSchemaVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAppliedSchemaVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAppliedSchemaVersionResolveEndpointMiddleware{
