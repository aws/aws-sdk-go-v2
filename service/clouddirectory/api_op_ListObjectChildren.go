...
func (c *Client) ListObjectChildren(ctx context.Context, params *ListObjectChildrenInput, optFns ...func(*Options)) (*ListObjectChildrenOutput, error) {
	stack := middleware.NewStack("ListObjectChildren", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpListObjectChildrenMiddlewares(stack)
...
func addawsRestjson1_serdeOpListObjectChildrenMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpListObjectChildren{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpListObjectChildren{}, middleware.After)
}
