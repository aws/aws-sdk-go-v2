...
func (*CreateTypedLinkFacetInput) operationName() string {
...
func (c *Client) addOperationCreateTypedLinkFacetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateTypedLinkFacetResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateTypedLinkFacetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateTypedLinkFacetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateTypedLinkFacetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateTypedLinkFacetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateTypedLinkFacetResolveEndpointMiddleware{
