...
func (*ListOutgoingTypedLinksInput) operationName() string {
...
func (c *Client) addOperationListOutgoingTypedLinksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListOutgoingTypedLinksResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListOutgoingTypedLinksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListOutgoingTypedLinksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListOutgoingTypedLinksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListOutgoingTypedLinksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListOutgoingTypedLinksResolveEndpointMiddleware{
