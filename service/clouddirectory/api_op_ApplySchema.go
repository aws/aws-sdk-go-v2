...
func (c *Client) ApplySchema(ctx context.Context, params *ApplySchemaInput, optFns ...func(*Options)) (*ApplySchemaOutput, error) {
	if params == nil { params = &ApplySchemaInput{} }
...
func (c *Client) addOperationApplySchemaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addApplySchemaResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opApplySchemaResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opApplySchemaResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opApplySchemaResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addApplySchemaResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opApplySchemaResolveEndpointMiddleware{
