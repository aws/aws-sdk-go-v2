...
func (c *Client) PutSchemaFromJson(ctx context.Context, params *PutSchemaFromJsonInput, optFns ...func(*Options)) (*PutSchemaFromJsonOutput, error) {
	if params == nil { params = &PutSchemaFromJsonInput{} }
...
func (c *Client) addOperationPutSchemaFromJsonMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutSchemaFromJsonResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutSchemaFromJsonResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutSchemaFromJsonResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutSchemaFromJsonResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutSchemaFromJsonResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutSchemaFromJsonResolveEndpointMiddleware{
