...
func (c *Client) BatchRead(ctx context.Context, params *BatchReadInput, optFns ...func(*Options)) (*BatchReadOutput, error) {
	if params == nil { params = &BatchReadInput{} }
...
func (c *Client) addOperationBatchReadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchReadResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchReadResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchReadResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchReadResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchReadResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchReadResolveEndpointMiddleware{
