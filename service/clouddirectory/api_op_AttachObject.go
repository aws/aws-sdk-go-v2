...
func (c *Client) AttachObject(ctx context.Context, params *AttachObjectInput, optFns ...func(*Options)) (*AttachObjectOutput, error) {
	if params == nil { params = &AttachObjectInput{} }
...
func (c *Client) addOperationAttachObjectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAttachObjectResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAttachObjectResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAttachObjectResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAttachObjectResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAttachObjectResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAttachObjectResolveEndpointMiddleware{
