...
func (c *Client) addOperationListTypedLinkFacetNamesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTypedLinkFacetNames", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
