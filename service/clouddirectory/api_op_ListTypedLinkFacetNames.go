...
func (c *Client) ListTypedLinkFacetNames(ctx context.Context, params *ListTypedLinkFacetNamesInput, optFns ...func(*Options)) (*ListTypedLinkFacetNamesOutput, error) {
	if params == nil { params = &ListTypedLinkFacetNamesInput{} }
...
func (c *Client) addOperationListTypedLinkFacetNamesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTypedLinkFacetNamesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTypedLinkFacetNamesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTypedLinkFacetNamesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTypedLinkFacetNamesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTypedLinkFacetNamesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTypedLinkFacetNamesResolveEndpointMiddleware{
