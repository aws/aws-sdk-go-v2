...
func (c *Client) BatchWrite(ctx context.Context, params *BatchWriteInput, optFns ...func(*Options)) (*BatchWriteOutput, error) {
	if params == nil { params = &BatchWriteInput{} }
...
func (c *Client) addOperationBatchWriteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchWriteResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchWriteResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchWriteResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchWriteResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchWriteResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchWriteResolveEndpointMiddleware{
