...
func (c *Client) GetFacet(ctx context.Context, params *GetFacetInput, optFns ...func(*Options)) (*GetFacetOutput, error) {
	if params == nil { params = &GetFacetInput{} }
...
func (c *Client) addOperationGetFacetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFacetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetFacetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetFacetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFacetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFacetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetFacetResolveEndpointMiddleware{
