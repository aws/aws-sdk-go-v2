...
func (c *Client) DetachFromIndex(ctx context.Context, params *DetachFromIndexInput, optFns ...func(*Options)) (*DetachFromIndexOutput, error) {
	if params == nil { params = &DetachFromIndexInput{} }
...
func (c *Client) addOperationDetachFromIndexMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDetachFromIndexResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDetachFromIndexResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDetachFromIndexResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDetachFromIndexResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDetachFromIndexResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDetachFromIndexResolveEndpointMiddleware{
