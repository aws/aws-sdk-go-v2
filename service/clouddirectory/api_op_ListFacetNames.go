...
func (c *Client) ListFacetNames(ctx context.Context, params *ListFacetNamesInput, optFns ...func(*Options)) (*ListFacetNamesOutput, error) {
	if params == nil { params = &ListFacetNamesInput{} }
...
func (c *Client) addOperationListFacetNamesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFacetNamesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListFacetNamesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListFacetNamesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFacetNamesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFacetNamesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListFacetNamesResolveEndpointMiddleware{
