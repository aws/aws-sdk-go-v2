...
func (c *Client) PublishSchema(ctx context.Context, params *PublishSchemaInput, optFns ...func(*Options)) (*PublishSchemaOutput, error) {
	if params == nil { params = &PublishSchemaInput{} }
...
func (c *Client) addOperationPublishSchemaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPublishSchemaResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPublishSchemaResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPublishSchemaResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPublishSchemaResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPublishSchemaResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPublishSchemaResolveEndpointMiddleware{
