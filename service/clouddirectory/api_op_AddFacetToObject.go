...
func (*AddFacetToObjectInput) operationName() string {
...
func (c *Client) addOperationAddFacetToObjectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAddFacetToObjectResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAddFacetToObjectResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAddFacetToObjectResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAddFacetToObjectResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAddFacetToObjectResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAddFacetToObjectResolveEndpointMiddleware{
