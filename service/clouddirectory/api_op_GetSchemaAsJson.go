...
func (c *Client) GetSchemaAsJson(ctx context.Context, params *GetSchemaAsJsonInput, optFns ...func(*Options)) (*GetSchemaAsJsonOutput, error) {
	if params == nil { params = &GetSchemaAsJsonInput{} }
...
func (c *Client) addOperationGetSchemaAsJsonMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSchemaAsJsonResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSchemaAsJsonResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSchemaAsJsonResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSchemaAsJsonResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSchemaAsJsonResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSchemaAsJsonResolveEndpointMiddleware{
