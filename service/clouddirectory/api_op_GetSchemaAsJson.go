...
func (c *Client) GetSchemaAsJson(ctx context.Context, params *GetSchemaAsJsonInput, optFns ...func(*Options)) (*GetSchemaAsJsonOutput, error) {
	stack := middleware.NewStack("GetSchemaAsJson", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpGetSchemaAsJsonMiddlewares(stack)
...
func addawsRestjson1_serdeOpGetSchemaAsJsonMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpGetSchemaAsJson{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpGetSchemaAsJson{}, middleware.After)
}
