...
func (v *CreateExperienceOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.CreateExperienceResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *CreateExperienceOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Id != nil {
		s.WriteString(schemas.CreateExperienceResponse_Id, *v.Id)
	}
}
