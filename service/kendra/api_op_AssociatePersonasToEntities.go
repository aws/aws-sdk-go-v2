...
func (c *Client) addOperationAssociatePersonasToEntitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociatePersonasToEntities", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
