...
func (c *Client) AssociatePersonasToEntities(ctx context.Context, params *AssociatePersonasToEntitiesInput, optFns ...func(*Options)) (*AssociatePersonasToEntitiesOutput, error) {
	if params == nil { params = &AssociatePersonasToEntitiesInput{} }
...
func (c *Client) addOperationAssociatePersonasToEntitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociatePersonasToEntitiesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociatePersonasToEntitiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociatePersonasToEntitiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociatePersonasToEntitiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociatePersonasToEntitiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociatePersonasToEntitiesResolveEndpointMiddleware{
