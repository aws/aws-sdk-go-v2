...
func (*StopDataSourceSyncJobInput) operationName() string {
...
func (c *Client) addOperationStopDataSourceSyncJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopDataSourceSyncJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopDataSourceSyncJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopDataSourceSyncJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopDataSourceSyncJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopDataSourceSyncJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopDataSourceSyncJobResolveEndpointMiddleware{
