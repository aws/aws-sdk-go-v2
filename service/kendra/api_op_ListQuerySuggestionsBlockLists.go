...
func (c *Client) addOperationListQuerySuggestionsBlockListsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListQuerySuggestionsBlockLists", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
