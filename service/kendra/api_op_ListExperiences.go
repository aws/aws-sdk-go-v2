...
func (*ListExperiencesInput) operationName() string {
...
func (c *Client) addOperationListExperiencesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListExperiencesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListExperiencesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListExperiencesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListExperiencesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListExperiencesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListExperiencesResolveEndpointMiddleware{
