...
// PutPrincipalMappingoperation. For example, if a user in the group
...
// PutPrincipalMapping . DeletePrincipalMapping is currently not supported in the
...
type DeletePrincipalMappingInput struct {
	...
	// is the ordering ID, is the latest action you want to process and apply on top of
	...
	// DELETEaction for that updated group with the latest members list doesn't get
