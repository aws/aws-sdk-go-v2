...
func (c *Client) ListThesauri(ctx context.Context, params *ListThesauriInput, optFns ...func(*Options)) (*ListThesauriOutput, error) {
	if params == nil { params = &ListThesauriInput{} }
...
func (c *Client) addOperationListThesauriMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListThesauriResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListThesauriResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListThesauriResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListThesauriResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListThesauriResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListThesauriResolveEndpointMiddleware{
