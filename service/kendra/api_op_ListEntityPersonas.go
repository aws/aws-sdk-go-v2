...
func (*ListEntityPersonasInput) operationName() string {
...
func (c *Client) addOperationListEntityPersonasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEntityPersonasResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListEntityPersonasResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListEntityPersonasResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEntityPersonasResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEntityPersonasResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListEntityPersonasResolveEndpointMiddleware{
