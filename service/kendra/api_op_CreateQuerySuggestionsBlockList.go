...
func (c *Client) addOperationCreateQuerySuggestionsBlockListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateQuerySuggestionsBlockList", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
