...
func (c *Client) addOperationUpdateAccessControlConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAccessControlConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
