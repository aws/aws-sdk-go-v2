...
func (c *Client) addOperationAssociateEntitiesToExperienceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateEntitiesToExperience", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
