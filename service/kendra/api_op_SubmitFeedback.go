...
func (c *Client) SubmitFeedback(ctx context.Context, params *SubmitFeedbackInput, optFns ...func(*Options)) (*SubmitFeedbackOutput, error) {
	if params == nil { params = &SubmitFeedbackInput{} }
...
func (c *Client) addOperationSubmitFeedbackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSubmitFeedbackResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSubmitFeedbackResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSubmitFeedbackResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSubmitFeedbackResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSubmitFeedbackResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSubmitFeedbackResolveEndpointMiddleware{
