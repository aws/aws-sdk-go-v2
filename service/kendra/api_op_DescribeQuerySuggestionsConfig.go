...
func (c *Client) addOperationDescribeQuerySuggestionsConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeQuerySuggestionsConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
