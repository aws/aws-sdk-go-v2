...
func (c *Client) ListFaqs(ctx context.Context, params *ListFaqsInput, optFns ...func(*Options)) (*ListFaqsOutput, error) {
	if params == nil { params = &ListFaqsInput{} }
...
func (c *Client) addOperationListFaqsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFaqsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListFaqsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListFaqsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFaqsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFaqsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListFaqsResolveEndpointMiddleware{
