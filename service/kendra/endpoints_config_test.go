...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-kendra.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kendra.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kendra.dev",
			expectURL:     aws.String("https://env-kendra.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-kendra.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kendra.dev",
			expectURL:     aws.String("http://config-kendra.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-kendra.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-kendra.dev",
			clientEndpoint: aws.String("https://client-kendra.dev"),
			expectURL:      aws.String("https://client-kendra.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_KENDRA", c.envService)
			}
