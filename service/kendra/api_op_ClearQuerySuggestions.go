...
func (c *Client) ClearQuerySuggestions(ctx context.Context, params *ClearQuerySuggestionsInput, optFns ...func(*Options)) (*ClearQuerySuggestionsOutput, error) {
	if params == nil { params = &ClearQuerySuggestionsInput{} }
...
func (c *Client) addOperationClearQuerySuggestionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addClearQuerySuggestionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opClearQuerySuggestionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opClearQuerySuggestionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opClearQuerySuggestionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addClearQuerySuggestionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opClearQuerySuggestionsResolveEndpointMiddleware{
