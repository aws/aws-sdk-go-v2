...
func (c *Client) DeleteQuerySuggestionsBlockList(ctx context.Context, params *DeleteQuerySuggestionsBlockListInput, optFns ...func(*Options)) (*DeleteQuerySuggestionsBlockListOutput, error) {
	if params == nil { params = &DeleteQuerySuggestionsBlockListInput{} }
...
func (c *Client) addOperationDeleteQuerySuggestionsBlockListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteQuerySuggestionsBlockListResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteQuerySuggestionsBlockListResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteQuerySuggestionsBlockListResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteQuerySuggestionsBlockListResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteQuerySuggestionsBlockListResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteQuerySuggestionsBlockListResolveEndpointMiddleware{
