...
func (c *Client) ListGroupsOlderThanOrderingId(ctx context.Context, params *ListGroupsOlderThanOrderingIdInput, optFns ...func(*Options)) (*ListGroupsOlderThanOrderingIdOutput, error) {
	if params == nil { params = &ListGroupsOlderThanOrderingIdInput{} }
...
func (c *Client) addOperationListGroupsOlderThanOrderingIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListGroupsOlderThanOrderingIdResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListGroupsOlderThanOrderingIdResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListGroupsOlderThanOrderingIdResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListGroupsOlderThanOrderingIdResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListGroupsOlderThanOrderingIdResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListGroupsOlderThanOrderingIdResolveEndpointMiddleware{
