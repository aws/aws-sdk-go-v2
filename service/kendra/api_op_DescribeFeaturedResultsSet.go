...
func (c *Client) addOperationDescribeFeaturedResultsSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeFeaturedResultsSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
