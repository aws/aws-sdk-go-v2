...
func (c *Client) addOperationListFeaturedResultsSetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFeaturedResultsSets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
