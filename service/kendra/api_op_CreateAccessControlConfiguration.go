...
// that should be blocked from access to top-secret documents. Your documents in
// your index still give this user access to top-secret documents due to the user
// having access at the time your documents were indexed. You can create a specific
// access control configuration for this user with deny access. You can later
// update the access control configuration to allow access in the case the user
// returns to the company and re-joins the 'top-secret' team. You can re-configure
// access control for your documents circumstances change. To apply your access
// control configuration to certain documents, you call the BatchPutDocument
