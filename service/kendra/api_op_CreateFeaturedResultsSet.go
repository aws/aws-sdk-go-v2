...
func (v *CreateFeaturedResultsSetOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.CreateFeaturedResultsSetResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *CreateFeaturedResultsSetOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.FeaturedResultsSet != nil {
		s.WriteStruct(schemas.CreateFeaturedResultsSetResponse_FeaturedResultsSet)
		v.FeaturedResultsSet.SerializeMembers(s)
		s.CloseStruct()
	}
}
