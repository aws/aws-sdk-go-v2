...
func (v *UpdateFeaturedResultsSetOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.UpdateFeaturedResultsSetResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *UpdateFeaturedResultsSetOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.FeaturedResultsSet != nil {
		s.WriteStruct(schemas.UpdateFeaturedResultsSetResponse_FeaturedResultsSet)
