...
func (c *Client) addOperationUpdateFeaturedResultsSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateFeaturedResultsSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
