...
// to ingest inline documents or a set of documents stored in an Amazon S3 bucket.
// Use this API to ingest your text and unstructured text into an index, add custom
...
type BatchPutDocumentInput struct {
	...
	// For more information about file size
	// and transaction per second quotas, see Quotas (https://docs.aws.amazon.com/kendra/latest/dg/quotas.html)
	// .
	//
	...
	// BatchPutDocument API. For more information, see IAM Roles for Amazon Kendra (https://docs.aws.amazon.com/kendra/latest/dg/iam-roles.html)
	// .
	RoleArn *string
