...
func (c *Client) GetKeyspace(ctx context.Context, params *GetKeyspaceInput, optFns ...func(*Options)) (*GetKeyspaceOutput, error) {
	if params == nil { params = &GetKeyspaceInput{} }
...
func (c *Client) addOperationGetKeyspaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetKeyspaceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetKeyspaceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetKeyspaceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetKeyspaceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetKeyspaceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetKeyspaceResolveEndpointMiddleware{
