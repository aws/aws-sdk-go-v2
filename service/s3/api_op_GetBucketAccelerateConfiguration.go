...
func addOperationGetBucketAccelerateConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetBucketAccelerateConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetBucketAccelerateConfigurationStackSlots(stack); err != nil {
		return err
	}
