...
func (c *Client) addOperationGetBucketPolicyStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBucketPolicyStatusEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opGetBucketPolicyStatusEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opGetBucketPolicyStatusEndpointDisableHTTPSMiddleware) ID() string {
	return "opGetBucketPolicyStatusEndpointDisableHTTPSMiddleware"
}

func (m *opGetBucketPolicyStatusEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBucketPolicyStatusEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opGetBucketPolicyStatusEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opGetBucketPolicyStatusResolveEndpointMiddleware", middleware.After)
}
...
func (*opGetBucketPolicyStatusResolveEndpointMiddleware) ID() string {
	return "opGetBucketPolicyStatusResolveEndpointMiddleware"
}
