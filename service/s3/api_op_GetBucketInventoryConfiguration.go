...
func (c *Client) addOperationGetBucketInventoryConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBucketInventoryConfigurationEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opGetBucketInventoryConfigurationEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opGetBucketInventoryConfigurationEndpointDisableHTTPSMiddleware) ID() string {
	return "opGetBucketInventoryConfigurationEndpointDisableHTTPSMiddleware"
}

func (m *opGetBucketInventoryConfigurationEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBucketInventoryConfigurationEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opGetBucketInventoryConfigurationEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opGetBucketInventoryConfigurationResolveEndpointMiddleware", middleware.After)
}
...
func (*opGetBucketInventoryConfigurationResolveEndpointMiddleware) ID() string {
	return "opGetBucketInventoryConfigurationResolveEndpointMiddleware"
}
