...
func (c *Client) addOperationDeleteBucketInventoryConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteBucketInventoryConfigurationEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opDeleteBucketInventoryConfigurationEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opDeleteBucketInventoryConfigurationEndpointDisableHTTPSMiddleware) ID() string {
	return "opDeleteBucketInventoryConfigurationEndpointDisableHTTPSMiddleware"
}

func (m *opDeleteBucketInventoryConfigurationEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteBucketInventoryConfigurationEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opDeleteBucketInventoryConfigurationEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opDeleteBucketInventoryConfigurationResolveEndpointMiddleware", middleware.After)
}
...
func (*opDeleteBucketInventoryConfigurationResolveEndpointMiddleware) ID() string {
	return "opDeleteBucketInventoryConfigurationResolveEndpointMiddleware"
}
