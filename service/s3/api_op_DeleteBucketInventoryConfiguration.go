...
func addOperationDeleteBucketInventoryConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteBucketInventoryConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteBucketInventoryConfigurationStackSlots(stack); err != nil {
		return err
	}
