...
// the object. If you grant READ access to the anonymous user, you can return the
...
// the data requested. If both of the If-None-Match  and If-Modified-Since
...
// then, S3 returns 304 Not Modified response code. For more information about
// conditional requests, see RFC 7232 (https://tools.ietf.org/html/rfc7232). The
// following operations are related to GetObject :
...
// getGetObjectBucketMember returns a pointer to string denoting a provided
