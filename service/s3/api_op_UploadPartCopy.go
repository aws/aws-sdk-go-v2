...
// request. You must initiate a multipart upload before you can upload any part. In
// response to your initiate request. Amazon S3 returns a unique identifier, the
// upload ID, that you must include in your upload part request. For more
// information about using the UploadPartCopy operation, see the following:
//
//     *
...
//
//     * For information about
// copying objects using a single atomic operation vs. the multipart upload, see
// Operations on Objects
// (https://docs.aws.amazon.com/AmazonS3/latest/dev/ObjectOperations.html) in the
// Amazon Simple Storage Service Developer Guide.
//
//     * For information about
// using server-side encryption with customer-provided encryption keys with the
...
func addOperationUploadPartCopyStackSlots(stack *middleware.Stack) error {
...
func addOperationUploadPartCopyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUploadPartCopyStackSlots(stack); err != nil {
		return err
	}
