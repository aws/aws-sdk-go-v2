...
func (c *Client) addOperationPutBucketReplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutBucketReplicationEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opPutBucketReplicationEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opPutBucketReplicationEndpointDisableHTTPSMiddleware) ID() string {
	return "opPutBucketReplicationEndpointDisableHTTPSMiddleware"
}

func (m *opPutBucketReplicationEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutBucketReplicationEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opPutBucketReplicationEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opPutBucketReplicationResolveEndpointMiddleware", middleware.After)
}
...
func (*opPutBucketReplicationResolveEndpointMiddleware) ID() string {
	return "opPutBucketReplicationResolveEndpointMiddleware"
}
