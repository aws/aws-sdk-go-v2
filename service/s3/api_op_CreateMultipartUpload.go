...
//
//     * Use encryption keys managed by Amazon S3
...
func addOperationCreateMultipartUploadStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateMultipartUploadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateMultipartUploadStackSlots(stack); err != nil {
		return err
	}
