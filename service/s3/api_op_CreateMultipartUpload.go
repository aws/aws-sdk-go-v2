...
func (c *Client) addOperationCreateMultipartUploadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateMultipartUploadEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opCreateMultipartUploadEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opCreateMultipartUploadEndpointDisableHTTPSMiddleware) ID() string {
	return "opCreateMultipartUploadEndpointDisableHTTPSMiddleware"
}

func (m *opCreateMultipartUploadEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateMultipartUploadEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opCreateMultipartUploadEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opCreateMultipartUploadResolveEndpointMiddleware", middleware.After)
}
...
func (*opCreateMultipartUploadResolveEndpointMiddleware) ID() string {
	return "opCreateMultipartUploadResolveEndpointMiddleware"
}
