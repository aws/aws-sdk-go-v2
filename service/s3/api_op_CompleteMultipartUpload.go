...
func (c *Client) addOperationCompleteMultipartUploadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCompleteMultipartUploadEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opCompleteMultipartUploadEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opCompleteMultipartUploadEndpointDisableHTTPSMiddleware) ID() string {
	return "opCompleteMultipartUploadEndpointDisableHTTPSMiddleware"
}

func (m *opCompleteMultipartUploadEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCompleteMultipartUploadEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opCompleteMultipartUploadEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opCompleteMultipartUploadResolveEndpointMiddleware", middleware.After)
}
...
func (*opCompleteMultipartUploadResolveEndpointMiddleware) ID() string {
	return "opCompleteMultipartUploadResolveEndpointMiddleware"
}
