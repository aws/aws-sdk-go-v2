...
func addOperationPutBucketNotificationConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationPutBucketNotificationConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutBucketNotificationConfigurationStackSlots(stack); err != nil {
		return err
	}
