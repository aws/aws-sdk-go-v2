...
func (c *Client) addOperationGetBucketVersioningMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBucketVersioningEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opGetBucketVersioningEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opGetBucketVersioningEndpointDisableHTTPSMiddleware) ID() string {
	return "opGetBucketVersioningEndpointDisableHTTPSMiddleware"
}

func (m *opGetBucketVersioningEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBucketVersioningEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opGetBucketVersioningEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opGetBucketVersioningResolveEndpointMiddleware", middleware.After)
}
