...
//
// s3:PutBucketCORSaction. By default, the bucket owner has this permission and
...
// the cors  subresource to the bucket. The cors subresource is an XML document
// in which you configure rules that identify origins and the HTTP methods that can
// be executed on your bucket. The document is limited to 64 KB in size. When
// Amazon S3 receives a cross-origin request (or a pre-flight OPTIONS request)
