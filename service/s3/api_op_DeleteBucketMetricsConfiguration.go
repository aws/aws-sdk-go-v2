...
func (c *Client) addOperationDeleteBucketMetricsConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteBucketMetricsConfigurationEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opDeleteBucketMetricsConfigurationEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opDeleteBucketMetricsConfigurationEndpointDisableHTTPSMiddleware) ID() string {
	return "opDeleteBucketMetricsConfigurationEndpointDisableHTTPSMiddleware"
}

func (m *opDeleteBucketMetricsConfigurationEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteBucketMetricsConfigurationEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opDeleteBucketMetricsConfigurationEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opDeleteBucketMetricsConfigurationResolveEndpointMiddleware", middleware.After)
}
...
func (*opDeleteBucketMetricsConfigurationResolveEndpointMiddleware) ID() string {
	return "opDeleteBucketMetricsConfigurationResolveEndpointMiddleware"
}
