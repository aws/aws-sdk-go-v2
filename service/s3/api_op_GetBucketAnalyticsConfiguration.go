...
func (c *Client) addOperationGetBucketAnalyticsConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBucketAnalyticsConfigurationEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opGetBucketAnalyticsConfigurationEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opGetBucketAnalyticsConfigurationEndpointDisableHTTPSMiddleware) ID() string {
	return "opGetBucketAnalyticsConfigurationEndpointDisableHTTPSMiddleware"
}

func (m *opGetBucketAnalyticsConfigurationEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBucketAnalyticsConfigurationEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opGetBucketAnalyticsConfigurationEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opGetBucketAnalyticsConfigurationResolveEndpointMiddleware", middleware.After)
}
...
func (*opGetBucketAnalyticsConfigurationResolveEndpointMiddleware) ID() string {
	return "opGetBucketAnalyticsConfigurationResolveEndpointMiddleware"
}
