...
// the IsTruncated element in the response. If there are no more configurations
...
// to perform the s3:GetAnalyticsConfiguration action. The bucket owner has this
