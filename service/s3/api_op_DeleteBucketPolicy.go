...
// the bucket owner's account to use this operation.  <p>If you don't have
// <code>DeleteBucketPolicy</code> permissions, Amazon S3 returns a <code>403
...
// Bucket Policies and UserPolicies</a>.  The following operations are related to
// DeleteBucketPolicy
//
//     * CreateBucket ()
//
...
func (c *Client) DeleteBucketPolicy(ctx context.Context, params *DeleteBucketPolicyInput, optFns ...func(*Options)) (*DeleteBucketPolicyOutput, error) {
	stack := middleware.NewStack("DeleteBucketPolicy", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestxml_serdeOpDeleteBucketPolicyMiddlewares(stack)
...
func addawsRestxml_serdeOpDeleteBucketPolicyMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestxml_serializeOpDeleteBucketPolicy{}, middleware.After)
	stack.Deserialize.Add(&awsRestxml_deserializeOpDeleteBucketPolicy{}, middleware.After)
}
