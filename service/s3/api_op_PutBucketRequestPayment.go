...
func (c *Client) addOperationPutBucketRequestPaymentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutBucketRequestPaymentEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opPutBucketRequestPaymentEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opPutBucketRequestPaymentEndpointDisableHTTPSMiddleware) ID() string {
	return "opPutBucketRequestPaymentEndpointDisableHTTPSMiddleware"
}

func (m *opPutBucketRequestPaymentEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutBucketRequestPaymentEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opPutBucketRequestPaymentEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opPutBucketRequestPaymentResolveEndpointMiddleware", middleware.After)
}
...
func (*opPutBucketRequestPaymentResolveEndpointMiddleware) ID() string {
	return "opPutBucketRequestPaymentResolveEndpointMiddleware"
}
