...
func (c *Client) addOperationCopyObjectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCopyObjectEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opCopyObjectEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opCopyObjectEndpointDisableHTTPSMiddleware) ID() string {
	return "opCopyObjectEndpointDisableHTTPSMiddleware"
}

func (m *opCopyObjectEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCopyObjectEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opCopyObjectEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opCopyObjectResolveEndpointMiddleware", middleware.After)
}
...
func (*opCopyObjectResolveEndpointMiddleware) ID() string {
	return "opCopyObjectResolveEndpointMiddleware"
}
