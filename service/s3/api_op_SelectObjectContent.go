...
type opSelectObjectContentEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opSelectObjectContentEndpointDisableHTTPSMiddleware) ID() string {
	return "opSelectObjectContentEndpointDisableHTTPSMiddleware"
}

func (m *opSelectObjectContentEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
