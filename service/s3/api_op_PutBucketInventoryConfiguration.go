...
func addOperationPutBucketInventoryConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationPutBucketInventoryConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutBucketInventoryConfigurationStackSlots(stack); err != nil {
		return err
	}
