...
func (c *Client) addOperationPutObjectRetentionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutObjectRetentionEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opPutObjectRetentionEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opPutObjectRetentionEndpointDisableHTTPSMiddleware) ID() string {
	return "opPutObjectRetentionEndpointDisableHTTPSMiddleware"
}

func (m *opPutObjectRetentionEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutObjectRetentionEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opPutObjectRetentionEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opPutObjectRetentionResolveEndpointMiddleware", middleware.After)
}
...
func (*opPutObjectRetentionResolveEndpointMiddleware) ID() string {
	return "opPutObjectRetentionResolveEndpointMiddleware"
}
