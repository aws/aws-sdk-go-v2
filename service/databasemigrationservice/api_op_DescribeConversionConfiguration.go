...
func (c *Client) DescribeConversionConfiguration(ctx context.Context, params *DescribeConversionConfigurationInput, optFns ...func(*Options)) (*DescribeConversionConfigurationOutput, error) {
	if params == nil { params = &DescribeConversionConfigurationInput{} }
...
func (c *Client) addOperationDescribeConversionConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeConversionConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeConversionConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeConversionConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeConversionConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeConversionConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeConversionConfigurationResolveEndpointMiddleware{
