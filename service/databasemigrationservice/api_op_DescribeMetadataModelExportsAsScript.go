...
func (c *Client) DescribeMetadataModelExportsAsScript(ctx context.Context, params *DescribeMetadataModelExportsAsScriptInput, optFns ...func(*Options)) (*DescribeMetadataModelExportsAsScriptOutput, error) {
	if params == nil { params = &DescribeMetadataModelExportsAsScriptInput{} }
...
func (c *Client) addOperationDescribeMetadataModelExportsAsScriptMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeMetadataModelExportsAsScriptResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeMetadataModelExportsAsScriptResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeMetadataModelExportsAsScriptResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeMetadataModelExportsAsScriptResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeMetadataModelExportsAsScriptResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeMetadataModelExportsAsScriptResolveEndpointMiddleware{
