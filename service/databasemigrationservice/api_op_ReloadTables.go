...
func (c *Client) ReloadTables(ctx context.Context, params *ReloadTablesInput, optFns ...func(*Options)) (*ReloadTablesOutput, error) {
	if params == nil { params = &ReloadTablesInput{} }
...
func (c *Client) addOperationReloadTablesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addReloadTablesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opReloadTablesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opReloadTablesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opReloadTablesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addReloadTablesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opReloadTablesResolveEndpointMiddleware{
