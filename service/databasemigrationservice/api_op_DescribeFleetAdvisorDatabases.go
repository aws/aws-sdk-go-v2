...
func (*DescribeFleetAdvisorDatabasesInput) operationName() string {
...
func (c *Client) addOperationDescribeFleetAdvisorDatabasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeFleetAdvisorDatabasesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeFleetAdvisorDatabasesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeFleetAdvisorDatabasesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeFleetAdvisorDatabasesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeFleetAdvisorDatabasesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeFleetAdvisorDatabasesResolveEndpointMiddleware{
