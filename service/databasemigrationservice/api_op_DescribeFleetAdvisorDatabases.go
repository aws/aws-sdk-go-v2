...
func (c *Client) addOperationDescribeFleetAdvisorDatabasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeFleetAdvisorDatabases", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
