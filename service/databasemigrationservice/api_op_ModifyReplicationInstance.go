...
type ModifyReplicationInstanceInput struct {
	...
	// as possible. This parameter must be set to true when specifying a value for
	...
	// The change is asynchronously applied as soon as possible. An outage does result
	...
	// EngineVersionto a lower version number than the current default version, DMS
	...
	// ensure pending changes are applied. Default: Uses existing setting Format:
