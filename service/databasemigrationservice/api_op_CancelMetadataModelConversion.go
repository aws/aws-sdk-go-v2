...
func (c *Client) addOperationCancelMetadataModelConversionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelMetadataModelConversion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
