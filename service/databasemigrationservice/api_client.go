...
const (
	ServiceName = "AWS Database Migration Service" // Service's name
	ServiceID   = "DatabaseMigrationService"       // Service's identifier
	EndpointsID = "dms"                            // Service's Endpoint identifier
)
