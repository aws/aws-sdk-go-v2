...
func (c *Client) addOperationDeleteFleetAdvisorDatabasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteFleetAdvisorDatabases", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
