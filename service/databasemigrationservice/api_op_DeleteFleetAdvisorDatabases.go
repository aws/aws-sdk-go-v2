...
func (c *Client) DeleteFleetAdvisorDatabases(ctx context.Context, params *DeleteFleetAdvisorDatabasesInput, optFns ...func(*Options)) (*DeleteFleetAdvisorDatabasesOutput, error) {
	if params == nil { params = &DeleteFleetAdvisorDatabasesInput{} }
...
func (c *Client) addOperationDeleteFleetAdvisorDatabasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteFleetAdvisorDatabasesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteFleetAdvisorDatabasesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteFleetAdvisorDatabasesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteFleetAdvisorDatabasesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteFleetAdvisorDatabasesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteFleetAdvisorDatabasesResolveEndpointMiddleware{
