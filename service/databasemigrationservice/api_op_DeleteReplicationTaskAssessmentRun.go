...
func (c *Client) DeleteReplicationTaskAssessmentRun(ctx context.Context, params *DeleteReplicationTaskAssessmentRunInput, optFns ...func(*Options)) (*DeleteReplicationTaskAssessmentRunOutput, error) {
	if params == nil { params = &DeleteReplicationTaskAssessmentRunInput{} }
...
func (c *Client) addOperationDeleteReplicationTaskAssessmentRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteReplicationTaskAssessmentRunResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteReplicationTaskAssessmentRunResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteReplicationTaskAssessmentRunResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteReplicationTaskAssessmentRunResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteReplicationTaskAssessmentRunResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteReplicationTaskAssessmentRunResolveEndpointMiddleware{
