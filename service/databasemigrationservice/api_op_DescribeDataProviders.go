...
func (c *Client) DescribeDataProviders(ctx context.Context, params *DescribeDataProvidersInput, optFns ...func(*Options)) (*DescribeDataProvidersOutput, error) {
	if params == nil { params = &DescribeDataProvidersInput{} }
...
func (c *Client) addOperationDescribeDataProvidersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeDataProvidersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeDataProvidersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeDataProvidersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeDataProvidersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeDataProvidersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeDataProvidersResolveEndpointMiddleware{
