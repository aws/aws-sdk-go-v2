...
func (c *Client) addOperationDescribeMetadataModelChildrenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMetadataModelChildren", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
