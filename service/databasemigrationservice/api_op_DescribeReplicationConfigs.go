...
func (c *Client) addOperationDescribeReplicationConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReplicationConfigs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
