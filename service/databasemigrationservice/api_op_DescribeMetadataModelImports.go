...
func (c *Client) addOperationDescribeMetadataModelImportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMetadataModelImports", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
