...
func (c *Client) addOperationUpdateSubscriptionsToEventBridgeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateSubscriptionsToEventBridge", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
