...
func addOperationDescribeReplicationInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeReplicationInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeReplicationInstancesStackSlots(stack); err != nil {
		return err
	}
