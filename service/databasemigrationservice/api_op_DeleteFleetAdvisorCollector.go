...
func (c *Client) DeleteFleetAdvisorCollector(ctx context.Context, params *DeleteFleetAdvisorCollectorInput, optFns ...func(*Options)) (*DeleteFleetAdvisorCollectorOutput, error) {
	if params == nil { params = &DeleteFleetAdvisorCollectorInput{} }
...
func (c *Client) addOperationDeleteFleetAdvisorCollectorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteFleetAdvisorCollectorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteFleetAdvisorCollectorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteFleetAdvisorCollectorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteFleetAdvisorCollectorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteFleetAdvisorCollectorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteFleetAdvisorCollectorResolveEndpointMiddleware{
