...
func (c *Client) addOperationRunFleetAdvisorLsaAnalysisMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RunFleetAdvisorLsaAnalysis", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
