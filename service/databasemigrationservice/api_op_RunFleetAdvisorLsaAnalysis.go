...
func (c *Client) RunFleetAdvisorLsaAnalysis(ctx context.Context, params *RunFleetAdvisorLsaAnalysisInput, optFns ...func(*Options)) (*RunFleetAdvisorLsaAnalysisOutput, error) {
	if params == nil { params = &RunFleetAdvisorLsaAnalysisInput{} }
...
func (c *Client) addOperationRunFleetAdvisorLsaAnalysisMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRunFleetAdvisorLsaAnalysisResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRunFleetAdvisorLsaAnalysisResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRunFleetAdvisorLsaAnalysisResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRunFleetAdvisorLsaAnalysisResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRunFleetAdvisorLsaAnalysisResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRunFleetAdvisorLsaAnalysisResolveEndpointMiddleware{
