...
func (c *Client) addOperationDescribeOrderableReplicationInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeOrderableReplicationInstances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
