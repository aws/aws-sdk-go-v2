...
func addOperationDescribeOrderableReplicationInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeOrderableReplicationInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeOrderableReplicationInstancesStackSlots(stack); err != nil {
		return err
	}
