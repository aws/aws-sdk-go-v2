...
func (c *Client) DescribeOrderableReplicationInstances(ctx context.Context, params *DescribeOrderableReplicationInstancesInput, optFns ...func(*Options)) (*DescribeOrderableReplicationInstancesOutput, error) {
	if params == nil { params = &DescribeOrderableReplicationInstancesInput{} }
...
func (c *Client) addOperationDescribeOrderableReplicationInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeOrderableReplicationInstancesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeOrderableReplicationInstancesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeOrderableReplicationInstancesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeOrderableReplicationInstancesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeOrderableReplicationInstancesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeOrderableReplicationInstancesResolveEndpointMiddleware{
