...
func (c *Client) addOperationModifyReplicationConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyReplicationConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
