...
func (c *Client) addOperationDescribeReplicationSubnetGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReplicationSubnetGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
