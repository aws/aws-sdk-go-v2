...
func (c *Client) addOperationStartMetadataModelExportToTargetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartMetadataModelExportToTarget", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
