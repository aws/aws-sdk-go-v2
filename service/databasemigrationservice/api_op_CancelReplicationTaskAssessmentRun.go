...
func addOperationCancelReplicationTaskAssessmentRunStackSlots(stack *middleware.Stack) error {
...
func addOperationCancelReplicationTaskAssessmentRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCancelReplicationTaskAssessmentRunStackSlots(stack); err != nil {
		return err
	}
