...
func (c *Client) CancelReplicationTaskAssessmentRun(ctx context.Context, params *CancelReplicationTaskAssessmentRunInput, optFns ...func(*Options)) (*CancelReplicationTaskAssessmentRunOutput, error) {
	if params == nil { params = &CancelReplicationTaskAssessmentRunInput{} }
...
func (c *Client) addOperationCancelReplicationTaskAssessmentRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelReplicationTaskAssessmentRunResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelReplicationTaskAssessmentRunResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelReplicationTaskAssessmentRunResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelReplicationTaskAssessmentRunResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelReplicationTaskAssessmentRunResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelReplicationTaskAssessmentRunResolveEndpointMiddleware{
