...
func (c *Client) addOperationCancelMetadataModelCreationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelMetadataModelCreation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
