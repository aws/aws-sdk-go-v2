...
func (c *Client) addOperationDescribeMetadataModelCreationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMetadataModelCreations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
