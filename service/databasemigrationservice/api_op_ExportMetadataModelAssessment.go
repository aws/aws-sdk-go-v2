...
func (c *Client) addOperationExportMetadataModelAssessmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ExportMetadataModelAssessment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
