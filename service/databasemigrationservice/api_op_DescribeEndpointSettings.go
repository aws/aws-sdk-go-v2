...
func (c *Client) addOperationDescribeEndpointSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEndpointSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
