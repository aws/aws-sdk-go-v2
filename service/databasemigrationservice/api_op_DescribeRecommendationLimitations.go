...
func (c *Client) addOperationDescribeRecommendationLimitationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRecommendationLimitations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
