...
// events generated from all DMS sources belonging to your customer account. For
// more information about DMS events, see Working with Events and Notifications (https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Events.html)
