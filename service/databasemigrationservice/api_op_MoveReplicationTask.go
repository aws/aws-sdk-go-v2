...
func (c *Client) MoveReplicationTask(ctx context.Context, params *MoveReplicationTaskInput, optFns ...func(*Options)) (*MoveReplicationTaskOutput, error) {
	if params == nil { params = &MoveReplicationTaskInput{} }
...
func (c *Client) addOperationMoveReplicationTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addMoveReplicationTaskResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opMoveReplicationTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opMoveReplicationTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opMoveReplicationTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addMoveReplicationTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opMoveReplicationTaskResolveEndpointMiddleware{
