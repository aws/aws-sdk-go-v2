...
func (c *Client) addOperationModifyReplicationSubnetGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyReplicationSubnetGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
