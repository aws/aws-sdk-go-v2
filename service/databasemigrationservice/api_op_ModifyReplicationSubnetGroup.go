...
func (c *Client) ModifyReplicationSubnetGroup(ctx context.Context, params *ModifyReplicationSubnetGroupInput, optFns ...func(*Options)) (*ModifyReplicationSubnetGroupOutput, error) {
	if params == nil { params = &ModifyReplicationSubnetGroupInput{} }
...
func (c *Client) addOperationModifyReplicationSubnetGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addModifyReplicationSubnetGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opModifyReplicationSubnetGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opModifyReplicationSubnetGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opModifyReplicationSubnetGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addModifyReplicationSubnetGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opModifyReplicationSubnetGroupResolveEndpointMiddleware{
