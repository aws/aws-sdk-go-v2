...
func (c *Client) addOperationDescribeExtensionPackAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeExtensionPackAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
...
// ExtensionPackAssociatedWaiterOptions are waiter options for
// ExtensionPackAssociatedWaiter
type ExtensionPackAssociatedWaiterOptions struct {
	...
	// ExtensionPackAssociatedWaiter will use default minimum delay of 10 seconds. Note
	// that MinDelay must resolve to a value lesser than or equal to the MaxDelay.
	MinDelay time.Duration

	// MaxDelay is the maximum amount of time to delay between retries. If unset or
	// set to zero, ExtensionPackAssociatedWaiter will use default max delay of 120
	...
	Retryable func(context.Context, *DescribeExtensionPackAssociationsInput, *DescribeExtensionPackAssociationsOutput, error) (bool, error)
}

// ExtensionPackAssociatedWaiter defines the waiters for ExtensionPackAssociated
type ExtensionPackAssociatedWaiter struct {
	client DescribeExtensionPackAssociationsAPIClient

	options ExtensionPackAssociatedWaiterOptions
}

// NewExtensionPackAssociatedWaiter constructs a ExtensionPackAssociatedWaiter.
func NewExtensionPackAssociatedWaiter(client DescribeExtensionPackAssociationsAPIClient, optFns ...func(*ExtensionPackAssociatedWaiterOptions)) *ExtensionPackAssociatedWaiter {
	options := ExtensionPackAssociatedWaiterOptions{}
	options.MinDelay = 10 * time.Second
	options.MaxDelay = 120 * time.Second
	options.Retryable = extensionPackAssociatedStateRetryable

	for _, fn := range optFns {
		fn(&options)
	}
	return &ExtensionPackAssociatedWaiter{
		client:  client,
		options: options,
	}
}

// Wait calls the waiter function for ExtensionPackAssociated waiter. The
// maxWaitDur is the maximum wait duration the waiter will wait. The maxWaitDur is
// required and must be greater than zero.
func (w *ExtensionPackAssociatedWaiter) Wait(ctx context.Context, params *DescribeExtensionPackAssociationsInput, maxWaitDur time.Duration, optFns ...func(*ExtensionPackAssociatedWaiterOptions)) error {
	_, err := w.WaitForOutput(ctx, params, maxWaitDur, optFns...)
	return err
}

// WaitForOutput calls the waiter function for ExtensionPackAssociated waiter and
// returns the output of the successful operation. The maxWaitDur is the maximum
// wait duration the waiter will wait. The maxWaitDur is required and must be
// greater than zero.
func (w *ExtensionPackAssociatedWaiter) WaitForOutput(ctx context.Context, params *DescribeExtensionPackAssociationsInput, maxWaitDur time.Duration, optFns ...func(*ExtensionPackAssociatedWaiterOptions)) (*DescribeExtensionPackAssociationsOutput, error) {
	if maxWaitDur <= 0 {
	...
	for {
		...
		out, err := w.client.DescribeExtensionPackAssociations(ctx, params, func(o *Options) {
	...
	return nil, fmt.Errorf("exceeded max wait time for ExtensionPackAssociated waiter")
}

func extensionPackAssociatedStateRetryable(ctx context.Context, input *DescribeExtensionPackAssociationsInput, output *DescribeExtensionPackAssociationsOutput, err error) (bool, error) {
