...
func (c *Client) addOperationStartMetadataModelImportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartMetadataModelImport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
