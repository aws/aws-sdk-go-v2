...
func (c *Client) StartMetadataModelImport(ctx context.Context, params *StartMetadataModelImportInput, optFns ...func(*Options)) (*StartMetadataModelImportOutput, error) {
	if params == nil { params = &StartMetadataModelImportInput{} }
...
func (c *Client) addOperationStartMetadataModelImportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartMetadataModelImportResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartMetadataModelImportResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartMetadataModelImportResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartMetadataModelImportResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartMetadataModelImportResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartMetadataModelImportResolveEndpointMiddleware{
