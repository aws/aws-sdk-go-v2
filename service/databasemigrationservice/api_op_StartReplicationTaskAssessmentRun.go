...
func addOperationStartReplicationTaskAssessmentRunStackSlots(stack *middleware.Stack) error {
...
func addOperationStartReplicationTaskAssessmentRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartReplicationTaskAssessmentRunStackSlots(stack); err != nil {
		return err
	}
