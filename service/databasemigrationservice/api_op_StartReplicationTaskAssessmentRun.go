...
func (c *Client) addOperationStartReplicationTaskAssessmentRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartReplicationTaskAssessmentRun", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
