...
func (*DescribeMetadataModelExportsToTargetInput) operationName() string {
...
func (c *Client) addOperationDescribeMetadataModelExportsToTargetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeMetadataModelExportsToTargetResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeMetadataModelExportsToTargetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeMetadataModelExportsToTargetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeMetadataModelExportsToTargetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeMetadataModelExportsToTargetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeMetadataModelExportsToTargetResolveEndpointMiddleware{
