...
func (c *Client) addOperationDescribeMetadataModelExportsToTargetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMetadataModelExportsToTarget", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
