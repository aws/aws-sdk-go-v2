...
func (c *Client) StartMetadataModelExportAsScript(ctx context.Context, params *StartMetadataModelExportAsScriptInput, optFns ...func(*Options)) (*StartMetadataModelExportAsScriptOutput, error) {
	if params == nil { params = &StartMetadataModelExportAsScriptInput{} }
...
func (c *Client) addOperationStartMetadataModelExportAsScriptMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartMetadataModelExportAsScriptResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartMetadataModelExportAsScriptResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartMetadataModelExportAsScriptResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartMetadataModelExportAsScriptResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartMetadataModelExportAsScriptResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartMetadataModelExportAsScriptResolveEndpointMiddleware{
