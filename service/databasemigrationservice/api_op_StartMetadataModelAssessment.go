...
func (c *Client) StartMetadataModelAssessment(ctx context.Context, params *StartMetadataModelAssessmentInput, optFns ...func(*Options)) (*StartMetadataModelAssessmentOutput, error) {
	if params == nil { params = &StartMetadataModelAssessmentInput{} }
...
func (c *Client) addOperationStartMetadataModelAssessmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartMetadataModelAssessmentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartMetadataModelAssessmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartMetadataModelAssessmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartMetadataModelAssessmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartMetadataModelAssessmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartMetadataModelAssessmentResolveEndpointMiddleware{
