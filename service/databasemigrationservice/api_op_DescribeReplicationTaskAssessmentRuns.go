...
func addOperationDescribeReplicationTaskAssessmentRunsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeReplicationTaskAssessmentRunsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeReplicationTaskAssessmentRunsStackSlots(stack); err != nil {
		return err
	}
