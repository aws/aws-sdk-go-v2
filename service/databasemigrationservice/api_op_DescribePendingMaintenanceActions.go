...
func (c *Client) DescribePendingMaintenanceActions(ctx context.Context, params *DescribePendingMaintenanceActionsInput, optFns ...func(*Options)) (*DescribePendingMaintenanceActionsOutput, error) {
	...
	addawsAwsjson11_serdeOpDescribePendingMaintenanceActionsMiddlewares(stack)
...
func addawsAwsjson11_serdeOpDescribePendingMaintenanceActionsMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpDescribePendingMaintenanceActions{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpDescribePendingMaintenanceActions{}, middleware.After)
}
