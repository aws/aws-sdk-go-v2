...
func (c *Client) addOperationGetTargetSelectionRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetTargetSelectionRules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
