...
func (c *Client) CreateDataProvider(ctx context.Context, params *CreateDataProviderInput, optFns ...func(*Options)) (*CreateDataProviderOutput, error) {
	if params == nil { params = &CreateDataProviderInput{} }
...
func (c *Client) addOperationCreateDataProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateDataProviderResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateDataProviderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateDataProviderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateDataProviderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateDataProviderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateDataProviderResolveEndpointMiddleware{
