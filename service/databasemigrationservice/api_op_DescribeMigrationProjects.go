...
func (c *Client) addOperationDescribeMigrationProjectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMigrationProjects", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
