...
func addOperationDescribeReplicationInstanceTaskLogsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeReplicationInstanceTaskLogsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeReplicationInstanceTaskLogsStackSlots(stack); err != nil {
		return err
	}
