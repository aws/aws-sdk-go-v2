...
type DescribeAccountAttributesOutput struct {
	...
	// is the following: dms-AccountNumber-UniqueAccountIdentifier. Here is an
	// example name for this default S3 bucket: dms-111122223333-c44445555666. DMS
	// supports the UniqueAccountIdentifier  parameter in versions 3.1.4 and later.
