...
type DescribeAccountAttributesOutput struct {
	...
	// name artifacts. For example, DMS uses this identifier to name the default Amazon
	// S3 bucket for storing task assessment reports in a given Region. The format of
	// this S3 bucket name is the following: dms-AccountNumber-UniqueAccountIdentifier.
	// Here is an example name for this default S3 bucket:
	// dms-111122223333-c44445555666. DMS supports the UniqueAccountIdentifier
