...
// Using the Client
//
// To use AWS Database Migration Service with the SDK use the New function to create
...
//
// See the AWS Database Migration Service client for more information on
