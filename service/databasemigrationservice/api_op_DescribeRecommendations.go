...
func (c *Client) addOperationDescribeRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRecommendations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
