...
func (c *Client) StartReplicationTaskAssessment(ctx context.Context, params *StartReplicationTaskAssessmentInput, optFns ...func(*Options)) (*StartReplicationTaskAssessmentOutput, error) {
	if params == nil { params = &StartReplicationTaskAssessmentInput{} }
...
func (c *Client) addOperationStartReplicationTaskAssessmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartReplicationTaskAssessmentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartReplicationTaskAssessmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartReplicationTaskAssessmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartReplicationTaskAssessmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartReplicationTaskAssessmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartReplicationTaskAssessmentResolveEndpointMiddleware{
