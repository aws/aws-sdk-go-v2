...
func addOperationStartReplicationTaskAssessmentStackSlots(stack *middleware.Stack) error {
...
func addOperationStartReplicationTaskAssessmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartReplicationTaskAssessmentStackSlots(stack); err != nil {
		return err
	}
