...
func (c *Client) ReloadReplicationTables(ctx context.Context, params *ReloadReplicationTablesInput, optFns ...func(*Options)) (*ReloadReplicationTablesOutput, error) {
	if params == nil { params = &ReloadReplicationTablesInput{} }
...
func (c *Client) addOperationReloadReplicationTablesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addReloadReplicationTablesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opReloadReplicationTablesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opReloadReplicationTablesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opReloadReplicationTablesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addReloadReplicationTablesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opReloadReplicationTablesResolveEndpointMiddleware{
