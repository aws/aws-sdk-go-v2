...
func addOperationDescribeReplicationTaskAssessmentResultsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeReplicationTaskAssessmentResultsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeReplicationTaskAssessmentResultsStackSlots(stack); err != nil {
		return err
	}
