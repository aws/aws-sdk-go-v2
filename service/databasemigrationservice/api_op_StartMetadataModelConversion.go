...
func (c *Client) StartMetadataModelConversion(ctx context.Context, params *StartMetadataModelConversionInput, optFns ...func(*Options)) (*StartMetadataModelConversionOutput, error) {
	if params == nil { params = &StartMetadataModelConversionInput{} }
...
func (c *Client) addOperationStartMetadataModelConversionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartMetadataModelConversionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartMetadataModelConversionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartMetadataModelConversionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartMetadataModelConversionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartMetadataModelConversionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartMetadataModelConversionResolveEndpointMiddleware{
