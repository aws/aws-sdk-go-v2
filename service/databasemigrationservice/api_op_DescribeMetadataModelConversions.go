...
func (c *Client) DescribeMetadataModelConversions(ctx context.Context, params *DescribeMetadataModelConversionsInput, optFns ...func(*Options)) (*DescribeMetadataModelConversionsOutput, error) {
	if params == nil { params = &DescribeMetadataModelConversionsInput{} }
...
func (c *Client) addOperationDescribeMetadataModelConversionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeMetadataModelConversionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeMetadataModelConversionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeMetadataModelConversionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeMetadataModelConversionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeMetadataModelConversionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeMetadataModelConversionsResolveEndpointMiddleware{
