...
func (c *Client) DescribeMetadataModelAssessments(ctx context.Context, params *DescribeMetadataModelAssessmentsInput, optFns ...func(*Options)) (*DescribeMetadataModelAssessmentsOutput, error) {
	if params == nil { params = &DescribeMetadataModelAssessmentsInput{} }
...
func (c *Client) addOperationDescribeMetadataModelAssessmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeMetadataModelAssessmentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeMetadataModelAssessmentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeMetadataModelAssessmentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeMetadataModelAssessmentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeMetadataModelAssessmentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeMetadataModelAssessmentsResolveEndpointMiddleware{
