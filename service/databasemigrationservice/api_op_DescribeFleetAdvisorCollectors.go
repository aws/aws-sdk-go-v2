...
func (c *Client) addOperationDescribeFleetAdvisorCollectorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeFleetAdvisorCollectors", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
