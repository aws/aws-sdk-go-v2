...
func addOperationListCustomVerificationEmailTemplatesStackSlots(stack *middleware.Stack) error {
...
func addOperationListCustomVerificationEmailTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListCustomVerificationEmailTemplatesStackSlots(stack); err != nil {
		return err
	}
