...
func (c *Client) addOperationListCustomVerificationEmailTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCustomVerificationEmailTemplates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
