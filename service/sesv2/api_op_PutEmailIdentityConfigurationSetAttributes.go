...
func (c *Client) PutEmailIdentityConfigurationSetAttributes(ctx context.Context, params *PutEmailIdentityConfigurationSetAttributesInput, optFns ...func(*Options)) (*PutEmailIdentityConfigurationSetAttributesOutput, error) {
	if params == nil { params = &PutEmailIdentityConfigurationSetAttributesInput{} }
...
func (c *Client) addOperationPutEmailIdentityConfigurationSetAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutEmailIdentityConfigurationSetAttributesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutEmailIdentityConfigurationSetAttributesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutEmailIdentityConfigurationSetAttributesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutEmailIdentityConfigurationSetAttributesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutEmailIdentityConfigurationSetAttributesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutEmailIdentityConfigurationSetAttributesResolveEndpointMiddleware{
