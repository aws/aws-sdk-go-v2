...
func (c *Client) ListEmailIdentities(ctx context.Context, params *ListEmailIdentitiesInput, optFns ...func(*Options)) (*ListEmailIdentitiesOutput, error) {
	if params == nil { params = &ListEmailIdentitiesInput{} }
...
func (c *Client) addOperationListEmailIdentitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEmailIdentitiesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListEmailIdentitiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListEmailIdentitiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEmailIdentitiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEmailIdentitiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListEmailIdentitiesResolveEndpointMiddleware{
