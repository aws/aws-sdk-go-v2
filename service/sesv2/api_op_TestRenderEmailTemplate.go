...
func (c *Client) addOperationTestRenderEmailTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "TestRenderEmailTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
