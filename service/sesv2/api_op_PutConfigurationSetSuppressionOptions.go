...
func (c *Client) PutConfigurationSetSuppressionOptions(ctx context.Context, params *PutConfigurationSetSuppressionOptionsInput, optFns ...func(*Options)) (*PutConfigurationSetSuppressionOptionsOutput, error) {
	if params == nil { params = &PutConfigurationSetSuppressionOptionsInput{} }
...
func (c *Client) addOperationPutConfigurationSetSuppressionOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutConfigurationSetSuppressionOptionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutConfigurationSetSuppressionOptionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutConfigurationSetSuppressionOptionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutConfigurationSetSuppressionOptionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutConfigurationSetSuppressionOptionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutConfigurationSetSuppressionOptionsResolveEndpointMiddleware{
