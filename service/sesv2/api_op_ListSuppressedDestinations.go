...
func (c *Client) addOperationListSuppressedDestinationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSuppressedDestinations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
