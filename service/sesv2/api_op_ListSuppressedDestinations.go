...
func addOperationListSuppressedDestinationsStackSlots(stack *middleware.Stack) error {
...
func addOperationListSuppressedDestinationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListSuppressedDestinationsStackSlots(stack); err != nil {
		return err
	}
