...
func (c *Client) addOperationGetDeliverabilityTestReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDeliverabilityTestReport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
