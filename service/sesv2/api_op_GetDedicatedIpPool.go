...
func (c *Client) GetDedicatedIpPool(ctx context.Context, params *GetDedicatedIpPoolInput, optFns ...func(*Options)) (*GetDedicatedIpPoolOutput, error) {
	if params == nil { params = &GetDedicatedIpPoolInput{} }
...
func (c *Client) addOperationGetDedicatedIpPoolMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDedicatedIpPoolResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDedicatedIpPoolResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDedicatedIpPoolResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDedicatedIpPoolResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDedicatedIpPoolResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDedicatedIpPoolResolveEndpointMiddleware{
