...
func (c *Client) addOperationCreateDeliverabilityTestReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateDeliverabilityTestReport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
