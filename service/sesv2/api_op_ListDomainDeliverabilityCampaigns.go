...
func (c *Client) addOperationListDomainDeliverabilityCampaignsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDomainDeliverabilityCampaigns", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
