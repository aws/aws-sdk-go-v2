...
func (c *Client) addOperationSendCustomVerificationEmailMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SendCustomVerificationEmail", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
