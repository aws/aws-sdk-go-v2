...
func (c *Client) PutConfigurationSetVdmOptions(ctx context.Context, params *PutConfigurationSetVdmOptionsInput, optFns ...func(*Options)) (*PutConfigurationSetVdmOptionsOutput, error) {
	if params == nil { params = &PutConfigurationSetVdmOptionsInput{} }
...
func (c *Client) addOperationPutConfigurationSetVdmOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutConfigurationSetVdmOptionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutConfigurationSetVdmOptionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutConfigurationSetVdmOptionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutConfigurationSetVdmOptionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutConfigurationSetVdmOptionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutConfigurationSetVdmOptionsResolveEndpointMiddleware{
