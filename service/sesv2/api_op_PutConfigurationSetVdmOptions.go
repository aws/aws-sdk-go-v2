...
func (c *Client) addOperationPutConfigurationSetVdmOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutConfigurationSetVdmOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
