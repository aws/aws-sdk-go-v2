...
func (c *Client) GetDedicatedIp(ctx context.Context, params *GetDedicatedIpInput, optFns ...func(*Options)) (*GetDedicatedIpOutput, error) {
	if params == nil { params = &GetDedicatedIpInput{} }
...
func (c *Client) addOperationGetDedicatedIpMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDedicatedIpResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDedicatedIpResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDedicatedIpResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDedicatedIpResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDedicatedIpResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDedicatedIpResolveEndpointMiddleware{
