...
func (c *Client) addOperationPutConfigurationSetArchivingOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutConfigurationSetArchivingOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
