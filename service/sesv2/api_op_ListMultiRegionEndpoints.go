...
func (c *Client) addOperationListMultiRegionEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMultiRegionEndpoints", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
