...
func (c *Client) addOperationDeleteEmailIdentityPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteEmailIdentityPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
