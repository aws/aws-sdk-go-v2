...
func addOperationPutAccountSuppressionAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationPutAccountSuppressionAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutAccountSuppressionAttributesStackSlots(stack); err != nil {
		return err
	}
