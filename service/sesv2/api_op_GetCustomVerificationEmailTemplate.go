...
func (c *Client) addOperationGetCustomVerificationEmailTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCustomVerificationEmailTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
