...
func (c *Client) addOperationUpdateCustomVerificationEmailTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCustomVerificationEmailTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
