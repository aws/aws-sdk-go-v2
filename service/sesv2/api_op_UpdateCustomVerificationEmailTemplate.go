...
func addOperationUpdateCustomVerificationEmailTemplateStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateCustomVerificationEmailTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateCustomVerificationEmailTemplateStackSlots(stack); err != nil {
		return err
	}
