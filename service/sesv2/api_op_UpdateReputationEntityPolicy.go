...
func (c *Client) addOperationUpdateReputationEntityPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateReputationEntityPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
