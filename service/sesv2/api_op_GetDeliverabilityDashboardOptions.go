...
func (c *Client) addOperationGetDeliverabilityDashboardOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDeliverabilityDashboardOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
