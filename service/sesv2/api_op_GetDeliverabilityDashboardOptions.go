...
func addOperationGetDeliverabilityDashboardOptionsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetDeliverabilityDashboardOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetDeliverabilityDashboardOptionsStackSlots(stack); err != nil {
		return err
	}
