...
func (c *Client) PutAccountVdmAttributes(ctx context.Context, params *PutAccountVdmAttributesInput, optFns ...func(*Options)) (*PutAccountVdmAttributesOutput, error) {
	if params == nil { params = &PutAccountVdmAttributesInput{} }
...
func (c *Client) addOperationPutAccountVdmAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutAccountVdmAttributesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutAccountVdmAttributesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutAccountVdmAttributesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutAccountVdmAttributesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutAccountVdmAttributesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutAccountVdmAttributesResolveEndpointMiddleware{
