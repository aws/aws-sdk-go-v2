...
func addOperationCreateContactListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpCreateContactListValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opCreateContactList(options.Region), middleware.Before)
