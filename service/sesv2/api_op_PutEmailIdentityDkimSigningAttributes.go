...
func (c *Client) addOperationPutEmailIdentityDkimSigningAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutEmailIdentityDkimSigningAttributes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
