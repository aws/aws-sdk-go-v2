...
func addOperationPutEmailIdentityDkimSigningAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationPutEmailIdentityDkimSigningAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutEmailIdentityDkimSigningAttributesStackSlots(stack); err != nil {
		return err
	}
