...
func addOperationDeleteConfigurationSetEventDestinationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteConfigurationSetEventDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteConfigurationSetEventDestinationStackSlots(stack); err != nil {
		return err
	}
