...
func (c *Client) PutDedicatedIpPoolScalingAttributes(ctx context.Context, params *PutDedicatedIpPoolScalingAttributesInput, optFns ...func(*Options)) (*PutDedicatedIpPoolScalingAttributesOutput, error) {
	if params == nil { params = &PutDedicatedIpPoolScalingAttributesInput{} }
...
func (c *Client) addOperationPutDedicatedIpPoolScalingAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutDedicatedIpPoolScalingAttributesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutDedicatedIpPoolScalingAttributesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutDedicatedIpPoolScalingAttributesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutDedicatedIpPoolScalingAttributesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutDedicatedIpPoolScalingAttributesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutDedicatedIpPoolScalingAttributesResolveEndpointMiddleware{
