...
func (c *Client) addOperationCreateMultiRegionEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMultiRegionEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
