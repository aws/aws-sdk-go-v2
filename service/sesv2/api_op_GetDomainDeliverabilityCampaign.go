...
func (c *Client) addOperationGetDomainDeliverabilityCampaignMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDomainDeliverabilityCampaign", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
