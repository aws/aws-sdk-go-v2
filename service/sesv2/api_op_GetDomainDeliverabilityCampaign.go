...
func (*GetDomainDeliverabilityCampaignInput) operationName() string {
...
func (c *Client) addOperationGetDomainDeliverabilityCampaignMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDomainDeliverabilityCampaignResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetDomainDeliverabilityCampaignResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetDomainDeliverabilityCampaignResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDomainDeliverabilityCampaignResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDomainDeliverabilityCampaignResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetDomainDeliverabilityCampaignResolveEndpointMiddleware{
