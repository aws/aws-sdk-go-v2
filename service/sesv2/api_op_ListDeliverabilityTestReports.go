...
func (c *Client) ListDeliverabilityTestReports(ctx context.Context, params *ListDeliverabilityTestReportsInput, optFns ...func(*Options)) (*ListDeliverabilityTestReportsOutput, error) {
	if params == nil { params = &ListDeliverabilityTestReportsInput{} }
...
func (c *Client) addOperationListDeliverabilityTestReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDeliverabilityTestReportsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDeliverabilityTestReportsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDeliverabilityTestReportsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDeliverabilityTestReportsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDeliverabilityTestReportsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDeliverabilityTestReportsResolveEndpointMiddleware{
