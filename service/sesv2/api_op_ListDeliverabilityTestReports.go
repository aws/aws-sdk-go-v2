...
func (c *Client) addOperationListDeliverabilityTestReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDeliverabilityTestReports", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
