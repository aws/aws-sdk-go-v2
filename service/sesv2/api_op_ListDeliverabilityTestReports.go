...
func addOperationListDeliverabilityTestReportsStackSlots(stack *middleware.Stack) error {
...
func addOperationListDeliverabilityTestReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListDeliverabilityTestReportsStackSlots(stack); err != nil {
		return err
	}
