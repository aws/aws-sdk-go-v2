...
func (c *Client) addOperationUpdateReputationEntityCustomerManagedStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateReputationEntityCustomerManagedStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
