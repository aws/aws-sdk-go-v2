...
func (c *Client) GetContactList(ctx context.Context, params *GetContactListInput, optFns ...func(*Options)) (*GetContactListOutput, error) {
	if params == nil { params = &GetContactListInput{} }
...
func (c *Client) addOperationGetContactListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetContactListResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetContactListResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetContactListResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetContactListResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetContactListResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetContactListResolveEndpointMiddleware{
