...
func (c *Client) addOperationGetEmailIdentityPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetEmailIdentityPolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
