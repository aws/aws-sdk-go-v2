...
func addOperationPutEmailIdentityMailFromAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationPutEmailIdentityMailFromAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutEmailIdentityMailFromAttributesStackSlots(stack); err != nil {
		return err
	}
