...
func (c *Client) addOperationCreateCustomVerificationEmailTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCustomVerificationEmailTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
