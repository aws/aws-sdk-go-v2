...
func addOperationCreateCustomVerificationEmailTemplateStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateCustomVerificationEmailTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateCustomVerificationEmailTemplateStackSlots(stack); err != nil {
		return err
	}
