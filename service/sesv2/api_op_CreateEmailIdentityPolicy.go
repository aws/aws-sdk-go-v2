...
func (c *Client) addOperationCreateEmailIdentityPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateEmailIdentityPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
