...
func (c *Client) addOperationGetEmailAddressInsightsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetEmailAddressInsights", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
