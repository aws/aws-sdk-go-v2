...
func addOperationCreateConfigurationSetEventDestinationStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateConfigurationSetEventDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateConfigurationSetEventDestinationStackSlots(stack); err != nil {
		return err
	}
