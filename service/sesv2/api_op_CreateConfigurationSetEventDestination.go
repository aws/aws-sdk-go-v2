...
func (c *Client) addOperationCreateConfigurationSetEventDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateConfigurationSetEventDestination", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
