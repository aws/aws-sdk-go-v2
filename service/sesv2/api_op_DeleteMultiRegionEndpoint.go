...
func (c *Client) addOperationDeleteMultiRegionEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteMultiRegionEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
