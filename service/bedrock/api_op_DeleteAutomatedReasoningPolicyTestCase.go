...
func (c *Client) addOperationDeleteAutomatedReasoningPolicyTestCaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteAutomatedReasoningPolicyTestCase", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
