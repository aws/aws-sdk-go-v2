...
func (c *Client) addOperationCreateAutomatedReasoningPolicyVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateAutomatedReasoningPolicyVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
