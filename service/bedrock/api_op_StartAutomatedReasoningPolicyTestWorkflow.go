...
func (c *Client) addOperationStartAutomatedReasoningPolicyTestWorkflowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartAutomatedReasoningPolicyTestWorkflow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
