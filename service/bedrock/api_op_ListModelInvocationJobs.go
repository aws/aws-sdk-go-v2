...
func (c *Client) addOperationListModelInvocationJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListModelInvocationJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
