...
func (c *Client) addOperationBatchDeleteEvaluationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDeleteEvaluationJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
