...
func (c *Client) addOperationDeleteProvisionedModelThroughputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteProvisionedModelThroughput", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
