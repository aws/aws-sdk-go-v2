...
func (c *Client) addOperationDeleteProvisionedModelThroughputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteProvisionedModelThroughputResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteProvisionedModelThroughputResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteProvisionedModelThroughputResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteProvisionedModelThroughputResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteProvisionedModelThroughputResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteProvisionedModelThroughputResolveEndpointMiddleware{
