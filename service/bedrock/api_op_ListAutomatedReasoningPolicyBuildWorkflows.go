...
func (c *Client) addOperationListAutomatedReasoningPolicyBuildWorkflowsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAutomatedReasoningPolicyBuildWorkflows", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
