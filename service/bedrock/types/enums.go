...
type ModelInvocationType string

// Enum values for ModelInvocationType
const (
	ModelInvocationTypeInvokeModel ModelInvocationType = "InvokeModel"
	ModelInvocationTypeConverse    ModelInvocationType = "Converse"
)

// Values returns all known values for ModelInvocationType. Note that this can be
// expanded in the future, and so it is only as up to date as the client.
//
// The ordering of this slice is not guaranteed to be stable across updates.
func (ModelInvocationType) Values() []ModelInvocationType {
	return []ModelInvocationType{
		"InvokeModel",
		"Converse",
	}
}
