...
func (c *Client) addOperationUpdateProvisionedModelThroughputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateProvisionedModelThroughput", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
