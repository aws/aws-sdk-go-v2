...
func (c *Client) addOperationUpdateProvisionedModelThroughputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateProvisionedModelThroughputResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateProvisionedModelThroughputResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateProvisionedModelThroughputResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateProvisionedModelThroughputResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateProvisionedModelThroughputResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateProvisionedModelThroughputResolveEndpointMiddleware{
