...
func (c *Client) addOperationUpdateCustomModelDeploymentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCustomModelDeployment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
