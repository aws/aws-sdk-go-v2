...
func (c *Client) addOperationListAutomatedReasoningPolicyTestCasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAutomatedReasoningPolicyTestCases", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
