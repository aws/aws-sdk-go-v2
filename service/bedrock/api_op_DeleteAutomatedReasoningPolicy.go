...
func (c *Client) addOperationDeleteAutomatedReasoningPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteAutomatedReasoningPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
