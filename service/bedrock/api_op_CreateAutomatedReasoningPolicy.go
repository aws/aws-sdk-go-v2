...
func (c *Client) addOperationCreateAutomatedReasoningPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateAutomatedReasoningPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
