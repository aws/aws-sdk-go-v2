...
func (c *Client) addOperationListCustomModelDeploymentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCustomModelDeployments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
