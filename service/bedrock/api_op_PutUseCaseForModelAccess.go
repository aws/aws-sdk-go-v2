...
func (c *Client) addOperationPutUseCaseForModelAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutUseCaseForModelAccess", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
