...
func (c *Client) addOperationListAutomatedReasoningPolicyTestResultsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAutomatedReasoningPolicyTestResults", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
