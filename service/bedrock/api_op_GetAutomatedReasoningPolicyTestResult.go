...
func (c *Client) addOperationGetAutomatedReasoningPolicyTestResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAutomatedReasoningPolicyTestResult", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
