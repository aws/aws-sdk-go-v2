...
func (c *Client) addOperationCreateModelCustomizationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateModelCustomizationJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
