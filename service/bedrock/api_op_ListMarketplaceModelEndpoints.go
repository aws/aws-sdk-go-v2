...
func (c *Client) addOperationListMarketplaceModelEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMarketplaceModelEndpoints", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
