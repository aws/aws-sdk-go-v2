...
func (v *ListMarketplaceModelEndpointsInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListMarketplaceModelEndpointsRequest)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ListMarketplaceModelEndpointsInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.MaxResults != nil {
		s.WriteInt32(schemas.ListMarketplaceModelEndpointsRequest_maxResults, *v.MaxResults)
	}
	if v.ModelSourceEquals != nil {
		s.WriteString(schemas.ListMarketplaceModelEndpointsRequest_modelSourceEquals, *v.ModelSourceEquals)
	}
	if v.NextToken != nil {
		s.WriteString(schemas.ListMarketplaceModelEndpointsRequest_nextToken, *v.NextToken)
	}
}
...
func (v *ListMarketplaceModelEndpointsOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListMarketplaceModelEndpointsResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ListMarketplaceModelEndpointsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	serializeMarketplaceModelEndpointSummaries(s, schemas.ListMarketplaceModelEndpointsResponse_marketplaceModelEndpoints, v.MarketplaceModelEndpoints)
	if v.NextToken != nil {
		s.WriteString(schemas.ListMarketplaceModelEndpointsResponse_nextToken, *v.NextToken)
	}
}
func (v *ListMarketplaceModelEndpointsOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListMarketplaceModelEndpointsResponse, func(s *smithy.Schema) error {
		switch s {
		case schemas.ListMarketplaceModelEndpointsResponse_marketplaceModelEndpoints:
			return deserializeMarketplaceModelEndpointSummaries(d, schemas.ListMarketplaceModelEndpointsResponse_marketplaceModelEndpoints, &v.MarketplaceModelEndpoints)
		case schemas.ListMarketplaceModelEndpointsResponse_nextToken:
			v.NextToken = new(string)
			return d.ReadString(schemas.ListMarketplaceModelEndpointsResponse_nextToken, v.NextToken)
		}
		return nil
	})
}
func (c *Client) addOperationListMarketplaceModelEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ListMarketplaceModelEndpoints, schemas.ListMarketplaceModelEndpointsRequest, schemas.ListMarketplaceModelEndpointsResponse)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ListMarketplaceModelEndpoints, schemas.ListMarketplaceModelEndpointsRequest, schemas.ListMarketplaceModelEndpointsResponse), output: &ListMarketplaceModelEndpointsOutput{}}, middleware.After); err != nil {
		return err
	}
