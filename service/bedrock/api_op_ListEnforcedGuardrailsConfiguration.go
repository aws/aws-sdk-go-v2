...
func (c *Client) addOperationListEnforcedGuardrailsConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEnforcedGuardrailsConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
