...
func (c *Client) addOperationCreateAutomatedReasoningPolicyTestCaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateAutomatedReasoningPolicyTestCase", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
