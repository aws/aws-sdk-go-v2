...
func (c *Client) addOperationUpdateAutomatedReasoningPolicyAnnotationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAutomatedReasoningPolicyAnnotations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
