...
func (c *Client) addOperationDeleteCustomModelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCustomModelResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteCustomModelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteCustomModelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCustomModelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCustomModelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteCustomModelResolveEndpointMiddleware{
