...
func (c *Client) addOperationStartAutomatedReasoningPolicyBuildWorkflowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartAutomatedReasoningPolicyBuildWorkflow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
