...
func (c *Client) addOperationListAutomatedReasoningPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAutomatedReasoningPolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
