...
func (c *Client) addOperationDeregisterMarketplaceModelEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterMarketplaceModelEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
