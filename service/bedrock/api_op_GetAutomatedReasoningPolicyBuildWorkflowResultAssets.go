...
func (c *Client) addOperationGetAutomatedReasoningPolicyBuildWorkflowResultAssetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAutomatedReasoningPolicyBuildWorkflowResultAssets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
