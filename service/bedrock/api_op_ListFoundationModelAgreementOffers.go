...
func (c *Client) addOperationListFoundationModelAgreementOffersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFoundationModelAgreementOffers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
