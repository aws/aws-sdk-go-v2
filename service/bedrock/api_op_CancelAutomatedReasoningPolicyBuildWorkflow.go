...
func (c *Client) addOperationCancelAutomatedReasoningPolicyBuildWorkflowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelAutomatedReasoningPolicyBuildWorkflow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
