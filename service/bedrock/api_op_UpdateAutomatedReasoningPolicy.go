...
func (c *Client) addOperationUpdateAutomatedReasoningPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAutomatedReasoningPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
