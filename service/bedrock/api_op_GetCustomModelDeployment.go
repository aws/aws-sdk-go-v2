...
func (c *Client) addOperationGetCustomModelDeploymentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCustomModelDeployment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
