...
func (c *Client) addOperationStopModelCustomizationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopModelCustomizationJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
