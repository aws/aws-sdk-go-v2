...
func (c *Client) addOperationListModelCustomizationJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListModelCustomizationJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
