...
func (c *Client) addOperationCreateMarketplaceModelEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMarketplaceModelEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
