...
func (c *Client) CreateFoundationModelAgreement(ctx context.Context, params *CreateFoundationModelAgreementInput, optFns ...func(*Options)) (*CreateFoundationModelAgreementOutput, error) {
	if params == nil { params = &CreateFoundationModelAgreementInput{} }
...
func (c *Client) addOperationCreateFoundationModelAgreementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err != nil { return err }
	if err := addProtocolFinalizerMiddlewares(stack, options, "CreateFoundationModelAgreement"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opCreateFoundationModelAgreement(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opCreateFoundationModelAgreement(region string) *awsmiddleware.RegisterServiceMetadata {
