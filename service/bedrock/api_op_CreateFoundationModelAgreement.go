...
func (c *Client) addOperationCreateFoundationModelAgreementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateFoundationModelAgreement", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
