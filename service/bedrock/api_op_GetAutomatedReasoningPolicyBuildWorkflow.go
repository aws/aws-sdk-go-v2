...
func (c *Client) addOperationGetAutomatedReasoningPolicyBuildWorkflowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAutomatedReasoningPolicyBuildWorkflow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
