...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-lambda-core.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lambda-core.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lambda-core.dev",
			expectURL:     aws.String("https://env-lambda-core.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-lambda-core.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lambda-core.dev",
			expectURL:     aws.String("http://config-lambda-core.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-lambda-core.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-lambda-core.dev",
			clientEndpoint: aws.String("https://client-lambda-core.dev"),
			expectURL:      aws.String("https://client-lambda-core.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_LAMBDA_CORE", c.envService)
			}
