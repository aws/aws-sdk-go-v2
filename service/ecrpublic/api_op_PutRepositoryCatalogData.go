...
func (c *Client) addOperationPutRepositoryCatalogDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutRepositoryCatalogData", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
