...
func (c *Client) addOperationGetRepositoryCatalogDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRepositoryCatalogData", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
