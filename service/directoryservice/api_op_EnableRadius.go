...
func (*EnableRadiusInput) operationName() string {
	return "EnableRadius"
}
...
func (c *Client) addOperationEnableRadiusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableRadiusResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opEnableRadiusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opEnableRadiusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableRadiusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableRadiusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opEnableRadiusResolveEndpointMiddleware{
