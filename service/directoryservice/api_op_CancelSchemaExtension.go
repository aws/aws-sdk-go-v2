...
func (c *Client) CancelSchemaExtension(ctx context.Context, params *CancelSchemaExtensionInput, optFns ...func(*Options)) (*CancelSchemaExtensionOutput, error) {
	if params == nil { params = &CancelSchemaExtensionInput{} }
...
func (c *Client) addOperationCancelSchemaExtensionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelSchemaExtensionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelSchemaExtensionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelSchemaExtensionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelSchemaExtensionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelSchemaExtensionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelSchemaExtensionResolveEndpointMiddleware{
