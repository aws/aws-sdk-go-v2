...
type AddIpRoutesInput struct {
	...
	// - Type: Custom UDP
	// Rule, Protocol: UDP, Range: 138, Source: 0.0.0.0/0
	...
	// - Type: Custom TCP Rule, Protocol: TCP, Range: 88,
	// Source: 0.0.0.0/0
	...
	// - Type:
	// DNS (TCP), Protocol: TCP, Range: 53, Source: 0.0.0.0/0
	// - Type: LDAP, Protocol:
	// TCP, Range: 389, Source: 0.0.0.0/0
	// - Type: All ICMP, Protocol: All, Range: N/A,
	// Source: 0.0.0.0/0
	//
	// Outbound:
	// - Type: All traffic, Protocol: All, Range: All,
