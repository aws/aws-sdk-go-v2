...
func (c *Client) EnableLDAPS(ctx context.Context, params *EnableLDAPSInput, optFns ...func(*Options)) (*EnableLDAPSOutput, error) {
	if params == nil { params = &EnableLDAPSInput{} }
...
func (c *Client) addOperationEnableLDAPSMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableLDAPSResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEnableLDAPSResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEnableLDAPSResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableLDAPSResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableLDAPSResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEnableLDAPSResolveEndpointMiddleware{
