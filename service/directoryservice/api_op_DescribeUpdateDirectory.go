...
func (c *Client) addOperationDescribeUpdateDirectoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeUpdateDirectory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
