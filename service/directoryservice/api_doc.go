...
// Using the Client
//
// To use Directory Service with the SDK use the New function to create
...
//
// See the Directory Service client for more information on
