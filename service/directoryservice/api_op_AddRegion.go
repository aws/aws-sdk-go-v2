...
func (c *Client) AddRegion(ctx context.Context, params *AddRegionInput, optFns ...func(*Options)) (*AddRegionOutput, error) {
	if params == nil { params = &AddRegionInput{} }
...
func (c *Client) addOperationAddRegionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAddRegionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAddRegionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAddRegionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAddRegionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAddRegionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAddRegionResolveEndpointMiddleware{
