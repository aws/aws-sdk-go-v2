...
func addOperationCreateConditionalForwarderStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateConditionalForwarderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateConditionalForwarderStackSlots(stack); err != nil {
		return err
	}
