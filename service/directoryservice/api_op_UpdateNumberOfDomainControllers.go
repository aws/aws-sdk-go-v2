...
func (c *Client) addOperationUpdateNumberOfDomainControllersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateNumberOfDomainControllers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
