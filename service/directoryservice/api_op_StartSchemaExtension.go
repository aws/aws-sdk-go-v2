...
func (c *Client) StartSchemaExtension(ctx context.Context, params *StartSchemaExtensionInput, optFns ...func(*Options)) (*StartSchemaExtensionOutput, error) {
	if params == nil { params = &StartSchemaExtensionInput{} }
...
func (c *Client) addOperationStartSchemaExtensionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartSchemaExtensionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartSchemaExtensionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartSchemaExtensionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartSchemaExtensionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartSchemaExtensionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartSchemaExtensionResolveEndpointMiddleware{
