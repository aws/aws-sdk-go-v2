...
func (c *Client) DisableRadius(ctx context.Context, params *DisableRadiusInput, optFns ...func(*Options)) (*DisableRadiusOutput, error) {
	if params == nil { params = &DisableRadiusInput{} }
...
func (c *Client) addOperationDisableRadiusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableRadiusResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisableRadiusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisableRadiusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableRadiusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableRadiusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisableRadiusResolveEndpointMiddleware{
