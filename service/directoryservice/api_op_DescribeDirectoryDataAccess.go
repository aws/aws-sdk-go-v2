...
func (c *Client) addOperationDescribeDirectoryDataAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDirectoryDataAccess", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
