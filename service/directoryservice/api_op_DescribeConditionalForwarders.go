...
func addOperationDescribeConditionalForwardersStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeConditionalForwardersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeConditionalForwardersStackSlots(stack); err != nil {
		return err
	}
