...
func (c *Client) addOperationDescribeConditionalForwardersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConditionalForwarders", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
