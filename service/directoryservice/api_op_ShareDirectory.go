...
// consumer account. The ShareMethod parameter determines whether the specified
// directory can be shared between Amazon Web Services accounts inside the same
// Amazon Web Services organization ( ORGANIZATIONS). It also determines whether
// you can share the directory with any other Amazon Web Services account either
// inside or outside of the organization ( HANDSHAKE ). The ShareNotes parameter
// is only used when HANDSHAKE is called, which sends a directory sharing request
