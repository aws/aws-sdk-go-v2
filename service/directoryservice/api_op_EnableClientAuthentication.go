...
func (c *Client) EnableClientAuthentication(ctx context.Context, params *EnableClientAuthenticationInput, optFns ...func(*Options)) (*EnableClientAuthenticationOutput, error) {
	if params == nil { params = &EnableClientAuthenticationInput{} }
...
func (c *Client) addOperationEnableClientAuthenticationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableClientAuthenticationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEnableClientAuthenticationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEnableClientAuthenticationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableClientAuthenticationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableClientAuthenticationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEnableClientAuthenticationResolveEndpointMiddleware{
