...
func (c *Client) addOperationDisableClientAuthenticationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisableClientAuthentication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
