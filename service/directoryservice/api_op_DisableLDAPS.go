...
func (*DisableLDAPSInput) operationName() string {
	return "DisableLDAPS"
}
...
func (c *Client) addOperationDisableLDAPSMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableLDAPSResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDisableLDAPSResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDisableLDAPSResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableLDAPSResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableLDAPSResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDisableLDAPSResolveEndpointMiddleware{
