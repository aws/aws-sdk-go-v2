...
func (c *Client) addOperationDeleteConditionalForwarderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteConditionalForwarder", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
