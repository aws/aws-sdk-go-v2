...
func (c *Client) AcceptSharedDirectory(ctx context.Context, params *AcceptSharedDirectoryInput, optFns ...func(*Options)) (*AcceptSharedDirectoryOutput, error) {
	stack := middleware.NewStack("AcceptSharedDirectory", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpAcceptSharedDirectoryMiddlewares(stack)
	...
	addOpAcceptSharedDirectoryValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opAcceptSharedDirectory(options.Region), middleware.Before)
...
func addawsAwsjson11_serdeOpAcceptSharedDirectoryMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpAcceptSharedDirectory{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpAcceptSharedDirectory{}, middleware.After)
}
