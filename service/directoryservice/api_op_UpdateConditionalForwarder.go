...
func (c *Client) addOperationUpdateConditionalForwarderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateConditionalForwarder", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
