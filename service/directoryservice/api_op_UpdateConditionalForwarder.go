...
func addOperationUpdateConditionalForwarderStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateConditionalForwarderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateConditionalForwarderStackSlots(stack); err != nil {
		return err
	}
