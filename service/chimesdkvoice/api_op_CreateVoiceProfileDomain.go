...
func (c *Client) addOperationCreateVoiceProfileDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateVoiceProfileDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
