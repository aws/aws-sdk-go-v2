...
func (c *Client) addOperationListVoiceConnectorGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListVoiceConnectorGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
