...
func (*GetSipMediaApplicationInput) operationName() string {
...
func (c *Client) addOperationGetSipMediaApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSipMediaApplicationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetSipMediaApplicationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetSipMediaApplicationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSipMediaApplicationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSipMediaApplicationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetSipMediaApplicationResolveEndpointMiddleware{
