...
func (c *Client) UpdateSipMediaApplicationCall(ctx context.Context, params *UpdateSipMediaApplicationCallInput, optFns ...func(*Options)) (*UpdateSipMediaApplicationCallOutput, error) {
	if params == nil { params = &UpdateSipMediaApplicationCallInput{} }
...
func (c *Client) addOperationUpdateSipMediaApplicationCallMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateSipMediaApplicationCallResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateSipMediaApplicationCallResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateSipMediaApplicationCallResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateSipMediaApplicationCallResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateSipMediaApplicationCallResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateSipMediaApplicationCallResolveEndpointMiddleware{
