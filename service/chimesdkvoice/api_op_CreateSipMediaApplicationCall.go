...
func (c *Client) addOperationCreateSipMediaApplicationCallMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateSipMediaApplicationCall", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
