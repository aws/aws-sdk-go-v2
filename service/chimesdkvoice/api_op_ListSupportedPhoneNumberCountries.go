...
func (c *Client) addOperationListSupportedPhoneNumberCountriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSupportedPhoneNumberCountries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
