...
func (c *Client) ListSupportedPhoneNumberCountries(ctx context.Context, params *ListSupportedPhoneNumberCountriesInput, optFns ...func(*Options)) (*ListSupportedPhoneNumberCountriesOutput, error) {
	if params == nil { params = &ListSupportedPhoneNumberCountriesInput{} }
...
func (c *Client) addOperationListSupportedPhoneNumberCountriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSupportedPhoneNumberCountriesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSupportedPhoneNumberCountriesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSupportedPhoneNumberCountriesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSupportedPhoneNumberCountriesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSupportedPhoneNumberCountriesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSupportedPhoneNumberCountriesResolveEndpointMiddleware{
