...
func (c *Client) addOperationPutVoiceConnectorTerminationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutVoiceConnectorTermination", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
