...
func (c *Client) addOperationDeleteVoiceProfileDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteVoiceProfileDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
