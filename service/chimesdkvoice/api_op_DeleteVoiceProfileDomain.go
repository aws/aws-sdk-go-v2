...
func (c *Client) DeleteVoiceProfileDomain(ctx context.Context, params *DeleteVoiceProfileDomainInput, optFns ...func(*Options)) (*DeleteVoiceProfileDomainOutput, error) {
	if params == nil { params = &DeleteVoiceProfileDomainInput{} }
...
func (c *Client) addOperationDeleteVoiceProfileDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteVoiceProfileDomainResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteVoiceProfileDomainResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteVoiceProfileDomainResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteVoiceProfileDomainResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteVoiceProfileDomainResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteVoiceProfileDomainResolveEndpointMiddleware{
