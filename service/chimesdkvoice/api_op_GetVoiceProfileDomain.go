...
func (c *Client) GetVoiceProfileDomain(ctx context.Context, params *GetVoiceProfileDomainInput, optFns ...func(*Options)) (*GetVoiceProfileDomainOutput, error) {
	if params == nil { params = &GetVoiceProfileDomainInput{} }
...
func (c *Client) addOperationGetVoiceProfileDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetVoiceProfileDomainResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetVoiceProfileDomainResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetVoiceProfileDomainResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetVoiceProfileDomainResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetVoiceProfileDomainResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetVoiceProfileDomainResolveEndpointMiddleware{
