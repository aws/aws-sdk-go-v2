...
func (c *Client) ListAvailableVoiceConnectorRegions(ctx context.Context, params *ListAvailableVoiceConnectorRegionsInput, optFns ...func(*Options)) (*ListAvailableVoiceConnectorRegionsOutput, error) {
	if params == nil { params = &ListAvailableVoiceConnectorRegionsInput{} }
...
func (c *Client) addOperationListAvailableVoiceConnectorRegionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAvailableVoiceConnectorRegionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAvailableVoiceConnectorRegionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAvailableVoiceConnectorRegionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAvailableVoiceConnectorRegionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAvailableVoiceConnectorRegionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAvailableVoiceConnectorRegionsResolveEndpointMiddleware{
