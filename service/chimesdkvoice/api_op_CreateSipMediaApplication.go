...
func (c *Client) addOperationCreateSipMediaApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateSipMediaApplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
