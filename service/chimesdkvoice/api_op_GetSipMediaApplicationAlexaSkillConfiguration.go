...
func (*GetSipMediaApplicationAlexaSkillConfigurationInput) operationName() string {
...
func (c *Client) addOperationGetSipMediaApplicationAlexaSkillConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSipMediaApplicationAlexaSkillConfigurationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetSipMediaApplicationAlexaSkillConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetSipMediaApplicationAlexaSkillConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSipMediaApplicationAlexaSkillConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSipMediaApplicationAlexaSkillConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetSipMediaApplicationAlexaSkillConfigurationResolveEndpointMiddleware{
