...
func (c *Client) ListPhoneNumberOrders(ctx context.Context, params *ListPhoneNumberOrdersInput, optFns ...func(*Options)) (*ListPhoneNumberOrdersOutput, error) {
	if params == nil { params = &ListPhoneNumberOrdersInput{} }
...
func (c *Client) addOperationListPhoneNumberOrdersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPhoneNumberOrdersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPhoneNumberOrdersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPhoneNumberOrdersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPhoneNumberOrdersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPhoneNumberOrdersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPhoneNumberOrdersResolveEndpointMiddleware{
