...
func (c *Client) ListVoiceProfileDomains(ctx context.Context, params *ListVoiceProfileDomainsInput, optFns ...func(*Options)) (*ListVoiceProfileDomainsOutput, error) {
	if params == nil { params = &ListVoiceProfileDomainsInput{} }
...
func (c *Client) addOperationListVoiceProfileDomainsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListVoiceProfileDomainsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListVoiceProfileDomainsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListVoiceProfileDomainsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListVoiceProfileDomainsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListVoiceProfileDomainsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListVoiceProfileDomainsResolveEndpointMiddleware{
