...
func (c *Client) addOperationListVoiceProfileDomainsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListVoiceProfileDomains", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
