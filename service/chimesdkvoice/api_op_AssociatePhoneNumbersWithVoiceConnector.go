...
func (c *Client) AssociatePhoneNumbersWithVoiceConnector(ctx context.Context, params *AssociatePhoneNumbersWithVoiceConnectorInput, optFns ...func(*Options)) (*AssociatePhoneNumbersWithVoiceConnectorOutput, error) {
	if params == nil { params = &AssociatePhoneNumbersWithVoiceConnectorInput{} }
...
func (c *Client) addOperationAssociatePhoneNumbersWithVoiceConnectorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociatePhoneNumbersWithVoiceConnectorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociatePhoneNumbersWithVoiceConnectorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociatePhoneNumbersWithVoiceConnectorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociatePhoneNumbersWithVoiceConnectorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociatePhoneNumbersWithVoiceConnectorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociatePhoneNumbersWithVoiceConnectorResolveEndpointMiddleware{
