...
func (c *Client) addOperationAssociatePhoneNumbersWithVoiceConnectorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociatePhoneNumbersWithVoiceConnector", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
