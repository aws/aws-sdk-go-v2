...
func (c *Client) addOperationGetVoiceConnectorTerminationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetVoiceConnectorTermination", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
