...
func (c *Client) addOperationListSipMediaApplicationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSipMediaApplications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
