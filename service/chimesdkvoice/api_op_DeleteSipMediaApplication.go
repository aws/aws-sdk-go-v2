...
func (c *Client) addOperationDeleteSipMediaApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteSipMediaApplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
