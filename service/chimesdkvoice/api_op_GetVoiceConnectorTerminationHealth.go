...
func (c *Client) addOperationGetVoiceConnectorTerminationHealthMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetVoiceConnectorTerminationHealth", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
