...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/chimesdkvoice/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "Chime SDK Voice", cfg.ConfigSources)
	if found && err == nil {
