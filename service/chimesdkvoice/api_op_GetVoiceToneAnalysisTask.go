...
func (*GetVoiceToneAnalysisTaskInput) operationName() string {
	return "GetVoiceToneAnalysisTask"
}
...
func (c *Client) addOperationGetVoiceToneAnalysisTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetVoiceToneAnalysisTaskResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetVoiceToneAnalysisTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetVoiceToneAnalysisTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetVoiceToneAnalysisTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetVoiceToneAnalysisTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetVoiceToneAnalysisTaskResolveEndpointMiddleware{
