...
func (v *ListVoiceConnectorsOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListVoiceConnectorsResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ListVoiceConnectorsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.NextToken != nil {
		s.WriteString(schemas.ListVoiceConnectorsResponse_NextToken, *v.NextToken)
	}
	serializeVoiceConnectorList(s, schemas.ListVoiceConnectorsResponse_VoiceConnectors, v.VoiceConnectors)
}
