...
func (c *Client) addOperationAssociatePhoneNumbersWithVoiceConnectorGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociatePhoneNumbersWithVoiceConnectorGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
