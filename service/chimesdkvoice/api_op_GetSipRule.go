...
func (c *Client) GetSipRule(ctx context.Context, params *GetSipRuleInput, optFns ...func(*Options)) (*GetSipRuleOutput, error) {
	if params == nil { params = &GetSipRuleInput{} }
...
func (c *Client) addOperationGetSipRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSipRuleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSipRuleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSipRuleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSipRuleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSipRuleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSipRuleResolveEndpointMiddleware{
