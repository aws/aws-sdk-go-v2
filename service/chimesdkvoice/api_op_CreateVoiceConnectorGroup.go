...
func (c *Client) addOperationCreateVoiceConnectorGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateVoiceConnectorGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
