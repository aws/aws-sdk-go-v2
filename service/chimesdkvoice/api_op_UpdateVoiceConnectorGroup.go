...
func (c *Client) addOperationUpdateVoiceConnectorGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateVoiceConnectorGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
