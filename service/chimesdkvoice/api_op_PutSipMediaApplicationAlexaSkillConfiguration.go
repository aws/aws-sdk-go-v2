...
func (c *Client) PutSipMediaApplicationAlexaSkillConfiguration(ctx context.Context, params *PutSipMediaApplicationAlexaSkillConfigurationInput, optFns ...func(*Options)) (*PutSipMediaApplicationAlexaSkillConfigurationOutput, error) {
	if params == nil { params = &PutSipMediaApplicationAlexaSkillConfigurationInput{} }
...
func (c *Client) addOperationPutSipMediaApplicationAlexaSkillConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutSipMediaApplicationAlexaSkillConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutSipMediaApplicationAlexaSkillConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutSipMediaApplicationAlexaSkillConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutSipMediaApplicationAlexaSkillConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutSipMediaApplicationAlexaSkillConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutSipMediaApplicationAlexaSkillConfigurationResolveEndpointMiddleware{
