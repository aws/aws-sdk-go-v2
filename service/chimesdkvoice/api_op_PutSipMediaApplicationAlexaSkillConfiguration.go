...
func (c *Client) addOperationPutSipMediaApplicationAlexaSkillConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutSipMediaApplicationAlexaSkillConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
