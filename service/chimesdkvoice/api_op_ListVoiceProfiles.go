...
func (*ListVoiceProfilesInput) operationName() string {
...
func (c *Client) addOperationListVoiceProfilesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListVoiceProfilesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListVoiceProfilesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListVoiceProfilesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListVoiceProfilesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListVoiceProfilesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListVoiceProfilesResolveEndpointMiddleware{
