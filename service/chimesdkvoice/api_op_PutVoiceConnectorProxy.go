...
func (c *Client) PutVoiceConnectorProxy(ctx context.Context, params *PutVoiceConnectorProxyInput, optFns ...func(*Options)) (*PutVoiceConnectorProxyOutput, error) {
	if params == nil { params = &PutVoiceConnectorProxyInput{} }
...
func (c *Client) addOperationPutVoiceConnectorProxyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutVoiceConnectorProxyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutVoiceConnectorProxyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutVoiceConnectorProxyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutVoiceConnectorProxyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutVoiceConnectorProxyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutVoiceConnectorProxyResolveEndpointMiddleware{
