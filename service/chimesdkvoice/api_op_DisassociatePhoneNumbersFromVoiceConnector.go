...
func (c *Client) addOperationDisassociatePhoneNumbersFromVoiceConnectorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociatePhoneNumbersFromVoiceConnector", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
