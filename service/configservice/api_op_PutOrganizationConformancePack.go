...
func (c *Client) addOperationPutOrganizationConformancePackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutOrganizationConformancePack", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
