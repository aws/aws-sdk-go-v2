...
func addOperationPutOrganizationConformancePackStackSlots(stack *middleware.Stack) error {
...
func addOperationPutOrganizationConformancePackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutOrganizationConformancePackStackSlots(stack); err != nil {
		return err
	}
