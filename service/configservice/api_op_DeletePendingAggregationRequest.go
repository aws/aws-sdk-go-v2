...
func (c *Client) addOperationDeletePendingAggregationRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeletePendingAggregationRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
