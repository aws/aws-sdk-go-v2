...
func addOperationDeletePendingAggregationRequestStackSlots(stack *middleware.Stack) error {
...
func addOperationDeletePendingAggregationRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeletePendingAggregationRequestStackSlots(stack); err != nil {
		return err
	}
