...
func (c *Client) PutDeliveryChannel(ctx context.Context, params *PutDeliveryChannelInput, optFns ...func(*Options)) (*PutDeliveryChannelOutput, error) {
	if params == nil { params = &PutDeliveryChannelInput{} }
...
func (c *Client) addOperationPutDeliveryChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutDeliveryChannelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutDeliveryChannelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutDeliveryChannelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutDeliveryChannelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutDeliveryChannelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutDeliveryChannelResolveEndpointMiddleware{
