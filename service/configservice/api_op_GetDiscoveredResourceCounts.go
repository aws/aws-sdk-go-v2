...
// buckets.
// - You make a call to the GetDiscoveredResourceCounts action and specify
// that you want all resource types.
// - Config returns the following:
// - The resource
// types (EC2 instances, IAM users, and S3 buckets).
// - The number of each resource
// type (25, 20, and 15).
// - The total number of all resources (60).
//
// The response
// is paginated. By default, Config lists 100 ResourceCount objects on each page.
...
// - You just
// enabled resource recording.
//
// It might take a few minutes for Config to record
