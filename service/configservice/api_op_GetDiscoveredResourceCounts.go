...
// By default, Config lists 100 ResourceCount objects on each page. You can
...
// GetDiscoveredResourceCountsaction, you might not immediately receive resource
...
type GetDiscoveredResourceCountsInput struct {
	...
	// value for resourceTypes is not specified, Config returns all resource types
	// that Config is recording in the region for your account. If the configuration
