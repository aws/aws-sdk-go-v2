...
func addOperationGetDiscoveredResourceCountsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetDiscoveredResourceCountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetDiscoveredResourceCountsStackSlots(stack); err != nil {
		return err
	}
