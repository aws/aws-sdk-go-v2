...
func addOperationPutAggregationAuthorizationStackSlots(stack *middleware.Stack) error {
...
func addOperationPutAggregationAuthorizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutAggregationAuthorizationStackSlots(stack); err != nil {
		return err
	}
