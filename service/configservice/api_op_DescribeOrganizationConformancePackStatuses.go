...
func addOperationDescribeOrganizationConformancePackStatusesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeOrganizationConformancePackStatusesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeOrganizationConformancePackStatusesStackSlots(stack); err != nil {
		return err
	}
