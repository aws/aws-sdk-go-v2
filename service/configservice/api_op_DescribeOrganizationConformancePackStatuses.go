...
func (c *Client) DescribeOrganizationConformancePackStatusesRequest(input *DescribeOrganizationConformancePackStatusesInput) DescribeOrganizationConformancePackStatusesRequest {
	...
	req := c.newRequest(op, input, &DescribeOrganizationConformancePackStatusesOutput{})
...
func (r DescribeOrganizationConformancePackStatusesRequest) Send(ctx context.Context) (*DescribeOrganizationConformancePackStatusesResponse, error) {
	...
	resp := &DescribeOrganizationConformancePackStatusesResponse{
		DescribeOrganizationConformancePackStatusesOutput: r.Request.Data.(*DescribeOrganizationConformancePackStatusesOutput),
