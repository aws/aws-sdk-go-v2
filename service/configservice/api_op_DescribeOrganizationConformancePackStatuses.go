...
func (c *Client) addOperationDescribeOrganizationConformancePackStatusesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeOrganizationConformancePackStatuses", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
