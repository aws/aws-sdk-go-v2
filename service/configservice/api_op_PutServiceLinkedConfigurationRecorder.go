...
func (c *Client) addOperationPutServiceLinkedConfigurationRecorderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutServiceLinkedConfigurationRecorder", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
