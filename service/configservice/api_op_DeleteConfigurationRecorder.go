...
func (c *Client) addOperationDeleteConfigurationRecorderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteConfigurationRecorder", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
