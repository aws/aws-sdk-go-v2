...
func addOperationDeleteConfigurationRecorderStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteConfigurationRecorderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteConfigurationRecorderStackSlots(stack); err != nil {
		return err
	}
