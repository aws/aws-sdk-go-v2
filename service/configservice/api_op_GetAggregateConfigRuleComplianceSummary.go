...
func (c *Client) addOperationGetAggregateConfigRuleComplianceSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAggregateConfigRuleComplianceSummary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
