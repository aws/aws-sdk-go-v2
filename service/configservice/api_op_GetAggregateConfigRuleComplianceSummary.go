...
func addOperationGetAggregateConfigRuleComplianceSummaryStackSlots(stack *middleware.Stack) error {
...
func addOperationGetAggregateConfigRuleComplianceSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetAggregateConfigRuleComplianceSummaryStackSlots(stack); err != nil {
		return err
	}
