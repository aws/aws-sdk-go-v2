...
func (c *Client) GetAggregateConfigRuleComplianceSummary(ctx context.Context, params *GetAggregateConfigRuleComplianceSummaryInput, optFns ...func(*Options)) (*GetAggregateConfigRuleComplianceSummaryOutput, error) {
	if params == nil { params = &GetAggregateConfigRuleComplianceSummaryInput{} }
...
func (c *Client) addOperationGetAggregateConfigRuleComplianceSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAggregateConfigRuleComplianceSummaryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAggregateConfigRuleComplianceSummaryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAggregateConfigRuleComplianceSummaryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAggregateConfigRuleComplianceSummaryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAggregateConfigRuleComplianceSummaryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAggregateConfigRuleComplianceSummaryResolveEndpointMiddleware{
