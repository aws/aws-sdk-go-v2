...
func (c *Client) addOperationDescribeConformancePackStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConformancePackStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
