...
func (c *Client) addOperationDescribeConfigurationAggregatorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConfigurationAggregators", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
