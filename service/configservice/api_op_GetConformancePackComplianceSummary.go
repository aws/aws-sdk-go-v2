...
func addOperationGetConformancePackComplianceSummaryStackSlots(stack *middleware.Stack) error {
...
func addOperationGetConformancePackComplianceSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetConformancePackComplianceSummaryStackSlots(stack); err != nil {
		return err
	}
