...
func addOperationDescribeDeliveryChannelStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeDeliveryChannelStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeDeliveryChannelStatusStackSlots(stack); err != nil {
		return err
	}
