...
func (*DescribeOrganizationConfigRuleStatusesInput) operationName() string {
...
func (c *Client) addOperationDescribeOrganizationConfigRuleStatusesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeOrganizationConfigRuleStatusesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeOrganizationConfigRuleStatusesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeOrganizationConfigRuleStatusesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeOrganizationConfigRuleStatusesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeOrganizationConfigRuleStatusesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeOrganizationConfigRuleStatusesResolveEndpointMiddleware{
