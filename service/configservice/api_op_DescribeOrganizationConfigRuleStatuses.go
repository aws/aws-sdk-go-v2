...
func addOperationDescribeOrganizationConfigRuleStatusesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeOrganizationConfigRuleStatusesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeOrganizationConfigRuleStatusesStackSlots(stack); err != nil {
		return err
	}
