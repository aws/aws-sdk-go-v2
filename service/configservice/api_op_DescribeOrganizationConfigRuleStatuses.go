...
func (c *Client) addOperationDescribeOrganizationConfigRuleStatusesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeOrganizationConfigRuleStatuses", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
