...
func (c *Client) addOperationDeleteRemediationExceptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteRemediationExceptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
