...
func (c *Client) addOperationGetComplianceDetailsByResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetComplianceDetailsByResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
