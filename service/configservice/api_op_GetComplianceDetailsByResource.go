...
func addOperationGetComplianceDetailsByResourceStackSlots(stack *middleware.Stack) error {
...
func addOperationGetComplianceDetailsByResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetComplianceDetailsByResourceStackSlots(stack); err != nil {
		return err
	}
