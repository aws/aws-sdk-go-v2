...
func (c *Client) addOperationGetComplianceSummaryByResourceTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetComplianceSummaryByResourceType", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
