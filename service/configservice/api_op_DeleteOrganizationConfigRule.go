...
func (c *Client) addOperationDeleteOrganizationConfigRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteOrganizationConfigRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
