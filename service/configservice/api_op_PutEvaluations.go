...
func (c *Client) PutEvaluations(ctx context.Context, params *PutEvaluationsInput, optFns ...func(*Options)) (*PutEvaluationsOutput, error) {
	if params == nil { params = &PutEvaluationsInput{} }
...
func (c *Client) addOperationPutEvaluationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutEvaluationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutEvaluationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutEvaluationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutEvaluationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutEvaluationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutEvaluationsResolveEndpointMiddleware{
