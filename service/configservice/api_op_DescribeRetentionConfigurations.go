...
func addOperationDescribeRetentionConfigurationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeRetentionConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeRetentionConfigurationsStackSlots(stack); err != nil {
		return err
	}
