...
// returns the ConfigurationItems for the specified retention period. The
// response is paginated. By default, Config returns a limit of 10 configuration
...
// request again and specify the string for the nextToken parameter. Each call to
// the API is limited to span a duration of seven days. It is likely that the
// number of records returned is smaller than the specified limit. In such cases,
// you can make another call, using the nextToken .
