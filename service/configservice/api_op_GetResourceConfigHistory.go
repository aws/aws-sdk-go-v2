...
func (c *Client) addOperationGetResourceConfigHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetResourceConfigHistory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
