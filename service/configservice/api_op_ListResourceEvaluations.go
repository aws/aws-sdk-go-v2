...
func (c *Client) addOperationListResourceEvaluationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListResourceEvaluations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
