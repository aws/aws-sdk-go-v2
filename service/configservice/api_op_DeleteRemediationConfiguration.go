...
func addOperationDeleteRemediationConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteRemediationConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteRemediationConfigurationStackSlots(stack); err != nil {
		return err
	}
