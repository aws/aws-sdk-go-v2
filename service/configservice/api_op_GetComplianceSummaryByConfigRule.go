...
func (*GetComplianceSummaryByConfigRuleInput) operationName() string {
	return "GetComplianceSummaryByConfigRule"
}
...
func (c *Client) addOperationGetComplianceSummaryByConfigRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetComplianceSummaryByConfigRuleResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetComplianceSummaryByConfigRuleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetComplianceSummaryByConfigRuleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetComplianceSummaryByConfigRuleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetComplianceSummaryByConfigRuleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetComplianceSummaryByConfigRuleResolveEndpointMiddleware{
