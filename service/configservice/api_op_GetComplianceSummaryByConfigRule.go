...
func (c *Client) addOperationGetComplianceSummaryByConfigRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetComplianceSummaryByConfigRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
