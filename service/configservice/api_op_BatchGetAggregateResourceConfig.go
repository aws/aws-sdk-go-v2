...
func (c *Client) addOperationBatchGetAggregateResourceConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetAggregateResourceConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
