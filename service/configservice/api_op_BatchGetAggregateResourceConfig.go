...
func addOperationBatchGetAggregateResourceConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationBatchGetAggregateResourceConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationBatchGetAggregateResourceConfigStackSlots(stack); err != nil {
		return err
	}
