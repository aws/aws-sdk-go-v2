...
func (c *Client) addOperationGetAggregateDiscoveredResourceCountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAggregateDiscoveredResourceCounts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
