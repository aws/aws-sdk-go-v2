...
func (c *Client) GetOrganizationCustomRulePolicy(ctx context.Context, params *GetOrganizationCustomRulePolicyInput, optFns ...func(*Options)) (*GetOrganizationCustomRulePolicyOutput, error) {
	if params == nil { params = &GetOrganizationCustomRulePolicyInput{} }
...
func (c *Client) addOperationGetOrganizationCustomRulePolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetOrganizationCustomRulePolicyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetOrganizationCustomRulePolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetOrganizationCustomRulePolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetOrganizationCustomRulePolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetOrganizationCustomRulePolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetOrganizationCustomRulePolicyResolveEndpointMiddleware{
