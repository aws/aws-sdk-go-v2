...
func (c *Client) addOperationGetOrganizationCustomRulePolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetOrganizationCustomRulePolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
