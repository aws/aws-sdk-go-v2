...
func (c *Client) addOperationDescribeComplianceByResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeComplianceByResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
