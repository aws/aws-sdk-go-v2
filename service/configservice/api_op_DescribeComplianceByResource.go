...
func addOperationDescribeComplianceByResourceStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeComplianceByResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeComplianceByResourceStackSlots(stack); err != nil {
		return err
	}
