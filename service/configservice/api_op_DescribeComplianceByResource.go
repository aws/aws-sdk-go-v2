...
func (*DescribeComplianceByResourceInput) operationName() string {
...
func (c *Client) addOperationDescribeComplianceByResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeComplianceByResourceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeComplianceByResourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeComplianceByResourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeComplianceByResourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeComplianceByResourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeComplianceByResourceResolveEndpointMiddleware{
