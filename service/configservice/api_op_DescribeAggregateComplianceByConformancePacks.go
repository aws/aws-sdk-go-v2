...
func (c *Client) addOperationDescribeAggregateComplianceByConformancePacksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAggregateComplianceByConformancePacks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
