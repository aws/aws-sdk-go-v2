...
func (c *Client) addOperationDescribeAggregateComplianceByConformancePacksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeAggregateComplianceByConformancePacksResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeAggregateComplianceByConformancePacksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeAggregateComplianceByConformancePacksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeAggregateComplianceByConformancePacksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeAggregateComplianceByConformancePacksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeAggregateComplianceByConformancePacksResolveEndpointMiddleware{
