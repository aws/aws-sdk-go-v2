...
func (c *Client) addOperationListConfigurationRecordersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListConfigurationRecorders", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
