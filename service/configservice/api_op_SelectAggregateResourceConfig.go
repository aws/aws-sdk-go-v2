...
func (c *Client) addOperationSelectAggregateResourceConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SelectAggregateResourceConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
