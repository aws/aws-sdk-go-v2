...
func addOperationSelectAggregateResourceConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationSelectAggregateResourceConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationSelectAggregateResourceConfigStackSlots(stack); err != nil {
		return err
	}
