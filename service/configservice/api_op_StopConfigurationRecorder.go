...
func (c *Client) StopConfigurationRecorder(ctx context.Context, params *StopConfigurationRecorderInput, optFns ...func(*Options)) (*StopConfigurationRecorderOutput, error) {
	if params == nil { params = &StopConfigurationRecorderInput{} }
...
func (c *Client) addOperationStopConfigurationRecorderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopConfigurationRecorderResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopConfigurationRecorderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopConfigurationRecorderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopConfigurationRecorderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopConfigurationRecorderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopConfigurationRecorderResolveEndpointMiddleware{
