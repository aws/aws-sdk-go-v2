...
func (c *Client) addOperationStopConfigurationRecorderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopConfigurationRecorder", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
