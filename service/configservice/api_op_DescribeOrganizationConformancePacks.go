...
func (*DescribeOrganizationConformancePacksInput) operationName() string {
...
func (c *Client) addOperationDescribeOrganizationConformancePacksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeOrganizationConformancePacksResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeOrganizationConformancePacksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeOrganizationConformancePacksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeOrganizationConformancePacksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeOrganizationConformancePacksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeOrganizationConformancePacksResolveEndpointMiddleware{
