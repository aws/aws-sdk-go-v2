...
func (c *Client) addOperationDescribePendingAggregationRequestsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribePendingAggregationRequests", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
