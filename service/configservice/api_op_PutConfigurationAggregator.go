...
func (c *Client) addOperationPutConfigurationAggregatorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutConfigurationAggregator", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
