...
func (c *Client) addOperationPutRemediationConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutRemediationConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
