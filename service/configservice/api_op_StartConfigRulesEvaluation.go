...
func (c *Client) addOperationStartConfigRulesEvaluationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartConfigRulesEvaluation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
