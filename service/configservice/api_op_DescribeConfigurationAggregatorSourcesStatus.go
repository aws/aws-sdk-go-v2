...
func (c *Client) addOperationDescribeConfigurationAggregatorSourcesStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConfigurationAggregatorSourcesStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
