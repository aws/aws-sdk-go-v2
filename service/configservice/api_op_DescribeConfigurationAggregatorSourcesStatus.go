...
func addOperationDescribeConfigurationAggregatorSourcesStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeConfigurationAggregatorSourcesStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeConfigurationAggregatorSourcesStatusStackSlots(stack); err != nil {
		return err
	}
