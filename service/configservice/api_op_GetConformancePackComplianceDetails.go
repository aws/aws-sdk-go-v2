...
func (c *Client) addOperationGetConformancePackComplianceDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetConformancePackComplianceDetailsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetConformancePackComplianceDetailsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetConformancePackComplianceDetailsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetConformancePackComplianceDetailsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetConformancePackComplianceDetailsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetConformancePackComplianceDetailsResolveEndpointMiddleware{
