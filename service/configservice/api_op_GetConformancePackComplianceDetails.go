...
func (c *Client) addOperationGetConformancePackComplianceDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetConformancePackComplianceDetails", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
