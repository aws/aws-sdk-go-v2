...
func (c *Client) StartConfigurationRecorder(ctx context.Context, params *StartConfigurationRecorderInput, optFns ...func(*Options)) (*StartConfigurationRecorderOutput, error) {
	if params == nil { params = &StartConfigurationRecorderInput{} }
...
func (c *Client) addOperationStartConfigurationRecorderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartConfigurationRecorderResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartConfigurationRecorderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartConfigurationRecorderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartConfigurationRecorderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartConfigurationRecorderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartConfigurationRecorderResolveEndpointMiddleware{
