...
func (c *Client) addOperationStartConfigurationRecorderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartConfigurationRecorder", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
