...
func (c *Client) addOperationPutRemediationExceptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutRemediationExceptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
