...
func (c *Client) DescribeAggregationAuthorizations(ctx context.Context, params *DescribeAggregationAuthorizationsInput, optFns ...func(*Options)) (*DescribeAggregationAuthorizationsOutput, error) {
	stack := middleware.NewStack("DescribeAggregationAuthorizations", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpDescribeAggregationAuthorizationsMiddlewares(stack)
...
func addawsAwsjson11_serdeOpDescribeAggregationAuthorizationsMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpDescribeAggregationAuthorizations{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpDescribeAggregationAuthorizations{}, middleware.After)
}
