...
func addOperationDescribeAggregationAuthorizationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeAggregationAuthorizationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeAggregationAuthorizationsStackSlots(stack); err != nil {
		return err
	}
