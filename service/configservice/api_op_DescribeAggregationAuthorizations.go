...
func (c *Client) addOperationDescribeAggregationAuthorizationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAggregationAuthorizations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
