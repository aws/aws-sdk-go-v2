...
func (*GetCustomRulePolicyInput) operationName() string {
	return "GetCustomRulePolicy"
}
...
func (c *Client) addOperationGetCustomRulePolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCustomRulePolicyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetCustomRulePolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetCustomRulePolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCustomRulePolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCustomRulePolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetCustomRulePolicyResolveEndpointMiddleware{
