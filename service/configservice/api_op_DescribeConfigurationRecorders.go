...
func addOperationDescribeConfigurationRecordersStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeConfigurationRecordersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeConfigurationRecordersStackSlots(stack); err != nil {
		return err
	}
