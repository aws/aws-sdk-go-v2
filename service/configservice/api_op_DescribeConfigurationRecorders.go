...
func (c *Client) addOperationDescribeConfigurationRecordersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConfigurationRecorders", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
