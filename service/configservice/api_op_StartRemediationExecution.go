...
func (c *Client) addOperationStartRemediationExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartRemediationExecution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
