...
func (c *Client) addOperationDescribeDeliveryChannelsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDeliveryChannels", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
