...
func (c *Client) addOperationStartResourceEvaluationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartResourceEvaluation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
