...
func addOperationDescribeRemediationExecutionStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeRemediationExecutionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeRemediationExecutionStatusStackSlots(stack); err != nil {
		return err
	}
