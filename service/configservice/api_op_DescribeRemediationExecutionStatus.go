...
func (c *Client) addOperationDescribeRemediationExecutionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRemediationExecutionStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
