...
func (c *Client) addOperationDescribeConformancePackComplianceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConformancePackCompliance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
