...
func addOperationDescribeConformancePackComplianceStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeConformancePackComplianceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeConformancePackComplianceStackSlots(stack); err != nil {
		return err
	}
