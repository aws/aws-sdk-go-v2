...
func (c *Client) addOperationGetOrganizationConfigRuleDetailedStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetOrganizationConfigRuleDetailedStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
