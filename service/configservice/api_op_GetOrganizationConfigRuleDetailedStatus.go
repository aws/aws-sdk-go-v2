...
func (*GetOrganizationConfigRuleDetailedStatusInput) operationName() string {
	return "GetOrganizationConfigRuleDetailedStatus"
}
...
func (c *Client) addOperationGetOrganizationConfigRuleDetailedStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetOrganizationConfigRuleDetailedStatusResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetOrganizationConfigRuleDetailedStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetOrganizationConfigRuleDetailedStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetOrganizationConfigRuleDetailedStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetOrganizationConfigRuleDetailedStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetOrganizationConfigRuleDetailedStatusResolveEndpointMiddleware{
