...
func addOperationGetOrganizationConfigRuleDetailedStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationGetOrganizationConfigRuleDetailedStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetOrganizationConfigRuleDetailedStatusStackSlots(stack); err != nil {
		return err
	}
