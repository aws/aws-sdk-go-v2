...
func (c *Client) ListStoredQueries(ctx context.Context, params *ListStoredQueriesInput, optFns ...func(*Options)) (*ListStoredQueriesOutput, error) {
	if params == nil { params = &ListStoredQueriesInput{} }
...
func (c *Client) addOperationListStoredQueriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListStoredQueriesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListStoredQueriesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListStoredQueriesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListStoredQueriesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListStoredQueriesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListStoredQueriesResolveEndpointMiddleware{
