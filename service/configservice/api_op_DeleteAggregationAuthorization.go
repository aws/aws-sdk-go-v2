...
func (c *Client) addOperationDeleteAggregationAuthorizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteAggregationAuthorization", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
