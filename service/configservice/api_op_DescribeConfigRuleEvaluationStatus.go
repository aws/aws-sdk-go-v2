...
func (c *Client) addOperationDescribeConfigRuleEvaluationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConfigRuleEvaluationStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
