...
func (c *Client) DescribeAggregateComplianceByConfigRules(ctx context.Context, params *DescribeAggregateComplianceByConfigRulesInput, optFns ...func(*Options)) (*DescribeAggregateComplianceByConfigRulesOutput, error) {
	if params == nil { params = &DescribeAggregateComplianceByConfigRulesInput{} }
...
func (c *Client) addOperationDescribeAggregateComplianceByConfigRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeAggregateComplianceByConfigRulesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeAggregateComplianceByConfigRulesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeAggregateComplianceByConfigRulesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeAggregateComplianceByConfigRulesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeAggregateComplianceByConfigRulesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeAggregateComplianceByConfigRulesResolveEndpointMiddleware{
