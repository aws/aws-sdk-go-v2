...
func (c *Client) addOperationDescribeAggregateComplianceByConfigRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAggregateComplianceByConfigRules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
