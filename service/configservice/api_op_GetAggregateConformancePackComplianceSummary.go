...
func (c *Client) addOperationGetAggregateConformancePackComplianceSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAggregateConformancePackComplianceSummary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
