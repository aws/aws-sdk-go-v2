...
func (*GetComplianceDetailsByConfigRuleInput) operationName() string {
	return "GetComplianceDetailsByConfigRule"
}
...
func (c *Client) addOperationGetComplianceDetailsByConfigRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetComplianceDetailsByConfigRuleResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetComplianceDetailsByConfigRuleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetComplianceDetailsByConfigRuleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetComplianceDetailsByConfigRuleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetComplianceDetailsByConfigRuleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetComplianceDetailsByConfigRuleResolveEndpointMiddleware{
