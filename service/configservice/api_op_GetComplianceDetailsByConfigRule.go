...
func addOperationGetComplianceDetailsByConfigRuleStackSlots(stack *middleware.Stack) error {
...
func addOperationGetComplianceDetailsByConfigRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetComplianceDetailsByConfigRuleStackSlots(stack); err != nil {
		return err
	}
