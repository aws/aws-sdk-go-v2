...
// information on how many Config rules you can have per account, see  Service
// Limits
// (https://docs.aws.amazon.com/config/latest/developerguide/configlimits.html) in
// the Config Developer Guide. For more information about developing and using
// Config rules, see Evaluating Amazon Web Services resource Configurations with
// Config
