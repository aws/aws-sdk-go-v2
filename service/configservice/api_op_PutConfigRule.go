...
// identifier for the SourceIdentifier key. Config Custom Rules are rules that
// you create from scratch. There are two ways to create Config custom rules: with
...
// the function. You specify the ARN in the SourceIdentifier key. This key is
// part of the Source  object, which is part of the ConfigRule object. For any
// new Config rule that you add, specify the ConfigRuleName  in the ConfigRule
// object. Do not specify the ConfigRuleArn  or the ConfigRuleId. These values
// are generated by Config for new rules. If you are updating a rule that you added
