...
func (c *Client) addOperationDeleteEvaluationResultsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteEvaluationResults", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
