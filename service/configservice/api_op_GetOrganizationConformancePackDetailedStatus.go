...
func (*GetOrganizationConformancePackDetailedStatusInput) operationName() string {
	return "GetOrganizationConformancePackDetailedStatus"
}
...
func (c *Client) addOperationGetOrganizationConformancePackDetailedStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetOrganizationConformancePackDetailedStatusResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetOrganizationConformancePackDetailedStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetOrganizationConformancePackDetailedStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetOrganizationConformancePackDetailedStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetOrganizationConformancePackDetailedStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetOrganizationConformancePackDetailedStatusResolveEndpointMiddleware{
