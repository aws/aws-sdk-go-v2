...
func addOperationGetOrganizationConformancePackDetailedStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationGetOrganizationConformancePackDetailedStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetOrganizationConformancePackDetailedStatusStackSlots(stack); err != nil {
		return err
	}
