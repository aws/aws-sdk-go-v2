...
func (c *Client) ListConformancePackComplianceScores(ctx context.Context, params *ListConformancePackComplianceScoresInput, optFns ...func(*Options)) (*ListConformancePackComplianceScoresOutput, error) {
	if params == nil { params = &ListConformancePackComplianceScoresInput{} }
...
func (c *Client) addOperationListConformancePackComplianceScoresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListConformancePackComplianceScoresResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListConformancePackComplianceScoresResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListConformancePackComplianceScoresResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListConformancePackComplianceScoresResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListConformancePackComplianceScoresResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListConformancePackComplianceScoresResolveEndpointMiddleware{
