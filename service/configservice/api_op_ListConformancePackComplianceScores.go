...
func (c *Client) addOperationListConformancePackComplianceScoresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListConformancePackComplianceScores", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
