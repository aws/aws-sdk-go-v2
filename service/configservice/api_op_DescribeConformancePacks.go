...
func (c *Client) addOperationDescribeConformancePacksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConformancePacks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
