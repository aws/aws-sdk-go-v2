...
func (c *Client) addOperationListManagedNotificationChildEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListManagedNotificationChildEvents", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
