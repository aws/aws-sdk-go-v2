...
func (c *Client) addOperationAssociateManagedNotificationAdditionalChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateManagedNotificationAdditionalChannel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
