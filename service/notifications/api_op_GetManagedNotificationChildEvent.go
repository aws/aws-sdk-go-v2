...
func (c *Client) addOperationGetManagedNotificationChildEventMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetManagedNotificationChildEvent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
