...
func (c *Client) addOperationDisassociateManagedNotificationAccountContactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateManagedNotificationAccountContact", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
