...
func (c *Client) addOperationGetManagedNotificationEventMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetManagedNotificationEvent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
