...
func (c *Client) addOperationListNotificationConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListNotificationConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
