...
func (c *Client) addOperationRegisterNotificationHubMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterNotificationHub", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
