...
func (c *Client) addOperationListOrganizationalUnitsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOrganizationalUnits", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
