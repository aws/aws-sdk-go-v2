...
func (c *Client) addOperationListManagedNotificationEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListManagedNotificationEvents", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
