...
func (c *Client) addOperationListManagedNotificationChannelAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListManagedNotificationChannelAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
