...
func (c *Client) StartCutover(ctx context.Context, params *StartCutoverInput, optFns ...func(*Options)) (*StartCutoverOutput, error) {
	if params == nil { params = &StartCutoverInput{} }
...
func (c *Client) addOperationStartCutoverMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartCutoverResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartCutoverResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartCutoverResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartCutoverResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartCutoverResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartCutoverResolveEndpointMiddleware{
