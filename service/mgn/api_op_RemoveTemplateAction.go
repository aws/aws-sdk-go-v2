...
func (*RemoveTemplateActionInput) operationName() string {
...
func (c *Client) addOperationRemoveTemplateActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRemoveTemplateActionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRemoveTemplateActionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRemoveTemplateActionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRemoveTemplateActionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRemoveTemplateActionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRemoveTemplateActionResolveEndpointMiddleware{
