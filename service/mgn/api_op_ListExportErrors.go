...
func (c *Client) ListExportErrors(ctx context.Context, params *ListExportErrorsInput, optFns ...func(*Options)) (*ListExportErrorsOutput, error) {
	if params == nil { params = &ListExportErrorsInput{} }
...
func (c *Client) addOperationListExportErrorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListExportErrorsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListExportErrorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListExportErrorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListExportErrorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListExportErrorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListExportErrorsResolveEndpointMiddleware{
