...
func (c *Client) PauseReplication(ctx context.Context, params *PauseReplicationInput, optFns ...func(*Options)) (*PauseReplicationOutput, error) {
	if params == nil { params = &PauseReplicationInput{} }
...
func (c *Client) addOperationPauseReplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPauseReplicationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPauseReplicationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPauseReplicationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPauseReplicationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPauseReplicationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPauseReplicationResolveEndpointMiddleware{
