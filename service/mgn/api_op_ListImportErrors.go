...
func (c *Client) ListImportErrors(ctx context.Context, params *ListImportErrorsInput, optFns ...func(*Options)) (*ListImportErrorsOutput, error) {
	if params == nil { params = &ListImportErrorsInput{} }
...
func (c *Client) addOperationListImportErrorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListImportErrorsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListImportErrorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListImportErrorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListImportErrorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListImportErrorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListImportErrorsResolveEndpointMiddleware{
