...
func (c *Client) FinalizeCutover(ctx context.Context, params *FinalizeCutoverInput, optFns ...func(*Options)) (*FinalizeCutoverOutput, error) {
	if params == nil { params = &FinalizeCutoverInput{} }
...
func (c *Client) addOperationFinalizeCutoverMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addFinalizeCutoverResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opFinalizeCutoverResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opFinalizeCutoverResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opFinalizeCutoverResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addFinalizeCutoverResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opFinalizeCutoverResolveEndpointMiddleware{
