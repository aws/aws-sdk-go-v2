...
func (v *FinalizeCutoverInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.FinalizeCutoverRequest)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *FinalizeCutoverInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AccountID != nil {
		s.WriteString(schemas.FinalizeCutoverRequest_accountID, *v.AccountID)
	}
	if v.SourceServerID != nil {
		s.WriteString(schemas.FinalizeCutoverRequest_sourceServerID, *v.SourceServerID)
	}
}
func (v *FinalizeCutoverInput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.FinalizeCutoverRequest, func(s *smithy.Schema) error {
		switch s {
		case schemas.FinalizeCutoverRequest_accountID:
			v.AccountID = new(string)
			return d.ReadString(schemas.FinalizeCutoverRequest_accountID, v.AccountID)
		case schemas.FinalizeCutoverRequest_sourceServerID:
			v.SourceServerID = new(string)
			return d.ReadString(schemas.FinalizeCutoverRequest_sourceServerID, v.SourceServerID)
		}
		return nil
	})
}
...
func (v *FinalizeCutoverOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.SourceServer)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *FinalizeCutoverOutput) SerializeMembers(s smithy.ShapeSerializer) {
...
func (v *FinalizeCutoverOutput) Deserialize(d smithy.ShapeDeserializer) error {
...
func (c *Client) addOperationFinalizeCutoverMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.FinalizeCutover, schemas.FinalizeCutoverRequest, schemas.SourceServer)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.FinalizeCutover, schemas.FinalizeCutoverRequest, schemas.SourceServer), output: &FinalizeCutoverOutput{}}, middleware.After); err != nil {
		return err
	}
