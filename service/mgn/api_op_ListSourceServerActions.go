...
func (c *Client) addOperationListSourceServerActionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSourceServerActions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
