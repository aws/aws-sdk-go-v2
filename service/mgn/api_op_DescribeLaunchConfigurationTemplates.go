...
func (c *Client) DescribeLaunchConfigurationTemplates(ctx context.Context, params *DescribeLaunchConfigurationTemplatesInput, optFns ...func(*Options)) (*DescribeLaunchConfigurationTemplatesOutput, error) {
	if params == nil { params = &DescribeLaunchConfigurationTemplatesInput{} }
...
func (c *Client) addOperationDescribeLaunchConfigurationTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeLaunchConfigurationTemplatesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeLaunchConfigurationTemplatesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeLaunchConfigurationTemplatesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeLaunchConfigurationTemplatesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeLaunchConfigurationTemplatesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeLaunchConfigurationTemplatesResolveEndpointMiddleware{
