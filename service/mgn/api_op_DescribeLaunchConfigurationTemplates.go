...
func (c *Client) addOperationDescribeLaunchConfigurationTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeLaunchConfigurationTemplates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
