...
func (v *UpdateSourceServerInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.UpdateSourceServerRequest)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *UpdateSourceServerInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AccountID != nil {
		s.WriteString(schemas.UpdateSourceServerRequest_accountID, *v.AccountID)
	}
	if v.ConnectorAction != nil {
		s.WriteStruct(schemas.UpdateSourceServerRequest_connectorAction)
		v.ConnectorAction.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.FqdnForActionFramework != nil {
		s.WriteString(schemas.UpdateSourceServerRequest_fqdnForActionFramework, *v.FqdnForActionFramework)
	}
	if v.Platform != nil {
		s.WriteString(schemas.UpdateSourceServerRequest_platform, *v.Platform)
	}
	if v.SourceServerID != nil {
		s.WriteString(schemas.UpdateSourceServerRequest_sourceServerID, *v.SourceServerID)
	}
	if v.UserProvidedID != nil {
		s.WriteString(schemas.UpdateSourceServerRequest_userProvidedID, *v.UserProvidedID)
	}
}
...
func (v *UpdateSourceServerOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.SourceServer)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *UpdateSourceServerOutput) SerializeMembers(s smithy.ShapeSerializer) {
...
func (v *UpdateSourceServerOutput) Deserialize(d smithy.ShapeDeserializer) error {
...
func (c *Client) addOperationUpdateSourceServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.UpdateSourceServer, schemas.UpdateSourceServerRequest, schemas.SourceServer)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.UpdateSourceServer, schemas.UpdateSourceServerRequest, schemas.SourceServer), output: &UpdateSourceServerOutput{}}, middleware.After); err != nil {
		return err
	}
