...
func (*RemoveSourceServerActionInput) operationName() string {
...
func (c *Client) addOperationRemoveSourceServerActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRemoveSourceServerActionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRemoveSourceServerActionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRemoveSourceServerActionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRemoveSourceServerActionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRemoveSourceServerActionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRemoveSourceServerActionResolveEndpointMiddleware{
