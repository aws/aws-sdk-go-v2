...
func (c *Client) addOperationRemoveSourceServerActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RemoveSourceServerAction", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
