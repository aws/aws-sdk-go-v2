...
func (*DeleteReplicationConfigurationTemplateInput) operationName() string {
...
func (c *Client) addOperationDeleteReplicationConfigurationTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteReplicationConfigurationTemplateResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteReplicationConfigurationTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteReplicationConfigurationTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteReplicationConfigurationTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteReplicationConfigurationTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteReplicationConfigurationTemplateResolveEndpointMiddleware{
