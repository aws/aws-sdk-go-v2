...
func (c *Client) StartExport(ctx context.Context, params *StartExportInput, optFns ...func(*Options)) (*StartExportOutput, error) {
	if params == nil { params = &StartExportInput{} }
...
func (c *Client) addOperationStartExportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartExportResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartExportResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartExportResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartExportResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartExportResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartExportResolveEndpointMiddleware{
