...
func (v *ChangeServerLifeCycleStateInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ChangeServerLifeCycleStateRequest)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ChangeServerLifeCycleStateInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AccountID != nil {
		s.WriteString(schemas.ChangeServerLifeCycleStateRequest_accountID, *v.AccountID)
	}
	if v.LifeCycle != nil {
		s.WriteStruct(schemas.ChangeServerLifeCycleStateRequest_lifeCycle)
		v.LifeCycle.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.SourceServerID != nil {
		s.WriteString(schemas.ChangeServerLifeCycleStateRequest_sourceServerID, *v.SourceServerID)
	}
}
func (v *ChangeServerLifeCycleStateInput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ChangeServerLifeCycleStateRequest, func(s *smithy.Schema) error {
		switch s {
		case schemas.ChangeServerLifeCycleStateRequest_accountID:
			v.AccountID = new(string)
			return d.ReadString(schemas.ChangeServerLifeCycleStateRequest_accountID, v.AccountID)
		case schemas.ChangeServerLifeCycleStateRequest_lifeCycle:
			v.LifeCycle = &types.ChangeServerLifeCycleStateSourceServerLifecycle{}
			return v.LifeCycle.Deserialize(d)
		case schemas.ChangeServerLifeCycleStateRequest_sourceServerID:
			v.SourceServerID = new(string)
			return d.ReadString(schemas.ChangeServerLifeCycleStateRequest_sourceServerID, v.SourceServerID)
		}
		return nil
	})
}
...
func (v *ChangeServerLifeCycleStateOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.SourceServer)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ChangeServerLifeCycleStateOutput) SerializeMembers(s smithy.ShapeSerializer) {
...
func (v *ChangeServerLifeCycleStateOutput) Deserialize(d smithy.ShapeDeserializer) error {
...
func (c *Client) addOperationChangeServerLifeCycleStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ChangeServerLifeCycleState, schemas.ChangeServerLifeCycleStateRequest, schemas.SourceServer)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ChangeServerLifeCycleState, schemas.ChangeServerLifeCycleStateRequest, schemas.SourceServer), output: &ChangeServerLifeCycleStateOutput{}}, middleware.After); err != nil {
		return err
	}
