...
func (c *Client) ChangeServerLifeCycleState(ctx context.Context, params *ChangeServerLifeCycleStateInput, optFns ...func(*Options)) (*ChangeServerLifeCycleStateOutput, error) {
	if params == nil { params = &ChangeServerLifeCycleStateInput{} }
...
func (c *Client) addOperationChangeServerLifeCycleStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addChangeServerLifeCycleStateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opChangeServerLifeCycleStateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opChangeServerLifeCycleStateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opChangeServerLifeCycleStateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addChangeServerLifeCycleStateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opChangeServerLifeCycleStateResolveEndpointMiddleware{
