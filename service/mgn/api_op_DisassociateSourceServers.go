...
func (c *Client) addOperationDisassociateSourceServersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateSourceServers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
