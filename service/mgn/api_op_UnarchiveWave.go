...
func (*UnarchiveWaveInput) operationName() string {
...
func (c *Client) addOperationUnarchiveWaveMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUnarchiveWaveResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUnarchiveWaveResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUnarchiveWaveResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUnarchiveWaveResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUnarchiveWaveResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUnarchiveWaveResolveEndpointMiddleware{
