...
func (c *Client) ArchiveWave(ctx context.Context, params *ArchiveWaveInput, optFns ...func(*Options)) (*ArchiveWaveOutput, error) {
	if params == nil { params = &ArchiveWaveInput{} }
...
func (c *Client) addOperationArchiveWaveMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addArchiveWaveResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opArchiveWaveResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opArchiveWaveResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opArchiveWaveResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addArchiveWaveResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opArchiveWaveResolveEndpointMiddleware{
