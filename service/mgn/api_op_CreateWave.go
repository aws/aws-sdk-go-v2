...
func (*CreateWaveInput) operationName() string {
	return "CreateWave"
}
...
func (c *Client) addOperationCreateWaveMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateWaveResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateWaveResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateWaveResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateWaveResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateWaveResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateWaveResolveEndpointMiddleware{
