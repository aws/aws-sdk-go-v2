...
func (c *Client) DeleteDecoderManifest(ctx context.Context, params *DeleteDecoderManifestInput, optFns ...func(*Options)) (*DeleteDecoderManifestOutput, error) {
	if params == nil { params = &DeleteDecoderManifestInput{} }
...
func (c *Client) addOperationDeleteDecoderManifestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteDecoderManifestResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteDecoderManifestResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteDecoderManifestResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteDecoderManifestResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteDecoderManifestResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteDecoderManifestResolveEndpointMiddleware{
