...
func (c *Client) ImportDecoderManifest(ctx context.Context, params *ImportDecoderManifestInput, optFns ...func(*Options)) (*ImportDecoderManifestOutput, error) {
	if params == nil { params = &ImportDecoderManifestInput{} }
...
func (c *Client) addOperationImportDecoderManifestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addImportDecoderManifestResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opImportDecoderManifestResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opImportDecoderManifestResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opImportDecoderManifestResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addImportDecoderManifestResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opImportDecoderManifestResolveEndpointMiddleware{
