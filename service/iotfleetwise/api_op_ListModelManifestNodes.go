...
func (*ListModelManifestNodesInput) operationName() string {
...
func (c *Client) addOperationListModelManifestNodesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListModelManifestNodesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListModelManifestNodesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListModelManifestNodesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListModelManifestNodesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListModelManifestNodesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListModelManifestNodesResolveEndpointMiddleware{
