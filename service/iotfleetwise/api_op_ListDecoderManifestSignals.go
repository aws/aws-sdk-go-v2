...
func (c *Client) addOperationListDecoderManifestSignalsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDecoderManifestSignals", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
