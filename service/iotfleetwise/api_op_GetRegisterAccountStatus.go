...
func (c *Client) addOperationGetRegisterAccountStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRegisterAccountStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
