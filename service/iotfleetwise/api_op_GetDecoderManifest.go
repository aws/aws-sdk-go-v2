...
func (c *Client) GetDecoderManifest(ctx context.Context, params *GetDecoderManifestInput, optFns ...func(*Options)) (*GetDecoderManifestOutput, error) {
	if params == nil { params = &GetDecoderManifestInput{} }
...
func (c *Client) addOperationGetDecoderManifestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDecoderManifestResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDecoderManifestResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDecoderManifestResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDecoderManifestResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDecoderManifestResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDecoderManifestResolveEndpointMiddleware{
