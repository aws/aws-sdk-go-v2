...
func (c *Client) UpdateVehicle(ctx context.Context, params *UpdateVehicleInput, optFns ...func(*Options)) (*UpdateVehicleOutput, error) {
	if params == nil { params = &UpdateVehicleInput{} }
...
func (c *Client) addOperationUpdateVehicleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateVehicleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateVehicleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateVehicleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateVehicleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateVehicleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateVehicleResolveEndpointMiddleware{
