...
func (c *Client) ListDecoderManifestNetworkInterfaces(ctx context.Context, params *ListDecoderManifestNetworkInterfacesInput, optFns ...func(*Options)) (*ListDecoderManifestNetworkInterfacesOutput, error) {
	if params == nil { params = &ListDecoderManifestNetworkInterfacesInput{} }
...
func (c *Client) addOperationListDecoderManifestNetworkInterfacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDecoderManifestNetworkInterfacesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDecoderManifestNetworkInterfacesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDecoderManifestNetworkInterfacesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDecoderManifestNetworkInterfacesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDecoderManifestNetworkInterfacesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDecoderManifestNetworkInterfacesResolveEndpointMiddleware{
