...
func (c *Client) addOperationListDecoderManifestNetworkInterfacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDecoderManifestNetworkInterfaces", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
