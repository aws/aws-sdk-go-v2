...
func (c *Client) ListFleetsForVehicle(ctx context.Context, params *ListFleetsForVehicleInput, optFns ...func(*Options)) (*ListFleetsForVehicleOutput, error) {
	if params == nil { params = &ListFleetsForVehicleInput{} }
...
func (c *Client) addOperationListFleetsForVehicleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFleetsForVehicleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListFleetsForVehicleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListFleetsForVehicleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFleetsForVehicleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFleetsForVehicleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListFleetsForVehicleResolveEndpointMiddleware{
