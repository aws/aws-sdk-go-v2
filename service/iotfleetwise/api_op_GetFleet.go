...
func (c *Client) addOperationGetFleetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFleetResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetFleetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetFleetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFleetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFleetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetFleetResolveEndpointMiddleware{
