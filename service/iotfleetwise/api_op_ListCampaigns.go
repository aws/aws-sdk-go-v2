...
func (c *Client) ListCampaigns(ctx context.Context, params *ListCampaignsInput, optFns ...func(*Options)) (*ListCampaignsOutput, error) {
	if params == nil { params = &ListCampaignsInput{} }
...
func (c *Client) addOperationListCampaignsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCampaignsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCampaignsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCampaignsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCampaignsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCampaignsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCampaignsResolveEndpointMiddleware{
