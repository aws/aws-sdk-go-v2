...
func (c *Client) CreateModelManifest(ctx context.Context, params *CreateModelManifestInput, optFns ...func(*Options)) (*CreateModelManifestOutput, error) {
	if params == nil { params = &CreateModelManifestInput{} }
...
func (c *Client) addOperationCreateModelManifestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateModelManifestResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateModelManifestResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateModelManifestResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateModelManifestResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateModelManifestResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateModelManifestResolveEndpointMiddleware{
