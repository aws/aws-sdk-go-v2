...
func (c *Client) GetVehicleStatus(ctx context.Context, params *GetVehicleStatusInput, optFns ...func(*Options)) (*GetVehicleStatusOutput, error) {
	if params == nil { params = &GetVehicleStatusInput{} }
...
func (c *Client) addOperationGetVehicleStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetVehicleStatusResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetVehicleStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetVehicleStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetVehicleStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetVehicleStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetVehicleStatusResolveEndpointMiddleware{
