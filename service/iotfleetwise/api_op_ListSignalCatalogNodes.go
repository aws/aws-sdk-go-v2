...
func (c *Client) ListSignalCatalogNodes(ctx context.Context, params *ListSignalCatalogNodesInput, optFns ...func(*Options)) (*ListSignalCatalogNodesOutput, error) {
	if params == nil { params = &ListSignalCatalogNodesInput{} }
...
func (c *Client) addOperationListSignalCatalogNodesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSignalCatalogNodesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSignalCatalogNodesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSignalCatalogNodesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSignalCatalogNodesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSignalCatalogNodesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSignalCatalogNodesResolveEndpointMiddleware{
