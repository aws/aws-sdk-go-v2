...
func (c *Client) AssociateVehicleFleet(ctx context.Context, params *AssociateVehicleFleetInput, optFns ...func(*Options)) (*AssociateVehicleFleetOutput, error) {
	if params == nil { params = &AssociateVehicleFleetInput{} }
...
func (c *Client) addOperationAssociateVehicleFleetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateVehicleFleetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateVehicleFleetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateVehicleFleetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateVehicleFleetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateVehicleFleetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateVehicleFleetResolveEndpointMiddleware{
