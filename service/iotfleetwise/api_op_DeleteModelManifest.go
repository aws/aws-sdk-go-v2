...
func (c *Client) DeleteModelManifest(ctx context.Context, params *DeleteModelManifestInput, optFns ...func(*Options)) (*DeleteModelManifestOutput, error) {
	if params == nil { params = &DeleteModelManifestInput{} }
...
func (c *Client) addOperationDeleteModelManifestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteModelManifestResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteModelManifestResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteModelManifestResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteModelManifestResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteModelManifestResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteModelManifestResolveEndpointMiddleware{
