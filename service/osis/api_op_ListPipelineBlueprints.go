...
func (c *Client) ListPipelineBlueprints(ctx context.Context, params *ListPipelineBlueprintsInput, optFns ...func(*Options)) (*ListPipelineBlueprintsOutput, error) {
	if params == nil { params = &ListPipelineBlueprintsInput{} }
...
func (c *Client) addOperationListPipelineBlueprintsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPipelineBlueprintsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPipelineBlueprintsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPipelineBlueprintsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPipelineBlueprintsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPipelineBlueprintsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPipelineBlueprintsResolveEndpointMiddleware{
