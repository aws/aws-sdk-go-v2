...
// Enum values for PipelineEndpointStatus
const (
...
// Values returns all known values for PipelineEndpointStatus. Note that this can
// be expanded in the future, and so it is only as up to date as the client.
//
// The ordering of this slice is not guaranteed to be stable across updates.
func (PipelineEndpointStatus) Values() []PipelineEndpointStatus {
	return []PipelineEndpointStatus{
		"CREATING",
		"ACTIVE",
		"CREATE_FAILED",
		"DELETING",
