...
func (c *Client) StartPipeline(ctx context.Context, params *StartPipelineInput, optFns ...func(*Options)) (*StartPipelineOutput, error) {
	if params == nil { params = &StartPipelineInput{} }
...
func (c *Client) addOperationStartPipelineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartPipelineResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartPipelineResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartPipelineResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartPipelineResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartPipelineResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartPipelineResolveEndpointMiddleware{
