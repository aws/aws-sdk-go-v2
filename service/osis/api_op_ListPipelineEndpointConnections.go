...
func (c *Client) addOperationListPipelineEndpointConnectionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPipelineEndpointConnections", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
