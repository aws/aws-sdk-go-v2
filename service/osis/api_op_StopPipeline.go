...
func (*StopPipelineInput) operationName() string {
	return "StopPipeline"
}
...
func (c *Client) addOperationStopPipelineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopPipelineResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopPipelineResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopPipelineResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopPipelineResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopPipelineResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopPipelineResolveEndpointMiddleware{
