...
func (c *Client) addOperationGetPipelineChangeProgressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPipelineChangeProgress", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
