...
func (c *Client) GetPipelineChangeProgress(ctx context.Context, params *GetPipelineChangeProgressInput, optFns ...func(*Options)) (*GetPipelineChangeProgressOutput, error) {
	if params == nil { params = &GetPipelineChangeProgressInput{} }
...
func (c *Client) addOperationGetPipelineChangeProgressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPipelineChangeProgressResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPipelineChangeProgressResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPipelineChangeProgressResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPipelineChangeProgressResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPipelineChangeProgressResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPipelineChangeProgressResolveEndpointMiddleware{
