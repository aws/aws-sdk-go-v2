...
// of the Amazon Neptune DB instance is deleting until the DB snapshot is
// created. The API action DescribeDBInstance is used to monitor the status of
// this operation. The action can't be canceled or reverted once submitted. Note
...
// the SkipFinalSnapshot  parameter is set to true. You can't delete a DB
// instance if it is the only instance in the DB cluster, or if it has deletion
// protection enabled.
...
type DeleteDBInstanceInput struct {
	...
	// specified, a DB snapshot is created before the DB instance is deleted. Note that
