...
func addOperationDescribeValidDBInstanceModificationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeValidDBInstanceModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeValidDBInstanceModificationsStackSlots(stack); err != nil {
		return err
	}
