...
func (c *Client) addOperationDescribeValidDBInstanceModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeValidDBInstanceModifications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
