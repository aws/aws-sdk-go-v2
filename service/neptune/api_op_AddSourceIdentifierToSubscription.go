...
func (c *Client) AddSourceIdentifierToSubscription(ctx context.Context, params *AddSourceIdentifierToSubscriptionInput, optFns ...func(*Options)) (*AddSourceIdentifierToSubscriptionOutput, error) {
	if params == nil { params = &AddSourceIdentifierToSubscriptionInput{} }
...
func (c *Client) addOperationAddSourceIdentifierToSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAddSourceIdentifierToSubscriptionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAddSourceIdentifierToSubscriptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAddSourceIdentifierToSubscriptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAddSourceIdentifierToSubscriptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAddSourceIdentifierToSubscriptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAddSourceIdentifierToSubscriptionResolveEndpointMiddleware{
