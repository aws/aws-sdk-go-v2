...
func addOperationResetDBClusterParameterGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationResetDBClusterParameterGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationResetDBClusterParameterGroupStackSlots(stack); err != nil {
		return err
	}
