...
func (c *Client) addOperationSwitchoverGlobalClusterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SwitchoverGlobalCluster", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
