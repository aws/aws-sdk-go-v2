...
func addOperationDescribeEventSubscriptionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeEventSubscriptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeEventSubscriptionsStackSlots(stack); err != nil {
		return err
	}
