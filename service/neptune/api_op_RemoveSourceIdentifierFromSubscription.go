...
func addOperationRemoveSourceIdentifierFromSubscriptionStackSlots(stack *middleware.Stack) error {
...
func addOperationRemoveSourceIdentifierFromSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRemoveSourceIdentifierFromSubscriptionStackSlots(stack); err != nil {
		return err
	}
