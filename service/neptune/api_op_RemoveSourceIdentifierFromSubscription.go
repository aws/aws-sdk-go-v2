...
func (c *Client) addOperationRemoveSourceIdentifierFromSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RemoveSourceIdentifierFromSubscription", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
