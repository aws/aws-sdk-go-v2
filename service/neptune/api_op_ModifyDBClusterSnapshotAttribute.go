...
func addOperationModifyDBClusterSnapshotAttributeStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyDBClusterSnapshotAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyDBClusterSnapshotAttributeStackSlots(stack); err != nil {
		return err
	}
