...
func addOperationDescribePendingMaintenanceActionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribePendingMaintenanceActionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribePendingMaintenanceActionsStackSlots(stack); err != nil {
		return err
	}
