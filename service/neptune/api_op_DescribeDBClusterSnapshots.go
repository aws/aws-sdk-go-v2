...
func addOperationDescribeDBClusterSnapshotsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeDBClusterSnapshotsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeDBClusterSnapshotsStackSlots(stack); err != nil {
		return err
	}
