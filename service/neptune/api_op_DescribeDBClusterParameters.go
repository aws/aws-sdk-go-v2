...
func addOperationDescribeDBClusterParametersStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeDBClusterParametersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeDBClusterParametersStackSlots(stack); err != nil {
		return err
	}
