...
func (c *Client) addOperationDescribeDBParameterGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDBParameterGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
