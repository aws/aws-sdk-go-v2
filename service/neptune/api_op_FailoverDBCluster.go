...
// Forces a failover for a DB cluster. A failover for a DB cluster promotes one
// of the Read Replicas (read-only instances) in the DB cluster to be the primary
