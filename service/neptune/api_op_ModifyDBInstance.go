...
type ModifyDBInstanceInput struct {
	...
	// PreferredMaintenanceWindowsetting for the DB instance. If this parameter is
	// set to false, changes to the DB instance are applied during the next
	// maintenance window. Some parameter changes can cause an outage and are applied
	// on the next call to RebootDBInstance , or the next failure reboot. Default:
	// false
	...
	// trueduring the maintenance window, and a newer minor version is available, and
	...
	// DB cluster. For more information, see ModifyDBCluster. Default: Uses existing
	// setting
	...
	// is specified as true  for this request. Default: Uses existing setting
	...
	// DBPortNumberparameter must not match any of the port values specified for
	...
	// move your DB instance to a different VPC. Changing the subnet group causes an
	...
	// set to true  for this request. Default: Uses existing setting
	Iops *int32
	...
	// you must also set MonitoringInterval  to a value other than 0. Valid Values:
	// 0, 1, 5, 10, 15, 30, 60
	...
	// end of the window to ensure pending changes are applied. Default: Uses existing
	...
	// change is asynchronously applied as soon as possible. Not applicable. The
