...
func (c *Client) addOperationDeleteDBClusterEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDBClusterEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
