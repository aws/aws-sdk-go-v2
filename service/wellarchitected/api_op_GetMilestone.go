...
func (*GetMilestoneInput) operationName() string {
	return "GetMilestone"
}
...
func (c *Client) addOperationGetMilestoneMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMilestoneResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetMilestoneResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetMilestoneResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMilestoneResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMilestoneResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetMilestoneResolveEndpointMiddleware{
