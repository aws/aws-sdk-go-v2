...
func (c *Client) addOperationListLensReviewImprovementsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListLensReviewImprovements", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
