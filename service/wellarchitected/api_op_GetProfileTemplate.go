...
func (c *Client) GetProfileTemplate(ctx context.Context, params *GetProfileTemplateInput, optFns ...func(*Options)) (*GetProfileTemplateOutput, error) {
	if params == nil { params = &GetProfileTemplateInput{} }
...
func (c *Client) addOperationGetProfileTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetProfileTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetProfileTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetProfileTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetProfileTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetProfileTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetProfileTemplateResolveEndpointMiddleware{
