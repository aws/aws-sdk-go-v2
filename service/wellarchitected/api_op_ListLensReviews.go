...
func (c *Client) ListLensReviews(ctx context.Context, params *ListLensReviewsInput, optFns ...func(*Options)) (*ListLensReviewsOutput, error) {
	if params == nil { params = &ListLensReviewsInput{} }
...
func (c *Client) addOperationListLensReviewsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLensReviewsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListLensReviewsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListLensReviewsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLensReviewsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLensReviewsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListLensReviewsResolveEndpointMiddleware{
