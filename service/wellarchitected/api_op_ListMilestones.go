...
func (c *Client) ListMilestones(ctx context.Context, params *ListMilestonesInput, optFns ...func(*Options)) (*ListMilestonesOutput, error) {
	if params == nil { params = &ListMilestonesInput{} }
...
func (c *Client) addOperationListMilestonesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMilestonesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListMilestonesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListMilestonesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMilestonesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListMilestonesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListMilestonesResolveEndpointMiddleware{
