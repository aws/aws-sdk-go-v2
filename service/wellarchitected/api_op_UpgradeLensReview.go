...
func (c *Client) UpgradeLensReview(ctx context.Context, params *UpgradeLensReviewInput, optFns ...func(*Options)) (*UpgradeLensReviewOutput, error) {
	if params == nil { params = &UpgradeLensReviewInput{} }
...
func (c *Client) addOperationUpgradeLensReviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpgradeLensReviewResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpgradeLensReviewResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpgradeLensReviewResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpgradeLensReviewResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpgradeLensReviewResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpgradeLensReviewResolveEndpointMiddleware{
