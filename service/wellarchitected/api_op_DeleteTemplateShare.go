...
func (c *Client) addOperationDeleteTemplateShareMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteTemplateShareResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteTemplateShareResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteTemplateShareResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteTemplateShareResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteTemplateShareResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteTemplateShareResolveEndpointMiddleware{
