...
func (v *DeleteLensShareInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DeleteLensShareInput)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DeleteLensShareInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ClientRequestToken != nil {
		s.WriteString(schemas.DeleteLensShareInput_ClientRequestToken, *v.ClientRequestToken)
	}
	if v.LensAlias != nil {
		s.WriteString(schemas.DeleteLensShareInput_LensAlias, *v.LensAlias)
	}
	if v.ShareId != nil {
		s.WriteString(schemas.DeleteLensShareInput_ShareId, *v.ShareId)
	}
}
...
func (v *DeleteLensShareOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(nil)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DeleteLensShareOutput) SerializeMembers(s smithy.ShapeSerializer) {
}
func (v *DeleteLensShareOutput) Deserialize(d smithy.ShapeDeserializer) error {
...
func (c *Client) addOperationDeleteLensShareMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.DeleteLensShare, schemas.DeleteLensShareInput, nil)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.DeleteLensShare, schemas.DeleteLensShareInput, nil), output: &DeleteLensShareOutput{}}, middleware.After); err != nil {
		return err
	}
