...
// accounts, IAM users, organizations, and organizational units (OUs) that you
// shared the lens with can continue to use it, but they will no longer be able to
// apply it to new workloads. Disclaimer By sharing your custom lenses with other
// Amazon Web Services accounts, you acknowledge that Amazon Web Services will make
// your custom lenses available to those other accounts. Those other accounts may
