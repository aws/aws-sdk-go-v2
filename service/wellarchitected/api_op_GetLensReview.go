...
func (*GetLensReviewInput) operationName() string {
...
func (c *Client) addOperationGetLensReviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetLensReviewResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetLensReviewResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetLensReviewResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetLensReviewResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetLensReviewResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetLensReviewResolveEndpointMiddleware{
