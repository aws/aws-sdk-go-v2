...
func (c *Client) GetWorkload(ctx context.Context, params *GetWorkloadInput, optFns ...func(*Options)) (*GetWorkloadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetWorkload", params, optFns, addOperationGetWorkloadMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetWorkloadMiddlewares(stack *middleware.Stack, options Options) (err error) {
