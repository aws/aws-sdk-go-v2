...
func (c *Client) addOperationCreateReviewTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateReviewTemplateResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateReviewTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateReviewTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateReviewTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateReviewTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateReviewTemplateResolveEndpointMiddleware{
