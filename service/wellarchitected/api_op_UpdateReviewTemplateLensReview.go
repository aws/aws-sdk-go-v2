...
func (c *Client) addOperationUpdateReviewTemplateLensReviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateReviewTemplateLensReviewResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateReviewTemplateLensReviewResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateReviewTemplateLensReviewResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateReviewTemplateLensReviewResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateReviewTemplateLensReviewResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateReviewTemplateLensReviewResolveEndpointMiddleware{
