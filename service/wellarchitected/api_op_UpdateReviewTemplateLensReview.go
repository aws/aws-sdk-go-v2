...
func (c *Client) addOperationUpdateReviewTemplateLensReviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateReviewTemplateLensReview", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
