...
func (c *Client) addOperationListReviewTemplateAnswersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListReviewTemplateAnswersResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListReviewTemplateAnswersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListReviewTemplateAnswersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListReviewTemplateAnswersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListReviewTemplateAnswersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListReviewTemplateAnswersResolveEndpointMiddleware{
