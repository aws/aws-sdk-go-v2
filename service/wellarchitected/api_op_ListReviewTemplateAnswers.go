...
func (c *Client) addOperationListReviewTemplateAnswersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListReviewTemplateAnswers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
