...
func (*ListShareInvitationsInput) operationName() string {
...
func (c *Client) addOperationListShareInvitationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListShareInvitationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListShareInvitationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListShareInvitationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListShareInvitationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListShareInvitationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListShareInvitationsResolveEndpointMiddleware{
