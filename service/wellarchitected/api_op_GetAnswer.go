...
func (c *Client) GetAnswer(ctx context.Context, params *GetAnswerInput, optFns ...func(*Options)) (*GetAnswerOutput, error) {
	if params == nil { params = &GetAnswerInput{} }
...
func (c *Client) addOperationGetAnswerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAnswerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAnswerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAnswerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAnswerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAnswerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAnswerResolveEndpointMiddleware{
