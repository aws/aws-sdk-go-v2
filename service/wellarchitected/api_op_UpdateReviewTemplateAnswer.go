...
func (c *Client) addOperationUpdateReviewTemplateAnswerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateReviewTemplateAnswerResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateReviewTemplateAnswerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateReviewTemplateAnswerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateReviewTemplateAnswerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateReviewTemplateAnswerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateReviewTemplateAnswerResolveEndpointMiddleware{
