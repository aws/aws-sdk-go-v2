...
func (c *Client) addOperationUpdateReviewTemplateAnswerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateReviewTemplateAnswer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
