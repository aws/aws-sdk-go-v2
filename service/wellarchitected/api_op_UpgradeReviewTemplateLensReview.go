...
func (c *Client) addOperationUpgradeReviewTemplateLensReviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpgradeReviewTemplateLensReviewResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpgradeReviewTemplateLensReviewResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpgradeReviewTemplateLensReviewResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpgradeReviewTemplateLensReviewResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpgradeReviewTemplateLensReviewResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpgradeReviewTemplateLensReviewResolveEndpointMiddleware{
