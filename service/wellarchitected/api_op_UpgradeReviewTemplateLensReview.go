...
func (c *Client) addOperationUpgradeReviewTemplateLensReviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpgradeReviewTemplateLensReview", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
