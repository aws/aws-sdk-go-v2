...
func (*ListLensesInput) operationName() string {
	return "ListLenses"
}
...
func (c *Client) addOperationListLensesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLensesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListLensesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListLensesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLensesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLensesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListLensesResolveEndpointMiddleware{
