...
func (c *Client) addOperationGetReviewTemplateAnswerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetReviewTemplateAnswer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
