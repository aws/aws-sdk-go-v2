...
func (c *Client) addOperationGetReviewTemplateAnswerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetReviewTemplateAnswerResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetReviewTemplateAnswerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetReviewTemplateAnswerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetReviewTemplateAnswerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetReviewTemplateAnswerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetReviewTemplateAnswerResolveEndpointMiddleware{
