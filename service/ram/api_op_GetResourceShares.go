...
func (c *Client) GetResourceShares(ctx context.Context, params *GetResourceSharesInput, optFns ...func(*Options)) (*GetResourceSharesOutput, error) {
	stack := middleware.NewStack("GetResourceShares", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpGetResourceSharesMiddlewares(stack)
...
func addawsRestjson1_serdeOpGetResourceSharesMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpGetResourceShares{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpGetResourceShares{}, middleware.After)
}
