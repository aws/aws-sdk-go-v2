...
func (*GetResourceSharesInput) operationName() string {
...
func (c *Client) addOperationGetResourceSharesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetResourceSharesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetResourceSharesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetResourceSharesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetResourceSharesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetResourceSharesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetResourceSharesResolveEndpointMiddleware{
