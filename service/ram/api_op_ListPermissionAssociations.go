...
func (c *Client) addOperationListPermissionAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPermissionAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
