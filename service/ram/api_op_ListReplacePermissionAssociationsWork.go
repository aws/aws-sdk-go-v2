...
func (c *Client) addOperationListReplacePermissionAssociationsWorkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListReplacePermissionAssociationsWorkResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListReplacePermissionAssociationsWorkResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListReplacePermissionAssociationsWorkResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListReplacePermissionAssociationsWorkResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListReplacePermissionAssociationsWorkResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListReplacePermissionAssociationsWorkResolveEndpointMiddleware{
