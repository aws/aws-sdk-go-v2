...
func addOperationAcceptResourceShareInvitationStackSlots(stack *middleware.Stack) error {
...
func addOperationAcceptResourceShareInvitationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAcceptResourceShareInvitationStackSlots(stack); err != nil {
		return err
	}
