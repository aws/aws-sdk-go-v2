...
func (*AcceptResourceShareInvitationInput) operationName() string {
...
func (c *Client) addOperationAcceptResourceShareInvitationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAcceptResourceShareInvitationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAcceptResourceShareInvitationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAcceptResourceShareInvitationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAcceptResourceShareInvitationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAcceptResourceShareInvitationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAcceptResourceShareInvitationResolveEndpointMiddleware{
