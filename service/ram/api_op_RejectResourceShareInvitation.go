...
func addOperationRejectResourceShareInvitationStackSlots(stack *middleware.Stack) error {
...
func addOperationRejectResourceShareInvitationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRejectResourceShareInvitationStackSlots(stack); err != nil {
		return err
	}
