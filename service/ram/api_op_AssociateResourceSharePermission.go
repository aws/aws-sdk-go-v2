...
func addOperationAssociateResourceSharePermissionStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociateResourceSharePermissionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociateResourceSharePermissionStackSlots(stack); err != nil {
		return err
	}
