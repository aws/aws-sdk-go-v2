...
func (*GetResourceShareInvitationsInput) operationName() string {
...
func (c *Client) addOperationGetResourceShareInvitationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetResourceShareInvitationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetResourceShareInvitationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetResourceShareInvitationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetResourceShareInvitationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetResourceShareInvitationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetResourceShareInvitationsResolveEndpointMiddleware{
