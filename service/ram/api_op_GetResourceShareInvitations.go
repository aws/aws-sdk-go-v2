...
func (c *Client) addOperationGetResourceShareInvitationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetResourceShareInvitations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
