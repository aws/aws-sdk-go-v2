...
func (c *Client) addOperationGetResourceShareAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetResourceShareAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
