...
func addOperationDisassociateResourceSharePermissionStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateResourceSharePermissionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateResourceSharePermissionStackSlots(stack); err != nil {
		return err
	}
