...
func (c *Client) addOperationListResourceSharePermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListResourceSharePermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
