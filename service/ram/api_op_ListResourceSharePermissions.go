...
func addOperationListResourceSharePermissionsStackSlots(stack *middleware.Stack) error {
...
func addOperationListResourceSharePermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListResourceSharePermissionsStackSlots(stack); err != nil {
		return err
	}
