...
func addOperationListPendingInvitationResourcesStackSlots(stack *middleware.Stack) error {
...
func addOperationListPendingInvitationResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListPendingInvitationResourcesStackSlots(stack); err != nil {
		return err
	}
