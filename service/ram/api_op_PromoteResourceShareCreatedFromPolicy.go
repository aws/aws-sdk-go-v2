...
func addOperationPromoteResourceShareCreatedFromPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationPromoteResourceShareCreatedFromPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPromoteResourceShareCreatedFromPolicyStackSlots(stack); err != nil {
		return err
	}
