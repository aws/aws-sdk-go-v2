...
type awsRestjson1_deserializeOpListSourceAssociations struct {
}

func (*awsRestjson1_deserializeOpListSourceAssociations) ID() string {
	return "OperationDeserializer"
}

func (m *awsRestjson1_deserializeOpListSourceAssociations) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsRestjson1_deserializeOpErrorListSourceAssociations(response, &metadata)
	}
	output := &ListSourceAssociationsOutput{}
	out.Result = output
	...
	err = awsRestjson1_deserializeOpDocumentListSourceAssociationsOutput(&output, shape)
	if err != nil {
		var snapshot bytes.Buffer
		io.Copy(&snapshot, ringBuffer)
		return out, metadata, &smithy.DeserializationError{
...
func awsRestjson1_deserializeOpErrorListSourceAssociations(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func awsRestjson1_deserializeOpDocumentListSourceAssociationsOutput(v **ListSourceAssociationsOutput, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *ListSourceAssociationsOutput
	if *v == nil {
		sv = &ListSourceAssociationsOutput{}
	} else {
		sv = *v
	}
	...
	for key, value := range shape {
		...
		case "sourceAssociations":
			if err := awsRestjson1_deserializeDocumentAssociatedSourceList(&sv.SourceAssociations, value); err != nil {
				return err
			}
...
func awsRestjson1_deserializeDocumentAssociatedSource(v **types.AssociatedSource, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *types.AssociatedSource
	if *v == nil {
		sv = &types.AssociatedSource{}
	} else {
		sv = *v
	}
...
func awsRestjson1_deserializeDocumentAssociatedSourceList(v *[]types.AssociatedSource, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var cv []types.AssociatedSource
	if *v == nil {
		cv = []types.AssociatedSource{}
	} else {
		cv = *v
	}

	for _, value := range shape {
		var col types.AssociatedSource
		destAddr := &col
		if err := awsRestjson1_deserializeDocumentAssociatedSource(&destAddr, value); err != nil {
			return err
		}
		col = *destAddr
		cv = append(cv, col)
