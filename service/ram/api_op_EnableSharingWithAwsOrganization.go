...
func addOperationEnableSharingWithAwsOrganizationStackSlots(stack *middleware.Stack) error {
...
func addOperationEnableSharingWithAwsOrganizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationEnableSharingWithAwsOrganizationStackSlots(stack); err != nil {
		return err
	}
