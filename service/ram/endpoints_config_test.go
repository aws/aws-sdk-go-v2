...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ram.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ram.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ram.dev",
			expectURL:     aws.String("https://env-ram.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ram.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ram.dev",
			expectURL:     aws.String("http://config-ram.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ram.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ram.dev",
			clientEndpoint: aws.String("https://client-ram.dev"),
			expectURL:      aws.String("https://client-ram.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_RAM", c.envService)
			}
