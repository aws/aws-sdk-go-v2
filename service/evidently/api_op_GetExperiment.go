...
func (c *Client) GetExperiment(ctx context.Context, params *GetExperimentInput, optFns ...func(*Options)) (*GetExperimentOutput, error) {
	if params == nil { params = &GetExperimentInput{} }
...
func (c *Client) addOperationGetExperimentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetExperimentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetExperimentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetExperimentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetExperimentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetExperimentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetExperimentResolveEndpointMiddleware{
