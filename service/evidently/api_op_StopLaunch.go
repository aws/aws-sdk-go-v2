...
func (c *Client) StopLaunch(ctx context.Context, params *StopLaunchInput, optFns ...func(*Options)) (*StopLaunchOutput, error) {
	if params == nil { params = &StopLaunchInput{} }
...
func (c *Client) addOperationStopLaunchMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopLaunchResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopLaunchResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopLaunchResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopLaunchResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopLaunchResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopLaunchResolveEndpointMiddleware{
