...
func (c *Client) PutProjectEvents(ctx context.Context, params *PutProjectEventsInput, optFns ...func(*Options)) (*PutProjectEventsOutput, error) {
	if params == nil { params = &PutProjectEventsInput{} }
...
func (c *Client) addOperationPutProjectEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutProjectEventsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutProjectEventsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutProjectEventsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutProjectEventsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addPutProjectEventsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutProjectEventsResolveEndpointMiddleware{
