...
func (c *Client) UpdateProjectDataDelivery(ctx context.Context, params *UpdateProjectDataDeliveryInput, optFns ...func(*Options)) (*UpdateProjectDataDeliveryOutput, error) {
	if params == nil { params = &UpdateProjectDataDeliveryInput{} }
...
func (c *Client) addOperationUpdateProjectDataDeliveryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateProjectDataDeliveryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateProjectDataDeliveryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateProjectDataDeliveryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateProjectDataDeliveryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateProjectDataDeliveryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateProjectDataDeliveryResolveEndpointMiddleware{
