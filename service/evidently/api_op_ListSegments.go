...
func (c *Client) ListSegments(ctx context.Context, params *ListSegmentsInput, optFns ...func(*Options)) (*ListSegmentsOutput, error) {
	if params == nil { params = &ListSegmentsInput{} }
...
func (c *Client) addOperationListSegmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSegmentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSegmentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSegmentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSegmentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSegmentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSegmentsResolveEndpointMiddleware{
