...
func (c *Client) TestSegmentPattern(ctx context.Context, params *TestSegmentPatternInput, optFns ...func(*Options)) (*TestSegmentPatternOutput, error) {
	if params == nil { params = &TestSegmentPatternInput{} }
...
func (c *Client) addOperationTestSegmentPatternMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addTestSegmentPatternResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opTestSegmentPatternResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opTestSegmentPatternResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opTestSegmentPatternResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addTestSegmentPatternResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opTestSegmentPatternResolveEndpointMiddleware{
