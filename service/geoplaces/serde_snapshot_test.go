...
func TestSerdeCheckSnapshot_Autocomplete(t *testing.T) {
...
func TestSerdeCheckSnapshot_Geocode(t *testing.T) {
	input := &GeocodeInput{
		QueryText: ptr.String("__QueryText__"),
...
func TestSerdeCheckSnapshot_ReverseGeocode(t *testing.T) {
...
func TestSerdeCheckSnapshot_SearchNearby(t *testing.T) {
...
func TestSerdeCheckSnapshot_SearchText(t *testing.T) {
...
func TestSerdeUpdateSnapshot_Autocomplete(t *testing.T) {
	input := &AutocompleteInput{
		QueryText:  ptr.String("__QueryText__"),
		MaxResults: ptr.Int32(1),
		BiasPosition: []float64{
...
func TestSerdeUpdateSnapshot_Geocode(t *testing.T) {
	input := &GeocodeInput{
		QueryText: ptr.String("__QueryText__"),
		QueryComponents: &types.GeocodeQueryComponents{
			Country:       ptr.String("__Country__"),
...
func TestSerdeUpdateSnapshot_ReverseGeocode(t *testing.T) {
	input := &ReverseGeocodeInput{
		QueryPosition: []float64{
			1.0,
			1.0,
...
func TestSerdeUpdateSnapshot_SearchNearby(t *testing.T) {
	input := &SearchNearbyInput{
		QueryPosition: []float64{
			1.0,
			1.0,
...
func TestSerdeUpdateSnapshot_SearchText(t *testing.T) {
	input := &SearchTextInput{
		QueryText:  ptr.String("__QueryText__"),
		QueryId:    ptr.String("__QueryId__"),
		MaxResults: ptr.Int32(1),
