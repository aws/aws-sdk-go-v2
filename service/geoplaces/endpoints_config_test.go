...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-geo-places.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-geo-places.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-geo-places.dev",
			expectURL:     aws.String("https://env-geo-places.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-geo-places.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-geo-places.dev",
			expectURL:     aws.String("http://config-geo-places.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-geo-places.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-geo-places.dev",
			clientEndpoint: aws.String("https://client-geo-places.dev"),
			expectURL:      aws.String("https://client-geo-places.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_GEO_PLACES", c.envService)
			}
