...
func (c *Client) addOperationRegisterComputeNodeGroupInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterComputeNodeGroupInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
