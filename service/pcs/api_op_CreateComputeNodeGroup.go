...
type CreateComputeNodeGroupInput struct {
	...
	// must have pcs:RegisterComputeNodeGroupInstance permissions attached in order to
	// provision instances correctly. The resource identifier of the ARN must start
	// with AWSPCS . For example,
