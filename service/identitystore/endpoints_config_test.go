...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-identitystore.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-identitystore.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-identitystore.dev",
			expectURL:     aws.String("https://env-identitystore.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-identitystore.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-identitystore.dev",
			expectURL:     aws.String("http://config-identitystore.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-identitystore.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-identitystore.dev",
			clientEndpoint: aws.String("https://client-identitystore.dev"),
			expectURL:      aws.String("https://client-identitystore.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IDENTITYSTORE", c.envService)
			}
