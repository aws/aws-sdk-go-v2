...
func (c *Client) addOperationListGroupMembershipsForMemberMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListGroupMembershipsForMember", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
