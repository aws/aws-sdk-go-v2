...
func (c *Client) GetGroupMembershipId(ctx context.Context, params *GetGroupMembershipIdInput, optFns ...func(*Options)) (*GetGroupMembershipIdOutput, error) {
	if params == nil { params = &GetGroupMembershipIdInput{} }
...
func (c *Client) addOperationGetGroupMembershipIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetGroupMembershipIdResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetGroupMembershipIdResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetGroupMembershipIdResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetGroupMembershipIdResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetGroupMembershipIdResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetGroupMembershipIdResolveEndpointMiddleware{
