...
func (c *Client) addOperationListAccountIntegrationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAccountIntegrations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
