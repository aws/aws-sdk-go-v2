...
func (*CreateCalculatedAttributeDefinitionInput) operationName() string {
...
func (c *Client) addOperationCreateCalculatedAttributeDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateCalculatedAttributeDefinitionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateCalculatedAttributeDefinitionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateCalculatedAttributeDefinitionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateCalculatedAttributeDefinitionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateCalculatedAttributeDefinitionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateCalculatedAttributeDefinitionResolveEndpointMiddleware{
