...
// UTC to detect duplicate profiles in your domains. After the Identity Resolution
// Job completes, use the GetMatches (https://docs.aws.amazon.com/customerprofiles/latest/APIReference/API_GetMatches.html)
...
//   - FullName
//
// For example, two or more profiles—with spelling mistakes such
// as John Doe and Jhn Doe, or different casing email addresses such as
// JOHN_DOE@ANYCOMPANY.COM and johndoe@anycompany.com, or different phone number
// formats such as 555-010-0000 and +1-555-010-0000—can be detected as belonging to
// the same customer John Doe and merged into a unified profile.
