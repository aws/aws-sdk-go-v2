...
func (c *Client) GetCalculatedAttributeForProfile(ctx context.Context, params *GetCalculatedAttributeForProfileInput, optFns ...func(*Options)) (*GetCalculatedAttributeForProfileOutput, error) {
	if params == nil { params = &GetCalculatedAttributeForProfileInput{} }
...
func (c *Client) addOperationGetCalculatedAttributeForProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCalculatedAttributeForProfileResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCalculatedAttributeForProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCalculatedAttributeForProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCalculatedAttributeForProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCalculatedAttributeForProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCalculatedAttributeForProfileResolveEndpointMiddleware{
