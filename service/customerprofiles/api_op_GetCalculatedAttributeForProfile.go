...
func (c *Client) addOperationGetCalculatedAttributeForProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCalculatedAttributeForProfile", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
