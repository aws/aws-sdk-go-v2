...
func (*DeleteProfileKeyInput) operationName() string {
...
func (c *Client) addOperationDeleteProfileKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteProfileKeyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteProfileKeyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteProfileKeyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteProfileKeyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteProfileKeyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteProfileKeyResolveEndpointMiddleware{
