...
func (c *Client) ListIdentityResolutionJobs(ctx context.Context, params *ListIdentityResolutionJobsInput, optFns ...func(*Options)) (*ListIdentityResolutionJobsOutput, error) {
	if params == nil { params = &ListIdentityResolutionJobsInput{} }
...
func (c *Client) addOperationListIdentityResolutionJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListIdentityResolutionJobsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListIdentityResolutionJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListIdentityResolutionJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListIdentityResolutionJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListIdentityResolutionJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListIdentityResolutionJobsResolveEndpointMiddleware{
