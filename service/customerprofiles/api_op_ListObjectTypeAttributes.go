...
func (c *Client) addOperationListObjectTypeAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListObjectTypeAttributes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
