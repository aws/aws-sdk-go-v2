...
func (c *Client) addOperationGetProfileObjectTypeTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetProfileObjectTypeTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
