...
func (c *Client) addOperationListObjectTypeAttributeValuesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListObjectTypeAttributeValues", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
