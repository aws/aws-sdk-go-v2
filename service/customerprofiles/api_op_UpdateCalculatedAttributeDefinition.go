...
func (c *Client) UpdateCalculatedAttributeDefinition(ctx context.Context, params *UpdateCalculatedAttributeDefinitionInput, optFns ...func(*Options)) (*UpdateCalculatedAttributeDefinitionOutput, error) {
	if params == nil { params = &UpdateCalculatedAttributeDefinitionInput{} }
...
func (c *Client) addOperationUpdateCalculatedAttributeDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateCalculatedAttributeDefinitionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateCalculatedAttributeDefinitionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateCalculatedAttributeDefinitionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateCalculatedAttributeDefinitionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateCalculatedAttributeDefinitionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateCalculatedAttributeDefinitionResolveEndpointMiddleware{
