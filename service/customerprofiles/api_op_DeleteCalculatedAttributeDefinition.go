...
func (c *Client) DeleteCalculatedAttributeDefinition(ctx context.Context, params *DeleteCalculatedAttributeDefinitionInput, optFns ...func(*Options)) (*DeleteCalculatedAttributeDefinitionOutput, error) {
	if params == nil { params = &DeleteCalculatedAttributeDefinitionInput{} }
...
func (c *Client) addOperationDeleteCalculatedAttributeDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCalculatedAttributeDefinitionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteCalculatedAttributeDefinitionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteCalculatedAttributeDefinitionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCalculatedAttributeDefinitionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCalculatedAttributeDefinitionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteCalculatedAttributeDefinitionResolveEndpointMiddleware{
