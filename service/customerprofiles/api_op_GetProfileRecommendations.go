...
func (c *Client) addOperationGetProfileRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetProfileRecommendations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
