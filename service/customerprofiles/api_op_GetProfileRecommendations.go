...
func (c *Client) GetProfileRecommendations(ctx context.Context, params *GetProfileRecommendationsInput, optFns ...func(*Options)) (*GetProfileRecommendationsOutput, error) {
	if params == nil { params = &GetProfileRecommendationsInput{} }
...
func (c *Client) addOperationGetProfileRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err != nil { return err }
	if err := addProtocolFinalizerMiddlewares(stack, options, "GetProfileRecommendations"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetProfileRecommendations(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opGetProfileRecommendations(region string) *awsmiddleware.RegisterServiceMetadata {
