...
type DiversityCapType string

// Enum values for DiversityCapType
const (
	DiversityCapTypePercentage DiversityCapType = "PERCENTAGE"
	DiversityCapTypeValue      DiversityCapType = "VALUE"
)

// Values returns all known values for DiversityCapType. Note that this can be
// expanded in the future, and so it is only as up to date as the client.
//
// The ordering of this slice is not guaranteed to be stable across updates.
func (DiversityCapType) Values() []DiversityCapType {
	return []DiversityCapType{
		"PERCENTAGE",
		"VALUE",
	}
}
