...
func (c *Client) addOperationGetObjectTypeAttributeStatisticsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetObjectTypeAttributeStatistics", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
