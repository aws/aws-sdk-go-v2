...
type ListRecommendersInput struct {
	...
	// The maximum number of recommenders to return in the response. The default value
	// is 100.
	MaxResults *int32

	// A token received from a previous ListRecommenders call to retrieve the next
	// page of results.
	NextToken *string
...
func (c *Client) addOperationListRecommendersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(&awsRestjson1_serializeOpListRecommenders{}, middleware.After)
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(&awsRestjson1_deserializeOpListRecommenders{}, middleware.After)
	if err != nil {
		return err
	}
	...
	if err = addOpListRecommendersValidationMiddleware(stack); err != nil {
		return err
	}
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRecommenders", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
