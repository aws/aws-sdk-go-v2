...
func (*ListCalculatedAttributeDefinitionsInput) operationName() string {
...
func (c *Client) addOperationListCalculatedAttributeDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCalculatedAttributeDefinitionsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListCalculatedAttributeDefinitionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListCalculatedAttributeDefinitionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCalculatedAttributeDefinitionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCalculatedAttributeDefinitionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListCalculatedAttributeDefinitionsResolveEndpointMiddleware{
