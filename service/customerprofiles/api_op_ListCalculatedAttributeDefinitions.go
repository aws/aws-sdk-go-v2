...
func (c *Client) addOperationListCalculatedAttributeDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCalculatedAttributeDefinitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
