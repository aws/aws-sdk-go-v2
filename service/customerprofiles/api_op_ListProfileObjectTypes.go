...
func (*ListProfileObjectTypesInput) operationName() string {
...
func (c *Client) addOperationListProfileObjectTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListProfileObjectTypesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListProfileObjectTypesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListProfileObjectTypesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListProfileObjectTypesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListProfileObjectTypesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListProfileObjectTypesResolveEndpointMiddleware{
