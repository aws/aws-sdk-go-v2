...
func TestCheckResponseSnapshot_CreateMonitor(t *testing.T) {
	want := &CreateMonitorOutput{
		...
		State:             types.MonitorState("PENDING"),
...
func TestCheckResponseSnapshot_CreateProbe(t *testing.T) {
	want := &CreateProbeOutput{
		ProbeId:         ptr.String("__ProbeId__"),
		ProbeArn:        ptr.String("__ProbeArn__"),
	...
	status, header, body, err := serdeRespReadSnapshot("CreateProbe.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "CreateProbe.response", err)
	}
}
...
func TestCheckResponseSnapshot_DeleteProbe(t *testing.T) {
	want := &DeleteProbeOutput{}
	status, header, body, err := serdeRespReadSnapshot("DeleteProbe.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "DeleteProbe.response", err)
	}
}
...
func TestCheckResponseSnapshot_GetProbe(t *testing.T) {
	want := &GetProbeOutput{
		ProbeId:         ptr.String("__ProbeId__"),
		ProbeArn:        ptr.String("__ProbeArn__"),
		SourceArn:       ptr.String("__SourceArn__"),
	...
	status, header, body, err := serdeRespReadSnapshot("GetProbe.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "GetProbe.response", err)
	}
}
...
func TestCheckResponseSnapshot_UpdateProbe(t *testing.T) {
	want := &UpdateProbeOutput{
		ProbeId:         ptr.String("__ProbeId__"),
		ProbeArn:        ptr.String("__ProbeArn__"),
		SourceArn:       ptr.String("__SourceArn__"),
		Destination:     ptr.String("__Destination__"),
	...
	status, header, body, err := serdeRespReadSnapshot("UpdateProbe.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "UpdateProbe.response", err)
	}
}
