...
func (c *Client) addOperationBatchAddChannelRoleToAccessorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchAddChannelRoleToAccessors", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
