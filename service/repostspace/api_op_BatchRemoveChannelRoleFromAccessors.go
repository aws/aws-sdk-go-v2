...
func (c *Client) addOperationBatchRemoveChannelRoleFromAccessorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchRemoveChannelRoleFromAccessors", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
