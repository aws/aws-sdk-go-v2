...
func TestCheckSnapshot_GetTaskInstance(t *testing.T) {
    svc := New(Options{})
    _, err := svc.GetTaskInstance(context.Background(), nil, func(o *Options) {
        o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
            return testSnapshot(stack, "GetTaskInstance")
        })
    })
    if _, ok := err.(snapshotOK); !ok && err != nil {
        t.Fatal(err)
...
func TestCheckSnapshot_ListTaskInstances(t *testing.T) {
    svc := New(Options{})
    _, err := svc.ListTaskInstances(context.Background(), nil, func(o *Options) {
        o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
            return testSnapshot(stack, "ListTaskInstances")
        })
    })
    if _, ok := err.(snapshotOK); !ok && err != nil {
        t.Fatal(err)
...
func TestUpdateSnapshot_GetTaskInstance(t *testing.T) {
    svc := New(Options{})
    _, err := svc.GetTaskInstance(context.Background(), nil, func(o *Options) {
        o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
            return updateSnapshot(stack, "GetTaskInstance")
        })
    })
    if _, ok := err.(snapshotOK); !ok && err != nil {
        t.Fatal(err)
...
func TestUpdateSnapshot_ListTaskInstances(t *testing.T) {
    svc := New(Options{})
    _, err := svc.ListTaskInstances(context.Background(), nil, func(o *Options) {
        o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
            return updateSnapshot(stack, "ListTaskInstances")
        })
    })
    if _, ok := err.(snapshotOK); !ok && err != nil {
        t.Fatal(err)
