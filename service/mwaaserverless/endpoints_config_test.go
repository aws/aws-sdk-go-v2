...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-mwaa-serverless.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mwaa-serverless.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mwaa-serverless.dev",
			expectURL:     aws.String("https://env-mwaa-serverless.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-mwaa-serverless.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mwaa-serverless.dev",
			expectURL:     aws.String("http://config-mwaa-serverless.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-mwaa-serverless.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-mwaa-serverless.dev",
			clientEndpoint: aws.String("https://client-mwaa-serverless.dev"),
			expectURL:      aws.String("https://client-mwaa-serverless.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MWAA_SERVERLESS", c.envService)
			}
