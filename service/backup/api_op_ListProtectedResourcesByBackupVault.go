...
func (c *Client) addOperationListProtectedResourcesByBackupVaultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListProtectedResourcesByBackupVault", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
