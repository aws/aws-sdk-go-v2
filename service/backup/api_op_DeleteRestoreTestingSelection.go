...
func (c *Client) addOperationDeleteRestoreTestingSelectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteRestoreTestingSelection", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
