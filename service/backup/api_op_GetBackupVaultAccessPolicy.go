...
func addOperationGetBackupVaultAccessPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationGetBackupVaultAccessPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetBackupVaultAccessPolicyStackSlots(stack); err != nil {
		return err
	}
