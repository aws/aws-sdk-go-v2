...
func (c *Client) addOperationListIndexedRecoveryPointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListIndexedRecoveryPoints", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
