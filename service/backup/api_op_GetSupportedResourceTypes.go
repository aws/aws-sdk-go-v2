...
func (c *Client) addOperationGetSupportedResourceTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSupportedResourceTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
