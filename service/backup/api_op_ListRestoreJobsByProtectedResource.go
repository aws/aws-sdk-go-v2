...
func (c *Client) addOperationListRestoreJobsByProtectedResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRestoreJobsByProtectedResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
