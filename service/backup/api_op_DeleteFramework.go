...
func (c *Client) DeleteFramework(ctx context.Context, params *DeleteFrameworkInput, optFns ...func(*Options)) (*DeleteFrameworkOutput, error) {
	if params == nil { params = &DeleteFrameworkInput{} }
...
func (c *Client) addOperationDeleteFrameworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteFrameworkResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteFrameworkResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteFrameworkResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteFrameworkResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteFrameworkResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteFrameworkResolveEndpointMiddleware{
