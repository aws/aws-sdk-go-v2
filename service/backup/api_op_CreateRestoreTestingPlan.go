...
func (c *Client) addOperationCreateRestoreTestingPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateRestoreTestingPlan", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
