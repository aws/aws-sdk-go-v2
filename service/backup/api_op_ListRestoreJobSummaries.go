...
func (c *Client) addOperationListRestoreJobSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRestoreJobSummariesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
func (*opListRestoreJobSummariesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRestoreJobSummariesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRestoreJobSummariesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListRestoreJobSummariesResolveEndpointMiddleware{
