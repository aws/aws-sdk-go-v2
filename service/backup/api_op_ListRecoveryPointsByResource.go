...
func addOperationListRecoveryPointsByResourceStackSlots(stack *middleware.Stack) error {
...
func addOperationListRecoveryPointsByResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListRecoveryPointsByResourceStackSlots(stack); err != nil {
		return err
	}
