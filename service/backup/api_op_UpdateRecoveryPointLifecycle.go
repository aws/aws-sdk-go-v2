...
func (c *Client) addOperationUpdateRecoveryPointLifecycleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRecoveryPointLifecycle", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
