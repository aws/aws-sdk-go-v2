...
func addOperationUpdateRecoveryPointLifecycleStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateRecoveryPointLifecycleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateRecoveryPointLifecycleStackSlots(stack); err != nil {
		return err
	}
