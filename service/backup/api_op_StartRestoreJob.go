...
type StartRestoreJobInput struct {
	...
	// by GetRecoveryPointRestoreMetadata might be required to restore a resource.
	// For example, you might need to provide a new resource name if the original
	// already exists. You need to specify specific metadata to restore an Amazon
