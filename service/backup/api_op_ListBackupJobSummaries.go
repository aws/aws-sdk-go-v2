...
func (c *Client) addOperationListBackupJobSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBackupJobSummariesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListBackupJobSummariesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListBackupJobSummariesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBackupJobSummariesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListBackupJobSummariesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListBackupJobSummariesResolveEndpointMiddleware{
