...
func (c *Client) PutBackupVaultAccessPolicy(ctx context.Context, params *PutBackupVaultAccessPolicyInput, optFns ...func(*Options)) (*PutBackupVaultAccessPolicyOutput, error) {
	if params == nil { params = &PutBackupVaultAccessPolicyInput{} }
...
func (c *Client) addOperationPutBackupVaultAccessPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutBackupVaultAccessPolicyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutBackupVaultAccessPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutBackupVaultAccessPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutBackupVaultAccessPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutBackupVaultAccessPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutBackupVaultAccessPolicyResolveEndpointMiddleware{
