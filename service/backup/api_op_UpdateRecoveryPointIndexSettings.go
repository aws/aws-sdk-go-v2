...
func (c *Client) addOperationUpdateRecoveryPointIndexSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRecoveryPointIndexSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
