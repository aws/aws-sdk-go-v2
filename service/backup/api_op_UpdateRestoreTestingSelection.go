...
func (c *Client) addOperationUpdateRestoreTestingSelectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRestoreTestingSelection", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
