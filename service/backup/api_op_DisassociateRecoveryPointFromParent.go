...
func (c *Client) addOperationDisassociateRecoveryPointFromParentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateRecoveryPointFromParent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
