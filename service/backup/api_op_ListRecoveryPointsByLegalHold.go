...
func (c *Client) ListRecoveryPointsByLegalHold(ctx context.Context, params *ListRecoveryPointsByLegalHoldInput, optFns ...func(*Options)) (*ListRecoveryPointsByLegalHoldOutput, error) {
	if params == nil { params = &ListRecoveryPointsByLegalHoldInput{} }
...
func (c *Client) addOperationListRecoveryPointsByLegalHoldMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRecoveryPointsByLegalHoldResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRecoveryPointsByLegalHoldResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRecoveryPointsByLegalHoldResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRecoveryPointsByLegalHoldResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRecoveryPointsByLegalHoldResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRecoveryPointsByLegalHoldResolveEndpointMiddleware{
