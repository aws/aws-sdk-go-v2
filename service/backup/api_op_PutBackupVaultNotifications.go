...
type PutBackupVaultNotificationsInput struct {
	...
	// the backup vault. For common use cases and code samples, see Using Amazon SNS
	// to track Backup events (https://docs.aws.amazon.com/aws-backup/latest/devguide/sns-notifications.html)
	...
	// items that are deprecated events (for reference) and are no longer in use. They
	// are no longer supported and will not return statuses or notifications. Refer to
	// the list above for current supported events.
	//
