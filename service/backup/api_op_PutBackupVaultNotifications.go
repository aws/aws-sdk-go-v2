...
func addOperationPutBackupVaultNotificationsStackSlots(stack *middleware.Stack) error {
...
func addOperationPutBackupVaultNotificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutBackupVaultNotificationsStackSlots(stack); err != nil {
		return err
	}
