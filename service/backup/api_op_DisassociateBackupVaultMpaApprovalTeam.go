...
func (c *Client) addOperationDisassociateBackupVaultMpaApprovalTeamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateBackupVaultMpaApprovalTeam", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
