...
func (c *Client) addOperationDescribeProtectedResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeProtectedResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
