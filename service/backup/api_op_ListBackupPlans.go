...
func (c *Client) addOperationListBackupPlansMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBackupPlansResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListBackupPlansResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListBackupPlansResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBackupPlansResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListBackupPlansResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListBackupPlansResolveEndpointMiddleware{
