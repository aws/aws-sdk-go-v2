...
func addOperationGetBackupVaultNotificationsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetBackupVaultNotificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetBackupVaultNotificationsStackSlots(stack); err != nil {
		return err
	}
