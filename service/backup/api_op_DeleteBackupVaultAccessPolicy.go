...
func addOperationDeleteBackupVaultAccessPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteBackupVaultAccessPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteBackupVaultAccessPolicyStackSlots(stack); err != nil {
		return err
	}
