...
func (c *Client) addOperationDeleteBackupVaultAccessPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteBackupVaultAccessPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
