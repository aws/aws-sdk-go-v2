...
func (*DeleteBackupVaultNotificationsInput) operationName() string {
...
func (c *Client) addOperationDeleteBackupVaultNotificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteBackupVaultNotificationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteBackupVaultNotificationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteBackupVaultNotificationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteBackupVaultNotificationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteBackupVaultNotificationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteBackupVaultNotificationsResolveEndpointMiddleware{
