...
func addOperationDeleteBackupVaultNotificationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteBackupVaultNotificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteBackupVaultNotificationsStackSlots(stack); err != nil {
		return err
	}
