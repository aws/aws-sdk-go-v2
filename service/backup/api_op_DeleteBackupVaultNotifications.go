...
func (c *Client) addOperationDeleteBackupVaultNotificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteBackupVaultNotifications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
