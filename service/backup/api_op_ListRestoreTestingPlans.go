...
func (c *Client) addOperationListRestoreTestingPlansMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRestoreTestingPlans", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
