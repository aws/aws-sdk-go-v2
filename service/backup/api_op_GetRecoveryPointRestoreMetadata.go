...
func addOperationGetRecoveryPointRestoreMetadataStackSlots(stack *middleware.Stack) error {
...
func addOperationGetRecoveryPointRestoreMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetRecoveryPointRestoreMetadataStackSlots(stack); err != nil {
		return err
	}
