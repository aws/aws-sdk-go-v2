...
type awsRestjson1_serializeOpCreateBackupAccessPoint struct {
}

func (*awsRestjson1_serializeOpCreateBackupAccessPoint) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpCreateBackupAccessPoint) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/backup-access-point/create")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "PUT"
	var restEncoder *httpbinding.Encoder
	...
	jsonEncoder := smithyjson.NewEncoder()
	if err := awsRestjson1_serializeOpDocumentCreateBackupAccessPointInput(input, jsonEncoder.Value); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsCreateBackupAccessPointInput(v *CreateBackupAccessPointInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
func awsRestjson1_serializeOpDocumentCreateBackupAccessPointInput(v *CreateBackupAccessPointInput, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.AccessPointMetadata != nil {
		ok := object.Key("AccessPointMetadata")
		if err := awsRestjson1_serializeDocumentAccessPointMetadataMap(v.AccessPointMetadata, ok); err != nil {
			return err
		}
	}
...
type awsRestjson1_serializeOpCreateTieringConfiguration struct {
}

func (*awsRestjson1_serializeOpCreateTieringConfiguration) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpCreateTieringConfiguration) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/tiering-configurations")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "PUT"
	var restEncoder *httpbinding.Encoder
	...
	jsonEncoder := smithyjson.NewEncoder()
	if err := awsRestjson1_serializeOpDocumentCreateTieringConfigurationInput(input, jsonEncoder.Value); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsCreateTieringConfigurationInput(v *CreateTieringConfigurationInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
func awsRestjson1_serializeOpDocumentCreateTieringConfigurationInput(v *CreateTieringConfigurationInput, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
	...
	if v.TieringConfiguration != nil {
		ok := object.Key("TieringConfiguration")
		if err := awsRestjson1_serializeDocumentTieringConfigurationInputForCreate(v.TieringConfiguration, ok); err != nil {
			return err
		}
	}

	if v.TieringConfigurationTags != nil {
		ok := object.Key("TieringConfigurationTags")
		if err := awsRestjson1_serializeDocumentTags(v.TieringConfigurationTags, ok); err != nil {
			return err
		}
	}
...
type awsRestjson1_serializeOpDeleteBackupAccessPoint struct {
}

func (*awsRestjson1_serializeOpDeleteBackupAccessPoint) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpDeleteBackupAccessPoint) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/backup-access-point/delete/{AccessPointArn}")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "DELETE"
	var restEncoder *httpbinding.Encoder
	...
	if err := awsRestjson1_serializeOpHttpBindingsDeleteBackupAccessPointInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsDeleteBackupAccessPointInput(v *DeleteBackupAccessPointInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}

	if v.AccessPointArn == nil || len(*v.AccessPointArn) == 0 {
		return &smithy.SerializationError{Err: fmt.Errorf("input member AccessPointArn must not be empty")}
	}
	if v.AccessPointArn != nil {
		if err := encoder.SetURI("AccessPointArn").String(*v.AccessPointArn); err != nil {
			return err
		}
	}
...
type awsRestjson1_serializeOpDeleteTieringConfiguration struct {
}

func (*awsRestjson1_serializeOpDeleteTieringConfiguration) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpDeleteTieringConfiguration) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/tiering-configurations/{TieringConfigurationName}")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "DELETE"
	var restEncoder *httpbinding.Encoder
	...
	if err := awsRestjson1_serializeOpHttpBindingsDeleteTieringConfigurationInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsDeleteTieringConfigurationInput(v *DeleteTieringConfigurationInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}

	if v.TieringConfigurationName == nil || len(*v.TieringConfigurationName) == 0 {
		return &smithy.SerializationError{Err: fmt.Errorf("input member TieringConfigurationName must not be empty")}
	}
	if v.TieringConfigurationName != nil {
		if err := encoder.SetURI("TieringConfigurationName").String(*v.TieringConfigurationName); err != nil {
			return err
		}
	}
...
type awsRestjson1_serializeOpDescribeBackupAccessPoint struct {
}

func (*awsRestjson1_serializeOpDescribeBackupAccessPoint) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpDescribeBackupAccessPoint) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/backup-access-point/{AccessPointArn}")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "GET"
	var restEncoder *httpbinding.Encoder
	...
	if err := awsRestjson1_serializeOpHttpBindingsDescribeBackupAccessPointInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsDescribeBackupAccessPointInput(v *DescribeBackupAccessPointInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
type awsRestjson1_serializeOpGetTieringConfiguration struct {
}

func (*awsRestjson1_serializeOpGetTieringConfiguration) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpGetTieringConfiguration) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	if err := awsRestjson1_serializeOpHttpBindingsGetTieringConfigurationInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsGetTieringConfigurationInput(v *GetTieringConfigurationInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
type awsRestjson1_serializeOpListBackupAccessPoints struct {
}

func (*awsRestjson1_serializeOpListBackupAccessPoints) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpListBackupAccessPoints) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	input, ok := in.Parameters.(*ListBackupAccessPointsInput)
	_ = input
	if !ok {
		return out, metadata, &smithy.SerializationError{Err: fmt.Errorf("unknown input parameters type %T", in.Parameters)}
	}

	opPath, opQuery := httpbinding.SplitURI("/backup-access-point")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "GET"
	var restEncoder *httpbinding.Encoder
	...
	if err := awsRestjson1_serializeOpHttpBindingsListBackupAccessPointsInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsListBackupAccessPointsInput(v *ListBackupAccessPointsInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
type awsRestjson1_serializeOpListBackupAccessPointsByRecoveryPoint struct {
}

func (*awsRestjson1_serializeOpListBackupAccessPointsByRecoveryPoint) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpListBackupAccessPointsByRecoveryPoint) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/backup-access-point/recovery-point/{RecoveryPointArn}")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "POST"
	var restEncoder *httpbinding.Encoder
	...
	if err := awsRestjson1_serializeOpHttpBindingsListBackupAccessPointsByRecoveryPointInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsListBackupAccessPointsByRecoveryPointInput(v *ListBackupAccessPointsByRecoveryPointInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
type awsRestjson1_serializeOpListBackupAccessPointsByResource struct {
}

func (*awsRestjson1_serializeOpListBackupAccessPointsByResource) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpListBackupAccessPointsByResource) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/backup-access-point/resource/{ResourceArn}")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "POST"
	var restEncoder *httpbinding.Encoder
	...
	if err := awsRestjson1_serializeOpHttpBindingsListBackupAccessPointsByResourceInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsListBackupAccessPointsByResourceInput(v *ListBackupAccessPointsByResourceInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
type awsRestjson1_serializeOpListTieringConfigurations struct {
}

func (*awsRestjson1_serializeOpListTieringConfigurations) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpListTieringConfigurations) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	input, ok := in.Parameters.(*ListTieringConfigurationsInput)
	_ = input
	if !ok {
		return out, metadata, &smithy.SerializationError{Err: fmt.Errorf("unknown input parameters type %T", in.Parameters)}
	}
	...
	if err := awsRestjson1_serializeOpHttpBindingsListTieringConfigurationsInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsListTieringConfigurationsInput(v *ListTieringConfigurationsInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
type awsRestjson1_serializeOpUpdateTieringConfiguration struct {
}

func (*awsRestjson1_serializeOpUpdateTieringConfiguration) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpUpdateTieringConfiguration) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	if err := awsRestjson1_serializeOpHttpBindingsUpdateTieringConfigurationInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
	...
	jsonEncoder := smithyjson.NewEncoder()
	if err := awsRestjson1_serializeOpDocumentUpdateTieringConfigurationInput(input, jsonEncoder.Value); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsUpdateTieringConfigurationInput(v *UpdateTieringConfigurationInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
func awsRestjson1_serializeOpDocumentUpdateTieringConfigurationInput(v *UpdateTieringConfigurationInput, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.TieringConfiguration != nil {
		ok := object.Key("TieringConfiguration")
		if err := awsRestjson1_serializeDocumentTieringConfigurationInputForUpdate(v.TieringConfiguration, ok); err != nil {
			return err
		}
	}
...
func awsRestjson1_serializeDocumentAccessPointMetadataMap(v map[string]string, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
...
func awsRestjson1_serializeDocumentResourceSelection(v *types.ResourceSelection, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
	...
	if v.TieringDownSettingsInDays != nil {
		ok := object.Key("TieringDownSettingsInDays")
		ok.Integer(*v.TieringDownSettingsInDays)
	}

	return nil
}

func awsRestjson1_serializeDocumentResourceSelections(v []types.ResourceSelection, value smithyjson.Value) error {
	array := value.Array()
	defer array.Close()

	for i := range v {
		av := array.Value()
		if err := awsRestjson1_serializeDocumentResourceSelection(&v[i], av); err != nil {
			return err
		}
	}
	return nil
...
func awsRestjson1_serializeDocumentTieringConfigurationInputForCreate(v *types.TieringConfigurationInputForCreate, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
	...
	if v.ResourceSelection != nil {
		...
		if err := awsRestjson1_serializeDocumentResourceSelections(v.ResourceSelection, ok); err != nil {
			return err
		}
	}

	if v.TieringConfigurationName != nil {
		ok := object.Key("TieringConfigurationName")
		ok.String(*v.TieringConfigurationName)
	}

	return nil
}

func awsRestjson1_serializeDocumentTieringConfigurationInputForUpdate(v *types.TieringConfigurationInputForUpdate, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
