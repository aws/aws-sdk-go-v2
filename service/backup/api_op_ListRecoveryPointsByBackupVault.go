...
func (c *Client) ListRecoveryPointsByBackupVault(ctx context.Context, params *ListRecoveryPointsByBackupVaultInput, optFns ...func(*Options)) (*ListRecoveryPointsByBackupVaultOutput, error) {
	if params == nil { params = &ListRecoveryPointsByBackupVaultInput{} }
...
func (c *Client) addOperationListRecoveryPointsByBackupVaultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRecoveryPointsByBackupVaultResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRecoveryPointsByBackupVaultResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRecoveryPointsByBackupVaultResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRecoveryPointsByBackupVaultResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRecoveryPointsByBackupVaultResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRecoveryPointsByBackupVaultResolveEndpointMiddleware{
