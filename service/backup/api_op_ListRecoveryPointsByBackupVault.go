...
func (c *Client) addOperationListRecoveryPointsByBackupVaultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRecoveryPointsByBackupVault", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
