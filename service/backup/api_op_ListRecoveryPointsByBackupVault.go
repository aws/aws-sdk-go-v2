...
func addOperationListRecoveryPointsByBackupVaultStackSlots(stack *middleware.Stack) error {
...
func addOperationListRecoveryPointsByBackupVaultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListRecoveryPointsByBackupVaultStackSlots(stack); err != nil {
		return err
	}
