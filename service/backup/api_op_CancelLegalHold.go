...
func (c *Client) CancelLegalHold(ctx context.Context, params *CancelLegalHoldInput, optFns ...func(*Options)) (*CancelLegalHoldOutput, error) {
	if params == nil { params = &CancelLegalHoldInput{} }
...
func (c *Client) addOperationCancelLegalHoldMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelLegalHoldResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelLegalHoldResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelLegalHoldResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelLegalHoldResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelLegalHoldResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelLegalHoldResolveEndpointMiddleware{
