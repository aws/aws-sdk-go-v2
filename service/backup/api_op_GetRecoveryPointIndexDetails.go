...
func (c *Client) addOperationGetRecoveryPointIndexDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRecoveryPointIndexDetails", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
