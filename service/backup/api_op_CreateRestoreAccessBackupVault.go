...
func (c *Client) addOperationCreateRestoreAccessBackupVaultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateRestoreAccessBackupVault", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
