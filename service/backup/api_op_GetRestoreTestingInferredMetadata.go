...
func (c *Client) addOperationGetRestoreTestingInferredMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRestoreTestingInferredMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
