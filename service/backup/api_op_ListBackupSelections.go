...
func (c *Client) ListBackupSelections(ctx context.Context, params *ListBackupSelectionsInput, optFns ...func(*Options)) (*ListBackupSelectionsOutput, error) {
	if params == nil { params = &ListBackupSelectionsInput{} }
...
func (c *Client) addOperationListBackupSelectionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBackupSelectionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListBackupSelectionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListBackupSelectionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBackupSelectionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListBackupSelectionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListBackupSelectionsResolveEndpointMiddleware{
