...
func (c *Client) addOperationAddApplicationVpcConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AddApplicationVpcConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
