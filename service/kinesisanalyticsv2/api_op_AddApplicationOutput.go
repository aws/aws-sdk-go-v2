...
func (c *Client) AddApplicationOutput(ctx context.Context, params *AddApplicationOutputInput, optFns ...func(*Options)) (*AddApplicationOutputOutput, error) {
	if params == nil { params = &AddApplicationOutputInput{} }
...
func (c *Client) addOperationAddApplicationOutputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAddApplicationOutputResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAddApplicationOutputResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAddApplicationOutputResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAddApplicationOutputResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAddApplicationOutputResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAddApplicationOutputResolveEndpointMiddleware{
