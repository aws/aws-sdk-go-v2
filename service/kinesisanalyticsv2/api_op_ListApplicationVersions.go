...
func (c *Client) addOperationListApplicationVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListApplicationVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
