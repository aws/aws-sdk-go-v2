...
func (v *DeleteApplicationSnapshotOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DeleteApplicationSnapshotResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DeleteApplicationSnapshotOutput) SerializeMembers(s smithy.ShapeSerializer) {
}
