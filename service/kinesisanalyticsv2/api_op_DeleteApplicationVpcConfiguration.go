...
func (c *Client) addOperationDeleteApplicationVpcConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteApplicationVpcConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
