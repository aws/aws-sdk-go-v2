...
func (c *Client) addOperationListApplicationSnapshotsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListApplicationSnapshots", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
