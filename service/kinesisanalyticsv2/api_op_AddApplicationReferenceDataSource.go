...
func addOperationAddApplicationReferenceDataSourceStackSlots(stack *middleware.Stack) error {
...
func addOperationAddApplicationReferenceDataSourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAddApplicationReferenceDataSourceStackSlots(stack); err != nil {
		return err
	}
