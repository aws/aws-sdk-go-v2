...
// requests to Kinesis Analytics V2.
//
...
// Using the Client
//
// To use Kinesis Analytics V2 with the SDK use the New function to create
...
//
// See the Kinesis Analytics V2 client for more information on
