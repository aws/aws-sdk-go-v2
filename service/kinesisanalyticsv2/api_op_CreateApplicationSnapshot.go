...
func (c *Client) addOperationCreateApplicationSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateApplicationSnapshot", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
