...
func (c *Client) addOperationCheckSchemaVersionValidityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CheckSchemaVersionValidity", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
