...
func (c *Client) addOperationUpdateColumnStatisticsTaskSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateColumnStatisticsTaskSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
