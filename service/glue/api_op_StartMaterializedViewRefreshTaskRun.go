...
func (c *Client) addOperationStartMaterializedViewRefreshTaskRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartMaterializedViewRefreshTaskRun", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
