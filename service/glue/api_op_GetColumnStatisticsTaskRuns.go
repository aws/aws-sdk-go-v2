...
func (c *Client) addOperationGetColumnStatisticsTaskRunsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetColumnStatisticsTaskRuns", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
