...
type CreateMLTransformInput struct {
	...
	// pricing page (https://aws.amazon.com/glue/pricing/) . MaxCapacity is a
	// mutually exclusive option with NumberOfWorkers  and WorkerType .
	...
	// task runs. If WorkerType  is set, then NumberOfWorkers is required (and vice
	// versa).
	...
	// in Glue, see Amazon Web Services Tags in Glue (https://docs.aws.amazon.com/glue/latest/dg/monitor-tags.html)
	// in the developer guide.
