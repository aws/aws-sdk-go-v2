...
func (c *Client) addOperationDeleteDataQualityRulesetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDataQualityRuleset", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
