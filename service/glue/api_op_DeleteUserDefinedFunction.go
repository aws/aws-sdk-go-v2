...
func (c *Client) addOperationDeleteUserDefinedFunctionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteUserDefinedFunction", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
