...
func (c *Client) GetClassifier(ctx context.Context, params *GetClassifierInput, optFns ...func(*Options)) (*GetClassifierOutput, error) {
	stack := middleware.NewStack("GetClassifier", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpGetClassifierMiddlewares(stack)
...
func addawsAwsjson11_serdeOpGetClassifierMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpGetClassifier{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpGetClassifier{}, middleware.After)
}
