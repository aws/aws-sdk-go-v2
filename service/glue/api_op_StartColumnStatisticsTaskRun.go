...
func (c *Client) addOperationStartColumnStatisticsTaskRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartColumnStatisticsTaskRun", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
