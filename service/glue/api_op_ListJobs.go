...
// available in your account, and their names. This operation takes the optional
// Tags field, which you can use as a filter on the response so that tagged
// resources can be retrieved as a group. If you choose to use tags filtering, only
