...
func (c *Client) addOperationUpdateTableOptimizerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateTableOptimizerResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateTableOptimizerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateTableOptimizerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateTableOptimizerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateTableOptimizerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateTableOptimizerResolveEndpointMiddleware{
