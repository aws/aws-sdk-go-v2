...
func (c *Client) addOperationGetUnfilteredPartitionMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetUnfilteredPartitionMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
