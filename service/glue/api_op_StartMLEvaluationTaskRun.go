...
func (c *Client) addOperationStartMLEvaluationTaskRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartMLEvaluationTaskRun", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
