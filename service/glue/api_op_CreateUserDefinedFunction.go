...
func (c *Client) addOperationCreateUserDefinedFunctionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateUserDefinedFunction", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
