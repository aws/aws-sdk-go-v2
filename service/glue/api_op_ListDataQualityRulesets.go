...
func (c *Client) addOperationListDataQualityRulesetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDataQualityRulesets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
