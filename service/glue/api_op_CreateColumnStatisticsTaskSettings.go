...
func (c *Client) addOperationCreateColumnStatisticsTaskSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateColumnStatisticsTaskSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
