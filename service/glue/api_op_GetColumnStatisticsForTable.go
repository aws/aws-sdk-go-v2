...
func (c *Client) addOperationGetColumnStatisticsForTableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetColumnStatisticsForTable", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
