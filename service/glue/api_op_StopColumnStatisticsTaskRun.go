...
func (c *Client) addOperationStopColumnStatisticsTaskRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopColumnStatisticsTaskRun", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
