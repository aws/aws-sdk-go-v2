...
func (c *Client) addOperationListDataQualityRulesetEvaluationRunsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDataQualityRulesetEvaluationRuns", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
