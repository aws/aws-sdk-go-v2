...
func (c *Client) addOperationStartDataQualityRulesetEvaluationRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartDataQualityRulesetEvaluationRun", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
