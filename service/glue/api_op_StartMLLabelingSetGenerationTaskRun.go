...
func addOperationStartMLLabelingSetGenerationTaskRunStackSlots(stack *middleware.Stack) error {
...
func addOperationStartMLLabelingSetGenerationTaskRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartMLLabelingSetGenerationTaskRunStackSlots(stack); err != nil {
		return err
	}
