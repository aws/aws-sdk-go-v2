...
func (c *Client) addOperationStartMLLabelingSetGenerationTaskRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartMLLabelingSetGenerationTaskRun", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
