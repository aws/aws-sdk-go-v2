...
func (c *Client) addOperationQuerySchemaVersionMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "QuerySchemaVersionMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
