...
func (c *Client) addOperationGetColumnStatisticsTaskRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetColumnStatisticsTaskRun", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
