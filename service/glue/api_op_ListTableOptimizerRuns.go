...
func (c *Client) addOperationListTableOptimizerRunsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTableOptimizerRunsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListTableOptimizerRunsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListTableOptimizerRunsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTableOptimizerRunsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTableOptimizerRunsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListTableOptimizerRunsResolveEndpointMiddleware{
