...
func (c *Client) addOperationListColumnStatisticsTaskRunsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListColumnStatisticsTaskRuns", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
