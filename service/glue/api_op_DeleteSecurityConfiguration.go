...
func addOperationDeleteSecurityConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteSecurityConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteSecurityConfigurationStackSlots(stack); err != nil {
		return err
	}
