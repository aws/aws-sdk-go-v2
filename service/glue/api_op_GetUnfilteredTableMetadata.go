...
func (c *Client) addOperationGetUnfilteredTableMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetUnfilteredTableMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
