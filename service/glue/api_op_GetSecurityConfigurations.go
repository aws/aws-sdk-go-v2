...
func (c *Client) addOperationGetSecurityConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSecurityConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
