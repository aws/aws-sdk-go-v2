...
func (c *Client) addOperationGetIntegrationResourcePropertyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetIntegrationResourceProperty", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
