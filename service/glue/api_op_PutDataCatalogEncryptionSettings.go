...
func addOperationPutDataCatalogEncryptionSettingsStackSlots(stack *middleware.Stack) error {
...
func addOperationPutDataCatalogEncryptionSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutDataCatalogEncryptionSettingsStackSlots(stack); err != nil {
		return err
	}
