...
func addOperationGetColumnStatisticsForPartitionStackSlots(stack *middleware.Stack) error {
...
func addOperationGetColumnStatisticsForPartitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetColumnStatisticsForPartitionStackSlots(stack); err != nil {
		return err
	}
