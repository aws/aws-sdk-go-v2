...
func (c *Client) addOperationRemoveSchemaVersionMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RemoveSchemaVersionMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
