...
func (c *Client) addOperationGetUnfilteredPartitionsMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetUnfilteredPartitionsMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
