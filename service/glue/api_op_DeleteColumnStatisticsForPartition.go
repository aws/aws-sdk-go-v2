...
func (c *Client) addOperationDeleteColumnStatisticsForPartitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteColumnStatisticsForPartition", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
