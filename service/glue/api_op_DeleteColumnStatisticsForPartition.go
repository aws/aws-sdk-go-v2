...
func addOperationDeleteColumnStatisticsForPartitionStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteColumnStatisticsForPartitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteColumnStatisticsForPartitionStackSlots(stack); err != nil {
		return err
	}
