...
func addOperationGetDataCatalogEncryptionSettingsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetDataCatalogEncryptionSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetDataCatalogEncryptionSettingsStackSlots(stack); err != nil {
		return err
	}
