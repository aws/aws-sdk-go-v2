...
func (c *Client) addOperationDeleteGlueIdentityCenterConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteGlueIdentityCenterConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
