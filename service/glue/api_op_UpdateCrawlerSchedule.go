...
func (c *Client) UpdateCrawlerSchedule(ctx context.Context, params *UpdateCrawlerScheduleInput, optFns ...func(*Options)) (*UpdateCrawlerScheduleOutput, error) {
	stack := middleware.NewStack("UpdateCrawlerSchedule", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpUpdateCrawlerScheduleMiddlewares(stack)
	...
	addOpUpdateCrawlerScheduleValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opUpdateCrawlerSchedule(options.Region), middleware.Before)
...
func addawsAwsjson11_serdeOpUpdateCrawlerScheduleMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpUpdateCrawlerSchedule{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpUpdateCrawlerSchedule{}, middleware.After)
}
