...
func (c *Client) addOperationBatchGetDataQualityResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetDataQualityResult", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
