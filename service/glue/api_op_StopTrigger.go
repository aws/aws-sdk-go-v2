...
func (c *Client) StopTrigger(ctx context.Context, params *StopTriggerInput, optFns ...func(*Options)) (*StopTriggerOutput, error) {
	stack := middleware.NewStack("StopTrigger", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpStopTriggerMiddlewares(stack)
...
func addawsAwsjson11_serdeOpStopTriggerMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpStopTrigger{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpStopTrigger{}, middleware.After)
}
