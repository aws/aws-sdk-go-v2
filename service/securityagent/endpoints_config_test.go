...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-securityagent.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-securityagent.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-securityagent.dev",
			expectURL:     aws.String("https://env-securityagent.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-securityagent.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-securityagent.dev",
			expectURL:     aws.String("http://config-securityagent.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-securityagent.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-securityagent.dev",
			clientEndpoint: aws.String("https://client-securityagent.dev"),
			expectURL:      aws.String("https://client-securityagent.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SECURITYAGENT", c.envService)
			}
