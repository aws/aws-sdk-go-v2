...
func (c *Client) addOperationListCodeReviewJobsForCodeReviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListCodeReviewJobsForCodeReview(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opListCodeReviewJobsForCodeReview(region string) *awsmiddleware.RegisterServiceMetadata {
