...
func (c *Client) addOperationUpdateThreatModelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "UpdateThreatModel"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opUpdateThreatModel(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opUpdateThreatModel(region string) *awsmiddleware.RegisterServiceMetadata {
