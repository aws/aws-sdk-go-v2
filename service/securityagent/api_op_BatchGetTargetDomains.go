...
func (c *Client) BatchGetTargetDomains(ctx context.Context, params *BatchGetTargetDomainsInput, optFns ...func(*Options)) (*BatchGetTargetDomainsOutput, error) {
	if params == nil { params = &BatchGetTargetDomainsInput{} }
...
func (c *Client) addOperationBatchGetTargetDomainsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opBatchGetTargetDomains(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opBatchGetTargetDomains(region string) *awsmiddleware.RegisterServiceMetadata {
