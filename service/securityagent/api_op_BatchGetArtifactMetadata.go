...
func (c *Client) addOperationBatchGetArtifactMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetArtifactMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
