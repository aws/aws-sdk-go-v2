...
func (c *Client) addOperationInitiateProviderRegistrationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "InitiateProviderRegistration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
