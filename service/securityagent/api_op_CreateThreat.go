...
func (c *Client) addOperationCreateThreatMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "CreateThreat"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opCreateThreat(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opCreateThreat(region string) *awsmiddleware.RegisterServiceMetadata {
