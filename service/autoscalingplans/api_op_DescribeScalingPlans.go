...
func (*DescribeScalingPlansInput) operationName() string {
	return "DescribeScalingPlans"
}
...
func (c *Client) addOperationDescribeScalingPlansMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeScalingPlansResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeScalingPlansResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeScalingPlansResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeScalingPlansResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeScalingPlansResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeScalingPlansResolveEndpointMiddleware{
