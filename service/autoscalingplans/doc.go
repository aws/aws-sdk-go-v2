...
// users required permissions for AWS Auto Scaling actions, see the AWS Auto
// Scaling User Guide (https://docs.aws.amazon.com/autoscaling/plans/userguide/what-is-aws-auto-scaling.html)
// .
