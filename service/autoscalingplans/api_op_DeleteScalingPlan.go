...
func (*DeleteScalingPlanInput) operationName() string {
	return "DeleteScalingPlan"
}
...
func (c *Client) addOperationDeleteScalingPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteScalingPlanResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteScalingPlanResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteScalingPlanResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteScalingPlanResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteScalingPlanResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteScalingPlanResolveEndpointMiddleware{
