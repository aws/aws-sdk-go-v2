...
func addOperationDescribeScalingPlanResourcesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeScalingPlanResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeScalingPlanResourcesStackSlots(stack); err != nil {
		return err
	}
