...
func addOperationGetScalingPlanResourceForecastDataStackSlots(stack *middleware.Stack) error {
...
func addOperationGetScalingPlanResourceForecastDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetScalingPlanResourceForecastDataStackSlots(stack); err != nil {
		return err
	}
