...
func (c *Client) addOperationGetScalingPlanResourceForecastDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetScalingPlanResourceForecastData", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
