...
// Using the Client
//
// To use Kinesis Analytics with the SDK use the New function to create
...
//
// See the Kinesis Analytics client for more information on
