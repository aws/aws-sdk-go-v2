...
// log streams with Amazon Kinesis Analytics applications, see Working with
// Amazon CloudWatch Logs (https://docs.aws.amazon.com/kinesisanalytics/latest/dev/cloudwatch-logs.html)
// .
