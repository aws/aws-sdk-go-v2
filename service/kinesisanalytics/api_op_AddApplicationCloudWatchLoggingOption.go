...
func (c *Client) AddApplicationCloudWatchLoggingOption(ctx context.Context, params *AddApplicationCloudWatchLoggingOptionInput, optFns ...func(*Options)) (*AddApplicationCloudWatchLoggingOptionOutput, error) {
	if params == nil { params = &AddApplicationCloudWatchLoggingOptionInput{} }
...
func (c *Client) addOperationAddApplicationCloudWatchLoggingOptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAddApplicationCloudWatchLoggingOptionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAddApplicationCloudWatchLoggingOptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAddApplicationCloudWatchLoggingOptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAddApplicationCloudWatchLoggingOptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAddApplicationCloudWatchLoggingOptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAddApplicationCloudWatchLoggingOptionResolveEndpointMiddleware{
