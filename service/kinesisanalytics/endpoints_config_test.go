...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-kinesis-analytics.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kinesis-analytics.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kinesis-analytics.dev",
			expectURL:     aws.String("https://env-kinesis-analytics.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-kinesis-analytics.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kinesis-analytics.dev",
			expectURL:     aws.String("http://config-kinesis-analytics.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-kinesis-analytics.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-kinesis-analytics.dev",
			clientEndpoint: aws.String("https://client-kinesis-analytics.dev"),
			expectURL:      aws.String("https://client-kinesis-analytics.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_KINESIS_ANALYTICS", c.envService)
			}
