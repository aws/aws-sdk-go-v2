...
func (c *Client) addOperationListConfigurationManagersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListConfigurationManagers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
