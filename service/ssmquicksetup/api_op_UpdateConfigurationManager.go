...
func (c *Client) addOperationUpdateConfigurationManagerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateConfigurationManager", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
