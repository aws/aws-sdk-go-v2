...
type IntentSummary struct {
	...
	// If the user confirms the intent, Amazon Lex sets this field to Confirmed. If
	// the user denies the intent, Amazon Lex sets this value to Denied. The possible
	// values are:
