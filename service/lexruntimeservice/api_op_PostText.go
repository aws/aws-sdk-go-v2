...
type PostTextInput struct {
	...
	// userIDfield. To decide the user ID to use for your application, consider the
	// following factors.
	...
	// information, see Setting Request Attributes (https://docs.aws.amazon.com/lex/latest/dg/context-mgmt.html#context-mgmt-request-attribs)
	// .
...
type PostTextOutput struct {
	...
	// dialogAction.typeits response, Amazon Lex decides on the next course of action
	...
	// TOP_RESOLUTIONAmazon Lex returns the first value in the resolution list or, if
