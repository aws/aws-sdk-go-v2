...
func (c *Client) PostContent(ctx context.Context, params *PostContentInput, optFns ...func(*Options)) (*PostContentOutput, error) {
	if params == nil { params = &PostContentInput{} }
...
func (c *Client) addOperationPostContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPostContentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPostContentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPostContentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPostContentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPostContentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPostContentResolveEndpointMiddleware{
