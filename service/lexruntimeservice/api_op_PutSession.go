...
type PutSessionInput struct {
	...
	// if a GetSession  request returns three intents in the summary view and you call
...
type PutSessionOutput struct {
	...
	// The next message that should be presented to the user. The encodedMessage
	...
	// during the conversation. Amazon Lex creates a resolution list containing likely
	...
	// valueSelectionStrategy is set to ORIGINAL_VALUE, the value provided by the
	// user is returned, if the user value is similar to the slot values. If
