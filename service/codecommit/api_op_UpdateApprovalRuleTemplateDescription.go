...
func addOperationUpdateApprovalRuleTemplateDescriptionStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateApprovalRuleTemplateDescriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateApprovalRuleTemplateDescriptionStackSlots(stack); err != nil {
		return err
	}
