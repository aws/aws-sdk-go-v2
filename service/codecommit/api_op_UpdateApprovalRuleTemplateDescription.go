...
func (c *Client) UpdateApprovalRuleTemplateDescription(ctx context.Context, params *UpdateApprovalRuleTemplateDescriptionInput, optFns ...func(*Options)) (*UpdateApprovalRuleTemplateDescriptionOutput, error) {
	if params == nil { params = &UpdateApprovalRuleTemplateDescriptionInput{} }
...
func (c *Client) addOperationUpdateApprovalRuleTemplateDescriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateApprovalRuleTemplateDescriptionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateApprovalRuleTemplateDescriptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateApprovalRuleTemplateDescriptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateApprovalRuleTemplateDescriptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateApprovalRuleTemplateDescriptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateApprovalRuleTemplateDescriptionResolveEndpointMiddleware{
