...
func (c *Client) addOperationUpdatePullRequestApprovalRuleContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdatePullRequestApprovalRuleContent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
