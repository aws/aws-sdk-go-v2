...
type UpdatePullRequestApprovalRuleContentInput struct {
	...
	// - A federated user identified in IAM
	// as Mary_Major (arn:aws:sts::123456789012:federated-user/Mary_Major)
	//
	// This option
	// does not recognize an active session of someone assuming the role of
