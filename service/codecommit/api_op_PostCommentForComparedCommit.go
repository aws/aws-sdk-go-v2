...
func (c *Client) addOperationPostCommentForComparedCommitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PostCommentForComparedCommit", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
