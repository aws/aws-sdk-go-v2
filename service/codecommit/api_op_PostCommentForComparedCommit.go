...
func addOperationPostCommentForComparedCommitStackSlots(stack *middleware.Stack) error {
...
func addOperationPostCommentForComparedCommitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPostCommentForComparedCommitStackSlots(stack); err != nil {
		return err
	}
