...
func (c *Client) UpdatePullRequestDescription(ctx context.Context, params *UpdatePullRequestDescriptionInput, optFns ...func(*Options)) (*UpdatePullRequestDescriptionOutput, error) {
	if params == nil { params = &UpdatePullRequestDescriptionInput{} }
...
func (c *Client) addOperationUpdatePullRequestDescriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdatePullRequestDescriptionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdatePullRequestDescriptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdatePullRequestDescriptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdatePullRequestDescriptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdatePullRequestDescriptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdatePullRequestDescriptionResolveEndpointMiddleware{
