...
func (c *Client) addOperationBatchDescribeMergeConflictsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDescribeMergeConflicts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
