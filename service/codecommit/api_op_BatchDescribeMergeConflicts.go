...
func addOperationBatchDescribeMergeConflictsStackSlots(stack *middleware.Stack) error {
...
func addOperationBatchDescribeMergeConflictsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationBatchDescribeMergeConflictsStackSlots(stack); err != nil {
		return err
	}
