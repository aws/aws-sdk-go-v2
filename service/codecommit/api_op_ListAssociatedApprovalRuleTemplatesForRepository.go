...
func (c *Client) ListAssociatedApprovalRuleTemplatesForRepository(ctx context.Context, params *ListAssociatedApprovalRuleTemplatesForRepositoryInput, optFns ...func(*Options)) (*ListAssociatedApprovalRuleTemplatesForRepositoryOutput, error) {
	if params == nil { params = &ListAssociatedApprovalRuleTemplatesForRepositoryInput{} }
...
func (c *Client) addOperationListAssociatedApprovalRuleTemplatesForRepositoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAssociatedApprovalRuleTemplatesForRepositoryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAssociatedApprovalRuleTemplatesForRepositoryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAssociatedApprovalRuleTemplatesForRepositoryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAssociatedApprovalRuleTemplatesForRepositoryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAssociatedApprovalRuleTemplatesForRepositoryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAssociatedApprovalRuleTemplatesForRepositoryResolveEndpointMiddleware{
