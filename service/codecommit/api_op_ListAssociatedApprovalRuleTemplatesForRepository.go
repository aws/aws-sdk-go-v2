...
func (c *Client) addOperationListAssociatedApprovalRuleTemplatesForRepositoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAssociatedApprovalRuleTemplatesForRepository", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
