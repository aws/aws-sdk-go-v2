...
func (c *Client) addOperationAssociateApprovalRuleTemplateWithRepositoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateApprovalRuleTemplateWithRepository", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
