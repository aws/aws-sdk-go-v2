...
func addOperationAssociateApprovalRuleTemplateWithRepositoryStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociateApprovalRuleTemplateWithRepositoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociateApprovalRuleTemplateWithRepositoryStackSlots(stack); err != nil {
		return err
	}
