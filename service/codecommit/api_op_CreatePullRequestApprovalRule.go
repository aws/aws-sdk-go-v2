...
func addOperationCreatePullRequestApprovalRuleStackSlots(stack *middleware.Stack) error {
...
func addOperationCreatePullRequestApprovalRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreatePullRequestApprovalRuleStackSlots(stack); err != nil {
		return err
	}
