...
func (c *Client) addOperationCreatePullRequestApprovalRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreatePullRequestApprovalRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
