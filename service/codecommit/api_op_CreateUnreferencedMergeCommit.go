...
func addOperationCreateUnreferencedMergeCommitStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateUnreferencedMergeCommitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateUnreferencedMergeCommitStackSlots(stack); err != nil {
		return err
	}
