...
func (c *Client) addOperationCreateUnreferencedMergeCommitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateUnreferencedMergeCommit", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
