...
func (c *Client) CreateUnreferencedMergeCommit(ctx context.Context, params *CreateUnreferencedMergeCommitInput, optFns ...func(*Options)) (*CreateUnreferencedMergeCommitOutput, error) {
	if params == nil { params = &CreateUnreferencedMergeCommitInput{} }
...
func (c *Client) addOperationCreateUnreferencedMergeCommitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateUnreferencedMergeCommitResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateUnreferencedMergeCommitResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateUnreferencedMergeCommitResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateUnreferencedMergeCommitResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateUnreferencedMergeCommitResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateUnreferencedMergeCommitResolveEndpointMiddleware{
