...
// objects:  <p>Repositories, by calling the following:</p> <ul> <li> <p>
...
// <a>CreateRepository</a>, which creates an AWS CodeCommit repository.</p> </li>
// <li> <p> <a>DeleteRepository</a>, which deletes an AWS CodeCommit
// repository.</p> </li> <li> <p> <a>GetRepository</a>, which returns information
// about a specified repository.</p> </li> <li> <p> <a>ListRepositories</a>, which
// lists all AWS CodeCommit repositories associated with your AWS account.</p>
...
// the new HTTPS or SSH URL to use.</p> </li> </ul> <p>Branches, by calling the
// following:</p> <ul> <li> <p> <a>CreateBranch</a>, which creates a branch in a
// specified repository.</p> </li> <li> <p> <a>DeleteBranch</a>, which deletes the
// specified branch in a repository unless it is the default branch.</p> </li> <li>
// <p> <a>GetBranch</a>, which returns information about a specified branch.</p>
// </li> <li> <p> <a>ListBranches</a>, which lists all branches for a specified
...
// following:</p> <ul> <li> <p> <a>DeleteFile</a>, which deletes the content of a
// specified file from a specified branch.</p> </li> <li> <p> <a>GetBlob</a>, which
// returns the base-64 encoded content of an individual Git blob object in a
// repository.</p> </li> <li> <p> <a>GetFile</a>, which returns the base-64 encoded
...
// <a>PutFile</a>, which adds or modifies a single file in a specified repository
...
func addClientUserAgent(stack *middleware.Stack) {
	awsmiddleware.AddUserAgentKey("codecommit")(stack)
}
