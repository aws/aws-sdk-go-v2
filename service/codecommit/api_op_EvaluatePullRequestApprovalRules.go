...
func (c *Client) EvaluatePullRequestApprovalRules(ctx context.Context, params *EvaluatePullRequestApprovalRulesInput, optFns ...func(*Options)) (*EvaluatePullRequestApprovalRulesOutput, error) {
	if params == nil { params = &EvaluatePullRequestApprovalRulesInput{} }
...
func (c *Client) addOperationEvaluatePullRequestApprovalRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEvaluatePullRequestApprovalRulesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEvaluatePullRequestApprovalRulesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEvaluatePullRequestApprovalRulesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEvaluatePullRequestApprovalRulesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEvaluatePullRequestApprovalRulesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEvaluatePullRequestApprovalRulesResolveEndpointMiddleware{
