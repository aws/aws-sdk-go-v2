...
func (c *Client) addOperationEvaluatePullRequestApprovalRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EvaluatePullRequestApprovalRules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
