...
func (c *Client) GetComment(ctx context.Context, params *GetCommentInput, optFns ...func(*Options)) (*GetCommentOutput, error) {
	if params == nil { params = &GetCommentInput{} }
...
func (c *Client) addOperationGetCommentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCommentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCommentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCommentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCommentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCommentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCommentResolveEndpointMiddleware{
