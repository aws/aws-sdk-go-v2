...
func (c *Client) addOperationUpdatePullRequestApprovalStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdatePullRequestApprovalState", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
