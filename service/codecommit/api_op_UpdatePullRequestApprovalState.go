...
func (c *Client) UpdatePullRequestApprovalState(ctx context.Context, params *UpdatePullRequestApprovalStateInput, optFns ...func(*Options)) (*UpdatePullRequestApprovalStateOutput, error) {
	if params == nil { params = &UpdatePullRequestApprovalStateInput{} }
...
func (c *Client) addOperationUpdatePullRequestApprovalStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdatePullRequestApprovalStateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdatePullRequestApprovalStateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdatePullRequestApprovalStateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdatePullRequestApprovalStateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdatePullRequestApprovalStateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdatePullRequestApprovalStateResolveEndpointMiddleware{
