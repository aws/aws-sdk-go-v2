...
func (c *Client) MergePullRequestByThreeWay(ctx context.Context, params *MergePullRequestByThreeWayInput, optFns ...func(*Options)) (*MergePullRequestByThreeWayOutput, error) {
	if params == nil { params = &MergePullRequestByThreeWayInput{} }
...
func (c *Client) addOperationMergePullRequestByThreeWayMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addMergePullRequestByThreeWayResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opMergePullRequestByThreeWayResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opMergePullRequestByThreeWayResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opMergePullRequestByThreeWayResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addMergePullRequestByThreeWayResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opMergePullRequestByThreeWayResolveEndpointMiddleware{
