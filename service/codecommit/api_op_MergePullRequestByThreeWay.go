...
func addOperationMergePullRequestByThreeWayStackSlots(stack *middleware.Stack) error {
...
func addOperationMergePullRequestByThreeWayMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationMergePullRequestByThreeWayStackSlots(stack); err != nil {
		return err
	}
