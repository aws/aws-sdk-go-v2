...
func (c *Client) addOperationMergePullRequestByThreeWayMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "MergePullRequestByThreeWay", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
