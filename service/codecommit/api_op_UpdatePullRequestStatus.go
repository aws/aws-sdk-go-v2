...
func (*UpdatePullRequestStatusInput) operationName() string {
...
func (c *Client) addOperationUpdatePullRequestStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdatePullRequestStatusResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdatePullRequestStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdatePullRequestStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdatePullRequestStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdatePullRequestStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdatePullRequestStatusResolveEndpointMiddleware{
