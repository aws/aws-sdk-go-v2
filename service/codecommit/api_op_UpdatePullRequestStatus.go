...
func (c *Client) addOperationUpdatePullRequestStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdatePullRequestStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
