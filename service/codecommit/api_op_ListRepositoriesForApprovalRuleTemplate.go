...
func addOperationListRepositoriesForApprovalRuleTemplateStackSlots(stack *middleware.Stack) error {
...
func addOperationListRepositoriesForApprovalRuleTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListRepositoriesForApprovalRuleTemplateStackSlots(stack); err != nil {
		return err
	}
