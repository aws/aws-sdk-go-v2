...
func (c *Client) ListRepositoriesForApprovalRuleTemplate(ctx context.Context, params *ListRepositoriesForApprovalRuleTemplateInput, optFns ...func(*Options)) (*ListRepositoriesForApprovalRuleTemplateOutput, error) {
	if params == nil { params = &ListRepositoriesForApprovalRuleTemplateInput{} }
...
func (c *Client) addOperationListRepositoriesForApprovalRuleTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRepositoriesForApprovalRuleTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRepositoriesForApprovalRuleTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRepositoriesForApprovalRuleTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRepositoriesForApprovalRuleTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRepositoriesForApprovalRuleTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRepositoriesForApprovalRuleTemplateResolveEndpointMiddleware{
