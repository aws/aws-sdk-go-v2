...
func (c *Client) DeleteCommentContent(ctx context.Context, params *DeleteCommentContentInput, optFns ...func(*Options)) (*DeleteCommentContentOutput, error) {
	if params == nil { params = &DeleteCommentContentInput{} }
...
func (c *Client) addOperationDeleteCommentContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCommentContentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteCommentContentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteCommentContentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCommentContentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCommentContentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteCommentContentResolveEndpointMiddleware{
