...
func (c *Client) addOperationUpdateApprovalRuleTemplateContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateApprovalRuleTemplateContent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
