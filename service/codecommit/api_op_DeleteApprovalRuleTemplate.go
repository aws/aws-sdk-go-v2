...
func addOperationDeleteApprovalRuleTemplateStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteApprovalRuleTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteApprovalRuleTemplateStackSlots(stack); err != nil {
		return err
	}
