...
func (c *Client) addOperationBatchDisassociateApprovalRuleTemplateFromRepositoriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDisassociateApprovalRuleTemplateFromRepositories", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
