...
func (c *Client) addOperationDisassociateApprovalRuleTemplateFromRepositoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateApprovalRuleTemplateFromRepository", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
