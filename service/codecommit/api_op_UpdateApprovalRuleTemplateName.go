...
func (*UpdateApprovalRuleTemplateNameInput) operationName() string {
...
func (c *Client) addOperationUpdateApprovalRuleTemplateNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateApprovalRuleTemplateNameResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateApprovalRuleTemplateNameResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateApprovalRuleTemplateNameResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateApprovalRuleTemplateNameResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateApprovalRuleTemplateNameResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateApprovalRuleTemplateNameResolveEndpointMiddleware{
