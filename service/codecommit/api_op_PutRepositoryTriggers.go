...
func (c *Client) PutRepositoryTriggers(ctx context.Context, params *PutRepositoryTriggersInput, optFns ...func(*Options)) (*PutRepositoryTriggersOutput, error) {
	if params == nil { params = &PutRepositoryTriggersInput{} }
...
func (c *Client) addOperationPutRepositoryTriggersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutRepositoryTriggersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutRepositoryTriggersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutRepositoryTriggersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutRepositoryTriggersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutRepositoryTriggersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutRepositoryTriggersResolveEndpointMiddleware{
