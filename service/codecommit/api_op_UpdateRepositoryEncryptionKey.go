...
func (c *Client) addOperationUpdateRepositoryEncryptionKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRepositoryEncryptionKey", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
