...
func (c *Client) MergeBranchesByFastForward(ctx context.Context, params *MergeBranchesByFastForwardInput, optFns ...func(*Options)) (*MergeBranchesByFastForwardOutput, error) {
	if params == nil { params = &MergeBranchesByFastForwardInput{} }
...
func (c *Client) addOperationMergeBranchesByFastForwardMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addMergeBranchesByFastForwardResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opMergeBranchesByFastForwardResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opMergeBranchesByFastForwardResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opMergeBranchesByFastForwardResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addMergeBranchesByFastForwardResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opMergeBranchesByFastForwardResolveEndpointMiddleware{
