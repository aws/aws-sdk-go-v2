...
func (c *Client) addOperationGetPullRequestOverrideStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPullRequestOverrideState", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
