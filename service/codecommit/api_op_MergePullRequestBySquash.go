...
func (c *Client) MergePullRequestBySquash(ctx context.Context, params *MergePullRequestBySquashInput, optFns ...func(*Options)) (*MergePullRequestBySquashOutput, error) {
	stack := middleware.NewStack("MergePullRequestBySquash", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpMergePullRequestBySquashMiddlewares(stack)
...
func addawsAwsjson11_serdeOpMergePullRequestBySquashMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpMergePullRequestBySquash{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpMergePullRequestBySquash{}, middleware.After)
}
