...
func (c *Client) addOperationMergePullRequestBySquashMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "MergePullRequestBySquash", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
