...
func (*UpdateRepositoryDescriptionInput) operationName() string {
...
func (c *Client) addOperationUpdateRepositoryDescriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateRepositoryDescriptionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateRepositoryDescriptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateRepositoryDescriptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateRepositoryDescriptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateRepositoryDescriptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateRepositoryDescriptionResolveEndpointMiddleware{
