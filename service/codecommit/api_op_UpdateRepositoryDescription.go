...
func addOperationUpdateRepositoryDescriptionStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateRepositoryDescriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateRepositoryDescriptionStackSlots(stack); err != nil {
		return err
	}
