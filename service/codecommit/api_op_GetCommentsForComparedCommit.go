...
func (c *Client) addOperationGetCommentsForComparedCommitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCommentsForComparedCommit", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
