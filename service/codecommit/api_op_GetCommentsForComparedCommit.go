...
func (c *Client) GetCommentsForComparedCommit(ctx context.Context, params *GetCommentsForComparedCommitInput, optFns ...func(*Options)) (*GetCommentsForComparedCommitOutput, error) {
	if params == nil { params = &GetCommentsForComparedCommitInput{} }
...
func (c *Client) addOperationGetCommentsForComparedCommitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCommentsForComparedCommitResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCommentsForComparedCommitResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCommentsForComparedCommitResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCommentsForComparedCommitResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCommentsForComparedCommitResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCommentsForComparedCommitResolveEndpointMiddleware{
