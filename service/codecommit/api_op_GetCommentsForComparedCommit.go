...
func addOperationGetCommentsForComparedCommitStackSlots(stack *middleware.Stack) error {
...
func addOperationGetCommentsForComparedCommitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetCommentsForComparedCommitStackSlots(stack); err != nil {
		return err
	}
