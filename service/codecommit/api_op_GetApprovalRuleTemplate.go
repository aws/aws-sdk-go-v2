...
func (c *Client) addOperationGetApprovalRuleTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetApprovalRuleTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
