...
func (c *Client) addOperationDeletePullRequestApprovalRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeletePullRequestApprovalRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
