...
func (c *Client) ListBranches(ctx context.Context, params *ListBranchesInput, optFns ...func(*Options)) (*ListBranchesOutput, error) {
	if params == nil { params = &ListBranchesInput{} }
...
func (c *Client) addOperationListBranchesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBranchesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListBranchesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListBranchesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBranchesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListBranchesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListBranchesResolveEndpointMiddleware{
