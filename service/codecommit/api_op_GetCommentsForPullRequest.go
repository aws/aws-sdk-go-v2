...
func (c *Client) addOperationGetCommentsForPullRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCommentsForPullRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
