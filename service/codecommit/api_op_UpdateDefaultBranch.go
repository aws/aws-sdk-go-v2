...
func (*UpdateDefaultBranchInput) operationName() string {
...
func (c *Client) addOperationUpdateDefaultBranchMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateDefaultBranchResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateDefaultBranchResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateDefaultBranchResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateDefaultBranchResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateDefaultBranchResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateDefaultBranchResolveEndpointMiddleware{
