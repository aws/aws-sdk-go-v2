...
func (c *Client) ListApprovalRuleTemplates(ctx context.Context, params *ListApprovalRuleTemplatesInput, optFns ...func(*Options)) (*ListApprovalRuleTemplatesOutput, error) {
	if params == nil { params = &ListApprovalRuleTemplatesInput{} }
...
func (c *Client) addOperationListApprovalRuleTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListApprovalRuleTemplatesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListApprovalRuleTemplatesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListApprovalRuleTemplatesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListApprovalRuleTemplatesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListApprovalRuleTemplatesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListApprovalRuleTemplatesResolveEndpointMiddleware{
