...
func (c *Client) addOperationListApprovalRuleTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListApprovalRuleTemplates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
