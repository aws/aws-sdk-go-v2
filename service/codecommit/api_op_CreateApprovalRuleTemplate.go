...
func addOperationCreateApprovalRuleTemplateStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateApprovalRuleTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateApprovalRuleTemplateStackSlots(stack); err != nil {
		return err
	}
