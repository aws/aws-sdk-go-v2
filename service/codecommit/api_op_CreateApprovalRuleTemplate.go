...
type CreateApprovalRuleTemplateInput struct {
	...
	// destination references (branches) match those specified in the template. When
	// you create the content of the approval rule template, you can specify approvers
