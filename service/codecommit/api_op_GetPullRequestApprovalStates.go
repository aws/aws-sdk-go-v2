...
func (c *Client) GetPullRequestApprovalStates(ctx context.Context, params *GetPullRequestApprovalStatesInput, optFns ...func(*Options)) (*GetPullRequestApprovalStatesOutput, error) {
	if params == nil { params = &GetPullRequestApprovalStatesInput{} }
...
func (c *Client) addOperationGetPullRequestApprovalStatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPullRequestApprovalStatesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPullRequestApprovalStatesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPullRequestApprovalStatesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPullRequestApprovalStatesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPullRequestApprovalStatesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPullRequestApprovalStatesResolveEndpointMiddleware{
