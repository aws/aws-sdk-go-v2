...
func (c *Client) addOperationGetPullRequestApprovalStatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPullRequestApprovalStates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
