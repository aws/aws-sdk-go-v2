...
func (c *Client) DeleteBranch(ctx context.Context, params *DeleteBranchInput, optFns ...func(*Options)) (*DeleteBranchOutput, error) {
	...
	addawsAwsjson11_serdeOpDeleteBranchMiddlewares(stack)
...
func addawsAwsjson11_serdeOpDeleteBranchMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpDeleteBranch{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpDeleteBranch{}, middleware.After)
}
