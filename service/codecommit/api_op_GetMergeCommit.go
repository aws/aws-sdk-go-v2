...
func (c *Client) GetMergeCommit(ctx context.Context, params *GetMergeCommitInput, optFns ...func(*Options)) (*GetMergeCommitOutput, error) {
	stack := middleware.NewStack("GetMergeCommit", smithyhttp.NewStackRequest)
...
func addawsAwsjson11_serdeOpGetMergeCommitMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpGetMergeCommit{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpGetMergeCommit{}, middleware.After)
}
