...
func addOperationMergePullRequestByFastForwardStackSlots(stack *middleware.Stack) error {
...
func addOperationMergePullRequestByFastForwardMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationMergePullRequestByFastForwardStackSlots(stack); err != nil {
		return err
	}
