...
func (c *Client) addOperationMergePullRequestByFastForwardMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "MergePullRequestByFastForward", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
