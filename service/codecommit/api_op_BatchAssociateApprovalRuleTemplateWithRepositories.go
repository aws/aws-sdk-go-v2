...
func (c *Client) addOperationBatchAssociateApprovalRuleTemplateWithRepositoriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchAssociateApprovalRuleTemplateWithRepositories", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
