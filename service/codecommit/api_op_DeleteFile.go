...
func (c *Client) DeleteFile(ctx context.Context, params *DeleteFileInput, optFns ...func(*Options)) (*DeleteFileOutput, error) {
	stack := middleware.NewStack("DeleteFile", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpDeleteFileMiddlewares(stack)
	...
	addOpDeleteFileValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteFile(options.Region), middleware.Before)
...
func addawsAwsjson11_serdeOpDeleteFileMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpDeleteFile{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpDeleteFile{}, middleware.After)
}
