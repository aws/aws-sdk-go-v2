...
func (c *Client) GetPullRequest(ctx context.Context, params *GetPullRequestInput, optFns ...func(*Options)) (*GetPullRequestOutput, error) {
	if params == nil { params = &GetPullRequestInput{} }
...
func (c *Client) addOperationGetPullRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPullRequestResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPullRequestResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPullRequestResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPullRequestResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPullRequestResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPullRequestResolveEndpointMiddleware{
