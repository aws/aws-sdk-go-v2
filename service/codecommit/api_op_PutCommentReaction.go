...
func (c *Client) PutCommentReaction(ctx context.Context, params *PutCommentReactionInput, optFns ...func(*Options)) (*PutCommentReactionOutput, error) {
	if params == nil { params = &PutCommentReactionInput{} }
...
func (c *Client) addOperationPutCommentReactionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutCommentReactionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutCommentReactionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutCommentReactionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutCommentReactionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutCommentReactionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutCommentReactionResolveEndpointMiddleware{
