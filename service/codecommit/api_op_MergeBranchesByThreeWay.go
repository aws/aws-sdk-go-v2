...
func (c *Client) MergeBranchesByThreeWay(ctx context.Context, params *MergeBranchesByThreeWayInput, optFns ...func(*Options)) (*MergeBranchesByThreeWayOutput, error) {
	if params == nil { params = &MergeBranchesByThreeWayInput{} }
...
func (c *Client) addOperationMergeBranchesByThreeWayMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addMergeBranchesByThreeWayResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opMergeBranchesByThreeWayResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opMergeBranchesByThreeWayResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opMergeBranchesByThreeWayResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addMergeBranchesByThreeWayResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opMergeBranchesByThreeWayResolveEndpointMiddleware{
