...
func (c *Client) ListTunnels(ctx context.Context, params *ListTunnelsInput, optFns ...func(*Options)) (*ListTunnelsOutput, error) {
	if params == nil { params = &ListTunnelsInput{} }
...
func (c *Client) addOperationListTunnelsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTunnelsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTunnelsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTunnelsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTunnelsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTunnelsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTunnelsResolveEndpointMiddleware{
