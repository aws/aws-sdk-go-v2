...
const (
	ServiceName = "AWS IoT Secure Tunneling" // Service's name
	ServiceID   = "IoTSecureTunneling"       // Service's identifier
	EndpointsID = "api.tunneling.iot"        // Service's Endpoint identifier
)
...
//     svc := iotsecuretunneling.New(myConfig)
