...
func (c *Client) CloseTunnel(ctx context.Context, params *CloseTunnelInput, optFns ...func(*Options)) (*CloseTunnelOutput, error) {
	if params == nil { params = &CloseTunnelInput{} }
...
func (c *Client) addOperationCloseTunnelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCloseTunnelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCloseTunnelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCloseTunnelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCloseTunnelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCloseTunnelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCloseTunnelResolveEndpointMiddleware{
