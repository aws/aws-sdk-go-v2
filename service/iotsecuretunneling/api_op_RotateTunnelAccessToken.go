...
func (c *Client) addOperationRotateTunnelAccessTokenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RotateTunnelAccessToken", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
