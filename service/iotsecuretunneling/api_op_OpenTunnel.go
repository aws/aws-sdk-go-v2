...
func (c *Client) OpenTunnel(ctx context.Context, params *OpenTunnelInput, optFns ...func(*Options)) (*OpenTunnelOutput, error) {
	if params == nil { params = &OpenTunnelInput{} }
...
func (c *Client) addOperationOpenTunnelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addOpenTunnelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opOpenTunnelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opOpenTunnelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opOpenTunnelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addOpenTunnelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opOpenTunnelResolveEndpointMiddleware{
