...
type CloneStackInput struct {
	...
	// UseOpsworksSecurityGroupsyou can instead provide your own custom security
	...
	// about how to use AWS OpsWorks Stacks with a VPC, see Running a Stack in a VPC (https://docs.aws.amazon.com/opsworks/latest/userguide/workingstacks-vpc.html)
