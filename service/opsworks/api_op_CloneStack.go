...
func (c *Client) CloneStack(ctx context.Context, params *CloneStackInput, optFns ...func(*Options)) (*CloneStackOutput, error) {
	if params == nil { params = &CloneStackInput{} }
...
func (c *Client) addOperationCloneStackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCloneStackResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCloneStackResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCloneStackResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCloneStackResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCloneStackResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCloneStackResolveEndpointMiddleware{
