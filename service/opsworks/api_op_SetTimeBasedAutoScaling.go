...
func (c *Client) SetTimeBasedAutoScaling(ctx context.Context, params *SetTimeBasedAutoScalingInput, optFns ...func(*Options)) (*SetTimeBasedAutoScalingOutput, error) {
	if params == nil { params = &SetTimeBasedAutoScalingInput{} }
...
func (c *Client) addOperationSetTimeBasedAutoScalingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetTimeBasedAutoScalingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetTimeBasedAutoScalingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetTimeBasedAutoScalingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetTimeBasedAutoScalingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetTimeBasedAutoScalingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetTimeBasedAutoScalingResolveEndpointMiddleware{
