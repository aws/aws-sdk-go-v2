...
type UpdateInstanceInput struct {
	...
	// list contains the currently supported types. For more information, see
	...
	// AMI that you want to use. For more information about supported operating
	// systems, see Operating Systems (https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-os.html)
