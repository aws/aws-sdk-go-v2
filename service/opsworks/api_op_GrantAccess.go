...
func (c *Client) GrantAccess(ctx context.Context, params *GrantAccessInput, optFns ...func(*Options)) (*GrantAccessOutput, error) {
	if params == nil { params = &GrantAccessInput{} }
...
func (c *Client) addOperationGrantAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGrantAccessResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGrantAccessResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGrantAccessResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGrantAccessResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGrantAccessResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGrantAccessResolveEndpointMiddleware{
