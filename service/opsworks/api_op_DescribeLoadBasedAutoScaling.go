...
func addOperationDescribeLoadBasedAutoScalingStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeLoadBasedAutoScalingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeLoadBasedAutoScalingStackSlots(stack); err != nil {
		return err
	}
