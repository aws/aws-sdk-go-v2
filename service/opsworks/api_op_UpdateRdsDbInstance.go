...
func (c *Client) UpdateRdsDbInstance(ctx context.Context, params *UpdateRdsDbInstanceInput, optFns ...func(*Options)) (*UpdateRdsDbInstanceOutput, error) {
	if params == nil { params = &UpdateRdsDbInstanceInput{} }
...
func (c *Client) addOperationUpdateRdsDbInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateRdsDbInstanceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateRdsDbInstanceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateRdsDbInstanceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateRdsDbInstanceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateRdsDbInstanceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateRdsDbInstanceResolveEndpointMiddleware{
