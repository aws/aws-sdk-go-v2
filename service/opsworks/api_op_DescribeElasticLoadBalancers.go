...
func addOperationDescribeElasticLoadBalancersStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeElasticLoadBalancersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeElasticLoadBalancersStackSlots(stack); err != nil {
		return err
	}
