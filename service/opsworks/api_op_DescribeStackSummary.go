...
func (c *Client) DescribeStackSummary(ctx context.Context, params *DescribeStackSummaryInput, optFns ...func(*Options)) (*DescribeStackSummaryOutput, error) {
	if params == nil { params = &DescribeStackSummaryInput{} }
...
func (c *Client) addOperationDescribeStackSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeStackSummaryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeStackSummaryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeStackSummaryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeStackSummaryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeStackSummaryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeStackSummaryResolveEndpointMiddleware{
