...
func addOperationDescribeTimeBasedAutoScalingStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeTimeBasedAutoScalingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeTimeBasedAutoScalingStackSlots(stack); err != nil {
		return err
	}
