...
func (c *Client) DescribeTimeBasedAutoScaling(ctx context.Context, params *DescribeTimeBasedAutoScalingInput, optFns ...func(*Options)) (*DescribeTimeBasedAutoScalingOutput, error) {
	if params == nil { params = &DescribeTimeBasedAutoScalingInput{} }
...
func (c *Client) addOperationDescribeTimeBasedAutoScalingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeTimeBasedAutoScalingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeTimeBasedAutoScalingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeTimeBasedAutoScalingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeTimeBasedAutoScalingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeTimeBasedAutoScalingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeTimeBasedAutoScalingResolveEndpointMiddleware{
