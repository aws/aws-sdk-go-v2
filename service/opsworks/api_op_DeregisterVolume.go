...
func (*DeregisterVolumeInput) operationName() string {
...
func (c *Client) addOperationDeregisterVolumeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeregisterVolumeResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeregisterVolumeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeregisterVolumeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeregisterVolumeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeregisterVolumeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeregisterVolumeResolveEndpointMiddleware{
