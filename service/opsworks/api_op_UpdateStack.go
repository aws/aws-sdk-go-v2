...
type UpdateStackInput struct {
	...
	// a key-pair name, AWS OpsWorks Stacks installs the public key on the instance and
	...
	// UseOpsworksSecurityGroupsallows you to provide your own custom security groups
