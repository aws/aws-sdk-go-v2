...
func (c *Client) StartStack(ctx context.Context, params *StartStackInput, optFns ...func(*Options)) (*StartStackOutput, error) {
	if params == nil { params = &StartStackInput{} }
...
func (c *Client) addOperationStartStackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartStackResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartStackResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartStackResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartStackResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartStackResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartStackResolveEndpointMiddleware{
