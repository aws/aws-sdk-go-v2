...
func addOperationDescribeStackProvisioningParametersStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeStackProvisioningParametersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeStackProvisioningParametersStackSlots(stack); err != nil {
		return err
	}
