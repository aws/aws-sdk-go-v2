...
func (*StopStackInput) operationName() string {
	return "StopStack"
}
...
func (c *Client) addOperationStopStackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopStackResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopStackResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopStackResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopStackResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopStackResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopStackResolveEndpointMiddleware{
