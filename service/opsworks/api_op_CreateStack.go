...
type CreateStackInput struct {
	...
	// to us-east-1 , and the --stack-region parameter is set to one of the
	// following, then the stack uses a legacy or classic region: us-west-1,
	...
	// us-east-1API endpoint. Because it is a best practice to choose the regional
	// endpoint that is closest to where you manage AWS, we recommend that you use
	// regional endpoints for new stacks. The AWS CLI common --region parameter
	// always specifies a regional API endpoint; it cannot be used to specify a classic
