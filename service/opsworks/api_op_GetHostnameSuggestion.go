...
func (c *Client) GetHostnameSuggestion(ctx context.Context, params *GetHostnameSuggestionInput, optFns ...func(*Options)) (*GetHostnameSuggestionOutput, error) {
	if params == nil { params = &GetHostnameSuggestionInput{} }
...
func (c *Client) addOperationGetHostnameSuggestionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetHostnameSuggestionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetHostnameSuggestionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetHostnameSuggestionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetHostnameSuggestionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetHostnameSuggestionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetHostnameSuggestionResolveEndpointMiddleware{
