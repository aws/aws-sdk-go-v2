...
func (c *Client) GetHostnameSuggestion(ctx context.Context, params *GetHostnameSuggestionInput, optFns ...func(*Options)) (*GetHostnameSuggestionOutput, error) {
	stack := middleware.NewStack("GetHostnameSuggestion", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpGetHostnameSuggestionMiddlewares(stack)
...
func addawsAwsjson11_serdeOpGetHostnameSuggestionMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpGetHostnameSuggestion{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpGetHostnameSuggestion{}, middleware.After)
}
