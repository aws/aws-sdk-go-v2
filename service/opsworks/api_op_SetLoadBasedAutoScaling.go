...
func (c *Client) SetLoadBasedAutoScaling(ctx context.Context, params *SetLoadBasedAutoScalingInput, optFns ...func(*Options)) (*SetLoadBasedAutoScalingOutput, error) {
	if params == nil { params = &SetLoadBasedAutoScalingInput{} }
...
func (c *Client) addOperationSetLoadBasedAutoScalingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetLoadBasedAutoScalingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetLoadBasedAutoScalingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetLoadBasedAutoScalingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetLoadBasedAutoScalingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetLoadBasedAutoScalingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetLoadBasedAutoScalingResolveEndpointMiddleware{
