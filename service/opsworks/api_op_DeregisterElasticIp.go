...
func (c *Client) DeregisterElasticIp(ctx context.Context, params *DeregisterElasticIpInput, optFns ...func(*Options)) (*DeregisterElasticIpOutput, error) {
	stack := middleware.NewStack("DeregisterElasticIp", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpDeregisterElasticIpMiddlewares(stack)
...
func addawsAwsjson11_serdeOpDeregisterElasticIpMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpDeregisterElasticIp{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpDeregisterElasticIp{}, middleware.After)
}
