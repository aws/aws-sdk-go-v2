...
func (c *Client) CreateEventAction(ctx context.Context, params *CreateEventActionInput, optFns ...func(*Options)) (*CreateEventActionOutput, error) {
	if params == nil { params = &CreateEventActionInput{} }
...
func (c *Client) addOperationCreateEventActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateEventActionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateEventActionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateEventActionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateEventActionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateEventActionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateEventActionResolveEndpointMiddleware{
