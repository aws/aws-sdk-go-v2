...
func (c *Client) addOperationSendDataSetNotificationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SendDataSetNotification", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
