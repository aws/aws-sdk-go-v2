...
func (*DeleteEventActionInput) operationName() string {
...
func (c *Client) addOperationDeleteEventActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteEventActionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteEventActionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteEventActionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteEventActionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteEventActionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteEventActionResolveEndpointMiddleware{
