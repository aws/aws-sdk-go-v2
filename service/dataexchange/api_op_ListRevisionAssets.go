...
func (c *Client) ListRevisionAssets(ctx context.Context, params *ListRevisionAssetsInput, optFns ...func(*Options)) (*ListRevisionAssetsOutput, error) {
	if params == nil { params = &ListRevisionAssetsInput{} }
...
func (c *Client) addOperationListRevisionAssetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRevisionAssetsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRevisionAssetsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRevisionAssetsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRevisionAssetsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRevisionAssetsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRevisionAssetsResolveEndpointMiddleware{
