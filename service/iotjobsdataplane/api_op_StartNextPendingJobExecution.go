...
func addOperationStartNextPendingJobExecutionStackSlots(stack *middleware.Stack) error {
...
func addOperationStartNextPendingJobExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartNextPendingJobExecutionStackSlots(stack); err != nil {
		return err
	}
