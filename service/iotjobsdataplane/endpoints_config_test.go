...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iot-jobs-data-plane.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-jobs-data-plane.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-jobs-data-plane.dev",
			expectURL:     aws.String("https://env-iot-jobs-data-plane.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iot-jobs-data-plane.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-jobs-data-plane.dev",
			expectURL:     aws.String("http://config-iot-jobs-data-plane.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iot-jobs-data-plane.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iot-jobs-data-plane.dev",
			clientEndpoint: aws.String("https://client-iot-jobs-data-plane.dev"),
			expectURL:      aws.String("https://client-iot-jobs-data-plane.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IOT_JOBS_DATA_PLANE", c.envService)
			}
