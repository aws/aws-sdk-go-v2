...
func (c *Client) addOperationGetResourceRequestStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetResourceRequestStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
