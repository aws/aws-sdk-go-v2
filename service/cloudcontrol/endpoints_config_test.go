...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cloudcontrol.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudcontrol.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudcontrol.dev",
			expectURL:     aws.String("https://env-cloudcontrol.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cloudcontrol.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudcontrol.dev",
			expectURL:     aws.String("http://config-cloudcontrol.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cloudcontrol.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cloudcontrol.dev",
			clientEndpoint: aws.String("https://client-cloudcontrol.dev"),
			expectURL:      aws.String("https://client-cloudcontrol.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CLOUDCONTROL", c.envService)
			}
