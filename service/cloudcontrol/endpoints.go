...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/cloudcontrol/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "CloudControl", cfg.ConfigSources)
	if found && err == nil {
