...
func (c *Client) addOperationGetSearchResultExportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSearchResultExportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
