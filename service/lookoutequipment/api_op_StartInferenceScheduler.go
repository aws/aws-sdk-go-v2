...
func (c *Client) addOperationStartInferenceSchedulerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartInferenceScheduler", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
