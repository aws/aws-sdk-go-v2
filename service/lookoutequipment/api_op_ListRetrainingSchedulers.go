...
func (c *Client) addOperationListRetrainingSchedulersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRetrainingSchedulersResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListRetrainingSchedulersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListRetrainingSchedulersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRetrainingSchedulersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRetrainingSchedulersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListRetrainingSchedulersResolveEndpointMiddleware{
