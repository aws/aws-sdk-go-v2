...
func (c *Client) addOperationListRetrainingSchedulersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRetrainingSchedulers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
