...
func (c *Client) addOperationListInferenceSchedulersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListInferenceSchedulers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
