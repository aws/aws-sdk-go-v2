...
func (c *Client) addOperationStopRetrainingSchedulerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopRetrainingScheduler", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
