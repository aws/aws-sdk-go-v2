...
func (c *Client) addOperationCreateRetrainingSchedulerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateRetrainingScheduler", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
