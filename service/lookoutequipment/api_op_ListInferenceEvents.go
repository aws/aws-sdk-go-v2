...
func (*ListInferenceEventsInput) operationName() string {
...
func (c *Client) addOperationListInferenceEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListInferenceEventsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListInferenceEventsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListInferenceEventsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListInferenceEventsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListInferenceEventsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListInferenceEventsResolveEndpointMiddleware{
