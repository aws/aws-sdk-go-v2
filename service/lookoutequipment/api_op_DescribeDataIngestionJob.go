...
func (c *Client) addOperationDescribeDataIngestionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDataIngestionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
