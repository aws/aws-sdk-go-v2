...
func (c *Client) StopInferenceScheduler(ctx context.Context, params *StopInferenceSchedulerInput, optFns ...func(*Options)) (*StopInferenceSchedulerOutput, error) {
	if params == nil { params = &StopInferenceSchedulerInput{} }
...
func (c *Client) addOperationStopInferenceSchedulerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopInferenceSchedulerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopInferenceSchedulerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopInferenceSchedulerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopInferenceSchedulerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopInferenceSchedulerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopInferenceSchedulerResolveEndpointMiddleware{
