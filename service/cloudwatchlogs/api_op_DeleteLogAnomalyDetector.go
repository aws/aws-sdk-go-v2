...
func (c *Client) addOperationDeleteLogAnomalyDetectorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteLogAnomalyDetector", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
