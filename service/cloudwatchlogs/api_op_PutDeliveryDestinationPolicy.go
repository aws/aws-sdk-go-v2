...
func (c *Client) addOperationPutDeliveryDestinationPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutDeliveryDestinationPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
