...
func (c *Client) addOperationListAggregateLogGroupSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAggregateLogGroupSummaries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
