...
func (c *Client) addOperationListSyslogConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSyslogConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
