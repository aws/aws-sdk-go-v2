...
// @timestampis the timestamp of each log event. For more information about the
// fields that are generated by CloudWatch logs, see Supported Logs and
...
type GetLogGroupFieldsInput struct {
	...
	// minutes before this time are queries. If you omit time, the 8 minutes before
	// and 8 minutes after this time are searched. The time value is specified as
