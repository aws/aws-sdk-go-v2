...
func (c *Client) addOperationPutLogGroupDeletionProtectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutLogGroupDeletionProtection", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
