...
type UntagResourceInput struct {
	...
	// The ARN of the CloudWatch Logs resource that you're removing tags from. The
	// ARN format of a log group is
	// arn:aws:logs:Region:account-id:log-group:log-group-name The ARN format of a
	// destination is arn:aws:logs:Region:account-id:destination:destination-name
