...
func (c *Client) GetLogFields(ctx context.Context, params *GetLogFieldsInput, optFns ...func(*Options)) (*GetLogFieldsOutput, error) {
	if params == nil { params = &GetLogFieldsInput{} }
...
func (c *Client) addOperationGetLogFieldsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err != nil { return err }
	if err := addProtocolFinalizerMiddlewares(stack, options, "GetLogFields"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetLogFields(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opGetLogFields(region string) *awsmiddleware.RegisterServiceMetadata {
