...
func (c *Client) addOperationDescribeResourcePoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeResourcePolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
