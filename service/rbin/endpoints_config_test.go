...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-rbin.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rbin.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rbin.dev",
			expectURL:     aws.String("https://env-rbin.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-rbin.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rbin.dev",
			expectURL:     aws.String("http://config-rbin.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-rbin.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-rbin.dev",
			clientEndpoint: aws.String("https://client-rbin.dev"),
			expectURL:      aws.String("https://client-rbin.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_RBIN", c.envService)
			}
