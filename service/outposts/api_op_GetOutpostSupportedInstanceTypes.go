...
func (c *Client) addOperationGetOutpostSupportedInstanceTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetOutpostSupportedInstanceTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
