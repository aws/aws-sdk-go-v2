...
func (c *Client) addOperationUpdateSiteRackPhysicalPropertiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateSiteRackPhysicalProperties", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
