...
func (*GetSiteAddressInput) operationName() string {
...
func (c *Client) addOperationGetSiteAddressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSiteAddressResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetSiteAddressResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetSiteAddressResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSiteAddressResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSiteAddressResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetSiteAddressResolveEndpointMiddleware{
