...
// Create a list of the Outpost sites for your Amazon Web Services account. Add
...
// operating address. If you specify multiple filters, the filters are joined with
