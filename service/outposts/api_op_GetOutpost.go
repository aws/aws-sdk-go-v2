...
func (c *Client) GetOutpost(ctx context.Context, params *GetOutpostInput, optFns ...func(*Options)) (*GetOutpostOutput, error) {
	if params == nil { params = &GetOutpostInput{} }
...
func (c *Client) addOperationGetOutpostMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetOutpostResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetOutpostResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetOutpostResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetOutpostResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetOutpostResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetOutpostResolveEndpointMiddleware{
