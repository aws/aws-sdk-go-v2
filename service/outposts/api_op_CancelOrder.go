...
func (c *Client) CancelOrder(ctx context.Context, params *CancelOrderInput, optFns ...func(*Options)) (*CancelOrderOutput, error) {
	if params == nil { params = &CancelOrderInput{} }
...
func (c *Client) addOperationCancelOrderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelOrderResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelOrderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelOrderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelOrderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelOrderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelOrderResolveEndpointMiddleware{
