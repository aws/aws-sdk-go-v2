...
func (c *Client) addOperationGetOutpostBillingInformationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetOutpostBillingInformation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
