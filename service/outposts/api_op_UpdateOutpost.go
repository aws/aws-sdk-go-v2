...
func (c *Client) addOperationUpdateOutpostMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateOutpostResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateOutpostResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateOutpostResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateOutpostResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateOutpostResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateOutpostResolveEndpointMiddleware{
