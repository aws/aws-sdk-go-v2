...
func (c *Client) addOperationGetOutpostInstanceTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetOutpostInstanceTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
