...
func (c *Client) GetCatalogItem(ctx context.Context, params *GetCatalogItemInput, optFns ...func(*Options)) (*GetCatalogItemOutput, error) {
	if params == nil { params = &GetCatalogItemInput{} }
...
func (c *Client) addOperationGetCatalogItemMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCatalogItemResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCatalogItemResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCatalogItemResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCatalogItemResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCatalogItemResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCatalogItemResolveEndpointMiddleware{
