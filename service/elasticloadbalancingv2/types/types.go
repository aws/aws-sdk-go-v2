...
type LoadBalancerAttribute struct {
	...
	// or false. The default is true. Elastic Load Balancing requires that message
	...
	// Web Services WAF. The value is true or false. The default is false.
	//
	// The
	...
	// load balancing is enabled. The value is true or false. The default is false.
	Key *string
