...
func addOperationModifyTargetGroupAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyTargetGroupAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyTargetGroupAttributesStackSlots(stack); err != nil {
		return err
	}
