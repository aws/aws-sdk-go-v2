...
func (c *Client) addOperationGetTrustStoreCaCertificatesBundleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetTrustStoreCaCertificatesBundle", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
