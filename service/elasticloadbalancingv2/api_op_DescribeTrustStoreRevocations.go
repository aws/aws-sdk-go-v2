...
func (c *Client) addOperationDescribeTrustStoreRevocationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeTrustStoreRevocations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
