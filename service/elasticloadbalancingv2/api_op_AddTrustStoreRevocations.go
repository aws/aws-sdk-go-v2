...
func (c *Client) addOperationAddTrustStoreRevocationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AddTrustStoreRevocations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
