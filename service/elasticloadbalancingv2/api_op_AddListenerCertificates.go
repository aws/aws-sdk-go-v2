...
func (c *Client) addOperationAddListenerCertificatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AddListenerCertificates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
