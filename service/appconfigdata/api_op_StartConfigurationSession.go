...
func (c *Client) addOperationStartConfigurationSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartConfigurationSession", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
