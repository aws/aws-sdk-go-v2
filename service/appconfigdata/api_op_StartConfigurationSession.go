...
func (c *Client) StartConfigurationSession(ctx context.Context, params *StartConfigurationSessionInput, optFns ...func(*Options)) (*StartConfigurationSessionOutput, error) {
	if params == nil { params = &StartConfigurationSessionInput{} }
...
func (c *Client) addOperationStartConfigurationSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartConfigurationSessionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartConfigurationSessionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartConfigurationSessionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartConfigurationSessionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartConfigurationSessionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartConfigurationSessionResolveEndpointMiddleware{
