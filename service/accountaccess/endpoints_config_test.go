...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-account-access.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-account-access.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-account-access.dev",
			expectURL:     aws.String("https://env-account-access.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-account-access.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-account-access.dev",
			expectURL:     aws.String("http://config-account-access.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-account-access.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-account-access.dev",
			clientEndpoint: aws.String("https://client-account-access.dev"),
			expectURL:      aws.String("https://client-account-access.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ACCOUNT_ACCESS", c.envService)
			}
