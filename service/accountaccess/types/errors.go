...
func (e *AlreadyCreatedException) ErrorMessage() string {
	if e.Message == nil {
		return ""
	}
	return *e.Message
...
func (e *AlreadyCreatedException) ErrorFault() smithy.ErrorFault { return smithy.FaultClient }
func (v *AlreadyCreatedException) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.AlreadyCreatedException)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *AlreadyCreatedException) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Message != nil {
		s.WriteString(schemas.AlreadyCreatedException_message, *v.Message)
	}
}
func (v *AlreadyCreatedException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.AlreadyCreatedException, func(s *smithy.Schema) error {
		switch s {
		case schemas.AlreadyCreatedException_message:
			v.Message = new(string)
			return d.ReadString(schemas.AlreadyCreatedException_message, v.Message)
		}
		return nil
	})
}
