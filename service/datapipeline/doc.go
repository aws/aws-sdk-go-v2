...
// data. AWS Data Pipeline provides a JAR implementation of a task runner called
...
// task runner to provide custom data management. AWS Data Pipeline implements two
// main sets of functionality. Use the first set to create a pipeline and define
...
// task ready for processing. The logic for performing the task, such as querying
// the data, running data analysis, or converting the data from one format to
// another, is contained within the task runner. The task runner performs the task
// assigned to it by the web service, reporting progress to the web service as it
