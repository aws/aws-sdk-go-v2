...
func (c *Client) addOperationReportTaskRunnerHeartbeatMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ReportTaskRunnerHeartbeat", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
