...
func addOperationValidatePipelineDefinitionStackSlots(stack *middleware.Stack) error {
...
func addOperationValidatePipelineDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationValidatePipelineDefinitionStackSlots(stack); err != nil {
		return err
	}
