...
func (c *Client) PollForTask(ctx context.Context, params *PollForTaskInput, optFns ...func(*Options)) (*PollForTaskOutput, error) {
	if params == nil { params = &PollForTaskInput{} }
...
func (c *Client) addOperationPollForTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPollForTaskResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPollForTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPollForTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPollForTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPollForTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPollForTaskResolveEndpointMiddleware{
