...
type GetShardIteratorInput struct {
	...
	// in the shard. In DynamoDB Streams, there is a 24 hour limit on data retention.
	// Stream records whose age exceeds this limit are subject to removal (trimming)
	// from the stream.
