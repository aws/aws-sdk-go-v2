...
func (*DescribeStateMachineAliasInput) operationName() string {
...
func (c *Client) addOperationDescribeStateMachineAliasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeStateMachineAliasResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeStateMachineAliasResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeStateMachineAliasResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeStateMachineAliasResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeStateMachineAliasResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeStateMachineAliasResolveEndpointMiddleware{
