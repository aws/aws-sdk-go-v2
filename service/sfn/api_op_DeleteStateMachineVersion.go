...
func (*DeleteStateMachineVersionInput) operationName() string {
...
func (c *Client) addOperationDeleteStateMachineVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteStateMachineVersionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteStateMachineVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteStateMachineVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteStateMachineVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteStateMachineVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteStateMachineVersionResolveEndpointMiddleware{
