...
func addOperationDescribeStateMachineForExecutionStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeStateMachineForExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeStateMachineForExecutionStackSlots(stack); err != nil {
		return err
	}
