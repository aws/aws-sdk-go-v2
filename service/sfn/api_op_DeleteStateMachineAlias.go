...
func (c *Client) addOperationDeleteStateMachineAliasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteStateMachineAlias", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
