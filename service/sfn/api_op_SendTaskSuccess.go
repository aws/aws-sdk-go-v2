...
func (c *Client) SendTaskSuccess(ctx context.Context, params *SendTaskSuccessInput, optFns ...func(*Options)) (*SendTaskSuccessOutput, error) {
	if params == nil { params = &SendTaskSuccessInput{} }
...
func (c *Client) addOperationSendTaskSuccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendTaskSuccessResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSendTaskSuccessResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSendTaskSuccessResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendTaskSuccessResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendTaskSuccessResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSendTaskSuccessResolveEndpointMiddleware{
