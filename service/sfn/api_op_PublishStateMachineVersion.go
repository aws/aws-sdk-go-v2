...
func (c *Client) addOperationPublishStateMachineVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PublishStateMachineVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
