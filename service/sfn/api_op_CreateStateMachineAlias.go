...
func (c *Client) addOperationCreateStateMachineAliasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateStateMachineAlias", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
