...
func (*SendTaskFailureInput) operationName() string {
...
func (c *Client) addOperationSendTaskFailureMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendTaskFailureResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opSendTaskFailureResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opSendTaskFailureResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendTaskFailureResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendTaskFailureResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opSendTaskFailureResolveEndpointMiddleware{
