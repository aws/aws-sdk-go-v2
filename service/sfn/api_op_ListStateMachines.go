...
func (c *Client) ListStateMachines(ctx context.Context, params *ListStateMachinesInput, optFns ...func(*Options)) (*ListStateMachinesOutput, error) {
	if params == nil { params = &ListStateMachinesInput{} }
...
func (c *Client) addOperationListStateMachinesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListStateMachinesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListStateMachinesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListStateMachinesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListStateMachinesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListStateMachinesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListStateMachinesResolveEndpointMiddleware{
