...
func (*SendTaskHeartbeatInput) operationName() string {
...
func (c *Client) addOperationSendTaskHeartbeatMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendTaskHeartbeatResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opSendTaskHeartbeatResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opSendTaskHeartbeatResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendTaskHeartbeatResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendTaskHeartbeatResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opSendTaskHeartbeatResolveEndpointMiddleware{
