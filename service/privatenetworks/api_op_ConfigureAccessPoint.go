...
func (c *Client) ConfigureAccessPoint(ctx context.Context, params *ConfigureAccessPointInput, optFns ...func(*Options)) (*ConfigureAccessPointOutput, error) {
	if params == nil { params = &ConfigureAccessPointInput{} }
...
func (c *Client) addOperationConfigureAccessPointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addConfigureAccessPointResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opConfigureAccessPointResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opConfigureAccessPointResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opConfigureAccessPointResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addConfigureAccessPointResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opConfigureAccessPointResolveEndpointMiddleware{
