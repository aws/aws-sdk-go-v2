...
func (c *Client) addOperationListNetworksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListNetworksResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListNetworksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListNetworksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListNetworksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListNetworksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListNetworksResolveEndpointMiddleware{
