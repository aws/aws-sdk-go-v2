...
func (c *Client) AcknowledgeOrderReceipt(ctx context.Context, params *AcknowledgeOrderReceiptInput, optFns ...func(*Options)) (*AcknowledgeOrderReceiptOutput, error) {
	if params == nil { params = &AcknowledgeOrderReceiptInput{} }
...
func (c *Client) addOperationAcknowledgeOrderReceiptMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAcknowledgeOrderReceiptResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAcknowledgeOrderReceiptResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAcknowledgeOrderReceiptResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAcknowledgeOrderReceiptResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAcknowledgeOrderReceiptResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAcknowledgeOrderReceiptResolveEndpointMiddleware{
