...
func (c *Client) GetNetworkSite(ctx context.Context, params *GetNetworkSiteInput, optFns ...func(*Options)) (*GetNetworkSiteOutput, error) {
	if params == nil { params = &GetNetworkSiteInput{} }
...
func (c *Client) addOperationGetNetworkSiteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetNetworkSiteResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetNetworkSiteResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetNetworkSiteResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetNetworkSiteResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetNetworkSiteResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetNetworkSiteResolveEndpointMiddleware{
