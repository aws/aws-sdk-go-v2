...
func (c *Client) ActivateNetworkSite(ctx context.Context, params *ActivateNetworkSiteInput, optFns ...func(*Options)) (*ActivateNetworkSiteOutput, error) {
	if params == nil { params = &ActivateNetworkSiteInput{} }
...
func (c *Client) addOperationActivateNetworkSiteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addActivateNetworkSiteResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opActivateNetworkSiteResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opActivateNetworkSiteResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opActivateNetworkSiteResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addActivateNetworkSiteResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opActivateNetworkSiteResolveEndpointMiddleware{
