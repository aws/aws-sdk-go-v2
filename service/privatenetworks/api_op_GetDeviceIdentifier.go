...
func (*GetDeviceIdentifierInput) operationName() string {
...
func (c *Client) addOperationGetDeviceIdentifierMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDeviceIdentifierResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetDeviceIdentifierResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetDeviceIdentifierResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDeviceIdentifierResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDeviceIdentifierResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetDeviceIdentifierResolveEndpointMiddleware{
