...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/privatenetworks/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "PrivateNetworks", cfg.ConfigSources)
	if found && err == nil {
