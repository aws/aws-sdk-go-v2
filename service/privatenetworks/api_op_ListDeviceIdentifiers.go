...
func (c *Client) ListDeviceIdentifiers(ctx context.Context, params *ListDeviceIdentifiersInput, optFns ...func(*Options)) (*ListDeviceIdentifiersOutput, error) {
	if params == nil { params = &ListDeviceIdentifiersInput{} }
...
func (c *Client) addOperationListDeviceIdentifiersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDeviceIdentifiersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDeviceIdentifiersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDeviceIdentifiersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDeviceIdentifiersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDeviceIdentifiersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDeviceIdentifiersResolveEndpointMiddleware{
