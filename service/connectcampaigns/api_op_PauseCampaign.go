...
func (c *Client) addOperationPauseCampaignMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPauseCampaignResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opPauseCampaignResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opPauseCampaignResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPauseCampaignResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPauseCampaignResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opPauseCampaignResolveEndpointMiddleware{
