...
func (*StopCampaignInput) operationName() string {
	return "StopCampaign"
}
...
func (c *Client) addOperationStopCampaignMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopCampaignResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopCampaignResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopCampaignResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopCampaignResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopCampaignResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopCampaignResolveEndpointMiddleware{
