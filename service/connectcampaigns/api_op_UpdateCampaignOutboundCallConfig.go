...
func (c *Client) UpdateCampaignOutboundCallConfig(ctx context.Context, params *UpdateCampaignOutboundCallConfigInput, optFns ...func(*Options)) (*UpdateCampaignOutboundCallConfigOutput, error) {
	if params == nil { params = &UpdateCampaignOutboundCallConfigInput{} }
...
func (c *Client) addOperationUpdateCampaignOutboundCallConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateCampaignOutboundCallConfigResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateCampaignOutboundCallConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateCampaignOutboundCallConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateCampaignOutboundCallConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateCampaignOutboundCallConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateCampaignOutboundCallConfigResolveEndpointMiddleware{
