...
func (c *Client) addOperationUpdateCampaignOutboundCallConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCampaignOutboundCallConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
