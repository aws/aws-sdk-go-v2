...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-connectcampaigns.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connectcampaigns.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connectcampaigns.dev",
			expectURL:     aws.String("https://env-connectcampaigns.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-connectcampaigns.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connectcampaigns.dev",
			expectURL:     aws.String("http://config-connectcampaigns.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-connectcampaigns.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-connectcampaigns.dev",
			clientEndpoint: aws.String("https://client-connectcampaigns.dev"),
			expectURL:      aws.String("https://client-connectcampaigns.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CONNECTCAMPAIGNS", c.envService)
			}
