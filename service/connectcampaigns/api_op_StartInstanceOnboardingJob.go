...
func (c *Client) addOperationStartInstanceOnboardingJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartInstanceOnboardingJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
