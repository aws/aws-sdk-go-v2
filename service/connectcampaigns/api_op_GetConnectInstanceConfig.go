...
func (c *Client) addOperationGetConnectInstanceConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetConnectInstanceConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetConnectInstanceConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetConnectInstanceConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetConnectInstanceConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetConnectInstanceConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetConnectInstanceConfigResolveEndpointMiddleware{
