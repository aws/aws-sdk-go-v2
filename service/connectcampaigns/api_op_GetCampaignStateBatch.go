...
func (c *Client) GetCampaignStateBatch(ctx context.Context, params *GetCampaignStateBatchInput, optFns ...func(*Options)) (*GetCampaignStateBatchOutput, error) {
	if params == nil { params = &GetCampaignStateBatchInput{} }
...
func (c *Client) addOperationGetCampaignStateBatchMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCampaignStateBatchResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCampaignStateBatchResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCampaignStateBatchResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCampaignStateBatchResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCampaignStateBatchResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCampaignStateBatchResolveEndpointMiddleware{
