...
func (c *Client) addOperationUpdateCampaignDialerConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCampaignDialerConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
