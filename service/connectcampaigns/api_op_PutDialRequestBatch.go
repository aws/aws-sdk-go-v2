...
func (c *Client) PutDialRequestBatch(ctx context.Context, params *PutDialRequestBatchInput, optFns ...func(*Options)) (*PutDialRequestBatchOutput, error) {
	if params == nil { params = &PutDialRequestBatchInput{} }
...
func (c *Client) addOperationPutDialRequestBatchMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutDialRequestBatchResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutDialRequestBatchResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutDialRequestBatchResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutDialRequestBatchResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutDialRequestBatchResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutDialRequestBatchResolveEndpointMiddleware{
