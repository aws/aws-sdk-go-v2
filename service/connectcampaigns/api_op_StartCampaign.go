...
func (*StartCampaignInput) operationName() string {
...
func (c *Client) addOperationStartCampaignMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartCampaignResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStartCampaignResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStartCampaignResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartCampaignResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartCampaignResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStartCampaignResolveEndpointMiddleware{
