...
func (c *Client) DeleteConnectInstanceConfig(ctx context.Context, params *DeleteConnectInstanceConfigInput, optFns ...func(*Options)) (*DeleteConnectInstanceConfigOutput, error) {
	if params == nil { params = &DeleteConnectInstanceConfigInput{} }
...
func (c *Client) addOperationDeleteConnectInstanceConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteConnectInstanceConfigResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteConnectInstanceConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteConnectInstanceConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteConnectInstanceConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteConnectInstanceConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteConnectInstanceConfigResolveEndpointMiddleware{
