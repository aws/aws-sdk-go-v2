...
func (v *DeleteInstanceOnboardingJobInput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.DeleteInstanceOnboardingJobRequest, func(s *smithy.Schema) error {
		switch s {
		case schemas.DeleteInstanceOnboardingJobRequest_connectInstanceId:
			v.ConnectInstanceId = new(string)
			return d.ReadString(schemas.DeleteInstanceOnboardingJobRequest_connectInstanceId, v.ConnectInstanceId)
		}
		return nil
	})
}
