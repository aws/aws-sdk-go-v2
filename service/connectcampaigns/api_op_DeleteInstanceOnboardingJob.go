...
func (c *Client) DeleteInstanceOnboardingJob(ctx context.Context, params *DeleteInstanceOnboardingJobInput, optFns ...func(*Options)) (*DeleteInstanceOnboardingJobOutput, error) {
	if params == nil { params = &DeleteInstanceOnboardingJobInput{} }
...
func (c *Client) addOperationDeleteInstanceOnboardingJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteInstanceOnboardingJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteInstanceOnboardingJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteInstanceOnboardingJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteInstanceOnboardingJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteInstanceOnboardingJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteInstanceOnboardingJobResolveEndpointMiddleware{
