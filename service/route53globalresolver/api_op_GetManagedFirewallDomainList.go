...
func (c *Client) addOperationGetManagedFirewallDomainListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetManagedFirewallDomainList", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
