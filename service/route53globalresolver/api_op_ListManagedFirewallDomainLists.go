...
func (c *Client) addOperationListManagedFirewallDomainListsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListManagedFirewallDomainLists", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
