...
func (c *Client) addOperationGetWorkloadDeploymentPatternMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetWorkloadDeploymentPattern", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
