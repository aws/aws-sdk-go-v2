...
func (c *Client) addOperationListWorkloadDeploymentPatternsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListWorkloadDeploymentPatterns", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
