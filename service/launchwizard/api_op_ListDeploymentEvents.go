...
func (c *Client) addOperationListDeploymentEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDeploymentEventsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListDeploymentEventsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListDeploymentEventsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDeploymentEventsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDeploymentEventsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListDeploymentEventsResolveEndpointMiddleware{
