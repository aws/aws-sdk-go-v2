...
func addOperationIncreaseStreamRetentionPeriodStackSlots(stack *middleware.Stack) error {
...
func addOperationIncreaseStreamRetentionPeriodMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationIncreaseStreamRetentionPeriodStackSlots(stack); err != nil {
		return err
	}
