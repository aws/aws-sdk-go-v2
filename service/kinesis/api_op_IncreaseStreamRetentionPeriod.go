...
func (c *Client) addOperationIncreaseStreamRetentionPeriodMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "IncreaseStreamRetentionPeriod", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
