...
func (c *Client) addOperationUpdateStreamWarmThroughputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateStreamWarmThroughput", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
