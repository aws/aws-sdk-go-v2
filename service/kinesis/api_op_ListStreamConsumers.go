...
type ListStreamConsumersInput struct {
	...
	// ListStreamConsumersto return. The default value is 100. If you specify a value
...
type ListStreamConsumersOutput struct {
	...
	// ListStreamConsumersto list the next set of registered consumers. For more
	// information about the use of this pagination token when calling the
	// ListStreamConsumers operation, see ListStreamConsumersInput$NextToken. Tokens
	// expire after 300 seconds. When you obtain a value for NextToken in the
