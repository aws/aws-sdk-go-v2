...
func (c *Client) addOperationEnableEnhancedMonitoringMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableEnhancedMonitoring", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
