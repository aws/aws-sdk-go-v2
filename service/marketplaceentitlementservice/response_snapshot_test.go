...
func TestCheckResponseSnapshot_GetEntitlements(t *testing.T) {
	...
	status, header, body, err := serdeRespReadSnapshot("GetEntitlements.response")
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "GetEntitlements.response", err)
	}
}
