...
// Using the Client
//
// To use AWS Marketplace Entitlement Service with the SDK use the New function to create
...
//
// See the AWS Marketplace Entitlement Service client for more information on
