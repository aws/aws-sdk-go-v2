...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/marketplaceentitlementservice/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_MARKETPLACE_ENTITLEMENT_SERVICE")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Marketplace Entitlement Service", cfg.ConfigSources)
	if found && err == nil {
...
var bddNodes = [51]int32{
	-1, 1, -1, 0, 16, 3, 1, 4, 100000014, 2, 5, 100000014, 3, 12, 6, 5, 11, 7, 6, 9, 8, 9, 100000006, 100000013, 7, 100000004, 10, 8, 100000011, 100000012, 6, 100000004, 100000005, 4, 14, 13, 6, 100000008, 100000010, 6, 15, 100000009, 8, 100000007, 100000008, 3, 100000001, 17, 6, 100000002, 100000003}
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 4:
		uriString := func() string {
			...
			out.WriteString("https://entitlement-marketplace.")
	...
	case 7:
		uriString := func() string {
			var out strings.Builder
			out.WriteString("https://entitlement.marketplace-fips.")
			out.WriteString(*params.Region)
			out.WriteString(".")
			out.WriteString(c.PartitionResult.DualStackDnsSuffix)
			return out.String()
