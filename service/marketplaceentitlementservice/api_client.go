...
const (
	ServiceName = "AWS Marketplace Entitlement Service" // Service's name
	ServiceID   = "MarketplaceEntitlementService"       // Service's identifier
	EndpointsID = "entitlement.marketplace"             // Service's Endpoint identifier
)
