...
//
// AWS Marketplace Entitlement Service This reference provides descriptions of
// the AWS Marketplace Entitlement Service API. AWS Marketplace Entitlement Service
// is used to determine the entitlement of a customer to a given product. An
