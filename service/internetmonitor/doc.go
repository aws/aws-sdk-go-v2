...
// Amazon Web Services and your end users. It reduces the time it takes for you to
// diagnose internet issues from days to minutes. Internet Monitor uses the
...
// CloudFront distributions, or WorkSpaces directories, to enable Internet Monitor
// to know where your application's internet traffic is. Internet Monitor then
// provides internet measurements from Amazon Web Services that are specific to the
// locations and networks that communicate with your application. For more
// information, see Using Amazon CloudWatch Internet Monitor
