...
func (c *Client) DeleteConnection(ctx context.Context, params *DeleteConnectionInput, optFns ...func(*Options)) (*DeleteConnectionOutput, error) {
	...
	addawsAwsjson10_serdeOpDeleteConnectionMiddlewares(stack)
...
func addawsAwsjson10_serdeOpDeleteConnectionMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson10_serializeOpDeleteConnection{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson10_deserializeOpDeleteConnection{}, middleware.After)
}
