...
func (c *Client) GetHost(ctx context.Context, params *GetHostInput, optFns ...func(*Options)) (*GetHostOutput, error) {
	stack := middleware.NewStack("GetHost", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson10_serdeOpGetHostMiddlewares(stack)
...
func addawsAwsjson10_serdeOpGetHostMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson10_serializeOpGetHost{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson10_deserializeOpGetHost{}, middleware.After)
}
