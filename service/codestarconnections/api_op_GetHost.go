...
func (c *Client) GetHost(ctx context.Context, params *GetHostInput, optFns ...func(*Options)) (*GetHostOutput, error) {
	if params == nil { params = &GetHostInput{} }
...
func (c *Client) addOperationGetHostMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetHostResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetHostResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetHostResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetHostResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetHostResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetHostResolveEndpointMiddleware{
