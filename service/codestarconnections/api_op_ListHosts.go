...
func (c *Client) addOperationListHostsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListHostsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListHostsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListHostsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListHostsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListHostsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListHostsResolveEndpointMiddleware{
