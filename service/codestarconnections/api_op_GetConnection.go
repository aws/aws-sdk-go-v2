...
func (c *Client) GetConnection(ctx context.Context, params *GetConnectionInput, optFns ...func(*Options)) (*GetConnectionOutput, error) {
	...
	addawsAwsjson10_serdeOpGetConnectionMiddlewares(stack)
...
func addawsAwsjson10_serdeOpGetConnectionMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson10_serializeOpGetConnection{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson10_deserializeOpGetConnection{}, middleware.After)
}
