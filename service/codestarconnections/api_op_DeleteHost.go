...
func (*DeleteHostInput) operationName() string {
	return "DeleteHost"
}
...
func (c *Client) addOperationDeleteHostMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteHostResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteHostResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteHostResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteHostResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteHostResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteHostResolveEndpointMiddleware{
