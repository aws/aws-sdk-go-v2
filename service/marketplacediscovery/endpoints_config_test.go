...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-marketplace-discovery.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-discovery.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-discovery.dev",
			expectURL:     aws.String("https://env-marketplace-discovery.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-marketplace-discovery.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-discovery.dev",
			expectURL:     aws.String("http://config-marketplace-discovery.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-marketplace-discovery.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-marketplace-discovery.dev",
			clientEndpoint: aws.String("https://client-marketplace-discovery.dev"),
			expectURL:      aws.String("https://client-marketplace-discovery.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MARKETPLACE_DISCOVERY", c.envService)
			}
