...
func (c *Client) addOperationPutInboundDmarcSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutInboundDmarcSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
