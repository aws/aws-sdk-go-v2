...
func (*AssociateDelegateToResourceInput) operationName() string {
...
func (c *Client) addOperationAssociateDelegateToResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateDelegateToResourceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAssociateDelegateToResourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAssociateDelegateToResourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateDelegateToResourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateDelegateToResourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAssociateDelegateToResourceResolveEndpointMiddleware{
