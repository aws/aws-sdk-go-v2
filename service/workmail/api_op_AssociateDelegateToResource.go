...
func addOperationAssociateDelegateToResourceStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociateDelegateToResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociateDelegateToResourceStackSlots(stack); err != nil {
		return err
	}
