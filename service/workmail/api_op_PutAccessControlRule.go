...
func addOperationPutAccessControlRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpPutAccessControlRuleValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opPutAccessControlRule(options.Region), middleware.Before)
