...
func (c *Client) GetMobileDeviceAccessOverride(ctx context.Context, params *GetMobileDeviceAccessOverrideInput, optFns ...func(*Options)) (*GetMobileDeviceAccessOverrideOutput, error) {
	if params == nil { params = &GetMobileDeviceAccessOverrideInput{} }
...
func (c *Client) addOperationGetMobileDeviceAccessOverrideMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMobileDeviceAccessOverrideResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetMobileDeviceAccessOverrideResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetMobileDeviceAccessOverrideResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMobileDeviceAccessOverrideResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMobileDeviceAccessOverrideResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetMobileDeviceAccessOverrideResolveEndpointMiddleware{
