...
func (c *Client) addOperationGetMobileDeviceAccessOverrideMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetMobileDeviceAccessOverride", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
