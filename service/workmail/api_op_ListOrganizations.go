...
func (*ListOrganizationsInput) operationName() string {
...
func (c *Client) addOperationListOrganizationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListOrganizationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListOrganizationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListOrganizationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListOrganizationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListOrganizationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListOrganizationsResolveEndpointMiddleware{
