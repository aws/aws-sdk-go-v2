...
func addOperationCancelMailboxExportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addIdempotencyToken_opCancelMailboxExportJobMiddleware(stack, options)
	addOpCancelMailboxExportJobValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opCancelMailboxExportJob(options.Region), middleware.Before)
...
func addIdempotencyToken_opCancelMailboxExportJobMiddleware(stack *middleware.Stack, cfg Options) {
	stack.Initialize.Add(&idempotencyToken_initializeOpCancelMailboxExportJob{tokenProvider: cfg.IdempotencyTokenProvider}, middleware.Before)
}
