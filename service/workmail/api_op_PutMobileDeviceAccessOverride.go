...
func (c *Client) addOperationPutMobileDeviceAccessOverrideMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutMobileDeviceAccessOverride", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
