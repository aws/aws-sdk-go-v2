...
func addOperationStartMailboxExportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addIdempotencyToken_opStartMailboxExportJobMiddleware(stack, options)
	addOpStartMailboxExportJobValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opStartMailboxExportJob(options.Region), middleware.Before)
...
func addIdempotencyToken_opStartMailboxExportJobMiddleware(stack *middleware.Stack, cfg Options) {
	stack.Initialize.Add(&idempotencyToken_initializeOpStartMailboxExportJob{tokenProvider: cfg.IdempotencyTokenProvider}, middleware.Before)
}
