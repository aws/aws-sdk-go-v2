...
func (c *Client) ListMobileDeviceAccessOverrides(ctx context.Context, params *ListMobileDeviceAccessOverridesInput, optFns ...func(*Options)) (*ListMobileDeviceAccessOverridesOutput, error) {
	if params == nil { params = &ListMobileDeviceAccessOverridesInput{} }
...
func (c *Client) addOperationListMobileDeviceAccessOverridesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMobileDeviceAccessOverridesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListMobileDeviceAccessOverridesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListMobileDeviceAccessOverridesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMobileDeviceAccessOverridesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListMobileDeviceAccessOverridesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListMobileDeviceAccessOverridesResolveEndpointMiddleware{
