...
func (c *Client) addOperationListMobileDeviceAccessOverridesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMobileDeviceAccessOverrides", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
