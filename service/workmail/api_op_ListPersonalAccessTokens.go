...
func (c *Client) addOperationListPersonalAccessTokensMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPersonalAccessTokens", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
