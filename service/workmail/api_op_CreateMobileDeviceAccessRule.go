...
func (c *Client) addOperationCreateMobileDeviceAccessRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMobileDeviceAccessRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
