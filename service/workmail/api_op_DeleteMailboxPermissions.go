...
func (c *Client) addOperationDeleteMailboxPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteMailboxPermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
