...
func (c *Client) addOperationUpdateAvailabilityConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAvailabilityConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
