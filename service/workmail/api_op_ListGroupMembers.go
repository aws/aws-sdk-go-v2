...
func (*ListGroupMembersInput) operationName() string {
...
func (c *Client) addOperationListGroupMembersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListGroupMembersResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListGroupMembersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListGroupMembersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListGroupMembersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListGroupMembersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListGroupMembersResolveEndpointMiddleware{
