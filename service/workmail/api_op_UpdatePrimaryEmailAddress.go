...
func (c *Client) addOperationUpdatePrimaryEmailAddressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdatePrimaryEmailAddress", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
