...
func (c *Client) addOperationDeleteImpersonationRoleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteImpersonationRole", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
