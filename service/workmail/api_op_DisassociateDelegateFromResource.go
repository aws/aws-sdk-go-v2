...
func (c *Client) addOperationDisassociateDelegateFromResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateDelegateFromResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
