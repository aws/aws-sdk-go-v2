...
func (c *Client) addOperationUpdateImpersonationRoleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateImpersonationRole", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
