...
func (c *Client) ListAvailabilityConfigurations(ctx context.Context, params *ListAvailabilityConfigurationsInput, optFns ...func(*Options)) (*ListAvailabilityConfigurationsOutput, error) {
	if params == nil { params = &ListAvailabilityConfigurationsInput{} }
...
func (c *Client) addOperationListAvailabilityConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAvailabilityConfigurationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAvailabilityConfigurationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAvailabilityConfigurationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAvailabilityConfigurationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAvailabilityConfigurationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAvailabilityConfigurationsResolveEndpointMiddleware{
