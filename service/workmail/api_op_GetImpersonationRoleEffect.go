...
func (c *Client) addOperationGetImpersonationRoleEffectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetImpersonationRoleEffect", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
