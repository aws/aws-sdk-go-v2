...
func (c *Client) DeleteResource(ctx context.Context, params *DeleteResourceInput, optFns ...func(*Options)) (*DeleteResourceOutput, error) {
	...
	addawsAwsjson11_serdeOpDeleteResourceMiddlewares(stack)
...
func addawsAwsjson11_serdeOpDeleteResourceMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpDeleteResource{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpDeleteResource{}, middleware.After)
}
