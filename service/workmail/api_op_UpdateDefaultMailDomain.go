...
func (c *Client) addOperationUpdateDefaultMailDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDefaultMailDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
