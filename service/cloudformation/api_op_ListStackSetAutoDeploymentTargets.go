...
func (c *Client) addOperationListStackSetAutoDeploymentTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListStackSetAutoDeploymentTargets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
