...
func (c *Client) addOperationDeleteGeneratedTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteGeneratedTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
