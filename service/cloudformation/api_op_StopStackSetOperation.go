...
func (c *Client) StopStackSetOperation(ctx context.Context, params *StopStackSetOperationInput, optFns ...func(*Options)) (*StopStackSetOperationOutput, error) {
	if params == nil { params = &StopStackSetOperationInput{} }
...
func (c *Client) addOperationStopStackSetOperationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopStackSetOperationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopStackSetOperationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopStackSetOperationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopStackSetOperationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopStackSetOperationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopStackSetOperationResolveEndpointMiddleware{
