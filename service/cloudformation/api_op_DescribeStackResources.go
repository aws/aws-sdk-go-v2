...
// DescribeStackResourcesreturns resource information for up to 90 days after the
// stack has been deleted. You must specify either StackName  or
// PhysicalResourceId , but not both. In addition, you can specify
// LogicalResourceIdto filter the returned result. For more information about
...
type DescribeStackResourcesInput struct {
	...
	// Cloud (EC2) instance, PhysicalResourceId  corresponds to the InstanceId. You
	// can pass the EC2 InstanceId  to DescribeStackResources to find which stack the
	...
	// Default: There is
	// no default value. Required: Conditional. If you don't specify StackName, you
