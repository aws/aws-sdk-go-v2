...
func (c *Client) addOperationCreateGeneratedTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateGeneratedTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
