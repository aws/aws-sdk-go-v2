...
func (c *Client) addOperationDeactivateOrganizationsAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeactivateOrganizationsAccess", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
