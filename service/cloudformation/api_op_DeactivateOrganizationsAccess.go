...
func (c *Client) DeactivateOrganizationsAccess(ctx context.Context, params *DeactivateOrganizationsAccessInput, optFns ...func(*Options)) (*DeactivateOrganizationsAccessOutput, error) {
	if params == nil { params = &DeactivateOrganizationsAccessInput{} }
...
func (c *Client) addOperationDeactivateOrganizationsAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeactivateOrganizationsAccessResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeactivateOrganizationsAccessResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeactivateOrganizationsAccessResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeactivateOrganizationsAccessResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeactivateOrganizationsAccessResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeactivateOrganizationsAccessResolveEndpointMiddleware{
