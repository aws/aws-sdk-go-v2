...
func (c *Client) addOperationListStackSetOperationResultsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListStackSetOperationResults", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
