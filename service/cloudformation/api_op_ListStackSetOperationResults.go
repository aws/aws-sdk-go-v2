...
func addOperationListStackSetOperationResultsStackSlots(stack *middleware.Stack) error {
...
func addOperationListStackSetOperationResultsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListStackSetOperationResultsStackSlots(stack); err != nil {
		return err
	}
