...
func (c *Client) UpdateStackInstances(ctx context.Context, params *UpdateStackInstancesInput, optFns ...func(*Options)) (*UpdateStackInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateStackInstances", params, optFns, addOperationUpdateStackInstancesMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateStackInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateStackInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateStackInstancesStackSlots(stack); err != nil {
		return err
	}
