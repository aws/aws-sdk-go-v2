...
func (c *Client) addOperationDetectStackResourceDriftMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DetectStackResourceDrift", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
