...
func (c *Client) UpdateStack(ctx context.Context, params *UpdateStackInput, optFns ...func(*Options)) (*UpdateStackOutput, error) {
	...
	addawsAwsquery_serdeOpUpdateStackMiddlewares(stack)
...
func addawsAwsquery_serdeOpUpdateStackMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpUpdateStack{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpUpdateStack{}, middleware.After)
}
