...
func (c *Client) addOperationListResourceScanResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListResourceScanResources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
