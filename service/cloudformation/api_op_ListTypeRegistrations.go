...
func (*ListTypeRegistrationsInput) operationName() string {
...
func (c *Client) addOperationListTypeRegistrationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTypeRegistrationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListTypeRegistrationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListTypeRegistrationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTypeRegistrationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTypeRegistrationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListTypeRegistrationsResolveEndpointMiddleware{
