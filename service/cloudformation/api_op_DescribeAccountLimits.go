...
//   req := client.DescribeAccountLimitsRequest(input)
//   p := cloudformation.NewDescribeAccountLimitsRequestPaginator(req)
//
...
//   }
//
func NewDescribeAccountLimitsPaginator(req DescribeAccountLimitsRequest) DescribeAccountLimitsPaginator {
...
// DescribeAccountLimitsPaginator is used to paginate the request. This can be done by
// calling Next and CurrentPage.
type DescribeAccountLimitsPaginator struct {
	aws.Pager
}

func (p *DescribeAccountLimitsPaginator) CurrentPage() *DescribeAccountLimitsOutput {
	return p.Pager.CurrentPage().(*DescribeAccountLimitsOutput)
}
