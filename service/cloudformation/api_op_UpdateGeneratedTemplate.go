...
func (c *Client) addOperationUpdateGeneratedTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateGeneratedTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
