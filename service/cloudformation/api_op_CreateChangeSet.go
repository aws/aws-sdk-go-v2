...
// CreateChangeSetcall successfully completes, CloudFormation starts creating the
// change set. To check the status of the change set or to review it, use the
// DescribeChangeSetaction. When you are satisfied with the changes the change
...
type CreateChangeSetInput struct {
	...
	// To create a change set for an import operation, specify IMPORT. If you create
	// a change set for a new stack, CloudFormation creates a stack with a unique stack
	...
	// CreateChangeSetrequests to ensure that CloudFormation successfully received
	// them.
	ClientToken *string
