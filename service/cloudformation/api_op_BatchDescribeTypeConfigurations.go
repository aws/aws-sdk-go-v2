...
func (c *Client) addOperationBatchDescribeTypeConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDescribeTypeConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
