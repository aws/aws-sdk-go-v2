...
func (c *Client) addOperationDescribeGeneratedTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeGeneratedTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
