...
func (*SetTypeDefaultVersionInput) operationName() string {
	return "SetTypeDefaultVersion"
}
...
func (c *Client) addOperationSetTypeDefaultVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetTypeDefaultVersionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opSetTypeDefaultVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opSetTypeDefaultVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetTypeDefaultVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetTypeDefaultVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opSetTypeDefaultVersionResolveEndpointMiddleware{
