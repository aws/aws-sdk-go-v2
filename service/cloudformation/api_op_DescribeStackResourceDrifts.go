...
type DescribeStackResourceDriftsOutput struct {
	...
	// one StackResourceDrift for each stack resource that has been checked for
	// drift. Resources that haven't yet been checked for drift aren't included.
	// Resources that do not currently support drift detection aren't checked, and so
