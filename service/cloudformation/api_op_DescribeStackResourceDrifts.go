...
func addOperationDescribeStackResourceDriftsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeStackResourceDriftsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeStackResourceDriftsStackSlots(stack); err != nil {
		return err
	}
