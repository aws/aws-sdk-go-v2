...
type UpdateStackSetInput struct {
	...
	// Set Operations (https://docs.aws.amazon.com/AWSCloudFormation/stacksets-prereqs.html)
	...
	//   Custom Processing on Templates (https://docs.aws.amazon.com/AWSCloudFormation/template-macros.html)
	//   . Stack sets with service-managed permissions do not currently support the use
	//   of macros in templates. (This includes the AWS::Include (https://docs.aws.amazon.com/AWSCloudFormation/create-reusable-transform-function-snippets-and-add-to-your-template-with-aws-include-transform.html)
...
func (c *Client) addOperationUpdateStackSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateStackSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateStackSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateStackSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateStackSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateStackSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateStackSetResolveEndpointMiddleware{
