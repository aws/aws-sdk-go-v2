...
// accounts and Amazon Web Services Regions. Even if the stack set operation
...
type UpdateStackSetInput struct {
	...
	// instances associated with this stack set, don't specify the Accounts  or
	// Regionsproperties. If the stack set update includes changes to the template
	// (that is, if the TemplateBody  or TemplateURL properties are specified), or
	// the Parameters property, CloudFormation marks all stack instances with a
	// status of OUTDATED prior to updating the stack instances in the specified
	// accounts and Amazon Web Services Regions. If the stack set update does not
	// include changes to the template or parameters, CloudFormation updates the stack
	// instances in the specified accounts and Amazon Web Services Regions, while
	...
	// administrator account. For more information, see Granting Permissions for
	// Stack Set Operations (http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-prereqs.html)
	...
	// update includes changes to the template (that is, if TemplateBody  or
	// TemplateURL is specified), or the Parameters, CloudFormation marks all stack
	// instances with a status of OUTDATED prior to updating the stack instances in
	// the specified accounts and Amazon Web Services Regions. If the stack set update
	// doesn't include changes to the template or parameters, CloudFormation updates
	...
	// AWSCloudFormationStackSetExecutionRolerole for the stack set operation.
	// Specify an IAM role only if you are using customized execution roles to control
	// which stack resources users and groups can include in their stack sets. If you
	// specify a customized execution role, CloudFormation uses that role to update the
	// stack. If you do not specify a customized execution role, CloudFormation
	...
	// cannot modify PermissionModel if there are stack instances associated with
	// your stack set.
	...
	// properties are specified), or the Parameters property, CloudFormation marks
	...
	// not include changes to the template or parameters, CloudFormation updates the
	// stack instances in the specified accounts and Regions, while leaving all other
	...
	// and a maximum length of 51,200 bytes. For more information, see Template
