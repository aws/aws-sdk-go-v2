...
func (c *Client) RecordHandlerProgress(ctx context.Context, params *RecordHandlerProgressInput, optFns ...func(*Options)) (*RecordHandlerProgressOutput, error) {
	if params == nil { params = &RecordHandlerProgressInput{} }
...
func (c *Client) addOperationRecordHandlerProgressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRecordHandlerProgressResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRecordHandlerProgressResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRecordHandlerProgressResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRecordHandlerProgressResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRecordHandlerProgressResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRecordHandlerProgressResolveEndpointMiddleware{
