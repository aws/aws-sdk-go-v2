...
func (c *Client) ListTypes(ctx context.Context, params *ListTypesInput, optFns ...func(*Options)) (*ListTypesOutput, error) {
	if params == nil { params = &ListTypesInput{} }
...
func (c *Client) addOperationListTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTypesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTypesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTypesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTypesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTypesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTypesResolveEndpointMiddleware{
