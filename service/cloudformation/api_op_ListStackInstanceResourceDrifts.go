...
func (c *Client) addOperationListStackInstanceResourceDriftsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListStackInstanceResourceDrifts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
