...
func (c *Client) ListStackInstanceResourceDrifts(ctx context.Context, params *ListStackInstanceResourceDriftsInput, optFns ...func(*Options)) (*ListStackInstanceResourceDriftsOutput, error) {
	if params == nil { params = &ListStackInstanceResourceDriftsInput{} }
...
func (c *Client) addOperationListStackInstanceResourceDriftsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListStackInstanceResourceDriftsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListStackInstanceResourceDriftsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListStackInstanceResourceDriftsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListStackInstanceResourceDriftsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListStackInstanceResourceDriftsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListStackInstanceResourceDriftsResolveEndpointMiddleware{
