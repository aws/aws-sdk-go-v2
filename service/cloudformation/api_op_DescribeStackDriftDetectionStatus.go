...
func addOperationDescribeStackDriftDetectionStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeStackDriftDetectionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeStackDriftDetectionStatusStackSlots(stack); err != nil {
		return err
	}
