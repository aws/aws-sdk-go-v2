...
func (c *Client) ListEvents(ctx context.Context, params *ListEventsInput, optFns ...func(*Options)) (*ListEventsOutput, error) {
	if params == nil { params = &ListEventsInput{} }
...
func (c *Client) addOperationListEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEventsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListEventsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListEventsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEventsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEventsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListEventsResolveEndpointMiddleware{
