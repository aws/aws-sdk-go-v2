...
type PerformanceInsightsMetricDimensionGroup struct {
	...
	// - db.host - The host name of the connected client
	// (all engines)
	...
	// -
	// db.wait_event_type - The type of event for which the database backend is waiting
	// (all engines)
...
type PerformanceInsightsMetricQuery struct {
	...
	// query. Restrictions:
	// - Any number of filters by the same dimension, as specified
	// in the GroupBy parameter.
	// - A single filter for any other dimension in this
	// dimension group.
...
type ReactiveAnomaly struct {
	...
	// - CONTEXTUAL - the anomaly contains
	// additional information about an insight or its causal anomaly.
	Type AnomalyType
