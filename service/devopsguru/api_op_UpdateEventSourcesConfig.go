...
func (c *Client) addOperationUpdateEventSourcesConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateEventSourcesConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
