...
func (*ListInsightsInput) operationName() string {
	return "ListInsights"
}
...
func (c *Client) addOperationListInsightsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListInsightsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListInsightsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListInsightsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListInsightsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListInsightsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListInsightsResolveEndpointMiddleware{
