...
func (c *Client) addOperationDescribeEventSourcesConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEventSourcesConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
