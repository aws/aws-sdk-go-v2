...
func (c *Client) PutFeedback(ctx context.Context, params *PutFeedbackInput, optFns ...func(*Options)) (*PutFeedbackOutput, error) {
	if params == nil { params = &PutFeedbackInput{} }
...
func (c *Client) addOperationPutFeedbackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutFeedbackResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutFeedbackResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutFeedbackResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutFeedbackResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutFeedbackResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutFeedbackResolveEndpointMiddleware{
