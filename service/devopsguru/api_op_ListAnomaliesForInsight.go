...
func (c *Client) addOperationListAnomaliesForInsightMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAnomaliesForInsight", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
