...
func (c *Client) ListAnomalousLogGroups(ctx context.Context, params *ListAnomalousLogGroupsInput, optFns ...func(*Options)) (*ListAnomalousLogGroupsOutput, error) {
	if params == nil { params = &ListAnomalousLogGroupsInput{} }
...
func (c *Client) addOperationListAnomalousLogGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAnomalousLogGroupsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAnomalousLogGroupsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAnomalousLogGroupsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAnomalousLogGroupsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAnomalousLogGroupsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAnomalousLogGroupsResolveEndpointMiddleware{
