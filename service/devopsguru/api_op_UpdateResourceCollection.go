...
func (c *Client) addOperationUpdateResourceCollectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateResourceCollection", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
