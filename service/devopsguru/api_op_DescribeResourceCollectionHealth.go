...
func (c *Client) addOperationDescribeResourceCollectionHealthMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeResourceCollectionHealth", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
