...
func (c *Client) addOperationDescribeServiceIntegrationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeServiceIntegration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
