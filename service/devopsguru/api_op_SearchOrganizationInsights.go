...
func (c *Client) addOperationSearchOrganizationInsightsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SearchOrganizationInsights", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
