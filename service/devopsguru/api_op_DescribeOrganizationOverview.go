...
func (c *Client) addOperationDescribeOrganizationOverviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeOrganizationOverview", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
