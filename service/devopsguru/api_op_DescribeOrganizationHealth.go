...
func (c *Client) addOperationDescribeOrganizationHealthMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeOrganizationHealth", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
