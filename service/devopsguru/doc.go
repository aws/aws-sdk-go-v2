...
// resources that you want DevOps Guru to cover, then the Amazon CloudWatch metrics
// and AWS CloudTrail events related to those resources are analyzed. When
// anomalous behavior is detected, DevOps Guru creates an insight that includes
// recommendations, related events, and related metrics that can help you improve
// your operational applications. For more information, see What is Amazon DevOps
...
// and track your work addressing insights. To learn about the DevOps Guru
