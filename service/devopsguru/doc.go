...
// an insight that includes recommendations, related events, and related metrics
// that can help you improve your operational applications. For more information,
// see What is Amazon DevOps Guru
// (https://docs.aws.amazon.com/devops-guru/latest/userguide/welcome.html). You can
// specify 1 or 2 Amazon Simple Notification Service topics so you are notified
// every time a new insight is created. You can also enable DevOps Guru to generate
// an OpsItem in Amazon Web Services Systems Manager for each insight to help you
// manage and track your work addressing insights. To learn about the DevOps Guru
// workflow, see How DevOps Guru works
