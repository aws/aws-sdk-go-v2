...
func (c *Client) addOperationDescribeAccountOverviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAccountOverview", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
