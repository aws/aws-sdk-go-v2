...
func addOperationDescribeRepositoryAssociationStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeRepositoryAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeRepositoryAssociationStackSlots(stack); err != nil {
		return err
	}
