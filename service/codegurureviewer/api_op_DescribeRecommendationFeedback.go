...
func (c *Client) addOperationDescribeRecommendationFeedbackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRecommendationFeedback", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
