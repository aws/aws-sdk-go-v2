...
func addOperationDescribeRecommendationFeedbackStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeRecommendationFeedbackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeRecommendationFeedbackStackSlots(stack); err != nil {
		return err
	}
