...
func addOperationListRecommendationFeedbackStackSlots(stack *middleware.Stack) error {
...
func addOperationListRecommendationFeedbackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListRecommendationFeedbackStackSlots(stack); err != nil {
		return err
	}
