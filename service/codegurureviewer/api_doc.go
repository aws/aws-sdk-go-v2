...
// Using the Client
//
// To use CodeGuruReviewer with the SDK use the New function to create
...
//
// See the CodeGuruReviewer client for more information on
