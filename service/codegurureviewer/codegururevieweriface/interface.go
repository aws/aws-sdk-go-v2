...
// codegurureviewer.Client methods. This make unit testing your code that
...
//    // CodeGuruReviewer.
//    func myFunc(svc codegururevieweriface.ClientAPI) bool {
...
//        codegururevieweriface.ClientPI
//    }
//    func (m *mockClientClient) AssociateRepository(input *codegurureviewer.AssociateRepositoryInput) (*codegurureviewer.AssociateRepositoryOutput, error) {
