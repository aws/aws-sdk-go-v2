...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-codeguru-reviewer.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeguru-reviewer.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeguru-reviewer.dev",
			expectURL:     aws.String("https://env-codeguru-reviewer.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-codeguru-reviewer.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeguru-reviewer.dev",
			expectURL:     aws.String("http://config-codeguru-reviewer.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-codeguru-reviewer.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-codeguru-reviewer.dev",
			clientEndpoint: aws.String("https://client-codeguru-reviewer.dev"),
			expectURL:      aws.String("https://client-codeguru-reviewer.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CODEGURU_REVIEWER", c.envService)
			}
