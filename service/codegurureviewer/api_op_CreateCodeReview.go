...
func addOperationCreateCodeReviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addIdempotencyToken_opCreateCodeReviewMiddleware(stack, options)
	addOpCreateCodeReviewValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opCreateCodeReview(options.Region), middleware.Before)
...
func addIdempotencyToken_opCreateCodeReviewMiddleware(stack *middleware.Stack, cfg Options) {
	stack.Initialize.Add(&idempotencyToken_initializeOpCreateCodeReview{tokenProvider: cfg.IdempotencyTokenProvider}, middleware.Before)
}
