...
func addOperationListRepositoryAssociationsStackSlots(stack *middleware.Stack) error {
...
func addOperationListRepositoryAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListRepositoryAssociationsStackSlots(stack); err != nil {
		return err
	}
