...
func (c *Client) addOperationPutRecommendationFeedbackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutRecommendationFeedback", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
