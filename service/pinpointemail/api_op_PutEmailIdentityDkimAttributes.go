...
func (c *Client) PutEmailIdentityDkimAttributes(ctx context.Context, params *PutEmailIdentityDkimAttributesInput, optFns ...func(*Options)) (*PutEmailIdentityDkimAttributesOutput, error) {
	if params == nil { params = &PutEmailIdentityDkimAttributesInput{} }
...
func (c *Client) addOperationPutEmailIdentityDkimAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutEmailIdentityDkimAttributesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutEmailIdentityDkimAttributesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutEmailIdentityDkimAttributesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutEmailIdentityDkimAttributesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutEmailIdentityDkimAttributesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutEmailIdentityDkimAttributesResolveEndpointMiddleware{
