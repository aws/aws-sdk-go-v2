...
func addOperationPutEmailIdentityDkimAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationPutEmailIdentityDkimAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutEmailIdentityDkimAttributesStackSlots(stack); err != nil {
		return err
	}
