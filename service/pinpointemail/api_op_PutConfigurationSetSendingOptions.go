...
func (c *Client) addOperationPutConfigurationSetSendingOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutConfigurationSetSendingOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
