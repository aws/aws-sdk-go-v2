...
func (*PutEmailIdentityFeedbackAttributesInput) operationName() string {
...
func (c *Client) addOperationPutEmailIdentityFeedbackAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutEmailIdentityFeedbackAttributesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opPutEmailIdentityFeedbackAttributesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opPutEmailIdentityFeedbackAttributesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutEmailIdentityFeedbackAttributesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutEmailIdentityFeedbackAttributesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opPutEmailIdentityFeedbackAttributesResolveEndpointMiddleware{
