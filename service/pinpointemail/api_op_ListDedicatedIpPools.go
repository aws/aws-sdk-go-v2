...
func (c *Client) ListDedicatedIpPools(ctx context.Context, params *ListDedicatedIpPoolsInput, optFns ...func(*Options)) (*ListDedicatedIpPoolsOutput, error) {
	if params == nil { params = &ListDedicatedIpPoolsInput{} }
...
func (c *Client) addOperationListDedicatedIpPoolsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDedicatedIpPoolsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDedicatedIpPoolsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDedicatedIpPoolsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDedicatedIpPoolsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDedicatedIpPoolsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDedicatedIpPoolsResolveEndpointMiddleware{
