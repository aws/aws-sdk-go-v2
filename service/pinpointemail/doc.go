...
//
// The Amazon Pinpoint API is available in the US East (N. Virginia) Region
// at the following endpoint: email.us-east-1.amazonaws.com
//
...
// Using the Client
//
// To Amazon Pinpoint Email Service with the SDK use the New function to create
