...
func (c *Client) PutDedicatedIpInPool(ctx context.Context, params *PutDedicatedIpInPoolInput, optFns ...func(*Options)) (*PutDedicatedIpInPoolOutput, error) {
	if params == nil { params = &PutDedicatedIpInPoolInput{} }
...
func (c *Client) addOperationPutDedicatedIpInPoolMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutDedicatedIpInPoolResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutDedicatedIpInPoolResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutDedicatedIpInPoolResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutDedicatedIpInPoolResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutDedicatedIpInPoolResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutDedicatedIpInPoolResolveEndpointMiddleware{
