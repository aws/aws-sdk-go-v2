...
func (c *Client) PutConfigurationSetReputationOptions(ctx context.Context, params *PutConfigurationSetReputationOptionsInput, optFns ...func(*Options)) (*PutConfigurationSetReputationOptionsOutput, error) {
	if params == nil { params = &PutConfigurationSetReputationOptionsInput{} }
...
func (c *Client) addOperationPutConfigurationSetReputationOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutConfigurationSetReputationOptionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutConfigurationSetReputationOptionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutConfigurationSetReputationOptionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutConfigurationSetReputationOptionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutConfigurationSetReputationOptionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutConfigurationSetReputationOptionsResolveEndpointMiddleware{
