...
func (c *Client) addOperationPutConfigurationSetReputationOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutConfigurationSetReputationOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
