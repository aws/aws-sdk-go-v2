...
func addOperationUpdateConfigurationSetEventDestinationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateConfigurationSetEventDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateConfigurationSetEventDestinationStackSlots(stack); err != nil {
		return err
	}
