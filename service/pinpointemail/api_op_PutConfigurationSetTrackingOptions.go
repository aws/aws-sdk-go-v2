...
func (c *Client) PutConfigurationSetTrackingOptions(ctx context.Context, params *PutConfigurationSetTrackingOptionsInput, optFns ...func(*Options)) (*PutConfigurationSetTrackingOptionsOutput, error) {
	if params == nil { params = &PutConfigurationSetTrackingOptionsInput{} }
...
func (c *Client) addOperationPutConfigurationSetTrackingOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutConfigurationSetTrackingOptionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutConfigurationSetTrackingOptionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutConfigurationSetTrackingOptionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutConfigurationSetTrackingOptionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutConfigurationSetTrackingOptionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutConfigurationSetTrackingOptionsResolveEndpointMiddleware{
