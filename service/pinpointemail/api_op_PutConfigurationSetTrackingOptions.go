...
func addOperationPutConfigurationSetTrackingOptionsStackSlots(stack *middleware.Stack) error {
...
func addOperationPutConfigurationSetTrackingOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutConfigurationSetTrackingOptionsStackSlots(stack); err != nil {
		return err
	}
