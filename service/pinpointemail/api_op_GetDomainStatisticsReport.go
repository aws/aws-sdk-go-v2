...
func (c *Client) addOperationGetDomainStatisticsReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDomainStatisticsReport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
