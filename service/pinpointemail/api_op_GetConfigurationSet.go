...
// email, and more. In Amazon Pinpoint, configuration sets are groups of rules that
// you can apply to the emails you send. You apply a configuration set to an email
// by including a reference to the configuration set in the headers of the email.
