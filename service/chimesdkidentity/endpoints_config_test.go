...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-chime-sdk-identity.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime-sdk-identity.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime-sdk-identity.dev",
			expectURL:     aws.String("https://env-chime-sdk-identity.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-chime-sdk-identity.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime-sdk-identity.dev",
			expectURL:     aws.String("http://config-chime-sdk-identity.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-chime-sdk-identity.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-chime-sdk-identity.dev",
			clientEndpoint: aws.String("https://client-chime-sdk-identity.dev"),
			expectURL:      aws.String("https://client-chime-sdk-identity.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CHIME_SDK_IDENTITY", c.envService)
			}
