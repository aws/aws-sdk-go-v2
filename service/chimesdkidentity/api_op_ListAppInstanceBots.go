...
func (c *Client) ListAppInstanceBots(ctx context.Context, params *ListAppInstanceBotsInput, optFns ...func(*Options)) (*ListAppInstanceBotsOutput, error) {
	if params == nil { params = &ListAppInstanceBotsInput{} }
...
func (c *Client) addOperationListAppInstanceBotsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAppInstanceBotsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAppInstanceBotsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAppInstanceBotsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAppInstanceBotsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAppInstanceBotsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAppInstanceBotsResolveEndpointMiddleware{
