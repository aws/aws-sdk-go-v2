...
func (*UpdateAppInstanceUserEndpointInput) operationName() string {
...
func (c *Client) addOperationUpdateAppInstanceUserEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateAppInstanceUserEndpointResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateAppInstanceUserEndpointResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateAppInstanceUserEndpointResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateAppInstanceUserEndpointResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateAppInstanceUserEndpointResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateAppInstanceUserEndpointResolveEndpointMiddleware{
