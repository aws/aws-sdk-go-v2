...
func (c *Client) addOperationDeregisterAppInstanceUserEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterAppInstanceUserEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
