...
func (*UpdateAppInstanceBotInput) operationName() string {
...
func (c *Client) addOperationUpdateAppInstanceBotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateAppInstanceBotResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateAppInstanceBotResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateAppInstanceBotResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateAppInstanceBotResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateAppInstanceBotResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateAppInstanceBotResolveEndpointMiddleware{
