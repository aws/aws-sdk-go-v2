...
func (*DeleteAppInstanceUserInput) operationName() string {
...
func (c *Client) addOperationDeleteAppInstanceUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAppInstanceUserResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteAppInstanceUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteAppInstanceUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteAppInstanceUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAppInstanceUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteAppInstanceUserResolveEndpointMiddleware{
