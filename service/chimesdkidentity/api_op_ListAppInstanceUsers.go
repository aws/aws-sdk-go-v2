...
func (c *Client) ListAppInstanceUsers(ctx context.Context, params *ListAppInstanceUsersInput, optFns ...func(*Options)) (*ListAppInstanceUsersOutput, error) {
	if params == nil { params = &ListAppInstanceUsersInput{} }
...
func (c *Client) addOperationListAppInstanceUsersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAppInstanceUsersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAppInstanceUsersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAppInstanceUsersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAppInstanceUsersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAppInstanceUsersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAppInstanceUsersResolveEndpointMiddleware{
