...
func (*DeleteAppInstanceBotInput) operationName() string {
...
func (c *Client) addOperationDeleteAppInstanceBotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAppInstanceBotResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteAppInstanceBotResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteAppInstanceBotResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteAppInstanceBotResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAppInstanceBotResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteAppInstanceBotResolveEndpointMiddleware{
