...
func (c *Client) ListAppInstanceUserEndpoints(ctx context.Context, params *ListAppInstanceUserEndpointsInput, optFns ...func(*Options)) (*ListAppInstanceUserEndpointsOutput, error) {
	if params == nil { params = &ListAppInstanceUserEndpointsInput{} }
...
func (c *Client) addOperationListAppInstanceUserEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAppInstanceUserEndpointsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAppInstanceUserEndpointsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAppInstanceUserEndpointsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAppInstanceUserEndpointsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAppInstanceUserEndpointsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAppInstanceUserEndpointsResolveEndpointMiddleware{
