...
func (*UpdateAppInstanceUserInput) operationName() string {
...
func (c *Client) addOperationUpdateAppInstanceUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateAppInstanceUserResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateAppInstanceUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateAppInstanceUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateAppInstanceUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateAppInstanceUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateAppInstanceUserResolveEndpointMiddleware{
