...
func (c *Client) addOperationGetAppInstanceRetentionSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAppInstanceRetentionSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
