...
func (c *Client) addOperationPutAppInstanceUserExpirationSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutAppInstanceUserExpirationSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
