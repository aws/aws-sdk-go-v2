...
func (c *Client) PutAppInstanceUserExpirationSettings(ctx context.Context, params *PutAppInstanceUserExpirationSettingsInput, optFns ...func(*Options)) (*PutAppInstanceUserExpirationSettingsOutput, error) {
	if params == nil { params = &PutAppInstanceUserExpirationSettingsInput{} }
...
func (c *Client) addOperationPutAppInstanceUserExpirationSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutAppInstanceUserExpirationSettingsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutAppInstanceUserExpirationSettingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutAppInstanceUserExpirationSettingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutAppInstanceUserExpirationSettingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutAppInstanceUserExpirationSettingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutAppInstanceUserExpirationSettingsResolveEndpointMiddleware{
