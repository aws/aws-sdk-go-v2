...
func (v *CreateAppInstanceUserOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.CreateAppInstanceUserResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *CreateAppInstanceUserOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AppInstanceUserArn != nil {
		s.WriteString(schemas.CreateAppInstanceUserResponse_AppInstanceUserArn, *v.AppInstanceUserArn)
	}
}
