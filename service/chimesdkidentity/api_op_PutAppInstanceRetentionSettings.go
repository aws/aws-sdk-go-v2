...
func (v *PutAppInstanceRetentionSettingsOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.PutAppInstanceRetentionSettingsResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *PutAppInstanceRetentionSettingsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AppInstanceRetentionSettings != nil {
		s.WriteStruct(schemas.PutAppInstanceRetentionSettingsResponse_AppInstanceRetentionSettings)
		v.AppInstanceRetentionSettings.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.InitiateDeletionTimestamp != nil {
		s.WriteTime(schemas.PutAppInstanceRetentionSettingsResponse_InitiateDeletionTimestamp, *v.InitiateDeletionTimestamp)
	}
}
