...
func (c *Client) addOperationDescribeAppInstanceAdminMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAppInstanceAdmin", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
