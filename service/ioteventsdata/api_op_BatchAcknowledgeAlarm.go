...
func (*BatchAcknowledgeAlarmInput) operationName() string {
...
func (c *Client) addOperationBatchAcknowledgeAlarmMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchAcknowledgeAlarmResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opBatchAcknowledgeAlarmResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opBatchAcknowledgeAlarmResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchAcknowledgeAlarmResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchAcknowledgeAlarmResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opBatchAcknowledgeAlarmResolveEndpointMiddleware{
