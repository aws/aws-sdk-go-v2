...
func (c *Client) BatchEnableAlarm(ctx context.Context, params *BatchEnableAlarmInput, optFns ...func(*Options)) (*BatchEnableAlarmOutput, error) {
	if params == nil { params = &BatchEnableAlarmInput{} }
...
func (c *Client) addOperationBatchEnableAlarmMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchEnableAlarmResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchEnableAlarmResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchEnableAlarmResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchEnableAlarmResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchEnableAlarmResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchEnableAlarmResolveEndpointMiddleware{
