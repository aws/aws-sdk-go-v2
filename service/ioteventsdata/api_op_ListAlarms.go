...
func (*ListAlarmsInput) operationName() string {
	return "ListAlarms"
}
...
func (c *Client) addOperationListAlarmsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAlarmsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListAlarmsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListAlarmsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAlarmsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAlarmsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListAlarmsResolveEndpointMiddleware{
