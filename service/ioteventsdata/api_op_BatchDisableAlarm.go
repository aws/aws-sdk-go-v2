...
func (*BatchDisableAlarmInput) operationName() string {
...
func (c *Client) addOperationBatchDisableAlarmMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchDisableAlarmResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opBatchDisableAlarmResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opBatchDisableAlarmResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchDisableAlarmResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchDisableAlarmResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opBatchDisableAlarmResolveEndpointMiddleware{
