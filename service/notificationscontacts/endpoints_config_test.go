...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-notificationscontacts.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-notificationscontacts.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-notificationscontacts.dev",
			expectURL:     aws.String("https://env-notificationscontacts.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-notificationscontacts.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-notificationscontacts.dev",
			expectURL:     aws.String("http://config-notificationscontacts.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-notificationscontacts.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-notificationscontacts.dev",
			clientEndpoint: aws.String("https://client-notificationscontacts.dev"),
			expectURL:      aws.String("https://client-notificationscontacts.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_NOTIFICATIONSCONTACTS", c.envService)
			}
