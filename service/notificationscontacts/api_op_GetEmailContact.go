...
func (c *Client) GetEmailContact(ctx context.Context, params *GetEmailContactInput, optFns ...func(*Options)) (*GetEmailContactOutput, error) {
	if params == nil { params = &GetEmailContactInput{} }
...
func (c *Client) addOperationGetEmailContactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err != nil { return err }
	if err := addProtocolFinalizerMiddlewares(stack, options, "GetEmailContact"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetEmailContact(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opGetEmailContact(region string) *awsmiddleware.RegisterServiceMetadata {
