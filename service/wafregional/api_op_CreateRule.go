...
// ByteMatchSetobjects, and other predicates that identify the requests that you
// want to block. If you add more than one predicate to a Rule, a request must
// match all of the specifications to be allowed or blocked. For example, suppose
// that you add the following to a Rule :
//   - An IPSet that matches the IP address 192.0.2.44/32
//   - A ByteMatchSet that matches BadBot in the User-Agent header
//
// You then add
// the Rule  to a WebACL and specify that you want to blocks requests that
// satisfy the Rule. For a request to be blocked, it must come from the IP
