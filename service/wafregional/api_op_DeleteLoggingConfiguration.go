...
func addOperationDeleteLoggingConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteLoggingConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteLoggingConfigurationStackSlots(stack); err != nil {
		return err
	}
