...
// WAF Regional. See this package's package overview docs
...
const (
	ServiceName = "WAF Regional" // Service's name
	ServiceID   = "WAFRegional"  // Service's identifier
	EndpointsID = "waf-regional" // Service's Endpoint identifier
)
