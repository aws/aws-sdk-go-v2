...
// and global use. Permanently deletes a RateBasedRule. You can't delete a rule
// if it's still used in any WebACL objects or if it still includes any
// predicates, such as ByteMatchSet objects. If you just want to remove a rule
// from a WebACL , use UpdateWebACL . To permanently delete a RateBasedRule from
