...
// The web ACL has an unsupported entity but the IgnoreUnsupportedType is not set
// to true.
...
// - S3_BUCKET_NOT_ACCESSIBLE - The
// bucket policy doesn't allow AWS WAF to perform the PutObject action in the
// bucket.
...
// - You tried
// to remove a Rule from a WebACL, but the Rule isn't in the specified WebACL.
// -
...
// - You tried to add a Rule to a
// WebACL, but the Rule already exists in the specified WebACL.
// - You tried to add
// a ByteMatchTuple to a ByteMatchSet, but the ByteMatchTuple already exists in the
// specified WebACL.
...
// WebACL with a DefaultActionType other than ALLOW, BLOCK, or COUNT.
// - You tried
// to create a RateBasedRule with a RateKey value other than IP.
// - You tried to
// update a WebACL with a WafActionType other than ALLOW, BLOCK, or COUNT.
// - You
// tried to update a ByteMatchSet with a FieldToMatchType other than HEADER,
// METHOD, QUERY_STRING, URI, or BODY.
// - You tried to update a ByteMatchSet with a
// Field of HEADER but no value for Data.
// - Your request references an ARN that is
// malformed, or corresponds to a resource with which a web ACL cannot be
// associated.
...
// policy with each PutPermissionPolicy request.
// - The policy must include an
// Effect, Action and Principal.
// - Effect must specify Allow.
// - The Action in the
// policy must be waf:UpdateWebACL, waf-regional:UpdateWebACL, waf:GetRuleGroup and
// waf-regional:GetRuleGroup . Any extra or wildcard actions in the policy will be
// rejected.
...
// that contains one or more ByteMatchTuple objects.
...
// to or delete a Rule from a WebACL that doesn't exist.
// - You tried to add a
// ByteMatchSet to or delete a ByteMatchSet from a Rule that doesn't exist.
// - You
// tried to add an IP address to or delete an IP address from an IPSet that doesn't
// exist.
