...
// to a WebACL, but the Rule already exists in the specified WebACL.
//
// * You tried
// to add a ByteMatchTuple to a ByteMatchSet, but the ByteMatchTuple already exists
...
// ByteMatchSet with a Field of HEADER but no value for Data.
//
// * Your request
