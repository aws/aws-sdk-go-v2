...
func (c *Client) ListRateBasedRules(ctx context.Context, params *ListRateBasedRulesInput, optFns ...func(*Options)) (*ListRateBasedRulesOutput, error) {
	if params == nil { params = &ListRateBasedRulesInput{} }
...
func (c *Client) addOperationListRateBasedRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRateBasedRulesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRateBasedRulesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRateBasedRulesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRateBasedRulesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRateBasedRulesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRateBasedRulesResolveEndpointMiddleware{
