...
func (r *resolver) ResolveEndpoint(
	...
	if exprVal := params.Region; exprVal != nil {
		...
		if exprVal := awsrulesfn.GetPartition(_Region); exprVal != nil {
			...
			if _Region == "af-south-1" {
				uriString := "https://waf-regional.af-south-1.amazonaws.com"
			...
			if _Region == "ap-east-1" {
				uriString := "https://waf-regional.ap-east-1.amazonaws.com"
			...
			if _Region == "ap-northeast-1" {
				uriString := "https://waf-regional.ap-northeast-1.amazonaws.com"
			...
			if _Region == "ap-northeast-2" {
				uriString := "https://waf-regional.ap-northeast-2.amazonaws.com"
			...
			if _Region == "ap-northeast-3" {
				uriString := "https://waf-regional.ap-northeast-3.amazonaws.com"
			...
			if _Region == "ap-south-1" {
				uriString := "https://waf-regional.ap-south-1.amazonaws.com"
			...
			if _Region == "ap-southeast-1" {
				uriString := "https://waf-regional.ap-southeast-1.amazonaws.com"
			...
			if _Region == "ap-southeast-2" {
				uriString := "https://waf-regional.ap-southeast-2.amazonaws.com"
			...
			if _Region == "ap-southeast-3" {
				uriString := "https://waf-regional.ap-southeast-3.amazonaws.com"
			...
			if _Region == "ca-central-1" {
				uriString := "https://waf-regional.ca-central-1.amazonaws.com"
			...
			if _Region == "eu-central-1" {
				uriString := "https://waf-regional.eu-central-1.amazonaws.com"
			...
			if _Region == "eu-north-1" {
				uriString := "https://waf-regional.eu-north-1.amazonaws.com"
			...
			if _Region == "eu-south-1" {
				uriString := "https://waf-regional.eu-south-1.amazonaws.com"
			...
			if _Region == "eu-west-1" {
				uriString := "https://waf-regional.eu-west-1.amazonaws.com"
			...
			if _Region == "eu-west-2" {
				uriString := "https://waf-regional.eu-west-2.amazonaws.com"
			...
			if _Region == "eu-west-3" {
				uriString := "https://waf-regional.eu-west-3.amazonaws.com"
			...
			if _Region == "me-south-1" {
				uriString := "https://waf-regional.me-south-1.amazonaws.com"
			...
			if _Region == "sa-east-1" {
				uriString := "https://waf-regional.sa-east-1.amazonaws.com"
			...
			if _Region == "us-east-1" {
				uriString := "https://waf-regional.us-east-1.amazonaws.com"
			...
			if _Region == "us-east-2" {
				uriString := "https://waf-regional.us-east-2.amazonaws.com"
			...
			if _Region == "us-west-1" {
				uriString := "https://waf-regional.us-west-1.amazonaws.com"
			...
			if _Region == "us-west-2" {
				uriString := "https://waf-regional.us-west-2.amazonaws.com"
			...
			if _Region == "cn-north-1" {
				uriString := "https://waf-regional.cn-north-1.amazonaws.com.cn"
			...
			if _Region == "cn-northwest-1" {
				uriString := "https://waf-regional.cn-northwest-1.amazonaws.com.cn"
			...
			if _Region == "us-gov-east-1" {
				uriString := "https://waf-regional.us-gov-east-1.amazonaws.com"
			...
			if _Region == "us-gov-west-1" {
				uriString := "https://waf-regional.us-gov-west-1.amazonaws.com"
