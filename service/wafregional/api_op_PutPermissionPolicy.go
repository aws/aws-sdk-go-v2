...
// - The Action in
// the policy must be waf:UpdateWebACL, waf-regional:UpdateWebACL, waf:GetRuleGroup
// and waf-regional:GetRuleGroup . Any extra or wildcard actions in the policy will
// be rejected.
// - The policy cannot include a Resource parameter.
// - The ARN in the
// request must be a valid WAF RuleGroup ARN and the RuleGroup must exist in the
// same region.
