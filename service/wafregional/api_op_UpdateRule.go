...
func (c *Client) UpdateRule(ctx context.Context, params *UpdateRuleInput, optFns ...func(*Options)) (*UpdateRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRule", params, optFns, addOperationUpdateRuleMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRuleStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateRuleStackSlots(stack); err != nil {
		return err
	}
