...
// steps:
//
//     * Create an Amazon Kinesis Data Firehose. Create the data firehose
// with a PUT source and in the region that you are operating. However, if you are
...
func addOperationPutLoggingConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationPutLoggingConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutLoggingConfigurationStackSlots(stack); err != nil {
		return err
	}
