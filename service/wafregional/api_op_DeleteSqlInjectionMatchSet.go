...
func addOperationDeleteSqlInjectionMatchSetStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteSqlInjectionMatchSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteSqlInjectionMatchSetStackSlots(stack); err != nil {
		return err
	}
