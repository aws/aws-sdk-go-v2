...
func (c *Client) addOperationDeleteSqlInjectionMatchSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteSqlInjectionMatchSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
