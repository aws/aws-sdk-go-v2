...
type ListXssMatchSetsInput struct {
	...
	// allows you to list another group of XssMatchSets. For the second and
	// subsequent ListXssMatchSets  requests, specify the value of NextMarker from
	// the previous response to get information about another batch of XssMatchSets .
	NextMarker *string
