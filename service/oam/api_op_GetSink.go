...
func (c *Client) GetSink(ctx context.Context, params *GetSinkInput, optFns ...func(*Options)) (*GetSinkOutput, error) {
	if params == nil { params = &GetSinkInput{} }
...
func (c *Client) addOperationGetSinkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSinkResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSinkResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSinkResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSinkResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSinkResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSinkResolveEndpointMiddleware{
