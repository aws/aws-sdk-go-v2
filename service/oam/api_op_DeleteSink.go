...
func (c *Client) DeleteSink(ctx context.Context, params *DeleteSinkInput, optFns ...func(*Options)) (*DeleteSinkOutput, error) {
	if params == nil { params = &DeleteSinkInput{} }
...
func (c *Client) addOperationDeleteSinkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteSinkResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteSinkResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteSinkResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteSinkResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteSinkResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteSinkResolveEndpointMiddleware{
