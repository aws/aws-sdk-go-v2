...
func (c *Client) addOperationBatchAssociateUserStackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchAssociateUserStack", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
