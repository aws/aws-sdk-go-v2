...
func (*BatchAssociateUserStackInput) operationName() string {
...
func (c *Client) addOperationBatchAssociateUserStackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchAssociateUserStackResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opBatchAssociateUserStackResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opBatchAssociateUserStackResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchAssociateUserStackResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchAssociateUserStackResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opBatchAssociateUserStackResolveEndpointMiddleware{
