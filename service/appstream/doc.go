...
// access to your users on demand. You can call the AppStream 2.0 API operations by
// using an interface VPC endpoint (interface endpoint). For more information, see
