...
func (c *Client) addOperationCreateAppBlockBuilderStreamingURLMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateAppBlockBuilderStreamingURL", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
