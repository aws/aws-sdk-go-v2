...
func (c *Client) DescribeUsageReportSubscriptions(ctx context.Context, params *DescribeUsageReportSubscriptionsInput, optFns ...func(*Options)) (*DescribeUsageReportSubscriptionsOutput, error) {
	if params == nil { params = &DescribeUsageReportSubscriptionsInput{} }
...
func (c *Client) addOperationDescribeUsageReportSubscriptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeUsageReportSubscriptionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeUsageReportSubscriptionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeUsageReportSubscriptionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeUsageReportSubscriptionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeUsageReportSubscriptionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeUsageReportSubscriptionsResolveEndpointMiddleware{
