...
func addOperationDescribeUsageReportSubscriptionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeUsageReportSubscriptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeUsageReportSubscriptionsStackSlots(stack); err != nil {
		return err
	}
