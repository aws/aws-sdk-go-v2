...
func (c *Client) addOperationExpireSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addExpireSessionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opExpireSessionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opExpireSessionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opExpireSessionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addExpireSessionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opExpireSessionResolveEndpointMiddleware{
