...
func (c *Client) AssociateAppBlockBuilderAppBlock(ctx context.Context, params *AssociateAppBlockBuilderAppBlockInput, optFns ...func(*Options)) (*AssociateAppBlockBuilderAppBlockOutput, error) {
	if params == nil { params = &AssociateAppBlockBuilderAppBlockInput{} }
...
func (c *Client) addOperationAssociateAppBlockBuilderAppBlockMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateAppBlockBuilderAppBlockResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateAppBlockBuilderAppBlockResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateAppBlockBuilderAppBlockResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateAppBlockBuilderAppBlockResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateAppBlockBuilderAppBlockResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateAppBlockBuilderAppBlockResolveEndpointMiddleware{
