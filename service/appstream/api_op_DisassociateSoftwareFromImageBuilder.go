...
func (c *Client) addOperationDisassociateSoftwareFromImageBuilderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateSoftwareFromImageBuilder", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
