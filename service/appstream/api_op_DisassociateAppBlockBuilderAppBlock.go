...
func (c *Client) addOperationDisassociateAppBlockBuilderAppBlockMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateAppBlockBuilderAppBlock", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
