...
func (*DisassociateAppBlockBuilderAppBlockInput) operationName() string {
...
func (c *Client) addOperationDisassociateAppBlockBuilderAppBlockMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateAppBlockBuilderAppBlockResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDisassociateAppBlockBuilderAppBlockResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDisassociateAppBlockBuilderAppBlockResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateAppBlockBuilderAppBlockResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateAppBlockBuilderAppBlockResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDisassociateAppBlockBuilderAppBlockResolveEndpointMiddleware{
