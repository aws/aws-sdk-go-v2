...
func (*UpdateEntitlementInput) operationName() string {
...
func (c *Client) addOperationUpdateEntitlementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateEntitlementResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateEntitlementResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateEntitlementResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateEntitlementResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateEntitlementResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateEntitlementResolveEndpointMiddleware{
