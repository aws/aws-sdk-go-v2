...
func addOperationCreateImageBuilderStreamingURLStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateImageBuilderStreamingURLMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateImageBuilderStreamingURLStackSlots(stack); err != nil {
		return err
	}
