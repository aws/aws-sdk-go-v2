...
func (c *Client) StopImageBuilder(ctx context.Context, params *StopImageBuilderInput, optFns ...func(*Options)) (*StopImageBuilderOutput, error) {
	stack := middleware.NewStack("StopImageBuilder", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpStopImageBuilderMiddlewares(stack)
...
func addawsAwsjson11_serdeOpStopImageBuilderMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpStopImageBuilder{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpStopImageBuilder{}, middleware.After)
}
