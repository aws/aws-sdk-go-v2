...
func (c *Client) StopImageBuilder(ctx context.Context, params *StopImageBuilderInput, optFns ...func(*Options)) (*StopImageBuilderOutput, error) {
	if params == nil { params = &StopImageBuilderInput{} }
...
func (c *Client) addOperationStopImageBuilderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopImageBuilderResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopImageBuilderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopImageBuilderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopImageBuilderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopImageBuilderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopImageBuilderResolveEndpointMiddleware{
