...
func (*UpdateImagePermissionsInput) operationName() string {
...
func (c *Client) addOperationUpdateImagePermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateImagePermissionsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateImagePermissionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateImagePermissionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateImagePermissionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateImagePermissionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateImagePermissionsResolveEndpointMiddleware{
