...
func (c *Client) addOperationDisassociateApplicationFromEntitlementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateApplicationFromEntitlement", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
