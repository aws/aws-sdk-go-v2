...
func (c *Client) addOperationAssociateApplicationToEntitlementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateApplicationToEntitlement", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
