...
func (c *Client) AssociateApplicationToEntitlement(ctx context.Context, params *AssociateApplicationToEntitlementInput, optFns ...func(*Options)) (*AssociateApplicationToEntitlementOutput, error) {
	if params == nil { params = &AssociateApplicationToEntitlementInput{} }
...
func (c *Client) addOperationAssociateApplicationToEntitlementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateApplicationToEntitlementResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateApplicationToEntitlementResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateApplicationToEntitlementResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateApplicationToEntitlementResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateApplicationToEntitlementResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateApplicationToEntitlementResolveEndpointMiddleware{
