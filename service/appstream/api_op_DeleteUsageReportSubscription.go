...
func addOperationDeleteUsageReportSubscriptionStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteUsageReportSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteUsageReportSubscriptionStackSlots(stack); err != nil {
		return err
	}
