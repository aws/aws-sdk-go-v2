...
func (*DeleteImagePermissionsInput) operationName() string {
...
func (c *Client) addOperationDeleteImagePermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteImagePermissionsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteImagePermissionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteImagePermissionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteImagePermissionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteImagePermissionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteImagePermissionsResolveEndpointMiddleware{
