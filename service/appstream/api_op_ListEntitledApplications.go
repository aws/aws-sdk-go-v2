...
func (c *Client) ListEntitledApplications(ctx context.Context, params *ListEntitledApplicationsInput, optFns ...func(*Options)) (*ListEntitledApplicationsOutput, error) {
	if params == nil { params = &ListEntitledApplicationsInput{} }
...
func (c *Client) addOperationListEntitledApplicationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEntitledApplicationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListEntitledApplicationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListEntitledApplicationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEntitledApplicationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEntitledApplicationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListEntitledApplicationsResolveEndpointMiddleware{
