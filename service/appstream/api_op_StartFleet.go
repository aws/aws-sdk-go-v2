...
func (c *Client) StartFleet(ctx context.Context, params *StartFleetInput, optFns ...func(*Options)) (*StartFleetOutput, error) {
	if params == nil { params = &StartFleetInput{} }
...
func (c *Client) addOperationStartFleetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartFleetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartFleetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartFleetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartFleetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartFleetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartFleetResolveEndpointMiddleware{
