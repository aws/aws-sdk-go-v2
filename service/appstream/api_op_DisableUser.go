...
func (c *Client) DisableUser(ctx context.Context, params *DisableUserInput, optFns ...func(*Options)) (*DisableUserOutput, error) {
	if params == nil { params = &DisableUserInput{} }
...
func (c *Client) addOperationDisableUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableUserResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisableUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisableUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisableUserResolveEndpointMiddleware{
