...
func (c *Client) addOperationDescribeAppBlockBuilderAppBlockAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAppBlockBuilderAppBlockAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
