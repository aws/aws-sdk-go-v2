...
func (*DeleteAppBlockBuilderInput) operationName() string {
...
func (c *Client) addOperationDeleteAppBlockBuilderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAppBlockBuilderResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteAppBlockBuilderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteAppBlockBuilderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteAppBlockBuilderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAppBlockBuilderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteAppBlockBuilderResolveEndpointMiddleware{
