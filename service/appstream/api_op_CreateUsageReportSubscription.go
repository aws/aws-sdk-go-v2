...
func addOperationCreateUsageReportSubscriptionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateUsageReportSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateUsageReportSubscriptionStackSlots(stack); err != nil {
		return err
	}
