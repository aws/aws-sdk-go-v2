...
func addOperationDescribeUserStackAssociationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeUserStackAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeUserStackAssociationsStackSlots(stack); err != nil {
		return err
	}
