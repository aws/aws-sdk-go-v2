...
func (c *Client) addOperationDescribeUserStackAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeUserStackAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
