...
func (c *Client) DescribeAppBlockBuilders(ctx context.Context, params *DescribeAppBlockBuildersInput, optFns ...func(*Options)) (*DescribeAppBlockBuildersOutput, error) {
	if params == nil { params = &DescribeAppBlockBuildersInput{} }
...
func (c *Client) addOperationDescribeAppBlockBuildersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeAppBlockBuildersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeAppBlockBuildersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeAppBlockBuildersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeAppBlockBuildersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeAppBlockBuildersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeAppBlockBuildersResolveEndpointMiddleware{
