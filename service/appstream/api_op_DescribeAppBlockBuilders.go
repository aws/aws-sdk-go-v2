...
func (c *Client) addOperationDescribeAppBlockBuildersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAppBlockBuilders", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
