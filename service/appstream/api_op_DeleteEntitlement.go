...
func (c *Client) DeleteEntitlement(ctx context.Context, params *DeleteEntitlementInput, optFns ...func(*Options)) (*DeleteEntitlementOutput, error) {
	if params == nil { params = &DeleteEntitlementInput{} }
...
func (c *Client) addOperationDeleteEntitlementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteEntitlementResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteEntitlementResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteEntitlementResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteEntitlementResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteEntitlementResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteEntitlementResolveEndpointMiddleware{
