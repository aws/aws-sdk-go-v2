...
func (c *Client) GetHomeRegion(ctx context.Context, params *GetHomeRegionInput, optFns ...func(*Options)) (*GetHomeRegionOutput, error) {
	if params == nil { params = &GetHomeRegionInput{} }
...
func (c *Client) addOperationGetHomeRegionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetHomeRegionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetHomeRegionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetHomeRegionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetHomeRegionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetHomeRegionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetHomeRegionResolveEndpointMiddleware{
