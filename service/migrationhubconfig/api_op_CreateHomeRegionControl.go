...
func (c *Client) addOperationCreateHomeRegionControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateHomeRegionControl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
