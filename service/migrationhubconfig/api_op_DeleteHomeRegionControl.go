...
func (c *Client) addOperationDeleteHomeRegionControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteHomeRegionControl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
