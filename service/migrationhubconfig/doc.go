...
//
//     * API calls for read actions
// (list, describe, stop, and delete) are permitted outside of your home region.
//
//
...
//
// For specific API usage, see the sections that follow
// in this AWS Migration Hub Home Region API reference.
