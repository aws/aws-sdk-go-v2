...
func addOperationDescribeHomeRegionControlsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeHomeRegionControlsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeHomeRegionControlsStackSlots(stack); err != nil {
		return err
	}
