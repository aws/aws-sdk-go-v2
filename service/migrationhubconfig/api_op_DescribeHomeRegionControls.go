...
func (c *Client) addOperationDescribeHomeRegionControlsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeHomeRegionControls", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
