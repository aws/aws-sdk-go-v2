module github.com/Enflick/aws-sdk-go-v2/service/timestreamquery
...
require (
	...
	github.com/Enflick/aws-sdk-go-v2/service/internal/endpoint-discovery v0.0.0-20250325221836-b4195dfa2eb5
