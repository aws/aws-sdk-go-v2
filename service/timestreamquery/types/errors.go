...
func (v *QueryExecutionException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.QueryExecutionException, func(s *smithy.Schema) error {
		switch s {
		case schemas.QueryExecutionException_Message:
			v.Message = new(string)
			return d.ReadString(schemas.QueryExecutionException_Message, v.Message)
		}
		return nil
	})
}
...
func (v *ResourceNotFoundException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ResourceNotFoundException, func(s *smithy.Schema) error {
		...
		case schemas.ResourceNotFoundException_ScheduledQueryArn:
			v.ScheduledQueryArn = new(string)
			return d.ReadString(schemas.ResourceNotFoundException_ScheduledQueryArn, v.ScheduledQueryArn)
		}
		return nil
	})
}
