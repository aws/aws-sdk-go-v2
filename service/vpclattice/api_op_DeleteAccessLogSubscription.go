...
func (*DeleteAccessLogSubscriptionInput) operationName() string {
...
func (c *Client) addOperationDeleteAccessLogSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAccessLogSubscriptionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteAccessLogSubscriptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteAccessLogSubscriptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteAccessLogSubscriptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAccessLogSubscriptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteAccessLogSubscriptionResolveEndpointMiddleware{
