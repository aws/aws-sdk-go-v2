...
func (c *Client) CreateResourceGateway(ctx context.Context, params *CreateResourceGatewayInput, optFns ...func(*Options)) (*CreateResourceGatewayOutput, error) {
	if params == nil { params = &CreateResourceGatewayInput{} }
...
func (m *idempotencyToken_initializeOpCreateResourceGateway) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *CreateResourceGatewayInput ")}
