...
func (c *Client) StartDomainVerification(ctx context.Context, params *StartDomainVerificationInput, optFns ...func(*Options)) (*StartDomainVerificationOutput, error) {
	if params == nil { params = &StartDomainVerificationInput{} }
...
func (m *idempotencyToken_initializeOpStartDomainVerification) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *StartDomainVerificationInput ")}
