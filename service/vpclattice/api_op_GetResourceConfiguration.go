...
func (c *Client) addOperationGetResourceConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetResourceConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
