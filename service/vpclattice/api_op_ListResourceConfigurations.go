...
func (c *Client) addOperationListResourceConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListResourceConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
