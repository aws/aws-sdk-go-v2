...
func (c *Client) addOperationListDomainVerificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDomainVerifications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
