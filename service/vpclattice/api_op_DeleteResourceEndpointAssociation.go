...
func (c *Client) DeleteResourceEndpointAssociation(ctx context.Context, params *DeleteResourceEndpointAssociationInput, optFns ...func(*Options)) (*DeleteResourceEndpointAssociationOutput, error) {
	if params == nil { params = &DeleteResourceEndpointAssociationInput{} }
...
func (c *Client) addOperationDeleteResourceEndpointAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err != nil { return err }
	if err := addProtocolFinalizerMiddlewares(stack, options, "DeleteResourceEndpointAssociation"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteResourceEndpointAssociation(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opDeleteResourceEndpointAssociation(region string) *awsmiddleware.RegisterServiceMetadata {
