...
func (c *Client) ListServiceNetworks(ctx context.Context, params *ListServiceNetworksInput, optFns ...func(*Options)) (*ListServiceNetworksOutput, error) {
	if params == nil { params = &ListServiceNetworksInput{} }
...
func (c *Client) addOperationListServiceNetworksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListServiceNetworksResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListServiceNetworksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListServiceNetworksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListServiceNetworksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListServiceNetworksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListServiceNetworksResolveEndpointMiddleware{
