...
func (c *Client) CreateServiceNetworkResourceAssociation(ctx context.Context, params *CreateServiceNetworkResourceAssociationInput, optFns ...func(*Options)) (*CreateServiceNetworkResourceAssociationOutput, error) {
	if params == nil { params = &CreateServiceNetworkResourceAssociationInput{} }
...
func (m *idempotencyToken_initializeOpCreateServiceNetworkResourceAssociation) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *CreateServiceNetworkResourceAssociationInput ")}
