...
func (c *Client) UpdateUserAccessLoggingSettings(ctx context.Context, params *UpdateUserAccessLoggingSettingsInput, optFns ...func(*Options)) (*UpdateUserAccessLoggingSettingsOutput, error) {
	if params == nil { params = &UpdateUserAccessLoggingSettingsInput{} }
...
func (c *Client) addOperationUpdateUserAccessLoggingSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateUserAccessLoggingSettingsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
func (m *idempotencyToken_initializeOpUpdateUserAccessLoggingSettings) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *UpdateUserAccessLoggingSettingsInput ")}
...
type opUpdateUserAccessLoggingSettingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateUserAccessLoggingSettingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateUserAccessLoggingSettingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateUserAccessLoggingSettingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateUserAccessLoggingSettingsResolveEndpointMiddleware{
