...
func (*ListNetworkSettingsInput) operationName() string {
...
func (c *Client) addOperationListNetworkSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListNetworkSettingsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListNetworkSettingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListNetworkSettingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListNetworkSettingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListNetworkSettingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListNetworkSettingsResolveEndpointMiddleware{
