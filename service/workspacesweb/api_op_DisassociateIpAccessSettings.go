...
func (c *Client) addOperationDisassociateIpAccessSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateIpAccessSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
