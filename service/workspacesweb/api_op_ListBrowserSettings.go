...
func (*ListBrowserSettingsInput) operationName() string {
...
func (c *Client) addOperationListBrowserSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBrowserSettingsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListBrowserSettingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListBrowserSettingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBrowserSettingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListBrowserSettingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListBrowserSettingsResolveEndpointMiddleware{
