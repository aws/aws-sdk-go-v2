...
func (c *Client) GetUserAccessLoggingSettings(ctx context.Context, params *GetUserAccessLoggingSettingsInput, optFns ...func(*Options)) (*GetUserAccessLoggingSettingsOutput, error) {
	if params == nil { params = &GetUserAccessLoggingSettingsInput{} }
...
func (c *Client) addOperationGetUserAccessLoggingSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetUserAccessLoggingSettingsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetUserAccessLoggingSettingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetUserAccessLoggingSettingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetUserAccessLoggingSettingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetUserAccessLoggingSettingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetUserAccessLoggingSettingsResolveEndpointMiddleware{
