...
func (c *Client) addOperationCreateUserAccessLoggingSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateUserAccessLoggingSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
