...
func (c *Client) addOperationListTrustStoresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTrustStoresResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListTrustStoresResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListTrustStoresResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTrustStoresResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTrustStoresResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListTrustStoresResolveEndpointMiddleware{
