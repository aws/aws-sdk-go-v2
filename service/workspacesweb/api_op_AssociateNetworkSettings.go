...
func (c *Client) AssociateNetworkSettings(ctx context.Context, params *AssociateNetworkSettingsInput, optFns ...func(*Options)) (*AssociateNetworkSettingsOutput, error) {
	if params == nil { params = &AssociateNetworkSettingsInput{} }
...
func (c *Client) addOperationAssociateNetworkSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateNetworkSettingsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateNetworkSettingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateNetworkSettingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateNetworkSettingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateNetworkSettingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateNetworkSettingsResolveEndpointMiddleware{
