...
func (*ListIpAccessSettingsInput) operationName() string {
...
func (c *Client) addOperationListIpAccessSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListIpAccessSettingsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListIpAccessSettingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListIpAccessSettingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListIpAccessSettingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListIpAccessSettingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListIpAccessSettingsResolveEndpointMiddleware{
