...
func (c *Client) addOperationAssociateBrowserSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateBrowserSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
