...
func (c *Client) addOperationDisassociateUserSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateUserSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
