...
func (c *Client) DeleteBrowserSettings(ctx context.Context, params *DeleteBrowserSettingsInput, optFns ...func(*Options)) (*DeleteBrowserSettingsOutput, error) {
	if params == nil { params = &DeleteBrowserSettingsInput{} }
...
func (c *Client) addOperationDeleteBrowserSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteBrowserSettingsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteBrowserSettingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteBrowserSettingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteBrowserSettingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteBrowserSettingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteBrowserSettingsResolveEndpointMiddleware{
