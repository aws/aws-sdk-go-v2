...
func (c *Client) addOperationDeleteUserAccessLoggingSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteUserAccessLoggingSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
