...
func (c *Client) GetPortalServiceProviderMetadata(ctx context.Context, params *GetPortalServiceProviderMetadataInput, optFns ...func(*Options)) (*GetPortalServiceProviderMetadataOutput, error) {
	if params == nil { params = &GetPortalServiceProviderMetadataInput{} }
...
func (c *Client) addOperationGetPortalServiceProviderMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPortalServiceProviderMetadataResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPortalServiceProviderMetadataResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPortalServiceProviderMetadataResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPortalServiceProviderMetadataResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPortalServiceProviderMetadataResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPortalServiceProviderMetadataResolveEndpointMiddleware{
