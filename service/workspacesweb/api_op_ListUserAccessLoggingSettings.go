...
func (*ListUserAccessLoggingSettingsInput) operationName() string {
...
func (c *Client) addOperationListUserAccessLoggingSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListUserAccessLoggingSettingsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListUserAccessLoggingSettingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListUserAccessLoggingSettingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListUserAccessLoggingSettingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListUserAccessLoggingSettingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListUserAccessLoggingSettingsResolveEndpointMiddleware{
