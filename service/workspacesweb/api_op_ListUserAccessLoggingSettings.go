...
func (c *Client) addOperationListUserAccessLoggingSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListUserAccessLoggingSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
