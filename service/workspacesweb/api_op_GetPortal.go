...
func (c *Client) GetPortal(ctx context.Context, params *GetPortalInput, optFns ...func(*Options)) (*GetPortalOutput, error) {
	if params == nil { params = &GetPortalInput{} }
...
func (c *Client) addOperationGetPortalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPortalResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPortalResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPortalResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPortalResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPortalResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPortalResolveEndpointMiddleware{
