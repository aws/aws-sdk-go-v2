...
func (c *Client) addOperationUpdateServicePrimaryTaskSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateServicePrimaryTaskSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
