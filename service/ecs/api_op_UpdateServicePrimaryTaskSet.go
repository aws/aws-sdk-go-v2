...
func addOperationUpdateServicePrimaryTaskSetStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateServicePrimaryTaskSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateServicePrimaryTaskSetStackSlots(stack); err != nil {
		return err
	}
