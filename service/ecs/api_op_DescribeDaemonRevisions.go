...
func (c *Client) addOperationDescribeDaemonRevisionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDaemonRevisions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
