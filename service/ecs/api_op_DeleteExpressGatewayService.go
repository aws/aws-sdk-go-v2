...
func (c *Client) addOperationDeleteExpressGatewayServiceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteExpressGatewayService", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
