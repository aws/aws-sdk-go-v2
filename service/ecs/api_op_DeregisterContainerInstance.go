...
func addOperationDeregisterContainerInstanceStackSlots(stack *middleware.Stack) error {
...
func addOperationDeregisterContainerInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeregisterContainerInstanceStackSlots(stack); err != nil {
		return err
	}
