...
func (c *Client) addOperationDeregisterContainerInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterContainerInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
