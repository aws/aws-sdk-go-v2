...
func addOperationListTaskDefinitionFamiliesStackSlots(stack *middleware.Stack) error {
...
func addOperationListTaskDefinitionFamiliesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListTaskDefinitionFamiliesStackSlots(stack); err != nil {
		return err
	}
