...
//     the Docker daemon (shown in the valid values below). Additional log drivers may
...
type ManagedScaling struct {
	...
	// be greater than 0 and less than or equal to 100 . A value of 100 results in the
