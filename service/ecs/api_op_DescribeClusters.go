...
type DescribeClustersInput struct {
	...
	// ATTACHMENTSis specified, the attachments for the container instances or tasks
	// within the cluster are included, for example the capacity providers. If
	// SETTINGS is specified, the settings for the cluster are included. If
	// CONFIGURATIONS is specified, the configuration for the cluster is included. If
	// STATISTICSis specified, the task and service count is included, separated by
	// launch type. If TAGS is specified, the metadata tags associated with the
