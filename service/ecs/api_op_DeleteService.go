...
// that require cleanup, the service status moves from ACTIVE  to DRAINING, and
// the service is no longer visible in the console or in the ListServices API
...
// services return a ServiceNotFoundException error. If you attempt to create a
// new service with the same name as an existing service in either ACTIVE  or
