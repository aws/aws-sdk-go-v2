...
func (c *Client) addOperationPutClusterCapacityProvidersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutClusterCapacityProviders", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
