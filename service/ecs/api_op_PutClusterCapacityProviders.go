...
func addOperationPutClusterCapacityProvidersStackSlots(stack *middleware.Stack) error {
...
func addOperationPutClusterCapacityProvidersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutClusterCapacityProvidersStackSlots(stack); err != nil {
		return err
	}
