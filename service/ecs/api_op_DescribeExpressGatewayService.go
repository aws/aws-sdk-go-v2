...
func (c *Client) addOperationDescribeExpressGatewayServiceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeExpressGatewayService", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
