...
// instance or instances. The following change began on March 21, 2024. When the
// task definition revision is not specified, Amazon ECS resolves the task
// definition revision before it authorizes the task definition. Starting April 15,
...
// use RunTask to place tasks for you. For more information, see Scheduling Tasks (https://docs.aws.amazon.com/AmazonECS/latest/developerguide/scheduling_tasks.html)
