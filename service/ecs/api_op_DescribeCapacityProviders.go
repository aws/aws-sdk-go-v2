...
func (c *Client) addOperationDescribeCapacityProvidersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCapacityProviders", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
