...
func (c *Client) addOperationUpdateContainerInstancesStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateContainerInstancesState", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
