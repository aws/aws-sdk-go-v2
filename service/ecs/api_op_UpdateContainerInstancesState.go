...
func addOperationUpdateContainerInstancesStateStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateContainerInstancesStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateContainerInstancesStateStackSlots(stack); err != nil {
		return err
	}
