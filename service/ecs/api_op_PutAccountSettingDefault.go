...
func (c *Client) addOperationPutAccountSettingDefaultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutAccountSettingDefault", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
