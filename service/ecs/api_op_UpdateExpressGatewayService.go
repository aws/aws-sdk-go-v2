...
func (c *Client) addOperationUpdateExpressGatewayServiceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateExpressGatewayService", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
