...
func (c *Client) addOperationSubmitContainerStateChangeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SubmitContainerStateChange", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
