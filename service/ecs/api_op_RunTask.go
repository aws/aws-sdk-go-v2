...
// the latest revision of a task definition. You can allow Amazon ECS to place
// tasks for you, or you can customize how Amazon ECS places tasks using placement
// constraints and placement strategies. For more information, see Scheduling Tasks (https://docs.aws.amazon.com/AmazonECS/latest/developerguide/scheduling_tasks.html)
