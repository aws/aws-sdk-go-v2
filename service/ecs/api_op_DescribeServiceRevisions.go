...
func (c *Client) addOperationDescribeServiceRevisionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeServiceRevisions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
