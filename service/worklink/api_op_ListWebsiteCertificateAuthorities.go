...
func (c *Client) ListWebsiteCertificateAuthorities(ctx context.Context, params *ListWebsiteCertificateAuthoritiesInput, optFns ...func(*Options)) (*ListWebsiteCertificateAuthoritiesOutput, error) {
	if params == nil { params = &ListWebsiteCertificateAuthoritiesInput{} }
...
func (c *Client) addOperationListWebsiteCertificateAuthoritiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWebsiteCertificateAuthoritiesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListWebsiteCertificateAuthoritiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListWebsiteCertificateAuthoritiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWebsiteCertificateAuthoritiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWebsiteCertificateAuthoritiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListWebsiteCertificateAuthoritiesResolveEndpointMiddleware{
