...
func addOperationListWebsiteCertificateAuthoritiesStackSlots(stack *middleware.Stack) error {
...
func addOperationListWebsiteCertificateAuthoritiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListWebsiteCertificateAuthoritiesStackSlots(stack); err != nil {
		return err
	}
