...
func addOperationDescribeDevicePolicyConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeDevicePolicyConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeDevicePolicyConfigurationStackSlots(stack); err != nil {
		return err
	}
