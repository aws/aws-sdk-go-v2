...
func addOperationUpdateAuditStreamConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateAuditStreamConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateAuditStreamConfigurationStackSlots(stack); err != nil {
		return err
	}
