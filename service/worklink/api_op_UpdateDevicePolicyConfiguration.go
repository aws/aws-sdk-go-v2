...
func addOperationUpdateDevicePolicyConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateDevicePolicyConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateDevicePolicyConfigurationStackSlots(stack); err != nil {
		return err
	}
