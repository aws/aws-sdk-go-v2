...
func (*RevokeDomainAccessInput) operationName() string {
...
func (c *Client) addOperationRevokeDomainAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRevokeDomainAccessResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRevokeDomainAccessResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRevokeDomainAccessResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRevokeDomainAccessResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRevokeDomainAccessResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRevokeDomainAccessResolveEndpointMiddleware{
