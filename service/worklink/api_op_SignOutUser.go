...
func (*SignOutUserInput) operationName() string {
	return "SignOutUser"
}
...
func (c *Client) addOperationSignOutUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSignOutUserResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opSignOutUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opSignOutUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSignOutUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSignOutUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opSignOutUserResolveEndpointMiddleware{
