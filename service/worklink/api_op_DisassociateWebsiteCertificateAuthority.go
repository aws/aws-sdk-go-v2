...
func addOperationDisassociateWebsiteCertificateAuthorityStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateWebsiteCertificateAuthorityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateWebsiteCertificateAuthorityStackSlots(stack); err != nil {
		return err
	}
