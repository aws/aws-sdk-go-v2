...
func (c *Client) UpdateDomainMetadata(ctx context.Context, params *UpdateDomainMetadataInput, optFns ...func(*Options)) (*UpdateDomainMetadataOutput, error) {
	stack := middleware.NewStack("UpdateDomainMetadata", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpUpdateDomainMetadataMiddlewares(stack)
...
func addawsRestjson1_serdeOpUpdateDomainMetadataMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpUpdateDomainMetadata{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpUpdateDomainMetadata{}, middleware.After)
}
