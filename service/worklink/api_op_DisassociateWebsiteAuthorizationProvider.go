...
func (c *Client) DisassociateWebsiteAuthorizationProvider(ctx context.Context, params *DisassociateWebsiteAuthorizationProviderInput, optFns ...func(*Options)) (*DisassociateWebsiteAuthorizationProviderOutput, error) {
	if params == nil { params = &DisassociateWebsiteAuthorizationProviderInput{} }
...
func (c *Client) addOperationDisassociateWebsiteAuthorizationProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateWebsiteAuthorizationProviderResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateWebsiteAuthorizationProviderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateWebsiteAuthorizationProviderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateWebsiteAuthorizationProviderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateWebsiteAuthorizationProviderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateWebsiteAuthorizationProviderResolveEndpointMiddleware{
