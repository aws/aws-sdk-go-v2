...
func addOperationDisassociateWebsiteAuthorizationProviderStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateWebsiteAuthorizationProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateWebsiteAuthorizationProviderStackSlots(stack); err != nil {
		return err
	}
