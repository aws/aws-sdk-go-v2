...
func addOperationUpdateCompanyNetworkConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateCompanyNetworkConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateCompanyNetworkConfigurationStackSlots(stack); err != nil {
		return err
	}
