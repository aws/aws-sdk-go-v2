...
func addOperationDescribeIdentityProviderConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeIdentityProviderConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeIdentityProviderConfigurationStackSlots(stack); err != nil {
		return err
	}
