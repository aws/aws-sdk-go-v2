...
func addOperationDescribeWebsiteCertificateAuthorityStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeWebsiteCertificateAuthorityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeWebsiteCertificateAuthorityStackSlots(stack); err != nil {
		return err
	}
