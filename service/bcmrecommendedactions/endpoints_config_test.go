...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-bcm-recommended-actions.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bcm-recommended-actions.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bcm-recommended-actions.dev",
			expectURL:     aws.String("https://env-bcm-recommended-actions.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-bcm-recommended-actions.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bcm-recommended-actions.dev",
			expectURL:     aws.String("http://config-bcm-recommended-actions.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-bcm-recommended-actions.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-bcm-recommended-actions.dev",
			clientEndpoint: aws.String("https://client-bcm-recommended-actions.dev"),
			expectURL:      aws.String("https://client-bcm-recommended-actions.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BCM_RECOMMENDED_ACTIONS", c.envService)
			}
