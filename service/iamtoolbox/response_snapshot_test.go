...
func TestCheckResponseSnapshot_GetRequestAuthorizationDetails(t *testing.T) {
	...
	status, header, body, err := serdeRespReadSnapshot("GetRequestAuthorizationDetails.response")
	...
	got, err := svc.GetRequestAuthorizationDetails(context.Background(), &GetRequestAuthorizationDetailsInput{
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "GetRequestAuthorizationDetails.response", err)
	}
}
...
func TestCheckResponseSnapshot_Error_AccessDeniedException(t *testing.T) {
	...
	svc := serdeRespClient(status, header, body)
	_, opErr := svc.GetRequestAuthorizationDetails(context.Background(), &GetRequestAuthorizationDetailsInput{
		AuthorizationId: ptr.String("__AuthorizationId__"),
		NextToken:       ptr.String("__NextToken__"),
	})
	if opErr == nil {
