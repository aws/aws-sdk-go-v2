...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iam-toolbox.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iam-toolbox.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iam-toolbox.dev",
			expectURL:     aws.String("https://env-iam-toolbox.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iam-toolbox.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iam-toolbox.dev",
			expectURL:     aws.String("http://config-iam-toolbox.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iam-toolbox.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iam-toolbox.dev",
			clientEndpoint: aws.String("https://client-iam-toolbox.dev"),
			expectURL:      aws.String("https://client-iam-toolbox.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IAM_TOOLBOX", c.envService)
			}
