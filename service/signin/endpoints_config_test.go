...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-signin.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-signin.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-signin.dev",
			expectURL:     aws.String("https://env-signin.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-signin.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-signin.dev",
			expectURL:     aws.String("http://config-signin.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-signin.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-signin.dev",
			clientEndpoint: aws.String("https://client-signin.dev"),
			expectURL:      aws.String("https://client-signin.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SIGNIN", c.envService)
			}
