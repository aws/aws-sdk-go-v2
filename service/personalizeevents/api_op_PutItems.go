...
func (c *Client) PutItems(ctx context.Context, params *PutItemsInput, optFns ...func(*Options)) (*PutItemsOutput, error) {
	if params == nil { params = &PutItemsInput{} }
...
func (c *Client) addOperationPutItemsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutItemsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutItemsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutItemsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutItemsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutItemsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutItemsResolveEndpointMiddleware{
