...
func (*PutUsersInput) operationName() string {
	return "PutUsers"
}
...
func (c *Client) addOperationPutUsersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutUsersResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opPutUsersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opPutUsersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutUsersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutUsersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opPutUsersResolveEndpointMiddleware{
