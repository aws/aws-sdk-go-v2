...
const (
	ServiceName = "Amazon Personalize Events" // Service's name
	ServiceID   = "PersonalizeEvents"         // Service's identifier
	EndpointsID = "personalize-events"        // Service's Endpoint identifier
)
...
//     svc := personalizeevents.New(myConfig)
