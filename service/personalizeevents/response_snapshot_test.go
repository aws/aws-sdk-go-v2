...
func TestCheckResponseSnapshot_PutActionInteractions(t *testing.T) {
	want := &PutActionInteractionsOutput{}
	status, header, body, err := serdeRespReadSnapshot("PutActionInteractions.response")
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "PutActionInteractions.response", err)
	}
}

func TestCheckResponseSnapshot_PutActions(t *testing.T) {
	want := &PutActionsOutput{}
	status, header, body, err := serdeRespReadSnapshot("PutActions.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "PutActions.response", err)
	}
}
...
func TestCheckResponseSnapshot_PutItems(t *testing.T) {
	want := &PutItemsOutput{}
	status, header, body, err := serdeRespReadSnapshot("PutItems.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "PutItems.response", err)
	}
}

func TestCheckResponseSnapshot_PutUsers(t *testing.T) {
	want := &PutUsersOutput{}
	status, header, body, err := serdeRespReadSnapshot("PutUsers.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "PutUsers.response", err)
	}
}
