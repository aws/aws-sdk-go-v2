...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-restjsondataplane.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-restjsondataplane.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-restjsondataplane.dev",
			expectURL:     aws.String("https://env-restjsondataplane.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-restjsondataplane.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-restjsondataplane.dev",
			expectURL:     aws.String("http://config-restjsondataplane.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-restjsondataplane.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-restjsondataplane.dev",
			clientEndpoint: aws.String("https://client-restjsondataplane.dev"),
			expectURL:      aws.String("https://client-restjsondataplane.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_RESTJSONDATAPLANE", c.envService)
			}
