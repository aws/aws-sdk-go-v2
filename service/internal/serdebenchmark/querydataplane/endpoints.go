...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/internal/serdebenchmark/querydataplane/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_QUERYDATAPLANE")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "QueryDataPlane", cfg.ConfigSources)
	if found && err == nil {
