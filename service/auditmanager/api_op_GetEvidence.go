...
func (c *Client) GetEvidence(ctx context.Context, params *GetEvidenceInput, optFns ...func(*Options)) (*GetEvidenceOutput, error) {
	if params == nil { params = &GetEvidenceInput{} }
...
func (c *Client) addOperationGetEvidenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetEvidenceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetEvidenceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetEvidenceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetEvidenceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetEvidenceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetEvidenceResolveEndpointMiddleware{
