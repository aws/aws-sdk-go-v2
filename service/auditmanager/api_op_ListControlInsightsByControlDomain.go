...
func (c *Client) ListControlInsightsByControlDomain(ctx context.Context, params *ListControlInsightsByControlDomainInput, optFns ...func(*Options)) (*ListControlInsightsByControlDomainOutput, error) {
	if params == nil { params = &ListControlInsightsByControlDomainInput{} }
...
func (c *Client) addOperationListControlInsightsByControlDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListControlInsightsByControlDomainResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListControlInsightsByControlDomainResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListControlInsightsByControlDomainResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListControlInsightsByControlDomainResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListControlInsightsByControlDomainResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListControlInsightsByControlDomainResolveEndpointMiddleware{
