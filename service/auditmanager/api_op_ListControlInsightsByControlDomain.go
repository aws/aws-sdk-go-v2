...
func (c *Client) addOperationListControlInsightsByControlDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListControlInsightsByControlDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
