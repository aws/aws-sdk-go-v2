...
func (c *Client) addOperationGetEvidenceFoldersByAssessmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetEvidenceFoldersByAssessment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
