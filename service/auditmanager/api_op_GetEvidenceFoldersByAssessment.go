...
func (c *Client) GetEvidenceFoldersByAssessment(ctx context.Context, params *GetEvidenceFoldersByAssessmentInput, optFns ...func(*Options)) (*GetEvidenceFoldersByAssessmentOutput, error) {
	if params == nil { params = &GetEvidenceFoldersByAssessmentInput{} }
...
func (c *Client) addOperationGetEvidenceFoldersByAssessmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetEvidenceFoldersByAssessmentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetEvidenceFoldersByAssessmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetEvidenceFoldersByAssessmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetEvidenceFoldersByAssessmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetEvidenceFoldersByAssessmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetEvidenceFoldersByAssessmentResolveEndpointMiddleware{
