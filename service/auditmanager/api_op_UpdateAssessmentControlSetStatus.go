...
func (c *Client) addOperationUpdateAssessmentControlSetStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAssessmentControlSetStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
