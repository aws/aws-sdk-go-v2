...
func (c *Client) GetDelegations(ctx context.Context, params *GetDelegationsInput, optFns ...func(*Options)) (*GetDelegationsOutput, error) {
	if params == nil { params = &GetDelegationsInput{} }
...
func (c *Client) addOperationGetDelegationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDelegationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDelegationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDelegationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDelegationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDelegationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDelegationsResolveEndpointMiddleware{
