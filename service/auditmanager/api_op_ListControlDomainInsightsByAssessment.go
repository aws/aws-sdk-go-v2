...
func (*ListControlDomainInsightsByAssessmentInput) operationName() string {
...
func (c *Client) addOperationListControlDomainInsightsByAssessmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListControlDomainInsightsByAssessmentResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListControlDomainInsightsByAssessmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListControlDomainInsightsByAssessmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListControlDomainInsightsByAssessmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListControlDomainInsightsByAssessmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListControlDomainInsightsByAssessmentResolveEndpointMiddleware{
