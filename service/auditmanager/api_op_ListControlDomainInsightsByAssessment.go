...
func (c *Client) addOperationListControlDomainInsightsByAssessmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListControlDomainInsightsByAssessment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
