...
func (c *Client) GetEvidenceFolder(ctx context.Context, params *GetEvidenceFolderInput, optFns ...func(*Options)) (*GetEvidenceFolderOutput, error) {
	if params == nil { params = &GetEvidenceFolderInput{} }
...
func (c *Client) addOperationGetEvidenceFolderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetEvidenceFolderResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetEvidenceFolderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetEvidenceFolderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetEvidenceFolderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetEvidenceFolderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetEvidenceFolderResolveEndpointMiddleware{
