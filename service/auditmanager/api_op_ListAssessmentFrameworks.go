...
func (c *Client) addOperationListAssessmentFrameworksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAssessmentFrameworks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
