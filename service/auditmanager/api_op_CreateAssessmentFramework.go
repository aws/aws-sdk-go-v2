...
func (c *Client) addOperationCreateAssessmentFrameworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateAssessmentFramework", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
