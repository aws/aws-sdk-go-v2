...
func (c *Client) addOperationListAssessmentFrameworkShareRequestsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAssessmentFrameworkShareRequests", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
