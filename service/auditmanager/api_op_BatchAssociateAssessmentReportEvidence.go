...
func (*BatchAssociateAssessmentReportEvidenceInput) operationName() string {
...
func (c *Client) addOperationBatchAssociateAssessmentReportEvidenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchAssociateAssessmentReportEvidenceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opBatchAssociateAssessmentReportEvidenceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opBatchAssociateAssessmentReportEvidenceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchAssociateAssessmentReportEvidenceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchAssociateAssessmentReportEvidenceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opBatchAssociateAssessmentReportEvidenceResolveEndpointMiddleware{
