...
func (c *Client) AssociateAssessmentReportEvidenceFolder(ctx context.Context, params *AssociateAssessmentReportEvidenceFolderInput, optFns ...func(*Options)) (*AssociateAssessmentReportEvidenceFolderOutput, error) {
	if params == nil { params = &AssociateAssessmentReportEvidenceFolderInput{} }
...
func (c *Client) addOperationAssociateAssessmentReportEvidenceFolderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateAssessmentReportEvidenceFolderResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateAssessmentReportEvidenceFolderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateAssessmentReportEvidenceFolderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateAssessmentReportEvidenceFolderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateAssessmentReportEvidenceFolderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateAssessmentReportEvidenceFolderResolveEndpointMiddleware{
