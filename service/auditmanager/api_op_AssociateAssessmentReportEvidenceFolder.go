...
func (c *Client) addOperationAssociateAssessmentReportEvidenceFolderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateAssessmentReportEvidenceFolder", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
