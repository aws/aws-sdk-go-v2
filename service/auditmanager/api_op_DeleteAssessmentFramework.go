...
func (*DeleteAssessmentFrameworkInput) operationName() string {
...
func (c *Client) addOperationDeleteAssessmentFrameworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAssessmentFrameworkResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteAssessmentFrameworkResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteAssessmentFrameworkResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteAssessmentFrameworkResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAssessmentFrameworkResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteAssessmentFrameworkResolveEndpointMiddleware{
