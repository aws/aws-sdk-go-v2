...
func (c *Client) addOperationDeleteAssessmentFrameworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteAssessmentFramework", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
