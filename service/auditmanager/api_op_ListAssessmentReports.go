...
func (c *Client) ListAssessmentReports(ctx context.Context, params *ListAssessmentReportsInput, optFns ...func(*Options)) (*ListAssessmentReportsOutput, error) {
	if params == nil { params = &ListAssessmentReportsInput{} }
...
func (c *Client) addOperationListAssessmentReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAssessmentReportsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAssessmentReportsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAssessmentReportsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAssessmentReportsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAssessmentReportsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAssessmentReportsResolveEndpointMiddleware{
