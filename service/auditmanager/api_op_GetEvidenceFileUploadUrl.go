...
func (c *Client) GetEvidenceFileUploadUrl(ctx context.Context, params *GetEvidenceFileUploadUrlInput, optFns ...func(*Options)) (*GetEvidenceFileUploadUrlOutput, error) {
	if params == nil { params = &GetEvidenceFileUploadUrlInput{} }
...
func (c *Client) addOperationGetEvidenceFileUploadUrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetEvidenceFileUploadUrlResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetEvidenceFileUploadUrlResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetEvidenceFileUploadUrlResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetEvidenceFileUploadUrlResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetEvidenceFileUploadUrlResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetEvidenceFileUploadUrlResolveEndpointMiddleware{
