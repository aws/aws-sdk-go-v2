...
func (c *Client) addOperationUpdateAssessmentFrameworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAssessmentFramework", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
