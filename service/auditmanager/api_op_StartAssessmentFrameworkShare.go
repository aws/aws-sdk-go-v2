...
func (c *Client) addOperationStartAssessmentFrameworkShareMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartAssessmentFrameworkShare", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
