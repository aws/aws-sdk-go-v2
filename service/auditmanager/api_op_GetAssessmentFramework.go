...
func (c *Client) GetAssessmentFramework(ctx context.Context, params *GetAssessmentFrameworkInput, optFns ...func(*Options)) (*GetAssessmentFrameworkOutput, error) {
	if params == nil { params = &GetAssessmentFrameworkInput{} }
...
func (c *Client) addOperationGetAssessmentFrameworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAssessmentFrameworkResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAssessmentFrameworkResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAssessmentFrameworkResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAssessmentFrameworkResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAssessmentFrameworkResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAssessmentFrameworkResolveEndpointMiddleware{
