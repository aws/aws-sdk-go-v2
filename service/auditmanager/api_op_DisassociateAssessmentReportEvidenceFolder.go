...
func (c *Client) addOperationDisassociateAssessmentReportEvidenceFolderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateAssessmentReportEvidenceFolder", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
