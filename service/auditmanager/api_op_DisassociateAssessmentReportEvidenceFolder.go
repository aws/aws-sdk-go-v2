...
func (*DisassociateAssessmentReportEvidenceFolderInput) operationName() string {
...
func (c *Client) addOperationDisassociateAssessmentReportEvidenceFolderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateAssessmentReportEvidenceFolderResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDisassociateAssessmentReportEvidenceFolderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDisassociateAssessmentReportEvidenceFolderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateAssessmentReportEvidenceFolderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateAssessmentReportEvidenceFolderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDisassociateAssessmentReportEvidenceFolderResolveEndpointMiddleware{
