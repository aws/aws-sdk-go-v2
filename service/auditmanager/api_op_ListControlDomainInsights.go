...
func (c *Client) addOperationListControlDomainInsightsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListControlDomainInsights", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
