...
func (c *Client) ListControlDomainInsights(ctx context.Context, params *ListControlDomainInsightsInput, optFns ...func(*Options)) (*ListControlDomainInsightsOutput, error) {
	if params == nil { params = &ListControlDomainInsightsInput{} }
...
func (c *Client) addOperationListControlDomainInsightsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListControlDomainInsightsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListControlDomainInsightsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListControlDomainInsightsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListControlDomainInsightsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListControlDomainInsightsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListControlDomainInsightsResolveEndpointMiddleware{
