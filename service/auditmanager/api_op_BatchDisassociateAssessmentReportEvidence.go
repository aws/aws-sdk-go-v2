...
func (c *Client) BatchDisassociateAssessmentReportEvidence(ctx context.Context, params *BatchDisassociateAssessmentReportEvidenceInput, optFns ...func(*Options)) (*BatchDisassociateAssessmentReportEvidenceOutput, error) {
	if params == nil { params = &BatchDisassociateAssessmentReportEvidenceInput{} }
...
func (c *Client) addOperationBatchDisassociateAssessmentReportEvidenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchDisassociateAssessmentReportEvidenceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchDisassociateAssessmentReportEvidenceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchDisassociateAssessmentReportEvidenceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchDisassociateAssessmentReportEvidenceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchDisassociateAssessmentReportEvidenceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchDisassociateAssessmentReportEvidenceResolveEndpointMiddleware{
