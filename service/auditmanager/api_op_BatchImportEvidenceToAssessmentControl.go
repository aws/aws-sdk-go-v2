...
func (c *Client) addOperationBatchImportEvidenceToAssessmentControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchImportEvidenceToAssessmentControl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
