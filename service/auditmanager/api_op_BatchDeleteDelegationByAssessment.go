...
func (c *Client) addOperationBatchDeleteDelegationByAssessmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDeleteDelegationByAssessment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
