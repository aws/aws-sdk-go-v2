...
func (c *Client) BatchDeleteDelegationByAssessment(ctx context.Context, params *BatchDeleteDelegationByAssessmentInput, optFns ...func(*Options)) (*BatchDeleteDelegationByAssessmentOutput, error) {
	if params == nil { params = &BatchDeleteDelegationByAssessmentInput{} }
...
func (c *Client) addOperationBatchDeleteDelegationByAssessmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchDeleteDelegationByAssessmentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchDeleteDelegationByAssessmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchDeleteDelegationByAssessmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchDeleteDelegationByAssessmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchDeleteDelegationByAssessmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchDeleteDelegationByAssessmentResolveEndpointMiddleware{
