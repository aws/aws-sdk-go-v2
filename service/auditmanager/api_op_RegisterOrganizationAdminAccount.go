...
func (c *Client) RegisterOrganizationAdminAccount(ctx context.Context, params *RegisterOrganizationAdminAccountInput, optFns ...func(*Options)) (*RegisterOrganizationAdminAccountOutput, error) {
	if params == nil { params = &RegisterOrganizationAdminAccountInput{} }
...
func (c *Client) addOperationRegisterOrganizationAdminAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRegisterOrganizationAdminAccountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRegisterOrganizationAdminAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRegisterOrganizationAdminAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRegisterOrganizationAdminAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRegisterOrganizationAdminAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRegisterOrganizationAdminAccountResolveEndpointMiddleware{
