...
func (c *Client) addOperationGetEvidenceFoldersByAssessmentControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetEvidenceFoldersByAssessmentControl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
