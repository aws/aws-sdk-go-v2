...
func (c *Client) GetChangeLogs(ctx context.Context, params *GetChangeLogsInput, optFns ...func(*Options)) (*GetChangeLogsOutput, error) {
	if params == nil { params = &GetChangeLogsInput{} }
...
func (c *Client) addOperationGetChangeLogsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetChangeLogsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetChangeLogsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetChangeLogsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetChangeLogsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetChangeLogsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetChangeLogsResolveEndpointMiddleware{
