...
func (c *Client) CreateControl(ctx context.Context, params *CreateControlInput, optFns ...func(*Options)) (*CreateControlOutput, error) {
	if params == nil { params = &CreateControlInput{} }
...
func (c *Client) addOperationCreateControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateControlResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateControlResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateControlResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateControlResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateControlResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateControlResolveEndpointMiddleware{
