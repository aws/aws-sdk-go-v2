...
// DeleteAssessmentReportoperation, Audit Manager attempts to delete the
// following data:
//   - The specified assessment report that’s stored in your S3 bucket
//   - The associated metadata that’s stored in Audit Manager
//
// If Audit Manager
// can’t access the assessment report in your S3 bucket, the report isn’t deleted.
// In this event, the DeleteAssessmentReport operation doesn’t fail. Instead, it
...
// Manager receives a 403 (Forbidden)  or 404 (Not Found) error from Amazon S3.
// To avoid this, make sure that your S3 bucket is available, and that you
// configured the correct permissions for Audit Manager to delete resources in your
// S3 bucket. For an example permissions policy that you can use, see Assessment
// report destination permissions (https://docs.aws.amazon.com/audit-manager/latest/userguide/security_iam_id-based-policy-examples.html#full-administrator-access-assessment-report-destination)
