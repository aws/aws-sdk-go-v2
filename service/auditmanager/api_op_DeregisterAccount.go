...
// Deregisters an account in Audit Manager. Before you deregister, you can use
// the UpdateSettings (https://docs.aws.amazon.com/audit-manager/latest/APIReference/API_UpdateSettings.html)
...
// DeregistrationPolicyattribute to request the deletion of your data. For more
