...
func (c *Client) addOperationValidateAssessmentReportIntegrityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ValidateAssessmentReportIntegrity", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
