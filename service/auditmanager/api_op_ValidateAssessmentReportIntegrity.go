...
func (c *Client) ValidateAssessmentReportIntegrity(ctx context.Context, params *ValidateAssessmentReportIntegrityInput, optFns ...func(*Options)) (*ValidateAssessmentReportIntegrityOutput, error) {
	if params == nil { params = &ValidateAssessmentReportIntegrityInput{} }
...
func (c *Client) addOperationValidateAssessmentReportIntegrityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addValidateAssessmentReportIntegrityResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opValidateAssessmentReportIntegrityResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opValidateAssessmentReportIntegrityResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opValidateAssessmentReportIntegrityResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addValidateAssessmentReportIntegrityResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opValidateAssessmentReportIntegrityResolveEndpointMiddleware{
