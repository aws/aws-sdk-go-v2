...
func (c *Client) Untag(ctx context.Context, params *UntagInput, optFns ...func(*Options)) (*UntagOutput, error) {
	if params == nil { params = &UntagInput{} }
...
func (c *Client) addOperationUntagMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUntagResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUntagResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUntagResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUntagResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUntagResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUntagResolveEndpointMiddleware{
