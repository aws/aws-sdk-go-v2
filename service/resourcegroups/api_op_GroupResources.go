...
// Adds the specified resources to the specified group. You can use this
// operation with only resource groups that are configured with the following
// types:
//   - AWS::EC2::HostManagement
//   - AWS::EC2::CapacityReservationPool
//
// Other resource group type and resource
// types aren't currently supported by this operation. Minimum permissions To run
