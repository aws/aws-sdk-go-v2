...
func (c *Client) addOperationGetActionRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetActionRecommendations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
