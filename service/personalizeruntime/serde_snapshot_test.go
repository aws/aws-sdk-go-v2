...
func TestSerdeCheckSnapshot_GetPersonalizedRanking(t *testing.T) {
...
func TestSerdeUpdateSnapshot_GetActionRecommendations(t *testing.T) {
	input := &GetActionRecommendationsInput{
		CampaignArn: ptr.String("__CampaignArn__"),
		UserId:      ptr.String("__UserId__"),
		NumResults:  1,
...
func TestSerdeUpdateSnapshot_GetPersonalizedRanking(t *testing.T) {
	input := &GetPersonalizedRankingInput{
		CampaignArn: ptr.String("__CampaignArn__"),
		InputList: []string{
			"__Member__",
