...
// required, userId not used
//
// Campaigns that are backed by a solution created using
// a recipe of type PERSONALIZED_RANKING use the API. For recommenders, the
...
// use case requirements see Choosing recommender use cases
