...
func addOperationDescribeProblemObservationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeProblemObservationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeProblemObservationsStackSlots(stack); err != nil {
		return err
	}
