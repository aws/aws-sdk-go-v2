...
func (c *Client) addOperationDescribeProblemObservationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeProblemObservations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
