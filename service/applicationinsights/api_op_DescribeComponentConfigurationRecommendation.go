...
func addOperationDescribeComponentConfigurationRecommendationStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeComponentConfigurationRecommendationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeComponentConfigurationRecommendationStackSlots(stack); err != nil {
		return err
	}
