...
func (c *Client) addOperationDescribeComponentConfigurationRecommendationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeComponentConfigurationRecommendation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
