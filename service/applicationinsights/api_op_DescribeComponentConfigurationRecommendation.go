...
func (c *Client) DescribeComponentConfigurationRecommendation(ctx context.Context, params *DescribeComponentConfigurationRecommendationInput, optFns ...func(*Options)) (*DescribeComponentConfigurationRecommendationOutput, error) {
	if params == nil { params = &DescribeComponentConfigurationRecommendationInput{} }
...
func (c *Client) addOperationDescribeComponentConfigurationRecommendationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeComponentConfigurationRecommendationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeComponentConfigurationRecommendationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeComponentConfigurationRecommendationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeComponentConfigurationRecommendationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeComponentConfigurationRecommendationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeComponentConfigurationRecommendationResolveEndpointMiddleware{
