...
// requests to Application Insights.
//
...
// Using the Client
//
// To use Application Insights with the SDK use the New function to create
...
//
// See the Application Insights client for more information on
