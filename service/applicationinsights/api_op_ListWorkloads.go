...
func (v *ListWorkloadsOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListWorkloadsResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}
...
func (v *ListWorkloadsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.NextToken != nil {
		s.WriteString(schemas.ListWorkloadsResponse_NextToken, *v.NextToken)
	}
	serializeWorkloadList(s, schemas.ListWorkloadsResponse_WorkloadList, v.WorkloadList)
}
