...
func (c *Client) ListProblems(ctx context.Context, params *ListProblemsInput, optFns ...func(*Options)) (*ListProblemsOutput, error) {
	if params == nil { params = &ListProblemsInput{} }
...
func (c *Client) addOperationListProblemsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListProblemsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListProblemsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListProblemsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListProblemsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListProblemsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListProblemsResolveEndpointMiddleware{
