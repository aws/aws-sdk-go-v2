...
func addOperationUpdateComponentConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateComponentConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateComponentConfigurationStackSlots(stack); err != nil {
		return err
	}
