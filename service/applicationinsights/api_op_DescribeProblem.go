...
func (c *Client) DescribeProblem(ctx context.Context, params *DescribeProblemInput, optFns ...func(*Options)) (*DescribeProblemOutput, error) {
	if params == nil { params = &DescribeProblemInput{} }
...
func (c *Client) addOperationDescribeProblemMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeProblemResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeProblemResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeProblemResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeProblemResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeProblemResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeProblemResolveEndpointMiddleware{
