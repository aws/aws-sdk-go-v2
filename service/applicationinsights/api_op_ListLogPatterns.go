...
func (*ListLogPatternsInput) operationName() string {
...
func (c *Client) addOperationListLogPatternsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLogPatternsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListLogPatternsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListLogPatternsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLogPatternsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLogPatternsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListLogPatternsResolveEndpointMiddleware{
