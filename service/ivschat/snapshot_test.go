...
func TestCheckSnapshot_CreateChatToken(t *testing.T) {
	svc := New(Options{})
	_, err := svc.CreateChatToken(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "CreateChatToken")
		})
	})
...
func TestCheckSnapshot_DisconnectUser(t *testing.T) {
	svc := New(Options{})
	_, err := svc.DisconnectUser(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "DisconnectUser")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_CreateChatToken(t *testing.T) {
	svc := New(Options{})
	_, err := svc.CreateChatToken(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return updateSnapshot(stack, "CreateChatToken")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_DisconnectUser(t *testing.T) {
	svc := New(Options{})
	_, err := svc.DisconnectUser(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return updateSnapshot(stack, "DisconnectUser")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
