...
func (c *Client) addOperationListLoggingConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListLoggingConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
