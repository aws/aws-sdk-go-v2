...
func (c *Client) GetRoom(ctx context.Context, params *GetRoomInput, optFns ...func(*Options)) (*GetRoomOutput, error) {
	if params == nil { params = &GetRoomInput{} }
...
func (c *Client) addOperationGetRoomMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRoomResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRoomResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRoomResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRoomResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRoomResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRoomResolveEndpointMiddleware{
