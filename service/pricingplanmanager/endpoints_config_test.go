...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-pricing-plan-manager.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pricing-plan-manager.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pricing-plan-manager.dev",
			expectURL:     aws.String("https://env-pricing-plan-manager.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-pricing-plan-manager.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pricing-plan-manager.dev",
			expectURL:     aws.String("http://config-pricing-plan-manager.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-pricing-plan-manager.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-pricing-plan-manager.dev",
			clientEndpoint: aws.String("https://client-pricing-plan-manager.dev"),
			expectURL:      aws.String("https://client-pricing-plan-manager.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PRICING_PLAN_MANAGER", c.envService)
			}
