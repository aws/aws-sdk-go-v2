...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/pricingplanmanager/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_PRICING_PLAN_MANAGER")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Pricing Plan Manager", cfg.ConfigSources)
	if found && err == nil {
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 2:
		uriString := "https://pricingplanmanager.us-east-1.api.aws"
		uri, err := url.Parse(uriString)
		if err != nil {
			return smithyendpoints.Endpoint{}, fmt.Errorf("Failed to parse uri: %s", uriString)
		}
