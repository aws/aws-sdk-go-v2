...
func (c *Client) SendHeartbeat(ctx context.Context, params *SendHeartbeatInput, optFns ...func(*Options)) (*SendHeartbeatOutput, error) {
	if params == nil { params = &SendHeartbeatInput{} }
...
func (c *Client) addOperationSendHeartbeatMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendHeartbeatResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSendHeartbeatResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSendHeartbeatResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendHeartbeatResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendHeartbeatResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSendHeartbeatResolveEndpointMiddleware{
