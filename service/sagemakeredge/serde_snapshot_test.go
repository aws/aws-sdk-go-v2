...
func TestSerdeCheckSnapshot_GetDeviceRegistration(t *testing.T) {
...
func TestSerdeCheckSnapshot_SendHeartbeat(t *testing.T) {
...
func TestSerdeUpdateSnapshot_GetDeviceRegistration(t *testing.T) {
	input := &GetDeviceRegistrationInput{
		DeviceName:      ptr.String("__DeviceName__"),
		DeviceFleetName: ptr.String("__DeviceFleetName__"),
	}
...
func TestSerdeUpdateSnapshot_SendHeartbeat(t *testing.T) {
	input := &SendHeartbeatInput{
		AgentMetrics: []types.EdgeMetric{
			{
				Dimension:  ptr.String("__Dimension__"),
