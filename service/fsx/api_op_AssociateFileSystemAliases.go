...
func (c *Client) addOperationAssociateFileSystemAliasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateFileSystemAliases", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
