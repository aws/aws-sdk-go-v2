...
func (c *Client) addOperationRestoreVolumeFromSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RestoreVolumeFromSnapshot", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
