...
func (c *Client) addOperationDetachAndDeleteS3AccessPointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DetachAndDeleteS3AccessPoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
