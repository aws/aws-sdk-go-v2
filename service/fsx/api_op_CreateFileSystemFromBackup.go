...
// this operation returns the description of the file system. If a client request
// token with the specified by the file system exists and the parameters don't
...
// the file system.
//
// Parameters like the Active Directory, default share name,
...
// request token and the initial call created a file system, the client receives a
// success message as long as the parameters are the same. The
