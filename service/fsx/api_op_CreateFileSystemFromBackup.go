...
func (c *Client) addOperationCreateFileSystemFromBackupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateFileSystemFromBackup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
