...
func addOperationCreateFileSystemFromBackupStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateFileSystemFromBackupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateFileSystemFromBackupStackSlots(stack); err != nil {
		return err
	}
