...
func (c *Client) addOperationDisassociateFileSystemAliasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateFileSystemAliases", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
