...
// CreateFileSystemoperation without the risk of creating an extra file system.
...
// CreateFileSystemreturns the description of the existing file system. If a file
// system with the specified client request token exists and the parameters don't
// match, this call returns IncompatibleParameterError. If a file system with the
// specified client request token doesn't exist, CreateFileSystem does the
// following:
...
type CreateFileSystemInput struct {
	...
	// gibibytes (GiB). FSx for Lustre file systems - The amount of storage capacity
	// that you can configure depends on the value that you set for StorageType and
	// the Lustre DeploymentType , as follows:
	...
	// PreferredSubnetIDproperties. For more information about Multi-AZ file system
	...
	// in the Amazon FSx for ONTAP User Guide. For Windows SINGLE_AZ_1  and
	// SINGLE_AZ_2and all Lustre deployment types, provide exactly one subnet ID. The
	...
	// then the default is 2.12 . If you set FileSystemTypeVersion  to 2.10  for a
