...
func (c *Client) addOperationDescribeStorageVirtualMachinesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeStorageVirtualMachines", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
