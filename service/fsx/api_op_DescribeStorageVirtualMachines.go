...
func (c *Client) DescribeStorageVirtualMachines(ctx context.Context, params *DescribeStorageVirtualMachinesInput, optFns ...func(*Options)) (*DescribeStorageVirtualMachinesOutput, error) {
	if params == nil { params = &DescribeStorageVirtualMachinesInput{} }
...
func (c *Client) addOperationDescribeStorageVirtualMachinesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeStorageVirtualMachinesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeStorageVirtualMachinesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeStorageVirtualMachinesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeStorageVirtualMachinesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeStorageVirtualMachinesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeStorageVirtualMachinesResolveEndpointMiddleware{
