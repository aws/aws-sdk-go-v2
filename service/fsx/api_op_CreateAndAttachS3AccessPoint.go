...
func (c *Client) addOperationCreateAndAttachS3AccessPointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateAndAttachS3AccessPoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
