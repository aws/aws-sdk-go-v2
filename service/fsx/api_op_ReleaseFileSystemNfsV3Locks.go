...
func (c *Client) addOperationReleaseFileSystemNfsV3LocksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ReleaseFileSystemNfsV3Locks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
