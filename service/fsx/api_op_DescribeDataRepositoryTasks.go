...
func (c *Client) addOperationDescribeDataRepositoryTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDataRepositoryTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
