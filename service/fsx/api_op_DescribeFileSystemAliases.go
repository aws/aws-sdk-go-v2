...
func (c *Client) addOperationDescribeFileSystemAliasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeFileSystemAliases", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
