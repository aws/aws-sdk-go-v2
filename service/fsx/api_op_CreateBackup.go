...
// with the original file system or volume. For Amazon FSx for Lustre file systems,
// you can create a backup only for file systems that have the following
// configuration:
...
// operation returns while the backup's lifecycle state is still CREATING. You
// can check the backup creation status by calling the DescribeBackups (https://docs.aws.amazon.com/fsx/latest/APIReference/API_DescribeBackups.html)
...
type CreateBackupInput struct {
	...
	// CreateBackupoperation, no existing file system tags are copied from the file
