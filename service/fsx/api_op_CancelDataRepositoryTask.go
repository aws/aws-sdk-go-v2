...
func (c *Client) addOperationCancelDataRepositoryTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelDataRepositoryTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
