...
func (c *Client) addOperationCopySnapshotAndUpdateVolumeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CopySnapshotAndUpdateVolume", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
