...
func (c *Client) addOperationStartMisconfiguredStateRecoveryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartMisconfiguredStateRecovery", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
