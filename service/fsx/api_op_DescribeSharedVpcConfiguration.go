...
func (c *Client) addOperationDescribeSharedVpcConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSharedVpcConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
