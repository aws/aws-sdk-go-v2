...
func TestEndpointCase2(t *testing.T) {
	...
	uri, _ := url.Parse("https://partnercentral-prm-fips.global.api.aws")
...
func TestEndpointCase3(t *testing.T) {
	...
	uri, _ := url.Parse("https://partnercentral-prm.global.api.aws")
...
func TestEndpointCase4(t *testing.T) {
	...
	uri, _ := url.Parse("https://partnercentral-prm-fips.global.api.amazonwebservices.com.cn")
...
func TestEndpointCase5(t *testing.T) {
	...
	uri, _ := url.Parse("https://partnercentral-prm.global.api.amazonwebservices.com.cn")
...
func TestEndpointCase6(t *testing.T) {
	...
	uri, _ := url.Parse("https://partnercentral-prm-fips.us-gov.api.aws")
...
func TestEndpointCase7(t *testing.T) {
	...
	uri, _ := url.Parse("https://partnercentral-prm.us-gov.api.aws")
