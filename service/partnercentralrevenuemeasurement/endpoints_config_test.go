...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-partnercentral-revenue-measurement.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-partnercentral-revenue-measurement.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-partnercentral-revenue-measurement.dev",
			expectURL:     aws.String("https://env-partnercentral-revenue-measurement.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-partnercentral-revenue-measurement.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-partnercentral-revenue-measurement.dev",
			expectURL:     aws.String("http://config-partnercentral-revenue-measurement.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-partnercentral-revenue-measurement.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-partnercentral-revenue-measurement.dev",
			clientEndpoint: aws.String("https://client-partnercentral-revenue-measurement.dev"),
			expectURL:      aws.String("https://client-partnercentral-revenue-measurement.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PARTNERCENTRAL_REVENUE_MEASUREMENT", c.envService)
			}
