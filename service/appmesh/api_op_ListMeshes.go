...
func (c *Client) addOperationListMeshesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMeshesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListMeshesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListMeshesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMeshesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListMeshesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListMeshesResolveEndpointMiddleware{
