...
// Security (TLS). You define a listener for any inbound traffic that your
// virtual node expects. Any virtual service that your virtual node expects to
// communicate to is specified as a backend. The response metadata for your new
// virtual node contains the arn that is associated with the virtual node. Set
...
// APPMESH_RESOURCE_CLUSTERenvironment variable with your own name. For more
