...
func (c *Client) ListVirtualServices(ctx context.Context, params *ListVirtualServicesInput, optFns ...func(*Options)) (*ListVirtualServicesOutput, error) {
	if params == nil { params = &ListVirtualServicesInput{} }
...
func (c *Client) addOperationListVirtualServicesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListVirtualServicesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListVirtualServicesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListVirtualServicesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListVirtualServicesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListVirtualServicesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListVirtualServicesResolveEndpointMiddleware{
