...
func (c *Client) DeleteVirtualRouter(ctx context.Context, params *DeleteVirtualRouterInput, optFns ...func(*Options)) (*DeleteVirtualRouterOutput, error) {
	if params == nil { params = &DeleteVirtualRouterInput{} }
...
func (c *Client) addOperationDeleteVirtualRouterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteVirtualRouterResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteVirtualRouterResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteVirtualRouterResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteVirtualRouterResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteVirtualRouterResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteVirtualRouterResolveEndpointMiddleware{
