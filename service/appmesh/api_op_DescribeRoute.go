...
func (c *Client) DescribeRoute(ctx context.Context, params *DescribeRouteInput, optFns ...func(*Options)) (*DescribeRouteOutput, error) {
	if params == nil { params = &DescribeRouteInput{} }
...
func (c *Client) addOperationDescribeRouteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeRouteResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeRouteResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeRouteResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeRouteResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeRouteResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeRouteResolveEndpointMiddleware{
