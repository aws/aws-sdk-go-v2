...
func (c *Client) ListGatewayRoutes(ctx context.Context, params *ListGatewayRoutesInput, optFns ...func(*Options)) (*ListGatewayRoutesOutput, error) {
	if params == nil { params = &ListGatewayRoutesInput{} }
...
func (c *Client) addOperationListGatewayRoutesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListGatewayRoutesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListGatewayRoutesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListGatewayRoutesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListGatewayRoutesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListGatewayRoutesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListGatewayRoutesResolveEndpointMiddleware{
