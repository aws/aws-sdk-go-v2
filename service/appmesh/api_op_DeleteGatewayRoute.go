...
func (*DeleteGatewayRouteInput) operationName() string {
...
func (c *Client) addOperationDeleteGatewayRouteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteGatewayRouteResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteGatewayRouteResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteGatewayRouteResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteGatewayRouteResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteGatewayRouteResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteGatewayRouteResolveEndpointMiddleware{
