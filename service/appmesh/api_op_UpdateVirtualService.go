...
func (c *Client) UpdateVirtualService(ctx context.Context, params *UpdateVirtualServiceInput, optFns ...func(*Options)) (*UpdateVirtualServiceOutput, error) {
	stack := middleware.NewStack("UpdateVirtualService", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpUpdateVirtualServiceMiddlewares(stack)
...
func addawsRestjson1_serdeOpUpdateVirtualServiceMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpUpdateVirtualService{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpUpdateVirtualService{}, middleware.After)
}
