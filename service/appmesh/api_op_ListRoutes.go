...
func (v *ListRoutesInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListRoutesInput)
...
func (v *ListRoutesInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Limit != nil {
		s.WriteInt32(schemas.ListRoutesInput_limit, *v.Limit)
	}
	if v.MeshName != nil {
		s.WriteString(schemas.ListRoutesInput_meshName, *v.MeshName)
	}
	if v.MeshOwner != nil {
		s.WriteString(schemas.ListRoutesInput_meshOwner, *v.MeshOwner)
	}
	if v.NextToken != nil {
		s.WriteString(schemas.ListRoutesInput_nextToken, *v.NextToken)
	}
	if v.VirtualRouterName != nil {
		s.WriteString(schemas.ListRoutesInput_virtualRouterName, *v.VirtualRouterName)
	}
}
func (v *ListRoutesInput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListRoutesInput, func(s *smithy.Schema) error {
		switch s {
		case schemas.ListRoutesInput_limit:
			v.Limit = new(int32)
			return d.ReadInt32(schemas.ListRoutesInput_limit, v.Limit)
		case schemas.ListRoutesInput_meshName:
			v.MeshName = new(string)
			return d.ReadString(schemas.ListRoutesInput_meshName, v.MeshName)
		case schemas.ListRoutesInput_meshOwner:
			v.MeshOwner = new(string)
			return d.ReadString(schemas.ListRoutesInput_meshOwner, v.MeshOwner)
		case schemas.ListRoutesInput_nextToken:
			v.NextToken = new(string)
			return d.ReadString(schemas.ListRoutesInput_nextToken, v.NextToken)
		case schemas.ListRoutesInput_virtualRouterName:
			v.VirtualRouterName = new(string)
			return d.ReadString(schemas.ListRoutesInput_virtualRouterName, v.VirtualRouterName)
		}
		return nil
	})
}
...
func (v *ListRoutesOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListRoutesOutput)
	v.SerializeMembers(s)
	s.CloseStruct()
}
...
func (v *ListRoutesOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.NextToken != nil {
		s.WriteString(schemas.ListRoutesOutput_nextToken, *v.NextToken)
	}
	serializeRouteList(s, schemas.ListRoutesOutput_routes, v.Routes)
}
func (v *ListRoutesOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListRoutesOutput, func(s *smithy.Schema) error {
		switch s {
		case schemas.ListRoutesOutput_nextToken:
			v.NextToken = new(string)
			return d.ReadString(schemas.ListRoutesOutput_nextToken, v.NextToken)
		case schemas.ListRoutesOutput_routes:
			return deserializeRouteList(d, schemas.ListRoutesOutput_routes, &v.Routes)
		}
		return nil
	})
}
func (c *Client) addOperationListRoutesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ListRoutes, schemas.ListRoutesInput, schemas.ListRoutesOutput)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ListRoutes, schemas.ListRoutesInput, schemas.ListRoutesOutput), output: &ListRoutesOutput{}}, middleware.After); err != nil {
		return err
	}
