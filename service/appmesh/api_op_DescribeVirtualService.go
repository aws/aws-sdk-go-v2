...
func (c *Client) DescribeVirtualService(ctx context.Context, params *DescribeVirtualServiceInput, optFns ...func(*Options)) (*DescribeVirtualServiceOutput, error) {
	if params == nil { params = &DescribeVirtualServiceInput{} }
...
func (c *Client) addOperationDescribeVirtualServiceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeVirtualServiceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeVirtualServiceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeVirtualServiceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeVirtualServiceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeVirtualServiceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeVirtualServiceResolveEndpointMiddleware{
