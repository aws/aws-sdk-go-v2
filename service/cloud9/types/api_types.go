...
type Environment struct {
	...
	Type enums.EnvironmentType `locationName:"type" type:"string" enum:"true"`
}
...
type EnvironmentLifecycle struct {
	...
	Status enums.EnvironmentLifecycleStatus `locationName:"status" type:"string" enum:"true"`
}
...
type EnvironmentMember struct {
	...
	Permissions enums.Permissions `locationName:"permissions" type:"string" enum:"true"`
