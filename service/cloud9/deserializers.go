...
type awsAwsjson11_deserializeOpCreateEnvironmentSSH struct {
}

func (*awsAwsjson11_deserializeOpCreateEnvironmentSSH) ID() string {
	return "OperationDeserializer"
}

func (m *awsAwsjson11_deserializeOpCreateEnvironmentSSH) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsjson11_deserializeOpErrorCreateEnvironmentSSH(response, &metadata)
	}
	output := &CreateEnvironmentSSHOutput{}
	out.Result = output
	...
	err = awsAwsjson11_deserializeOpDocumentCreateEnvironmentSSHOutput(&output, shape)
	if err != nil {
		var snapshot bytes.Buffer
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
...
func awsAwsjson11_deserializeOpErrorCreateEnvironmentSSH(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
type awsAwsjson11_deserializeOpDescribeSSHRemote struct {
}

func (*awsAwsjson11_deserializeOpDescribeSSHRemote) ID() string {
	return "OperationDeserializer"
}

func (m *awsAwsjson11_deserializeOpDescribeSSHRemote) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsjson11_deserializeOpErrorDescribeSSHRemote(response, &metadata)
	}
	output := &DescribeSSHRemoteOutput{}
	out.Result = output
	...
	err = awsAwsjson11_deserializeOpDocumentDescribeSSHRemoteOutput(&output, shape)
	if err != nil {
		var snapshot bytes.Buffer
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
...
func awsAwsjson11_deserializeOpErrorDescribeSSHRemote(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
type awsAwsjson11_deserializeOpUpdateSSHRemote struct {
}

func (*awsAwsjson11_deserializeOpUpdateSSHRemote) ID() string {
	return "OperationDeserializer"
}

func (m *awsAwsjson11_deserializeOpUpdateSSHRemote) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsAwsjson11_deserializeOpErrorUpdateSSHRemote(response, &metadata)
	}
	output := &UpdateSSHRemoteOutput{}
	out.Result = output
	...
	err = awsAwsjson11_deserializeOpDocumentUpdateSSHRemoteOutput(&output, shape)
	if err != nil {
		var snapshot bytes.Buffer
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
...
func awsAwsjson11_deserializeOpErrorUpdateSSHRemote(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func awsAwsjson11_deserializeDocumentSSHRemoteEnvironmentDescription(v **types.SSHRemoteEnvironmentDescription, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *types.SSHRemoteEnvironmentDescription
	if *v == nil {
		sv = &types.SSHRemoteEnvironmentDescription{}
	} else {
		sv = *v
	}
	...
	for key, value := range shape {
		...
		case "bastionHost":
			if value != nil {
				jtv, ok := value.(string)
				if !ok {
					return fmt.Errorf("expected SSHJumpHost to be of type string, got %T instead", value)
				}
				sv.BastionHost = ptr.String(jtv)
			}
		...
		case "environmentPath":
			if value != nil {
				jtv, ok := value.(string)
				if !ok {
					return fmt.Errorf("expected RemotePath to be of type string, got %T instead", value)
				}
				sv.EnvironmentPath = ptr.String(jtv)
			}
		...
		case "loginName":
			if value != nil {
				jtv, ok := value.(string)
				if !ok {
					return fmt.Errorf("expected LoginName to be of type string, got %T instead", value)
				}
				sv.LoginName = ptr.String(jtv)
			}
...
func awsAwsjson11_deserializeOpDocumentCreateEnvironmentSSHOutput(v **CreateEnvironmentSSHOutput, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *CreateEnvironmentSSHOutput
	if *v == nil {
		sv = &CreateEnvironmentSSHOutput{}
	} else {
		sv = *v
	}
...
func awsAwsjson11_deserializeOpDocumentDescribeSSHRemoteOutput(v **DescribeSSHRemoteOutput, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *DescribeSSHRemoteOutput
	if *v == nil {
		sv = &DescribeSSHRemoteOutput{}
	} else {
		sv = *v
	}
	...
	for key, value := range shape {
		switch key {
		case "remote":
			if err := awsAwsjson11_deserializeDocumentSSHRemoteEnvironmentDescription(&sv.Remote, value); err != nil {
				return err
			}
...
func awsAwsjson11_deserializeOpDocumentUpdateSSHRemoteOutput(v **UpdateSSHRemoteOutput, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *UpdateSSHRemoteOutput
	if *v == nil {
		sv = &UpdateSSHRemoteOutput{}
	} else {
		sv = *v
	}
