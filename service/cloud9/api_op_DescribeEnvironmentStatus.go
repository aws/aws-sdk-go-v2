...
func (c *Client) addOperationDescribeEnvironmentStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEnvironmentStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
