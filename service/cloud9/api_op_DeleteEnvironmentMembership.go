...
func (*DeleteEnvironmentMembershipInput) operationName() string {
...
func (c *Client) addOperationDeleteEnvironmentMembershipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteEnvironmentMembershipResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteEnvironmentMembershipResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteEnvironmentMembershipResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteEnvironmentMembershipResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteEnvironmentMembershipResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteEnvironmentMembershipResolveEndpointMiddleware{
