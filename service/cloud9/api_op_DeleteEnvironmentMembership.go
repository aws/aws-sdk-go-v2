...
func addOperationDeleteEnvironmentMembershipStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteEnvironmentMembershipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteEnvironmentMembershipStackSlots(stack); err != nil {
		return err
	}
