...
func (c *Client) addOperationDeleteEnvironmentMembershipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteEnvironmentMembership", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
