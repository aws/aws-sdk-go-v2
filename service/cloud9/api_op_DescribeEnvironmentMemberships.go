...
func (c *Client) addOperationDescribeEnvironmentMembershipsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEnvironmentMemberships", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
