...
func addOperationDescribeAvailabilityOptionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeAvailabilityOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeAvailabilityOptionsStackSlots(stack); err != nil {
		return err
	}
