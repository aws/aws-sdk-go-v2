...
func (c *Client) DefineExpression(ctx context.Context, params *DefineExpressionInput, optFns ...func(*Options)) (*DefineExpressionOutput, error) {
	if params == nil { params = &DefineExpressionInput{} }
...
func (c *Client) addOperationDefineExpressionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDefineExpressionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDefineExpressionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDefineExpressionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDefineExpressionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDefineExpressionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDefineExpressionResolveEndpointMiddleware{
