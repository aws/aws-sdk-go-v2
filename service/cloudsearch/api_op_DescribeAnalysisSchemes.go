...
func (c *Client) addOperationDescribeAnalysisSchemesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAnalysisSchemes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
