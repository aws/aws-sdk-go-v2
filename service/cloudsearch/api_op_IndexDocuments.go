...
func (c *Client) IndexDocuments(ctx context.Context, params *IndexDocumentsInput, optFns ...func(*Options)) (*IndexDocumentsOutput, error) {
	if params == nil { params = &IndexDocumentsInput{} }
...
func (c *Client) addOperationIndexDocumentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addIndexDocumentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opIndexDocumentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opIndexDocumentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opIndexDocumentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addIndexDocumentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opIndexDocumentsResolveEndpointMiddleware{
