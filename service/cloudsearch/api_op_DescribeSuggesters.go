...
func (c *Client) DescribeSuggesters(ctx context.Context, params *DescribeSuggestersInput, optFns ...func(*Options)) (*DescribeSuggestersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSuggesters", params, optFns, addOperationDescribeSuggestersMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSuggestersStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeSuggestersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeSuggestersStackSlots(stack); err != nil {
		return err
	}
