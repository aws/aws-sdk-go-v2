...
func (c *Client) DefineIndexField(ctx context.Context, params *DefineIndexFieldInput, optFns ...func(*Options)) (*DefineIndexFieldOutput, error) {
	if params == nil { params = &DefineIndexFieldInput{} }
...
func (c *Client) addOperationDefineIndexFieldMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDefineIndexFieldResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDefineIndexFieldResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDefineIndexFieldResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDefineIndexFieldResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDefineIndexFieldResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDefineIndexFieldResolveEndpointMiddleware{
