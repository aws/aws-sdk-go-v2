...
func addOperationDescribeServiceAccessPoliciesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeServiceAccessPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeServiceAccessPoliciesStackSlots(stack); err != nil {
		return err
	}
