...
func (c *Client) addOperationDescribeServiceAccessPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeServiceAccessPolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
