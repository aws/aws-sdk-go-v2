...
func (c *Client) UpdateAvailabilityOptions(ctx context.Context, params *UpdateAvailabilityOptionsInput, optFns ...func(*Options)) (*UpdateAvailabilityOptionsOutput, error) {
	if params == nil { params = &UpdateAvailabilityOptionsInput{} }
...
func (c *Client) addOperationUpdateAvailabilityOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateAvailabilityOptionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateAvailabilityOptionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateAvailabilityOptionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateAvailabilityOptionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateAvailabilityOptionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateAvailabilityOptionsResolveEndpointMiddleware{
