...
func (c *Client) DefineSuggester(ctx context.Context, params *DefineSuggesterInput, optFns ...func(*Options)) (*DefineSuggesterOutput, error) {
	if params == nil { params = &DefineSuggesterInput{} }
...
func (c *Client) addOperationDefineSuggesterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDefineSuggesterResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDefineSuggesterResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDefineSuggesterResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDefineSuggesterResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDefineSuggesterResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDefineSuggesterResolveEndpointMiddleware{
