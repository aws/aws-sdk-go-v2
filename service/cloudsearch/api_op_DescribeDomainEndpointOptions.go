...
func (c *Client) addOperationDescribeDomainEndpointOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDomainEndpointOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
