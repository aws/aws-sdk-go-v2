...
func addOperationUpdateServiceAccessPoliciesStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateServiceAccessPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateServiceAccessPoliciesStackSlots(stack); err != nil {
		return err
	}
