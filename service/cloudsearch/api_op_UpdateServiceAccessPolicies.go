...
func (*UpdateServiceAccessPoliciesInput) operationName() string {
...
func (c *Client) addOperationUpdateServiceAccessPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateServiceAccessPoliciesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateServiceAccessPoliciesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateServiceAccessPoliciesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateServiceAccessPoliciesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateServiceAccessPoliciesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateServiceAccessPoliciesResolveEndpointMiddleware{
