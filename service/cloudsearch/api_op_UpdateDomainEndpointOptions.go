...
func (c *Client) addOperationUpdateDomainEndpointOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDomainEndpointOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
