...
func (c *Client) DefineAnalysisScheme(ctx context.Context, params *DefineAnalysisSchemeInput, optFns ...func(*Options)) (*DefineAnalysisSchemeOutput, error) {
	stack := middleware.NewStack("DefineAnalysisScheme", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsquery_serdeOpDefineAnalysisSchemeMiddlewares(stack)
...
func addawsAwsquery_serdeOpDefineAnalysisSchemeMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpDefineAnalysisScheme{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpDefineAnalysisScheme{}, middleware.After)
}
