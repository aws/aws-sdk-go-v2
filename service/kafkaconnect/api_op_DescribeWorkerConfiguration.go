...
func (c *Client) addOperationDescribeWorkerConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeWorkerConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
