...
func (c *Client) addOperationDescribeConnectorOperationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConnectorOperation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
