...
func (c *Client) ListCustomPlugins(ctx context.Context, params *ListCustomPluginsInput, optFns ...func(*Options)) (*ListCustomPluginsOutput, error) {
	if params == nil { params = &ListCustomPluginsInput{} }
...
func (c *Client) addOperationListCustomPluginsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCustomPluginsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCustomPluginsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCustomPluginsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCustomPluginsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCustomPluginsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCustomPluginsResolveEndpointMiddleware{
