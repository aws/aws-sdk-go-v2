...
func (c *Client) addOperationListWorkerConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListWorkerConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
