...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-marketplace-deployment.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-deployment.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-deployment.dev",
			expectURL:     aws.String("https://env-marketplace-deployment.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-marketplace-deployment.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-deployment.dev",
			expectURL:     aws.String("http://config-marketplace-deployment.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-marketplace-deployment.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-marketplace-deployment.dev",
			clientEndpoint: aws.String("https://client-marketplace-deployment.dev"),
			expectURL:      aws.String("https://client-marketplace-deployment.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MARKETPLACE_DEPLOYMENT", c.envService)
			}
