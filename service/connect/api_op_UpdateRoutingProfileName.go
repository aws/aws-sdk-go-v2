...
func (*UpdateRoutingProfileNameInput) operationName() string {
...
func (c *Client) addOperationUpdateRoutingProfileNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateRoutingProfileNameResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateRoutingProfileNameResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateRoutingProfileNameResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateRoutingProfileNameResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateRoutingProfileNameResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateRoutingProfileNameResolveEndpointMiddleware{
