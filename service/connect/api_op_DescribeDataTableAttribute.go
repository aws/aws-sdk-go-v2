...
func (c *Client) addOperationDescribeDataTableAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDataTableAttribute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
