...
func (c *Client) SearchResourceTags(ctx context.Context, params *SearchResourceTagsInput, optFns ...func(*Options)) (*SearchResourceTagsOutput, error) {
	if params == nil { params = &SearchResourceTagsInput{} }
...
func (c *Client) addOperationSearchResourceTagsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSearchResourceTagsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSearchResourceTagsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSearchResourceTagsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSearchResourceTagsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSearchResourceTagsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSearchResourceTagsResolveEndpointMiddleware{
