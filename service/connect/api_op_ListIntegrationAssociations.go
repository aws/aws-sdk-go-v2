...
func (*ListIntegrationAssociationsInput) operationName() string {
...
func (c *Client) addOperationListIntegrationAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListIntegrationAssociationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListIntegrationAssociationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListIntegrationAssociationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListIntegrationAssociationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListIntegrationAssociationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListIntegrationAssociationsResolveEndpointMiddleware{
