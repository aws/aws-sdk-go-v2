...
func (c *Client) addOperationListIntegrationAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListIntegrationAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
