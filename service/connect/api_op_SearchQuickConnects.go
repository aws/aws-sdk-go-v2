...
func (c *Client) SearchQuickConnects(ctx context.Context, params *SearchQuickConnectsInput, optFns ...func(*Options)) (*SearchQuickConnectsOutput, error) {
	if params == nil { params = &SearchQuickConnectsInput{} }
...
func (c *Client) addOperationSearchQuickConnectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSearchQuickConnectsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSearchQuickConnectsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSearchQuickConnectsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSearchQuickConnectsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSearchQuickConnectsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSearchQuickConnectsResolveEndpointMiddleware{
