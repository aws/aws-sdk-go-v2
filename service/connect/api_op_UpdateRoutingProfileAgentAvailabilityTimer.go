...
func (c *Client) addOperationUpdateRoutingProfileAgentAvailabilityTimerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRoutingProfileAgentAvailabilityTimer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
