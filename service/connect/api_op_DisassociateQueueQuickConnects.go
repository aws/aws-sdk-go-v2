...
func (c *Client) addOperationDisassociateQueueQuickConnectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateQueueQuickConnects", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
