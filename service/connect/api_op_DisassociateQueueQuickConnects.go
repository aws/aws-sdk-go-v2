...
func (*DisassociateQueueQuickConnectsInput) operationName() string {
...
func (c *Client) addOperationDisassociateQueueQuickConnectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateQueueQuickConnectsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDisassociateQueueQuickConnectsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDisassociateQueueQuickConnectsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateQueueQuickConnectsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateQueueQuickConnectsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDisassociateQueueQuickConnectsResolveEndpointMiddleware{
