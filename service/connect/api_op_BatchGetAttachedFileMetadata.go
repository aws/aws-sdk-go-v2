...
func (c *Client) addOperationBatchGetAttachedFileMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetAttachedFileMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
