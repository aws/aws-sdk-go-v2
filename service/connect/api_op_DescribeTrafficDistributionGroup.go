...
func (c *Client) DescribeTrafficDistributionGroup(ctx context.Context, params *DescribeTrafficDistributionGroupInput, optFns ...func(*Options)) (*DescribeTrafficDistributionGroupOutput, error) {
	if params == nil { params = &DescribeTrafficDistributionGroupInput{} }
...
func (c *Client) addOperationDescribeTrafficDistributionGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeTrafficDistributionGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeTrafficDistributionGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeTrafficDistributionGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeTrafficDistributionGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeTrafficDistributionGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeTrafficDistributionGroupResolveEndpointMiddleware{
