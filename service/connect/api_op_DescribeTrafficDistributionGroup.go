...
func (c *Client) addOperationDescribeTrafficDistributionGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeTrafficDistributionGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
