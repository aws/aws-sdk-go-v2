...
func (c *Client) addOperationCreateDataTableAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateDataTableAttribute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
