...
func (c *Client) addOperationDisassociateUserProficienciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateUserProficiencies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
