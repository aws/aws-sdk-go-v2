...
func (c *Client) addOperationListPredefinedAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPredefinedAttributes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
