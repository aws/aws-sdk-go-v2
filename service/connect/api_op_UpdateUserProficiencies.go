...
func (c *Client) addOperationUpdateUserProficienciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateUserProficiencies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
