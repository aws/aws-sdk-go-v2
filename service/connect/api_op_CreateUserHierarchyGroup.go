...
func (c *Client) addOperationCreateUserHierarchyGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateUserHierarchyGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
