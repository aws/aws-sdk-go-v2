...
func (c *Client) addOperationDisassociateRoutingProfileQueuesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateRoutingProfileQueues", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
