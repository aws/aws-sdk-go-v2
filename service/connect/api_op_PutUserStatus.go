...
func (c *Client) PutUserStatus(ctx context.Context, params *PutUserStatusInput, optFns ...func(*Options)) (*PutUserStatusOutput, error) {
	if params == nil { params = &PutUserStatusInput{} }
...
func (c *Client) addOperationPutUserStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutUserStatusResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutUserStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutUserStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutUserStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutUserStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutUserStatusResolveEndpointMiddleware{
