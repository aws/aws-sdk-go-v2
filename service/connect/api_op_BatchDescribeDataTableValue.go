...
func (c *Client) addOperationBatchDescribeDataTableValueMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDescribeDataTableValue", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
