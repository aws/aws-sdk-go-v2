...
func (c *Client) addOperationDeleteUserHierarchyGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteUserHierarchyGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
