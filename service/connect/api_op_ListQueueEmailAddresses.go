...
func (c *Client) addOperationListQueueEmailAddressesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListQueueEmailAddresses", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
