...
func (c *Client) ListRoutingProfileQueues(ctx context.Context, params *ListRoutingProfileQueuesInput, optFns ...func(*Options)) (*ListRoutingProfileQueuesOutput, error) {
	if params == nil { params = &ListRoutingProfileQueuesInput{} }
...
func (c *Client) addOperationListRoutingProfileQueuesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRoutingProfileQueuesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRoutingProfileQueuesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRoutingProfileQueuesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRoutingProfileQueuesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRoutingProfileQueuesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRoutingProfileQueuesResolveEndpointMiddleware{
