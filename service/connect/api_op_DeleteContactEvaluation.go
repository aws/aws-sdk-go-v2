...
func (c *Client) addOperationDeleteContactEvaluationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteContactEvaluation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
