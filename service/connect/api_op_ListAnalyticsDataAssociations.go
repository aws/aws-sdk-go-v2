...
func (c *Client) addOperationListAnalyticsDataAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAnalyticsDataAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
