...
func (c *Client) addOperationCreateContactFlowModuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateContactFlowModule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
