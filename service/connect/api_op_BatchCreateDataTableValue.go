...
func (c *Client) addOperationBatchCreateDataTableValueMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchCreateDataTableValue", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
