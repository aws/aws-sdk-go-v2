...
func (*DeleteContactFlowModuleInput) operationName() string {
...
func (c *Client) addOperationDeleteContactFlowModuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteContactFlowModuleResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteContactFlowModuleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteContactFlowModuleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteContactFlowModuleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteContactFlowModuleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteContactFlowModuleResolveEndpointMiddleware{
