...
func (c *Client) addOperationDeleteContactFlowModuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteContactFlowModule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
