...
func (c *Client) TransferContact(ctx context.Context, params *TransferContactInput, optFns ...func(*Options)) (*TransferContactOutput, error) {
	if params == nil { params = &TransferContactInput{} }
...
func (c *Client) addOperationTransferContactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addTransferContactResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
func (m *idempotencyToken_initializeOpTransferContact) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *TransferContactInput ")}
...
type opTransferContactResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opTransferContactResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opTransferContactResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addTransferContactResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opTransferContactResolveEndpointMiddleware{
