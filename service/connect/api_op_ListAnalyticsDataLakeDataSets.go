...
func (c *Client) addOperationListAnalyticsDataLakeDataSetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAnalyticsDataLakeDataSets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
