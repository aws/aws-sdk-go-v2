...
func (c *Client) addOperationSearchAvailablePhoneNumbersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SearchAvailablePhoneNumbers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
