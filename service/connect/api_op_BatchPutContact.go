...
func (c *Client) addOperationBatchPutContactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchPutContactResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opBatchPutContactResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opBatchPutContactResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchPutContactResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchPutContactResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opBatchPutContactResolveEndpointMiddleware{
