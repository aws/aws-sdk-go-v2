...
func (c *Client) addOperationStartOutboundVoiceContactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartOutboundVoiceContact", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
