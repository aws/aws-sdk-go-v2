...
func (c *Client) addOperationListEntitySecurityProfilesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEntitySecurityProfiles", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
