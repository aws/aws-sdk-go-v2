...
func (c *Client) addOperationUpdateQueueOutboundCallerConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateQueueOutboundCallerConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
