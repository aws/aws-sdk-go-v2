...
func (c *Client) StopContact(ctx context.Context, params *StopContactInput, optFns ...func(*Options)) (*StopContactOutput, error) {
	stack := middleware.NewStack("StopContact", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpStopContactMiddlewares(stack)
...
func addawsRestjson1_serdeOpStopContactMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpStopContact{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpStopContact{}, middleware.After)
}
