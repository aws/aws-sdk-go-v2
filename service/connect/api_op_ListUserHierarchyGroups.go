...
//
// For more information about agent hierarchies, see [Set Up Agent Hierarchies] in the Connect Customer
// Administrator Guide.
//
...
func (c *Client) addOperationListUserHierarchyGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListUserHierarchyGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
