...
func (c *Client) AssociateBot(ctx context.Context, params *AssociateBotInput, optFns ...func(*Options)) (*AssociateBotOutput, error) {
	if params == nil { params = &AssociateBotInput{} }
...
func (c *Client) addOperationAssociateBotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateBotResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateBotResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateBotResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateBotResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateBotResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateBotResolveEndpointMiddleware{
