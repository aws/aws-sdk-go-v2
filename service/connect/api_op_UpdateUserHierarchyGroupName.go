...
func (*UpdateUserHierarchyGroupNameInput) operationName() string {
...
func (c *Client) addOperationUpdateUserHierarchyGroupNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateUserHierarchyGroupNameResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateUserHierarchyGroupNameResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateUserHierarchyGroupNameResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateUserHierarchyGroupNameResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateUserHierarchyGroupNameResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateUserHierarchyGroupNameResolveEndpointMiddleware{
