...
func (c *Client) addOperationUpdateUserHierarchyGroupNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateUserHierarchyGroupName", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
