...
func (v *ListSecurityProfilesInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.InstanceId != nil {
		s.WriteString(schemas.ListSecurityProfilesRequest_InstanceId, *v.InstanceId)
	}
	if v.MaxResults != nil {
...
func (v *ListSecurityProfilesOutput) SerializeMembers(s smithy.ShapeSerializer) {
	...
	serializeSecurityProfileSummaryList(s, schemas.ListSecurityProfilesResponse_SecurityProfileSummaryList, v.SecurityProfileSummaryList)
}
func (v *ListSecurityProfilesOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListSecurityProfilesResponse, func(s *smithy.Schema) error {
		...
		case schemas.ListSecurityProfilesResponse_SecurityProfileSummaryList:
			return deserializeSecurityProfileSummaryList(d, schemas.ListSecurityProfilesResponse_SecurityProfileSummaryList, &v.SecurityProfileSummaryList)
		}
		return nil
	})
}
