...
func (c *Client) addOperationUpdateEmailAddressMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateEmailAddressMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
