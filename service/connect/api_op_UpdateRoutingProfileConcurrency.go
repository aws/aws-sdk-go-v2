...
func (c *Client) addOperationUpdateRoutingProfileConcurrencyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRoutingProfileConcurrency", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
