...
func (c *Client) UpdateRoutingProfileConcurrency(ctx context.Context, params *UpdateRoutingProfileConcurrencyInput, optFns ...func(*Options)) (*UpdateRoutingProfileConcurrencyOutput, error) {
	if params == nil { params = &UpdateRoutingProfileConcurrencyInput{} }
...
func (c *Client) addOperationUpdateRoutingProfileConcurrencyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateRoutingProfileConcurrencyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateRoutingProfileConcurrencyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateRoutingProfileConcurrencyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateRoutingProfileConcurrencyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateRoutingProfileConcurrencyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateRoutingProfileConcurrencyResolveEndpointMiddleware{
