...
func (c *Client) SearchHoursOfOperations(ctx context.Context, params *SearchHoursOfOperationsInput, optFns ...func(*Options)) (*SearchHoursOfOperationsOutput, error) {
	if params == nil { params = &SearchHoursOfOperationsInput{} }
...
func (c *Client) addOperationSearchHoursOfOperationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSearchHoursOfOperationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSearchHoursOfOperationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSearchHoursOfOperationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSearchHoursOfOperationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSearchHoursOfOperationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSearchHoursOfOperationsResolveEndpointMiddleware{
