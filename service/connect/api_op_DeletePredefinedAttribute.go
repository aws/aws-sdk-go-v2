...
func (c *Client) addOperationDeletePredefinedAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeletePredefinedAttribute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
