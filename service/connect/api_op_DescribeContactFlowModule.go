...
func (c *Client) addOperationDescribeContactFlowModuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeContactFlowModule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
