...
func (c *Client) addOperationDescribePredefinedAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribePredefinedAttribute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
