...
func (c *Client) addOperationUpdateQueueOutboundEmailConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateQueueOutboundEmailConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
