...
func (c *Client) addOperationUpdateTrafficDistributionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateTrafficDistribution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
