...
func (c *Client) addOperationUpdateUserRoutingProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateUserRoutingProfile", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
