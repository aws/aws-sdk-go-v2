...
func (*UpdateUserRoutingProfileInput) operationName() string {
...
func (c *Client) addOperationUpdateUserRoutingProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateUserRoutingProfileResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateUserRoutingProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateUserRoutingProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateUserRoutingProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateUserRoutingProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateUserRoutingProfileResolveEndpointMiddleware{
