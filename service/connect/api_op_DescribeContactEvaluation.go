...
func (c *Client) addOperationDescribeContactEvaluationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeContactEvaluation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
