...
func (*UpdateContactFlowNameInput) operationName() string {
...
func (c *Client) addOperationUpdateContactFlowNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateContactFlowNameResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateContactFlowNameResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateContactFlowNameResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateContactFlowNameResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateContactFlowNameResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateContactFlowNameResolveEndpointMiddleware{
