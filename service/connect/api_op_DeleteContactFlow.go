...
func (*DeleteContactFlowInput) operationName() string {
...
func (c *Client) addOperationDeleteContactFlowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteContactFlowResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteContactFlowResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteContactFlowResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteContactFlowResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteContactFlowResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteContactFlowResolveEndpointMiddleware{
