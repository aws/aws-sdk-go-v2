...
func (c *Client) addOperationDisassociateHoursOfOperationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateHoursOfOperations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
