...
func (c *Client) addOperationListSecurityProfileApplicationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSecurityProfileApplicationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListSecurityProfileApplicationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListSecurityProfileApplicationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSecurityProfileApplicationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSecurityProfileApplicationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListSecurityProfileApplicationsResolveEndpointMiddleware{
