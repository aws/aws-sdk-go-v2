...
func (c *Client) UpdateUserHierarchyStructure(ctx context.Context, params *UpdateUserHierarchyStructureInput, optFns ...func(*Options)) (*UpdateUserHierarchyStructureOutput, error) {
	if params == nil { params = &UpdateUserHierarchyStructureInput{} }
...
func (c *Client) addOperationUpdateUserHierarchyStructureMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateUserHierarchyStructureResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateUserHierarchyStructureResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateUserHierarchyStructureResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateUserHierarchyStructureResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateUserHierarchyStructureResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateUserHierarchyStructureResolveEndpointMiddleware{
