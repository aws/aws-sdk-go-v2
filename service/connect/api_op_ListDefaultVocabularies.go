...
func (c *Client) addOperationListDefaultVocabulariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDefaultVocabulariesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListDefaultVocabulariesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListDefaultVocabulariesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDefaultVocabulariesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDefaultVocabulariesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListDefaultVocabulariesResolveEndpointMiddleware{
