...
func (c *Client) AssociateDefaultVocabulary(ctx context.Context, params *AssociateDefaultVocabularyInput, optFns ...func(*Options)) (*AssociateDefaultVocabularyOutput, error) {
	if params == nil { params = &AssociateDefaultVocabularyInput{} }
...
func (c *Client) addOperationAssociateDefaultVocabularyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateDefaultVocabularyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateDefaultVocabularyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateDefaultVocabularyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateDefaultVocabularyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateDefaultVocabularyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateDefaultVocabularyResolveEndpointMiddleware{
