...
func (c *Client) addOperationAssociateDefaultVocabularyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateDefaultVocabulary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
