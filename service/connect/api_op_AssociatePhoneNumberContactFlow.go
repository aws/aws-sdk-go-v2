...
func (c *Client) AssociatePhoneNumberContactFlow(ctx context.Context, params *AssociatePhoneNumberContactFlowInput, optFns ...func(*Options)) (*AssociatePhoneNumberContactFlowOutput, error) {
	if params == nil { params = &AssociatePhoneNumberContactFlowInput{} }
...
func (c *Client) addOperationAssociatePhoneNumberContactFlowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociatePhoneNumberContactFlowResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociatePhoneNumberContactFlowResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociatePhoneNumberContactFlowResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociatePhoneNumberContactFlowResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociatePhoneNumberContactFlowResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociatePhoneNumberContactFlowResolveEndpointMiddleware{
