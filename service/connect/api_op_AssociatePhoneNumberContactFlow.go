...
func (c *Client) addOperationAssociatePhoneNumberContactFlowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociatePhoneNumberContactFlow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
