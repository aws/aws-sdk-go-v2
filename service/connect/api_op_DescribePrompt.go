...
func (c *Client) DescribePrompt(ctx context.Context, params *DescribePromptInput, optFns ...func(*Options)) (*DescribePromptOutput, error) {
	if params == nil { params = &DescribePromptInput{} }
...
func (c *Client) addOperationDescribePromptMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribePromptResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribePromptResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribePromptResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribePromptResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribePromptResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribePromptResolveEndpointMiddleware{
