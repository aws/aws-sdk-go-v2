...
func (*UpdateInstanceAttributeInput) operationName() string {
...
func (c *Client) addOperationUpdateInstanceAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateInstanceAttributeResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateInstanceAttributeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateInstanceAttributeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateInstanceAttributeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateInstanceAttributeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateInstanceAttributeResolveEndpointMiddleware{
