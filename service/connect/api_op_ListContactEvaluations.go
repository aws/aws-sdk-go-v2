...
func (c *Client) ListContactEvaluations(ctx context.Context, params *ListContactEvaluationsInput, optFns ...func(*Options)) (*ListContactEvaluationsOutput, error) {
	if params == nil { params = &ListContactEvaluationsInput{} }
...
func (c *Client) addOperationListContactEvaluationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListContactEvaluationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListContactEvaluationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListContactEvaluationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListContactEvaluationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListContactEvaluationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListContactEvaluationsResolveEndpointMiddleware{
