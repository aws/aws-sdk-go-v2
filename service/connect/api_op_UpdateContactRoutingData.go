...
func (c *Client) addOperationUpdateContactRoutingDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateContactRoutingData", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
