...
func (c *Client) addOperationAssociateRoutingProfileQueuesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateRoutingProfileQueues", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
