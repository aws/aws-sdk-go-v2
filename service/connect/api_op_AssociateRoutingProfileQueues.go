...
func (c *Client) AssociateRoutingProfileQueues(ctx context.Context, params *AssociateRoutingProfileQueuesInput, optFns ...func(*Options)) (*AssociateRoutingProfileQueuesOutput, error) {
	if params == nil { params = &AssociateRoutingProfileQueuesInput{} }
...
func (c *Client) addOperationAssociateRoutingProfileQueuesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateRoutingProfileQueuesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateRoutingProfileQueuesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateRoutingProfileQueuesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateRoutingProfileQueuesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateRoutingProfileQueuesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateRoutingProfileQueuesResolveEndpointMiddleware{
