...
func (c *Client) SuspendContactRecording(ctx context.Context, params *SuspendContactRecordingInput, optFns ...func(*Options)) (*SuspendContactRecordingOutput, error) {
	if params == nil { params = &SuspendContactRecordingInput{} }
...
func (c *Client) addOperationSuspendContactRecordingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSuspendContactRecordingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSuspendContactRecordingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSuspendContactRecordingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSuspendContactRecordingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSuspendContactRecordingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSuspendContactRecordingResolveEndpointMiddleware{
