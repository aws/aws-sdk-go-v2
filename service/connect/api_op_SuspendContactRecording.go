...
func (c *Client) addOperationSuspendContactRecordingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SuspendContactRecording", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
