...
func (c *Client) addOperationUpdateRoutingProfileDefaultOutboundQueueMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRoutingProfileDefaultOutboundQueue", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
