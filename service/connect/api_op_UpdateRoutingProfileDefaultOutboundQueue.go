...
func (*UpdateRoutingProfileDefaultOutboundQueueInput) operationName() string {
...
func (c *Client) addOperationUpdateRoutingProfileDefaultOutboundQueueMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateRoutingProfileDefaultOutboundQueueResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateRoutingProfileDefaultOutboundQueueResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateRoutingProfileDefaultOutboundQueueResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateRoutingProfileDefaultOutboundQueueResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateRoutingProfileDefaultOutboundQueueResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateRoutingProfileDefaultOutboundQueueResolveEndpointMiddleware{
