...
func (c *Client) SearchRoutingProfiles(ctx context.Context, params *SearchRoutingProfilesInput, optFns ...func(*Options)) (*SearchRoutingProfilesOutput, error) {
	if params == nil { params = &SearchRoutingProfilesInput{} }
...
func (c *Client) addOperationSearchRoutingProfilesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSearchRoutingProfilesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSearchRoutingProfilesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSearchRoutingProfilesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSearchRoutingProfilesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSearchRoutingProfilesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSearchRoutingProfilesResolveEndpointMiddleware{
