...
func (c *Client) addOperationUpdateContactFlowModuleMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateContactFlowModuleMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
