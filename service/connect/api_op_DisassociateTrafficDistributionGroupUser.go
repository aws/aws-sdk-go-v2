...
func (c *Client) addOperationDisassociateTrafficDistributionGroupUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateTrafficDistributionGroupUser", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
