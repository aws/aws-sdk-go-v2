...
func (c *Client) addOperationDeactivateEvaluationFormMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeactivateEvaluationForm", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
