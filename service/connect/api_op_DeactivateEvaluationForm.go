...
func (c *Client) DeactivateEvaluationForm(ctx context.Context, params *DeactivateEvaluationFormInput, optFns ...func(*Options)) (*DeactivateEvaluationFormOutput, error) {
	if params == nil { params = &DeactivateEvaluationFormInput{} }
...
func (c *Client) addOperationDeactivateEvaluationFormMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeactivateEvaluationFormResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeactivateEvaluationFormResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeactivateEvaluationFormResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeactivateEvaluationFormResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeactivateEvaluationFormResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeactivateEvaluationFormResolveEndpointMiddleware{
