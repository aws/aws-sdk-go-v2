...
func (c *Client) addOperationEvaluateDataTableValuesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EvaluateDataTableValues", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
