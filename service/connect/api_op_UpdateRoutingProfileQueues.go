...
func (c *Client) addOperationUpdateRoutingProfileQueuesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRoutingProfileQueues", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
