...
func (c *Client) addOperationDescribeAuthenticationProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAuthenticationProfile", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
