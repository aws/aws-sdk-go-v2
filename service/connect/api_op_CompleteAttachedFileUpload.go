...
func (c *Client) addOperationCompleteAttachedFileUploadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CompleteAttachedFileUpload", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
