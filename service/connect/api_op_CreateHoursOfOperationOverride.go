...
func (c *Client) addOperationCreateHoursOfOperationOverrideMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateHoursOfOperationOverride", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
