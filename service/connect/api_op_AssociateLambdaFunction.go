...
func (c *Client) addOperationAssociateLambdaFunctionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateLambdaFunction", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
