...
func (c *Client) addOperationUpdateHoursOfOperationOverrideMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateHoursOfOperationOverride", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
