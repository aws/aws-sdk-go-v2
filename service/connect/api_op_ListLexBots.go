...
func (*ListLexBotsInput) operationName() string {
	return "ListLexBots"
}
...
func (c *Client) addOperationListLexBotsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLexBotsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListLexBotsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListLexBotsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLexBotsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLexBotsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListLexBotsResolveEndpointMiddleware{
