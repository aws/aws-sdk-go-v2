...
func (c *Client) addOperationUpdateDataTableMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDataTableMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
