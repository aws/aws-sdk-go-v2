...
func (c *Client) GetPromptFile(ctx context.Context, params *GetPromptFileInput, optFns ...func(*Options)) (*GetPromptFileOutput, error) {
	if params == nil { params = &GetPromptFileInput{} }
...
func (c *Client) addOperationGetPromptFileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPromptFileResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPromptFileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPromptFileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPromptFileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPromptFileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPromptFileResolveEndpointMiddleware{
