...
func (c *Client) addOperationUpdateDataTablePrimaryValuesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDataTablePrimaryValues", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
