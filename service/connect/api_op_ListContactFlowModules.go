...
func (*ListContactFlowModulesInput) operationName() string {
...
func (c *Client) addOperationListContactFlowModulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListContactFlowModulesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListContactFlowModulesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListContactFlowModulesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListContactFlowModulesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListContactFlowModulesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListContactFlowModulesResolveEndpointMiddleware{
