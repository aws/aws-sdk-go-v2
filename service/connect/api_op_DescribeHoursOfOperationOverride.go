...
func (c *Client) addOperationDescribeHoursOfOperationOverrideMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeHoursOfOperationOverride", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
