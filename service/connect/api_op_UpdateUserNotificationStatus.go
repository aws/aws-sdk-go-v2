...
func (c *Client) addOperationUpdateUserNotificationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateUserNotificationStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
