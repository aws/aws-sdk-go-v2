...
func (c *Client) ListApprovedOrigins(ctx context.Context, params *ListApprovedOriginsInput, optFns ...func(*Options)) (*ListApprovedOriginsOutput, error) {
	if params == nil { params = &ListApprovedOriginsInput{} }
...
func (c *Client) addOperationListApprovedOriginsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListApprovedOriginsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListApprovedOriginsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListApprovedOriginsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListApprovedOriginsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListApprovedOriginsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListApprovedOriginsResolveEndpointMiddleware{
