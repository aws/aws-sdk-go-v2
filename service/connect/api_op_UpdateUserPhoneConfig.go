...
func (*UpdateUserPhoneConfigInput) operationName() string {
...
func (c *Client) addOperationUpdateUserPhoneConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateUserPhoneConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateUserPhoneConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateUserPhoneConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateUserPhoneConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateUserPhoneConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateUserPhoneConfigResolveEndpointMiddleware{
