...
func (c *Client) DismissUserContact(ctx context.Context, params *DismissUserContactInput, optFns ...func(*Options)) (*DismissUserContactOutput, error) {
	if params == nil { params = &DismissUserContactInput{} }
...
func (c *Client) addOperationDismissUserContactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDismissUserContactResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDismissUserContactResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDismissUserContactResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDismissUserContactResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDismissUserContactResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDismissUserContactResolveEndpointMiddleware{
