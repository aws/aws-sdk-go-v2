...
func (c *Client) addOperationAssociateTrafficDistributionGroupUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateTrafficDistributionGroupUser", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
