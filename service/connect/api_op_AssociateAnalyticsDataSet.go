...
func (c *Client) addOperationAssociateAnalyticsDataSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateAnalyticsDataSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
