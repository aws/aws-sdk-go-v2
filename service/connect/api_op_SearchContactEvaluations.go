...
func (c *Client) addOperationSearchContactEvaluationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SearchContactEvaluations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
