...
func (c *Client) addOperationSearchUserHierarchyGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SearchUserHierarchyGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
