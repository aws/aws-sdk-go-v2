...
func (c *Client) addOperationCreatePushNotificationRegistrationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreatePushNotificationRegistration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
