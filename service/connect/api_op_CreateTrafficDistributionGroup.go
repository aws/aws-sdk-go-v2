...
func (c *Client) addOperationCreateTrafficDistributionGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateTrafficDistributionGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
