...
func (*UpdateContactEvaluationInput) operationName() string {
...
func (c *Client) addOperationUpdateContactEvaluationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateContactEvaluationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateContactEvaluationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateContactEvaluationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateContactEvaluationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateContactEvaluationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateContactEvaluationResolveEndpointMiddleware{
