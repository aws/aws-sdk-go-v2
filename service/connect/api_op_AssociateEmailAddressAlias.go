...
func (c *Client) addOperationAssociateEmailAddressAliasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateEmailAddressAlias", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
