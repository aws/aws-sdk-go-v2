...
func (*UpdateUserSecurityProfilesInput) operationName() string {
...
func (c *Client) addOperationUpdateUserSecurityProfilesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateUserSecurityProfilesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateUserSecurityProfilesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateUserSecurityProfilesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateUserSecurityProfilesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateUserSecurityProfilesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateUserSecurityProfilesResolveEndpointMiddleware{
