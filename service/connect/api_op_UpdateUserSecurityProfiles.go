...
func (c *Client) addOperationUpdateUserSecurityProfilesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateUserSecurityProfiles", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
