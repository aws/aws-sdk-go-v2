...
func (c *Client) addOperationAssociateUserProficienciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateUserProficiencies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
