...
func (c *Client) addOperationDescribeHoursOfOperationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeHoursOfOperation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
