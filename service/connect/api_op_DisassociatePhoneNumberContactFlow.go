...
func (c *Client) addOperationDisassociatePhoneNumberContactFlowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociatePhoneNumberContactFlowResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDisassociatePhoneNumberContactFlowResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDisassociatePhoneNumberContactFlowResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociatePhoneNumberContactFlowResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociatePhoneNumberContactFlowResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDisassociatePhoneNumberContactFlowResolveEndpointMiddleware{
