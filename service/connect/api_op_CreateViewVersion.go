...
func (c *Client) addOperationCreateViewVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateViewVersionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateViewVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateViewVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateViewVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateViewVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateViewVersionResolveEndpointMiddleware{
