...
func (c *Client) addOperationDeleteContactFlowVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteContactFlowVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
