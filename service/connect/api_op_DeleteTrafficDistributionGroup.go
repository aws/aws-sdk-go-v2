...
func (c *Client) addOperationDeleteTrafficDistributionGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteTrafficDistributionGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
