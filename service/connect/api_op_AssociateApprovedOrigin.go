...
func (c *Client) addOperationAssociateApprovedOriginMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateApprovedOrigin", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
