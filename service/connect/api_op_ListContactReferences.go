...
func (c *Client) ListContactReferences(ctx context.Context, params *ListContactReferencesInput, optFns ...func(*Options)) (*ListContactReferencesOutput, error) {
	if params == nil { params = &ListContactReferencesInput{} }
...
func (c *Client) addOperationListContactReferencesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListContactReferencesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListContactReferencesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListContactReferencesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListContactReferencesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListContactReferencesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListContactReferencesResolveEndpointMiddleware{
