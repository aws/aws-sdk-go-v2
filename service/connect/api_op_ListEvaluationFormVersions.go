...
func (c *Client) addOperationListEvaluationFormVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEvaluationFormVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
