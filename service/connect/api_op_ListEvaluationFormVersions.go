...
func (*ListEvaluationFormVersionsInput) operationName() string {
...
func (c *Client) addOperationListEvaluationFormVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEvaluationFormVersionsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListEvaluationFormVersionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListEvaluationFormVersionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEvaluationFormVersionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEvaluationFormVersionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListEvaluationFormVersionsResolveEndpointMiddleware{
