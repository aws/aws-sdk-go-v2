...
func (*ResumeContactRecordingInput) operationName() string {
...
func (c *Client) addOperationResumeContactRecordingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResumeContactRecordingResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opResumeContactRecordingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opResumeContactRecordingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResumeContactRecordingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResumeContactRecordingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opResumeContactRecordingResolveEndpointMiddleware{
