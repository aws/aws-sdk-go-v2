...
func (c *Client) addOperationUpdateContactFlowMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateContactFlowMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
