...
func (c *Client) addOperationStartOutboundChatContactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartOutboundChatContact", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
