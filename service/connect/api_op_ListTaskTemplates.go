...
func (*ListTaskTemplatesInput) operationName() string {
...
func (c *Client) addOperationListTaskTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTaskTemplatesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListTaskTemplatesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListTaskTemplatesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTaskTemplatesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTaskTemplatesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListTaskTemplatesResolveEndpointMiddleware{
