...
func (c *Client) addOperationAssociateInstanceStorageConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateInstanceStorageConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
