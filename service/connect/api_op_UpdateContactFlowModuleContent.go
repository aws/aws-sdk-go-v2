...
func (c *Client) addOperationUpdateContactFlowModuleContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateContactFlowModuleContent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
