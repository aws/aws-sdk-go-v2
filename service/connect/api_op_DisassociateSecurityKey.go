...
func (c *Client) addOperationDisassociateSecurityKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateSecurityKey", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
