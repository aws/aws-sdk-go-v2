...
func (c *Client) DisassociateSecurityKey(ctx context.Context, params *DisassociateSecurityKeyInput, optFns ...func(*Options)) (*DisassociateSecurityKeyOutput, error) {
	if params == nil { params = &DisassociateSecurityKeyInput{} }
...
func (m *idempotencyToken_initializeOpDisassociateSecurityKey) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *DisassociateSecurityKeyInput ")}
