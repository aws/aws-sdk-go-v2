...
func (c *Client) addOperationUpdateViewContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateViewContentResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateViewContentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateViewContentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateViewContentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateViewContentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateViewContentResolveEndpointMiddleware{
