...
func (*ListTrafficDistributionGroupsInput) operationName() string {
...
func (c *Client) addOperationListTrafficDistributionGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTrafficDistributionGroupsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListTrafficDistributionGroupsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListTrafficDistributionGroupsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTrafficDistributionGroupsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTrafficDistributionGroupsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListTrafficDistributionGroupsResolveEndpointMiddleware{
