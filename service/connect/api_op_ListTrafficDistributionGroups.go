...
func (c *Client) addOperationListTrafficDistributionGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTrafficDistributionGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
