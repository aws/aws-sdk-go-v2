...
func (*DeleteRoutingProfileInput) operationName() string {
...
func (c *Client) addOperationDeleteRoutingProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteRoutingProfileResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteRoutingProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteRoutingProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteRoutingProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteRoutingProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteRoutingProfileResolveEndpointMiddleware{
