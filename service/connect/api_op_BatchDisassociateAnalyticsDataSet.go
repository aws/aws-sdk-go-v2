...
func (c *Client) addOperationBatchDisassociateAnalyticsDataSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDisassociateAnalyticsDataSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
