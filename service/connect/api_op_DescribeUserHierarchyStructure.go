...
func (*DescribeUserHierarchyStructureInput) operationName() string {
...
func (c *Client) addOperationDescribeUserHierarchyStructureMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeUserHierarchyStructureResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeUserHierarchyStructureResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeUserHierarchyStructureResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeUserHierarchyStructureResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeUserHierarchyStructureResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeUserHierarchyStructureResolveEndpointMiddleware{
