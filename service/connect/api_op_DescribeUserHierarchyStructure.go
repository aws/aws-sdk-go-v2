...
func (c *Client) addOperationDescribeUserHierarchyStructureMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeUserHierarchyStructure", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
