...
func addOperationDescribeUserHierarchyStructureStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeUserHierarchyStructureMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeUserHierarchyStructureStackSlots(stack); err != nil {
		return err
	}
