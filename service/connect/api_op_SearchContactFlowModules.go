...
func (c *Client) addOperationSearchContactFlowModulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SearchContactFlowModules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
