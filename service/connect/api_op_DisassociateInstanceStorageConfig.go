...
func (c *Client) addOperationDisassociateInstanceStorageConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateInstanceStorageConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
