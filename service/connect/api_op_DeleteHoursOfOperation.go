...
func (*DeleteHoursOfOperationInput) operationName() string {
...
func (c *Client) addOperationDeleteHoursOfOperationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteHoursOfOperationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteHoursOfOperationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteHoursOfOperationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteHoursOfOperationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteHoursOfOperationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteHoursOfOperationResolveEndpointMiddleware{
