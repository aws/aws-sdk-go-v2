...
func (c *Client) addOperationUpdateDataTableAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDataTableAttribute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
