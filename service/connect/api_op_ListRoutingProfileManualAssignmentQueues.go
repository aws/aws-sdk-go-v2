...
func (c *Client) addOperationListRoutingProfileManualAssignmentQueuesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRoutingProfileManualAssignmentQueues", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
