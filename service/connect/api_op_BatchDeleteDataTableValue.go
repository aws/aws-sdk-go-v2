...
func (c *Client) addOperationBatchDeleteDataTableValueMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDeleteDataTableValue", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
