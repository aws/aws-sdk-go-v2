...
func (c *Client) addOperationCreatePredefinedAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreatePredefinedAttribute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
