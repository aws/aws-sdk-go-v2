...
func (c *Client) addOperationDisassociateEmailAddressAliasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateEmailAddressAlias", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
