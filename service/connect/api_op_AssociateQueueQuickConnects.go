...
func (c *Client) AssociateQueueQuickConnects(ctx context.Context, params *AssociateQueueQuickConnectsInput, optFns ...func(*Options)) (*AssociateQueueQuickConnectsOutput, error) {
	if params == nil { params = &AssociateQueueQuickConnectsInput{} }
...
func (c *Client) addOperationAssociateQueueQuickConnectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateQueueQuickConnectsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateQueueQuickConnectsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateQueueQuickConnectsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateQueueQuickConnectsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateQueueQuickConnectsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateQueueQuickConnectsResolveEndpointMiddleware{
