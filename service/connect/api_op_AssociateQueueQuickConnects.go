...
func (c *Client) addOperationAssociateQueueQuickConnectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateQueueQuickConnects", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
