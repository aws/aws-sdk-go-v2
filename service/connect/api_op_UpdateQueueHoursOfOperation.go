...
func (c *Client) addOperationUpdateQueueHoursOfOperationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateQueueHoursOfOperation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
