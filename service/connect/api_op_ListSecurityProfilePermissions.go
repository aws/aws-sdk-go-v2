...
func (*ListSecurityProfilePermissionsInput) operationName() string {
...
func (c *Client) addOperationListSecurityProfilePermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSecurityProfilePermissionsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListSecurityProfilePermissionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListSecurityProfilePermissionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSecurityProfilePermissionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSecurityProfilePermissionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListSecurityProfilePermissionsResolveEndpointMiddleware{
