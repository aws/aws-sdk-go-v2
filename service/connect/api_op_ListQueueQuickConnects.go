...
func (c *Client) ListQueueQuickConnects(ctx context.Context, params *ListQueueQuickConnectsInput, optFns ...func(*Options)) (*ListQueueQuickConnectsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListQueueQuickConnects", params, optFns, addOperationListQueueQuickConnectsMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationListQueueQuickConnectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
