...
func (*ListQueueQuickConnectsInput) operationName() string {
...
func (c *Client) addOperationListQueueQuickConnectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListQueueQuickConnectsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListQueueQuickConnectsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListQueueQuickConnectsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListQueueQuickConnectsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListQueueQuickConnectsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListQueueQuickConnectsResolveEndpointMiddleware{
