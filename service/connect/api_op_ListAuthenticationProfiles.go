...
func (c *Client) addOperationListAuthenticationProfilesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAuthenticationProfiles", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
