...
func (c *Client) addOperationSearchHoursOfOperationOverridesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SearchHoursOfOperationOverrides", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
