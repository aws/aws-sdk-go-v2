...
func (c *Client) addOperationGetDefaultPatchBaselineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDefaultPatchBaseline", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
