...
func addOperationDescribeEffectiveInstanceAssociationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeEffectiveInstanceAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeEffectiveInstanceAssociationsStackSlots(stack); err != nil {
		return err
	}
