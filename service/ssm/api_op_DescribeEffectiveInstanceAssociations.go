...
func (c *Client) addOperationDescribeEffectiveInstanceAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEffectiveInstanceAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
