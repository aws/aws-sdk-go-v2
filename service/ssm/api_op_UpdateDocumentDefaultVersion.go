...
func addOperationUpdateDocumentDefaultVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateDocumentDefaultVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateDocumentDefaultVersionStackSlots(stack); err != nil {
		return err
	}
