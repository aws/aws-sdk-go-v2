...
func addOperationGetPatchBaselineForPatchGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationGetPatchBaselineForPatchGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetPatchBaselineForPatchGroupStackSlots(stack); err != nil {
		return err
	}
