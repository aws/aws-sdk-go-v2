...
func (c *Client) addOperationStartChangeRequestExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartChangeRequestExecution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
