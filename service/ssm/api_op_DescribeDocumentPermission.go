...
func (c *Client) addOperationDescribeDocumentPermissionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDocumentPermission", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
