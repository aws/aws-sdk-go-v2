...
func addOperationDescribeInstancePatchStatesForPatchGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeInstancePatchStatesForPatchGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeInstancePatchStatesForPatchGroupStackSlots(stack); err != nil {
		return err
	}
