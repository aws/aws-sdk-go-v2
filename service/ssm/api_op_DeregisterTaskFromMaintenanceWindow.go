...
func (c *Client) addOperationDeregisterTaskFromMaintenanceWindowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterTaskFromMaintenanceWindow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
