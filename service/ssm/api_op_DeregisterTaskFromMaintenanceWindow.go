...
func addOperationDeregisterTaskFromMaintenanceWindowStackSlots(stack *middleware.Stack) error {
...
func addOperationDeregisterTaskFromMaintenanceWindowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeregisterTaskFromMaintenanceWindowStackSlots(stack); err != nil {
		return err
	}
