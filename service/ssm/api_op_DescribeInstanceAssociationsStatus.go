...
func addOperationDescribeInstanceAssociationsStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeInstanceAssociationsStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeInstanceAssociationsStatusStackSlots(stack); err != nil {
		return err
	}
