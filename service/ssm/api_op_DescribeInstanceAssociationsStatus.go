...
func (c *Client) addOperationDescribeInstanceAssociationsStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeInstanceAssociationsStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
