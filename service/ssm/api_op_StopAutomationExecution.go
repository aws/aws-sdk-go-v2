...
func (c *Client) addOperationStopAutomationExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopAutomationExecution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
