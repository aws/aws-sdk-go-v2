...
// RegisterTaskWithMaintenanceWindowoperation are required for this request.
...
type UpdateMaintenanceWindowTaskInput struct {
	...
	// number of targets that are allowed to run this task, in parallel. Although this
	// element is listed as "Required: No", a value can be omitted only when you are
	...
	// RegisterTaskWithMaintenanceWindowoperation are also required for this API
	...
	// TaskInvocationParametersvalues that you want to retain. The values you don't
	...
	// parameters to pass to a task when it runs, instead use the Parameters option
	// in the TaskInvocationParameters structure. For information about how Systems
