...
func addOperationUpdateMaintenanceWindowTaskStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateMaintenanceWindowTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateMaintenanceWindowTaskStackSlots(stack); err != nil {
		return err
	}
