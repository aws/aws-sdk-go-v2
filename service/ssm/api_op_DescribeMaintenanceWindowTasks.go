...
func addOperationDescribeMaintenanceWindowTasksStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeMaintenanceWindowTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeMaintenanceWindowTasksStackSlots(stack); err != nil {
		return err
	}
