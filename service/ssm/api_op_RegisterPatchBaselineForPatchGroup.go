...
func (c *Client) addOperationRegisterPatchBaselineForPatchGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterPatchBaselineForPatchGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
