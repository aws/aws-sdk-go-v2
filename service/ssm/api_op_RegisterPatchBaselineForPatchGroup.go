...
func addOperationRegisterPatchBaselineForPatchGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationRegisterPatchBaselineForPatchGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRegisterPatchBaselineForPatchGroupStackSlots(stack); err != nil {
		return err
	}
