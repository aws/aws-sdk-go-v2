...
func addOperationRegisterTargetWithMaintenanceWindowStackSlots(stack *middleware.Stack) error {
...
func addOperationRegisterTargetWithMaintenanceWindowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRegisterTargetWithMaintenanceWindowStackSlots(stack); err != nil {
		return err
	}
