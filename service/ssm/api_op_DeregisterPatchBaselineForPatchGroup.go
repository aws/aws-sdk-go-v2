...
func (c *Client) addOperationDeregisterPatchBaselineForPatchGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterPatchBaselineForPatchGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
