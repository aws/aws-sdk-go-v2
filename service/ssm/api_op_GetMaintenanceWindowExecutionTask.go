...
func (c *Client) addOperationGetMaintenanceWindowExecutionTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetMaintenanceWindowExecutionTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
