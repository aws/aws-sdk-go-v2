...
func (c *Client) addOperationDescribePatchGroupStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribePatchGroupState", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
