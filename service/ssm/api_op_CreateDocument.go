...
type CreateDocumentInput struct {
	...
	// command. For examples, see the following topics in the Amazon Web Services
	...
	// ApplicationConfigurationSchemadocument for validation purposes. For more
	...
	// To add tags to an existing SSM document,
	...
	// on any resources. For a list of valid resource types, see Amazon Web Services
