...
func addOperationDescribeMaintenanceWindowsForTargetStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeMaintenanceWindowsForTargetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeMaintenanceWindowsForTargetStackSlots(stack); err != nil {
		return err
	}
