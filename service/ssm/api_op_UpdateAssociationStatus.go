...
func (c *Client) addOperationUpdateAssociationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAssociationStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
