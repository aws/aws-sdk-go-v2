...
func addOperationDescribeAutomationStepExecutionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeAutomationStepExecutionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeAutomationStepExecutionsStackSlots(stack); err != nil {
		return err
	}
