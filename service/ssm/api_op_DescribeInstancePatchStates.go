...
func addOperationDescribeInstancePatchStatesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeInstancePatchStatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeInstancePatchStatesStackSlots(stack); err != nil {
		return err
	}
