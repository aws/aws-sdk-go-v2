...
func (c *Client) addOperationDescribeMaintenanceWindowsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMaintenanceWindows", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
