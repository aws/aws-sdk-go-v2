...
func (c *Client) addOperationDeleteMaintenanceWindowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteMaintenanceWindow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
