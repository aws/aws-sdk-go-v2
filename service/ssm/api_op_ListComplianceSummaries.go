...
func (c *Client) addOperationListComplianceSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListComplianceSummaries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
