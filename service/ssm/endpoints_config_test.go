...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ssm.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm.dev",
			expectURL:     aws.String("https://env-ssm.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ssm.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm.dev",
			expectURL:     aws.String("http://config-ssm.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ssm.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ssm.dev",
			clientEndpoint: aws.String("https://client-ssm.dev"),
			expectURL:      aws.String("https://client-ssm.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SSM", c.envService)
			}
