...
func addOperationRegisterTaskWithMaintenanceWindowStackSlots(stack *middleware.Stack) error {
...
func addOperationRegisterTaskWithMaintenanceWindowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRegisterTaskWithMaintenanceWindowStackSlots(stack); err != nil {
		return err
	}
