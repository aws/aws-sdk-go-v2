...
func (c *Client) addOperationAssociateOpsItemRelatedItemMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateOpsItemRelatedItem", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
