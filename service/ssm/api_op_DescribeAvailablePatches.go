...
type DescribeAvailablePatchesInput struct {
	...
	// Linux When specifying
	// filters for Linux patches, you must specify a key-pair for PRODUCT. For
	// example, using the Command Line Interface (CLI), the following command fails:
	// aws ssm describe-available-patches --filters Key=CVE_ID,Values=CVE-2018-3615
	// However, the following command succeeds: aws ssm describe-available-patches
	// --filters Key=PRODUCT,Values=AmazonLinux2018.03 Key=CVE_ID,Values=CVE-2018-3615
