...
type DescribeAvailablePatchesInput struct {
	...
	// - MSRC_SEVERITY Sample values: ServicePacks |
	// Important | Moderate
	// - CLASSIFICATION Sample values: ServicePacks |
	// SecurityUpdates | DefinitionUpdates
	// - PATCH_ID Sample values: KB123456 |
	// KB4516046
	//
	// Linux When specifying filters for Linux patches, you must specify a
	// key-pair for PRODUCT. For example, using the Command Line Interface (CLI), the
	// following command fails: aws ssm describe-available-patches --filters
