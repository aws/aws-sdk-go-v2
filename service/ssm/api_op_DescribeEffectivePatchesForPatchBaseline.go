...
func (c *Client) addOperationDescribeEffectivePatchesForPatchBaselineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEffectivePatchesForPatchBaseline", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
