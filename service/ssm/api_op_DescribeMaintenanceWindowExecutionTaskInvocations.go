...
func addOperationDescribeMaintenanceWindowExecutionTaskInvocationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeMaintenanceWindowExecutionTaskInvocationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeMaintenanceWindowExecutionTaskInvocationsStackSlots(stack); err != nil {
		return err
	}
