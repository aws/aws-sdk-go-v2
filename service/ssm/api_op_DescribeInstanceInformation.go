...
func addOperationDescribeInstanceInformationStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeInstanceInformationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeInstanceInformationStackSlots(stack); err != nil {
		return err
	}
