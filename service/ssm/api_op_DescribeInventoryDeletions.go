...
func addOperationDescribeInventoryDeletionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeInventoryDeletionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeInventoryDeletionsStackSlots(stack); err != nil {
		return err
	}
