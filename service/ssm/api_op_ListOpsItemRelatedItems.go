...
func (c *Client) addOperationListOpsItemRelatedItemsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOpsItemRelatedItems", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
