...
// ResetServiceSettingto change the value back to the original value defined by
// the Amazon Web Services service team. Update the service setting for the
// account.
...
type UpdateServiceSettingInput struct {
	...
	// /ssm/managed-instance/default-ec2-instance-management-rolesetting should only
