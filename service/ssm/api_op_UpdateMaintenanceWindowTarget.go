...
func addOperationUpdateMaintenanceWindowTargetStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateMaintenanceWindowTargetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateMaintenanceWindowTargetStackSlots(stack); err != nil {
		return err
	}
