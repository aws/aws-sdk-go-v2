...
func (c *Client) addOperationDeregisterTargetFromMaintenanceWindowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterTargetFromMaintenanceWindow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
