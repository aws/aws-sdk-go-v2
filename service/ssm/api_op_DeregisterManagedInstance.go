...
func (c *Client) addOperationDeregisterManagedInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterManagedInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
