...
func (c *Client) addOperationDescribeAssociationExecutionTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAssociationExecutionTargets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
