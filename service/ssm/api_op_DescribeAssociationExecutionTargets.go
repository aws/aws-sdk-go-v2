...
func addOperationDescribeAssociationExecutionTargetsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeAssociationExecutionTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeAssociationExecutionTargetsStackSlots(stack); err != nil {
		return err
	}
