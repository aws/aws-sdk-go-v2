...
func (c *Client) addOperationUpdateManagedInstanceRoleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateManagedInstanceRole", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
