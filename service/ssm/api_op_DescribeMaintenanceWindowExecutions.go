...
func addOperationDescribeMaintenanceWindowExecutionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeMaintenanceWindowExecutionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeMaintenanceWindowExecutionsStackSlots(stack); err != nil {
		return err
	}
