...
// Web Services services teams define the default value for a SettingId. You
...
// UpdateServiceSettingAPI operation to change the default setting. Reset the
// service setting for the account to the default value as provisioned by the
