...
func (c *Client) addOperationGetDeployablePatchSnapshotForInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDeployablePatchSnapshotForInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
