...
func addOperationRegisterDefaultPatchBaselineStackSlots(stack *middleware.Stack) error {
...
func addOperationRegisterDefaultPatchBaselineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRegisterDefaultPatchBaselineStackSlots(stack); err != nil {
		return err
	}
