...
func (c *Client) addOperationRegisterDefaultPatchBaselineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterDefaultPatchBaseline", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
