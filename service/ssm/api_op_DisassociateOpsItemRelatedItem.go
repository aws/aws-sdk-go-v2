...
func (c *Client) addOperationDisassociateOpsItemRelatedItemMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateOpsItemRelatedItem", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
