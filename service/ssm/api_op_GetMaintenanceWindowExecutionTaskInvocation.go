...
func (c *Client) addOperationGetMaintenanceWindowExecutionTaskInvocationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetMaintenanceWindowExecutionTaskInvocation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
