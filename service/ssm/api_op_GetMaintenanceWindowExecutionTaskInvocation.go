...
func addOperationGetMaintenanceWindowExecutionTaskInvocationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetMaintenanceWindowExecutionTaskInvocationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetMaintenanceWindowExecutionTaskInvocationStackSlots(stack); err != nil {
		return err
	}
