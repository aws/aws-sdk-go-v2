...
func addOperationCancelMaintenanceWindowExecutionStackSlots(stack *middleware.Stack) error {
...
func addOperationCancelMaintenanceWindowExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCancelMaintenanceWindowExecutionStackSlots(stack); err != nil {
		return err
	}
