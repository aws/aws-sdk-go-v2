...
func (c *Client) addOperationCancelMaintenanceWindowExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelMaintenanceWindowExecution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
