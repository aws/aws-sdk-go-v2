...
func addOperationListResourceComplianceSummariesStackSlots(stack *middleware.Stack) error {
...
func addOperationListResourceComplianceSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListResourceComplianceSummariesStackSlots(stack); err != nil {
		return err
	}
