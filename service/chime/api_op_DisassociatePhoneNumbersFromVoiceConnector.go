...
func addOperationDisassociatePhoneNumbersFromVoiceConnectorStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociatePhoneNumbersFromVoiceConnectorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociatePhoneNumbersFromVoiceConnectorStackSlots(stack); err != nil {
		return err
	}
