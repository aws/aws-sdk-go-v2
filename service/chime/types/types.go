...
// specified attendee. The JoinToken expires when the meeting ends or when DeleteAttendee is
...
type EngineTranscribeSettings struct {
	...
	//
	// If you don't specify a Region, then the MediaRegion parameter of the [CreateMeeting.html] API will
	// be used. However, if Amazon Transcribe is not available in the MediaRegion ,
	...
	//
	// [CreateMeeting.html]: https://docs.aws.amazon.com/chime-sdk/latest/APIReference/API_meeting-chime_CreateMeeting.html
...
type MediaPlacement struct {
	...
	// The screen data URL.
	//
	// This parameter is is no longer supported and no longer used by the Amazon Chime
	// SDK.
