...
func addOperationAssociateSigninDelegateGroupsWithAccountStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociateSigninDelegateGroupsWithAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociateSigninDelegateGroupsWithAccountStackSlots(stack); err != nil {
		return err
	}
