...
func (c *Client) AssociateSigninDelegateGroupsWithAccount(ctx context.Context, params *AssociateSigninDelegateGroupsWithAccountInput, optFns ...func(*Options)) (*AssociateSigninDelegateGroupsWithAccountOutput, error) {
	if params == nil { params = &AssociateSigninDelegateGroupsWithAccountInput{} }
...
func (c *Client) addOperationAssociateSigninDelegateGroupsWithAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateSigninDelegateGroupsWithAccountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateSigninDelegateGroupsWithAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateSigninDelegateGroupsWithAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateSigninDelegateGroupsWithAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateSigninDelegateGroupsWithAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateSigninDelegateGroupsWithAccountResolveEndpointMiddleware{
