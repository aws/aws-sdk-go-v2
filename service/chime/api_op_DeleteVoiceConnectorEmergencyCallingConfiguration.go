...
func addOperationDeleteVoiceConnectorEmergencyCallingConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteVoiceConnectorEmergencyCallingConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteVoiceConnectorEmergencyCallingConfigurationStackSlots(stack); err != nil {
		return err
	}
