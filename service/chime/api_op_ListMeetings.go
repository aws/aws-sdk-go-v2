...
func (*ListMeetingsInput) operationName() string {
	return "ListMeetings"
}
...
func (c *Client) addOperationListMeetingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMeetingsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListMeetingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListMeetingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMeetingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListMeetingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListMeetingsResolveEndpointMiddleware{
