...
func (c *Client) GetVoiceConnectorOrigination(ctx context.Context, params *GetVoiceConnectorOriginationInput, optFns ...func(*Options)) (*GetVoiceConnectorOriginationOutput, error) {
	if params == nil { params = &GetVoiceConnectorOriginationInput{} }
...
func (c *Client) addOperationGetVoiceConnectorOriginationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetVoiceConnectorOriginationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetVoiceConnectorOriginationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetVoiceConnectorOriginationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetVoiceConnectorOriginationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetVoiceConnectorOriginationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetVoiceConnectorOriginationResolveEndpointMiddleware{
