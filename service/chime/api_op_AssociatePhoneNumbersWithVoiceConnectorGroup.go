...
func addOperationAssociatePhoneNumbersWithVoiceConnectorGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociatePhoneNumbersWithVoiceConnectorGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociatePhoneNumbersWithVoiceConnectorGroupStackSlots(stack); err != nil {
		return err
	}
