...
func (c *Client) DisassociateSigninDelegateGroupsFromAccount(ctx context.Context, params *DisassociateSigninDelegateGroupsFromAccountInput, optFns ...func(*Options)) (*DisassociateSigninDelegateGroupsFromAccountOutput, error) {
	stack := middleware.NewStack("DisassociateSigninDelegateGroupsFromAccount", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpDisassociateSigninDelegateGroupsFromAccountMiddlewares(stack)
...
func addawsRestjson1_serdeOpDisassociateSigninDelegateGroupsFromAccountMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpDisassociateSigninDelegateGroupsFromAccount{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpDisassociateSigninDelegateGroupsFromAccount{}, middleware.After)
}
