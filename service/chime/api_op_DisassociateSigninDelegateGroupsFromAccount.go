...
func addOperationDisassociateSigninDelegateGroupsFromAccountStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateSigninDelegateGroupsFromAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateSigninDelegateGroupsFromAccountStackSlots(stack); err != nil {
		return err
	}
