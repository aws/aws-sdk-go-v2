...
func (c *Client) DisassociateSigninDelegateGroupsFromAccount(ctx context.Context, params *DisassociateSigninDelegateGroupsFromAccountInput, optFns ...func(*Options)) (*DisassociateSigninDelegateGroupsFromAccountOutput, error) {
	if params == nil { params = &DisassociateSigninDelegateGroupsFromAccountInput{} }
...
func (c *Client) addOperationDisassociateSigninDelegateGroupsFromAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateSigninDelegateGroupsFromAccountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateSigninDelegateGroupsFromAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateSigninDelegateGroupsFromAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateSigninDelegateGroupsFromAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateSigninDelegateGroupsFromAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateSigninDelegateGroupsFromAccountResolveEndpointMiddleware{
