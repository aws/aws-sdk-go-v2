...
func addOperationGetVoiceConnectorEmergencyCallingConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetVoiceConnectorEmergencyCallingConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetVoiceConnectorEmergencyCallingConfigurationStackSlots(stack); err != nil {
		return err
	}
