...
func (*GetMediaCapturePipelineInput) operationName() string {
...
func (c *Client) addOperationGetMediaCapturePipelineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMediaCapturePipelineResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetMediaCapturePipelineResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetMediaCapturePipelineResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMediaCapturePipelineResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMediaCapturePipelineResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetMediaCapturePipelineResolveEndpointMiddleware{
