...
func addOperationPutVoiceConnectorTerminationCredentialsStackSlots(stack *middleware.Stack) error {
...
func addOperationPutVoiceConnectorTerminationCredentialsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutVoiceConnectorTerminationCredentialsStackSlots(stack); err != nil {
		return err
	}
