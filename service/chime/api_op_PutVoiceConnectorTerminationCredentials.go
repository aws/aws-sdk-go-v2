...
func (c *Client) PutVoiceConnectorTerminationCredentials(ctx context.Context, params *PutVoiceConnectorTerminationCredentialsInput, optFns ...func(*Options)) (*PutVoiceConnectorTerminationCredentialsOutput, error) {
	if params == nil { params = &PutVoiceConnectorTerminationCredentialsInput{} }
...
func (c *Client) addOperationPutVoiceConnectorTerminationCredentialsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutVoiceConnectorTerminationCredentialsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutVoiceConnectorTerminationCredentialsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutVoiceConnectorTerminationCredentialsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutVoiceConnectorTerminationCredentialsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutVoiceConnectorTerminationCredentialsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutVoiceConnectorTerminationCredentialsResolveEndpointMiddleware{
