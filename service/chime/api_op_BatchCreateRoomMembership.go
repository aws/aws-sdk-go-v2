...
func (c *Client) addOperationBatchCreateRoomMembershipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchCreateRoomMembership", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
