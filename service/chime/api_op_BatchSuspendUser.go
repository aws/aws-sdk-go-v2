...
func (c *Client) BatchSuspendUser(ctx context.Context, params *BatchSuspendUserInput, optFns ...func(*Options)) (*BatchSuspendUserOutput, error) {
	if params == nil { params = &BatchSuspendUserInput{} }
...
func (c *Client) addOperationBatchSuspendUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchSuspendUserResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchSuspendUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchSuspendUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchSuspendUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchSuspendUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchSuspendUserResolveEndpointMiddleware{
