...
func (c *Client) PutAppInstanceStreamingConfigurations(ctx context.Context, params *PutAppInstanceStreamingConfigurationsInput, optFns ...func(*Options)) (*PutAppInstanceStreamingConfigurationsOutput, error) {
	if params == nil { params = &PutAppInstanceStreamingConfigurationsInput{} }
...
func (c *Client) addOperationPutAppInstanceStreamingConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutAppInstanceStreamingConfigurationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutAppInstanceStreamingConfigurationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutAppInstanceStreamingConfigurationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutAppInstanceStreamingConfigurationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutAppInstanceStreamingConfigurationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutAppInstanceStreamingConfigurationsResolveEndpointMiddleware{
