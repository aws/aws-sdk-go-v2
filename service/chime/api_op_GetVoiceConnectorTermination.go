...
func addOperationGetVoiceConnectorTerminationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetVoiceConnectorTerminationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetVoiceConnectorTerminationStackSlots(stack); err != nil {
		return err
	}
