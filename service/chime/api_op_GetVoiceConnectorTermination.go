...
func (c *Client) GetVoiceConnectorTermination(ctx context.Context, params *GetVoiceConnectorTerminationInput, optFns ...func(*Options)) (*GetVoiceConnectorTerminationOutput, error) {
	if params == nil { params = &GetVoiceConnectorTerminationInput{} }
...
func (c *Client) addOperationGetVoiceConnectorTerminationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetVoiceConnectorTerminationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetVoiceConnectorTerminationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetVoiceConnectorTerminationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetVoiceConnectorTerminationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetVoiceConnectorTerminationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetVoiceConnectorTerminationResolveEndpointMiddleware{
