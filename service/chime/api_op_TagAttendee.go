...
func (c *Client) TagAttendee(ctx context.Context, params *TagAttendeeInput, optFns ...func(*Options)) (*TagAttendeeOutput, error) {
	if params == nil { params = &TagAttendeeInput{} }
...
func (c *Client) addOperationTagAttendeeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addTagAttendeeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opTagAttendeeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opTagAttendeeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opTagAttendeeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addTagAttendeeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opTagAttendeeResolveEndpointMiddleware{
