...
func (c *Client) PutVoiceConnectorEmergencyCallingConfiguration(ctx context.Context, params *PutVoiceConnectorEmergencyCallingConfigurationInput, optFns ...func(*Options)) (*PutVoiceConnectorEmergencyCallingConfigurationOutput, error) {
	if params == nil { params = &PutVoiceConnectorEmergencyCallingConfigurationInput{} }
...
func (c *Client) addOperationPutVoiceConnectorEmergencyCallingConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutVoiceConnectorEmergencyCallingConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutVoiceConnectorEmergencyCallingConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutVoiceConnectorEmergencyCallingConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutVoiceConnectorEmergencyCallingConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutVoiceConnectorEmergencyCallingConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutVoiceConnectorEmergencyCallingConfigurationResolveEndpointMiddleware{
