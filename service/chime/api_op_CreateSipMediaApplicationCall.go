...
func (*CreateSipMediaApplicationCallInput) operationName() string {
...
func (c *Client) addOperationCreateSipMediaApplicationCallMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateSipMediaApplicationCallResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateSipMediaApplicationCallResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateSipMediaApplicationCallResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateSipMediaApplicationCallResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateSipMediaApplicationCallResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateSipMediaApplicationCallResolveEndpointMiddleware{
