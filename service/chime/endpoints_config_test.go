...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-chime.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime.dev",
			expectURL:     aws.String("https://env-chime.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-chime.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime.dev",
			expectURL:     aws.String("http://config-chime.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-chime.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-chime.dev",
			clientEndpoint: aws.String("https://client-chime.dev"),
			expectURL:      aws.String("https://client-chime.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CHIME", c.envService)
			}
