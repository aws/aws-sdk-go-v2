...
func (c *Client) CreateAccount(ctx context.Context, params *CreateAccountInput, optFns ...func(*Options)) (*CreateAccountOutput, error) {
	stack := middleware.NewStack("CreateAccount", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpCreateAccountMiddlewares(stack)
...
func addawsRestjson1_serdeOpCreateAccountMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpCreateAccount{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpCreateAccount{}, middleware.After)
}
