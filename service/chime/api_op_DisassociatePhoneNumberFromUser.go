...
func addOperationDisassociatePhoneNumberFromUserStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociatePhoneNumberFromUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociatePhoneNumberFromUserStackSlots(stack); err != nil {
		return err
	}
