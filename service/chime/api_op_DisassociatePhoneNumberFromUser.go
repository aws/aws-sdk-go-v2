...
func (c *Client) DisassociatePhoneNumberFromUser(ctx context.Context, params *DisassociatePhoneNumberFromUserInput, optFns ...func(*Options)) (*DisassociatePhoneNumberFromUserOutput, error) {
	if params == nil { params = &DisassociatePhoneNumberFromUserInput{} }
...
func (c *Client) addOperationDisassociatePhoneNumberFromUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociatePhoneNumberFromUserResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociatePhoneNumberFromUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociatePhoneNumberFromUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociatePhoneNumberFromUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociatePhoneNumberFromUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociatePhoneNumberFromUserResolveEndpointMiddleware{
