...
func addOperationListVoiceConnectorTerminationCredentialsStackSlots(stack *middleware.Stack) error {
...
func addOperationListVoiceConnectorTerminationCredentialsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListVoiceConnectorTerminationCredentialsStackSlots(stack); err != nil {
		return err
	}
