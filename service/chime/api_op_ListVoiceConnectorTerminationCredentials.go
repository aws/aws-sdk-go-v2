...
func (c *Client) ListVoiceConnectorTerminationCredentials(ctx context.Context, params *ListVoiceConnectorTerminationCredentialsInput, optFns ...func(*Options)) (*ListVoiceConnectorTerminationCredentialsOutput, error) {
	if params == nil { params = &ListVoiceConnectorTerminationCredentialsInput{} }
...
func (c *Client) addOperationListVoiceConnectorTerminationCredentialsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListVoiceConnectorTerminationCredentialsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListVoiceConnectorTerminationCredentialsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListVoiceConnectorTerminationCredentialsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListVoiceConnectorTerminationCredentialsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListVoiceConnectorTerminationCredentialsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListVoiceConnectorTerminationCredentialsResolveEndpointMiddleware{
