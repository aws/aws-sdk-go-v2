...
func (c *Client) UntagAttendee(ctx context.Context, params *UntagAttendeeInput, optFns ...func(*Options)) (*UntagAttendeeOutput, error) {
	if params == nil { params = &UntagAttendeeInput{} }
...
func (c *Client) addOperationUntagAttendeeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUntagAttendeeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUntagAttendeeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUntagAttendeeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUntagAttendeeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUntagAttendeeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUntagAttendeeResolveEndpointMiddleware{
