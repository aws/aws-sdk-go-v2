...
func (c *Client) GetAppInstanceStreamingConfigurations(ctx context.Context, params *GetAppInstanceStreamingConfigurationsInput, optFns ...func(*Options)) (*GetAppInstanceStreamingConfigurationsOutput, error) {
	if params == nil { params = &GetAppInstanceStreamingConfigurationsInput{} }
...
func (c *Client) addOperationGetAppInstanceStreamingConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAppInstanceStreamingConfigurationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAppInstanceStreamingConfigurationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAppInstanceStreamingConfigurationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAppInstanceStreamingConfigurationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAppInstanceStreamingConfigurationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAppInstanceStreamingConfigurationsResolveEndpointMiddleware{
