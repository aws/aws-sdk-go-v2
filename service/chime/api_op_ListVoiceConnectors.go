...
func (*ListVoiceConnectorsInput) operationName() string {
...
func (c *Client) addOperationListVoiceConnectorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListVoiceConnectorsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListVoiceConnectorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListVoiceConnectorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListVoiceConnectorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListVoiceConnectorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListVoiceConnectorsResolveEndpointMiddleware{
