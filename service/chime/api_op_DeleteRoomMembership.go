...
func (*DeleteRoomMembershipInput) operationName() string {
...
func (c *Client) addOperationDeleteRoomMembershipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteRoomMembershipResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteRoomMembershipResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteRoomMembershipResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteRoomMembershipResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteRoomMembershipResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteRoomMembershipResolveEndpointMiddleware{
