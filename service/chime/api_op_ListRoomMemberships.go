...
func (c *Client) ListRoomMemberships(ctx context.Context, params *ListRoomMembershipsInput, optFns ...func(*Options)) (*ListRoomMembershipsOutput, error) {
	if params == nil { params = &ListRoomMembershipsInput{} }
...
func (c *Client) addOperationListRoomMembershipsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRoomMembershipsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRoomMembershipsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRoomMembershipsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRoomMembershipsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRoomMembershipsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRoomMembershipsResolveEndpointMiddleware{
