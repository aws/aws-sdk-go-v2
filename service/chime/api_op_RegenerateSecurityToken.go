...
func (c *Client) RegenerateSecurityToken(ctx context.Context, params *RegenerateSecurityTokenInput, optFns ...func(*Options)) (*RegenerateSecurityTokenOutput, error) {
	if params == nil { params = &RegenerateSecurityTokenInput{} }
...
func (c *Client) addOperationRegenerateSecurityTokenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRegenerateSecurityTokenResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRegenerateSecurityTokenResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRegenerateSecurityTokenResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRegenerateSecurityTokenResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRegenerateSecurityTokenResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRegenerateSecurityTokenResolveEndpointMiddleware{
