...
func (c *Client) addOperationRegenerateSecurityTokenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegenerateSecurityToken", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
