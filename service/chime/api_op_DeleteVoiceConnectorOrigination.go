...
func addOperationDeleteVoiceConnectorOriginationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteVoiceConnectorOriginationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteVoiceConnectorOriginationStackSlots(stack); err != nil {
		return err
	}
