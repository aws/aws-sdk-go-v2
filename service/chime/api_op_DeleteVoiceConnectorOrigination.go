...
func (*DeleteVoiceConnectorOriginationInput) operationName() string {
...
func (c *Client) addOperationDeleteVoiceConnectorOriginationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteVoiceConnectorOriginationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteVoiceConnectorOriginationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteVoiceConnectorOriginationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteVoiceConnectorOriginationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteVoiceConnectorOriginationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteVoiceConnectorOriginationResolveEndpointMiddleware{
