...
func addOperationDeleteVoiceConnectorTerminationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteVoiceConnectorTerminationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteVoiceConnectorTerminationStackSlots(stack); err != nil {
		return err
	}
