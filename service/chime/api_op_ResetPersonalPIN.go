...
func (c *Client) ResetPersonalPIN(ctx context.Context, params *ResetPersonalPINInput, optFns ...func(*Options)) (*ResetPersonalPINOutput, error) {
	if params == nil { params = &ResetPersonalPINInput{} }
...
func (c *Client) addOperationResetPersonalPINMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResetPersonalPINResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opResetPersonalPINResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opResetPersonalPINResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResetPersonalPINResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResetPersonalPINResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opResetPersonalPINResolveEndpointMiddleware{
