...
func (c *Client) InviteUsers(ctx context.Context, params *InviteUsersInput, optFns ...func(*Options)) (*InviteUsersOutput, error) {
	if params == nil { params = &InviteUsersInput{} }
...
func (c *Client) addOperationInviteUsersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addInviteUsersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opInviteUsersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opInviteUsersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opInviteUsersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addInviteUsersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opInviteUsersResolveEndpointMiddleware{
