...
func (c *Client) PutVoiceConnectorTermination(ctx context.Context, params *PutVoiceConnectorTerminationInput, optFns ...func(*Options)) (*PutVoiceConnectorTerminationOutput, error) {
	if params == nil { params = &PutVoiceConnectorTerminationInput{} }
...
func (c *Client) addOperationPutVoiceConnectorTerminationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutVoiceConnectorTerminationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutVoiceConnectorTerminationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutVoiceConnectorTerminationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutVoiceConnectorTerminationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutVoiceConnectorTerminationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutVoiceConnectorTerminationResolveEndpointMiddleware{
