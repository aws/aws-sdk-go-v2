...
func (c *Client) DeleteRoom(ctx context.Context, params *DeleteRoomInput, optFns ...func(*Options)) (*DeleteRoomOutput, error) {
	...
	addawsRestjson1_serdeOpDeleteRoomMiddlewares(stack)
...
func addawsRestjson1_serdeOpDeleteRoomMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpDeleteRoom{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpDeleteRoom{}, middleware.After)
}
