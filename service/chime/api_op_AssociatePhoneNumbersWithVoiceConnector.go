...
func addOperationAssociatePhoneNumbersWithVoiceConnectorStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociatePhoneNumbersWithVoiceConnectorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociatePhoneNumbersWithVoiceConnectorStackSlots(stack); err != nil {
		return err
	}
