...
func (*RedactRoomMessageInput) operationName() string {
...
func (c *Client) addOperationRedactRoomMessageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRedactRoomMessageResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRedactRoomMessageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRedactRoomMessageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRedactRoomMessageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRedactRoomMessageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRedactRoomMessageResolveEndpointMiddleware{
