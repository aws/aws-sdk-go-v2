...
func (c *Client) LogoutUser(ctx context.Context, params *LogoutUserInput, optFns ...func(*Options)) (*LogoutUserOutput, error) {
	if params == nil { params = &LogoutUserInput{} }
...
func (c *Client) addOperationLogoutUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addLogoutUserResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opLogoutUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opLogoutUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opLogoutUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addLogoutUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opLogoutUserResolveEndpointMiddleware{
