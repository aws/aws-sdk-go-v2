...
// the latest version, [DeleteChannel], in the Amazon Chime SDK.
//
...
func (m *endpointPrefix_opDeleteChannelMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opDeleteChannelMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opDeleteChannelMiddleware{}, "ResolveEndpointV2", middleware.After)
}
