...
func (*AssociatePhoneNumberWithUserInput) operationName() string {
...
func (c *Client) addOperationAssociatePhoneNumberWithUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociatePhoneNumberWithUserResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAssociatePhoneNumberWithUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAssociatePhoneNumberWithUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociatePhoneNumberWithUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociatePhoneNumberWithUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAssociatePhoneNumberWithUserResolveEndpointMiddleware{
