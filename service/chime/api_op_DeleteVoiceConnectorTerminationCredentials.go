...
func (*DeleteVoiceConnectorTerminationCredentialsInput) operationName() string {
...
func (c *Client) addOperationDeleteVoiceConnectorTerminationCredentialsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteVoiceConnectorTerminationCredentialsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteVoiceConnectorTerminationCredentialsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteVoiceConnectorTerminationCredentialsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteVoiceConnectorTerminationCredentialsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteVoiceConnectorTerminationCredentialsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteVoiceConnectorTerminationCredentialsResolveEndpointMiddleware{
