...
func (*ListChannelModeratorsInput) operationName() string {
...
func (c *Client) addOperationListChannelModeratorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListChannelModeratorsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListChannelModeratorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListChannelModeratorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListChannelModeratorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListChannelModeratorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListChannelModeratorsResolveEndpointMiddleware{
