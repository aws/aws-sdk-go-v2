...
func addOperationPutVoiceConnectorStreamingConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationPutVoiceConnectorStreamingConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutVoiceConnectorStreamingConfigurationStackSlots(stack); err != nil {
		return err
	}
