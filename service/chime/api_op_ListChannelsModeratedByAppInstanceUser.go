...
func (c *Client) ListChannelsModeratedByAppInstanceUser(ctx context.Context, params *ListChannelsModeratedByAppInstanceUserInput, optFns ...func(*Options)) (*ListChannelsModeratedByAppInstanceUserOutput, error) {
	if params == nil { params = &ListChannelsModeratedByAppInstanceUserInput{} }
...
func (c *Client) addOperationListChannelsModeratedByAppInstanceUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListChannelsModeratedByAppInstanceUserResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListChannelsModeratedByAppInstanceUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListChannelsModeratedByAppInstanceUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListChannelsModeratedByAppInstanceUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListChannelsModeratedByAppInstanceUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListChannelsModeratedByAppInstanceUserResolveEndpointMiddleware{
