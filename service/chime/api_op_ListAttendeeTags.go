...
func (c *Client) ListAttendeeTags(ctx context.Context, params *ListAttendeeTagsInput, optFns ...func(*Options)) (*ListAttendeeTagsOutput, error) {
	if params == nil { params = &ListAttendeeTagsInput{} }
...
func (c *Client) addOperationListAttendeeTagsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAttendeeTagsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAttendeeTagsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAttendeeTagsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAttendeeTagsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAttendeeTagsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAttendeeTagsResolveEndpointMiddleware{
