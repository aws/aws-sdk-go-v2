...
func (c *Client) GetMeeting(ctx context.Context, params *GetMeetingInput, optFns ...func(*Options)) (*GetMeetingOutput, error) {
	if params == nil { params = &GetMeetingInput{} }
...
func (c *Client) addOperationGetMeetingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMeetingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetMeetingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetMeetingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMeetingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMeetingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetMeetingResolveEndpointMiddleware{
