...
func (*UntagMeetingInput) operationName() string {
	return "UntagMeeting"
}
...
func (c *Client) addOperationUntagMeetingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUntagMeetingResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUntagMeetingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUntagMeetingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUntagMeetingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUntagMeetingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUntagMeetingResolveEndpointMiddleware{
