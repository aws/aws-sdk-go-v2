...
func (c *Client) GetPhoneNumberOrder(ctx context.Context, params *GetPhoneNumberOrderInput, optFns ...func(*Options)) (*GetPhoneNumberOrderOutput, error) {
	if params == nil { params = &GetPhoneNumberOrderInput{} }
...
func (c *Client) addOperationGetPhoneNumberOrderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPhoneNumberOrderResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPhoneNumberOrderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPhoneNumberOrderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPhoneNumberOrderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPhoneNumberOrderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPhoneNumberOrderResolveEndpointMiddleware{
