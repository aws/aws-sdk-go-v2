...
func (c *Client) RedactConversationMessage(ctx context.Context, params *RedactConversationMessageInput, optFns ...func(*Options)) (*RedactConversationMessageOutput, error) {
	if params == nil { params = &RedactConversationMessageInput{} }
...
func (c *Client) addOperationRedactConversationMessageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRedactConversationMessageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRedactConversationMessageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRedactConversationMessageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRedactConversationMessageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRedactConversationMessageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRedactConversationMessageResolveEndpointMiddleware{
