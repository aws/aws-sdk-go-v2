...
func addOperationCreateMeetingWithAttendeesStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateMeetingWithAttendeesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateMeetingWithAttendeesStackSlots(stack); err != nil {
		return err
	}
