...
func (c *Client) addOperationListRoomsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRoomsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListRoomsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListRoomsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRoomsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRoomsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListRoomsResolveEndpointMiddleware{
