...
func addOperationPutVoiceConnectorOriginationStackSlots(stack *middleware.Stack) error {
...
func addOperationPutVoiceConnectorOriginationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutVoiceConnectorOriginationStackSlots(stack); err != nil {
		return err
	}
