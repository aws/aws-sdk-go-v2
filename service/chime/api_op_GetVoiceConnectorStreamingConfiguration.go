...
func addOperationGetVoiceConnectorStreamingConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetVoiceConnectorStreamingConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetVoiceConnectorStreamingConfigurationStackSlots(stack); err != nil {
		return err
	}
