...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/chime/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_CHIME")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Chime", cfg.ConfigSources)
	if found && err == nil {
...
var bddNodes = [42]int32{
	-1, 1, -1, 0, 13, 3, 1, 4, 100000012, 2, 5, 100000012, 3, 9, 6, 5, 8, 7, 7, 100000004, 100000011, 6, 100000009, 100000010, 4, 11, 10, 5, 100000006, 100000008, 5, 12, 100000007, 6, 100000005, 100000006, 3, 100000001, 14, 5, 100000002, 100000003}
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 4:
		uriString := "https://chime.us-east-1.amazonaws.com"
		uri, err := url.Parse(uriString)
		if err != nil {
			return smithyendpoints.Endpoint{}, fmt.Errorf("Failed to parse uri: %s", uriString)
		}
				...
				smithyauth.SetAuthOptions(&out, []*smithyauth.Option{
					{
						...
						SignerProperties: func() smithy.Properties {
							...
							smithyhttp.SetSigV4SigningName(&sp, "chime")
							smithyhttp.SetSigV4ASigningName(&sp, "chime")
	...
	case 5:
		uriString := func() string {
			...
			out.WriteString("https://chime-fips.")
