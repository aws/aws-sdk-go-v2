...
func (c *Client) addOperationUpdatePhoneNumberSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdatePhoneNumberSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
