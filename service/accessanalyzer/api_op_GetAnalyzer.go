...
func (c *Client) GetAnalyzer(ctx context.Context, params *GetAnalyzerInput, optFns ...func(*Options)) (*GetAnalyzerOutput, error) {
	if params == nil { params = &GetAnalyzerInput{} }
...
func (c *Client) addOperationGetAnalyzerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAnalyzerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAnalyzerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAnalyzerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAnalyzerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAnalyzerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAnalyzerResolveEndpointMiddleware{
