...
func (c *Client) ListArchiveRules(ctx context.Context, params *ListArchiveRulesInput, optFns ...func(*Options)) (*ListArchiveRulesOutput, error) {
	if params == nil { params = &ListArchiveRulesInput{} }
...
func (c *Client) addOperationListArchiveRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListArchiveRulesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListArchiveRulesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListArchiveRulesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListArchiveRulesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListArchiveRulesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListArchiveRulesResolveEndpointMiddleware{
