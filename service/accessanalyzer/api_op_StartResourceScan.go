...
func (c *Client) StartResourceScan(ctx context.Context, params *StartResourceScanInput, optFns ...func(*Options)) (*StartResourceScanOutput, error) {
	if params == nil { params = &StartResourceScanInput{} }
...
func (c *Client) addOperationStartResourceScanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartResourceScanResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartResourceScanResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartResourceScanResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartResourceScanResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartResourceScanResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartResourceScanResolveEndpointMiddleware{
