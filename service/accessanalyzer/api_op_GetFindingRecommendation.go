...
func (c *Client) addOperationGetFindingRecommendationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetFindingRecommendation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
