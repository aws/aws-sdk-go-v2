...
func (c *Client) GetFinding(ctx context.Context, params *GetFindingInput, optFns ...func(*Options)) (*GetFindingOutput, error) {
	if params == nil { params = &GetFindingInput{} }
...
func (c *Client) addOperationGetFindingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFindingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetFindingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetFindingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFindingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFindingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetFindingResolveEndpointMiddleware{
