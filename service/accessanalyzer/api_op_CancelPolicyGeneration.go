...
func (c *Client) CancelPolicyGeneration(ctx context.Context, params *CancelPolicyGenerationInput, optFns ...func(*Options)) (*CancelPolicyGenerationOutput, error) {
	if params == nil { params = &CancelPolicyGenerationInput{} }
...
func (c *Client) addOperationCancelPolicyGenerationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelPolicyGenerationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelPolicyGenerationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelPolicyGenerationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelPolicyGenerationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelPolicyGenerationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelPolicyGenerationResolveEndpointMiddleware{
