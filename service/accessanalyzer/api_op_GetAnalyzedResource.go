...
func (*GetAnalyzedResourceInput) operationName() string {
	return "GetAnalyzedResource"
}
...
func (c *Client) addOperationGetAnalyzedResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAnalyzedResourceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetAnalyzedResourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetAnalyzedResourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAnalyzedResourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAnalyzedResourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetAnalyzedResourceResolveEndpointMiddleware{
