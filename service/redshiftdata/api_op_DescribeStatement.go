...
func addOperationDescribeStatementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpDescribeStatementValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opDescribeStatement(options.Region), middleware.Before)
