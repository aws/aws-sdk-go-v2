...
//
// * Secrets Manager -
// when connecting to a cluster, provide the secret-arn of a secret stored in
// Secrets Manager which has username and password. The specified secret contains
