...
func addOperationCreateParticipantConnectionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateParticipantConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateParticipantConnectionStackSlots(stack); err != nil {
		return err
	}
