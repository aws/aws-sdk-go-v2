...
// Amazon Connect Participant. See this package's package overview docs
...
const (
	ServiceName = "Amazon Connect Participant" // Service's name
	ServiceID   = "ConnectParticipant"         // Service's identifier
	EndpointsID = "participant.connect"        // Service's Endpoint identifier
)
...
//     svc := connectparticipant.New(myConfig)
