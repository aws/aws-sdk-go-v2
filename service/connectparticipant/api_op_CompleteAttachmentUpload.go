...
func (c *Client) addOperationCompleteAttachmentUploadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CompleteAttachmentUpload", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
