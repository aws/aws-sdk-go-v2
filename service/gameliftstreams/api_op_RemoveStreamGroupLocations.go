...
func (c *Client) addOperationRemoveStreamGroupLocationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RemoveStreamGroupLocations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
