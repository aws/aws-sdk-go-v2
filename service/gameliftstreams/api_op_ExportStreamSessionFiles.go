...
func (c *Client) addOperationExportStreamSessionFilesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ExportStreamSessionFiles", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
