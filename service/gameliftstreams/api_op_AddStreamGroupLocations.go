...
func (c *Client) addOperationAddStreamGroupLocationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AddStreamGroupLocations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
