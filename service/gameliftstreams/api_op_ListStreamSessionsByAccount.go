...
func (c *Client) addOperationListStreamSessionsByAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListStreamSessionsByAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
