...
func (c *Client) RemoveDraftAppVersionResourceMappings(ctx context.Context, params *RemoveDraftAppVersionResourceMappingsInput, optFns ...func(*Options)) (*RemoveDraftAppVersionResourceMappingsOutput, error) {
	if params == nil { params = &RemoveDraftAppVersionResourceMappingsInput{} }
...
func (c *Client) addOperationRemoveDraftAppVersionResourceMappingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRemoveDraftAppVersionResourceMappingsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRemoveDraftAppVersionResourceMappingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRemoveDraftAppVersionResourceMappingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRemoveDraftAppVersionResourceMappingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRemoveDraftAppVersionResourceMappingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRemoveDraftAppVersionResourceMappingsResolveEndpointMiddleware{
