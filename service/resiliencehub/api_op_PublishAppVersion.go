...
func (c *Client) PublishAppVersion(ctx context.Context, params *PublishAppVersionInput, optFns ...func(*Options)) (*PublishAppVersionOutput, error) {
	if params == nil { params = &PublishAppVersionInput{} }
...
func (c *Client) addOperationPublishAppVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPublishAppVersionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPublishAppVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPublishAppVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPublishAppVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPublishAppVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPublishAppVersionResolveEndpointMiddleware{
