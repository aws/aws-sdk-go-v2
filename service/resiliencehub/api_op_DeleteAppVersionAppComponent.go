...
func (c *Client) addOperationDeleteAppVersionAppComponentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteAppVersionAppComponent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
