...
func (c *Client) addOperationListSuggestedResiliencyPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSuggestedResiliencyPolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
