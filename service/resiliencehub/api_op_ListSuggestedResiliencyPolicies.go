...
func (*ListSuggestedResiliencyPoliciesInput) operationName() string {
...
func (c *Client) addOperationListSuggestedResiliencyPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSuggestedResiliencyPoliciesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListSuggestedResiliencyPoliciesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListSuggestedResiliencyPoliciesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSuggestedResiliencyPoliciesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSuggestedResiliencyPoliciesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListSuggestedResiliencyPoliciesResolveEndpointMiddleware{
