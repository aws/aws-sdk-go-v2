...
func (c *Client) addOperationUpdateAppVersionAppComponentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAppVersionAppComponent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
