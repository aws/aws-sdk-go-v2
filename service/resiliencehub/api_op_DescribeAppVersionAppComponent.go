...
func (c *Client) addOperationDescribeAppVersionAppComponentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAppVersionAppComponent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
