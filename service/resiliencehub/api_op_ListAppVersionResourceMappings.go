...
func (c *Client) addOperationListAppVersionResourceMappingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAppVersionResourceMappings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
