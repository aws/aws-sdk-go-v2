...
func (c *Client) ListAppVersionResourceMappings(ctx context.Context, params *ListAppVersionResourceMappingsInput, optFns ...func(*Options)) (*ListAppVersionResourceMappingsOutput, error) {
	if params == nil { params = &ListAppVersionResourceMappingsInput{} }
...
func (c *Client) addOperationListAppVersionResourceMappingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAppVersionResourceMappingsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAppVersionResourceMappingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAppVersionResourceMappingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAppVersionResourceMappingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAppVersionResourceMappingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAppVersionResourceMappingsResolveEndpointMiddleware{
