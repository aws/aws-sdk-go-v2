...
func (c *Client) ListAppComponentRecommendations(ctx context.Context, params *ListAppComponentRecommendationsInput, optFns ...func(*Options)) (*ListAppComponentRecommendationsOutput, error) {
	if params == nil { params = &ListAppComponentRecommendationsInput{} }
...
func (c *Client) addOperationListAppComponentRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAppComponentRecommendationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAppComponentRecommendationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAppComponentRecommendationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAppComponentRecommendationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAppComponentRecommendationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAppComponentRecommendationsResolveEndpointMiddleware{
