...
func (c *Client) addOperationListAppVersionResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAppVersionResources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
