...
func (*ResolveAppVersionResourcesInput) operationName() string {
...
func (c *Client) addOperationResolveAppVersionResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResolveAppVersionResourcesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opResolveAppVersionResourcesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opResolveAppVersionResourcesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResolveAppVersionResourcesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResolveAppVersionResourcesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opResolveAppVersionResourcesResolveEndpointMiddleware{
