...
func (c *Client) addOperationListTestRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTestRecommendations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
