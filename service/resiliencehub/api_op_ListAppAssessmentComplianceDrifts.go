...
func (c *Client) addOperationListAppAssessmentComplianceDriftsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAppAssessmentComplianceDrifts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
