...
func (c *Client) addOperationDescribeAppVersionResourcesResolutionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAppVersionResourcesResolutionStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
