...
func (c *Client) addOperationBatchUpdateRecommendationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchUpdateRecommendationStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
