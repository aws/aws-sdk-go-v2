...
func (c *Client) addOperationDeleteAppVersionResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteAppVersionResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
