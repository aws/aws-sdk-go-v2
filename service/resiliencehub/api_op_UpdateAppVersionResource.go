...
func (c *Client) addOperationUpdateAppVersionResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAppVersionResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
