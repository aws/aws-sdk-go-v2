...
func (c *Client) addOperationCreateAppVersionAppComponentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateAppVersionAppComponent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
