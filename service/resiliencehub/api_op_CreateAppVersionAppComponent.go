...
// Creates a new Application Component in the AWS Resilience Hub application. This
// API updates the AWS Resilience Hub application draft version. To use this
