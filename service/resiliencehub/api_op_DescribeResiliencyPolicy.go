...
func (c *Client) addOperationDescribeResiliencyPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeResiliencyPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
