...
func (c *Client) addOperationListUnsupportedAppVersionResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListUnsupportedAppVersionResources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
