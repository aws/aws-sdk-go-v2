...
func (c *Client) addOperationImportResourcesToDraftAppVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ImportResourcesToDraftAppVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
