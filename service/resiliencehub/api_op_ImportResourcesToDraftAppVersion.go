...
func (c *Client) ImportResourcesToDraftAppVersion(ctx context.Context, params *ImportResourcesToDraftAppVersionInput, optFns ...func(*Options)) (*ImportResourcesToDraftAppVersionOutput, error) {
	if params == nil { params = &ImportResourcesToDraftAppVersionInput{} }
...
func (c *Client) addOperationImportResourcesToDraftAppVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addImportResourcesToDraftAppVersionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opImportResourcesToDraftAppVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opImportResourcesToDraftAppVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opImportResourcesToDraftAppVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addImportResourcesToDraftAppVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opImportResourcesToDraftAppVersionResolveEndpointMiddleware{
