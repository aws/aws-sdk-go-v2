...
func (c *Client) addOperationDescribeResourceGroupingRecommendationTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeResourceGroupingRecommendationTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
