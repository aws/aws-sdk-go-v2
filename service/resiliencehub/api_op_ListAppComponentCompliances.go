...
func (c *Client) addOperationListAppComponentCompliancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAppComponentCompliances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
