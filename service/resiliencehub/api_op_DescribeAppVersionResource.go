...
func (c *Client) addOperationDescribeAppVersionResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAppVersionResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
