...
func (c *Client) addOperationListAlarmRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAlarmRecommendations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
