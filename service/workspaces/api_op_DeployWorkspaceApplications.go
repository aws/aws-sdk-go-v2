...
func (c *Client) addOperationDeployWorkspaceApplicationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeployWorkspaceApplicationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeployWorkspaceApplicationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeployWorkspaceApplicationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeployWorkspaceApplicationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeployWorkspaceApplicationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeployWorkspaceApplicationsResolveEndpointMiddleware{
