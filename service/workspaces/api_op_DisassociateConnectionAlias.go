...
func (c *Client) addOperationDisassociateConnectionAliasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateConnectionAlias", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
