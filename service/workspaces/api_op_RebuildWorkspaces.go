...
// data. For more information, see Rebuild a WorkSpace (https://docs.aws.amazon.com/workspaces/latest/adminguide/reset-workspace.html)
...
func (c *Client) RebuildWorkspaces(ctx context.Context, params *RebuildWorkspacesInput, optFns ...func(*Options)) (*RebuildWorkspacesOutput, error) {
	if params == nil { params = &RebuildWorkspacesInput{} }
...
func (c *Client) addOperationRebuildWorkspacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRebuildWorkspacesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRebuildWorkspacesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRebuildWorkspacesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRebuildWorkspacesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRebuildWorkspacesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRebuildWorkspacesResolveEndpointMiddleware{
