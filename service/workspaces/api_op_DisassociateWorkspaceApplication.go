...
func (c *Client) addOperationDisassociateWorkspaceApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateWorkspaceApplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
