...
func (c *Client) addOperationDeregisterWorkspaceDirectoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterWorkspaceDirectory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
