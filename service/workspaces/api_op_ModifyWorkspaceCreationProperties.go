...
func (c *Client) ModifyWorkspaceCreationProperties(ctx context.Context, params *ModifyWorkspaceCreationPropertiesInput, optFns ...func(*Options)) (*ModifyWorkspaceCreationPropertiesOutput, error) {
	if params == nil { params = &ModifyWorkspaceCreationPropertiesInput{} }
...
func (c *Client) addOperationModifyWorkspaceCreationPropertiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addModifyWorkspaceCreationPropertiesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opModifyWorkspaceCreationPropertiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opModifyWorkspaceCreationPropertiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opModifyWorkspaceCreationPropertiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addModifyWorkspaceCreationPropertiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opModifyWorkspaceCreationPropertiesResolveEndpointMiddleware{
