...
func addOperationModifyWorkspaceCreationPropertiesStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyWorkspaceCreationPropertiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyWorkspaceCreationPropertiesStackSlots(stack); err != nil {
		return err
	}
