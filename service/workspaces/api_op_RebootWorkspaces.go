...
func (c *Client) RebootWorkspaces(ctx context.Context, params *RebootWorkspacesInput, optFns ...func(*Options)) (*RebootWorkspacesOutput, error) {
	if params == nil { params = &RebootWorkspacesInput{} }
...
func (c *Client) addOperationRebootWorkspacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRebootWorkspacesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRebootWorkspacesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRebootWorkspacesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRebootWorkspacesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRebootWorkspacesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRebootWorkspacesResolveEndpointMiddleware{
