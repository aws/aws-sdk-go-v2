...
func (c *Client) addOperationAcceptAccountLinkInvitationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AcceptAccountLinkInvitation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
