...
func (c *Client) addOperationRegisterWorkspaceDirectoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterWorkspaceDirectory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
