...
func addOperationRegisterWorkspaceDirectoryStackSlots(stack *middleware.Stack) error {
...
func addOperationRegisterWorkspaceDirectoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRegisterWorkspaceDirectoryStackSlots(stack); err != nil {
		return err
	}
