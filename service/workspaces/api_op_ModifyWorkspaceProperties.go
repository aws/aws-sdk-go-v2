...
func (*ModifyWorkspacePropertiesInput) operationName() string {
...
func (c *Client) addOperationModifyWorkspacePropertiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addModifyWorkspacePropertiesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opModifyWorkspacePropertiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opModifyWorkspacePropertiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opModifyWorkspacePropertiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addModifyWorkspacePropertiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opModifyWorkspacePropertiesResolveEndpointMiddleware{
