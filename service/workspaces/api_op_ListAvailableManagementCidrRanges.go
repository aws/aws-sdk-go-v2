...
func (c *Client) addOperationListAvailableManagementCidrRangesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAvailableManagementCidrRanges", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
