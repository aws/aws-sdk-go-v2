...
func addOperationListAvailableManagementCidrRangesStackSlots(stack *middleware.Stack) error {
...
func addOperationListAvailableManagementCidrRangesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListAvailableManagementCidrRangesStackSlots(stack); err != nil {
		return err
	}
