...
func (c *Client) addOperationCreateConnectClientAddInMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateConnectClientAddIn", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
