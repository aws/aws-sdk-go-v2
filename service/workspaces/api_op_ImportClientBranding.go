...
func (c *Client) ImportClientBranding(ctx context.Context, params *ImportClientBrandingInput, optFns ...func(*Options)) (*ImportClientBrandingOutput, error) {
	if params == nil { params = &ImportClientBrandingInput{} }
...
func (c *Client) addOperationImportClientBrandingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addImportClientBrandingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opImportClientBrandingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opImportClientBrandingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opImportClientBrandingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addImportClientBrandingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opImportClientBrandingResolveEndpointMiddleware{
