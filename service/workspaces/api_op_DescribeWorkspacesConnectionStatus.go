...
func addOperationDescribeWorkspacesConnectionStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeWorkspacesConnectionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeWorkspacesConnectionStatusStackSlots(stack); err != nil {
		return err
	}
