...
func (c *Client) addOperationUpdateConnectClientAddInMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateConnectClientAddIn", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
