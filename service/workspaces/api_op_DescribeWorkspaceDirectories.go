...
func addOperationDescribeWorkspaceDirectoriesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeWorkspaceDirectoriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeWorkspaceDirectoriesStackSlots(stack); err != nil {
		return err
	}
