...
func (c *Client) addOperationDescribeWorkspacesPoolSessionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeWorkspacesPoolSessions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
