...
func (c *Client) addOperationDescribeCustomWorkspaceImageImportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCustomWorkspaceImageImport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
