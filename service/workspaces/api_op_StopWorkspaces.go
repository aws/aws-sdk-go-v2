...
func (c *Client) StopWorkspaces(ctx context.Context, params *StopWorkspacesInput, optFns ...func(*Options)) (*StopWorkspacesOutput, error) {
	if params == nil { params = &StopWorkspacesInput{} }
...
func (c *Client) addOperationStopWorkspacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopWorkspacesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopWorkspacesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopWorkspacesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopWorkspacesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopWorkspacesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopWorkspacesResolveEndpointMiddleware{
