...
func (c *Client) addOperationDescribeAccountModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAccountModifications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
