...
func addOperationDescribeAccountModificationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeAccountModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeAccountModificationsStackSlots(stack); err != nil {
		return err
	}
