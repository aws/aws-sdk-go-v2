...
func addOperationModifyWorkspaceAccessPropertiesStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyWorkspaceAccessPropertiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyWorkspaceAccessPropertiesStackSlots(stack); err != nil {
		return err
	}
