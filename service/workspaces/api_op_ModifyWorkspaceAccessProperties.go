...
func (*ModifyWorkspaceAccessPropertiesInput) operationName() string {
...
func (c *Client) addOperationModifyWorkspaceAccessPropertiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addModifyWorkspaceAccessPropertiesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opModifyWorkspaceAccessPropertiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opModifyWorkspaceAccessPropertiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opModifyWorkspaceAccessPropertiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addModifyWorkspaceAccessPropertiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opModifyWorkspaceAccessPropertiesResolveEndpointMiddleware{
