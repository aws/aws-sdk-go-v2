...
func addOperationDescribeWorkspaceImagePermissionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeWorkspaceImagePermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeWorkspaceImagePermissionsStackSlots(stack); err != nil {
		return err
	}
