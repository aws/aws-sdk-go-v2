...
func addOperationDescribeWorkspaceSnapshotsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeWorkspaceSnapshotsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeWorkspaceSnapshotsStackSlots(stack); err != nil {
		return err
	}
