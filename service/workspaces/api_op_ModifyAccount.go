...
func (*ModifyAccountInput) operationName() string {
...
func (c *Client) addOperationModifyAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addModifyAccountResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opModifyAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opModifyAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opModifyAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addModifyAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opModifyAccountResolveEndpointMiddleware{
