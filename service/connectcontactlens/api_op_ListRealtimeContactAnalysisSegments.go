...
func (c *Client) addOperationListRealtimeContactAnalysisSegmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRealtimeContactAnalysisSegments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
