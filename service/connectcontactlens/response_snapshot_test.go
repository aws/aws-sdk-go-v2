...
func TestCheckResponseSnapshot_ListRealtimeContactAnalysisSegments(t *testing.T) {
	...
	status, header, body, err := serdeRespReadSnapshot("ListRealtimeContactAnalysisSegments.response")
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "ListRealtimeContactAnalysisSegments.response", err)
	}
}
