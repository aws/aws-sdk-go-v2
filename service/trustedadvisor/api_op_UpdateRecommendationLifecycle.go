...
func (c *Client) addOperationUpdateRecommendationLifecycleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRecommendationLifecycle", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
