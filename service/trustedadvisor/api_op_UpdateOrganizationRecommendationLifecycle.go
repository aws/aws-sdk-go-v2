...
func (c *Client) addOperationUpdateOrganizationRecommendationLifecycleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateOrganizationRecommendationLifecycle", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
