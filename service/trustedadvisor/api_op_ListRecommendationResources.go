...
func (c *Client) addOperationListRecommendationResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRecommendationResources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
