...
func (c *Client) addOperationListOrganizationRecommendationAccountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOrganizationRecommendationAccounts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
