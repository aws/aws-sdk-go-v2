...
func (c *Client) addOperationGetQueryResultsWorkloadInsightsTopContributorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetQueryResultsWorkloadInsightsTopContributors", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
