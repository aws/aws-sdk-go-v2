...
func (c *Client) addOperationGetQueryStatusMonitorTopContributorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetQueryStatusMonitorTopContributors", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
