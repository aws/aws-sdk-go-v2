...
func (c *Client) addOperationStopQueryMonitorTopContributorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopQueryMonitorTopContributors", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
