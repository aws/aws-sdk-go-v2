...
func (c *Client) addOperationGetQueryResultsWorkloadInsightsTopContributorsDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetQueryResultsWorkloadInsightsTopContributorsData", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
