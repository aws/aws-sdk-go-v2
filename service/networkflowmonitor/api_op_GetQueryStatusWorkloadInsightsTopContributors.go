...
func (c *Client) addOperationGetQueryStatusWorkloadInsightsTopContributorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetQueryStatusWorkloadInsightsTopContributors", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
