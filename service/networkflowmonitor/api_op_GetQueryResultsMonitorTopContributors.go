...
func (c *Client) addOperationGetQueryResultsMonitorTopContributorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetQueryResultsMonitorTopContributors", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
