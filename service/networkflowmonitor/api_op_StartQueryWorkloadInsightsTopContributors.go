...
func (c *Client) addOperationStartQueryWorkloadInsightsTopContributorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartQueryWorkloadInsightsTopContributors", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
