...
func (c *Client) addOperationStopQueryWorkloadInsightsTopContributorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopQueryWorkloadInsightsTopContributors", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
