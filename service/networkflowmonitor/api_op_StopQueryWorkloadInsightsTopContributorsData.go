...
func (c *Client) addOperationStopQueryWorkloadInsightsTopContributorsDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopQueryWorkloadInsightsTopContributorsData", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
