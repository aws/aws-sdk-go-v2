...
func (c *Client) addOperationDisconnectCustomKeyStoreMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisconnectCustomKeyStore", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
