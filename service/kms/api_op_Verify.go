...
type VerifyInput struct {
	...
	// security of the verification operation can be compromised. When the value of
	...
	// while signing. However, if the signed message is hashed once while signing, but
...
type VerifyOutput struct {
	...
	// True indicates that the Signature  was produced by signing the Message with
	// the specified KeyID  and SigningAlgorithm. If the signature is not verified,
