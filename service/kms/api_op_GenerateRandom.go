...
// Returns a random byte string that is cryptographically secure. You must use
// the NumberOfBytes parameter to specify the length of the random byte string.
// There is no default value for string length. By default, the random byte string
// is generated in KMS. To generate the byte string in the CloudHSM cluster
...
// using the Amazon Web Services Nitro Enclaves Development Kit (https://github.com/aws/aws-nitro-enclaves-sdk-c)
...
type GenerateRandomInput struct {
	...
	// the DescribeCustomKeyStores operation. External key store IDs are not valid
	// for this parameter. If you specify the ID of an external key store,
