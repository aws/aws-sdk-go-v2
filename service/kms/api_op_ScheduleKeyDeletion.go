...
// PendingDeletionand the key can't be used in any cryptographic operations. It
// remains in this state for the duration of the waiting period. Before the waiting
// period ends, you can use CancelKeyDeletion to cancel the deletion of the KMS
// key. After the waiting period ends, KMS deletes the KMS key, its key material,
// and all KMS data associated with it, including all aliases that refer to it.
...
// the use of a KMS key without deleting it, use DisableKey. You can schedule the
...
type ScheduleKeyDeletionInput struct {
	...
	// ends, KMS deletes the KMS key. If the KMS key is a multi-Region primary key with
