...
// Services account. Required permissions: kms:GetKeyPolicy (https://docs.aws.amazon.com/kms/latest/developerguide/kms-api-permissions-reference.html)
...
type GetKeyPolicyInput struct {
	...
	// Gets the key policy for the specified KMS key. Specify the key ID or key ARN
