...
func addOperationGenerateDataKeyWithoutPlaintextStackSlots(stack *middleware.Stack) error {
...
func addOperationGenerateDataKeyWithoutPlaintextMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGenerateDataKeyWithoutPlaintextStackSlots(stack); err != nil {
		return err
	}
