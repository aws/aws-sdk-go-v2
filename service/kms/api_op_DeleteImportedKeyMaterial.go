...
func (c *Client) addOperationDeleteImportedKeyMaterialMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteImportedKeyMaterial", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
