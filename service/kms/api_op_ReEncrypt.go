...
// the public key of an asymmetric KMS key (https://docs.aws.amazon.com/kms/latest/developerguide/symm-asymm-concepts.html#asymmetric-cmks)
...
type ReEncryptInput struct {
	...
	// Specify a symmetric encryption KMS key or an asymmetric KMS key with a KeyUsage
	...
	// the encryption algorithm used for symmetric encryption KMS keys. This parameter
	...
	// ciphertext. If you identify a different KMS key, the ReEncrypt operation
	// throws an IncorrectKeyException. This parameter is required only when the
	// ciphertext was encrypted under an asymmetric KMS key. If you used a symmetric
	// encryption KMS key, KMS can get the KMS key from metadata that it adds to the
