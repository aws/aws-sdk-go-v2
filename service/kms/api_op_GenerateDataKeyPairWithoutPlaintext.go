...
func addOperationGenerateDataKeyPairWithoutPlaintextStackSlots(stack *middleware.Stack) error {
...
func addOperationGenerateDataKeyPairWithoutPlaintextMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGenerateDataKeyPairWithoutPlaintextStackSlots(stack); err != nil {
		return err
	}
