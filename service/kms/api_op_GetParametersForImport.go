...
// token expire, send another GetParametersForImport request. The KMS key that
...
type GetParametersForImportInput struct {
	...
	// key material. The Origin  of the KMS key must be EXTERNAL. Specify the key ID
	...
	// ImportKeyMaterial operation to import it. For more information, see Encrypt
	// the key material (https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys-encrypt-key-material.html)
