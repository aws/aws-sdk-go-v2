...
type CreateGrantInput struct {
	...
	// asymmetric KMS key that allows the GenerateDataKey operation. If you try, KMS
	// returns a ValidationError  exception. For details, see Grant operations (https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#terms-grant-operations)
	...
	// EncryptionContextSubsetgrant constraints. Each constraint value can include up
