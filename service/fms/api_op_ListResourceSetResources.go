...
func (c *Client) addOperationListResourceSetResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListResourceSetResources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
