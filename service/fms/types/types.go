...
type NetworkAclEntrySet struct {
	...
	// creates. You must specify at least one first entry or one last entry in any
	// network ACL policy.
...
type StatefulEngineOptions struct {
	...
	// in the Network Firewall Developer Guide. Default: DEFAULT_ACTION_ORDER
	RuleOrder RuleOrder
	...
	// For more information, see Stream exception policy in your firewall policy (https://docs.aws.amazon.com/network-firewall/latest/developerguide/stream-exception-policy.html)
	// in the Network Firewall Developer Guide. Default: FMS_IGNORE
