...
func (c *Client) GetThirdPartyFirewallAssociationStatus(ctx context.Context, params *GetThirdPartyFirewallAssociationStatusInput, optFns ...func(*Options)) (*GetThirdPartyFirewallAssociationStatusOutput, error) {
	if params == nil { params = &GetThirdPartyFirewallAssociationStatusInput{} }
...
func (c *Client) addOperationGetThirdPartyFirewallAssociationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetThirdPartyFirewallAssociationStatusResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetThirdPartyFirewallAssociationStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetThirdPartyFirewallAssociationStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetThirdPartyFirewallAssociationStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetThirdPartyFirewallAssociationStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetThirdPartyFirewallAssociationStatusResolveEndpointMiddleware{
