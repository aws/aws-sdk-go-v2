...
func (c *Client) addOperationGetThirdPartyFirewallAssociationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetThirdPartyFirewallAssociationStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
