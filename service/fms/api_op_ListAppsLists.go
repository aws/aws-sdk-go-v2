...
func (c *Client) ListAppsLists(ctx context.Context, params *ListAppsListsInput, optFns ...func(*Options)) (*ListAppsListsOutput, error) {
	if params == nil { params = &ListAppsListsInput{} }
...
func (c *Client) addOperationListAppsListsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAppsListsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAppsListsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAppsListsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAppsListsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAppsListsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAppsListsResolveEndpointMiddleware{
