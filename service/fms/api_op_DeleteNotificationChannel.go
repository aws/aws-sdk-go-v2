...
func (c *Client) addOperationDeleteNotificationChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteNotificationChannel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
