...
func (c *Client) addOperationListThirdPartyFirewallFirewallPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListThirdPartyFirewallFirewallPolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
