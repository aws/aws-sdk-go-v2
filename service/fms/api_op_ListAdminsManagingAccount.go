...
func (c *Client) addOperationListAdminsManagingAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAdminsManagingAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
