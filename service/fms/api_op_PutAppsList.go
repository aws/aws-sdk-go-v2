...
func (c *Client) PutAppsList(ctx context.Context, params *PutAppsListInput, optFns ...func(*Options)) (*PutAppsListOutput, error) {
	if params == nil { params = &PutAppsListInput{} }
...
func (c *Client) addOperationPutAppsListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutAppsListResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutAppsListResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutAppsListResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutAppsListResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutAppsListResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutAppsListResolveEndpointMiddleware{
