...
func (c *Client) GetProtocolsList(ctx context.Context, params *GetProtocolsListInput, optFns ...func(*Options)) (*GetProtocolsListOutput, error) {
	if params == nil { params = &GetProtocolsListInput{} }
...
func (c *Client) addOperationGetProtocolsListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetProtocolsListResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetProtocolsListResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetProtocolsListResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetProtocolsListResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetProtocolsListResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetProtocolsListResolveEndpointMiddleware{
