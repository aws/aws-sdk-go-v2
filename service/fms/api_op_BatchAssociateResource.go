...
func (c *Client) BatchAssociateResource(ctx context.Context, params *BatchAssociateResourceInput, optFns ...func(*Options)) (*BatchAssociateResourceOutput, error) {
	if params == nil { params = &BatchAssociateResourceInput{} }
...
func (c *Client) addOperationBatchAssociateResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchAssociateResourceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchAssociateResourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchAssociateResourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchAssociateResourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchAssociateResourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchAssociateResourceResolveEndpointMiddleware{
