...
func (c *Client) GetAdminAccount(ctx context.Context, params *GetAdminAccountInput, optFns ...func(*Options)) (*GetAdminAccountOutput, error) {
	if params == nil { params = &GetAdminAccountInput{} }
...
func (c *Client) addOperationGetAdminAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAdminAccountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAdminAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAdminAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAdminAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAdminAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAdminAccountResolveEndpointMiddleware{
