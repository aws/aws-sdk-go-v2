...
func (c *Client) BatchDisassociateResource(ctx context.Context, params *BatchDisassociateResourceInput, optFns ...func(*Options)) (*BatchDisassociateResourceOutput, error) {
	if params == nil { params = &BatchDisassociateResourceInput{} }
...
func (c *Client) addOperationBatchDisassociateResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchDisassociateResourceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchDisassociateResourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchDisassociateResourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchDisassociateResourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchDisassociateResourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchDisassociateResourceResolveEndpointMiddleware{
