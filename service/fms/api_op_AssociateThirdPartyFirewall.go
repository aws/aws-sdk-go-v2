...
func (c *Client) addOperationAssociateThirdPartyFirewallMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateThirdPartyFirewall", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
