...
func (c *Client) addOperationDescribeCrossAccountAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCrossAccountAttachment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
