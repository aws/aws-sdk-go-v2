...
func (c *Client) addOperationDeleteCrossAccountAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteCrossAccountAttachment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
