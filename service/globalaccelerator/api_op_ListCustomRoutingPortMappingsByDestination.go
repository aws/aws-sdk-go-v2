...
func (c *Client) ListCustomRoutingPortMappingsByDestination(ctx context.Context, params *ListCustomRoutingPortMappingsByDestinationInput, optFns ...func(*Options)) (*ListCustomRoutingPortMappingsByDestinationOutput, error) {
	if params == nil { params = &ListCustomRoutingPortMappingsByDestinationInput{} }
...
func (c *Client) addOperationListCustomRoutingPortMappingsByDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCustomRoutingPortMappingsByDestinationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCustomRoutingPortMappingsByDestinationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCustomRoutingPortMappingsByDestinationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCustomRoutingPortMappingsByDestinationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCustomRoutingPortMappingsByDestinationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCustomRoutingPortMappingsByDestinationResolveEndpointMiddleware{
