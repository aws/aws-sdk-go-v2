...
func (c *Client) addOperationListCustomRoutingEndpointGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCustomRoutingEndpointGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
