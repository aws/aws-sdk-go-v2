...
func (c *Client) addOperationListCrossAccountResourceAccountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCrossAccountResourceAccounts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
