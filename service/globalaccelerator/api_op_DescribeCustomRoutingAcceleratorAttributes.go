...
func (*DescribeCustomRoutingAcceleratorAttributesInput) operationName() string {
...
func (c *Client) addOperationDescribeCustomRoutingAcceleratorAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeCustomRoutingAcceleratorAttributesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeCustomRoutingAcceleratorAttributesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeCustomRoutingAcceleratorAttributesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeCustomRoutingAcceleratorAttributesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeCustomRoutingAcceleratorAttributesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeCustomRoutingAcceleratorAttributesResolveEndpointMiddleware{
