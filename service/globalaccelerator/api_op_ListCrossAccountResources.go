...
func (c *Client) addOperationListCrossAccountResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCrossAccountResources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
