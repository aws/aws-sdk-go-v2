...
func (c *Client) ListByoipCidrs(ctx context.Context, params *ListByoipCidrsInput, optFns ...func(*Options)) (*ListByoipCidrsOutput, error) {
	if params == nil { params = &ListByoipCidrsInput{} }
...
func (c *Client) addOperationListByoipCidrsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListByoipCidrsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListByoipCidrsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListByoipCidrsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListByoipCidrsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListByoipCidrsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListByoipCidrsResolveEndpointMiddleware{
