...
func (c *Client) DescribeCustomRoutingAccelerator(ctx context.Context, params *DescribeCustomRoutingAcceleratorInput, optFns ...func(*Options)) (*DescribeCustomRoutingAcceleratorOutput, error) {
	if params == nil { params = &DescribeCustomRoutingAcceleratorInput{} }
...
func (c *Client) addOperationDescribeCustomRoutingAcceleratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeCustomRoutingAcceleratorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeCustomRoutingAcceleratorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeCustomRoutingAcceleratorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeCustomRoutingAcceleratorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeCustomRoutingAcceleratorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeCustomRoutingAcceleratorResolveEndpointMiddleware{
