...
func (c *Client) addOperationCreateCustomRoutingListenerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCustomRoutingListener", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
