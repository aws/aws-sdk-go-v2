...
func (c *Client) addOperationAddCustomRoutingEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AddCustomRoutingEndpoints", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
