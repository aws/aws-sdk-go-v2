...
func (c *Client) addOperationUpdateCustomRoutingAcceleratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCustomRoutingAccelerator", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
