...
func (c *Client) DescribeCustomRoutingEndpointGroup(ctx context.Context, params *DescribeCustomRoutingEndpointGroupInput, optFns ...func(*Options)) (*DescribeCustomRoutingEndpointGroupOutput, error) {
	if params == nil { params = &DescribeCustomRoutingEndpointGroupInput{} }
...
func (c *Client) addOperationDescribeCustomRoutingEndpointGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeCustomRoutingEndpointGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeCustomRoutingEndpointGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeCustomRoutingEndpointGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeCustomRoutingEndpointGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeCustomRoutingEndpointGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeCustomRoutingEndpointGroupResolveEndpointMiddleware{
