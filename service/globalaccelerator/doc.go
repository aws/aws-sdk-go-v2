...
// from your own IP address ranges that you bring toGlobal Accelerator (BYOIP). For
// a standard accelerator, they distribute incoming application traffic across
