...
func addOperationUpdateAcceleratorAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateAcceleratorAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateAcceleratorAttributesStackSlots(stack); err != nil {
		return err
	}
