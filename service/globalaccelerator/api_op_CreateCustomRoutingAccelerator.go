...
func (c *Client) addOperationCreateCustomRoutingAcceleratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCustomRoutingAccelerator", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
