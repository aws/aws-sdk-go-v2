...
func (*DescribeAcceleratorAttributesInput) operationName() string {
...
func (c *Client) addOperationDescribeAcceleratorAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeAcceleratorAttributesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeAcceleratorAttributesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeAcceleratorAttributesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeAcceleratorAttributesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeAcceleratorAttributesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeAcceleratorAttributesResolveEndpointMiddleware{
