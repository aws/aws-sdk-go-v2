...
func addOperationDescribeAcceleratorAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeAcceleratorAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeAcceleratorAttributesStackSlots(stack); err != nil {
		return err
	}
