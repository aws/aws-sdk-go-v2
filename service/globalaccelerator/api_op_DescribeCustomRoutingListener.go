...
func (c *Client) addOperationDescribeCustomRoutingListenerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCustomRoutingListener", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
