...
func (c *Client) addOperationAllowCustomRoutingTrafficMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AllowCustomRoutingTraffic", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
