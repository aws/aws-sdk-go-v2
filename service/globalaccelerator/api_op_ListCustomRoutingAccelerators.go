...
func (c *Client) ListCustomRoutingAccelerators(ctx context.Context, params *ListCustomRoutingAcceleratorsInput, optFns ...func(*Options)) (*ListCustomRoutingAcceleratorsOutput, error) {
	if params == nil { params = &ListCustomRoutingAcceleratorsInput{} }
...
func (c *Client) addOperationListCustomRoutingAcceleratorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCustomRoutingAcceleratorsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCustomRoutingAcceleratorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCustomRoutingAcceleratorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCustomRoutingAcceleratorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCustomRoutingAcceleratorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCustomRoutingAcceleratorsResolveEndpointMiddleware{
