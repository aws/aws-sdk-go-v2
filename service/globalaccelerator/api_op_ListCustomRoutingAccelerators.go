...
func (c *Client) addOperationListCustomRoutingAcceleratorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCustomRoutingAccelerators", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
