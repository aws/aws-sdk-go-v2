...
func (c *Client) addOperationRemoveCustomRoutingEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RemoveCustomRoutingEndpoints", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
