...
func (*RemoveCustomRoutingEndpointsInput) operationName() string {
...
func (c *Client) addOperationRemoveCustomRoutingEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRemoveCustomRoutingEndpointsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRemoveCustomRoutingEndpointsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRemoveCustomRoutingEndpointsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRemoveCustomRoutingEndpointsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRemoveCustomRoutingEndpointsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRemoveCustomRoutingEndpointsResolveEndpointMiddleware{
