...
func (c *Client) addOperationListCrossAccountAttachmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCrossAccountAttachmentsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListCrossAccountAttachmentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListCrossAccountAttachmentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCrossAccountAttachmentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCrossAccountAttachmentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListCrossAccountAttachmentsResolveEndpointMiddleware{
