...
func (c *Client) addOperationListCrossAccountAttachmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCrossAccountAttachments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
