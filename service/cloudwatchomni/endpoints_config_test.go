...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cloudwatchomni.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudwatchomni.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudwatchomni.dev",
			expectURL:     aws.String("https://env-cloudwatchomni.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cloudwatchomni.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudwatchomni.dev",
			expectURL:     aws.String("http://config-cloudwatchomni.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cloudwatchomni.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cloudwatchomni.dev",
			clientEndpoint: aws.String("https://client-cloudwatchomni.dev"),
			expectURL:      aws.String("https://client-cloudwatchomni.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CLOUDWATCHOMNI", c.envService)
			}
