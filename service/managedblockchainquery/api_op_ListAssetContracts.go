...
func (c *Client) addOperationListAssetContractsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAssetContractsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListAssetContractsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListAssetContractsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAssetContractsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAssetContractsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListAssetContractsResolveEndpointMiddleware{
