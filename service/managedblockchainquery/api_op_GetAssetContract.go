...
func (c *Client) addOperationGetAssetContractMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAssetContractResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetAssetContractResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetAssetContractResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAssetContractResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAssetContractResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetAssetContractResolveEndpointMiddleware{
