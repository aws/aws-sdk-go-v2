...
func (c *Client) GetTransaction(ctx context.Context, params *GetTransactionInput, optFns ...func(*Options)) (*GetTransactionOutput, error) {
	if params == nil { params = &GetTransactionInput{} }
...
func (c *Client) addOperationGetTransactionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTransactionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetTransactionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetTransactionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTransactionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTransactionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetTransactionResolveEndpointMiddleware{
