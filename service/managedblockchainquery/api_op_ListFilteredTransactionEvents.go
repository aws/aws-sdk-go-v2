...
func (c *Client) addOperationListFilteredTransactionEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFilteredTransactionEvents", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
