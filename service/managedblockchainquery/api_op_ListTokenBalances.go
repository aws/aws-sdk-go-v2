...
//   - Lists all token balances owned by an address (either a contact address or a
//   wallet address).
...
func (c *Client) ListTokenBalances(ctx context.Context, params *ListTokenBalancesInput, optFns ...func(*Options)) (*ListTokenBalancesOutput, error) {
	if params == nil { params = &ListTokenBalancesInput{} }
...
func (c *Client) addOperationListTokenBalancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTokenBalancesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTokenBalancesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTokenBalancesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTokenBalancesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTokenBalancesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTokenBalancesResolveEndpointMiddleware{
