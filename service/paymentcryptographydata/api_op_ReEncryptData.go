...
// schemes:
//
//   - DUKPT: TDES and AES algorithms. To encrypt using DUKPT, a DUKPT key must
...
//
//   - Asymmetric: RSA . You can use an RSA key on either the incoming or the
//     outgoing side, paired with a symmetric key on the other side.
//
