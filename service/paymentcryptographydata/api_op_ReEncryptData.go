...
// using public component (imported by calling [ImportKey]) of the asymmetric key pair
// created outside of Amazon Web Services Payment Cryptography.
//
...
// Services Payment Cryptography supports RSA . To encrypt using DUKPT, a DUKPT key
// must already exist within your account with KeyModesOfUse set to DeriveKey or a
// new DUKPT can be generated by calling [CreateKey].
//
