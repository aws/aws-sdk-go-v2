...
type awsRestjson1_deserializeOpGenerateAs2805KekValidation struct {
}

func (*awsRestjson1_deserializeOpGenerateAs2805KekValidation) ID() string {
	return "OperationDeserializer"
}

func (m *awsRestjson1_deserializeOpGenerateAs2805KekValidation) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsRestjson1_deserializeOpErrorGenerateAs2805KekValidation(response, &metadata)
	}
	...
	err = awsRestjson1_deserializeOpDocumentGenerateAs2805KekValidationOutput(&output, shape)
	if err != nil {
		var snapshot bytes.Buffer
		io.Copy(&snapshot, ringBuffer)
		return out, metadata, &smithy.DeserializationError{
...
func awsRestjson1_deserializeOpErrorGenerateAs2805KekValidation(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func awsRestjson1_deserializeOpDocumentGenerateAs2805KekValidationOutput(v **GenerateAs2805KekValidationOutput, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *GenerateAs2805KekValidationOutput
	if *v == nil {
		sv = &GenerateAs2805KekValidationOutput{}
	} else {
		sv = *v
	}
	...
	for key, value := range shape {
		...
		case "RandomKeyReceive":
			if value != nil {
				jtv, ok := value.(string)
				if !ok {
					return fmt.Errorf("expected As2805RandomKeyMaterial to be of type string, got %T instead", value)
				}
				sv.RandomKeyReceive = ptr.String(jtv)
			}
		...
		case "RandomKeySend":
			if value != nil {
				...
				sv.RandomKeySend = ptr.String(jtv)
			}
...
type awsRestjson1_deserializeOpGenerateAuthRequestCryptogram struct {
}

func (*awsRestjson1_deserializeOpGenerateAuthRequestCryptogram) ID() string {
	return "OperationDeserializer"
}

func (m *awsRestjson1_deserializeOpGenerateAuthRequestCryptogram) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsRestjson1_deserializeOpErrorGenerateAuthRequestCryptogram(response, &metadata)
	}
	...
	err = awsRestjson1_deserializeOpDocumentGenerateAuthRequestCryptogramOutput(&output, shape)
	if err != nil {
		var snapshot bytes.Buffer
		io.Copy(&snapshot, ringBuffer)
		return out, metadata, &smithy.DeserializationError{
...
func awsRestjson1_deserializeOpErrorGenerateAuthRequestCryptogram(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func awsRestjson1_deserializeOpDocumentGenerateAuthRequestCryptogramOutput(v **GenerateAuthRequestCryptogramOutput, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *GenerateAuthRequestCryptogramOutput
	if *v == nil {
		sv = &GenerateAuthRequestCryptogramOutput{}
	} else {
		sv = *v
	}
	...
	for key, value := range shape {
		...
		case "AuthRequestCryptogram":
			if value != nil {
				jtv, ok := value.(string)
				if !ok {
					return fmt.Errorf("expected AuthRequestCryptogramType to be of type string, got %T instead", value)
				}
				sv.AuthRequestCryptogram = ptr.String(jtv)
			}
...
type awsRestjson1_deserializeOpTranslateKeyMaterial struct {
}

func (*awsRestjson1_deserializeOpTranslateKeyMaterial) ID() string {
	return "OperationDeserializer"
}

func (m *awsRestjson1_deserializeOpTranslateKeyMaterial) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsRestjson1_deserializeOpErrorTranslateKeyMaterial(response, &metadata)
	}
	...
	err = awsRestjson1_deserializeOpDocumentTranslateKeyMaterialOutput(&output, shape)
	if err != nil {
		var snapshot bytes.Buffer
		io.Copy(&snapshot, ringBuffer)
		return out, metadata, &smithy.DeserializationError{
...
func awsRestjson1_deserializeOpErrorTranslateKeyMaterial(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func awsRestjson1_deserializeOpDocumentTranslateKeyMaterialOutput(v **TranslateKeyMaterialOutput, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *TranslateKeyMaterialOutput
	if *v == nil {
		sv = &TranslateKeyMaterialOutput{}
	} else {
		sv = *v
	}
	...
	for key, value := range shape {
		switch key {
		case "WrappedKey":
			if err := awsRestjson1_deserializeDocumentWrappedWorkingKey(&sv.WrappedKey, value); err != nil {
				return err
			}
...
func awsRestjson1_deserializeDocumentWrappedWorkingKey(v **types.WrappedWorkingKey, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *types.WrappedWorkingKey
	if *v == nil {
		sv = &types.WrappedWorkingKey{}
	} else {
		sv = *v
	}
	...
	for key, value := range shape {
		...
		case "WrappedKeyMaterial":
			if value != nil {
				...
				sv.WrappedKeyMaterial = ptr.String(jtv)
			}
