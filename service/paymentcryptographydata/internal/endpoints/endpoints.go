		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			{
				...
				Hostname:          "dataplane.payment-cryptography.{region}.api.amazonwebservices.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "dataplane.payment-cryptography-fips.{region}.amazonaws.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "dataplane.payment-cryptography-fips.{region}.api.amazonwebservices.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "dataplane.payment-cryptography.{region}.amazonaws.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
		},
