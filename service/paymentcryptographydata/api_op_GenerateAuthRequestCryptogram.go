...
func (v *GenerateAuthRequestCryptogramOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.GenerateAuthRequestCryptogramOutput)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *GenerateAuthRequestCryptogramOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AuthRequestCryptogram != nil {
		s.WriteString(schemas.GenerateAuthRequestCryptogramOutput_AuthRequestCryptogram, *v.AuthRequestCryptogram)
	}
	if v.KeyArn != nil {
		s.WriteString(schemas.GenerateAuthRequestCryptogramOutput_KeyArn, *v.KeyArn)
	}
	if v.KeyCheckValue != nil {
		s.WriteString(schemas.GenerateAuthRequestCryptogramOutput_KeyCheckValue, *v.KeyCheckValue)
	}
}
