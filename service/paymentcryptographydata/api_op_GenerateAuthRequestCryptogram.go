...
func (c *Client) addOperationGenerateAuthRequestCryptogramMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GenerateAuthRequestCryptogram", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
