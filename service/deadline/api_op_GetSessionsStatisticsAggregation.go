...
func (c *Client) addOperationGetSessionsStatisticsAggregationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSessionsStatisticsAggregation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
