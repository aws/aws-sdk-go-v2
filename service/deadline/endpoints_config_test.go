...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-deadline.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-deadline.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-deadline.dev",
			expectURL:     aws.String("https://env-deadline.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-deadline.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-deadline.dev",
			expectURL:     aws.String("http://config-deadline.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-deadline.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-deadline.dev",
			clientEndpoint: aws.String("https://client-deadline.dev"),
			expectURL:      aws.String("https://client-deadline.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DEADLINE", c.envService)
			}
