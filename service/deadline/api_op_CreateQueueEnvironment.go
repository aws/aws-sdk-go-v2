...
func (c *Client) CreateQueueEnvironment(ctx context.Context, params *CreateQueueEnvironmentInput, optFns ...func(*Options)) (*CreateQueueEnvironmentOutput, error) {
	if params == nil { params = &CreateQueueEnvironmentInput{} }
...
func (m *idempotencyToken_initializeOpCreateQueueEnvironment) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *CreateQueueEnvironmentInput ")}
