...
func (c *Client) addOperationListStorageProfilesForQueueMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListStorageProfilesForQueue", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
