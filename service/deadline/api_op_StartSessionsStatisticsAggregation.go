...
func (c *Client) addOperationStartSessionsStatisticsAggregationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartSessionsStatisticsAggregation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
