...
func (v *ListSessionsInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.FarmId != nil {
		s.WriteString(schemas.ListSessionsRequest_farmId, *v.FarmId)
	}
	if v.JobId != nil {
		s.WriteString(schemas.ListSessionsRequest_jobId, *v.JobId)
	}
	if v.MaxResults != nil {
	...
	if v.QueueId != nil {
		s.WriteString(schemas.ListSessionsRequest_queueId, *v.QueueId)
	}
}
...
func (v *ListSessionsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	...
	serializeSessionSummaries(s, schemas.ListSessionsResponse_sessions, v.Sessions)
}
func (v *ListSessionsOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListSessionsResponse, func(s *smithy.Schema) error {
		...
		case schemas.ListSessionsResponse_sessions:
			return deserializeSessionSummaries(d, schemas.ListSessionsResponse_sessions, &v.Sessions)
		}
		return nil
	})
}
