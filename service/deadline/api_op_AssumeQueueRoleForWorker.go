...
func (c *Client) addOperationAssumeQueueRoleForWorkerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssumeQueueRoleForWorker", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
