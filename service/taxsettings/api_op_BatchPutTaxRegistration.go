...
func (c *Client) addOperationBatchPutTaxRegistrationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchPutTaxRegistration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
