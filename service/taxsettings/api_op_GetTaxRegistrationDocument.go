...
func (c *Client) addOperationGetTaxRegistrationDocumentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetTaxRegistrationDocument", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
