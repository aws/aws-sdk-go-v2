...
func (c *Client) addOperationListSupplementalTaxRegistrationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSupplementalTaxRegistrations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
