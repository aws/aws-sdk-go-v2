...
func (c *Client) addOperationUpdateExperimentTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateExperimentTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
