...
func (*ListExperimentTemplatesInput) operationName() string {
...
func (c *Client) addOperationListExperimentTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListExperimentTemplatesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListExperimentTemplatesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListExperimentTemplatesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListExperimentTemplatesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListExperimentTemplatesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListExperimentTemplatesResolveEndpointMiddleware{
