...
func (c *Client) addOperationDeleteExperimentTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteExperimentTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
