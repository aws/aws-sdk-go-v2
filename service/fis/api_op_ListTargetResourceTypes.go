...
func (c *Client) addOperationListTargetResourceTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTargetResourceTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
