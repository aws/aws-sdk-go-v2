...
func (c *Client) GetAction(ctx context.Context, params *GetActionInput, optFns ...func(*Options)) (*GetActionOutput, error) {
	if params == nil { params = &GetActionInput{} }
...
func (c *Client) addOperationGetActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetActionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetActionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetActionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetActionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetActionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetActionResolveEndpointMiddleware{
