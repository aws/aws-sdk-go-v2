...
func (c *Client) addOperationListExperimentTargetAccountConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListExperimentTargetAccountConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
