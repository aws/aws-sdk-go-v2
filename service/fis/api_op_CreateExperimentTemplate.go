...
func (c *Client) addOperationCreateExperimentTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateExperimentTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
