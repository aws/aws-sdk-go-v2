...
func (c *Client) addOperationListTargetAccountConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTargetAccountConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
