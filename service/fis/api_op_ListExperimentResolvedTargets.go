...
func (c *Client) addOperationListExperimentResolvedTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListExperimentResolvedTargets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
