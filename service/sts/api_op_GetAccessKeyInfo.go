...
// ASIAare temporary credentials that are created using STS operations. If the
// account in the response belongs to you, you can sign in as the root user and
// review your root user access keys. Then, you can pull a credentials report (https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_getting-report.html)
