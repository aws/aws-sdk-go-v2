...
// DurationSecondsvalue from 900 seconds (15 minutes) up to the maximum session
...
type AssumeRoleWithSAMLOutput struct {
	...
	// a federated user. The following pseudocode shows how the hash value is
	// calculated: BASE64 ( SHA1 ( "https://example.com/saml" + "123456789012" +
	// "/MySAMLIdP" ) )
	...
	// That way, actions that are taken with the role are associated with that user.
	// After the source identity is set, the value cannot be changed. It is present in
	// the request for all actions that are taken by the role and persists across
