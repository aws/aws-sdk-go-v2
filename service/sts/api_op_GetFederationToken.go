...
func (c *Client) GetFederationToken(ctx context.Context, params *GetFederationTokenInput, optFns ...func(*Options)) (*GetFederationTokenOutput, error) {
	...
	addawsAwsquery_serdeOpGetFederationTokenMiddlewares(stack)
...
func addawsAwsquery_serdeOpGetFederationTokenMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpGetFederationToken{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpGetFederationToken{}, middleware.After)
}
