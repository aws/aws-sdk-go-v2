...
func addOperationDecodeAuthorizationMessageStackSlots(stack *middleware.Stack) error {
...
func addOperationDecodeAuthorizationMessageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDecodeAuthorizationMessageStackSlots(stack); err != nil {
		return err
	}
