...
func (*DeletePolicyStoreInput) operationName() string {
...
func (c *Client) addOperationDeletePolicyStoreMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeletePolicyStoreResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeletePolicyStoreResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeletePolicyStoreResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeletePolicyStoreResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeletePolicyStoreResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeletePolicyStoreResolveEndpointMiddleware{
