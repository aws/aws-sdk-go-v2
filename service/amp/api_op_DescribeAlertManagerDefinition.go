...
func (c *Client) addOperationDescribeAlertManagerDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAlertManagerDefinition", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
