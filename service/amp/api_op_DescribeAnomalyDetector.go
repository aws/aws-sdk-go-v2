...
func (c *Client) addOperationDescribeAnomalyDetectorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAnomalyDetector", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
