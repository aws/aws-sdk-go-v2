...
func (c *Client) addOperationListOpportunityFromEngagementTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOpportunityFromEngagementTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
