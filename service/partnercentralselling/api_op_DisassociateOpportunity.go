...
func (c *Client) addOperationDisassociateOpportunityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateOpportunity", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
