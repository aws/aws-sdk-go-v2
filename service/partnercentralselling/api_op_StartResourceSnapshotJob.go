...
func (c *Client) addOperationStartResourceSnapshotJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartResourceSnapshotJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
