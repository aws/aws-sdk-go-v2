...
func (c *Client) addOperationUpdateEngagementContextMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateEngagementContext", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
