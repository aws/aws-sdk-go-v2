...
func (c *Client) addOperationGetProspectingFromEngagementTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "GetProspectingFromEngagementTask"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetProspectingFromEngagementTask(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opGetProspectingFromEngagementTask(region string) *awsmiddleware.RegisterServiceMetadata {
