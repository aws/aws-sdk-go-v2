...
func (c *Client) addOperationCreateResourceSnapshotJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateResourceSnapshotJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
