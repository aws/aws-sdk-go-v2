...
func (c *Client) addOperationCreateEngagementContextMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateEngagementContext", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
