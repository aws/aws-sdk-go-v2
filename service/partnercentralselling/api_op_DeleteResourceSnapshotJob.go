...
func (c *Client) addOperationDeleteResourceSnapshotJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteResourceSnapshotJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
