...
func (c *Client) addOperationListResourceSnapshotJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListResourceSnapshotJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
