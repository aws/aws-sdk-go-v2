...
func (c *Client) addOperationStartOpportunityFromEngagementTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartOpportunityFromEngagementTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
