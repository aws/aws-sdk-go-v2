...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/sagemakerruntimehttp2/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_SAGEMAKER_RUNTIME_HTTP2")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "SageMaker Runtime HTTP2", cfg.ConfigSources)
	if found && err == nil {
...
var bddNodes = [69]int32{
	-1, 1, -1, 0, 22, 3, 1, 4, 100000015, 2, 5, 100000015, 3, 19, 6, 4, 19, 7, 5, 19, 8, 6, 19, 9, 7, 19, 10, 8, 19, 11, 9, 19, 12, 10, 15, 13, 12, 14, 100000014, 13, 100000012, 100000013, 11, 17, 16, 12, 100000009, 100000011, 12, 18, 100000010, 13, 100000008, 100000009, 10, 21, 20, 12, 100000005, 100000004, 12, 100000007, 100000006, 10, 100000001, 23, 12, 100000002, 100000003}
