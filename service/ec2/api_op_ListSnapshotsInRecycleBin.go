...
func (c *Client) addOperationListSnapshotsInRecycleBinMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSnapshotsInRecycleBin", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
