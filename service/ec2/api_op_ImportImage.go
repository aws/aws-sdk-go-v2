...
func (c *Client) ImportImage(ctx context.Context, params *ImportImageInput, optFns ...func(*Options)) (*ImportImageOutput, error) {
	stack := middleware.NewStack("ImportImage", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsEc2query_serdeOpImportImageMiddlewares(stack)
	...
	stack.Initialize.Add(newServiceMetadataMiddleware_opImportImage(options.Region), middleware.Before)
...
func addawsEc2query_serdeOpImportImageMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsEc2query_serializeOpImportImage{}, middleware.After)
	stack.Deserialize.Add(&awsEc2query_deserializeOpImportImage{}, middleware.After)
}
