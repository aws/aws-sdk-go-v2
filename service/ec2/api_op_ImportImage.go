...
// system is licensed appropriately and your billing is optimized. For more
// information, see Importing a VM as an image using VM Import/Export (https://docs.aws.amazon.com/vm-import/latest/userguide/vmimport-image-import.html)
...
type ImportImageInput struct {
	...
	// This action will eventually report failure. The specified KMS key must exist in
	// the Region that the AMI is being copied to. Amazon EBS does not support
	// asymmetric KMS keys.
	KmsKeyId *string
	...
	// importing. Specify AWS to replace the source-system license with an Amazon Web
	// Services license or BYOL to retain the source-system license. Leaving this
	// parameter undefined is the same as choosing AWS when importing a Windows
	// Server operating system, and the same as choosing BYOL when importing a
	// Windows client operating system (such as Windows 10) or a Linux operating
	// system. To use BYOL, you must have existing licenses with rights to use these
	// licenses in a third party cloud, such as Amazon Web Services. For more
	// information, see Prerequisites (https://docs.aws.amazon.com/vm-import/latest/userguide/vmimport-image-import.html#prerequisites-image)
	// in the VM Import/Export User Guide.
	LicenseType *string
