...
func (c *Client) addOperationModifyVpcBlockPublicAccessExclusionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyVpcBlockPublicAccessExclusion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
