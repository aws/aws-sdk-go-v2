...
func (c *Client) addOperationCreateVerifiedAccessEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateVerifiedAccessEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
