...
func (c *Client) addOperationRestoreManagedPrefixListVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RestoreManagedPrefixListVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
