...
// modify longer ID settings for resource types that are within the opt-in period.
...
// vpc-endpoint | vpc-peering-connection  | vpn-connection  | vpn-gateway. For
// more information, see Resource IDs (https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/resource-ids.html)
