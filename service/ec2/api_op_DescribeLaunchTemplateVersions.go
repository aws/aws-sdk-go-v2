...
func addOperationDescribeLaunchTemplateVersionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeLaunchTemplateVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeLaunchTemplateVersionsStackSlots(stack); err != nil {
		return err
	}
