...
func (c *Client) addOperationDescribeFastLaunchImagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeFastLaunchImages", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
