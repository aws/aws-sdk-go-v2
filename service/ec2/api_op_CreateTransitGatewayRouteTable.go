...
func addOperationCreateTransitGatewayRouteTableStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateTransitGatewayRouteTableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateTransitGatewayRouteTableStackSlots(stack); err != nil {
		return err
	}
