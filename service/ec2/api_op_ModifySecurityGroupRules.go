...
func (c *Client) addOperationModifySecurityGroupRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifySecurityGroupRules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
