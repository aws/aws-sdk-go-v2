...
func (c *Client) addOperationGetVerifiedAccessGroupPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetVerifiedAccessGroupPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
