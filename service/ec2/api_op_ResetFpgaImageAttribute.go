...
func (c *Client) addOperationResetFpgaImageAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ResetFpgaImageAttribute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
