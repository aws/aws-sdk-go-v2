...
func (c *Client) addOperationDescribeIdentityIdFormatMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeIdentityIdFormat", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
