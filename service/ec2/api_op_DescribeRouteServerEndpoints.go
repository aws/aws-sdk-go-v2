...
func (c *Client) addOperationDescribeRouteServerEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRouteServerEndpoints", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
