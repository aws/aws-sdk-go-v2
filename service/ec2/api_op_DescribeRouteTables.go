...
type DescribeRouteTablesInput struct {
	...
	// - association.route-table-id - The ID of the
	// route table involved in the association.
	// - association.subnet-id - The ID of the
	// subnet involved in the association.
	// - association.main - Indicates whether the
	// route table is the main route table for the VPC (true | false). Route tables
	...
	// - route.nat-gateway-id - The ID of a
	// NAT gateway.
	...
	// find all resources assigned a tag with a specific key, regardless of the tag
	// value.
