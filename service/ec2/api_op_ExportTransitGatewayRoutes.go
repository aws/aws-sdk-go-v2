...
func addOperationExportTransitGatewayRoutesStackSlots(stack *middleware.Stack) error {
...
func addOperationExportTransitGatewayRoutesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationExportTransitGatewayRoutesStackSlots(stack); err != nil {
		return err
	}
