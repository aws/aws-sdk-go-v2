...
func (c *Client) addOperationExportTransitGatewayRoutesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ExportTransitGatewayRoutes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
