...
func (c *Client) addOperationModifySnapshotAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifySnapshotAttribute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
