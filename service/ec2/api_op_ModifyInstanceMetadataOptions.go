...
func (c *Client) addOperationModifyInstanceMetadataOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyInstanceMetadataOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
