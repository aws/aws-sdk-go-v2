...
func addOperationModifyInstanceMetadataOptionsStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyInstanceMetadataOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyInstanceMetadataOptionsStackSlots(stack); err != nil {
		return err
	}
