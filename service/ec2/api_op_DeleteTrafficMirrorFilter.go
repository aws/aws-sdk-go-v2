...
func (c *Client) addOperationDeleteTrafficMirrorFilterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteTrafficMirrorFilter", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
