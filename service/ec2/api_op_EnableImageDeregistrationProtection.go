...
func (c *Client) addOperationEnableImageDeregistrationProtectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableImageDeregistrationProtection", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
