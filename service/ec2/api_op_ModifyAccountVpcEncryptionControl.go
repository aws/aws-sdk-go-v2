...
func (c *Client) addOperationModifyAccountVpcEncryptionControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyAccountVpcEncryptionControl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
