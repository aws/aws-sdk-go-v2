...
func (c *Client) addOperationDeregisterTransitGatewayMulticastGroupMembersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterTransitGatewayMulticastGroupMembers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
