...
func addOperationDeregisterTransitGatewayMulticastGroupMembersStackSlots(stack *middleware.Stack) error {
...
func addOperationDeregisterTransitGatewayMulticastGroupMembersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeregisterTransitGatewayMulticastGroupMembersStackSlots(stack); err != nil {
		return err
	}
