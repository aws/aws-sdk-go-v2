...
func addOperationDisassociateTransitGatewayMulticastDomainStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateTransitGatewayMulticastDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateTransitGatewayMulticastDomainStackSlots(stack); err != nil {
		return err
	}
