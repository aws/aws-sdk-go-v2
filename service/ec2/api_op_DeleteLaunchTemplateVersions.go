...
func addOperationDeleteLaunchTemplateVersionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteLaunchTemplateVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteLaunchTemplateVersionsStackSlots(stack); err != nil {
		return err
	}
