...
func (c *Client) addOperationDeleteLaunchTemplateVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteLaunchTemplateVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
