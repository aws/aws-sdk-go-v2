...
func (c *Client) addOperationCancelCapacityReservationFleetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelCapacityReservationFleets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
