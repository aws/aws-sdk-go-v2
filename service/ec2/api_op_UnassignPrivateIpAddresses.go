...
func (c *Client) addOperationUnassignPrivateIpAddressesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UnassignPrivateIpAddresses", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
