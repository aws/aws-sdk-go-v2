...
func addOperationCreateSpotDatafeedSubscriptionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateSpotDatafeedSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateSpotDatafeedSubscriptionStackSlots(stack); err != nil {
		return err
	}
