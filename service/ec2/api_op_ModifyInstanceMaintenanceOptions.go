...
func (c *Client) addOperationModifyInstanceMaintenanceOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyInstanceMaintenanceOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
