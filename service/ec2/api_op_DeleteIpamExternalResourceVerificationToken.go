...
func (c *Client) addOperationDeleteIpamExternalResourceVerificationTokenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteIpamExternalResourceVerificationToken", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
