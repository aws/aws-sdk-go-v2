...
func (c *Client) addOperationDescribeExportImageTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeExportImageTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
