...
func addOperationDescribeFastSnapshotRestoresStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeFastSnapshotRestoresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeFastSnapshotRestoresStackSlots(stack); err != nil {
		return err
	}
