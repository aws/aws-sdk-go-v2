...
func (c *Client) addOperationDescribeFastSnapshotRestoresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeFastSnapshotRestores", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
