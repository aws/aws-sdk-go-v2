...
func (c *Client) addOperationDescribeNetworkInsightsAccessScopeAnalysesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeNetworkInsightsAccessScopeAnalyses", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
