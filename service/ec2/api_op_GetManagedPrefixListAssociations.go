...
func (c *Client) addOperationGetManagedPrefixListAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetManagedPrefixListAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
