...
func (c *Client) addOperationDescribeDeclarativePoliciesReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDeclarativePoliciesReports", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
