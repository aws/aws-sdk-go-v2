...
func addOperationGetDefaultCreditSpecificationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetDefaultCreditSpecificationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetDefaultCreditSpecificationStackSlots(stack); err != nil {
		return err
	}
