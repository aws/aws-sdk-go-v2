...
func addOperationTerminateClientVpnConnectionsStackSlots(stack *middleware.Stack) error {
...
func addOperationTerminateClientVpnConnectionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationTerminateClientVpnConnectionsStackSlots(stack); err != nil {
		return err
	}
