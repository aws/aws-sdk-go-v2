...
func addOperationGetTransitGatewayRouteTableAssociationsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetTransitGatewayRouteTableAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetTransitGatewayRouteTableAssociationsStackSlots(stack); err != nil {
		return err
	}
