...
func addOperationRejectVpcEndpointConnectionsStackSlots(stack *middleware.Stack) error {
...
func addOperationRejectVpcEndpointConnectionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRejectVpcEndpointConnectionsStackSlots(stack); err != nil {
		return err
	}
