...
func (c *Client) addOperationRejectVpcEndpointConnectionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RejectVpcEndpointConnections", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
