...
func (c *Client) addOperationGetAllowedImagesSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAllowedImagesSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
