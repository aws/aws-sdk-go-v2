...
func (c *Client) addOperationCreateDelegateMacVolumeOwnershipTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateDelegateMacVolumeOwnershipTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
