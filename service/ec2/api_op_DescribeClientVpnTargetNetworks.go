...
func addOperationDescribeClientVpnTargetNetworksStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeClientVpnTargetNetworksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeClientVpnTargetNetworksStackSlots(stack); err != nil {
		return err
	}
