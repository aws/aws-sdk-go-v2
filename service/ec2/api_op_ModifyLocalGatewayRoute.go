...
func (c *Client) addOperationModifyLocalGatewayRouteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyLocalGatewayRoute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
