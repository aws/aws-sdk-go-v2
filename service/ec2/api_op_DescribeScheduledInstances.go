...
func addOperationDescribeScheduledInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeScheduledInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeScheduledInstancesStackSlots(stack); err != nil {
		return err
	}
