...
func addOperationCreateLaunchTemplateVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateLaunchTemplateVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateLaunchTemplateVersionStackSlots(stack); err != nil {
		return err
	}
