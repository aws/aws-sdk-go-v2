...
func (c *Client) addOperationCreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
