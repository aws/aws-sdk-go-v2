...
func (c *Client) addOperationDescribeReservedInstancesListingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReservedInstancesListings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
