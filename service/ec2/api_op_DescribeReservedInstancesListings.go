...
func addOperationDescribeReservedInstancesListingsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeReservedInstancesListingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeReservedInstancesListingsStackSlots(stack); err != nil {
		return err
	}
