...
func addOperationDisableTransitGatewayRouteTablePropagationStackSlots(stack *middleware.Stack) error {
...
func addOperationDisableTransitGatewayRouteTablePropagationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisableTransitGatewayRouteTablePropagationStackSlots(stack); err != nil {
		return err
	}
