...
func (c *Client) addOperationDisableTransitGatewayRouteTablePropagationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisableTransitGatewayRouteTablePropagation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
