...
func (c *Client) addOperationCreateCapacityReservationFleetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCapacityReservationFleet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
