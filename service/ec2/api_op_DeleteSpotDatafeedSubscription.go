...
func addOperationDeleteSpotDatafeedSubscriptionStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteSpotDatafeedSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteSpotDatafeedSubscriptionStackSlots(stack); err != nil {
		return err
	}
