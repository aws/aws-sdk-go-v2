...
func addOperationDisassociateClientVpnTargetNetworkStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateClientVpnTargetNetworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateClientVpnTargetNetworkStackSlots(stack); err != nil {
		return err
	}
