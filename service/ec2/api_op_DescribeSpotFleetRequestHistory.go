...
func (c *Client) addOperationDescribeSpotFleetRequestHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSpotFleetRequestHistory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
