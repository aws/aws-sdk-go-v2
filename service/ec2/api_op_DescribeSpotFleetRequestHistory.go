...
func addOperationDescribeSpotFleetRequestHistoryStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeSpotFleetRequestHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeSpotFleetRequestHistoryStackSlots(stack); err != nil {
		return err
	}
