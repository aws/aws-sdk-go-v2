...
func (c *Client) addOperationDescribeManagedPrefixListsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeManagedPrefixLists", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
