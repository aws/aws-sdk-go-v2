...
func (c *Client) addOperationDescribeMacModificationTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMacModificationTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
