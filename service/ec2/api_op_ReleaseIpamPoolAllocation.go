...
func (c *Client) addOperationReleaseIpamPoolAllocationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ReleaseIpamPoolAllocation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
