...
// Imports a disk into an EBS snapshot. For more information, see Importing a
// disk as a snapshot using VM Import/Export (https://docs.aws.amazon.com/vm-import/latest/userguide/vmimport-import-snapshot.html)
...
type ImportSnapshotInput struct {
	...
	// the Region that the snapshot is being copied to. Amazon EBS does not support
	// asymmetric KMS keys.
	KmsKeyId *string
