...
func (c *Client) addOperationAssociateTransitGatewayMulticastDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateTransitGatewayMulticastDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
