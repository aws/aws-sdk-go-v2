...
func (c *Client) addOperationDescribeLocalGatewayRouteTableVpcAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeLocalGatewayRouteTableVpcAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
