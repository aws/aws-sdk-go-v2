...
type DescribeSecurityGroupsInput struct {
	...
	// - The name of a security group that is referenced in an outbound security group
	// rule.
	// - egress.ip-permission.ipv6-cidr - An IPv6 CIDR block for an outbound
	// security group rule.
	// - egress.ip-permission.prefix-list-id - The ID of a prefix
	...
	// - egress.ip-permission.user-id - The
	// ID of an Amazon Web Services account that has been referenced in an outbound
	// security group rule.
	// - group-id - The ID of the security group.
	// - group-name -
	// The name of the security group.
	// - ip-permission.cidr - An IPv4 CIDR block for an
	// inbound security group rule.
	// - ip-permission.from-port - For an inbound rule,
	// the start of port range for the TCP and UDP protocols, or an ICMP type number.
	// -
	// ip-permission.group-id - The ID of a security group that has been referenced in
	// an inbound security group rule.
	// - ip-permission.group-name - The name of a
	// security group that is referenced in an inbound security group rule.
	// -
	...
	// - ip-permission.protocol - The IP
	// protocol for an inbound security group rule (tcp | udp | icmp, a protocol
	// number, or -1 for all protocols).
	// - ip-permission.to-port - For an inbound rule,
