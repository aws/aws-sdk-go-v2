...
func addOperationCreateVpcPeeringConnectionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateVpcPeeringConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateVpcPeeringConnectionStackSlots(stack); err != nil {
		return err
	}
