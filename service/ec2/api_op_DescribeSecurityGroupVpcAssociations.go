...
func (c *Client) addOperationDescribeSecurityGroupVpcAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSecurityGroupVpcAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
