...
func (c *Client) addOperationDisassociateTrunkInterfaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateTrunkInterface", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
