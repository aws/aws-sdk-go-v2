...
func (c *Client) addOperationDeleteIpamPrefixListResolverMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteIpamPrefixListResolver", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
