...
func (c *Client) addOperationUpdateCapacityManagerOrganizationsAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCapacityManagerOrganizationsAccess", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
