...
func addOperationDescribeSecurityGroupReferencesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeSecurityGroupReferencesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeSecurityGroupReferencesStackSlots(stack); err != nil {
		return err
	}
