...
func (c *Client) addOperationDescribeSecurityGroupReferencesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSecurityGroupReferences", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
