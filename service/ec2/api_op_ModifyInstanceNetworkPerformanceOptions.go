...
func (c *Client) addOperationModifyInstanceNetworkPerformanceOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyInstanceNetworkPerformanceOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
