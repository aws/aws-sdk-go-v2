...
func (c *Client) addOperationRevokeSecurityGroupEgressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RevokeSecurityGroupEgress", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
