...
func addOperationDescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsStackSlots(stack); err != nil {
		return err
	}
