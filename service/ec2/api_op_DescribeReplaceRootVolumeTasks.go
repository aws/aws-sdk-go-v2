...
func (c *Client) addOperationDescribeReplaceRootVolumeTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReplaceRootVolumeTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
