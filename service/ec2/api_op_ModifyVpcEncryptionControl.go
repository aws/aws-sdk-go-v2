...
func (c *Client) addOperationModifyVpcEncryptionControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyVpcEncryptionControl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
