...
func (c *Client) addOperationCreateInstanceExportTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateInstanceExportTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
