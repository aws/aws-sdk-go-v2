...
func (c *Client) addOperationModifyVpcEndpointPayerResponsibilityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyVpcEndpointPayerResponsibility", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
