...
func (c *Client) addOperationDescribeVpcEndpointConnectionNotificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeVpcEndpointConnectionNotifications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
