...
func (c *Client) addOperationGetReservedInstancesExchangeQuoteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetReservedInstancesExchangeQuote", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
