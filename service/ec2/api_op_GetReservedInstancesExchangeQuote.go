...
func addOperationGetReservedInstancesExchangeQuoteStackSlots(stack *middleware.Stack) error {
...
func addOperationGetReservedInstancesExchangeQuoteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetReservedInstancesExchangeQuoteStackSlots(stack); err != nil {
		return err
	}
