...
func (c *Client) addOperationCreateVpnConnectionRouteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateVpnConnectionRoute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
