...
func (c *Client) addOperationDescribeTransitGatewayRouteTableAnnouncementsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeTransitGatewayRouteTableAnnouncements", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
