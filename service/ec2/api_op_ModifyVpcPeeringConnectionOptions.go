...
func addOperationModifyVpcPeeringConnectionOptionsStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyVpcPeeringConnectionOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyVpcPeeringConnectionOptionsStackSlots(stack); err != nil {
		return err
	}
