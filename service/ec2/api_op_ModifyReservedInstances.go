...
func (c *Client) addOperationModifyReservedInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyReservedInstances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
