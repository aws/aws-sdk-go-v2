...
func (c *Client) addOperationDescribeTransitGatewayPolicyTablesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeTransitGatewayPolicyTables", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
