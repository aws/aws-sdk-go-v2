...
func (c *Client) addOperationCreateEgressOnlyInternetGatewayMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateEgressOnlyInternetGateway", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
