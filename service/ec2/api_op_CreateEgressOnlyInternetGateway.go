...
func addOperationCreateEgressOnlyInternetGatewayStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateEgressOnlyInternetGatewayMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateEgressOnlyInternetGatewayStackSlots(stack); err != nil {
		return err
	}
