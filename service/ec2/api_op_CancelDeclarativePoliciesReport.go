...
func (c *Client) addOperationCancelDeclarativePoliciesReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelDeclarativePoliciesReport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
