...
// enters the available state, you can attach your VPCs and VPN connections to
// the transit gateway. To attach your VPCs, use CreateTransitGatewayVpcAttachment
...
// CreateTransitGatewayRouteTableto create additional transit gateway route
// tables. If you disable automatic route propagation, we do not create a default
// transit gateway route table. You can use
// EnableTransitGatewayRouteTablePropagationto propagate routes from a resource
