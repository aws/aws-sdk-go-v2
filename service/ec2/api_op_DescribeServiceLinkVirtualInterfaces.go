...
func (c *Client) addOperationDescribeServiceLinkVirtualInterfacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeServiceLinkVirtualInterfaces", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
