...
func (c *Client) addOperationRejectCapacityReservationBillingOwnershipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RejectCapacityReservationBillingOwnership", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
