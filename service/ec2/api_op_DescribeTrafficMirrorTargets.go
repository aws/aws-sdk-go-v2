...
func addOperationDescribeTrafficMirrorTargetsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeTrafficMirrorTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeTrafficMirrorTargetsStackSlots(stack); err != nil {
		return err
	}
