...
func (c *Client) addOperationDeleteVpcBlockPublicAccessExclusionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteVpcBlockPublicAccessExclusion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
