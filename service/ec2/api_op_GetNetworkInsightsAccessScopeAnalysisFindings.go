...
func (c *Client) addOperationGetNetworkInsightsAccessScopeAnalysisFindingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetNetworkInsightsAccessScopeAnalysisFindings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
