...
func addOperationModifyVpcEndpointConnectionNotificationStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyVpcEndpointConnectionNotificationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyVpcEndpointConnectionNotificationStackSlots(stack); err != nil {
		return err
	}
