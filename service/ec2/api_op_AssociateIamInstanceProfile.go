...
func (c *Client) addOperationAssociateIamInstanceProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateIamInstanceProfile", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
