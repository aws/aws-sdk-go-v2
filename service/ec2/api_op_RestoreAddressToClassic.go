...
func (c *Client) addOperationRestoreAddressToClassicMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RestoreAddressToClassic", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
