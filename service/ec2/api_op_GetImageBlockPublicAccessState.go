...
func (c *Client) addOperationGetImageBlockPublicAccessStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetImageBlockPublicAccessState", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
