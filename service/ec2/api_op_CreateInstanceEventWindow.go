...
func (c *Client) addOperationCreateInstanceEventWindowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateInstanceEventWindow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
