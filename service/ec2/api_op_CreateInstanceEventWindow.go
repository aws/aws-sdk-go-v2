...
// EC2 instances can run. You can define either a set of time ranges or a cron
...
// AssociateInstanceEventWindowAPI. Event windows are applicable only for
...
//
// For
// more information, see Define event windows for scheduled events (https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/event-windows.html)
