...
func (c *Client) addOperationCreateLocalGatewayVirtualInterfaceGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateLocalGatewayVirtualInterfaceGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
