...
func (c *Client) addOperationDisableEbsEncryptionByDefaultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisableEbsEncryptionByDefault", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
