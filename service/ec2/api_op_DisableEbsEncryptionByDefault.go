...
func addOperationDisableEbsEncryptionByDefaultStackSlots(stack *middleware.Stack) error {
...
func addOperationDisableEbsEncryptionByDefaultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisableEbsEncryptionByDefaultStackSlots(stack); err != nil {
		return err
	}
