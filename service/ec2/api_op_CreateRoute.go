...
func (c *Client) CreateRoute(ctx context.Context, params *CreateRouteInput, optFns ...func(*Options)) (*CreateRouteOutput, error) {
	...
	addawsEc2query_serdeOpCreateRouteMiddlewares(stack)
...
func addawsEc2query_serdeOpCreateRouteMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsEc2query_serializeOpCreateRoute{}, middleware.After)
	stack.Deserialize.Add(&awsEc2query_deserializeOpCreateRoute{}, middleware.After)
}
