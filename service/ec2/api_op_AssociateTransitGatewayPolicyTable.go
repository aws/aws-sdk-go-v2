...
func (c *Client) addOperationAssociateTransitGatewayPolicyTableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateTransitGatewayPolicyTable", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
