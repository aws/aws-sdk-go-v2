...
func (c *Client) addOperationDescribeSpotFleetRequestsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSpotFleetRequests", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
