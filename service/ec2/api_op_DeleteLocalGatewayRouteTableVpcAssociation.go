...
func addOperationDeleteLocalGatewayRouteTableVpcAssociationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteLocalGatewayRouteTableVpcAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteLocalGatewayRouteTableVpcAssociationStackSlots(stack); err != nil {
		return err
	}
