...
func addOperationRegisterInstanceEventNotificationAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationRegisterInstanceEventNotificationAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRegisterInstanceEventNotificationAttributesStackSlots(stack); err != nil {
		return err
	}
