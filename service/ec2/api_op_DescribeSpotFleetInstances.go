...
func (c *Client) addOperationDescribeSpotFleetInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSpotFleetInstances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
