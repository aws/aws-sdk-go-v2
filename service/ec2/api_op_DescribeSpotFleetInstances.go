...
func addOperationDescribeSpotFleetInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeSpotFleetInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeSpotFleetInstancesStackSlots(stack); err != nil {
		return err
	}
