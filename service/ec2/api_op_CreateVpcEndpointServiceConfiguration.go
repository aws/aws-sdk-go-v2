...
func addOperationCreateVpcEndpointServiceConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateVpcEndpointServiceConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateVpcEndpointServiceConfigurationStackSlots(stack); err != nil {
		return err
	}
