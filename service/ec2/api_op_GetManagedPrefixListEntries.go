...
func addOperationGetManagedPrefixListEntriesStackSlots(stack *middleware.Stack) error {
...
func addOperationGetManagedPrefixListEntriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetManagedPrefixListEntriesStackSlots(stack); err != nil {
		return err
	}
