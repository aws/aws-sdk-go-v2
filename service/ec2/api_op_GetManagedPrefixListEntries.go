...
func (c *Client) addOperationGetManagedPrefixListEntriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetManagedPrefixListEntries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
