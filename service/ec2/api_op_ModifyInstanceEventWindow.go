...
func (c *Client) addOperationModifyInstanceEventWindowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyInstanceEventWindow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
