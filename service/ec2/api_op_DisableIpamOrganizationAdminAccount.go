...
func (c *Client) addOperationDisableIpamOrganizationAdminAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisableIpamOrganizationAdminAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
