...
func (c *Client) addOperationDescribeCapacityBlockOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCapacityBlockOfferings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
