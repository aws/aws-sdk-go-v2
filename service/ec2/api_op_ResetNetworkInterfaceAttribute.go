...
func (c *Client) addOperationResetNetworkInterfaceAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ResetNetworkInterfaceAttribute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
