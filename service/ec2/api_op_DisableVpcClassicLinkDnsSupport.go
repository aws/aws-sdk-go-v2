...
func (c *Client) addOperationDisableVpcClassicLinkDnsSupportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisableVpcClassicLinkDnsSupport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
