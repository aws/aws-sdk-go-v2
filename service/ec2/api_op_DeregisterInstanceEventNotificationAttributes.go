...
func addOperationDeregisterInstanceEventNotificationAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationDeregisterInstanceEventNotificationAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeregisterInstanceEventNotificationAttributesStackSlots(stack); err != nil {
		return err
	}
