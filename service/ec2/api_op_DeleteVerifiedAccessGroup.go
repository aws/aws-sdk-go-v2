...
func (c *Client) addOperationDeleteVerifiedAccessGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteVerifiedAccessGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
