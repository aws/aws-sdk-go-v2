...
func (c *Client) addOperationModifyInstanceMetadataDefaultsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyInstanceMetadataDefaults", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
