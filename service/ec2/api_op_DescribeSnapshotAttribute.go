...
func (c *Client) addOperationDescribeSnapshotAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSnapshotAttribute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
