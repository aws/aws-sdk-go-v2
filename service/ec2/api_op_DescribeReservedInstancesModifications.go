...
func addOperationDescribeReservedInstancesModificationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeReservedInstancesModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeReservedInstancesModificationsStackSlots(stack); err != nil {
		return err
	}
