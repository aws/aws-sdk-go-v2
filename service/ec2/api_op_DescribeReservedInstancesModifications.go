...
func (c *Client) addOperationDescribeReservedInstancesModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReservedInstancesModifications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
