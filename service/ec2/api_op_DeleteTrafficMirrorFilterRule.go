...
func (c *Client) addOperationDeleteTrafficMirrorFilterRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteTrafficMirrorFilterRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
