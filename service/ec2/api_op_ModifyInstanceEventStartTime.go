...
func addOperationModifyInstanceEventStartTimeStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyInstanceEventStartTimeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyInstanceEventStartTimeStackSlots(stack); err != nil {
		return err
	}
