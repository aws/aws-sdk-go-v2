...
func (c *Client) addOperationModifyInstanceEventStartTimeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyInstanceEventStartTime", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
