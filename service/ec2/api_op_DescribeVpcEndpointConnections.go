...
type DescribeVpcEndpointConnectionsInput struct {
	...
	// - vpc-endpoint-owner - The ID of the Amazon Web
	// Services account ID that owns the endpoint.
	// - vpc-endpoint-state - The state of
	// the endpoint (pendingAcceptance | pending | available | deleting | deleted |
	// rejected | failed).
