...
func addOperationDescribeVpcEndpointConnectionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeVpcEndpointConnectionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeVpcEndpointConnectionsStackSlots(stack); err != nil {
		return err
	}
