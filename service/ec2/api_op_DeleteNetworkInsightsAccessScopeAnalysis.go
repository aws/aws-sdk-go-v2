...
func (c *Client) addOperationDeleteNetworkInsightsAccessScopeAnalysisMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteNetworkInsightsAccessScopeAnalysis", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
