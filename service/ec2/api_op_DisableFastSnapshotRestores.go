...
func addOperationDisableFastSnapshotRestoresStackSlots(stack *middleware.Stack) error {
...
func addOperationDisableFastSnapshotRestoresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisableFastSnapshotRestoresStackSlots(stack); err != nil {
		return err
	}
