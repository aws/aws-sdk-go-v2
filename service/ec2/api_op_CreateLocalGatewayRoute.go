...
func (c *Client) addOperationCreateLocalGatewayRouteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateLocalGatewayRoute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
