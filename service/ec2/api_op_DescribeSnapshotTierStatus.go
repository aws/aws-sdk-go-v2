...
func (c *Client) addOperationDescribeSnapshotTierStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSnapshotTierStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
