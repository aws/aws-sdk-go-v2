...
func (c *Client) addOperationStartNetworkInsightsAnalysisMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartNetworkInsightsAnalysis", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
