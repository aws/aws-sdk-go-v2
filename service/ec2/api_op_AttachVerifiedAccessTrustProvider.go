...
func (c *Client) addOperationAttachVerifiedAccessTrustProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AttachVerifiedAccessTrustProvider", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
