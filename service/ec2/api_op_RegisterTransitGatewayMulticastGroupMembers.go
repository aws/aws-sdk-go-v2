...
func addOperationRegisterTransitGatewayMulticastGroupMembersStackSlots(stack *middleware.Stack) error {
...
func addOperationRegisterTransitGatewayMulticastGroupMembersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRegisterTransitGatewayMulticastGroupMembersStackSlots(stack); err != nil {
		return err
	}
