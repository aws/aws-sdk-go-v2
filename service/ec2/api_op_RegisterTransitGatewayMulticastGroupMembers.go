...
func (c *Client) addOperationRegisterTransitGatewayMulticastGroupMembersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterTransitGatewayMulticastGroupMembers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
