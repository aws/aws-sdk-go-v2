...
func addOperationCreateTrafficMirrorSessionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateTrafficMirrorSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateTrafficMirrorSessionStackSlots(stack); err != nil {
		return err
	}
