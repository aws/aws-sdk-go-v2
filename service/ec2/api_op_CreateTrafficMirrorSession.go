...
func (c *Client) addOperationCreateTrafficMirrorSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateTrafficMirrorSession", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
