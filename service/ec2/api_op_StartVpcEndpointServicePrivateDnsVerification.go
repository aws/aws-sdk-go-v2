...
func addOperationStartVpcEndpointServicePrivateDnsVerificationStackSlots(stack *middleware.Stack) error {
...
func addOperationStartVpcEndpointServicePrivateDnsVerificationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartVpcEndpointServicePrivateDnsVerificationStackSlots(stack); err != nil {
		return err
	}
