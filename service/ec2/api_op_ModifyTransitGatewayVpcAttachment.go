...
func addOperationModifyTransitGatewayVpcAttachmentStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyTransitGatewayVpcAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyTransitGatewayVpcAttachmentStackSlots(stack); err != nil {
		return err
	}
