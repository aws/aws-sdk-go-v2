...
func (c *Client) addOperationDeleteNetworkInsightsPathMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteNetworkInsightsPath", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
