...
func (c *Client) addOperationGetCapacityManagerMetricDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCapacityManagerMetricData", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
