...
func (c *Client) addOperationDescribePlacementGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribePlacementGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
