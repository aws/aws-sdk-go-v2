...
func (c *Client) addOperationRevokeSecurityGroupIngressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RevokeSecurityGroupIngress", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
