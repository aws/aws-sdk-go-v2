...
func addOperationRevokeSecurityGroupIngressStackSlots(stack *middleware.Stack) error {
...
func addOperationRevokeSecurityGroupIngressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRevokeSecurityGroupIngressStackSlots(stack); err != nil {
		return err
	}
