...
func addOperationSearchTransitGatewayMulticastGroupsStackSlots(stack *middleware.Stack) error {
...
func addOperationSearchTransitGatewayMulticastGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationSearchTransitGatewayMulticastGroupsStackSlots(stack); err != nil {
		return err
	}
