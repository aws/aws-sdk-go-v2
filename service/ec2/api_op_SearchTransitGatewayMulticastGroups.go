...
type SearchTransitGatewayMulticastGroupsInput struct {
	...
	// - is-group-member - The resource
	// is a group member. Valid values are true | false.
	// - is-group-source - The
	// resource is a group source. Valid values are true | false.
	// - member-type - The
	// member type. Valid values are igmp | static.
