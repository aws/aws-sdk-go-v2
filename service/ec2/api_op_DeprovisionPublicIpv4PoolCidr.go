...
func (c *Client) addOperationDeprovisionPublicIpv4PoolCidrMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeprovisionPublicIpv4PoolCidr", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
