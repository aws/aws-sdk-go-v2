...
func (c *Client) addOperationCreateIpamPrefixListResolverTargetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateIpamPrefixListResolverTarget", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
