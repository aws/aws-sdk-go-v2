...
func addOperationDeleteTransitGatewayVpcAttachmentStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteTransitGatewayVpcAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteTransitGatewayVpcAttachmentStackSlots(stack); err != nil {
		return err
	}
