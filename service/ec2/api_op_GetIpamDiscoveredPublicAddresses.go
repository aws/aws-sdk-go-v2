...
func (c *Client) addOperationGetIpamDiscoveredPublicAddressesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetIpamDiscoveredPublicAddresses", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
