...
func (c *Client) addOperationDescribeConversionTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConversionTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
