...
func addOperationCreateTransitGatewayPeeringAttachmentStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateTransitGatewayPeeringAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateTransitGatewayPeeringAttachmentStackSlots(stack); err != nil {
		return err
	}
