...
func addOperationGetHostReservationPurchasePreviewStackSlots(stack *middleware.Stack) error {
...
func addOperationGetHostReservationPurchasePreviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetHostReservationPurchasePreviewStackSlots(stack); err != nil {
		return err
	}
