...
func (c *Client) addOperationGetHostReservationPurchasePreviewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetHostReservationPurchasePreview", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
