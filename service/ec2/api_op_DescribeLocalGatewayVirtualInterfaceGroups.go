...
func (c *Client) addOperationDescribeLocalGatewayVirtualInterfaceGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeLocalGatewayVirtualInterfaceGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
