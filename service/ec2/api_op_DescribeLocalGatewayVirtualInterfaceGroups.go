...
func addOperationDescribeLocalGatewayVirtualInterfaceGroupsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeLocalGatewayVirtualInterfaceGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeLocalGatewayVirtualInterfaceGroupsStackSlots(stack); err != nil {
		return err
	}
