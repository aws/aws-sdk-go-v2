...
func (c *Client) addOperationAuthorizeClientVpnIngressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AuthorizeClientVpnIngress", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
