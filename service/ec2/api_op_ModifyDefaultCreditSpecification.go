...
func addOperationModifyDefaultCreditSpecificationStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyDefaultCreditSpecificationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyDefaultCreditSpecificationStackSlots(stack); err != nil {
		return err
	}
