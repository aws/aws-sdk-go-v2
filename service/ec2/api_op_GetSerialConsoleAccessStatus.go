...
func (c *Client) addOperationGetSerialConsoleAccessStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSerialConsoleAccessStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
