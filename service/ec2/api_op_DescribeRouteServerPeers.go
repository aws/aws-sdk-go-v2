...
func (c *Client) addOperationDescribeRouteServerPeersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRouteServerPeers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
