...
func (c *Client) addOperationModifyCapacityReservationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyCapacityReservation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
