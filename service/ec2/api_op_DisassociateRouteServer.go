...
func (c *Client) addOperationDisassociateRouteServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateRouteServer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
