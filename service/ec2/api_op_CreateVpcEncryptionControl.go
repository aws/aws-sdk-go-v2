...
func (c *Client) addOperationCreateVpcEncryptionControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateVpcEncryptionControl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
