...
func (c *Client) addOperationCreateIpamExternalResourceVerificationTokenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateIpamExternalResourceVerificationToken", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
