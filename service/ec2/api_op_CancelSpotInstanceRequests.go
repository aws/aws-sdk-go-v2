...
func addOperationCancelSpotInstanceRequestsStackSlots(stack *middleware.Stack) error {
...
func addOperationCancelSpotInstanceRequestsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCancelSpotInstanceRequestsStackSlots(stack); err != nil {
		return err
	}
