...
func (c *Client) addOperationDeregisterTransitGatewayMulticastGroupSourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterTransitGatewayMulticastGroupSources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
