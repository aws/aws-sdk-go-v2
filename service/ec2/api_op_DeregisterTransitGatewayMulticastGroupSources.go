...
func addOperationDeregisterTransitGatewayMulticastGroupSourcesStackSlots(stack *middleware.Stack) error {
...
func addOperationDeregisterTransitGatewayMulticastGroupSourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeregisterTransitGatewayMulticastGroupSourcesStackSlots(stack); err != nil {
		return err
	}
