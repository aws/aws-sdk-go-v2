...
//
// Before you
// perform the migration to the new gateway, you must configure the new gateway.
// Use CreateVpnGateway  to create a virtual private gateway, or
// CreateTransitGatewayto create a transit gateway. This step is required when
// you migrate from a virtual private gateway with static routes to a transit
// gateway. You must delete the static routes before you migrate to the new
// gateway. Keep a copy of the static route before you delete it. You will need to
// add back these routes to the transit gateway after the VPN connection migration
// is complete. After you migrate to the new gateway, you might need to modify your
...
// CreateTransitGatewayRouteto add the routes. If you deleted VPN static routes,
