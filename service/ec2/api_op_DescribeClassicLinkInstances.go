...
func (c *Client) addOperationDescribeClassicLinkInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeClassicLinkInstances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
