...
func (c *Client) addOperationCreateTrafficMirrorTargetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateTrafficMirrorTarget", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
