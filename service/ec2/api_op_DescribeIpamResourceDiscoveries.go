...
func (c *Client) addOperationDescribeIpamResourceDiscoveriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeIpamResourceDiscoveries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
