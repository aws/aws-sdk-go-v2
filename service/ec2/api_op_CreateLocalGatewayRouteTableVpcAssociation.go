...
func (c *Client) addOperationCreateLocalGatewayRouteTableVpcAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateLocalGatewayRouteTableVpcAssociation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
