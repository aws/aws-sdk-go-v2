...
func addOperationDescribeNetworkInterfacePermissionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeNetworkInterfacePermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeNetworkInterfacePermissionsStackSlots(stack); err != nil {
		return err
	}
