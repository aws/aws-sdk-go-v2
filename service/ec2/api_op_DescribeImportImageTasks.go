...
func (c *Client) addOperationDescribeImportImageTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeImportImageTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
