...
func (c *Client) addOperationEnableFastSnapshotRestoresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableFastSnapshotRestores", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
