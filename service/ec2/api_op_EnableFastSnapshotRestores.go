...
func addOperationEnableFastSnapshotRestoresStackSlots(stack *middleware.Stack) error {
...
func addOperationEnableFastSnapshotRestoresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationEnableFastSnapshotRestoresStackSlots(stack); err != nil {
		return err
	}
