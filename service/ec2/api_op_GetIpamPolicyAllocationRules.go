...
func (c *Client) addOperationGetIpamPolicyAllocationRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetIpamPolicyAllocationRules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
