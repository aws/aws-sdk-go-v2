...
func (c *Client) addOperationDescribeNetworkInsightsAccessScopesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeNetworkInsightsAccessScopes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
