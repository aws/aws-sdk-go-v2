...
func (c *Client) addOperationDescribeCarrierGatewaysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCarrierGateways", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
