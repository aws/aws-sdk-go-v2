...
func (c *Client) addOperationDeleteEgressOnlyInternetGatewayMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteEgressOnlyInternetGateway", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
