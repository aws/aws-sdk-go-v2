...
func (c *Client) addOperationModifyInstanceCpuOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyInstanceCpuOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
