...
func (c *Client) addOperationDescribeInstanceCreditSpecificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeInstanceCreditSpecifications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
