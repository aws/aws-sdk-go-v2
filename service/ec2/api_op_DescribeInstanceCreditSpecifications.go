...
func addOperationDescribeInstanceCreditSpecificationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeInstanceCreditSpecificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeInstanceCreditSpecificationsStackSlots(stack); err != nil {
		return err
	}
