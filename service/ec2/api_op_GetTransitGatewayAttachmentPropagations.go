...
func addOperationGetTransitGatewayAttachmentPropagationsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetTransitGatewayAttachmentPropagationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetTransitGatewayAttachmentPropagationsStackSlots(stack); err != nil {
		return err
	}
