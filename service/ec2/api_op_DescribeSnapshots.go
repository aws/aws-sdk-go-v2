...
// include the Amazon Web Services account IDs of the specified owners, amazon
// for snapshots owned by Amazon, or self for snapshots that you own. If you
...
// or have explicit permissions, or all for public snapshots. If you are
// describing a long list of snapshots, we recommend that you paginate the output
