...
func (c *Client) addOperationEnableVpcClassicLinkDnsSupportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableVpcClassicLinkDnsSupport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
