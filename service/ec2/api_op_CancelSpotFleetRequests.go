...
func (c *Client) addOperationCancelSpotFleetRequestsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelSpotFleetRequests", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
