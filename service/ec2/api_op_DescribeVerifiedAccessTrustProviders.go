...
func (c *Client) addOperationDescribeVerifiedAccessTrustProvidersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeVerifiedAccessTrustProviders", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
