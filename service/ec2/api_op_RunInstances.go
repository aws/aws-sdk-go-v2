...
func (c *Client) RunInstances(ctx context.Context, params *RunInstancesInput, optFns ...func(*Options)) (*RunInstancesOutput, error) {
	stack := middleware.NewStack("RunInstances", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsEc2query_serdeOpRunInstancesMiddlewares(stack)
...
func addawsEc2query_serdeOpRunInstancesMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsEc2query_serializeOpRunInstances{}, middleware.After)
	stack.Deserialize.Add(&awsEc2query_deserializeOpRunInstances{}, middleware.After)
}
...
func addIdempotencyToken_opRunInstancesMiddleware(stack *middleware.Stack, cfg Options) {
	stack.Initialize.Add(&idempotencyToken_initializeOpRunInstances{tokenProvider: cfg.IdempotencyTokenProvider}, middleware.Before)
}
