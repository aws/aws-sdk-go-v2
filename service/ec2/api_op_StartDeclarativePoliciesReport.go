...
func (c *Client) addOperationStartDeclarativePoliciesReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartDeclarativePoliciesReport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
