...
func (c *Client) addOperationReplaceImageCriteriaInAllowedImagesSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ReplaceImageCriteriaInAllowedImagesSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
