...
func addOperationDescribeLocalGatewayVirtualInterfacesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeLocalGatewayVirtualInterfacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeLocalGatewayVirtualInterfacesStackSlots(stack); err != nil {
		return err
	}
