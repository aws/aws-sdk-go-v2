...
func addOperationDisassociateTransitGatewayRouteTableStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateTransitGatewayRouteTableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateTransitGatewayRouteTableStackSlots(stack); err != nil {
		return err
	}
