...
func (c *Client) addOperationDisassociateTransitGatewayRouteTableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateTransitGatewayRouteTable", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
