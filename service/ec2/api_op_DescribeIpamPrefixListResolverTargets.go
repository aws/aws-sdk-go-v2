...
func (c *Client) addOperationDescribeIpamPrefixListResolverTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeIpamPrefixListResolverTargets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
