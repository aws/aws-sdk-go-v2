...
func addOperationUpdateSecurityGroupRuleDescriptionsIngressStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateSecurityGroupRuleDescriptionsIngressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateSecurityGroupRuleDescriptionsIngressStackSlots(stack); err != nil {
		return err
	}
