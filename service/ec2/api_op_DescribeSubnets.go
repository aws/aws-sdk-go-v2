...
type DescribeSubnetsInput struct {
	...
	// You can also use availabilityZone as the filter name.
	// - availability-zone-id -
	// The ID of the Availability Zone for the subnet. You can also use
	// availabilityZoneId as the filter name.
	// - available-ip-address-count - The number
	// of IPv4 addresses in the subnet that are available.
	// - cidr-block - The IPv4 CIDR
	...
	// - customer-owned-ipv4-pool - The
	// customer-owned IPv4 address pool associated with the subnet.
	// - default-for-az -
	// Indicates whether this is the default subnet for the Availability Zone (true |
	// false). You can also use defaultForAz as the filter name.
	// - enable-dns64 -
