...
func (c *Client) addOperationDescribeSecurityGroupRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSecurityGroupRules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
