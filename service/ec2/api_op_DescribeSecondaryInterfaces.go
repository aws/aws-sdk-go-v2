...
func (c *Client) addOperationDescribeSecondaryInterfacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSecondaryInterfaces", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
