...
func addOperationModifyInstanceCreditSpecificationStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyInstanceCreditSpecificationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyInstanceCreditSpecificationStackSlots(stack); err != nil {
		return err
	}
