...
func (c *Client) addOperationDisassociateNatGatewayAddressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateNatGatewayAddress", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
