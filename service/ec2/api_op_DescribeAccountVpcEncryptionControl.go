...
func (c *Client) addOperationDescribeAccountVpcEncryptionControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAccountVpcEncryptionControl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
