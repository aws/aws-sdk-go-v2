...
func (c *Client) addOperationDescribeCapacityBlockExtensionOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCapacityBlockExtensionOfferings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
