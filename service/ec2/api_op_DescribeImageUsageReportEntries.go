...
func (c *Client) addOperationDescribeImageUsageReportEntriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeImageUsageReportEntries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
