...
func (c *Client) addOperationDeleteTransitGatewayRouteTableAnnouncementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteTransitGatewayRouteTableAnnouncement", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
