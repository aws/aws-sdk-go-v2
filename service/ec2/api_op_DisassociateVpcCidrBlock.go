...
func (c *Client) addOperationDisassociateVpcCidrBlockMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateVpcCidrBlock", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
