...
func (c *Client) addOperationResetEbsDefaultKmsKeyIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ResetEbsDefaultKmsKeyId", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
