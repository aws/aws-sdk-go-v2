...
func (c *Client) addOperationGetRouteServerPropagationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRouteServerPropagations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
