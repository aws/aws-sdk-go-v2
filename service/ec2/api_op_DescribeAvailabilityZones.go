...
func (c *Client) addOperationDescribeAvailabilityZonesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAvailabilityZones", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
