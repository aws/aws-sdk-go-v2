...
func (c *Client) addOperationDescribeAwsNetworkPerformanceMetricSubscriptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAwsNetworkPerformanceMetricSubscriptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
