...
func (c *Client) addOperationEnableAllowedImagesSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableAllowedImagesSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
