...
type DescribeInstanceStatusInput struct {
	...
	// - Filters on system status where the name is reachability (passed | failed |
	// initializing | insufficient-data).
	// - system-status.status - The system status of
	// the instance (ok | impaired | initializing | insufficient-data |
	// not-applicable).
