...
func addOperationModifyVpcEndpointServicePermissionsStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyVpcEndpointServicePermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyVpcEndpointServicePermissionsStackSlots(stack); err != nil {
		return err
	}
