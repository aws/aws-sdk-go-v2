...
func (c *Client) addOperationModifyClientVpnEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyClientVpnEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
