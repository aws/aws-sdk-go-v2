...
func (c *Client) addOperationModifyAvailabilityZoneGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyAvailabilityZoneGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
