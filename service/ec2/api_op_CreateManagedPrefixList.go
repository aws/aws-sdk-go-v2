...
func (c *Client) addOperationCreateManagedPrefixListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateManagedPrefixList", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
