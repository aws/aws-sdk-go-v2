...
func (c *Client) addOperationGetSecurityGroupsForVpcMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSecurityGroupsForVpc", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
