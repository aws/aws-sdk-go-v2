...
func (c *Client) addOperationCreateVerifiedAccessInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateVerifiedAccessInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
