...
func (c *Client) addOperationAssociateClientVpnTargetNetworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateClientVpnTargetNetwork", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
