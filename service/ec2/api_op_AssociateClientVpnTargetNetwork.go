...
func addOperationAssociateClientVpnTargetNetworkStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociateClientVpnTargetNetworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociateClientVpnTargetNetworkStackSlots(stack); err != nil {
		return err
	}
