...
type DescribeInstancesInput struct {
	...
	// zone (YYYY-MM-DDThh:mm:ss.sssZ), for example, 2021-09-29T11:04:43.305Z. You can
	...
	// instance (for example, shows "User Initiated [date]" when you stop or terminate
	// the instance). Similar to the state-reason-code filter.
	// - requester-id - The ID
	// of the entity that launched the instance on your behalf (for example, Amazon Web
	// Services Management Console, Auto Scaling, and so on).
	// - reservation-id - The ID
	// of the instance's reservation. A reservation ID is created any time you launch
	// an instance. A reservation ID has a one-to-one relationship with an instance
	// launch request, but can be associated with more than one instance if you launch
	...
	// true means that checking is enabled, and false means that checking is disabled.
	...
	// - virtualization-type - The virtualization type of
	// the instance (paravirtual | hvm).
	// - vpc-id - The ID of the VPC that the instance
	// is running in.
