...
func (c *Client) DescribeInstances(ctx context.Context, params *DescribeInstancesInput, optFns ...func(*Options)) (*DescribeInstancesOutput, error) {
	...
	addawsEc2query_serdeOpDescribeInstancesMiddlewares(stack)
...
func addawsEc2query_serdeOpDescribeInstancesMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsEc2query_serializeOpDescribeInstances{}, middleware.After)
	stack.Deserialize.Add(&awsEc2query_deserializeOpDescribeInstances{}, middleware.After)
}
