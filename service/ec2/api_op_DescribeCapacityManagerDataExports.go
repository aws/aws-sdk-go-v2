...
func (c *Client) addOperationDescribeCapacityManagerDataExportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCapacityManagerDataExports", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
