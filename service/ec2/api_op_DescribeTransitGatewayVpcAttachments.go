...
func addOperationDescribeTransitGatewayVpcAttachmentsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeTransitGatewayVpcAttachmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeTransitGatewayVpcAttachmentsStackSlots(stack); err != nil {
		return err
	}
