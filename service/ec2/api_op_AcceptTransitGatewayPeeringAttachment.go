...
func addOperationAcceptTransitGatewayPeeringAttachmentStackSlots(stack *middleware.Stack) error {
...
func addOperationAcceptTransitGatewayPeeringAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAcceptTransitGatewayPeeringAttachmentStackSlots(stack); err != nil {
		return err
	}
