...
func (c *Client) addOperationAcceptTransitGatewayPeeringAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AcceptTransitGatewayPeeringAttachment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
