...
func addOperationDisableVgwRoutePropagationStackSlots(stack *middleware.Stack) error {
...
func addOperationDisableVgwRoutePropagationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisableVgwRoutePropagationStackSlots(stack); err != nil {
		return err
	}
