...
func addOperationDeleteTransitGatewayMulticastDomainStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteTransitGatewayMulticastDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteTransitGatewayMulticastDomainStackSlots(stack); err != nil {
		return err
	}
