...
func (c *Client) addOperationCreateVpcEndpointConnectionNotificationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateVpcEndpointConnectionNotification", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
