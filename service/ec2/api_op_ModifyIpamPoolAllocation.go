...
func (c *Client) addOperationModifyIpamPoolAllocationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyIpamPoolAllocation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
