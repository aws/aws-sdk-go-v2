...
func (c *Client) DeleteFpgaImage(ctx context.Context, params *DeleteFpgaImageInput, optFns ...func(*Options)) (*DeleteFpgaImageOutput, error) {
	stack := middleware.NewStack("DeleteFpgaImage", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsEc2query_serdeOpDeleteFpgaImageMiddlewares(stack)
...
func addawsEc2query_serdeOpDeleteFpgaImageMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsEc2query_serializeOpDeleteFpgaImage{}, middleware.After)
	stack.Deserialize.Add(&awsEc2query_deserializeOpDeleteFpgaImage{}, middleware.After)
}
