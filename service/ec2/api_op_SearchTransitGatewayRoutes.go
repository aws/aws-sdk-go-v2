...
func addOperationSearchTransitGatewayRoutesStackSlots(stack *middleware.Stack) error {
...
func addOperationSearchTransitGatewayRoutesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationSearchTransitGatewayRoutesStackSlots(stack); err != nil {
		return err
	}
