...
func (c *Client) addOperationGetCapacityReservationUsageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCapacityReservationUsage", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
