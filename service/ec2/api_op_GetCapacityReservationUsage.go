...
func addOperationGetCapacityReservationUsageStackSlots(stack *middleware.Stack) error {
...
func addOperationGetCapacityReservationUsageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetCapacityReservationUsageStackSlots(stack); err != nil {
		return err
	}
