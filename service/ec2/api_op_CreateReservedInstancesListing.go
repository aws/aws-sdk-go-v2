...
func (c *Client) addOperationCreateReservedInstancesListingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateReservedInstancesListing", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
