...
func addOperationCreateReservedInstancesListingStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateReservedInstancesListingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateReservedInstancesListingStackSlots(stack); err != nil {
		return err
	}
