...
func addOperationPurchaseScheduledInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationPurchaseScheduledInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPurchaseScheduledInstancesStackSlots(stack); err != nil {
		return err
	}
