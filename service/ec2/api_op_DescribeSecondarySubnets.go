...
func (c *Client) addOperationDescribeSecondarySubnetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSecondarySubnets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
