...
func (c *Client) addOperationDescribeInstanceConnectEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeInstanceConnectEndpoints", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
