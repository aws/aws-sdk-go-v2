...
func addOperationDescribeTransitGatewayPeeringAttachmentsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeTransitGatewayPeeringAttachmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeTransitGatewayPeeringAttachmentsStackSlots(stack); err != nil {
		return err
	}
