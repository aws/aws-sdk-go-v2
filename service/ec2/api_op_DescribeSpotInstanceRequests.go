...
func addOperationDescribeSpotInstanceRequestsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeSpotInstanceRequestsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeSpotInstanceRequestsStackSlots(stack); err != nil {
		return err
	}
