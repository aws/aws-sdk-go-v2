...
func (c *Client) addOperationEnableEbsEncryptionByDefaultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableEbsEncryptionByDefault", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
