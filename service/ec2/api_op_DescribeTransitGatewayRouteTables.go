...
func addOperationDescribeTransitGatewayRouteTablesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeTransitGatewayRouteTablesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeTransitGatewayRouteTablesStackSlots(stack); err != nil {
		return err
	}
