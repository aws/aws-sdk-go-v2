...
func (c *Client) addOperationAcceptReservedInstancesExchangeQuoteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AcceptReservedInstancesExchangeQuote", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
