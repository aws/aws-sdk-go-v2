...
func (c *Client) addOperationModifyTransitGatewayPrefixListReferenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyTransitGatewayPrefixListReference", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
