...
func (c *Client) addOperationDeleteNetworkInsightsAnalysisMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteNetworkInsightsAnalysis", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
