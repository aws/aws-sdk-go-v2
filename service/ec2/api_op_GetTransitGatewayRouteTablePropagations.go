...
func addOperationGetTransitGatewayRouteTablePropagationsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetTransitGatewayRouteTablePropagationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetTransitGatewayRouteTablePropagationsStackSlots(stack); err != nil {
		return err
	}
