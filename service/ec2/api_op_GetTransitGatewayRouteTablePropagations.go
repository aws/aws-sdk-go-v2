...
func (c *Client) addOperationGetTransitGatewayRouteTablePropagationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetTransitGatewayRouteTablePropagations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
