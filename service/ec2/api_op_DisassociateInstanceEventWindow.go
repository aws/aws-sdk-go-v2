...
func (c *Client) addOperationDisassociateInstanceEventWindowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateInstanceEventWindow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
