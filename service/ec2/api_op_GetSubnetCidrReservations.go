...
func (c *Client) addOperationGetSubnetCidrReservationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSubnetCidrReservations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
