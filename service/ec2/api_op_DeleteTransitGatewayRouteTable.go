...
func addOperationDeleteTransitGatewayRouteTableStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteTransitGatewayRouteTableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteTransitGatewayRouteTableStackSlots(stack); err != nil {
		return err
	}
