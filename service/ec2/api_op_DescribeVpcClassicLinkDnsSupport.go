...
func addOperationDescribeVpcClassicLinkDnsSupportStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeVpcClassicLinkDnsSupportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeVpcClassicLinkDnsSupportStackSlots(stack); err != nil {
		return err
	}
