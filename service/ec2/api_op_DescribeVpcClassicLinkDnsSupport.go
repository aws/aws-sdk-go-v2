...
func (c *Client) addOperationDescribeVpcClassicLinkDnsSupportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeVpcClassicLinkDnsSupport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
