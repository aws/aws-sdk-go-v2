...
func (c *Client) addOperationDescribeImportSnapshotTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeImportSnapshotTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
