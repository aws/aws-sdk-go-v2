...
func addOperationDescribeVolumesModificationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeVolumesModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeVolumesModificationsStackSlots(stack); err != nil {
		return err
	}
