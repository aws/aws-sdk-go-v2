...
func (c *Client) addOperationDescribeLocalGatewayRouteTablesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeLocalGatewayRouteTables", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
