...
func addOperationGetGroupsForCapacityReservationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetGroupsForCapacityReservationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetGroupsForCapacityReservationStackSlots(stack); err != nil {
		return err
	}
