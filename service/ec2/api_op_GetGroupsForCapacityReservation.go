...
func (c *Client) addOperationGetGroupsForCapacityReservationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetGroupsForCapacityReservation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
