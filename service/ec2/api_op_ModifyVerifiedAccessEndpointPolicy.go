...
func (c *Client) addOperationModifyVerifiedAccessEndpointPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyVerifiedAccessEndpointPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
