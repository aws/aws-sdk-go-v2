...
func (c *Client) addOperationCreateIpamPrefixListResolverMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateIpamPrefixListResolver", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
