...
func (c *Client) addOperationCreateRouteServerEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateRouteServerEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
