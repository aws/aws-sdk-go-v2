...
func (c *Client) addOperationDisassociateSecurityGroupVpcMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateSecurityGroupVpc", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
