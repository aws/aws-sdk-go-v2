...
func (c *Client) addOperationDescribeCapacityBlockExtensionHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCapacityBlockExtensionHistory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
