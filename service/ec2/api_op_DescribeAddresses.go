...
type DescribeAddressesInput struct {
	...
	// - domain - Indicates whether the address is for
	// use in EC2-Classic (standard) or in a VPC (vpc).
	// - instance-id - The ID of the
	// instance the address is associated with, if any.
	// - network-border-group - A
	// unique set of Availability Zones, Local Zones, or Wavelength Zones from where
	// Amazon Web Services advertises IP addresses.
	// - network-interface-id - [EC2-VPC]
