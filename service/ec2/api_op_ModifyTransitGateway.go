...
func addOperationModifyTransitGatewayMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpModifyTransitGatewayValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opModifyTransitGateway(options.Region), middleware.Before)
