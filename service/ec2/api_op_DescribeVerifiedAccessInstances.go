...
func (c *Client) addOperationDescribeVerifiedAccessInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeVerifiedAccessInstances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
