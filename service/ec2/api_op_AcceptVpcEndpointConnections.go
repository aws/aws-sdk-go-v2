...
func addOperationAcceptVpcEndpointConnectionsStackSlots(stack *middleware.Stack) error {
...
func addOperationAcceptVpcEndpointConnectionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAcceptVpcEndpointConnectionsStackSlots(stack); err != nil {
		return err
	}
