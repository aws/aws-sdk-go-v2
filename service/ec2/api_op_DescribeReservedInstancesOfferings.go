...
func addOperationDescribeReservedInstancesOfferingsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeReservedInstancesOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeReservedInstancesOfferingsStackSlots(stack); err != nil {
		return err
	}
