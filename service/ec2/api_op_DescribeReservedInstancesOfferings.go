...
func (c *Client) addOperationDescribeReservedInstancesOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReservedInstancesOfferings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
