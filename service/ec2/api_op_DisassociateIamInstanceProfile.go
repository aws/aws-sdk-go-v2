...
func addOperationDisassociateIamInstanceProfileStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateIamInstanceProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateIamInstanceProfileStackSlots(stack); err != nil {
		return err
	}
