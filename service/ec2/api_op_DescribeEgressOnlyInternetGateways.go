...
func (c *Client) addOperationDescribeEgressOnlyInternetGatewaysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEgressOnlyInternetGateways", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
