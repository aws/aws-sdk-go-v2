...
func (c *Client) addOperationCreateTransitGatewayMulticastDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateTransitGatewayMulticastDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
