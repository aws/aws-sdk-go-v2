...
func addOperationCreateTransitGatewayMulticastDomainStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateTransitGatewayMulticastDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateTransitGatewayMulticastDomainStackSlots(stack); err != nil {
		return err
	}
