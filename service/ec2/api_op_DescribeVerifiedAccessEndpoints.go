...
func (c *Client) addOperationDescribeVerifiedAccessEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeVerifiedAccessEndpoints", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
