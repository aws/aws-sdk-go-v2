...
func (c *Client) addOperationCancelReservedInstancesListingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelReservedInstancesListing", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
