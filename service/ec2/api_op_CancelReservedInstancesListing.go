...
func addOperationCancelReservedInstancesListingStackSlots(stack *middleware.Stack) error {
...
func addOperationCancelReservedInstancesListingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCancelReservedInstancesListingStackSlots(stack); err != nil {
		return err
	}
