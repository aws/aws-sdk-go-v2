...
func (c *Client) addOperationGetVerifiedAccessEndpointTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetVerifiedAccessEndpointTargets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
