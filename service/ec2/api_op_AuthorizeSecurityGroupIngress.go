...
func addOperationAuthorizeSecurityGroupIngressStackSlots(stack *middleware.Stack) error {
...
func addOperationAuthorizeSecurityGroupIngressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAuthorizeSecurityGroupIngressStackSlots(stack); err != nil {
		return err
	}
