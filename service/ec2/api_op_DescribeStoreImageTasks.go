...
func (c *Client) addOperationDescribeStoreImageTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeStoreImageTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
