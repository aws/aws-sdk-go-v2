...
func (c *Client) addOperationDescribeNetworkInsightsAnalysesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeNetworkInsightsAnalyses", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
