...
type CreateVpcEndpointInput struct {
	...
	// to the default public DNS name for the service instead of the public DNS names
	// that are automatically generated by the VPC endpoint service. To use a private
	// hosted zone, you must set the following VPC attributes to true :
	// enableDnsHostnames and enableDnsSupport . Use ModifyVpcAttribute to set the
	// VPC attributes. Default: true
