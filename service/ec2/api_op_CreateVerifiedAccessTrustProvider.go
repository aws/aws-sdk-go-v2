...
func (c *Client) addOperationCreateVerifiedAccessTrustProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateVerifiedAccessTrustProvider", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
