...
func addOperationDescribeTransitGatewayAttachmentsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeTransitGatewayAttachmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeTransitGatewayAttachmentsStackSlots(stack); err != nil {
		return err
	}
