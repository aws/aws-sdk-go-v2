...
// vpc-endpoint | vpc-peering-connection  | vpn-connection  | vpn-gateway. This
// setting applies to the IAM user who makes the request; it does not apply to the
...
// overrides these settings for themselves. For more information, see Resource IDs (https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/resource-ids.html)
