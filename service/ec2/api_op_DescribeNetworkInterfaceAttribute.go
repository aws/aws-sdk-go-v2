...
func addOperationDescribeNetworkInterfaceAttributeStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeNetworkInterfaceAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeNetworkInterfaceAttributeStackSlots(stack); err != nil {
		return err
	}
