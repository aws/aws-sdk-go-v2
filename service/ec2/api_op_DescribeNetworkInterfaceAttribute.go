...
func (c *Client) addOperationDescribeNetworkInterfaceAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeNetworkInterfaceAttribute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
