...
func (c *Client) addOperationDescribeIpamPoolAllocationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeIpamPoolAllocations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
