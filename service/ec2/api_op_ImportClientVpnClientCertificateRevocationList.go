...
func addOperationImportClientVpnClientCertificateRevocationListStackSlots(stack *middleware.Stack) error {
...
func addOperationImportClientVpnClientCertificateRevocationListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationImportClientVpnClientCertificateRevocationListStackSlots(stack); err != nil {
		return err
	}
