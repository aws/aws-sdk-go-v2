...
func (c *Client) DeleteTransitGateway(ctx context.Context, params *DeleteTransitGatewayInput, optFns ...func(*Options)) (*DeleteTransitGatewayOutput, error) {
	stack := middleware.NewStack("DeleteTransitGateway", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsEc2query_serdeOpDeleteTransitGatewayMiddlewares(stack)
...
func addawsEc2query_serdeOpDeleteTransitGatewayMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsEc2query_serializeOpDeleteTransitGateway{}, middleware.After)
	stack.Deserialize.Add(&awsEc2query_deserializeOpDeleteTransitGateway{}, middleware.After)
}
