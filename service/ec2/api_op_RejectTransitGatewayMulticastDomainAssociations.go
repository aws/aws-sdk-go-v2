...
func (c *Client) addOperationRejectTransitGatewayMulticastDomainAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RejectTransitGatewayMulticastDomainAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
