...
func addOperationPurchaseReservedInstancesOfferingStackSlots(stack *middleware.Stack) error {
...
func addOperationPurchaseReservedInstancesOfferingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPurchaseReservedInstancesOfferingStackSlots(stack); err != nil {
		return err
	}
