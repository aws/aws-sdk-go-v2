...
func addOperationCreateTrafficMirrorFilterRuleStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateTrafficMirrorFilterRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateTrafficMirrorFilterRuleStackSlots(stack); err != nil {
		return err
	}
