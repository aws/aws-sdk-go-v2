...
func (c *Client) addOperationModifyNetworkInterfaceAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyNetworkInterfaceAttribute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
