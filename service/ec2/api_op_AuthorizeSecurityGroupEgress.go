...
func addOperationAuthorizeSecurityGroupEgressStackSlots(stack *middleware.Stack) error {
...
func addOperationAuthorizeSecurityGroupEgressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAuthorizeSecurityGroupEgressStackSlots(stack); err != nil {
		return err
	}
