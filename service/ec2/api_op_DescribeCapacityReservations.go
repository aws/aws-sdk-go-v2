...
func addOperationDescribeCapacityReservationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeCapacityReservationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeCapacityReservationsStackSlots(stack); err != nil {
		return err
	}
