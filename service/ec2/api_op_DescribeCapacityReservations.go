...
func (c *Client) addOperationDescribeCapacityReservationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCapacityReservations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
