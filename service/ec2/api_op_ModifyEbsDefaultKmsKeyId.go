...
func (c *Client) addOperationModifyEbsDefaultKmsKeyIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyEbsDefaultKmsKeyId", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
