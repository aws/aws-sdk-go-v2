...
func (c *Client) addOperationModifyIpamPrefixListResolverMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyIpamPrefixListResolver", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
