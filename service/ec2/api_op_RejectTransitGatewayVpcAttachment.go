...
func addOperationRejectTransitGatewayVpcAttachmentStackSlots(stack *middleware.Stack) error {
...
func addOperationRejectTransitGatewayVpcAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRejectTransitGatewayVpcAttachmentStackSlots(stack); err != nil {
		return err
	}
