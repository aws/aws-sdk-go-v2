...
func (c *Client) addOperationRejectTransitGatewayVpcAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RejectTransitGatewayVpcAttachment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
