...
func (c *Client) addOperationDeleteVpnConnectionRouteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteVpnConnectionRoute", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
