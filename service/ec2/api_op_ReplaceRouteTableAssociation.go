...
func addOperationReplaceRouteTableAssociationStackSlots(stack *middleware.Stack) error {
...
func addOperationReplaceRouteTableAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationReplaceRouteTableAssociationStackSlots(stack); err != nil {
		return err
	}
