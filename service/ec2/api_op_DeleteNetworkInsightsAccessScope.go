...
func (c *Client) addOperationDeleteNetworkInsightsAccessScopeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteNetworkInsightsAccessScope", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
