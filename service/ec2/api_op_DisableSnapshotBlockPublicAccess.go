...
func (c *Client) addOperationDisableSnapshotBlockPublicAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisableSnapshotBlockPublicAccess", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
