...
func (c *Client) addOperationAcceptTransitGatewayMulticastDomainAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AcceptTransitGatewayMulticastDomainAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
