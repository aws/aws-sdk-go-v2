...
func addOperationEnableTransitGatewayRouteTablePropagationStackSlots(stack *middleware.Stack) error {
...
func addOperationEnableTransitGatewayRouteTablePropagationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationEnableTransitGatewayRouteTablePropagationStackSlots(stack); err != nil {
		return err
	}
