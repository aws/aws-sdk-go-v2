...
func addOperationDescribeInstanceEventNotificationAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeInstanceEventNotificationAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeInstanceEventNotificationAttributesStackSlots(stack); err != nil {
		return err
	}
