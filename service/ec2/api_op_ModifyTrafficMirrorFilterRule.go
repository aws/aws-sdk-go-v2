...
func addOperationModifyTrafficMirrorFilterRuleStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyTrafficMirrorFilterRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyTrafficMirrorFilterRuleStackSlots(stack); err != nil {
		return err
	}
