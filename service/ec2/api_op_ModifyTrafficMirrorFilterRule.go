...
func (c *Client) addOperationModifyTrafficMirrorFilterRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyTrafficMirrorFilterRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
