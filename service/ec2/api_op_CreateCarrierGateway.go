...
func addOperationCreateCarrierGatewayMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addIdempotencyToken_opCreateCarrierGatewayMiddleware(stack, options)
	addOpCreateCarrierGatewayValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opCreateCarrierGateway(options.Region), middleware.Before)
...
func addIdempotencyToken_opCreateCarrierGatewayMiddleware(stack *middleware.Stack, cfg Options) {
	stack.Initialize.Add(&idempotencyToken_initializeOpCreateCarrierGateway{tokenProvider: cfg.IdempotencyTokenProvider}, middleware.Before)
}
