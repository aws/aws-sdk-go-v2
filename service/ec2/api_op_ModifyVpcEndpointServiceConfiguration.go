...
func addOperationModifyVpcEndpointServiceConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyVpcEndpointServiceConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyVpcEndpointServiceConfigurationStackSlots(stack); err != nil {
		return err
	}
