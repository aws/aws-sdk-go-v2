...
func addOperationModifyTrafficMirrorFilterNetworkServicesStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyTrafficMirrorFilterNetworkServicesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyTrafficMirrorFilterNetworkServicesStackSlots(stack); err != nil {
		return err
	}
