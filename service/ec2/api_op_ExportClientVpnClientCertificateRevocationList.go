...
func addOperationExportClientVpnClientCertificateRevocationListStackSlots(stack *middleware.Stack) error {
...
func addOperationExportClientVpnClientCertificateRevocationListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationExportClientVpnClientCertificateRevocationListStackSlots(stack); err != nil {
		return err
	}
