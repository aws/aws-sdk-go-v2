...
func (c *Client) addOperationRejectTransitGatewayPeeringAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RejectTransitGatewayPeeringAttachment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
