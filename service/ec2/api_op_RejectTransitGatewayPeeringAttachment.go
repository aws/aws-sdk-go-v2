...
func addOperationRejectTransitGatewayPeeringAttachmentStackSlots(stack *middleware.Stack) error {
...
func addOperationRejectTransitGatewayPeeringAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRejectTransitGatewayPeeringAttachmentStackSlots(stack); err != nil {
		return err
	}
