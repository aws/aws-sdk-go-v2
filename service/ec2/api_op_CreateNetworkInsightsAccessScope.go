...
func (c *Client) addOperationCreateNetworkInsightsAccessScopeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateNetworkInsightsAccessScope", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
