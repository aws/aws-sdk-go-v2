...
// Deletes the specified EC2 Fleets. After you delete an EC2 Fleet, it launches
// no new instances. You must also specify whether a deleted EC2 Fleet should
...
// deleted_runningstate, and the instances continue to run until they are
// interrupted or you terminate them manually. For instant fleets, EC2 Fleet must
// terminate the instances when the fleet is deleted. A deleted instant fleet
// with running instances is not supported. Restrictions
...
type DeleteFleetsInput struct {
	...
	// . Supported only for fleets of type maintain  and request . For instant
	// fleets, you cannot specify NoTerminateInstances . A deleted instant fleet with
