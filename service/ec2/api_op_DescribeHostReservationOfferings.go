...
func (c *Client) addOperationDescribeHostReservationOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeHostReservationOfferings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
