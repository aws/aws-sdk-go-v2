...
func addOperationDescribeHostReservationOfferingsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeHostReservationOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeHostReservationOfferingsStackSlots(stack); err != nil {
		return err
	}
