...
func (c *Client) addOperationCreateMacSystemIntegrityProtectionModificationTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMacSystemIntegrityProtectionModificationTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
