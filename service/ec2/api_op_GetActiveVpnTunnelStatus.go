...
func (c *Client) addOperationGetActiveVpnTunnelStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetActiveVpnTunnelStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
