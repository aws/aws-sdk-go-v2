...
func (c *Client) addOperationEnableIpamOrganizationAdminAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableIpamOrganizationAdminAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
