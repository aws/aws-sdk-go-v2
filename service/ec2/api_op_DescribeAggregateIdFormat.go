...
func (c *Client) addOperationDescribeAggregateIdFormatMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAggregateIdFormat", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
