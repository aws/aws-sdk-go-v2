...
func (c *Client) addOperationCreateReplaceRootVolumeTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateReplaceRootVolumeTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
