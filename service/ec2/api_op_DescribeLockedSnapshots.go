...
func (c *Client) addOperationDescribeLockedSnapshotsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeLockedSnapshots", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
