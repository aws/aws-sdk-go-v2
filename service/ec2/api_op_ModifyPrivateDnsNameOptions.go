...
func (c *Client) addOperationModifyPrivateDnsNameOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyPrivateDnsNameOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
