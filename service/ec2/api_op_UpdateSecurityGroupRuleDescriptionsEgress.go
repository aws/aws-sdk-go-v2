...
func (c *Client) addOperationUpdateSecurityGroupRuleDescriptionsEgressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateSecurityGroupRuleDescriptionsEgress", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
