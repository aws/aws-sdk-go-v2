...
func addOperationUpdateSecurityGroupRuleDescriptionsEgressStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateSecurityGroupRuleDescriptionsEgressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateSecurityGroupRuleDescriptionsEgressStackSlots(stack); err != nil {
		return err
	}
