...
func addOperationDeleteQueuedReservedInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteQueuedReservedInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteQueuedReservedInstancesStackSlots(stack); err != nil {
		return err
	}
