...
func (c *Client) addOperationDeleteQueuedReservedInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteQueuedReservedInstances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
