...
func (c *Client) addOperationGetRouteServerRoutingDatabaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRouteServerRoutingDatabase", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
