...
func (c *Client) addOperationDescribeVpcBlockPublicAccessOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeVpcBlockPublicAccessOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
