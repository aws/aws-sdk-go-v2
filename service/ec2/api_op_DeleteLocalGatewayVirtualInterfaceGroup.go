...
func (c *Client) addOperationDeleteLocalGatewayVirtualInterfaceGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteLocalGatewayVirtualInterfaceGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
