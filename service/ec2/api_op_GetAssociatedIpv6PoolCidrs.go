...
func (c *Client) addOperationGetAssociatedIpv6PoolCidrsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAssociatedIpv6PoolCidrs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
