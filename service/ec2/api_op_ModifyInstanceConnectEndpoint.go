...
func (c *Client) addOperationModifyInstanceConnectEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyInstanceConnectEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
