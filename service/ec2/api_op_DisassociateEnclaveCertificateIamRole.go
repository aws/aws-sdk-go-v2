...
func (c *Client) addOperationDisassociateEnclaveCertificateIamRoleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateEnclaveCertificateIamRole", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
