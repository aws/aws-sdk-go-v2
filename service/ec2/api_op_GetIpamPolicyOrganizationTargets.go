...
func (c *Client) addOperationGetIpamPolicyOrganizationTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetIpamPolicyOrganizationTargets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
