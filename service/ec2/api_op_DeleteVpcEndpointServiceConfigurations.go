...
func addOperationDeleteVpcEndpointServiceConfigurationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteVpcEndpointServiceConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteVpcEndpointServiceConfigurationsStackSlots(stack); err != nil {
		return err
	}
