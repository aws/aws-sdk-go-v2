...
func addOperationDescribeSpotDatafeedSubscriptionStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeSpotDatafeedSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeSpotDatafeedSubscriptionStackSlots(stack); err != nil {
		return err
	}
