...
func (c *Client) addOperationModifyCapacityReservationFleetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyCapacityReservationFleet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
