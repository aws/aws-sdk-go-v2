...
func addOperationDescribeVpcEndpointServicesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeVpcEndpointServicesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeVpcEndpointServicesStackSlots(stack); err != nil {
		return err
	}
