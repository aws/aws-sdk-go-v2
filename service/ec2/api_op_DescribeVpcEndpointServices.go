...
func (c *Client) addOperationDescribeVpcEndpointServicesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeVpcEndpointServices", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
