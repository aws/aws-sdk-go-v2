...
func (c *Client) addOperationDisableSerialConsoleAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisableSerialConsoleAccess", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
