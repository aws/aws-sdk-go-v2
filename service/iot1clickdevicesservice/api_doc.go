...
// Using the Client
//
// To use AWS IoT 1-Click Devices Service with the SDK use the New function to create
...
//
// See the AWS IoT 1-Click Devices Service client for more information on
