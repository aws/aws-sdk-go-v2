...
func (c *Client) InitiateDeviceClaim(ctx context.Context, params *InitiateDeviceClaimInput, optFns ...func(*Options)) (*InitiateDeviceClaimOutput, error) {
	if params == nil { params = &InitiateDeviceClaimInput{} }
...
func (c *Client) addOperationInitiateDeviceClaimMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addInitiateDeviceClaimResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opInitiateDeviceClaimResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opInitiateDeviceClaimResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opInitiateDeviceClaimResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addInitiateDeviceClaimResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opInitiateDeviceClaimResolveEndpointMiddleware{
