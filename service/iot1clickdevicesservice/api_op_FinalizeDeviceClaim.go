...
func (c *Client) FinalizeDeviceClaim(ctx context.Context, params *FinalizeDeviceClaimInput, optFns ...func(*Options)) (*FinalizeDeviceClaimOutput, error) {
	if params == nil { params = &FinalizeDeviceClaimInput{} }
...
func (c *Client) addOperationFinalizeDeviceClaimMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addFinalizeDeviceClaimResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opFinalizeDeviceClaimResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opFinalizeDeviceClaimResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opFinalizeDeviceClaimResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addFinalizeDeviceClaimResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opFinalizeDeviceClaimResolveEndpointMiddleware{
