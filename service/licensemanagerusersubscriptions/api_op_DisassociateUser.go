...
func (c *Client) DisassociateUser(ctx context.Context, params *DisassociateUserInput, optFns ...func(*Options)) (*DisassociateUserOutput, error) {
	if params == nil { params = &DisassociateUserInput{} }
...
func (c *Client) addOperationDisassociateUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateUserResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateUserResolveEndpointMiddleware{
