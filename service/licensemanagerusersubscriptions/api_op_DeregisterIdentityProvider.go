...
func (c *Client) addOperationDeregisterIdentityProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterIdentityProvider", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
