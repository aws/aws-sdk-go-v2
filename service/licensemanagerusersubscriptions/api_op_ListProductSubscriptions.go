...
func (c *Client) addOperationListProductSubscriptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListProductSubscriptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
