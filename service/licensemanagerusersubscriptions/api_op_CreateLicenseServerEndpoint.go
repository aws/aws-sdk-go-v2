...
func (c *Client) addOperationCreateLicenseServerEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateLicenseServerEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
