...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-license-manager-user-subscriptions.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-license-manager-user-subscriptions.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-license-manager-user-subscriptions.dev",
			expectURL:     aws.String("https://env-license-manager-user-subscriptions.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-license-manager-user-subscriptions.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-license-manager-user-subscriptions.dev",
			expectURL:     aws.String("http://config-license-manager-user-subscriptions.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-license-manager-user-subscriptions.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-license-manager-user-subscriptions.dev",
			clientEndpoint: aws.String("https://client-license-manager-user-subscriptions.dev"),
			expectURL:      aws.String("https://client-license-manager-user-subscriptions.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_LICENSE_MANAGER_USER_SUBSCRIPTIONS", c.envService)
			}
