...
func (c *Client) addOperationListLicenseServerEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListLicenseServerEndpoints", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
