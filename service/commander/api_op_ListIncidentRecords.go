...
func (c *Client) ListIncidentRecords(ctx context.Context, params *ListIncidentRecordsInput, optFns ...func(*Options)) (*ListIncidentRecordsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListIncidentRecords", params, optFns, addOperationListIncidentRecordsMiddlewares)
	if err != nil {
		return nil, err
	}
...
type ListIncidentRecordsInput struct {
	...
	// Filter the list of incident records you are searching through. You can filter on
	// the following keys:
	//
	// * creationTime
	//
...
func addOperationListIncidentRecordsMiddlewares(stack *middleware.Stack, options Options) (err error) {
