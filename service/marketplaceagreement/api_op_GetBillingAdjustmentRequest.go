...
func (c *Client) addOperationGetBillingAdjustmentRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetBillingAdjustmentRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
