...
func (v *SendAgreementPaymentRequestOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.SendAgreementPaymentRequestOutput)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *SendAgreementPaymentRequestOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AgreementId != nil {
		s.WriteString(schemas.SendAgreementPaymentRequestOutput_agreementId, *v.AgreementId)
	}
	if v.ChargeAmount != nil {
		s.WriteString(schemas.SendAgreementPaymentRequestOutput_chargeAmount, *v.ChargeAmount)
	}
	if v.CreatedAt != nil {
		s.WriteTime(schemas.SendAgreementPaymentRequestOutput_createdAt, *v.CreatedAt)
	}
	if v.CurrencyCode != nil {
		s.WriteString(schemas.SendAgreementPaymentRequestOutput_currencyCode, *v.CurrencyCode)
	}
	if v.Description != nil {
		s.WriteString(schemas.SendAgreementPaymentRequestOutput_description, *v.Description)
	}
	if v.Name != nil {
		s.WriteString(schemas.SendAgreementPaymentRequestOutput_name, *v.Name)
	}
	if v.PaymentRequestId != nil {
		s.WriteString(schemas.SendAgreementPaymentRequestOutput_paymentRequestId, *v.PaymentRequestId)
	}
	if v.Status != "" {
		s.WriteString(schemas.SendAgreementPaymentRequestOutput_status, string(v.Status))
	}
}
