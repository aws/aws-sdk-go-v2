...
func (c *Client) addOperationRejectAgreementCancellationRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RejectAgreementCancellationRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
