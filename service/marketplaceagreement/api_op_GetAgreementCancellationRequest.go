...
func (c *Client) addOperationGetAgreementCancellationRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAgreementCancellationRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
