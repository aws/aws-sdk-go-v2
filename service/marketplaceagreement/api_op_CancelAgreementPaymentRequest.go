...
func (c *Client) addOperationCancelAgreementPaymentRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelAgreementPaymentRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
