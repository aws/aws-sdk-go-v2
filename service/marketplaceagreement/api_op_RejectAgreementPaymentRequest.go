...
func (c *Client) addOperationRejectAgreementPaymentRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RejectAgreementPaymentRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
