...
func (c *Client) addOperationListAgreementInvoiceLineItemsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAgreementInvoiceLineItems", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
