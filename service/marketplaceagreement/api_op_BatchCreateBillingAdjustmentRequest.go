...
func (c *Client) addOperationBatchCreateBillingAdjustmentRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchCreateBillingAdjustmentRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
