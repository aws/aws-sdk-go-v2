...
func (c *Client) addOperationUpdateMicrosoftTeamsChannelConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateMicrosoftTeamsChannelConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
