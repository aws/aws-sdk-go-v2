...
func (c *Client) addOperationListMicrosoftTeamsConfiguredTeamsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMicrosoftTeamsConfiguredTeams", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
