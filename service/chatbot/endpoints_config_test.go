...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-chatbot.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chatbot.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chatbot.dev",
			expectURL:     aws.String("https://env-chatbot.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-chatbot.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chatbot.dev",
			expectURL:     aws.String("http://config-chatbot.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-chatbot.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-chatbot.dev",
			clientEndpoint: aws.String("https://client-chatbot.dev"),
			expectURL:      aws.String("https://client-chatbot.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CHATBOT", c.envService)
			}
