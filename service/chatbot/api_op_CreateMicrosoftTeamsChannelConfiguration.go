...
func (c *Client) addOperationCreateMicrosoftTeamsChannelConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMicrosoftTeamsChannelConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
