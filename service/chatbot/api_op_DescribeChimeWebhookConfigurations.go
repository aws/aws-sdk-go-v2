...
func (c *Client) addOperationDescribeChimeWebhookConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeChimeWebhookConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
