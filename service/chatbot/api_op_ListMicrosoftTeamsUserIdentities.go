...
func (c *Client) addOperationListMicrosoftTeamsUserIdentitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMicrosoftTeamsUserIdentities", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
