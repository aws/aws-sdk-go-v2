...
func (c *Client) addOperationDeleteMicrosoftTeamsUserIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteMicrosoftTeamsUserIdentity", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
