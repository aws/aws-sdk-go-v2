...
func (c *Client) addOperationCreateChimeWebhookConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateChimeWebhookConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
