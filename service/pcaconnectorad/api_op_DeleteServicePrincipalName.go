...
func (c *Client) addOperationDeleteServicePrincipalNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteServicePrincipalName", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
