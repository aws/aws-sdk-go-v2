...
func (c *Client) addOperationListServicePrincipalNamesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListServicePrincipalNames", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
