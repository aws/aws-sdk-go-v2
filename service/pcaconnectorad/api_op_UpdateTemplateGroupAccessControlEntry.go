...
func (c *Client) addOperationUpdateTemplateGroupAccessControlEntryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateTemplateGroupAccessControlEntryResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateTemplateGroupAccessControlEntryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateTemplateGroupAccessControlEntryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateTemplateGroupAccessControlEntryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateTemplateGroupAccessControlEntryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateTemplateGroupAccessControlEntryResolveEndpointMiddleware{
