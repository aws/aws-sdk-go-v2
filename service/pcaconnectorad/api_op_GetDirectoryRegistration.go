...
func (c *Client) addOperationGetDirectoryRegistrationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDirectoryRegistration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
