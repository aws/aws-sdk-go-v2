...
func (c *Client) addOperationListTemplateGroupAccessControlEntriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTemplateGroupAccessControlEntries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
