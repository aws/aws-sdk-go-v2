...
func (c *Client) addOperationListTemplateGroupAccessControlEntriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTemplateGroupAccessControlEntriesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListTemplateGroupAccessControlEntriesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListTemplateGroupAccessControlEntriesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTemplateGroupAccessControlEntriesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTemplateGroupAccessControlEntriesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListTemplateGroupAccessControlEntriesResolveEndpointMiddleware{
