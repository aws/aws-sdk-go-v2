...
func (c *Client) addOperationGetTemplateGroupAccessControlEntryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTemplateGroupAccessControlEntryResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetTemplateGroupAccessControlEntryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetTemplateGroupAccessControlEntryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTemplateGroupAccessControlEntryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTemplateGroupAccessControlEntryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetTemplateGroupAccessControlEntryResolveEndpointMiddleware{
