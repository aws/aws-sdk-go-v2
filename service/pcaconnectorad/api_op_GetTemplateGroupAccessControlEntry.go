...
func (c *Client) addOperationGetTemplateGroupAccessControlEntryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetTemplateGroupAccessControlEntry", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
