...
func (*DeleteDirectoryRegistrationInput) operationName() string {
	return "DeleteDirectoryRegistration"
}
...
func (c *Client) addOperationDeleteDirectoryRegistrationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteDirectoryRegistrationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteDirectoryRegistrationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteDirectoryRegistrationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteDirectoryRegistrationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteDirectoryRegistrationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteDirectoryRegistrationResolveEndpointMiddleware{
