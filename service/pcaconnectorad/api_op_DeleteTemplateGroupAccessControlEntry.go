...
func (c *Client) addOperationDeleteTemplateGroupAccessControlEntryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteTemplateGroupAccessControlEntryResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteTemplateGroupAccessControlEntryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteTemplateGroupAccessControlEntryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteTemplateGroupAccessControlEntryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteTemplateGroupAccessControlEntryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteTemplateGroupAccessControlEntryResolveEndpointMiddleware{
