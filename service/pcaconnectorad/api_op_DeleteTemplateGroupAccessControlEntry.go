...
func (c *Client) addOperationDeleteTemplateGroupAccessControlEntryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteTemplateGroupAccessControlEntry", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
