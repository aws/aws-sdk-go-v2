...
func (c *Client) addOperationCreateServicePrincipalNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateServicePrincipalName", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
