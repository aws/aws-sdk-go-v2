...
func (*CreateServicePrincipalNameInput) operationName() string {
	return "CreateServicePrincipalName"
}
...
func (c *Client) addOperationCreateServicePrincipalNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateServicePrincipalNameResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateServicePrincipalNameResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateServicePrincipalNameResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateServicePrincipalNameResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateServicePrincipalNameResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateServicePrincipalNameResolveEndpointMiddleware{
