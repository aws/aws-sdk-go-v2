...
func (c *Client) addOperationGetServicePrincipalNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetServicePrincipalName", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
