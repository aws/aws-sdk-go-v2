...
func (c *Client) addOperationGetServicePrincipalNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetServicePrincipalNameResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetServicePrincipalNameResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetServicePrincipalNameResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetServicePrincipalNameResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetServicePrincipalNameResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetServicePrincipalNameResolveEndpointMiddleware{
