...
func (c *Client) addOperationListServiceQuotaIncreaseRequestsInTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListServiceQuotaIncreaseRequestsInTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
