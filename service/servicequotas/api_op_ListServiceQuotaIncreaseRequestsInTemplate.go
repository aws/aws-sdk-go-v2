...
func addOperationListServiceQuotaIncreaseRequestsInTemplateStackSlots(stack *middleware.Stack) error {
...
func addOperationListServiceQuotaIncreaseRequestsInTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListServiceQuotaIncreaseRequestsInTemplateStackSlots(stack); err != nil {
		return err
	}
