...
func (c *Client) ListServiceQuotaIncreaseRequestsInTemplate(ctx context.Context, params *ListServiceQuotaIncreaseRequestsInTemplateInput, optFns ...func(*Options)) (*ListServiceQuotaIncreaseRequestsInTemplateOutput, error) {
	if params == nil { params = &ListServiceQuotaIncreaseRequestsInTemplateInput{} }
...
func (c *Client) addOperationListServiceQuotaIncreaseRequestsInTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListServiceQuotaIncreaseRequestsInTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListServiceQuotaIncreaseRequestsInTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListServiceQuotaIncreaseRequestsInTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListServiceQuotaIncreaseRequestsInTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListServiceQuotaIncreaseRequestsInTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListServiceQuotaIncreaseRequestsInTemplateResolveEndpointMiddleware{
