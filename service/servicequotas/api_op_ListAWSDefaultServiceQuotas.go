...
func (c *Client) ListAWSDefaultServiceQuotas(ctx context.Context, params *ListAWSDefaultServiceQuotasInput, optFns ...func(*Options)) (*ListAWSDefaultServiceQuotasOutput, error) {
	if params == nil { params = &ListAWSDefaultServiceQuotasInput{} }
...
func (c *Client) addOperationListAWSDefaultServiceQuotasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAWSDefaultServiceQuotasResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAWSDefaultServiceQuotasResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAWSDefaultServiceQuotasResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAWSDefaultServiceQuotasResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAWSDefaultServiceQuotasResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAWSDefaultServiceQuotasResolveEndpointMiddleware{
