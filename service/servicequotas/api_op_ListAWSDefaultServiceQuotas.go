...
func (c *Client) addOperationListAWSDefaultServiceQuotasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAWSDefaultServiceQuotas", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
