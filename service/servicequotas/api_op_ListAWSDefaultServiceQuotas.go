...
func addOperationListAWSDefaultServiceQuotasStackSlots(stack *middleware.Stack) error {
...
func addOperationListAWSDefaultServiceQuotasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListAWSDefaultServiceQuotasStackSlots(stack); err != nil {
		return err
	}
