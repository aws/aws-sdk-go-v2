...
func addOperationListRequestedServiceQuotaChangeHistoryStackSlots(stack *middleware.Stack) error {
...
func addOperationListRequestedServiceQuotaChangeHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListRequestedServiceQuotaChangeHistoryStackSlots(stack); err != nil {
		return err
	}
