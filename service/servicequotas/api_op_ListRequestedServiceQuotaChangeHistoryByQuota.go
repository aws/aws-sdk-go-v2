...
func (c *Client) addOperationListRequestedServiceQuotaChangeHistoryByQuotaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRequestedServiceQuotaChangeHistoryByQuota", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
