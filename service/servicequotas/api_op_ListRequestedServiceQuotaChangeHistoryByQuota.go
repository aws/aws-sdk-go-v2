...
func addOperationListRequestedServiceQuotaChangeHistoryByQuotaStackSlots(stack *middleware.Stack) error {
...
func addOperationListRequestedServiceQuotaChangeHistoryByQuotaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListRequestedServiceQuotaChangeHistoryByQuotaStackSlots(stack); err != nil {
		return err
	}
