...
func (c *Client) addOperationPutServiceQuotaIncreaseRequestIntoTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutServiceQuotaIncreaseRequestIntoTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
