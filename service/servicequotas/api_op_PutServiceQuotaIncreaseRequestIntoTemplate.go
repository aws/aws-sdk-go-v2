...
func (c *Client) PutServiceQuotaIncreaseRequestIntoTemplate(ctx context.Context, params *PutServiceQuotaIncreaseRequestIntoTemplateInput, optFns ...func(*Options)) (*PutServiceQuotaIncreaseRequestIntoTemplateOutput, error) {
	if params == nil { params = &PutServiceQuotaIncreaseRequestIntoTemplateInput{} }
...
func (c *Client) addOperationPutServiceQuotaIncreaseRequestIntoTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutServiceQuotaIncreaseRequestIntoTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutServiceQuotaIncreaseRequestIntoTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutServiceQuotaIncreaseRequestIntoTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutServiceQuotaIncreaseRequestIntoTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutServiceQuotaIncreaseRequestIntoTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutServiceQuotaIncreaseRequestIntoTemplateResolveEndpointMiddleware{
