...
func (c *Client) addOperationGetServiceQuotaIncreaseRequestFromTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetServiceQuotaIncreaseRequestFromTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
