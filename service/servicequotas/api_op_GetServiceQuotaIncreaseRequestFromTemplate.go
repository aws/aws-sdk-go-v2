...
func addOperationGetServiceQuotaIncreaseRequestFromTemplateStackSlots(stack *middleware.Stack) error {
...
func addOperationGetServiceQuotaIncreaseRequestFromTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetServiceQuotaIncreaseRequestFromTemplateStackSlots(stack); err != nil {
		return err
	}
