...
func (c *Client) addOperationAssociateServiceQuotaTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateServiceQuotaTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
