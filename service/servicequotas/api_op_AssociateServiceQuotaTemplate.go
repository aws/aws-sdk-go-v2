...
func (v *AssociateServiceQuotaTemplateOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.AssociateServiceQuotaTemplateResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *AssociateServiceQuotaTemplateOutput) SerializeMembers(s smithy.ShapeSerializer) {
}
