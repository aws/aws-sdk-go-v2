...
func (*GetRequestedServiceQuotaChangeInput) operationName() string {
	return "GetRequestedServiceQuotaChange"
}
...
func (c *Client) addOperationGetRequestedServiceQuotaChangeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRequestedServiceQuotaChangeResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetRequestedServiceQuotaChangeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetRequestedServiceQuotaChangeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRequestedServiceQuotaChangeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRequestedServiceQuotaChangeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetRequestedServiceQuotaChangeResolveEndpointMiddleware{
