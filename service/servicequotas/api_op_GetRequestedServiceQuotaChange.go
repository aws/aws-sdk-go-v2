...
func (c *Client) addOperationGetRequestedServiceQuotaChangeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRequestedServiceQuotaChange", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
