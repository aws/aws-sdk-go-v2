...
func addOperationGetRequestedServiceQuotaChangeStackSlots(stack *middleware.Stack) error {
...
func addOperationGetRequestedServiceQuotaChangeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetRequestedServiceQuotaChangeStackSlots(stack); err != nil {
		return err
	}
