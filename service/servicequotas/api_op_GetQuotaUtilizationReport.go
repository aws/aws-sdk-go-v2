...
func (c *Client) addOperationGetQuotaUtilizationReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetQuotaUtilizationReport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
