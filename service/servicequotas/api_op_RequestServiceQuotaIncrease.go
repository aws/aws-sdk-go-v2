...
func addOperationRequestServiceQuotaIncreaseStackSlots(stack *middleware.Stack) error {
...
func addOperationRequestServiceQuotaIncreaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRequestServiceQuotaIncreaseStackSlots(stack); err != nil {
		return err
	}
