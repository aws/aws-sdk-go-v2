...
func (c *Client) addOperationRequestServiceQuotaIncreaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RequestServiceQuotaIncrease", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
