...
func (c *Client) addOperationDeleteServiceQuotaIncreaseRequestFromTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteServiceQuotaIncreaseRequestFromTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
