...
func (c *Client) DeleteServiceQuotaIncreaseRequestFromTemplate(ctx context.Context, params *DeleteServiceQuotaIncreaseRequestFromTemplateInput, optFns ...func(*Options)) (*DeleteServiceQuotaIncreaseRequestFromTemplateOutput, error) {
	if params == nil { params = &DeleteServiceQuotaIncreaseRequestFromTemplateInput{} }
...
func (c *Client) addOperationDeleteServiceQuotaIncreaseRequestFromTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteServiceQuotaIncreaseRequestFromTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteServiceQuotaIncreaseRequestFromTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteServiceQuotaIncreaseRequestFromTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteServiceQuotaIncreaseRequestFromTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteServiceQuotaIncreaseRequestFromTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteServiceQuotaIncreaseRequestFromTemplateResolveEndpointMiddleware{
