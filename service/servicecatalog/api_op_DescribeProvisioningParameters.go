...
func (c *Client) addOperationDescribeProvisioningParametersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeProvisioningParameters", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
