...
func addOperationDescribeProvisioningParametersStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeProvisioningParametersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeProvisioningParametersStackSlots(stack); err != nil {
		return err
	}
