...
func addOperationDescribeProvisionedProductPlanStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeProvisionedProductPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeProvisionedProductPlanStackSlots(stack); err != nil {
		return err
	}
