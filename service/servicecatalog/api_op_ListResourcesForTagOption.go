...
func (c *Client) ListResourcesForTagOption(ctx context.Context, params *ListResourcesForTagOptionInput, optFns ...func(*Options)) (*ListResourcesForTagOptionOutput, error) {
	if params == nil { params = &ListResourcesForTagOptionInput{} }
...
func (c *Client) addOperationListResourcesForTagOptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListResourcesForTagOptionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListResourcesForTagOptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListResourcesForTagOptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListResourcesForTagOptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListResourcesForTagOptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListResourcesForTagOptionResolveEndpointMiddleware{
