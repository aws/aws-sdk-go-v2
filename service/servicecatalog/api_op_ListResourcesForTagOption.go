...
func (c *Client) addOperationListResourcesForTagOptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListResourcesForTagOption", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
