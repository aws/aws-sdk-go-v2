...
func addOperationBatchDisassociateServiceActionFromProvisioningArtifactStackSlots(stack *middleware.Stack) error {
...
func addOperationBatchDisassociateServiceActionFromProvisioningArtifactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationBatchDisassociateServiceActionFromProvisioningArtifactStackSlots(stack); err != nil {
		return err
	}
