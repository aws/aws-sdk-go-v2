...
func (c *Client) BatchDisassociateServiceActionFromProvisioningArtifact(ctx context.Context, params *BatchDisassociateServiceActionFromProvisioningArtifactInput, optFns ...func(*Options)) (*BatchDisassociateServiceActionFromProvisioningArtifactOutput, error) {
	if params == nil { params = &BatchDisassociateServiceActionFromProvisioningArtifactInput{} }
...
func (c *Client) addOperationBatchDisassociateServiceActionFromProvisioningArtifactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchDisassociateServiceActionFromProvisioningArtifactResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchDisassociateServiceActionFromProvisioningArtifactResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchDisassociateServiceActionFromProvisioningArtifactResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchDisassociateServiceActionFromProvisioningArtifactResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchDisassociateServiceActionFromProvisioningArtifactResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchDisassociateServiceActionFromProvisioningArtifactResolveEndpointMiddleware{
