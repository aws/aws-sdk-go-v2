...
func (c *Client) addOperationListStackInstancesForProvisionedProductMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListStackInstancesForProvisionedProductResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListStackInstancesForProvisionedProductResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListStackInstancesForProvisionedProductResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListStackInstancesForProvisionedProductResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListStackInstancesForProvisionedProductResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListStackInstancesForProvisionedProductResolveEndpointMiddleware{
