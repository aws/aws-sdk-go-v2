...
func addOperationListStackInstancesForProvisionedProductStackSlots(stack *middleware.Stack) error {
...
func addOperationListStackInstancesForProvisionedProductMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListStackInstancesForProvisionedProductStackSlots(stack); err != nil {
		return err
	}
