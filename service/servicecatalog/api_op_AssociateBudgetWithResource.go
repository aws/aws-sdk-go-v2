...
func (c *Client) addOperationAssociateBudgetWithResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateBudgetWithResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
