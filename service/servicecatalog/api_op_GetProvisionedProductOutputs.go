...
func (c *Client) addOperationGetProvisionedProductOutputsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetProvisionedProductOutputs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
