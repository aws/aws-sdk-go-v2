...
func (c *Client) CreateServiceAction(ctx context.Context, params *CreateServiceActionInput, optFns ...func(*Options)) (*CreateServiceActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateServiceAction", params, optFns, addOperationCreateServiceActionMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateServiceActionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateServiceActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateServiceActionStackSlots(stack); err != nil {
		return err
	}
