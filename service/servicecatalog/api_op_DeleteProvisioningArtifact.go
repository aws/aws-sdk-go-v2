...
func (c *Client) addOperationDeleteProvisioningArtifactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteProvisioningArtifact", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
