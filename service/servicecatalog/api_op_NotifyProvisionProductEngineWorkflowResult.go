...
func (c *Client) NotifyProvisionProductEngineWorkflowResult(ctx context.Context, params *NotifyProvisionProductEngineWorkflowResultInput, optFns ...func(*Options)) (*NotifyProvisionProductEngineWorkflowResultOutput, error) {
	if params == nil { params = &NotifyProvisionProductEngineWorkflowResultInput{} }
...
func (c *Client) addOperationNotifyProvisionProductEngineWorkflowResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addNotifyProvisionProductEngineWorkflowResultResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
func (m *idempotencyToken_initializeOpNotifyProvisionProductEngineWorkflowResult) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *NotifyProvisionProductEngineWorkflowResultInput ")}
...
type opNotifyProvisionProductEngineWorkflowResultResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opNotifyProvisionProductEngineWorkflowResultResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opNotifyProvisionProductEngineWorkflowResultResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addNotifyProvisionProductEngineWorkflowResultResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opNotifyProvisionProductEngineWorkflowResultResolveEndpointMiddleware{
