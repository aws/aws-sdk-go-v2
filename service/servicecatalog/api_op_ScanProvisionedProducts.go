...
func (c *Client) addOperationScanProvisionedProductsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ScanProvisionedProducts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
