...
func (*ScanProvisionedProductsInput) operationName() string {
...
func (c *Client) addOperationScanProvisionedProductsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addScanProvisionedProductsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opScanProvisionedProductsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opScanProvisionedProductsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opScanProvisionedProductsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addScanProvisionedProductsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opScanProvisionedProductsResolveEndpointMiddleware{
