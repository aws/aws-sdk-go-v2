...
func addOperationGetAWSOrganizationsAccessStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationGetAWSOrganizationsAccessStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetAWSOrganizationsAccessStatusStackSlots(stack); err != nil {
		return err
	}
