...
func (c *Client) addOperationGetAWSOrganizationsAccessStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAWSOrganizationsAccessStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
