...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-service-catalog.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-service-catalog.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-service-catalog.dev",
			expectURL:     aws.String("https://env-service-catalog.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-service-catalog.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-service-catalog.dev",
			expectURL:     aws.String("http://config-service-catalog.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-service-catalog.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-service-catalog.dev",
			clientEndpoint: aws.String("https://client-service-catalog.dev"),
			expectURL:      aws.String("https://client-service-catalog.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SERVICE_CATALOG", c.envService)
			}
