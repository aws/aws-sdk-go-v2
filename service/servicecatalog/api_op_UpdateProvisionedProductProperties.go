...
func addOperationUpdateProvisionedProductPropertiesStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateProvisionedProductPropertiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateProvisionedProductPropertiesStackSlots(stack); err != nil {
		return err
	}
