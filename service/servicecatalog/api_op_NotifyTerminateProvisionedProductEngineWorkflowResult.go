...
func (c *Client) addOperationNotifyTerminateProvisionedProductEngineWorkflowResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "NotifyTerminateProvisionedProductEngineWorkflowResult", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
