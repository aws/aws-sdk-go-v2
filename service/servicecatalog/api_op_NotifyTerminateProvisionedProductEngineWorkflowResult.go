...
func (c *Client) addOperationNotifyTerminateProvisionedProductEngineWorkflowResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "NotifyTerminateProvisionedProductEngineWorkflowResult"), middleware.Before); err != nil {
		return err
	}
