...
func (c *Client) ListProvisioningArtifacts(ctx context.Context, params *ListProvisioningArtifactsInput, optFns ...func(*Options)) (*ListProvisioningArtifactsOutput, error) {
	if params == nil { params = &ListProvisioningArtifactsInput{} }
...
func (c *Client) addOperationListProvisioningArtifactsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListProvisioningArtifactsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListProvisioningArtifactsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListProvisioningArtifactsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListProvisioningArtifactsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListProvisioningArtifactsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListProvisioningArtifactsResolveEndpointMiddleware{
