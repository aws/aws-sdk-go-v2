...
func (c *Client) ListRecordHistory(ctx context.Context, params *ListRecordHistoryInput, optFns ...func(*Options)) (*ListRecordHistoryOutput, error) {
	if params == nil { params = &ListRecordHistoryInput{} }
...
func (c *Client) addOperationListRecordHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRecordHistoryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRecordHistoryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRecordHistoryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRecordHistoryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRecordHistoryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRecordHistoryResolveEndpointMiddleware{
