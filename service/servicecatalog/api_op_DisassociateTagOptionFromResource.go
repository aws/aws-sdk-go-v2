...
func addOperationDisassociateTagOptionFromResourceStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateTagOptionFromResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateTagOptionFromResourceStackSlots(stack); err != nil {
		return err
	}
