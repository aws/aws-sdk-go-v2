...
func (c *Client) addOperationDisassociateTagOptionFromResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateTagOptionFromResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
