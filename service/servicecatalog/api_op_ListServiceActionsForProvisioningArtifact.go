...
func addOperationListServiceActionsForProvisioningArtifactStackSlots(stack *middleware.Stack) error {
...
func addOperationListServiceActionsForProvisioningArtifactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListServiceActionsForProvisioningArtifactStackSlots(stack); err != nil {
		return err
	}
