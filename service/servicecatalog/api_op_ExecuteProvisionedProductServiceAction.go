...
func addOperationExecuteProvisionedProductServiceActionStackSlots(stack *middleware.Stack) error {
...
func addOperationExecuteProvisionedProductServiceActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationExecuteProvisionedProductServiceActionStackSlots(stack); err != nil {
		return err
	}
