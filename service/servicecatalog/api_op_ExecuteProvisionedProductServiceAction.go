...
func (c *Client) addOperationExecuteProvisionedProductServiceActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ExecuteProvisionedProductServiceAction", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
