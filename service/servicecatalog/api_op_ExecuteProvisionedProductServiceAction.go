...
func (*ExecuteProvisionedProductServiceActionInput) operationName() string {
...
func (c *Client) addOperationExecuteProvisionedProductServiceActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addExecuteProvisionedProductServiceActionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opExecuteProvisionedProductServiceActionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opExecuteProvisionedProductServiceActionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opExecuteProvisionedProductServiceActionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addExecuteProvisionedProductServiceActionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opExecuteProvisionedProductServiceActionResolveEndpointMiddleware{
