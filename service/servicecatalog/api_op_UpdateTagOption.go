...
func (c *Client) UpdateTagOption(ctx context.Context, params *UpdateTagOptionInput, optFns ...func(*Options)) (*UpdateTagOptionOutput, error) {
	if params == nil { params = &UpdateTagOptionInput{} }
...
func (c *Client) addOperationUpdateTagOptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateTagOptionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateTagOptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateTagOptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateTagOptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateTagOptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateTagOptionResolveEndpointMiddleware{
