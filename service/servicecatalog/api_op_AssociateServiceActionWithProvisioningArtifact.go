...
func (c *Client) AssociateServiceActionWithProvisioningArtifact(ctx context.Context, params *AssociateServiceActionWithProvisioningArtifactInput, optFns ...func(*Options)) (*AssociateServiceActionWithProvisioningArtifactOutput, error) {
	if params == nil { params = &AssociateServiceActionWithProvisioningArtifactInput{} }
...
func (c *Client) addOperationAssociateServiceActionWithProvisioningArtifactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateServiceActionWithProvisioningArtifactResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateServiceActionWithProvisioningArtifactResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateServiceActionWithProvisioningArtifactResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateServiceActionWithProvisioningArtifactResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateServiceActionWithProvisioningArtifactResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateServiceActionWithProvisioningArtifactResolveEndpointMiddleware{
