...
func addOperationExecuteProvisionedProductPlanStackSlots(stack *middleware.Stack) error {
...
func addOperationExecuteProvisionedProductPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationExecuteProvisionedProductPlanStackSlots(stack); err != nil {
		return err
	}
