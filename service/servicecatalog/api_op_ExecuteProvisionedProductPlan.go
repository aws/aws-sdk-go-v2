...
func (c *Client) addOperationExecuteProvisionedProductPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ExecuteProvisionedProductPlan", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
