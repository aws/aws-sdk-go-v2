...
func (c *Client) addOperationDescribeProvisioningArtifactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeProvisioningArtifact", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
