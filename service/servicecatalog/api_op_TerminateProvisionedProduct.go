...
func addOperationTerminateProvisionedProductStackSlots(stack *middleware.Stack) error {
...
func addOperationTerminateProvisionedProductMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationTerminateProvisionedProductStackSlots(stack); err != nil {
		return err
	}
