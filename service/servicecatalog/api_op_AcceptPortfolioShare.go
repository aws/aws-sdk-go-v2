...
func (*AcceptPortfolioShareInput) operationName() string {
...
func (c *Client) addOperationAcceptPortfolioShareMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAcceptPortfolioShareResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAcceptPortfolioShareResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAcceptPortfolioShareResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAcceptPortfolioShareResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAcceptPortfolioShareResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAcceptPortfolioShareResolveEndpointMiddleware{
