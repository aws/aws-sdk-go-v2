...
func addOperationAssociateProductWithPortfolioStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociateProductWithPortfolioMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociateProductWithPortfolioStackSlots(stack); err != nil {
		return err
	}
