...
func (c *Client) addOperationAssociateProductWithPortfolioMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateProductWithPortfolio", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
