...
func addOperationDescribeProvisionedProductStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeProvisionedProductMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeProvisionedProductStackSlots(stack); err != nil {
		return err
	}
	...
	if err := addOpDescribeProvisionedProductValidationMiddleware(stack); err != nil {
		return err
	}
