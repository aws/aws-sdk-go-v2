...
type UpdateConstraintInput struct {
	...
	// constraint type as follows: LAUNCH You are required to specify either the
	// RoleArn or the LocalRoleName  but can't use both. Specify the RoleArn property
	// as follows: {"RoleArn" : "arn:aws:iam::123456789012:role/LaunchRole"} Specify
	// the LocalRoleName  property as follows: {"LocalRoleName": "SCBasicLaunchRole"}
	...
	// and a STACKSET  constraint. You also cannot have more than one LAUNCH
	// constraint on a product and portfolio. NOTIFICATION Specify the
	...
	// NOT_ALLOWED . STACKSET Specify the Parameters  property as follows:
	// {"Version": "String", "Properties": {"AccountList": [ "String" ], "RegionList":
	// [ "String" ], "AdminRole": "String", "ExecutionRole": "String"}}You cannot
	// have both a LAUNCH  and a STACKSET constraint. You also cannot have more than
	// one STACKSET  constraint on a product and portfolio. Products with a STACKSET
	// constraint will launch an CloudFormation stack set. TEMPLATE Specify the Rules
