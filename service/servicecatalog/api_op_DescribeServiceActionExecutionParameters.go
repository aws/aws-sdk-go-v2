...
func (c *Client) DescribeServiceActionExecutionParameters(ctx context.Context, params *DescribeServiceActionExecutionParametersInput, optFns ...func(*Options)) (*DescribeServiceActionExecutionParametersOutput, error) {
	if params == nil { params = &DescribeServiceActionExecutionParametersInput{} }
...
func (c *Client) addOperationDescribeServiceActionExecutionParametersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeServiceActionExecutionParametersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeServiceActionExecutionParametersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeServiceActionExecutionParametersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeServiceActionExecutionParametersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeServiceActionExecutionParametersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeServiceActionExecutionParametersResolveEndpointMiddleware{
