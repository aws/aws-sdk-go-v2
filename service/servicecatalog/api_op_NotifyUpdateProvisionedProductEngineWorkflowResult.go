...
func (c *Client) NotifyUpdateProvisionedProductEngineWorkflowResult(ctx context.Context, params *NotifyUpdateProvisionedProductEngineWorkflowResultInput, optFns ...func(*Options)) (*NotifyUpdateProvisionedProductEngineWorkflowResultOutput, error) {
	if params == nil { params = &NotifyUpdateProvisionedProductEngineWorkflowResultInput{} }
...
func (c *Client) addOperationNotifyUpdateProvisionedProductEngineWorkflowResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addNotifyUpdateProvisionedProductEngineWorkflowResultResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
func (m *idempotencyToken_initializeOpNotifyUpdateProvisionedProductEngineWorkflowResult) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *NotifyUpdateProvisionedProductEngineWorkflowResultInput ")}
...
type opNotifyUpdateProvisionedProductEngineWorkflowResultResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opNotifyUpdateProvisionedProductEngineWorkflowResultResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opNotifyUpdateProvisionedProductEngineWorkflowResultResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addNotifyUpdateProvisionedProductEngineWorkflowResultResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opNotifyUpdateProvisionedProductEngineWorkflowResultResolveEndpointMiddleware{
