...
func (c *Client) addOperationUpdateProvisionedProductMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateProvisionedProduct", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
