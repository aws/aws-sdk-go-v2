...
func addOperationDisassociateBudgetFromResourceStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateBudgetFromResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateBudgetFromResourceStackSlots(stack); err != nil {
		return err
	}
