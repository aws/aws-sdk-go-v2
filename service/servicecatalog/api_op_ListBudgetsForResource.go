...
func (c *Client) ListBudgetsForResource(ctx context.Context, params *ListBudgetsForResourceInput, optFns ...func(*Options)) (*ListBudgetsForResourceOutput, error) {
	if params == nil { params = &ListBudgetsForResourceInput{} }
...
func (c *Client) addOperationListBudgetsForResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBudgetsForResourceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListBudgetsForResourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListBudgetsForResourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBudgetsForResourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListBudgetsForResourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListBudgetsForResourceResolveEndpointMiddleware{
