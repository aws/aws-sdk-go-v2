...
func addOperationListProvisioningArtifactsForServiceActionStackSlots(stack *middleware.Stack) error {
...
func addOperationListProvisioningArtifactsForServiceActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListProvisioningArtifactsForServiceActionStackSlots(stack); err != nil {
		return err
	}
