...
func addOperationAssociatePrincipalWithPortfolioStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociatePrincipalWithPortfolioMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociatePrincipalWithPortfolioStackSlots(stack); err != nil {
		return err
	}
