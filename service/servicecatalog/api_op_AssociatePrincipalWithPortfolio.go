...
func (c *Client) addOperationAssociatePrincipalWithPortfolioMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociatePrincipalWithPortfolio", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
