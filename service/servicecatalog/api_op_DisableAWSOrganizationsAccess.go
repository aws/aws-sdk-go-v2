...
func (c *Client) addOperationDisableAWSOrganizationsAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisableAWSOrganizationsAccess", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
