...
func (c *Client) SearchProductsAsAdmin(ctx context.Context, params *SearchProductsAsAdminInput, optFns ...func(*Options)) (*SearchProductsAsAdminOutput, error) {
	if params == nil { params = &SearchProductsAsAdminInput{} }
...
func (c *Client) addOperationSearchProductsAsAdminMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSearchProductsAsAdminResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSearchProductsAsAdminResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSearchProductsAsAdminResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSearchProductsAsAdminResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSearchProductsAsAdminResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSearchProductsAsAdminResolveEndpointMiddleware{
