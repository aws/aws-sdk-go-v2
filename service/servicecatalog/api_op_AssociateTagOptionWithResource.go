...
func addOperationAssociateTagOptionWithResourceStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociateTagOptionWithResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociateTagOptionWithResourceStackSlots(stack); err != nil {
		return err
	}
