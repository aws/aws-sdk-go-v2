...
func (c *Client) AssociateTagOptionWithResource(ctx context.Context, params *AssociateTagOptionWithResourceInput, optFns ...func(*Options)) (*AssociateTagOptionWithResourceOutput, error) {
	if params == nil { params = &AssociateTagOptionWithResourceInput{} }
...
func (c *Client) addOperationAssociateTagOptionWithResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateTagOptionWithResourceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateTagOptionWithResourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateTagOptionWithResourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateTagOptionWithResourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateTagOptionWithResourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateTagOptionWithResourceResolveEndpointMiddleware{
