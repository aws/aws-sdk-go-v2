...
func (c *Client) addOperationCreateProvisionedProductPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateProvisionedProductPlan", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
