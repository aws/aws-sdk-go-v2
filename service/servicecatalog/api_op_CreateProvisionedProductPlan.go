...
func addOperationCreateProvisionedProductPlanStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateProvisionedProductPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateProvisionedProductPlanStackSlots(stack); err != nil {
		return err
	}
