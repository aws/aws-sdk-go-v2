...
func (c *Client) CopyProduct(ctx context.Context, params *CopyProductInput, optFns ...func(*Options)) (*CopyProductOutput, error) {
	if params == nil { params = &CopyProductInput{} }
...
func (c *Client) addOperationCopyProductMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCopyProductResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
func (m *idempotencyToken_initializeOpCopyProduct) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *CopyProductInput ")}
...
type opCopyProductResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCopyProductResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCopyProductResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCopyProductResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCopyProductResolveEndpointMiddleware{
