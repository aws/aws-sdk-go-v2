...
func addOperationListProvisionedProductPlansStackSlots(stack *middleware.Stack) error {
...
func addOperationListProvisionedProductPlansMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListProvisionedProductPlansStackSlots(stack); err != nil {
		return err
	}
