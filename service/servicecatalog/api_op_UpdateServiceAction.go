...
func (c *Client) UpdateServiceAction(ctx context.Context, params *UpdateServiceActionInput, optFns ...func(*Options)) (*UpdateServiceActionOutput, error) {
	if params == nil { params = &UpdateServiceActionInput{} }
...
func (c *Client) addOperationUpdateServiceActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateServiceActionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateServiceActionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateServiceActionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateServiceActionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateServiceActionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateServiceActionResolveEndpointMiddleware{
