...
func (c *Client) addOperationDescribeCopyProductStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCopyProductStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
