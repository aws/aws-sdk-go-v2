...
func (c *Client) addOperationListPrincipalsForPortfolioMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPrincipalsForPortfolio", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
