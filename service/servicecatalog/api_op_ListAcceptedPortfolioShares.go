...
func (c *Client) addOperationListAcceptedPortfolioSharesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAcceptedPortfolioShares", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
