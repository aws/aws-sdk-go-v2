...
func addOperationListAcceptedPortfolioSharesStackSlots(stack *middleware.Stack) error {
...
func addOperationListAcceptedPortfolioSharesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListAcceptedPortfolioSharesStackSlots(stack); err != nil {
		return err
	}
