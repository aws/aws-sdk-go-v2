...
func (c *Client) ListLaunchPaths(ctx context.Context, params *ListLaunchPathsInput, optFns ...func(*Options)) (*ListLaunchPathsOutput, error) {
	if params == nil { params = &ListLaunchPathsInput{} }
...
func (c *Client) addOperationListLaunchPathsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLaunchPathsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListLaunchPathsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListLaunchPathsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLaunchPathsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLaunchPathsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListLaunchPathsResolveEndpointMiddleware{
