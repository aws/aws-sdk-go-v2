...
func (c *Client) DescribeTagOption(ctx context.Context, params *DescribeTagOptionInput, optFns ...func(*Options)) (*DescribeTagOptionOutput, error) {
	if params == nil { params = &DescribeTagOptionInput{} }
...
func (c *Client) addOperationDescribeTagOptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeTagOptionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeTagOptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeTagOptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeTagOptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeTagOptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeTagOptionResolveEndpointMiddleware{
