...
func (c *Client) DisassociateProductFromPortfolio(ctx context.Context, params *DisassociateProductFromPortfolioInput, optFns ...func(*Options)) (*DisassociateProductFromPortfolioOutput, error) {
	if params == nil { params = &DisassociateProductFromPortfolioInput{} }
...
func (c *Client) addOperationDisassociateProductFromPortfolioMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateProductFromPortfolioResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateProductFromPortfolioResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateProductFromPortfolioResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateProductFromPortfolioResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateProductFromPortfolioResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateProductFromPortfolioResolveEndpointMiddleware{
