...
func addOperationDisassociateProductFromPortfolioStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateProductFromPortfolioMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateProductFromPortfolioStackSlots(stack); err != nil {
		return err
	}
