...
func (c *Client) addOperationBatchAssociateServiceActionWithProvisioningArtifactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchAssociateServiceActionWithProvisioningArtifact", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
