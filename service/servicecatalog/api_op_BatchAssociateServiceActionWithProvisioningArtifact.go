...
func addOperationBatchAssociateServiceActionWithProvisioningArtifactStackSlots(stack *middleware.Stack) error {
...
func addOperationBatchAssociateServiceActionWithProvisioningArtifactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationBatchAssociateServiceActionWithProvisioningArtifactStackSlots(stack); err != nil {
		return err
	}
