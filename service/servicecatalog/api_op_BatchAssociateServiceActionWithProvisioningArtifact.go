...
func (c *Client) BatchAssociateServiceActionWithProvisioningArtifact(ctx context.Context, params *BatchAssociateServiceActionWithProvisioningArtifactInput, optFns ...func(*Options)) (*BatchAssociateServiceActionWithProvisioningArtifactOutput, error) {
	if params == nil { params = &BatchAssociateServiceActionWithProvisioningArtifactInput{} }
...
func (c *Client) addOperationBatchAssociateServiceActionWithProvisioningArtifactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchAssociateServiceActionWithProvisioningArtifactResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchAssociateServiceActionWithProvisioningArtifactResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchAssociateServiceActionWithProvisioningArtifactResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchAssociateServiceActionWithProvisioningArtifactResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchAssociateServiceActionWithProvisioningArtifactResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchAssociateServiceActionWithProvisioningArtifactResolveEndpointMiddleware{
