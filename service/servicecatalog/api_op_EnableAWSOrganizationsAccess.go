...
func (c *Client) addOperationEnableAWSOrganizationsAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableAWSOrganizationsAccess", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
