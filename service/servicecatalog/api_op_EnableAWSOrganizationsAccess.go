...
func (c *Client) EnableAWSOrganizationsAccess(ctx context.Context, params *EnableAWSOrganizationsAccessInput, optFns ...func(*Options)) (*EnableAWSOrganizationsAccessOutput, error) {
	if params == nil { params = &EnableAWSOrganizationsAccessInput{} }
...
func (c *Client) addOperationEnableAWSOrganizationsAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableAWSOrganizationsAccessResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEnableAWSOrganizationsAccessResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEnableAWSOrganizationsAccessResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableAWSOrganizationsAccessResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableAWSOrganizationsAccessResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEnableAWSOrganizationsAccessResolveEndpointMiddleware{
