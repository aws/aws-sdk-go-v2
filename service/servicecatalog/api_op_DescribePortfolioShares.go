...
func (c *Client) addOperationDescribePortfolioSharesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribePortfolioShares", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
