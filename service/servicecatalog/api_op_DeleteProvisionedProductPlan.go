...
func (c *Client) addOperationDeleteProvisionedProductPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteProvisionedProductPlan", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
