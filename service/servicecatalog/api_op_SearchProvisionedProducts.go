...
func (c *Client) addOperationSearchProvisionedProductsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SearchProvisionedProducts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
