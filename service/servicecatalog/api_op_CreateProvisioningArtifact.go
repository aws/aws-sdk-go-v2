...
func addOperationCreateProvisioningArtifactStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateProvisioningArtifactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateProvisioningArtifactStackSlots(stack); err != nil {
		return err
	}
