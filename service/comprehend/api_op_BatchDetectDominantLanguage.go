...
func (c *Client) addOperationBatchDetectDominantLanguageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDetectDominantLanguage", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
