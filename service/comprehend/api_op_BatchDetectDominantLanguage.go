...
func addOperationBatchDetectDominantLanguageStackSlots(stack *middleware.Stack) error {
...
func addOperationBatchDetectDominantLanguageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationBatchDetectDominantLanguageStackSlots(stack); err != nil {
		return err
	}
