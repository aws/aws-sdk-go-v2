...
func (c *Client) addOperationDescribeTargetedSentimentDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeTargetedSentimentDetectionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
