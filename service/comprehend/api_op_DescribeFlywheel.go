...
func (c *Client) DescribeFlywheel(ctx context.Context, params *DescribeFlywheelInput, optFns ...func(*Options)) (*DescribeFlywheelOutput, error) {
	if params == nil { params = &DescribeFlywheelInput{} }
...
func (c *Client) addOperationDescribeFlywheelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeFlywheelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeFlywheelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeFlywheelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeFlywheelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeFlywheelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeFlywheelResolveEndpointMiddleware{
