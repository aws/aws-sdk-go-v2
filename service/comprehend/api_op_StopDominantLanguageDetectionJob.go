...
func addOperationStopDominantLanguageDetectionJobStackSlots(stack *middleware.Stack) error {
...
func addOperationStopDominantLanguageDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStopDominantLanguageDetectionJobStackSlots(stack); err != nil {
		return err
	}
