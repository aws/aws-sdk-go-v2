...
func (c *Client) addOperationStopDominantLanguageDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopDominantLanguageDetectionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
