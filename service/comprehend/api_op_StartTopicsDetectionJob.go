...
func (c *Client) addOperationStartTopicsDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartTopicsDetectionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
