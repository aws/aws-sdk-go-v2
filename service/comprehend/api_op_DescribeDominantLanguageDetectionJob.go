...
func (c *Client) addOperationDescribeDominantLanguageDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDominantLanguageDetectionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
