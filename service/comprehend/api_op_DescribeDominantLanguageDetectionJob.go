...
func addOperationDescribeDominantLanguageDetectionJobStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeDominantLanguageDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeDominantLanguageDetectionJobStackSlots(stack); err != nil {
		return err
	}
