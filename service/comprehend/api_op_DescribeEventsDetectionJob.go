...
func (c *Client) addOperationDescribeEventsDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEventsDetectionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
