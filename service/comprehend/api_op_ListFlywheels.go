...
func (c *Client) ListFlywheels(ctx context.Context, params *ListFlywheelsInput, optFns ...func(*Options)) (*ListFlywheelsOutput, error) {
	if params == nil { params = &ListFlywheelsInput{} }
...
func (c *Client) addOperationListFlywheelsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFlywheelsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListFlywheelsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListFlywheelsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFlywheelsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFlywheelsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListFlywheelsResolveEndpointMiddleware{
