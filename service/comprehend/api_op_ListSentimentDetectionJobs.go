...
func addOperationListSentimentDetectionJobsStackSlots(stack *middleware.Stack) error {
...
func addOperationListSentimentDetectionJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListSentimentDetectionJobsStackSlots(stack); err != nil {
		return err
	}
