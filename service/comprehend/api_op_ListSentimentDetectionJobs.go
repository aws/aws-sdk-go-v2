...
func (*ListSentimentDetectionJobsInput) operationName() string {
...
func (c *Client) addOperationListSentimentDetectionJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSentimentDetectionJobsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListSentimentDetectionJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListSentimentDetectionJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSentimentDetectionJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSentimentDetectionJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListSentimentDetectionJobsResolveEndpointMiddleware{
