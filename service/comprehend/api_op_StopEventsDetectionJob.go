...
func (c *Client) StopEventsDetectionJob(ctx context.Context, params *StopEventsDetectionJobInput, optFns ...func(*Options)) (*StopEventsDetectionJobOutput, error) {
	if params == nil { params = &StopEventsDetectionJobInput{} }
...
func (c *Client) addOperationStopEventsDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopEventsDetectionJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopEventsDetectionJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopEventsDetectionJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopEventsDetectionJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopEventsDetectionJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopEventsDetectionJobResolveEndpointMiddleware{
