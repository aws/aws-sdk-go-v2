...
func (c *Client) StartKeyPhrasesDetectionJob(ctx context.Context, params *StartKeyPhrasesDetectionJobInput, optFns ...func(*Options)) (*StartKeyPhrasesDetectionJobOutput, error) {
	stack := middleware.NewStack("StartKeyPhrasesDetectionJob", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpStartKeyPhrasesDetectionJobMiddlewares(stack)
...
func addawsAwsjson11_serdeOpStartKeyPhrasesDetectionJobMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpStartKeyPhrasesDetectionJob{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpStartKeyPhrasesDetectionJob{}, middleware.After)
}
...
func addIdempotencyToken_opStartKeyPhrasesDetectionJobMiddleware(stack *middleware.Stack, cfg Options) {
	stack.Initialize.Add(&idempotencyToken_initializeOpStartKeyPhrasesDetectionJob{tokenProvider: cfg.IdempotencyTokenProvider}, middleware.Before)
}
