...
func addOperationStartKeyPhrasesDetectionJobStackSlots(stack *middleware.Stack) error {
...
func addOperationStartKeyPhrasesDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartKeyPhrasesDetectionJobStackSlots(stack); err != nil {
		return err
	}
