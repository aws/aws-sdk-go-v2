...
func (c *Client) addOperationDetectTargetedSentimentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DetectTargetedSentiment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
