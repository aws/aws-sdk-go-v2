...
func addOperationStartDominantLanguageDetectionJobStackSlots(stack *middleware.Stack) error {
...
func addOperationStartDominantLanguageDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartDominantLanguageDetectionJobStackSlots(stack); err != nil {
		return err
	}
