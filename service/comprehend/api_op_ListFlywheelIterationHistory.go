...
func (c *Client) addOperationListFlywheelIterationHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFlywheelIterationHistory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
