...
func (*DeleteEntityRecognizerInput) operationName() string {
...
func (c *Client) addOperationDeleteEntityRecognizerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteEntityRecognizerResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteEntityRecognizerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteEntityRecognizerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteEntityRecognizerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteEntityRecognizerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteEntityRecognizerResolveEndpointMiddleware{
