...
func (c *Client) addOperationStopPiiEntitiesDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopPiiEntitiesDetectionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
