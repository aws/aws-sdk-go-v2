...
func (c *Client) DeleteFlywheel(ctx context.Context, params *DeleteFlywheelInput, optFns ...func(*Options)) (*DeleteFlywheelOutput, error) {
	if params == nil { params = &DeleteFlywheelInput{} }
...
func (c *Client) addOperationDeleteFlywheelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteFlywheelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteFlywheelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteFlywheelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteFlywheelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteFlywheelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteFlywheelResolveEndpointMiddleware{
