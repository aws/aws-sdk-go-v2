...
func (*UpdateFlywheelInput) operationName() string {
...
func (c *Client) addOperationUpdateFlywheelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateFlywheelResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateFlywheelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateFlywheelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateFlywheelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateFlywheelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateFlywheelResolveEndpointMiddleware{
