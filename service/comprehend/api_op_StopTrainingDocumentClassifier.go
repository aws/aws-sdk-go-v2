...
func (c *Client) StopTrainingDocumentClassifier(ctx context.Context, params *StopTrainingDocumentClassifierInput, optFns ...func(*Options)) (*StopTrainingDocumentClassifierOutput, error) {
	if params == nil { params = &StopTrainingDocumentClassifierInput{} }
...
func (c *Client) addOperationStopTrainingDocumentClassifierMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopTrainingDocumentClassifierResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopTrainingDocumentClassifierResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopTrainingDocumentClassifierResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopTrainingDocumentClassifierResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopTrainingDocumentClassifierResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopTrainingDocumentClassifierResolveEndpointMiddleware{
