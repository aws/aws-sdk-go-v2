...
func addOperationStopTrainingDocumentClassifierStackSlots(stack *middleware.Stack) error {
...
func addOperationStopTrainingDocumentClassifierMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStopTrainingDocumentClassifierStackSlots(stack); err != nil {
		return err
	}
