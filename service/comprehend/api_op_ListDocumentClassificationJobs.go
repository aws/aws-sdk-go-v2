...
func (*ListDocumentClassificationJobsInput) operationName() string {
...
func (c *Client) addOperationListDocumentClassificationJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDocumentClassificationJobsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListDocumentClassificationJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListDocumentClassificationJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDocumentClassificationJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDocumentClassificationJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListDocumentClassificationJobsResolveEndpointMiddleware{
