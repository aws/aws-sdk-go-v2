...
func (c *Client) ListEntityRecognizerSummaries(ctx context.Context, params *ListEntityRecognizerSummariesInput, optFns ...func(*Options)) (*ListEntityRecognizerSummariesOutput, error) {
	if params == nil { params = &ListEntityRecognizerSummariesInput{} }
...
func (c *Client) addOperationListEntityRecognizerSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEntityRecognizerSummariesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListEntityRecognizerSummariesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListEntityRecognizerSummariesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEntityRecognizerSummariesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEntityRecognizerSummariesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListEntityRecognizerSummariesResolveEndpointMiddleware{
