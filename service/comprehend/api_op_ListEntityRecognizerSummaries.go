...
func (c *Client) addOperationListEntityRecognizerSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEntityRecognizerSummaries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
