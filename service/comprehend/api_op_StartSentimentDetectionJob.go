...
func addOperationStartSentimentDetectionJobStackSlots(stack *middleware.Stack) error {
...
func addOperationStartSentimentDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartSentimentDetectionJobStackSlots(stack); err != nil {
		return err
	}
