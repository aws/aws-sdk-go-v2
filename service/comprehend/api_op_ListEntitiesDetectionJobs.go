...
func (*ListEntitiesDetectionJobsInput) operationName() string {
...
func (c *Client) addOperationListEntitiesDetectionJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEntitiesDetectionJobsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListEntitiesDetectionJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListEntitiesDetectionJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEntitiesDetectionJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEntitiesDetectionJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListEntitiesDetectionJobsResolveEndpointMiddleware{
