...
func addOperationDescribeDocumentClassificationJobStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeDocumentClassificationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeDocumentClassificationJobStackSlots(stack); err != nil {
		return err
	}
