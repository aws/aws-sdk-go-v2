...
func (c *Client) addOperationDescribeKeyPhrasesDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeKeyPhrasesDetectionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
