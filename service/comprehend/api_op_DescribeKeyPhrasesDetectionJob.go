...
func addOperationDescribeKeyPhrasesDetectionJobStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeKeyPhrasesDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeKeyPhrasesDetectionJobStackSlots(stack); err != nil {
		return err
	}
