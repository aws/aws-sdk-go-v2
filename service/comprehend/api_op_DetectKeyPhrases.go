...
func (c *Client) DetectKeyPhrases(ctx context.Context, params *DetectKeyPhrasesInput, optFns ...func(*Options)) (*DetectKeyPhrasesOutput, error) {
	if params == nil { params = &DetectKeyPhrasesInput{} }
...
func (c *Client) addOperationDetectKeyPhrasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDetectKeyPhrasesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDetectKeyPhrasesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDetectKeyPhrasesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDetectKeyPhrasesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDetectKeyPhrasesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDetectKeyPhrasesResolveEndpointMiddleware{
