...
func addOperationListDominantLanguageDetectionJobsStackSlots(stack *middleware.Stack) error {
...
func addOperationListDominantLanguageDetectionJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListDominantLanguageDetectionJobsStackSlots(stack); err != nil {
		return err
	}
