...
func (c *Client) addOperationListDominantLanguageDetectionJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDominantLanguageDetectionJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
