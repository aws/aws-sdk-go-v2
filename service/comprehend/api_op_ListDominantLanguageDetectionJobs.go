...
func (c *Client) ListDominantLanguageDetectionJobs(ctx context.Context, params *ListDominantLanguageDetectionJobsInput, optFns ...func(*Options)) (*ListDominantLanguageDetectionJobsOutput, error) {
	if params == nil { params = &ListDominantLanguageDetectionJobsInput{} }
...
func (c *Client) addOperationListDominantLanguageDetectionJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDominantLanguageDetectionJobsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDominantLanguageDetectionJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDominantLanguageDetectionJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDominantLanguageDetectionJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDominantLanguageDetectionJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDominantLanguageDetectionJobsResolveEndpointMiddleware{
