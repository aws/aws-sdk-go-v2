...
func addOperationDetectPiiEntitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpDetectPiiEntitiesValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opDetectPiiEntities(options.Region), middleware.Before)
