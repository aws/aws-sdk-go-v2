...
// it is put into the TRAINED; otherwise the training job is stopped and putted
// into the STOPPED state and the service sends back an HTTP 200 response with an
// empty HTTP body.
