...
func addOperationStopTrainingEntityRecognizerStackSlots(stack *middleware.Stack) error {
...
func addOperationStopTrainingEntityRecognizerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStopTrainingEntityRecognizerStackSlots(stack); err != nil {
		return err
	}
