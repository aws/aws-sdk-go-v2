...
func (c *Client) addOperationStopTrainingEntityRecognizerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopTrainingEntityRecognizer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
