...
func (c *Client) StopTrainingEntityRecognizer(ctx context.Context, params *StopTrainingEntityRecognizerInput, optFns ...func(*Options)) (*StopTrainingEntityRecognizerOutput, error) {
	if params == nil { params = &StopTrainingEntityRecognizerInput{} }
...
func (c *Client) addOperationStopTrainingEntityRecognizerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopTrainingEntityRecognizerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopTrainingEntityRecognizerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopTrainingEntityRecognizerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopTrainingEntityRecognizerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopTrainingEntityRecognizerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopTrainingEntityRecognizerResolveEndpointMiddleware{
