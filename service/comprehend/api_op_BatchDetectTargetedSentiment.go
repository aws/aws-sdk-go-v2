...
func (c *Client) addOperationBatchDetectTargetedSentimentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDetectTargetedSentiment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
