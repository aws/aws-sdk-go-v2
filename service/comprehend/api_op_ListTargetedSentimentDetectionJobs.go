...
func (c *Client) ListTargetedSentimentDetectionJobs(ctx context.Context, params *ListTargetedSentimentDetectionJobsInput, optFns ...func(*Options)) (*ListTargetedSentimentDetectionJobsOutput, error) {
	if params == nil { params = &ListTargetedSentimentDetectionJobsInput{} }
...
func (c *Client) addOperationListTargetedSentimentDetectionJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTargetedSentimentDetectionJobsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTargetedSentimentDetectionJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTargetedSentimentDetectionJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTargetedSentimentDetectionJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTargetedSentimentDetectionJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTargetedSentimentDetectionJobsResolveEndpointMiddleware{
