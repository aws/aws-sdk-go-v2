...
func (c *Client) addOperationListTargetedSentimentDetectionJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTargetedSentimentDetectionJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
