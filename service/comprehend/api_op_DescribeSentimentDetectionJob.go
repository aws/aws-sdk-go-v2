...
func (c *Client) addOperationDescribeSentimentDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSentimentDetectionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
