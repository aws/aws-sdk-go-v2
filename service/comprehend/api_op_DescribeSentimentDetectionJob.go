...
func (*DescribeSentimentDetectionJobInput) operationName() string {
...
func (c *Client) addOperationDescribeSentimentDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeSentimentDetectionJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeSentimentDetectionJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeSentimentDetectionJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeSentimentDetectionJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeSentimentDetectionJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeSentimentDetectionJobResolveEndpointMiddleware{
