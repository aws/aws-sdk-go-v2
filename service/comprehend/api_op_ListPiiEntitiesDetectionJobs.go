...
func (c *Client) addOperationListPiiEntitiesDetectionJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPiiEntitiesDetectionJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
