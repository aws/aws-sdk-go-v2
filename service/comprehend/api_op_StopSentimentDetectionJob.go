...
func (c *Client) addOperationStopSentimentDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopSentimentDetectionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
