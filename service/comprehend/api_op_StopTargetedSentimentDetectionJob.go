...
func (c *Client) addOperationStopTargetedSentimentDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopTargetedSentimentDetectionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
