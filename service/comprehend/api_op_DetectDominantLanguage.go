...
func (c *Client) DetectDominantLanguage(ctx context.Context, params *DetectDominantLanguageInput, optFns ...func(*Options)) (*DetectDominantLanguageOutput, error) {
	if params == nil { params = &DetectDominantLanguageInput{} }
...
func (c *Client) addOperationDetectDominantLanguageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDetectDominantLanguageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDetectDominantLanguageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDetectDominantLanguageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDetectDominantLanguageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDetectDominantLanguageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDetectDominantLanguageResolveEndpointMiddleware{
