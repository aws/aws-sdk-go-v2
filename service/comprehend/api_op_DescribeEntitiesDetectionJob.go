...
func (c *Client) addOperationDescribeEntitiesDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEntitiesDetectionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
