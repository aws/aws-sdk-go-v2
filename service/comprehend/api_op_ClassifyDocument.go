...
// the input document, the API response includes an entry in Errors that
// describes the errors. If the system detects a document-level error in your input
// document, the API returns an InvalidRequestException error response. For
// details about this exception, see Errors in semi-structured documents (https://docs.aws.amazon.com/comprehend/latest/dg/idp-inputs-sync-err.html)
