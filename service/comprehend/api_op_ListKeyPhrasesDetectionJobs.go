...
func (c *Client) ListKeyPhrasesDetectionJobs(ctx context.Context, params *ListKeyPhrasesDetectionJobsInput, optFns ...func(*Options)) (*ListKeyPhrasesDetectionJobsOutput, error) {
	if params == nil { params = &ListKeyPhrasesDetectionJobsInput{} }
...
func (c *Client) addOperationListKeyPhrasesDetectionJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListKeyPhrasesDetectionJobsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListKeyPhrasesDetectionJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListKeyPhrasesDetectionJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListKeyPhrasesDetectionJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListKeyPhrasesDetectionJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListKeyPhrasesDetectionJobsResolveEndpointMiddleware{
