...
func addOperationListKeyPhrasesDetectionJobsStackSlots(stack *middleware.Stack) error {
...
func addOperationListKeyPhrasesDetectionJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListKeyPhrasesDetectionJobsStackSlots(stack); err != nil {
		return err
	}
