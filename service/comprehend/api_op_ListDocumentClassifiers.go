...
func (c *Client) addOperationListDocumentClassifiersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDocumentClassifiers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
