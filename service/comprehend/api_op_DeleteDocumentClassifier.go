...
func (c *Client) addOperationDeleteDocumentClassifierMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDocumentClassifier", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
