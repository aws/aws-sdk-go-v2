...
func addOperationDescribeDocumentClassifierStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeDocumentClassifierMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeDocumentClassifierStackSlots(stack); err != nil {
		return err
	}
