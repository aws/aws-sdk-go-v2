...
func (c *Client) StopKeyPhrasesDetectionJob(ctx context.Context, params *StopKeyPhrasesDetectionJobInput, optFns ...func(*Options)) (*StopKeyPhrasesDetectionJobOutput, error) {
	if params == nil { params = &StopKeyPhrasesDetectionJobInput{} }
...
func (c *Client) addOperationStopKeyPhrasesDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopKeyPhrasesDetectionJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopKeyPhrasesDetectionJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopKeyPhrasesDetectionJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopKeyPhrasesDetectionJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopKeyPhrasesDetectionJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopKeyPhrasesDetectionJobResolveEndpointMiddleware{
