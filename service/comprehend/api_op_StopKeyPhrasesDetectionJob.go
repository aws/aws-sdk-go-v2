...
func addOperationStopKeyPhrasesDetectionJobStackSlots(stack *middleware.Stack) error {
...
func addOperationStopKeyPhrasesDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStopKeyPhrasesDetectionJobStackSlots(stack); err != nil {
		return err
	}
