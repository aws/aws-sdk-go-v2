...
func (c *Client) addOperationStopKeyPhrasesDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopKeyPhrasesDetectionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
