...
func addOperationStartDocumentClassificationJobStackSlots(stack *middleware.Stack) error {
...
func addOperationStartDocumentClassificationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartDocumentClassificationJobStackSlots(stack); err != nil {
		return err
	}
