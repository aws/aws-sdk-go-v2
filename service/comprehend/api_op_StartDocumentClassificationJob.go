...
func (c *Client) addOperationStartDocumentClassificationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartDocumentClassificationJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
