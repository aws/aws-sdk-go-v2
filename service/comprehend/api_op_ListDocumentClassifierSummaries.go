...
func (c *Client) addOperationListDocumentClassifierSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDocumentClassifierSummaries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
