...
func (v *ListDatasetsInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Filter != nil {
		s.WriteStruct(schemas.ListDatasetsRequest_Filter)
		v.Filter.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.FlywheelArn != nil {
		s.WriteString(schemas.ListDatasetsRequest_FlywheelArn, *v.FlywheelArn)
	}
	if v.MaxResults != nil {
...
func (v *ListDatasetsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	serializeDatasetPropertiesList(s, schemas.ListDatasetsResponse_DatasetPropertiesList, v.DatasetPropertiesList)
	if v.NextToken != nil {
...
func (v *ListDatasetsOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListDatasetsResponse, func(s *smithy.Schema) error {
		switch s {
		case schemas.ListDatasetsResponse_DatasetPropertiesList:
			return deserializeDatasetPropertiesList(d, schemas.ListDatasetsResponse_DatasetPropertiesList, &v.DatasetPropertiesList)
