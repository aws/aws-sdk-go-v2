...
// input records. Every request to BatchMeterUsage is for one product. If you
...
// 6 hours after the event. BatchMeterUsage  can process up to 25 UsageRecords at
// a time. A UsageRecord can optionally include multiple usage allocations, to
...
type BatchMeterUsageOutput struct {
	...
	// Contains all UsageRecords  that were not processed by BatchMeterUsage. This is
