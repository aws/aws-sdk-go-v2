...
func (c *Client) addOperationGetServiceLinkedRoleDeletionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetServiceLinkedRoleDeletionStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
