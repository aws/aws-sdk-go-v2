...
func (c *Client) addOperationGenerateServiceLastAccessedDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GenerateServiceLastAccessedDetails", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
