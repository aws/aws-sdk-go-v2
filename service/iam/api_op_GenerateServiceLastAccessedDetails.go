...
func addOperationGenerateServiceLastAccessedDetailsStackSlots(stack *middleware.Stack) error {
...
func addOperationGenerateServiceLastAccessedDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGenerateServiceLastAccessedDetailsStackSlots(stack); err != nil {
		return err
	}
