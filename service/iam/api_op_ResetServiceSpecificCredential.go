...
func (c *Client) addOperationResetServiceSpecificCredentialMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ResetServiceSpecificCredential", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
