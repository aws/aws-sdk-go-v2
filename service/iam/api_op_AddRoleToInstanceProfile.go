...
func (c *Client) addOperationAddRoleToInstanceProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AddRoleToInstanceProfile", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
