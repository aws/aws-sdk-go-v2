...
type ListEntitiesForPolicyInput struct {
	...
	// EntityFilter is Role, only the roles that are attached to the specified policy
	// are returned. This parameter is optional. If it is not included, all attached
	// entities (users, groups, and roles) are returned. The argument for this
	...
	// is not included, it defaults to a slash (/), listing all entities. This
