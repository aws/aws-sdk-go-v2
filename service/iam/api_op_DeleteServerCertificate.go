...
func (c *Client) addOperationDeleteServerCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteServerCertificate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
