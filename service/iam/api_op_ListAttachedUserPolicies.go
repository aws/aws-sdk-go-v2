...
func (c *Client) addOperationListAttachedUserPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAttachedUserPolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
