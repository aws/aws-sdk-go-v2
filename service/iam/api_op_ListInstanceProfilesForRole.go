...
func addOperationListInstanceProfilesForRoleStackSlots(stack *middleware.Stack) error {
...
func addOperationListInstanceProfilesForRoleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListInstanceProfilesForRoleStackSlots(stack); err != nil {
		return err
	}
