...
func (c *Client) ListUsers(ctx context.Context, params *ListUsersInput, optFns ...func(*Options)) (*ListUsersOutput, error) {
	...
	addawsAwsquery_serdeOpListUsersMiddlewares(stack)
...
func addawsAwsquery_serdeOpListUsersMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpListUsers{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpListUsers{}, middleware.After)
}
