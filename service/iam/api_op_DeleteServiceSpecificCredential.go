...
func (c *Client) addOperationDeleteServiceSpecificCredentialMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteServiceSpecificCredential", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
