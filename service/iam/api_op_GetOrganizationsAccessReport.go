...
func (c *Client) addOperationGetOrganizationsAccessReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetOrganizationsAccessReport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
