...
func addOperationGetOrganizationsAccessReportStackSlots(stack *middleware.Stack) error {
...
func addOperationGetOrganizationsAccessReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetOrganizationsAccessReportStackSlots(stack); err != nil {
		return err
	}
