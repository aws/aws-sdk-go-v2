...
// IAM group. A user can also have managed policies attached to it. To attach a
// managed policy to a group, use AttachGroupPolicy. To create a new managed
...
// POST rather than GET when calling PutGroupPolicy. For general information
// about using the Query API with IAM, see Making query requests (https://docs.aws.amazon.com/IAM/latest/UserGuide/IAM_UsingQueryAPI.html)
