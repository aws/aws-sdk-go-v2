...
func addOperationListServiceSpecificCredentialsStackSlots(stack *middleware.Stack) error {
...
func addOperationListServiceSpecificCredentialsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListServiceSpecificCredentialsStackSlots(stack); err != nil {
		return err
	}
