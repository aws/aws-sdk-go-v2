...
func addOperationDeleteOpenIDConnectProviderStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteOpenIDConnectProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteOpenIDConnectProviderStackSlots(stack); err != nil {
		return err
	}
