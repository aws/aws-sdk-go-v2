...
func addOperationUpdateServiceSpecificCredentialStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateServiceSpecificCredentialMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateServiceSpecificCredentialStackSlots(stack); err != nil {
		return err
	}
