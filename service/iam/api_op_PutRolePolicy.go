...
// IAM role. When you embed an inline policy in a role, the inline policy is used
// as part of the role's access (permissions) policy. The role's trust policy is
...
// IAM roles, see Using roles to delegate permissions and federate identities (https://docs.aws.amazon.com/IAM/latest/UserGuide/roles-toplevel.html)
