...
func (c *Client) addOperationUpdateServerCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateServerCertificate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
