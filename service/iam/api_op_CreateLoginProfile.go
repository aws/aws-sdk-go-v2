...
// Users page in the IAM console to create a password for any IAM user. Use
// ChangePasswordto update your own existing password in the My Security
// Credentials page in the Amazon Web Services Management Console. For more
// information about managing passwords, see Managing passwords (https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_ManagingLogins.html)
...
type CreateLoginProfileInput struct {
	...
	// exist. This parameter allows (through its regex pattern (http://wikipedia.org/wiki/regex)
