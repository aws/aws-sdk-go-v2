...
func (c *Client) addOperationGetOutboundWebIdentityFederationInfoMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetOutboundWebIdentityFederationInfo", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
