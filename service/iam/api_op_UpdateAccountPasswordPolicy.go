...
func addOperationUpdateAccountPasswordPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateAccountPasswordPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateAccountPasswordPolicyStackSlots(stack); err != nil {
		return err
	}
