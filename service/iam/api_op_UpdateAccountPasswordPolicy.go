...
func (c *Client) addOperationUpdateAccountPasswordPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAccountPasswordPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
