...
func (c *Client) addOperationDeleteSigningCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteSigningCertificate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
