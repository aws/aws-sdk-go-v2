...
func (c *Client) addOperationCreateDelegationRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateDelegationRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
