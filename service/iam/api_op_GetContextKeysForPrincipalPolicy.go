...
func addOperationGetContextKeysForPrincipalPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationGetContextKeysForPrincipalPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetContextKeysForPrincipalPolicyStackSlots(stack); err != nil {
		return err
	}
