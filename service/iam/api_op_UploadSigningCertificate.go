...
func (c *Client) addOperationUploadSigningCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UploadSigningCertificate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
