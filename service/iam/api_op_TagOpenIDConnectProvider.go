...
func (c *Client) addOperationTagOpenIDConnectProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "TagOpenIDConnectProvider", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
