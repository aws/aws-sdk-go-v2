...
func (c *Client) ListGroups(ctx context.Context, params *ListGroupsInput, optFns ...func(*Options)) (*ListGroupsOutput, error) {
	...
	addawsAwsquery_serdeOpListGroupsMiddlewares(stack)
...
func addawsAwsquery_serdeOpListGroupsMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpListGroups{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpListGroups{}, middleware.After)
}
