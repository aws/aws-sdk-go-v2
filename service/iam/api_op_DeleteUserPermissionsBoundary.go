...
func addOperationDeleteUserPermissionsBoundaryStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteUserPermissionsBoundaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteUserPermissionsBoundaryStackSlots(stack); err != nil {
		return err
	}
