...
func (c *Client) addOperationDeleteUserPermissionsBoundaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteUserPermissionsBoundary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
