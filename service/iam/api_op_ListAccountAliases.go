...
func (c *Client) ListAccountAliases(ctx context.Context, params *ListAccountAliasesInput, optFns ...func(*Options)) (*ListAccountAliasesOutput, error) {
	stack := middleware.NewStack("ListAccountAliases", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsquery_serdeOpListAccountAliasesMiddlewares(stack)
	...
	stack.Initialize.Add(newServiceMetadataMiddleware_opListAccountAliases(options.Region), middleware.Before)
...
func addawsAwsquery_serdeOpListAccountAliasesMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpListAccountAliases{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpListAccountAliases{}, middleware.After)
}
