...
// aid in organization and search. For example, you could search for all resources
// with the key name Project and the value MyImportantProject. Or search for all
...
// restrict access to only an IAM role that has a specified tag attached. You can
// also restrict access to only those resources that have a certain tag attached.
