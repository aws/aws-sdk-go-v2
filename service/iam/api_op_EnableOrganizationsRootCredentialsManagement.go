...
func (c *Client) addOperationEnableOrganizationsRootCredentialsManagementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableOrganizationsRootCredentialsManagement", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
