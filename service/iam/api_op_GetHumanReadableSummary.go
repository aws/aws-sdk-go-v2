...
func (c *Client) addOperationGetHumanReadableSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetHumanReadableSummary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
