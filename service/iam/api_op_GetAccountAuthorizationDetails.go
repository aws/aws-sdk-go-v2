...
func (c *Client) addOperationGetAccountAuthorizationDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAccountAuthorizationDetails", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
