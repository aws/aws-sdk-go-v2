...
func addOperationGetAccountAuthorizationDetailsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetAccountAuthorizationDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetAccountAuthorizationDetailsStackSlots(stack); err != nil {
		return err
	}
