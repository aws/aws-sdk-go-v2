...
func addOperationUpdateOpenIDConnectProviderThumbprintStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateOpenIDConnectProviderThumbprintMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateOpenIDConnectProviderThumbprintStackSlots(stack); err != nil {
		return err
	}
