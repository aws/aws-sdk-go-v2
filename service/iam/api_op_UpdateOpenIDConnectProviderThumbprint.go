...
func (c *Client) addOperationUpdateOpenIDConnectProviderThumbprintMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateOpenIDConnectProviderThumbprint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
