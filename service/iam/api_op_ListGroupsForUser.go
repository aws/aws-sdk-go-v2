...
func (c *Client) ListGroupsForUser(ctx context.Context, params *ListGroupsForUserInput, optFns ...func(*Options)) (*ListGroupsForUserOutput, error) {
	stack := middleware.NewStack("ListGroupsForUser", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsquery_serdeOpListGroupsForUserMiddlewares(stack)
	...
	addOpListGroupsForUserValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opListGroupsForUser(options.Region), middleware.Before)
...
func addawsAwsquery_serdeOpListGroupsForUserMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpListGroupsForUser{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpListGroupsForUser{}, middleware.After)
}
