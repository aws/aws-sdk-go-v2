...
func addOperationListPoliciesGrantingServiceAccessStackSlots(stack *middleware.Stack) error {
...
func addOperationListPoliciesGrantingServiceAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListPoliciesGrantingServiceAccessStackSlots(stack); err != nil {
		return err
	}
