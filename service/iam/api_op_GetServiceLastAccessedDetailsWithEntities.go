...
func addOperationGetServiceLastAccessedDetailsWithEntitiesStackSlots(stack *middleware.Stack) error {
...
func addOperationGetServiceLastAccessedDetailsWithEntitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetServiceLastAccessedDetailsWithEntitiesStackSlots(stack); err != nil {
		return err
	}
