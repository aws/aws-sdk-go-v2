...
func (c *Client) addOperationGetServiceLastAccessedDetailsWithEntitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetServiceLastAccessedDetailsWithEntities", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
