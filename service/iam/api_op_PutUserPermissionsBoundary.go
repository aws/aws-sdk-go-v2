...
func (c *Client) addOperationPutUserPermissionsBoundaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutUserPermissionsBoundary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
