...
func (c *Client) addOperationSetSecurityTokenServicePreferencesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SetSecurityTokenServicePreferences", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
