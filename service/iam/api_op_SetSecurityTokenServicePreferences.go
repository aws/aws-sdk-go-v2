...
func addOperationSetSecurityTokenServicePreferencesStackSlots(stack *middleware.Stack) error {
...
func addOperationSetSecurityTokenServicePreferencesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationSetSecurityTokenServicePreferencesStackSlots(stack); err != nil {
		return err
	}
