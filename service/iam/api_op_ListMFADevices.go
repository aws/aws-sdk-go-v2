...
func (c *Client) ListMFADevices(ctx context.Context, params *ListMFADevicesInput, optFns ...func(*Options)) (*ListMFADevicesOutput, error) {
	stack := middleware.NewStack("ListMFADevices", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsquery_serdeOpListMFADevicesMiddlewares(stack)
...
func addawsAwsquery_serdeOpListMFADevicesMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpListMFADevices{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpListMFADevices{}, middleware.After)
}
