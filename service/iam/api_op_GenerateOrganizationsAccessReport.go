...
func addOperationGenerateOrganizationsAccessReportStackSlots(stack *middleware.Stack) error {
...
func addOperationGenerateOrganizationsAccessReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGenerateOrganizationsAccessReportStackSlots(stack); err != nil {
		return err
	}
