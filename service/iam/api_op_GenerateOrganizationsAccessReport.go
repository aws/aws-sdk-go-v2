...
func (c *Client) addOperationGenerateOrganizationsAccessReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GenerateOrganizationsAccessReport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
