...
func (c *Client) addOperationDisableOrganizationsRootSessionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisableOrganizationsRootSessions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
