...
func (c *Client) addOperationGetAccountPasswordPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAccountPasswordPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
