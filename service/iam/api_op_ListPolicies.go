...
// policies, set Scope  to AWS . You can paginate the results using the MaxItems
// and Marker  parameters. For more information about managed policies, see
...
type ListPoliciesInput struct {
	...
	// IAM user, group, or role. When OnlyAttached  is false, or when the parameter
	...
	// permissions policies, set PolicyUsageFilter  to PermissionsPolicy. To list
	...
	// managed policies, set Scope  to AWS. To list only the customer managed
	// policies in your Amazon Web Services account, set Scope  to Local. This
	// parameter is optional. If it is not included, or if it is set to All, all
	// policies are returned.
