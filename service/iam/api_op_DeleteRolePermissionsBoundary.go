...
func (c *Client) addOperationDeleteRolePermissionsBoundaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteRolePermissionsBoundary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
