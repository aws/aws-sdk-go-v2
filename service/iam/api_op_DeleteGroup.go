...
func (c *Client) DeleteGroup(ctx context.Context, params *DeleteGroupInput, optFns ...func(*Options)) (*DeleteGroupOutput, error) {
	...
	addawsAwsquery_serdeOpDeleteGroupMiddlewares(stack)
...
func addawsAwsquery_serdeOpDeleteGroupMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpDeleteGroup{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpDeleteGroup{}, middleware.After)
}
