...
// GetServiceLastAccessedDetailsoperation returns a list of services. This list
...
// ACTION_LEVELgranularity when you generated the report, this operation returns
...
type GetServiceLastAccessedDetailsInput struct {
	...
	// used by the same role within a session, or by the same user when used to call
