...
func addOperationGetServiceLastAccessedDetailsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetServiceLastAccessedDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetServiceLastAccessedDetailsStackSlots(stack); err != nil {
		return err
	}
