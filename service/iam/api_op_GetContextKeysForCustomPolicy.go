...
func addOperationGetContextKeysForCustomPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationGetContextKeysForCustomPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetContextKeysForCustomPolicyStackSlots(stack); err != nil {
		return err
	}
