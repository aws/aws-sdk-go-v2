...
func (c *Client) addOperationListOpenIDConnectProviderTagsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOpenIDConnectProviderTags", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
