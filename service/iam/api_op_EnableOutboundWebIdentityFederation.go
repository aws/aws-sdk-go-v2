...
func (c *Client) addOperationEnableOutboundWebIdentityFederationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableOutboundWebIdentityFederation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
