...
func addOperationAddClientIDToOpenIDConnectProviderStackSlots(stack *middleware.Stack) error {
...
func addOperationAddClientIDToOpenIDConnectProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAddClientIDToOpenIDConnectProviderStackSlots(stack); err != nil {
		return err
	}
