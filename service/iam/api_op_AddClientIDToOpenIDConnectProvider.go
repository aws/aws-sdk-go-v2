...
func (c *Client) addOperationAddClientIDToOpenIDConnectProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AddClientIDToOpenIDConnectProvider", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
