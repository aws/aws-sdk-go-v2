...
func (c *Client) addOperationListOpenIDConnectProvidersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOpenIDConnectProviders", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
