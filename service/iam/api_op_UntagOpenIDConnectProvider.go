...
func (c *Client) addOperationUntagOpenIDConnectProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UntagOpenIDConnectProvider", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
