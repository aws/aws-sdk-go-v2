...
func (c *Client) GetGroup(ctx context.Context, params *GetGroupInput, optFns ...func(*Options)) (*GetGroupOutput, error) {
	...
	addawsAwsquery_serdeOpGetGroupMiddlewares(stack)
...
func addawsAwsquery_serdeOpGetGroupMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpGetGroup{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpGetGroup{}, middleware.After)
}
