...
func addOperationPutRolePermissionsBoundaryStackSlots(stack *middleware.Stack) error {
...
func addOperationPutRolePermissionsBoundaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutRolePermissionsBoundaryStackSlots(stack); err != nil {
		return err
	}
