...
func (c *Client) addOperationPutRolePermissionsBoundaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutRolePermissionsBoundary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
