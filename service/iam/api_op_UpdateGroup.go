...
// example, to change the group named Managers  to MGRs, the principal must have
...
type UpdateGroupInput struct {
	...
	// this is the original name. This parameter allows (through its regex pattern (http://wikipedia.org/wiki/regex)
	...
	// are not distinguished by case. For example, you cannot create resources named
