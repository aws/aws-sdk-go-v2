...
func (c *Client) addOperationDisableOrganizationsRootCredentialsManagementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisableOrganizationsRootCredentialsManagement", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
