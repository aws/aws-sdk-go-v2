...
// per user. You can create service-specific credentials for AWS CodeCommit and
// Amazon Keyspaces (for Apache Cassandra). You can reset the password to a new
// service-generated value by calling ResetServiceSpecificCredential. For more
// information about service-specific credentials, see Using IAM with AWS
