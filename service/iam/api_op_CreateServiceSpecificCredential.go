...
func (c *Client) addOperationCreateServiceSpecificCredentialMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateServiceSpecificCredential", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
