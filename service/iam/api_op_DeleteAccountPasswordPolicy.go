...
func addOperationDeleteAccountPasswordPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteAccountPasswordPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteAccountPasswordPolicyStackSlots(stack); err != nil {
		return err
	}
