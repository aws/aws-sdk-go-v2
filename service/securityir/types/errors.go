...
func (v *SecurityIncidentResponseNotActiveException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SecurityIncidentResponseNotActiveException, func(s *smithy.Schema) error {
		switch s {
		case schemas.SecurityIncidentResponseNotActiveException_message:
			v.Message = new(string)
			return d.ReadString(schemas.SecurityIncidentResponseNotActiveException_message, v.Message)
		}
		return nil
	})
}
