...
type ListBackupsInput struct {
	...
	// The backups from the table specified by BackupType  are listed. Where
	// BackupType can be:
...
type ListBackupsOutput struct {
	...
	// fetch the next page of results. If LastEvaluatedBackupArn is empty, then the
	// last page of results has been processed and there are no more results to be
	// retrieved. If LastEvaluatedBackupArn is not empty, this may or may not
	// indicate that there is more data to be returned. All results are guaranteed to
	// have been returned if and only if no value for LastEvaluatedBackupArn is
	// returned.
