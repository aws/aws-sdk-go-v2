...
// performance degradation, and use the AWS Management Console to monitor resource
// utilization and performance metrics. DynamoDB automatically spreads the data and
