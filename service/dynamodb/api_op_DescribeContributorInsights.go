...
func addOperationDescribeContributorInsightsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeContributorInsightsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeContributorInsightsStackSlots(stack); err != nil {
		return err
	}
