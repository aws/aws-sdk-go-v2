...
// contact Amazon Web Services Support (https://aws.amazon.com/support) to
...
//
// DynamoDB cancels
// a TransactGetItems  request under the following circumstances:
...
// This property is not set for other languages. Transaction cancellation reasons
// are ordered in the order of requested items, if an item has no error it will
// have None  code and Null message. Cancellation reason codes and possible error
// messages:
//   - No Errors:
//   - Code: None
//   - Message: null
