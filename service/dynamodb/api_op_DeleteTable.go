...
// DELETING state, no error is returned. This operation only applies to Version
// 2019.11.21 (Current) (https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html)
