...
// up to 4 concurrent restores (any type of restore) in a given account. You can
// call RestoreTableFromBackup at a maximum rate of 10 times per second. You must
