...
type BatchWriteItemInput struct {
	...
	// - Item - A map of attributes and
	// their values. Each entry in this map consists of an attribute name and an
...
type BatchWriteItemOutput struct {
	...
	// DeleteItem operation on the specified item. The item to be deleted is identified
	// by a Key subelement:
