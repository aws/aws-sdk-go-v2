...
func (c *Client) addOperationListContributorInsightsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListContributorInsights", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
