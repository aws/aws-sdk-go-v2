...
type UpdateItemInput struct {
	...
	// expressions, see Specifying Conditions (https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.SpecifyingConditions.html)
	// in the Amazon DynamoDB Developer Guide.
	...
	// information about expression attribute names, see Specifying Item Attributes (https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.AccessingItemAttributes.html)
	// in the Amazon DynamoDB Developer Guide.
	...
	// read capacity units are consumed. The values returned are strongly consistent.
	...
	// a=:value1, b=:value2 DELETE :value3, :value4, :value5For more information on
...
type UpdateItemOutput struct {
	...
	// ReturnItemCollectionMetricsparameter was specified. If the table does not have
