...
func (c *Client) addOperationUpdateGlobalTableSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateGlobalTableSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
