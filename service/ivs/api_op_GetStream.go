...
func (c *Client) GetStream(ctx context.Context, params *GetStreamInput, optFns ...func(*Options)) (*GetStreamOutput, error) {
	if params == nil { params = &GetStreamInput{} }
...
func (c *Client) addOperationGetStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetStreamResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetStreamResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetStreamResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetStreamResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetStreamResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetStreamResolveEndpointMiddleware{
