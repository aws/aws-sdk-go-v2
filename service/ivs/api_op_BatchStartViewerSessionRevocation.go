...
func (c *Client) BatchStartViewerSessionRevocation(ctx context.Context, params *BatchStartViewerSessionRevocationInput, optFns ...func(*Options)) (*BatchStartViewerSessionRevocationOutput, error) {
	if params == nil { params = &BatchStartViewerSessionRevocationInput{} }
...
func (c *Client) addOperationBatchStartViewerSessionRevocationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchStartViewerSessionRevocationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchStartViewerSessionRevocationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchStartViewerSessionRevocationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchStartViewerSessionRevocationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchStartViewerSessionRevocationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchStartViewerSessionRevocationResolveEndpointMiddleware{
