...
func (c *Client) addOperationBatchStartViewerSessionRevocationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchStartViewerSessionRevocation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
