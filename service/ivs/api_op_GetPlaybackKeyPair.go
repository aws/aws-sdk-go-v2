...
func (*GetPlaybackKeyPairInput) operationName() string {
...
func (c *Client) addOperationGetPlaybackKeyPairMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPlaybackKeyPairResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetPlaybackKeyPairResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetPlaybackKeyPairResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPlaybackKeyPairResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPlaybackKeyPairResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetPlaybackKeyPairResolveEndpointMiddleware{
