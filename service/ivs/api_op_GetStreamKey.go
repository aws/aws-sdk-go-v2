...
func (c *Client) GetStreamKey(ctx context.Context, params *GetStreamKeyInput, optFns ...func(*Options)) (*GetStreamKeyOutput, error) {
	if params == nil { params = &GetStreamKeyInput{} }
...
func (c *Client) addOperationGetStreamKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetStreamKeyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetStreamKeyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetStreamKeyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetStreamKeyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetStreamKeyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetStreamKeyResolveEndpointMiddleware{
