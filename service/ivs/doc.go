...
//     Amazon Web Services region where the API request is processed. This list can be
...
//     you will get an error (409 Conflict Exception).
//
// UpdateChannel
//   - — Updates a channel's configuration. This does not affect an ongoing stream
//     of this channel. You must stop and restart the stream for the changes to take
//     effect.
//
// DeleteChannel
...
//     specified channel ARN and viewer ID. Optionally, you can provide a version to
//     revoke viewer sessions less than and including that version.
//
...
//     used in conjunction with DeleteStreamKeyto prevent further streaming to a channel.
//
// PutMetadata
