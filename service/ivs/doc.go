...
// the stream key like a secret, since it allows anyone to stream to the channel.
// -
...
// - GetChannel — Gets the
// channel configuration for the specified channel ARN.
// - BatchGetChannel —
...
// - ImportPlaybackKeyPair — Imports the public portion of a
// new key pair and returns its arn and fingerprint. The privateKey can then be
...
// - DeleteRecordingConfiguration — Deletes the
