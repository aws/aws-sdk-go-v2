...
// Package ivs provides the API client, operations, and parameter types for
...
// including errors. The API is an Amazon Web Services regional service. For a list
// of supported regions and Amazon IVS HTTPS service endpoints, see the Amazon
// IVS page (https://docs.aws.amazon.com/general/latest/gr/ivs.html)in the Amazon
// Web Services General Reference. All API request parameters and URLs are case
...
// information about your IVS live stream (see Getting Started with Amazon IVS (https://docs.aws.amazon.com/ivs/latest/userguide/getting-started.html)
// ):
...
//
// PlaybackKeyPair Endpoints For more information, see Setting Up Private Channels (https://docs.aws.amazon.com/ivs/latest/userguide/private-channels.html)
