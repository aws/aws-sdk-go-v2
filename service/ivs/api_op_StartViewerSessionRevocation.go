...
func (c *Client) StartViewerSessionRevocation(ctx context.Context, params *StartViewerSessionRevocationInput, optFns ...func(*Options)) (*StartViewerSessionRevocationOutput, error) {
	if params == nil { params = &StartViewerSessionRevocationInput{} }
...
func (c *Client) addOperationStartViewerSessionRevocationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartViewerSessionRevocationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartViewerSessionRevocationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartViewerSessionRevocationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartViewerSessionRevocationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartViewerSessionRevocationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartViewerSessionRevocationResolveEndpointMiddleware{
