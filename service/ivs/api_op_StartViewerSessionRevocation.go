...
func (c *Client) addOperationStartViewerSessionRevocationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartViewerSessionRevocation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
