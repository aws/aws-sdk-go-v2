...
func (c *Client) addOperationListPlaybackRestrictionPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPlaybackRestrictionPolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
