...
func (c *Client) PutMetadata(ctx context.Context, params *PutMetadataInput, optFns ...func(*Options)) (*PutMetadataOutput, error) {
	stack := middleware.NewStack("PutMetadata", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpPutMetadataMiddlewares(stack)
...
func addawsRestjson1_serdeOpPutMetadataMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpPutMetadata{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpPutMetadata{}, middleware.After)
}
