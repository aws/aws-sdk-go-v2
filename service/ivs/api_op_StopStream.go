...
func (*StopStreamInput) operationName() string {
	return "StopStream"
}
...
func (c *Client) addOperationStopStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopStreamResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopStreamResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopStreamResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopStreamResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopStreamResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopStreamResolveEndpointMiddleware{
