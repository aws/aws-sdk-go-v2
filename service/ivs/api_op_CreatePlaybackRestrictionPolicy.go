...
func (c *Client) addOperationCreatePlaybackRestrictionPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreatePlaybackRestrictionPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
