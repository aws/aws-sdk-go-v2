...
func (c *Client) addOperationGetEnabledControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetEnabledControlResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetEnabledControlResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetEnabledControlResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetEnabledControlResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetEnabledControlResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetEnabledControlResolveEndpointMiddleware{
