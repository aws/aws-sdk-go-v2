...
func (c *Client) DisableControl(ctx context.Context, params *DisableControlInput, optFns ...func(*Options)) (*DisableControlOutput, error) {
	if params == nil { params = &DisableControlInput{} }
...
func (c *Client) addOperationDisableControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableControlResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisableControlResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisableControlResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableControlResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableControlResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisableControlResolveEndpointMiddleware{
