...
func (c *Client) addOperationListLandingZoneOperationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListLandingZoneOperations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
