...
func (c *Client) DescribeSNOMEDCTInferenceJob(ctx context.Context, params *DescribeSNOMEDCTInferenceJobInput, optFns ...func(*Options)) (*DescribeSNOMEDCTInferenceJobOutput, error) {
	if params == nil { params = &DescribeSNOMEDCTInferenceJobInput{} }
...
func (c *Client) addOperationDescribeSNOMEDCTInferenceJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeSNOMEDCTInferenceJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeSNOMEDCTInferenceJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeSNOMEDCTInferenceJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeSNOMEDCTInferenceJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeSNOMEDCTInferenceJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeSNOMEDCTInferenceJobResolveEndpointMiddleware{
