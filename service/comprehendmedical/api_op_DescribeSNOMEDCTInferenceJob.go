...
func (c *Client) addOperationDescribeSNOMEDCTInferenceJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSNOMEDCTInferenceJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
