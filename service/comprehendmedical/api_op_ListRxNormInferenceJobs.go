...
func (c *Client) addOperationListRxNormInferenceJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRxNormInferenceJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
