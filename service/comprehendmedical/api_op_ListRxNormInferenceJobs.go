...
func (c *Client) ListRxNormInferenceJobs(ctx context.Context, params *ListRxNormInferenceJobsInput, optFns ...func(*Options)) (*ListRxNormInferenceJobsOutput, error) {
	if params == nil { params = &ListRxNormInferenceJobsInput{} }
...
func (c *Client) addOperationListRxNormInferenceJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRxNormInferenceJobsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRxNormInferenceJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRxNormInferenceJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRxNormInferenceJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRxNormInferenceJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRxNormInferenceJobsResolveEndpointMiddleware{
