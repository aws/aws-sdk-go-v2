...
func (c *Client) addOperationDescribePHIDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribePHIDetectionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
