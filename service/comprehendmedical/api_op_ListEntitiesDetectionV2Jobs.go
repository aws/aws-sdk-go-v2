...
func addOperationListEntitiesDetectionV2JobsStackSlots(stack *middleware.Stack) error {
...
func addOperationListEntitiesDetectionV2JobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListEntitiesDetectionV2JobsStackSlots(stack); err != nil {
		return err
	}
