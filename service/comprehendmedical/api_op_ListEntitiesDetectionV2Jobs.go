...
func (*ListEntitiesDetectionV2JobsInput) operationName() string {
...
func (c *Client) addOperationListEntitiesDetectionV2JobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEntitiesDetectionV2JobsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListEntitiesDetectionV2JobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListEntitiesDetectionV2JobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEntitiesDetectionV2JobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEntitiesDetectionV2JobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListEntitiesDetectionV2JobsResolveEndpointMiddleware{
