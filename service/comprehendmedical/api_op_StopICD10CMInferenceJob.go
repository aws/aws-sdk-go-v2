...
func (c *Client) StopICD10CMInferenceJob(ctx context.Context, params *StopICD10CMInferenceJobInput, optFns ...func(*Options)) (*StopICD10CMInferenceJobOutput, error) {
	if params == nil { params = &StopICD10CMInferenceJobInput{} }
...
func (c *Client) addOperationStopICD10CMInferenceJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopICD10CMInferenceJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopICD10CMInferenceJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopICD10CMInferenceJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopICD10CMInferenceJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopICD10CMInferenceJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopICD10CMInferenceJobResolveEndpointMiddleware{
