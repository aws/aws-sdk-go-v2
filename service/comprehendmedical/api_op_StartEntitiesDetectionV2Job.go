...
func addOperationStartEntitiesDetectionV2JobStackSlots(stack *middleware.Stack) error {
...
func addOperationStartEntitiesDetectionV2JobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartEntitiesDetectionV2JobStackSlots(stack); err != nil {
		return err
	}
