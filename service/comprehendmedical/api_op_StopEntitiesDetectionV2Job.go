...
func addOperationStopEntitiesDetectionV2JobStackSlots(stack *middleware.Stack) error {
...
func addOperationStopEntitiesDetectionV2JobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStopEntitiesDetectionV2JobStackSlots(stack); err != nil {
		return err
	}
