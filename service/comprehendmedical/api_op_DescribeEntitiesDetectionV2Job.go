...
func addOperationDescribeEntitiesDetectionV2JobStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeEntitiesDetectionV2JobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeEntitiesDetectionV2JobStackSlots(stack); err != nil {
		return err
	}
