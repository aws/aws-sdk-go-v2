...
func (c *Client) ListS3Buckets(ctx context.Context, params *ListS3BucketsInput, optFns ...func(*Options)) (*ListS3BucketsOutput, error) {
	if params == nil { params = &ListS3BucketsInput{} }
...
func (c *Client) addOperationListS3BucketsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListS3BucketsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListS3BucketsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListS3BucketsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListS3BucketsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListS3BucketsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListS3BucketsResolveEndpointMiddleware{
