...
func (c *Client) ImportBackendAuth(ctx context.Context, params *ImportBackendAuthInput, optFns ...func(*Options)) (*ImportBackendAuthOutput, error) {
	if params == nil { params = &ImportBackendAuthInput{} }
...
func (c *Client) addOperationImportBackendAuthMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addImportBackendAuthResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opImportBackendAuthResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opImportBackendAuthResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opImportBackendAuthResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addImportBackendAuthResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opImportBackendAuthResolveEndpointMiddleware{
