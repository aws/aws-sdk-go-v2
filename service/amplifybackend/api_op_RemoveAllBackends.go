...
func (c *Client) RemoveAllBackends(ctx context.Context, params *RemoveAllBackendsInput, optFns ...func(*Options)) (*RemoveAllBackendsOutput, error) {
	if params == nil { params = &RemoveAllBackendsInput{} }
...
func (c *Client) addOperationRemoveAllBackendsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRemoveAllBackendsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRemoveAllBackendsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRemoveAllBackendsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRemoveAllBackendsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRemoveAllBackendsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRemoveAllBackendsResolveEndpointMiddleware{
