...
func (c *Client) ImportBackendStorage(ctx context.Context, params *ImportBackendStorageInput, optFns ...func(*Options)) (*ImportBackendStorageOutput, error) {
	if params == nil { params = &ImportBackendStorageInput{} }
...
func (c *Client) addOperationImportBackendStorageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addImportBackendStorageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opImportBackendStorageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opImportBackendStorageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opImportBackendStorageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addImportBackendStorageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opImportBackendStorageResolveEndpointMiddleware{
