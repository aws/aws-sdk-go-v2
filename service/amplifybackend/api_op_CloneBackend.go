...
func (c *Client) CloneBackend(ctx context.Context, params *CloneBackendInput, optFns ...func(*Options)) (*CloneBackendOutput, error) {
	if params == nil { params = &CloneBackendInput{} }
...
func (c *Client) addOperationCloneBackendMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCloneBackendResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCloneBackendResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCloneBackendResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCloneBackendResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCloneBackendResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCloneBackendResolveEndpointMiddleware{
