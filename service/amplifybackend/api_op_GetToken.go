...
func (*GetTokenInput) operationName() string {
	return "GetToken"
}
...
func (c *Client) addOperationGetTokenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTokenResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetTokenResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetTokenResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTokenResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTokenResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetTokenResolveEndpointMiddleware{
