...
func (c *Client) CreateBackendStorage(ctx context.Context, params *CreateBackendStorageInput, optFns ...func(*Options)) (*CreateBackendStorageOutput, error) {
	if params == nil { params = &CreateBackendStorageInput{} }
...
func (c *Client) addOperationCreateBackendStorageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateBackendStorageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateBackendStorageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateBackendStorageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateBackendStorageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateBackendStorageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateBackendStorageResolveEndpointMiddleware{
