...
func (c *Client) UpdateBackendAPI(ctx context.Context, params *UpdateBackendAPIInput, optFns ...func(*Options)) (*UpdateBackendAPIOutput, error) {
	if params == nil { params = &UpdateBackendAPIInput{} }
...
func (c *Client) addOperationUpdateBackendAPIMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateBackendAPIResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateBackendAPIResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateBackendAPIResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateBackendAPIResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateBackendAPIResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateBackendAPIResolveEndpointMiddleware{
