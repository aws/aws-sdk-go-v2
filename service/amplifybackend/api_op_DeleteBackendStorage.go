...
func (c *Client) DeleteBackendStorage(ctx context.Context, params *DeleteBackendStorageInput, optFns ...func(*Options)) (*DeleteBackendStorageOutput, error) {
	if params == nil { params = &DeleteBackendStorageInput{} }
...
func (c *Client) addOperationDeleteBackendStorageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteBackendStorageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteBackendStorageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteBackendStorageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteBackendStorageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteBackendStorageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteBackendStorageResolveEndpointMiddleware{
