...
func (c *Client) GetBackendAuth(ctx context.Context, params *GetBackendAuthInput, optFns ...func(*Options)) (*GetBackendAuthOutput, error) {
	if params == nil { params = &GetBackendAuthInput{} }
...
func (c *Client) addOperationGetBackendAuthMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBackendAuthResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetBackendAuthResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetBackendAuthResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetBackendAuthResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBackendAuthResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetBackendAuthResolveEndpointMiddleware{
