...
func (*UpdateBackendStorageInput) operationName() string {
...
func (c *Client) addOperationUpdateBackendStorageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateBackendStorageResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateBackendStorageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateBackendStorageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateBackendStorageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateBackendStorageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateBackendStorageResolveEndpointMiddleware{
