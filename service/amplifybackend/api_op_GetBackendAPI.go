...
func (*GetBackendAPIInput) operationName() string {
...
func (c *Client) addOperationGetBackendAPIMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBackendAPIResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetBackendAPIResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetBackendAPIResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetBackendAPIResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBackendAPIResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetBackendAPIResolveEndpointMiddleware{
