...
func (*UpdateBackendAuthInput) operationName() string {
...
func (c *Client) addOperationUpdateBackendAuthMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateBackendAuthResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateBackendAuthResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateBackendAuthResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateBackendAuthResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateBackendAuthResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateBackendAuthResolveEndpointMiddleware{
