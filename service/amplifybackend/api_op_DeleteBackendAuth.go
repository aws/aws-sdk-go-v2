...
func (*DeleteBackendAuthInput) operationName() string {
...
func (c *Client) addOperationDeleteBackendAuthMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteBackendAuthResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteBackendAuthResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteBackendAuthResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteBackendAuthResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteBackendAuthResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteBackendAuthResolveEndpointMiddleware{
