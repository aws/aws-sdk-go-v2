...
func (c *Client) CancelResize(ctx context.Context, params *CancelResizeInput, optFns ...func(*Options)) (*CancelResizeOutput, error) {
	if params == nil { params = &CancelResizeInput{} }
...
func (c *Client) addOperationCancelResizeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelResizeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelResizeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelResizeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelResizeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelResizeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelResizeResolveEndpointMiddleware{
