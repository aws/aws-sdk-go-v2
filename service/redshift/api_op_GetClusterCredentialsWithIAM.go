...
func (c *Client) addOperationGetClusterCredentialsWithIAMMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetClusterCredentialsWithIAM", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
