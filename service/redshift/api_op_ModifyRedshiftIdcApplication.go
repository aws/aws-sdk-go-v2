...
func (c *Client) addOperationModifyRedshiftIdcApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyRedshiftIdcApplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
