...
func addOperationDescribeClusterSubnetGroupsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeClusterSubnetGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeClusterSubnetGroupsStackSlots(stack); err != nil {
		return err
	}
