...
func (c *Client) addOperationBatchModifyClusterSnapshotsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchModifyClusterSnapshots", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
