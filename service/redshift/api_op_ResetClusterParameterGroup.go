...
func addOperationResetClusterParameterGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationResetClusterParameterGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationResetClusterParameterGroupStackSlots(stack); err != nil {
		return err
	}
