...
func (c *Client) addOperationDescribeRedshiftIdcApplicationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRedshiftIdcApplications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
