...
func addOperationDescribeOrderableClusterOptionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeOrderableClusterOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeOrderableClusterOptionsStackSlots(stack); err != nil {
		return err
	}
