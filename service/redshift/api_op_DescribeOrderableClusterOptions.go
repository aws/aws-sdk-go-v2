...
func (c *Client) addOperationDescribeOrderableClusterOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeOrderableClusterOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
