...
func (*ModifyClusterMaintenanceInput) operationName() string {
...
func (c *Client) addOperationModifyClusterMaintenanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addModifyClusterMaintenanceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opModifyClusterMaintenanceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opModifyClusterMaintenanceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opModifyClusterMaintenanceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addModifyClusterMaintenanceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opModifyClusterMaintenanceResolveEndpointMiddleware{
