...
func addOperationModifySnapshotCopyRetentionPeriodStackSlots(stack *middleware.Stack) error {
...
func addOperationModifySnapshotCopyRetentionPeriodMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifySnapshotCopyRetentionPeriodStackSlots(stack); err != nil {
		return err
	}
