...
func (c *Client) addOperationModifySnapshotCopyRetentionPeriodMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifySnapshotCopyRetentionPeriod", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
