...
func (c *Client) addOperationCreateRedshiftIdcApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateRedshiftIdcApplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
