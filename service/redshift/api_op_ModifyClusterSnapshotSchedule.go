...
func (c *Client) addOperationModifyClusterSnapshotScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyClusterSnapshotSchedule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
