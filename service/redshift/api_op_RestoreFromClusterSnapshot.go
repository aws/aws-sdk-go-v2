...
func addOperationRestoreFromClusterSnapshotStackSlots(stack *middleware.Stack) error {
...
func addOperationRestoreFromClusterSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRestoreFromClusterSnapshotStackSlots(stack); err != nil {
		return err
	}
