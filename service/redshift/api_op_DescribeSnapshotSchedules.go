...
func (c *Client) addOperationDescribeSnapshotSchedulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSnapshotSchedules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
