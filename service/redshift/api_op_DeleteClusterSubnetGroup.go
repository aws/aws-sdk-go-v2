...
func (c *Client) addOperationDeleteClusterSubnetGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteClusterSubnetGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
