...
func (c *Client) ResumeCluster(ctx context.Context, params *ResumeClusterInput, optFns ...func(*Options)) (*ResumeClusterOutput, error) {
	if params == nil { params = &ResumeClusterInput{} }
...
func (c *Client) addOperationResumeClusterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResumeClusterResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opResumeClusterResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opResumeClusterResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResumeClusterResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResumeClusterResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opResumeClusterResolveEndpointMiddleware{
