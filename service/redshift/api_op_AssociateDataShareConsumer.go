...
func (c *Client) addOperationAssociateDataShareConsumerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateDataShareConsumer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
