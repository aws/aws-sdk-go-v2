...
func (c *Client) addOperationDescribeCustomDomainAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCustomDomainAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
