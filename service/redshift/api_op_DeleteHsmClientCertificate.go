...
func addOperationDeleteHsmClientCertificateStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteHsmClientCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteHsmClientCertificateStackSlots(stack); err != nil {
		return err
	}
