...
func (*DeleteHsmClientCertificateInput) operationName() string {
...
func (c *Client) addOperationDeleteHsmClientCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteHsmClientCertificateResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteHsmClientCertificateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteHsmClientCertificateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteHsmClientCertificateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteHsmClientCertificateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteHsmClientCertificateResolveEndpointMiddleware{
