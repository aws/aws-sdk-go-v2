...
// (https://docs.aws.amazon.com/redshift/latest/gsg/getting-started.html). If you
// are a database developer, the Amazon Redshift Database Developer Guide
// (https://docs.aws.amazon.com/redshift/latest/dg/welcome.html) explains how to
