...
func (c *Client) AddPartner(ctx context.Context, params *AddPartnerInput, optFns ...func(*Options)) (*AddPartnerOutput, error) {
	if params == nil { params = &AddPartnerInput{} }
...
func (c *Client) addOperationAddPartnerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAddPartnerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAddPartnerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAddPartnerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAddPartnerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAddPartnerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAddPartnerResolveEndpointMiddleware{
