...
func (c *Client) addOperationGetReservedNodeExchangeConfigurationOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetReservedNodeExchangeConfigurationOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
