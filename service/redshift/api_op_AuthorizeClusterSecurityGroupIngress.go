...
func addOperationAuthorizeClusterSecurityGroupIngressStackSlots(stack *middleware.Stack) error {
...
func addOperationAuthorizeClusterSecurityGroupIngressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAuthorizeClusterSecurityGroupIngressStackSlots(stack); err != nil {
		return err
	}
