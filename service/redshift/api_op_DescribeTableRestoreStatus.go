...
func (c *Client) addOperationDescribeTableRestoreStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeTableRestoreStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
