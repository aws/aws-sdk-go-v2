...
func addOperationDescribeTableRestoreStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeTableRestoreStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeTableRestoreStatusStackSlots(stack); err != nil {
		return err
	}
