...
func (c *Client) addOperationDescribeEndpointAuthorizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEndpointAuthorization", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
