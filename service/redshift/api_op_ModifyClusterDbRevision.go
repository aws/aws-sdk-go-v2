...
func (c *Client) addOperationModifyClusterDbRevisionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyClusterDbRevision", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
