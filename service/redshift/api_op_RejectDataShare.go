...
func (c *Client) RejectDataShare(ctx context.Context, params *RejectDataShareInput, optFns ...func(*Options)) (*RejectDataShareOutput, error) {
	if params == nil { params = &RejectDataShareInput{} }
...
func (c *Client) addOperationRejectDataShareMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRejectDataShareResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRejectDataShareResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRejectDataShareResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRejectDataShareResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRejectDataShareResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRejectDataShareResolveEndpointMiddleware{
