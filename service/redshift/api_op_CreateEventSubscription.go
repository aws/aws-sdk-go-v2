...
// that type in your account. If you do not specify either the SourceType nor the
// SourceIdentifier, you will be notified of events generated from all Amazon
// Redshift sources belonging to your account. You must specify a source type if
...
type CreateEventSubscriptionInput struct {
	...
	// Redshift objects in your account. You must specify a source type in order to
