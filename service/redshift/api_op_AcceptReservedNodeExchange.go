...
func (c *Client) addOperationAcceptReservedNodeExchangeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AcceptReservedNodeExchange", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
