...
func addOperationAcceptReservedNodeExchangeStackSlots(stack *middleware.Stack) error {
...
func addOperationAcceptReservedNodeExchangeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAcceptReservedNodeExchangeStackSlots(stack); err != nil {
		return err
	}
