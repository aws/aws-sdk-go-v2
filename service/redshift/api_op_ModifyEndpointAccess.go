...
func (c *Client) ModifyEndpointAccess(ctx context.Context, params *ModifyEndpointAccessInput, optFns ...func(*Options)) (*ModifyEndpointAccessOutput, error) {
	if params == nil { params = &ModifyEndpointAccessInput{} }
...
func (c *Client) addOperationModifyEndpointAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addModifyEndpointAccessResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opModifyEndpointAccessResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opModifyEndpointAccessResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opModifyEndpointAccessResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addModifyEndpointAccessResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opModifyEndpointAccessResolveEndpointMiddleware{
