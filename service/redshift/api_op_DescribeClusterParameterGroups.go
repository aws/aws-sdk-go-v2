...
func addOperationDescribeClusterParameterGroupsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeClusterParameterGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeClusterParameterGroupsStackSlots(stack); err != nil {
		return err
	}
