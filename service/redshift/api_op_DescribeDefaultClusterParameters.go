...
func addOperationDescribeDefaultClusterParametersStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeDefaultClusterParametersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeDefaultClusterParametersStackSlots(stack); err != nil {
		return err
	}
