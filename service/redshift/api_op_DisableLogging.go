...
func (c *Client) DisableLogging(ctx context.Context, params *DisableLoggingInput, optFns ...func(*Options)) (*DisableLoggingOutput, error) {
	if params == nil { params = &DisableLoggingInput{} }
...
func (c *Client) addOperationDisableLoggingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableLoggingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisableLoggingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisableLoggingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableLoggingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableLoggingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisableLoggingResolveEndpointMiddleware{
