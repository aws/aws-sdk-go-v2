...
func (c *Client) addOperationModifyClusterSubnetGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyClusterSubnetGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
