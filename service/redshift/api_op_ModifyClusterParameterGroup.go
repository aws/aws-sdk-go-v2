...
func addOperationModifyClusterParameterGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyClusterParameterGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyClusterParameterGroupStackSlots(stack); err != nil {
		return err
	}
