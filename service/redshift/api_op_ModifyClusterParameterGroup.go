...
func (c *Client) addOperationModifyClusterParameterGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyClusterParameterGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
