...
func addOperationRestoreTableFromClusterSnapshotStackSlots(stack *middleware.Stack) error {
...
func addOperationRestoreTableFromClusterSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRestoreTableFromClusterSnapshotStackSlots(stack); err != nil {
		return err
	}
