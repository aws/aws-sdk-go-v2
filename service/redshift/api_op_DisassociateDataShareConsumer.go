...
func (c *Client) addOperationDisassociateDataShareConsumerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateDataShareConsumer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
