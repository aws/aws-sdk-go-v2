...
func (c *Client) addOperationCreateClusterSubnetGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateClusterSubnetGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
