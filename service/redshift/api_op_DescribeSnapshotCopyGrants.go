...
func (c *Client) addOperationDescribeSnapshotCopyGrantsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSnapshotCopyGrants", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
