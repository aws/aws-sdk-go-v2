...
func (c *Client) PauseCluster(ctx context.Context, params *PauseClusterInput, optFns ...func(*Options)) (*PauseClusterOutput, error) {
	if params == nil { params = &PauseClusterInput{} }
...
func (c *Client) addOperationPauseClusterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPauseClusterResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPauseClusterResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPauseClusterResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPauseClusterResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPauseClusterResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPauseClusterResolveEndpointMiddleware{
