...
func (c *Client) ModifyCluster(ctx context.Context, params *ModifyClusterInput, optFns ...func(*Options)) (*ModifyClusterOutput, error) {
	...
	addawsAwsquery_serdeOpModifyClusterMiddlewares(stack)
...
func addawsAwsquery_serdeOpModifyClusterMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpModifyCluster{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpModifyCluster{}, middleware.After)
}
