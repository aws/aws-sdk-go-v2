...
func addOperationRevokeClusterSecurityGroupIngressStackSlots(stack *middleware.Stack) error {
...
func addOperationRevokeClusterSecurityGroupIngressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRevokeClusterSecurityGroupIngressStackSlots(stack); err != nil {
		return err
	}
