...
func (c *Client) addOperationDescribeDataSharesForProducerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDataSharesForProducer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
