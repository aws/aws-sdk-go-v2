...
func (c *Client) DescribeStorage(ctx context.Context, params *DescribeStorageInput, optFns ...func(*Options)) (*DescribeStorageOutput, error) {
	if params == nil { params = &DescribeStorageInput{} }
...
func (c *Client) addOperationDescribeStorageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeStorageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeStorageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeStorageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeStorageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeStorageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeStorageResolveEndpointMiddleware{
