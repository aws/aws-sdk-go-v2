...
func addOperationPurchaseReservedNodeOfferingStackSlots(stack *middleware.Stack) error {
...
func addOperationPurchaseReservedNodeOfferingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPurchaseReservedNodeOfferingStackSlots(stack); err != nil {
		return err
	}
