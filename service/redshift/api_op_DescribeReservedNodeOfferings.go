...
func (c *Client) addOperationDescribeReservedNodeOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReservedNodeOfferings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
