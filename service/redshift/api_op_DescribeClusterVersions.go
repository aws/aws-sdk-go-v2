...
func (c *Client) addOperationDescribeClusterVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeClusterVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
