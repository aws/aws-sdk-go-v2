...
func addOperationCreateClusterParameterGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateClusterParameterGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateClusterParameterGroupStackSlots(stack); err != nil {
		return err
	}
