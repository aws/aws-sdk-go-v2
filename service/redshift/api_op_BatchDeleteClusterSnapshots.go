...
func (c *Client) addOperationBatchDeleteClusterSnapshotsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDeleteClusterSnapshots", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
