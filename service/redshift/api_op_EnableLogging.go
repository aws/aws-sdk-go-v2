...
func (c *Client) EnableLogging(ctx context.Context, params *EnableLoggingInput, optFns ...func(*Options)) (*EnableLoggingOutput, error) {
	if params == nil { params = &EnableLoggingInput{} }
...
func (c *Client) addOperationEnableLoggingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableLoggingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEnableLoggingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEnableLoggingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableLoggingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableLoggingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEnableLoggingResolveEndpointMiddleware{
