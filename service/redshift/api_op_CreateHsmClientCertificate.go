...
func addOperationCreateHsmClientCertificateStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateHsmClientCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateHsmClientCertificateStackSlots(stack); err != nil {
		return err
	}
