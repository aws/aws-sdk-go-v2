...
func (c *Client) addOperationCreateHsmClientCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateHsmClientCertificate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
