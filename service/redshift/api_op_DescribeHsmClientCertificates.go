...
func addOperationDescribeHsmClientCertificatesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeHsmClientCertificatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeHsmClientCertificatesStackSlots(stack); err != nil {
		return err
	}
