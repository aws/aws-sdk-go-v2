...
func (c *Client) addOperationDescribeHsmClientCertificatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeHsmClientCertificates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
