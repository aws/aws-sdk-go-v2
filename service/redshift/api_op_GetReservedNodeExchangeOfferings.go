...
func addOperationGetReservedNodeExchangeOfferingsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetReservedNodeExchangeOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetReservedNodeExchangeOfferingsStackSlots(stack); err != nil {
		return err
	}
