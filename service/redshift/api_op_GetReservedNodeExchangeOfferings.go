...
func (c *Client) addOperationGetReservedNodeExchangeOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetReservedNodeExchangeOfferings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
