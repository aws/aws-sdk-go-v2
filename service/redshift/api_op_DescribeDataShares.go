...
type DescribeDataSharesInput struct {
	...
	// response records. When the results of a DescribeDataSharesrequest exceed the value specified in
...
func (c *Client) addOperationDescribeDataSharesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDataShares", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
