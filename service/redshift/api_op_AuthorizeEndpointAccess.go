...
func (c *Client) addOperationAuthorizeEndpointAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AuthorizeEndpointAccess", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
