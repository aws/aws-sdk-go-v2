...
func (*ModifySnapshotScheduleInput) operationName() string {
...
func (c *Client) addOperationModifySnapshotScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addModifySnapshotScheduleResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opModifySnapshotScheduleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opModifySnapshotScheduleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opModifySnapshotScheduleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addModifySnapshotScheduleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opModifySnapshotScheduleResolveEndpointMiddleware{
