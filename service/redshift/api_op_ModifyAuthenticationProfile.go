...
func (c *Client) ModifyAuthenticationProfile(ctx context.Context, params *ModifyAuthenticationProfileInput, optFns ...func(*Options)) (*ModifyAuthenticationProfileOutput, error) {
	if params == nil { params = &ModifyAuthenticationProfileInput{} }
...
func (c *Client) addOperationModifyAuthenticationProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addModifyAuthenticationProfileResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opModifyAuthenticationProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opModifyAuthenticationProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opModifyAuthenticationProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addModifyAuthenticationProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opModifyAuthenticationProfileResolveEndpointMiddleware{
