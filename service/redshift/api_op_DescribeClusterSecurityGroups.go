...
func (c *Client) addOperationDescribeClusterSecurityGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeClusterSecurityGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
