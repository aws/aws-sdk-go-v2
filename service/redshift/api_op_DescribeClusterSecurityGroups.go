...
func addOperationDescribeClusterSecurityGroupsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeClusterSecurityGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeClusterSecurityGroupsStackSlots(stack); err != nil {
		return err
	}
