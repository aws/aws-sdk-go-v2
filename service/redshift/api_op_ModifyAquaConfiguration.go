...
func (c *Client) addOperationModifyAquaConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyAquaConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
