...
func addOperationDescribeClusterDbRevisionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeClusterDbRevisionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeClusterDbRevisionsStackSlots(stack); err != nil {
		return err
	}
