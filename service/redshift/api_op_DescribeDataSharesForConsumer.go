...
func (c *Client) addOperationDescribeDataSharesForConsumerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDataSharesForConsumer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
