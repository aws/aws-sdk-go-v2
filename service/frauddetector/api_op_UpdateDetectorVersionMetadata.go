...
func addOperationUpdateDetectorVersionMetadataStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateDetectorVersionMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateDetectorVersionMetadataStackSlots(stack); err != nil {
		return err
	}
