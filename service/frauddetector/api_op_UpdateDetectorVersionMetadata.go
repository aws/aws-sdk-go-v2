...
func (c *Client) addOperationUpdateDetectorVersionMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDetectorVersionMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
