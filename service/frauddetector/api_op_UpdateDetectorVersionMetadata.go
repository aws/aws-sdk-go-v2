...
func (*UpdateDetectorVersionMetadataInput) operationName() string {
...
func (c *Client) addOperationUpdateDetectorVersionMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateDetectorVersionMetadataResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateDetectorVersionMetadataResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateDetectorVersionMetadataResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateDetectorVersionMetadataResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateDetectorVersionMetadataResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateDetectorVersionMetadataResolveEndpointMiddleware{
