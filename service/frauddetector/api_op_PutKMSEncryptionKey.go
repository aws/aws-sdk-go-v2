...
func (c *Client) PutKMSEncryptionKey(ctx context.Context, params *PutKMSEncryptionKeyInput, optFns ...func(*Options)) (*PutKMSEncryptionKeyOutput, error) {
	if params == nil { params = &PutKMSEncryptionKeyInput{} }
...
func (c *Client) addOperationPutKMSEncryptionKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutKMSEncryptionKeyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutKMSEncryptionKeyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutKMSEncryptionKeyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutKMSEncryptionKeyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutKMSEncryptionKeyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutKMSEncryptionKeyResolveEndpointMiddleware{
