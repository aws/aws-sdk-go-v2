...
func (*PutEntityTypeInput) operationName() string {
...
func (c *Client) addOperationPutEntityTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutEntityTypeResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opPutEntityTypeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opPutEntityTypeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutEntityTypeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutEntityTypeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opPutEntityTypeResolveEndpointMiddleware{
