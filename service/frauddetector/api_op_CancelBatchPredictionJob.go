...
func (*CancelBatchPredictionJobInput) operationName() string {
...
func (c *Client) addOperationCancelBatchPredictionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelBatchPredictionJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCancelBatchPredictionJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCancelBatchPredictionJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelBatchPredictionJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelBatchPredictionJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCancelBatchPredictionJobResolveEndpointMiddleware{
