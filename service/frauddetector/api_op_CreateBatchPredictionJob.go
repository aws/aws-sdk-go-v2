...
func (c *Client) addOperationCreateBatchPredictionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateBatchPredictionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
