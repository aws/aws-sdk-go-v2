...
func (c *Client) GetEvent(ctx context.Context, params *GetEventInput, optFns ...func(*Options)) (*GetEventOutput, error) {
	if params == nil { params = &GetEventInput{} }
...
func (c *Client) addOperationGetEventMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetEventResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetEventResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetEventResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetEventResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetEventResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetEventResolveEndpointMiddleware{
