...
func (c *Client) GetRules(ctx context.Context, params *GetRulesInput, optFns ...func(*Options)) (*GetRulesOutput, error) {
	if params == nil { params = &GetRulesInput{} }
...
func (c *Client) addOperationGetRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRulesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRulesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRulesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRulesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRulesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRulesResolveEndpointMiddleware{
