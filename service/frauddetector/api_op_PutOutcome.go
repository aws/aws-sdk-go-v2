...
func (*PutOutcomeInput) operationName() string {
	return "PutOutcome"
}
...
func (c *Client) addOperationPutOutcomeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutOutcomeResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opPutOutcomeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opPutOutcomeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutOutcomeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutOutcomeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opPutOutcomeResolveEndpointMiddleware{
