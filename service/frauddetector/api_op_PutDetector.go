...
func (c *Client) PutDetector(ctx context.Context, params *PutDetectorInput, optFns ...func(*Options)) (*PutDetectorOutput, error) {
	if params == nil { params = &PutDetectorInput{} }
...
func (c *Client) addOperationPutDetectorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutDetectorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutDetectorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutDetectorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutDetectorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutDetectorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutDetectorResolveEndpointMiddleware{
