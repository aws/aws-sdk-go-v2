...
func (c *Client) GetDeleteEventsByEventTypeStatus(ctx context.Context, params *GetDeleteEventsByEventTypeStatusInput, optFns ...func(*Options)) (*GetDeleteEventsByEventTypeStatusOutput, error) {
	if params == nil { params = &GetDeleteEventsByEventTypeStatusInput{} }
...
func (c *Client) addOperationGetDeleteEventsByEventTypeStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDeleteEventsByEventTypeStatusResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDeleteEventsByEventTypeStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDeleteEventsByEventTypeStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDeleteEventsByEventTypeStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDeleteEventsByEventTypeStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDeleteEventsByEventTypeStatusResolveEndpointMiddleware{
