...
func (c *Client) addOperationGetDeleteEventsByEventTypeStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDeleteEventsByEventTypeStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
