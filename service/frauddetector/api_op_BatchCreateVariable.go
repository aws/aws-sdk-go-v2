...
func (c *Client) BatchCreateVariable(ctx context.Context, params *BatchCreateVariableInput, optFns ...func(*Options)) (*BatchCreateVariableOutput, error) {
	if params == nil { params = &BatchCreateVariableInput{} }
...
func (c *Client) addOperationBatchCreateVariableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchCreateVariableResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchCreateVariableResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchCreateVariableResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchCreateVariableResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchCreateVariableResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchCreateVariableResolveEndpointMiddleware{
