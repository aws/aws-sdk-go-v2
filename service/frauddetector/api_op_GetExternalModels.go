...
func (c *Client) GetExternalModels(ctx context.Context, params *GetExternalModelsInput, optFns ...func(*Options)) (*GetExternalModelsOutput, error) {
	if params == nil { params = &GetExternalModelsInput{} }
...
func (c *Client) addOperationGetExternalModelsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetExternalModelsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetExternalModelsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetExternalModelsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetExternalModelsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetExternalModelsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetExternalModelsResolveEndpointMiddleware{
