...
func (c *Client) GetOutcomes(ctx context.Context, params *GetOutcomesInput, optFns ...func(*Options)) (*GetOutcomesOutput, error) {
	if params == nil { params = &GetOutcomesInput{} }
...
func (c *Client) addOperationGetOutcomesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetOutcomesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetOutcomesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetOutcomesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetOutcomesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetOutcomesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetOutcomesResolveEndpointMiddleware{
