...
// Detector permanently deletes that label from the evaluation history, and the
...
func (c *Client) DeleteLabel(ctx context.Context, params *DeleteLabelInput, optFns ...func(*Options)) (*DeleteLabelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLabel", params, optFns, addOperationDeleteLabelMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLabelMiddlewares(stack *middleware.Stack, options Options) (err error) {
