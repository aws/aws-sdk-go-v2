...
func (*CancelBatchImportJobInput) operationName() string {
...
func (c *Client) addOperationCancelBatchImportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelBatchImportJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCancelBatchImportJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCancelBatchImportJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelBatchImportJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelBatchImportJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCancelBatchImportJobResolveEndpointMiddleware{
