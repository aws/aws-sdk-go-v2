...
func (*GetKMSEncryptionKeyInput) operationName() string {
	return "GetKMSEncryptionKey"
}
...
func (c *Client) addOperationGetKMSEncryptionKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetKMSEncryptionKeyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetKMSEncryptionKeyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetKMSEncryptionKeyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetKMSEncryptionKeyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetKMSEncryptionKeyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetKMSEncryptionKeyResolveEndpointMiddleware{
