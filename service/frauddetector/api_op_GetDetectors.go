...
func (c *Client) GetDetectors(ctx context.Context, params *GetDetectorsInput, optFns ...func(*Options)) (*GetDetectorsOutput, error) {
	if params == nil { params = &GetDetectorsInput{} }
...
func (c *Client) addOperationGetDetectorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDetectorsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDetectorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDetectorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDetectorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDetectorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDetectorsResolveEndpointMiddleware{
