...
func (c *Client) addOperationUpdateDetectorVersionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDetectorVersionStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
