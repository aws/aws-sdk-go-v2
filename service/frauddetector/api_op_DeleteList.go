...
func (*DeleteListInput) operationName() string {
	return "DeleteList"
}
...
func (c *Client) addOperationDeleteListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteListResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteListResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteListResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteListResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteListResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteListResolveEndpointMiddleware{
