...
func (c *Client) GetListElements(ctx context.Context, params *GetListElementsInput, optFns ...func(*Options)) (*GetListElementsOutput, error) {
	if params == nil { params = &GetListElementsInput{} }
...
func (c *Client) addOperationGetListElementsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetListElementsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetListElementsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetListElementsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetListElementsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetListElementsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetListElementsResolveEndpointMiddleware{
