...
func (c *Client) UnregisterConnector(ctx context.Context, params *UnregisterConnectorInput, optFns ...func(*Options)) (*UnregisterConnectorOutput, error) {
	if params == nil { params = &UnregisterConnectorInput{} }
...
func (c *Client) addOperationUnregisterConnectorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUnregisterConnectorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUnregisterConnectorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUnregisterConnectorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUnregisterConnectorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUnregisterConnectorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUnregisterConnectorResolveEndpointMiddleware{
