...
func (c *Client) addOperationUpdateConnectorRegistrationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateConnectorRegistration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
