...
func (c *Client) addOperationDescribeFlowExecutionRecordsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeFlowExecutionRecords", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
