...
func addOperationCreateConnectorProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpCreateConnectorProfileValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opCreateConnectorProfile(options.Region), middleware.Before)
