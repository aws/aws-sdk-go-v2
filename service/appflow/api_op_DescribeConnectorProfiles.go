...
func (c *Client) addOperationDescribeConnectorProfilesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConnectorProfiles", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
