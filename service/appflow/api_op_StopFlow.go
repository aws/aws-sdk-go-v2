...
func (c *Client) StopFlow(ctx context.Context, params *StopFlowInput, optFns ...func(*Options)) (*StopFlowOutput, error) {
	if params == nil { params = &StopFlowInput{} }
...
func (c *Client) addOperationStopFlowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopFlowResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopFlowResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopFlowResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopFlowResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopFlowResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopFlowResolveEndpointMiddleware{
