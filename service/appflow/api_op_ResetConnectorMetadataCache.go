...
func (c *Client) addOperationResetConnectorMetadataCacheMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ResetConnectorMetadataCache", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
