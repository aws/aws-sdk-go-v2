...
func (c *Client) ResetConnectorMetadataCache(ctx context.Context, params *ResetConnectorMetadataCacheInput, optFns ...func(*Options)) (*ResetConnectorMetadataCacheOutput, error) {
	if params == nil { params = &ResetConnectorMetadataCacheInput{} }
...
func (c *Client) addOperationResetConnectorMetadataCacheMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResetConnectorMetadataCacheResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opResetConnectorMetadataCacheResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opResetConnectorMetadataCacheResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResetConnectorMetadataCacheResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResetConnectorMetadataCacheResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opResetConnectorMetadataCacheResolveEndpointMiddleware{
