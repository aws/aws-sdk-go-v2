...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-forecastquery.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-forecastquery.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-forecastquery.dev",
			expectURL:     aws.String("https://env-forecastquery.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-forecastquery.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-forecastquery.dev",
			expectURL:     aws.String("http://config-forecastquery.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-forecastquery.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-forecastquery.dev",
			clientEndpoint: aws.String("https://client-forecastquery.dev"),
			expectURL:      aws.String("https://client-forecastquery.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_FORECASTQUERY", c.envService)
			}
