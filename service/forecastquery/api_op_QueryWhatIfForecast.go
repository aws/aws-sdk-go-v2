...
func (c *Client) QueryWhatIfForecast(ctx context.Context, params *QueryWhatIfForecastInput, optFns ...func(*Options)) (*QueryWhatIfForecastOutput, error) {
	if params == nil { params = &QueryWhatIfForecastInput{} }
...
func (c *Client) addOperationQueryWhatIfForecastMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addQueryWhatIfForecastResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opQueryWhatIfForecastResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opQueryWhatIfForecastResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opQueryWhatIfForecastResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addQueryWhatIfForecastResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opQueryWhatIfForecastResolveEndpointMiddleware{
