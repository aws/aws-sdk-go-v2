...
func (c *Client) UpdateWatchlist(ctx context.Context, params *UpdateWatchlistInput, optFns ...func(*Options)) (*UpdateWatchlistOutput, error) {
	if params == nil { params = &UpdateWatchlistInput{} }
...
func (c *Client) addOperationUpdateWatchlistMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateWatchlistResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateWatchlistResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateWatchlistResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateWatchlistResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateWatchlistResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateWatchlistResolveEndpointMiddleware{
