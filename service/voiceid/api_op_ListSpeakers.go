...
func (c *Client) ListSpeakers(ctx context.Context, params *ListSpeakersInput, optFns ...func(*Options)) (*ListSpeakersOutput, error) {
	if params == nil { params = &ListSpeakersInput{} }
...
func (c *Client) addOperationListSpeakersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSpeakersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSpeakersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSpeakersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSpeakersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSpeakersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSpeakersResolveEndpointMiddleware{
