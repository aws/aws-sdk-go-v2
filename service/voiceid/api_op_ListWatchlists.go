...
func (c *Client) ListWatchlists(ctx context.Context, params *ListWatchlistsInput, optFns ...func(*Options)) (*ListWatchlistsOutput, error) {
	if params == nil { params = &ListWatchlistsInput{} }
...
func (c *Client) addOperationListWatchlistsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWatchlistsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListWatchlistsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListWatchlistsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWatchlistsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWatchlistsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListWatchlistsResolveEndpointMiddleware{
