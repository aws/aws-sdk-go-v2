...
func (c *Client) addOperationListFraudsterRegistrationJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFraudsterRegistrationJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
