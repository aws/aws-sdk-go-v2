...
func (c *Client) addOperationStartSpeakerEnrollmentJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartSpeakerEnrollmentJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
