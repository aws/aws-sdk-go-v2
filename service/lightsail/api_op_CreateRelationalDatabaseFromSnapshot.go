...
func addOperationCreateRelationalDatabaseFromSnapshotStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateRelationalDatabaseFromSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateRelationalDatabaseFromSnapshotStackSlots(stack); err != nil {
		return err
	}
