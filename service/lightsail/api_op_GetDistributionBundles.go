...
func (c *Client) GetDistributionBundles(ctx context.Context, params *GetDistributionBundlesInput, optFns ...func(*Options)) (*GetDistributionBundlesOutput, error) {
	if params == nil { params = &GetDistributionBundlesInput{} }
...
func (c *Client) addOperationGetDistributionBundlesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDistributionBundlesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDistributionBundlesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDistributionBundlesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDistributionBundlesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDistributionBundlesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDistributionBundlesResolveEndpointMiddleware{
