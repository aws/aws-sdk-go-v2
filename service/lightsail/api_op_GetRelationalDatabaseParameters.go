...
func addOperationGetRelationalDatabaseParametersStackSlots(stack *middleware.Stack) error {
...
func addOperationGetRelationalDatabaseParametersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetRelationalDatabaseParametersStackSlots(stack); err != nil {
		return err
	}
