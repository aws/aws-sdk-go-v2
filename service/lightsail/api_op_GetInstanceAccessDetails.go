...
func (c *Client) addOperationGetInstanceAccessDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetInstanceAccessDetails", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
