...
func (c *Client) GetRelationalDatabaseBlueprints(ctx context.Context, params *GetRelationalDatabaseBlueprintsInput, optFns ...func(*Options)) (*GetRelationalDatabaseBlueprintsOutput, error) {
	if params == nil { params = &GetRelationalDatabaseBlueprintsInput{} }
...
func (c *Client) addOperationGetRelationalDatabaseBlueprintsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRelationalDatabaseBlueprintsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRelationalDatabaseBlueprintsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRelationalDatabaseBlueprintsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRelationalDatabaseBlueprintsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRelationalDatabaseBlueprintsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRelationalDatabaseBlueprintsResolveEndpointMiddleware{
