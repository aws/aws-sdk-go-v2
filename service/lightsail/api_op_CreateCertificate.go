...
// network (CDN) distribution and a container service. After the certificate is
// valid, use the AttachCertificateToDistribution action to use the certificate
// and its domains with your distribution. Or use the UpdateContainerService
// action to use the certificate and its domains with your container service. Only
// certificates created in the us-east-1 Amazon Web Services Region can be
...
type CreateCertificateInput struct {
	...
	// and subdomains (e.g., blog.example.com) for the certificate. You can specify a
