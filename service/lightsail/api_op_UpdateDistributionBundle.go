...
func (c *Client) addOperationUpdateDistributionBundleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDistributionBundle", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
