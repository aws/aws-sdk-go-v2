...
func (c *Client) GetInstancePortStates(ctx context.Context, params *GetInstancePortStatesInput, optFns ...func(*Options)) (*GetInstancePortStatesOutput, error) {
	if params == nil { params = &GetInstancePortStatesInput{} }
...
func (c *Client) addOperationGetInstancePortStatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetInstancePortStatesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetInstancePortStatesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetInstancePortStatesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetInstancePortStatesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetInstancePortStatesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetInstancePortStatesResolveEndpointMiddleware{
