...
func (c *Client) DetachDisk(ctx context.Context, params *DetachDiskInput, optFns ...func(*Options)) (*DetachDiskOutput, error) {
	if params == nil { params = &DetachDiskInput{} }
...
func (c *Client) addOperationDetachDiskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDetachDiskResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDetachDiskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDetachDiskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDetachDiskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDetachDiskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDetachDiskResolveEndpointMiddleware{
