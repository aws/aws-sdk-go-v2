...
type GetRelationalDatabaseLogEventsInput struct {
	...
	// request. To get a page token, perform an initial GetRelationalDatabaseLogEvents
	// request. If your results are paginated, the response will return a next forward
	// token and/or next backward token that you can specify as the page token in a
	// subsequent request.
	PageToken *string
