...
type GetContainerLogInput struct {
	...
	// example, if you wish to use an end time of October 1, 2018, at 9 PM UTC, specify
	// 1538427600 as the end time.
	//
	// You can convert a human-friendly time to Unix time
	// format using a converter like Epoch converter (https://www.epochconverter.com/).
	EndTime *time.Time
	...
	// pattern of "-ERROR".
	// - To return log events that contain the ERROR term, specify
	// a filter pattern of "ERROR".
	// - To return log events that contain both the ERROR
	// and Exception terms, specify a filter pattern of "ERROR Exception".
	// - To return
	// log events that contain the ERROR or the Exception term, specify a filter
