...
func (c *Client) GetExportSnapshotRecords(ctx context.Context, params *GetExportSnapshotRecordsInput, optFns ...func(*Options)) (*GetExportSnapshotRecordsOutput, error) {
	if params == nil { params = &GetExportSnapshotRecordsInput{} }
...
func (c *Client) addOperationGetExportSnapshotRecordsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetExportSnapshotRecordsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetExportSnapshotRecordsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetExportSnapshotRecordsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetExportSnapshotRecordsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetExportSnapshotRecordsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetExportSnapshotRecordsResolveEndpointMiddleware{
