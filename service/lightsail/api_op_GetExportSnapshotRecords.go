...
func (c *Client) addOperationGetExportSnapshotRecordsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetExportSnapshotRecords", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
