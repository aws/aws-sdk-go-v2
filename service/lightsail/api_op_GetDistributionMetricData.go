...
func (c *Client) addOperationGetDistributionMetricDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDistributionMetricData", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
