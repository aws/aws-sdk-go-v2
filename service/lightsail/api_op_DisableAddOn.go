...
func (c *Client) DisableAddOn(ctx context.Context, params *DisableAddOnInput, optFns ...func(*Options)) (*DisableAddOnOutput, error) {
	if params == nil { params = &DisableAddOnInput{} }
...
func (c *Client) addOperationDisableAddOnMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableAddOnResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisableAddOnResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisableAddOnResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableAddOnResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableAddOnResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisableAddOnResolveEndpointMiddleware{
