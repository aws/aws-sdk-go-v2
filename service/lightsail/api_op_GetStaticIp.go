...
func (c *Client) GetStaticIp(ctx context.Context, params *GetStaticIpInput, optFns ...func(*Options)) (*GetStaticIpOutput, error) {
	if params == nil { params = &GetStaticIpInput{} }
...
func (c *Client) addOperationGetStaticIpMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetStaticIpResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetStaticIpResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetStaticIpResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetStaticIpResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetStaticIpResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetStaticIpResolveEndpointMiddleware{
