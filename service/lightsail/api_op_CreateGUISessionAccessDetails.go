...
func (c *Client) addOperationCreateGUISessionAccessDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateGUISessionAccessDetails", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
