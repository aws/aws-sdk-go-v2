...
func (c *Client) PeerVpc(ctx context.Context, params *PeerVpcInput, optFns ...func(*Options)) (*PeerVpcOutput, error) {
	if params == nil { params = &PeerVpcInput{} }
...
func (c *Client) addOperationPeerVpcMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPeerVpcResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPeerVpcResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPeerVpcResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPeerVpcResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPeerVpcResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPeerVpcResolveEndpointMiddleware{
