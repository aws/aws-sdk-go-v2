...
func (c *Client) GetDisk(ctx context.Context, params *GetDiskInput, optFns ...func(*Options)) (*GetDiskOutput, error) {
	if params == nil { params = &GetDiskInput{} }
...
func (c *Client) addOperationGetDiskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDiskResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDiskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDiskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDiskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDiskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDiskResolveEndpointMiddleware{
