...
func addOperationGetRelationalDatabaseSnapshotStackSlots(stack *middleware.Stack) error {
...
func addOperationGetRelationalDatabaseSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetRelationalDatabaseSnapshotStackSlots(stack); err != nil {
		return err
	}
