...
func (c *Client) addOperationGetLoadBalancerTlsCertificatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetLoadBalancerTlsCertificates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
