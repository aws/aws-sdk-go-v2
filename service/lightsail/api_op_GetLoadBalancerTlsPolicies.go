...
func (c *Client) GetLoadBalancerTlsPolicies(ctx context.Context, params *GetLoadBalancerTlsPoliciesInput, optFns ...func(*Options)) (*GetLoadBalancerTlsPoliciesOutput, error) {
	if params == nil { params = &GetLoadBalancerTlsPoliciesInput{} }
...
func (c *Client) addOperationGetLoadBalancerTlsPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetLoadBalancerTlsPoliciesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetLoadBalancerTlsPoliciesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetLoadBalancerTlsPoliciesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetLoadBalancerTlsPoliciesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetLoadBalancerTlsPoliciesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetLoadBalancerTlsPoliciesResolveEndpointMiddleware{
