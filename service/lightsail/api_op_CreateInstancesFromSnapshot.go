...
func (c *Client) addOperationCreateInstancesFromSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateInstancesFromSnapshot", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
