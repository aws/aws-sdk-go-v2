...
func addOperationCreateInstancesFromSnapshotStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateInstancesFromSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateInstancesFromSnapshotStackSlots(stack); err != nil {
		return err
	}
