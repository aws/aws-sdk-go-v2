...
func addOperationGetCloudFormationStackRecordsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetCloudFormationStackRecordsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetCloudFormationStackRecordsStackSlots(stack); err != nil {
		return err
	}
