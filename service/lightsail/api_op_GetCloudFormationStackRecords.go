...
func (c *Client) GetCloudFormationStackRecords(ctx context.Context, params *GetCloudFormationStackRecordsInput, optFns ...func(*Options)) (*GetCloudFormationStackRecordsOutput, error) {
	if params == nil { params = &GetCloudFormationStackRecordsInput{} }
...
func (c *Client) addOperationGetCloudFormationStackRecordsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCloudFormationStackRecordsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCloudFormationStackRecordsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCloudFormationStackRecordsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCloudFormationStackRecordsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCloudFormationStackRecordsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCloudFormationStackRecordsResolveEndpointMiddleware{
