...
func (c *Client) addOperationGetCloudFormationStackRecordsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCloudFormationStackRecords", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
