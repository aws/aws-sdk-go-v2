...
type GetBucketMetricDataInput struct {
	...
	// - NumberOfObjects - The total number
	// of objects stored in a bucket. This value is calculated by counting all objects
	// in the bucket (including object versions) and the total number of parts for all
	// incomplete multipart uploads to the bucket. Statistics: The most useful
