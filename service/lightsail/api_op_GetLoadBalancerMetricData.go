...
func (c *Client) addOperationGetLoadBalancerMetricDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetLoadBalancerMetricData", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
