...
type GetLoadBalancerMetricDataInput struct {
	...
	// - HTTPCode_Instance_3XX_Count - The number
	// of HTTP 3XX response codes generated by the target instances. This does not
	// include any response codes generated by the load balancer. Statistics: The most
	// useful statistic is Sum. Note that Minimum, Maximum, and Average all return 1.
	// Unit: The published unit is Count.
	// - HTTPCode_Instance_4XX_Count - The number of
	// HTTP 4XX response codes generated by the target instances. This does not include
	// any response codes generated by the load balancer. Statistics: The most useful
	// statistic is Sum. Note that Minimum, Maximum, and Average all return 1. Unit:
	// The published unit is Count.
	// - HTTPCode_Instance_5XX_Count - The number of HTTP
	// 5XX response codes generated by the target instances. This does not include any
	// response codes generated by the load balancer. Statistics: The most useful
	// statistic is Sum. Note that Minimum, Maximum, and Average all return 1. Unit:
	// The published unit is Count.
	// - HTTPCode_LB_4XX_Count - The number of HTTP 4XX
	// client error codes that originated from the load balancer. Client errors are
	...
	// generated by the target instances. Statistics: The most useful statistic is Sum.
	// Note that Minimum, Maximum, and Average all return 1. Unit: The published unit
	// is Count.
	...
	// most useful statistic is Sum. Note that Minimum, Maximum, and Average all return
	// 1. Unit: The published unit is Count.
	// - InstanceResponseTime - The time elapsed,
	// in seconds, after the request leaves the load balancer until a response from the
	// target instance is received. Statistics: The most useful statistic is Average.
	...
	// number of connections. Statistics: The most useful statistic is Sum. Unit: The
	// published unit is Count.
	// - RequestCount - The number of requests processed over
	// IPv4. This count includes only the requests with a response generated by a
	// target instance of the load balancer. Statistics: The most useful statistic is
	// Sum. Note that Minimum, Maximum, and Average all return 1. Unit: The published
	// unit is Count.
	// - UnhealthyHostCount - The number of target instances that are
	// considered unhealthy. Statistics: The most useful statistic are Average,
	// Minimum, and Maximum. Unit: The published unit is Count.
	//
	// This member is required.
