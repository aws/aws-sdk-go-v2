...
func (c *Client) IsVpcPeered(ctx context.Context, params *IsVpcPeeredInput, optFns ...func(*Options)) (*IsVpcPeeredOutput, error) {
	if params == nil { params = &IsVpcPeeredInput{} }
...
func (c *Client) addOperationIsVpcPeeredMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addIsVpcPeeredResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opIsVpcPeeredResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opIsVpcPeeredResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opIsVpcPeeredResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addIsVpcPeeredResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opIsVpcPeeredResolveEndpointMiddleware{
