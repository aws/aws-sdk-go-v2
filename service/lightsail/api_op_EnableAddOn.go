...
func (c *Client) EnableAddOn(ctx context.Context, params *EnableAddOnInput, optFns ...func(*Options)) (*EnableAddOnOutput, error) {
	if params == nil { params = &EnableAddOnInput{} }
...
func (c *Client) addOperationEnableAddOnMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableAddOnResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEnableAddOnResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEnableAddOnResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableAddOnResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableAddOnResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEnableAddOnResolveEndpointMiddleware{
