...
func (c *Client) GetActiveNames(ctx context.Context, params *GetActiveNamesInput, optFns ...func(*Options)) (*GetActiveNamesOutput, error) {
	if params == nil { params = &GetActiveNamesInput{} }
...
func (c *Client) addOperationGetActiveNamesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetActiveNamesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetActiveNamesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetActiveNamesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetActiveNamesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetActiveNamesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetActiveNamesResolveEndpointMiddleware{
