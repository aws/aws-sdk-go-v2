...
func (c *Client) CloseInstancePublicPorts(ctx context.Context, params *CloseInstancePublicPortsInput, optFns ...func(*Options)) (*CloseInstancePublicPortsOutput, error) {
	if params == nil { params = &CloseInstancePublicPortsInput{} }
...
func (c *Client) addOperationCloseInstancePublicPortsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCloseInstancePublicPortsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCloseInstancePublicPortsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCloseInstancePublicPortsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCloseInstancePublicPortsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCloseInstancePublicPortsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCloseInstancePublicPortsResolveEndpointMiddleware{
