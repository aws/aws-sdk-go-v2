...
func (c *Client) PutAlarm(ctx context.Context, params *PutAlarmInput, optFns ...func(*Options)) (*PutAlarmOutput, error) {
	if params == nil { params = &PutAlarmInput{} }
...
func (c *Client) addOperationPutAlarmMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutAlarmResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutAlarmResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutAlarmResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutAlarmResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutAlarmResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutAlarmResolveEndpointMiddleware{
