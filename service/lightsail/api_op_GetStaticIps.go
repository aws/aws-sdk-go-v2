...
func (c *Client) GetStaticIps(ctx context.Context, params *GetStaticIpsInput, optFns ...func(*Options)) (*GetStaticIpsOutput, error) {
	if params == nil { params = &GetStaticIpsInput{} }
...
func (c *Client) addOperationGetStaticIpsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetStaticIpsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetStaticIpsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetStaticIpsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetStaticIpsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetStaticIpsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetStaticIpsResolveEndpointMiddleware{
