...
func (c *Client) OpenInstancePublicPorts(ctx context.Context, params *OpenInstancePublicPortsInput, optFns ...func(*Options)) (*OpenInstancePublicPortsOutput, error) {
	if params == nil { params = &OpenInstancePublicPortsInput{} }
...
func (c *Client) addOperationOpenInstancePublicPortsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addOpenInstancePublicPortsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opOpenInstancePublicPortsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opOpenInstancePublicPortsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opOpenInstancePublicPortsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addOpenInstancePublicPortsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opOpenInstancePublicPortsResolveEndpointMiddleware{
