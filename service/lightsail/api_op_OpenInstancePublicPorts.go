...
func (c *Client) addOperationOpenInstancePublicPortsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "OpenInstancePublicPorts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
