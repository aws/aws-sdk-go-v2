...
func (c *Client) StartGUISession(ctx context.Context, params *StartGUISessionInput, optFns ...func(*Options)) (*StartGUISessionOutput, error) {
	if params == nil { params = &StartGUISessionInput{} }
...
func (c *Client) addOperationStartGUISessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartGUISessionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartGUISessionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartGUISessionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartGUISessionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartGUISessionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartGUISessionResolveEndpointMiddleware{
