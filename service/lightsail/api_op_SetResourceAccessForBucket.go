...
func (c *Client) SetResourceAccessForBucket(ctx context.Context, params *SetResourceAccessForBucketInput, optFns ...func(*Options)) (*SetResourceAccessForBucketOutput, error) {
	if params == nil { params = &SetResourceAccessForBucketInput{} }
...
func (c *Client) addOperationSetResourceAccessForBucketMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetResourceAccessForBucketResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetResourceAccessForBucketResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetResourceAccessForBucketResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetResourceAccessForBucketResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetResourceAccessForBucketResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetResourceAccessForBucketResolveEndpointMiddleware{
