...
func (c *Client) addOperationGetContainerServiceDeploymentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetContainerServiceDeployments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
