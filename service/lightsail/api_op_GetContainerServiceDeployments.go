...
func (*GetContainerServiceDeploymentsInput) operationName() string {
	return "GetContainerServiceDeployments"
}
...
func (c *Client) addOperationGetContainerServiceDeploymentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetContainerServiceDeploymentsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetContainerServiceDeploymentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetContainerServiceDeploymentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetContainerServiceDeploymentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetContainerServiceDeploymentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetContainerServiceDeploymentsResolveEndpointMiddleware{
