...
type CreateContactMethodInput struct {
	...
	// For a list of countries/regions
	// where SMS text messages can be sent, and the latest Amazon Web Services Regions
	// where SMS text messaging is supported, see Supported Regions and Countries (https://docs.aws.amazon.com/sns/latest/dg/sns-supported-regions-countries.html)
