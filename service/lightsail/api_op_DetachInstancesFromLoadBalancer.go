...
func (c *Client) addOperationDetachInstancesFromLoadBalancerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DetachInstancesFromLoadBalancer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
