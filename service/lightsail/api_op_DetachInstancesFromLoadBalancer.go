...
func addOperationDetachInstancesFromLoadBalancerStackSlots(stack *middleware.Stack) error {
...
func addOperationDetachInstancesFromLoadBalancerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDetachInstancesFromLoadBalancerStackSlots(stack); err != nil {
		return err
	}
