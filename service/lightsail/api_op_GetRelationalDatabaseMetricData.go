...
func addOperationGetRelationalDatabaseMetricDataStackSlots(stack *middleware.Stack) error {
...
func addOperationGetRelationalDatabaseMetricDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetRelationalDatabaseMetricDataStackSlots(stack); err != nil {
		return err
	}
