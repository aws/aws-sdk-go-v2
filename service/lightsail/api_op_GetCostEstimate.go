...
func (c *Client) GetCostEstimate(ctx context.Context, params *GetCostEstimateInput, optFns ...func(*Options)) (*GetCostEstimateOutput, error) {
	if params == nil { params = &GetCostEstimateInput{} }
...
func (c *Client) addOperationGetCostEstimateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCostEstimateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCostEstimateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCostEstimateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCostEstimateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCostEstimateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCostEstimateResolveEndpointMiddleware{
