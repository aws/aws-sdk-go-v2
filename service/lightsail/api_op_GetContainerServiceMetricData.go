...
// container service. Metrics report the utilization of your resources. Monitor and
// collect metric data regularly to maintain the reliability, availability, and
...
type GetContainerServiceMetricDataInput struct {
	...
	// The granularity, in seconds, of the returned data points. All container
	// service metric data is available in 5-minute (300 seconds) granularity.
	//
	// This member is required.
	Period int32
