...
func (*DeleteDomainEntryInput) operationName() string {
...
func (c *Client) addOperationDeleteDomainEntryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteDomainEntryResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteDomainEntryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteDomainEntryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteDomainEntryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteDomainEntryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteDomainEntryResolveEndpointMiddleware{
