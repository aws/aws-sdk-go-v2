...
//
// create disk snapshotoperation supports tag-based access control via request
...
type CreateDiskSnapshotInput struct {
	...
	// cannot be defined together with the instance name  parameter. The disk name
	// and instance name  parameters are mutually exclusive.
	DiskName *string
