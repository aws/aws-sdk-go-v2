...
func (c *Client) CreateDiskSnapshot(ctx context.Context, params *CreateDiskSnapshotInput, optFns ...func(*Options)) (*CreateDiskSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDiskSnapshot", params, optFns, addOperationCreateDiskSnapshotMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDiskSnapshotStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateDiskSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateDiskSnapshotStackSlots(stack); err != nil {
		return err
	}
