...
// DeleteLoadBalancerTlsCertificateoperation supports tag-based access control
...
type DeleteLoadBalancerTlsCertificateInput struct {
	...
	// backup. The force parameter is required when the primary SSL/TLS certificate
