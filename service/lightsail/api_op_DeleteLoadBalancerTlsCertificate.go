...
func (c *Client) addOperationDeleteLoadBalancerTlsCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteLoadBalancerTlsCertificate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
