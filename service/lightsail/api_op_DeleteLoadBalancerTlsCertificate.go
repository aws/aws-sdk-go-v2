...
func addOperationDeleteLoadBalancerTlsCertificateStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteLoadBalancerTlsCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteLoadBalancerTlsCertificateStackSlots(stack); err != nil {
		return err
	}
