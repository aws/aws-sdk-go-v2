...
func (*StartRelationalDatabaseInput) operationName() string {
...
func (c *Client) addOperationStartRelationalDatabaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartRelationalDatabaseResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStartRelationalDatabaseResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStartRelationalDatabaseResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartRelationalDatabaseResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartRelationalDatabaseResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStartRelationalDatabaseResolveEndpointMiddleware{
