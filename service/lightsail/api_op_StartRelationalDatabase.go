...
func (c *Client) addOperationStartRelationalDatabaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartRelationalDatabase", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
