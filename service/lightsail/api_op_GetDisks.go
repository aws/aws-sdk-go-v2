...
func (*GetDisksInput) operationName() string {
	return "GetDisks"
}
...
func (c *Client) addOperationGetDisksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDisksResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetDisksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetDisksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDisksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDisksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetDisksResolveEndpointMiddleware{
