...
func (c *Client) addOperationUpdateRelationalDatabaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRelationalDatabase", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
