...
func addOperationAttachInstancesToLoadBalancerStackSlots(stack *middleware.Stack) error {
...
func addOperationAttachInstancesToLoadBalancerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAttachInstancesToLoadBalancerStackSlots(stack); err != nil {
		return err
	}
