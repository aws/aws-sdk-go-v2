...
func (c *Client) addOperationAttachInstancesToLoadBalancerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AttachInstancesToLoadBalancer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
