...
func (c *Client) AttachStaticIp(ctx context.Context, params *AttachStaticIpInput, optFns ...func(*Options)) (*AttachStaticIpOutput, error) {
	if params == nil { params = &AttachStaticIpInput{} }
...
func (c *Client) addOperationAttachStaticIpMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAttachStaticIpResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAttachStaticIpResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAttachStaticIpResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAttachStaticIpResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAttachStaticIpResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAttachStaticIpResolveEndpointMiddleware{
