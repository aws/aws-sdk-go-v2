...
func (c *Client) addOperationUpdateInstanceMetadataOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateInstanceMetadataOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
