...
type CreateRelationalDatabaseInput struct {
	...
	// use. MySQL The name of the database to create when the Lightsail database
	// resource is created. If this parameter isn't specified, no database is created
	// in the database resource. Constraints:
