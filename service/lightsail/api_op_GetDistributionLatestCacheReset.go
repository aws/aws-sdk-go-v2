...
func (c *Client) GetDistributionLatestCacheReset(ctx context.Context, params *GetDistributionLatestCacheResetInput, optFns ...func(*Options)) (*GetDistributionLatestCacheResetOutput, error) {
	if params == nil { params = &GetDistributionLatestCacheResetInput{} }
...
func (c *Client) addOperationGetDistributionLatestCacheResetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDistributionLatestCacheResetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDistributionLatestCacheResetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDistributionLatestCacheResetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDistributionLatestCacheResetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDistributionLatestCacheResetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDistributionLatestCacheResetResolveEndpointMiddleware{
