...
func (c *Client) addOperationGetDistributionLatestCacheResetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDistributionLatestCacheReset", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
