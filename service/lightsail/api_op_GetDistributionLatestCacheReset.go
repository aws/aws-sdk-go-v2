...
func addOperationGetDistributionLatestCacheResetStackSlots(stack *middleware.Stack) error {
...
func addOperationGetDistributionLatestCacheResetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetDistributionLatestCacheResetStackSlots(stack); err != nil {
		return err
	}
