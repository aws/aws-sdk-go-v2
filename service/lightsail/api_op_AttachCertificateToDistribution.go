...
func addOperationAttachCertificateToDistributionStackSlots(stack *middleware.Stack) error {
...
func addOperationAttachCertificateToDistributionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAttachCertificateToDistributionStackSlots(stack); err != nil {
		return err
	}
