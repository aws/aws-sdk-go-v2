...
func (c *Client) UnpeerVpc(ctx context.Context, params *UnpeerVpcInput, optFns ...func(*Options)) (*UnpeerVpcOutput, error) {
	if params == nil { params = &UnpeerVpcInput{} }
...
func (c *Client) addOperationUnpeerVpcMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUnpeerVpcResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUnpeerVpcResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUnpeerVpcResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUnpeerVpcResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUnpeerVpcResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUnpeerVpcResolveEndpointMiddleware{
