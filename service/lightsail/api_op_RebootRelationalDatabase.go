...
func (c *Client) addOperationRebootRelationalDatabaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RebootRelationalDatabase", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
