...
func (c *Client) addOperationGetRelationalDatabaseEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRelationalDatabaseEvents", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
