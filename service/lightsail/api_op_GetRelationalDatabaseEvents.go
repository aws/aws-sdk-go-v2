...
func addOperationGetRelationalDatabaseEventsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetRelationalDatabaseEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetRelationalDatabaseEventsStackSlots(stack); err != nil {
		return err
	}
