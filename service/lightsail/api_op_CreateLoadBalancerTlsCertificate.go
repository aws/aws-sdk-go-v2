...
func addOperationCreateLoadBalancerTlsCertificateStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateLoadBalancerTlsCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateLoadBalancerTlsCertificateStackSlots(stack); err != nil {
		return err
	}
