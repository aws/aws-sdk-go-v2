...
func (c *Client) ResetDistributionCache(ctx context.Context, params *ResetDistributionCacheInput, optFns ...func(*Options)) (*ResetDistributionCacheOutput, error) {
	if params == nil { params = &ResetDistributionCacheInput{} }
...
func (c *Client) addOperationResetDistributionCacheMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResetDistributionCacheResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opResetDistributionCacheResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opResetDistributionCacheResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResetDistributionCacheResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResetDistributionCacheResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opResetDistributionCacheResolveEndpointMiddleware{
