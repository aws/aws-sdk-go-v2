...
// a notification to the notification protocol ( Email  and/or SMS) configured
// for the alarm. An alarm is used to monitor a single metric for one of your
...
type TestAlarmInput struct {
	...
	// The alarm state to test. An alarm has the following possible states that can
	// be tested:
