...
func (c *Client) GetRelationalDatabaseLogStreams(ctx context.Context, params *GetRelationalDatabaseLogStreamsInput, optFns ...func(*Options)) (*GetRelationalDatabaseLogStreamsOutput, error) {
	if params == nil { params = &GetRelationalDatabaseLogStreamsInput{} }
...
func (c *Client) addOperationGetRelationalDatabaseLogStreamsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRelationalDatabaseLogStreamsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRelationalDatabaseLogStreamsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRelationalDatabaseLogStreamsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRelationalDatabaseLogStreamsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRelationalDatabaseLogStreamsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRelationalDatabaseLogStreamsResolveEndpointMiddleware{
