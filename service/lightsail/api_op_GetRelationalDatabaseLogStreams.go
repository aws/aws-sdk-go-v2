...
func addOperationGetRelationalDatabaseLogStreamsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetRelationalDatabaseLogStreamsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetRelationalDatabaseLogStreamsStackSlots(stack); err != nil {
		return err
	}
