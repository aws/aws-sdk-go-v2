...
func (c *Client) addOperationGetRelationalDatabaseLogStreamsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRelationalDatabaseLogStreams", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
