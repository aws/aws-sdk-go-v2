...
func (c *Client) addOperationAttachLoadBalancerTlsCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AttachLoadBalancerTlsCertificate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
