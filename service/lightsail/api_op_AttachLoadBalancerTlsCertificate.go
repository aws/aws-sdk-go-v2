...
func addOperationAttachLoadBalancerTlsCertificateStackSlots(stack *middleware.Stack) error {
...
func addOperationAttachLoadBalancerTlsCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAttachLoadBalancerTlsCertificateStackSlots(stack); err != nil {
		return err
	}
