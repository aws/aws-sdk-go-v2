...
func addOperationDeleteRelationalDatabaseSnapshotStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteRelationalDatabaseSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteRelationalDatabaseSnapshotStackSlots(stack); err != nil {
		return err
	}
