...
func (*GetKeyPairsInput) operationName() string {
	return "GetKeyPairs"
}
...
func (c *Client) addOperationGetKeyPairsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetKeyPairsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetKeyPairsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetKeyPairsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetKeyPairsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetKeyPairsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetKeyPairsResolveEndpointMiddleware{
