...
func (c *Client) AttachDisk(ctx context.Context, params *AttachDiskInput, optFns ...func(*Options)) (*AttachDiskOutput, error) {
	if params == nil { params = &AttachDiskInput{} }
...
func (c *Client) addOperationAttachDiskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAttachDiskResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAttachDiskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAttachDiskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAttachDiskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAttachDiskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAttachDiskResolveEndpointMiddleware{
