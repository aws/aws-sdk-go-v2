...
func (c *Client) addOperationCreateCloudFormationStackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCloudFormationStack", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
