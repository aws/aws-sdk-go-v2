...
func (c *Client) GetLoadBalancers(ctx context.Context, params *GetLoadBalancersInput, optFns ...func(*Options)) (*GetLoadBalancersOutput, error) {
	if params == nil { params = &GetLoadBalancersInput{} }
...
func (c *Client) addOperationGetLoadBalancersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetLoadBalancersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetLoadBalancersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetLoadBalancersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetLoadBalancersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetLoadBalancersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetLoadBalancersResolveEndpointMiddleware{
