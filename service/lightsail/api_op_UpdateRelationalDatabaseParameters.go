...
func addOperationUpdateRelationalDatabaseParametersStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateRelationalDatabaseParametersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateRelationalDatabaseParametersStackSlots(stack); err != nil {
		return err
	}
