...
func (c *Client) GetRelationalDatabases(ctx context.Context, params *GetRelationalDatabasesInput, optFns ...func(*Options)) (*GetRelationalDatabasesOutput, error) {
	if params == nil { params = &GetRelationalDatabasesInput{} }
...
func (c *Client) addOperationGetRelationalDatabasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRelationalDatabasesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRelationalDatabasesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRelationalDatabasesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRelationalDatabasesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRelationalDatabasesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRelationalDatabasesResolveEndpointMiddleware{
