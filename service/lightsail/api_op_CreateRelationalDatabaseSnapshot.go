...
func (c *Client) addOperationCreateRelationalDatabaseSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateRelationalDatabaseSnapshot", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
