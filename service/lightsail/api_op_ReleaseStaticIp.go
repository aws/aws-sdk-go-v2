...
func (c *Client) ReleaseStaticIp(ctx context.Context, params *ReleaseStaticIpInput, optFns ...func(*Options)) (*ReleaseStaticIpOutput, error) {
	if params == nil { params = &ReleaseStaticIpInput{} }
...
func (c *Client) addOperationReleaseStaticIpMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addReleaseStaticIpResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opReleaseStaticIpResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opReleaseStaticIpResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opReleaseStaticIpResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addReleaseStaticIpResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opReleaseStaticIpResolveEndpointMiddleware{
