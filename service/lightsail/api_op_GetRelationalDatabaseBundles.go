...
func addOperationGetRelationalDatabaseBundlesStackSlots(stack *middleware.Stack) error {
...
func addOperationGetRelationalDatabaseBundlesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetRelationalDatabaseBundlesStackSlots(stack); err != nil {
		return err
	}
