...
func (c *Client) GetRelationalDatabaseBundles(ctx context.Context, params *GetRelationalDatabaseBundlesInput, optFns ...func(*Options)) (*GetRelationalDatabaseBundlesOutput, error) {
	if params == nil { params = &GetRelationalDatabaseBundlesInput{} }
...
func (c *Client) addOperationGetRelationalDatabaseBundlesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRelationalDatabaseBundlesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRelationalDatabaseBundlesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRelationalDatabaseBundlesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRelationalDatabaseBundlesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRelationalDatabaseBundlesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRelationalDatabaseBundlesResolveEndpointMiddleware{
