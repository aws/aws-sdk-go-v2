...
func (c *Client) GetContainerServicePowers(ctx context.Context, params *GetContainerServicePowersInput, optFns ...func(*Options)) (*GetContainerServicePowersOutput, error) {
	if params == nil { params = &GetContainerServicePowersInput{} }
...
func (c *Client) addOperationGetContainerServicePowersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetContainerServicePowersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetContainerServicePowersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetContainerServicePowersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetContainerServicePowersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetContainerServicePowersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetContainerServicePowersResolveEndpointMiddleware{
