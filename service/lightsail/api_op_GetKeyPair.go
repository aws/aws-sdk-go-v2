...
func (c *Client) GetKeyPair(ctx context.Context, params *GetKeyPairInput, optFns ...func(*Options)) (*GetKeyPairOutput, error) {
	if params == nil { params = &GetKeyPairInput{} }
...
func (c *Client) addOperationGetKeyPairMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetKeyPairResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetKeyPairResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetKeyPairResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetKeyPairResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetKeyPairResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetKeyPairResolveEndpointMiddleware{
