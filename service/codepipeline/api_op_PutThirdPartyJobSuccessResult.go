...
func (c *Client) addOperationPutThirdPartyJobSuccessResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutThirdPartyJobSuccessResult", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
