...
func (c *Client) PutThirdPartyJobSuccessResult(ctx context.Context, params *PutThirdPartyJobSuccessResultInput, optFns ...func(*Options)) (*PutThirdPartyJobSuccessResultOutput, error) {
	if params == nil { params = &PutThirdPartyJobSuccessResultInput{} }
...
func (c *Client) addOperationPutThirdPartyJobSuccessResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutThirdPartyJobSuccessResultResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutThirdPartyJobSuccessResultResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutThirdPartyJobSuccessResultResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutThirdPartyJobSuccessResultResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutThirdPartyJobSuccessResultResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutThirdPartyJobSuccessResultResolveEndpointMiddleware{
