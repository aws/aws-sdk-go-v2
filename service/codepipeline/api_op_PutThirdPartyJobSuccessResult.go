...
func addOperationPutThirdPartyJobSuccessResultStackSlots(stack *middleware.Stack) error {
...
func addOperationPutThirdPartyJobSuccessResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutThirdPartyJobSuccessResultStackSlots(stack); err != nil {
		return err
	}
