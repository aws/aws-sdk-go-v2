...
func addOperationRegisterWebhookWithThirdPartyStackSlots(stack *middleware.Stack) error {
...
func addOperationRegisterWebhookWithThirdPartyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRegisterWebhookWithThirdPartyStackSlots(stack); err != nil {
		return err
	}
