...
func (*RegisterWebhookWithThirdPartyInput) operationName() string {
...
func (c *Client) addOperationRegisterWebhookWithThirdPartyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRegisterWebhookWithThirdPartyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRegisterWebhookWithThirdPartyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRegisterWebhookWithThirdPartyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRegisterWebhookWithThirdPartyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRegisterWebhookWithThirdPartyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRegisterWebhookWithThirdPartyResolveEndpointMiddleware{
