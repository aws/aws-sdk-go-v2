...
func (c *Client) addOperationGetThirdPartyJobDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetThirdPartyJobDetails", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
