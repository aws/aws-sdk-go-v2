...
func (c *Client) DeregisterWebhookWithThirdParty(ctx context.Context, params *DeregisterWebhookWithThirdPartyInput, optFns ...func(*Options)) (*DeregisterWebhookWithThirdPartyOutput, error) {
	if params == nil { params = &DeregisterWebhookWithThirdPartyInput{} }
...
func (c *Client) addOperationDeregisterWebhookWithThirdPartyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeregisterWebhookWithThirdPartyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeregisterWebhookWithThirdPartyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeregisterWebhookWithThirdPartyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeregisterWebhookWithThirdPartyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeregisterWebhookWithThirdPartyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeregisterWebhookWithThirdPartyResolveEndpointMiddleware{
