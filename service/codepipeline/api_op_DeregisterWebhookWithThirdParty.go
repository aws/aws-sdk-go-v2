...
func (c *Client) addOperationDeregisterWebhookWithThirdPartyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterWebhookWithThirdParty", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
