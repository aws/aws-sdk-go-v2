...
func (c *Client) AcknowledgeJob(ctx context.Context, params *AcknowledgeJobInput, optFns ...func(*Options)) (*AcknowledgeJobOutput, error) {
	if params == nil { params = &AcknowledgeJobInput{} }
...
func (c *Client) addOperationAcknowledgeJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAcknowledgeJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAcknowledgeJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAcknowledgeJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAcknowledgeJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAcknowledgeJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAcknowledgeJobResolveEndpointMiddleware{
