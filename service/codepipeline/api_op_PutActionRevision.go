...
func (c *Client) PutActionRevision(ctx context.Context, params *PutActionRevisionInput, optFns ...func(*Options)) (*PutActionRevisionOutput, error) {
	if params == nil { params = &PutActionRevisionInput{} }
...
func (c *Client) addOperationPutActionRevisionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutActionRevisionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutActionRevisionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutActionRevisionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutActionRevisionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutActionRevisionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutActionRevisionResolveEndpointMiddleware{
