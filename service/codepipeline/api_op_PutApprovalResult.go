...
func (c *Client) PutApprovalResult(ctx context.Context, params *PutApprovalResultInput, optFns ...func(*Options)) (*PutApprovalResultOutput, error) {
	if params == nil { params = &PutApprovalResultInput{} }
...
func (c *Client) addOperationPutApprovalResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutApprovalResultResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutApprovalResultResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutApprovalResultResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutApprovalResultResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutApprovalResultResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutApprovalResultResolveEndpointMiddleware{
