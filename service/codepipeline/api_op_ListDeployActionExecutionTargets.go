...
func (c *Client) addOperationListDeployActionExecutionTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDeployActionExecutionTargets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
