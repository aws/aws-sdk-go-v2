...
func (*PutJobFailureResultInput) operationName() string {
...
func (c *Client) addOperationPutJobFailureResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutJobFailureResultResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opPutJobFailureResultResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opPutJobFailureResultResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutJobFailureResultResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutJobFailureResultResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opPutJobFailureResultResolveEndpointMiddleware{
