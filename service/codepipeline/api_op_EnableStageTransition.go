...
func (*EnableStageTransitionInput) operationName() string {
...
func (c *Client) addOperationEnableStageTransitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableStageTransitionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opEnableStageTransitionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opEnableStageTransitionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableStageTransitionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableStageTransitionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opEnableStageTransitionResolveEndpointMiddleware{
