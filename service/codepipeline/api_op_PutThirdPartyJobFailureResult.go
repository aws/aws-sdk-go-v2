...
func addOperationPutThirdPartyJobFailureResultStackSlots(stack *middleware.Stack) error {
...
func addOperationPutThirdPartyJobFailureResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutThirdPartyJobFailureResultStackSlots(stack); err != nil {
		return err
	}
