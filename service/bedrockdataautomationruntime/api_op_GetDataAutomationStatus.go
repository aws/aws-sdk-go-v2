...
func (c *Client) addOperationGetDataAutomationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDataAutomationStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
