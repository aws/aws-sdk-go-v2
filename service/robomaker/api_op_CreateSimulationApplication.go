...
func addOperationCreateSimulationApplicationStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateSimulationApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateSimulationApplicationStackSlots(stack); err != nil {
		return err
	}
