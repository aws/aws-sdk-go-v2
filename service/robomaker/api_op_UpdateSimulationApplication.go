...
func addOperationUpdateSimulationApplicationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateSimulationApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateSimulationApplicationStackSlots(stack); err != nil {
		return err
	}
