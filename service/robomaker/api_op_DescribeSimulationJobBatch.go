...
func addOperationDescribeSimulationJobBatchStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeSimulationJobBatchMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeSimulationJobBatchStackSlots(stack); err != nil {
		return err
	}
