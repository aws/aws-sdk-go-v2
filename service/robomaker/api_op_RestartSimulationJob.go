...
func (c *Client) RestartSimulationJob(ctx context.Context, params *RestartSimulationJobInput, optFns ...func(*Options)) (*RestartSimulationJobOutput, error) {
	if params == nil { params = &RestartSimulationJobInput{} }
...
func (c *Client) addOperationRestartSimulationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRestartSimulationJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRestartSimulationJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRestartSimulationJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRestartSimulationJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRestartSimulationJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRestartSimulationJobResolveEndpointMiddleware{
