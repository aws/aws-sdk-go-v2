...
func (*CancelSimulationJobInput) operationName() string {
...
func (c *Client) addOperationCancelSimulationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelSimulationJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCancelSimulationJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCancelSimulationJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelSimulationJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelSimulationJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCancelSimulationJobResolveEndpointMiddleware{
