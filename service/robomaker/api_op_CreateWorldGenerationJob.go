...
func addOperationCreateWorldGenerationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addIdempotencyToken_opCreateWorldGenerationJobMiddleware(stack, options)
	addOpCreateWorldGenerationJobValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opCreateWorldGenerationJob(options.Region), middleware.Before)
...
func addIdempotencyToken_opCreateWorldGenerationJobMiddleware(stack *middleware.Stack, cfg Options) {
	stack.Initialize.Add(&idempotencyToken_initializeOpCreateWorldGenerationJob{tokenProvider: cfg.IdempotencyTokenProvider}, middleware.Before)
}
