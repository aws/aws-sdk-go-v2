...
// Cancels the specified deployment job. This API will no longer be supported as
// of May 2, 2022. Use it to remove resources that were created for Deployment
// Service.
//
...
func (c *Client) CancelDeploymentJob(ctx context.Context, params *CancelDeploymentJobInput, optFns ...func(*Options)) (*CancelDeploymentJobOutput, error) {
	if params == nil { params = &CancelDeploymentJobInput{} }
...
func (c *Client) addOperationCancelDeploymentJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelDeploymentJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelDeploymentJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelDeploymentJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelDeploymentJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelDeploymentJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelDeploymentJobResolveEndpointMiddleware{
