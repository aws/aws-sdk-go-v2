...
func (*CancelSimulationJobBatchInput) operationName() string {
...
func (c *Client) addOperationCancelSimulationJobBatchMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelSimulationJobBatchResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCancelSimulationJobBatchResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCancelSimulationJobBatchResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelSimulationJobBatchResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelSimulationJobBatchResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCancelSimulationJobBatchResolveEndpointMiddleware{
