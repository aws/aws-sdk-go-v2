...
func (c *Client) ListSimulationJobBatches(ctx context.Context, params *ListSimulationJobBatchesInput, optFns ...func(*Options)) (*ListSimulationJobBatchesOutput, error) {
	if params == nil { params = &ListSimulationJobBatchesInput{} }
...
func (c *Client) addOperationListSimulationJobBatchesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSimulationJobBatchesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSimulationJobBatchesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSimulationJobBatchesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSimulationJobBatchesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSimulationJobBatchesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSimulationJobBatchesResolveEndpointMiddleware{
