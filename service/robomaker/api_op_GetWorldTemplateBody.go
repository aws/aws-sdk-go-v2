...
func (c *Client) GetWorldTemplateBody(ctx context.Context, params *GetWorldTemplateBodyInput, optFns ...func(*Options)) (*GetWorldTemplateBodyOutput, error) {
	if params == nil { params = &GetWorldTemplateBodyInput{} }
...
func (c *Client) addOperationGetWorldTemplateBodyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetWorldTemplateBodyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetWorldTemplateBodyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetWorldTemplateBodyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetWorldTemplateBodyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetWorldTemplateBodyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetWorldTemplateBodyResolveEndpointMiddleware{
