...
func addOperationCreateWorldExportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addIdempotencyToken_opCreateWorldExportJobMiddleware(stack, options)
	addOpCreateWorldExportJobValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opCreateWorldExportJob(options.Region), middleware.Before)
...
func addIdempotencyToken_opCreateWorldExportJobMiddleware(stack *middleware.Stack, cfg Options) {
	stack.Initialize.Add(&idempotencyToken_initializeOpCreateWorldExportJob{tokenProvider: cfg.IdempotencyTokenProvider}, middleware.Before)
}
