...
func (c *Client) ListWorlds(ctx context.Context, params *ListWorldsInput, optFns ...func(*Options)) (*ListWorldsOutput, error) {
	if params == nil { params = &ListWorldsInput{} }
...
func (c *Client) addOperationListWorldsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWorldsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListWorldsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListWorldsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWorldsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWorldsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListWorldsResolveEndpointMiddleware{
