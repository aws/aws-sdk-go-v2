...
func (*DescribeDeploymentJobInput) operationName() string {
...
func (c *Client) addOperationDescribeDeploymentJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeDeploymentJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeDeploymentJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeDeploymentJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeDeploymentJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeDeploymentJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeDeploymentJobResolveEndpointMiddleware{
