...
// RoboMaker. See this package's package overview docs
...
const (
	ServiceName = "RoboMaker" // Service's name
	ServiceID   = "RoboMaker" // Service's identifier
	EndpointsID = "robomaker" // Service's Endpoint identifier
)
