...
func addOperationDeleteSimulationApplicationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteSimulationApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteSimulationApplicationStackSlots(stack); err != nil {
		return err
	}
