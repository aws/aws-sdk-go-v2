...
func (c *Client) addOperationCreateBillOfMaterialsImportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateBillOfMaterialsImportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
