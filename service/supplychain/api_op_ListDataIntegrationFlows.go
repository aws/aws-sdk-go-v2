...
func (c *Client) addOperationListDataIntegrationFlowsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDataIntegrationFlows", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
