...
func (c *Client) addOperationGetDataIntegrationEventMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDataIntegrationEvent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
