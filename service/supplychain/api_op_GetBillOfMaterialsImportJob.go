...
func (c *Client) addOperationGetBillOfMaterialsImportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetBillOfMaterialsImportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
