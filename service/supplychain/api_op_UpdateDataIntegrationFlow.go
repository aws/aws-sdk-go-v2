...
func (c *Client) addOperationUpdateDataIntegrationFlowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDataIntegrationFlow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
