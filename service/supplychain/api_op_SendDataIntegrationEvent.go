...
func (c *Client) addOperationSendDataIntegrationEventMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SendDataIntegrationEvent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
