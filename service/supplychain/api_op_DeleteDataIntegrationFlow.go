...
func (c *Client) addOperationDeleteDataIntegrationFlowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDataIntegrationFlow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
