...
func (c *Client) addOperationDescribeInsightsRefreshMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeInsightsRefresh", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
