...
func (c *Client) addOperationDisassociateAccessPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateAccessPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
