...
func (c *Client) addOperationAssociateEncryptionConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateEncryptionConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
