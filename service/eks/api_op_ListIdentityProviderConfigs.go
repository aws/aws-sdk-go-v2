...
func (c *Client) addOperationListIdentityProviderConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListIdentityProviderConfigs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
