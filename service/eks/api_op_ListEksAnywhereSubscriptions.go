...
func (c *Client) addOperationListEksAnywhereSubscriptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEksAnywhereSubscriptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
