...
func (c *Client) addOperationListAssociatedAccessPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAssociatedAccessPolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
