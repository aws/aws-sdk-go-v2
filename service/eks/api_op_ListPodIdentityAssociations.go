...
func (c *Client) addOperationListPodIdentityAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPodIdentityAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
