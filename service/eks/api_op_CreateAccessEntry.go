...
type CreateAccessEntryInput struct {
	...
	// This value can't be changed after access entry creation. IAM best practices (https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html#bp-users-federation-idp)
	...
	// you've created the access entry. If you set the value to EC2_LINUX or
	// EC2_WINDOWS , you can't specify values for kubernetesGroups , or associate an
