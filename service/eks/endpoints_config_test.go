...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-eks.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-eks.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-eks.dev",
			expectURL:     aws.String("https://env-eks.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-eks.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-eks.dev",
			expectURL:     aws.String("http://config-eks.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-eks.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-eks.dev",
			clientEndpoint: aws.String("https://client-eks.dev"),
			expectURL:      aws.String("https://client-eks.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_EKS", c.envService)
			}
