...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/migrationhubrefactorspaces/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "Migration Hub Refactor Spaces", cfg.ConfigSources)
	if found && err == nil {
