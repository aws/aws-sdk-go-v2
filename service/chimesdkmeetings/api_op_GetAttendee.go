...
func (v *GetAttendeeOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.GetAttendeeResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *GetAttendeeOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Attendee != nil {
		s.WriteStruct(schemas.GetAttendeeResponse_Attendee)
