...
func (c *Client) addOperationCreateMeetingWithAttendeesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMeetingWithAttendees", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
