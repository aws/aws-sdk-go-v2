...
// API in the Amazon Transcribe Developer Guide. By default, Amazon Transcribe may
...
// using audio content to develop and improve AWS AI/ML services by configuring an
