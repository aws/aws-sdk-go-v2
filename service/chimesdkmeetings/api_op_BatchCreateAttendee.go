...
func (c *Client) BatchCreateAttendee(ctx context.Context, params *BatchCreateAttendeeInput, optFns ...func(*Options)) (*BatchCreateAttendeeOutput, error) {
	if params == nil { params = &BatchCreateAttendeeInput{} }
...
func (c *Client) addOperationBatchCreateAttendeeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchCreateAttendeeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchCreateAttendeeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchCreateAttendeeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchCreateAttendeeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchCreateAttendeeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchCreateAttendeeResolveEndpointMiddleware{
