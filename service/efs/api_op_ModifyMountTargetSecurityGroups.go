...
func addOperationModifyMountTargetSecurityGroupsStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyMountTargetSecurityGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyMountTargetSecurityGroupsStackSlots(stack); err != nil {
		return err
	}
