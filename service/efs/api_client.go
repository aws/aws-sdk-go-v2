...
// EFS. See this package's package overview docs
...
const (
	ServiceName = "EFS"               // Service's name
	ServiceID   = "EFS"               // Service's identifier
	EndpointsID = "elasticfilesystem" // Service's Endpoint identifier
)
