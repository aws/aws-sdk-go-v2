...
// LifecycleConfigurationand turns off lifecycle management and EFS
...
// LifecycleConfigurationobject to an encrypted file system, you need the same
...
type PutLifecycleConfigurationInput struct {
	...
	// When using
	// the put-lifecycle-configuration  CLI command or the PutLifecycleConfiguration
	// API action, Amazon EFS requires that each LifecyclePolicy object have only a
	// single transition. This means that in a request body, LifecyclePolicies must
	// be structured as an array of LifecyclePolicy objects, one object for each
