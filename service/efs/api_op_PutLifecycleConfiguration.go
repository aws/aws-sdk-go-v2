...
func (c *Client) addOperationPutLifecycleConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutLifecycleConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
