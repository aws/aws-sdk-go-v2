...
func (c *Client) addOperationUpdateFileSystemProtectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateFileSystemProtection", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
