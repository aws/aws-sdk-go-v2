...
// action to create tags for EFS resources. Creates or overwrites tags associated
// with a file system. Each tag is a key-value pair. If a tag key specified in the
...
// operation. This operation requires permission for the
