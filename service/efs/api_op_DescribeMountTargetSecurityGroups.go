...
func addOperationDescribeMountTargetSecurityGroupsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeMountTargetSecurityGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeMountTargetSecurityGroupsStackSlots(stack); err != nil {
		return err
	}
