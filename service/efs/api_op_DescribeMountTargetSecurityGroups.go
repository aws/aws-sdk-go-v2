...
func (c *Client) addOperationDescribeMountTargetSecurityGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMountTargetSecurityGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
