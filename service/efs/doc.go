...
// simple, scalable file storage for use with Amazon EC2 instances in the Amazon
// Web Services Cloud. With Amazon EFS, storage capacity is elastic, growing and
...
// Elastic File System API Reference
