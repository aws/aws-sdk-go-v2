...
// - The VPC in which Amazon EFS creates
// the mount target
...
//
// If the request satisfies the requirements, Amazon EFS
// does the following:
// - Creates a new mount target in the specified subnet.
// - Also
// creates a new network interface in the subnet as follows:
// - If the request
// provides an IpAddress, Amazon EFS assigns that IP address to the network
// interface. Otherwise, Amazon EFS assigns a free address in the subnet (in the
// same way that the Amazon EC2 CreateNetworkInterface call does when a request
// does not specify a primary private IP address).
// - If the request provides
// SecurityGroups, this network interface is associated with those security groups.
