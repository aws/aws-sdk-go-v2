...
// on EC2 instances by using the mount target. You can create one mount target in
...
// permissions for the following Amazon EC2 actions:
//   - ec2:DescribeSubnets
...
type CreateMountTargetOutput struct {
	...
	// Services account. For example, the Availability Zone us-east-1a for your
	// Amazon Web Services account might not be the same location as us-east-1a for
