...
func (c *Client) GetSatellite(ctx context.Context, params *GetSatelliteInput, optFns ...func(*Options)) (*GetSatelliteOutput, error) {
	if params == nil { params = &GetSatelliteInput{} }
...
func (c *Client) addOperationGetSatelliteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSatelliteResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSatelliteResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSatelliteResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSatelliteResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSatelliteResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSatelliteResolveEndpointMiddleware{
