...
func (c *Client) addOperationGetDataflowEndpointGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDataflowEndpointGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
