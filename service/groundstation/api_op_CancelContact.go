...
func (c *Client) CancelContact(ctx context.Context, params *CancelContactInput, optFns ...func(*Options)) (*CancelContactOutput, error) {
	if params == nil { params = &CancelContactInput{} }
...
func (c *Client) addOperationCancelContactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelContactResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelContactResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelContactResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelContactResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelContactResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelContactResolveEndpointMiddleware{
