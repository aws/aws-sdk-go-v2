...
func (c *Client) addOperationDeleteDataflowEndpointGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDataflowEndpointGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
