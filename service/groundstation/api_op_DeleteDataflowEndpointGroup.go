...
func addOperationDeleteDataflowEndpointGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteDataflowEndpointGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteDataflowEndpointGroupStackSlots(stack); err != nil {
		return err
	}
