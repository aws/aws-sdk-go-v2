...
func (c *Client) addOperationListDataflowEndpointGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDataflowEndpointGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
