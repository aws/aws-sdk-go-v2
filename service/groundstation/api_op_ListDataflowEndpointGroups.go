...
func addOperationListDataflowEndpointGroupsStackSlots(stack *middleware.Stack) error {
...
func addOperationListDataflowEndpointGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListDataflowEndpointGroupsStackSlots(stack); err != nil {
		return err
	}
