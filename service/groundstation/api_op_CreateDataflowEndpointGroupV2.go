...
func (c *Client) addOperationCreateDataflowEndpointGroupV2Middlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateDataflowEndpointGroupV2", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
