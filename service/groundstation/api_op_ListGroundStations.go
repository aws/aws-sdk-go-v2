...
func (c *Client) ListGroundStations(ctx context.Context, params *ListGroundStationsInput, optFns ...func(*Options)) (*ListGroundStationsOutput, error) {
	if params == nil { params = &ListGroundStationsInput{} }
...
func (c *Client) addOperationListGroundStationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListGroundStationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListGroundStationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListGroundStationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListGroundStationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListGroundStationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListGroundStationsResolveEndpointMiddleware{
