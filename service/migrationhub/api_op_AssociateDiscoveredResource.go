...
func addOperationAssociateDiscoveredResourceStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociateDiscoveredResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociateDiscoveredResourceStackSlots(stack); err != nil {
		return err
	}
