...
func addOperationDisassociateDiscoveredResourceStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateDiscoveredResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateDiscoveredResourceStackSlots(stack); err != nil {
		return err
	}
