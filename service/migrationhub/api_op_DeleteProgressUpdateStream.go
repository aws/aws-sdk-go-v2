...
func addOperationDeleteProgressUpdateStreamStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteProgressUpdateStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteProgressUpdateStreamStackSlots(stack); err != nil {
		return err
	}
