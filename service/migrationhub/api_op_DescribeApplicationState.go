...
func (c *Client) addOperationDescribeApplicationStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeApplicationState", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
