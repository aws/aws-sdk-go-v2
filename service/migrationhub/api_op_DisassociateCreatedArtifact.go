...
func (c *Client) addOperationDisassociateCreatedArtifactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateCreatedArtifact", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
