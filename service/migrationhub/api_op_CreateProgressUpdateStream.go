...
func addOperationCreateProgressUpdateStreamStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateProgressUpdateStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateProgressUpdateStreamStackSlots(stack); err != nil {
		return err
	}
