...
func (c *Client) addOperationListMigrationTaskUpdatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMigrationTaskUpdates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
