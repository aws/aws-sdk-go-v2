...
func (c *Client) addOperationAssociateSourceResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateSourceResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
