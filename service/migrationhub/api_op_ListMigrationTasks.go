...
func (c *Client) ListMigrationTasks(ctx context.Context, params *ListMigrationTasksInput, optFns ...func(*Options)) (*ListMigrationTasksOutput, error) {
	stack := middleware.NewStack("ListMigrationTasks", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpListMigrationTasksMiddlewares(stack)
...
func addawsAwsjson11_serdeOpListMigrationTasksMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpListMigrationTasks{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpListMigrationTasks{}, middleware.After)
}
