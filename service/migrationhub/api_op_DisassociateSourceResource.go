...
func (c *Client) addOperationDisassociateSourceResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateSourceResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
