...
func (c *Client) addOperationListProgressUpdateStreamsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListProgressUpdateStreams", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
