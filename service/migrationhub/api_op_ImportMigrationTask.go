...
func (c *Client) ImportMigrationTask(ctx context.Context, params *ImportMigrationTaskInput, optFns ...func(*Options)) (*ImportMigrationTaskOutput, error) {
	if params == nil { params = &ImportMigrationTaskInput{} }
...
func (c *Client) addOperationImportMigrationTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addImportMigrationTaskResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opImportMigrationTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opImportMigrationTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opImportMigrationTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addImportMigrationTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opImportMigrationTaskResolveEndpointMiddleware{
