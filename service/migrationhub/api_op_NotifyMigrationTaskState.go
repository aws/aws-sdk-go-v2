...
func (c *Client) NotifyMigrationTaskState(ctx context.Context, params *NotifyMigrationTaskStateInput, optFns ...func(*Options)) (*NotifyMigrationTaskStateOutput, error) {
	if params == nil { params = &NotifyMigrationTaskStateInput{} }
...
func (c *Client) addOperationNotifyMigrationTaskStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addNotifyMigrationTaskStateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opNotifyMigrationTaskStateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opNotifyMigrationTaskStateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opNotifyMigrationTaskStateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addNotifyMigrationTaskStateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opNotifyMigrationTaskStateResolveEndpointMiddleware{
