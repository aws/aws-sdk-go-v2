...
func (c *Client) ListWorkerFleets(ctx context.Context, params *ListWorkerFleetsInput, optFns ...func(*Options)) (*ListWorkerFleetsOutput, error) {
	if params == nil { params = &ListWorkerFleetsInput{} }
...
func (c *Client) addOperationListWorkerFleetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWorkerFleetsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListWorkerFleetsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListWorkerFleetsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWorkerFleetsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWorkerFleetsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListWorkerFleetsResolveEndpointMiddleware{
