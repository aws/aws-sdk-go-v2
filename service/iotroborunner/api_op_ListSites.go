...
func (c *Client) ListSites(ctx context.Context, params *ListSitesInput, optFns ...func(*Options)) (*ListSitesOutput, error) {
	if params == nil { params = &ListSitesInput{} }
...
func (c *Client) addOperationListSitesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSitesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSitesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSitesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSitesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSitesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSitesResolveEndpointMiddleware{
