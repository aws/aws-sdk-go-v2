...
func (*ListWorkersInput) operationName() string {
	return "ListWorkers"
}
...
func (c *Client) addOperationListWorkersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWorkersResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListWorkersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListWorkersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWorkersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWorkersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListWorkersResolveEndpointMiddleware{
