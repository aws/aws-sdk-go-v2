...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/iotroborunner/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "IoT RoboRunner", cfg.ConfigSources)
	if found && err == nil {
