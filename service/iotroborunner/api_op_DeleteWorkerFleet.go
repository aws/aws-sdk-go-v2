...
func (c *Client) DeleteWorkerFleet(ctx context.Context, params *DeleteWorkerFleetInput, optFns ...func(*Options)) (*DeleteWorkerFleetOutput, error) {
	if params == nil { params = &DeleteWorkerFleetInput{} }
...
func (c *Client) addOperationDeleteWorkerFleetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteWorkerFleetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteWorkerFleetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteWorkerFleetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteWorkerFleetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteWorkerFleetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteWorkerFleetResolveEndpointMiddleware{
