...
func (c *Client) addOperationUpdateWorkerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateWorkerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateWorkerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateWorkerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateWorkerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateWorkerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateWorkerResolveEndpointMiddleware{
