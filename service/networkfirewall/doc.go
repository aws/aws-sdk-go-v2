...
// detection engine. Network Firewall supports Suricata version 5.0.2. For
...
// and in Network Firewall. For information about using Amazon VPC, see Amazon
// VPC User Guide (https://docs.aws.amazon.com/vpc/latest/userguide/). To start
// using Network Firewall, do the following:
