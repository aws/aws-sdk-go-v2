...
// with Suricata, a free, open source intrusion detection system (IDS) engine. AWS
// Network Firewall supports Suricata version 5.0.2. For information about
// Suricata, see the Suricata website (https://suricata-ids.org/). You can use
// Network Firewall to monitor and protect your VPC traffic in a number of ways.
// The following are just a few examples:
//
// * Allow domains or IP addresses for
// known AWS service endpoints, such as Amazon S3, and block all other forms of
// traffic.
//
