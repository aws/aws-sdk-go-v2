...
// on traffic entering or leaving your VPC.
...
// - In Network Firewall, create a firewall and
// specify your new firewall policy and VPC subnets. Network Firewall creates a
