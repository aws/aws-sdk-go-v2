...
func (c *Client) addOperationUpdateFirewallDescriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateFirewallDescription", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
