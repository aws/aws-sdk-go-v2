...
func (v *UpdateAvailabilityZoneChangeProtectionOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.UpdateAvailabilityZoneChangeProtectionResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *UpdateAvailabilityZoneChangeProtectionOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AvailabilityZoneChangeProtection != false {
		s.WriteBool(schemas.UpdateAvailabilityZoneChangeProtectionResponse_AvailabilityZoneChangeProtection, v.AvailabilityZoneChangeProtection)
	}
	if v.FirewallArn != nil {
		s.WriteString(schemas.UpdateAvailabilityZoneChangeProtectionResponse_FirewallArn, *v.FirewallArn)
	}
	if v.FirewallName != nil {
		s.WriteString(schemas.UpdateAvailabilityZoneChangeProtectionResponse_FirewallName, *v.FirewallName)
	}
	if v.UpdateToken != nil {
		s.WriteString(schemas.UpdateAvailabilityZoneChangeProtectionResponse_UpdateToken, *v.UpdateToken)
	}
}
