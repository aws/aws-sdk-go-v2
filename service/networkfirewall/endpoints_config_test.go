...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-network-firewall.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-network-firewall.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-network-firewall.dev",
			expectURL:     aws.String("https://env-network-firewall.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-network-firewall.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-network-firewall.dev",
			expectURL:     aws.String("http://config-network-firewall.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-network-firewall.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-network-firewall.dev",
			clientEndpoint: aws.String("https://client-network-firewall.dev"),
			expectURL:      aws.String("https://client-network-firewall.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_NETWORK_FIREWALL", c.envService)
			}
