...
func (c *Client) addOperationAcceptNetworkFirewallTransitGatewayAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AcceptNetworkFirewallTransitGatewayAttachment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
