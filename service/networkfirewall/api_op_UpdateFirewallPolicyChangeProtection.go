...
func (c *Client) UpdateFirewallPolicyChangeProtection(ctx context.Context, params *UpdateFirewallPolicyChangeProtectionInput, optFns ...func(*Options)) (*UpdateFirewallPolicyChangeProtectionOutput, error) {
	if params == nil { params = &UpdateFirewallPolicyChangeProtectionInput{} }
...
func (c *Client) addOperationUpdateFirewallPolicyChangeProtectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateFirewallPolicyChangeProtectionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateFirewallPolicyChangeProtectionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateFirewallPolicyChangeProtectionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateFirewallPolicyChangeProtectionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateFirewallPolicyChangeProtectionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateFirewallPolicyChangeProtectionResolveEndpointMiddleware{
