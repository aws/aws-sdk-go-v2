...
func (v *CreateProxyRulesOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.CreateProxyRulesResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *CreateProxyRulesOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ProxyRuleGroup != nil {
		s.WriteStruct(schemas.CreateProxyRulesResponse_ProxyRuleGroup)
		v.ProxyRuleGroup.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.UpdateToken != nil {
		s.WriteString(schemas.CreateProxyRulesResponse_UpdateToken, *v.UpdateToken)
	}
}
