...
func (v *DescribeTLSInspectionConfigurationOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DescribeTLSInspectionConfigurationResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DescribeTLSInspectionConfigurationOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.TLSInspectionConfiguration != nil {
		s.WriteStruct(schemas.DescribeTLSInspectionConfigurationResponse_TLSInspectionConfiguration)
		v.TLSInspectionConfiguration.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.TLSInspectionConfigurationResponse != nil {
		s.WriteStruct(schemas.DescribeTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse)
		v.TLSInspectionConfigurationResponse.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.UpdateToken != nil {
		s.WriteString(schemas.DescribeTLSInspectionConfigurationResponse_UpdateToken, *v.UpdateToken)
	}
}
