...
func (c *Client) addOperationUpdateFirewallEncryptionConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateFirewallEncryptionConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
