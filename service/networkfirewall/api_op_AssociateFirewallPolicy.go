...
func (c *Client) addOperationAssociateFirewallPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateFirewallPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
