...
func (c *Client) DescribeProxy(ctx context.Context, params *DescribeProxyInput, optFns ...func(*Options)) (*DescribeProxyOutput, error) {
	if params == nil { params = &DescribeProxyInput{} }
...
func (c *Client) addOperationDescribeProxyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err != nil { return err }
	if err := addProtocolFinalizerMiddlewares(stack, options, "DescribeProxy"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDescribeProxy(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opDescribeProxy(region string) *awsmiddleware.RegisterServiceMetadata {
