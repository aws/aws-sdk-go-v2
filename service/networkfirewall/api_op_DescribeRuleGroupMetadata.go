...
func (c *Client) addOperationDescribeRuleGroupMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRuleGroupMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
