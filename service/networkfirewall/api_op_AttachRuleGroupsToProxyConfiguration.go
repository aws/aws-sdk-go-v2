...
func (v *AttachRuleGroupsToProxyConfigurationOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.AttachRuleGroupsToProxyConfigurationResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *AttachRuleGroupsToProxyConfigurationOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ProxyConfiguration != nil {
		s.WriteStruct(schemas.AttachRuleGroupsToProxyConfigurationResponse_ProxyConfiguration)
		v.ProxyConfiguration.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.UpdateToken != nil {
		s.WriteString(schemas.AttachRuleGroupsToProxyConfigurationResponse_UpdateToken, *v.UpdateToken)
	}
}
