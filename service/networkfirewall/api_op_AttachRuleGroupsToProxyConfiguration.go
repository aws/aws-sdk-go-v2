...
func (c *Client) addOperationAttachRuleGroupsToProxyConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AttachRuleGroupsToProxyConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
