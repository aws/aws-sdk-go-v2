...
func (v *DeleteProxyRulesOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DeleteProxyRulesResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DeleteProxyRulesOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ProxyRuleGroup != nil {
		s.WriteStruct(schemas.DeleteProxyRulesResponse_ProxyRuleGroup)
