...
func (c *Client) DeleteProxyRules(ctx context.Context, params *DeleteProxyRulesInput, optFns ...func(*Options)) (*DeleteProxyRulesOutput, error) {
	if params == nil { params = &DeleteProxyRulesInput{} }
...
func (c *Client) addOperationDeleteProxyRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteProxyRules(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opDeleteProxyRules(region string) *awsmiddleware.RegisterServiceMetadata {
