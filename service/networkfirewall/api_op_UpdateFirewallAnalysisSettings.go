...
func (c *Client) addOperationUpdateFirewallAnalysisSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateFirewallAnalysisSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
