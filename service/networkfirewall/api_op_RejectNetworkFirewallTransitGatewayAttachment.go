...
func (v *RejectNetworkFirewallTransitGatewayAttachmentOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.RejectNetworkFirewallTransitGatewayAttachmentResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *RejectNetworkFirewallTransitGatewayAttachmentOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.TransitGatewayAttachmentId != nil {
		s.WriteString(schemas.RejectNetworkFirewallTransitGatewayAttachmentResponse_TransitGatewayAttachmentId, *v.TransitGatewayAttachmentId)
	}
	if v.TransitGatewayAttachmentStatus != "" {
		s.WriteString(schemas.RejectNetworkFirewallTransitGatewayAttachmentResponse_TransitGatewayAttachmentStatus, string(v.TransitGatewayAttachmentStatus))
	}
}
