...
func (c *Client) addOperationRejectNetworkFirewallTransitGatewayAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RejectNetworkFirewallTransitGatewayAttachment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
