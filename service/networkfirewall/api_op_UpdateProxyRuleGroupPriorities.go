...
func (c *Client) addOperationUpdateProxyRuleGroupPrioritiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateProxyRuleGroupPriorities", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
