...
func (v *ListVpcEndpointAssociationsOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListVpcEndpointAssociationsResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ListVpcEndpointAssociationsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.NextToken != nil {
		s.WriteString(schemas.ListVpcEndpointAssociationsResponse_NextToken, *v.NextToken)
	}
	serializeVpcEndpointAssociations(s, schemas.ListVpcEndpointAssociationsResponse_VpcEndpointAssociations, v.VpcEndpointAssociations)
}
