...
func (c *Client) addOperationListVpcEndpointAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListVpcEndpointAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
