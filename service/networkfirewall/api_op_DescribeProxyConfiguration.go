...
func (v *DescribeProxyConfigurationOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DescribeProxyConfigurationResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DescribeProxyConfigurationOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ProxyConfiguration != nil {
		s.WriteStruct(schemas.DescribeProxyConfigurationResponse_ProxyConfiguration)
		v.ProxyConfiguration.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.UpdateToken != nil {
		s.WriteString(schemas.DescribeProxyConfigurationResponse_UpdateToken, *v.UpdateToken)
	}
}
