...
func (c *Client) addOperationCreateProxyConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateProxyConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
