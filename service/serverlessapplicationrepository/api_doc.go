...
// Using the Client
//
// To use AWSServerlessApplicationRepository with the SDK use the New function to create
...
//
// See the AWSServerlessApplicationRepository client for more information on
