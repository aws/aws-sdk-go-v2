...
const (
	ServiceName = "AWSServerlessApplicationRepository" // Service's name
	ServiceID   = "ServerlessApplicationRepository"    // Service's identifier
	EndpointsID = "serverlessrepo"                     // Service's Endpoint identifier
)
