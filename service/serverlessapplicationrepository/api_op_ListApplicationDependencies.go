...
func addOperationListApplicationDependenciesStackSlots(stack *middleware.Stack) error {
...
func addOperationListApplicationDependenciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListApplicationDependenciesStackSlots(stack); err != nil {
		return err
	}
