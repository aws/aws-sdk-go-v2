...
func (c *Client) addOperationListApplicationDependenciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListApplicationDependencies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
