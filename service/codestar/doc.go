...
// AWS CodeStar.
//
// AWS CodeStar This is the API reference for AWS CodeStar. This reference
// provides descriptions of the operations and data types for the AWS CodeStar API
// along with usage examples. You can use the AWS CodeStar API to work with:
...
//
// Teams and
// team members, by calling the following:
