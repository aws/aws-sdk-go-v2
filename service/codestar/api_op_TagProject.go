...
func (c *Client) TagProject(ctx context.Context, params *TagProjectInput, optFns ...func(*Options)) (*TagProjectOutput, error) {
	if params == nil { params = &TagProjectInput{} }
...
func (c *Client) addOperationTagProjectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addTagProjectResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opTagProjectResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opTagProjectResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opTagProjectResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addTagProjectResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opTagProjectResolveEndpointMiddleware{
