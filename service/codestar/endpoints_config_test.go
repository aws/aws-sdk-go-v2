...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-codestar.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codestar.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codestar.dev",
			expectURL:     aws.String("https://env-codestar.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-codestar.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codestar.dev",
			expectURL:     aws.String("http://config-codestar.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-codestar.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-codestar.dev",
			clientEndpoint: aws.String("https://client-codestar.dev"),
			expectURL:      aws.String("https://client-codestar.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CODESTAR", c.envService)
			}
