...
func (c *Client) ListTagsForProject(ctx context.Context, params *ListTagsForProjectInput, optFns ...func(*Options)) (*ListTagsForProjectOutput, error) {
	if params == nil { params = &ListTagsForProjectInput{} }
...
func (c *Client) addOperationListTagsForProjectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTagsForProjectResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTagsForProjectResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTagsForProjectResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTagsForProjectResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTagsForProjectResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTagsForProjectResolveEndpointMiddleware{
