...
type awsRestjson1_deserializeOpDeleteSecurityConfiguration struct {
}

func (*awsRestjson1_deserializeOpDeleteSecurityConfiguration) ID() string {
	return "OperationDeserializer"
}

func (m *awsRestjson1_deserializeOpDeleteSecurityConfiguration) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsRestjson1_deserializeOpErrorDeleteSecurityConfiguration(response, &metadata)
	}
	...
	err = awsRestjson1_deserializeOpDocumentDeleteSecurityConfigurationOutput(&output, shape)
	if err != nil {
		var snapshot bytes.Buffer
		io.Copy(&snapshot, ringBuffer)
		return out, metadata, &smithy.DeserializationError{
...
func awsRestjson1_deserializeOpErrorDeleteSecurityConfiguration(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func awsRestjson1_deserializeOpDocumentDeleteSecurityConfigurationOutput(v **DeleteSecurityConfigurationOutput, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
...
type awsRestjson1_deserializeOpUpdateVirtualCluster struct {
}

func (*awsRestjson1_deserializeOpUpdateVirtualCluster) ID() string {
	return "OperationDeserializer"
}

func (m *awsRestjson1_deserializeOpUpdateVirtualCluster) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsRestjson1_deserializeOpErrorUpdateVirtualCluster(response, &metadata)
	}
	output := &UpdateVirtualClusterOutput{}
	out.Result = output
	...
	err = awsRestjson1_deserializeOpDocumentUpdateVirtualClusterOutput(&output, shape)
	if err != nil {
		var snapshot bytes.Buffer
		io.Copy(&snapshot, ringBuffer)
		return out, metadata, &smithy.DeserializationError{
...
func awsRestjson1_deserializeOpErrorUpdateVirtualCluster(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func awsRestjson1_deserializeOpDocumentUpdateVirtualClusterOutput(v **UpdateVirtualClusterOutput, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *UpdateVirtualClusterOutput
	if *v == nil {
		sv = &UpdateVirtualClusterOutput{}
	} else {
		sv = *v
	}
...
func awsRestjson1_deserializeDocumentAuthenticationConfiguration(v **types.AuthenticationConfiguration, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	for key, value := range shape {
		...
		case "iamConfiguration":
			if err := awsRestjson1_deserializeDocumentIAMConfiguration(&sv.IamConfiguration, value); err != nil {
				return err
			}
...
func awsRestjson1_deserializeDocumentIAMConfiguration(v **types.IAMConfiguration, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *types.IAMConfiguration
	if *v == nil {
		sv = &types.IAMConfiguration{}
	} else {
		sv = *v
	}
...
func awsRestjson1_deserializeDocumentIdentityCenterConfiguration(v **types.IdentityCenterConfiguration, value interface{}) error {
	...
	for key, value := range shape {
		switch key {
		case "emrIdentityCenterApplicationARN":
			if value != nil {
				jtv, ok := value.(string)
				if !ok {
					return fmt.Errorf("expected EmrIdentityCenterApplicationARN to be of type string, got %T instead", value)
				}
				sv.EmrIdentityCenterApplicationARN = ptr.String(jtv)
			}
		...
		case "identityCenterApplicationAssignmentRequired":
			if value != nil {
				jtv, ok := value.(bool)
				if !ok {
					return fmt.Errorf("expected Boolean to be of type *bool, got %T instead", value)
				}
				sv.IdentityCenterApplicationAssignmentRequired = ptr.Bool(jtv)
			}
	...
	for key, value := range shape {
		...
		case "maxConcurrentJobRuns":
			if value != nil {
				jtv, ok := value.(json.Number)
				if !ok {
					return fmt.Errorf("expected JobLimitInteger to be json.Number, got %T instead", value)
				}
				i64, err := jtv.Int64()
				if err != nil {
					return err
				}
				sv.MaxConcurrentJobRuns = ptr.Int32(int32(i64))
			}

		case "maxInQueueJobRuns":
			if value != nil {
				jtv, ok := value.(json.Number)
				if !ok {
					return fmt.Errorf("expected InQueueJobLimitInteger to be json.Number, got %T instead", value)
				}
				i64, err := jtv.Int64()
				if err != nil {
					return err
				}
				sv.MaxInQueueJobRuns = ptr.Int32(int32(i64))
			}
...
func awsRestjson1_deserializeDocumentSchedulerStatus(v **types.SchedulerStatus, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *types.SchedulerStatus
	if *v == nil {
		sv = &types.SchedulerStatus{}
	} else {
		sv = *v
	}
	...
	for key, value := range shape {
		...
		case "currentConcurrentJobRuns":
			if value != nil {
				...
				sv.CurrentConcurrentJobRuns = int32(i64)
			}

		case "currentInQueueJobRuns":
			if value != nil {
				jtv, ok := value.(json.Number)
				if !ok {
					return fmt.Errorf("expected NonNegativeInteger to be json.Number, got %T instead", value)
				...
				sv.CurrentInQueueJobRuns = int32(i64)
			}
...
func awsRestjson1_deserializeDocumentSecurityConfigurationData(v **types.SecurityConfigurationData, value interface{}) error {
	...
	for key, value := range shape {
		...
		case "authenticationConfiguration":
			if err := awsRestjson1_deserializeDocumentAuthenticationConfiguration(&sv.AuthenticationConfiguration, value); err != nil {
				return err
			}
...
func awsRestjson1_deserializeDocumentVirtualCluster(v **types.VirtualCluster, value interface{}) error {
	...
	for key, value := range shape {
		...
		case "schedulerStatus":
			if err := awsRestjson1_deserializeDocumentSchedulerStatus(&sv.SchedulerStatus, value); err != nil {
				return err
			}
