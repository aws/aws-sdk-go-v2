...
func (c *Client) addOperationListSecurityConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSecurityConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
