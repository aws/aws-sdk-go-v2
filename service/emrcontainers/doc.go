...
// EKS). With this deployment option, you can focus on running analytics workloads
...
// and tasks, see What is shared id="EMR-EKS"/>
...
// - It is the prefix in the CLI
// commands for Amazon EMR on EKS. For example, aws emr-containers start-job-run.
// -
// It is the prefix before IAM policy actions for Amazon EMR on EKS. For example,
// "Action": [ "emr-containers:StartJobRun"]. For more information, see Policy
...
// emr-containers.us-east-2.amazonaws.com. For more information, see Amazon EMR on
