...
// the actions and data types for Amazon Web Services Budgets. Budgets provide you
// with a way to see the following information:
//
// * How close your plan is to your
// budgeted amount or to the free tier limits
//
// * Your usage-to-date, including how
// much you've used of your Reserved Instances (RIs)
//
// * Your current estimated
// charges from Amazon Web Services, and how much your predicted usage will accrue
...
//
// * Cost budgets - Plan how much you want
// to spend on a service.
//
// * Usage budgets - Plan how much you want to use one or
// more services.
//
...
//
// Service Endpoint The Amazon
// Web Services Budgets API provides the following endpoint:
//
// *
// https://budgets.amazonaws.com
//
// For information about costs that are associated
// with the Amazon Web Services Budgets API, see Amazon Web Services Cost
