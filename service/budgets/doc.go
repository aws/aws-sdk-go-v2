...
//
// * RI
// utilization budgets - Define a utilization threshold, and receive alerts when
// your RI usage falls below that threshold. This lets you see if your RIs are
// unused or under-utilized.
//
// * RI coverage budgets - Define a coverage threshold,
// and receive alerts when the number of your instance hours that are covered by
// RIs fall below that threshold. This lets you see how much of your instance usage
// is covered by a reservation.
//
// Service Endpoint The Amazon Web Services Budgets
// API provides the following endpoint:
//
// * https://budgets.amazonaws.com
//
// For
// information about costs that are associated with the Amazon Web Services Budgets
// API, see Amazon Web Services Cost Management Pricing
