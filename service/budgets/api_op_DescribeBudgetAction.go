...
func addOperationDescribeBudgetActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpDescribeBudgetActionValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opDescribeBudgetAction(options.Region), middleware.Before)
