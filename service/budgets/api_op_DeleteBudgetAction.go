...
func addOperationDeleteBudgetActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpDeleteBudgetActionValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteBudgetAction(options.Region), middleware.Before)
