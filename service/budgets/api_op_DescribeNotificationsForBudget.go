...
func (c *Client) addOperationDescribeNotificationsForBudgetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeNotificationsForBudget", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
