...
func (c *Client) DescribeBudgetNotificationsForAccount(ctx context.Context, params *DescribeBudgetNotificationsForAccountInput, optFns ...func(*Options)) (*DescribeBudgetNotificationsForAccountOutput, error) {
	if params == nil { params = &DescribeBudgetNotificationsForAccountInput{} }
...
func (c *Client) addOperationDescribeBudgetNotificationsForAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeBudgetNotificationsForAccountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeBudgetNotificationsForAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeBudgetNotificationsForAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeBudgetNotificationsForAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeBudgetNotificationsForAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeBudgetNotificationsForAccountResolveEndpointMiddleware{
