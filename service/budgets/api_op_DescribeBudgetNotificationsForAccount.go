...
func (c *Client) addOperationDescribeBudgetNotificationsForAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeBudgetNotificationsForAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
