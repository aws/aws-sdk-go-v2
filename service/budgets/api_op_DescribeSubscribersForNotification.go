...
func addOperationDescribeSubscribersForNotificationStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeSubscribersForNotificationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeSubscribersForNotificationStackSlots(stack); err != nil {
		return err
	}
