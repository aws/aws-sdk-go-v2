...
type Budget struct {
	...
	// BudgetLimitis required for cost or usage budgets, but optional for RI or
	...
	// The types of costs that are included in this COST  budget. USAGE ,
	// RI_UTILIZATION , RI_COVERAGE , SAVINGS_PLANS_UTILIZATION , and
	...
	// PlannedBudgetLimitsis available for cost or usage budget and supports both
	// monthly and quarterly TimeUnit . For monthly budgets, provide 12 months of
	// PlannedBudgetLimitsvalues. This must start from the current month and include
	...
	// PlannedBudgetLimitsvalues only for the remaining periods. If the budget begins
	// at a date in the future, provide PlannedBudgetLimits values from the start
	// date of the budget. After all of the BudgetLimit  values in PlannedBudgetLimits
	...
	// specify an end date, Amazon Web Services set your end date to 06/15/87 00:00
	// UTC. The defaults are the same for the Billing and Cost Management console and
	// the API. You can change either date with the UpdateBudget operation. After the
	// end date, Amazon Web Services deletes the budget and all the associated
...
// forecastedSpendtracks how much that you're predicted to spend based on your
...
type Notification struct {
	...
	// in the ALARM  state, you passed the set threshold for the budget.
	NotificationState NotificationState

	// The type of threshold for a notification. For ABSOLUTE_VALUE thresholds,
	// Amazon Web Services notifies you when you go over or are forecasted to go over
	// your total cost threshold. For PERCENTAGE thresholds, Amazon Web Services
	// notifies you when you go over or are forecasted to go over a certain percentage
	// of your forecasted spend. For example, if you have a budget for 200 dollars and
	// you have a PERCENTAGE threshold of 80%, Amazon Web Services notifies you when
...
type Subscriber struct {
	...
	// SNS topic or an email. When you create a subscriber, the value of Address
...
type TimePeriod struct {
	...
	// for the Billing and Cost Management console and the API. After the end date,
	// Amazon Web Services deletes the budget and all the associated notifications and
	...
	// budget on January 24, 2018, chose DAILY, and didn't set a start date, Amazon
	// Web Services set your start date to 01/24/18 00:00 UTC . If you chose MONTHLY,
	// Amazon Web Services set your start date to 01/01/18 00:00 UTC. The defaults
	// are the same for the Billing and Cost Management console and the API. You can
	// change your start date with the UpdateBudget  operation.
	Start *time.Time
