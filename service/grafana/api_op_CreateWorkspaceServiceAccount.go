...
func (c *Client) addOperationCreateWorkspaceServiceAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateWorkspaceServiceAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
