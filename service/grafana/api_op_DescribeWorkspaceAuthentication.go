...
func (c *Client) DescribeWorkspaceAuthentication(ctx context.Context, params *DescribeWorkspaceAuthenticationInput, optFns ...func(*Options)) (*DescribeWorkspaceAuthenticationOutput, error) {
	if params == nil { params = &DescribeWorkspaceAuthenticationInput{} }
...
func (c *Client) addOperationDescribeWorkspaceAuthenticationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeWorkspaceAuthenticationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeWorkspaceAuthenticationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeWorkspaceAuthenticationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeWorkspaceAuthenticationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeWorkspaceAuthenticationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeWorkspaceAuthenticationResolveEndpointMiddleware{
