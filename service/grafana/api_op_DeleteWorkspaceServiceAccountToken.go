...
func (c *Client) addOperationDeleteWorkspaceServiceAccountTokenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteWorkspaceServiceAccountToken", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
