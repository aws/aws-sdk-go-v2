...
func (c *Client) addOperationListWorkspaceServiceAccountTokensMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListWorkspaceServiceAccountTokens", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
