...
func (c *Client) addOperationListWorkspaceServiceAccountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListWorkspaceServiceAccounts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
