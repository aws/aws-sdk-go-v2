...
// data visualization tool that is popular for its extensible data support. With
// Amazon Managed Grafana, you create logically isolated Grafana servers called
// workspaces. In a workspace, you can create Grafana dashboards and visualizations
// to analyze your metrics, logs, and traces without having to build, package, or
// deploy any hardware to run Grafana servers.
package grafana
