...
func (*DeleteWirelessGatewayTaskDefinitionInput) operationName() string {
...
func (c *Client) addOperationDeleteWirelessGatewayTaskDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteWirelessGatewayTaskDefinitionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteWirelessGatewayTaskDefinitionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteWirelessGatewayTaskDefinitionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteWirelessGatewayTaskDefinitionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteWirelessGatewayTaskDefinitionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteWirelessGatewayTaskDefinitionResolveEndpointMiddleware{
