...
func (c *Client) ListFuotaTasks(ctx context.Context, params *ListFuotaTasksInput, optFns ...func(*Options)) (*ListFuotaTasksOutput, error) {
	if params == nil { params = &ListFuotaTasksInput{} }
...
func (c *Client) addOperationListFuotaTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFuotaTasksResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListFuotaTasksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListFuotaTasksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFuotaTasksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFuotaTasksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListFuotaTasksResolveEndpointMiddleware{
