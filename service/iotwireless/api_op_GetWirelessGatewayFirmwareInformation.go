...
func (c *Client) GetWirelessGatewayFirmwareInformation(ctx context.Context, params *GetWirelessGatewayFirmwareInformationInput, optFns ...func(*Options)) (*GetWirelessGatewayFirmwareInformationOutput, error) {
	if params == nil { params = &GetWirelessGatewayFirmwareInformationInput{} }
...
func (c *Client) addOperationGetWirelessGatewayFirmwareInformationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetWirelessGatewayFirmwareInformationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetWirelessGatewayFirmwareInformationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetWirelessGatewayFirmwareInformationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetWirelessGatewayFirmwareInformationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetWirelessGatewayFirmwareInformationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetWirelessGatewayFirmwareInformationResolveEndpointMiddleware{
