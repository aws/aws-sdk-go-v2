...
func (c *Client) DisassociateWirelessDeviceFromMulticastGroup(ctx context.Context, params *DisassociateWirelessDeviceFromMulticastGroupInput, optFns ...func(*Options)) (*DisassociateWirelessDeviceFromMulticastGroupOutput, error) {
	if params == nil { params = &DisassociateWirelessDeviceFromMulticastGroupInput{} }
...
func (c *Client) addOperationDisassociateWirelessDeviceFromMulticastGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateWirelessDeviceFromMulticastGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateWirelessDeviceFromMulticastGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateWirelessDeviceFromMulticastGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateWirelessDeviceFromMulticastGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateWirelessDeviceFromMulticastGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateWirelessDeviceFromMulticastGroupResolveEndpointMiddleware{
