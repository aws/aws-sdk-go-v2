...
func (c *Client) addOperationDisassociateWirelessDeviceFromMulticastGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateWirelessDeviceFromMulticastGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
