...
func (c *Client) GetResourceEventConfiguration(ctx context.Context, params *GetResourceEventConfigurationInput, optFns ...func(*Options)) (*GetResourceEventConfigurationOutput, error) {
	if params == nil { params = &GetResourceEventConfigurationInput{} }
...
func (c *Client) addOperationGetResourceEventConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetResourceEventConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetResourceEventConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetResourceEventConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetResourceEventConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetResourceEventConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetResourceEventConfigurationResolveEndpointMiddleware{
