...
func (c *Client) GetWirelessDevice(ctx context.Context, params *GetWirelessDeviceInput, optFns ...func(*Options)) (*GetWirelessDeviceOutput, error) {
	if params == nil { params = &GetWirelessDeviceInput{} }
...
func (c *Client) addOperationGetWirelessDeviceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetWirelessDeviceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetWirelessDeviceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetWirelessDeviceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetWirelessDeviceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetWirelessDeviceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetWirelessDeviceResolveEndpointMiddleware{
