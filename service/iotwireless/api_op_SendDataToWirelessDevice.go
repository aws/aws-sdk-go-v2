...
func (c *Client) SendDataToWirelessDevice(ctx context.Context, params *SendDataToWirelessDeviceInput, optFns ...func(*Options)) (*SendDataToWirelessDeviceOutput, error) {
	if params == nil { params = &SendDataToWirelessDeviceInput{} }
...
func (c *Client) addOperationSendDataToWirelessDeviceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendDataToWirelessDeviceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSendDataToWirelessDeviceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSendDataToWirelessDeviceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendDataToWirelessDeviceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendDataToWirelessDeviceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSendDataToWirelessDeviceResolveEndpointMiddleware{
