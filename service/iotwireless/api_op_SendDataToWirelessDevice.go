...
func (c *Client) addOperationSendDataToWirelessDeviceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SendDataToWirelessDevice", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
