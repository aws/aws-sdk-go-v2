...
func (c *Client) addOperationGetWirelessGatewayTaskDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetWirelessGatewayTaskDefinition", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
