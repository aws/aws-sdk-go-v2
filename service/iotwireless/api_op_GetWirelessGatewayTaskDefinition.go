...
func (*GetWirelessGatewayTaskDefinitionInput) operationName() string {
	return "GetWirelessGatewayTaskDefinition"
}
...
func (c *Client) addOperationGetWirelessGatewayTaskDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetWirelessGatewayTaskDefinitionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetWirelessGatewayTaskDefinitionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetWirelessGatewayTaskDefinitionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetWirelessGatewayTaskDefinitionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetWirelessGatewayTaskDefinitionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetWirelessGatewayTaskDefinitionResolveEndpointMiddleware{
