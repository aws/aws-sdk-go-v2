...
func (c *Client) UpdateWirelessDeviceImportTask(ctx context.Context, params *UpdateWirelessDeviceImportTaskInput, optFns ...func(*Options)) (*UpdateWirelessDeviceImportTaskOutput, error) {
	if params == nil { params = &UpdateWirelessDeviceImportTaskInput{} }
...
func (c *Client) addOperationUpdateWirelessDeviceImportTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateWirelessDeviceImportTaskResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateWirelessDeviceImportTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateWirelessDeviceImportTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateWirelessDeviceImportTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateWirelessDeviceImportTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateWirelessDeviceImportTaskResolveEndpointMiddleware{
