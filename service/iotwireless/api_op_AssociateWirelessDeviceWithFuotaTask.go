...
func (c *Client) AssociateWirelessDeviceWithFuotaTask(ctx context.Context, params *AssociateWirelessDeviceWithFuotaTaskInput, optFns ...func(*Options)) (*AssociateWirelessDeviceWithFuotaTaskOutput, error) {
	if params == nil { params = &AssociateWirelessDeviceWithFuotaTaskInput{} }
...
func (c *Client) addOperationAssociateWirelessDeviceWithFuotaTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateWirelessDeviceWithFuotaTaskResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateWirelessDeviceWithFuotaTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateWirelessDeviceWithFuotaTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateWirelessDeviceWithFuotaTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateWirelessDeviceWithFuotaTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateWirelessDeviceWithFuotaTaskResolveEndpointMiddleware{
