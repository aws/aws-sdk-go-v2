...
func (c *Client) DisassociateWirelessGatewayFromCertificate(ctx context.Context, params *DisassociateWirelessGatewayFromCertificateInput, optFns ...func(*Options)) (*DisassociateWirelessGatewayFromCertificateOutput, error) {
	if params == nil { params = &DisassociateWirelessGatewayFromCertificateInput{} }
...
func (c *Client) addOperationDisassociateWirelessGatewayFromCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateWirelessGatewayFromCertificateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateWirelessGatewayFromCertificateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateWirelessGatewayFromCertificateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateWirelessGatewayFromCertificateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateWirelessGatewayFromCertificateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateWirelessGatewayFromCertificateResolveEndpointMiddleware{
