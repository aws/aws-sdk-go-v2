...
func (c *Client) addOperationDisassociateWirelessGatewayFromCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateWirelessGatewayFromCertificate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
