...
func (*AssociateWirelessGatewayWithThingInput) operationName() string {
...
func (c *Client) addOperationAssociateWirelessGatewayWithThingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateWirelessGatewayWithThingResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAssociateWirelessGatewayWithThingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAssociateWirelessGatewayWithThingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateWirelessGatewayWithThingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateWirelessGatewayWithThingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAssociateWirelessGatewayWithThingResolveEndpointMiddleware{
