...
func (c *Client) addOperationListWirelessDeviceImportTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListWirelessDeviceImportTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
