...
func (*ListWirelessDeviceImportTasksInput) operationName() string {
...
func (c *Client) addOperationListWirelessDeviceImportTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWirelessDeviceImportTasksResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListWirelessDeviceImportTasksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListWirelessDeviceImportTasksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWirelessDeviceImportTasksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWirelessDeviceImportTasksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListWirelessDeviceImportTasksResolveEndpointMiddleware{
