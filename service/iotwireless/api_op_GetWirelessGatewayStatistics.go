...
func (c *Client) addOperationGetWirelessGatewayStatisticsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetWirelessGatewayStatistics", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
