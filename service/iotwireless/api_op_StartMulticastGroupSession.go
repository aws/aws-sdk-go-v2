...
func (c *Client) StartMulticastGroupSession(ctx context.Context, params *StartMulticastGroupSessionInput, optFns ...func(*Options)) (*StartMulticastGroupSessionOutput, error) {
	if params == nil { params = &StartMulticastGroupSessionInput{} }
...
func (c *Client) addOperationStartMulticastGroupSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartMulticastGroupSessionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartMulticastGroupSessionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartMulticastGroupSessionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartMulticastGroupSessionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartMulticastGroupSessionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartMulticastGroupSessionResolveEndpointMiddleware{
