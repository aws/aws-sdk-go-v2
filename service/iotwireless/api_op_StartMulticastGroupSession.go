...
func (c *Client) addOperationStartMulticastGroupSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartMulticastGroupSession", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
