...
func (*UpdateFuotaTaskInput) operationName() string {
...
func (c *Client) addOperationUpdateFuotaTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateFuotaTaskResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateFuotaTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateFuotaTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateFuotaTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateFuotaTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateFuotaTaskResolveEndpointMiddleware{
