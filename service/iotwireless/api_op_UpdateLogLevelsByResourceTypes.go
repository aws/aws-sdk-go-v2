...
func (c *Client) UpdateLogLevelsByResourceTypes(ctx context.Context, params *UpdateLogLevelsByResourceTypesInput, optFns ...func(*Options)) (*UpdateLogLevelsByResourceTypesOutput, error) {
	if params == nil { params = &UpdateLogLevelsByResourceTypesInput{} }
...
func (c *Client) addOperationUpdateLogLevelsByResourceTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateLogLevelsByResourceTypesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateLogLevelsByResourceTypesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateLogLevelsByResourceTypesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateLogLevelsByResourceTypesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateLogLevelsByResourceTypesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateLogLevelsByResourceTypesResolveEndpointMiddleware{
