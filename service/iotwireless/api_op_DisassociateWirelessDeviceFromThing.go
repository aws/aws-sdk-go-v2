...
func (c *Client) addOperationDisassociateWirelessDeviceFromThingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateWirelessDeviceFromThing", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
