...
func (*DisassociateWirelessDeviceFromThingInput) operationName() string {
...
func (c *Client) addOperationDisassociateWirelessDeviceFromThingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateWirelessDeviceFromThingResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDisassociateWirelessDeviceFromThingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDisassociateWirelessDeviceFromThingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateWirelessDeviceFromThingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateWirelessDeviceFromThingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDisassociateWirelessDeviceFromThingResolveEndpointMiddleware{
