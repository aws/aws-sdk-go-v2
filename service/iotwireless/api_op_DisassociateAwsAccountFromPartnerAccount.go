...
func (c *Client) DisassociateAwsAccountFromPartnerAccount(ctx context.Context, params *DisassociateAwsAccountFromPartnerAccountInput, optFns ...func(*Options)) (*DisassociateAwsAccountFromPartnerAccountOutput, error) {
	if params == nil { params = &DisassociateAwsAccountFromPartnerAccountInput{} }
...
func (c *Client) addOperationDisassociateAwsAccountFromPartnerAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateAwsAccountFromPartnerAccountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateAwsAccountFromPartnerAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateAwsAccountFromPartnerAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateAwsAccountFromPartnerAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateAwsAccountFromPartnerAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateAwsAccountFromPartnerAccountResolveEndpointMiddleware{
