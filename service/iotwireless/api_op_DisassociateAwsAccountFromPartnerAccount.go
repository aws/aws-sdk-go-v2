...
func (c *Client) addOperationDisassociateAwsAccountFromPartnerAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateAwsAccountFromPartnerAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
