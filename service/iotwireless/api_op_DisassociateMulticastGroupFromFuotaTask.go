...
func (c *Client) DisassociateMulticastGroupFromFuotaTask(ctx context.Context, params *DisassociateMulticastGroupFromFuotaTaskInput, optFns ...func(*Options)) (*DisassociateMulticastGroupFromFuotaTaskOutput, error) {
	if params == nil { params = &DisassociateMulticastGroupFromFuotaTaskInput{} }
...
func (c *Client) addOperationDisassociateMulticastGroupFromFuotaTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateMulticastGroupFromFuotaTaskResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateMulticastGroupFromFuotaTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateMulticastGroupFromFuotaTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateMulticastGroupFromFuotaTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateMulticastGroupFromFuotaTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateMulticastGroupFromFuotaTaskResolveEndpointMiddleware{
