...
func (*StartBulkDisassociateWirelessDeviceFromMulticastGroupInput) operationName() string {
...
func (c *Client) addOperationStartBulkDisassociateWirelessDeviceFromMulticastGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartBulkDisassociateWirelessDeviceFromMulticastGroupResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStartBulkDisassociateWirelessDeviceFromMulticastGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStartBulkDisassociateWirelessDeviceFromMulticastGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartBulkDisassociateWirelessDeviceFromMulticastGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartBulkDisassociateWirelessDeviceFromMulticastGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStartBulkDisassociateWirelessDeviceFromMulticastGroupResolveEndpointMiddleware{
