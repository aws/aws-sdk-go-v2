...
func (c *Client) addOperationStartBulkDisassociateWirelessDeviceFromMulticastGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartBulkDisassociateWirelessDeviceFromMulticastGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
