...
func (*StartBulkAssociateWirelessDeviceWithMulticastGroupInput) operationName() string {
...
func (c *Client) addOperationStartBulkAssociateWirelessDeviceWithMulticastGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartBulkAssociateWirelessDeviceWithMulticastGroupResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStartBulkAssociateWirelessDeviceWithMulticastGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStartBulkAssociateWirelessDeviceWithMulticastGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartBulkAssociateWirelessDeviceWithMulticastGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartBulkAssociateWirelessDeviceWithMulticastGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStartBulkAssociateWirelessDeviceWithMulticastGroupResolveEndpointMiddleware{
