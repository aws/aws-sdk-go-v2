...
func (*AssociateWirelessGatewayWithCertificateInput) operationName() string {
...
func (c *Client) addOperationAssociateWirelessGatewayWithCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateWirelessGatewayWithCertificateResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAssociateWirelessGatewayWithCertificateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAssociateWirelessGatewayWithCertificateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateWirelessGatewayWithCertificateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateWirelessGatewayWithCertificateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAssociateWirelessGatewayWithCertificateResolveEndpointMiddleware{
