...
func (*GetWirelessGatewayInput) operationName() string {
	return "GetWirelessGateway"
}
...
func (c *Client) addOperationGetWirelessGatewayMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetWirelessGatewayResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetWirelessGatewayResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetWirelessGatewayResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetWirelessGatewayResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetWirelessGatewayResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetWirelessGatewayResolveEndpointMiddleware{
