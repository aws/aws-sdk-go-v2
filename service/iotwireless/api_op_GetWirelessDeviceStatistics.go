...
func (c *Client) GetWirelessDeviceStatistics(ctx context.Context, params *GetWirelessDeviceStatisticsInput, optFns ...func(*Options)) (*GetWirelessDeviceStatisticsOutput, error) {
	if params == nil { params = &GetWirelessDeviceStatisticsInput{} }
...
func (c *Client) addOperationGetWirelessDeviceStatisticsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetWirelessDeviceStatisticsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetWirelessDeviceStatisticsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetWirelessDeviceStatisticsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetWirelessDeviceStatisticsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetWirelessDeviceStatisticsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetWirelessDeviceStatisticsResolveEndpointMiddleware{
