...
func (c *Client) AssociateWirelessDeviceWithThing(ctx context.Context, params *AssociateWirelessDeviceWithThingInput, optFns ...func(*Options)) (*AssociateWirelessDeviceWithThingOutput, error) {
	if params == nil { params = &AssociateWirelessDeviceWithThingInput{} }
...
func (c *Client) addOperationAssociateWirelessDeviceWithThingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateWirelessDeviceWithThingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateWirelessDeviceWithThingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateWirelessDeviceWithThingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateWirelessDeviceWithThingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateWirelessDeviceWithThingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateWirelessDeviceWithThingResolveEndpointMiddleware{
