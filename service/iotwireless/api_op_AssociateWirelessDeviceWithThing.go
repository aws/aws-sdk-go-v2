...
func (c *Client) addOperationAssociateWirelessDeviceWithThingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateWirelessDeviceWithThing", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
