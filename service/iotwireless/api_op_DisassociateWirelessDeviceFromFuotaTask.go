...
func (*DisassociateWirelessDeviceFromFuotaTaskInput) operationName() string {
...
func (c *Client) addOperationDisassociateWirelessDeviceFromFuotaTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateWirelessDeviceFromFuotaTaskResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDisassociateWirelessDeviceFromFuotaTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDisassociateWirelessDeviceFromFuotaTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateWirelessDeviceFromFuotaTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateWirelessDeviceFromFuotaTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDisassociateWirelessDeviceFromFuotaTaskResolveEndpointMiddleware{
