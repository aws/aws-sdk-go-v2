...
func (c *Client) addOperationDisassociateWirelessDeviceFromFuotaTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateWirelessDeviceFromFuotaTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
