...
func (*GetLogLevelsByResourceTypesInput) operationName() string {
	return "GetLogLevelsByResourceTypes"
}
...
func (c *Client) addOperationGetLogLevelsByResourceTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetLogLevelsByResourceTypesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetLogLevelsByResourceTypesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetLogLevelsByResourceTypesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetLogLevelsByResourceTypesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetLogLevelsByResourceTypesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetLogLevelsByResourceTypesResolveEndpointMiddleware{
