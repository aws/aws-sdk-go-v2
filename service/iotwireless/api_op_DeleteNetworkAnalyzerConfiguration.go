...
func (*DeleteNetworkAnalyzerConfigurationInput) operationName() string {
...
func (c *Client) addOperationDeleteNetworkAnalyzerConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteNetworkAnalyzerConfigurationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteNetworkAnalyzerConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteNetworkAnalyzerConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteNetworkAnalyzerConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteNetworkAnalyzerConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteNetworkAnalyzerConfigurationResolveEndpointMiddleware{
