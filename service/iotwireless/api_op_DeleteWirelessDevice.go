...
func (*DeleteWirelessDeviceInput) operationName() string {
...
func (c *Client) addOperationDeleteWirelessDeviceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteWirelessDeviceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteWirelessDeviceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteWirelessDeviceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteWirelessDeviceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteWirelessDeviceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteWirelessDeviceResolveEndpointMiddleware{
