...
func (c *Client) addOperationUpdateEventConfigurationByResourceTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateEventConfigurationByResourceTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
