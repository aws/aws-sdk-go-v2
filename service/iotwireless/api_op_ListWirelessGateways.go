...
func (c *Client) ListWirelessGateways(ctx context.Context, params *ListWirelessGatewaysInput, optFns ...func(*Options)) (*ListWirelessGatewaysOutput, error) {
	if params == nil { params = &ListWirelessGatewaysInput{} }
...
func (c *Client) addOperationListWirelessGatewaysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWirelessGatewaysResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListWirelessGatewaysResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListWirelessGatewaysResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWirelessGatewaysResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWirelessGatewaysResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListWirelessGatewaysResolveEndpointMiddleware{
