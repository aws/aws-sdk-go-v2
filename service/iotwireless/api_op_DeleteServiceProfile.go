...
func (*DeleteServiceProfileInput) operationName() string {
...
func (c *Client) addOperationDeleteServiceProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteServiceProfileResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteServiceProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteServiceProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteServiceProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteServiceProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteServiceProfileResolveEndpointMiddleware{
