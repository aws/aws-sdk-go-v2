...
func (*DeleteWirelessGatewayTaskInput) operationName() string {
...
func (c *Client) addOperationDeleteWirelessGatewayTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteWirelessGatewayTaskResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteWirelessGatewayTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteWirelessGatewayTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteWirelessGatewayTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteWirelessGatewayTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteWirelessGatewayTaskResolveEndpointMiddleware{
