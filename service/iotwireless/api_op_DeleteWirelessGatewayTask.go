...
func (c *Client) addOperationDeleteWirelessGatewayTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteWirelessGatewayTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
