...
func (c *Client) addOperationListDevicesForWirelessDeviceImportTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDevicesForWirelessDeviceImportTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
