...
func (c *Client) ListDevicesForWirelessDeviceImportTask(ctx context.Context, params *ListDevicesForWirelessDeviceImportTaskInput, optFns ...func(*Options)) (*ListDevicesForWirelessDeviceImportTaskOutput, error) {
	if params == nil { params = &ListDevicesForWirelessDeviceImportTaskInput{} }
...
func (c *Client) addOperationListDevicesForWirelessDeviceImportTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDevicesForWirelessDeviceImportTaskResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDevicesForWirelessDeviceImportTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDevicesForWirelessDeviceImportTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDevicesForWirelessDeviceImportTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDevicesForWirelessDeviceImportTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDevicesForWirelessDeviceImportTaskResolveEndpointMiddleware{
