...
func (c *Client) ListDestinations(ctx context.Context, params *ListDestinationsInput, optFns ...func(*Options)) (*ListDestinationsOutput, error) {
	if params == nil { params = &ListDestinationsInput{} }
...
func (c *Client) addOperationListDestinationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDestinationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDestinationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDestinationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDestinationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDestinationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDestinationsResolveEndpointMiddleware{
