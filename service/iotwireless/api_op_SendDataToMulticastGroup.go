...
func (c *Client) addOperationSendDataToMulticastGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SendDataToMulticastGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
