...
func (c *Client) SendDataToMulticastGroup(ctx context.Context, params *SendDataToMulticastGroupInput, optFns ...func(*Options)) (*SendDataToMulticastGroupOutput, error) {
	if params == nil { params = &SendDataToMulticastGroupInput{} }
...
func (c *Client) addOperationSendDataToMulticastGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendDataToMulticastGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSendDataToMulticastGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSendDataToMulticastGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendDataToMulticastGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendDataToMulticastGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSendDataToMulticastGroupResolveEndpointMiddleware{
