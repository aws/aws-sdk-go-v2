...
func (c *Client) addOperationAssociateMulticastGroupWithFuotaTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateMulticastGroupWithFuotaTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
