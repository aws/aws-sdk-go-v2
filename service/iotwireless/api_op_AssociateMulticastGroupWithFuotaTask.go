...
func (c *Client) AssociateMulticastGroupWithFuotaTask(ctx context.Context, params *AssociateMulticastGroupWithFuotaTaskInput, optFns ...func(*Options)) (*AssociateMulticastGroupWithFuotaTaskOutput, error) {
	if params == nil { params = &AssociateMulticastGroupWithFuotaTaskInput{} }
...
func (c *Client) addOperationAssociateMulticastGroupWithFuotaTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateMulticastGroupWithFuotaTaskResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateMulticastGroupWithFuotaTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateMulticastGroupWithFuotaTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateMulticastGroupWithFuotaTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateMulticastGroupWithFuotaTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateMulticastGroupWithFuotaTaskResolveEndpointMiddleware{
