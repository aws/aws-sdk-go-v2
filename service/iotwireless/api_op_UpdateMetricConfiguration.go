...
func (c *Client) addOperationUpdateMetricConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateMetricConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
