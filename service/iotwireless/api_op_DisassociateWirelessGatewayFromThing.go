...
func (c *Client) addOperationDisassociateWirelessGatewayFromThingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateWirelessGatewayFromThing", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
