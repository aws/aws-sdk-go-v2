...
func (c *Client) DisassociateWirelessGatewayFromThing(ctx context.Context, params *DisassociateWirelessGatewayFromThingInput, optFns ...func(*Options)) (*DisassociateWirelessGatewayFromThingOutput, error) {
	if params == nil { params = &DisassociateWirelessGatewayFromThingInput{} }
...
func (c *Client) addOperationDisassociateWirelessGatewayFromThingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateWirelessGatewayFromThingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateWirelessGatewayFromThingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateWirelessGatewayFromThingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateWirelessGatewayFromThingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateWirelessGatewayFromThingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateWirelessGatewayFromThingResolveEndpointMiddleware{
