...
func (c *Client) addOperationDeleteWirelessDeviceImportTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteWirelessDeviceImportTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
