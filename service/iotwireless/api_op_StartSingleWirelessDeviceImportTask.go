...
func (c *Client) addOperationStartSingleWirelessDeviceImportTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartSingleWirelessDeviceImportTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
