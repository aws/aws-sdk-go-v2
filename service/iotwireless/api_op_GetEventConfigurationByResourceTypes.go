...
func (c *Client) GetEventConfigurationByResourceTypes(ctx context.Context, params *GetEventConfigurationByResourceTypesInput, optFns ...func(*Options)) (*GetEventConfigurationByResourceTypesOutput, error) {
	if params == nil { params = &GetEventConfigurationByResourceTypesInput{} }
...
func (c *Client) addOperationGetEventConfigurationByResourceTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetEventConfigurationByResourceTypesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetEventConfigurationByResourceTypesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetEventConfigurationByResourceTypesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetEventConfigurationByResourceTypesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetEventConfigurationByResourceTypesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetEventConfigurationByResourceTypesResolveEndpointMiddleware{
