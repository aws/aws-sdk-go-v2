...
func (c *Client) addOperationListMulticastGroupsByFuotaTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMulticastGroupsByFuotaTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
