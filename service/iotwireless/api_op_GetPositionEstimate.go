...
func (*GetPositionEstimateInput) operationName() string {
...
func (c *Client) addOperationGetPositionEstimateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPositionEstimateResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetPositionEstimateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetPositionEstimateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPositionEstimateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPositionEstimateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetPositionEstimateResolveEndpointMiddleware{
