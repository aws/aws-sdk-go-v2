...
func (*ListWirelessGatewayTaskDefinitionsInput) operationName() string {
...
func (c *Client) addOperationListWirelessGatewayTaskDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWirelessGatewayTaskDefinitionsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListWirelessGatewayTaskDefinitionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListWirelessGatewayTaskDefinitionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWirelessGatewayTaskDefinitionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWirelessGatewayTaskDefinitionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListWirelessGatewayTaskDefinitionsResolveEndpointMiddleware{
