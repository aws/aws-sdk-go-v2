...
func (c *Client) addOperationListWirelessGatewayTaskDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListWirelessGatewayTaskDefinitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
