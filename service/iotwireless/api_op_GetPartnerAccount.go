...
func (c *Client) GetPartnerAccount(ctx context.Context, params *GetPartnerAccountInput, optFns ...func(*Options)) (*GetPartnerAccountOutput, error) {
	if params == nil { params = &GetPartnerAccountInput{} }
...
func (c *Client) addOperationGetPartnerAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPartnerAccountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPartnerAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPartnerAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPartnerAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPartnerAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPartnerAccountResolveEndpointMiddleware{
