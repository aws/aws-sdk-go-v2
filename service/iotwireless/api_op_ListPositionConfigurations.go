...
func (c *Client) addOperationListPositionConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPositionConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
