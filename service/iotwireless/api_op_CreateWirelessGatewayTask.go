...
func (c *Client) addOperationCreateWirelessGatewayTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateWirelessGatewayTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
