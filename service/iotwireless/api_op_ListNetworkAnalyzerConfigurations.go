...
func (c *Client) ListNetworkAnalyzerConfigurations(ctx context.Context, params *ListNetworkAnalyzerConfigurationsInput, optFns ...func(*Options)) (*ListNetworkAnalyzerConfigurationsOutput, error) {
	if params == nil { params = &ListNetworkAnalyzerConfigurationsInput{} }
...
func (c *Client) addOperationListNetworkAnalyzerConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListNetworkAnalyzerConfigurationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListNetworkAnalyzerConfigurationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListNetworkAnalyzerConfigurationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListNetworkAnalyzerConfigurationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListNetworkAnalyzerConfigurationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListNetworkAnalyzerConfigurationsResolveEndpointMiddleware{
