...
func (c *Client) addOperationListNetworkAnalyzerConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListNetworkAnalyzerConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
