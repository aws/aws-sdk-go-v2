...
func (c *Client) ResetAllResourceLogLevels(ctx context.Context, params *ResetAllResourceLogLevelsInput, optFns ...func(*Options)) (*ResetAllResourceLogLevelsOutput, error) {
	if params == nil { params = &ResetAllResourceLogLevelsInput{} }
...
func (c *Client) addOperationResetAllResourceLogLevelsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResetAllResourceLogLevelsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opResetAllResourceLogLevelsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opResetAllResourceLogLevelsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResetAllResourceLogLevelsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResetAllResourceLogLevelsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opResetAllResourceLogLevelsResolveEndpointMiddleware{
