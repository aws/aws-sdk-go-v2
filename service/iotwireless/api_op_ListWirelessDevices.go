...
func (*ListWirelessDevicesInput) operationName() string {
...
func (c *Client) addOperationListWirelessDevicesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWirelessDevicesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListWirelessDevicesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListWirelessDevicesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWirelessDevicesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWirelessDevicesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListWirelessDevicesResolveEndpointMiddleware{
