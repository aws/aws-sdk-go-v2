...
func (c *Client) addOperationCreateServiceEnvironmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateServiceEnvironment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
