...
func (c *Client) addOperationDescribeSchedulingPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSchedulingPolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
