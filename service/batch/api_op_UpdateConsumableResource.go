...
func (c *Client) addOperationUpdateConsumableResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateConsumableResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
