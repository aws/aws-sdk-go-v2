...
func (c *Client) addOperationDescribeComputeEnvironmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeComputeEnvironments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
