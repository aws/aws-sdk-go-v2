...
func (c *Client) addOperationListConsumableResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListConsumableResources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
