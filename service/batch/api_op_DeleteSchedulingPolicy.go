...
func (c *Client) DeleteSchedulingPolicy(ctx context.Context, params *DeleteSchedulingPolicyInput, optFns ...func(*Options)) (*DeleteSchedulingPolicyOutput, error) {
	if params == nil { params = &DeleteSchedulingPolicyInput{} }
...
func (c *Client) addOperationDeleteSchedulingPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteSchedulingPolicyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteSchedulingPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteSchedulingPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteSchedulingPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteSchedulingPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteSchedulingPolicyResolveEndpointMiddleware{
