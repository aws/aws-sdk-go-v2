...
func (c *Client) addOperationDescribeConsumableResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConsumableResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
