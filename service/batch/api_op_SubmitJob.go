...
func (c *Client) SubmitJob(ctx context.Context, params *SubmitJobInput, optFns ...func(*Options)) (*SubmitJobOutput, error) {
	if params == nil { params = &SubmitJobInput{} }
...
func (c *Client) addOperationSubmitJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSubmitJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSubmitJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSubmitJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSubmitJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSubmitJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSubmitJobResolveEndpointMiddleware{
