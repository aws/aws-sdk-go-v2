...
func (c *Client) addOperationListJobsByConsumableResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListJobsByConsumableResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
