...
func (v *DescribeServiceEnvironmentsInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DescribeServiceEnvironmentsRequest)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DescribeServiceEnvironmentsInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.MaxResults != nil {
		s.WriteInt32(schemas.DescribeServiceEnvironmentsRequest_maxResults, *v.MaxResults)
	}
	if v.NextToken != nil {
		s.WriteString(schemas.DescribeServiceEnvironmentsRequest_nextToken, *v.NextToken)
	}
	serializeStringList(s, schemas.DescribeServiceEnvironmentsRequest_serviceEnvironments, v.ServiceEnvironments)
}
...
func (v *DescribeServiceEnvironmentsOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DescribeServiceEnvironmentsResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DescribeServiceEnvironmentsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.NextToken != nil {
		s.WriteString(schemas.DescribeServiceEnvironmentsResponse_nextToken, *v.NextToken)
	}
	serializeServiceEnvironmentDetailList(s, schemas.DescribeServiceEnvironmentsResponse_serviceEnvironments, v.ServiceEnvironments)
}
func (v *DescribeServiceEnvironmentsOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.DescribeServiceEnvironmentsResponse, func(s *smithy.Schema) error {
		switch s {
		case schemas.DescribeServiceEnvironmentsResponse_nextToken:
			v.NextToken = new(string)
			return d.ReadString(schemas.DescribeServiceEnvironmentsResponse_nextToken, v.NextToken)
		case schemas.DescribeServiceEnvironmentsResponse_serviceEnvironments:
			return deserializeServiceEnvironmentDetailList(d, schemas.DescribeServiceEnvironmentsResponse_serviceEnvironments, &v.ServiceEnvironments)
		}
		return nil
	})
}
func (c *Client) addOperationDescribeServiceEnvironmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.DescribeServiceEnvironments, schemas.DescribeServiceEnvironmentsRequest, schemas.DescribeServiceEnvironmentsResponse)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.DescribeServiceEnvironments, schemas.DescribeServiceEnvironmentsRequest, schemas.DescribeServiceEnvironmentsResponse), output: &DescribeServiceEnvironmentsOutput{}}, middleware.After); err != nil {
		return err
	}
