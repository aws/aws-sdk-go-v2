...
func (c *Client) addOperationDescribeServiceEnvironmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeServiceEnvironments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
