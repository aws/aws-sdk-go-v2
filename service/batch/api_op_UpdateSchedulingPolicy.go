...
func (*UpdateSchedulingPolicyInput) operationName() string {
...
func (c *Client) addOperationUpdateSchedulingPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateSchedulingPolicyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateSchedulingPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateSchedulingPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateSchedulingPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateSchedulingPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateSchedulingPolicyResolveEndpointMiddleware{
