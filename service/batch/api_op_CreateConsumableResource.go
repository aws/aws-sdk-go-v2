...
func (c *Client) addOperationCreateConsumableResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateConsumableResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
