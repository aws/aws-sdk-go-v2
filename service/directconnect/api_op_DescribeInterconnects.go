...
func (c *Client) DescribeInterconnects(ctx context.Context, params *DescribeInterconnectsInput, optFns ...func(*Options)) (*DescribeInterconnectsOutput, error) {
	if params == nil { params = &DescribeInterconnectsInput{} }
...
func (c *Client) addOperationDescribeInterconnectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeInterconnectsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeInterconnectsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeInterconnectsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeInterconnectsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeInterconnectsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeInterconnectsResolveEndpointMiddleware{
