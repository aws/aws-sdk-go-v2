...
func addOperationDisassociateConnectionFromLagStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateConnectionFromLagMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateConnectionFromLagStackSlots(stack); err != nil {
		return err
	}
