...
func (c *Client) AllocateConnectionOnInterconnect(ctx context.Context, params *AllocateConnectionOnInterconnectInput, optFns ...func(*Options)) (*AllocateConnectionOnInterconnectOutput, error) {
	if params == nil { params = &AllocateConnectionOnInterconnectInput{} }
...
func (c *Client) addOperationAllocateConnectionOnInterconnectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAllocateConnectionOnInterconnectResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAllocateConnectionOnInterconnectResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAllocateConnectionOnInterconnectResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAllocateConnectionOnInterconnectResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAllocateConnectionOnInterconnectResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAllocateConnectionOnInterconnectResolveEndpointMiddleware{
