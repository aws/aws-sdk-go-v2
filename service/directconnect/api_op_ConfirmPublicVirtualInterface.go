...
func addOperationConfirmPublicVirtualInterfaceStackSlots(stack *middleware.Stack) error {
...
func addOperationConfirmPublicVirtualInterfaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationConfirmPublicVirtualInterfaceStackSlots(stack); err != nil {
		return err
	}
