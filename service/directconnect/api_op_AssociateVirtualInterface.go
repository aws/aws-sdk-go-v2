...
func (v *AssociateVirtualInterfaceInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.AssociateVirtualInterfaceRequest)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *AssociateVirtualInterfaceInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ConnectionId != nil {
		s.WriteString(schemas.AssociateVirtualInterfaceRequest_connectionId, *v.ConnectionId)
	}
	if v.VirtualInterfaceId != nil {
		s.WriteString(schemas.AssociateVirtualInterfaceRequest_virtualInterfaceId, *v.VirtualInterfaceId)
	}
}
...
func (v *AssociateVirtualInterfaceOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.VirtualInterface)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *AssociateVirtualInterfaceOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AddressFamily != "" {
...
func (v *AssociateVirtualInterfaceOutput) Deserialize(d smithy.ShapeDeserializer) error {
...
func (c *Client) addOperationAssociateVirtualInterfaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.AssociateVirtualInterface, schemas.AssociateVirtualInterfaceRequest, schemas.VirtualInterface)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.AssociateVirtualInterface, schemas.AssociateVirtualInterfaceRequest, schemas.VirtualInterface), output: &AssociateVirtualInterfaceOutput{}}, middleware.After); err != nil {
		return err
	}
