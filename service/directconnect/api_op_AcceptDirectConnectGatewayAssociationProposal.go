...
func addOperationAcceptDirectConnectGatewayAssociationProposalStackSlots(stack *middleware.Stack) error {
...
func addOperationAcceptDirectConnectGatewayAssociationProposalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAcceptDirectConnectGatewayAssociationProposalStackSlots(stack); err != nil {
		return err
	}
