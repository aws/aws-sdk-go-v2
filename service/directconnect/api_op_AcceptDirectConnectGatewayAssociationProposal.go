...
func (c *Client) addOperationAcceptDirectConnectGatewayAssociationProposalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AcceptDirectConnectGatewayAssociationProposal", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
