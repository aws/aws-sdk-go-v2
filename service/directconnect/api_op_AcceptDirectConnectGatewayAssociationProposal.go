...
func (c *Client) AcceptDirectConnectGatewayAssociationProposal(ctx context.Context, params *AcceptDirectConnectGatewayAssociationProposalInput, optFns ...func(*Options)) (*AcceptDirectConnectGatewayAssociationProposalOutput, error) {
	if params == nil { params = &AcceptDirectConnectGatewayAssociationProposalInput{} }
...
func (c *Client) addOperationAcceptDirectConnectGatewayAssociationProposalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAcceptDirectConnectGatewayAssociationProposalResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAcceptDirectConnectGatewayAssociationProposalResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAcceptDirectConnectGatewayAssociationProposalResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAcceptDirectConnectGatewayAssociationProposalResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAcceptDirectConnectGatewayAssociationProposalResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAcceptDirectConnectGatewayAssociationProposalResolveEndpointMiddleware{
