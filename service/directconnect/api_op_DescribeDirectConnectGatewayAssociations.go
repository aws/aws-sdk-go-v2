...
func (c *Client) addOperationDescribeDirectConnectGatewayAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDirectConnectGatewayAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
