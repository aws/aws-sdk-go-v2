...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-direct-connect.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-direct-connect.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-direct-connect.dev",
			expectURL:     aws.String("https://env-direct-connect.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-direct-connect.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-direct-connect.dev",
			expectURL:     aws.String("http://config-direct-connect.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-direct-connect.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-direct-connect.dev",
			clientEndpoint: aws.String("https://client-direct-connect.dev"),
			expectURL:      aws.String("https://client-direct-connect.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DIRECT_CONNECT", c.envService)
			}
