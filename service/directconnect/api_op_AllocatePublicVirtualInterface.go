...
func (v *AllocatePublicVirtualInterfaceInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.AllocatePublicVirtualInterfaceRequest)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *AllocatePublicVirtualInterfaceInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ConnectionId != nil {
		s.WriteString(schemas.AllocatePublicVirtualInterfaceRequest_connectionId, *v.ConnectionId)
	}
	if v.NewPublicVirtualInterfaceAllocation != nil {
		s.WriteStruct(schemas.AllocatePublicVirtualInterfaceRequest_newPublicVirtualInterfaceAllocation)
		v.NewPublicVirtualInterfaceAllocation.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.OwnerAccount != nil {
		s.WriteString(schemas.AllocatePublicVirtualInterfaceRequest_ownerAccount, *v.OwnerAccount)
	}
}
...
func (v *AllocatePublicVirtualInterfaceOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.VirtualInterface)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *AllocatePublicVirtualInterfaceOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AddressFamily != "" {
...
func (v *AllocatePublicVirtualInterfaceOutput) Deserialize(d smithy.ShapeDeserializer) error {
...
func (c *Client) addOperationAllocatePublicVirtualInterfaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.AllocatePublicVirtualInterface, schemas.AllocatePublicVirtualInterfaceRequest, schemas.VirtualInterface)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.AllocatePublicVirtualInterface, schemas.AllocatePublicVirtualInterfaceRequest, schemas.VirtualInterface), output: &AllocatePublicVirtualInterfaceOutput{}}, middleware.After); err != nil {
		return err
	}
