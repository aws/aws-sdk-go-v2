...
func addOperationAllocatePublicVirtualInterfaceStackSlots(stack *middleware.Stack) error {
...
func addOperationAllocatePublicVirtualInterfaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAllocatePublicVirtualInterfaceStackSlots(stack); err != nil {
		return err
	}
