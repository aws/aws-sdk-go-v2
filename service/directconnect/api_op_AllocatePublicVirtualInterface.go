...
// handle traffic. When creating an IPv6 public virtual interface, omit the Amazon
// address and customer address. IPv6 addresses are automatically assigned from the
