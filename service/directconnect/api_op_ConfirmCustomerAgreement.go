...
func (c *Client) addOperationConfirmCustomerAgreementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ConfirmCustomerAgreement", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
