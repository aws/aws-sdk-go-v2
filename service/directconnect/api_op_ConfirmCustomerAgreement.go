...
func (c *Client) ConfirmCustomerAgreement(ctx context.Context, params *ConfirmCustomerAgreementInput, optFns ...func(*Options)) (*ConfirmCustomerAgreementOutput, error) {
	if params == nil { params = &ConfirmCustomerAgreementInput{} }
...
func (c *Client) addOperationConfirmCustomerAgreementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addConfirmCustomerAgreementResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opConfirmCustomerAgreementResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opConfirmCustomerAgreementResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opConfirmCustomerAgreementResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addConfirmCustomerAgreementResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opConfirmCustomerAgreementResolveEndpointMiddleware{
