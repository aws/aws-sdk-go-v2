...
func (c *Client) DescribeLags(ctx context.Context, params *DescribeLagsInput, optFns ...func(*Options)) (*DescribeLagsOutput, error) {
	if params == nil { params = &DescribeLagsInput{} }
...
func (c *Client) addOperationDescribeLagsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeLagsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeLagsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeLagsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeLagsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeLagsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeLagsResolveEndpointMiddleware{
