...
func (*DescribeConnectionsOnInterconnectInput) operationName() string {
...
func (c *Client) addOperationDescribeConnectionsOnInterconnectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeConnectionsOnInterconnectResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeConnectionsOnInterconnectResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeConnectionsOnInterconnectResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeConnectionsOnInterconnectResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeConnectionsOnInterconnectResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeConnectionsOnInterconnectResolveEndpointMiddleware{
