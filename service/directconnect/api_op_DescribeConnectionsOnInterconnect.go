...
func addOperationDescribeConnectionsOnInterconnectStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeConnectionsOnInterconnectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeConnectionsOnInterconnectStackSlots(stack); err != nil {
		return err
	}
