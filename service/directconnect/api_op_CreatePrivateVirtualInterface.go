...
func addOperationCreatePrivateVirtualInterfaceStackSlots(stack *middleware.Stack) error {
...
func addOperationCreatePrivateVirtualInterfaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreatePrivateVirtualInterfaceStackSlots(stack); err != nil {
		return err
	}
