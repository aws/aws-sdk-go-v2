...
func (c *Client) addOperationDescribeCustomerMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCustomerMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
