...
func addOperationCreatePublicVirtualInterfaceStackSlots(stack *middleware.Stack) error {
...
func addOperationCreatePublicVirtualInterfaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreatePublicVirtualInterfaceStackSlots(stack); err != nil {
		return err
	}
