...
func (c *Client) UpdateVirtualInterfaceAttributes(ctx context.Context, params *UpdateVirtualInterfaceAttributesInput, optFns ...func(*Options)) (*UpdateVirtualInterfaceAttributesOutput, error) {
	stack := middleware.NewStack("UpdateVirtualInterfaceAttributes", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpUpdateVirtualInterfaceAttributesMiddlewares(stack)
	...
	addOpUpdateVirtualInterfaceAttributesValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opUpdateVirtualInterfaceAttributes(options.Region), middleware.Before)
...
func addawsAwsjson11_serdeOpUpdateVirtualInterfaceAttributesMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpUpdateVirtualInterfaceAttributes{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpUpdateVirtualInterfaceAttributes{}, middleware.After)
}
