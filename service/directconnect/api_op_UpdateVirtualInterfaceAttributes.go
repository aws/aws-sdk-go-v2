...
func addOperationUpdateVirtualInterfaceAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateVirtualInterfaceAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateVirtualInterfaceAttributesStackSlots(stack); err != nil {
		return err
	}
