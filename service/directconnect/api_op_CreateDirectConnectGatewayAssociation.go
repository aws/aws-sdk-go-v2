...
func (c *Client) CreateDirectConnectGatewayAssociation(ctx context.Context, params *CreateDirectConnectGatewayAssociationInput, optFns ...func(*Options)) (*CreateDirectConnectGatewayAssociationOutput, error) {
	if params == nil { params = &CreateDirectConnectGatewayAssociationInput{} }
...
func (c *Client) addOperationCreateDirectConnectGatewayAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateDirectConnectGatewayAssociationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateDirectConnectGatewayAssociationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateDirectConnectGatewayAssociationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateDirectConnectGatewayAssociationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateDirectConnectGatewayAssociationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateDirectConnectGatewayAssociationResolveEndpointMiddleware{
