...
func addOperationCreateDirectConnectGatewayAssociationStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateDirectConnectGatewayAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateDirectConnectGatewayAssociationStackSlots(stack); err != nil {
		return err
	}
