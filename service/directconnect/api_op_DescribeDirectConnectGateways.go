...
func (*DescribeDirectConnectGatewaysInput) operationName() string {
...
func (c *Client) addOperationDescribeDirectConnectGatewaysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeDirectConnectGatewaysResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeDirectConnectGatewaysResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeDirectConnectGatewaysResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeDirectConnectGatewaysResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeDirectConnectGatewaysResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeDirectConnectGatewaysResolveEndpointMiddleware{
