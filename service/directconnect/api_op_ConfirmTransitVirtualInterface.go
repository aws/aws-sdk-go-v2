...
func addOperationConfirmTransitVirtualInterfaceStackSlots(stack *middleware.Stack) error {
...
func addOperationConfirmTransitVirtualInterfaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationConfirmTransitVirtualInterfaceStackSlots(stack); err != nil {
		return err
	}
