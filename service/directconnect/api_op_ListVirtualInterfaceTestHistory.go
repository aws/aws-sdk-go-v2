...
func (c *Client) addOperationListVirtualInterfaceTestHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListVirtualInterfaceTestHistory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
