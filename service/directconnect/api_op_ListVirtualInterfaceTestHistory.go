...
func (c *Client) ListVirtualInterfaceTestHistory(ctx context.Context, params *ListVirtualInterfaceTestHistoryInput, optFns ...func(*Options)) (*ListVirtualInterfaceTestHistoryOutput, error) {
	if params == nil { params = &ListVirtualInterfaceTestHistoryInput{} }
...
func (c *Client) addOperationListVirtualInterfaceTestHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListVirtualInterfaceTestHistoryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListVirtualInterfaceTestHistoryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListVirtualInterfaceTestHistoryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListVirtualInterfaceTestHistoryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListVirtualInterfaceTestHistoryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListVirtualInterfaceTestHistoryResolveEndpointMiddleware{
