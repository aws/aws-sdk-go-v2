...
func (*DescribeLocationsInput) operationName() string {
...
func (c *Client) addOperationDescribeLocationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeLocationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeLocationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeLocationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeLocationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeLocationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeLocationsResolveEndpointMiddleware{
