...
func addOperationAllocatePrivateVirtualInterfaceStackSlots(stack *middleware.Stack) error {
...
func addOperationAllocatePrivateVirtualInterfaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAllocatePrivateVirtualInterfaceStackSlots(stack); err != nil {
		return err
	}
