...
func (*AllocatePrivateVirtualInterfaceInput) operationName() string {
...
func (c *Client) addOperationAllocatePrivateVirtualInterfaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAllocatePrivateVirtualInterfaceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAllocatePrivateVirtualInterfaceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAllocatePrivateVirtualInterfaceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAllocatePrivateVirtualInterfaceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAllocatePrivateVirtualInterfaceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAllocatePrivateVirtualInterfaceResolveEndpointMiddleware{
