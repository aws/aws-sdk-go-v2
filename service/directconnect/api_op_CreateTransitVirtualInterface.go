...
// attached to a transit gateway to a Direct Connect gateway. If you associate your
// transit gateway with one or more Direct Connect gateways, the Autonomous System
// Number (ASN) used by the transit gateway and the Direct Connect gateway must be
