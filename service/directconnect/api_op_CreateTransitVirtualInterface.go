...
func (c *Client) addOperationCreateTransitVirtualInterfaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateTransitVirtualInterface", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
