...
func addOperationCreateTransitVirtualInterfaceStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateTransitVirtualInterfaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateTransitVirtualInterfaceStackSlots(stack); err != nil {
		return err
	}
