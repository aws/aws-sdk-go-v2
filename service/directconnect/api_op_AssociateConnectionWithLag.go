...
func (v *AssociateConnectionWithLagInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.AssociateConnectionWithLagRequest)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *AssociateConnectionWithLagInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ConnectionId != nil {
		s.WriteString(schemas.AssociateConnectionWithLagRequest_connectionId, *v.ConnectionId)
	}
	if v.LagId != nil {
		s.WriteString(schemas.AssociateConnectionWithLagRequest_lagId, *v.LagId)
	}
}
...
func (v *AssociateConnectionWithLagOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.Connection)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *AssociateConnectionWithLagOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AwsDevice != nil {
...
func (v *AssociateConnectionWithLagOutput) Deserialize(d smithy.ShapeDeserializer) error {
...
func (c *Client) addOperationAssociateConnectionWithLagMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.AssociateConnectionWithLag, schemas.AssociateConnectionWithLagRequest, schemas.Connection)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.AssociateConnectionWithLag, schemas.AssociateConnectionWithLagRequest, schemas.Connection), output: &AssociateConnectionWithLagOutput{}}, middleware.After); err != nil {
		return err
	}
