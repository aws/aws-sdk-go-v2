...
func addOperationAssociateConnectionWithLagStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociateConnectionWithLagMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociateConnectionWithLagStackSlots(stack); err != nil {
		return err
	}
