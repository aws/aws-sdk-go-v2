...
func addOperationDescribeDirectConnectGatewayAttachmentsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeDirectConnectGatewayAttachmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeDirectConnectGatewayAttachmentsStackSlots(stack); err != nil {
		return err
	}
