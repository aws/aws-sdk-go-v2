...
func (c *Client) DescribeDirectConnectGatewayAttachments(ctx context.Context, params *DescribeDirectConnectGatewayAttachmentsInput, optFns ...func(*Options)) (*DescribeDirectConnectGatewayAttachmentsOutput, error) {
	if params == nil { params = &DescribeDirectConnectGatewayAttachmentsInput{} }
...
func (c *Client) addOperationDescribeDirectConnectGatewayAttachmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeDirectConnectGatewayAttachmentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeDirectConnectGatewayAttachmentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeDirectConnectGatewayAttachmentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeDirectConnectGatewayAttachmentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeDirectConnectGatewayAttachmentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeDirectConnectGatewayAttachmentsResolveEndpointMiddleware{
