...
func (c *Client) StopBgpFailoverTest(ctx context.Context, params *StopBgpFailoverTestInput, optFns ...func(*Options)) (*StopBgpFailoverTestOutput, error) {
	if params == nil { params = &StopBgpFailoverTestInput{} }
...
func (c *Client) addOperationStopBgpFailoverTestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopBgpFailoverTestResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopBgpFailoverTestResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopBgpFailoverTestResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopBgpFailoverTestResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopBgpFailoverTestResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopBgpFailoverTestResolveEndpointMiddleware{
