...
func (c *Client) DescribeLoa(ctx context.Context, params *DescribeLoaInput, optFns ...func(*Options)) (*DescribeLoaOutput, error) {
	stack := middleware.NewStack("DescribeLoa", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpDescribeLoaMiddlewares(stack)
	...
	addOpDescribeLoaValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opDescribeLoa(options.Region), middleware.Before)
...
func addawsAwsjson11_serdeOpDescribeLoaMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpDescribeLoa{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpDescribeLoa{}, middleware.After)
}
