...
func addOperationConfirmPrivateVirtualInterfaceStackSlots(stack *middleware.Stack) error {
...
func addOperationConfirmPrivateVirtualInterfaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationConfirmPrivateVirtualInterfaceStackSlots(stack); err != nil {
		return err
	}
