...
func addOperationDeleteDirectConnectGatewayAssociationProposalStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteDirectConnectGatewayAssociationProposalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteDirectConnectGatewayAssociationProposalStackSlots(stack); err != nil {
		return err
	}
