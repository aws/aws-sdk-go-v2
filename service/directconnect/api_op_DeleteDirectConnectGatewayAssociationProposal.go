...
func (c *Client) addOperationDeleteDirectConnectGatewayAssociationProposalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDirectConnectGatewayAssociationProposal", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
