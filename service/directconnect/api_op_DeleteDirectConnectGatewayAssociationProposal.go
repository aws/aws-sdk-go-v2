...
func (*DeleteDirectConnectGatewayAssociationProposalInput) operationName() string {
...
func (c *Client) addOperationDeleteDirectConnectGatewayAssociationProposalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteDirectConnectGatewayAssociationProposalResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteDirectConnectGatewayAssociationProposalResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteDirectConnectGatewayAssociationProposalResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteDirectConnectGatewayAssociationProposalResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteDirectConnectGatewayAssociationProposalResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteDirectConnectGatewayAssociationProposalResolveEndpointMiddleware{
