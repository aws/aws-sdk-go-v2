...
func (c *Client) UpdateDirectConnectGateway(ctx context.Context, params *UpdateDirectConnectGatewayInput, optFns ...func(*Options)) (*UpdateDirectConnectGatewayOutput, error) {
	if params == nil { params = &UpdateDirectConnectGatewayInput{} }
...
func (c *Client) addOperationUpdateDirectConnectGatewayMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateDirectConnectGatewayResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateDirectConnectGatewayResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateDirectConnectGatewayResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateDirectConnectGatewayResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateDirectConnectGatewayResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateDirectConnectGatewayResolveEndpointMiddleware{
