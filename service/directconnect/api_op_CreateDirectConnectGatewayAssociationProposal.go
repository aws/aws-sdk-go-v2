...
func addOperationCreateDirectConnectGatewayAssociationProposalStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateDirectConnectGatewayAssociationProposalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateDirectConnectGatewayAssociationProposalStackSlots(stack); err != nil {
		return err
	}
