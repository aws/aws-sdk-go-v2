...
func (c *Client) addOperationDeleteDirectConnectGatewayMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDirectConnectGateway", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
