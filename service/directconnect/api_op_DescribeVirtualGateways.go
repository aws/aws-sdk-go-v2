...
// Lists the virtual private gateways owned by the account. You can create one or
// more Direct Connect private virtual interfaces linked to a virtual private
// gateway.
