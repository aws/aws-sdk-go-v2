...
// for a particular row, then that column will not be updated for that row. To
// clear out the data in a specific cell, you need to set the value as an empty
// string ("").
...
type BatchUpsertTableRowsInput struct {
	...
	// because of an error or one of the column ids in any of the rows does not exist
