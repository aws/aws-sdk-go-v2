...
func (*ListTableRowsInput) operationName() string {
...
func (c *Client) addOperationListTableRowsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTableRowsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListTableRowsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListTableRowsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTableRowsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTableRowsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListTableRowsResolveEndpointMiddleware{
