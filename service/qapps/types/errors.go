...
func (v *ContentTooLargeException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ContentTooLargeException, func(s *smithy.Schema) error {
		switch s {
		case schemas.ContentTooLargeException_message:
			v.Message = new(string)
			return d.ReadString(schemas.ContentTooLargeException_message, v.Message)
		case schemas.ContentTooLargeException_resourceId:
			v.ResourceId = new(string)
			return d.ReadString(schemas.ContentTooLargeException_resourceId, v.ResourceId)
		case schemas.ContentTooLargeException_resourceType:
			v.ResourceType = new(string)
			return d.ReadString(schemas.ContentTooLargeException_resourceType, v.ResourceType)
		}
		return nil
	})
}
