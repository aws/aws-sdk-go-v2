...
func (c *Client) addOperationUpdateLibraryItemMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateLibraryItemMetadata", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
