...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-qapps.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-qapps.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-qapps.dev",
			expectURL:     aws.String("https://env-qapps.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-qapps.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-qapps.dev",
			expectURL:     aws.String("http://config-qapps.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-qapps.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-qapps.dev",
			clientEndpoint: aws.String("https://client-qapps.dev"),
			expectURL:      aws.String("https://client-qapps.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_QAPPS", c.envService)
			}
