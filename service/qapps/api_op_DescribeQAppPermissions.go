...
func (c *Client) addOperationDescribeQAppPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeQAppPermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
