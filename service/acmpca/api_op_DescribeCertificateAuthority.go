...
func (c *Client) addOperationDescribeCertificateAuthorityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCertificateAuthority", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
