...
func (c *Client) addOperationGetCertificateAuthorityCsrMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCertificateAuthorityCsr", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
