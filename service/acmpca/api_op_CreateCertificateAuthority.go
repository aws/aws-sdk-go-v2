...
func addOperationCreateCertificateAuthorityStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateCertificateAuthorityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateCertificateAuthorityStackSlots(stack); err != nil {
		return err
	}
