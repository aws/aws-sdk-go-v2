...
func (c *Client) addOperationUntagCertificateAuthorityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UntagCertificateAuthority", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
