...
// a private CA, use the TagCertificateAuthority. Call the ListTags action to see
...
func addOperationUntagCertificateAuthorityStackSlots(stack *middleware.Stack) error {
...
func addOperationUntagCertificateAuthorityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUntagCertificateAuthorityStackSlots(stack); err != nil {
		return err
	}
