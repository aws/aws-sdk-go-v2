...
func (c *Client) addOperationDeleteCertificateAuthorityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteCertificateAuthority", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
