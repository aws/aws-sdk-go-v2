...
func (c *Client) addOperationDescribeCertificateAuthorityAuditReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCertificateAuthorityAuditReport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
