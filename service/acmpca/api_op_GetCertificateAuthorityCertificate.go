...
func addOperationGetCertificateAuthorityCertificateStackSlots(stack *middleware.Stack) error {
...
func addOperationGetCertificateAuthorityCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetCertificateAuthorityCertificateStackSlots(stack); err != nil {
		return err
	}
