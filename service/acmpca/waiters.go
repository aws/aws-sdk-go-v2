...
func (c *ACMPCA) WaitUntilAuditReportCreated(ctx context.Context, input *DescribeCertificateAuthorityAuditReportInput, opts ...aws.WaiterOption) error {
	w := aws.Waiter{
...
// sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ACMPCA) WaitUntilCertificateAuthorityCSRCreated(ctx context.Context, input *GetCertificateAuthorityCsrInput, opts ...aws.WaiterOption) error {
	w := aws.Waiter{
...
// sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ACMPCA) WaitUntilCertificateIssued(ctx context.Context, input *GetCertificateInput, opts ...aws.WaiterOption) error {
	w := aws.Waiter{
