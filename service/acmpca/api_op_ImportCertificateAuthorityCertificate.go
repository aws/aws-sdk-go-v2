...
func (c *Client) addOperationImportCertificateAuthorityCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ImportCertificateAuthorityCertificate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
