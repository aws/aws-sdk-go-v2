...
func (c *Client) ListCertificateAuthorities(ctx context.Context, params *ListCertificateAuthoritiesInput, optFns ...func(*Options)) (*ListCertificateAuthoritiesOutput, error) {
	if params == nil { params = &ListCertificateAuthoritiesInput{} }
...
func (c *Client) addOperationListCertificateAuthoritiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCertificateAuthoritiesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCertificateAuthoritiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCertificateAuthoritiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCertificateAuthoritiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCertificateAuthoritiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCertificateAuthoritiesResolveEndpointMiddleware{
