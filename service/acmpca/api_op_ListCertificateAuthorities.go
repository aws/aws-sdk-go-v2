...
func addOperationListCertificateAuthoritiesStackSlots(stack *middleware.Stack) error {
...
func addOperationListCertificateAuthoritiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListCertificateAuthoritiesStackSlots(stack); err != nil {
		return err
	}
