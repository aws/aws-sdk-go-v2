...
func (c *Client) addOperationListCertificateAuthoritiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCertificateAuthorities", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
