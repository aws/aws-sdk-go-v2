...
func (c *Client) addOperationListConnectInstanceIntegrationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListConnectInstanceIntegrations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
