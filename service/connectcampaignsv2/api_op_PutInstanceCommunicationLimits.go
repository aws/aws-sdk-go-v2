...
func (c *Client) addOperationPutInstanceCommunicationLimitsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutInstanceCommunicationLimits", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
