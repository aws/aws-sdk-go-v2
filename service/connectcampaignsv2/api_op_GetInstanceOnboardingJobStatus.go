...
func (c *Client) addOperationGetInstanceOnboardingJobStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetInstanceOnboardingJobStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
