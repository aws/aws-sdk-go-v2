...
// Resolver ConnectCampaignsV2 endpoint resolver
		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			{
				...
				Hostname:          "connect-campaigns.{region}.api.amazonwebservices.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "connect-campaigns-fips.{region}.amazonaws.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "connect-campaigns-fips.{region}.api.amazonwebservices.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "connect-campaigns.{region}.amazonaws.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
		},
		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			{
				...
				Hostname:          "connect-campaigns-fips.{region}.cloud.adc-e.uk",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "connect-campaigns.{region}.cloud.adc-e.uk",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
		},
		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			{
				...
				Hostname:          "connect-campaigns-fips.{region}.csp.hci.ic.gov",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "connect-campaigns.{region}.csp.hci.ic.gov",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
		},
