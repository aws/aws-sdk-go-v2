...
func (c *Client) addOperationPutProfileOutboundRequestBatchMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutProfileOutboundRequestBatch", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
