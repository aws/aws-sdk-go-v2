...
func (c *Client) addOperationPutOutboundRequestBatchMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutOutboundRequestBatch", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
