...
func (c *Client) addOperationGetInstanceCommunicationLimitsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetInstanceCommunicationLimits", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
