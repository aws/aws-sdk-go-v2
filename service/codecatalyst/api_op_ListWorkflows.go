...
func (v *ListWorkflowsInput) SerializeMembers(s smithy.ShapeSerializer) {
	...
	if v.ProjectName != nil {
		s.WriteString(schemas.ListWorkflowsRequest_projectName, *v.ProjectName)
	}
	serializeWorkflowSortCriteriaList(s, schemas.ListWorkflowsRequest_sortBy, v.SortBy)
	if v.SpaceName != nil {
		s.WriteString(schemas.ListWorkflowsRequest_spaceName, *v.SpaceName)
	}
}
...
func (v *ListWorkflowsOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListWorkflowsResponse, func(s *smithy.Schema) error {
		switch s {
		case schemas.ListWorkflowsResponse_items:
			return deserializeWorkflowSummaries(d, schemas.ListWorkflowsResponse_items, &v.Items)
