...
func (c *Client) addOperationListDevEnvironmentSessionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDevEnvironmentSessions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
