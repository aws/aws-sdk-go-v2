...
func (c *Client) StartDevEnvironment(ctx context.Context, params *StartDevEnvironmentInput, optFns ...func(*Options)) (*StartDevEnvironmentOutput, error) {
	if params == nil { params = &StartDevEnvironmentInput{} }
...
func (c *Client) addOperationStartDevEnvironmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartDevEnvironmentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartDevEnvironmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartDevEnvironmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartDevEnvironmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartDevEnvironmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartDevEnvironmentResolveEndpointMiddleware{
