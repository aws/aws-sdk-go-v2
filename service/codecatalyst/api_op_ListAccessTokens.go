...
func (c *Client) ListAccessTokens(ctx context.Context, params *ListAccessTokensInput, optFns ...func(*Options)) (*ListAccessTokensOutput, error) {
	if params == nil { params = &ListAccessTokensInput{} }
...
func (c *Client) addOperationListAccessTokensMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAccessTokensResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAccessTokensResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAccessTokensResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAccessTokensResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAccessTokensResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAccessTokensResolveEndpointMiddleware{
