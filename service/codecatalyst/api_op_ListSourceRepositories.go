...
func (c *Client) ListSourceRepositories(ctx context.Context, params *ListSourceRepositoriesInput, optFns ...func(*Options)) (*ListSourceRepositoriesOutput, error) {
	if params == nil { params = &ListSourceRepositoriesInput{} }
...
func (c *Client) addOperationListSourceRepositoriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSourceRepositoriesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSourceRepositoriesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSourceRepositoriesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSourceRepositoriesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSourceRepositoriesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSourceRepositoriesResolveEndpointMiddleware{
