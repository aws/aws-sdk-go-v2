...
func (c *Client) GetSourceRepositoryCloneUrls(ctx context.Context, params *GetSourceRepositoryCloneUrlsInput, optFns ...func(*Options)) (*GetSourceRepositoryCloneUrlsOutput, error) {
	if params == nil { params = &GetSourceRepositoryCloneUrlsInput{} }
...
func (c *Client) addOperationGetSourceRepositoryCloneUrlsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSourceRepositoryCloneUrlsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSourceRepositoryCloneUrlsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSourceRepositoryCloneUrlsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSourceRepositoryCloneUrlsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSourceRepositoryCloneUrlsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSourceRepositoryCloneUrlsResolveEndpointMiddleware{
