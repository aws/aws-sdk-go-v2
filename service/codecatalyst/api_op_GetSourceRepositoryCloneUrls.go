...
func (c *Client) addOperationGetSourceRepositoryCloneUrlsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSourceRepositoryCloneUrls", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
