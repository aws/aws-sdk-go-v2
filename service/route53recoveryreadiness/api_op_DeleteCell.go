...
func (c *Client) DeleteCell(ctx context.Context, params *DeleteCellInput, optFns ...func(*Options)) (*DeleteCellOutput, error) {
	if params == nil { params = &DeleteCellInput{} }
...
func (c *Client) addOperationDeleteCellMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCellResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteCellResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteCellResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCellResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCellResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteCellResolveEndpointMiddleware{
