...
func (c *Client) addOperationGetReadinessCheckStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetReadinessCheckStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
