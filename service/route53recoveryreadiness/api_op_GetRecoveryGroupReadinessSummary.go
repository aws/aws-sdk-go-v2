...
func (c *Client) addOperationGetRecoveryGroupReadinessSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRecoveryGroupReadinessSummary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
