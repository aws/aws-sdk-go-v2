...
func (c *Client) GetRecoveryGroupReadinessSummary(ctx context.Context, params *GetRecoveryGroupReadinessSummaryInput, optFns ...func(*Options)) (*GetRecoveryGroupReadinessSummaryOutput, error) {
	if params == nil { params = &GetRecoveryGroupReadinessSummaryInput{} }
...
func (c *Client) addOperationGetRecoveryGroupReadinessSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRecoveryGroupReadinessSummaryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRecoveryGroupReadinessSummaryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRecoveryGroupReadinessSummaryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRecoveryGroupReadinessSummaryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRecoveryGroupReadinessSummaryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRecoveryGroupReadinessSummaryResolveEndpointMiddleware{
