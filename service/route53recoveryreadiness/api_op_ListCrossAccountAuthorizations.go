...
func (c *Client) addOperationListCrossAccountAuthorizationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCrossAccountAuthorizations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
