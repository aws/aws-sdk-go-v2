...
func (c *Client) ListCrossAccountAuthorizations(ctx context.Context, params *ListCrossAccountAuthorizationsInput, optFns ...func(*Options)) (*ListCrossAccountAuthorizationsOutput, error) {
	if params == nil { params = &ListCrossAccountAuthorizationsInput{} }
...
func (c *Client) addOperationListCrossAccountAuthorizationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCrossAccountAuthorizationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCrossAccountAuthorizationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCrossAccountAuthorizationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCrossAccountAuthorizationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCrossAccountAuthorizationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCrossAccountAuthorizationsResolveEndpointMiddleware{
