...
func (*UpdateRecoveryGroupInput) operationName() string {
...
func (c *Client) addOperationUpdateRecoveryGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateRecoveryGroupResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateRecoveryGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateRecoveryGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateRecoveryGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateRecoveryGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateRecoveryGroupResolveEndpointMiddleware{
