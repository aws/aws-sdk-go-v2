...
func (*GetReadinessCheckInput) operationName() string {
...
func (c *Client) addOperationGetReadinessCheckMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetReadinessCheckResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetReadinessCheckResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetReadinessCheckResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetReadinessCheckResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetReadinessCheckResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetReadinessCheckResolveEndpointMiddleware{
