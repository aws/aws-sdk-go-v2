...
func (*GetRecoveryGroupInput) operationName() string {
	return "GetRecoveryGroup"
}
...
func (c *Client) addOperationGetRecoveryGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRecoveryGroupResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetRecoveryGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetRecoveryGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRecoveryGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRecoveryGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetRecoveryGroupResolveEndpointMiddleware{
