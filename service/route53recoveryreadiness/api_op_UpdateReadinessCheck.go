...
func (*UpdateReadinessCheckInput) operationName() string {
...
func (c *Client) addOperationUpdateReadinessCheckMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateReadinessCheckResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateReadinessCheckResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateReadinessCheckResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateReadinessCheckResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateReadinessCheckResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateReadinessCheckResolveEndpointMiddleware{
