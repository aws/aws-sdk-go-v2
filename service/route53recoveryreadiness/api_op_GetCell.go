...
func (c *Client) GetCell(ctx context.Context, params *GetCellInput, optFns ...func(*Options)) (*GetCellOutput, error) {
	if params == nil { params = &GetCellInput{} }
...
func (c *Client) addOperationGetCellMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCellResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCellResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCellResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCellResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCellResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCellResolveEndpointMiddleware{
