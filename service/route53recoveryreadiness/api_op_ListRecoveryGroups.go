...
func (c *Client) ListRecoveryGroups(ctx context.Context, params *ListRecoveryGroupsInput, optFns ...func(*Options)) (*ListRecoveryGroupsOutput, error) {
	if params == nil { params = &ListRecoveryGroupsInput{} }
...
func (c *Client) addOperationListRecoveryGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRecoveryGroupsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRecoveryGroupsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRecoveryGroupsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRecoveryGroupsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRecoveryGroupsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRecoveryGroupsResolveEndpointMiddleware{
