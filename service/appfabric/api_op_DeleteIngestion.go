...
func (*DeleteIngestionInput) operationName() string {
...
func (c *Client) addOperationDeleteIngestionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteIngestionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteIngestionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteIngestionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteIngestionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteIngestionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteIngestionResolveEndpointMiddleware{
