...
func (c *Client) ListIngestionDestinations(ctx context.Context, params *ListIngestionDestinationsInput, optFns ...func(*Options)) (*ListIngestionDestinationsOutput, error) {
	if params == nil { params = &ListIngestionDestinationsInput{} }
...
func (c *Client) addOperationListIngestionDestinationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListIngestionDestinationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListIngestionDestinationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListIngestionDestinationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListIngestionDestinationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListIngestionDestinationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListIngestionDestinationsResolveEndpointMiddleware{
