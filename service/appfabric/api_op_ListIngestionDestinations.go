...
func (c *Client) addOperationListIngestionDestinationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListIngestionDestinations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
