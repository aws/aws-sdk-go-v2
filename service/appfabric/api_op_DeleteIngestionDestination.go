...
func (c *Client) DeleteIngestionDestination(ctx context.Context, params *DeleteIngestionDestinationInput, optFns ...func(*Options)) (*DeleteIngestionDestinationOutput, error) {
	if params == nil { params = &DeleteIngestionDestinationInput{} }
...
func (c *Client) addOperationDeleteIngestionDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteIngestionDestinationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteIngestionDestinationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteIngestionDestinationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteIngestionDestinationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteIngestionDestinationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteIngestionDestinationResolveEndpointMiddleware{
