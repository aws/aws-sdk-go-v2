...
func (c *Client) addOperationDeleteIngestionDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteIngestionDestination", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
