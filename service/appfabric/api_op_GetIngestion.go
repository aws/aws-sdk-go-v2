...
func (c *Client) GetIngestion(ctx context.Context, params *GetIngestionInput, optFns ...func(*Options)) (*GetIngestionOutput, error) {
	if params == nil { params = &GetIngestionInput{} }
...
func (c *Client) addOperationGetIngestionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetIngestionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetIngestionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetIngestionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetIngestionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetIngestionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetIngestionResolveEndpointMiddleware{
