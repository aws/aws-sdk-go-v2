...
func (*StopIngestionInput) operationName() string {
...
func (c *Client) addOperationStopIngestionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopIngestionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopIngestionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopIngestionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopIngestionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopIngestionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopIngestionResolveEndpointMiddleware{
