...
func (c *Client) ListAppAuthorizations(ctx context.Context, params *ListAppAuthorizationsInput, optFns ...func(*Options)) (*ListAppAuthorizationsOutput, error) {
	if params == nil { params = &ListAppAuthorizationsInput{} }
...
func (c *Client) addOperationListAppAuthorizationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAppAuthorizationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAppAuthorizationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAppAuthorizationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAppAuthorizationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAppAuthorizationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAppAuthorizationsResolveEndpointMiddleware{
