...
func (c *Client) UpdateIngestionDestination(ctx context.Context, params *UpdateIngestionDestinationInput, optFns ...func(*Options)) (*UpdateIngestionDestinationOutput, error) {
	if params == nil { params = &UpdateIngestionDestinationInput{} }
...
func (c *Client) addOperationUpdateIngestionDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateIngestionDestinationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateIngestionDestinationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateIngestionDestinationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateIngestionDestinationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateIngestionDestinationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateIngestionDestinationResolveEndpointMiddleware{
