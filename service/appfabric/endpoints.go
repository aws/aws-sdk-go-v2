...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/appfabric/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "AppFabric", cfg.ConfigSources)
	if found && err == nil {
