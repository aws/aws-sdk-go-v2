...
func (c *Client) addOperationBatchGetUserAccessTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetUserAccessTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
