...
func (c *Client) StartUserAccessTasks(ctx context.Context, params *StartUserAccessTasksInput, optFns ...func(*Options)) (*StartUserAccessTasksOutput, error) {
	if params == nil { params = &StartUserAccessTasksInput{} }
...
func (c *Client) addOperationStartUserAccessTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartUserAccessTasksResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartUserAccessTasksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartUserAccessTasksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartUserAccessTasksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartUserAccessTasksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartUserAccessTasksResolveEndpointMiddleware{
