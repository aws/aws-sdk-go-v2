...
func (c *Client) GetAppBundle(ctx context.Context, params *GetAppBundleInput, optFns ...func(*Options)) (*GetAppBundleOutput, error) {
	if params == nil { params = &GetAppBundleInput{} }
...
func (c *Client) addOperationGetAppBundleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAppBundleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAppBundleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAppBundleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAppBundleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAppBundleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAppBundleResolveEndpointMiddleware{
