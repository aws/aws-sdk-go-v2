...
func addOperationDeletePackagingConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeletePackagingConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeletePackagingConfigurationStackSlots(stack); err != nil {
		return err
	}
