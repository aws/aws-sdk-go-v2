...
func (c *Client) addOperationListPackagingConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPackagingConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
