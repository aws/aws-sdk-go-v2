...
func addOperationListPackagingConfigurationsStackSlots(stack *middleware.Stack) error {
...
func addOperationListPackagingConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListPackagingConfigurationsStackSlots(stack); err != nil {
		return err
	}
