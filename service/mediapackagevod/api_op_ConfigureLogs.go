...
func (c *Client) ConfigureLogs(ctx context.Context, params *ConfigureLogsInput, optFns ...func(*Options)) (*ConfigureLogsOutput, error) {
	if params == nil { params = &ConfigureLogsInput{} }
...
func (c *Client) addOperationConfigureLogsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addConfigureLogsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opConfigureLogsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opConfigureLogsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opConfigureLogsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addConfigureLogsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opConfigureLogsResolveEndpointMiddleware{
