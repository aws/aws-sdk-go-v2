...
func (c *Client) addOperationListCompatibleImagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCompatibleImagesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListCompatibleImagesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListCompatibleImagesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCompatibleImagesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCompatibleImagesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListCompatibleImagesResolveEndpointMiddleware{
