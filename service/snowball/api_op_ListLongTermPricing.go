...
func (c *Client) ListLongTermPricing(ctx context.Context, params *ListLongTermPricingInput, optFns ...func(*Options)) (*ListLongTermPricingOutput, error) {
	if params == nil { params = &ListLongTermPricingInput{} }
...
func (c *Client) addOperationListLongTermPricingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLongTermPricingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListLongTermPricingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListLongTermPricingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLongTermPricingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLongTermPricingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListLongTermPricingResolveEndpointMiddleware{
