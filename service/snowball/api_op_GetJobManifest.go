...
// that job. The credentials of a given job, including its manifest file and unlock
...
func addOperationGetJobManifestStackSlots(stack *middleware.Stack) error {
...
func addOperationGetJobManifestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetJobManifestStackSlots(stack); err != nil {
		return err
	}
