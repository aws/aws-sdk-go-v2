...
type GetSoftwareUpdatesOutput struct {
	...
	// JobIdvalue. The software update will be available for 2 days after this
	// request is made. To access an update after the 2 days have passed, you'll have
	// to make another call to GetSoftwareUpdates .
	UpdatesURI *string
