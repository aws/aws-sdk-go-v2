...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-snowball.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-snowball.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-snowball.dev",
			expectURL:     aws.String("https://env-snowball.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-snowball.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-snowball.dev",
			expectURL:     aws.String("http://config-snowball.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-snowball.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-snowball.dev",
			clientEndpoint: aws.String("https://client-snowball.dev"),
			expectURL:      aws.String("https://client-snowball.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SNOWBALL", c.envService)
			}
