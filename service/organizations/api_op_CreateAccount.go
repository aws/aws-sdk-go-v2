...
func (c *Client) CreateAccount(ctx context.Context, params *CreateAccountInput, optFns ...func(*Options)) (*CreateAccountOutput, error) {
	...
	addawsAwsjson11_serdeOpCreateAccountMiddlewares(stack)
...
func addawsAwsjson11_serdeOpCreateAccountMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpCreateAccount{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpCreateAccount{}, middleware.After)
}
