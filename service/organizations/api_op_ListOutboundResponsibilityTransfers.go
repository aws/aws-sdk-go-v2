...
func (c *Client) addOperationListOutboundResponsibilityTransfersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOutboundResponsibilityTransfers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
