...
func (c *Client) addOperationInviteOrganizationToTransferResponsibilityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "InviteOrganizationToTransferResponsibility", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
