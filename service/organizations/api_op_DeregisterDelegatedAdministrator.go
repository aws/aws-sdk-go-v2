...
func (*DeregisterDelegatedAdministratorInput) operationName() string {
...
func (c *Client) addOperationDeregisterDelegatedAdministratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeregisterDelegatedAdministratorResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeregisterDelegatedAdministratorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeregisterDelegatedAdministratorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeregisterDelegatedAdministratorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeregisterDelegatedAdministratorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeregisterDelegatedAdministratorResolveEndpointMiddleware{
