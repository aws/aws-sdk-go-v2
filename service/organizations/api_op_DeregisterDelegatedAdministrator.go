...
func addOperationDeregisterDelegatedAdministratorStackSlots(stack *middleware.Stack) error {
...
func addOperationDeregisterDelegatedAdministratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeregisterDelegatedAdministratorStackSlots(stack); err != nil {
		return err
	}
