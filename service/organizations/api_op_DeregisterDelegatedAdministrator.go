...
func (c *Client) addOperationDeregisterDelegatedAdministratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterDelegatedAdministrator", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
