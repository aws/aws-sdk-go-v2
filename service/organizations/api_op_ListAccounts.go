...
func (c *Client) ListAccounts(ctx context.Context, params *ListAccountsInput, optFns ...func(*Options)) (*ListAccountsOutput, error) {
	...
	addawsAwsjson11_serdeOpListAccountsMiddlewares(stack)
...
func addawsAwsjson11_serdeOpListAccountsMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpListAccounts{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpListAccounts{}, middleware.After)
}
