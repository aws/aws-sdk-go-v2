...
func (c *Client) addOperationListInboundResponsibilityTransfersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListInboundResponsibilityTransfers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
