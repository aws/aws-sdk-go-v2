...
func (c *Client) addOperationInviteAccountToOrganizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "InviteAccountToOrganization", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
