...
func addOperationRemoveAccountFromOrganizationStackSlots(stack *middleware.Stack) error {
...
func addOperationRemoveAccountFromOrganizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRemoveAccountFromOrganizationStackSlots(stack); err != nil {
		return err
	}
