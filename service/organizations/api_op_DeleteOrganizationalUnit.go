...
func (c *Client) addOperationDeleteOrganizationalUnitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteOrganizationalUnit", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
