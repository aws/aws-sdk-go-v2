...
func (c *Client) addOperationListDelegatedAdministratorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDelegatedAdministrators", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
