...
func (c *Client) addOperationDescribeResponsibilityTransferMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeResponsibilityTransfer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
