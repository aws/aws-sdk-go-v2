...
func (c *Client) ListChildren(ctx context.Context, params *ListChildrenInput, optFns ...func(*Options)) (*ListChildrenOutput, error) {
	stack := middleware.NewStack("ListChildren", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpListChildrenMiddlewares(stack)
...
func addawsAwsjson11_serdeOpListChildrenMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpListChildren{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpListChildren{}, middleware.After)
}
