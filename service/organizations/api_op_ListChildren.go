...
func (c *Client) ListChildren(ctx context.Context, params *ListChildrenInput, optFns ...func(*Options)) (*ListChildrenOutput, error) {
	if params == nil { params = &ListChildrenInput{} }
...
func (c *Client) addOperationListChildrenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListChildrenResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListChildrenResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListChildrenResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListChildrenResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListChildrenResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListChildrenResolveEndpointMiddleware{
