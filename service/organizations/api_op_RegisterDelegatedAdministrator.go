...
func addOperationRegisterDelegatedAdministratorStackSlots(stack *middleware.Stack) error {
...
func addOperationRegisterDelegatedAdministratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRegisterDelegatedAdministratorStackSlots(stack); err != nil {
		return err
	}
