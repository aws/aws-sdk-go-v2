...
func (c *Client) addOperationRegisterDelegatedAdministratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterDelegatedAdministrator", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
