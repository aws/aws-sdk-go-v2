...
func (c *Client) MoveAccount(ctx context.Context, params *MoveAccountInput, optFns ...func(*Options)) (*MoveAccountOutput, error) {
	if params == nil { params = &MoveAccountInput{} }
...
func (c *Client) addOperationMoveAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addMoveAccountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opMoveAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opMoveAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opMoveAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addMoveAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opMoveAccountResolveEndpointMiddleware{
