...
func (c *Client) addOperationListCreateAccountStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCreateAccountStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
