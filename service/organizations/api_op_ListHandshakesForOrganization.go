...
func addOperationListHandshakesForOrganizationStackSlots(stack *middleware.Stack) error {
...
func addOperationListHandshakesForOrganizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListHandshakesForOrganizationStackSlots(stack); err != nil {
		return err
	}
