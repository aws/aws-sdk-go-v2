...
// that you own the email address associated with the management account. For more
...
// resend an invitation to an account, ensure that existing handshakes that might
// be considered duplicates are canceled or declined.
