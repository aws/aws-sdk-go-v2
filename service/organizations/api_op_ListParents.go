...
// is a delegated administrator for an AWS service. In the current release, a child
...
func (c *Client) ListParents(ctx context.Context, params *ListParentsInput, optFns ...func(*Options)) (*ListParentsOutput, error) {
	stack := middleware.NewStack("ListParents", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpListParentsMiddlewares(stack)
...
func addawsAwsjson11_serdeOpListParentsMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpListParents{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpListParents{}, middleware.After)
}
