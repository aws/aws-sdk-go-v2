...
func (c *Client) ListParents(ctx context.Context, params *ListParentsInput, optFns ...func(*Options)) (*ListParentsOutput, error) {
	if params == nil { params = &ListParentsInput{} }
...
func (c *Client) addOperationListParentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListParentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListParentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListParentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListParentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListParentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListParentsResolveEndpointMiddleware{
