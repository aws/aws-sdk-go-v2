...
func addOperationDescribeCreateAccountStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeCreateAccountStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeCreateAccountStatusStackSlots(stack); err != nil {
		return err
	}
