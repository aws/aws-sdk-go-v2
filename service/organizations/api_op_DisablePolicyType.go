...
func (*DisablePolicyTypeInput) operationName() string {
...
func (c *Client) addOperationDisablePolicyTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisablePolicyTypeResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDisablePolicyTypeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDisablePolicyTypeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisablePolicyTypeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisablePolicyTypeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDisablePolicyTypeResolveEndpointMiddleware{
