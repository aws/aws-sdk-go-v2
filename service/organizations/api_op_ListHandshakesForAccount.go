...
func (c *Client) addOperationListHandshakesForAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListHandshakesForAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
