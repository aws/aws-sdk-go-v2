...
func (c *Client) addOperationListOrganizationalUnitsForParentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOrganizationalUnitsForParent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
