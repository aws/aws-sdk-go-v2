...
func addOperationListOrganizationalUnitsForParentStackSlots(stack *middleware.Stack) error {
...
func addOperationListOrganizationalUnitsForParentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListOrganizationalUnitsForParentStackSlots(stack); err != nil {
		return err
	}
