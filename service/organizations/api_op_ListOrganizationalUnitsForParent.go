...
func (c *Client) ListOrganizationalUnitsForParent(ctx context.Context, params *ListOrganizationalUnitsForParentInput, optFns ...func(*Options)) (*ListOrganizationalUnitsForParentOutput, error) {
	if params == nil { params = &ListOrganizationalUnitsForParentInput{} }
...
func (c *Client) addOperationListOrganizationalUnitsForParentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListOrganizationalUnitsForParentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListOrganizationalUnitsForParentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListOrganizationalUnitsForParentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListOrganizationalUnitsForParentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListOrganizationalUnitsForParentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListOrganizationalUnitsForParentResolveEndpointMiddleware{
