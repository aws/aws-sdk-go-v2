...
func addOperationDescribeOrganizationalUnitStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeOrganizationalUnitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeOrganizationalUnitStackSlots(stack); err != nil {
		return err
	}
