...
func (c *Client) addOperationTerminateResponsibilityTransferMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "TerminateResponsibilityTransfer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
