...
func addOperationListDelegatedServicesForAccountStackSlots(stack *middleware.Stack) error {
...
func addOperationListDelegatedServicesForAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListDelegatedServicesForAccountStackSlots(stack); err != nil {
		return err
	}
