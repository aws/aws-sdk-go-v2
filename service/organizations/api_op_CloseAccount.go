...
// change to SUSPENDED.
// - Check the CloudTrail log for the CloseAccountResult event
// that gets published after the account closes successfully. For information on
// using CloudTrail with Organizations, see Logging and monitoring in Organizations
