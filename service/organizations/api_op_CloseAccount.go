...
// CloseAccountoperates asynchronously, it can return a successful completion
...
// Services account (https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_close.html)
