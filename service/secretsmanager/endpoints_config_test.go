...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-secrets-manager.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-secrets-manager.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-secrets-manager.dev",
			expectURL:     aws.String("https://env-secrets-manager.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-secrets-manager.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-secrets-manager.dev",
			expectURL:     aws.String("http://config-secrets-manager.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-secrets-manager.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-secrets-manager.dev",
			clientEndpoint: aws.String("https://client-secrets-manager.dev"),
			expectURL:      aws.String("https://client-secrets-manager.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SECRETS_MANAGER", c.envService)
			}
