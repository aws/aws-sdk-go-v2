...
// promotes the replica to a primary secret in the replica Region. You must call
// this operation from the Region in which you want to promote the replica to a
// primary secret. Secrets Manager generates a CloudTrail log entry when you call
