...
func (c *Client) addOperationStopReplicationToReplicaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopReplicationToReplica", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
