...
// Package secretsmanager provides the API client, operations, and parameter
// types for AWS Secrets Manager.
//
...
// Secrets Manager API version 2017-10-17. For a list of endpoints, see Amazon
// Web Services Secrets Manager endpoints (https://docs.aws.amazon.com/secretsmanager/latest/userguide/asm_access.html#endpoints)
