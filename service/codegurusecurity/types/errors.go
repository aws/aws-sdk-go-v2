...
func (v *AccessDeniedException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.AccessDeniedException, func(s *smithy.Schema) error {
		...
		case schemas.AccessDeniedException_resourceId:
			v.ResourceId = new(string)
			return d.ReadString(schemas.AccessDeniedException_resourceId, v.ResourceId)
		case schemas.AccessDeniedException_resourceType:
			v.ResourceType = new(string)
			return d.ReadString(schemas.AccessDeniedException_resourceType, v.ResourceType)
		}
		return nil
	})
}
...
func (v *InternalServerException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.InternalServerException, func(s *smithy.Schema) error {
		switch s {
		case schemas.InternalServerException_error:
			v.Error_ = new(string)
			return d.ReadString(schemas.InternalServerException_error, v.Error_)
