...
func (c *Client) ListScans(ctx context.Context, params *ListScansInput, optFns ...func(*Options)) (*ListScansOutput, error) {
	if params == nil { params = &ListScansInput{} }
...
func (c *Client) addOperationListScansMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListScansResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListScansResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListScansResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListScansResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListScansResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListScansResolveEndpointMiddleware{
