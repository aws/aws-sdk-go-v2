...
func (c *Client) ListFindingsMetrics(ctx context.Context, params *ListFindingsMetricsInput, optFns ...func(*Options)) (*ListFindingsMetricsOutput, error) {
	if params == nil { params = &ListFindingsMetricsInput{} }
...
func (c *Client) addOperationListFindingsMetricsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFindingsMetricsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListFindingsMetricsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListFindingsMetricsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFindingsMetricsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFindingsMetricsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListFindingsMetricsResolveEndpointMiddleware{
