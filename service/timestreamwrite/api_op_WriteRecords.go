...
// greater than the existing value of Version. You can update a data point as
// many times as desired, as long as the value of Version continuously increases.
...
// Version. However, if you were to resend the update request with Version  set to
// 2 , Timestream would then succeed in updating the record’s value, and the
// Version would be set to 2 . Next, suppose you sent a WriteRecords request with
// this same record and an identical measure value, but with Version  set to 3.
// In this case, Timestream would only update Version  to 3. Any further updates
