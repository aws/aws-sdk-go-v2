...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-timestream-write.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-timestream-write.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-timestream-write.dev",
			expectURL:     aws.String("https://env-timestream-write.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-timestream-write.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-timestream-write.dev",
			expectURL:     aws.String("http://config-timestream-write.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-timestream-write.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-timestream-write.dev",
			clientEndpoint: aws.String("https://client-timestream-write.dev"),
			expectURL:      aws.String("https://client-timestream-write.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_TIMESTREAM_WRITE", c.envService)
			}
