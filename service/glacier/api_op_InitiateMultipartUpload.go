...
func (c *Client) addOperationInitiateMultipartUploadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "InitiateMultipartUpload", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
