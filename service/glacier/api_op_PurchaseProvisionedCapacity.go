...
func (c *Client) addOperationPurchaseProvisionedCapacityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PurchaseProvisionedCapacity", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
