...
func (c *Client) PurchaseProvisionedCapacity(ctx context.Context, params *PurchaseProvisionedCapacityInput, optFns ...func(*Options)) (*PurchaseProvisionedCapacityOutput, error) {
	if params == nil { params = &PurchaseProvisionedCapacityInput{} }
...
func (c *Client) addOperationPurchaseProvisionedCapacityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPurchaseProvisionedCapacityResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPurchaseProvisionedCapacityResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPurchaseProvisionedCapacityResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPurchaseProvisionedCapacityResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPurchaseProvisionedCapacityResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPurchaseProvisionedCapacityResolveEndpointMiddleware{
