...
func (c *Client) addOperationDeleteVaultAccessPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteVaultAccessPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
