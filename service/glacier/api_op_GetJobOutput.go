...
func (c *Client) GetJobOutput(ctx context.Context, params *GetJobOutputInput, optFns ...func(*Options)) (*GetJobOutputOutput, error) {
	if params == nil { params = &GetJobOutputInput{} }
...
func (c *Client) addOperationGetJobOutputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetJobOutputResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetJobOutputResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetJobOutputResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetJobOutputResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetJobOutputResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetJobOutputResolveEndpointMiddleware{
