...
func addClientUserAgent(stack *middleware.Stack, options Options) error {
	if err := awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "glacier", goModuleVersion)(stack); err != nil { return err }
...
func setDefaultAccountID(input interface{}, accountID string) interface{} {
	switch i := input.(type) {
		case *AbortMultipartUploadInput:
			if i.AccountId == nil { i.AccountId = &accountID }
			return i
