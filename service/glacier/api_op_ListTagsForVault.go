...
func (c *Client) ListTagsForVault(ctx context.Context, params *ListTagsForVaultInput, optFns ...func(*Options)) (*ListTagsForVaultOutput, error) {
	if params == nil { params = &ListTagsForVaultInput{} }
...
func (c *Client) addOperationListTagsForVaultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTagsForVaultResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTagsForVaultResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTagsForVaultResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTagsForVaultResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTagsForVaultResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTagsForVaultResolveEndpointMiddleware{
