...
// Markerfield is set to a non-null value, which you can use to continue the
...
// , Succeeded , or Failed  status. Using the completed parameter, you can
// specify to return only jobs that were completed ( true) or jobs that were not
// completed ( false). For more information about using this operation, see the
