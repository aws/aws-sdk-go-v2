...
// Access Control with Vault Lock Policies (https://docs.aws.amazon.com/amazonglacier/latest/dev/vault-lock-policy.html)
...
// lock for the vault. You can abort the vault locking process by calling
// AbortVaultLock . You can get the state of the vault lock by calling
