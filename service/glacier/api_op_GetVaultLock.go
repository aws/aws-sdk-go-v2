...
func (c *Client) GetVaultLock(ctx context.Context, params *GetVaultLockInput, optFns ...func(*Options)) (*GetVaultLockOutput, error) {
	if params == nil { params = &GetVaultLockInput{} }
...
func (c *Client) addOperationGetVaultLockMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetVaultLockResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetVaultLockResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetVaultLockResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetVaultLockResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetVaultLockResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetVaultLockResolveEndpointMiddleware{
