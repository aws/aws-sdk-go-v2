...
func (*SetVaultAccessPolicyInput) operationName() string {
...
func (c *Client) addOperationSetVaultAccessPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetVaultAccessPolicyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opSetVaultAccessPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opSetVaultAccessPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetVaultAccessPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetVaultAccessPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opSetVaultAccessPolicyResolveEndpointMiddleware{
