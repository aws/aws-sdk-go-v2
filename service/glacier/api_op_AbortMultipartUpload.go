...
// This operation aborts a multipart upload identified by the upload ID. After
...
// multipart upload, see UploadMultipartPart  and CompleteMultipartUpload. This
// operation is idempotent. An AWS account has full permission to perform all
