...
func (c *Client) CreateVault(ctx context.Context, params *CreateVaultInput, optFns ...func(*Options)) (*CreateVaultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVault", params, optFns, addOperationCreateVaultMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVaultStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateVaultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateVaultStackSlots(stack); err != nil {
		return err
	}
