...
func (c *Client) addOperationDeregisterSubscriptionProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterSubscriptionProvider", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
