...
func (c *Client) ListLinuxSubscriptions(ctx context.Context, params *ListLinuxSubscriptionsInput, optFns ...func(*Options)) (*ListLinuxSubscriptionsOutput, error) {
	if params == nil { params = &ListLinuxSubscriptionsInput{} }
...
func (c *Client) addOperationListLinuxSubscriptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLinuxSubscriptionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListLinuxSubscriptionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListLinuxSubscriptionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLinuxSubscriptionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLinuxSubscriptionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListLinuxSubscriptionsResolveEndpointMiddleware{
