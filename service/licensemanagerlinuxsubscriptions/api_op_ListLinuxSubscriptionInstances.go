...
func (c *Client) addOperationListLinuxSubscriptionInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListLinuxSubscriptionInstances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
