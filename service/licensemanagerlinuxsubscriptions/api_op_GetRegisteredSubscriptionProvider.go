...
func (c *Client) addOperationGetRegisteredSubscriptionProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRegisteredSubscriptionProvider", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
