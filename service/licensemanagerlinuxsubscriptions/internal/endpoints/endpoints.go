		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			{
				...
				Hostname:          "license-manager-linux-subscriptions.{region}.api.amazonwebservices.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
			...
			},
			{
				...
				Hostname:          "license-manager-linux-subscriptions-fips.{region}.api.amazonwebservices.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
