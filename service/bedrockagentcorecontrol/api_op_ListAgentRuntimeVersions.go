...
func (c *Client) addOperationListAgentRuntimeVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAgentRuntimeVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
