...
func (c *Client) addOperationUpdateOauth2CredentialProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateOauth2CredentialProvider", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
