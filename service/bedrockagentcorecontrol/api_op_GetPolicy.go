...
func (v *GetPolicyInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.PolicyEngineId != nil {
		s.WriteString(schemas.GetPolicyRequest_policyEngineId, *v.PolicyEngineId)
	}
	if v.PolicyId != nil {
...
type GetPolicyOutput struct {
	...
	// The customer-assigned name of the policy. This is the human-readable identifier
	// that was specified when the policy was created.
	//
	// This member is required.
	Name *string
	...
	// policy engine context for the retrieved policy.
	//
	// This member is required.
	PolicyEngineId *string
	...
	// failures or the current state of the policy.
	//
	// This member is required.
...
func (v *GetPolicyOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.GetPolicyResponse, func(s *smithy.Schema) error {
		switch s {
		case schemas.GetPolicyResponse_createdAt:
			v.CreatedAt = new(time.Time)
			return d.ReadTime(schemas.GetPolicyResponse_createdAt, v.CreatedAt)
		case schemas.GetPolicyResponse_definition:
			return deserializePolicyDefinition(d, schemas.GetPolicyResponse_definition, &v.Definition)
		case schemas.GetPolicyResponse_description:
			v.Description = new(string)
			return d.ReadString(schemas.GetPolicyResponse_description, v.Description)
		case schemas.GetPolicyResponse_name:
			v.Name = new(string)
			return d.ReadString(schemas.GetPolicyResponse_name, v.Name)
		...
		case schemas.GetPolicyResponse_policyEngineId:
			v.PolicyEngineId = new(string)
			return d.ReadString(schemas.GetPolicyResponse_policyEngineId, v.PolicyEngineId)
		case schemas.GetPolicyResponse_policyId:
			v.PolicyId = new(string)
			return d.ReadString(schemas.GetPolicyResponse_policyId, v.PolicyId)
		case schemas.GetPolicyResponse_status:
			var ev string
			if err := d.ReadString(schemas.GetPolicyResponse_status, &ev); err != nil {
				return err
			}
			v.Status = types.PolicyStatus(ev)
			return nil
		case schemas.GetPolicyResponse_statusReasons:
			return deserializePolicyStatusReasons(d, schemas.GetPolicyResponse_statusReasons, &v.StatusReasons)
		case schemas.GetPolicyResponse_updatedAt:
			v.UpdatedAt = new(time.Time)
			return d.ReadTime(schemas.GetPolicyResponse_updatedAt, v.UpdatedAt)
		}
		return nil
	})
}
...
// PolicyActiveWaiterOptions are waiter options for PolicyActiveWaiter
type PolicyActiveWaiterOptions struct {
	...
	// set to zero, PolicyActiveWaiter will use default max delay of 120 seconds. Note
...
// PolicyActiveWaiter defines the waiters for PolicyActive
type PolicyActiveWaiter struct {
...
func NewPolicyActiveWaiter(client GetPolicyAPIClient, optFns ...func(*PolicyActiveWaiterOptions)) *PolicyActiveWaiter {
	...
	return &PolicyActiveWaiter{
		client:  client,
		options: options,
	}
}

// Wait calls the waiter function for PolicyActive waiter. The maxWaitDur is the
// maximum wait duration the waiter will wait. The maxWaitDur is required and must
// be greater than zero.
func (w *PolicyActiveWaiter) Wait(ctx context.Context, params *GetPolicyInput, maxWaitDur time.Duration, optFns ...func(*PolicyActiveWaiterOptions)) error {
	_, err := w.WaitForOutput(ctx, params, maxWaitDur, optFns...)
	return err
}

// WaitForOutput calls the waiter function for PolicyActive waiter and returns the
// output of the successful operation. The maxWaitDur is the maximum wait duration
// the waiter will wait. The maxWaitDur is required and must be greater than zero.
func (w *PolicyActiveWaiter) WaitForOutput(ctx context.Context, params *GetPolicyInput, maxWaitDur time.Duration, optFns ...func(*PolicyActiveWaiterOptions)) (*GetPolicyOutput, error) {
	if maxWaitDur <= 0 {
	...
	return nil, fmt.Errorf("exceeded max wait time for PolicyActive waiter")
}

func policyActiveStateRetryable(ctx context.Context, input *GetPolicyInput, output *GetPolicyOutput, err error) (bool, error) {
...
// PolicyDeletedWaiterOptions are waiter options for PolicyDeletedWaiter
type PolicyDeletedWaiterOptions struct {
	...
	// MinDelay is the minimum amount of time to delay between retries. If unset,
	// PolicyDeletedWaiter will use default minimum delay of 2 seconds. Note that
	// MinDelay must resolve to a value lesser than or equal to the MaxDelay.
	MinDelay time.Duration

	// MaxDelay is the maximum amount of time to delay between retries. If unset or
	// set to zero, PolicyDeletedWaiter will use default max delay of 120 seconds. Note
	// that MaxDelay must resolve to value greater than or equal to the MinDelay.
	MaxDelay time.Duration
...
// PolicyDeletedWaiter defines the waiters for PolicyDeleted
type PolicyDeletedWaiter struct {
	client GetPolicyAPIClient

	options PolicyDeletedWaiterOptions
}

// NewPolicyDeletedWaiter constructs a PolicyDeletedWaiter.
func NewPolicyDeletedWaiter(client GetPolicyAPIClient, optFns ...func(*PolicyDeletedWaiterOptions)) *PolicyDeletedWaiter {
	options := PolicyDeletedWaiterOptions{}
	options.MinDelay = 2 * time.Second
	options.MaxDelay = 120 * time.Second
	options.Retryable = policyDeletedStateRetryable

	for _, fn := range optFns {
		fn(&options)
	}
	return &PolicyDeletedWaiter{
		client:  client,
		options: options,
	}
}

// Wait calls the waiter function for PolicyDeleted waiter. The maxWaitDur is the
// maximum wait duration the waiter will wait. The maxWaitDur is required and must
// be greater than zero.
func (w *PolicyDeletedWaiter) Wait(ctx context.Context, params *GetPolicyInput, maxWaitDur time.Duration, optFns ...func(*PolicyDeletedWaiterOptions)) error {
	_, err := w.WaitForOutput(ctx, params, maxWaitDur, optFns...)
	return err
}

// WaitForOutput calls the waiter function for PolicyDeleted waiter and returns
// the output of the successful operation. The maxWaitDur is the maximum wait
// duration the waiter will wait. The maxWaitDur is required and must be greater
// than zero.
func (w *PolicyDeletedWaiter) WaitForOutput(ctx context.Context, params *GetPolicyInput, maxWaitDur time.Duration, optFns ...func(*PolicyDeletedWaiterOptions)) (*GetPolicyOutput, error) {
	if maxWaitDur <= 0 {
		return nil, fmt.Errorf("maximum wait time for waiter must be greater than zero")
	}
	...
	return nil, fmt.Errorf("exceeded max wait time for PolicyDeleted waiter")
}

func policyDeletedStateRetryable(ctx context.Context, input *GetPolicyInput, output *GetPolicyOutput, err error) (bool, error) {
