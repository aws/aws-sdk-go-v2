...
func (c *Client) SynchronizeGatewayTargets(ctx context.Context, params *SynchronizeGatewayTargetsInput, optFns ...func(*Options)) (*SynchronizeGatewayTargetsOutput, error) {
	if params == nil { params = &SynchronizeGatewayTargetsInput{} }
	
	result, metadata, err := c.invokeOperation(ctx, "SynchronizeGatewayTargets", params, optFns, c.addOperationSynchronizeGatewayTargetsMiddlewares)
	if err != nil { return nil, err }
	
	out := result.(*SynchronizeGatewayTargetsOutput)
...
func (c *Client) addOperationSynchronizeGatewayTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addOpSynchronizeGatewayTargetsValidationMiddleware(stack); err != nil {
	return err
	}
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opSynchronizeGatewayTargets(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opSynchronizeGatewayTargets(region string) *awsmiddleware.RegisterServiceMetadata {
