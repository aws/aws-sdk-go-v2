...
func (c *Client) addOperationSynchronizeGatewayTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SynchronizeGatewayTargets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
