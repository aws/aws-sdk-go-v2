...
func (c *Client) addOperationGetAgentRuntimeEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAgentRuntimeEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
