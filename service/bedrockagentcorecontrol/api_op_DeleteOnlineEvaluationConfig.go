...
func (c *Client) addOperationDeleteOnlineEvaluationConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteOnlineEvaluationConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
