...
func (c *Client) addOperationUpdateOnlineEvaluationConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateOnlineEvaluationConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
