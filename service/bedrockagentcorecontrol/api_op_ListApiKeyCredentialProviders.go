...
func (c *Client) addOperationListApiKeyCredentialProvidersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListApiKeyCredentialProviders", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
