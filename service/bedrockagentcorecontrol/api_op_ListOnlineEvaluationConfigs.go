...
func (c *Client) addOperationListOnlineEvaluationConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOnlineEvaluationConfigs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
