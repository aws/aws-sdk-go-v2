...
func (c *Client) ListGatewayTargets(ctx context.Context, params *ListGatewayTargetsInput, optFns ...func(*Options)) (*ListGatewayTargetsOutput, error) {
	if params == nil { params = &ListGatewayTargetsInput{} }
	
	result, metadata, err := c.invokeOperation(ctx, "ListGatewayTargets", params, optFns, c.addOperationListGatewayTargetsMiddlewares)
	if err != nil { return nil, err }
	
	out := result.(*ListGatewayTargetsOutput)
...
func (c *Client) addOperationListGatewayTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addOpListGatewayTargetsValidationMiddleware(stack); err != nil {
	return err
	}
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListGatewayTargets(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
type ListGatewayTargetsPaginator struct {
    options ListGatewayTargetsPaginatorOptions
    client ListGatewayTargetsAPIClient
...
func NewListGatewayTargetsPaginator(client ListGatewayTargetsAPIClient, params *ListGatewayTargetsInput, optFns ...func(*ListGatewayTargetsPaginatorOptions)) *ListGatewayTargetsPaginator {
	...
	return &ListGatewayTargetsPaginator{
	    options: options,
	    client: client,
	    params: params,
	    firstPage: true,
...
func (p *ListGatewayTargetsPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*ListGatewayTargetsOutput, error) {
	...
	result, err := p.client.ListGatewayTargets(ctx, &params, optFns...)
	if err != nil {
	    return nil, err
	}
	p.firstPage = false
...
// ListGatewayTargetsAPIClient is a client that implements the ListGatewayTargets
// operation.
...
var _ ListGatewayTargetsAPIClient = (*Client)(nil)

func newServiceMetadataMiddleware_opListGatewayTargets(region string) *awsmiddleware.RegisterServiceMetadata {
