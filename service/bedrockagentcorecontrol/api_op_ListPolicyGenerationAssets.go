...
func (c *Client) addOperationListPolicyGenerationAssetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPolicyGenerationAssets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
