...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-bedrock-agentcore-control.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bedrock-agentcore-control.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bedrock-agentcore-control.dev",
			expectURL:     aws.String("https://env-bedrock-agentcore-control.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-bedrock-agentcore-control.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bedrock-agentcore-control.dev",
			expectURL:     aws.String("http://config-bedrock-agentcore-control.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-bedrock-agentcore-control.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-bedrock-agentcore-control.dev",
			clientEndpoint: aws.String("https://client-bedrock-agentcore-control.dev"),
			expectURL:      aws.String("https://client-bedrock-agentcore-control.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BEDROCK_AGENTCORE_CONTROL", c.envService)
			}
