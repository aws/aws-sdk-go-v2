...
func (c *Client) addOperationListOauth2CredentialProvidersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOauth2CredentialProviders", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
