...
func (c *Client) addOperationUpdateConfigurationBundleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateConfigurationBundle", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
