...
func (c *Client) addOperationGetPolicyGenerationSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPolicyGenerationSummary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
