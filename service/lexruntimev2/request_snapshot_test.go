...
func TestCheckRequestSnapshot_RecognizeText(t *testing.T) {
	...
	if err := serdeTestSnapshot(method, rawPath, rawQuery, header, body.Bytes(), "RecognizeText"); err != nil {
		t.Fatal(err)
	}
}

func TestCheckRequestSnapshot_RecognizeUtterance(t *testing.T) {
	...
	if err := serdeTestSnapshot(method, rawPath, rawQuery, header, body.Bytes(), "RecognizeUtterance"); err != nil {
		t.Fatal(err)
	}
}
...
func TestUpdateRequestSnapshot_RecognizeText(t *testing.T) {
	input := &RecognizeTextInput{
		BotId:      ptr.String("__BotId__"),
		BotAliasId: ptr.String("__BotAliasId__"),
		LocaleId:   ptr.String("__LocaleId__"),
	...
	if err := serdeUpdateSnapshot(method, rawPath, rawQuery, header, body.Bytes(), "RecognizeText"); err != nil {
		t.Fatal(err)
	}
}

func TestUpdateRequestSnapshot_RecognizeUtterance(t *testing.T) {
	input := &RecognizeUtteranceInput{
		BotId:               ptr.String("__BotId__"),
		BotAliasId:          ptr.String("__BotAliasId__"),
		LocaleId:            ptr.String("__LocaleId__"),
	...
	if err := serdeUpdateSnapshot(method, rawPath, rawQuery, header, body.Bytes(), "RecognizeUtterance"); err != nil {
		t.Fatal(err)
	}
}
