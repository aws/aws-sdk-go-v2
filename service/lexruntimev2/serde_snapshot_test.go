...
func TestSerdeCheckSnapshot_RecognizeText(t *testing.T) {
...
func TestSerdeCheckSnapshot_RecognizeUtterance(t *testing.T) {
...
func TestSerdeUpdateSnapshot_RecognizeText(t *testing.T) {
	input := &RecognizeTextInput{
		BotId:      ptr.String("__BotId__"),
		BotAliasId: ptr.String("__BotAliasId__"),
		LocaleId:   ptr.String("__LocaleId__"),
...
func TestSerdeUpdateSnapshot_RecognizeUtterance(t *testing.T) {
	input := &RecognizeUtteranceInput{
		BotId:               ptr.String("__BotId__"),
		BotAliasId:          ptr.String("__BotAliasId__"),
		LocaleId:            ptr.String("__LocaleId__"),
