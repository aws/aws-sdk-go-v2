...
func (c *Client) addOperationCreateCloudExadataInfrastructureMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCloudExadataInfrastructure", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
