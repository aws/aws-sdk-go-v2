...
func (c *Client) addOperationListCloudExadataInfrastructuresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCloudExadataInfrastructures", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
