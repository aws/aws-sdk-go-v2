...
func (c *Client) addOperationAssociateIamRoleToResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateIamRoleToResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
