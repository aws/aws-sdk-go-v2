...
func (c *Client) addOperationGetCloudAutonomousVmClusterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCloudAutonomousVmCluster", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
