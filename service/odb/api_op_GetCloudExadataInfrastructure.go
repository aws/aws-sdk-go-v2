...
func (c *Client) addOperationGetCloudExadataInfrastructureMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCloudExadataInfrastructure", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
