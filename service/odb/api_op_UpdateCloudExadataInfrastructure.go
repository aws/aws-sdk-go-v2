...
func (c *Client) addOperationUpdateCloudExadataInfrastructureMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCloudExadataInfrastructure", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
