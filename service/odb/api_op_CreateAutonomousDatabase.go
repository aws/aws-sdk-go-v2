...
func (c *Client) addOperationCreateAutonomousDatabaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "CreateAutonomousDatabase"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opCreateAutonomousDatabase(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opCreateAutonomousDatabase(region string) *awsmiddleware.RegisterServiceMetadata {
