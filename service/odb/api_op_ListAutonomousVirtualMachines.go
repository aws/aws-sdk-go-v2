...
func (c *Client) addOperationListAutonomousVirtualMachinesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAutonomousVirtualMachines", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
