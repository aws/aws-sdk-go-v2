...
func (c *Client) ListGiVersions(ctx context.Context, params *ListGiVersionsInput, optFns ...func(*Options)) (*ListGiVersionsOutput, error) {
	if params == nil { params = &ListGiVersionsInput{} }
...
func (c *Client) addOperationListGiVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListGiVersions(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opListGiVersions(region string) *awsmiddleware.RegisterServiceMetadata {
