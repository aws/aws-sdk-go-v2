...
func (c *Client) ListDbNodes(ctx context.Context, params *ListDbNodesInput, optFns ...func(*Options)) (*ListDbNodesOutput, error) {
	if params == nil {
		params = &ListDbNodesInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "ListDbNodes", params, optFns, c.addOperationListDbNodesMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*ListDbNodesOutput)
...
func (c *Client) addOperationListDbNodesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDbNodes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
...
type ListDbNodesPaginator struct {
	options   ListDbNodesPaginatorOptions
	client    ListDbNodesAPIClient
	params    *ListDbNodesInput
	nextToken *string
	firstPage bool
}
...
func (p *ListDbNodesPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*ListDbNodesOutput, error) {
	...
	result, err := p.client.ListDbNodes(ctx, &params, optFns...)
	if err != nil {
		return nil, err
	}
	p.firstPage = false
