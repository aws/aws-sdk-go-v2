...
func (c *Client) addOperationListCloudAutonomousVmClustersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCloudAutonomousVmClusters", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
