...
func (c *Client) addOperationUpdateAutonomousDatabaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAutonomousDatabase", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
