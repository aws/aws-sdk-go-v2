...
func (c *Client) addOperationUpdateAutonomousDatabaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "UpdateAutonomousDatabase"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opUpdateAutonomousDatabase(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opUpdateAutonomousDatabase(region string) *awsmiddleware.RegisterServiceMetadata {
