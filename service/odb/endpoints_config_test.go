...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-odb.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-odb.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-odb.dev",
			expectURL:     aws.String("https://env-odb.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-odb.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-odb.dev",
			expectURL:     aws.String("http://config-odb.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-odb.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-odb.dev",
			clientEndpoint: aws.String("https://client-odb.dev"),
			expectURL:      aws.String("https://client-odb.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ODB", c.envService)
			}
