...
func (c *Client) AcceptMarketplaceRegistration(ctx context.Context, params *AcceptMarketplaceRegistrationInput, optFns ...func(*Options)) (*AcceptMarketplaceRegistrationOutput, error) {
	if params == nil { params = &AcceptMarketplaceRegistrationInput{} }
...
func (c *Client) addOperationAcceptMarketplaceRegistrationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err != nil { return err }
	if err := addProtocolFinalizerMiddlewares(stack, options, "AcceptMarketplaceRegistration"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opAcceptMarketplaceRegistration(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opAcceptMarketplaceRegistration(region string) *awsmiddleware.RegisterServiceMetadata {
