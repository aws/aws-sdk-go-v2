...
func (c *Client) BatchAssociateClientDeviceWithCoreDevice(ctx context.Context, params *BatchAssociateClientDeviceWithCoreDeviceInput, optFns ...func(*Options)) (*BatchAssociateClientDeviceWithCoreDeviceOutput, error) {
	if params == nil { params = &BatchAssociateClientDeviceWithCoreDeviceInput{} }
...
func (c *Client) addOperationBatchAssociateClientDeviceWithCoreDeviceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchAssociateClientDeviceWithCoreDeviceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchAssociateClientDeviceWithCoreDeviceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchAssociateClientDeviceWithCoreDeviceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchAssociateClientDeviceWithCoreDeviceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchAssociateClientDeviceWithCoreDeviceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchAssociateClientDeviceWithCoreDeviceResolveEndpointMiddleware{
