...
func (c *Client) addOperationListEffectiveDeploymentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEffectiveDeployments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
