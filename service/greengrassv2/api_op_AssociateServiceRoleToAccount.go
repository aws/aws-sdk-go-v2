...
func (c *Client) addOperationAssociateServiceRoleToAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateServiceRoleToAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
