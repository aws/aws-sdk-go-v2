...
var bddNodes = [51]int32{
	-1, 1, -1, 0, 16, 3, 1, 4, 100000015, 2, 5, 100000015, 3, 10, 6, 4, 9, 7, 9, 100000012, 8, 10, 100000013, 100000014, 5, 100000010, 100000011, 4, 14, 11, 6, 12, 100000009, 7, 100000006, 13, 8, 100000007, 100000008, 5, 15, 100000005, 6, 100000004, 100000005, 3, 100000001, 17, 4, 100000002, 100000003}
...
func evalCondition(idx int, params *EndpointParameters, c *conditionContext) bool {
	...
	case 9:
		return *params.Region == "dataplane-us-gov-east-1"
	case 10:
		return *params.Region == "dataplane-us-gov-west-1"
	}
	return false
}
