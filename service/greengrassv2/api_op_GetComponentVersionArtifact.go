...
func (c *Client) addOperationGetComponentVersionArtifactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetComponentVersionArtifact", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
