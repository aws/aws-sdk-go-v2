...
func (c *Client) ListClientDevicesAssociatedWithCoreDevice(ctx context.Context, params *ListClientDevicesAssociatedWithCoreDeviceInput, optFns ...func(*Options)) (*ListClientDevicesAssociatedWithCoreDeviceOutput, error) {
	if params == nil { params = &ListClientDevicesAssociatedWithCoreDeviceInput{} }
...
func (c *Client) addOperationListClientDevicesAssociatedWithCoreDeviceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListClientDevicesAssociatedWithCoreDeviceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListClientDevicesAssociatedWithCoreDeviceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListClientDevicesAssociatedWithCoreDeviceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListClientDevicesAssociatedWithCoreDeviceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListClientDevicesAssociatedWithCoreDeviceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListClientDevicesAssociatedWithCoreDeviceResolveEndpointMiddleware{
