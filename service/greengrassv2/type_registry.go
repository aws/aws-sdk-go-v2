...
var TypeRegistry = &smithy.TypeRegistry{
	Entries: map[string]*smithy.TypeRegistryEntry{
		...
		"com.amazonaws.greengrassv2#RequestAlreadyInProgressException": {
			Schema: schemas.RequestAlreadyInProgressException,
			New:    func() any { return &types.RequestAlreadyInProgressException{} },
		},
