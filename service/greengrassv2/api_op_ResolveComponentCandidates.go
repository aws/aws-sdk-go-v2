...
func (c *Client) ResolveComponentCandidates(ctx context.Context, params *ResolveComponentCandidatesInput, optFns ...func(*Options)) (*ResolveComponentCandidatesOutput, error) {
	if params == nil { params = &ResolveComponentCandidatesInput{} }
...
func (c *Client) addOperationResolveComponentCandidatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResolveComponentCandidatesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opResolveComponentCandidatesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opResolveComponentCandidatesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResolveComponentCandidatesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResolveComponentCandidatesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opResolveComponentCandidatesResolveEndpointMiddleware{
