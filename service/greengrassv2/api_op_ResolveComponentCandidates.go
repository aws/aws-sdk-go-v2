...
func (c *Client) addOperationResolveComponentCandidatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ResolveComponentCandidates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
