...
func (v *CreateComponentVersionOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.CreateComponentVersionResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *CreateComponentVersionOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Arn != nil {
		s.WriteString(schemas.CreateComponentVersionResponse_arn, *v.Arn)
	}
	if v.ComponentName != nil {
		s.WriteString(schemas.CreateComponentVersionResponse_componentName, *v.ComponentName)
	}
	if v.ComponentVersion != nil {
		s.WriteString(schemas.CreateComponentVersionResponse_componentVersion, *v.ComponentVersion)
	}
	if v.CreationTimestamp != nil {
		s.WriteTime(schemas.CreateComponentVersionResponse_creationTimestamp, *v.CreationTimestamp)
	}
	if v.Status != nil {
		s.WriteStruct(schemas.CreateComponentVersionResponse_status)
