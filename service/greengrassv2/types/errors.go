...
func (v *RequestAlreadyInProgressException) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.RequestAlreadyInProgressException)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *RequestAlreadyInProgressException) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Message != nil {
		s.WriteString(schemas.RequestAlreadyInProgressException_message, *v.Message)
	}
}
