...
func (c *Client) addOperationBatchDisassociateClientDeviceFromCoreDeviceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDisassociateClientDeviceFromCoreDevice", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
