...
func addOperationDeleteFieldLevelEncryptionProfileStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteFieldLevelEncryptionProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteFieldLevelEncryptionProfileStackSlots(stack); err != nil {
		return err
	}
