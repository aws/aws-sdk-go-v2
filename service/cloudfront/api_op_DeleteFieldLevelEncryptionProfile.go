...
func (*DeleteFieldLevelEncryptionProfileInput) operationName() string {
...
func (c *Client) addOperationDeleteFieldLevelEncryptionProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteFieldLevelEncryptionProfileResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteFieldLevelEncryptionProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteFieldLevelEncryptionProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteFieldLevelEncryptionProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteFieldLevelEncryptionProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteFieldLevelEncryptionProfileResolveEndpointMiddleware{
