...
func (c *Client) DeleteOriginAccessControl(ctx context.Context, params *DeleteOriginAccessControlInput, optFns ...func(*Options)) (*DeleteOriginAccessControlOutput, error) {
	if params == nil { params = &DeleteOriginAccessControlInput{} }
...
func (c *Client) addOperationDeleteOriginAccessControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteOriginAccessControlResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteOriginAccessControlResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteOriginAccessControlResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteOriginAccessControlResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteOriginAccessControlResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteOriginAccessControlResolveEndpointMiddleware{
