...
func (c *Client) addOperationListDistributionsByConnectionModeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDistributionsByConnectionMode", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
