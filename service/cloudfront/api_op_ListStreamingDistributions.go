...
func addOperationListStreamingDistributionsStackSlots(stack *middleware.Stack) error {
...
func addOperationListStreamingDistributionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListStreamingDistributionsStackSlots(stack); err != nil {
		return err
	}
