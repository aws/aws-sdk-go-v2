...
func (c *Client) addOperationListStreamingDistributionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListStreamingDistributions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
