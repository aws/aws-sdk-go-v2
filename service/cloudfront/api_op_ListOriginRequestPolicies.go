...
func (c *Client) addOperationListOriginRequestPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOriginRequestPolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
