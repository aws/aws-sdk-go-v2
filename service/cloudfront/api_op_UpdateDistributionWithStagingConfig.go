...
func (c *Client) addOperationUpdateDistributionWithStagingConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDistributionWithStagingConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
