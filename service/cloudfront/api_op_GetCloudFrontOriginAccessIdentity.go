...
func addOperationGetCloudFrontOriginAccessIdentityStackSlots(stack *middleware.Stack) error {
...
func addOperationGetCloudFrontOriginAccessIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetCloudFrontOriginAccessIdentityStackSlots(stack); err != nil {
		return err
	}
