...
func (*GetCloudFrontOriginAccessIdentityInput) operationName() string {
...
func (c *Client) addOperationGetCloudFrontOriginAccessIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCloudFrontOriginAccessIdentityResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetCloudFrontOriginAccessIdentityResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetCloudFrontOriginAccessIdentityResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCloudFrontOriginAccessIdentityResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCloudFrontOriginAccessIdentityResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetCloudFrontOriginAccessIdentityResolveEndpointMiddleware{
