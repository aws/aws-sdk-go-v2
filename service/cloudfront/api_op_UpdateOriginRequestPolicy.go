...
func (c *Client) addOperationUpdateOriginRequestPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateOriginRequestPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
