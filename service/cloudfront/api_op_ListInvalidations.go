...
func (*ListInvalidationsInput) operationName() string {
...
func (c *Client) addOperationListInvalidationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListInvalidationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListInvalidationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListInvalidationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListInvalidationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListInvalidationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListInvalidationsResolveEndpointMiddleware{
