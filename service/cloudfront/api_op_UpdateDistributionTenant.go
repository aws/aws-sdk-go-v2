...
func (c *Client) addOperationUpdateDistributionTenantMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDistributionTenant", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
