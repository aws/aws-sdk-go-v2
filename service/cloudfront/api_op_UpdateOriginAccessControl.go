...
func (c *Client) addOperationUpdateOriginAccessControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateOriginAccessControl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
