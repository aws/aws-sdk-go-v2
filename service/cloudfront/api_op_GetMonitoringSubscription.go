...
func (*GetMonitoringSubscriptionInput) operationName() string {
...
func (c *Client) addOperationGetMonitoringSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMonitoringSubscriptionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetMonitoringSubscriptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetMonitoringSubscriptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMonitoringSubscriptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMonitoringSubscriptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetMonitoringSubscriptionResolveEndpointMiddleware{
