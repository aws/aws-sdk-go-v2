...
func (c *Client) GetInvalidation(ctx context.Context, params *GetInvalidationInput, optFns ...func(*Options)) (*GetInvalidationOutput, error) {
	if params == nil { params = &GetInvalidationInput{} }
...
func (c *Client) addOperationGetInvalidationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetInvalidationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetInvalidationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetInvalidationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetInvalidationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetInvalidationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetInvalidationResolveEndpointMiddleware{
