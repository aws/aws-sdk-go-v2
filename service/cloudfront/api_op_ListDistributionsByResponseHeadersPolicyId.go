...
func (c *Client) ListDistributionsByResponseHeadersPolicyId(ctx context.Context, params *ListDistributionsByResponseHeadersPolicyIdInput, optFns ...func(*Options)) (*ListDistributionsByResponseHeadersPolicyIdOutput, error) {
	if params == nil { params = &ListDistributionsByResponseHeadersPolicyIdInput{} }
...
func (c *Client) addOperationListDistributionsByResponseHeadersPolicyIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDistributionsByResponseHeadersPolicyIdResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDistributionsByResponseHeadersPolicyIdResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDistributionsByResponseHeadersPolicyIdResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDistributionsByResponseHeadersPolicyIdResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDistributionsByResponseHeadersPolicyIdResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDistributionsByResponseHeadersPolicyIdResolveEndpointMiddleware{
