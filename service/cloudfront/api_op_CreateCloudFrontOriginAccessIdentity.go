...
func addOperationCreateCloudFrontOriginAccessIdentityStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateCloudFrontOriginAccessIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateCloudFrontOriginAccessIdentityStackSlots(stack); err != nil {
		return err
	}
