...
func addOperationDeleteStreamingDistributionStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteStreamingDistributionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteStreamingDistributionStackSlots(stack); err != nil {
		return err
	}
