...
func (c *Client) addOperationDeleteStreamingDistributionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteStreamingDistribution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
