...
func addOperationListDistributionsByKeyGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpListDistributionsByKeyGroupValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opListDistributionsByKeyGroup(options.Region), middleware.Before)
