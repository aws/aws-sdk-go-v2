...
func addOperationGetOriginRequestPolicyConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationGetOriginRequestPolicyConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetOriginRequestPolicyConfigStackSlots(stack); err != nil {
		return err
	}
