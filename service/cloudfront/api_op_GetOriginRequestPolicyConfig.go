...
func (*GetOriginRequestPolicyConfigInput) operationName() string {
...
func (c *Client) addOperationGetOriginRequestPolicyConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetOriginRequestPolicyConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetOriginRequestPolicyConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetOriginRequestPolicyConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetOriginRequestPolicyConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetOriginRequestPolicyConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetOriginRequestPolicyConfigResolveEndpointMiddleware{
