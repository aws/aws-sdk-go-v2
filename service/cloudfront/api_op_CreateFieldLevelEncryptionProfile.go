...
func (c *Client) addOperationCreateFieldLevelEncryptionProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateFieldLevelEncryptionProfileResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateFieldLevelEncryptionProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateFieldLevelEncryptionProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateFieldLevelEncryptionProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateFieldLevelEncryptionProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateFieldLevelEncryptionProfileResolveEndpointMiddleware{
