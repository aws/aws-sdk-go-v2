...
func (c *Client) addOperationUpdateContinuousDeploymentPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateContinuousDeploymentPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
