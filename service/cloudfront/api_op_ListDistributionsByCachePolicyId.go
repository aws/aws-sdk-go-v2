...
func (c *Client) ListDistributionsByCachePolicyId(ctx context.Context, params *ListDistributionsByCachePolicyIdInput, optFns ...func(*Options)) (*ListDistributionsByCachePolicyIdOutput, error) {
	if params == nil { params = &ListDistributionsByCachePolicyIdInput{} }
...
func (c *Client) addOperationListDistributionsByCachePolicyIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDistributionsByCachePolicyIdResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDistributionsByCachePolicyIdResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDistributionsByCachePolicyIdResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDistributionsByCachePolicyIdResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDistributionsByCachePolicyIdResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDistributionsByCachePolicyIdResolveEndpointMiddleware{
