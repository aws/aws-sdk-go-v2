...
func (c *Client) addOperationListDistributionsByCachePolicyIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDistributionsByCachePolicyId", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
