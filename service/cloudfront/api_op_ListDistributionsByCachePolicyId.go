...
func addOperationListDistributionsByCachePolicyIdStackSlots(stack *middleware.Stack) error {
...
func addOperationListDistributionsByCachePolicyIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListDistributionsByCachePolicyIdStackSlots(stack); err != nil {
		return err
	}
