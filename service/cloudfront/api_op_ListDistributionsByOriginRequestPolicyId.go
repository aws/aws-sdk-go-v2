...
func (c *Client) addOperationListDistributionsByOriginRequestPolicyIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDistributionsByOriginRequestPolicyId", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
