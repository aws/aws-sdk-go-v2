...
func addOperationListDistributionsByOriginRequestPolicyIdStackSlots(stack *middleware.Stack) error {
...
func addOperationListDistributionsByOriginRequestPolicyIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListDistributionsByOriginRequestPolicyIdStackSlots(stack); err != nil {
		return err
	}
