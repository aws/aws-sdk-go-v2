...
func addOperationCreateStreamingDistributionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateStreamingDistributionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateStreamingDistributionStackSlots(stack); err != nil {
		return err
	}
