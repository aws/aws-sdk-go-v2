...
func (c *Client) addOperationCreateStreamingDistributionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateStreamingDistribution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
