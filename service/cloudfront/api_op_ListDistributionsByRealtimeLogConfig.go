...
func (c *Client) addOperationListDistributionsByRealtimeLogConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDistributionsByRealtimeLogConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
