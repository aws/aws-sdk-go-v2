...
func (c *Client) addOperationCreateStreamingDistributionWithTagsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateStreamingDistributionWithTags", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
