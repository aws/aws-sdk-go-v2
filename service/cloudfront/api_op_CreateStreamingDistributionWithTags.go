...
func addOperationCreateStreamingDistributionWithTagsStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateStreamingDistributionWithTagsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateStreamingDistributionWithTagsStackSlots(stack); err != nil {
		return err
	}
