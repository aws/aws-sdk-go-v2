...
func (*DeleteMonitoringSubscriptionInput) operationName() string {
...
func (c *Client) addOperationDeleteMonitoringSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteMonitoringSubscriptionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteMonitoringSubscriptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteMonitoringSubscriptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteMonitoringSubscriptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteMonitoringSubscriptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteMonitoringSubscriptionResolveEndpointMiddleware{
