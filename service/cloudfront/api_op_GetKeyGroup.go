...
func (c *Client) GetKeyGroup(ctx context.Context, params *GetKeyGroupInput, optFns ...func(*Options)) (*GetKeyGroupOutput, error) {
	if params == nil { params = &GetKeyGroupInput{} }
...
func (c *Client) addOperationGetKeyGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetKeyGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetKeyGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetKeyGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetKeyGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetKeyGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetKeyGroupResolveEndpointMiddleware{
