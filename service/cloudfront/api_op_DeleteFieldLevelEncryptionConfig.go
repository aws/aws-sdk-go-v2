...
func (c *Client) DeleteFieldLevelEncryptionConfig(ctx context.Context, params *DeleteFieldLevelEncryptionConfigInput, optFns ...func(*Options)) (*DeleteFieldLevelEncryptionConfigOutput, error) {
	if params == nil { params = &DeleteFieldLevelEncryptionConfigInput{} }
...
func (c *Client) addOperationDeleteFieldLevelEncryptionConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteFieldLevelEncryptionConfigResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteFieldLevelEncryptionConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteFieldLevelEncryptionConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteFieldLevelEncryptionConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteFieldLevelEncryptionConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteFieldLevelEncryptionConfigResolveEndpointMiddleware{
