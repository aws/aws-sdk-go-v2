...
func (c *Client) addOperationListDistributionsByConnectionFunctionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDistributionsByConnectionFunction", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
