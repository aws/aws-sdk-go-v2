...
func (c *Client) addOperationListOriginAccessControlsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOriginAccessControls", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
