...
func (*GetFieldLevelEncryptionConfigInput) operationName() string {
...
func (c *Client) addOperationGetFieldLevelEncryptionConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFieldLevelEncryptionConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetFieldLevelEncryptionConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetFieldLevelEncryptionConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFieldLevelEncryptionConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFieldLevelEncryptionConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetFieldLevelEncryptionConfigResolveEndpointMiddleware{
