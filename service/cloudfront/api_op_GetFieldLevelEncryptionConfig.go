...
func addOperationGetFieldLevelEncryptionConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationGetFieldLevelEncryptionConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetFieldLevelEncryptionConfigStackSlots(stack); err != nil {
		return err
	}
