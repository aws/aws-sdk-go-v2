...
func (c *Client) addOperationGetFieldLevelEncryptionConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetFieldLevelEncryptionConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
