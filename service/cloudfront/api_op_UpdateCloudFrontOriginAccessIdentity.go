...
func addOperationUpdateCloudFrontOriginAccessIdentityStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateCloudFrontOriginAccessIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateCloudFrontOriginAccessIdentityStackSlots(stack); err != nil {
		return err
	}
