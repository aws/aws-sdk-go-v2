...
func (c *Client) UpdateCloudFrontOriginAccessIdentity(ctx context.Context, params *UpdateCloudFrontOriginAccessIdentityInput, optFns ...func(*Options)) (*UpdateCloudFrontOriginAccessIdentityOutput, error) {
	if params == nil { params = &UpdateCloudFrontOriginAccessIdentityInput{} }
...
func (c *Client) addOperationUpdateCloudFrontOriginAccessIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateCloudFrontOriginAccessIdentityResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateCloudFrontOriginAccessIdentityResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateCloudFrontOriginAccessIdentityResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateCloudFrontOriginAccessIdentityResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateCloudFrontOriginAccessIdentityResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateCloudFrontOriginAccessIdentityResolveEndpointMiddleware{
