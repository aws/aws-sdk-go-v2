...
func (c *Client) addOperationGetResponseHeadersPolicyConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetResponseHeadersPolicyConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
