...
func (*GetResponseHeadersPolicyConfigInput) operationName() string {
...
func (c *Client) addOperationGetResponseHeadersPolicyConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetResponseHeadersPolicyConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetResponseHeadersPolicyConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetResponseHeadersPolicyConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetResponseHeadersPolicyConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetResponseHeadersPolicyConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetResponseHeadersPolicyConfigResolveEndpointMiddleware{
