...
func (c *Client) ListPublicKeys(ctx context.Context, params *ListPublicKeysInput, optFns ...func(*Options)) (*ListPublicKeysOutput, error) {
	...
	addawsRestxml_serdeOpListPublicKeysMiddlewares(stack)
...
func addawsRestxml_serdeOpListPublicKeysMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestxml_serializeOpListPublicKeys{}, middleware.After)
	stack.Deserialize.Add(&awsRestxml_deserializeOpListPublicKeys{}, middleware.After)
}
