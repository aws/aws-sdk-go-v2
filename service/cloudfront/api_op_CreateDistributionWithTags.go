...
func addOperationCreateDistributionWithTagsStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateDistributionWithTagsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateDistributionWithTagsStackSlots(stack); err != nil {
		return err
	}
