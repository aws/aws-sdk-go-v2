...
func (c *Client) addOperationListInvalidationsForDistributionTenantMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListInvalidationsForDistributionTenant", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
