...
func (c *Client) addOperationCreateResponseHeadersPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateResponseHeadersPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
