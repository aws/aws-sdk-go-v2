...
func addOperationGetStreamingDistributionConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationGetStreamingDistributionConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetStreamingDistributionConfigStackSlots(stack); err != nil {
		return err
	}
