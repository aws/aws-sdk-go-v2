...
func (*DeleteOriginRequestPolicyInput) operationName() string {
...
func (c *Client) addOperationDeleteOriginRequestPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteOriginRequestPolicyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteOriginRequestPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteOriginRequestPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteOriginRequestPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteOriginRequestPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteOriginRequestPolicyResolveEndpointMiddleware{
