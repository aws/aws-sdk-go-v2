...
func (c *Client) addOperationDeleteOriginRequestPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteOriginRequestPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
