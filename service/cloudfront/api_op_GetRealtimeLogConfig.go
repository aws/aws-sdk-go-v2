...
func (*GetRealtimeLogConfigInput) operationName() string {
...
func (c *Client) addOperationGetRealtimeLogConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRealtimeLogConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetRealtimeLogConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetRealtimeLogConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRealtimeLogConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRealtimeLogConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetRealtimeLogConfigResolveEndpointMiddleware{
