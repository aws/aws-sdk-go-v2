...
func (c *Client) addOperationListFieldLevelEncryptionConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFieldLevelEncryptionConfigs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
