...
func (*ListFieldLevelEncryptionConfigsInput) operationName() string {
...
func (c *Client) addOperationListFieldLevelEncryptionConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFieldLevelEncryptionConfigsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListFieldLevelEncryptionConfigsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListFieldLevelEncryptionConfigsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFieldLevelEncryptionConfigsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFieldLevelEncryptionConfigsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListFieldLevelEncryptionConfigsResolveEndpointMiddleware{
