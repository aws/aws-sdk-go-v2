...
func (*GetContinuousDeploymentPolicyInput) operationName() string {
...
func (c *Client) addOperationGetContinuousDeploymentPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetContinuousDeploymentPolicyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetContinuousDeploymentPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetContinuousDeploymentPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetContinuousDeploymentPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetContinuousDeploymentPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetContinuousDeploymentPolicyResolveEndpointMiddleware{
