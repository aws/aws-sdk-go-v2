...
func (c *Client) addOperationGetContinuousDeploymentPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetContinuousDeploymentPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
