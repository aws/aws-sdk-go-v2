...
func (c *Client) addOperationDeleteCloudFrontOriginAccessIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteCloudFrontOriginAccessIdentity", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
