...
func (c *Client) DeleteCloudFrontOriginAccessIdentity(ctx context.Context, params *DeleteCloudFrontOriginAccessIdentityInput, optFns ...func(*Options)) (*DeleteCloudFrontOriginAccessIdentityOutput, error) {
	if params == nil { params = &DeleteCloudFrontOriginAccessIdentityInput{} }
...
func (c *Client) addOperationDeleteCloudFrontOriginAccessIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCloudFrontOriginAccessIdentityResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteCloudFrontOriginAccessIdentityResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteCloudFrontOriginAccessIdentityResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCloudFrontOriginAccessIdentityResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCloudFrontOriginAccessIdentityResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteCloudFrontOriginAccessIdentityResolveEndpointMiddleware{
