...
func addOperationDeleteCloudFrontOriginAccessIdentityStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteCloudFrontOriginAccessIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteCloudFrontOriginAccessIdentityStackSlots(stack); err != nil {
		return err
	}
