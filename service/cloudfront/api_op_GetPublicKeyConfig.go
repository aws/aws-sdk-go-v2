...
func (*GetPublicKeyConfigInput) operationName() string {
...
func (c *Client) addOperationGetPublicKeyConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPublicKeyConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetPublicKeyConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetPublicKeyConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPublicKeyConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPublicKeyConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetPublicKeyConfigResolveEndpointMiddleware{
