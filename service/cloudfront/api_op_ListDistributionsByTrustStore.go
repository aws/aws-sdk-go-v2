...
func (c *Client) addOperationListDistributionsByTrustStoreMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDistributionsByTrustStore", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
