...
func addOperationGetFieldLevelEncryptionProfileStackSlots(stack *middleware.Stack) error {
...
func addOperationGetFieldLevelEncryptionProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetFieldLevelEncryptionProfileStackSlots(stack); err != nil {
		return err
	}
