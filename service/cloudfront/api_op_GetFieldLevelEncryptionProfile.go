...
func (c *Client) GetFieldLevelEncryptionProfile(ctx context.Context, params *GetFieldLevelEncryptionProfileInput, optFns ...func(*Options)) (*GetFieldLevelEncryptionProfileOutput, error) {
	if params == nil { params = &GetFieldLevelEncryptionProfileInput{} }
...
func (c *Client) addOperationGetFieldLevelEncryptionProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFieldLevelEncryptionProfileResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetFieldLevelEncryptionProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetFieldLevelEncryptionProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFieldLevelEncryptionProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFieldLevelEncryptionProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetFieldLevelEncryptionProfileResolveEndpointMiddleware{
