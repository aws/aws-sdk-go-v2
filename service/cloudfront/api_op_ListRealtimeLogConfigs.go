...
func (*ListRealtimeLogConfigsInput) operationName() string {
...
func (c *Client) addOperationListRealtimeLogConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRealtimeLogConfigsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListRealtimeLogConfigsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListRealtimeLogConfigsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRealtimeLogConfigsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRealtimeLogConfigsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListRealtimeLogConfigsResolveEndpointMiddleware{
