...
func (c *Client) addOperationCreateDistributionTenantMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateDistributionTenant", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
