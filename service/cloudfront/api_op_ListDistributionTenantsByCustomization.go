...
func (c *Client) addOperationListDistributionTenantsByCustomizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDistributionTenantsByCustomization", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
