...
func (c *Client) addOperationCreateRealtimeLogConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateRealtimeLogConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
