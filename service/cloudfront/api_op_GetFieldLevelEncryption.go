...
func (c *Client) addOperationGetFieldLevelEncryptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetFieldLevelEncryption", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
