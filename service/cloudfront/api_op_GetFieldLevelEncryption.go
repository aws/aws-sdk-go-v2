...
func (*GetFieldLevelEncryptionInput) operationName() string {
	return "GetFieldLevelEncryption"
}
...
func (c *Client) addOperationGetFieldLevelEncryptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFieldLevelEncryptionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetFieldLevelEncryptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetFieldLevelEncryptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFieldLevelEncryptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFieldLevelEncryptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetFieldLevelEncryptionResolveEndpointMiddleware{
