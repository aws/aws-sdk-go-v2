...
func (*GetFieldLevelEncryptionProfileConfigInput) operationName() string {
	return "GetFieldLevelEncryptionProfileConfig"
}
...
func (c *Client) addOperationGetFieldLevelEncryptionProfileConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFieldLevelEncryptionProfileConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetFieldLevelEncryptionProfileConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetFieldLevelEncryptionProfileConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFieldLevelEncryptionProfileConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFieldLevelEncryptionProfileConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetFieldLevelEncryptionProfileConfigResolveEndpointMiddleware{
