...
func (c *Client) addOperationUpdateRealtimeLogConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRealtimeLogConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
