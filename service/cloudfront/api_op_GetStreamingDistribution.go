...
func (c *Client) addOperationGetStreamingDistributionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetStreamingDistribution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
