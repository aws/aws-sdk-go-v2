...
func (c *Client) ListFieldLevelEncryptionProfiles(ctx context.Context, params *ListFieldLevelEncryptionProfilesInput, optFns ...func(*Options)) (*ListFieldLevelEncryptionProfilesOutput, error) {
	if params == nil { params = &ListFieldLevelEncryptionProfilesInput{} }
...
func (c *Client) addOperationListFieldLevelEncryptionProfilesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFieldLevelEncryptionProfilesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListFieldLevelEncryptionProfilesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListFieldLevelEncryptionProfilesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFieldLevelEncryptionProfilesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFieldLevelEncryptionProfilesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListFieldLevelEncryptionProfilesResolveEndpointMiddleware{
