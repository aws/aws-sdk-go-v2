...
func addOperationListFieldLevelEncryptionProfilesStackSlots(stack *middleware.Stack) error {
...
func addOperationListFieldLevelEncryptionProfilesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListFieldLevelEncryptionProfilesStackSlots(stack); err != nil {
		return err
	}
