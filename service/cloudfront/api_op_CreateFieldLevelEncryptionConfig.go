...
func (*CreateFieldLevelEncryptionConfigInput) operationName() string {
...
func (c *Client) addOperationCreateFieldLevelEncryptionConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateFieldLevelEncryptionConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateFieldLevelEncryptionConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateFieldLevelEncryptionConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateFieldLevelEncryptionConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateFieldLevelEncryptionConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateFieldLevelEncryptionConfigResolveEndpointMiddleware{
