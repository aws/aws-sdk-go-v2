...
func addOperationCreateFieldLevelEncryptionConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateFieldLevelEncryptionConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateFieldLevelEncryptionConfigStackSlots(stack); err != nil {
		return err
	}
