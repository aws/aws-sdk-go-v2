...
func (*GetOriginRequestPolicyInput) operationName() string {
...
func (c *Client) addOperationGetOriginRequestPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetOriginRequestPolicyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetOriginRequestPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetOriginRequestPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetOriginRequestPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetOriginRequestPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetOriginRequestPolicyResolveEndpointMiddleware{
