...
func (*DeleteContinuousDeploymentPolicyInput) operationName() string {
...
func (c *Client) addOperationDeleteContinuousDeploymentPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteContinuousDeploymentPolicyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteContinuousDeploymentPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteContinuousDeploymentPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteContinuousDeploymentPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteContinuousDeploymentPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteContinuousDeploymentPolicyResolveEndpointMiddleware{
