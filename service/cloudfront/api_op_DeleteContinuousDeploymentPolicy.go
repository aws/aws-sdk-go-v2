...
func (c *Client) addOperationDeleteContinuousDeploymentPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteContinuousDeploymentPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
