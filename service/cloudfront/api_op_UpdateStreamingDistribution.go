...
func addOperationUpdateStreamingDistributionStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateStreamingDistributionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateStreamingDistributionStackSlots(stack); err != nil {
		return err
	}
