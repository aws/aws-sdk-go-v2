...
func (c *Client) addOperationListDistributionsByWebACLIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDistributionsByWebACLId", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
