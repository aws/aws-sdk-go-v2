...
func (c *Client) addOperationListCloudFrontOriginAccessIdentitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCloudFrontOriginAccessIdentities", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
