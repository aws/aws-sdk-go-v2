...
func addOperationListCloudFrontOriginAccessIdentitiesStackSlots(stack *middleware.Stack) error {
...
func addOperationListCloudFrontOriginAccessIdentitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListCloudFrontOriginAccessIdentitiesStackSlots(stack); err != nil {
		return err
	}
