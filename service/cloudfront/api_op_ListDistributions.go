...
func (c *Client) ListDistributions(ctx context.Context, params *ListDistributionsInput, optFns ...func(*Options)) (*ListDistributionsOutput, error) {
	stack := middleware.NewStack("ListDistributions", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestxml_serdeOpListDistributionsMiddlewares(stack)
	...
	stack.Initialize.Add(newServiceMetadataMiddleware_opListDistributions(options.Region), middleware.Before)
...
func addawsRestxml_serdeOpListDistributionsMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestxml_serializeOpListDistributions{}, middleware.After)
	stack.Deserialize.Add(&awsRestxml_deserializeOpListDistributions{}, middleware.After)
}
