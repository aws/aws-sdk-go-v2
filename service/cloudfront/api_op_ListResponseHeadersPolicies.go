...
func (c *Client) ListResponseHeadersPolicies(ctx context.Context, params *ListResponseHeadersPoliciesInput, optFns ...func(*Options)) (*ListResponseHeadersPoliciesOutput, error) {
	if params == nil { params = &ListResponseHeadersPoliciesInput{} }
...
func (c *Client) addOperationListResponseHeadersPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListResponseHeadersPoliciesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListResponseHeadersPoliciesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListResponseHeadersPoliciesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListResponseHeadersPoliciesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListResponseHeadersPoliciesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListResponseHeadersPoliciesResolveEndpointMiddleware{
