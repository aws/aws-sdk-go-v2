...
func (c *Client) ListContinuousDeploymentPolicies(ctx context.Context, params *ListContinuousDeploymentPoliciesInput, optFns ...func(*Options)) (*ListContinuousDeploymentPoliciesOutput, error) {
	if params == nil { params = &ListContinuousDeploymentPoliciesInput{} }
...
func (c *Client) addOperationListContinuousDeploymentPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListContinuousDeploymentPoliciesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListContinuousDeploymentPoliciesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListContinuousDeploymentPoliciesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListContinuousDeploymentPoliciesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListContinuousDeploymentPoliciesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListContinuousDeploymentPoliciesResolveEndpointMiddleware{
