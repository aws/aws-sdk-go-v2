...
func (c *Client) addOperationListContinuousDeploymentPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListContinuousDeploymentPolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
