...
func (c *Client) GetContinuousDeploymentPolicyConfig(ctx context.Context, params *GetContinuousDeploymentPolicyConfigInput, optFns ...func(*Options)) (*GetContinuousDeploymentPolicyConfigOutput, error) {
	if params == nil { params = &GetContinuousDeploymentPolicyConfigInput{} }
...
func (c *Client) addOperationGetContinuousDeploymentPolicyConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetContinuousDeploymentPolicyConfigResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetContinuousDeploymentPolicyConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetContinuousDeploymentPolicyConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetContinuousDeploymentPolicyConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetContinuousDeploymentPolicyConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetContinuousDeploymentPolicyConfigResolveEndpointMiddleware{
