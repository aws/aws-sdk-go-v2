...
func (c *Client) addOperationGetContinuousDeploymentPolicyConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetContinuousDeploymentPolicyConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
