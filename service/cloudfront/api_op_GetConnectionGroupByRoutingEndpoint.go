...
func (c *Client) addOperationGetConnectionGroupByRoutingEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetConnectionGroupByRoutingEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
