...
func (c *Client) addOperationListConnectionFunctionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListConnectionFunctions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
