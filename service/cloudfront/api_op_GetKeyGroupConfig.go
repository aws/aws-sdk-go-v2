...
func addOperationGetKeyGroupConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpGetKeyGroupConfigValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opGetKeyGroupConfig(options.Region), middleware.Before)
