...
func (c *Client) addOperationUpdateFieldLevelEncryptionProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateFieldLevelEncryptionProfile", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
