...
func addOperationUpdateFieldLevelEncryptionProfileStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateFieldLevelEncryptionProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateFieldLevelEncryptionProfileStackSlots(stack); err != nil {
		return err
	}
