...
func (c *Client) addOperationGetResponseHeadersPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetResponseHeadersPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
