...
func addOperationGetCloudFrontOriginAccessIdentityConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationGetCloudFrontOriginAccessIdentityConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetCloudFrontOriginAccessIdentityConfigStackSlots(stack); err != nil {
		return err
	}
