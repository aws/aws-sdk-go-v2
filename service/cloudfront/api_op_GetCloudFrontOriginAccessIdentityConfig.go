...
func (c *Client) addOperationGetCloudFrontOriginAccessIdentityConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCloudFrontOriginAccessIdentityConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetCloudFrontOriginAccessIdentityConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetCloudFrontOriginAccessIdentityConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCloudFrontOriginAccessIdentityConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCloudFrontOriginAccessIdentityConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetCloudFrontOriginAccessIdentityConfigResolveEndpointMiddleware{
