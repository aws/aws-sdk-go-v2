...
func (*CreateContinuousDeploymentPolicyInput) operationName() string {
...
func (c *Client) addOperationCreateContinuousDeploymentPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateContinuousDeploymentPolicyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateContinuousDeploymentPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateContinuousDeploymentPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateContinuousDeploymentPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateContinuousDeploymentPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateContinuousDeploymentPolicyResolveEndpointMiddleware{
