...
// configuration. After you create and update a staging distribution, you can use a
// continuous deployment policy to incrementally move traffic to the staging
// distribution. This workflow enables you to test changes to a distribution's
