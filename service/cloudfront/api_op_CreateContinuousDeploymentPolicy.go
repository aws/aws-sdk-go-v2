...
func (c *Client) addOperationCreateContinuousDeploymentPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateContinuousDeploymentPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
