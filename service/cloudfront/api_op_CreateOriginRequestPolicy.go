...
func (*CreateOriginRequestPolicyInput) operationName() string {
...
func (c *Client) addOperationCreateOriginRequestPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateOriginRequestPolicyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateOriginRequestPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateOriginRequestPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateOriginRequestPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateOriginRequestPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateOriginRequestPolicyResolveEndpointMiddleware{
