...
func (c *Client) addOperationBatchDeleteRumMetricDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDeleteRumMetricDefinitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
