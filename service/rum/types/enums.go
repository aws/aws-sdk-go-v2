...
// Enum values for AppMonitorPlatform
const (
...
// Values returns all known values for AppMonitorPlatform. Note that this can be
// expanded in the future, and so it is only as up to date as the client.
//
// The ordering of this slice is not guaranteed to be stable across updates.
func (AppMonitorPlatform) Values() []AppMonitorPlatform {
	return []AppMonitorPlatform{
		"Web",
		"Android",
		"iOS",
	}
