...
func (c *Client) addOperationBatchCreateRumMetricDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchCreateRumMetricDefinitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
