...
func (c *Client) addOperationGetMediaPipelineKinesisVideoStreamPoolMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMediaPipelineKinesisVideoStreamPoolResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetMediaPipelineKinesisVideoStreamPoolResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetMediaPipelineKinesisVideoStreamPoolResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMediaPipelineKinesisVideoStreamPoolResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMediaPipelineKinesisVideoStreamPoolResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetMediaPipelineKinesisVideoStreamPoolResolveEndpointMiddleware{
