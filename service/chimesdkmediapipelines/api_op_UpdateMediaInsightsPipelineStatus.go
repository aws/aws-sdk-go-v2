...
func (c *Client) UpdateMediaInsightsPipelineStatus(ctx context.Context, params *UpdateMediaInsightsPipelineStatusInput, optFns ...func(*Options)) (*UpdateMediaInsightsPipelineStatusOutput, error) {
	if params == nil { params = &UpdateMediaInsightsPipelineStatusInput{} }
...
func (c *Client) addOperationUpdateMediaInsightsPipelineStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateMediaInsightsPipelineStatusResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateMediaInsightsPipelineStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateMediaInsightsPipelineStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateMediaInsightsPipelineStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateMediaInsightsPipelineStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateMediaInsightsPipelineStatusResolveEndpointMiddleware{
