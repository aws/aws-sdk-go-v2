...
func (c *Client) addOperationUpdateMediaInsightsPipelineStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateMediaInsightsPipelineStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
