...
func (c *Client) addOperationStopSpeakerSearchTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopSpeakerSearchTaskResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopSpeakerSearchTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopSpeakerSearchTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopSpeakerSearchTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopSpeakerSearchTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopSpeakerSearchTaskResolveEndpointMiddleware{
