...
func (c *Client) addOperationGetMediaCapturePipelineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetMediaCapturePipeline", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
