...
func (*GetSpeakerSearchTaskInput) operationName() string {
	return "GetSpeakerSearchTask"
}
...
func (c *Client) addOperationGetSpeakerSearchTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSpeakerSearchTaskResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetSpeakerSearchTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetSpeakerSearchTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSpeakerSearchTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSpeakerSearchTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetSpeakerSearchTaskResolveEndpointMiddleware{
