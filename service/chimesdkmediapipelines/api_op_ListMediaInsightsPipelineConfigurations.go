...
func (c *Client) addOperationListMediaInsightsPipelineConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMediaInsightsPipelineConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
