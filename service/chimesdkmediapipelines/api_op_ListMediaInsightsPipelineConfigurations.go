...
func (*ListMediaInsightsPipelineConfigurationsInput) operationName() string {
...
func (c *Client) addOperationListMediaInsightsPipelineConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMediaInsightsPipelineConfigurationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListMediaInsightsPipelineConfigurationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListMediaInsightsPipelineConfigurationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMediaInsightsPipelineConfigurationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListMediaInsightsPipelineConfigurationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListMediaInsightsPipelineConfigurationsResolveEndpointMiddleware{
