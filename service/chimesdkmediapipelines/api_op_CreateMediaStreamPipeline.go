...
func (c *Client) addOperationCreateMediaStreamPipelineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMediaStreamPipeline", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
