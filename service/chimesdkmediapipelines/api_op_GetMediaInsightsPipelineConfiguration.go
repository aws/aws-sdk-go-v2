...
func (c *Client) addOperationGetMediaInsightsPipelineConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetMediaInsightsPipelineConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
