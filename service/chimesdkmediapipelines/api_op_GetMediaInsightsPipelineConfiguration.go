...
func (c *Client) GetMediaInsightsPipelineConfiguration(ctx context.Context, params *GetMediaInsightsPipelineConfigurationInput, optFns ...func(*Options)) (*GetMediaInsightsPipelineConfigurationOutput, error) {
	if params == nil { params = &GetMediaInsightsPipelineConfigurationInput{} }
...
func (c *Client) addOperationGetMediaInsightsPipelineConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMediaInsightsPipelineConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetMediaInsightsPipelineConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetMediaInsightsPipelineConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMediaInsightsPipelineConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMediaInsightsPipelineConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetMediaInsightsPipelineConfigurationResolveEndpointMiddleware{
