...
func (c *Client) addOperationDeleteMediaCapturePipelineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteMediaCapturePipeline", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
