...
func (*DeleteMediaCapturePipelineInput) operationName() string {
...
func (c *Client) addOperationDeleteMediaCapturePipelineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteMediaCapturePipelineResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteMediaCapturePipelineResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteMediaCapturePipelineResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteMediaCapturePipelineResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteMediaCapturePipelineResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteMediaCapturePipelineResolveEndpointMiddleware{
