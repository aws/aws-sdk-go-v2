...
func (c *Client) addOperationStartVoiceToneAnalysisTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartVoiceToneAnalysisTaskResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStartVoiceToneAnalysisTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStartVoiceToneAnalysisTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartVoiceToneAnalysisTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartVoiceToneAnalysisTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStartVoiceToneAnalysisTaskResolveEndpointMiddleware{
