...
func (c *Client) addOperationStartVoiceToneAnalysisTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartVoiceToneAnalysisTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
