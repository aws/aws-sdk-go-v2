...
func (c *Client) addOperationListMediaPipelineKinesisVideoStreamPoolsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMediaPipelineKinesisVideoStreamPools", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
