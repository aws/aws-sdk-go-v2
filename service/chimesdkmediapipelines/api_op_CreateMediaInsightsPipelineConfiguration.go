...
func (c *Client) addOperationCreateMediaInsightsPipelineConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMediaInsightsPipelineConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
