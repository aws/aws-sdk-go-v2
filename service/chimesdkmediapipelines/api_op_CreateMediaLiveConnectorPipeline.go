...
func (c *Client) addOperationCreateMediaLiveConnectorPipelineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMediaLiveConnectorPipeline", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
