...
func (c *Client) addOperationListMediaCapturePipelinesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMediaCapturePipelines", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
