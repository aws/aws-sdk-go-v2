...
func (*ListMediaCapturePipelinesInput) operationName() string {
...
func (c *Client) addOperationListMediaCapturePipelinesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMediaCapturePipelinesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListMediaCapturePipelinesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListMediaCapturePipelinesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMediaCapturePipelinesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListMediaCapturePipelinesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListMediaCapturePipelinesResolveEndpointMiddleware{
