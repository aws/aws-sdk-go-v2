...
func (c *Client) addOperationCreateMediaConcatenationPipelineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMediaConcatenationPipeline", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
