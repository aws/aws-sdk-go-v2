...
func (v *CreateMediaCapturePipelineOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.CreateMediaCapturePipelineResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *CreateMediaCapturePipelineOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.MediaCapturePipeline != nil {
		s.WriteStruct(schemas.CreateMediaCapturePipelineResponse_MediaCapturePipeline)
