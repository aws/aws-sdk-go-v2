...
func (v *UpdateMediaInsightsPipelineConfigurationOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.UpdateMediaInsightsPipelineConfigurationResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *UpdateMediaInsightsPipelineConfigurationOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.MediaInsightsPipelineConfiguration != nil {
		s.WriteStruct(schemas.UpdateMediaInsightsPipelineConfigurationResponse_MediaInsightsPipelineConfiguration)
