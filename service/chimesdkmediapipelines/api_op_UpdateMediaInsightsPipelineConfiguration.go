...
func (c *Client) UpdateMediaInsightsPipelineConfiguration(ctx context.Context, params *UpdateMediaInsightsPipelineConfigurationInput, optFns ...func(*Options)) (*UpdateMediaInsightsPipelineConfigurationOutput, error) {
	if params == nil { params = &UpdateMediaInsightsPipelineConfigurationInput{} }
...
func (c *Client) addOperationUpdateMediaInsightsPipelineConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateMediaInsightsPipelineConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateMediaInsightsPipelineConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateMediaInsightsPipelineConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateMediaInsightsPipelineConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateMediaInsightsPipelineConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateMediaInsightsPipelineConfigurationResolveEndpointMiddleware{
