...
func (c *Client) addOperationBatchDeleteRecipeVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDeleteRecipeVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
