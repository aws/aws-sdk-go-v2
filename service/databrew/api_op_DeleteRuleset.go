...
func (c *Client) addOperationDeleteRulesetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteRulesetResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteRulesetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteRulesetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteRulesetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteRulesetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteRulesetResolveEndpointMiddleware{
