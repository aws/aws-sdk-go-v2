...
func (c *Client) SendProjectSessionAction(ctx context.Context, params *SendProjectSessionActionInput, optFns ...func(*Options)) (*SendProjectSessionActionOutput, error) {
	if params == nil { params = &SendProjectSessionActionInput{} }
...
func (c *Client) addOperationSendProjectSessionActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendProjectSessionActionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSendProjectSessionActionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSendProjectSessionActionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendProjectSessionActionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendProjectSessionActionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSendProjectSessionActionResolveEndpointMiddleware{
