...
type EntityDetectorConfiguration struct {
	...
	//     - PERSON_NAME
	//     - DATE
	// The Entity type group USA_ALL is also supported, and includes all
	// of the above entity types except PERSON_NAME and DATE.
	//
	// This member is required.
	EntityTypes []string
...
// change to a DataBrew dataset. For more information, see Recipe actions
...
type Rule struct {
	...
	// column reference in the left side of a condition, for example, is_between
	// :val1 and :val2 . For more information, see Available checks (https://docs.aws.amazon.com/databrew/latest/dg/profile.data-quality-available-checks.html)
	//
	// This member is required.
