...
func (c *Client) StopJobRun(ctx context.Context, params *StopJobRunInput, optFns ...func(*Options)) (*StopJobRunOutput, error) {
	if params == nil { params = &StopJobRunInput{} }
...
func (c *Client) addOperationStopJobRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopJobRunResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopJobRunResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopJobRunResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopJobRunResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopJobRunResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopJobRunResolveEndpointMiddleware{
