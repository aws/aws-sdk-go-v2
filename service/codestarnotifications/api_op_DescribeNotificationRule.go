...
func (c *Client) addOperationDescribeNotificationRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeNotificationRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
