...
func (c *Client) ListNotificationRules(ctx context.Context, params *ListNotificationRulesInput, optFns ...func(*Options)) (*ListNotificationRulesOutput, error) {
	if params == nil { params = &ListNotificationRulesInput{} }
...
func (c *Client) addOperationListNotificationRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListNotificationRulesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListNotificationRulesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListNotificationRulesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListNotificationRulesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListNotificationRulesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListNotificationRulesResolveEndpointMiddleware{
