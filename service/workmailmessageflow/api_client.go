...
const (
	ServiceName = "Amazon WorkMail Message Flow" // Service's name
	ServiceID   = "WorkMailMessageFlow"          // Service's identifier
	EndpointsID = "workmailmessageflow"          // Service's Endpoint identifier
)
...
//     svc := workmailmessageflow.New(myConfig)
