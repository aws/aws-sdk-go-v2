...
func (c *Client) GetRawMessageContent(ctx context.Context, params *GetRawMessageContentInput, optFns ...func(*Options)) (*GetRawMessageContentOutput, error) {
	if params == nil { params = &GetRawMessageContentInput{} }
...
func (c *Client) addOperationGetRawMessageContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRawMessageContentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRawMessageContentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRawMessageContentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRawMessageContentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRawMessageContentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRawMessageContentResolveEndpointMiddleware{
