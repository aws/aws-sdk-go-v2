...
func (m *awsRestjson1_deserializeOpGetRawMessageContent) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	err = awsRestjson1_deserializeDocumentGetRawMessageContentOutput(output, response.Body)
	if err != nil {
...
func awsRestjson1_deserializeDocumentGetRawMessageContentOutput(v *GetRawMessageContentOutput, body io.ReadCloser) error {
	if v == nil {
