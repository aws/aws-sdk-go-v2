...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-connecthealth.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connecthealth.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connecthealth.dev",
			expectURL:     aws.String("https://env-connecthealth.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-connecthealth.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connecthealth.dev",
			expectURL:     aws.String("http://config-connecthealth.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-connecthealth.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-connecthealth.dev",
			clientEndpoint: aws.String("https://client-connecthealth.dev"),
			expectURL:      aws.String("https://client-connecthealth.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CONNECTHEALTH", c.envService)
			}
