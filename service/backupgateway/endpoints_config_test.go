...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-backup-gateway.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-backup-gateway.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-backup-gateway.dev",
			expectURL:     aws.String("https://env-backup-gateway.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-backup-gateway.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-backup-gateway.dev",
			expectURL:     aws.String("http://config-backup-gateway.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-backup-gateway.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-backup-gateway.dev",
			clientEndpoint: aws.String("https://client-backup-gateway.dev"),
			expectURL:      aws.String("https://client-backup-gateway.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BACKUP_GATEWAY", c.envService)
			}
