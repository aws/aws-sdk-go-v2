...
func (c *Client) DeleteHypervisor(ctx context.Context, params *DeleteHypervisorInput, optFns ...func(*Options)) (*DeleteHypervisorOutput, error) {
	if params == nil { params = &DeleteHypervisorInput{} }
...
func (c *Client) addOperationDeleteHypervisorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteHypervisorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteHypervisorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteHypervisorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteHypervisorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteHypervisorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteHypervisorResolveEndpointMiddleware{
