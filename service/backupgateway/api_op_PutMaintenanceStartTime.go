...
func (c *Client) addOperationPutMaintenanceStartTimeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutMaintenanceStartTime", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
