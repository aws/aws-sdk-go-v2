...
func (c *Client) AssociateGatewayToServer(ctx context.Context, params *AssociateGatewayToServerInput, optFns ...func(*Options)) (*AssociateGatewayToServerOutput, error) {
	if params == nil { params = &AssociateGatewayToServerInput{} }
...
func (c *Client) addOperationAssociateGatewayToServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateGatewayToServerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateGatewayToServerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateGatewayToServerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateGatewayToServerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateGatewayToServerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateGatewayToServerResolveEndpointMiddleware{
