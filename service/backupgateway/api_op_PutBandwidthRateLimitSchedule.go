...
func (c *Client) addOperationPutBandwidthRateLimitScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutBandwidthRateLimitSchedule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
