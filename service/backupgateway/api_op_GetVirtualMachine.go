...
func (c *Client) GetVirtualMachine(ctx context.Context, params *GetVirtualMachineInput, optFns ...func(*Options)) (*GetVirtualMachineOutput, error) {
	if params == nil { params = &GetVirtualMachineInput{} }
...
func (c *Client) addOperationGetVirtualMachineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetVirtualMachineResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetVirtualMachineResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetVirtualMachineResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetVirtualMachineResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetVirtualMachineResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetVirtualMachineResolveEndpointMiddleware{
