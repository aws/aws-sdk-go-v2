...
func (c *Client) GetBandwidthRateLimitSchedule(ctx context.Context, params *GetBandwidthRateLimitScheduleInput, optFns ...func(*Options)) (*GetBandwidthRateLimitScheduleOutput, error) {
	if params == nil { params = &GetBandwidthRateLimitScheduleInput{} }
...
func (c *Client) addOperationGetBandwidthRateLimitScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBandwidthRateLimitScheduleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetBandwidthRateLimitScheduleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetBandwidthRateLimitScheduleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetBandwidthRateLimitScheduleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBandwidthRateLimitScheduleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetBandwidthRateLimitScheduleResolveEndpointMiddleware{
