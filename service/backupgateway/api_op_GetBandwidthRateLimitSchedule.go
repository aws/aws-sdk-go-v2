...
func (c *Client) addOperationGetBandwidthRateLimitScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetBandwidthRateLimitSchedule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
