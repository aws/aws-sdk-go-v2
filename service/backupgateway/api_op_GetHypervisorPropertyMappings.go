...
func (c *Client) addOperationGetHypervisorPropertyMappingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetHypervisorPropertyMappings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
