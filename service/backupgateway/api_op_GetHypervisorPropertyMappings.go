...
func (*GetHypervisorPropertyMappingsInput) operationName() string {
	return "GetHypervisorPropertyMappings"
}
...
func (c *Client) addOperationGetHypervisorPropertyMappingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetHypervisorPropertyMappingsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetHypervisorPropertyMappingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetHypervisorPropertyMappingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetHypervisorPropertyMappingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetHypervisorPropertyMappingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetHypervisorPropertyMappingsResolveEndpointMiddleware{
