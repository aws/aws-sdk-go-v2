...
func (c *Client) GetHypervisor(ctx context.Context, params *GetHypervisorInput, optFns ...func(*Options)) (*GetHypervisorOutput, error) {
	if params == nil { params = &GetHypervisorInput{} }
...
func (c *Client) addOperationGetHypervisorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetHypervisorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetHypervisorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetHypervisorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetHypervisorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetHypervisorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetHypervisorResolveEndpointMiddleware{
