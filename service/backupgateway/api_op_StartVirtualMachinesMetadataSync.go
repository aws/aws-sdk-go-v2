...
func (c *Client) StartVirtualMachinesMetadataSync(ctx context.Context, params *StartVirtualMachinesMetadataSyncInput, optFns ...func(*Options)) (*StartVirtualMachinesMetadataSyncOutput, error) {
	if params == nil { params = &StartVirtualMachinesMetadataSyncInput{} }
...
func (c *Client) addOperationStartVirtualMachinesMetadataSyncMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartVirtualMachinesMetadataSyncResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartVirtualMachinesMetadataSyncResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartVirtualMachinesMetadataSyncResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartVirtualMachinesMetadataSyncResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartVirtualMachinesMetadataSyncResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartVirtualMachinesMetadataSyncResolveEndpointMiddleware{
