...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-aiops.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-aiops.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-aiops.dev",
			expectURL:     aws.String("https://env-aiops.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-aiops.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-aiops.dev",
			expectURL:     aws.String("http://config-aiops.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-aiops.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-aiops.dev",
			clientEndpoint: aws.String("https://client-aiops.dev"),
			expectURL:      aws.String("https://client-aiops.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_AIOPS", c.envService)
			}
