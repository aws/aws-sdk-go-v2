...
func (c *Client) addOperationCreateInvestigationGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateInvestigationGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
