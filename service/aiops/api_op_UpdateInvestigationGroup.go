...
func (c *Client) addOperationUpdateInvestigationGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateInvestigationGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
