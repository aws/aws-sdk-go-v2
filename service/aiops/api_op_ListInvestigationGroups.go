...
func (c *Client) addOperationListInvestigationGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListInvestigationGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
