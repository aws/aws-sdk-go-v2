...
func addOperationDisassociateDeviceFromPlacementStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateDeviceFromPlacementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateDeviceFromPlacementStackSlots(stack); err != nil {
		return err
	}
