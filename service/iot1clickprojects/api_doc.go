...
// requests to AWS IoT 1-Click Projects.
//
...
// Using the Client
//
// To use AWS IoT 1-Click Projects with the SDK use the New function to create
...
//
// See the AWS IoT 1-Click Projects client for more information on
