...
func (*DeletePlacementInput) operationName() string {
...
func (c *Client) addOperationDeletePlacementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeletePlacementResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeletePlacementResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeletePlacementResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeletePlacementResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeletePlacementResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeletePlacementResolveEndpointMiddleware{
