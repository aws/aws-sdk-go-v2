...
func (c *Client) addOperationUpdateWhatsAppFlowAssetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateWhatsAppFlowAssets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
