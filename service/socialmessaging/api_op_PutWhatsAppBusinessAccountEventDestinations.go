...
func (c *Client) addOperationPutWhatsAppBusinessAccountEventDestinationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutWhatsAppBusinessAccountEventDestinations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
