...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-socialmessaging.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-socialmessaging.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-socialmessaging.dev",
			expectURL:     aws.String("https://env-socialmessaging.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-socialmessaging.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-socialmessaging.dev",
			expectURL:     aws.String("http://config-socialmessaging.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-socialmessaging.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-socialmessaging.dev",
			clientEndpoint: aws.String("https://client-socialmessaging.dev"),
			expectURL:      aws.String("https://client-socialmessaging.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SOCIALMESSAGING", c.envService)
			}
