...
func (c *Client) addOperationGetLinkedWhatsAppBusinessAccountPhoneNumberMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetLinkedWhatsAppBusinessAccountPhoneNumber", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
