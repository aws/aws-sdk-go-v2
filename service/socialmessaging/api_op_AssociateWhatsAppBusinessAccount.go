...
func (c *Client) addOperationAssociateWhatsAppBusinessAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateWhatsAppBusinessAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
