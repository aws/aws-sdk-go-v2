...
func (c *Client) addOperationListWhatsAppTemplateLibraryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListWhatsAppTemplateLibrary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
