...
func (c *Client) addOperationDeleteWhatsAppMessageMediaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteWhatsAppMessageMedia", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
