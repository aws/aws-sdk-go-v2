...
func (c *Client) addOperationListWhatsAppMessageTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListWhatsAppMessageTemplates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
