...
func (c *Client) addOperationPostWhatsAppMessageMediaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PostWhatsAppMessageMedia", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
