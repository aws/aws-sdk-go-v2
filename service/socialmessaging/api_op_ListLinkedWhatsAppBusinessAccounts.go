...
func (c *Client) addOperationListLinkedWhatsAppBusinessAccountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListLinkedWhatsAppBusinessAccounts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
