...
func (c *Client) DeleteInputSecurityGroup(ctx context.Context, params *DeleteInputSecurityGroupInput, optFns ...func(*Options)) (*DeleteInputSecurityGroupOutput, error) {
	if params == nil { params = &DeleteInputSecurityGroupInput{} }
...
func (c *Client) addOperationDeleteInputSecurityGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteInputSecurityGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteInputSecurityGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteInputSecurityGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteInputSecurityGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteInputSecurityGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteInputSecurityGroupResolveEndpointMiddleware{
