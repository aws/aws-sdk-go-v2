...
func (c *Client) addOperationStartDeleteMonitorDeploymentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartDeleteMonitorDeployment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
