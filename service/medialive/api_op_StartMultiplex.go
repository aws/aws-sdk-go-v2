...
func (c *Client) StartMultiplex(ctx context.Context, params *StartMultiplexInput, optFns ...func(*Options)) (*StartMultiplexOutput, error) {
	if params == nil { params = &StartMultiplexInput{} }
...
func (c *Client) addOperationStartMultiplexMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartMultiplexResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartMultiplexResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartMultiplexResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartMultiplexResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartMultiplexResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartMultiplexResolveEndpointMiddleware{
