...
func (c *Client) AcceptInputDeviceTransfer(ctx context.Context, params *AcceptInputDeviceTransferInput, optFns ...func(*Options)) (*AcceptInputDeviceTransferOutput, error) {
	if params == nil { params = &AcceptInputDeviceTransferInput{} }
...
func (c *Client) addOperationAcceptInputDeviceTransferMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAcceptInputDeviceTransferResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAcceptInputDeviceTransferResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAcceptInputDeviceTransferResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAcceptInputDeviceTransferResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAcceptInputDeviceTransferResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAcceptInputDeviceTransferResolveEndpointMiddleware{
