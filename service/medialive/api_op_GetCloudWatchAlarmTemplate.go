...
func (c *Client) addOperationGetCloudWatchAlarmTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCloudWatchAlarmTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
