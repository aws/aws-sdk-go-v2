...
func (c *Client) CreateInputSecurityGroup(ctx context.Context, params *CreateInputSecurityGroupInput, optFns ...func(*Options)) (*CreateInputSecurityGroupOutput, error) {
	if params == nil { params = &CreateInputSecurityGroupInput{} }
...
func (c *Client) addOperationCreateInputSecurityGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateInputSecurityGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateInputSecurityGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateInputSecurityGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateInputSecurityGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateInputSecurityGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateInputSecurityGroupResolveEndpointMiddleware{
