...
func (c *Client) addOperationCreateInputSecurityGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateInputSecurityGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
