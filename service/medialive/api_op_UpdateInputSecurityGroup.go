...
func (c *Client) addOperationUpdateInputSecurityGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateInputSecurityGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
