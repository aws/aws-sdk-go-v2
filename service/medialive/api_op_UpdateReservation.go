...
func (c *Client) UpdateReservation(ctx context.Context, params *UpdateReservationInput, optFns ...func(*Options)) (*UpdateReservationOutput, error) {
	stack := middleware.NewStack("UpdateReservation", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpUpdateReservationMiddlewares(stack)
...
func addawsRestjson1_serdeOpUpdateReservationMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpUpdateReservation{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpUpdateReservation{}, middleware.After)
}
