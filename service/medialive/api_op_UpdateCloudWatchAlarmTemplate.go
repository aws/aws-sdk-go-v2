...
func (c *Client) addOperationUpdateCloudWatchAlarmTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCloudWatchAlarmTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
