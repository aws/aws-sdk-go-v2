...
func addOperationDescribeInputDeviceThumbnailStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeInputDeviceThumbnailMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeInputDeviceThumbnailStackSlots(stack); err != nil {
		return err
	}
