...
func (c *Client) addOperationListCloudWatchAlarmTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCloudWatchAlarmTemplates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
