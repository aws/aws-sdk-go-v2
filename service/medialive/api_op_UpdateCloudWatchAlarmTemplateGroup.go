...
func (c *Client) addOperationUpdateCloudWatchAlarmTemplateGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCloudWatchAlarmTemplateGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
