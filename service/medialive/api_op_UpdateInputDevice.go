...
func (*UpdateInputDeviceInput) operationName() string {
...
func (c *Client) addOperationUpdateInputDeviceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateInputDeviceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateInputDeviceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateInputDeviceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateInputDeviceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateInputDeviceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateInputDeviceResolveEndpointMiddleware{
