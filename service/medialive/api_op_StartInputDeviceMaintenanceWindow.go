...
func (c *Client) StartInputDeviceMaintenanceWindow(ctx context.Context, params *StartInputDeviceMaintenanceWindowInput, optFns ...func(*Options)) (*StartInputDeviceMaintenanceWindowOutput, error) {
	if params == nil { params = &StartInputDeviceMaintenanceWindowInput{} }
...
func (c *Client) addOperationStartInputDeviceMaintenanceWindowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartInputDeviceMaintenanceWindowResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartInputDeviceMaintenanceWindowResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartInputDeviceMaintenanceWindowResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartInputDeviceMaintenanceWindowResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartInputDeviceMaintenanceWindowResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartInputDeviceMaintenanceWindowResolveEndpointMiddleware{
