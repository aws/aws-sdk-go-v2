...
func (c *Client) addOperationStartInputDeviceMaintenanceWindowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartInputDeviceMaintenanceWindow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
