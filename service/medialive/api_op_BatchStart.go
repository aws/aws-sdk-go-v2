...
func (c *Client) BatchStart(ctx context.Context, params *BatchStartInput, optFns ...func(*Options)) (*BatchStartOutput, error) {
	if params == nil { params = &BatchStartInput{} }
...
func (c *Client) addOperationBatchStartMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchStartResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchStartResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchStartResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchStartResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchStartResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchStartResolveEndpointMiddleware{
