...
func (c *Client) addOperationListCloudWatchAlarmTemplateGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCloudWatchAlarmTemplateGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
