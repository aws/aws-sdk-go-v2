...
func (*RejectInputDeviceTransferInput) operationName() string {
...
func (c *Client) addOperationRejectInputDeviceTransferMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRejectInputDeviceTransferResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRejectInputDeviceTransferResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRejectInputDeviceTransferResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRejectInputDeviceTransferResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRejectInputDeviceTransferResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRejectInputDeviceTransferResolveEndpointMiddleware{
