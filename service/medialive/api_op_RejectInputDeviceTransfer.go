...
func (c *Client) addOperationRejectInputDeviceTransferMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RejectInputDeviceTransfer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
