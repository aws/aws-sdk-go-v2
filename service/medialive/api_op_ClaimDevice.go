...
func (c *Client) ClaimDevice(ctx context.Context, params *ClaimDeviceInput, optFns ...func(*Options)) (*ClaimDeviceOutput, error) {
	if params == nil { params = &ClaimDeviceInput{} }
...
func (c *Client) addOperationClaimDeviceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addClaimDeviceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opClaimDeviceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opClaimDeviceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opClaimDeviceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addClaimDeviceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opClaimDeviceResolveEndpointMiddleware{
