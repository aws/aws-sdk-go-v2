...
func (*ListMultiplexesInput) operationName() string {
...
func (c *Client) addOperationListMultiplexesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMultiplexesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListMultiplexesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListMultiplexesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMultiplexesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListMultiplexesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListMultiplexesResolveEndpointMiddleware{
