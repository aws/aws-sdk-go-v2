...
func (c *Client) addOperationCreateChannelPlacementGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateChannelPlacementGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
