...
func (c *Client) addOperationListInputDeviceTransfersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListInputDeviceTransfers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
