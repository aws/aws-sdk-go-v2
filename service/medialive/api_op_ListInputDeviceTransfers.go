...
func (c *Client) ListInputDeviceTransfers(ctx context.Context, params *ListInputDeviceTransfersInput, optFns ...func(*Options)) (*ListInputDeviceTransfersOutput, error) {
	if params == nil { params = &ListInputDeviceTransfersInput{} }
...
func (c *Client) addOperationListInputDeviceTransfersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListInputDeviceTransfersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListInputDeviceTransfersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListInputDeviceTransfersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListInputDeviceTransfersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListInputDeviceTransfersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListInputDeviceTransfersResolveEndpointMiddleware{
