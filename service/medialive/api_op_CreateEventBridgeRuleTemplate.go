...
func (c *Client) addOperationCreateEventBridgeRuleTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateEventBridgeRuleTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
