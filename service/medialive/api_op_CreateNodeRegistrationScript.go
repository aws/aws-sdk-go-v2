...
func (c *Client) addOperationCreateNodeRegistrationScriptMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateNodeRegistrationScript", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
