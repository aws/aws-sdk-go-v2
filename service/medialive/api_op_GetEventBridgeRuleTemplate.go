...
func (c *Client) addOperationGetEventBridgeRuleTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetEventBridgeRuleTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
