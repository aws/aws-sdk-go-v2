...
// MediaLive. See this package's package overview docs
...
const (
	ServiceName = "MediaLive" // Service's name
	ServiceID   = "MediaLive" // Service's identifier
	EndpointsID = "medialive" // Service's Endpoint identifier
)
