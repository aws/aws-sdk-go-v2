...
func (c *Client) BatchStop(ctx context.Context, params *BatchStopInput, optFns ...func(*Options)) (*BatchStopOutput, error) {
	if params == nil { params = &BatchStopInput{} }
...
func (c *Client) addOperationBatchStopMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchStopResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchStopResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchStopResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchStopResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchStopResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchStopResolveEndpointMiddleware{
