...
func (*DeleteMultiplexProgramInput) operationName() string {
...
func (c *Client) addOperationDeleteMultiplexProgramMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteMultiplexProgramResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteMultiplexProgramResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteMultiplexProgramResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteMultiplexProgramResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteMultiplexProgramResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteMultiplexProgramResolveEndpointMiddleware{
