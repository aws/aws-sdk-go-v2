...
func (*UpdateMultiplexProgramInput) operationName() string {
...
func (c *Client) addOperationUpdateMultiplexProgramMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateMultiplexProgramResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateMultiplexProgramResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateMultiplexProgramResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateMultiplexProgramResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateMultiplexProgramResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateMultiplexProgramResolveEndpointMiddleware{
