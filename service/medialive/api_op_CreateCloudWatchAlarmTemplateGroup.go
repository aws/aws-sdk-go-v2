...
func (c *Client) addOperationCreateCloudWatchAlarmTemplateGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCloudWatchAlarmTemplateGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
