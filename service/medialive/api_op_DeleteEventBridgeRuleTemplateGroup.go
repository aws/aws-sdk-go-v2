...
func (c *Client) addOperationDeleteEventBridgeRuleTemplateGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteEventBridgeRuleTemplateGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
