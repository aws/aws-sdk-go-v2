...
func (c *Client) addOperationListChannelPlacementGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListChannelPlacementGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
