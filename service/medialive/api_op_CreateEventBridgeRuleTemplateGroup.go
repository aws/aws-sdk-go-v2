...
func (c *Client) addOperationCreateEventBridgeRuleTemplateGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateEventBridgeRuleTemplateGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
