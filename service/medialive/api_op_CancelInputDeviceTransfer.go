...
func (c *Client) CancelInputDeviceTransfer(ctx context.Context, params *CancelInputDeviceTransferInput, optFns ...func(*Options)) (*CancelInputDeviceTransferOutput, error) {
	if params == nil { params = &CancelInputDeviceTransferInput{} }
...
func (c *Client) addOperationCancelInputDeviceTransferMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelInputDeviceTransferResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelInputDeviceTransferResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelInputDeviceTransferResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelInputDeviceTransferResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelInputDeviceTransferResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelInputDeviceTransferResolveEndpointMiddleware{
