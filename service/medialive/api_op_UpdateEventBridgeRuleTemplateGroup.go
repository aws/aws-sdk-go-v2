...
func (c *Client) addOperationUpdateEventBridgeRuleTemplateGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateEventBridgeRuleTemplateGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
