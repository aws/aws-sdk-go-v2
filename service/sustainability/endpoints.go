...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/sustainability/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_SUSTAINABILITY")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Sustainability", cfg.ConfigSources)
	if found && err == nil {
...
var bddNodes = [27]int32{
	-1, 1, -1, 0, 9, 3, 1, 4, 100000008, 2, 5, 100000008, 3, 8, 6, 4, 100000003, 7, 5, 100000004, 100000007, 5, 100000005, 100000006, 3, 100000001, 100000002}
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 3:
		uriString := func() string {
			...
			out.WriteString("https://api.sustainability.")
	...
	case 4:
		uriString := func() string {
			var out strings.Builder
			out.WriteString("https://sustainability.us-gov.")
			out.WriteString(c.PartitionResult.DualStackDnsSuffix)
			return out.String()
		}()
		uri, err := url.Parse(uriString)
	...
	case 5:
		uriString := func() string {
			var out strings.Builder
			out.WriteString("https://sustainability-fips.us-gov.")
			out.WriteString(c.PartitionResult.DualStackDnsSuffix)
			return out.String()
		}()
		uri, err := url.Parse(uriString)
	...
	case 6:
		uriString := func() string {
			var out strings.Builder
			out.WriteString("https://sustainability-fips.global.")
			out.WriteString(c.PartitionResult.DualStackDnsSuffix)
			return out.String()
		}()
		uri, err := url.Parse(uriString)
	...
	case 7:
		uriString := func() string {
			var out strings.Builder
			out.WriteString("https://sustainability.global.")
			out.WriteString(c.PartitionResult.DualStackDnsSuffix)
			return out.String()
		}()
		uri, err := url.Parse(uriString)
