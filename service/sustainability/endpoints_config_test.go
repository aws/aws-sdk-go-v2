...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-sustainability.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sustainability.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sustainability.dev",
			expectURL:     aws.String("https://env-sustainability.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-sustainability.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sustainability.dev",
			expectURL:     aws.String("http://config-sustainability.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-sustainability.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-sustainability.dev",
			clientEndpoint: aws.String("https://client-sustainability.dev"),
			expectURL:      aws.String("https://client-sustainability.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SUSTAINABILITY", c.envService)
			}
