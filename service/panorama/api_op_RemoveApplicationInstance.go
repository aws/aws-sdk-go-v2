...
func (*RemoveApplicationInstanceInput) operationName() string {
...
func (c *Client) addOperationRemoveApplicationInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRemoveApplicationInstanceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRemoveApplicationInstanceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRemoveApplicationInstanceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRemoveApplicationInstanceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRemoveApplicationInstanceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRemoveApplicationInstanceResolveEndpointMiddleware{
