...
func (c *Client) ListApplicationInstanceNodeInstances(ctx context.Context, params *ListApplicationInstanceNodeInstancesInput, optFns ...func(*Options)) (*ListApplicationInstanceNodeInstancesOutput, error) {
	if params == nil { params = &ListApplicationInstanceNodeInstancesInput{} }
...
func (c *Client) addOperationListApplicationInstanceNodeInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListApplicationInstanceNodeInstancesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListApplicationInstanceNodeInstancesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListApplicationInstanceNodeInstancesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListApplicationInstanceNodeInstancesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListApplicationInstanceNodeInstancesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListApplicationInstanceNodeInstancesResolveEndpointMiddleware{
