...
func (c *Client) DeregisterPackageVersion(ctx context.Context, params *DeregisterPackageVersionInput, optFns ...func(*Options)) (*DeregisterPackageVersionOutput, error) {
	if params == nil { params = &DeregisterPackageVersionInput{} }
...
func (c *Client) addOperationDeregisterPackageVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeregisterPackageVersionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeregisterPackageVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeregisterPackageVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeregisterPackageVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeregisterPackageVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeregisterPackageVersionResolveEndpointMiddleware{
