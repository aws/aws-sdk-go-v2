...
func (c *Client) ListPackageImportJobs(ctx context.Context, params *ListPackageImportJobsInput, optFns ...func(*Options)) (*ListPackageImportJobsOutput, error) {
	if params == nil { params = &ListPackageImportJobsInput{} }
...
func (c *Client) addOperationListPackageImportJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPackageImportJobsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPackageImportJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPackageImportJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPackageImportJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPackageImportJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPackageImportJobsResolveEndpointMiddleware{
