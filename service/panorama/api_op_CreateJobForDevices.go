...
func (c *Client) CreateJobForDevices(ctx context.Context, params *CreateJobForDevicesInput, optFns ...func(*Options)) (*CreateJobForDevicesOutput, error) {
	if params == nil { params = &CreateJobForDevicesInput{} }
...
func (c *Client) addOperationCreateJobForDevicesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateJobForDevicesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateJobForDevicesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateJobForDevicesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateJobForDevicesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateJobForDevicesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateJobForDevicesResolveEndpointMiddleware{
