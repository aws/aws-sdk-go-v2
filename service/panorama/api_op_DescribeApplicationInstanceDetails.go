...
func (*DescribeApplicationInstanceDetailsInput) operationName() string {
...
func (c *Client) addOperationDescribeApplicationInstanceDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeApplicationInstanceDetailsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeApplicationInstanceDetailsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeApplicationInstanceDetailsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeApplicationInstanceDetailsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeApplicationInstanceDetailsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeApplicationInstanceDetailsResolveEndpointMiddleware{
