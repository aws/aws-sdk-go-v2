...
func (c *Client) addOperationListNodesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListNodesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListNodesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListNodesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListNodesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListNodesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListNodesResolveEndpointMiddleware{
