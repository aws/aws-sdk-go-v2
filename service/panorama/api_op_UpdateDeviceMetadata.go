...
func (c *Client) UpdateDeviceMetadata(ctx context.Context, params *UpdateDeviceMetadataInput, optFns ...func(*Options)) (*UpdateDeviceMetadataOutput, error) {
	if params == nil { params = &UpdateDeviceMetadataInput{} }
...
func (c *Client) addOperationUpdateDeviceMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateDeviceMetadataResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateDeviceMetadataResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateDeviceMetadataResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateDeviceMetadataResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateDeviceMetadataResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateDeviceMetadataResolveEndpointMiddleware{
