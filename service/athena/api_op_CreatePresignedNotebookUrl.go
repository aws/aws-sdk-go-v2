...
func (c *Client) addOperationCreatePresignedNotebookUrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreatePresignedNotebookUrl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
