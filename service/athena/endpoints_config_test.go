...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-athena.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-athena.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-athena.dev",
			expectURL:     aws.String("https://env-athena.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-athena.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-athena.dev",
			expectURL:     aws.String("http://config-athena.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-athena.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-athena.dev",
			clientEndpoint: aws.String("https://client-athena.dev"),
			expectURL:      aws.String("https://client-athena.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ATHENA", c.envService)
			}
