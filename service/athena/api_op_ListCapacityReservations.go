...
func (c *Client) addOperationListCapacityReservationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCapacityReservations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
