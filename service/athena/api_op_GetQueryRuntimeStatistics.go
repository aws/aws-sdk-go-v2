...
// execution runtime statistics are returned only when QueryExecutionStatus$Stateis in a SUCCEEDED or FAILED
// state. Stage-level input and output row count and data size statistics are not
