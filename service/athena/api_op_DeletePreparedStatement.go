...
func (c *Client) addOperationDeletePreparedStatementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeletePreparedStatement", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
