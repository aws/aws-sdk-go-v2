...
func (c *Client) addOperationGetPreparedStatementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPreparedStatementResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetPreparedStatementResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetPreparedStatementResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPreparedStatementResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPreparedStatementResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetPreparedStatementResolveEndpointMiddleware{
