...
func (c *Client) ListDataCatalogs(ctx context.Context, params *ListDataCatalogsInput, optFns ...func(*Options)) (*ListDataCatalogsOutput, error) {
	if params == nil { params = &ListDataCatalogsInput{} }
...
func (c *Client) addOperationListDataCatalogsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDataCatalogsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDataCatalogsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDataCatalogsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDataCatalogsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDataCatalogsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDataCatalogsResolveEndpointMiddleware{
