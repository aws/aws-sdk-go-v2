...
// access to the workgroup. For code samples using the Amazon Web Services SDK for
// Java, see Examples and Code Samples (http://docs.aws.amazon.com/athena/latest/ug/code-samples.html)
