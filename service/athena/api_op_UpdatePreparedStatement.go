...
func (*UpdatePreparedStatementInput) operationName() string {
...
func (c *Client) addOperationUpdatePreparedStatementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdatePreparedStatementResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdatePreparedStatementResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdatePreparedStatementResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdatePreparedStatementResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdatePreparedStatementResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdatePreparedStatementResolveEndpointMiddleware{
