...
func (c *Client) addOperationGetCalculationExecutionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCalculationExecutionStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
