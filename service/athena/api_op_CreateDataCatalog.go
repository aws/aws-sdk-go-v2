...
type CreateDataCatalogInput struct {
	...
	// Services account to which the Glue Data Catalog belongs. catalog-id=catalog_id
	// -
	...
	// - In Regions where Athena
	// engine version 2 is not available, creating new Glue data catalogs results in an
	// INVALID_INPUT error.
