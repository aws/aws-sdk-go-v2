...
func (*DeleteCapacityReservationInput) operationName() string {
...
func (c *Client) addOperationDeleteCapacityReservationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCapacityReservationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteCapacityReservationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteCapacityReservationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCapacityReservationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCapacityReservationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteCapacityReservationResolveEndpointMiddleware{
