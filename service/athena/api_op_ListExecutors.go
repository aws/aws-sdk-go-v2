...
func (c *Client) ListExecutors(ctx context.Context, params *ListExecutorsInput, optFns ...func(*Options)) (*ListExecutorsOutput, error) {
	if params == nil { params = &ListExecutorsInput{} }
...
func (c *Client) addOperationListExecutorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListExecutorsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListExecutorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListExecutorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListExecutorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListExecutorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListExecutorsResolveEndpointMiddleware{
