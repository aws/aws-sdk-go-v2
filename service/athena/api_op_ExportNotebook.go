...
func (c *Client) ExportNotebook(ctx context.Context, params *ExportNotebookInput, optFns ...func(*Options)) (*ExportNotebookOutput, error) {
	if params == nil { params = &ExportNotebookInput{} }
...
func (c *Client) addOperationExportNotebookMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addExportNotebookResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opExportNotebookResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opExportNotebookResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opExportNotebookResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addExportNotebookResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opExportNotebookResolveEndpointMiddleware{
