...
func (c *Client) PutCapacityAssignmentConfiguration(ctx context.Context, params *PutCapacityAssignmentConfigurationInput, optFns ...func(*Options)) (*PutCapacityAssignmentConfigurationOutput, error) {
	if params == nil { params = &PutCapacityAssignmentConfigurationInput{} }
...
func (c *Client) addOperationPutCapacityAssignmentConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutCapacityAssignmentConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutCapacityAssignmentConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutCapacityAssignmentConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutCapacityAssignmentConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutCapacityAssignmentConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutCapacityAssignmentConfigurationResolveEndpointMiddleware{
