...
func (c *Client) addOperationStartCalculationExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartCalculationExecution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
