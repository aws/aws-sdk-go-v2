...
func (c *Client) addOperationCreateCapacityReservationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCapacityReservation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
