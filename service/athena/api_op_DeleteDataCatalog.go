...
func (*DeleteDataCatalogInput) operationName() string {
...
func (c *Client) addOperationDeleteDataCatalogMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteDataCatalogResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteDataCatalogResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteDataCatalogResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteDataCatalogResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteDataCatalogResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteDataCatalogResolveEndpointMiddleware{
