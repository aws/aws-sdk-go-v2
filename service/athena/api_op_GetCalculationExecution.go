...
func (c *Client) addOperationGetCalculationExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCalculationExecution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
