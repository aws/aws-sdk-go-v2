...
func (c *Client) addOperationGetCalculationExecutionCodeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCalculationExecutionCode", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
