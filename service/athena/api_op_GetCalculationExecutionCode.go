...
func (c *Client) GetCalculationExecutionCode(ctx context.Context, params *GetCalculationExecutionCodeInput, optFns ...func(*Options)) (*GetCalculationExecutionCodeOutput, error) {
	if params == nil { params = &GetCalculationExecutionCodeInput{} }
...
func (c *Client) addOperationGetCalculationExecutionCodeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCalculationExecutionCodeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCalculationExecutionCodeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCalculationExecutionCodeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCalculationExecutionCodeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCalculationExecutionCodeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCalculationExecutionCodeResolveEndpointMiddleware{
