...
func (c *Client) addOperationListApplicationDPUSizesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListApplicationDPUSizes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
