...
func (*DeleteNotebookInput) operationName() string {
...
func (c *Client) addOperationDeleteNotebookMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteNotebookResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteNotebookResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteNotebookResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteNotebookResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteNotebookResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteNotebookResolveEndpointMiddleware{
