...
func (c *Client) GetPricingPlan(ctx context.Context, params *GetPricingPlanInput, optFns ...func(*Options)) (*GetPricingPlanOutput, error) {
	if params == nil { params = &GetPricingPlanInput{} }
...
func (c *Client) addOperationGetPricingPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPricingPlanResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPricingPlanResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPricingPlanResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPricingPlanResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addGetPricingPlanResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPricingPlanResolveEndpointMiddleware{
