...
func (v *ConnectorFailureException) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ConnectorFailureException)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ConnectorFailureException) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Message != nil {
		s.WriteString(schemas.ConnectorFailureException_message, *v.Message)
	}
}
func (v *ConnectorFailureException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ConnectorFailureException, func(s *smithy.Schema) error {
		switch s {
		case schemas.ConnectorFailureException_message:
			v.Message = new(string)
			return d.ReadString(schemas.ConnectorFailureException_message, v.Message)
		}
		return nil
	})
}
...
func (v *ConnectorTimeoutException) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ConnectorTimeoutException)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ConnectorTimeoutException) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Message != nil {
		s.WriteString(schemas.ConnectorTimeoutException_message, *v.Message)
	}
}
func (v *ConnectorTimeoutException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ConnectorTimeoutException, func(s *smithy.Schema) error {
		switch s {
		case schemas.ConnectorTimeoutException_message:
			v.Message = new(string)
			return d.ReadString(schemas.ConnectorTimeoutException_message, v.Message)
		}
		return nil
	})
}
...
func (v *QueryTimeoutException) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.QueryTimeoutException)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *QueryTimeoutException) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Message != nil {
		s.WriteString(schemas.QueryTimeoutException_message, *v.Message)
	}
}
