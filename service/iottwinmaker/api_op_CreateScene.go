...
func (c *Client) CreateScene(ctx context.Context, params *CreateSceneInput, optFns ...func(*Options)) (*CreateSceneOutput, error) {
	if params == nil { params = &CreateSceneInput{} }
...
func (c *Client) addOperationCreateSceneMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateSceneResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateSceneResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateSceneResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateSceneResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addCreateSceneResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateSceneResolveEndpointMiddleware{
