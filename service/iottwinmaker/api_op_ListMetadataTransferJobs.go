...
func (c *Client) addOperationListMetadataTransferJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMetadataTransferJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
