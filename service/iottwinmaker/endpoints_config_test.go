...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iottwinmaker.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iottwinmaker.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iottwinmaker.dev",
			expectURL:     aws.String("https://env-iottwinmaker.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iottwinmaker.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iottwinmaker.dev",
			expectURL:     aws.String("http://config-iottwinmaker.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iottwinmaker.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iottwinmaker.dev",
			clientEndpoint: aws.String("https://client-iottwinmaker.dev"),
			expectURL:      aws.String("https://client-iottwinmaker.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IOTTWINMAKER", c.envService)
			}
