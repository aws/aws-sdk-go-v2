...
func (c *Client) ListScenes(ctx context.Context, params *ListScenesInput, optFns ...func(*Options)) (*ListScenesOutput, error) {
	if params == nil { params = &ListScenesInput{} }
...
func (c *Client) addOperationListScenesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListScenesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListScenesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListScenesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListScenesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListScenesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListScenesResolveEndpointMiddleware{
