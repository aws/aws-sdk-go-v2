...
func (c *Client) addOperationRegisterSlackWorkspaceForOrganizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterSlackWorkspaceForOrganization", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
