...
func (c *Client) addOperationListSlackChannelConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSlackChannelConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
