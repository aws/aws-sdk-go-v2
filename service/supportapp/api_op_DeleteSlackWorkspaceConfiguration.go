...
func (c *Client) DeleteSlackWorkspaceConfiguration(ctx context.Context, params *DeleteSlackWorkspaceConfigurationInput, optFns ...func(*Options)) (*DeleteSlackWorkspaceConfigurationOutput, error) {
	if params == nil { params = &DeleteSlackWorkspaceConfigurationInput{} }
...
func (c *Client) addOperationDeleteSlackWorkspaceConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteSlackWorkspaceConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteSlackWorkspaceConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteSlackWorkspaceConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteSlackWorkspaceConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteSlackWorkspaceConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteSlackWorkspaceConfigurationResolveEndpointMiddleware{
