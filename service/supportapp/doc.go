...
// - Create, search, update, and resolve your
// support cases
// - Request service quota increases for your account
// - Invite Amazon
// Web Services Support agents to your channel so that you can chat directly about
// your support cases
//
// For more information about how to perform these actions in
// Slack, see the following documentation in the Amazon Web Services Support User
// Guide:
...
//
// You
// can also use the Amazon Web Services Management Console instead of the Amazon
// Web Services Support App API to manage your Slack configurations. For more
// information, see Authorize a Slack workspace to enable the Amazon Web Services
// Support App
...
// - For more information about the Amazon Web Services
// Support App endpoints, see the Amazon Web Services Support App in Slack
// endpoints
