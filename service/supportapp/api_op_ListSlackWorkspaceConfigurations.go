...
func (c *Client) addOperationListSlackWorkspaceConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSlackWorkspaceConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
