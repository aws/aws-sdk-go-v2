...
func (c *Client) addOperationCreateSlackChannelConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateSlackChannelConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
