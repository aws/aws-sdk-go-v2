...
func (c *Client) PutAccountAlias(ctx context.Context, params *PutAccountAliasInput, optFns ...func(*Options)) (*PutAccountAliasOutput, error) {
	if params == nil { params = &PutAccountAliasInput{} }
...
func (c *Client) addOperationPutAccountAliasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutAccountAliasResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutAccountAliasResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutAccountAliasResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutAccountAliasResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutAccountAliasResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutAccountAliasResolveEndpointMiddleware{
