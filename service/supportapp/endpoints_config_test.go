...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-support-app.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-support-app.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-support-app.dev",
			expectURL:     aws.String("https://env-support-app.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-support-app.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-support-app.dev",
			expectURL:     aws.String("http://config-support-app.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-support-app.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-support-app.dev",
			clientEndpoint: aws.String("https://client-support-app.dev"),
			expectURL:      aws.String("https://client-support-app.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SUPPORT_APP", c.envService)
			}
