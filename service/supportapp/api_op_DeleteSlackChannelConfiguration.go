...
func (v *DeleteSlackChannelConfigurationInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ChannelId != nil {
		s.WriteString(schemas.DeleteSlackChannelConfigurationRequest_channelId, *v.ChannelId)
	}
	if v.TeamId != nil {
		s.WriteString(schemas.DeleteSlackChannelConfigurationRequest_teamId, *v.TeamId)
	}
}
func (v *DeleteSlackChannelConfigurationInput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.DeleteSlackChannelConfigurationRequest, func(s *smithy.Schema) error {
		switch s {
		case schemas.DeleteSlackChannelConfigurationRequest_channelId:
			v.ChannelId = new(string)
			return d.ReadString(schemas.DeleteSlackChannelConfigurationRequest_channelId, v.ChannelId)
		case schemas.DeleteSlackChannelConfigurationRequest_teamId:
			v.TeamId = new(string)
			return d.ReadString(schemas.DeleteSlackChannelConfigurationRequest_teamId, v.TeamId)
		}
		return nil
	})
}
...
func (v *DeleteSlackChannelConfigurationOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DeleteSlackChannelConfigurationResult)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DeleteSlackChannelConfigurationOutput) SerializeMembers(s smithy.ShapeSerializer) {
}
