...
func (*DeleteSlackChannelConfigurationInput) operationName() string {
...
func (c *Client) addOperationDeleteSlackChannelConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteSlackChannelConfigurationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteSlackChannelConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteSlackChannelConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteSlackChannelConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteSlackChannelConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteSlackChannelConfigurationResolveEndpointMiddleware{
