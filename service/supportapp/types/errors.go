...
// try the following:
// - Add, update, or delete a Slack channel configuration before
// you add a Slack workspace to your Amazon Web Services account.
// - Add a Slack
// channel configuration that already exists in your Amazon Web Services account.
// -
// Delete a Slack channel configuration for a live chat channel.
// - Delete a Slack
// workspace from your Amazon Web Services account that has an active live chat
// channel.
...
// - Call the
// RegisterSlackWorkspaceForOrganization API from a member account, but the
...
// Service Quotas request to Amazon Web Services Support App might exceed the
