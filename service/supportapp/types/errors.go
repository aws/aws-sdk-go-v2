...
// try the following:
//
// * Add, update, or delete a Slack channel configuration
// before you add a Slack workspace to your Amazon Web Services account.
//
// * Add a
// Slack channel configuration that already exists in your Amazon Web Services
// account.
//
