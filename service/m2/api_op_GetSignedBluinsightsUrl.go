...
func (c *Client) GetSignedBluinsightsUrl(ctx context.Context, params *GetSignedBluinsightsUrlInput, optFns ...func(*Options)) (*GetSignedBluinsightsUrlOutput, error) {
	if params == nil { params = &GetSignedBluinsightsUrlInput{} }
...
func (c *Client) addOperationGetSignedBluinsightsUrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSignedBluinsightsUrlResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSignedBluinsightsUrlResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSignedBluinsightsUrlResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSignedBluinsightsUrlResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSignedBluinsightsUrlResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSignedBluinsightsUrlResolveEndpointMiddleware{
