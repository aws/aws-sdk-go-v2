...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/m2/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "m2", cfg.ConfigSources)
	if found && err == nil {
