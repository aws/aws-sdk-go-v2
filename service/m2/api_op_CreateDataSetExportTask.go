...
func (c *Client) addOperationCreateDataSetExportTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateDataSetExportTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
