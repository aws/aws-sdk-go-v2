...
func (c *Client) addOperationListDataSetImportHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDataSetImportHistory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
