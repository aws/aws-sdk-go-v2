...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/agentregistry/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_AGENT_REGISTRY")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Agent Registry", cfg.ConfigSources)
	if found && err == nil {
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 2:
		uriString := func() string {
			...
			out.WriteString("https://agent-registry.")
	...
	case 3:
		return smithyendpoints.Endpoint{}, fmt.Errorf("endpoint rule error, %s", "Unable to resolve an Agent Registry endpoint: Region was not set and no explicit Endpoint override was provided.")
	}
