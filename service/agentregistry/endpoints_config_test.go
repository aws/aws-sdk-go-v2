...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-agent-registry.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-agent-registry.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-agent-registry.dev",
			expectURL:     aws.String("https://env-agent-registry.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-agent-registry.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-agent-registry.dev",
			expectURL:     aws.String("http://config-agent-registry.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-agent-registry.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-agent-registry.dev",
			clientEndpoint: aws.String("https://client-agent-registry.dev"),
			expectURL:      aws.String("https://client-agent-registry.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_AGENT_REGISTRY", c.envService)
			}
