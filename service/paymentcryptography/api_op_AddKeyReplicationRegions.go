...
func (c *Client) addOperationAddKeyReplicationRegionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AddKeyReplicationRegions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
