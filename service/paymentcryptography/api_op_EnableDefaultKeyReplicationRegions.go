...
func (c *Client) addOperationEnableDefaultKeyReplicationRegionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableDefaultKeyReplicationRegions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
