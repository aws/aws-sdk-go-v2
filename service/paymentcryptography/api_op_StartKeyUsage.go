...
func (c *Client) StartKeyUsage(ctx context.Context, params *StartKeyUsageInput, optFns ...func(*Options)) (*StartKeyUsageOutput, error) {
	if params == nil { params = &StartKeyUsageInput{} }
...
func (c *Client) addOperationStartKeyUsageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartKeyUsageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartKeyUsageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartKeyUsageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartKeyUsageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartKeyUsageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartKeyUsageResolveEndpointMiddleware{
