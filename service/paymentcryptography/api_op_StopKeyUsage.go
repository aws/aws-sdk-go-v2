...
func (c *Client) StopKeyUsage(ctx context.Context, params *StopKeyUsageInput, optFns ...func(*Options)) (*StopKeyUsageOutput, error) {
	if params == nil { params = &StopKeyUsageInput{} }
...
func (c *Client) addOperationStopKeyUsageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopKeyUsageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopKeyUsageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopKeyUsageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopKeyUsageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopKeyUsageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopKeyUsageResolveEndpointMiddleware{
