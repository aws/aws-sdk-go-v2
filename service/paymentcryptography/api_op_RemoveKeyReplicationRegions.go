...
func (c *Client) addOperationRemoveKeyReplicationRegionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RemoveKeyReplicationRegions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
