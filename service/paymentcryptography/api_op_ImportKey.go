...
// KRD wrapping certificate expires after 7 days. Next the KDH generates a key pair
// for the purpose of signing the encrypted KDH key and provides the public
// certificate of the signing key to Amazon Web Services Payment Cryptography. The
// KDH will also need to import the root certificate chain of the KDH signing
// certificate by calling ImportKey for RootCertificatePublicKey . For more
// information on TR-34 key import, see section Importing symmetric keys (https://docs.aws.amazon.com/payment-cryptography/latest/userguide/keys-import.html)
...
// key exchange method. To initiate import, call GetParametersForImport (https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_GetParametersForImport.html)
...
// KRD wrapping certificate expires after 7 days. You must trust and install the
// wrapping certificate and its certificate chain on the sending HSM and use it to
// wrap the key under export for WrappedKeyCryptogram generation. Next call
// ImportKey with KeyMaterial set to KEY_CRYPTOGRAM and provide the ImportToken
// and KeyAttributes for the key under import. To import working keys using TR-31
...
// Payment Cryptography by using TR-34 key import or by using CreateKey (https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_CreateKey.html)
