...
func (c *Client) addOperationGetDefaultKeyReplicationRegionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDefaultKeyReplicationRegions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
