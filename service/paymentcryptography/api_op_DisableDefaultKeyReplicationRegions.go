...
func (c *Client) addOperationDisableDefaultKeyReplicationRegionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisableDefaultKeyReplicationRegions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
