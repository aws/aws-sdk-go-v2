...
func (c *Client) addOperationGetPublicKeyCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPublicKeyCertificate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
