...
func (c *Client) addOperationGetCertificateSigningRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCertificateSigningRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
