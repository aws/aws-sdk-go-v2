...
func (c *Client) ListPricingPlans(ctx context.Context, params *ListPricingPlansInput, optFns ...func(*Options)) (*ListPricingPlansOutput, error) {
	if params == nil { params = &ListPricingPlansInput{} }
...
func (c *Client) addOperationListPricingPlansMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPricingPlansResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPricingPlansResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPricingPlansResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPricingPlansResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPricingPlansResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPricingPlansResolveEndpointMiddleware{
