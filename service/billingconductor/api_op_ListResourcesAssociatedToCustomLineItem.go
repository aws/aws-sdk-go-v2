...
func (c *Client) ListResourcesAssociatedToCustomLineItem(ctx context.Context, params *ListResourcesAssociatedToCustomLineItemInput, optFns ...func(*Options)) (*ListResourcesAssociatedToCustomLineItemOutput, error) {
	if params == nil { params = &ListResourcesAssociatedToCustomLineItemInput{} }
...
func (c *Client) addOperationListResourcesAssociatedToCustomLineItemMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListResourcesAssociatedToCustomLineItemResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListResourcesAssociatedToCustomLineItemResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListResourcesAssociatedToCustomLineItemResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListResourcesAssociatedToCustomLineItemResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListResourcesAssociatedToCustomLineItemResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListResourcesAssociatedToCustomLineItemResolveEndpointMiddleware{
