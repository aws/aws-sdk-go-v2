...
func (c *Client) addOperationBatchDisassociateResourcesFromCustomLineItemMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDisassociateResourcesFromCustomLineItem", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
