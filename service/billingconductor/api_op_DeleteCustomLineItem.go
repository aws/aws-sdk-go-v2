...
func (c *Client) DeleteCustomLineItem(ctx context.Context, params *DeleteCustomLineItemInput, optFns ...func(*Options)) (*DeleteCustomLineItemOutput, error) {
	if params == nil { params = &DeleteCustomLineItemInput{} }
...
func (c *Client) addOperationDeleteCustomLineItemMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCustomLineItemResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteCustomLineItemResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteCustomLineItemResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCustomLineItemResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCustomLineItemResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteCustomLineItemResolveEndpointMiddleware{
