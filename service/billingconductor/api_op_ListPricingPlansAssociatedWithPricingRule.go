...
func (*ListPricingPlansAssociatedWithPricingRuleInput) operationName() string {
...
func (c *Client) addOperationListPricingPlansAssociatedWithPricingRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPricingPlansAssociatedWithPricingRuleResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListPricingPlansAssociatedWithPricingRuleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListPricingPlansAssociatedWithPricingRuleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPricingPlansAssociatedWithPricingRuleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPricingPlansAssociatedWithPricingRuleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListPricingPlansAssociatedWithPricingRuleResolveEndpointMiddleware{
