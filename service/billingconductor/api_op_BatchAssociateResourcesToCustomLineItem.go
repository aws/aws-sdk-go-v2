...
func (c *Client) addOperationBatchAssociateResourcesToCustomLineItemMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchAssociateResourcesToCustomLineItem", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
