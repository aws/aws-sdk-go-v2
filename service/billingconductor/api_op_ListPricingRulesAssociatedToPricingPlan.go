...
func (c *Client) ListPricingRulesAssociatedToPricingPlan(ctx context.Context, params *ListPricingRulesAssociatedToPricingPlanInput, optFns ...func(*Options)) (*ListPricingRulesAssociatedToPricingPlanOutput, error) {
	if params == nil { params = &ListPricingRulesAssociatedToPricingPlanInput{} }
...
func (c *Client) addOperationListPricingRulesAssociatedToPricingPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPricingRulesAssociatedToPricingPlanResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPricingRulesAssociatedToPricingPlanResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPricingRulesAssociatedToPricingPlanResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPricingRulesAssociatedToPricingPlanResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPricingRulesAssociatedToPricingPlanResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPricingRulesAssociatedToPricingPlanResolveEndpointMiddleware{
