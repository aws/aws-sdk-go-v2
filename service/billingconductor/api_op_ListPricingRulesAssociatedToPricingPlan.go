...
func (c *Client) addOperationListPricingRulesAssociatedToPricingPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPricingRulesAssociatedToPricingPlan", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
