...
func (c *Client) ListCustomLineItems(ctx context.Context, params *ListCustomLineItemsInput, optFns ...func(*Options)) (*ListCustomLineItemsOutput, error) {
	if params == nil { params = &ListCustomLineItemsInput{} }
...
func (c *Client) addOperationListCustomLineItemsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCustomLineItemsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCustomLineItemsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCustomLineItemsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCustomLineItemsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCustomLineItemsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCustomLineItemsResolveEndpointMiddleware{
