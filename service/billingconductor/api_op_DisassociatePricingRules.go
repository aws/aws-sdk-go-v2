...
func (c *Client) DisassociatePricingRules(ctx context.Context, params *DisassociatePricingRulesInput, optFns ...func(*Options)) (*DisassociatePricingRulesOutput, error) {
	if params == nil { params = &DisassociatePricingRulesInput{} }
...
func (c *Client) addOperationDisassociatePricingRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociatePricingRulesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociatePricingRulesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociatePricingRulesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociatePricingRulesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociatePricingRulesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociatePricingRulesResolveEndpointMiddleware{
