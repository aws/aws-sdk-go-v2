...
func (c *Client) addOperationDisassociatePricingRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociatePricingRules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
