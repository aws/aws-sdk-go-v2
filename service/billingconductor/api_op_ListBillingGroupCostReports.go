...
func (c *Client) addOperationListBillingGroupCostReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListBillingGroupCostReports", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
