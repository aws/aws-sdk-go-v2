...
func (*ListBillingGroupCostReportsInput) operationName() string {
...
func (c *Client) addOperationListBillingGroupCostReportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBillingGroupCostReportsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListBillingGroupCostReportsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListBillingGroupCostReportsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBillingGroupCostReportsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListBillingGroupCostReportsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListBillingGroupCostReportsResolveEndpointMiddleware{
