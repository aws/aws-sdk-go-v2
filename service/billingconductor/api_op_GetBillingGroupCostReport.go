...
func (c *Client) addOperationGetBillingGroupCostReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetBillingGroupCostReport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
