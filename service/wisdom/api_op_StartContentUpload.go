...
func (c *Client) StartContentUpload(ctx context.Context, params *StartContentUploadInput, optFns ...func(*Options)) (*StartContentUploadOutput, error) {
	if params == nil { params = &StartContentUploadInput{} }
...
func (c *Client) addOperationStartContentUploadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartContentUploadResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartContentUploadResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartContentUploadResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartContentUploadResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartContentUploadResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartContentUploadResolveEndpointMiddleware{
