...
func (*GetAssistantAssociationInput) operationName() string {
...
func (c *Client) addOperationGetAssistantAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAssistantAssociationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetAssistantAssociationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetAssistantAssociationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAssistantAssociationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAssistantAssociationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetAssistantAssociationResolveEndpointMiddleware{
