...
func (c *Client) addOperationNotifyRecommendationsReceivedMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addNotifyRecommendationsReceivedResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opNotifyRecommendationsReceivedResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opNotifyRecommendationsReceivedResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opNotifyRecommendationsReceivedResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addNotifyRecommendationsReceivedResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opNotifyRecommendationsReceivedResolveEndpointMiddleware{
