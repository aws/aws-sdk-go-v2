...
func (c *Client) GetKnowledgeBase(ctx context.Context, params *GetKnowledgeBaseInput, optFns ...func(*Options)) (*GetKnowledgeBaseOutput, error) {
	if params == nil { params = &GetKnowledgeBaseInput{} }
...
func (c *Client) addOperationGetKnowledgeBaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetKnowledgeBaseResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetKnowledgeBaseResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetKnowledgeBaseResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetKnowledgeBaseResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetKnowledgeBaseResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetKnowledgeBaseResolveEndpointMiddleware{
