...
func (c *Client) RemoveKnowledgeBaseTemplateUri(ctx context.Context, params *RemoveKnowledgeBaseTemplateUriInput, optFns ...func(*Options)) (*RemoveKnowledgeBaseTemplateUriOutput, error) {
	if params == nil { params = &RemoveKnowledgeBaseTemplateUriInput{} }
...
func (c *Client) addOperationRemoveKnowledgeBaseTemplateUriMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRemoveKnowledgeBaseTemplateUriResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRemoveKnowledgeBaseTemplateUriResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRemoveKnowledgeBaseTemplateUriResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRemoveKnowledgeBaseTemplateUriResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRemoveKnowledgeBaseTemplateUriResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRemoveKnowledgeBaseTemplateUriResolveEndpointMiddleware{
