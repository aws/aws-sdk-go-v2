...
func (c *Client) addOperationListKnowledgeBasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListKnowledgeBasesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListKnowledgeBasesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListKnowledgeBasesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListKnowledgeBasesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListKnowledgeBasesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListKnowledgeBasesResolveEndpointMiddleware{
