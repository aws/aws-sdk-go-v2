...
func (c *Client) addOperationUpdateKnowledgeBaseTemplateUriMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateKnowledgeBaseTemplateUri", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
