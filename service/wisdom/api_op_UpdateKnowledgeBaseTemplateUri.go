...
func (c *Client) UpdateKnowledgeBaseTemplateUri(ctx context.Context, params *UpdateKnowledgeBaseTemplateUriInput, optFns ...func(*Options)) (*UpdateKnowledgeBaseTemplateUriOutput, error) {
	if params == nil { params = &UpdateKnowledgeBaseTemplateUriInput{} }
...
func (c *Client) addOperationUpdateKnowledgeBaseTemplateUriMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateKnowledgeBaseTemplateUriResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateKnowledgeBaseTemplateUriResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateKnowledgeBaseTemplateUriResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateKnowledgeBaseTemplateUriResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateKnowledgeBaseTemplateUriResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateKnowledgeBaseTemplateUriResolveEndpointMiddleware{
