...
func (c *Client) GetContent(ctx context.Context, params *GetContentInput, optFns ...func(*Options)) (*GetContentOutput, error) {
	if params == nil { params = &GetContentInput{} }
...
func (c *Client) addOperationGetContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetContentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetContentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetContentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetContentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetContentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetContentResolveEndpointMiddleware{
