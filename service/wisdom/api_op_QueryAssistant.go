...
func (c *Client) QueryAssistant(ctx context.Context, params *QueryAssistantInput, optFns ...func(*Options)) (*QueryAssistantOutput, error) {
	if params == nil { params = &QueryAssistantInput{} }
...
func (c *Client) addOperationQueryAssistantMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addQueryAssistantResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opQueryAssistantResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opQueryAssistantResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opQueryAssistantResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addQueryAssistantResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opQueryAssistantResolveEndpointMiddleware{
