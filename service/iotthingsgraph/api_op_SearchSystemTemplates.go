...
func (v *SearchSystemTemplatesOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.SearchSystemTemplatesResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *SearchSystemTemplatesOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.NextToken != nil {
		s.WriteString(schemas.SearchSystemTemplatesResponse_nextToken, *v.NextToken)
	}
	serializeSystemTemplateSummaries(s, schemas.SearchSystemTemplatesResponse_summaries, v.Summaries)
}
