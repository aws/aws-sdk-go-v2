...
func (*SearchSystemTemplatesInput) operationName() string {
...
func (c *Client) addOperationSearchSystemTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSearchSystemTemplatesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opSearchSystemTemplatesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opSearchSystemTemplatesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSearchSystemTemplatesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSearchSystemTemplatesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opSearchSystemTemplatesResolveEndpointMiddleware{
