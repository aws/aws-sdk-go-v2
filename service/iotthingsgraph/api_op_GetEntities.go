...
func (c *Client) GetEntities(ctx context.Context, params *GetEntitiesInput, optFns ...func(*Options)) (*GetEntitiesOutput, error) {
	if params == nil { params = &GetEntitiesInput{} }
...
func (c *Client) addOperationGetEntitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetEntitiesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetEntitiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetEntitiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetEntitiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetEntitiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetEntitiesResolveEndpointMiddleware{
