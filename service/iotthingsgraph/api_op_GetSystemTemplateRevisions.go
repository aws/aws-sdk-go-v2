...
func (c *Client) addOperationGetSystemTemplateRevisionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSystemTemplateRevisions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
