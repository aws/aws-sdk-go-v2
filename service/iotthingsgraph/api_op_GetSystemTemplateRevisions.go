...
func addOperationGetSystemTemplateRevisionsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetSystemTemplateRevisionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetSystemTemplateRevisionsStackSlots(stack); err != nil {
		return err
	}
