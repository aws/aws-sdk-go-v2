...
func addOperationGetNamespaceDeletionStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationGetNamespaceDeletionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetNamespaceDeletionStatusStackSlots(stack); err != nil {
		return err
	}
