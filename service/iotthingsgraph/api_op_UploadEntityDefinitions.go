...
func (c *Client) addOperationUploadEntityDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UploadEntityDefinitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
