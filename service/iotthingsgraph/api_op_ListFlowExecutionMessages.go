...
func (c *Client) ListFlowExecutionMessages(ctx context.Context, params *ListFlowExecutionMessagesInput, optFns ...func(*Options)) (*ListFlowExecutionMessagesOutput, error) {
	if params == nil { params = &ListFlowExecutionMessagesInput{} }
...
func (c *Client) addOperationListFlowExecutionMessagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFlowExecutionMessagesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListFlowExecutionMessagesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListFlowExecutionMessagesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFlowExecutionMessagesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFlowExecutionMessagesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListFlowExecutionMessagesResolveEndpointMiddleware{
