...
func (c *Client) addOperationDissociateEntityFromThingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DissociateEntityFromThing", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
