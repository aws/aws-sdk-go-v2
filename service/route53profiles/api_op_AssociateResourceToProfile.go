...
func (c *Client) addOperationAssociateResourceToProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateResourceToProfile", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
