...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-interconnect.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-interconnect.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-interconnect.dev",
			expectURL:     aws.String("https://env-interconnect.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-interconnect.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-interconnect.dev",
			expectURL:     aws.String("http://config-interconnect.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-interconnect.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-interconnect.dev",
			clientEndpoint: aws.String("https://client-interconnect.dev"),
			expectURL:      aws.String("https://client-interconnect.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_INTERCONNECT", c.envService)
			}
