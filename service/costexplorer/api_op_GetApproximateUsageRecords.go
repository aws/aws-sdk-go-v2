...
func (c *Client) addOperationGetApproximateUsageRecordsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetApproximateUsageRecords", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
