...
func (c *Client) GetAnomalies(ctx context.Context, params *GetAnomaliesInput, optFns ...func(*Options)) (*GetAnomaliesOutput, error) {
	if params == nil { params = &GetAnomaliesInput{} }
...
func (c *Client) addOperationGetAnomaliesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAnomaliesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAnomaliesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAnomaliesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAnomaliesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAnomaliesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAnomaliesResolveEndpointMiddleware{
