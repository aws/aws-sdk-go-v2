...
func (c *Client) addOperationListCostCategoryDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCostCategoryDefinitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
