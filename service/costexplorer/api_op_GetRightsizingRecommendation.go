...
func addOperationGetRightsizingRecommendationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetRightsizingRecommendationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetRightsizingRecommendationStackSlots(stack); err != nil {
		return err
	}
