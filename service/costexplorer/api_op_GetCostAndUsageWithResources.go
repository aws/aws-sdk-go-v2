...
func addOperationGetCostAndUsageWithResourcesStackSlots(stack *middleware.Stack) error {
...
func addOperationGetCostAndUsageWithResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetCostAndUsageWithResourcesStackSlots(stack); err != nil {
		return err
	}
