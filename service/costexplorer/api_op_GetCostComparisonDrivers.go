...
func (c *Client) addOperationGetCostComparisonDriversMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCostComparisonDrivers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
