...
func (c *Client) addOperationStartCostAllocationTagBackfillMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartCostAllocationTagBackfill", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
