...
func (c *Client) addOperationGetReservationUtilizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetReservationUtilization", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
