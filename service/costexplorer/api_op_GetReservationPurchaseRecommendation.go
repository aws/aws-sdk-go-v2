...
func addOperationGetReservationPurchaseRecommendationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetReservationPurchaseRecommendationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetReservationPurchaseRecommendationStackSlots(stack); err != nil {
		return err
	}
