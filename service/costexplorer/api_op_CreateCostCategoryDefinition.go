...
func addOperationCreateCostCategoryDefinitionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateCostCategoryDefinitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateCostCategoryDefinitionStackSlots(stack); err != nil {
		return err
	}
