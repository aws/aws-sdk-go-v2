...
func (c *Client) addOperationGetCostAndUsageComparisonsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCostAndUsageComparisons", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
