...
func (c *Client) GetSavingsPlansCoverage(ctx context.Context, params *GetSavingsPlansCoverageInput, optFns ...func(*Options)) (*GetSavingsPlansCoverageOutput, error) {
	if params == nil { params = &GetSavingsPlansCoverageInput{} }
...
func (c *Client) addOperationGetSavingsPlansCoverageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSavingsPlansCoverageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSavingsPlansCoverageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSavingsPlansCoverageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSavingsPlansCoverageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSavingsPlansCoverageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSavingsPlansCoverageResolveEndpointMiddleware{
