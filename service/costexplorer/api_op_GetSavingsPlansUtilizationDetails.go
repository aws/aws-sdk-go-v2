...
func addOperationGetSavingsPlansUtilizationDetailsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetSavingsPlansUtilizationDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetSavingsPlansUtilizationDetailsStackSlots(stack); err != nil {
		return err
	}
