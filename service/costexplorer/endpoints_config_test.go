...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cost-explorer.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cost-explorer.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cost-explorer.dev",
			expectURL:     aws.String("https://env-cost-explorer.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cost-explorer.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cost-explorer.dev",
			expectURL:     aws.String("http://config-cost-explorer.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cost-explorer.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cost-explorer.dev",
			clientEndpoint: aws.String("https://client-cost-explorer.dev"),
			expectURL:      aws.String("https://client-cost-explorer.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_COST_EXPLORER", c.envService)
			}
