...
func (c *Client) addOperationListCostAllocationTagBackfillHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCostAllocationTagBackfillHistory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
