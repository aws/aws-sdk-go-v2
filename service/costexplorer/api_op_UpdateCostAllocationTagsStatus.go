...
func (c *Client) addOperationUpdateCostAllocationTagsStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCostAllocationTagsStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
