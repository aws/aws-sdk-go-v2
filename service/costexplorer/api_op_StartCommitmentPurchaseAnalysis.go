...
func (c *Client) addOperationStartCommitmentPurchaseAnalysisMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartCommitmentPurchaseAnalysis", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
