...
// Using the Client
//
// To use AWS Cost Explorer with the SDK use the New function to create
...
//
// See the AWS Cost Explorer client for more information on
