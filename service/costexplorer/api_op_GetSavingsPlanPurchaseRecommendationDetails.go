...
func (c *Client) addOperationGetSavingsPlanPurchaseRecommendationDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSavingsPlanPurchaseRecommendationDetails", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
