...
var bddNodes = [63]int32{
	-1, 1, -1, 0, 20, 3, 1, 4, 100000018, 2, 5, 100000018, 3, 16, 6, 5, 12, 7, 6, 100000006, 8, 7, 100000007, 9, 8, 100000008, 10, 11, 100000009, 11, 12, 100000010, 100000017, 9, 100000004, 13, 10, 100000005, 14, 12, 100000010, 15, 13, 100000015, 100000016, 4, 18, 17, 5, 100000012, 100000014, 5, 19, 100000013, 13, 100000011, 100000012, 3, 100000001, 21, 5, 100000002, 100000003}
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 10:
		uriString := "https://ce.eusc-de-east-1.api.amazonwebservices.eu"
		uri, err := url.Parse(uriString)
		if err != nil {
			return smithyendpoints.Endpoint{}, fmt.Errorf("Failed to parse uri: %s", uriString)
		}
