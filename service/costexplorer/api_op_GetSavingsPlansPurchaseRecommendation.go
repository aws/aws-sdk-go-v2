...
func addOperationGetSavingsPlansPurchaseRecommendationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetSavingsPlansPurchaseRecommendationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetSavingsPlansPurchaseRecommendationStackSlots(stack); err != nil {
		return err
	}
