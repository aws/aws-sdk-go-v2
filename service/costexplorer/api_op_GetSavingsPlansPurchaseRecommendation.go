...
func (c *Client) addOperationGetSavingsPlansPurchaseRecommendationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSavingsPlansPurchaseRecommendation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
