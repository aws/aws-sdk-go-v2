...
type GetCostCategoriesInput struct {
	...
	// The value that you want to search the filter values for. If you don't specify
	// a CostCategoryName , SearchString is used to filter Cost Category names that
	// match the SearchString  pattern. If you specify a CostCategoryName ,
	...
	// DESCENDING . When you use the SortBy  value, the NextPageToken  and
