...
// production environment. Service Endpoint The Cost Explorer API provides the
// following endpoint:
//   - https://ce.us-east-1.amazonaws.com
//
// For information about the costs that
// are associated with the Cost Explorer API, see Amazon Web Services Cost
