...
func (c *Client) addOperationListCommitmentPurchaseAnalysesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCommitmentPurchaseAnalyses", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
