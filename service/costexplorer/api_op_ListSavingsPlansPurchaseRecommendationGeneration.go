...
func (c *Client) ListSavingsPlansPurchaseRecommendationGeneration(ctx context.Context, params *ListSavingsPlansPurchaseRecommendationGenerationInput, optFns ...func(*Options)) (*ListSavingsPlansPurchaseRecommendationGenerationOutput, error) {
	if params == nil { params = &ListSavingsPlansPurchaseRecommendationGenerationInput{} }
...
func (c *Client) addOperationListSavingsPlansPurchaseRecommendationGenerationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSavingsPlansPurchaseRecommendationGenerationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSavingsPlansPurchaseRecommendationGenerationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSavingsPlansPurchaseRecommendationGenerationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSavingsPlansPurchaseRecommendationGenerationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSavingsPlansPurchaseRecommendationGenerationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSavingsPlansPurchaseRecommendationGenerationResolveEndpointMiddleware{
