...
func (c *Client) addOperationListSavingsPlansPurchaseRecommendationGenerationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSavingsPlansPurchaseRecommendationGeneration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
