...
func addOperationGetSavingsPlansUtilizationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetSavingsPlansUtilizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetSavingsPlansUtilizationStackSlots(stack); err != nil {
		return err
	}
