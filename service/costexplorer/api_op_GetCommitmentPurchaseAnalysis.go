...
func (c *Client) addOperationGetCommitmentPurchaseAnalysisMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCommitmentPurchaseAnalysis", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
