...
func (c *Client) addOperationRemoveNotificationChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RemoveNotificationChannel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
