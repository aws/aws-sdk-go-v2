...
func (c *Client) ConfigureAgent(ctx context.Context, params *ConfigureAgentInput, optFns ...func(*Options)) (*ConfigureAgentOutput, error) {
	if params == nil { params = &ConfigureAgentInput{} }
...
func (c *Client) addOperationConfigureAgentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addConfigureAgentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opConfigureAgentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opConfigureAgentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opConfigureAgentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addConfigureAgentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opConfigureAgentResolveEndpointMiddleware{
