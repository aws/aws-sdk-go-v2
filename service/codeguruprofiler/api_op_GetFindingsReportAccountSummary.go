...
func (c *Client) addOperationGetFindingsReportAccountSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetFindingsReportAccountSummary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
