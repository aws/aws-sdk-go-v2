...
func (c *Client) addOperationAddNotificationChannelsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AddNotificationChannels", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
