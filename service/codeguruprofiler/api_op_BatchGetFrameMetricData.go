...
func (c *Client) addOperationBatchGetFrameMetricDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetFrameMetricData", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
