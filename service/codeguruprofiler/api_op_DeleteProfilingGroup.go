...
func (c *Client) DeleteProfilingGroup(ctx context.Context, params *DeleteProfilingGroupInput, optFns ...func(*Options)) (*DeleteProfilingGroupOutput, error) {
	if params == nil { params = &DeleteProfilingGroupInput{} }
...
func (c *Client) addOperationDeleteProfilingGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteProfilingGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteProfilingGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteProfilingGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteProfilingGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteProfilingGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteProfilingGroupResolveEndpointMiddleware{
