...
// GetProfileis not idempotent. Specify the time range for the requested
// aggregated profile using 1 or 2 of the following parameters: startTime ,
// endTime , period. The maximum time range allowed is 7 days. If you specify all
// 3 parameters, an exception is thrown. If you specify only period, the latest
...
type GetProfileInput struct {
	...
	// Content-Typeheaders of the HTTP request. You can specify one of the following:
	// or the default .
	...
	// calls method B , which calls method C , which calls method D, then the depth
	// is 4. If the maxDepth is set to 2, then the aggregated profile contains
	...
	// example, 2020-06-01T13:15:02.001Z represents 1 millisecond past June 1, 2020
	// 1:15:02 PM UTC. If you specify startTime , then you must also specify period
