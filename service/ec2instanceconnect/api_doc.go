...
// requests to EC2 Instance Connect.
//
...
// Using the Client
//
// To use EC2 Instance Connect with the SDK use the New function to create
...
//
// See the EC2 Instance Connect client for more information on
