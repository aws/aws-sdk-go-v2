...
// way to connect to their instances. To view the Amazon EC2 Instance Connect
// content in the Amazon EC2 User Guide, see Connect to your Linux instance using
