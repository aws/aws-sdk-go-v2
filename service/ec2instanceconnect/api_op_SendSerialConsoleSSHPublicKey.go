...
func (c *Client) addOperationSendSerialConsoleSSHPublicKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SendSerialConsoleSSHPublicKey", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
