...
func (c *Client) UpdateChannelNamespace(ctx context.Context, params *UpdateChannelNamespaceInput, optFns ...func(*Options)) (*UpdateChannelNamespaceOutput, error) {
	if params == nil { params = &UpdateChannelNamespaceInput{} }
...
func (c *Client) addOperationUpdateChannelNamespaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err != nil { return err }
	if err := addProtocolFinalizerMiddlewares(stack, options, "UpdateChannelNamespace"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opUpdateChannelNamespace(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opUpdateChannelNamespace(region string) *awsmiddleware.RegisterServiceMetadata {
