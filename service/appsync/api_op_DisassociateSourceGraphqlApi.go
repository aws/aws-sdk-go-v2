...
func (c *Client) DisassociateSourceGraphqlApi(ctx context.Context, params *DisassociateSourceGraphqlApiInput, optFns ...func(*Options)) (*DisassociateSourceGraphqlApiOutput, error) {
	if params == nil { params = &DisassociateSourceGraphqlApiInput{} }
...
func (c *Client) addOperationDisassociateSourceGraphqlApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateSourceGraphqlApiResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateSourceGraphqlApiResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateSourceGraphqlApiResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateSourceGraphqlApiResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateSourceGraphqlApiResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateSourceGraphqlApiResolveEndpointMiddleware{
