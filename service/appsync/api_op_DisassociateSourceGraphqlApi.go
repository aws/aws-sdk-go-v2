...
func (c *Client) addOperationDisassociateSourceGraphqlApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateSourceGraphqlApi", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
