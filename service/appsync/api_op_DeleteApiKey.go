...
func (*DeleteApiKeyInput) operationName() string {
	return "DeleteApiKey"
}
...
func (c *Client) addOperationDeleteApiKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteApiKeyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteApiKeyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteApiKeyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteApiKeyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteApiKeyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteApiKeyResolveEndpointMiddleware{
