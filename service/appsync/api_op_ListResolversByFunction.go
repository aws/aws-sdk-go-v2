...
func (c *Client) addOperationListResolversByFunctionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListResolversByFunction", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
