...
func (c *Client) addOperationListSourceApiAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSourceApiAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
