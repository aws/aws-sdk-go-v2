...
func (c *Client) ListGraphqlApis(ctx context.Context, params *ListGraphqlApisInput, optFns ...func(*Options)) (*ListGraphqlApisOutput, error) {
	if params == nil { params = &ListGraphqlApisInput{} }
...
func (c *Client) addOperationListGraphqlApisMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListGraphqlApisResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListGraphqlApisResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListGraphqlApisResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListGraphqlApisResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListGraphqlApisResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListGraphqlApisResolveEndpointMiddleware{
