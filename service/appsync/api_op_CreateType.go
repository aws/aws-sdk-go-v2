...
func (c *Client) CreateType(ctx context.Context, params *CreateTypeInput, optFns ...func(*Options)) (*CreateTypeOutput, error) {
	stack := middleware.NewStack("CreateType", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpCreateTypeMiddlewares(stack)
...
func addawsRestjson1_serdeOpCreateTypeMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpCreateType{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpCreateType{}, middleware.After)
}
