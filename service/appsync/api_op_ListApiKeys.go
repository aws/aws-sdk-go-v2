...
func (c *Client) ListApiKeys(ctx context.Context, params *ListApiKeysInput, optFns ...func(*Options)) (*ListApiKeysOutput, error) {
	if params == nil { params = &ListApiKeysInput{} }
...
func (c *Client) addOperationListApiKeysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListApiKeysResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListApiKeysResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListApiKeysResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListApiKeysResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListApiKeysResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListApiKeysResolveEndpointMiddleware{
