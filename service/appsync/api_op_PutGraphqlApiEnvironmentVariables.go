...
func (c *Client) addOperationPutGraphqlApiEnvironmentVariablesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutGraphqlApiEnvironmentVariables", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
