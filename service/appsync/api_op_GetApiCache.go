...
func (c *Client) GetApiCache(ctx context.Context, params *GetApiCacheInput, optFns ...func(*Options)) (*GetApiCacheOutput, error) {
	if params == nil { params = &GetApiCacheInput{} }
...
func (c *Client) addOperationGetApiCacheMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetApiCacheResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetApiCacheResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetApiCacheResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetApiCacheResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetApiCacheResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetApiCacheResolveEndpointMiddleware{
