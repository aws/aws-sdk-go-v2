...
func (c *Client) addOperationDisassociateMergedGraphqlApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateMergedGraphqlApi", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
