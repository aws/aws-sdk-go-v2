...
func (c *Client) GetDataSource(ctx context.Context, params *GetDataSourceInput, optFns ...func(*Options)) (*GetDataSourceOutput, error) {
	...
	addawsRestjson1_serdeOpGetDataSourceMiddlewares(stack)
...
func addawsRestjson1_serdeOpGetDataSourceMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpGetDataSource{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpGetDataSource{}, middleware.After)
}
