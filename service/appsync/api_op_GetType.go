...
func (c *Client) GetType(ctx context.Context, params *GetTypeInput, optFns ...func(*Options)) (*GetTypeOutput, error) {
	if params == nil { params = &GetTypeInput{} }
...
func (c *Client) addOperationGetTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTypeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetTypeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetTypeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTypeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTypeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetTypeResolveEndpointMiddleware{
