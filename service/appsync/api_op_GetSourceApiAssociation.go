...
func (c *Client) GetSourceApiAssociation(ctx context.Context, params *GetSourceApiAssociationInput, optFns ...func(*Options)) (*GetSourceApiAssociationOutput, error) {
	if params == nil { params = &GetSourceApiAssociationInput{} }
...
func (c *Client) addOperationGetSourceApiAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSourceApiAssociationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSourceApiAssociationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSourceApiAssociationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSourceApiAssociationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSourceApiAssociationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSourceApiAssociationResolveEndpointMiddleware{
