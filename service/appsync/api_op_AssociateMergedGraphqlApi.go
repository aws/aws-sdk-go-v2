...
func (*AssociateMergedGraphqlApiInput) operationName() string {
...
func (c *Client) addOperationAssociateMergedGraphqlApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateMergedGraphqlApiResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAssociateMergedGraphqlApiResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAssociateMergedGraphqlApiResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateMergedGraphqlApiResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateMergedGraphqlApiResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAssociateMergedGraphqlApiResolveEndpointMiddleware{
