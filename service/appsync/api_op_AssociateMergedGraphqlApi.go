...
func (c *Client) addOperationAssociateMergedGraphqlApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateMergedGraphqlApi", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
