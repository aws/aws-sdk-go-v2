...
func (c *Client) GetResolver(ctx context.Context, params *GetResolverInput, optFns ...func(*Options)) (*GetResolverOutput, error) {
	if params == nil { params = &GetResolverInput{} }
...
func (c *Client) addOperationGetResolverMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetResolverResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetResolverResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetResolverResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetResolverResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetResolverResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetResolverResolveEndpointMiddleware{
