...
func (c *Client) StartSchemaCreation(ctx context.Context, params *StartSchemaCreationInput, optFns ...func(*Options)) (*StartSchemaCreationOutput, error) {
	if params == nil { params = &StartSchemaCreationInput{} }
...
func (c *Client) addOperationStartSchemaCreationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartSchemaCreationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartSchemaCreationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartSchemaCreationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartSchemaCreationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartSchemaCreationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartSchemaCreationResolveEndpointMiddleware{
