...
// AWSAppSync. See this package's package overview docs
...
const (
	ServiceName = "AWSAppSync" // Service's name
	ServiceID   = "AppSync"    // Service's identifier
	EndpointsID = "appsync"    // Service's Endpoint identifier
)
