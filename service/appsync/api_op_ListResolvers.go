...
func (c *Client) ListResolvers(ctx context.Context, params *ListResolversInput, optFns ...func(*Options)) (*ListResolversOutput, error) {
	if params == nil { params = &ListResolversInput{} }
...
func (c *Client) addOperationListResolversMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListResolversResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListResolversResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListResolversResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListResolversResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListResolversResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListResolversResolveEndpointMiddleware{
