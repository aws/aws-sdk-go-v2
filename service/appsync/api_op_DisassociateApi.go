...
func (c *Client) DisassociateApi(ctx context.Context, params *DisassociateApiInput, optFns ...func(*Options)) (*DisassociateApiOutput, error) {
	if params == nil { params = &DisassociateApiInput{} }
...
func (c *Client) addOperationDisassociateApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateApiResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateApiResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateApiResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateApiResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateApiResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateApiResolveEndpointMiddleware{
