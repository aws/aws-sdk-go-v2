...
func (c *Client) GetGraphqlApi(ctx context.Context, params *GetGraphqlApiInput, optFns ...func(*Options)) (*GetGraphqlApiOutput, error) {
	if params == nil { params = &GetGraphqlApiInput{} }
...
func (c *Client) addOperationGetGraphqlApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetGraphqlApiResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetGraphqlApiResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetGraphqlApiResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetGraphqlApiResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetGraphqlApiResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetGraphqlApiResolveEndpointMiddleware{
