...
func (c *Client) addOperationListSupportedResourceTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSupportedResourceTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
