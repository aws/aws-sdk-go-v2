...
func (c *Client) GetView(ctx context.Context, params *GetViewInput, optFns ...func(*Options)) (*GetViewOutput, error) {
	if params == nil { params = &GetViewInput{} }
...
func (c *Client) addOperationGetViewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetViewResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetViewResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetViewResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetViewResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetViewResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetViewResolveEndpointMiddleware{
