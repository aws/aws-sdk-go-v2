...
func (c *Client) ListViews(ctx context.Context, params *ListViewsInput, optFns ...func(*Options)) (*ListViewsOutput, error) {
	if params == nil { params = &ListViewsInput{} }
...
func (c *Client) addOperationListViewsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListViewsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListViewsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListViewsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListViewsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListViewsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListViewsResolveEndpointMiddleware{
