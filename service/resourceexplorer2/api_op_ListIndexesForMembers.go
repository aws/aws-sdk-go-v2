...
func (c *Client) addOperationListIndexesForMembersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListIndexesForMembersResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListIndexesForMembersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListIndexesForMembersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListIndexesForMembersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListIndexesForMembersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListIndexesForMembersResolveEndpointMiddleware{
