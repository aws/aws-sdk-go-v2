...
func (c *Client) ListIndexes(ctx context.Context, params *ListIndexesInput, optFns ...func(*Options)) (*ListIndexesOutput, error) {
	if params == nil { params = &ListIndexesInput{} }
...
func (c *Client) addOperationListIndexesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListIndexesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListIndexesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListIndexesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListIndexesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListIndexesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListIndexesResolveEndpointMiddleware{
