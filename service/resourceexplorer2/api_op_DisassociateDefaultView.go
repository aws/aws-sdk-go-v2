...
func (c *Client) addOperationDisassociateDefaultViewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateDefaultView", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
