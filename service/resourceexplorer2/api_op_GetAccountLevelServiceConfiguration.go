...
func (c *Client) addOperationGetAccountLevelServiceConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAccountLevelServiceConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
