...
func (c *Client) addOperationListStreamingAccessForServicesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListStreamingAccessForServices", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
