...
func (c *Client) addOperationGetResourceExplorerSetupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetResourceExplorerSetup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
