...
func (c *Client) GetDefaultView(ctx context.Context, params *GetDefaultViewInput, optFns ...func(*Options)) (*GetDefaultViewOutput, error) {
	if params == nil { params = &GetDefaultViewInput{} }
...
func (c *Client) addOperationGetDefaultViewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDefaultViewResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDefaultViewResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDefaultViewResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDefaultViewResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDefaultViewResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDefaultViewResolveEndpointMiddleware{
