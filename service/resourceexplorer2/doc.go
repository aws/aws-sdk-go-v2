...
// (https://docs.aws.amazon.com/arexug/mainline/getting-started-terms-and-concepts.html#term-index)
...
// (https://docs.aws.amazon.com/arexug/mainline/manage-aggregator-region.html) by
// designating one of your Amazon Web Services Regions to contain the aggregator
// index for the account. When you promote a local index in a Region to become the
// aggregator index for the account
// (https://docs.aws.amazon.com/arexug/mainline/manage-aggregator-region-turn-on.html),
