...
// Searchoperation. You can create only one index in a Region. This operation
// creates only a local index. To promote the local index in one Amazon Web
// Services Region into the aggregator index for the Amazon Web Services account,
// use the UpdateIndexType  operation. For more information, see Turning on
// cross-Region search by creating an aggregator index (https://docs.aws.amazon.com/resource-explorer/latest/userguide/manage-aggregator-region.html)
