...
func (c *Client) addOperationListElasticsearchVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListElasticsearchVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
