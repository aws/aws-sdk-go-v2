...
func addOperationRejectInboundCrossClusterSearchConnectionStackSlots(stack *middleware.Stack) error {
...
func addOperationRejectInboundCrossClusterSearchConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRejectInboundCrossClusterSearchConnectionStackSlots(stack); err != nil {
		return err
	}
