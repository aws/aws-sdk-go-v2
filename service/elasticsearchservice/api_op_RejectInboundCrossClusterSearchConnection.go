...
func (*RejectInboundCrossClusterSearchConnectionInput) operationName() string {
...
func (c *Client) addOperationRejectInboundCrossClusterSearchConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRejectInboundCrossClusterSearchConnectionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRejectInboundCrossClusterSearchConnectionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRejectInboundCrossClusterSearchConnectionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRejectInboundCrossClusterSearchConnectionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRejectInboundCrossClusterSearchConnectionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRejectInboundCrossClusterSearchConnectionResolveEndpointMiddleware{
