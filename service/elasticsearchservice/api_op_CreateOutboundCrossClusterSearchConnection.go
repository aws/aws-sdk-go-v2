...
func addOperationCreateOutboundCrossClusterSearchConnectionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateOutboundCrossClusterSearchConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateOutboundCrossClusterSearchConnectionStackSlots(stack); err != nil {
		return err
	}
