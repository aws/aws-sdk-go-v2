...
func (c *Client) addOperationDescribeReservedElasticsearchInstanceOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReservedElasticsearchInstanceOfferings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
