...
func (*DescribeElasticsearchDomainsInput) operationName() string {
...
func (c *Client) addOperationDescribeElasticsearchDomainsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeElasticsearchDomainsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeElasticsearchDomainsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeElasticsearchDomainsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeElasticsearchDomainsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeElasticsearchDomainsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeElasticsearchDomainsResolveEndpointMiddleware{
