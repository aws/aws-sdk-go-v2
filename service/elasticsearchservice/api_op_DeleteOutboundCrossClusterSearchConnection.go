...
func (*DeleteOutboundCrossClusterSearchConnectionInput) operationName() string {
...
func (c *Client) addOperationDeleteOutboundCrossClusterSearchConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteOutboundCrossClusterSearchConnectionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteOutboundCrossClusterSearchConnectionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteOutboundCrossClusterSearchConnectionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteOutboundCrossClusterSearchConnectionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteOutboundCrossClusterSearchConnectionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteOutboundCrossClusterSearchConnectionResolveEndpointMiddleware{
