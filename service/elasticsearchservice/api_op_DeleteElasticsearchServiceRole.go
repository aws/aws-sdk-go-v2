...
func (c *Client) DeleteElasticsearchServiceRole(ctx context.Context, params *DeleteElasticsearchServiceRoleInput, optFns ...func(*Options)) (*DeleteElasticsearchServiceRoleOutput, error) {
	if params == nil { params = &DeleteElasticsearchServiceRoleInput{} }
...
func (c *Client) addOperationDeleteElasticsearchServiceRoleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteElasticsearchServiceRoleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteElasticsearchServiceRoleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteElasticsearchServiceRoleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteElasticsearchServiceRoleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteElasticsearchServiceRoleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteElasticsearchServiceRoleResolveEndpointMiddleware{
