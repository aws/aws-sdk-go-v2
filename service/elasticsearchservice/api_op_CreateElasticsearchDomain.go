...
func (c *Client) addOperationCreateElasticsearchDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateElasticsearchDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
