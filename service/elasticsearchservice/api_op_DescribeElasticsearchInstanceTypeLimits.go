...
func (c *Client) addOperationDescribeElasticsearchInstanceTypeLimitsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeElasticsearchInstanceTypeLimits", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
