...
func addOperationUpgradeElasticsearchDomainStackSlots(stack *middleware.Stack) error {
...
func addOperationUpgradeElasticsearchDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpgradeElasticsearchDomainStackSlots(stack); err != nil {
		return err
	}
