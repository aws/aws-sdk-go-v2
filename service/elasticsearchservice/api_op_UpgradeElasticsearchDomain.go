...
func (c *Client) addOperationUpgradeElasticsearchDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpgradeElasticsearchDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
