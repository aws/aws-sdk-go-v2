...
func (c *Client) addOperationDeleteElasticsearchDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteElasticsearchDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
