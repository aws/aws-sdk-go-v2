...
func (c *Client) PurchaseReservedElasticsearchInstanceOffering(ctx context.Context, params *PurchaseReservedElasticsearchInstanceOfferingInput, optFns ...func(*Options)) (*PurchaseReservedElasticsearchInstanceOfferingOutput, error) {
	if params == nil { params = &PurchaseReservedElasticsearchInstanceOfferingInput{} }
...
func (c *Client) addOperationPurchaseReservedElasticsearchInstanceOfferingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPurchaseReservedElasticsearchInstanceOfferingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPurchaseReservedElasticsearchInstanceOfferingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPurchaseReservedElasticsearchInstanceOfferingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPurchaseReservedElasticsearchInstanceOfferingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPurchaseReservedElasticsearchInstanceOfferingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPurchaseReservedElasticsearchInstanceOfferingResolveEndpointMiddleware{
