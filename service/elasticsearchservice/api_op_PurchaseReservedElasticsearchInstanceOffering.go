...
func (c *Client) addOperationPurchaseReservedElasticsearchInstanceOfferingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PurchaseReservedElasticsearchInstanceOffering", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
