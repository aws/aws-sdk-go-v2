...
func (c *Client) CancelElasticsearchServiceSoftwareUpdate(ctx context.Context, params *CancelElasticsearchServiceSoftwareUpdateInput, optFns ...func(*Options)) (*CancelElasticsearchServiceSoftwareUpdateOutput, error) {
	if params == nil { params = &CancelElasticsearchServiceSoftwareUpdateInput{} }
...
func (c *Client) addOperationCancelElasticsearchServiceSoftwareUpdateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelElasticsearchServiceSoftwareUpdateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelElasticsearchServiceSoftwareUpdateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelElasticsearchServiceSoftwareUpdateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelElasticsearchServiceSoftwareUpdateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelElasticsearchServiceSoftwareUpdateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelElasticsearchServiceSoftwareUpdateResolveEndpointMiddleware{
