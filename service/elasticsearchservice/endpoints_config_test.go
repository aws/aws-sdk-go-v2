...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-elasticsearch-service.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elasticsearch-service.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elasticsearch-service.dev",
			expectURL:     aws.String("https://env-elasticsearch-service.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-elasticsearch-service.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elasticsearch-service.dev",
			expectURL:     aws.String("http://config-elasticsearch-service.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-elasticsearch-service.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-elasticsearch-service.dev",
			clientEndpoint: aws.String("https://client-elasticsearch-service.dev"),
			expectURL:      aws.String("https://client-elasticsearch-service.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ELASTICSEARCH_SERVICE", c.envService)
			}
