...
func addOperationDescribeElasticsearchDomainStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeElasticsearchDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeElasticsearchDomainStackSlots(stack); err != nil {
		return err
	}
