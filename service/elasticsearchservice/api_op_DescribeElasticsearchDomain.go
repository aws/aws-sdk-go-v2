...
func (c *Client) DescribeElasticsearchDomain(ctx context.Context, params *DescribeElasticsearchDomainInput, optFns ...func(*Options)) (*DescribeElasticsearchDomainOutput, error) {
	stack := middleware.NewStack("DescribeElasticsearchDomain", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpDescribeElasticsearchDomainMiddlewares(stack)
...
func addawsRestjson1_serdeOpDescribeElasticsearchDomainMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpDescribeElasticsearchDomain{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpDescribeElasticsearchDomain{}, middleware.After)
}
