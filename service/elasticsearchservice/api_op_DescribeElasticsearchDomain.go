...
func (c *Client) addOperationDescribeElasticsearchDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeElasticsearchDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
