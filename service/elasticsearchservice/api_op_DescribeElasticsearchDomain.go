...
func (*DescribeElasticsearchDomainInput) operationName() string {
...
func (c *Client) addOperationDescribeElasticsearchDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeElasticsearchDomainResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeElasticsearchDomainResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeElasticsearchDomainResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeElasticsearchDomainResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeElasticsearchDomainResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeElasticsearchDomainResolveEndpointMiddleware{
