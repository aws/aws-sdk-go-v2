...
func addOperationDescribeReservedElasticsearchInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeReservedElasticsearchInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeReservedElasticsearchInstancesStackSlots(stack); err != nil {
		return err
	}
