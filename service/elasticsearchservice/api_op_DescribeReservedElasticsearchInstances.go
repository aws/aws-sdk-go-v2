...
func (*DescribeReservedElasticsearchInstancesInput) operationName() string {
...
func (c *Client) addOperationDescribeReservedElasticsearchInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeReservedElasticsearchInstancesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeReservedElasticsearchInstancesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeReservedElasticsearchInstancesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeReservedElasticsearchInstancesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeReservedElasticsearchInstancesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeReservedElasticsearchInstancesResolveEndpointMiddleware{
