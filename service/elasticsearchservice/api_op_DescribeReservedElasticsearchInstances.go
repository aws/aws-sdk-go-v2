...
func (c *Client) addOperationDescribeReservedElasticsearchInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReservedElasticsearchInstances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
