...
func addOperationGetCompatibleElasticsearchVersionsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetCompatibleElasticsearchVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetCompatibleElasticsearchVersionsStackSlots(stack); err != nil {
		return err
	}
