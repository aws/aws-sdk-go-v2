...
func (c *Client) GetCompatibleElasticsearchVersions(ctx context.Context, params *GetCompatibleElasticsearchVersionsInput, optFns ...func(*Options)) (*GetCompatibleElasticsearchVersionsOutput, error) {
	if params == nil { params = &GetCompatibleElasticsearchVersionsInput{} }
...
func (c *Client) addOperationGetCompatibleElasticsearchVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCompatibleElasticsearchVersionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCompatibleElasticsearchVersionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCompatibleElasticsearchVersionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCompatibleElasticsearchVersionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCompatibleElasticsearchVersionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCompatibleElasticsearchVersionsResolveEndpointMiddleware{
