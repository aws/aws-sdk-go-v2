...
func (c *Client) DescribeElasticsearchDomainConfig(ctx context.Context, params *DescribeElasticsearchDomainConfigInput, optFns ...func(*Options)) (*DescribeElasticsearchDomainConfigOutput, error) {
	if params == nil { params = &DescribeElasticsearchDomainConfigInput{} }
...
func (c *Client) addOperationDescribeElasticsearchDomainConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeElasticsearchDomainConfigResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeElasticsearchDomainConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeElasticsearchDomainConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeElasticsearchDomainConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeElasticsearchDomainConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeElasticsearchDomainConfigResolveEndpointMiddleware{
