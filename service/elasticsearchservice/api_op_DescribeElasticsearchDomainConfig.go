...
func addOperationDescribeElasticsearchDomainConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeElasticsearchDomainConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeElasticsearchDomainConfigStackSlots(stack); err != nil {
		return err
	}
