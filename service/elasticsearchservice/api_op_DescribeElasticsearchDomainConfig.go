...
func (c *Client) addOperationDescribeElasticsearchDomainConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeElasticsearchDomainConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
