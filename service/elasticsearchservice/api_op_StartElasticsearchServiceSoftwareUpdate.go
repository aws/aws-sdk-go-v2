...
func (c *Client) StartElasticsearchServiceSoftwareUpdate(ctx context.Context, params *StartElasticsearchServiceSoftwareUpdateInput, optFns ...func(*Options)) (*StartElasticsearchServiceSoftwareUpdateOutput, error) {
	if params == nil { params = &StartElasticsearchServiceSoftwareUpdateInput{} }
...
func (c *Client) addOperationStartElasticsearchServiceSoftwareUpdateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartElasticsearchServiceSoftwareUpdateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartElasticsearchServiceSoftwareUpdateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartElasticsearchServiceSoftwareUpdateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartElasticsearchServiceSoftwareUpdateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartElasticsearchServiceSoftwareUpdateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartElasticsearchServiceSoftwareUpdateResolveEndpointMiddleware{
