...
func (c *Client) addOperationDescribeInboundCrossClusterSearchConnectionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeInboundCrossClusterSearchConnections", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
