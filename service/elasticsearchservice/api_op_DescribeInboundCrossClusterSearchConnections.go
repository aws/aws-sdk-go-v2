...
func addOperationDescribeInboundCrossClusterSearchConnectionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeInboundCrossClusterSearchConnectionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeInboundCrossClusterSearchConnectionsStackSlots(stack); err != nil {
		return err
	}
