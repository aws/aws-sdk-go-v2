...
func (c *Client) DeleteInboundCrossClusterSearchConnection(ctx context.Context, params *DeleteInboundCrossClusterSearchConnectionInput, optFns ...func(*Options)) (*DeleteInboundCrossClusterSearchConnectionOutput, error) {
	if params == nil { params = &DeleteInboundCrossClusterSearchConnectionInput{} }
...
func (c *Client) addOperationDeleteInboundCrossClusterSearchConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteInboundCrossClusterSearchConnectionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteInboundCrossClusterSearchConnectionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteInboundCrossClusterSearchConnectionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteInboundCrossClusterSearchConnectionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteInboundCrossClusterSearchConnectionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteInboundCrossClusterSearchConnectionResolveEndpointMiddleware{
