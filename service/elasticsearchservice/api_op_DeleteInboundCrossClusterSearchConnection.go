...
func addOperationDeleteInboundCrossClusterSearchConnectionStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteInboundCrossClusterSearchConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteInboundCrossClusterSearchConnectionStackSlots(stack); err != nil {
		return err
	}
