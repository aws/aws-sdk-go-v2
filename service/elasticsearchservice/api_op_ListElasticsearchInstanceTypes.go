...
func (c *Client) addOperationListElasticsearchInstanceTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListElasticsearchInstanceTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
