...
func addOperationListElasticsearchInstanceTypesStackSlots(stack *middleware.Stack) error {
...
func addOperationListElasticsearchInstanceTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListElasticsearchInstanceTypesStackSlots(stack); err != nil {
		return err
	}
