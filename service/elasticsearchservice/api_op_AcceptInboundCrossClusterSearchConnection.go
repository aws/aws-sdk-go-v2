...
func (c *Client) AcceptInboundCrossClusterSearchConnection(ctx context.Context, params *AcceptInboundCrossClusterSearchConnectionInput, optFns ...func(*Options)) (*AcceptInboundCrossClusterSearchConnectionOutput, error) {
	if params == nil { params = &AcceptInboundCrossClusterSearchConnectionInput{} }
...
func (c *Client) addOperationAcceptInboundCrossClusterSearchConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAcceptInboundCrossClusterSearchConnectionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAcceptInboundCrossClusterSearchConnectionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAcceptInboundCrossClusterSearchConnectionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAcceptInboundCrossClusterSearchConnectionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAcceptInboundCrossClusterSearchConnectionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAcceptInboundCrossClusterSearchConnectionResolveEndpointMiddleware{
