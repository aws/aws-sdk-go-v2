...
func (*PutCodeBindingInput) operationName() string {
...
func (c *Client) addOperationPutCodeBindingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutCodeBindingResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opPutCodeBindingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opPutCodeBindingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutCodeBindingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutCodeBindingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opPutCodeBindingResolveEndpointMiddleware{
