...
func (*SearchSchemasInput) operationName() string {
...
func (c *Client) addOperationSearchSchemasMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSearchSchemasResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opSearchSchemasResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opSearchSchemasResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSearchSchemasResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSearchSchemasResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opSearchSchemasResolveEndpointMiddleware{
