...
func (c *Client) GetDiscoveredSchema(ctx context.Context, params *GetDiscoveredSchemaInput, optFns ...func(*Options)) (*GetDiscoveredSchemaOutput, error) {
	if params == nil { params = &GetDiscoveredSchemaInput{} }
...
func (c *Client) addOperationGetDiscoveredSchemaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDiscoveredSchemaResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDiscoveredSchemaResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDiscoveredSchemaResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDiscoveredSchemaResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDiscoveredSchemaResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDiscoveredSchemaResolveEndpointMiddleware{
