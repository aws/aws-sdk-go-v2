...
func (c *Client) StartDiscoverer(ctx context.Context, params *StartDiscovererInput, optFns ...func(*Options)) (*StartDiscovererOutput, error) {
	if params == nil { params = &StartDiscovererInput{} }
...
func (c *Client) addOperationStartDiscovererMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartDiscovererResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartDiscovererResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartDiscovererResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartDiscovererResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartDiscovererResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartDiscovererResolveEndpointMiddleware{
