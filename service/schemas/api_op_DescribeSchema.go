...
func (c *Client) DescribeSchema(ctx context.Context, params *DescribeSchemaInput, optFns ...func(*Options)) (*DescribeSchemaOutput, error) {
	...
	addawsRestjson1_serdeOpDescribeSchemaMiddlewares(stack)
...
func addawsRestjson1_serdeOpDescribeSchemaMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpDescribeSchema{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpDescribeSchema{}, middleware.After)
}
