...
func (c *Client) ExportSchema(ctx context.Context, params *ExportSchemaInput, optFns ...func(*Options)) (*ExportSchemaOutput, error) {
	if params == nil { params = &ExportSchemaInput{} }
...
func (c *Client) addOperationExportSchemaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addExportSchemaResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opExportSchemaResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opExportSchemaResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opExportSchemaResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addExportSchemaResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opExportSchemaResolveEndpointMiddleware{
