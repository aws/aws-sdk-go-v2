...
func (c *Client) StopDiscoverer(ctx context.Context, params *StopDiscovererInput, optFns ...func(*Options)) (*StopDiscovererOutput, error) {
	if params == nil { params = &StopDiscovererInput{} }
...
func (c *Client) addOperationStopDiscovererMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopDiscovererResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopDiscovererResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopDiscovererResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopDiscovererResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopDiscovererResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopDiscovererResolveEndpointMiddleware{
