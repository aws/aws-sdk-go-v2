...
func (c *Client) addOperationDeleteWorkflowStepGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteWorkflowStepGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
