...
func (c *Client) DeleteWorkflowStepGroup(ctx context.Context, params *DeleteWorkflowStepGroupInput, optFns ...func(*Options)) (*DeleteWorkflowStepGroupOutput, error) {
	if params == nil { params = &DeleteWorkflowStepGroupInput{} }
...
func (c *Client) addOperationDeleteWorkflowStepGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteWorkflowStepGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteWorkflowStepGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteWorkflowStepGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteWorkflowStepGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteWorkflowStepGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteWorkflowStepGroupResolveEndpointMiddleware{
