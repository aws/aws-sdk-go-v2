...
func (c *Client) ListWorkflowSteps(ctx context.Context, params *ListWorkflowStepsInput, optFns ...func(*Options)) (*ListWorkflowStepsOutput, error) {
	if params == nil { params = &ListWorkflowStepsInput{} }
...
func (c *Client) addOperationListWorkflowStepsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWorkflowStepsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListWorkflowStepsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListWorkflowStepsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWorkflowStepsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWorkflowStepsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListWorkflowStepsResolveEndpointMiddleware{
