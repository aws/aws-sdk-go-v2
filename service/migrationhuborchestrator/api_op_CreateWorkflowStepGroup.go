...
func (c *Client) addOperationCreateWorkflowStepGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateWorkflowStepGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
