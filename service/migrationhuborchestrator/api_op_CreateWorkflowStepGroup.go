...
func (*CreateWorkflowStepGroupInput) operationName() string {
	return "CreateWorkflowStepGroup"
}
...
func (c *Client) addOperationCreateWorkflowStepGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateWorkflowStepGroupResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateWorkflowStepGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateWorkflowStepGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateWorkflowStepGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateWorkflowStepGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateWorkflowStepGroupResolveEndpointMiddleware{
