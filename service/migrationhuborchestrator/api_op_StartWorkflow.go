...
func (c *Client) StartWorkflow(ctx context.Context, params *StartWorkflowInput, optFns ...func(*Options)) (*StartWorkflowOutput, error) {
	if params == nil { params = &StartWorkflowInput{} }
...
func (c *Client) addOperationStartWorkflowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartWorkflowResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartWorkflowResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartWorkflowResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartWorkflowResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartWorkflowResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartWorkflowResolveEndpointMiddleware{
