...
func (*DeleteWorkflowStepInput) operationName() string {
	return "DeleteWorkflowStep"
}
...
func (c *Client) addOperationDeleteWorkflowStepMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteWorkflowStepResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteWorkflowStepResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteWorkflowStepResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteWorkflowStepResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteWorkflowStepResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteWorkflowStepResolveEndpointMiddleware{
