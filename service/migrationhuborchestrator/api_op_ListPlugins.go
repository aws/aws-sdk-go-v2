...
func (c *Client) ListPlugins(ctx context.Context, params *ListPluginsInput, optFns ...func(*Options)) (*ListPluginsOutput, error) {
	if params == nil { params = &ListPluginsInput{} }
...
func (c *Client) addOperationListPluginsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPluginsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPluginsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPluginsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPluginsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPluginsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPluginsResolveEndpointMiddleware{
