...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-migrationhuborchestrator.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-migrationhuborchestrator.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-migrationhuborchestrator.dev",
			expectURL:     aws.String("https://env-migrationhuborchestrator.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-migrationhuborchestrator.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-migrationhuborchestrator.dev",
			expectURL:     aws.String("http://config-migrationhuborchestrator.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-migrationhuborchestrator.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-migrationhuborchestrator.dev",
			clientEndpoint: aws.String("https://client-migrationhuborchestrator.dev"),
			expectURL:      aws.String("https://client-migrationhuborchestrator.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MIGRATIONHUBORCHESTRATOR", c.envService)
			}
