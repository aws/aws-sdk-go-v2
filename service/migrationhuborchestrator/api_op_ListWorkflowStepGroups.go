...
func (*ListWorkflowStepGroupsInput) operationName() string {
	return "ListWorkflowStepGroups"
}
...
func (c *Client) addOperationListWorkflowStepGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWorkflowStepGroupsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListWorkflowStepGroupsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListWorkflowStepGroupsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWorkflowStepGroupsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWorkflowStepGroupsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListWorkflowStepGroupsResolveEndpointMiddleware{
