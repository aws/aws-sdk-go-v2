...
func (*GetTemplateStepInput) operationName() string {
...
func (c *Client) addOperationGetTemplateStepMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTemplateStepResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetTemplateStepResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetTemplateStepResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTemplateStepResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTemplateStepResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetTemplateStepResolveEndpointMiddleware{
