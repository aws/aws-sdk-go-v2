...
const (
	ServiceName = "Amazon Mobile Analytics" // Service's name
	ServiceID   = "MobileAnalytics"         // Service's identifier
	EndpointsID = "mobileanalytics"         // Service's Endpoint identifier
)
