...
func (c *Client) ListDetectorModels(ctx context.Context, params *ListDetectorModelsInput, optFns ...func(*Options)) (*ListDetectorModelsOutput, error) {
	if params == nil { params = &ListDetectorModelsInput{} }
...
func (c *Client) addOperationListDetectorModelsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDetectorModelsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDetectorModelsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDetectorModelsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDetectorModelsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDetectorModelsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDetectorModelsResolveEndpointMiddleware{
