...
func (*ListDetectorModelVersionsInput) operationName() string {
...
func (c *Client) addOperationListDetectorModelVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDetectorModelVersionsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListDetectorModelVersionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListDetectorModelVersionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDetectorModelVersionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDetectorModelVersionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListDetectorModelVersionsResolveEndpointMiddleware{
