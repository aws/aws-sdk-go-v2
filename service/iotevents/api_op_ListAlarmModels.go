...
func (c *Client) ListAlarmModels(ctx context.Context, params *ListAlarmModelsInput, optFns ...func(*Options)) (*ListAlarmModelsOutput, error) {
	if params == nil { params = &ListAlarmModelsInput{} }
...
func (c *Client) addOperationListAlarmModelsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAlarmModelsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAlarmModelsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAlarmModelsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAlarmModelsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAlarmModelsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAlarmModelsResolveEndpointMiddleware{
