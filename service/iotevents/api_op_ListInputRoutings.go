...
func (c *Client) ListInputRoutings(ctx context.Context, params *ListInputRoutingsInput, optFns ...func(*Options)) (*ListInputRoutingsOutput, error) {
	if params == nil { params = &ListInputRoutingsInput{} }
...
func (c *Client) addOperationListInputRoutingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListInputRoutingsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListInputRoutingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListInputRoutingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListInputRoutingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListInputRoutingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListInputRoutingsResolveEndpointMiddleware{
