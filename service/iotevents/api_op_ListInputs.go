...
func (c *Client) ListInputs(ctx context.Context, params *ListInputsInput, optFns ...func(*Options)) (*ListInputsOutput, error) {
	if params == nil { params = &ListInputsInput{} }
...
func (c *Client) addOperationListInputsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListInputsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListInputsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListInputsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListInputsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListInputsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListInputsResolveEndpointMiddleware{
