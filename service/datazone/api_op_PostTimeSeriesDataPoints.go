...
func (c *Client) addOperationPostTimeSeriesDataPointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PostTimeSeriesDataPoints", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
