...
func (c *Client) addOperationListDataSourceRunActivitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDataSourceRunActivities", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
