...
func (c *Client) addOperationUpdateSubscriptionTargetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateSubscriptionTarget", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
