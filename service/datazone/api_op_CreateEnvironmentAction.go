...
func (c *Client) addOperationCreateEnvironmentActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateEnvironmentAction", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
