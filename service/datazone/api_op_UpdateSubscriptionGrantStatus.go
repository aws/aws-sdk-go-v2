...
func (c *Client) addOperationUpdateSubscriptionGrantStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateSubscriptionGrantStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
