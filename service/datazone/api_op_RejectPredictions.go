...
func (c *Client) addOperationRejectPredictionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRejectPredictionsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRejectPredictionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRejectPredictionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRejectPredictionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRejectPredictionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRejectPredictionsResolveEndpointMiddleware{
