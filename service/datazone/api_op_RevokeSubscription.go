...
func (c *Client) addOperationRevokeSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRevokeSubscriptionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
func (*opRevokeSubscriptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRevokeSubscriptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRevokeSubscriptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRevokeSubscriptionResolveEndpointMiddleware{
