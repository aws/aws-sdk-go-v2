...
func (c *Client) addOperationGetGlossaryTermMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetGlossaryTermResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetGlossaryTermResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetGlossaryTermResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetGlossaryTermResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetGlossaryTermResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetGlossaryTermResolveEndpointMiddleware{
