...
func (c *Client) addOperationCreateEnvironmentProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateEnvironmentProfile", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
