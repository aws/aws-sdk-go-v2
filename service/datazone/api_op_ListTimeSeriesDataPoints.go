...
func (c *Client) addOperationListTimeSeriesDataPointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTimeSeriesDataPoints", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
