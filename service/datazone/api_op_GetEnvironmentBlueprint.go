...
func (c *Client) addOperationGetEnvironmentBlueprintMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetEnvironmentBlueprintResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetEnvironmentBlueprintResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetEnvironmentBlueprintResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetEnvironmentBlueprintResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetEnvironmentBlueprintResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetEnvironmentBlueprintResolveEndpointMiddleware{
