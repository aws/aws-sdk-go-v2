...
func (c *Client) addOperationListEnvironmentBlueprintConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEnvironmentBlueprintConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
