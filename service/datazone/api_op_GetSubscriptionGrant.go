...
func (c *Client) addOperationGetSubscriptionGrantMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSubscriptionGrantResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetSubscriptionGrantResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetSubscriptionGrantResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSubscriptionGrantResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSubscriptionGrantResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetSubscriptionGrantResolveEndpointMiddleware{
