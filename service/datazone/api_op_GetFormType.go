...
func (c *Client) addOperationGetFormTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFormTypeResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetFormTypeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetFormTypeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFormTypeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFormTypeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetFormTypeResolveEndpointMiddleware{
