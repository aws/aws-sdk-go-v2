...
func (c *Client) addOperationDeleteEnvironmentBlueprintConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteEnvironmentBlueprintConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
