...
func (c *Client) addOperationGetDataExportConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDataExportConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
