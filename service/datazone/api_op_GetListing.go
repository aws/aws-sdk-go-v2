...
func (c *Client) addOperationGetListingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetListingResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetListingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetListingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetListingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetListingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetListingResolveEndpointMiddleware{
