...
func (c *Client) addOperationListAccountsInAccountPoolMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAccountsInAccountPool", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
