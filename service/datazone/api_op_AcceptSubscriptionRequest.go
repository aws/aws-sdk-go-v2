...
func (c *Client) addOperationAcceptSubscriptionRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAcceptSubscriptionRequestResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAcceptSubscriptionRequestResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAcceptSubscriptionRequestResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAcceptSubscriptionRequestResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAcceptSubscriptionRequestResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAcceptSubscriptionRequestResolveEndpointMiddleware{
