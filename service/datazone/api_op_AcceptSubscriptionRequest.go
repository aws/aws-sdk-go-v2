...
func (c *Client) addOperationAcceptSubscriptionRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AcceptSubscriptionRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
