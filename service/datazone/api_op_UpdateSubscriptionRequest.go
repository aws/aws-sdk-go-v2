...
func (c *Client) addOperationUpdateSubscriptionRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateSubscriptionRequestResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateSubscriptionRequestResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateSubscriptionRequestResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateSubscriptionRequestResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateSubscriptionRequestResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateSubscriptionRequestResolveEndpointMiddleware{
