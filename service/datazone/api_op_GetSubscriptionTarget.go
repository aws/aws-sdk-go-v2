...
func (c *Client) addOperationGetSubscriptionTargetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSubscriptionTargetResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetSubscriptionTargetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetSubscriptionTargetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSubscriptionTargetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSubscriptionTargetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetSubscriptionTargetResolveEndpointMiddleware{
