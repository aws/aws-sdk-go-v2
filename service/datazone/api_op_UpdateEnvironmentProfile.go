...
func (c *Client) addOperationUpdateEnvironmentProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateEnvironmentProfile", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
