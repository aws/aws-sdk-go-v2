...
func (c *Client) addOperationDeleteTimeSeriesDataPointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteTimeSeriesDataPoints", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
