...
func (c *Client) addOperationCreateDataProductRevisionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateDataProductRevision", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
