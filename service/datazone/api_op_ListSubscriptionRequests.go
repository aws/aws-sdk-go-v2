...
func (c *Client) addOperationListSubscriptionRequestsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSubscriptionRequests", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
