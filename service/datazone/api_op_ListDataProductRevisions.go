...
func (c *Client) addOperationListDataProductRevisionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDataProductRevisions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
