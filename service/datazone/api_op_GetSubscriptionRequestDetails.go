...
func (c *Client) addOperationGetSubscriptionRequestDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSubscriptionRequestDetails", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
