...
func (c *Client) addOperationListSubscriptionTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSubscriptionTargets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
