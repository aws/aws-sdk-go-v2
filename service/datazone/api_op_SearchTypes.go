...
func (c *Client) addOperationSearchTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSearchTypesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opSearchTypesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opSearchTypesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSearchTypesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSearchTypesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opSearchTypesResolveEndpointMiddleware{
