...
func (c *Client) addOperationGetIamPortalLoginUrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetIamPortalLoginUrlResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetIamPortalLoginUrlResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetIamPortalLoginUrlResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetIamPortalLoginUrlResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetIamPortalLoginUrlResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetIamPortalLoginUrlResolveEndpointMiddleware{
