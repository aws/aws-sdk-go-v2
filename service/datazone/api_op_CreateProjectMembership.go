...
func (c *Client) addOperationCreateProjectMembershipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateProjectMembership", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
