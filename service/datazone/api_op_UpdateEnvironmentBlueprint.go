...
func (c *Client) addOperationUpdateEnvironmentBlueprintMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateEnvironmentBlueprint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
