...
func (c *Client) addOperationGetUserProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetUserProfileResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetUserProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetUserProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetUserProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetUserProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetUserProfileResolveEndpointMiddleware{
