...
func (c *Client) addOperationDeleteProjectMembershipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteProjectMembership", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
