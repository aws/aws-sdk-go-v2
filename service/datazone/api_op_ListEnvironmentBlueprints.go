...
func (c *Client) addOperationListEnvironmentBlueprintsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEnvironmentBlueprintsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListEnvironmentBlueprintsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListEnvironmentBlueprintsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEnvironmentBlueprintsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEnvironmentBlueprintsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListEnvironmentBlueprintsResolveEndpointMiddleware{
