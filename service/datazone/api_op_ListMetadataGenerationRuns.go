...
func (c *Client) addOperationListMetadataGenerationRunsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMetadataGenerationRuns", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
