...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/dax/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "DAX", cfg.ConfigSources)
	if found && err == nil {
