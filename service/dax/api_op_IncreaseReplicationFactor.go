...
func (c *Client) addOperationIncreaseReplicationFactorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "IncreaseReplicationFactor", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
