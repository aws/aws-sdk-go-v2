...
type CreateClusterInput struct {
	...
	// replicas. To do this, set ReplicationFactor to a number between 3 (one primary
	// and two read replicas) and 10 (one primary and nine read replicas). If the
	// AvailabilityZones parameter is provided, its length must equal the
	// ReplicationFactor. AWS recommends that you have at least two read replicas per
	// cluster.
	//
	// This member is required.
	...
	// The name of the subnet group to be used for the replication group. DAX
	// clusters can only run in an Amazon VPC environment. All of the subnets that you
