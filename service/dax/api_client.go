...
// Amazon DAX. See this package's package overview docs
...
const (
	ServiceName = "Amazon DAX" // Service's name
	ServiceID   = "DAX"        // Service's identifier
	EndpointsID = "dax"        // Service's Endpoint identifier
)
