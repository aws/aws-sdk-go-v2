...
func (c *Client) addOperationDescribeDefaultParametersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDefaultParameters", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
