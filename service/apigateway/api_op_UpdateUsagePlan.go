...
func (*UpdateUsagePlanInput) operationName() string {
...
func (c *Client) addOperationUpdateUsagePlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateUsagePlanResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateUsagePlanResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateUsagePlanResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateUsagePlanResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateUsagePlanResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateUsagePlanResolveEndpointMiddleware{
