...
func (c *Client) addOperationUpdateDocumentationPartMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDocumentationPart", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
