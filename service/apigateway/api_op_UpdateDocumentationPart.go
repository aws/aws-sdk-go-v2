...
func (c *Client) UpdateDocumentationPart(ctx context.Context, params *UpdateDocumentationPartInput, optFns ...func(*Options)) (*UpdateDocumentationPartOutput, error) {
	stack := middleware.NewStack("UpdateDocumentationPart", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpUpdateDocumentationPartMiddlewares(stack)
	...
	addOpUpdateDocumentationPartValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opUpdateDocumentationPart(options.Region), middleware.Before)
...
func addawsRestjson1_serdeOpUpdateDocumentationPartMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpUpdateDocumentationPart{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpUpdateDocumentationPart{}, middleware.After)
}
