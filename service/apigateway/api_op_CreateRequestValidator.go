...
func (*CreateRequestValidatorInput) operationName() string {
...
func (c *Client) addOperationCreateRequestValidatorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateRequestValidatorResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateRequestValidatorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateRequestValidatorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateRequestValidatorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateRequestValidatorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateRequestValidatorResolveEndpointMiddleware{
