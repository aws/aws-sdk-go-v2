...
func (c *Client) addOperationCreateDocumentationPartMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateDocumentationPart", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
