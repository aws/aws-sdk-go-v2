...
func (c *Client) DeleteResource(ctx context.Context, params *DeleteResourceInput, optFns ...func(*Options)) (*DeleteResourceOutput, error) {
	stack := middleware.NewStack("DeleteResource", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpDeleteResourceMiddlewares(stack)
...
func addawsRestjson1_serdeOpDeleteResourceMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpDeleteResource{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpDeleteResource{}, middleware.After)
}
