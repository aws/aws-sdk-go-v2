...
func (c *Client) addOperationUpdateDocumentationVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDocumentationVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
