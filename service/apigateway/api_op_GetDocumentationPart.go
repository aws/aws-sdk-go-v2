...
func (*GetDocumentationPartInput) operationName() string {
	return "GetDocumentationPart"
}
...
func (c *Client) addOperationGetDocumentationPartMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDocumentationPartResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetDocumentationPartResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetDocumentationPartResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDocumentationPartResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDocumentationPartResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetDocumentationPartResolveEndpointMiddleware{
