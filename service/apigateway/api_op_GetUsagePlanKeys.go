...
func (c *Client) GetUsagePlanKeys(ctx context.Context, params *GetUsagePlanKeysInput, optFns ...func(*Options)) (*GetUsagePlanKeysOutput, error) {
	if params == nil { params = &GetUsagePlanKeysInput{} }
...
func (c *Client) addOperationGetUsagePlanKeysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetUsagePlanKeysResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetUsagePlanKeysResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetUsagePlanKeysResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetUsagePlanKeysResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetUsagePlanKeysResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetUsagePlanKeysResolveEndpointMiddleware{
