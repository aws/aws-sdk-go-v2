...
func (*DeleteMethodInput) operationName() string {
	return "DeleteMethod"
}
...
func (c *Client) addOperationDeleteMethodMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteMethodResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteMethodResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteMethodResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteMethodResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteMethodResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteMethodResolveEndpointMiddleware{
