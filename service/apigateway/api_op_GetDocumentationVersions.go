...
func (c *Client) addOperationGetDocumentationVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDocumentationVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
