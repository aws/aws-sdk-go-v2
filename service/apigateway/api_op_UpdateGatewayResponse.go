...
func (*UpdateGatewayResponseInput) operationName() string {
...
func (c *Client) addOperationUpdateGatewayResponseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateGatewayResponseResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateGatewayResponseResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateGatewayResponseResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateGatewayResponseResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateGatewayResponseResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateGatewayResponseResolveEndpointMiddleware{
