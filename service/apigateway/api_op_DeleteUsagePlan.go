...
func (c *Client) DeleteUsagePlan(ctx context.Context, params *DeleteUsagePlanInput, optFns ...func(*Options)) (*DeleteUsagePlanOutput, error) {
	stack := middleware.NewStack("DeleteUsagePlan", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpDeleteUsagePlanMiddlewares(stack)
...
func addawsRestjson1_serdeOpDeleteUsagePlanMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpDeleteUsagePlan{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpDeleteUsagePlan{}, middleware.After)
}
