...
func (c *Client) GetSdkTypes(ctx context.Context, params *GetSdkTypesInput, optFns ...func(*Options)) (*GetSdkTypesOutput, error) {
	if params == nil { params = &GetSdkTypesInput{} }
...
func (c *Client) addOperationGetSdkTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSdkTypesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSdkTypesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSdkTypesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSdkTypesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSdkTypesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSdkTypesResolveEndpointMiddleware{
