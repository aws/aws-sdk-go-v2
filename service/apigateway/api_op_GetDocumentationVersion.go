...
func (c *Client) addOperationGetDocumentationVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDocumentationVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
