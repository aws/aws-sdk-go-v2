...
func (c *Client) FlushStageAuthorizersCache(ctx context.Context, params *FlushStageAuthorizersCacheInput, optFns ...func(*Options)) (*FlushStageAuthorizersCacheOutput, error) {
	if params == nil { params = &FlushStageAuthorizersCacheInput{} }
...
func (c *Client) addOperationFlushStageAuthorizersCacheMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addFlushStageAuthorizersCacheResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opFlushStageAuthorizersCacheResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opFlushStageAuthorizersCacheResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opFlushStageAuthorizersCacheResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addFlushStageAuthorizersCacheResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opFlushStageAuthorizersCacheResolveEndpointMiddleware{
