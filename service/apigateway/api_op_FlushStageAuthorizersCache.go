...
func addOperationFlushStageAuthorizersCacheStackSlots(stack *middleware.Stack) error {
...
func addOperationFlushStageAuthorizersCacheMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationFlushStageAuthorizersCacheStackSlots(stack); err != nil {
		return err
	}
