...
func (c *Client) FlushStageCache(ctx context.Context, params *FlushStageCacheInput, optFns ...func(*Options)) (*FlushStageCacheOutput, error) {
	if params == nil { params = &FlushStageCacheInput{} }
...
func (c *Client) addOperationFlushStageCacheMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addFlushStageCacheResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opFlushStageCacheResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opFlushStageCacheResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opFlushStageCacheResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addFlushStageCacheResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opFlushStageCacheResolveEndpointMiddleware{
