...
func (*GetBasePathMappingInput) operationName() string {
...
func (c *Client) addOperationGetBasePathMappingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBasePathMappingResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetBasePathMappingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetBasePathMappingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetBasePathMappingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBasePathMappingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetBasePathMappingResolveEndpointMiddleware{
