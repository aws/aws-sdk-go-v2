...
func (v *GetRestApiInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.GetRestApiRequest)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *GetRestApiInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.RestApiId != nil {
		s.WriteString(schemas.GetRestApiRequest_restApiId, *v.RestApiId)
	}
}
...
func (v *GetRestApiOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.RestApi)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *GetRestApiOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ApiKeySource != "" {
...
func (v *GetRestApiOutput) Deserialize(d smithy.ShapeDeserializer) error {
...
func (c *Client) addOperationGetRestApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.GetRestApi, schemas.GetRestApiRequest, schemas.RestApi)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.GetRestApi, schemas.GetRestApiRequest, schemas.RestApi), output: &GetRestApiOutput{}}, middleware.After); err != nil {
		return err
	}
