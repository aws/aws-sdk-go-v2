...
func (c *Client) GetIntegrationResponse(ctx context.Context, params *GetIntegrationResponseInput, optFns ...func(*Options)) (*GetIntegrationResponseOutput, error) {
	if params == nil { params = &GetIntegrationResponseInput{} }
...
func (c *Client) addOperationGetIntegrationResponseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetIntegrationResponseResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetIntegrationResponseResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetIntegrationResponseResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetIntegrationResponseResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetIntegrationResponseResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetIntegrationResponseResolveEndpointMiddleware{
