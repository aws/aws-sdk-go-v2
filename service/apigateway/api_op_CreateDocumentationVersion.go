...
func addOperationCreateDocumentationVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateDocumentationVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateDocumentationVersionStackSlots(stack); err != nil {
		return err
	}
