...
func (*CreateDocumentationVersionInput) operationName() string {
...
func (c *Client) addOperationCreateDocumentationVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateDocumentationVersionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateDocumentationVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateDocumentationVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateDocumentationVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateDocumentationVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateDocumentationVersionResolveEndpointMiddleware{
