...
func (*PutIntegrationResponseInput) operationName() string {
...
func (c *Client) addOperationPutIntegrationResponseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutIntegrationResponseResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opPutIntegrationResponseResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opPutIntegrationResponseResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutIntegrationResponseResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutIntegrationResponseResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opPutIntegrationResponseResolveEndpointMiddleware{
