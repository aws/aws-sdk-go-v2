...
func (c *Client) addOperationUpdateClientCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateClientCertificate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
