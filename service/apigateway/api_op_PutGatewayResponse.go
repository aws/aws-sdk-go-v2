...
func (c *Client) PutGatewayResponse(ctx context.Context, params *PutGatewayResponseInput, optFns ...func(*Options)) (*PutGatewayResponseOutput, error) {
	if params == nil { params = &PutGatewayResponseInput{} }
...
func (c *Client) addOperationPutGatewayResponseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutGatewayResponseResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutGatewayResponseResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutGatewayResponseResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutGatewayResponseResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutGatewayResponseResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutGatewayResponseResolveEndpointMiddleware{
