...
func (c *Client) UpdateRestApi(ctx context.Context, params *UpdateRestApiInput, optFns ...func(*Options)) (*UpdateRestApiOutput, error) {
	if params == nil { params = &UpdateRestApiInput{} }
...
func (c *Client) addOperationUpdateRestApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateRestApiResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateRestApiResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateRestApiResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateRestApiResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateRestApiResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateRestApiResolveEndpointMiddleware{
