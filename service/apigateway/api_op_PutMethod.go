...
func (c *Client) PutMethod(ctx context.Context, params *PutMethodInput, optFns ...func(*Options)) (*PutMethodOutput, error) {
	if params == nil { params = &PutMethodInput{} }
...
func (c *Client) addOperationPutMethodMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutMethodResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutMethodResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutMethodResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutMethodResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutMethodResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutMethodResolveEndpointMiddleware{
