...
func (c *Client) GetRequestValidator(ctx context.Context, params *GetRequestValidatorInput, optFns ...func(*Options)) (*GetRequestValidatorOutput, error) {
	if params == nil { params = &GetRequestValidatorInput{} }
...
func (c *Client) addOperationGetRequestValidatorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRequestValidatorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRequestValidatorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRequestValidatorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRequestValidatorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRequestValidatorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRequestValidatorResolveEndpointMiddleware{
