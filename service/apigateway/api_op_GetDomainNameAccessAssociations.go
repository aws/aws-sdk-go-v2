...
func (c *Client) addOperationGetDomainNameAccessAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDomainNameAccessAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
