...
func (c *Client) GetBasePathMappings(ctx context.Context, params *GetBasePathMappingsInput, optFns ...func(*Options)) (*GetBasePathMappingsOutput, error) {
	if params == nil { params = &GetBasePathMappingsInput{} }
...
func (c *Client) addOperationGetBasePathMappingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBasePathMappingsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetBasePathMappingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetBasePathMappingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetBasePathMappingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBasePathMappingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetBasePathMappingsResolveEndpointMiddleware{
