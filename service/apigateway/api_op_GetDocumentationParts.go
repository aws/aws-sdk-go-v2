...
func (*GetDocumentationPartsInput) operationName() string {
	return "GetDocumentationParts"
}
...
func (c *Client) addOperationGetDocumentationPartsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDocumentationPartsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetDocumentationPartsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetDocumentationPartsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDocumentationPartsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDocumentationPartsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetDocumentationPartsResolveEndpointMiddleware{
