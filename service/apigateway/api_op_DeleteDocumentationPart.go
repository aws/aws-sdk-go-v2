...
func (*DeleteDocumentationPartInput) operationName() string {
...
func (c *Client) addOperationDeleteDocumentationPartMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteDocumentationPartResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteDocumentationPartResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteDocumentationPartResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteDocumentationPartResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteDocumentationPartResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteDocumentationPartResolveEndpointMiddleware{
