...
func (c *Client) UpdateMethod(ctx context.Context, params *UpdateMethodInput, optFns ...func(*Options)) (*UpdateMethodOutput, error) {
	if params == nil { params = &UpdateMethodInput{} }
...
func (c *Client) addOperationUpdateMethodMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateMethodResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateMethodResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateMethodResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateMethodResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateMethodResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateMethodResolveEndpointMiddleware{
