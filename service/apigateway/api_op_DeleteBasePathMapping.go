...
func (c *Client) DeleteBasePathMapping(ctx context.Context, params *DeleteBasePathMappingInput, optFns ...func(*Options)) (*DeleteBasePathMappingOutput, error) {
	stack := middleware.NewStack("DeleteBasePathMapping", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpDeleteBasePathMappingMiddlewares(stack)
...
func addawsRestjson1_serdeOpDeleteBasePathMappingMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpDeleteBasePathMapping{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpDeleteBasePathMapping{}, middleware.After)
}
