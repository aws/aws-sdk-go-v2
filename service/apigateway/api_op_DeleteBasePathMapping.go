...
func (c *Client) DeleteBasePathMapping(ctx context.Context, params *DeleteBasePathMappingInput, optFns ...func(*Options)) (*DeleteBasePathMappingOutput, error) {
	if params == nil { params = &DeleteBasePathMappingInput{} }
...
func (c *Client) addOperationDeleteBasePathMappingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteBasePathMappingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteBasePathMappingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteBasePathMappingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteBasePathMappingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteBasePathMappingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteBasePathMappingResolveEndpointMiddleware{
