...
func (c *Client) addOperationGenerateClientCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GenerateClientCertificate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
