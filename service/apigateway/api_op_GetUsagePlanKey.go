...
func (*GetUsagePlanKeyInput) operationName() string {
...
func (c *Client) addOperationGetUsagePlanKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetUsagePlanKeyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetUsagePlanKeyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetUsagePlanKeyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetUsagePlanKeyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetUsagePlanKeyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetUsagePlanKeyResolveEndpointMiddleware{
