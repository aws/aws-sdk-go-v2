...
func (c *Client) addOperationListRecommendedActionSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRecommendedActionSummaries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
