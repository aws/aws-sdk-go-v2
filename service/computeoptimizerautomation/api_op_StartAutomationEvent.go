...
func (c *Client) StartAutomationEvent(ctx context.Context, params *StartAutomationEventInput, optFns ...func(*Options)) (*StartAutomationEventOutput, error) {
	if params == nil { params = &StartAutomationEventInput{} }
...
func (c *Client) addOperationStartAutomationEventMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	err = stack.Serialize.Add(&awsAwsjson10_serializeOpStartAutomationEvent{}, middleware.After)
	if err != nil { return err }
	err = stack.Deserialize.Add(&awsAwsjson10_deserializeOpStartAutomationEvent{}, middleware.After)
	if err != nil { return err }
...
func (m *idempotencyToken_initializeOpStartAutomationEvent) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *StartAutomationEventInput ")}
