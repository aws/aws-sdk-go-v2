...
func (v *UntagResourceInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ClientToken != nil {
		s.WriteString(schemas.UntagResourceRequest_clientToken, *v.ClientToken)
	}
	if v.ResourceArn != nil {
		s.WriteString(schemas.UntagResourceRequest_resourceArn, *v.ResourceArn)
	}
	if v.RuleRevision != nil {
		s.WriteInt64(schemas.UntagResourceRequest_ruleRevision, *v.RuleRevision)
	}
...
func (c *Client) addOperationUntagResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addIdempotencyToken_opUntagResourceMiddleware(stack, options); err != nil {
		return err
	}
...
type idempotencyToken_initializeOpUntagResource struct {
	tokenProvider IdempotencyTokenProvider
}

func (*idempotencyToken_initializeOpUntagResource) ID() string {
	return "OperationIdempotencyTokenAutoFill"
}

func (m *idempotencyToken_initializeOpUntagResource) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok {
		return out, metadata, fmt.Errorf("expected middleware input to be of type *UntagResourceInput ")
	}
...
func addIdempotencyToken_opUntagResourceMiddleware(stack *middleware.Stack, cfg Options) error {
	return stack.Initialize.Add(&idempotencyToken_initializeOpUntagResource{tokenProvider: cfg.IdempotencyTokenProvider}, middleware.Before)
}
