...
func (c *Client) RollbackAutomationEvent(ctx context.Context, params *RollbackAutomationEventInput, optFns ...func(*Options)) (*RollbackAutomationEventOutput, error) {
	if params == nil { params = &RollbackAutomationEventInput{} }
...
func (c *Client) addOperationRollbackAutomationEventMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	err = stack.Serialize.Add(&awsAwsjson10_serializeOpRollbackAutomationEvent{}, middleware.After)
	if err != nil { return err }
	err = stack.Deserialize.Add(&awsAwsjson10_deserializeOpRollbackAutomationEvent{}, middleware.After)
	if err != nil { return err }
...
func (m *idempotencyToken_initializeOpRollbackAutomationEvent) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *RollbackAutomationEventInput ")}
