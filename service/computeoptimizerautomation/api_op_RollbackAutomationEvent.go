...
func (c *Client) addOperationRollbackAutomationEventMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RollbackAutomationEvent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
