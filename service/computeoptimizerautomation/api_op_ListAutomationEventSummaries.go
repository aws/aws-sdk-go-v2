...
func (c *Client) addOperationListAutomationEventSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAutomationEventSummaries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
