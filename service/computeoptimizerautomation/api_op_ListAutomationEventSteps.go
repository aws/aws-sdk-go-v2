...
func (c *Client) addOperationListAutomationEventStepsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAutomationEventSteps", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
