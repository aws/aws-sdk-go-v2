...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-compute-optimizer-automation.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-compute-optimizer-automation.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-compute-optimizer-automation.dev",
			expectURL:     aws.String("https://env-compute-optimizer-automation.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-compute-optimizer-automation.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-compute-optimizer-automation.dev",
			expectURL:     aws.String("http://config-compute-optimizer-automation.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-compute-optimizer-automation.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-compute-optimizer-automation.dev",
			clientEndpoint: aws.String("https://client-compute-optimizer-automation.dev"),
			expectURL:      aws.String("https://client-compute-optimizer-automation.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_COMPUTE_OPTIMIZER_AUTOMATION", c.envService)
			}
