...
const (
	ServiceName = "Amazon SageMaker Runtime" // Service's name
	ServiceID   = "SageMakerRuntime"         // Service's identifier
	EndpointsID = "runtime.sagemaker"        // Service's Endpoint identifier
)
