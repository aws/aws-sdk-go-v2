...
func TestSerdeCheckSnapshot_InvokeEndpoint(t *testing.T) {
	...
	header := map[string][]string{}
	svc := serdeNewClient()
	_, err := svc.InvokeEndpoint(context.Background(), input, func(o *Options) {
	...
	if err := serdeTestSnapshot(method, rawPath, rawQuery, header, body.Bytes(), "InvokeEndpoint"); err != nil {
		if err != nil && !strings.Contains(err.Error(), "error: success") {
			t.Fatal(err)
		}
	}
...
func TestSerdeCheckSnapshot_InvokeEndpointAsync(t *testing.T) {
	...
	header := map[string][]string{}
	svc := serdeNewClient()
	_, err := svc.InvokeEndpointAsync(context.Background(), input, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			stack.Initialize.Remove("OperationInputValidation")
			stack.Serialize.Remove("RequestCompression")
			return stack.Finalize.Add(&captureSerdeRequestMiddleware{
	...
	if err := serdeTestSnapshot(method, rawPath, rawQuery, header, body.Bytes(), "InvokeEndpointAsync"); err != nil {
		if err != nil && !strings.Contains(err.Error(), "error: success") {
			t.Fatal(err)
		}
	}
}
func TestSerdeUpdateSnapshot_InvokeEndpoint(t *testing.T) {
	input := &InvokeEndpointInput{
		EndpointName:            ptr.String("__EndpointName__"),
		Body:                    []byte("blob"),
		ContentType:             ptr.String("__ContentType__"),
	...
	if err := serdeUpdateSnapshot(method, rawPath, rawQuery, header, body.Bytes(), "InvokeEndpoint"); err != nil {
		if err != nil && !strings.Contains(err.Error(), "error: success") {
			t.Fatal(err)
		}
	}
...
func TestSerdeUpdateSnapshot_InvokeEndpointAsync(t *testing.T) {
	input := &InvokeEndpointAsyncInput{
		EndpointName:             ptr.String("__EndpointName__"),
		ContentType:              ptr.String("__ContentType__"),
		Accept:                   ptr.String("__Accept__"),
	...
	if err := serdeUpdateSnapshot(method, rawPath, rawQuery, header, body.Bytes(), "InvokeEndpointAsync"); err != nil {
		if err != nil && !strings.Contains(err.Error(), "error: success") {
			t.Fatal(err)
		}
	}
