...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-sagemaker-runtime.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker-runtime.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker-runtime.dev",
			expectURL:     aws.String("https://env-sagemaker-runtime.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-sagemaker-runtime.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker-runtime.dev",
			expectURL:     aws.String("http://config-sagemaker-runtime.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-sagemaker-runtime.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-sagemaker-runtime.dev",
			clientEndpoint: aws.String("https://client-sagemaker-runtime.dev"),
			expectURL:      aws.String("https://client-sagemaker-runtime.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SAGEMAKER_RUNTIME", c.envService)
			}
