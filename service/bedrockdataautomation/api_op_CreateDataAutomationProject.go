...
func (c *Client) CreateDataAutomationProject(ctx context.Context, params *CreateDataAutomationProjectInput, optFns ...func(*Options)) (*CreateDataAutomationProjectOutput, error) {
	if params == nil { params = &CreateDataAutomationProjectInput{} }
...
func (m *idempotencyToken_initializeOpCreateDataAutomationProject) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *CreateDataAutomationProjectInput ")}
