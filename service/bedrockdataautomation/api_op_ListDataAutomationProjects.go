...
func (c *Client) addOperationListDataAutomationProjectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDataAutomationProjects", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
