...
func (c *Client) addOperationStartSpeechSynthesisTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartSpeechSynthesisTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
