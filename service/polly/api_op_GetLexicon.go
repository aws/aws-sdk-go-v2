...
func (c *Client) GetLexicon(ctx context.Context, params *GetLexiconInput, optFns ...func(*Options)) (*GetLexiconOutput, error) {
	if params == nil { params = &GetLexiconInput{} }
...
func (c *Client) addOperationGetLexiconMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetLexiconResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetLexiconResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetLexiconResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetLexiconResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetLexiconResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetLexiconResolveEndpointMiddleware{
