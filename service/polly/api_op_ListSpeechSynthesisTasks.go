...
func (c *Client) addOperationListSpeechSynthesisTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSpeechSynthesisTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
