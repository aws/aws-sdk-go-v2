...
func (c *Client) PutLexicon(ctx context.Context, params *PutLexiconInput, optFns ...func(*Options)) (*PutLexiconOutput, error) {
	if params == nil { params = &PutLexiconInput{} }
...
func (c *Client) addOperationPutLexiconMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutLexiconResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutLexiconResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutLexiconResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutLexiconResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutLexiconResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutLexiconResolveEndpointMiddleware{
