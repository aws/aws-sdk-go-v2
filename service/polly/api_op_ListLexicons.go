...
func (c *Client) ListLexicons(ctx context.Context, params *ListLexiconsInput, optFns ...func(*Options)) (*ListLexiconsOutput, error) {
	if params == nil { params = &ListLexiconsInput{} }
...
func (c *Client) addOperationListLexiconsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLexiconsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListLexiconsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListLexiconsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLexiconsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLexiconsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListLexiconsResolveEndpointMiddleware{
