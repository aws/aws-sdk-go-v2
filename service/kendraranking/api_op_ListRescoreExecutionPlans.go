...
func (c *Client) ListRescoreExecutionPlans(ctx context.Context, params *ListRescoreExecutionPlansInput, optFns ...func(*Options)) (*ListRescoreExecutionPlansOutput, error) {
	if params == nil { params = &ListRescoreExecutionPlansInput{} }
...
func (c *Client) addOperationListRescoreExecutionPlansMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRescoreExecutionPlansResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRescoreExecutionPlansResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRescoreExecutionPlansResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRescoreExecutionPlansResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRescoreExecutionPlansResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRescoreExecutionPlansResolveEndpointMiddleware{
