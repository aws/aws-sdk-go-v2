...
func (c *Client) addOperationCreateRescoreExecutionPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateRescoreExecutionPlan", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
