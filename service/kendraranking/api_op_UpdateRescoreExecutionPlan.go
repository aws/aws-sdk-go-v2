...
func (c *Client) addOperationUpdateRescoreExecutionPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRescoreExecutionPlan", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
