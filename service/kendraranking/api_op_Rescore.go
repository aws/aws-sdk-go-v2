...
func (c *Client) Rescore(ctx context.Context, params *RescoreInput, optFns ...func(*Options)) (*RescoreOutput, error) {
	if params == nil { params = &RescoreInput{} }
...
func (c *Client) addOperationRescoreMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRescoreResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRescoreResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRescoreResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRescoreResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRescoreResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRescoreResolveEndpointMiddleware{
