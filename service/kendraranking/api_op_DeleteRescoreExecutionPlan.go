...
func (*DeleteRescoreExecutionPlanInput) operationName() string {
	return "DeleteRescoreExecutionPlan"
}
...
func (c *Client) addOperationDeleteRescoreExecutionPlanMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteRescoreExecutionPlanResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteRescoreExecutionPlanResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteRescoreExecutionPlanResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteRescoreExecutionPlanResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteRescoreExecutionPlanResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteRescoreExecutionPlanResolveEndpointMiddleware{
