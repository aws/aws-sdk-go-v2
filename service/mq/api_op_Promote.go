...
func (c *Client) Promote(ctx context.Context, params *PromoteInput, optFns ...func(*Options)) (*PromoteOutput, error) {
	if params == nil { params = &PromoteInput{} }
...
func (c *Client) addOperationPromoteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPromoteResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPromoteResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPromoteResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPromoteResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPromoteResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPromoteResolveEndpointMiddleware{
