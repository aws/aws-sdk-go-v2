...
func (c *Client) ListBrokers(ctx context.Context, params *ListBrokersInput, optFns ...func(*Options)) (*ListBrokersOutput, error) {
	stack := middleware.NewStack("ListBrokers", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpListBrokersMiddlewares(stack)
...
func addawsRestjson1_serdeOpListBrokersMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpListBrokers{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpListBrokers{}, middleware.After)
}
