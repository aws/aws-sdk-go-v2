...
func (c *Client) RebootBroker(ctx context.Context, params *RebootBrokerInput, optFns ...func(*Options)) (*RebootBrokerOutput, error) {
	if params == nil { params = &RebootBrokerInput{} }
...
func (c *Client) addOperationRebootBrokerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRebootBrokerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRebootBrokerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRebootBrokerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRebootBrokerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRebootBrokerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRebootBrokerResolveEndpointMiddleware{
