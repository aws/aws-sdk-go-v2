...
func (c *Client) addOperationDescribeBrokerEngineTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeBrokerEngineTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
