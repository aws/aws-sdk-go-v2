...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-bedrock-agent-runtime.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bedrock-agent-runtime.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bedrock-agent-runtime.dev",
			expectURL:     aws.String("https://env-bedrock-agent-runtime.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-bedrock-agent-runtime.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bedrock-agent-runtime.dev",
			expectURL:     aws.String("http://config-bedrock-agent-runtime.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-bedrock-agent-runtime.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-bedrock-agent-runtime.dev",
			clientEndpoint: aws.String("https://client-bedrock-agent-runtime.dev"),
			expectURL:      aws.String("https://client-bedrock-agent-runtime.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BEDROCK_AGENT_RUNTIME", c.envService)
			}
