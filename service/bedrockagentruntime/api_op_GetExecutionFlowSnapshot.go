...
func (c *Client) addOperationGetExecutionFlowSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetExecutionFlowSnapshot", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
