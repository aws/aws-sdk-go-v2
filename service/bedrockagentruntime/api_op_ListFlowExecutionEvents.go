...
func (c *Client) addOperationListFlowExecutionEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFlowExecutionEvents", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
