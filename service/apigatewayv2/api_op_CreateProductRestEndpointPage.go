...
func (c *Client) addOperationCreateProductRestEndpointPageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateProductRestEndpointPage", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
