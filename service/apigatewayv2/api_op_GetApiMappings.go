...
func (c *Client) GetApiMappings(ctx context.Context, params *GetApiMappingsInput, optFns ...func(*Options)) (*GetApiMappingsOutput, error) {
	if params == nil { params = &GetApiMappingsInput{} }
...
func (c *Client) addOperationGetApiMappingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetApiMappingsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetApiMappingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetApiMappingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetApiMappingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetApiMappingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetApiMappingsResolveEndpointMiddleware{
