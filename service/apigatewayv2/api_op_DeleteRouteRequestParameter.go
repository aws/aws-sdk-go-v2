...
func (c *Client) DeleteRouteRequestParameter(ctx context.Context, params *DeleteRouteRequestParameterInput, optFns ...func(*Options)) (*DeleteRouteRequestParameterOutput, error) {
	if params == nil { params = &DeleteRouteRequestParameterInput{} }
...
func (c *Client) addOperationDeleteRouteRequestParameterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteRouteRequestParameterResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteRouteRequestParameterResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteRouteRequestParameterResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteRouteRequestParameterResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteRouteRequestParameterResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteRouteRequestParameterResolveEndpointMiddleware{
