...
func addOperationDeleteRouteRequestParameterStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteRouteRequestParameterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteRouteRequestParameterStackSlots(stack); err != nil {
		return err
	}
