...
func (c *Client) addOperationDeleteRouteRequestParameterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteRouteRequestParameter", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
