...
func (c *Client) CreateIntegration(ctx context.Context, params *CreateIntegrationInput, optFns ...func(*Options)) (*CreateIntegrationOutput, error) {
	stack := middleware.NewStack("CreateIntegration", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpCreateIntegrationMiddlewares(stack)
	...
	addOpCreateIntegrationValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opCreateIntegration(options.Region), middleware.Before)
...
func addawsRestjson1_serdeOpCreateIntegrationMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpCreateIntegration{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpCreateIntegration{}, middleware.After)
}
