...
func (c *Client) GetIntegrations(ctx context.Context, params *GetIntegrationsInput, optFns ...func(*Options)) (*GetIntegrationsOutput, error) {
	if params == nil { params = &GetIntegrationsInput{} }
...
func (c *Client) addOperationGetIntegrationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetIntegrationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetIntegrationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetIntegrationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetIntegrationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetIntegrationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetIntegrationsResolveEndpointMiddleware{
