...
func (c *Client) GetApi(ctx context.Context, params *GetApiInput, optFns ...func(*Options)) (*GetApiOutput, error) {
	stack := middleware.NewStack("GetApi", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpGetApiMiddlewares(stack)
	...
	addOpGetApiValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opGetApi(options.Region), middleware.Before)
...
func addawsRestjson1_serdeOpGetApiMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpGetApi{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpGetApi{}, middleware.After)
}
