...
func (*GetApiInput) operationName() string {
	return "GetApi"
}
...
func (c *Client) addOperationGetApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetApiResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetApiResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetApiResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetApiResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetApiResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetApiResolveEndpointMiddleware{
