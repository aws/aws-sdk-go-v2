...
func (*DeleteCorsConfigurationInput) operationName() string {
...
func (c *Client) addOperationDeleteCorsConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCorsConfigurationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteCorsConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteCorsConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCorsConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCorsConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteCorsConfigurationResolveEndpointMiddleware{
