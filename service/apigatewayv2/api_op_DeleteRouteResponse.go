...
func (*DeleteRouteResponseInput) operationName() string {
...
func (c *Client) addOperationDeleteRouteResponseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteRouteResponseResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteRouteResponseResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteRouteResponseResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteRouteResponseResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteRouteResponseResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteRouteResponseResolveEndpointMiddleware{
