...
func (*GetRouteResponseInput) operationName() string {
...
func (c *Client) addOperationGetRouteResponseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRouteResponseResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetRouteResponseResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetRouteResponseResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRouteResponseResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRouteResponseResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetRouteResponseResolveEndpointMiddleware{
