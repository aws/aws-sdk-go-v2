...
func (c *Client) GetApis(ctx context.Context, params *GetApisInput, optFns ...func(*Options)) (*GetApisOutput, error) {
	if params == nil { params = &GetApisInput{} }
...
func (c *Client) addOperationGetApisMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetApisResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetApisResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetApisResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetApisResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetApisResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetApisResolveEndpointMiddleware{
