...
func (c *Client) addOperationDeleteApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteApiResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteApiResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteApiResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteApiResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteApiResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteApiResolveEndpointMiddleware{
