...
func (*DeleteRouteSettingsInput) operationName() string {
...
func (c *Client) addOperationDeleteRouteSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteRouteSettingsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteRouteSettingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteRouteSettingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteRouteSettingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteRouteSettingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteRouteSettingsResolveEndpointMiddleware{
