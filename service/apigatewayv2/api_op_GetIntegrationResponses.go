...
func (c *Client) addOperationGetIntegrationResponsesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetIntegrationResponses", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
