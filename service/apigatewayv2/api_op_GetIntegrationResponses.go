...
func (*GetIntegrationResponsesInput) operationName() string {
...
func (c *Client) addOperationGetIntegrationResponsesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetIntegrationResponsesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetIntegrationResponsesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetIntegrationResponsesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetIntegrationResponsesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetIntegrationResponsesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetIntegrationResponsesResolveEndpointMiddleware{
