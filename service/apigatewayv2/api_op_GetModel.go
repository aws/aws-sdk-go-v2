...
func (c *Client) GetModel(ctx context.Context, params *GetModelInput, optFns ...func(*Options)) (*GetModelOutput, error) {
	if params == nil { params = &GetModelInput{} }
...
func (c *Client) addOperationGetModelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetModelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetModelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetModelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetModelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetModelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetModelResolveEndpointMiddleware{
