...
func (c *Client) addOperationUpdateIntegrationResponseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateIntegrationResponse", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
