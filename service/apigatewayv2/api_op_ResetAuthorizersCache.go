...
func (c *Client) ResetAuthorizersCache(ctx context.Context, params *ResetAuthorizersCacheInput, optFns ...func(*Options)) (*ResetAuthorizersCacheOutput, error) {
	if params == nil { params = &ResetAuthorizersCacheInput{} }
...
func (c *Client) addOperationResetAuthorizersCacheMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResetAuthorizersCacheResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opResetAuthorizersCacheResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opResetAuthorizersCacheResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResetAuthorizersCacheResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResetAuthorizersCacheResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opResetAuthorizersCacheResolveEndpointMiddleware{
