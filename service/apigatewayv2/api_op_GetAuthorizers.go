...
func (c *Client) GetAuthorizers(ctx context.Context, params *GetAuthorizersInput, optFns ...func(*Options)) (*GetAuthorizersOutput, error) {
	if params == nil { params = &GetAuthorizersInput{} }
...
func (c *Client) addOperationGetAuthorizersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetAuthorizersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetAuthorizersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetAuthorizersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetAuthorizersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetAuthorizersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetAuthorizersResolveEndpointMiddleware{
