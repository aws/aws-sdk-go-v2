...
func (c *Client) ReimportApi(ctx context.Context, params *ReimportApiInput, optFns ...func(*Options)) (*ReimportApiOutput, error) {
	if params == nil { params = &ReimportApiInput{} }
...
func (c *Client) addOperationReimportApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addReimportApiResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opReimportApiResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opReimportApiResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opReimportApiResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addReimportApiResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opReimportApiResolveEndpointMiddleware{
