...
func (c *Client) GetRouteResponses(ctx context.Context, params *GetRouteResponsesInput, optFns ...func(*Options)) (*GetRouteResponsesOutput, error) {
	if params == nil { params = &GetRouteResponsesInput{} }
...
func (c *Client) addOperationGetRouteResponsesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRouteResponsesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRouteResponsesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRouteResponsesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRouteResponsesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRouteResponsesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRouteResponsesResolveEndpointMiddleware{
