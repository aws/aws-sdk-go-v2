...
func (c *Client) StartApplicationRefresh(ctx context.Context, params *StartApplicationRefreshInput, optFns ...func(*Options)) (*StartApplicationRefreshOutput, error) {
	if params == nil { params = &StartApplicationRefreshInput{} }
...
func (c *Client) addOperationStartApplicationRefreshMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartApplicationRefreshResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartApplicationRefreshResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartApplicationRefreshResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartApplicationRefreshResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	...
	for _, authScheme := range authSchemes {
	    ...
	    if v4aScheme.SigningName == nil {
	        v4aScheme.SigningName = aws.String("ssm-sap")
	    }
...
func addStartApplicationRefreshResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartApplicationRefreshResolveEndpointMiddleware{
