...
func (*PutResourcePermissionInput) operationName() string {
	return "PutResourcePermission"
}
...
func (c *Client) addOperationPutResourcePermissionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutResourcePermissionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opPutResourcePermissionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opPutResourcePermissionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutResourcePermissionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutResourcePermissionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opPutResourcePermissionResolveEndpointMiddleware{
