...
func (c *Client) addOperationListConfigurationCheckOperationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListConfigurationCheckOperations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
