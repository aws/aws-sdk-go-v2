...
func (c *Client) GrantFlowEntitlements(ctx context.Context, params *GrantFlowEntitlementsInput, optFns ...func(*Options)) (*GrantFlowEntitlementsOutput, error) {
	if params == nil { params = &GrantFlowEntitlementsInput{} }
...
func (c *Client) addOperationGrantFlowEntitlementsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGrantFlowEntitlementsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGrantFlowEntitlementsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGrantFlowEntitlementsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGrantFlowEntitlementsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGrantFlowEntitlementsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGrantFlowEntitlementsResolveEndpointMiddleware{
