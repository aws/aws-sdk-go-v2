...
func (c *Client) AddFlowVpcInterfaces(ctx context.Context, params *AddFlowVpcInterfacesInput, optFns ...func(*Options)) (*AddFlowVpcInterfacesOutput, error) {
	if params == nil { params = &AddFlowVpcInterfacesInput{} }
...
func (c *Client) addOperationAddFlowVpcInterfacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAddFlowVpcInterfacesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAddFlowVpcInterfacesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAddFlowVpcInterfacesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAddFlowVpcInterfacesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAddFlowVpcInterfacesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAddFlowVpcInterfacesResolveEndpointMiddleware{
