...
func (*UpdateBridgeOutputInput) operationName() string {
...
func (c *Client) addOperationUpdateBridgeOutputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateBridgeOutputResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateBridgeOutputResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateBridgeOutputResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateBridgeOutputResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateBridgeOutputResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateBridgeOutputResolveEndpointMiddleware{
