...
func (*CreateBridgeInput) operationName() string {
	return "CreateBridge"
}
...
func (c *Client) addOperationCreateBridgeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateBridgeResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateBridgeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateBridgeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateBridgeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateBridgeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateBridgeResolveEndpointMiddleware{
