...
func (*UpdateBridgeSourceInput) operationName() string {
...
func (c *Client) addOperationUpdateBridgeSourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateBridgeSourceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateBridgeSourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateBridgeSourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateBridgeSourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateBridgeSourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateBridgeSourceResolveEndpointMiddleware{
