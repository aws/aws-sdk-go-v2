...
func (*AddBridgeSourcesInput) operationName() string {
...
func (c *Client) addOperationAddBridgeSourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAddBridgeSourcesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAddBridgeSourcesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAddBridgeSourcesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAddBridgeSourcesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAddBridgeSourcesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAddBridgeSourcesResolveEndpointMiddleware{
