...
func (*AddBridgeOutputsInput) operationName() string {
...
func (c *Client) addOperationAddBridgeOutputsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAddBridgeOutputsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAddBridgeOutputsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAddBridgeOutputsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAddBridgeOutputsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAddBridgeOutputsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAddBridgeOutputsResolveEndpointMiddleware{
