...
func (c *Client) RemoveBridgeOutput(ctx context.Context, params *RemoveBridgeOutputInput, optFns ...func(*Options)) (*RemoveBridgeOutputOutput, error) {
	if params == nil { params = &RemoveBridgeOutputInput{} }
...
func (c *Client) addOperationRemoveBridgeOutputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRemoveBridgeOutputResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRemoveBridgeOutputResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRemoveBridgeOutputResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRemoveBridgeOutputResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRemoveBridgeOutputResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRemoveBridgeOutputResolveEndpointMiddleware{
