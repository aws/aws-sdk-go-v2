...
func (c *Client) addOperationListRouterNetworkInterfacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRouterNetworkInterfaces", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
