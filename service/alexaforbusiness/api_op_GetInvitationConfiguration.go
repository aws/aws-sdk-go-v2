...
func addOperationGetInvitationConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationGetInvitationConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetInvitationConfigurationStackSlots(stack); err != nil {
		return err
	}
