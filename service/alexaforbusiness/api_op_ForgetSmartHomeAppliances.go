...
func (c *Client) ForgetSmartHomeAppliances(ctx context.Context, params *ForgetSmartHomeAppliancesInput, optFns ...func(*Options)) (*ForgetSmartHomeAppliancesOutput, error) {
	if params == nil { params = &ForgetSmartHomeAppliancesInput{} }
...
func (c *Client) addOperationForgetSmartHomeAppliancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addForgetSmartHomeAppliancesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opForgetSmartHomeAppliancesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opForgetSmartHomeAppliancesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opForgetSmartHomeAppliancesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addForgetSmartHomeAppliancesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opForgetSmartHomeAppliancesResolveEndpointMiddleware{
