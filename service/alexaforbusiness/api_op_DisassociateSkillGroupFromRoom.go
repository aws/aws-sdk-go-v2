...
func addOperationDisassociateSkillGroupFromRoomStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateSkillGroupFromRoomMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateSkillGroupFromRoomStackSlots(stack); err != nil {
		return err
	}
