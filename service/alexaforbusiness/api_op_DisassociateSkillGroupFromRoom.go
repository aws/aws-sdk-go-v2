...
func (c *Client) DisassociateSkillGroupFromRoom(ctx context.Context, params *DisassociateSkillGroupFromRoomInput, optFns ...func(*Options)) (*DisassociateSkillGroupFromRoomOutput, error) {
	if params == nil { params = &DisassociateSkillGroupFromRoomInput{} }
...
func (c *Client) addOperationDisassociateSkillGroupFromRoomMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateSkillGroupFromRoomResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateSkillGroupFromRoomResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateSkillGroupFromRoomResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateSkillGroupFromRoomResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateSkillGroupFromRoomResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateSkillGroupFromRoomResolveEndpointMiddleware{
