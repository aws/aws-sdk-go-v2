...
func (c *Client) AssociateDeviceWithNetworkProfile(ctx context.Context, params *AssociateDeviceWithNetworkProfileInput, optFns ...func(*Options)) (*AssociateDeviceWithNetworkProfileOutput, error) {
	if params == nil { params = &AssociateDeviceWithNetworkProfileInput{} }
...
func (c *Client) addOperationAssociateDeviceWithNetworkProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateDeviceWithNetworkProfileResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateDeviceWithNetworkProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateDeviceWithNetworkProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateDeviceWithNetworkProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateDeviceWithNetworkProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateDeviceWithNetworkProfileResolveEndpointMiddleware{
