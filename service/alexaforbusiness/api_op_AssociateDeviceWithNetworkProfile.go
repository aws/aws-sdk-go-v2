...
func addOperationAssociateDeviceWithNetworkProfileStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociateDeviceWithNetworkProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociateDeviceWithNetworkProfileStackSlots(stack); err != nil {
		return err
	}
