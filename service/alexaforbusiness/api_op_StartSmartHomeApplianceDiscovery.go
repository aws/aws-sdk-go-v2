...
func addOperationStartSmartHomeApplianceDiscoveryStackSlots(stack *middleware.Stack) error {
...
func addOperationStartSmartHomeApplianceDiscoveryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartSmartHomeApplianceDiscoveryStackSlots(stack); err != nil {
		return err
	}
