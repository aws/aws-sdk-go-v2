...
func (c *Client) UpdateSkillGroup(ctx context.Context, params *UpdateSkillGroupInput, optFns ...func(*Options)) (*UpdateSkillGroupOutput, error) {
	if params == nil { params = &UpdateSkillGroupInput{} }
...
func (c *Client) addOperationUpdateSkillGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateSkillGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateSkillGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateSkillGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateSkillGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateSkillGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateSkillGroupResolveEndpointMiddleware{
