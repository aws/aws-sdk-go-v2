...
func (c *Client) UpdateGatewayGroup(ctx context.Context, params *UpdateGatewayGroupInput, optFns ...func(*Options)) (*UpdateGatewayGroupOutput, error) {
	if params == nil { params = &UpdateGatewayGroupInput{} }
...
func (c *Client) addOperationUpdateGatewayGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateGatewayGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateGatewayGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateGatewayGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateGatewayGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateGatewayGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateGatewayGroupResolveEndpointMiddleware{
