...
func addOperationDisassociateSkillFromUsersStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateSkillFromUsersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateSkillFromUsersStackSlots(stack); err != nil {
		return err
	}
