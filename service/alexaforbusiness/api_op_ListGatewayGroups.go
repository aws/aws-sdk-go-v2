...
func (c *Client) ListGatewayGroups(ctx context.Context, params *ListGatewayGroupsInput, optFns ...func(*Options)) (*ListGatewayGroupsOutput, error) {
	if params == nil { params = &ListGatewayGroupsInput{} }
...
func (c *Client) addOperationListGatewayGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListGatewayGroupsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListGatewayGroupsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListGatewayGroupsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListGatewayGroupsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListGatewayGroupsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListGatewayGroupsResolveEndpointMiddleware{
