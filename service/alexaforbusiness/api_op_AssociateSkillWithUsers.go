...
func (c *Client) AssociateSkillWithUsers(ctx context.Context, params *AssociateSkillWithUsersInput, optFns ...func(*Options)) (*AssociateSkillWithUsersOutput, error) {
	if params == nil { params = &AssociateSkillWithUsersInput{} }
...
func (c *Client) addOperationAssociateSkillWithUsersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateSkillWithUsersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateSkillWithUsersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateSkillWithUsersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateSkillWithUsersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateSkillWithUsersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateSkillWithUsersResolveEndpointMiddleware{
