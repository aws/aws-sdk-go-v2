...
func addOperationDeleteBusinessReportScheduleStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteBusinessReportScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteBusinessReportScheduleStackSlots(stack); err != nil {
		return err
	}
