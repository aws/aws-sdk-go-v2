...
func (c *Client) DeleteAddressBook(ctx context.Context, params *DeleteAddressBookInput, optFns ...func(*Options)) (*DeleteAddressBookOutput, error) {
	if params == nil { params = &DeleteAddressBookInput{} }
...
func (c *Client) addOperationDeleteAddressBookMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAddressBookResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteAddressBookResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteAddressBookResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteAddressBookResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAddressBookResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteAddressBookResolveEndpointMiddleware{
