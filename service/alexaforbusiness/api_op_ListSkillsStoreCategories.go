...
func (c *Client) ListSkillsStoreCategories(ctx context.Context, params *ListSkillsStoreCategoriesInput, optFns ...func(*Options)) (*ListSkillsStoreCategoriesOutput, error) {
	if params == nil { params = &ListSkillsStoreCategoriesInput{} }
...
func (c *Client) addOperationListSkillsStoreCategoriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSkillsStoreCategoriesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSkillsStoreCategoriesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSkillsStoreCategoriesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSkillsStoreCategoriesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSkillsStoreCategoriesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSkillsStoreCategoriesResolveEndpointMiddleware{
