...
func (c *Client) ApproveSkill(ctx context.Context, params *ApproveSkillInput, optFns ...func(*Options)) (*ApproveSkillOutput, error) {
	if params == nil { params = &ApproveSkillInput{} }
...
func (c *Client) addOperationApproveSkillMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addApproveSkillResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opApproveSkillResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opApproveSkillResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opApproveSkillResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addApproveSkillResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opApproveSkillResolveEndpointMiddleware{
