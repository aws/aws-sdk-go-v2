...
func addOperationDisassociateContactFromAddressBookStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateContactFromAddressBookMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateContactFromAddressBookStackSlots(stack); err != nil {
		return err
	}
