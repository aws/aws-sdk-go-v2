...
func (c *Client) DisassociateContactFromAddressBook(ctx context.Context, params *DisassociateContactFromAddressBookInput, optFns ...func(*Options)) (*DisassociateContactFromAddressBookOutput, error) {
	if params == nil { params = &DisassociateContactFromAddressBookInput{} }
...
func (c *Client) addOperationDisassociateContactFromAddressBookMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateContactFromAddressBookResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateContactFromAddressBookResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateContactFromAddressBookResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateContactFromAddressBookResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateContactFromAddressBookResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateContactFromAddressBookResolveEndpointMiddleware{
