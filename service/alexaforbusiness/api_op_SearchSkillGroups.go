...
func (c *Client) SearchSkillGroups(ctx context.Context, params *SearchSkillGroupsInput, optFns ...func(*Options)) (*SearchSkillGroupsOutput, error) {
	if params == nil { params = &SearchSkillGroupsInput{} }
...
func (c *Client) addOperationSearchSkillGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSearchSkillGroupsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSearchSkillGroupsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSearchSkillGroupsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSearchSkillGroupsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSearchSkillGroupsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSearchSkillGroupsResolveEndpointMiddleware{
