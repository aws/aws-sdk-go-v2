...
func (*DisassociateSkillFromSkillGroupInput) operationName() string {
...
func (c *Client) addOperationDisassociateSkillFromSkillGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateSkillFromSkillGroupResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDisassociateSkillFromSkillGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDisassociateSkillFromSkillGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateSkillFromSkillGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateSkillFromSkillGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDisassociateSkillFromSkillGroupResolveEndpointMiddleware{
