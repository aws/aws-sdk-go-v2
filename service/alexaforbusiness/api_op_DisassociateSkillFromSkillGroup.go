...
func addOperationDisassociateSkillFromSkillGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateSkillFromSkillGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateSkillFromSkillGroupStackSlots(stack); err != nil {
		return err
	}
