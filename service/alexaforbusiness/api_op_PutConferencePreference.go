...
func (c *Client) PutConferencePreference(ctx context.Context, params *PutConferencePreferenceInput, optFns ...func(*Options)) (*PutConferencePreferenceOutput, error) {
	stack := middleware.NewStack("PutConferencePreference", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpPutConferencePreferenceMiddlewares(stack)
...
func addawsAwsjson11_serdeOpPutConferencePreferenceMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpPutConferencePreference{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpPutConferencePreference{}, middleware.After)
}
