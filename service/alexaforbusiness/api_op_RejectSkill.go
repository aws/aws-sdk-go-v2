...
func (c *Client) RejectSkill(ctx context.Context, params *RejectSkillInput, optFns ...func(*Options)) (*RejectSkillOutput, error) {
	if params == nil { params = &RejectSkillInput{} }
...
func (c *Client) addOperationRejectSkillMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRejectSkillResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRejectSkillResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRejectSkillResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRejectSkillResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRejectSkillResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRejectSkillResolveEndpointMiddleware{
