...
func addOperationCreateBusinessReportScheduleStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateBusinessReportScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateBusinessReportScheduleStackSlots(stack); err != nil {
		return err
	}
