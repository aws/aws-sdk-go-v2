...
func (c *Client) GetConferenceProvider(ctx context.Context, params *GetConferenceProviderInput, optFns ...func(*Options)) (*GetConferenceProviderOutput, error) {
	if params == nil { params = &GetConferenceProviderInput{} }
...
func (c *Client) addOperationGetConferenceProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetConferenceProviderResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetConferenceProviderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetConferenceProviderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetConferenceProviderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetConferenceProviderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetConferenceProviderResolveEndpointMiddleware{
