...
func (c *Client) ListConferenceProviders(ctx context.Context, params *ListConferenceProvidersInput, optFns ...func(*Options)) (*ListConferenceProvidersOutput, error) {
	if params == nil { params = &ListConferenceProvidersInput{} }
...
func (c *Client) addOperationListConferenceProvidersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListConferenceProvidersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListConferenceProvidersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListConferenceProvidersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListConferenceProvidersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListConferenceProvidersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListConferenceProvidersResolveEndpointMiddleware{
