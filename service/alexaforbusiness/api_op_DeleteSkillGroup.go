...
func (c *Client) DeleteSkillGroup(ctx context.Context, params *DeleteSkillGroupInput, optFns ...func(*Options)) (*DeleteSkillGroupOutput, error) {
	if params == nil { params = &DeleteSkillGroupInput{} }
...
func (c *Client) addOperationDeleteSkillGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteSkillGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteSkillGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteSkillGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteSkillGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteSkillGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteSkillGroupResolveEndpointMiddleware{
