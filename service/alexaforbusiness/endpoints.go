...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/alexaforbusiness/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_ALEXA_FOR_BUSINESS")

	if g && !s {
		return
	}

	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "Alexa For Business", cfg.ConfigSources)
	if found && err == nil {
					...
					if true == _PartitionResult.SupportsFIPS {
						if true == _PartitionResult.SupportsDualStack {
							uriString := func() string {
								...
								out.WriteString("https://a4b-fips.")
