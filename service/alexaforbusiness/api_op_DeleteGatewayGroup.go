...
func (*DeleteGatewayGroupInput) operationName() string {
...
func (c *Client) addOperationDeleteGatewayGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteGatewayGroupResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteGatewayGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteGatewayGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteGatewayGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteGatewayGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteGatewayGroupResolveEndpointMiddleware{
