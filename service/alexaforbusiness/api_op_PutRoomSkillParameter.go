...
func (c *Client) PutRoomSkillParameter(ctx context.Context, params *PutRoomSkillParameterInput, optFns ...func(*Options)) (*PutRoomSkillParameterOutput, error) {
	if params == nil { params = &PutRoomSkillParameterInput{} }
...
func (c *Client) addOperationPutRoomSkillParameterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutRoomSkillParameterResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutRoomSkillParameterResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutRoomSkillParameterResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutRoomSkillParameterResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutRoomSkillParameterResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutRoomSkillParameterResolveEndpointMiddleware{
