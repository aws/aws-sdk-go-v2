...
func (c *Client) GetConferencePreference(ctx context.Context, params *GetConferencePreferenceInput, optFns ...func(*Options)) (*GetConferencePreferenceOutput, error) {
	if params == nil { params = &GetConferencePreferenceInput{} }
...
func (c *Client) addOperationGetConferencePreferenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetConferencePreferenceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetConferencePreferenceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetConferencePreferenceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetConferencePreferenceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetConferencePreferenceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetConferencePreferenceResolveEndpointMiddleware{
