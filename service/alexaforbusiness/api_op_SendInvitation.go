...
func (*SendInvitationInput) operationName() string {
...
func (c *Client) addOperationSendInvitationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendInvitationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opSendInvitationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opSendInvitationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendInvitationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendInvitationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opSendInvitationResolveEndpointMiddleware{
