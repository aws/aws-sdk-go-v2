...
func (c *Client) ListSkills(ctx context.Context, params *ListSkillsInput, optFns ...func(*Options)) (*ListSkillsOutput, error) {
	if params == nil { params = &ListSkillsInput{} }
...
func (c *Client) addOperationListSkillsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSkillsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSkillsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSkillsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSkillsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSkillsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSkillsResolveEndpointMiddleware{
