...
func addOperationAssociateContactWithAddressBookStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociateContactWithAddressBookMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociateContactWithAddressBookStackSlots(stack); err != nil {
		return err
	}
