...
func (c *Client) ListSmartHomeAppliances(ctx context.Context, params *ListSmartHomeAppliancesInput, optFns ...func(*Options)) (*ListSmartHomeAppliancesOutput, error) {
	if params == nil { params = &ListSmartHomeAppliancesInput{} }
...
func (c *Client) addOperationListSmartHomeAppliancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSmartHomeAppliancesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSmartHomeAppliancesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSmartHomeAppliancesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSmartHomeAppliancesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSmartHomeAppliancesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSmartHomeAppliancesResolveEndpointMiddleware{
