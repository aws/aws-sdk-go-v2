...
func (c *Client) GetRoomSkillParameter(ctx context.Context, params *GetRoomSkillParameterInput, optFns ...func(*Options)) (*GetRoomSkillParameterOutput, error) {
	if params == nil { params = &GetRoomSkillParameterInput{} }
...
func (c *Client) addOperationGetRoomSkillParameterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRoomSkillParameterResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRoomSkillParameterResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRoomSkillParameterResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRoomSkillParameterResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRoomSkillParameterResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRoomSkillParameterResolveEndpointMiddleware{
