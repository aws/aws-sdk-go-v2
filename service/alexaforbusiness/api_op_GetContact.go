...
func (c *Client) GetContact(ctx context.Context, params *GetContactInput, optFns ...func(*Options)) (*GetContactOutput, error) {
	stack := middleware.NewStack("GetContact", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpGetContactMiddlewares(stack)
...
func addawsAwsjson11_serdeOpGetContactMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpGetContact{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpGetContact{}, middleware.After)
}
