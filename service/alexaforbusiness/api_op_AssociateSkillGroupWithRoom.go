...
func (c *Client) AssociateSkillGroupWithRoom(ctx context.Context, params *AssociateSkillGroupWithRoomInput, optFns ...func(*Options)) (*AssociateSkillGroupWithRoomOutput, error) {
	if params == nil { params = &AssociateSkillGroupWithRoomInput{} }
...
func (c *Client) addOperationAssociateSkillGroupWithRoomMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateSkillGroupWithRoomResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateSkillGroupWithRoomResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateSkillGroupWithRoomResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateSkillGroupWithRoomResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateSkillGroupWithRoomResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateSkillGroupWithRoomResolveEndpointMiddleware{
