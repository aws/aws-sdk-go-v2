...
func (c *Client) GetRoom(ctx context.Context, params *GetRoomInput, optFns ...func(*Options)) (*GetRoomOutput, error) {
	...
	addawsAwsjson11_serdeOpGetRoomMiddlewares(stack)
...
func addawsAwsjson11_serdeOpGetRoomMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpGetRoom{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpGetRoom{}, middleware.After)
}
