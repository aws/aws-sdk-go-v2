...
func (c *Client) addOperationListAIGuardrailVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAIGuardrailVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
