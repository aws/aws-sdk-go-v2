...
func (v *UpdateAIPromptOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.UpdateAIPromptResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *UpdateAIPromptOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AiPrompt != nil {
		s.WriteStruct(schemas.UpdateAIPromptResponse_aiPrompt)
