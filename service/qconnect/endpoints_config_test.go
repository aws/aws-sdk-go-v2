...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-qconnect.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-qconnect.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-qconnect.dev",
			expectURL:     aws.String("https://env-qconnect.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-qconnect.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-qconnect.dev",
			expectURL:     aws.String("http://config-qconnect.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-qconnect.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-qconnect.dev",
			clientEndpoint: aws.String("https://client-qconnect.dev"),
			expectURL:      aws.String("https://client-qconnect.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_QCONNECT", c.envService)
			}
