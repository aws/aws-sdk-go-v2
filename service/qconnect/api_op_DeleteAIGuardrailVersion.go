...
func (c *Client) addOperationDeleteAIGuardrailVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteAIGuardrailVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
