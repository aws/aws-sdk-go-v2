...
func (c *Client) addOperationCreateMessageTemplateAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMessageTemplateAttachment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
