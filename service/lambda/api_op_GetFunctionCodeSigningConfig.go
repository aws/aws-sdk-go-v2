...
func (c *Client) addOperationGetFunctionCodeSigningConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetFunctionCodeSigningConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
