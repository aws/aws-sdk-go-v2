...
func addOperationUpdateFunctionConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateFunctionConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateFunctionConfigurationStackSlots(stack); err != nil {
		return err
	}
