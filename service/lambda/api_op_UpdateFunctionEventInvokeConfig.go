...
func addOperationUpdateFunctionEventInvokeConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateFunctionEventInvokeConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateFunctionEventInvokeConfigStackSlots(stack); err != nil {
		return err
	}
