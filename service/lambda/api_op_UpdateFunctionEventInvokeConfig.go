...
func (c *Client) addOperationUpdateFunctionEventInvokeConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateFunctionEventInvokeConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateFunctionEventInvokeConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  BuiltInParameterResolver
}

func (*opUpdateFunctionEventInvokeConfigResolveEndpointMiddleware) ID() string {
	return "opUpdateFunctionEventInvokeConfigResolveEndpointMiddleware"
}

func (m *opUpdateFunctionEventInvokeConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateFunctionEventInvokeConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateFunctionEventInvokeConfigResolveEndpointMiddleware{
