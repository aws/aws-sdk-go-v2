...
func (c *Client) addOperationUpdateFunctionEventInvokeConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateFunctionEventInvokeConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
