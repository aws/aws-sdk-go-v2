...
func (c *Client) addOperationCreateFunctionUrlConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateFunctionUrlConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateFunctionUrlConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  BuiltInParameterResolver
}

func (*opCreateFunctionUrlConfigResolveEndpointMiddleware) ID() string {
	return "opCreateFunctionUrlConfigResolveEndpointMiddleware"
}

func (m *opCreateFunctionUrlConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateFunctionUrlConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateFunctionUrlConfigResolveEndpointMiddleware{
