...
func (c *Client) addOperationDeleteFunctionUrlConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteFunctionUrlConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
