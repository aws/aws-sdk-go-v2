...
func (v *DeleteEventSourceMappingInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DeleteEventSourceMappingRequest)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DeleteEventSourceMappingInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.UUID != nil {
		s.WriteString(schemas.DeleteEventSourceMappingRequest_UUID, *v.UUID)
	}
}
...
func (v *DeleteEventSourceMappingOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.EventSourceMappingConfiguration)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DeleteEventSourceMappingOutput) SerializeMembers(s smithy.ShapeSerializer) {
...
func (v *DeleteEventSourceMappingOutput) Deserialize(d smithy.ShapeDeserializer) error {
...
func (c *Client) addOperationDeleteEventSourceMappingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.DeleteEventSourceMapping, schemas.DeleteEventSourceMappingRequest, schemas.EventSourceMappingConfiguration)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.DeleteEventSourceMapping, schemas.DeleteEventSourceMappingRequest, schemas.EventSourceMappingConfiguration), output: &DeleteEventSourceMappingOutput{}}, middleware.After); err != nil {
		return err
	}
