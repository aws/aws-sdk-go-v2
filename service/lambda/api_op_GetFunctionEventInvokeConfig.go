...
func addOperationGetFunctionEventInvokeConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationGetFunctionEventInvokeConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetFunctionEventInvokeConfigStackSlots(stack); err != nil {
		return err
	}
