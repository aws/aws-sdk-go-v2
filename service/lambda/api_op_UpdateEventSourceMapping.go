...
func (c *Client) addOperationUpdateEventSourceMappingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateEventSourceMapping", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
