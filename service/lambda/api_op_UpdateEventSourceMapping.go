...
func (c *Client) addOperationUpdateEventSourceMappingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateEventSourceMappingResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateEventSourceMappingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  BuiltInParameterResolver
}

func (*opUpdateEventSourceMappingResolveEndpointMiddleware) ID() string {
	return "opUpdateEventSourceMappingResolveEndpointMiddleware"
}

func (m *opUpdateEventSourceMappingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateEventSourceMappingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateEventSourceMappingResolveEndpointMiddleware{
