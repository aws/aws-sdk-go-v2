...
func (c *Client) addOperationInvokeWithResponseStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "InvokeWithResponseStream", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
