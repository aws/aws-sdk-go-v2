...
func (c *Client) addOperationDeleteFunctionCodeSigningConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteFunctionCodeSigningConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
