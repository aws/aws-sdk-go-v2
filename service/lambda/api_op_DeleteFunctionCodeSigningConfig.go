...
func (c *Client) addOperationDeleteFunctionCodeSigningConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteFunctionCodeSigningConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteFunctionCodeSigningConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  BuiltInParameterResolver
}

func (*opDeleteFunctionCodeSigningConfigResolveEndpointMiddleware) ID() string {
	return "opDeleteFunctionCodeSigningConfigResolveEndpointMiddleware"
}

func (m *opDeleteFunctionCodeSigningConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteFunctionCodeSigningConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteFunctionCodeSigningConfigResolveEndpointMiddleware{
