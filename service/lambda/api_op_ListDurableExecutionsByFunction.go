...
func (c *Client) addOperationListDurableExecutionsByFunctionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDurableExecutionsByFunction", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
