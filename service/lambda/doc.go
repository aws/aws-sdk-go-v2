...
// Package lambda provides the API client, operations, and parameter types for
// AWS Lambda.
//
...
// access the API. For installation instructions, see Tools for Amazon Web
// Services (http://aws.amazon.com/tools/). For a list of Region-specific
// endpoints that Lambda supports, see Lambda endpoints and quotas  (https://docs.aws.amazon.com/general/latest/gr/lambda-service.html/)
...
// first two authorities are available from Amazon trust services (https://www.amazontrust.com/repository/)
...
// Certificate Manager FAQs. (http://aws.amazon.com/certificate-manager/faqs/#certificates)
package lambda
