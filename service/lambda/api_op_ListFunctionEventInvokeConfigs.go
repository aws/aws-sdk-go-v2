...
func addOperationListFunctionEventInvokeConfigsStackSlots(stack *middleware.Stack) error {
...
func addOperationListFunctionEventInvokeConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListFunctionEventInvokeConfigsStackSlots(stack); err != nil {
		return err
	}
