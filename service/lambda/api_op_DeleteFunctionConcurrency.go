...
func (c *Client) addOperationDeleteFunctionConcurrencyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteFunctionConcurrency", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
