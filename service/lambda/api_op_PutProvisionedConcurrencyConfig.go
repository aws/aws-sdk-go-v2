...
func (c *Client) addOperationPutProvisionedConcurrencyConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutProvisionedConcurrencyConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
