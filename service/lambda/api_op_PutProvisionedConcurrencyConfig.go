...
func addOperationPutProvisionedConcurrencyConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationPutProvisionedConcurrencyConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutProvisionedConcurrencyConfigStackSlots(stack); err != nil {
		return err
	}
