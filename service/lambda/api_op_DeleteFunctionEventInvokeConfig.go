...
func addOperationDeleteFunctionEventInvokeConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteFunctionEventInvokeConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteFunctionEventInvokeConfigStackSlots(stack); err != nil {
		return err
	}
