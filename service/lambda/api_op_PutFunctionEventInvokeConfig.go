...
func addOperationPutFunctionEventInvokeConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationPutFunctionEventInvokeConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutFunctionEventInvokeConfigStackSlots(stack); err != nil {
		return err
	}
