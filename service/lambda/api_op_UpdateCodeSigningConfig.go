...
func (c *Client) addOperationUpdateCodeSigningConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCodeSigningConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
