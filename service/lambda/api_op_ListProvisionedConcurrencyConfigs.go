...
func addOperationListProvisionedConcurrencyConfigsStackSlots(stack *middleware.Stack) error {
...
func addOperationListProvisionedConcurrencyConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListProvisionedConcurrencyConfigsStackSlots(stack); err != nil {
		return err
	}
