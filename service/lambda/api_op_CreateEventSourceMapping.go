...
func (c *Client) addOperationCreateEventSourceMappingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateEventSourceMapping", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
