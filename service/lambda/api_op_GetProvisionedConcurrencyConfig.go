...
func (c *Client) addOperationGetProvisionedConcurrencyConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetProvisionedConcurrencyConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
