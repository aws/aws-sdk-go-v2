...
func addOperationGetProvisionedConcurrencyConfigStackSlots(stack *middleware.Stack) error {
...
func addOperationGetProvisionedConcurrencyConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetProvisionedConcurrencyConfigStackSlots(stack); err != nil {
		return err
	}
