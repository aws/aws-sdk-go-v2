...
func (c *Client) addOperationAddLayerVersionPermissionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AddLayerVersionPermission", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
