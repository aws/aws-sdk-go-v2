...
func (c *Client) addOperationListFunctionVersionsByCapacityProviderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFunctionVersionsByCapacityProvider", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
