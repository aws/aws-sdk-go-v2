...
func (c *Client) addOperationPutRuntimeManagementConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutRuntimeManagementConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
