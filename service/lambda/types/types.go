...
type SourceAccessConfiguration struct {
	...
	// - SASL_SCRAM_512_AUTH – (Amazon MSK, Self-managed Apache
	// Kafka) The Secrets Manager ARN of your secret key used for SASL SCRAM-512
	...
	// self-managed Apache Kafka) The Secrets Manager ARN of your secret key containing
	// the certificate chain (X.509 PEM), private key (PKCS#8 PEM), and private key
	...
	// Manager ARN of your secret key containing the root CA certificate (X.509 PEM)
	// used for TLS encryption of your Apache Kafka brokers.
