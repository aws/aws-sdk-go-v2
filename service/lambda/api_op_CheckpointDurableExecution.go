...
func (c *Client) addOperationCheckpointDurableExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CheckpointDurableExecution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
