...
func (c *Client) addOperationInvokeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addInvokeResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opInvokeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  BuiltInParameterResolver
}

func (*opInvokeResolveEndpointMiddleware) ID() string {
	return "opInvokeResolveEndpointMiddleware"
}

func (m *opInvokeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addInvokeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opInvokeResolveEndpointMiddleware{
