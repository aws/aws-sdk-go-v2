...
type GetResourcePolicyInput struct {
	...
	// The Amazon Resource Name (ARN) of the function you want to retrieve the policy
	// for. You can use either a qualified or an unqualified ARN, but the value you
