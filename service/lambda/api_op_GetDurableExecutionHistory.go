...
func (c *Client) addOperationGetDurableExecutionHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDurableExecutionHistory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
