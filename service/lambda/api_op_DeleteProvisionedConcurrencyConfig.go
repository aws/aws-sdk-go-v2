...
func (c *Client) addOperationDeleteProvisionedConcurrencyConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteProvisionedConcurrencyConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
