...
func (c *Client) addOperationGetRuntimeManagementConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRuntimeManagementConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
