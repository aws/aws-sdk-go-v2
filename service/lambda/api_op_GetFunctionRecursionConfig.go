...
func (c *Client) addOperationGetFunctionRecursionConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetFunctionRecursionConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
