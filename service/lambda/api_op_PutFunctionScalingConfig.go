...
func (c *Client) addOperationPutFunctionScalingConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutFunctionScalingConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
