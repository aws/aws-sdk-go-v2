...
func (c *Client) PutFunctionScalingConfig(ctx context.Context, params *PutFunctionScalingConfigInput, optFns ...func(*Options)) (*PutFunctionScalingConfigOutput, error) {
	if params == nil { params = &PutFunctionScalingConfigInput{} }
...
func (c *Client) addOperationPutFunctionScalingConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err != nil { return err }
	if err := addProtocolFinalizerMiddlewares(stack, options, "PutFunctionScalingConfig"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opPutFunctionScalingConfig(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opPutFunctionScalingConfig(region string) *awsmiddleware.RegisterServiceMetadata {
