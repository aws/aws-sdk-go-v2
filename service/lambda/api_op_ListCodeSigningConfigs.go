...
func (c *Client) addOperationListCodeSigningConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCodeSigningConfigsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListCodeSigningConfigsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  BuiltInParameterResolver
}

func (*opListCodeSigningConfigsResolveEndpointMiddleware) ID() string {
	return "opListCodeSigningConfigsResolveEndpointMiddleware"
}

func (m *opListCodeSigningConfigsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCodeSigningConfigsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListCodeSigningConfigsResolveEndpointMiddleware{
