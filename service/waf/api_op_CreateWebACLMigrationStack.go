...
func (c *Client) addOperationCreateWebACLMigrationStackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateWebACLMigrationStack", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
