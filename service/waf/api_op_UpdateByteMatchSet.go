...
// - Whether
// to perform any conversions on the request, such as converting it to lowercase,
// before inspecting it for the specified string.
//
// For example, you can add a
// ByteMatchSetUpdate object that matches web requests in which User-Agent headers
// contain the string BadBot. You can then configure AWS WAF to block those
