...
func (c *Client) addOperationUpdateSqlInjectionMatchSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateSqlInjectionMatchSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
