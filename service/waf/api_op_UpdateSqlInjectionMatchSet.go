...
func addOperationUpdateSqlInjectionMatchSetStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateSqlInjectionMatchSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateSqlInjectionMatchSetStackSlots(stack); err != nil {
		return err
	}
