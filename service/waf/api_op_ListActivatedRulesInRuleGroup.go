...
func (c *Client) addOperationListActivatedRulesInRuleGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListActivatedRulesInRuleGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
