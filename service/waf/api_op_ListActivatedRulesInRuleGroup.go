...
func addOperationListActivatedRulesInRuleGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationListActivatedRulesInRuleGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListActivatedRulesInRuleGroupStackSlots(stack); err != nil {
		return err
	}
