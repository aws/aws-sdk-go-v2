...
func (c *Client) ListActivatedRulesInRuleGroup(ctx context.Context, params *ListActivatedRulesInRuleGroupInput, optFns ...func(*Options)) (*ListActivatedRulesInRuleGroupOutput, error) {
	if params == nil { params = &ListActivatedRulesInRuleGroupInput{} }
...
func (c *Client) addOperationListActivatedRulesInRuleGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListActivatedRulesInRuleGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListActivatedRulesInRuleGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListActivatedRulesInRuleGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListActivatedRulesInRuleGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListActivatedRulesInRuleGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListActivatedRulesInRuleGroupResolveEndpointMiddleware{
