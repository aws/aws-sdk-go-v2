...
func (c *Client) addOperationGetSqlInjectionMatchSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSqlInjectionMatchSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
