...
func (c *Client) ListWebACLs(ctx context.Context, params *ListWebACLsInput, optFns ...func(*Options)) (*ListWebACLsOutput, error) {
	if params == nil { params = &ListWebACLsInput{} }
...
func (c *Client) addOperationListWebACLsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWebACLsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListWebACLsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListWebACLsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWebACLsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWebACLsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListWebACLsResolveEndpointMiddleware{
