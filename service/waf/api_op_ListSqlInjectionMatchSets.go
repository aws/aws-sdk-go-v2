...
type ListSqlInjectionMatchSetsInput struct {
	...
	// return for this request. If you have more SqlInjectionMatchSet objects than
	...
	// response that allows you to list another group of SqlInjectionMatchSets. For
	// the second and subsequent ListSqlInjectionMatchSets requests, specify the
