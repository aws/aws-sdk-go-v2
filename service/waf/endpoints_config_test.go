...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-waf.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-waf.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-waf.dev",
			expectURL:     aws.String("https://env-waf.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-waf.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-waf.dev",
			expectURL:     aws.String("http://config-waf.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-waf.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-waf.dev",
			clientEndpoint: aws.String("https://client-waf.dev"),
			expectURL:      aws.String("https://client-waf.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_WAF", c.envService)
			}
