...
func (c *Client) addOperationListSubscribedRuleGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSubscribedRuleGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
