...
func (*ListRegexPatternSetsInput) operationName() string {
...
func (c *Client) addOperationListRegexPatternSetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRegexPatternSetsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListRegexPatternSetsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListRegexPatternSetsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRegexPatternSetsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRegexPatternSetsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListRegexPatternSetsResolveEndpointMiddleware{
