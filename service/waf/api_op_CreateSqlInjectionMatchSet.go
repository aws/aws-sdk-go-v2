...
func addOperationCreateSqlInjectionMatchSetStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateSqlInjectionMatchSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateSqlInjectionMatchSetStackSlots(stack); err != nil {
		return err
	}
