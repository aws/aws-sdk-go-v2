...
func (c *Client) addOperationCreateSqlInjectionMatchSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateSqlInjectionMatchSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
