...
func (c *Client) GetRateBasedRuleManagedKeys(ctx context.Context, params *GetRateBasedRuleManagedKeysInput, optFns ...func(*Options)) (*GetRateBasedRuleManagedKeysOutput, error) {
	if params == nil { params = &GetRateBasedRuleManagedKeysInput{} }
...
func (c *Client) addOperationGetRateBasedRuleManagedKeysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRateBasedRuleManagedKeysResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRateBasedRuleManagedKeysResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRateBasedRuleManagedKeysResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRateBasedRuleManagedKeysResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRateBasedRuleManagedKeysResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRateBasedRuleManagedKeysResolveEndpointMiddleware{
