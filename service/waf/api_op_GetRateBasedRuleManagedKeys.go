...
func (c *Client) addOperationGetRateBasedRuleManagedKeysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRateBasedRuleManagedKeys", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
