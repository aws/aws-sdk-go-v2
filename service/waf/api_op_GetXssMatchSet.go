...
func (*GetXssMatchSetInput) operationName() string {
	return "GetXssMatchSet"
}
...
func (c *Client) addOperationGetXssMatchSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetXssMatchSetResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetXssMatchSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetXssMatchSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetXssMatchSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetXssMatchSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetXssMatchSetResolveEndpointMiddleware{
