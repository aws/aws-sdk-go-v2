...
// specified time range elapsed, GetSampledRequests returns an updated time
// range. This new time range indicates the actual period during which AWS WAF
...
type GetSampledRequestsInput struct {
	...
	// resource received fewer requests than the value of MaxItems ,
...
type GetSampledRequestsOutput struct {
	...
	// GetSampledRequestsrequest. However, if your AWS resource received more than
	// 5,000 requests during the time range that you specified in the request,
	// GetSampledRequestsreturns the time range for the first 5,000 requests. Times
