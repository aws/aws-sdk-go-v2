...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/simpledbv2/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_SIMPLEDBV2")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "SimpleDBv2", cfg.ConfigSources)
	if found && err == nil {
			...
			if _Region == "us-east-1" {
				if _UseFIPS == false {
					if _UseDualStack == false {
						uriString := "https://sdb.amazonaws.com"
					...
					if true == _PartitionResult.SupportsFIPS {
						if true == _PartitionResult.SupportsDualStack {
							uriString := func() string {
								...
								out.WriteString("https://sdb-fips.")
