...
type ListExportsInput struct {
	...
	// The name of the domain to filter exports. If not provided, exports for all the
...
type ListExportsOutput struct {
	...
	// A pagination token indicating that more results are available. To retrieve the
	// next page of results, provide this token in a subsequent ListExports request. If
	// null or empty, there are no more results to retrieve.
	NextToken *string
