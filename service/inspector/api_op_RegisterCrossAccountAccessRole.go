...
func (c *Client) addOperationRegisterCrossAccountAccessRoleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterCrossAccountAccessRole", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
