...
func (c *Client) SubscribeToEvent(ctx context.Context, params *SubscribeToEventInput, optFns ...func(*Options)) (*SubscribeToEventOutput, error) {
	if params == nil { params = &SubscribeToEventInput{} }
...
func (c *Client) addOperationSubscribeToEventMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSubscribeToEventResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSubscribeToEventResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSubscribeToEventResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSubscribeToEventResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSubscribeToEventResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSubscribeToEventResolveEndpointMiddleware{
