...
func (*StopAssessmentRunInput) operationName() string {
...
func (c *Client) addOperationStopAssessmentRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopAssessmentRunResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopAssessmentRunResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopAssessmentRunResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopAssessmentRunResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopAssessmentRunResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopAssessmentRunResolveEndpointMiddleware{
