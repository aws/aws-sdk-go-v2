...
func (c *Client) DeleteAssessmentTarget(ctx context.Context, params *DeleteAssessmentTargetInput, optFns ...func(*Options)) (*DeleteAssessmentTargetOutput, error) {
	if params == nil { params = &DeleteAssessmentTargetInput{} }
...
func (c *Client) addOperationDeleteAssessmentTargetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAssessmentTargetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteAssessmentTargetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteAssessmentTargetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteAssessmentTargetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAssessmentTargetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteAssessmentTargetResolveEndpointMiddleware{
