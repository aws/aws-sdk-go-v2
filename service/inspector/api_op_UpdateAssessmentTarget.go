...
func (*UpdateAssessmentTargetInput) operationName() string {
...
func (c *Client) addOperationUpdateAssessmentTargetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateAssessmentTargetResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateAssessmentTargetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateAssessmentTargetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateAssessmentTargetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateAssessmentTargetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateAssessmentTargetResolveEndpointMiddleware{
