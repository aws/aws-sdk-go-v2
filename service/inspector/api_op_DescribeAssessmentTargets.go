...
func (c *Client) addOperationDescribeAssessmentTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAssessmentTargets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
