...
func (c *Client) SetTagsForResource(ctx context.Context, params *SetTagsForResourceInput, optFns ...func(*Options)) (*SetTagsForResourceOutput, error) {
	if params == nil { params = &SetTagsForResourceInput{} }
...
func (c *Client) addOperationSetTagsForResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetTagsForResourceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetTagsForResourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetTagsForResourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetTagsForResourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetTagsForResourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetTagsForResourceResolveEndpointMiddleware{
