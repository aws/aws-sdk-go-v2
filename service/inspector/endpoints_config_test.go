...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-inspector.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-inspector.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-inspector.dev",
			expectURL:     aws.String("https://env-inspector.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-inspector.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-inspector.dev",
			expectURL:     aws.String("http://config-inspector.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-inspector.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-inspector.dev",
			clientEndpoint: aws.String("https://client-inspector.dev"),
			expectURL:      aws.String("https://client-inspector.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_INSPECTOR", c.envService)
			}
