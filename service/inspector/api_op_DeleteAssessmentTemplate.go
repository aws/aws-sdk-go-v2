...
func (*DeleteAssessmentTemplateInput) operationName() string {
...
func (c *Client) addOperationDeleteAssessmentTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAssessmentTemplateResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteAssessmentTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteAssessmentTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteAssessmentTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAssessmentTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteAssessmentTemplateResolveEndpointMiddleware{
