...
func (c *Client) ListAssessmentRunAgents(ctx context.Context, params *ListAssessmentRunAgentsInput, optFns ...func(*Options)) (*ListAssessmentRunAgentsOutput, error) {
	if params == nil { params = &ListAssessmentRunAgentsInput{} }
...
func (c *Client) addOperationListAssessmentRunAgentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAssessmentRunAgentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAssessmentRunAgentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAssessmentRunAgentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAssessmentRunAgentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAssessmentRunAgentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAssessmentRunAgentsResolveEndpointMiddleware{
