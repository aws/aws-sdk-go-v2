...
func (c *Client) ListRulesPackages(ctx context.Context, params *ListRulesPackagesInput, optFns ...func(*Options)) (*ListRulesPackagesOutput, error) {
	if params == nil { params = &ListRulesPackagesInput{} }
...
func (c *Client) addOperationListRulesPackagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRulesPackagesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRulesPackagesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRulesPackagesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRulesPackagesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRulesPackagesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRulesPackagesResolveEndpointMiddleware{
