...
func addOperationRemoveAttributesFromFindingsStackSlots(stack *middleware.Stack) error {
...
func addOperationRemoveAttributesFromFindingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRemoveAttributesFromFindingsStackSlots(stack); err != nil {
		return err
	}
