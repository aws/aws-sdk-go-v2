...
func (c *Client) addOperationDescribeCrossAccountAccessRoleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCrossAccountAccessRole", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
