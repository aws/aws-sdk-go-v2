...
func addOperationDescribeCrossAccountAccessRoleStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeCrossAccountAccessRoleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeCrossAccountAccessRoleStackSlots(stack); err != nil {
		return err
	}
