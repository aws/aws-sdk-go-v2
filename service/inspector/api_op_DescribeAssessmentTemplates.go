...
func (c *Client) addOperationDescribeAssessmentTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAssessmentTemplates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
