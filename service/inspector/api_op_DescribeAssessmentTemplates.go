...
func (*DescribeAssessmentTemplatesInput) operationName() string {
...
func (c *Client) addOperationDescribeAssessmentTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeAssessmentTemplatesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeAssessmentTemplatesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeAssessmentTemplatesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeAssessmentTemplatesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeAssessmentTemplatesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeAssessmentTemplatesResolveEndpointMiddleware{
