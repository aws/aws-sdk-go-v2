...
func addOperationDescribeAssessmentTemplatesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeAssessmentTemplatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeAssessmentTemplatesStackSlots(stack); err != nil {
		return err
	}
