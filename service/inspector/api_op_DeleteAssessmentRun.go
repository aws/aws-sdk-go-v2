...
func (*DeleteAssessmentRunInput) operationName() string {
...
func (c *Client) addOperationDeleteAssessmentRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAssessmentRunResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteAssessmentRunResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteAssessmentRunResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteAssessmentRunResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAssessmentRunResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteAssessmentRunResolveEndpointMiddleware{
