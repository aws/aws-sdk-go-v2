...
func (c *Client) ListExclusions(ctx context.Context, params *ListExclusionsInput, optFns ...func(*Options)) (*ListExclusionsOutput, error) {
	if params == nil { params = &ListExclusionsInput{} }
...
func (c *Client) addOperationListExclusionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListExclusionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListExclusionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListExclusionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListExclusionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListExclusionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListExclusionsResolveEndpointMiddleware{
