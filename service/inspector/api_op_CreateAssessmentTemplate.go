...
func (c *Client) addOperationCreateAssessmentTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateAssessmentTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
