...
func (*DescribeAssessmentRunsInput) operationName() string {
...
func (c *Client) addOperationDescribeAssessmentRunsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeAssessmentRunsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeAssessmentRunsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeAssessmentRunsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeAssessmentRunsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeAssessmentRunsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeAssessmentRunsResolveEndpointMiddleware{
