...
func (c *Client) addOperationGetAutoshiftObserverNotificationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAutoshiftObserverNotificationStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
