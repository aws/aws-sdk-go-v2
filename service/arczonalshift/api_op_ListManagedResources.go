...
func (c *Client) ListManagedResources(ctx context.Context, params *ListManagedResourcesInput, optFns ...func(*Options)) (*ListManagedResourcesOutput, error) {
	if params == nil { params = &ListManagedResourcesInput{} }
...
func (c *Client) addOperationListManagedResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListManagedResourcesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListManagedResourcesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListManagedResourcesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListManagedResourcesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListManagedResourcesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListManagedResourcesResolveEndpointMiddleware{
