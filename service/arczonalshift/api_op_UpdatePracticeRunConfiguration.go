...
func (c *Client) addOperationUpdatePracticeRunConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdatePracticeRunConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
