...
func (c *Client) addOperationUpdateZonalAutoshiftConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateZonalAutoshiftConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
