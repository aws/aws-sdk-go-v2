...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/arczonalshift/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "ARC Zonal Shift", cfg.ConfigSources)
	if found && err == nil {
