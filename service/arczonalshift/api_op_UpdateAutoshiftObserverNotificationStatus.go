...
func (c *Client) addOperationUpdateAutoshiftObserverNotificationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAutoshiftObserverNotificationStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
