...
func (*UpdateZonalShiftInput) operationName() string {
...
func (c *Client) addOperationUpdateZonalShiftMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateZonalShiftResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateZonalShiftResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateZonalShiftResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateZonalShiftResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateZonalShiftResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateZonalShiftResolveEndpointMiddleware{
