...
func (c *Client) addOperationCreatePracticeRunConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreatePracticeRunConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
