...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/snowdevicemanagement/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "Snow Device Management", cfg.ConfigSources)
	if found && err == nil {
