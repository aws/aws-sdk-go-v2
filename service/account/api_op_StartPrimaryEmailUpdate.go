...
func (c *Client) addOperationStartPrimaryEmailUpdateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartPrimaryEmailUpdate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
