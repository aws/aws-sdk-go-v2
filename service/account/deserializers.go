...
type awsRestjson1_deserializeOpGetGovCloudAccountInformation struct {
}

func (*awsRestjson1_deserializeOpGetGovCloudAccountInformation) ID() string {
	return "OperationDeserializer"
}

func (m *awsRestjson1_deserializeOpGetGovCloudAccountInformation) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsRestjson1_deserializeOpErrorGetGovCloudAccountInformation(response, &metadata)
	}
	output := &GetGovCloudAccountInformationOutput{}
	out.Result = output
	...
	err = awsRestjson1_deserializeOpDocumentGetGovCloudAccountInformationOutput(&output, shape)
	if err != nil {
		var snapshot bytes.Buffer
		io.Copy(&snapshot, ringBuffer)
		return out, metadata, &smithy.DeserializationError{
...
func awsRestjson1_deserializeOpErrorGetGovCloudAccountInformation(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func awsRestjson1_deserializeOpDocumentGetGovCloudAccountInformationOutput(v **GetGovCloudAccountInformationOutput, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *GetGovCloudAccountInformationOutput
	if *v == nil {
		sv = &GetGovCloudAccountInformationOutput{}
	} else {
		sv = *v
	}
	...
	for key, value := range shape {
		...
		case "AccountState":
			if value != nil {
				jtv, ok := value.(string)
				if !ok {
					return fmt.Errorf("expected AwsAccountState to be of type string, got %T instead", value)
				}
				sv.AccountState = types.AwsAccountState(jtv)
			}
...
type awsRestjson1_deserializeOpGetPrimaryEmailUpdateStatus struct {
}

func (*awsRestjson1_deserializeOpGetPrimaryEmailUpdateStatus) ID() string {
	return "OperationDeserializer"
}

func (m *awsRestjson1_deserializeOpGetPrimaryEmailUpdateStatus) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsRestjson1_deserializeOpErrorGetPrimaryEmailUpdateStatus(response, &metadata)
	}
	output := &GetPrimaryEmailUpdateStatusOutput{}
	out.Result = output
	...
	err = awsRestjson1_deserializeOpDocumentGetPrimaryEmailUpdateStatusOutput(&output, shape)
	if err != nil {
		var snapshot bytes.Buffer
		io.Copy(&snapshot, ringBuffer)
		return out, metadata, &smithy.DeserializationError{
...
func awsRestjson1_deserializeOpErrorGetPrimaryEmailUpdateStatus(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func awsRestjson1_deserializeOpDocumentGetPrimaryEmailUpdateStatusOutput(v **GetPrimaryEmailUpdateStatusOutput, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *GetPrimaryEmailUpdateStatusOutput
	if *v == nil {
		sv = &GetPrimaryEmailUpdateStatusOutput{}
	} else {
		sv = *v
	}
...
func awsRestjson1_deserializeOpHttpBindingsResourceUnavailableException(v *types.ResourceUnavailableException, response *smithyhttp.Response) error {
	if v == nil {
		return fmt.Errorf("unsupported deserialization for nil %T", v)
	}
...
func awsRestjson1_deserializeErrorResourceUnavailableException(response *smithyhttp.Response, errorBody *bytes.Reader) error {
	...
	if err := awsRestjson1_deserializeOpHttpBindingsResourceUnavailableException(output, response); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to decode response error with invalid HTTP bindings, %w", err)}
	}
