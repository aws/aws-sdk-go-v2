...
func (c *Client) addOperationAcceptPrimaryEmailUpdateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AcceptPrimaryEmailUpdate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
