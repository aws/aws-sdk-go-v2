...
func (c *Client) addOperationGetGovCloudAccountInformationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetGovCloudAccountInformation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
