...
func (c *Client) GetDecryptedAPIKey(ctx context.Context, params *GetDecryptedAPIKeyInput, optFns ...func(*Options)) (*GetDecryptedAPIKeyOutput, error) {
	if params == nil { params = &GetDecryptedAPIKeyInput{} }
...
func (c *Client) addOperationGetDecryptedAPIKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDecryptedAPIKeyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDecryptedAPIKeyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDecryptedAPIKeyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDecryptedAPIKeyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDecryptedAPIKeyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDecryptedAPIKeyResolveEndpointMiddleware{
