...
func (c *Client) addOperationPutManagedRuleSetVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutManagedRuleSetVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
