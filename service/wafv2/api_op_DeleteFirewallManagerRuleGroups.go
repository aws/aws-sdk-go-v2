...
func addOperationDeleteFirewallManagerRuleGroupsStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteFirewallManagerRuleGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteFirewallManagerRuleGroupsStackSlots(stack); err != nil {
		return err
	}
