...
func (c *Client) addOperationDeleteFirewallManagerRuleGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteFirewallManagerRuleGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
