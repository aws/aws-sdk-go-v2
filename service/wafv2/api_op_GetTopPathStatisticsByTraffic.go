...
func (c *Client) addOperationGetTopPathStatisticsByTrafficMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetTopPathStatisticsByTraffic", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
