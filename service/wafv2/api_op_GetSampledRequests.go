...
// previous three hours. GetSampledRequests returns a time range, which is
// usually the time range that you specified. However, if your resource (such as a
...
type GetSampledRequestsOutput struct {
	...
	// includes every request that your Amazon Web Services resource received during
	...
	// GetSampledRequestsrequest. However, if your Amazon Web Services resource
