...
func (c *Client) ListAvailableManagedRuleGroupVersions(ctx context.Context, params *ListAvailableManagedRuleGroupVersionsInput, optFns ...func(*Options)) (*ListAvailableManagedRuleGroupVersionsOutput, error) {
	if params == nil { params = &ListAvailableManagedRuleGroupVersionsInput{} }
...
func (c *Client) addOperationListAvailableManagedRuleGroupVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAvailableManagedRuleGroupVersionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAvailableManagedRuleGroupVersionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAvailableManagedRuleGroupVersionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAvailableManagedRuleGroupVersionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAvailableManagedRuleGroupVersionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAvailableManagedRuleGroupVersionsResolveEndpointMiddleware{
