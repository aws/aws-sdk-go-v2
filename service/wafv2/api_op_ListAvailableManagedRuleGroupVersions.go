...
func (c *Client) addOperationListAvailableManagedRuleGroupVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAvailableManagedRuleGroupVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
