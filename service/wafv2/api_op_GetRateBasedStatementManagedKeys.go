...
func (c *Client) GetRateBasedStatementManagedKeys(ctx context.Context, params *GetRateBasedStatementManagedKeysInput, optFns ...func(*Options)) (*GetRateBasedStatementManagedKeysOutput, error) {
	if params == nil { params = &GetRateBasedStatementManagedKeysInput{} }
...
func (c *Client) addOperationGetRateBasedStatementManagedKeysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRateBasedStatementManagedKeysResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRateBasedStatementManagedKeysResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRateBasedStatementManagedKeysResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRateBasedStatementManagedKeysResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRateBasedStatementManagedKeysResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRateBasedStatementManagedKeysResolveEndpointMiddleware{
