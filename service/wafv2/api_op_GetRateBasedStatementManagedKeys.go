...
func addOperationGetRateBasedStatementManagedKeysStackSlots(stack *middleware.Stack) error {
...
func addOperationGetRateBasedStatementManagedKeysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetRateBasedStatementManagedKeysStackSlots(stack); err != nil {
		return err
	}
