...
func (c *Client) addOperationDescribeAllManagedProductsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAllManagedProducts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
