...
func (c *Client) DescribeAllManagedProducts(ctx context.Context, params *DescribeAllManagedProductsInput, optFns ...func(*Options)) (*DescribeAllManagedProductsOutput, error) {
	if params == nil { params = &DescribeAllManagedProductsInput{} }
...
func (c *Client) addOperationDescribeAllManagedProductsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeAllManagedProductsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeAllManagedProductsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeAllManagedProductsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeAllManagedProductsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeAllManagedProductsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeAllManagedProductsResolveEndpointMiddleware{
