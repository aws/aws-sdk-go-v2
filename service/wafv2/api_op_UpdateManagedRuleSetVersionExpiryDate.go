...
func (c *Client) UpdateManagedRuleSetVersionExpiryDate(ctx context.Context, params *UpdateManagedRuleSetVersionExpiryDateInput, optFns ...func(*Options)) (*UpdateManagedRuleSetVersionExpiryDateOutput, error) {
	if params == nil { params = &UpdateManagedRuleSetVersionExpiryDateInput{} }
...
func (c *Client) addOperationUpdateManagedRuleSetVersionExpiryDateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateManagedRuleSetVersionExpiryDateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateManagedRuleSetVersionExpiryDateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateManagedRuleSetVersionExpiryDateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateManagedRuleSetVersionExpiryDateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateManagedRuleSetVersionExpiryDateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateManagedRuleSetVersionExpiryDateResolveEndpointMiddleware{
