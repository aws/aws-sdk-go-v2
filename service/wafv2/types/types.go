...
type ByteMatchStatement struct {
	...
	//   - JA3Fingerprint : The string to match against the web request's JA3
...
type FieldToMatch struct {
	...
	// Match against the request's JA3 fingerprint header. The header contains a hash
	// fingerprint of the TLS Client Hello packet for the request. You can use this
	// choice only with a string match ByteMatchStatement with the PositionalConstraint
	// set to EXACTLY .
