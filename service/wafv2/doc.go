...
// API, Application Load Balancer, AppSync GraphQL API, or Amazon Cognito user
// pool. WAF also lets you control access to your content, to protect the Amazon
// Web Services resource that WAF is monitoring. Based on conditions that you
...
// response. This API guide is for developers who need detailed information about
// WAF API actions, data types, and errors. For detailed information about WAF
