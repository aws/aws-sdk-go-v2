...
// and an overview of how to use AWS WAF, see the AWS WAF Developer Guide
...
// regional application can be an Application Load Balancer (ALB), an API Gateway
// REST API, or an AppSync GraphQL API.
//
//     * For AWS CloudFront applications, you
...
// more information, see AWS SDKs (http://aws.amazon.com/tools/#SDKs). We currently
...
//
//     * You use one API for both
// global and regional applications. Where you need to distinguish the scope, you
// specify a Scope parameter and set it to CLOUDFRONT or REGIONAL.
//
//     * You can
...
//
//     * The limits AWS WAF places on the use of
// rules more closely reflects the cost of running each type of rule. Rule groups
// include capacity settings, so you know the maximum cost of a rule group when you
// use it.
package wafv2
