...
//
// * For AWS CloudFront applications, you must use the
// API endpoint listed for US East (N. Virginia): us-east-1.
//
// Alternatively, you
// can use one of the AWS SDKs to access an API that's tailored to the programming
