...
// in the WAF Developer Guide. The CAPTCHA API requires a key that authorizes
// CAPTCHA use from the client application domain. You can use a single key for up
// to 5 domains. After you generate a key, you can copy it for use in your
