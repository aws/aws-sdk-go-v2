...
func (v *ListTagsForResourceOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.NextMarker != nil {
		s.WriteString(schemas.ListTagsForResourceResponse_NextMarker, *v.NextMarker)
	}
	if v.TagInfoForResource != nil {
		s.WriteStruct(schemas.ListTagsForResourceResponse_TagInfoForResource)
		v.TagInfoForResource.SerializeMembers(s)
		s.CloseStruct()
	}
}
