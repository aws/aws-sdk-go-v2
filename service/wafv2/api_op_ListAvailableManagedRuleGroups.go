...
func addOperationListAvailableManagedRuleGroupsStackSlots(stack *middleware.Stack) error {
...
func addOperationListAvailableManagedRuleGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListAvailableManagedRuleGroupsStackSlots(stack); err != nil {
		return err
	}
