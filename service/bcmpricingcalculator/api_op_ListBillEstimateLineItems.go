...
func (c *Client) addOperationListBillEstimateLineItemsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListBillEstimateLineItems", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
