...
func (c *Client) ListBillScenarioUsageModifications(ctx context.Context, params *ListBillScenarioUsageModificationsInput, optFns ...func(*Options)) (*ListBillScenarioUsageModificationsOutput, error) {
	if params == nil {
		params = &ListBillScenarioUsageModificationsInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "ListBillScenarioUsageModifications", params, optFns, c.addOperationListBillScenarioUsageModificationsMiddlewares)
	if err != nil {
		return nil, err
	}
...
func (v *ListBillScenarioUsageModificationsOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListBillScenarioUsageModificationsResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ListBillScenarioUsageModificationsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	serializeBillScenarioUsageModificationItems(s, schemas.ListBillScenarioUsageModificationsResponse_items, v.Items)
	if v.NextToken != nil {
		s.WriteString(schemas.ListBillScenarioUsageModificationsResponse_nextToken, *v.NextToken)
	}
}
...
func (c *Client) addOperationListBillScenarioUsageModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addOpListBillScenarioUsageModificationsValidationMiddleware(stack); err != nil {
		return err
	}
...
// ListBillScenarioUsageModificationsPaginatorOptions is the paginator options for
...
// ListBillScenarioUsageModificationsPaginator is a paginator for
// ListBillScenarioUsageModifications
type ListBillScenarioUsageModificationsPaginator struct {
	options   ListBillScenarioUsageModificationsPaginatorOptions
	client    ListBillScenarioUsageModificationsAPIClient
	params    *ListBillScenarioUsageModificationsInput
	nextToken *string
	firstPage bool
}

// NewListBillScenarioUsageModificationsPaginator returns a new
// ListBillScenarioUsageModificationsPaginator
func NewListBillScenarioUsageModificationsPaginator(client ListBillScenarioUsageModificationsAPIClient, params *ListBillScenarioUsageModificationsInput, optFns ...func(*ListBillScenarioUsageModificationsPaginatorOptions)) *ListBillScenarioUsageModificationsPaginator {
	if params == nil {
		params = &ListBillScenarioUsageModificationsInput{}
	}
	...
	return &ListBillScenarioUsageModificationsPaginator{
		options:   options,
		client:    client,
		params:    params,
		firstPage: true,
...
func (p *ListBillScenarioUsageModificationsPaginator) HasMorePages() bool {
	return p.firstPage || (p.nextToken != nil && len(*p.nextToken) != 0)
}

// NextPage retrieves the next ListBillScenarioUsageModifications page.
func (p *ListBillScenarioUsageModificationsPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*ListBillScenarioUsageModificationsOutput, error) {
	if !p.HasMorePages() {
	...
	result, err := p.client.ListBillScenarioUsageModifications(ctx, &params, optFns...)
	if err != nil {
		return nil, err
	}
	p.firstPage = false
...
// ListBillScenarioUsageModificationsAPIClient is a client that implements the
// ListBillScenarioUsageModifications operation.
...
var _ ListBillScenarioUsageModificationsAPIClient = (*Client)(nil)
