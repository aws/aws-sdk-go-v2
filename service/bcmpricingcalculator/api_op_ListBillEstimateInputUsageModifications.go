...
func (c *Client) addOperationListBillEstimateInputUsageModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListBillEstimateInputUsageModifications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
