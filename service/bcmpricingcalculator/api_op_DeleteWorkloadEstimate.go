...
func (c *Client) DeleteWorkloadEstimate(ctx context.Context, params *DeleteWorkloadEstimateInput, optFns ...func(*Options)) (*DeleteWorkloadEstimateOutput, error) {
	if params == nil { params = &DeleteWorkloadEstimateInput{} }
...
func (c *Client) addOperationDeleteWorkloadEstimateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err != nil { return err }
	if err := addProtocolFinalizerMiddlewares(stack, options, "DeleteWorkloadEstimate"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteWorkloadEstimate(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opDeleteWorkloadEstimate(region string) *awsmiddleware.RegisterServiceMetadata {
