...
func (c *Client) addOperationListBillScenarioCommitmentModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListBillScenarioCommitmentModifications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
