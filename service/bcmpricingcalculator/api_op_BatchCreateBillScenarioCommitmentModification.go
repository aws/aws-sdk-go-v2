...
func (c *Client) addOperationBatchCreateBillScenarioCommitmentModificationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchCreateBillScenarioCommitmentModification", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
