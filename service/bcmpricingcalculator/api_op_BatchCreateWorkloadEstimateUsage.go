...
func (c *Client) addOperationBatchCreateWorkloadEstimateUsageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchCreateWorkloadEstimateUsage", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
