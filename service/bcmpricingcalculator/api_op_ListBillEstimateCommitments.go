...
func (c *Client) addOperationListBillEstimateCommitmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListBillEstimateCommitments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
