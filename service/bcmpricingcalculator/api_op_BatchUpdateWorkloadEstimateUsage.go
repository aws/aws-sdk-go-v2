...
func (c *Client) addOperationBatchUpdateWorkloadEstimateUsageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchUpdateWorkloadEstimateUsage", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
