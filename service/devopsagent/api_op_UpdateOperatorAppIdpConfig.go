...
func (c *Client) addOperationUpdateOperatorAppIdpConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateOperatorAppIdpConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
