...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-devops-agent.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-devops-agent.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-devops-agent.dev",
			expectURL:     aws.String("https://env-devops-agent.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-devops-agent.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-devops-agent.dev",
			expectURL:     aws.String("http://config-devops-agent.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-devops-agent.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-devops-agent.dev",
			clientEndpoint: aws.String("https://client-devops-agent.dev"),
			expectURL:      aws.String("https://client-devops-agent.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DEVOPS_AGENT", c.envService)
			}
