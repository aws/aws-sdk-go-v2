...
func (c *Client) GetAgentSpace(ctx context.Context, params *GetAgentSpaceInput, optFns ...func(*Options)) (*GetAgentSpaceOutput, error) {
	if params == nil { params = &GetAgentSpaceInput{} }
...
func (c *Client) addOperationGetAgentSpaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetAgentSpace(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opGetAgentSpace(region string) *awsmiddleware.RegisterServiceMetadata {
