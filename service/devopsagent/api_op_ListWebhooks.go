...
func (c *Client) addOperationListWebhooksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEndpointPrefix_opListWebhooksMiddleware(stack); err != nil {
		return err
	}
	if err = addOpListWebhooksValidationMiddleware(stack); err != nil {
		return err
	}
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListWebhooks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
...
type endpointPrefix_opListWebhooksMiddleware struct {
}

func (*endpointPrefix_opListWebhooksMiddleware) ID() string {
	return "EndpointHostPrefix"
}

func (m *endpointPrefix_opListWebhooksMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opListWebhooksMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opListWebhooksMiddleware{}, "ResolveEndpointV2", middleware.After)
}
