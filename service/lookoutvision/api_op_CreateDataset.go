...
// DatasetType. On the second call, specify test for the value of DatasetType. of
// dataset with
...
type CreateDatasetInput struct {
	...
	// ClientToken is considered a new call to CreateDataset. An idempotency token is
	// active for 8 hours.
	ClientToken *string
