...
type CreateDatasetInput struct {
	...
	// retry your call to CreateDataset  by using the same ClientToken parameter
	...
	// create the dataset. If you don't specify DatasetSource, an empty dataset is
	// created and the operation synchronously returns. Later, you can add JSON Lines
	// by calling UpdateDatasetEntries . If you specify a value for DataSource, the
