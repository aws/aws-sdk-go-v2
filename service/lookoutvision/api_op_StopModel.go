...
type StopModelInput struct {
	...
	// from getting a response from StopModel. In this case, safely retry your call
	// to StopModel  by using the same ClientToken parameter value. If you don't
	// supply a value for ClientToken, the AWS SDK you are using inserts a value for
	// you. This prevents retries after a network error from making multiple stop
	...
	// Using a different value for ClientToken  is considered a new call to StopModel
