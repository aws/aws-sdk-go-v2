...
func addOperationSetLoadBalancerPoliciesForBackendServerStackSlots(stack *middleware.Stack) error {
...
func addOperationSetLoadBalancerPoliciesForBackendServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationSetLoadBalancerPoliciesForBackendServerStackSlots(stack); err != nil {
		return err
	}
