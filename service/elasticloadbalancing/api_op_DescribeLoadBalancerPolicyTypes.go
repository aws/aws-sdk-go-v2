...
func (c *Client) addOperationDescribeLoadBalancerPolicyTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeLoadBalancerPolicyTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
