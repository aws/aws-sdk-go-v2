...
func addOperationCreateAppCookieStickinessPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateAppCookieStickinessPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateAppCookieStickinessPolicyStackSlots(stack); err != nil {
		return err
	}
