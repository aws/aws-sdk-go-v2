...
func (c *Client) addOperationDeleteLoadBalancerListenersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteLoadBalancerListeners", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
