...
func addOperationDeleteLoadBalancerListenersStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteLoadBalancerListenersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteLoadBalancerListenersStackSlots(stack); err != nil {
		return err
	}
