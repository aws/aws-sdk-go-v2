...
func (*DeleteLoadBalancerListenersInput) operationName() string {
...
func (c *Client) addOperationDeleteLoadBalancerListenersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteLoadBalancerListenersResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteLoadBalancerListenersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteLoadBalancerListenersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteLoadBalancerListenersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteLoadBalancerListenersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteLoadBalancerListenersResolveEndpointMiddleware{
