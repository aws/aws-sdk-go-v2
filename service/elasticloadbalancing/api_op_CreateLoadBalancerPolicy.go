...
func (c *Client) addOperationCreateLoadBalancerPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateLoadBalancerPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
