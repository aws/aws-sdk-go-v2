...
func (c *Client) addOperationDeleteLoadBalancerPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteLoadBalancerPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
