...
func addOperationAttachLoadBalancerToSubnetsStackSlots(stack *middleware.Stack) error {
...
func addOperationAttachLoadBalancerToSubnetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAttachLoadBalancerToSubnetsStackSlots(stack); err != nil {
		return err
	}
