...
func addOperationDisableAvailabilityZonesForLoadBalancerStackSlots(stack *middleware.Stack) error {
...
func addOperationDisableAvailabilityZonesForLoadBalancerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisableAvailabilityZonesForLoadBalancerStackSlots(stack); err != nil {
		return err
	}
