...
// for the specified load balancer in EC2-Classic or a default VPC. For load
// balancers in a non-default VPC, use DetachLoadBalancerFromSubnets. There must
// be at least one Availability Zone registered with a load balancer at all times.
...
// remaining Availability Zones. For more information, see Add or Remove
// Availability Zones (https://docs.aws.amazon.com/elasticloadbalancing/latest/classic/enable-disable-az.html)
