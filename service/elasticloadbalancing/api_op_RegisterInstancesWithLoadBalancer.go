...
func addOperationRegisterInstancesWithLoadBalancerStackSlots(stack *middleware.Stack) error {
...
func addOperationRegisterInstancesWithLoadBalancerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRegisterInstancesWithLoadBalancerStackSlots(stack); err != nil {
		return err
	}
