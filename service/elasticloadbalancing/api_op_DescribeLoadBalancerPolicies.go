...
func addOperationDescribeLoadBalancerPoliciesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeLoadBalancerPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeLoadBalancerPoliciesStackSlots(stack); err != nil {
		return err
	}
