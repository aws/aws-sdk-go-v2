...
func addOperationSetLoadBalancerListenerSSLCertificateStackSlots(stack *middleware.Stack) error {
...
func addOperationSetLoadBalancerListenerSSLCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationSetLoadBalancerListenerSSLCertificateStackSlots(stack); err != nil {
		return err
	}
