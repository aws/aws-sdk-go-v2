...
func addOperationSetLoadBalancerPoliciesOfListenerStackSlots(stack *middleware.Stack) error {
...
func addOperationSetLoadBalancerPoliciesOfListenerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationSetLoadBalancerPoliciesOfListenerStackSlots(stack); err != nil {
		return err
	}
