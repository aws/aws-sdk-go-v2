...
func (c *Client) SetLoadBalancerPoliciesOfListener(ctx context.Context, params *SetLoadBalancerPoliciesOfListenerInput, optFns ...func(*Options)) (*SetLoadBalancerPoliciesOfListenerOutput, error) {
	if params == nil { params = &SetLoadBalancerPoliciesOfListenerInput{} }
...
func (c *Client) addOperationSetLoadBalancerPoliciesOfListenerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetLoadBalancerPoliciesOfListenerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetLoadBalancerPoliciesOfListenerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetLoadBalancerPoliciesOfListenerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetLoadBalancerPoliciesOfListenerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetLoadBalancerPoliciesOfListenerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetLoadBalancerPoliciesOfListenerResolveEndpointMiddleware{
