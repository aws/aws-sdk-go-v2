...
// Elastic Load Balancing  <p>A load balancer can distribute incoming traffic
...
// connections from the load balancer to the instances.</p> <p>Elastic Load
...
// balancer based on your application needs. For more information, see the <a
...
func addClientUserAgent(stack *middleware.Stack) {
	awsmiddleware.AddUserAgentKey("elasticloadbalancing")(stack)
}
