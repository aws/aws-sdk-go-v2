...
func (c *Client) DetachLoadBalancerFromSubnets(ctx context.Context, params *DetachLoadBalancerFromSubnetsInput, optFns ...func(*Options)) (*DetachLoadBalancerFromSubnetsOutput, error) {
	if params == nil { params = &DetachLoadBalancerFromSubnetsInput{} }
...
func (c *Client) addOperationDetachLoadBalancerFromSubnetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDetachLoadBalancerFromSubnetsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDetachLoadBalancerFromSubnetsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDetachLoadBalancerFromSubnetsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDetachLoadBalancerFromSubnetsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDetachLoadBalancerFromSubnetsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDetachLoadBalancerFromSubnetsResolveEndpointMiddleware{
