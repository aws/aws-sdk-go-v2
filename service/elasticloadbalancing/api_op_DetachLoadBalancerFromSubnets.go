...
func addOperationDetachLoadBalancerFromSubnetsStackSlots(stack *middleware.Stack) error {
...
func addOperationDetachLoadBalancerFromSubnetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDetachLoadBalancerFromSubnetsStackSlots(stack); err != nil {
		return err
	}
