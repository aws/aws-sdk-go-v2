...
func (c *Client) ApplySecurityGroupsToLoadBalancer(ctx context.Context, params *ApplySecurityGroupsToLoadBalancerInput, optFns ...func(*Options)) (*ApplySecurityGroupsToLoadBalancerOutput, error) {
	if params == nil { params = &ApplySecurityGroupsToLoadBalancerInput{} }
...
func (c *Client) addOperationApplySecurityGroupsToLoadBalancerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addApplySecurityGroupsToLoadBalancerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opApplySecurityGroupsToLoadBalancerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opApplySecurityGroupsToLoadBalancerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opApplySecurityGroupsToLoadBalancerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addApplySecurityGroupsToLoadBalancerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opApplySecurityGroupsToLoadBalancerResolveEndpointMiddleware{
