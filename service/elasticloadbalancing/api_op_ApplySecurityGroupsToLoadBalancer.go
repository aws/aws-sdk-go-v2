...
func (c *Client) addOperationApplySecurityGroupsToLoadBalancerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ApplySecurityGroupsToLoadBalancer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
