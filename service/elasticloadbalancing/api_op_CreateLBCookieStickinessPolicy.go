...
func addOperationCreateLBCookieStickinessPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateLBCookieStickinessPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateLBCookieStickinessPolicyStackSlots(stack); err != nil {
		return err
	}
