...
func (c *Client) addOperationCreateLBCookieStickinessPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateLBCookieStickinessPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
