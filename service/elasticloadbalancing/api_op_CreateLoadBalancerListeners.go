...
func (c *Client) addOperationCreateLoadBalancerListenersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateLoadBalancerListeners", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
