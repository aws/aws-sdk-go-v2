...
func addOperationCreateLoadBalancerListenersStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateLoadBalancerListenersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateLoadBalancerListenersStackSlots(stack); err != nil {
		return err
	}
