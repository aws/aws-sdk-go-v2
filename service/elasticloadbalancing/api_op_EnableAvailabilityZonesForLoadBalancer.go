...
func addOperationEnableAvailabilityZonesForLoadBalancerStackSlots(stack *middleware.Stack) error {
...
func addOperationEnableAvailabilityZonesForLoadBalancerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationEnableAvailabilityZonesForLoadBalancerStackSlots(stack); err != nil {
		return err
	}
