...
func (c *Client) EnableAvailabilityZonesForLoadBalancer(ctx context.Context, params *EnableAvailabilityZonesForLoadBalancerInput, optFns ...func(*Options)) (*EnableAvailabilityZonesForLoadBalancerOutput, error) {
	if params == nil { params = &EnableAvailabilityZonesForLoadBalancerInput{} }
...
func (c *Client) addOperationEnableAvailabilityZonesForLoadBalancerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableAvailabilityZonesForLoadBalancerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEnableAvailabilityZonesForLoadBalancerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEnableAvailabilityZonesForLoadBalancerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableAvailabilityZonesForLoadBalancerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableAvailabilityZonesForLoadBalancerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEnableAvailabilityZonesForLoadBalancerResolveEndpointMiddleware{
