...
func addOperationDeregisterInstancesFromLoadBalancerStackSlots(stack *middleware.Stack) error {
...
func addOperationDeregisterInstancesFromLoadBalancerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeregisterInstancesFromLoadBalancerStackSlots(stack); err != nil {
		return err
	}
