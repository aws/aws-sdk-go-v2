...
func (c *Client) GetForm(ctx context.Context, params *GetFormInput, optFns ...func(*Options)) (*GetFormOutput, error) {
	if params == nil { params = &GetFormInput{} }
...
func (c *Client) addOperationGetFormMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFormResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetFormResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetFormResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFormResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFormResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetFormResolveEndpointMiddleware{
