...
func (c *Client) ExportThemes(ctx context.Context, params *ExportThemesInput, optFns ...func(*Options)) (*ExportThemesOutput, error) {
	if params == nil { params = &ExportThemesInput{} }
...
func (c *Client) addOperationExportThemesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addExportThemesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opExportThemesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opExportThemesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opExportThemesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addExportThemesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opExportThemesResolveEndpointMiddleware{
