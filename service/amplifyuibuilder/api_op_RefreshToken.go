...
func (c *Client) RefreshToken(ctx context.Context, params *RefreshTokenInput, optFns ...func(*Options)) (*RefreshTokenOutput, error) {
	if params == nil { params = &RefreshTokenInput{} }
...
func (c *Client) addOperationRefreshTokenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRefreshTokenResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRefreshTokenResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRefreshTokenResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRefreshTokenResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRefreshTokenResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRefreshTokenResolveEndpointMiddleware{
