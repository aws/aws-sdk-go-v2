...
func (*DeleteFormInput) operationName() string {
	return "DeleteForm"
}
...
func (c *Client) addOperationDeleteFormMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteFormResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteFormResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteFormResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteFormResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteFormResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteFormResolveEndpointMiddleware{
