...
func (c *Client) ExchangeCodeForToken(ctx context.Context, params *ExchangeCodeForTokenInput, optFns ...func(*Options)) (*ExchangeCodeForTokenOutput, error) {
	if params == nil { params = &ExchangeCodeForTokenInput{} }
...
func (c *Client) addOperationExchangeCodeForTokenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addExchangeCodeForTokenResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opExchangeCodeForTokenResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opExchangeCodeForTokenResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opExchangeCodeForTokenResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addExchangeCodeForTokenResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opExchangeCodeForTokenResolveEndpointMiddleware{
