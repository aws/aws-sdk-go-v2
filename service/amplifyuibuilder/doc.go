...
// application's backend Amazon Web Services resources. You can also use the
// Amplify Studio visual designer to create UI components and model data for an
// app. For more information, see Introduction
// (https://docs.amplify.aws/console/adminui/intro) in the Amplify Docs. The
...
// Amplify application to Amazon Web Services, see the Amplify Console User Guide
