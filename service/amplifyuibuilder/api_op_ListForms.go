...
func (c *Client) ListForms(ctx context.Context, params *ListFormsInput, optFns ...func(*Options)) (*ListFormsOutput, error) {
	if params == nil { params = &ListFormsInput{} }
...
func (c *Client) addOperationListFormsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFormsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListFormsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListFormsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFormsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFormsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListFormsResolveEndpointMiddleware{
