...
func (c *Client) GetMetadata(ctx context.Context, params *GetMetadataInput, optFns ...func(*Options)) (*GetMetadataOutput, error) {
	if params == nil { params = &GetMetadataInput{} }
...
func (c *Client) addOperationGetMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMetadataResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetMetadataResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetMetadataResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMetadataResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMetadataResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetMetadataResolveEndpointMiddleware{
