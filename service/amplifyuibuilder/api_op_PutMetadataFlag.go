...
func (c *Client) PutMetadataFlag(ctx context.Context, params *PutMetadataFlagInput, optFns ...func(*Options)) (*PutMetadataFlagOutput, error) {
	if params == nil { params = &PutMetadataFlagInput{} }
...
func (c *Client) addOperationPutMetadataFlagMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutMetadataFlagResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutMetadataFlagResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutMetadataFlagResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutMetadataFlagResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutMetadataFlagResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutMetadataFlagResolveEndpointMiddleware{
