...
func (c *Client) ListFHIRDatastores(ctx context.Context, params *ListFHIRDatastoresInput, optFns ...func(*Options)) (*ListFHIRDatastoresOutput, error) {
	if params == nil { params = &ListFHIRDatastoresInput{} }
...
func (c *Client) addOperationListFHIRDatastoresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFHIRDatastoresResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListFHIRDatastoresResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListFHIRDatastoresResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFHIRDatastoresResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFHIRDatastoresResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListFHIRDatastoresResolveEndpointMiddleware{
