...
func (c *Client) addOperationUpdateGatewaySoftwareNowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateGatewaySoftwareNow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
