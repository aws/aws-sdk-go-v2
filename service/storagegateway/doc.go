...
// upload data to the Cloud for cost effective backup and rapid disaster recovery.
...
// Region and the endpoints available for use with Storage Gateway.
//
// Storage
...
// Gateway the ID for a volume might be vol-AA22BB012345DAF670. When you use this
// ID with the EC2 API, you must change it to vol-aa22bb012345daf670. Otherwise,
// the EC2 API might not behave as expected. IDs for Storage Gateway volumes and
...
// (http://aws.amazon.com/ec2/faqs/#longer-ids). For example, a volume Amazon
// Resource Name (ARN) with the longer volume ID format looks like the following:
