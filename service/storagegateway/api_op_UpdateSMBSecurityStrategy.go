...
func (c *Client) addOperationUpdateSMBSecurityStrategyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateSMBSecurityStrategy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
