...
func (c *Client) addOperationUpdateSMBFileShareVisibilityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateSMBFileShareVisibility", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
