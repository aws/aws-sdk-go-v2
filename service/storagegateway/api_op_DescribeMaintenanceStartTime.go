...
func addOperationDescribeMaintenanceStartTimeStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeMaintenanceStartTimeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeMaintenanceStartTimeStackSlots(stack); err != nil {
		return err
	}
