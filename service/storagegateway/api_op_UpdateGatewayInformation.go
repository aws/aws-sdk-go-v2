...
func (c *Client) addOperationUpdateGatewayInformationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateGatewayInformation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
