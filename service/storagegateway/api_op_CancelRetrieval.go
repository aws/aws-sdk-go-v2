...
func (c *Client) CancelRetrieval(ctx context.Context, params *CancelRetrievalInput, optFns ...func(*Options)) (*CancelRetrievalOutput, error) {
	if params == nil { params = &CancelRetrievalInput{} }
...
func (c *Client) addOperationCancelRetrievalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelRetrievalResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelRetrievalResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelRetrievalResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelRetrievalResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelRetrievalResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelRetrievalResolveEndpointMiddleware{
