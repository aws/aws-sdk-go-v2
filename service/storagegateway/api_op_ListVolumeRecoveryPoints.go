...
func (c *Client) ListVolumeRecoveryPoints(ctx context.Context, params *ListVolumeRecoveryPointsInput, optFns ...func(*Options)) (*ListVolumeRecoveryPointsOutput, error) {
	if params == nil { params = &ListVolumeRecoveryPointsInput{} }
...
func (c *Client) addOperationListVolumeRecoveryPointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListVolumeRecoveryPointsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListVolumeRecoveryPointsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListVolumeRecoveryPointsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListVolumeRecoveryPointsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListVolumeRecoveryPointsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListVolumeRecoveryPointsResolveEndpointMiddleware{
