...
type DescribeSMBSettingsOutput struct {
	...
	// - MandatorySigning: If you use this option, file
	...
	// - MandatoryEncryption: If you use this option, file
	// gateway only allows connections from SMBv3 clients that have encryption enabled.
	// This option is highly recommended for environments that handle sensitive data.
	// This option works with SMB clients on Microsoft Windows 8, Windows Server 2012
	// or newer.
