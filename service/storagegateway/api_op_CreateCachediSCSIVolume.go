...
func (c *Client) addOperationCreateCachediSCSIVolumeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCachediSCSIVolume", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
