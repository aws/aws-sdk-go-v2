...
func (c *Client) addOperationStartAvailabilityMonitorTestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartAvailabilityMonitorTest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
