...
func (*StartAvailabilityMonitorTestInput) operationName() string {
...
func (c *Client) addOperationStartAvailabilityMonitorTestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartAvailabilityMonitorTestResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStartAvailabilityMonitorTestResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStartAvailabilityMonitorTestResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartAvailabilityMonitorTestResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartAvailabilityMonitorTestResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStartAvailabilityMonitorTestResolveEndpointMiddleware{
