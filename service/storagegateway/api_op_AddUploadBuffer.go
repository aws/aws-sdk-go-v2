...
func (c *Client) AddUploadBuffer(ctx context.Context, params *AddUploadBufferInput, optFns ...func(*Options)) (*AddUploadBufferOutput, error) {
	if params == nil { params = &AddUploadBufferInput{} }
...
func (c *Client) addOperationAddUploadBufferMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAddUploadBufferResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAddUploadBufferResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAddUploadBufferResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAddUploadBufferResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAddUploadBufferResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAddUploadBufferResolveEndpointMiddleware{
