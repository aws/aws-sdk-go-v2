...
func (c *Client) addOperationDescribeCachediSCSIVolumesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCachediSCSIVolumes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
