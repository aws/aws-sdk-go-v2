...
func (c *Client) addOperationDescribeBandwidthRateLimitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeBandwidthRateLimit", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
