...
func (c *Client) SetLocalConsolePassword(ctx context.Context, params *SetLocalConsolePasswordInput, optFns ...func(*Options)) (*SetLocalConsolePasswordOutput, error) {
	if params == nil { params = &SetLocalConsolePasswordInput{} }
...
func (c *Client) addOperationSetLocalConsolePasswordMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetLocalConsolePasswordResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetLocalConsolePasswordResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetLocalConsolePasswordResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetLocalConsolePasswordResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetLocalConsolePasswordResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetLocalConsolePasswordResolveEndpointMiddleware{
