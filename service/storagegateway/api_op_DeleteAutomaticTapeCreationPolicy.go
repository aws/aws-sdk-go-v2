...
func addOperationDeleteAutomaticTapeCreationPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteAutomaticTapeCreationPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteAutomaticTapeCreationPolicyStackSlots(stack); err != nil {
		return err
	}
