...
func addOperationListAutomaticTapeCreationPoliciesStackSlots(stack *middleware.Stack) error {
...
func addOperationListAutomaticTapeCreationPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListAutomaticTapeCreationPoliciesStackSlots(stack); err != nil {
		return err
	}
