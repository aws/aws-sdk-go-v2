...
func (c *Client) ListAutomaticTapeCreationPolicies(ctx context.Context, params *ListAutomaticTapeCreationPoliciesInput, optFns ...func(*Options)) (*ListAutomaticTapeCreationPoliciesOutput, error) {
	if params == nil { params = &ListAutomaticTapeCreationPoliciesInput{} }
...
func (c *Client) addOperationListAutomaticTapeCreationPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAutomaticTapeCreationPoliciesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAutomaticTapeCreationPoliciesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAutomaticTapeCreationPoliciesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAutomaticTapeCreationPoliciesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAutomaticTapeCreationPoliciesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAutomaticTapeCreationPoliciesResolveEndpointMiddleware{
