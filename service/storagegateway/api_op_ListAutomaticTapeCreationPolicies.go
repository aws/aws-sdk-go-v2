...
func (c *Client) addOperationListAutomaticTapeCreationPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAutomaticTapeCreationPolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
