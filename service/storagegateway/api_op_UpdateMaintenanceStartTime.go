...
func addOperationUpdateMaintenanceStartTimeStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateMaintenanceStartTimeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateMaintenanceStartTimeStackSlots(stack); err != nil {
		return err
	}
