...
func (c *Client) StartGateway(ctx context.Context, params *StartGatewayInput, optFns ...func(*Options)) (*StartGatewayOutput, error) {
	stack := middleware.NewStack("StartGateway", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpStartGatewayMiddlewares(stack)
	...
	addOpStartGatewayValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opStartGateway(options.Region), middleware.Before)
...
func addawsAwsjson11_serdeOpStartGatewayMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpStartGateway{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpStartGateway{}, middleware.After)
}
