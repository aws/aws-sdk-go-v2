...
func (*DeleteTapeArchiveInput) operationName() string {
...
func (c *Client) addOperationDeleteTapeArchiveMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteTapeArchiveResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteTapeArchiveResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteTapeArchiveResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteTapeArchiveResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteTapeArchiveResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteTapeArchiveResolveEndpointMiddleware{
