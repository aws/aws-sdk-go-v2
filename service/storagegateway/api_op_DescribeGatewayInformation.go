...
func (c *Client) addOperationDescribeGatewayInformationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeGatewayInformation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
