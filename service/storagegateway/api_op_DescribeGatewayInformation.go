...
func addOperationDescribeGatewayInformationStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeGatewayInformationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeGatewayInformationStackSlots(stack); err != nil {
		return err
	}
