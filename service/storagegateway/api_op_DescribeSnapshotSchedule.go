...
func (c *Client) addOperationDescribeSnapshotScheduleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSnapshotSchedule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
