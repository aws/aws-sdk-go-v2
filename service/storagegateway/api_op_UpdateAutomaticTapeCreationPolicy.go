...
func (*UpdateAutomaticTapeCreationPolicyInput) operationName() string {
...
func (c *Client) addOperationUpdateAutomaticTapeCreationPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateAutomaticTapeCreationPolicyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateAutomaticTapeCreationPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateAutomaticTapeCreationPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateAutomaticTapeCreationPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateAutomaticTapeCreationPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateAutomaticTapeCreationPolicyResolveEndpointMiddleware{
