...
// interface. This operation is only supported for S3 File Gateways. S3 File
// Gateways require Security Token Service (Amazon Web Services STS) to be
...
type CreateSMBFileShareInput struct {
	...
	// , @group1 , and @DOMAIN\group1. Use this option very carefully, because any
	// user in this list can do anything they like on the file share, regardless of
	// file permissions.
