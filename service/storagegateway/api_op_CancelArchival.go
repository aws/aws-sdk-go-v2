...
func (c *Client) CancelArchival(ctx context.Context, params *CancelArchivalInput, optFns ...func(*Options)) (*CancelArchivalOutput, error) {
	if params == nil { params = &CancelArchivalInput{} }
...
func (c *Client) addOperationCancelArchivalMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelArchivalResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelArchivalResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelArchivalResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelArchivalResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelArchivalResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelArchivalResolveEndpointMiddleware{
