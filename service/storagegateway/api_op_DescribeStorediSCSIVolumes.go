...
func (c *Client) addOperationDescribeStorediSCSIVolumesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeStorediSCSIVolumes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
