...
type DescribeStorediSCSIVolumesOutput struct {
	...
	// this field contains the snapshot ID used, e.g. snap-1122aabb. Otherwise, this
	// field is not included.
	// - StorediSCSIVolumes: An array of StorediSCSIVolume
	// objects where each object contains metadata about one stored volume.
	// -
	// TargetARN: The Amazon Resource Name (ARN) of the volume target.
	// - VolumeARN: The
	// Amazon Resource Name (ARN) of the stored volume.
	// - VolumeDiskId: The disk ID of
	// the local disk that was specified in the CreateStorediSCSIVolume operation.
	// -
	...
	// VolumeStatus values that indicates the state of the volume.
	// - VolumeType: One of
	// the enumeration values describing the type of the volume. Currently, only STORED
