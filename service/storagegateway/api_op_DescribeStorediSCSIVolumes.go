...
type DescribeStorediSCSIVolumesOutput struct {
	...
	// fields are returned:
	//
	//     * ChapEnabled: Indicates whether mutual CHAP is
	...
	//
	//     * SourceSnapshotId: If the stored volume was
	...
	//
	//     * VolumeId: The unique identifier of
	// the storage volume, e.g. vol-1122AABB.
	//
	//     * VolumeiSCSIAttributes: An
	// VolumeiSCSIAttributes object that represents a collection of iSCSI attributes
	// for one stored volume.
	//
	//     * VolumeProgress: Represents the percentage complete
	...
	//
	//     * VolumeSizeInBytes: The size of the volume
	// in bytes.
	//
	//     * VolumeStatus: One of the VolumeStatus values that indicates the
	// state of the volume.
	//
	//     * VolumeType: One of the enumeration values describing
	// the type of the volume. Currently, only STORED volumes are supported.
...
func addOperationDescribeStorediSCSIVolumesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeStorediSCSIVolumesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeStorediSCSIVolumesStackSlots(stack); err != nil {
		return err
	}
