...
func (c *Client) addOperationUpdateBandwidthRateLimitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateBandwidthRateLimit", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
