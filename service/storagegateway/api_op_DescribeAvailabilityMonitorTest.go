...
func (c *Client) DescribeAvailabilityMonitorTest(ctx context.Context, params *DescribeAvailabilityMonitorTestInput, optFns ...func(*Options)) (*DescribeAvailabilityMonitorTestOutput, error) {
	if params == nil { params = &DescribeAvailabilityMonitorTestInput{} }
...
func (c *Client) addOperationDescribeAvailabilityMonitorTestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeAvailabilityMonitorTestResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeAvailabilityMonitorTestResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeAvailabilityMonitorTestResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeAvailabilityMonitorTestResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeAvailabilityMonitorTestResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeAvailabilityMonitorTestResolveEndpointMiddleware{
