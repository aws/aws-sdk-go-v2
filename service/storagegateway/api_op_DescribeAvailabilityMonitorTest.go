...
func (c *Client) addOperationDescribeAvailabilityMonitorTestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAvailabilityMonitorTest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
