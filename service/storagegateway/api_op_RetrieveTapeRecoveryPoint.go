...
func (c *Client) addOperationRetrieveTapeRecoveryPointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RetrieveTapeRecoveryPoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
