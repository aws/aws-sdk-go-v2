...
func addOperationCreateSnapshotFromVolumeRecoveryPointStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateSnapshotFromVolumeRecoveryPointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateSnapshotFromVolumeRecoveryPointStackSlots(stack); err != nil {
		return err
	}
