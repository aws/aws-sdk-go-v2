...
func (c *Client) addOperationCreateSnapshotFromVolumeRecoveryPointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateSnapshotFromVolumeRecoveryPoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
