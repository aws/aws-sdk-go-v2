...
func TestSerdeCheckSnapshot_GetBuyerDashboard(t *testing.T) {
	...
	header := map[string][]string{}
	svc := serdeNewClient()
	_, err := svc.GetBuyerDashboard(context.Background(), input, func(o *Options) {
	...
	if err := serdeTestSnapshot(method, rawPath, rawQuery, header, body.Bytes(), "GetBuyerDashboard"); err != nil {
		if err != nil && !strings.Contains(err.Error(), "error: success") {
			t.Fatal(err)
		}
	}
}
func TestSerdeUpdateSnapshot_GetBuyerDashboard(t *testing.T) {
	input := &GetBuyerDashboardInput{
		DashboardIdentifier: ptr.String("__DashboardIdentifier__"),
		EmbeddingDomains: []string{
			"__Member__",
	...
	if err := serdeUpdateSnapshot(method, rawPath, rawQuery, header, body.Bytes(), "GetBuyerDashboard"); err != nil {
		if err != nil && !strings.Contains(err.Error(), "error: success") {
			t.Fatal(err)
		}
	}
