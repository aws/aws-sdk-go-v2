...
func TestCheckResponseSnapshot_GetBuyerDashboard(t *testing.T) {
	want := &GetBuyerDashboardOutput{
	...
	status, header, body, err := serdeRespReadSnapshot("GetBuyerDashboard.response")
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "GetBuyerDashboard.response", err)
	}
}
