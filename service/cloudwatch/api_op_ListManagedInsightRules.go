...
func (c *Client) addOperationListManagedInsightRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListManagedInsightRules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
