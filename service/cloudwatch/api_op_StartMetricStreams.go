...
type StartMetricStreamsInput struct {
	...
	// The array of the names of metric streams to start streaming. This is an "all
	// or nothing" operation. If you do not have permission to access all of the metric
