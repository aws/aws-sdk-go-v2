...
func (c *Client) addOperationDescribeAlarmsForMetricMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAlarmsForMetric", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
