...
type PutCompositeAlarmInput struct {
	...
	// AlarmRule structure, and for testing your alarm actions. Alarm names specified
	// in AlarmRule can be surrounded with double-quotes ("), but do not have to be.
	// The following are some examples of AlarmRule:
	// - ALARM(CPUUtilizationTooHigh) AND
	// ALARM(DiskReadOpsTooHigh) specifies that the composite alarm goes into ALARM
	// state only if both CPUUtilizationTooHigh and DiskReadOpsTooHigh alarms are in
	// ALARM state.
