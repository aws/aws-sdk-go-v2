...
// and applications. CloudWatch alarms send notifications or automatically change
// the resources you are monitoring based on rules that you define. For example,
...
// instances to handle increased load. You can also use this data to stop
// under-used instances to save money. In addition to monitoring the built-in
// metrics that come with AWS, you can monitor your own custom metrics. With
