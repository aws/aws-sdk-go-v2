...
// vertical annotations. There is a limit of 20 transactions per second for this
// API. Each GetMetricWidgetImage  action has the following limits:
...
type GetMetricWidgetImageInput struct {
	...
	// axis limits, and so on. You can include only one MetricWidget parameter in
	// each GetMetricWidgetImage  call. For more information about the syntax of
	// MetricWidget see GetMetricWidgetImage: Metric Widget Structure and Syntax (https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/CloudWatch-Metric-Widget-Structure.html)
	...
	// cases, and all actions using an Amazon Web Services SDK, you should use png.
