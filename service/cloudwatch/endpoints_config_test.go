...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cloudwatch.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudwatch.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudwatch.dev",
			expectURL:     aws.String("https://env-cloudwatch.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cloudwatch.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudwatch.dev",
			expectURL:     aws.String("http://config-cloudwatch.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cloudwatch.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cloudwatch.dev",
			clientEndpoint: aws.String("https://client-cloudwatch.dev"),
			expectURL:      aws.String("https://client-cloudwatch.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CLOUDWATCH", c.envService)
			}
