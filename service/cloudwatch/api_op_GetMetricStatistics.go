...
//
// Percentile
// statistics are not available for metrics when any of the metric values are
// negative numbers. Amazon CloudWatch retains metric data as follows:
...
type GetMetricStatisticsInput struct {
	...
	// specified when the data was reported to CloudWatch. If you specify a unit, the
	// operation returns only data that was collected with that unit specified. If you
