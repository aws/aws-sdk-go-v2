...
func (c *Client) addOperationDisassociateDatasetKmsKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateDatasetKmsKey", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
