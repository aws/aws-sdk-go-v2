...
func (c *Client) addOperationDescribeAlarmContributorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAlarmContributors", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
