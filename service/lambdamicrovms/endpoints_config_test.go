...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-lambda-microvms.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lambda-microvms.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lambda-microvms.dev",
			expectURL:     aws.String("https://env-lambda-microvms.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-lambda-microvms.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lambda-microvms.dev",
			expectURL:     aws.String("http://config-lambda-microvms.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-lambda-microvms.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-lambda-microvms.dev",
			clientEndpoint: aws.String("https://client-lambda-microvms.dev"),
			expectURL:      aws.String("https://client-lambda-microvms.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_LAMBDA_MICROVMS", c.envService)
			}
