...
func (c *Client) addOperationUpdateMicrovmImageVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "UpdateMicrovmImageVersion"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opUpdateMicrovmImageVersion(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opUpdateMicrovmImageVersion(region string) *awsmiddleware.RegisterServiceMetadata {
