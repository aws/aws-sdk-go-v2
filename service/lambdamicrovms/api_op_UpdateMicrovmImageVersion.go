...
func (c *Client) addOperationUpdateMicrovmImageVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateMicrovmImageVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
