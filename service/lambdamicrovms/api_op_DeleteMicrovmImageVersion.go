...
func (c *Client) addOperationDeleteMicrovmImageVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteMicrovmImageVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
