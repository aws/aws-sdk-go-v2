...
func (c *Client) addOperationRunMicrovmMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "RunMicrovm"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opRunMicrovm(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opRunMicrovm(region string) *awsmiddleware.RegisterServiceMetadata {
