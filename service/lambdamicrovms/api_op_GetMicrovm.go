...
func (c *Client) addOperationGetMicrovmMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "GetMicrovm"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetMicrovm(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opGetMicrovm(region string) *awsmiddleware.RegisterServiceMetadata {
