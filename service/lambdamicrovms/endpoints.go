...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/lambdamicrovms/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_LAMBDA_MICROVMS")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Lambda Microvms", cfg.ConfigSources)
	if found && err == nil {
