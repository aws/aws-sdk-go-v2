...
func (c *Client) addOperationGetGuestUserHistoryCountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetGuestUserHistoryCount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
