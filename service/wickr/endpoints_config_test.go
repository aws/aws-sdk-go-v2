...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-wickr.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-wickr.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-wickr.dev",
			expectURL:     aws.String("https://env-wickr.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-wickr.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-wickr.dev",
			expectURL:     aws.String("http://config-wickr.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-wickr.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-wickr.dev",
			clientEndpoint: aws.String("https://client-wickr.dev"),
			expectURL:      aws.String("https://client-wickr.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_WICKR", c.envService)
			}
