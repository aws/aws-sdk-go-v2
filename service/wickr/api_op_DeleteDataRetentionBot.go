...
func (c *Client) DeleteDataRetentionBot(ctx context.Context, params *DeleteDataRetentionBotInput, optFns ...func(*Options)) (*DeleteDataRetentionBotOutput, error) {
	if params == nil { params = &DeleteDataRetentionBotInput{} }
	
	result, metadata, err := c.invokeOperation(ctx, "DeleteDataRetentionBot", params, optFns, c.addOperationDeleteDataRetentionBotMiddlewares)
	if err != nil { return nil, err }
	
	out := result.(*DeleteDataRetentionBotOutput)
	out.ResultMetadata = metadata
	return out, nil
}

type DeleteDataRetentionBotInput struct {
...
func (c *Client) addOperationDeleteDataRetentionBotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addOpDeleteDataRetentionBotValidationMiddleware(stack); err != nil {
	return err
	}
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteDataRetentionBot(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opDeleteDataRetentionBot(region string) *awsmiddleware.RegisterServiceMetadata {
