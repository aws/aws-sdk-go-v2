...
type awsRestjson1_deserializeOpGetOpentdfConfig struct {
}

func (*awsRestjson1_deserializeOpGetOpentdfConfig) ID() string {
	return "OperationDeserializer"
}

func (m *awsRestjson1_deserializeOpGetOpentdfConfig) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsRestjson1_deserializeOpErrorGetOpentdfConfig(response, &metadata)
	}
	output := &GetOpentdfConfigOutput{}
	out.Result = output
	...
	err = awsRestjson1_deserializeOpDocumentGetOpentdfConfigOutput(&output, shape)
	if err != nil {
		var snapshot bytes.Buffer
		io.Copy(&snapshot, ringBuffer)
		return out, metadata, &smithy.DeserializationError{
...
func awsRestjson1_deserializeOpErrorGetOpentdfConfig(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func awsRestjson1_deserializeOpDocumentGetOpentdfConfigOutput(v **GetOpentdfConfigOutput, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *GetOpentdfConfigOutput
	if *v == nil {
		sv = &GetOpentdfConfigOutput{}
	} else {
		sv = *v
	}
...
type awsRestjson1_deserializeOpRegisterOpentdfConfig struct {
}

func (*awsRestjson1_deserializeOpRegisterOpentdfConfig) ID() string {
	return "OperationDeserializer"
}

func (m *awsRestjson1_deserializeOpRegisterOpentdfConfig) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsRestjson1_deserializeOpErrorRegisterOpentdfConfig(response, &metadata)
	}
	output := &RegisterOpentdfConfigOutput{}
	out.Result = output
	...
	err = awsRestjson1_deserializeOpDocumentRegisterOpentdfConfigOutput(&output, shape)
	if err != nil {
		var snapshot bytes.Buffer
		io.Copy(&snapshot, ringBuffer)
		return out, metadata, &smithy.DeserializationError{
...
func awsRestjson1_deserializeOpErrorRegisterOpentdfConfig(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func awsRestjson1_deserializeOpDocumentRegisterOpentdfConfigOutput(v **RegisterOpentdfConfigOutput, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *RegisterOpentdfConfigOutput
	if *v == nil {
		sv = &RegisterOpentdfConfigOutput{}
	} else {
		sv = *v
	}
	...
	for key, value := range shape {
		...
		case "maxNonSsoSessionMinutes":
			if value != nil {
				...
				sv.MaxNonSsoSessionMinutes = ptr.Int32(int32(i64))
			}
