...
// for EMR Serverless Web Service.
//
...
// Apache Hive. With EMR Serverless, you don’t have to configure, optimize, secure,
// or operate clusters to run applications with these frameworks. The API reference
// to Amazon EMR Serverless is emr-serverless. The emr-serverless prefix is used in
// the following scenarios:
//
// * It is the prefix in the CLI commands for Amazon EMR
// Serverless. For example, aws emr-serverless start-job-run.
//
// * It is the prefix
// before IAM policy actions for Amazon EMR Serverless. For example, "Action":
// ["emr-serverless:StartJobRun"]. For more information, see Policy actions for
