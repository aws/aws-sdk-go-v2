...
func (*DeleteTextMessageSpendLimitOverrideInput) operationName() string {
...
func (c *Client) addOperationDeleteTextMessageSpendLimitOverrideMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteTextMessageSpendLimitOverrideResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteTextMessageSpendLimitOverrideResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteTextMessageSpendLimitOverrideResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteTextMessageSpendLimitOverrideResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteTextMessageSpendLimitOverrideResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteTextMessageSpendLimitOverrideResolveEndpointMiddleware{
