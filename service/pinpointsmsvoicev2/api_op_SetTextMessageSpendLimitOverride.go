...
func (c *Client) SetTextMessageSpendLimitOverride(ctx context.Context, params *SetTextMessageSpendLimitOverrideInput, optFns ...func(*Options)) (*SetTextMessageSpendLimitOverrideOutput, error) {
	if params == nil { params = &SetTextMessageSpendLimitOverrideInput{} }
...
func (c *Client) addOperationSetTextMessageSpendLimitOverrideMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetTextMessageSpendLimitOverrideResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetTextMessageSpendLimitOverrideResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetTextMessageSpendLimitOverrideResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetTextMessageSpendLimitOverrideResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetTextMessageSpendLimitOverrideResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetTextMessageSpendLimitOverrideResolveEndpointMiddleware{
