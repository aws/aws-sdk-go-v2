...
func (c *Client) addOperationSetTextMessageSpendLimitOverrideMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SetTextMessageSpendLimitOverride", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
