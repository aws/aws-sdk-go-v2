...
func (c *Client) addOperationDescribeRegistrationFieldDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRegistrationFieldDefinitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
