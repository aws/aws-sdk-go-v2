...
func (c *Client) addOperationDeleteDefaultMessageTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDefaultMessageType", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
