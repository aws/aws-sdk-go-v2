...
func (c *Client) addOperationPutRegistrationFieldValueMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutRegistrationFieldValue", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
