...
func (c *Client) SetDefaultSenderId(ctx context.Context, params *SetDefaultSenderIdInput, optFns ...func(*Options)) (*SetDefaultSenderIdOutput, error) {
	if params == nil { params = &SetDefaultSenderIdInput{} }
...
func (c *Client) addOperationSetDefaultSenderIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetDefaultSenderIdResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetDefaultSenderIdResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetDefaultSenderIdResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetDefaultSenderIdResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetDefaultSenderIdResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetDefaultSenderIdResolveEndpointMiddleware{
