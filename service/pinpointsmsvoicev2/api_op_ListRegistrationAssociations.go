...
func (c *Client) addOperationListRegistrationAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRegistrationAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
