...
func (c *Client) addOperationDeleteMediaMessageSpendLimitOverrideMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteMediaMessageSpendLimitOverride", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
