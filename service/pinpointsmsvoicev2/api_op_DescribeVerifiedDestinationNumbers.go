...
func (c *Client) addOperationDescribeVerifiedDestinationNumbersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeVerifiedDestinationNumbers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
