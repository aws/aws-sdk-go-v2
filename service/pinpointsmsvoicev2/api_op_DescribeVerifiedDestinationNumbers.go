...
func (v *DescribeVerifiedDestinationNumbersOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DescribeVerifiedDestinationNumbersResult)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DescribeVerifiedDestinationNumbersOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.NextToken != nil {
		s.WriteString(schemas.DescribeVerifiedDestinationNumbersResult_NextToken, *v.NextToken)
	}
	serializeVerifiedDestinationNumberInformationList(s, schemas.DescribeVerifiedDestinationNumbersResult_VerifiedDestinationNumbers, v.VerifiedDestinationNumbers)
}
