...
func (c *Client) DescribeConfigurationSets(ctx context.Context, params *DescribeConfigurationSetsInput, optFns ...func(*Options)) (*DescribeConfigurationSetsOutput, error) {
	if params == nil { params = &DescribeConfigurationSetsInput{} }
...
func (c *Client) addOperationDescribeConfigurationSetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeConfigurationSetsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeConfigurationSetsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeConfigurationSetsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeConfigurationSetsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeConfigurationSetsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeConfigurationSetsResolveEndpointMiddleware{
