...
func (c *Client) addOperationDescribeRegistrationSectionDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRegistrationSectionDefinitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
