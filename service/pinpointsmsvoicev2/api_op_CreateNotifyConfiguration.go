...
func (c *Client) CreateNotifyConfiguration(ctx context.Context, params *CreateNotifyConfigurationInput, optFns ...func(*Options)) (*CreateNotifyConfigurationOutput, error) {
	if params == nil { params = &CreateNotifyConfigurationInput{} }
...
func (m *idempotencyToken_initializeOpCreateNotifyConfiguration) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *CreateNotifyConfigurationInput ")}
