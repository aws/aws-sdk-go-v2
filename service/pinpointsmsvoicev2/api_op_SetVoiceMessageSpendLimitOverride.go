...
func (c *Client) addOperationSetVoiceMessageSpendLimitOverrideMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SetVoiceMessageSpendLimitOverride", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
