...
func (c *Client) SetVoiceMessageSpendLimitOverride(ctx context.Context, params *SetVoiceMessageSpendLimitOverrideInput, optFns ...func(*Options)) (*SetVoiceMessageSpendLimitOverrideOutput, error) {
	if params == nil { params = &SetVoiceMessageSpendLimitOverrideInput{} }
...
func (c *Client) addOperationSetVoiceMessageSpendLimitOverrideMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetVoiceMessageSpendLimitOverrideResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetVoiceMessageSpendLimitOverrideResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetVoiceMessageSpendLimitOverrideResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetVoiceMessageSpendLimitOverrideResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetVoiceMessageSpendLimitOverrideResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetVoiceMessageSpendLimitOverrideResolveEndpointMiddleware{
