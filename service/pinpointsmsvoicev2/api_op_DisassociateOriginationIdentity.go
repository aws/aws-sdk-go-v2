...
func (c *Client) addOperationDisassociateOriginationIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateOriginationIdentity", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
