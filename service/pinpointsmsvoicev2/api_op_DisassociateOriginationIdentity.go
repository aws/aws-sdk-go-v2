...
func (v *DisassociateOriginationIdentityOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DisassociateOriginationIdentityResult)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DisassociateOriginationIdentityOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.IsoCountryCode != nil {
		s.WriteString(schemas.DisassociateOriginationIdentityResult_IsoCountryCode, *v.IsoCountryCode)
	}
	if v.OriginationIdentity != nil {
		s.WriteString(schemas.DisassociateOriginationIdentityResult_OriginationIdentity, *v.OriginationIdentity)
	}
	if v.OriginationIdentityArn != nil {
		s.WriteString(schemas.DisassociateOriginationIdentityResult_OriginationIdentityArn, *v.OriginationIdentityArn)
	}
	if v.PoolArn != nil {
		s.WriteString(schemas.DisassociateOriginationIdentityResult_PoolArn, *v.PoolArn)
	}
	if v.PoolId != nil {
		s.WriteString(schemas.DisassociateOriginationIdentityResult_PoolId, *v.PoolId)
	}
}
