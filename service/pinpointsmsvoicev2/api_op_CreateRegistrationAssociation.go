...
func (c *Client) addOperationCreateRegistrationAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateRegistrationAssociation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
