...
func (c *Client) CreateVerifiedDestinationNumber(ctx context.Context, params *CreateVerifiedDestinationNumberInput, optFns ...func(*Options)) (*CreateVerifiedDestinationNumberOutput, error) {
	if params == nil { params = &CreateVerifiedDestinationNumberInput{} }
...
func (m *idempotencyToken_initializeOpCreateVerifiedDestinationNumber) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *CreateVerifiedDestinationNumberInput ")}
