...
// the SMS and voice channels. Amazon Pinpoint SMS and Voice, version 2 resources
// such as phone numbers, sender IDs, and opt-out lists can be used by the Amazon
// Pinpoint API. If you're new to Amazon Pinpoint SMS, it's also helpful to review
// the Amazon Pinpoint SMS User Guide (https://docs.aws.amazon.com/sms-voice/latest/userguide/what-is-service.html)
// . The Amazon Pinpoint Developer Guide provides tutorials, code samples, and
// procedures that demonstrate how to use Amazon Pinpoint SMS features
// programmatically and how to integrate Amazon Pinpoint functionality into mobile
// apps and other types of applications. The guide also provides key information,
// such as Amazon Pinpoint integration with other Amazon Web Services services, and
// the quotas that apply to use of the service. Regional availability The Amazon
// Pinpoint SMS and Voice, version 2 API Reference is available in several Amazon
// Web Services Regions and it provides an endpoint for each of these Regions. For
// a list of all the Regions and endpoints where the API is currently available,
// see Amazon Web Services Service Endpoints (https://docs.aws.amazon.com/general/latest/gr/rande.html#pinpoint_region)
