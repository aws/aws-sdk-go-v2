...
func (v *ReleaseSenderIdOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ReleaseSenderIdResult)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ReleaseSenderIdOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.IsoCountryCode != nil {
		s.WriteString(schemas.ReleaseSenderIdResult_IsoCountryCode, *v.IsoCountryCode)
	}
	serializeMessageTypeList(s, schemas.ReleaseSenderIdResult_MessageTypes, v.MessageTypes)
	if v.MonthlyLeasingPrice != nil {
		s.WriteString(schemas.ReleaseSenderIdResult_MonthlyLeasingPrice, *v.MonthlyLeasingPrice)
	}
	s.WriteBool(schemas.ReleaseSenderIdResult_Registered, v.Registered)
	if v.RegistrationId != nil {
		s.WriteString(schemas.ReleaseSenderIdResult_RegistrationId, *v.RegistrationId)
	}
	if v.SenderId != nil {
		s.WriteString(schemas.ReleaseSenderIdResult_SenderId, *v.SenderId)
	}
	if v.SenderIdArn != nil {
		s.WriteString(schemas.ReleaseSenderIdResult_SenderIdArn, *v.SenderIdArn)
	}
}
