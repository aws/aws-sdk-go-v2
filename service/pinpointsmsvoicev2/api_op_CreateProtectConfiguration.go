...
func (c *Client) addOperationCreateProtectConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateProtectConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
