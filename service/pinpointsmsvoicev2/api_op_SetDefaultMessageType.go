...
func (c *Client) SetDefaultMessageType(ctx context.Context, params *SetDefaultMessageTypeInput, optFns ...func(*Options)) (*SetDefaultMessageTypeOutput, error) {
	if params == nil { params = &SetDefaultMessageTypeInput{} }
...
func (c *Client) addOperationSetDefaultMessageTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetDefaultMessageTypeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetDefaultMessageTypeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetDefaultMessageTypeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetDefaultMessageTypeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetDefaultMessageTypeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetDefaultMessageTypeResolveEndpointMiddleware{
