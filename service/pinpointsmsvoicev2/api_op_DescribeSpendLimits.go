...
func (v *DescribeSpendLimitsOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DescribeSpendLimitsResult)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DescribeSpendLimitsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.NextToken != nil {
		s.WriteString(schemas.DescribeSpendLimitsResult_NextToken, *v.NextToken)
	}
	serializeSpendLimitList(s, schemas.DescribeSpendLimitsResult_SpendLimits, v.SpendLimits)
}
