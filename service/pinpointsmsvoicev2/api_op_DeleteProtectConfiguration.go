...
func (c *Client) addOperationDeleteProtectConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteProtectConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
