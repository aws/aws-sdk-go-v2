...
func (c *Client) addOperationAssociateOriginationIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateOriginationIdentity", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
