...
func (c *Client) DeleteVoiceMessageSpendLimitOverride(ctx context.Context, params *DeleteVoiceMessageSpendLimitOverrideInput, optFns ...func(*Options)) (*DeleteVoiceMessageSpendLimitOverrideOutput, error) {
	if params == nil { params = &DeleteVoiceMessageSpendLimitOverrideInput{} }
...
func (c *Client) addOperationDeleteVoiceMessageSpendLimitOverrideMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteVoiceMessageSpendLimitOverrideResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteVoiceMessageSpendLimitOverrideResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteVoiceMessageSpendLimitOverrideResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteVoiceMessageSpendLimitOverrideResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteVoiceMessageSpendLimitOverrideResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteVoiceMessageSpendLimitOverrideResolveEndpointMiddleware{
