...
func (c *Client) addOperationSetAccountDefaultProtectConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SetAccountDefaultProtectConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
