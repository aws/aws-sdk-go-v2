...
func (c *Client) addOperationAssociateProtectConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateProtectConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
