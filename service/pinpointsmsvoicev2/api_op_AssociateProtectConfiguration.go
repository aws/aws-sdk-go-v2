...
func (v *AssociateProtectConfigurationOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.AssociateProtectConfigurationResult)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *AssociateProtectConfigurationOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ConfigurationSetArn != nil {
		s.WriteString(schemas.AssociateProtectConfigurationResult_ConfigurationSetArn, *v.ConfigurationSetArn)
	}
	if v.ConfigurationSetName != nil {
		s.WriteString(schemas.AssociateProtectConfigurationResult_ConfigurationSetName, *v.ConfigurationSetName)
	}
	if v.ProtectConfigurationArn != nil {
		s.WriteString(schemas.AssociateProtectConfigurationResult_ProtectConfigurationArn, *v.ProtectConfigurationArn)
	}
	if v.ProtectConfigurationId != nil {
		s.WriteString(schemas.AssociateProtectConfigurationResult_ProtectConfigurationId, *v.ProtectConfigurationId)
	}
}
