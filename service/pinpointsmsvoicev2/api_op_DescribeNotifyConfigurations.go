...
func (v *DescribeNotifyConfigurationsOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.DescribeNotifyConfigurationsResult)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *DescribeNotifyConfigurationsOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.NextToken != nil {
		s.WriteString(schemas.DescribeNotifyConfigurationsResult_NextToken, *v.NextToken)
	}
	serializeNotifyConfigurationInformationList(s, schemas.DescribeNotifyConfigurationsResult_NotifyConfigurations, v.NotifyConfigurations)
}
