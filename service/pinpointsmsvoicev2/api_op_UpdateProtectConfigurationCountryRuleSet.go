...
func (c *Client) addOperationUpdateProtectConfigurationCountryRuleSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateProtectConfigurationCountryRuleSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
