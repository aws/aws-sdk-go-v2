...
func (c *Client) DeleteDefaultSenderId(ctx context.Context, params *DeleteDefaultSenderIdInput, optFns ...func(*Options)) (*DeleteDefaultSenderIdOutput, error) {
	if params == nil { params = &DeleteDefaultSenderIdInput{} }
...
func (c *Client) addOperationDeleteDefaultSenderIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteDefaultSenderIdResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteDefaultSenderIdResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteDefaultSenderIdResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteDefaultSenderIdResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteDefaultSenderIdResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteDefaultSenderIdResolveEndpointMiddleware{
