...
func (c *Client) addOperationDescribeRegistrationAttachmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRegistrationAttachments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
