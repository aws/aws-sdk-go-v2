...
func (c *Client) ListPoolOriginationIdentities(ctx context.Context, params *ListPoolOriginationIdentitiesInput, optFns ...func(*Options)) (*ListPoolOriginationIdentitiesOutput, error) {
	if params == nil { params = &ListPoolOriginationIdentitiesInput{} }
...
func (c *Client) addOperationListPoolOriginationIdentitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPoolOriginationIdentitiesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPoolOriginationIdentitiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPoolOriginationIdentitiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPoolOriginationIdentitiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPoolOriginationIdentitiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPoolOriginationIdentitiesResolveEndpointMiddleware{
