...
func (c *Client) addOperationDescribeProtectConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeProtectConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
