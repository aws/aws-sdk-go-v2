...
func (c *Client) addOperationDescribeOptedOutNumbersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeOptedOutNumbers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
