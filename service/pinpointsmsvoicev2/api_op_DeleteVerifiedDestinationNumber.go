...
func (c *Client) addOperationDeleteVerifiedDestinationNumberMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteVerifiedDestinationNumber", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
