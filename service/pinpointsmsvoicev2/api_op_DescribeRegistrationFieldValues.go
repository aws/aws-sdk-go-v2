...
func (c *Client) addOperationDescribeRegistrationFieldValuesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRegistrationFieldValues", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
