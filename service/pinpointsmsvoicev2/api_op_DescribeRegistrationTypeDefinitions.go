...
func (c *Client) addOperationDescribeRegistrationTypeDefinitionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRegistrationTypeDefinitions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
