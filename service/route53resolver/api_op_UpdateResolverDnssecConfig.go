...
func (c *Client) addOperationUpdateResolverDnssecConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateResolverDnssecConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
