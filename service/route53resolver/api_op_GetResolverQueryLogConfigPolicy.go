...
func (c *Client) GetResolverQueryLogConfigPolicy(ctx context.Context, params *GetResolverQueryLogConfigPolicyInput, optFns ...func(*Options)) (*GetResolverQueryLogConfigPolicyOutput, error) {
	if params == nil { params = &GetResolverQueryLogConfigPolicyInput{} }
...
func (c *Client) addOperationGetResolverQueryLogConfigPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetResolverQueryLogConfigPolicyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetResolverQueryLogConfigPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetResolverQueryLogConfigPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetResolverQueryLogConfigPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetResolverQueryLogConfigPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetResolverQueryLogConfigPolicyResolveEndpointMiddleware{
