...
func (*GetResolverQueryLogConfigInput) operationName() string {
	return "GetResolverQueryLogConfig"
}
...
func (c *Client) addOperationGetResolverQueryLogConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetResolverQueryLogConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetResolverQueryLogConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetResolverQueryLogConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetResolverQueryLogConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetResolverQueryLogConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetResolverQueryLogConfigResolveEndpointMiddleware{
