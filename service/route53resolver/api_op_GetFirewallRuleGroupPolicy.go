...
func (c *Client) addOperationGetFirewallRuleGroupPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetFirewallRuleGroupPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
