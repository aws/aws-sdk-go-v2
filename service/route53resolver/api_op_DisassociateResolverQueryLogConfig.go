...
// Disassociates a VPC from a query logging configuration. Before you can delete
// a query logging configuration, you must first disassociate all VPCs from the
