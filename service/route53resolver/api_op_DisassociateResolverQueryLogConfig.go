...
func (c *Client) addOperationDisassociateResolverQueryLogConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateResolverQueryLogConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
