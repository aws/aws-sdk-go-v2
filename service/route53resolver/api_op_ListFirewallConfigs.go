...
func (c *Client) ListFirewallConfigs(ctx context.Context, params *ListFirewallConfigsInput, optFns ...func(*Options)) (*ListFirewallConfigsOutput, error) {
	if params == nil { params = &ListFirewallConfigsInput{} }
...
func (c *Client) addOperationListFirewallConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFirewallConfigsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListFirewallConfigsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListFirewallConfigsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFirewallConfigsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFirewallConfigsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListFirewallConfigsResolveEndpointMiddleware{
