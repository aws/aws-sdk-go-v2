...
func (c *Client) PutFirewallRuleGroupPolicy(ctx context.Context, params *PutFirewallRuleGroupPolicyInput, optFns ...func(*Options)) (*PutFirewallRuleGroupPolicyOutput, error) {
	if params == nil { params = &PutFirewallRuleGroupPolicyInput{} }
...
func (c *Client) addOperationPutFirewallRuleGroupPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutFirewallRuleGroupPolicyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutFirewallRuleGroupPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutFirewallRuleGroupPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutFirewallRuleGroupPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutFirewallRuleGroupPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutFirewallRuleGroupPolicyResolveEndpointMiddleware{
