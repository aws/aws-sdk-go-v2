...
// all other domain names. You can also configure DNS resolution between your VPC
// and your network over a Direct Connect or VPN connection: Forward DNS queries
// from resolvers on your network to Route 53 Resolver DNS resolvers on your
// network can forward DNS queries to Resolver in a specified VPC. This allows your
// DNS resolvers to easily resolve domain names for AWS resources such as EC2
// instances or records in a Route 53 private hosted zone. For more information,
// see How DNS Resolvers on Your Network Forward DNS Queries to Route 53 Resolver
