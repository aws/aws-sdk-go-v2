...
// SubnetId=[subnet_id_in_different_AZ] Note the resolver endpoint ID that appears
// in the response. You'll use it in step 3.
//
//     * Get the IP addresses for the
// Resolver endpoints: get-resolver-endpoint --resolver-endpoint-id
// [resolver_endpoint_id]
//
//     * In your network configuration, define the IP
// addresses that you got in step 3 as DNS servers. You can now query instance
// names in your VPCs and the names of records in your private hosted zone.
//
// You
// can also perform the following operations using the AWS CLI:
//
//     *
// list-resolver-endpoints: List all endpoints. The syntax includes options for
// pagination and filtering.
//
//     * update-resolver-endpoints: Add IP addresses to
// an endpoint or remove IP addresses from an endpoint.
//
// To delete an endpoint, use
// the following AWS CLI command: delete-resolver-endpoint --resolver-endpoint-id
// [resolver_endpoint_id]
