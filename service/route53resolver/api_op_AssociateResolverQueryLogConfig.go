...
func (c *Client) addOperationAssociateResolverQueryLogConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateResolverQueryLogConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
