...
// specified Resolver operation. This error can also be thrown when a customer has
// reached the 5120 character limit for a resource policy for CloudWatch Logs.
