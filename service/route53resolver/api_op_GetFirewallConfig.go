...
func (c *Client) GetFirewallConfig(ctx context.Context, params *GetFirewallConfigInput, optFns ...func(*Options)) (*GetFirewallConfigOutput, error) {
	if params == nil { params = &GetFirewallConfigInput{} }
...
func (c *Client) addOperationGetFirewallConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFirewallConfigResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetFirewallConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetFirewallConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFirewallConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFirewallConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetFirewallConfigResolveEndpointMiddleware{
