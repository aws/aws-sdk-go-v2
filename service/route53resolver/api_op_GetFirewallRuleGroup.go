...
func (*GetFirewallRuleGroupInput) operationName() string {
	return "GetFirewallRuleGroup"
}
...
func (c *Client) addOperationGetFirewallRuleGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFirewallRuleGroupResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetFirewallRuleGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetFirewallRuleGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFirewallRuleGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFirewallRuleGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetFirewallRuleGroupResolveEndpointMiddleware{
