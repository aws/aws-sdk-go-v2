...
func (c *Client) addOperationDisassociateResolverRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateResolverRule", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
