...
func (c *Client) addOperationCreateResolverQueryLogConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateResolverQueryLogConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
