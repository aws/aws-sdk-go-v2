...
func (c *Client) DeleteFirewallRuleGroup(ctx context.Context, params *DeleteFirewallRuleGroupInput, optFns ...func(*Options)) (*DeleteFirewallRuleGroupOutput, error) {
	if params == nil { params = &DeleteFirewallRuleGroupInput{} }
...
func (c *Client) addOperationDeleteFirewallRuleGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteFirewallRuleGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteFirewallRuleGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteFirewallRuleGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteFirewallRuleGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteFirewallRuleGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteFirewallRuleGroupResolveEndpointMiddleware{
