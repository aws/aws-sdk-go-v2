...
func (c *Client) addOperationDeleteFirewallRuleGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteFirewallRuleGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
