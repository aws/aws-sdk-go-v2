...
func (c *Client) GetOutpostResolver(ctx context.Context, params *GetOutpostResolverInput, optFns ...func(*Options)) (*GetOutpostResolverOutput, error) {
	if params == nil { params = &GetOutpostResolverInput{} }
...
func (c *Client) addOperationGetOutpostResolverMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetOutpostResolverResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetOutpostResolverResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetOutpostResolverResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetOutpostResolverResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetOutpostResolverResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetOutpostResolverResolveEndpointMiddleware{
