...
func (c *Client) ListResolverConfigs(ctx context.Context, params *ListResolverConfigsInput, optFns ...func(*Options)) (*ListResolverConfigsOutput, error) {
	if params == nil { params = &ListResolverConfigsInput{} }
...
func (c *Client) addOperationListResolverConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListResolverConfigsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListResolverConfigsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListResolverConfigsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListResolverConfigsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListResolverConfigsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListResolverConfigsResolveEndpointMiddleware{
