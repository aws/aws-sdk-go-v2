...
func (c *Client) addOperationListFirewallRuleGroupAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFirewallRuleGroupAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
