...
func (*ListFirewallRuleGroupAssociationsInput) operationName() string {
...
func (c *Client) addOperationListFirewallRuleGroupAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFirewallRuleGroupAssociationsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListFirewallRuleGroupAssociationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListFirewallRuleGroupAssociationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFirewallRuleGroupAssociationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFirewallRuleGroupAssociationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListFirewallRuleGroupAssociationsResolveEndpointMiddleware{
