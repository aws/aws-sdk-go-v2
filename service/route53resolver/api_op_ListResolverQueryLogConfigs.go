...
func (c *Client) addOperationListResolverQueryLogConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListResolverQueryLogConfigs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
