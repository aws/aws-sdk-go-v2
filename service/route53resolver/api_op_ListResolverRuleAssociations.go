...
func addOperationListResolverRuleAssociationsStackSlots(stack *middleware.Stack) error {
...
func addOperationListResolverRuleAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListResolverRuleAssociationsStackSlots(stack); err != nil {
		return err
	}
