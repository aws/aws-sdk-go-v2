...
func (c *Client) GetFirewallDomainList(ctx context.Context, params *GetFirewallDomainListInput, optFns ...func(*Options)) (*GetFirewallDomainListOutput, error) {
	if params == nil { params = &GetFirewallDomainListInput{} }
...
func (c *Client) addOperationGetFirewallDomainListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFirewallDomainListResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetFirewallDomainListResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetFirewallDomainListResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFirewallDomainListResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFirewallDomainListResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetFirewallDomainListResolveEndpointMiddleware{
