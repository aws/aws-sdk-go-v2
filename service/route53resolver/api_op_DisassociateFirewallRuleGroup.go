...
func (c *Client) addOperationDisassociateFirewallRuleGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateFirewallRuleGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
