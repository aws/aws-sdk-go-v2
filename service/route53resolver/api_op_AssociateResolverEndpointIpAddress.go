...
func (c *Client) addOperationAssociateResolverEndpointIpAddressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateResolverEndpointIpAddress", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
