...
func addOperationGetResolverQueryLogConfigAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addOpGetResolverQueryLogConfigAssociationValidationMiddleware(stack)
	stack.Initialize.Add(newServiceMetadataMiddleware_opGetResolverQueryLogConfigAssociation(options.Region), middleware.Before)
