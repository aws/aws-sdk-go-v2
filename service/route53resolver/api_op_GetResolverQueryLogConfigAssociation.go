...
func (c *Client) GetResolverQueryLogConfigAssociation(ctx context.Context, params *GetResolverQueryLogConfigAssociationInput, optFns ...func(*Options)) (*GetResolverQueryLogConfigAssociationOutput, error) {
	if params == nil { params = &GetResolverQueryLogConfigAssociationInput{} }
...
func (c *Client) addOperationGetResolverQueryLogConfigAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetResolverQueryLogConfigAssociationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetResolverQueryLogConfigAssociationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetResolverQueryLogConfigAssociationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetResolverQueryLogConfigAssociationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetResolverQueryLogConfigAssociationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetResolverQueryLogConfigAssociationResolveEndpointMiddleware{
