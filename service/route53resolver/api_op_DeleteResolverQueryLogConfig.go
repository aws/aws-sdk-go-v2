...
func (c *Client) addOperationDeleteResolverQueryLogConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteResolverQueryLogConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
