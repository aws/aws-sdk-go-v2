...
func (c *Client) addOperationListFirewallDomainListsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFirewallDomainLists", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
