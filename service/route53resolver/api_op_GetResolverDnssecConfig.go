...
func (c *Client) GetResolverDnssecConfig(ctx context.Context, params *GetResolverDnssecConfigInput, optFns ...func(*Options)) (*GetResolverDnssecConfigOutput, error) {
	if params == nil { params = &GetResolverDnssecConfigInput{} }
...
func (c *Client) addOperationGetResolverDnssecConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetResolverDnssecConfigResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetResolverDnssecConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetResolverDnssecConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetResolverDnssecConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetResolverDnssecConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetResolverDnssecConfigResolveEndpointMiddleware{
