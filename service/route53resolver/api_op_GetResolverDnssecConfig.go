...
func (c *Client) addOperationGetResolverDnssecConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetResolverDnssecConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
