...
func (c *Client) PutResolverQueryLogConfigPolicy(ctx context.Context, params *PutResolverQueryLogConfigPolicyInput, optFns ...func(*Options)) (*PutResolverQueryLogConfigPolicyOutput, error) {
	if params == nil { params = &PutResolverQueryLogConfigPolicyInput{} }
...
func (c *Client) addOperationPutResolverQueryLogConfigPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutResolverQueryLogConfigPolicyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutResolverQueryLogConfigPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutResolverQueryLogConfigPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutResolverQueryLogConfigPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutResolverQueryLogConfigPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutResolverQueryLogConfigPolicyResolveEndpointMiddleware{
