...
type ListFirewallDomainsOutput struct {
	...
	// A list of the domains in the firewall domain list. This might be a partial
	// list of the domains that you've defined in the domain list. For information, see
	//
	// MaxResults .
	Domains []string
