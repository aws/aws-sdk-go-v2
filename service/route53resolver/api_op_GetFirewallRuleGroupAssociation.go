...
func (c *Client) GetFirewallRuleGroupAssociation(ctx context.Context, params *GetFirewallRuleGroupAssociationInput, optFns ...func(*Options)) (*GetFirewallRuleGroupAssociationOutput, error) {
	if params == nil { params = &GetFirewallRuleGroupAssociationInput{} }
...
func (c *Client) addOperationGetFirewallRuleGroupAssociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFirewallRuleGroupAssociationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetFirewallRuleGroupAssociationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetFirewallRuleGroupAssociationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFirewallRuleGroupAssociationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFirewallRuleGroupAssociationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetFirewallRuleGroupAssociationResolveEndpointMiddleware{
