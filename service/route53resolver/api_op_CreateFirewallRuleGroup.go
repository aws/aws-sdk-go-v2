...
func (c *Client) addOperationCreateFirewallRuleGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateFirewallRuleGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
