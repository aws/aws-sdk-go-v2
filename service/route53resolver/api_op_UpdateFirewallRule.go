...
func (c *Client) UpdateFirewallRule(ctx context.Context, params *UpdateFirewallRuleInput, optFns ...func(*Options)) (*UpdateFirewallRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFirewallRule", params, optFns, addOperationUpdateFirewallRuleMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFirewallRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
