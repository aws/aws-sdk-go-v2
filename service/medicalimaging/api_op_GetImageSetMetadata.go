...
func (c *Client) GetImageSetMetadata(ctx context.Context, params *GetImageSetMetadataInput, optFns ...func(*Options)) (*GetImageSetMetadataOutput, error) {
	if params == nil { params = &GetImageSetMetadataInput{} }
...
func (c *Client) addOperationGetImageSetMetadataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetImageSetMetadataResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetImageSetMetadataResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetImageSetMetadataResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetImageSetMetadataResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addGetImageSetMetadataResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetImageSetMetadataResolveEndpointMiddleware{
