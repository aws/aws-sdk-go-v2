...
func (c *Client) GetDatastore(ctx context.Context, params *GetDatastoreInput, optFns ...func(*Options)) (*GetDatastoreOutput, error) {
	if params == nil { params = &GetDatastoreInput{} }
...
func (c *Client) addOperationGetDatastoreMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDatastoreResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDatastoreResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDatastoreResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDatastoreResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDatastoreResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDatastoreResolveEndpointMiddleware{
