...
// images. For an introduction to the service, see the AWS HealthImaging Developer
// Guide  (https://docs.aws.amazon.com/healthimaging/latest/devguide/what-is.html)
...
// using HealthImaging API actions in one of the language-specific AWS SDKs, refer
// to the See Also link at the end of each section that describes an API action or
// data type. The following sections list AWS HealthImaging API actions categorized
// according to functionality. Links are provided to actions within this Reference,
// along with links back to corresponding sections in the AWS HealthImaging
