...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-medical-imaging.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-medical-imaging.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-medical-imaging.dev",
			expectURL:     aws.String("https://env-medical-imaging.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-medical-imaging.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-medical-imaging.dev",
			expectURL:     aws.String("http://config-medical-imaging.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-medical-imaging.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-medical-imaging.dev",
			clientEndpoint: aws.String("https://client-medical-imaging.dev"),
			expectURL:      aws.String("https://client-medical-imaging.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MEDICAL_IMAGING", c.envService)
			}
