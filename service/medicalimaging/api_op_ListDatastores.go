...
func (c *Client) ListDatastores(ctx context.Context, params *ListDatastoresInput, optFns ...func(*Options)) (*ListDatastoresOutput, error) {
	if params == nil { params = &ListDatastoresInput{} }
...
func (c *Client) addOperationListDatastoresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDatastoresResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDatastoresResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDatastoresResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDatastoresResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDatastoresResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDatastoresResolveEndpointMiddleware{
