...
func (c *Client) CopyImageSet(ctx context.Context, params *CopyImageSetInput, optFns ...func(*Options)) (*CopyImageSetOutput, error) {
	if params == nil { params = &CopyImageSetInput{} }
...
func (c *Client) addOperationCopyImageSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCopyImageSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCopyImageSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCopyImageSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCopyImageSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addCopyImageSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCopyImageSetResolveEndpointMiddleware{
