...
func (c *Client) DeleteImageSet(ctx context.Context, params *DeleteImageSetInput, optFns ...func(*Options)) (*DeleteImageSetOutput, error) {
	if params == nil { params = &DeleteImageSetInput{} }
...
func (c *Client) addOperationDeleteImageSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteImageSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteImageSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteImageSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteImageSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addDeleteImageSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteImageSetResolveEndpointMiddleware{
