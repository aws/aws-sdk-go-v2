...
type SearchQuantumTasksInput struct {
	...
	// Array of SearchQuantumTasksFilter objects to use when searching for quantum
	// tasks.
	//
...
func (c *Client) addOperationSearchQuantumTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SearchQuantumTasks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
