...
func (c *Client) SearchQuantumTasks(ctx context.Context, params *SearchQuantumTasksInput, optFns ...func(*Options)) (*SearchQuantumTasksOutput, error) {
	if params == nil { params = &SearchQuantumTasksInput{} }
...
func (c *Client) addOperationSearchQuantumTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSearchQuantumTasksResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSearchQuantumTasksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSearchQuantumTasksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSearchQuantumTasksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSearchQuantumTasksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSearchQuantumTasksResolveEndpointMiddleware{
