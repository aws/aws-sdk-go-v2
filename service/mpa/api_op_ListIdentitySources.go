...
func (v *ListIdentitySourcesInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ListIdentitySourcesRequest)
...
func (v *ListIdentitySourcesInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.MaxResults != nil {
		s.WriteInt32(schemas.ListIdentitySourcesRequest_MaxResults, *v.MaxResults)
	}
	if v.NextToken != nil {
		s.WriteString(schemas.ListIdentitySourcesRequest_NextToken, *v.NextToken)
	}
}
...
func (v *ListIdentitySourcesOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListIdentitySourcesResponse, func(s *smithy.Schema) error {
		switch s {
		case schemas.ListIdentitySourcesResponse_IdentitySources:
			return deserializeIdentitySources(d, schemas.ListIdentitySourcesResponse_IdentitySources, &v.IdentitySources)
		case schemas.ListIdentitySourcesResponse_NextToken:
			v.NextToken = new(string)
			return d.ReadString(schemas.ListIdentitySourcesResponse_NextToken, v.NextToken)
		}
		return nil
	})
}
func (c *Client) addOperationListIdentitySourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ListIdentitySources, schemas.ListIdentitySourcesRequest, schemas.ListIdentitySourcesResponse)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ListIdentitySources, schemas.ListIdentitySourcesRequest, schemas.ListIdentitySourcesResponse), output: &ListIdentitySourcesOutput{}}, middleware.After); err != nil {
		return err
	}
