...
func (c *Client) addOperationStartActiveApprovalTeamDeletionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartActiveApprovalTeamDeletion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
