...
func (c *Client) addOperationDeleteInactiveApprovalTeamVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteInactiveApprovalTeamVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
