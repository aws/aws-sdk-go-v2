...
func (c *Client) ActivateUser(ctx context.Context, params *ActivateUserInput, optFns ...func(*Options)) (*ActivateUserOutput, error) {
	if params == nil { params = &ActivateUserInput{} }
...
func (c *Client) addOperationActivateUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addActivateUserResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opActivateUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opActivateUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opActivateUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addActivateUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opActivateUserResolveEndpointMiddleware{
