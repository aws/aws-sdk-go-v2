...
func (c *Client) addOperationDescribeDocumentVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDocumentVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
