...
func (*DeleteDocumentVersionInput) operationName() string {
...
func (c *Client) addOperationDeleteDocumentVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteDocumentVersionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteDocumentVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteDocumentVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteDocumentVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteDocumentVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteDocumentVersionResolveEndpointMiddleware{
