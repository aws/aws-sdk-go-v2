...
func addOperationRemoveAllResourcePermissionsStackSlots(stack *middleware.Stack) error {
...
func addOperationRemoveAllResourcePermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRemoveAllResourcePermissionsStackSlots(stack); err != nil {
		return err
	}
