...
func (c *Client) AbortDocumentVersionUpload(ctx context.Context, params *AbortDocumentVersionUploadInput, optFns ...func(*Options)) (*AbortDocumentVersionUploadOutput, error) {
	if params == nil { params = &AbortDocumentVersionUploadInput{} }
...
func (c *Client) addOperationAbortDocumentVersionUploadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAbortDocumentVersionUploadResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAbortDocumentVersionUploadResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAbortDocumentVersionUploadResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAbortDocumentVersionUploadResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAbortDocumentVersionUploadResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAbortDocumentVersionUploadResolveEndpointMiddleware{
