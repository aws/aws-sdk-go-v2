...
func (c *Client) DeleteComment(ctx context.Context, params *DeleteCommentInput, optFns ...func(*Options)) (*DeleteCommentOutput, error) {
	stack := middleware.NewStack("DeleteComment", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpDeleteCommentMiddlewares(stack)
...
func addawsRestjson1_serdeOpDeleteCommentMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpDeleteComment{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpDeleteComment{}, middleware.After)
}
