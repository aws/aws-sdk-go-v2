...
func (*GetFolderPathInput) operationName() string {
...
func (c *Client) addOperationGetFolderPathMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFolderPathResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetFolderPathResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetFolderPathResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFolderPathResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFolderPathResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetFolderPathResolveEndpointMiddleware{
