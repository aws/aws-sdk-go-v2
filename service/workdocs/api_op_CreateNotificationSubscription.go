...
func addOperationCreateNotificationSubscriptionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateNotificationSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateNotificationSubscriptionStackSlots(stack); err != nil {
		return err
	}
