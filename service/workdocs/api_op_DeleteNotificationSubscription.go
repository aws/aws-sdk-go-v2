...
func (*DeleteNotificationSubscriptionInput) operationName() string {
...
func (c *Client) addOperationDeleteNotificationSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteNotificationSubscriptionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteNotificationSubscriptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteNotificationSubscriptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteNotificationSubscriptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteNotificationSubscriptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteNotificationSubscriptionResolveEndpointMiddleware{
