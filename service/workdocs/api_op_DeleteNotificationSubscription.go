...
func addOperationDeleteNotificationSubscriptionStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteNotificationSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteNotificationSubscriptionStackSlots(stack); err != nil {
		return err
	}
