...
func (c *Client) DeleteFolderContents(ctx context.Context, params *DeleteFolderContentsInput, optFns ...func(*Options)) (*DeleteFolderContentsOutput, error) {
	if params == nil { params = &DeleteFolderContentsInput{} }
...
func (c *Client) addOperationDeleteFolderContentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteFolderContentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteFolderContentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteFolderContentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteFolderContentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteFolderContentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteFolderContentsResolveEndpointMiddleware{
