...
func (c *Client) addOperationDescribeResourcePermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeResourcePermissions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
