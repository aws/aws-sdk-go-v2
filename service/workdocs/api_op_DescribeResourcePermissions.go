...
func addOperationDescribeResourcePermissionsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeResourcePermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeResourcePermissionsStackSlots(stack); err != nil {
		return err
	}
