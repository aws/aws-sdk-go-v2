...
func (c *Client) DeactivateUser(ctx context.Context, params *DeactivateUserInput, optFns ...func(*Options)) (*DeactivateUserOutput, error) {
	if params == nil { params = &DeactivateUserInput{} }
...
func (c *Client) addOperationDeactivateUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeactivateUserResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeactivateUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeactivateUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeactivateUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeactivateUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeactivateUserResolveEndpointMiddleware{
