...
func (c *Client) addOperationRemoveResourcePermissionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RemoveResourcePermission", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
