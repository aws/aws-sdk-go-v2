...
func (c *Client) addOperationInstallToRemoteAccessSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "InstallToRemoteAccessSession", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
