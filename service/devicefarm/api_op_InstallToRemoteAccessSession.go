...
func (c *Client) InstallToRemoteAccessSession(ctx context.Context, params *InstallToRemoteAccessSessionInput, optFns ...func(*Options)) (*InstallToRemoteAccessSessionOutput, error) {
	if params == nil { params = &InstallToRemoteAccessSessionInput{} }
...
func (c *Client) addOperationInstallToRemoteAccessSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addInstallToRemoteAccessSessionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opInstallToRemoteAccessSessionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opInstallToRemoteAccessSessionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opInstallToRemoteAccessSessionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addInstallToRemoteAccessSessionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opInstallToRemoteAccessSessionResolveEndpointMiddleware{
