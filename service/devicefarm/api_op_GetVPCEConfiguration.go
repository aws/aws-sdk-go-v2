...
func (c *Client) GetVPCEConfiguration(ctx context.Context, params *GetVPCEConfigurationInput, optFns ...func(*Options)) (*GetVPCEConfigurationOutput, error) {
	if params == nil { params = &GetVPCEConfigurationInput{} }
...
func (c *Client) addOperationGetVPCEConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetVPCEConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetVPCEConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetVPCEConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetVPCEConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetVPCEConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetVPCEConfigurationResolveEndpointMiddleware{
