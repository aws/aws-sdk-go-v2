...
func addOperationGetDevicePoolCompatibilityStackSlots(stack *middleware.Stack) error {
...
func addOperationGetDevicePoolCompatibilityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetDevicePoolCompatibilityStackSlots(stack); err != nil {
		return err
	}
