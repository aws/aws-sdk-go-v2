...
func (c *Client) ListSamples(ctx context.Context, params *ListSamplesInput, optFns ...func(*Options)) (*ListSamplesOutput, error) {
	if params == nil { params = &ListSamplesInput{} }
...
func (c *Client) addOperationListSamplesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSamplesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSamplesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSamplesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSamplesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSamplesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSamplesResolveEndpointMiddleware{
