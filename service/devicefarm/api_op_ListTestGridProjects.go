...
func (c *Client) ListTestGridProjects(ctx context.Context, params *ListTestGridProjectsInput, optFns ...func(*Options)) (*ListTestGridProjectsOutput, error) {
	if params == nil { params = &ListTestGridProjectsInput{} }
...
func (c *Client) addOperationListTestGridProjectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTestGridProjectsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTestGridProjectsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTestGridProjectsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTestGridProjectsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTestGridProjectsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTestGridProjectsResolveEndpointMiddleware{
