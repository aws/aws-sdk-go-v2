...
func (c *Client) addOperationUpdateVPCEConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateVPCEConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
