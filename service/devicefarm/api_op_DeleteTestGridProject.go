...
func (c *Client) DeleteTestGridProject(ctx context.Context, params *DeleteTestGridProjectInput, optFns ...func(*Options)) (*DeleteTestGridProjectOutput, error) {
	if params == nil { params = &DeleteTestGridProjectInput{} }
...
func (c *Client) addOperationDeleteTestGridProjectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteTestGridProjectResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteTestGridProjectResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteTestGridProjectResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteTestGridProjectResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteTestGridProjectResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteTestGridProjectResolveEndpointMiddleware{
