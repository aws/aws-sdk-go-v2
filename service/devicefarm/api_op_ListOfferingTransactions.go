...
func (c *Client) addOperationListOfferingTransactionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListOfferingTransactions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
