...
func (c *Client) ListOfferingTransactions(ctx context.Context, params *ListOfferingTransactionsInput, optFns ...func(*Options)) (*ListOfferingTransactionsOutput, error) {
	if params == nil { params = &ListOfferingTransactionsInput{} }
...
func (c *Client) addOperationListOfferingTransactionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListOfferingTransactionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListOfferingTransactionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListOfferingTransactionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListOfferingTransactionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListOfferingTransactionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListOfferingTransactionsResolveEndpointMiddleware{
