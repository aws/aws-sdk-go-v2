...
func (c *Client) GetUpload(ctx context.Context, params *GetUploadInput, optFns ...func(*Options)) (*GetUploadOutput, error) {
	if params == nil { params = &GetUploadInput{} }
...
func (c *Client) addOperationGetUploadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetUploadResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetUploadResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetUploadResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetUploadResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetUploadResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetUploadResolveEndpointMiddleware{
