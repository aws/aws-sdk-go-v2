...
func addOperationListTestGridSessionArtifactsStackSlots(stack *middleware.Stack) error {
...
func addOperationListTestGridSessionArtifactsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListTestGridSessionArtifactsStackSlots(stack); err != nil {
		return err
	}
