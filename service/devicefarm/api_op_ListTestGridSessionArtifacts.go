...
func (c *Client) addOperationListTestGridSessionArtifactsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTestGridSessionArtifacts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
