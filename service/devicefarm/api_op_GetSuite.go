...
func (c *Client) GetSuite(ctx context.Context, params *GetSuiteInput, optFns ...func(*Options)) (*GetSuiteOutput, error) {
	if params == nil { params = &GetSuiteInput{} }
...
func (c *Client) addOperationGetSuiteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSuiteResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSuiteResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSuiteResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSuiteResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSuiteResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSuiteResolveEndpointMiddleware{
