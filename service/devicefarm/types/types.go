...
type Artifact struct {
	...
	// - EXERCISER_MONKEY_OUTPUT: the artifact
	// (log) generated by an Android fuzz test.
...
// represent system-wide CPU usage.
type CPU struct {
...
type DeviceFilter struct {
	...
	//
	// Attribute Values
	// - The PLATFORM attribute can be set to ANDROID or
	// IOS.
...
type DevicePool struct {
	...
	// - CURATED: A device pool that is
	// created and managed by AWS Device Farm.
	// - PRIVATE: A device pool that is created
	// and managed by the device pool developer.
	Type DevicePoolType
...
type DeviceSelectionConfiguration struct {
	...
	// - Attribute The aspect of
	// a device such as platform or model used as the selection criteria in a device
	// filter. Allowed values include:
	// - ARN: The Amazon Resource Name (ARN) of the
	// device (for example, arn:aws:devicefarm:us-west-2::device:12345Example).
	// -
	// PLATFORM: The device platform. Valid values are ANDROID or IOS.
	// - OS_VERSION:
	// The operating system version (for example, 10.3.2).
	// - MODEL: The device model
	// (for example, iPad 5th Gen).
	// - AVAILABILITY: The current availability of the
	// device. Valid values are AVAILABLE, HIGHLY_AVAILABLE, BUSY, or
	// TEMPORARY_NOT_AVAILABLE.
	// - FORM_FACTOR: The device form factor. Valid values are
	// PHONE or TABLET.
	...
	// - INSTANCE_ARN: The Amazon Resource Name (ARN) of the
	// device instance.
	...
	//
	// - Values An array of one or more filter
	// values. Operator Values
	// - The IN and NOT_IN operators can take a values array
...
type IncompatibilityMessage struct {
	...
	// - MANUFACTURER
	// - PLATFORM (for example, Android or
	// iOS)
...
// system degrees (for example, 47.6204, -122.3491). Elevation is currently not
// supported.
...
type Sample struct {
	...
	// - MEMORY: A memory usage
	// sample type. This is expressed as the total proportional set size of an app
...
type ScheduleRunTest struct {
	...
	// - tags: You can limit execution
	// to features or scenarios that have (or don't have) certain tags (for example,
	// @smoke or @smoke,~@wip).
	//
	// For Appium tests (all types):
	// - appium_version: The
	// Appium version. Currently supported values are 1.6.5 (and later), latest, and
	// default.
	// - latest runs the latest Appium version supported by Device Farm
	// (1.9.1).
	// - For default, Device Farm selects a compatible version of Appium for
	// the device. The current behavior is to run 1.7.2 on Android devices and iOS 9
	// and earlier and 1.7.2 for iOS 10 and later.
	// - This behavior is subject to
	// change.
	//
	// For fuzz tests (Android only):
	// - event_count: The number of events,
	// between 1 and 10000, that the UI fuzz test should perform.
	// - throttle: The time,
	// in ms, between 0 and 1000, that the UI fuzz test should wait between events.
	// -
	...
	// - password: A password to use if the
	// Explorer encounters a login form. If not supplied, no password is inserted.
	//
	// For
	// Instrumentation:
...
// a browser in an automated context. Video elements might be broken up into
