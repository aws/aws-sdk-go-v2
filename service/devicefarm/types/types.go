...
// androidPaths . For web app tests, you can specify both iosPaths  and
// androidPaths .
...
type DeviceFilter struct {
	...
	// criteria in a device filter. The supported operators for each attribute are
	// provided in the following list. ARN The Amazon Resource Name (ARN) of the device
	// (for example, arn:aws:devicefarm:us-west-2::device:12345Example). Supported
	...
	// EQUALS , IN , NOT_IN AVAILABILITY The current availability of the device.
	// Valid values are AVAILABLE, HIGHLY_AVAILABLE, BUSY, or TEMPORARY_NOT_AVAILABLE.
...
type DeviceSelectionConfiguration struct {
	...
	//         - The IN and NOT_IN operators can take a values array that has more than one element.
	//         - The other operators require an array with a single element. Attribute Values
	//         - The PLATFORM attribute can be set to ANDROID or IOS.
	//         - The AVAILABILITY attribute can be set to AVAILABLE, HIGHLY_AVAILABLE, BUSY, or TEMPORARY_NOT_AVAILABLE.
	//         - The FORM_FACTOR attribute can be set to PHONE or TABLET.
	//         - The FLEET_TYPE attribute can be set to PUBLIC or PRIVATE.
...
type Rule struct {
	...
	// , IN , NOT_IN AVAILABILITY The current availability of the device. Valid
	// values are AVAILABLE, HIGHLY_AVAILABLE, BUSY, or TEMPORARY_NOT_AVAILABLE.
	// Supported operators: EQUALS FLEET_TYPE The fleet type. Valid values are PUBLIC
	// or PRIVATE. Supported operators: EQUALS FORM_FACTOR The device form factor.
	// Valid values are PHONE or TABLET. Supported operators: EQUALS , IN , NOT_IN
...
type Run struct {
	...
	// parameter is not specified, the default value is metered. If you have
	// unmetered device slots, you must set this to unmetered to use them. Otherwise,
...
type ScheduleRunConfiguration struct {
	...
	// Specifies the billing method for a test run: metered  or unmetered. If the
	// parameter is not specified, the default value is metered. If you have
	// purchased unmetered device slots, you must set this parameter to unmetered to
...
// running a browser in an automated context. Video elements might be broken up
// into multiple artifacts as they grow in size during creation.
