...
func (c *Client) ListUniqueProblems(ctx context.Context, params *ListUniqueProblemsInput, optFns ...func(*Options)) (*ListUniqueProblemsOutput, error) {
	if params == nil { params = &ListUniqueProblemsInput{} }
...
func (c *Client) addOperationListUniqueProblemsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListUniqueProblemsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListUniqueProblemsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListUniqueProblemsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListUniqueProblemsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListUniqueProblemsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListUniqueProblemsResolveEndpointMiddleware{
