...
func (c *Client) addOperationDeleteVPCEConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteVPCEConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
