...
func (c *Client) StopRun(ctx context.Context, params *StopRunInput, optFns ...func(*Options)) (*StopRunOutput, error) {
	if params == nil { params = &StopRunInput{} }
...
func (c *Client) addOperationStopRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopRunResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopRunResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopRunResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopRunResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopRunResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopRunResolveEndpointMiddleware{
