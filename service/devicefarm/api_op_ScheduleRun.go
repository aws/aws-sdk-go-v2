...
func (c *Client) ScheduleRun(ctx context.Context, params *ScheduleRunInput, optFns ...func(*Options)) (*ScheduleRunOutput, error) {
	if params == nil { params = &ScheduleRunInput{} }
...
func (c *Client) addOperationScheduleRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addScheduleRunResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opScheduleRunResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opScheduleRunResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opScheduleRunResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addScheduleRunResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opScheduleRunResolveEndpointMiddleware{
