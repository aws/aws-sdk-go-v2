...
func (c *Client) UpdateTestGridProject(ctx context.Context, params *UpdateTestGridProjectInput, optFns ...func(*Options)) (*UpdateTestGridProjectOutput, error) {
	if params == nil { params = &UpdateTestGridProjectInput{} }
...
func (c *Client) addOperationUpdateTestGridProjectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateTestGridProjectResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateTestGridProjectResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateTestGridProjectResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateTestGridProjectResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateTestGridProjectResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateTestGridProjectResolveEndpointMiddleware{
