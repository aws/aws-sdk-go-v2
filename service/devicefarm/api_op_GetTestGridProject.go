...
func (c *Client) GetTestGridProject(ctx context.Context, params *GetTestGridProjectInput, optFns ...func(*Options)) (*GetTestGridProjectOutput, error) {
	if params == nil { params = &GetTestGridProjectInput{} }
...
func (c *Client) addOperationGetTestGridProjectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTestGridProjectResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetTestGridProjectResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetTestGridProjectResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTestGridProjectResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTestGridProjectResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetTestGridProjectResolveEndpointMiddleware{
