...
func (c *Client) addOperationStopRemoteAccessSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopRemoteAccessSession", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
