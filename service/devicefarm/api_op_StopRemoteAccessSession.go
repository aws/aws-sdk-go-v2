...
func (c *Client) StopRemoteAccessSession(ctx context.Context, params *StopRemoteAccessSessionInput, optFns ...func(*Options)) (*StopRemoteAccessSessionOutput, error) {
	if params == nil { params = &StopRemoteAccessSessionInput{} }
...
func (c *Client) addOperationStopRemoteAccessSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopRemoteAccessSessionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopRemoteAccessSessionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopRemoteAccessSessionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopRemoteAccessSessionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopRemoteAccessSessionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopRemoteAccessSessionResolveEndpointMiddleware{
