...
func (c *Client) GetRemoteAccessSession(ctx context.Context, params *GetRemoteAccessSessionInput, optFns ...func(*Options)) (*GetRemoteAccessSessionOutput, error) {
	if params == nil { params = &GetRemoteAccessSessionInput{} }
...
func (c *Client) addOperationGetRemoteAccessSessionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRemoteAccessSessionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRemoteAccessSessionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRemoteAccessSessionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRemoteAccessSessionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRemoteAccessSessionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRemoteAccessSessionResolveEndpointMiddleware{
