...
func (*DeleteNetworkProfileInput) operationName() string {
...
func (c *Client) addOperationDeleteNetworkProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteNetworkProfileResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteNetworkProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteNetworkProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteNetworkProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteNetworkProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteNetworkProfileResolveEndpointMiddleware{
