...
func (c *Client) addOperationCreateVPCEConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateVPCEConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
