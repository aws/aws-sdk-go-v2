...
func (c *Client) GetProject(ctx context.Context, params *GetProjectInput, optFns ...func(*Options)) (*GetProjectOutput, error) {
	if params == nil { params = &GetProjectInput{} }
...
func (c *Client) addOperationGetProjectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetProjectResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetProjectResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetProjectResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetProjectResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetProjectResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetProjectResolveEndpointMiddleware{
