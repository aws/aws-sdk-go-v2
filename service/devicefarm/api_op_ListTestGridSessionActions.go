...
func (c *Client) addOperationListTestGridSessionActionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTestGridSessionActions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
