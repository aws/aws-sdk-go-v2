...
func addOperationListTestGridSessionActionsStackSlots(stack *middleware.Stack) error {
...
func addOperationListTestGridSessionActionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListTestGridSessionActionsStackSlots(stack); err != nil {
		return err
	}
