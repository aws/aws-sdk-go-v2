...
func (*PutDataLakeSettingsInput) operationName() string {
...
func (c *Client) addOperationPutDataLakeSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutDataLakeSettingsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opPutDataLakeSettingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opPutDataLakeSettingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutDataLakeSettingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutDataLakeSettingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opPutDataLakeSettingsResolveEndpointMiddleware{
