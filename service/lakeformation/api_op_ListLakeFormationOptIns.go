...
func (c *Client) addOperationListLakeFormationOptInsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLakeFormationOptInsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListLakeFormationOptInsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListLakeFormationOptInsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLakeFormationOptInsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLakeFormationOptInsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListLakeFormationOptInsResolveEndpointMiddleware{
