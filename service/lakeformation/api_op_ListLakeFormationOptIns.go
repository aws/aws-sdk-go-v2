...
func (c *Client) addOperationListLakeFormationOptInsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListLakeFormationOptIns", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
