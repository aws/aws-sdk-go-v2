...
func (c *Client) GetEffectivePermissionsForPath(ctx context.Context, params *GetEffectivePermissionsForPathInput, optFns ...func(*Options)) (*GetEffectivePermissionsForPathOutput, error) {
	if params == nil { params = &GetEffectivePermissionsForPathInput{} }
...
func (c *Client) addOperationGetEffectivePermissionsForPathMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetEffectivePermissionsForPathResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetEffectivePermissionsForPathResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetEffectivePermissionsForPathResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetEffectivePermissionsForPathResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetEffectivePermissionsForPathResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetEffectivePermissionsForPathResolveEndpointMiddleware{
