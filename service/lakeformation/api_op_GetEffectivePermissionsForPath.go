...
func (c *Client) addOperationGetEffectivePermissionsForPathMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetEffectivePermissionsForPath", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
