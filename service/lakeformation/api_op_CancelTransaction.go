...
func (c *Client) CancelTransaction(ctx context.Context, params *CancelTransactionInput, optFns ...func(*Options)) (*CancelTransactionOutput, error) {
	if params == nil { params = &CancelTransactionInput{} }
...
func (c *Client) addOperationCancelTransactionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelTransactionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelTransactionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelTransactionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelTransactionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelTransactionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelTransactionResolveEndpointMiddleware{
