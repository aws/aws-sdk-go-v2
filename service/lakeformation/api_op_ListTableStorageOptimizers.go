...
func (c *Client) addOperationListTableStorageOptimizersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTableStorageOptimizers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
