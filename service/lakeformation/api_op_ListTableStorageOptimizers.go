...
func (c *Client) ListTableStorageOptimizers(ctx context.Context, params *ListTableStorageOptimizersInput, optFns ...func(*Options)) (*ListTableStorageOptimizersOutput, error) {
	if params == nil { params = &ListTableStorageOptimizersInput{} }
...
func (c *Client) addOperationListTableStorageOptimizersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTableStorageOptimizersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTableStorageOptimizersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTableStorageOptimizersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTableStorageOptimizersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTableStorageOptimizersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTableStorageOptimizersResolveEndpointMiddleware{
