...
func (c *Client) GetDataCellsFilter(ctx context.Context, params *GetDataCellsFilterInput, optFns ...func(*Options)) (*GetDataCellsFilterOutput, error) {
	if params == nil { params = &GetDataCellsFilterInput{} }
...
func (c *Client) addOperationGetDataCellsFilterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDataCellsFilterResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDataCellsFilterResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDataCellsFilterResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDataCellsFilterResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDataCellsFilterResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDataCellsFilterResolveEndpointMiddleware{
