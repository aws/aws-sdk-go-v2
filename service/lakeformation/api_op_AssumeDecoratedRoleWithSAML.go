...
func (c *Client) addOperationAssumeDecoratedRoleWithSAMLMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssumeDecoratedRoleWithSAML", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
