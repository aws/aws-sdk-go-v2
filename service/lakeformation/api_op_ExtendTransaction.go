...
func (c *Client) ExtendTransaction(ctx context.Context, params *ExtendTransactionInput, optFns ...func(*Options)) (*ExtendTransactionOutput, error) {
	if params == nil { params = &ExtendTransactionInput{} }
...
func (c *Client) addOperationExtendTransactionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addExtendTransactionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opExtendTransactionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opExtendTransactionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opExtendTransactionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addExtendTransactionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opExtendTransactionResolveEndpointMiddleware{
