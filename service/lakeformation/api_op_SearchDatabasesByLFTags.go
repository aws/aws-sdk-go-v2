...
func (c *Client) addOperationSearchDatabasesByLFTagsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SearchDatabasesByLFTags", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
