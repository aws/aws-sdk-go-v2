		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			{
				...
				Hostname:          "lakeformation.{region}.api.amazonwebservices.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "lakeformation-fips.{region}.amazonaws.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "lakeformation-fips.{region}.api.amazonwebservices.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
