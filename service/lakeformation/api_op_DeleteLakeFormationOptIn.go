...
func (c *Client) addOperationDeleteLakeFormationOptInMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteLakeFormationOptIn", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
