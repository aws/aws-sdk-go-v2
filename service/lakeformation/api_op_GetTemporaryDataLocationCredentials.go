...
func (c *Client) addOperationGetTemporaryDataLocationCredentialsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetTemporaryDataLocationCredentials", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
