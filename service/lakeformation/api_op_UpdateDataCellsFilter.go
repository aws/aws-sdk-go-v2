...
func (c *Client) UpdateDataCellsFilter(ctx context.Context, params *UpdateDataCellsFilterInput, optFns ...func(*Options)) (*UpdateDataCellsFilterOutput, error) {
	if params == nil { params = &UpdateDataCellsFilterInput{} }
...
func (c *Client) addOperationUpdateDataCellsFilterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateDataCellsFilterResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateDataCellsFilterResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateDataCellsFilterResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateDataCellsFilterResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateDataCellsFilterResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateDataCellsFilterResolveEndpointMiddleware{
