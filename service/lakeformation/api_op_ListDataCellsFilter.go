...
func (c *Client) ListDataCellsFilter(ctx context.Context, params *ListDataCellsFilterInput, optFns ...func(*Options)) (*ListDataCellsFilterOutput, error) {
	if params == nil { params = &ListDataCellsFilterInput{} }
...
func (c *Client) addOperationListDataCellsFilterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDataCellsFilterResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDataCellsFilterResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDataCellsFilterResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDataCellsFilterResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDataCellsFilterResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDataCellsFilterResolveEndpointMiddleware{
