...
// MediaStore Data. See this package's package overview docs
...
const (
	ServiceName = "MediaStore Data" // Service's name
	ServiceID   = "MediaStoreData"  // Service's identifier
	EndpointsID = "data.mediastore" // Service's Endpoint identifier
)
