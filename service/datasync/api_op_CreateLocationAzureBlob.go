...
func (c *Client) addOperationCreateLocationAzureBlobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateLocationAzureBlob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
