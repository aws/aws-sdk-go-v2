...
func (c *Client) addOperationDescribeLocationFsxOpenZfsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeLocationFsxOpenZfs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
