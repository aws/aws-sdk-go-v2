...
type DescribeTaskExecutionOutput struct {
	...
	// of the task execution. This value is the expected number of files to be
	...
	// is calculated and updated on an ongoing basis during the TRANSFERRING phase of
	// the task execution. It's updated periodically when each file is read from the
	// source and sent over the network. If failures occur during a transfer, this
	// value can be less than EstimatedFilesToTransfer. In some cases, this value can
	// also be greater than EstimatedFilesToTransfer. This element is
