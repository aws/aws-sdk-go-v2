...
func addOperationCreateLocationObjectStorageStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateLocationObjectStorageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateLocationObjectStorageStackSlots(stack); err != nil {
		return err
	}
