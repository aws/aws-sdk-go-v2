...
func (c *Client) ListAgents(ctx context.Context, params *ListAgentsInput, optFns ...func(*Options)) (*ListAgentsOutput, error) {
	if params == nil { params = &ListAgentsInput{} }
...
func (c *Client) addOperationListAgentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAgentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAgentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAgentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAgentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAgentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAgentsResolveEndpointMiddleware{
