...
func (c *Client) addOperationDescribeLocationFsxOntapMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeLocationFsxOntap", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
