...
func (c *Client) ListStorageSystems(ctx context.Context, params *ListStorageSystemsInput, optFns ...func(*Options)) (*ListStorageSystemsOutput, error) {
	if params == nil { params = &ListStorageSystemsInput{} }
...
func (c *Client) addOperationListStorageSystemsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListStorageSystemsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
func (m *endpointPrefix_opListStorageSystemsMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEndpointPrefix_opListStorageSystemsMiddleware(stack *middleware.Stack) error {
	return stack.Serialize.Insert(&endpointPrefix_opListStorageSystemsMiddleware{}, `OperationSerializer`, middleware.After)
}
...
type opListStorageSystemsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListStorageSystemsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListStorageSystemsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListStorageSystemsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListStorageSystemsResolveEndpointMiddleware{
