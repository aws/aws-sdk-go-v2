...
func (c *Client) addOperationDescribeLocationObjectStorageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeLocationObjectStorage", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
