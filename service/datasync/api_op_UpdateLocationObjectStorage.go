...
func (c *Client) addOperationUpdateLocationObjectStorageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateLocationObjectStorage", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
