...
func (c *Client) DescribeStorageSystemResourceMetrics(ctx context.Context, params *DescribeStorageSystemResourceMetricsInput, optFns ...func(*Options)) (*DescribeStorageSystemResourceMetricsOutput, error) {
	if params == nil { params = &DescribeStorageSystemResourceMetricsInput{} }
...
func (c *Client) addOperationDescribeStorageSystemResourceMetricsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeStorageSystemResourceMetricsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
func (m *endpointPrefix_opDescribeStorageSystemResourceMetricsMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEndpointPrefix_opDescribeStorageSystemResourceMetricsMiddleware(stack *middleware.Stack) error {
	return stack.Serialize.Insert(&endpointPrefix_opDescribeStorageSystemResourceMetricsMiddleware{}, `OperationSerializer`, middleware.After)
}
...
type opDescribeStorageSystemResourceMetricsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeStorageSystemResourceMetricsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeStorageSystemResourceMetricsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addDescribeStorageSystemResourceMetricsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeStorageSystemResourceMetricsResolveEndpointMiddleware{
