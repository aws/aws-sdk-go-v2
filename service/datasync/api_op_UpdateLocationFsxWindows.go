...
func (c *Client) addOperationUpdateLocationFsxWindowsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateLocationFsxWindows", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
