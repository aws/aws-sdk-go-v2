...
type CreateTaskInput struct {
	...
	//
	//   - ENHANCED - Transfer virtually unlimited numbers of objects with enhanced
	//   metrics, more detailed logs, and higher performance than Basic mode. Currently
	...
	//   storage and on-premises, edge, or other cloud storage. DataSync [quotas]apply.
	//
