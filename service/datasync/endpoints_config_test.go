...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-datasync.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-datasync.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-datasync.dev",
			expectURL:     aws.String("https://env-datasync.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-datasync.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-datasync.dev",
			expectURL:     aws.String("http://config-datasync.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-datasync.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-datasync.dev",
			clientEndpoint: aws.String("https://client-datasync.dev"),
			expectURL:      aws.String("https://client-datasync.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DATASYNC", c.envService)
			}
