...
// DataSync. See this package's package overview docs
...
const (
	ServiceName = "DataSync" // Service's name
	ServiceID   = "DataSync" // Service's identifier
	EndpointsID = "datasync" // Service's Endpoint identifier
)
