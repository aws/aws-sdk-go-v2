...
func addOperationDescribePartnerEventSourceStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribePartnerEventSourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribePartnerEventSourceStackSlots(stack); err != nil {
		return err
	}
