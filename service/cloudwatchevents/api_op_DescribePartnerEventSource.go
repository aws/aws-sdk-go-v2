...
func (c *Client) addOperationDescribePartnerEventSourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribePartnerEventSource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
