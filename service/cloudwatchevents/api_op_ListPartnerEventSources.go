...
func (c *Client) addOperationListPartnerEventSourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPartnerEventSources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
