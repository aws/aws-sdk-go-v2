...
func addOperationListPartnerEventSourceAccountsStackSlots(stack *middleware.Stack) error {
...
func addOperationListPartnerEventSourceAccountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListPartnerEventSourceAccountsStackSlots(stack); err != nil {
		return err
	}
