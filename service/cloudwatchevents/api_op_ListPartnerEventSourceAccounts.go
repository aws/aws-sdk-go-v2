...
func (*ListPartnerEventSourceAccountsInput) operationName() string {
...
func (c *Client) addOperationListPartnerEventSourceAccountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPartnerEventSourceAccountsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListPartnerEventSourceAccountsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListPartnerEventSourceAccountsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPartnerEventSourceAccountsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPartnerEventSourceAccountsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListPartnerEventSourceAccountsResolveEndpointMiddleware{
