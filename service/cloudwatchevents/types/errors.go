...
// DeleteRule or RemoveTargets , you can use the Force parameter in those calls
// to delete the rule or remove targets from the rule. You cannot modify these
// managed rules by using DisableRule , EnableRule , PutTargets , PutRule ,
