...
func (c *Client) addOperationDeletePartnerEventSourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeletePartnerEventSource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
