...
func (c *Client) GetCrl(ctx context.Context, params *GetCrlInput, optFns ...func(*Options)) (*GetCrlOutput, error) {
	if params == nil { params = &GetCrlInput{} }
...
func (c *Client) addOperationGetCrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCrlResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCrlResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCrlResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCrlResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCrlResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCrlResolveEndpointMiddleware{
