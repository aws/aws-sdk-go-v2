...
func (c *Client) EnableProfile(ctx context.Context, params *EnableProfileInput, optFns ...func(*Options)) (*EnableProfileOutput, error) {
	if params == nil { params = &EnableProfileInput{} }
...
func (c *Client) addOperationEnableProfileMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableProfileResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEnableProfileResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEnableProfileResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableProfileResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableProfileResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEnableProfileResolveEndpointMiddleware{
