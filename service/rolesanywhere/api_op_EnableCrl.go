...
func (*EnableCrlInput) operationName() string {
	return "EnableCrl"
}
...
func (c *Client) addOperationEnableCrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableCrlResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opEnableCrlResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opEnableCrlResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableCrlResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableCrlResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opEnableCrlResolveEndpointMiddleware{
