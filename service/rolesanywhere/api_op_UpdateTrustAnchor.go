...
func (*UpdateTrustAnchorInput) operationName() string {
...
func (c *Client) addOperationUpdateTrustAnchorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateTrustAnchorResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateTrustAnchorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateTrustAnchorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateTrustAnchorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateTrustAnchorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateTrustAnchorResolveEndpointMiddleware{
