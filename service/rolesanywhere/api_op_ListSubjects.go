...
func (c *Client) ListSubjects(ctx context.Context, params *ListSubjectsInput, optFns ...func(*Options)) (*ListSubjectsOutput, error) {
	if params == nil { params = &ListSubjectsInput{} }
...
func (c *Client) addOperationListSubjectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSubjectsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSubjectsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSubjectsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSubjectsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSubjectsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSubjectsResolveEndpointMiddleware{
