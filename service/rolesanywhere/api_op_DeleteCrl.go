...
func (c *Client) DeleteCrl(ctx context.Context, params *DeleteCrlInput, optFns ...func(*Options)) (*DeleteCrlOutput, error) {
	if params == nil { params = &DeleteCrlInput{} }
...
func (c *Client) addOperationDeleteCrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCrlResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteCrlResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteCrlResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCrlResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCrlResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteCrlResolveEndpointMiddleware{
