...
func (c *Client) addOperationResetNotificationSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ResetNotificationSettings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
