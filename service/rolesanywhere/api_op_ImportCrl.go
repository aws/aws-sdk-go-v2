...
func (c *Client) ImportCrl(ctx context.Context, params *ImportCrlInput, optFns ...func(*Options)) (*ImportCrlOutput, error) {
	if params == nil { params = &ImportCrlInput{} }
...
func (c *Client) addOperationImportCrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addImportCrlResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opImportCrlResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opImportCrlResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opImportCrlResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addImportCrlResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opImportCrlResolveEndpointMiddleware{
