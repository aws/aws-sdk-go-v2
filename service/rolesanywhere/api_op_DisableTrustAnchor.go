...
func (c *Client) DisableTrustAnchor(ctx context.Context, params *DisableTrustAnchorInput, optFns ...func(*Options)) (*DisableTrustAnchorOutput, error) {
	if params == nil { params = &DisableTrustAnchorInput{} }
...
func (c *Client) addOperationDisableTrustAnchorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableTrustAnchorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisableTrustAnchorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisableTrustAnchorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableTrustAnchorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableTrustAnchorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisableTrustAnchorResolveEndpointMiddleware{
