...
func (c *Client) ListTrustAnchors(ctx context.Context, params *ListTrustAnchorsInput, optFns ...func(*Options)) (*ListTrustAnchorsOutput, error) {
	if params == nil { params = &ListTrustAnchorsInput{} }
...
func (c *Client) addOperationListTrustAnchorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTrustAnchorsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTrustAnchorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTrustAnchorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTrustAnchorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTrustAnchorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTrustAnchorsResolveEndpointMiddleware{
