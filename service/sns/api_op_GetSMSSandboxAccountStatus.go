...
func (c *Client) addOperationGetSMSSandboxAccountStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSMSSandboxAccountStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
