...
func (c *Client) CreatePlatformEndpoint(ctx context.Context, params *CreatePlatformEndpointInput, optFns ...func(*Options)) (*CreatePlatformEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePlatformEndpoint", params, optFns, addOperationCreatePlatformEndpointMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePlatformEndpointStackSlots(stack *middleware.Stack) error {
...
func addOperationCreatePlatformEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreatePlatformEndpointStackSlots(stack); err != nil {
		return err
	}
