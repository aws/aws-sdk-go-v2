...
type SetSMSAttributesInput struct {
	...
	// messages within minutes. Amazon SNS stops sending SMS messages within minutes of
	// the limit being crossed. During that interval, if you continue to send SMS
	// messages, you will incur costs that exceed your limit. By default, the spend
	// limit is set to the maximum allowed by Amazon SNS. If you want to raise the
	// limit, submit an SNS Limit Increase case (https://console.aws.amazon.com/support/home#/case/create?issueType=service-limit-increase&limitType=service-code-sns)
	...
	// To receive the report, the bucket must have a
	// policy that allows the Amazon SNS service principal to perform the s3:PutObject
	// and s3:GetBucketLocation actions. For an example bucket policy and usage
	// report, see Monitoring SMS Activity (https://docs.aws.amazon.com/sns/latest/dg/sms_stats.html)
