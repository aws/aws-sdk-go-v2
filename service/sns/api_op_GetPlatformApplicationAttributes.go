...
type GetPlatformApplicationAttributesOutput struct {
	...
	// - AppleCertificateExpiryDate – The expiry date
	// of the SSL certificate used to configure certificate-based authentication.
	// -
	// ApplePlatformTeamID – The Apple developer account ID used to configure
	// token-based authentication.
	// - ApplePlatformBundleID – The app identifier used to
