...
func (c *Client) addOperationListSMSSandboxPhoneNumbersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSMSSandboxPhoneNumbers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
