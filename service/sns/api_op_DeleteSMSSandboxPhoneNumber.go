...
// Deletes an account's verified or pending phone number from the SMS sandbox. When
// you start using Amazon SNS to send SMS messages, your account is in the SMS
