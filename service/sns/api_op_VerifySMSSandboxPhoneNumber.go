...
// calling AWS account. When you start using Amazon SNS to send SMS messages, your
// AWS account is in the SMS sandbox. The SMS sandbox provides a safe environment
// for you to try Amazon SNS features without risking your reputation as an SMS
