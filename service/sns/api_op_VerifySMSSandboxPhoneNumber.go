...
func (c *Client) addOperationVerifySMSSandboxPhoneNumberMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "VerifySMSSandboxPhoneNumber", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
