...
func addOperationListEndpointsByPlatformApplicationStackSlots(stack *middleware.Stack) error {
...
func addOperationListEndpointsByPlatformApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListEndpointsByPlatformApplicationStackSlots(stack); err != nil {
		return err
	}
