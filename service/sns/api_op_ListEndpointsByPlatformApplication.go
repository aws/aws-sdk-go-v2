...
func (c *Client) addOperationListEndpointsByPlatformApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEndpointsByPlatformApplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
