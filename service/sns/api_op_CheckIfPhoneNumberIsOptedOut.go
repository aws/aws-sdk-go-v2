...
func addOperationCheckIfPhoneNumberIsOptedOutStackSlots(stack *middleware.Stack) error {
...
func addOperationCheckIfPhoneNumberIsOptedOutMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCheckIfPhoneNumberIsOptedOutStackSlots(stack); err != nil {
		return err
	}
