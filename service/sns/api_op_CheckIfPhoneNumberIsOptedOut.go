...
func (c *Client) addOperationCheckIfPhoneNumberIsOptedOutMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CheckIfPhoneNumberIsOptedOut", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
