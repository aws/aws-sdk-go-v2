...
// Amazon SNS Developer Guide (https://docs.aws.amazon.com/sns/latest/dg/). For
// information on the permissions you need to use this API, see Identity and access
// management in Amazon SNS
