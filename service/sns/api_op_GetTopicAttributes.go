...
type GetTopicAttributesOutput struct {
	...
	// - TracingConfig – Tracing mode of
	// an Amazon SNS topic. By default TracingConfig is set to PassThrough, and the
	// topic passes through the tracing header it receives from an Amazon SNS publisher
	// to its subscriptions. If set to Active, Amazon SNS will vend X-Ray segment data
