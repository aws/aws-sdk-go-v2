...
func (c *Client) addOperationListSubscriptionsByTopicMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSubscriptionsByTopic", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
