...
type PublishInput struct {
	...
	// transport protocol, set the value of the MessageStructure  parameter to json
	// and use a JSON object for the Message  parameter. Constraints:
	...
	// A-Z, 0-9) and punctuation (!"#$%&'()*+,-./:;<=>?@[\]^_`{|}~). Every message
	// must have a unique MessageDeduplicationId, which is a token used for
	...
	// MessageDeduplicationIdduring the 5-minute deduplication interval is treated as
	// a duplicate. If the topic has ContentBasedDeduplication set, the system
	// generates a MessageDeduplicationId  based on the contents of the message. Your
	...
	// parameter, you must specify a value for the PhoneNumber  or TargetArn
	// parameters.
	TopicArn *string
