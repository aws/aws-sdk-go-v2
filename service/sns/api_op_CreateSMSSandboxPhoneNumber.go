...
func (c *Client) addOperationCreateSMSSandboxPhoneNumberMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateSMSSandboxPhoneNumber", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
