...
type GetSubscriptionAttributesOutput struct {
	...
	// the topic delivery policy and account system defaults.
	// - FilterPolicy – The
	// filter policy JSON that is assigned to the subscription. For more information,
	// see Amazon SNS Message Filtering
	// (https://docs.aws.amazon.com/sns/latest/dg/sns-message-filtering.html) in the
	// Amazon SNS Developer Guide.
	// - FilterPolicyScope – This attribute lets you choose
	// the filtering scope by using one of the following string value types:
	// -
	...
	//
	// - Owner – The Amazon
	// Web Services account ID of the subscription's owner.
	// - PendingConfirmation –
	// true if the subscription hasn't been confirmed. To confirm a pending
	...
	//
	// Specifying a valid ARN for this attribute
	// is required for Kinesis Data Firehose delivery stream subscriptions. For more
