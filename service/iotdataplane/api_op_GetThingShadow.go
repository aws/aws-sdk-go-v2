...
func (c *Client) GetThingShadow(ctx context.Context, params *GetThingShadowInput, optFns ...func(*Options)) (*GetThingShadowOutput, error) {
	if params == nil { params = &GetThingShadowInput{} }
...
func (c *Client) addOperationGetThingShadowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetThingShadowResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetThingShadowResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetThingShadowResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetThingShadowResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetThingShadowResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetThingShadowResolveEndpointMiddleware{
