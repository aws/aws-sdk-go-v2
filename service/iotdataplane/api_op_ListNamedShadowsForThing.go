...
func (c *Client) addOperationListNamedShadowsForThingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListNamedShadowsForThing", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
