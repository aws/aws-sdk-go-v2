...
func (c *Client) GetRetainedMessage(ctx context.Context, params *GetRetainedMessageInput, optFns ...func(*Options)) (*GetRetainedMessageOutput, error) {
	if params == nil { params = &GetRetainedMessageInput{} }
...
func (c *Client) addOperationGetRetainedMessageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRetainedMessageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRetainedMessageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRetainedMessageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRetainedMessageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRetainedMessageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRetainedMessageResolveEndpointMiddleware{
