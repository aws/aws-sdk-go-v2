...
type ListSubscriptionsInput struct {
	...
	// The unique identifier of the MQTT client to list subscriptions for. The client
	...
	// The maximum number of subscriptions to return in a single request. By default,
	// this is set to 20.
	MaxResults *int32
