...
func (c *Client) PutItem(ctx context.Context, params *PutItemInput, optFns ...func(*Options)) (*PutItemOutput, error) {
	if params == nil { params = &PutItemInput{} }
...
func (v *PutItemInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ConditionExpression != nil { s.WriteString(schemas.PutItemInput_ConditionExpression, *v.ConditionExpression) }
	if v.ConditionalOperator != nil { s.WriteString(schemas.PutItemInput_ConditionalOperator, *v.ConditionalOperator) }
	...
	if v.ReturnConsumedCapacity != nil { s.WriteString(schemas.PutItemInput_ReturnConsumedCapacity, *v.ReturnConsumedCapacity) }
	if v.ReturnItemCollectionMetrics != nil { s.WriteString(schemas.PutItemInput_ReturnItemCollectionMetrics, *v.ReturnItemCollectionMetrics) }
	if v.ReturnValues != nil { s.WriteString(schemas.PutItemInput_ReturnValues, *v.ReturnValues) }
	if v.ReturnValuesOnConditionCheckFailure != nil { s.WriteString(schemas.PutItemInput_ReturnValuesOnConditionCheckFailure, *v.ReturnValuesOnConditionCheckFailure) }
	if v.TableName != nil { s.WriteString(schemas.PutItemInput_TableName, *v.TableName) }
}
...
func (v *PutItemOutput) SerializeMembers(s smithy.ShapeSerializer) {
	...
	if v.ConsumedCapacity != nil { s.WriteStruct(schemas.PutItemOutput_ConsumedCapacity)
	v.ConsumedCapacity.SerializeMembers(s)
	s.CloseStruct() }
	if v.ItemCollectionMetrics != nil { s.WriteStruct(schemas.PutItemOutput_ItemCollectionMetrics)
