...
func (c *Client) HeadObject(ctx context.Context, params *HeadObjectInput, optFns ...func(*Options)) (*HeadObjectOutput, error) {
	if params == nil { params = &HeadObjectInput{} }
...
func (v *HeadObjectInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Bucket != nil { s.WriteString(schemas.HeadObjectRequest_Bucket, *v.Bucket) }
	if v.ChecksumMode != nil { s.WriteString(schemas.HeadObjectRequest_ChecksumMode, *v.ChecksumMode) }
	if v.ExpectedBucketOwner != nil { s.WriteString(schemas.HeadObjectRequest_ExpectedBucketOwner, *v.ExpectedBucketOwner) }
	if v.IfMatch != nil { s.WriteString(schemas.HeadObjectRequest_IfMatch, *v.IfMatch) }
	if v.IfModifiedSince != nil { s.WriteTime(schemas.HeadObjectRequest_IfModifiedSince, *v.IfModifiedSince) }
	if v.IfNoneMatch != nil { s.WriteString(schemas.HeadObjectRequest_IfNoneMatch, *v.IfNoneMatch) }
	if v.IfUnmodifiedSince != nil { s.WriteTime(schemas.HeadObjectRequest_IfUnmodifiedSince, *v.IfUnmodifiedSince) }
	if v.Key != nil { s.WriteString(schemas.HeadObjectRequest_Key, *v.Key) }
	if v.PartNumber != nil { s.WriteInt32(schemas.HeadObjectRequest_PartNumber, *v.PartNumber) }
	if v.Range != nil { s.WriteString(schemas.HeadObjectRequest_Range, *v.Range) }
	if v.RequestPayer != nil { s.WriteString(schemas.HeadObjectRequest_RequestPayer, *v.RequestPayer) }
	if v.ResponseCacheControl != nil { s.WriteString(schemas.HeadObjectRequest_ResponseCacheControl, *v.ResponseCacheControl) }
	if v.ResponseContentDisposition != nil { s.WriteString(schemas.HeadObjectRequest_ResponseContentDisposition, *v.ResponseContentDisposition) }
	if v.ResponseContentEncoding != nil { s.WriteString(schemas.HeadObjectRequest_ResponseContentEncoding, *v.ResponseContentEncoding) }
	if v.ResponseContentLanguage != nil { s.WriteString(schemas.HeadObjectRequest_ResponseContentLanguage, *v.ResponseContentLanguage) }
	if v.ResponseContentType != nil { s.WriteString(schemas.HeadObjectRequest_ResponseContentType, *v.ResponseContentType) }
	if v.ResponseExpires != nil { s.WriteTime(schemas.HeadObjectRequest_ResponseExpires, *v.ResponseExpires) }
	if v.SSECustomerAlgorithm != nil { s.WriteString(schemas.HeadObjectRequest_SSECustomerAlgorithm, *v.SSECustomerAlgorithm) }
	if v.SSECustomerKey != nil { s.WriteString(schemas.HeadObjectRequest_SSECustomerKey, *v.SSECustomerKey) }
	if v.SSECustomerKeyMD5 != nil { s.WriteString(schemas.HeadObjectRequest_SSECustomerKeyMD5, *v.SSECustomerKeyMD5) }
	if v.VersionId != nil { s.WriteString(schemas.HeadObjectRequest_VersionId, *v.VersionId) }
}
...
func (v *HeadObjectOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AcceptRanges != nil { s.WriteString(schemas.HeadObjectOutput_AcceptRanges, *v.AcceptRanges) }
	if v.ArchiveStatus != nil { s.WriteString(schemas.HeadObjectOutput_ArchiveStatus, *v.ArchiveStatus) }
	if v.BucketKeyEnabled != nil { s.WriteBool(schemas.HeadObjectOutput_BucketKeyEnabled, *v.BucketKeyEnabled) }
	if v.CacheControl != nil { s.WriteString(schemas.HeadObjectOutput_CacheControl, *v.CacheControl) }
	if v.ChecksumCRC32 != nil { s.WriteString(schemas.HeadObjectOutput_ChecksumCRC32, *v.ChecksumCRC32) }
	if v.ChecksumCRC32C != nil { s.WriteString(schemas.HeadObjectOutput_ChecksumCRC32C, *v.ChecksumCRC32C) }
	if v.ChecksumCRC64NVME != nil { s.WriteString(schemas.HeadObjectOutput_ChecksumCRC64NVME, *v.ChecksumCRC64NVME) }
	if v.ChecksumSHA1 != nil { s.WriteString(schemas.HeadObjectOutput_ChecksumSHA1, *v.ChecksumSHA1) }
	if v.ChecksumSHA256 != nil { s.WriteString(schemas.HeadObjectOutput_ChecksumSHA256, *v.ChecksumSHA256) }
	if v.ChecksumType != nil { s.WriteString(schemas.HeadObjectOutput_ChecksumType, *v.ChecksumType) }
	if v.ContentDisposition != nil { s.WriteString(schemas.HeadObjectOutput_ContentDisposition, *v.ContentDisposition) }
	if v.ContentEncoding != nil { s.WriteString(schemas.HeadObjectOutput_ContentEncoding, *v.ContentEncoding) }
	if v.ContentLanguage != nil { s.WriteString(schemas.HeadObjectOutput_ContentLanguage, *v.ContentLanguage) }
	if v.ContentLength != nil { s.WriteInt64(schemas.HeadObjectOutput_ContentLength, *v.ContentLength) }
	if v.ContentRange != nil { s.WriteString(schemas.HeadObjectOutput_ContentRange, *v.ContentRange) }
	if v.ContentType != nil { s.WriteString(schemas.HeadObjectOutput_ContentType, *v.ContentType) }
	if v.DeleteMarker != nil { s.WriteBool(schemas.HeadObjectOutput_DeleteMarker, *v.DeleteMarker) }
	if v.ETag != nil { s.WriteString(schemas.HeadObjectOutput_ETag, *v.ETag) }
	if v.Expiration != nil { s.WriteString(schemas.HeadObjectOutput_Expiration, *v.Expiration) }
	if v.Expires != nil { s.WriteTime(schemas.HeadObjectOutput_Expires, *v.Expires) }
	if v.LastModified != nil { s.WriteTime(schemas.HeadObjectOutput_LastModified, *v.LastModified) }
	if v.MissingMeta != nil { s.WriteInt32(schemas.HeadObjectOutput_MissingMeta, *v.MissingMeta) }
	if v.ObjectLockLegalHoldStatus != nil { s.WriteString(schemas.HeadObjectOutput_ObjectLockLegalHoldStatus, *v.ObjectLockLegalHoldStatus) }
	if v.ObjectLockMode != nil { s.WriteString(schemas.HeadObjectOutput_ObjectLockMode, *v.ObjectLockMode) }
	if v.ObjectLockRetainUntilDate != nil { s.WriteTime(schemas.HeadObjectOutput_ObjectLockRetainUntilDate, *v.ObjectLockRetainUntilDate) }
	if v.PartsCount != nil { s.WriteInt32(schemas.HeadObjectOutput_PartsCount, *v.PartsCount) }
	if v.ReplicationStatus != nil { s.WriteString(schemas.HeadObjectOutput_ReplicationStatus, *v.ReplicationStatus) }
	if v.RequestCharged != nil { s.WriteString(schemas.HeadObjectOutput_RequestCharged, *v.RequestCharged) }
	if v.Restore != nil { s.WriteString(schemas.HeadObjectOutput_Restore, *v.Restore) }
	if v.SSECustomerAlgorithm != nil { s.WriteString(schemas.HeadObjectOutput_SSECustomerAlgorithm, *v.SSECustomerAlgorithm) }
	if v.SSECustomerKeyMD5 != nil { s.WriteString(schemas.HeadObjectOutput_SSECustomerKeyMD5, *v.SSECustomerKeyMD5) }
	if v.SSEKMSKeyId != nil { s.WriteString(schemas.HeadObjectOutput_SSEKMSKeyId, *v.SSEKMSKeyId) }
	if v.ServerSideEncryption != nil { s.WriteString(schemas.HeadObjectOutput_ServerSideEncryption, *v.ServerSideEncryption) }
	if v.StorageClass != nil { s.WriteString(schemas.HeadObjectOutput_StorageClass, *v.StorageClass) }
	if v.TagCount != nil { s.WriteInt32(schemas.HeadObjectOutput_TagCount, *v.TagCount) }
	if v.VersionId != nil { s.WriteString(schemas.HeadObjectOutput_VersionId, *v.VersionId) }
	if v.WebsiteRedirectLocation != nil { s.WriteString(schemas.HeadObjectOutput_WebsiteRedirectLocation, *v.WebsiteRedirectLocation) }
}
