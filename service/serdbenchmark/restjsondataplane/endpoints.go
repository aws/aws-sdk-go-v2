...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/serdbenchmark/restjsondataplane/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_RESTJSONDATAPLANE")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "RestJsonDataPlane", cfg.ConfigSources)
	if found && err == nil {
