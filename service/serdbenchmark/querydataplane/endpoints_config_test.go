...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-querydataplane.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-querydataplane.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-querydataplane.dev",
			expectURL:     aws.String("https://env-querydataplane.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-querydataplane.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-querydataplane.dev",
			expectURL:     aws.String("http://config-querydataplane.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-querydataplane.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-querydataplane.dev",
			clientEndpoint: aws.String("https://client-querydataplane.dev"),
			expectURL:      aws.String("https://client-querydataplane.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_QUERYDATAPLANE", c.envService)
			}
