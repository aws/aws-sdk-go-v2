...
func TestSerdClient_GetMetricData_(t *testing.T) {
	...
	BodyAssert func(io.Reader) error
		...
		"awsQuery_GetMetricDataRequest_S": {
			...
			EndTime:
			ptr.Time(smithytime.ParseEpochSeconds(1609462800)),
			},
			ExpectMethod: "POST",
			ExpectURIPath: "/",
			ExpectQuery: []smithytesting.QueryItem {
		...
		"awsQuery_GetMetricDataRequest_L": {
			...
			ptr.String("m1 * 100"),
			Label:
			ptr.String("alpacas_found_percent"),
			},
			types.MetricDataQuery{
			Id:
			ptr.String("m3"),
			...
			ptr.String("m6"),
			Expression:
			ptr.String("ANOMALY_DETECTION_FUNCTION(m5, 2)"),
			Label:
			ptr.String("dolphins_jumping_anomaly"),
			},
			types.MetricDataQuery{
			Id:
			ptr.String("m7"),
			...
			ptr.String("m7 + m8"),
			Label:
			ptr.String("combined_animal_activity"),
			ReturnData:
			ptr.Bool(false),
			},
			types.MetricDataQuery{
			...
			ptr.String("m12"),
			Expression:
			ptr.String("IF(m11 > 50, 1, 0)"),
			Label:
			ptr.String("high_panda_activity"),
			},
			types.MetricDataQuery{
			Id:
			ptr.String("m13"),
			...
			ptr.String("m21"),
			Expression:
			ptr.String("(m19 + m20) / 1024"),
			Label:
			ptr.String("aquatic_mammals_total"),
			},
			types.MetricDataQuery{
			Id:
			ptr.String("m22"),
			...
			ptr.String("m24"),
			Expression:
			ptr.String("SEARCH('{AWS/SDK,InstanceId} MetricName=\"alpacas_found\"', 'Average', 300)"),
			Label:
			ptr.String("all_alpacas"),
			},
			types.MetricDataQuery{
			Id:
			ptr.String("m25"),
			...
			ptr.String("m25 * 4096"),
			Label:
			ptr.String("estimated_toucan_bytes"),
			},
			types.MetricDataQuery{
			Id:
			ptr.String("m28"),
			...
			ptr.Int32(1440),
			ScanBy:
			types.ScanBy("TimestampDescending"),
			LabelOptions:
			&types.LabelOptions{
			Timezone:
			ptr.String("UTC"),
...
func TestDeserdClient_GetMetricData_(t *testing.T) {
	...
	ExpectResult *GetMetricDataOutput
		...
		"awsQuery_GetMetricDataResponse_L": {
			...
			StatusCode:
			types.StatusCode("PartialData"),
			Messages:
			[]types.MessageData{
			types.MessageData{
			Code:
			ptr.String("InternalError"),
			Value:
			ptr.String("Penguin data partially unavailable due to ice storm"),
			},
			},
			},
			types.MetricDataResult{
			...
			StatusCode:
			types.StatusCode("InternalError"),
			Messages:
			[]types.MessageData{
			types.MessageData{
			Code:
			ptr.String("InternalError"),
			Value:
			ptr.String("Giraffe feeding schedule access denied"),
			},
			},
			},
			types.MetricDataResult{
			...
			StatusCode:
			types.StatusCode("Forbidden"),
			Messages:
			[]types.MessageData{
			types.MessageData{
			Code:
			ptr.String("AccessDenied"),
			Value:
			ptr.String("Zebra tracking permissions insufficient"),
			},
			},
			},
			types.MetricDataResult{
			...
			ptr.String("r3"),
			Label:
			ptr.String("butterfly_response_time"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("d1"),
			Label:
			ptr.String("fish_swimming_speed"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("d4"),
			Label:
			ptr.String("octopus_response_time"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("d5"),
			Label:
			ptr.String("max_sea_creature_latency"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("l1"),
			Label:
			ptr.String("firefly_invocations"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("l3"),
			Label:
			ptr.String("total_bug_execution_time"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("l5"),
			Label:
			ptr.String("grasshopper_throttles"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("s1"),
			Label:
			ptr.String("acorn_storage_bytes"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			},
			...
			ptr.String("dy1"),
			Label:
			ptr.String("squirrel_read_capacity"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("dy2"),
			Label:
			ptr.String("total_chipmunk_capacity"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("dy3"),
			Label:
			ptr.String("hamster_throttled_requests"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("sq1"),
			Label:
			ptr.String("rabbit_messages_visible"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("sq2"),
			Label:
			ptr.String("bunny_message_growth_rate"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("sq4"),
			Label:
			ptr.String("cottontail_messages_received"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("sq5"),
			Label:
			ptr.String("rabbit_message_backlog"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("sn1"),
			Label:
			ptr.String("pigeon_notifications_sent"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("sn2"),
			Label:
			ptr.String("dove_notification_failure_rate"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("cf2"),
			Label:
			ptr.String("eagle_bytes_downloaded"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("cf3"),
			Label:
			ptr.String("avg_bird_response_size"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("cf4"),
			Label:
			ptr.String("crow_4xx_error_rate"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("cf5"),
			Label:
			ptr.String("raven_5xx_error_rate"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("cf6"),
			Label:
			ptr.String("total_bird_error_rate"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("ag2"),
			Label:
			ptr.String("gorilla_p95_latency"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("ag4"),
			Label:
			ptr.String("orangutan_5xx_errors"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("ec1"),
			Label:
			ptr.String("cheetah_cpu_utilization"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("ec2"),
			Label:
			ptr.String("leopard_memory_utilization"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("ec3"),
			Label:
			ptr.String("max_wildcat_utilization"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("el1"),
			Label:
			ptr.String("sloth_cpu_utilization"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("el2"),
			Label:
			ptr.String("armadillo_cache_misses"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("el3"),
			Label:
			ptr.String("anteater_cache_hit_rate"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("k1"),
			Label:
			ptr.String("salmon_incoming_records"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("k2"),
			Label:
			ptr.String("trout_outgoing_records"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("k3"),
			Label:
			ptr.String("fish_record_backlog"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("rs1"),
			Label:
			ptr.String("whale_cpu_utilization"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("rs2"),
			Label:
			ptr.String("dolphin_connection_anomaly"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("cw1"),
			Label:
			ptr.String("mole_disk_used_percent"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("cw2"),
			Label:
			ptr.String("badger_mem_used_percent"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("cw3"),
			Label:
			ptr.String("groundhog_resource_alert"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("cw4"),
			Label:
			ptr.String("prairie_dog_tcp_connections"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("cw5"),
			Label:
			ptr.String("gopher_processes_total"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("cw6"),
			Label:
			ptr.String("woodchuck_process_growth_rate"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			ptr.String("u2"),
			Label:
			ptr.String("nightingale_api_call_rate"),
			Timestamps:
			[]time.Time{
			smithytime.ParseEpochSeconds(1609459200),
			smithytime.ParseEpochSeconds(1609459500),
			...
			NextToken:
			ptr.String("AQICAHhQdAFQVGGp"),
			Messages:
			[]types.MessageData{
			types.MessageData{
			Code:
			ptr.String("PartialData"),
			Value:
			ptr.String("Some animal metrics could not be retrieved due to migration season"),
			},
			},
			},
		},
