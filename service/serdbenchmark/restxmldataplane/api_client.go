...
func withOperationMetrics(parent context.Context, mp metrics.MeterProvider) (context.Context, error) {
    ...
    meter := mp.Meter("github.com/aws/aws-sdk-go-v2/service/serdbenchmark/restxmldataplane")
    om := &operationMetrics{}
...
func operationTracer(p tracing.TracerProvider) tracing.Tracer {
    return p.Tracer("github.com/aws/aws-sdk-go-v2/service/serdbenchmark/restxmldataplane")
}
...
finalizeClientEndpointResolverOptions(&options)
    ...
    handler := smithyhttp.NewClientHandlerWithOptions(options.HTTPClient, func(o *smithyhttp.ClientHandler) {
        o.Meter = options.MeterProvider.Meter("github.com/aws/aws-sdk-go-v2/service/serdbenchmark/restxmldataplane")
    })
...
func addRetry(stack *middleware.Stack, o Options, c *Client) error {
    attempt := retry.NewAttemptMiddleware(o.Retryer, smithyhttp.RequestCloner, func(m *retry.Attempt) {
        ...
        m.OperationMeter = o.MeterProvider.Meter("github.com/aws/aws-sdk-go-v2/service/serdbenchmark/restxmldataplane")
...
func GetComputedInputChecksumsMetadata(m middleware.Metadata) (ComputedInputChecksumsMetadata, bool) {
	...
	if !ok { return ComputedInputChecksumsMetadata{}, false }
...
func GetChecksumValidationMetadata(m middleware.Metadata) (ChecksumValidationMetadata, bool) {
	...
	if !ok { return ChecksumValidationMetadata{}, false }
