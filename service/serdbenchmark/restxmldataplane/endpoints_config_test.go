...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-restxmldataplane.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-restxmldataplane.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-restxmldataplane.dev",
			expectURL:     aws.String("https://env-restxmldataplane.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-restxmldataplane.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-restxmldataplane.dev",
			expectURL:     aws.String("http://config-restxmldataplane.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-restxmldataplane.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-restxmldataplane.dev",
			clientEndpoint: aws.String("https://client-restxmldataplane.dev"),
			expectURL:      aws.String("https://client-restxmldataplane.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_RESTXMLDATAPLANE", c.envService)
			}
