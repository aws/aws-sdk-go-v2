...
func (c *Client) CopyObject(ctx context.Context, params *CopyObjectInput, optFns ...func(*Options)) (*CopyObjectOutput, error) {
	if params == nil { params = &CopyObjectInput{} }
...
func (v *CopyObjectInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ACL != nil { s.WriteString(schemas.CopyObjectRequest_ACL, *v.ACL) }
	if v.Bucket != nil { s.WriteString(schemas.CopyObjectRequest_Bucket, *v.Bucket) }
	if v.BucketKeyEnabled != nil { s.WriteBool(schemas.CopyObjectRequest_BucketKeyEnabled, *v.BucketKeyEnabled) }
	if v.CacheControl != nil { s.WriteString(schemas.CopyObjectRequest_CacheControl, *v.CacheControl) }
	if v.ChecksumAlgorithm != nil { s.WriteString(schemas.CopyObjectRequest_ChecksumAlgorithm, *v.ChecksumAlgorithm) }
	if v.ContentDisposition != nil { s.WriteString(schemas.CopyObjectRequest_ContentDisposition, *v.ContentDisposition) }
	if v.ContentEncoding != nil { s.WriteString(schemas.CopyObjectRequest_ContentEncoding, *v.ContentEncoding) }
	if v.ContentLanguage != nil { s.WriteString(schemas.CopyObjectRequest_ContentLanguage, *v.ContentLanguage) }
	if v.ContentType != nil { s.WriteString(schemas.CopyObjectRequest_ContentType, *v.ContentType) }
	if v.CopySource != nil { s.WriteString(schemas.CopyObjectRequest_CopySource, *v.CopySource) }
	if v.CopySourceIfMatch != nil { s.WriteString(schemas.CopyObjectRequest_CopySourceIfMatch, *v.CopySourceIfMatch) }
	if v.CopySourceIfModifiedSince != nil { s.WriteTime(schemas.CopyObjectRequest_CopySourceIfModifiedSince, *v.CopySourceIfModifiedSince) }
	if v.CopySourceIfNoneMatch != nil { s.WriteString(schemas.CopyObjectRequest_CopySourceIfNoneMatch, *v.CopySourceIfNoneMatch) }
	if v.CopySourceIfUnmodifiedSince != nil { s.WriteTime(schemas.CopyObjectRequest_CopySourceIfUnmodifiedSince, *v.CopySourceIfUnmodifiedSince) }
	if v.CopySourceSSECustomerAlgorithm != nil { s.WriteString(schemas.CopyObjectRequest_CopySourceSSECustomerAlgorithm, *v.CopySourceSSECustomerAlgorithm) }
	if v.CopySourceSSECustomerKey != nil { s.WriteString(schemas.CopyObjectRequest_CopySourceSSECustomerKey, *v.CopySourceSSECustomerKey) }
	if v.CopySourceSSECustomerKeyMD5 != nil { s.WriteString(schemas.CopyObjectRequest_CopySourceSSECustomerKeyMD5, *v.CopySourceSSECustomerKeyMD5) }
	if v.ExpectedBucketOwner != nil { s.WriteString(schemas.CopyObjectRequest_ExpectedBucketOwner, *v.ExpectedBucketOwner) }
	if v.ExpectedSourceBucketOwner != nil { s.WriteString(schemas.CopyObjectRequest_ExpectedSourceBucketOwner, *v.ExpectedSourceBucketOwner) }
	if v.Expires != nil { s.WriteTime(schemas.CopyObjectRequest_Expires, *v.Expires) }
	if v.GrantFullControl != nil { s.WriteString(schemas.CopyObjectRequest_GrantFullControl, *v.GrantFullControl) }
	if v.GrantRead != nil { s.WriteString(schemas.CopyObjectRequest_GrantRead, *v.GrantRead) }
	if v.GrantReadACP != nil { s.WriteString(schemas.CopyObjectRequest_GrantReadACP, *v.GrantReadACP) }
	if v.GrantWriteACP != nil { s.WriteString(schemas.CopyObjectRequest_GrantWriteACP, *v.GrantWriteACP) }
	if v.IfMatch != nil { s.WriteString(schemas.CopyObjectRequest_IfMatch, *v.IfMatch) }
	if v.IfNoneMatch != nil { s.WriteString(schemas.CopyObjectRequest_IfNoneMatch, *v.IfNoneMatch) }
	if v.Key != nil { s.WriteString(schemas.CopyObjectRequest_Key, *v.Key) }
	if v.MetadataDirective != nil { s.WriteString(schemas.CopyObjectRequest_MetadataDirective, *v.MetadataDirective) }
	if v.ObjectLockLegalHoldStatus != nil { s.WriteString(schemas.CopyObjectRequest_ObjectLockLegalHoldStatus, *v.ObjectLockLegalHoldStatus) }
	if v.ObjectLockMode != nil { s.WriteString(schemas.CopyObjectRequest_ObjectLockMode, *v.ObjectLockMode) }
	if v.ObjectLockRetainUntilDate != nil { s.WriteTime(schemas.CopyObjectRequest_ObjectLockRetainUntilDate, *v.ObjectLockRetainUntilDate) }
	if v.RequestPayer != nil { s.WriteString(schemas.CopyObjectRequest_RequestPayer, *v.RequestPayer) }
	if v.SSECustomerAlgorithm != nil { s.WriteString(schemas.CopyObjectRequest_SSECustomerAlgorithm, *v.SSECustomerAlgorithm) }
	if v.SSECustomerKey != nil { s.WriteString(schemas.CopyObjectRequest_SSECustomerKey, *v.SSECustomerKey) }
	if v.SSECustomerKeyMD5 != nil { s.WriteString(schemas.CopyObjectRequest_SSECustomerKeyMD5, *v.SSECustomerKeyMD5) }
	if v.SSEKMSEncryptionContext != nil { s.WriteString(schemas.CopyObjectRequest_SSEKMSEncryptionContext, *v.SSEKMSEncryptionContext) }
	if v.SSEKMSKeyId != nil { s.WriteString(schemas.CopyObjectRequest_SSEKMSKeyId, *v.SSEKMSKeyId) }
	if v.ServerSideEncryption != nil { s.WriteString(schemas.CopyObjectRequest_ServerSideEncryption, *v.ServerSideEncryption) }
	if v.StorageClass != nil { s.WriteString(schemas.CopyObjectRequest_StorageClass, *v.StorageClass) }
	if v.Tagging != nil { s.WriteString(schemas.CopyObjectRequest_Tagging, *v.Tagging) }
	if v.TaggingDirective != nil { s.WriteString(schemas.CopyObjectRequest_TaggingDirective, *v.TaggingDirective) }
	if v.WebsiteRedirectLocation != nil { s.WriteString(schemas.CopyObjectRequest_WebsiteRedirectLocation, *v.WebsiteRedirectLocation) }
}
...
func (v *CopyObjectOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.BucketKeyEnabled != nil { s.WriteBool(schemas.CopyObjectOutput_BucketKeyEnabled, *v.BucketKeyEnabled) }
	if v.ChecksumCRC32 != nil { s.WriteString(schemas.CopyObjectOutput_ChecksumCRC32, *v.ChecksumCRC32) }
	if v.ChecksumCRC32C != nil { s.WriteString(schemas.CopyObjectOutput_ChecksumCRC32C, *v.ChecksumCRC32C) }
	if v.ChecksumCRC64NVME != nil { s.WriteString(schemas.CopyObjectOutput_ChecksumCRC64NVME, *v.ChecksumCRC64NVME) }
	if v.ChecksumSHA1 != nil { s.WriteString(schemas.CopyObjectOutput_ChecksumSHA1, *v.ChecksumSHA1) }
	if v.ChecksumSHA256 != nil { s.WriteString(schemas.CopyObjectOutput_ChecksumSHA256, *v.ChecksumSHA256) }
	if v.ChecksumType != nil { s.WriteString(schemas.CopyObjectOutput_ChecksumType, *v.ChecksumType) }
	if v.CopySourceVersionId != nil { s.WriteString(schemas.CopyObjectOutput_CopySourceVersionId, *v.CopySourceVersionId) }
	if v.ETag != nil { s.WriteString(schemas.CopyObjectOutput_ETag, *v.ETag) }
	if v.Expiration != nil { s.WriteString(schemas.CopyObjectOutput_Expiration, *v.Expiration) }
	if v.LastModified != nil { s.WriteTime(schemas.CopyObjectOutput_LastModified, *v.LastModified) }
	if v.RequestCharged != nil { s.WriteString(schemas.CopyObjectOutput_RequestCharged, *v.RequestCharged) }
	if v.SSECustomerAlgorithm != nil { s.WriteString(schemas.CopyObjectOutput_SSECustomerAlgorithm, *v.SSECustomerAlgorithm) }
	if v.SSECustomerKeyMD5 != nil { s.WriteString(schemas.CopyObjectOutput_SSECustomerKeyMD5, *v.SSECustomerKeyMD5) }
	if v.SSEKMSEncryptionContext != nil { s.WriteString(schemas.CopyObjectOutput_SSEKMSEncryptionContext, *v.SSEKMSEncryptionContext) }
	if v.SSEKMSKeyId != nil { s.WriteString(schemas.CopyObjectOutput_SSEKMSKeyId, *v.SSEKMSKeyId) }
	if v.ServerSideEncryption != nil { s.WriteString(schemas.CopyObjectOutput_ServerSideEncryption, *v.ServerSideEncryption) }
	if v.VersionId != nil { s.WriteString(schemas.CopyObjectOutput_VersionId, *v.VersionId) }
}
