...
func (v *PutObjectInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ACL != nil { s.WriteString(schemas.PutObjectRequest_ACL, *v.ACL) }
	if v.Body != nil { s.WriteBlob(schemas.PutObjectRequest_Body, v.Body) }
	if v.Bucket != nil { s.WriteString(schemas.PutObjectRequest_Bucket, *v.Bucket) }
	if v.BucketKeyEnabled != nil { s.WriteBool(schemas.PutObjectRequest_BucketKeyEnabled, *v.BucketKeyEnabled) }
	if v.CacheControl != nil { s.WriteString(schemas.PutObjectRequest_CacheControl, *v.CacheControl) }
	if v.ChecksumAlgorithm != "" { s.WriteString(schemas.PutObjectRequest_ChecksumAlgorithm, string(v.ChecksumAlgorithm)) }
	if v.ChecksumCRC32 != nil { s.WriteString(schemas.PutObjectRequest_ChecksumCRC32, *v.ChecksumCRC32) }
	if v.ChecksumCRC32C != nil { s.WriteString(schemas.PutObjectRequest_ChecksumCRC32C, *v.ChecksumCRC32C) }
	if v.ChecksumCRC64NVME != nil { s.WriteString(schemas.PutObjectRequest_ChecksumCRC64NVME, *v.ChecksumCRC64NVME) }
	if v.ChecksumSHA1 != nil { s.WriteString(schemas.PutObjectRequest_ChecksumSHA1, *v.ChecksumSHA1) }
	if v.ChecksumSHA256 != nil { s.WriteString(schemas.PutObjectRequest_ChecksumSHA256, *v.ChecksumSHA256) }
	if v.ContentDisposition != nil { s.WriteString(schemas.PutObjectRequest_ContentDisposition, *v.ContentDisposition) }
	if v.ContentEncoding != nil { s.WriteString(schemas.PutObjectRequest_ContentEncoding, *v.ContentEncoding) }
	if v.ContentLanguage != nil { s.WriteString(schemas.PutObjectRequest_ContentLanguage, *v.ContentLanguage) }
	if v.ContentLength != nil { s.WriteInt64(schemas.PutObjectRequest_ContentLength, *v.ContentLength) }
	if v.ContentMD5 != nil { s.WriteString(schemas.PutObjectRequest_ContentMD5, *v.ContentMD5) }
	if v.ContentType != nil { s.WriteString(schemas.PutObjectRequest_ContentType, *v.ContentType) }
	if v.ExpectedBucketOwner != nil { s.WriteString(schemas.PutObjectRequest_ExpectedBucketOwner, *v.ExpectedBucketOwner) }
	if v.Expires != nil { s.WriteTime(schemas.PutObjectRequest_Expires, *v.Expires) }
	if v.GrantFullControl != nil { s.WriteString(schemas.PutObjectRequest_GrantFullControl, *v.GrantFullControl) }
	if v.GrantRead != nil { s.WriteString(schemas.PutObjectRequest_GrantRead, *v.GrantRead) }
	if v.GrantReadACP != nil { s.WriteString(schemas.PutObjectRequest_GrantReadACP, *v.GrantReadACP) }
	if v.GrantWriteACP != nil { s.WriteString(schemas.PutObjectRequest_GrantWriteACP, *v.GrantWriteACP) }
	if v.IfMatch != nil { s.WriteString(schemas.PutObjectRequest_IfMatch, *v.IfMatch) }
	if v.IfNoneMatch != nil { s.WriteString(schemas.PutObjectRequest_IfNoneMatch, *v.IfNoneMatch) }
	if v.Key != nil { s.WriteString(schemas.PutObjectRequest_Key, *v.Key) }
	serializeMetadata(s, schemas.PutObjectRequest_Metadata, v.Metadata)
	if v.ObjectLockLegalHoldStatus != nil { s.WriteString(schemas.PutObjectRequest_ObjectLockLegalHoldStatus, *v.ObjectLockLegalHoldStatus) }
	if v.ObjectLockMode != nil { s.WriteString(schemas.PutObjectRequest_ObjectLockMode, *v.ObjectLockMode) }
	if v.ObjectLockRetainUntilDate != nil { s.WriteTime(schemas.PutObjectRequest_ObjectLockRetainUntilDate, *v.ObjectLockRetainUntilDate) }
	if v.RequestPayer != nil { s.WriteString(schemas.PutObjectRequest_RequestPayer, *v.RequestPayer) }
	if v.SSECustomerAlgorithm != nil { s.WriteString(schemas.PutObjectRequest_SSECustomerAlgorithm, *v.SSECustomerAlgorithm) }
	if v.SSECustomerKey != nil { s.WriteString(schemas.PutObjectRequest_SSECustomerKey, *v.SSECustomerKey) }
	if v.SSECustomerKeyMD5 != nil { s.WriteString(schemas.PutObjectRequest_SSECustomerKeyMD5, *v.SSECustomerKeyMD5) }
	if v.SSEKMSEncryptionContext != nil { s.WriteString(schemas.PutObjectRequest_SSEKMSEncryptionContext, *v.SSEKMSEncryptionContext) }
	if v.SSEKMSKeyId != nil { s.WriteString(schemas.PutObjectRequest_SSEKMSKeyId, *v.SSEKMSKeyId) }
	if v.ServerSideEncryption != nil { s.WriteString(schemas.PutObjectRequest_ServerSideEncryption, *v.ServerSideEncryption) }
	if v.StorageClass != nil { s.WriteString(schemas.PutObjectRequest_StorageClass, *v.StorageClass) }
	if v.Tagging != nil { s.WriteString(schemas.PutObjectRequest_Tagging, *v.Tagging) }
	if v.WebsiteRedirectLocation != nil { s.WriteString(schemas.PutObjectRequest_WebsiteRedirectLocation, *v.WebsiteRedirectLocation) }
	if v.WriteOffsetBytes != nil { s.WriteInt64(schemas.PutObjectRequest_WriteOffsetBytes, *v.WriteOffsetBytes) }
}
...
func (v *PutObjectOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.BucketKeyEnabled != nil { s.WriteBool(schemas.PutObjectOutput_BucketKeyEnabled, *v.BucketKeyEnabled) }
	if v.ChecksumCRC32 != nil { s.WriteString(schemas.PutObjectOutput_ChecksumCRC32, *v.ChecksumCRC32) }
	if v.ChecksumCRC32C != nil { s.WriteString(schemas.PutObjectOutput_ChecksumCRC32C, *v.ChecksumCRC32C) }
	if v.ChecksumCRC64NVME != nil { s.WriteString(schemas.PutObjectOutput_ChecksumCRC64NVME, *v.ChecksumCRC64NVME) }
	if v.ChecksumSHA1 != nil { s.WriteString(schemas.PutObjectOutput_ChecksumSHA1, *v.ChecksumSHA1) }
	if v.ChecksumSHA256 != nil { s.WriteString(schemas.PutObjectOutput_ChecksumSHA256, *v.ChecksumSHA256) }
	if v.ChecksumType != nil { s.WriteString(schemas.PutObjectOutput_ChecksumType, *v.ChecksumType) }
	if v.ETag != nil { s.WriteString(schemas.PutObjectOutput_ETag, *v.ETag) }
	if v.Expiration != nil { s.WriteString(schemas.PutObjectOutput_Expiration, *v.Expiration) }
	if v.RequestCharged != nil { s.WriteString(schemas.PutObjectOutput_RequestCharged, *v.RequestCharged) }
	if v.SSECustomerAlgorithm != nil { s.WriteString(schemas.PutObjectOutput_SSECustomerAlgorithm, *v.SSECustomerAlgorithm) }
	if v.SSECustomerKeyMD5 != nil { s.WriteString(schemas.PutObjectOutput_SSECustomerKeyMD5, *v.SSECustomerKeyMD5) }
	if v.SSEKMSEncryptionContext != nil { s.WriteString(schemas.PutObjectOutput_SSEKMSEncryptionContext, *v.SSEKMSEncryptionContext) }
	if v.SSEKMSKeyId != nil { s.WriteString(schemas.PutObjectOutput_SSEKMSKeyId, *v.SSEKMSKeyId) }
	if v.ServerSideEncryption != nil { s.WriteString(schemas.PutObjectOutput_ServerSideEncryption, *v.ServerSideEncryption) }
	if v.Size != nil { s.WriteInt64(schemas.PutObjectOutput_Size, *v.Size) }
	if v.VersionId != nil { s.WriteString(schemas.PutObjectOutput_VersionId, *v.VersionId) }
}
