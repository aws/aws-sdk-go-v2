...
func (c *Client) GetDatasetContent(ctx context.Context, params *GetDatasetContentInput, optFns ...func(*Options)) (*GetDatasetContentOutput, error) {
	if params == nil { params = &GetDatasetContentInput{} }
...
func (c *Client) addOperationGetDatasetContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDatasetContentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDatasetContentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDatasetContentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDatasetContentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDatasetContentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDatasetContentResolveEndpointMiddleware{
