...
func (c *Client) ListDatasetContents(ctx context.Context, params *ListDatasetContentsInput, optFns ...func(*Options)) (*ListDatasetContentsOutput, error) {
	if params == nil { params = &ListDatasetContentsInput{} }
...
func (c *Client) addOperationListDatasetContentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDatasetContentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDatasetContentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDatasetContentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDatasetContentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDatasetContentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDatasetContentsResolveEndpointMiddleware{
