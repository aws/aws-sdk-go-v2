...
func (c *Client) CancelPipelineReprocessing(ctx context.Context, params *CancelPipelineReprocessingInput, optFns ...func(*Options)) (*CancelPipelineReprocessingOutput, error) {
	if params == nil { params = &CancelPipelineReprocessingInput{} }
...
func (c *Client) addOperationCancelPipelineReprocessingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelPipelineReprocessingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelPipelineReprocessingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelPipelineReprocessingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelPipelineReprocessingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelPipelineReprocessingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelPipelineReprocessingResolveEndpointMiddleware{
