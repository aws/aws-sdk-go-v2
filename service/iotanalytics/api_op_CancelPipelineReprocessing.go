...
func addOperationCancelPipelineReprocessingStackSlots(stack *middleware.Stack) error {
...
func addOperationCancelPipelineReprocessingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCancelPipelineReprocessingStackSlots(stack); err != nil {
		return err
	}
