...
func (c *Client) DescribeDatastore(ctx context.Context, params *DescribeDatastoreInput, optFns ...func(*Options)) (*DescribeDatastoreOutput, error) {
	if params == nil { params = &DescribeDatastoreInput{} }
...
func (c *Client) addOperationDescribeDatastoreMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeDatastoreResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeDatastoreResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeDatastoreResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeDatastoreResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeDatastoreResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeDatastoreResolveEndpointMiddleware{
