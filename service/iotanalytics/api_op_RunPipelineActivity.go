...
func (c *Client) RunPipelineActivity(ctx context.Context, params *RunPipelineActivityInput, optFns ...func(*Options)) (*RunPipelineActivityOutput, error) {
	if params == nil { params = &RunPipelineActivityInput{} }
...
func (c *Client) addOperationRunPipelineActivityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRunPipelineActivityResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRunPipelineActivityResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRunPipelineActivityResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRunPipelineActivityResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRunPipelineActivityResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRunPipelineActivityResolveEndpointMiddleware{
