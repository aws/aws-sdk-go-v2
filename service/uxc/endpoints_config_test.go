...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-uxc.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-uxc.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-uxc.dev",
			expectURL:     aws.String("https://env-uxc.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-uxc.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-uxc.dev",
			expectURL:     aws.String("http://config-uxc.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-uxc.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-uxc.dev",
			clientEndpoint: aws.String("https://client-uxc.dev"),
			expectURL:      aws.String("https://client-uxc.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_UXC", c.envService)
			}
