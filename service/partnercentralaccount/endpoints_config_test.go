...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-partnercentral-account.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-partnercentral-account.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-partnercentral-account.dev",
			expectURL:     aws.String("https://env-partnercentral-account.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-partnercentral-account.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-partnercentral-account.dev",
			expectURL:     aws.String("http://config-partnercentral-account.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-partnercentral-account.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-partnercentral-account.dev",
			clientEndpoint: aws.String("https://client-partnercentral-account.dev"),
			expectURL:      aws.String("https://client-partnercentral-account.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PARTNERCENTRAL_ACCOUNT", c.envService)
			}
