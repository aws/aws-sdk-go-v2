...
func (c *Client) addOperationCancelProfileUpdateTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelProfileUpdateTask", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
