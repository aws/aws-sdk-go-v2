...
func (v *GetAllianceLeadContactOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.GetAllianceLeadContactResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *GetAllianceLeadContactOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.AllianceLeadContact != nil {
		s.WriteStruct(schemas.GetAllianceLeadContactResponse_AllianceLeadContact)
		v.AllianceLeadContact.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.Arn != nil {
		s.WriteString(schemas.GetAllianceLeadContactResponse_Arn, *v.Arn)
	}
	if v.Catalog != nil {
		s.WriteString(schemas.GetAllianceLeadContactResponse_Catalog, *v.Catalog)
	}
	if v.Id != nil {
		s.WriteString(schemas.GetAllianceLeadContactResponse_Id, *v.Id)
	}
}
