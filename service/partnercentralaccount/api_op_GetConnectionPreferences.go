...
func (c *Client) addOperationGetConnectionPreferencesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetConnectionPreferences", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
