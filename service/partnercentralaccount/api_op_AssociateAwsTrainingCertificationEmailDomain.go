...
func (c *Client) AssociateAwsTrainingCertificationEmailDomain(ctx context.Context, params *AssociateAwsTrainingCertificationEmailDomainInput, optFns ...func(*Options)) (*AssociateAwsTrainingCertificationEmailDomainOutput, error) {
	if params == nil { params = &AssociateAwsTrainingCertificationEmailDomainInput{} }
...
func (m *idempotencyToken_initializeOpAssociateAwsTrainingCertificationEmailDomain) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *AssociateAwsTrainingCertificationEmailDomainInput ")}
