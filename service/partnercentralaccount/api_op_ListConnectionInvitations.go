...
func (c *Client) addOperationListConnectionInvitationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListConnectionInvitations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
