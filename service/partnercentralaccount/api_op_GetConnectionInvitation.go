...
func (c *Client) addOperationGetConnectionInvitationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetConnectionInvitation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
