...
func (c *Client) CreateContainer(ctx context.Context, params *CreateContainerInput, optFns ...func(*Options)) (*CreateContainerOutput, error) {
	stack := middleware.NewStack("CreateContainer", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpCreateContainerMiddlewares(stack)
...
func addawsAwsjson11_serdeOpCreateContainerMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpCreateContainer{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpCreateContainer{}, middleware.After)
}
