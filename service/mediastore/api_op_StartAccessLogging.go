...
func (c *Client) StartAccessLogging(ctx context.Context, params *StartAccessLoggingInput, optFns ...func(*Options)) (*StartAccessLoggingOutput, error) {
	if params == nil { params = &StartAccessLoggingInput{} }
...
func (c *Client) addOperationStartAccessLoggingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartAccessLoggingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartAccessLoggingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartAccessLoggingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartAccessLoggingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartAccessLoggingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartAccessLoggingResolveEndpointMiddleware{
