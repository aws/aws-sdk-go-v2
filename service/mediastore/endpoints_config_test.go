...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-mediastore.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediastore.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediastore.dev",
			expectURL:     aws.String("https://env-mediastore.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-mediastore.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediastore.dev",
			expectURL:     aws.String("http://config-mediastore.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-mediastore.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-mediastore.dev",
			clientEndpoint: aws.String("https://client-mediastore.dev"),
			expectURL:      aws.String("https://client-mediastore.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MEDIASTORE", c.envService)
			}
