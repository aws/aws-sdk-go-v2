...
func (c *Client) addOperationDeleteEdgeConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteEdgeConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
