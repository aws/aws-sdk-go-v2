...
func (c *Client) addOperationStartEdgeConfigurationUpdateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartEdgeConfigurationUpdate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
