...
func (c *Client) addOperationUpdateStreamStorageConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateStreamStorageConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
