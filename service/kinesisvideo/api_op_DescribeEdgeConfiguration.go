...
func (c *Client) addOperationDescribeEdgeConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEdgeConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
