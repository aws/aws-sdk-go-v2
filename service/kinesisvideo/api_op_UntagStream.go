...
func (c *Client) UntagStream(ctx context.Context, params *UntagStreamInput, optFns ...func(*Options)) (*UntagStreamOutput, error) {
	if params == nil { params = &UntagStreamInput{} }
...
func (c *Client) addOperationUntagStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUntagStreamResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUntagStreamResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUntagStreamResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUntagStreamResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUntagStreamResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUntagStreamResolveEndpointMiddleware{
