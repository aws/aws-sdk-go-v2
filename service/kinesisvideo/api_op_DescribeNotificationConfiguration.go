...
func (c *Client) DescribeNotificationConfiguration(ctx context.Context, params *DescribeNotificationConfigurationInput, optFns ...func(*Options)) (*DescribeNotificationConfigurationOutput, error) {
	if params == nil { params = &DescribeNotificationConfigurationInput{} }
...
func (c *Client) addOperationDescribeNotificationConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeNotificationConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeNotificationConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeNotificationConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeNotificationConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeNotificationConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeNotificationConfigurationResolveEndpointMiddleware{
