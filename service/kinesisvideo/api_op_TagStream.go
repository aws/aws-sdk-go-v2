...
func (*TagStreamInput) operationName() string {
	return "TagStream"
}
...
func (c *Client) addOperationTagStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addTagStreamResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opTagStreamResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opTagStreamResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opTagStreamResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addTagStreamResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opTagStreamResolveEndpointMiddleware{
