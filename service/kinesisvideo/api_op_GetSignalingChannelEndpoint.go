...
func (c *Client) addOperationGetSignalingChannelEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSignalingChannelEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
