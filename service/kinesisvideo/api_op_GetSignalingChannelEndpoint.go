...
func addOperationGetSignalingChannelEndpointStackSlots(stack *middleware.Stack) error {
...
func addOperationGetSignalingChannelEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetSignalingChannelEndpointStackSlots(stack); err != nil {
		return err
	}
