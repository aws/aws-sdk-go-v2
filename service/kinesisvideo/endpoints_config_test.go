...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-kinesis-video.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kinesis-video.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kinesis-video.dev",
			expectURL:     aws.String("https://env-kinesis-video.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-kinesis-video.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kinesis-video.dev",
			expectURL:     aws.String("http://config-kinesis-video.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-kinesis-video.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-kinesis-video.dev",
			clientEndpoint: aws.String("https://client-kinesis-video.dev"),
			expectURL:      aws.String("https://client-kinesis-video.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_KINESIS_VIDEO", c.envService)
			}
