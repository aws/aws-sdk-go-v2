...
func (c *Client) addOperationListEdgeAgentConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEdgeAgentConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
