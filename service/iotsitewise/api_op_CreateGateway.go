...
func (m *endpointPrefix_opCreateGatewayMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opCreateGatewayMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opCreateGatewayMiddleware{}, middleware.Before)
}
