...
func (c *Client) addOperationListPipelinesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEndpointPrefix_opListPipelinesMiddleware(stack); err != nil {
		return err
	}
	if err = addOpListPipelinesValidationMiddleware(stack); err != nil {
		return err
	}
...
type endpointPrefix_opListPipelinesMiddleware struct {
}

func (*endpointPrefix_opListPipelinesMiddleware) ID() string {
	return "EndpointHostPrefix"
}

func (m *endpointPrefix_opListPipelinesMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opListPipelinesMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opListPipelinesMiddleware{}, "ResolveEndpointV2", middleware.After)
}
