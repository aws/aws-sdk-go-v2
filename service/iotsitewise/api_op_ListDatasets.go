...
func (c *Client) addOperationListDatasetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEndpointPrefix_opListDatasetsMiddleware(stack); err != nil {
		return err
	}
	if err = addOpListDatasetsValidationMiddleware(stack); err != nil {
		return err
	}
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDatasets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
...
type endpointPrefix_opListDatasetsMiddleware struct {
}

func (*endpointPrefix_opListDatasetsMiddleware) ID() string {
	return "EndpointHostPrefix"
}

func (m *endpointPrefix_opListDatasetsMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opListDatasetsMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opListDatasetsMiddleware{}, "ResolveEndpointV2", middleware.After)
}
