...
func (c *Client) ListBulkImportJobs(ctx context.Context, params *ListBulkImportJobsInput, optFns ...func(*Options)) (*ListBulkImportJobsOutput, error) {
	if params == nil { params = &ListBulkImportJobsInput{} }
...
func (c *Client) addOperationListBulkImportJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBulkImportJobsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListBulkImportJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListBulkImportJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBulkImportJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListBulkImportJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListBulkImportJobsResolveEndpointMiddleware{
