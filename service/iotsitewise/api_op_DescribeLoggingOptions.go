...
func (m *endpointPrefix_opDescribeLoggingOptionsMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opDescribeLoggingOptionsMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opDescribeLoggingOptionsMiddleware{}, middleware.Before)
}
