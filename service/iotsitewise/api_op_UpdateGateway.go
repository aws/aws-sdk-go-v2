...
func (m *endpointPrefix_opUpdateGatewayMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opUpdateGatewayMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opUpdateGatewayMiddleware{}, middleware.Before)
}
