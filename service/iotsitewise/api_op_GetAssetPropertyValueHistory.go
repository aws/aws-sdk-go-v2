...
func (m *endpointPrefix_opGetAssetPropertyValueHistoryMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opGetAssetPropertyValueHistoryMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opGetAssetPropertyValueHistoryMiddleware{}, middleware.Before)
}
