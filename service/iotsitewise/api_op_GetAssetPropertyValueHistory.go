...
func addOperationGetAssetPropertyValueHistoryStackSlots(stack *middleware.Stack) error {
...
func addOperationGetAssetPropertyValueHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetAssetPropertyValueHistoryStackSlots(stack); err != nil {
		return err
	}
