...
func (m *endpointPrefix_opDeleteAccessPolicyMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opDeleteAccessPolicyMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opDeleteAccessPolicyMiddleware{}, middleware.Before)
}
