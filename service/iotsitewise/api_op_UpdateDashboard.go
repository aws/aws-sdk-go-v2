...
func (m *endpointPrefix_opUpdateDashboardMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opUpdateDashboardMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opUpdateDashboardMiddleware{}, middleware.Before)
}
