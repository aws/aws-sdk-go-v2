...
func (m *endpointPrefix_opPutLoggingOptionsMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opPutLoggingOptionsMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opPutLoggingOptionsMiddleware{}, middleware.Before)
}
