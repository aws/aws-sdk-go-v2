...
func (m *endpointPrefix_opListAssociatedAssetsMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opListAssociatedAssetsMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opListAssociatedAssetsMiddleware{}, middleware.Before)
}
