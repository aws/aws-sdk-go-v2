...
func (c *Client) addOperationAssociateTimeSeriesToAssetPropertyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateTimeSeriesToAssetProperty", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
