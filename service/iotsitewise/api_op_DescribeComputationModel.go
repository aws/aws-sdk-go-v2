...
func (c *Client) addOperationDescribeComputationModelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeComputationModel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
