...
func (m *endpointPrefix_opUpdateGatewayCapabilityConfigurationMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opUpdateGatewayCapabilityConfigurationMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opUpdateGatewayCapabilityConfigurationMiddleware{}, middleware.Before)
}
