...
func addOperationUpdateGatewayCapabilityConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateGatewayCapabilityConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateGatewayCapabilityConfigurationStackSlots(stack); err != nil {
		return err
	}
