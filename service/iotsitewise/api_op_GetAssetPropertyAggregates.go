...
func (c *Client) addOperationGetAssetPropertyAggregatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAssetPropertyAggregates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
