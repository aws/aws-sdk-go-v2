...
func (c *Client) addOperationBatchGetAssetPropertyValueHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetAssetPropertyValueHistory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
