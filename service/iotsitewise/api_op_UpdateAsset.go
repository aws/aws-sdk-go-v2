...
func addOperationUpdateAssetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addEndpointPrefix_opUpdateAssetMiddleware(stack)
...
func addEndpointPrefix_opUpdateAssetMiddleware(stack *middleware.Stack) error {
	return stack.Serialize.Insert(&endpointPrefix_opUpdateAssetMiddleware{}, `OperationSerializer`, middleware.Before)
}
