...
func (m *endpointPrefix_opListDashboardsMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opListDashboardsMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opListDashboardsMiddleware{}, middleware.Before)
}
