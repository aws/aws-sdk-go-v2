...
func (c *Client) addOperationDescribeStorageConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeStorageConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
