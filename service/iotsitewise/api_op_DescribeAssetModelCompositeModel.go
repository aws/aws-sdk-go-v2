...
func (c *Client) addOperationDescribeAssetModelCompositeModelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAssetModelCompositeModel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
