...
func addOperationListProjectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addEndpointPrefix_opListProjectsMiddleware(stack)
...
func addEndpointPrefix_opListProjectsMiddleware(stack *middleware.Stack) error {
	return stack.Serialize.Insert(&endpointPrefix_opListProjectsMiddleware{}, `OperationSerializer`, middleware.Before)
}
