...
func (m *endpointPrefix_opBatchPutAssetPropertyValueMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opBatchPutAssetPropertyValueMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opBatchPutAssetPropertyValueMiddleware{}, middleware.Before)
}
