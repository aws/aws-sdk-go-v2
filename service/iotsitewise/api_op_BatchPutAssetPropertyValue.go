...
func (c *Client) addOperationBatchPutAssetPropertyValueMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchPutAssetPropertyValue", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
