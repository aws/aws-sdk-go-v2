...
func (m *endpointPrefix_opGetAssetPropertyValueMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opGetAssetPropertyValueMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opGetAssetPropertyValueMiddleware{}, middleware.Before)
}
