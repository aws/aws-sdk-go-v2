...
func (c *Client) addOperationDeleteDashboardMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDashboard", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
...
func (m *endpointPrefix_opDeleteDashboardMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opDeleteDashboardMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opDeleteDashboardMiddleware{}, "ResolveEndpointV2", middleware.After)
}
