...
func (m *endpointPrefix_opDeleteDashboardMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opDeleteDashboardMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opDeleteDashboardMiddleware{}, middleware.Before)
}
