...
func (m *endpointPrefix_opBatchDisassociateProjectAssetsMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opBatchDisassociateProjectAssetsMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opBatchDisassociateProjectAssetsMiddleware{}, middleware.Before)
}
