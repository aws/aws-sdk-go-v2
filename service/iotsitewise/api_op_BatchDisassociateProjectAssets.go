...
func (c *Client) addOperationBatchDisassociateProjectAssetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDisassociateProjectAssets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
