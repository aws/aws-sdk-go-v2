...
func (m *endpointPrefix_opCreateAssetModelMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opCreateAssetModelMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opCreateAssetModelMiddleware{}, middleware.Before)
}
