...
func (c *Client) addOperationListComputationModelDataBindingUsagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListComputationModelDataBindingUsages", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
