...
func (m *endpointPrefix_opDeleteProjectMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opDeleteProjectMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opDeleteProjectMiddleware{}, middleware.Before)
}
