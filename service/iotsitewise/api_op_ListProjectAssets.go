...
func (m *endpointPrefix_opListProjectAssetsMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opListProjectAssetsMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opListProjectAssetsMiddleware{}, middleware.Before)
}
