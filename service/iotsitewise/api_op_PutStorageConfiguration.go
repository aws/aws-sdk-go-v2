...
func (c *Client) addOperationPutStorageConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutStorageConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
