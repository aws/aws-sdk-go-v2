...
func (m *endpointPrefix_opDescribeProjectMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opDescribeProjectMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opDescribeProjectMiddleware{}, middleware.Before)
}
