...
func (m *endpointPrefix_opUpdateAssetModelMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opUpdateAssetModelMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opUpdateAssetModelMiddleware{}, middleware.Before)
}
