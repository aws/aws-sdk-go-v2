...
func (c *Client) addOperationDescribeAssetCompositeModelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAssetCompositeModel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
