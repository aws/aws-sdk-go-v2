...
func (m *endpointPrefix_opDescribeAssetPropertyMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opDescribeAssetPropertyMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opDescribeAssetPropertyMiddleware{}, middleware.Before)
}
