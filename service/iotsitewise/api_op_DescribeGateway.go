...
func (m *endpointPrefix_opDescribeGatewayMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opDescribeGatewayMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opDescribeGatewayMiddleware{}, middleware.Before)
}
