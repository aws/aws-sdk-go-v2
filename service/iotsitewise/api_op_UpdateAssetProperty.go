...
func (m *endpointPrefix_opUpdateAssetPropertyMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opUpdateAssetPropertyMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opUpdateAssetPropertyMiddleware{}, middleware.Before)
}
