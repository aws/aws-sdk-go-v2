...
func (c *Client) ListAssetProperties(ctx context.Context, params *ListAssetPropertiesInput, optFns ...func(*Options)) (*ListAssetPropertiesOutput, error) {
	if params == nil { params = &ListAssetPropertiesInput{} }
...
func (c *Client) addOperationListAssetPropertiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAssetPropertiesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAssetPropertiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAssetPropertiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAssetPropertiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListAssetPropertiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAssetPropertiesResolveEndpointMiddleware{
