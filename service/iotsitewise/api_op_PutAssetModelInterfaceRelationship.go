...
func (c *Client) addOperationPutAssetModelInterfaceRelationshipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutAssetModelInterfaceRelationship", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
