...
func (c *Client) addOperationDeleteAssetModelInterfaceRelationshipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteAssetModelInterfaceRelationship", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
