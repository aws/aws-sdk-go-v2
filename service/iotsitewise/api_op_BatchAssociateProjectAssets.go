...
func (c *Client) addOperationBatchAssociateProjectAssetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchAssociateProjectAssets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
