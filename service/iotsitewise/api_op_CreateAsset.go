...
func (m *endpointPrefix_opCreateAssetMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opCreateAssetMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opCreateAssetMiddleware{}, middleware.Before)
}
