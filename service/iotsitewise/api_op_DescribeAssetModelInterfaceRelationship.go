...
func (c *Client) addOperationDescribeAssetModelInterfaceRelationshipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAssetModelInterfaceRelationship", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
