...
func (c *Client) addOperationListApplicationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEndpointPrefix_opListApplicationsMiddleware(stack); err != nil {
		return err
	}
...
type endpointPrefix_opListApplicationsMiddleware struct {
}

func (*endpointPrefix_opListApplicationsMiddleware) ID() string {
	return "EndpointHostPrefix"
}

func (m *endpointPrefix_opListApplicationsMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opListApplicationsMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opListApplicationsMiddleware{}, "ResolveEndpointV2", middleware.After)
}
