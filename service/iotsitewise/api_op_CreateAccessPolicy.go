...
func (m *endpointPrefix_opCreateAccessPolicyMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opCreateAccessPolicyMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opCreateAccessPolicyMiddleware{}, middleware.Before)
}
