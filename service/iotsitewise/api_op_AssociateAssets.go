...
func (m *endpointPrefix_opAssociateAssetsMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opAssociateAssetsMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opAssociateAssetsMiddleware{}, middleware.Before)
}
