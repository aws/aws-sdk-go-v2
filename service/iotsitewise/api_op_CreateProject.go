...
func (m *endpointPrefix_opCreateProjectMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opCreateProjectMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opCreateProjectMiddleware{}, middleware.Before)
}
