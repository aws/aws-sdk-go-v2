...
func (c *Client) NotifyObjectComplete(ctx context.Context, params *NotifyObjectCompleteInput, optFns ...func(*Options)) (*NotifyObjectCompleteOutput, error) {
	if params == nil { params = &NotifyObjectCompleteInput{} }
...
func (c *Client) addOperationNotifyObjectCompleteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addNotifyObjectCompleteResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opNotifyObjectCompleteResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opNotifyObjectCompleteResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opNotifyObjectCompleteResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addNotifyObjectCompleteResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opNotifyObjectCompleteResolveEndpointMiddleware{
