...
func (c *Client) ListChunks(ctx context.Context, params *ListChunksInput, optFns ...func(*Options)) (*ListChunksOutput, error) {
	if params == nil { params = &ListChunksInput{} }
...
func (c *Client) addOperationListChunksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListChunksResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListChunksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListChunksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListChunksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListChunksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListChunksResolveEndpointMiddleware{
