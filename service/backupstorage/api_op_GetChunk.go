...
func (c *Client) GetChunk(ctx context.Context, params *GetChunkInput, optFns ...func(*Options)) (*GetChunkOutput, error) {
	if params == nil { params = &GetChunkInput{} }
...
func (c *Client) addOperationGetChunkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetChunkResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetChunkResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetChunkResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetChunkResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetChunkResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetChunkResolveEndpointMiddleware{
