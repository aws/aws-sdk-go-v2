...
func (c *Client) PutChunk(ctx context.Context, params *PutChunkInput, optFns ...func(*Options)) (*PutChunkOutput, error) {
	if params == nil { params = &PutChunkInput{} }
...
func (c *Client) addOperationPutChunkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutChunkResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutChunkResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutChunkResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutChunkResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutChunkResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutChunkResolveEndpointMiddleware{
