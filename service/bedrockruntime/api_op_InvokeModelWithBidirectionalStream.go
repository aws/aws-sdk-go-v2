...
func (c *Client) InvokeModelWithBidirectionalStream(ctx context.Context, params *InvokeModelWithBidirectionalStreamInput, optFns ...func(*Options)) (*InvokeModelWithBidirectionalStreamOutput, error) {
	...
	result, metadata, err := c.invokeEventStreamOperation(ctx, "InvokeModelWithBidirectionalStream", params, optFns, c.addOperationInvokeModelWithBidirectionalStreamMiddlewares)
	if err != nil {
		return nil, err
	}
...
type InvokeModelWithBidirectionalStreamOutput struct {
	...
	initialReply chan InvokeModelWithBidirectionalStreamInitialReply
...
type InvokeModelWithBidirectionalStreamInitialReply struct {
	// Metadata pertaining to the operation's result.
	ResultMetadata middleware.Metadata
...
func (o *InvokeModelWithBidirectionalStreamOutput) GetInitialReply() <-chan InvokeModelWithBidirectionalStreamInitialReply {
...
type eventStreamBuild_opInvokeModelWithBidirectionalStreamMiddleware struct {
}

func (*eventStreamBuild_opInvokeModelWithBidirectionalStreamMiddleware) ID() string {
	return "EventStreamBuildMiddleware"
}

func (m *eventStreamBuild_opInvokeModelWithBidirectionalStreamMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
	...
	res, ok := out.Result.(*InvokeModelWithBidirectionalStreamOutput)
	if !ok {
		// we have this as error, but really no one will be listening to it
		return out, metadata, fmt.Errorf("unexpected type of result. expected InvokeModelWithBidirectionalStreamOutput, got %T. Additionally %w", out.Result, err)
	}
	if err != nil {
