...
func TestCheckRequestSnapshot_Converse(t *testing.T) {
	input := &ConverseInput{
...
func TestCheckRequestSnapshot_CountTokens(t *testing.T) {
...
func TestCheckRequestSnapshot_GetAsyncInvoke(t *testing.T) {
...
func TestCheckRequestSnapshot_InvokeGuardrailChecks(t *testing.T) {
...
func TestCheckRequestSnapshot_InvokeModel(t *testing.T) {
...
func TestCheckRequestSnapshot_ListAsyncInvokes(t *testing.T) {
...
func TestCheckRequestSnapshot_StartAsyncInvoke(t *testing.T) {
...
func TestUpdateRequestSnapshot_ApplyGuardrail(t *testing.T) {
	input := &ApplyGuardrailInput{
		GuardrailIdentifier: ptr.String("__GuardrailIdentifier__"),
		GuardrailVersion:    ptr.String("__GuardrailVersion__"),
		Source:              types.GuardrailContentSource("INPUT"),
...
func TestUpdateRequestSnapshot_Converse(t *testing.T) {
	input := &ConverseInput{
		ModelId: ptr.String("__ModelId__"),
		Messages: []types.Message{
			{
...
func TestUpdateRequestSnapshot_CountTokens(t *testing.T) {
	input := &CountTokensInput{
		ModelId: ptr.String("__ModelId__"),
		Input: &types.CountTokensInputMemberInvokeModel{
			Value: types.InvokeModelTokensRequest{
...
func TestUpdateRequestSnapshot_GetAsyncInvoke(t *testing.T) {
	input := &GetAsyncInvokeInput{
		InvocationArn: ptr.String("__InvocationArn__"),
	}
	body := &bytes.Buffer{}
...
func TestUpdateRequestSnapshot_InvokeGuardrailChecks(t *testing.T) {
	input := &InvokeGuardrailChecksInput{
		Messages: []types.GuardrailChecksMessage{
			{
				Role: types.GuardrailChecksRole("user"),
...
func TestUpdateRequestSnapshot_InvokeModel(t *testing.T) {
	input := &InvokeModelInput{
		Body:                     []byte("blob"),
		ContentType:              ptr.String("__ContentType__"),
		Accept:                   ptr.String("__Accept__"),
...
func TestUpdateRequestSnapshot_ListAsyncInvokes(t *testing.T) {
	input := &ListAsyncInvokesInput{
		SubmitTimeAfter:  ptr.Time(time.Date(2000, 1, 1, 0, 0, 0, 0, time.UTC)),
		SubmitTimeBefore: ptr.Time(time.Date(2000, 1, 1, 0, 0, 0, 0, time.UTC)),
		StatusEquals:     types.AsyncInvokeStatus("InProgress"),
...
func TestUpdateRequestSnapshot_StartAsyncInvoke(t *testing.T) {
	input := &StartAsyncInvokeInput{
		ClientRequestToken: ptr.String("__ClientRequestToken__"),
		ModelId:            ptr.String("__ModelId__"),
		ModelInput:         nil,
