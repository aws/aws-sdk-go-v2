...
func (c *Client) addOperationCreateForecastExportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateForecastExportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
