...
func (c *Client) addOperationDescribeDatasetImportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDatasetImportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
