...
func (c *Client) addOperationListExplainabilityExportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListExplainabilityExports", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
