...
func (c *Client) addOperationDescribeExplainabilityExportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeExplainabilityExport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
