...
func (*DeleteExplainabilityExportInput) operationName() string {
...
func (c *Client) addOperationDeleteExplainabilityExportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteExplainabilityExportResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteExplainabilityExportResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteExplainabilityExportResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteExplainabilityExportResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteExplainabilityExportResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteExplainabilityExportResolveEndpointMiddleware{
