...
func (c *Client) addOperationDeleteExplainabilityExportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteExplainabilityExport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
