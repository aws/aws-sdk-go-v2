...
// an AutoPredictor ( CreateAutoPredictor) Creates an Amazon Forecast
// Explainability. Explainability helps you better understand how the attributes in
// your datasets impact forecast. Amazon Forecast uses a metric called Impact
// scores to quantify the relative impact of each attribute and determine whether
// they increase or decrease forecast values. To enable Forecast Explainability,
// your predictor must include at least one of the following: related time series,
// item metadata, or additional datasets like Holidays and the Weather Index.
...
// time points, provide a Forecast ARN. CreateExplainability with a Predictor ARN
...
// an Explainability resource. The following parameters are required when providing
// a Predictor ARN:
...
//
// If you set
// TimeSeriesGranularity to “SPECIFIC”, you must also provide the following:
...
type CreateExplainabilityInput struct {
	...
	// the Explainability. Use the following timestamp format: yyyy-MM-ddTHH:mm:ss
