...
func (c *Client) ListWhatIfForecasts(ctx context.Context, params *ListWhatIfForecastsInput, optFns ...func(*Options)) (*ListWhatIfForecastsOutput, error) {
	if params == nil { params = &ListWhatIfForecastsInput{} }
...
func (c *Client) addOperationListWhatIfForecastsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWhatIfForecastsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListWhatIfForecastsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListWhatIfForecastsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWhatIfForecastsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWhatIfForecastsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListWhatIfForecastsResolveEndpointMiddleware{
