...
func (c *Client) DeletePredictor(ctx context.Context, params *DeletePredictorInput, optFns ...func(*Options)) (*DeletePredictorOutput, error) {
	if params == nil { params = &DeletePredictorInput{} }
...
func (c *Client) addOperationDeletePredictorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeletePredictorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeletePredictorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeletePredictorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeletePredictorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeletePredictorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeletePredictorResolveEndpointMiddleware{
