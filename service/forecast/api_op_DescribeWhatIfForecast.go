...
func (*DescribeWhatIfForecastInput) operationName() string {
...
func (c *Client) addOperationDescribeWhatIfForecastMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeWhatIfForecastResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeWhatIfForecastResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeWhatIfForecastResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeWhatIfForecastResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeWhatIfForecastResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeWhatIfForecastResolveEndpointMiddleware{
