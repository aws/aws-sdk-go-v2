...
// operation. The Status  of a dataset group must be ACTIVE before you can use
...
type CreateDatasetGroupInput struct {
	...
	// the fields that must be present in training data that you import to a dataset.
