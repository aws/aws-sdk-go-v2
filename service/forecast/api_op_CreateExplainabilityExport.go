...
func (c *Client) addOperationCreateExplainabilityExportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateExplainabilityExport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
