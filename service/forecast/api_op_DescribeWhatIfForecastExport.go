...
func (c *Client) addOperationDescribeWhatIfForecastExportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeWhatIfForecastExport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
