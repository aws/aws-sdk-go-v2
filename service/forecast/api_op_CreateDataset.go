...
func (v *CreateDatasetInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.DataFrequency != nil {
		s.WriteString(schemas.CreateDatasetRequest_DataFrequency, *v.DataFrequency)
	}
	...
	if v.Domain != "" {
		s.WriteString(schemas.CreateDatasetRequest_Domain, string(v.Domain))
	}
	if v.EncryptionConfig != nil {
		s.WriteStruct(schemas.CreateDatasetRequest_EncryptionConfig)
		v.EncryptionConfig.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.Schema != nil {
		s.WriteStruct(schemas.CreateDatasetRequest_Schema)
