...
// operation. For example Forecast datasets, see the Amazon Forecast Sample
// GitHub repository (https://github.com/aws-samples/amazon-forecast-samples).
...
type CreateDatasetInput struct {
	...
	// operation must match. The Domain  and DatasetType that you choose determine
	// the fields that must be present in the training data that you import to the
	// dataset. For example, if you choose the RETAIL  domain and TARGET_TIME_SERIES
	// as the DatasetType , Amazon Forecast requires item_id , timestamp , and demand
	// fields to be present in your data. For more information, see Importing datasets (https://docs.aws.amazon.com/forecast/latest/dg/howitworks-datasets-groups.html)
	// .
	//
	// This member is required.
	Domain types.Domain
