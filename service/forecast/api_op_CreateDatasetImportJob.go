...
type CreateDatasetImportJobInput struct {
	...
	// DataSourcemust include an Key Management Service (KMS) key and the IAM role
	...
	// FULLdataset import replaces all of the existing data with the newly imported
	...
	// and those timestamps are expressed in local time.
