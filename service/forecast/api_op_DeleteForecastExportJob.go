...
func (c *Client) addOperationDeleteForecastExportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteForecastExportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
