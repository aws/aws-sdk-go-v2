...
func (*DeleteWhatIfForecastExportInput) operationName() string {
...
func (c *Client) addOperationDeleteWhatIfForecastExportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteWhatIfForecastExportResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteWhatIfForecastExportResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteWhatIfForecastExportResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteWhatIfForecastExportResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteWhatIfForecastExportResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteWhatIfForecastExportResolveEndpointMiddleware{
