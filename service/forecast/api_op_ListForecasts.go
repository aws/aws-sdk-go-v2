...
type ListForecastsInput struct {
	...
	// on. Valid values are DatasetGroupArn, PredictorArn, and Status.
	// - Value - The
	// value to match.
	//
	// For example, to list all forecasts whose status is not ACTIVE,
	// you would specify: "Filters": [ { "Condition": "IS_NOT", "Key": "Status",
	// "Value": "ACTIVE" } ]
