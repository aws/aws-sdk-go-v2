...
func (c *Client) ListMonitorEvaluations(ctx context.Context, params *ListMonitorEvaluationsInput, optFns ...func(*Options)) (*ListMonitorEvaluationsOutput, error) {
	if params == nil { params = &ListMonitorEvaluationsInput{} }
...
func (c *Client) addOperationListMonitorEvaluationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMonitorEvaluationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListMonitorEvaluationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListMonitorEvaluationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMonitorEvaluationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListMonitorEvaluationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListMonitorEvaluationsResolveEndpointMiddleware{
