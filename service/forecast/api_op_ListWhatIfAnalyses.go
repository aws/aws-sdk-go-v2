...
func (*ListWhatIfAnalysesInput) operationName() string {
...
func (c *Client) addOperationListWhatIfAnalysesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWhatIfAnalysesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListWhatIfAnalysesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListWhatIfAnalysesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWhatIfAnalysesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWhatIfAnalysesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListWhatIfAnalysesResolveEndpointMiddleware{
