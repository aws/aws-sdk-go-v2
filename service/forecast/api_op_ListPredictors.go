...
func (c *Client) ListPredictors(ctx context.Context, params *ListPredictorsInput, optFns ...func(*Options)) (*ListPredictorsOutput, error) {
	if params == nil { params = &ListPredictorsInput{} }
...
func (c *Client) addOperationListPredictorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPredictorsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPredictorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPredictorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPredictorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPredictorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPredictorsResolveEndpointMiddleware{
