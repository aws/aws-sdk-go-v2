...
// resource and its child resources. Child resources are resources that were
...
// resource. Amazon Forecast resources possess the following parent-child resource
// hierarchies:
