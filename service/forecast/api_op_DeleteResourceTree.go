...
func (*DeleteResourceTreeInput) operationName() string {
...
func (c *Client) addOperationDeleteResourceTreeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteResourceTreeResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteResourceTreeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteResourceTreeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteResourceTreeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteResourceTreeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteResourceTreeResolveEndpointMiddleware{
