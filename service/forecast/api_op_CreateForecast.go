...
// CreatePredictorrequest. When you query a forecast, you can request a specific
// date range within the forecast. To get a list of all your forecasts, use the
// ListForecastsoperation. The forecasts generated by Amazon Forecast are in the
// same time zone as the dataset that was used to create the predictor. For more
// information, see howitworks-forecast . The Status  of the forecast must be
// ACTIVE before you can query or export the forecast. Use the DescribeForecast
// operation to get the status. By default, a forecast includes predictions for
// every item ( item_id) in the dataset group that was used to train the
// predictor. However, you can use the TimeSeriesSelector object to generate a
// forecast on a subset of time series. Forecast creation is skipped for any time
// series that you specify that are not in the input dataset. The forecast export
...
type CreateForecastInput struct {
	...
	// currently specify up to 5 quantiles per forecast. Accepted values include 0.01
	// to 0.99 (increments of .01 only) and mean. The mean forecast is different from
