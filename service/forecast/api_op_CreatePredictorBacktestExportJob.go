...
func (c *Client) addOperationCreatePredictorBacktestExportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreatePredictorBacktestExportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
