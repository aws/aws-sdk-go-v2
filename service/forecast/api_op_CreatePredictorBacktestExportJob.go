...
// files are exported to your specified S3 bucket. The export file names will match
// the following conventions: __.csv The component is in Java SimpleDate format
// (yyyy-MM-ddTHH-mm-ssZ). You must specify a DataDestination object that includes
// an Amazon S3 bucket and an AWS Identity and Access Management (IAM) role that
