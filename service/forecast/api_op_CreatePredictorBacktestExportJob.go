...
// operation. Two CSV files are exported to a specified S3 bucket. You must specify
// a DataDestination object that includes an AWS Identity and Access Management
...
func (c *Client) CreatePredictorBacktestExportJob(ctx context.Context, params *CreatePredictorBacktestExportJobInput, optFns ...func(*Options)) (*CreatePredictorBacktestExportJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePredictorBacktestExportJob", params, optFns, addOperationCreatePredictorBacktestExportJobMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePredictorBacktestExportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
