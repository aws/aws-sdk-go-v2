...
func (c *Client) ResumeResource(ctx context.Context, params *ResumeResourceInput, optFns ...func(*Options)) (*ResumeResourceOutput, error) {
	if params == nil { params = &ResumeResourceInput{} }
...
func (c *Client) addOperationResumeResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResumeResourceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opResumeResourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opResumeResourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResumeResourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResumeResourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opResumeResourceResolveEndpointMiddleware{
