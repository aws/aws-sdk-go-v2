...
// the TARGET_TIME_SERIES dataset to improve model training. For more
// information, see FeaturizationConfig . For RELATED_TIME_SERIES datasets,
// CreatePredictor verifies that the DataFrequency specified when the dataset was
// created matches the ForecastFrequency. TARGET_TIME_SERIES datasets don't have
// this restriction. Amazon Forecast also verifies the delimiter and timestamp
// format. For more information, see howitworks-datasets-groups. By default,
...
// predictor by setting the ForecastTypes. AutoML If you want Amazon Forecast to
// evaluate each algorithm and choose the one that minimizes the objective
// function , set PerformAutoML  to true . The objective function is defined as
// the mean of the weighted losses over the forecast types. By default, these are
// the p10, p50, and p90 quantile losses. For more information, see
// EvaluationResult. When AutoML is enabled, the following properties are
// disallowed:
//   - AlgorithmArn
//   - HPOConfig
//   - PerformHPO
...
type CreatePredictorInput struct {
	...
	// (HPO). For more information, see aws-forecast-choosing-recipes. If you
