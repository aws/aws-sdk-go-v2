...
func (c *Client) DeleteAlert(ctx context.Context, params *DeleteAlertInput, optFns ...func(*Options)) (*DeleteAlertOutput, error) {
	if params == nil { params = &DeleteAlertInput{} }
...
func (c *Client) addOperationDeleteAlertMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAlertResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteAlertResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteAlertResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteAlertResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAlertResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteAlertResolveEndpointMiddleware{
