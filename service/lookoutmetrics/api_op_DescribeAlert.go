...
func (c *Client) DescribeAlert(ctx context.Context, params *DescribeAlertInput, optFns ...func(*Options)) (*DescribeAlertOutput, error) {
	if params == nil { params = &DescribeAlertInput{} }
...
func (c *Client) addOperationDescribeAlertMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeAlertResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeAlertResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeAlertResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeAlertResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeAlertResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeAlertResolveEndpointMiddleware{
