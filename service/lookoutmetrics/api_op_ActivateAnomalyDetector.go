...
func (*ActivateAnomalyDetectorInput) operationName() string {
...
func (c *Client) addOperationActivateAnomalyDetectorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addActivateAnomalyDetectorResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opActivateAnomalyDetectorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opActivateAnomalyDetectorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opActivateAnomalyDetectorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addActivateAnomalyDetectorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opActivateAnomalyDetectorResolveEndpointMiddleware{
