...
import (
	...
	"github.com/Enflick/aws-sdk-go-v2/service/lookoutmetrics/types"
...
func (c *Client) addOperationDescribeAnomalyDetectionExecutionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "DescribeAnomalyDetectionExecutions"); err != nil {
