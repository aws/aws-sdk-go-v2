...
func (c *Client) DescribeAnomalyDetectionExecutions(ctx context.Context, params *DescribeAnomalyDetectionExecutionsInput, optFns ...func(*Options)) (*DescribeAnomalyDetectionExecutionsOutput, error) {
	if params == nil { params = &DescribeAnomalyDetectionExecutionsInput{} }
...
func (c *Client) addOperationDescribeAnomalyDetectionExecutionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeAnomalyDetectionExecutionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeAnomalyDetectionExecutionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeAnomalyDetectionExecutionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeAnomalyDetectionExecutionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeAnomalyDetectionExecutionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeAnomalyDetectionExecutionsResolveEndpointMiddleware{
