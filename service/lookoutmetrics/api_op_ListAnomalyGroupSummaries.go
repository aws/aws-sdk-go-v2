...
func (c *Client) ListAnomalyGroupSummaries(ctx context.Context, params *ListAnomalyGroupSummariesInput, optFns ...func(*Options)) (*ListAnomalyGroupSummariesOutput, error) {
	if params == nil { params = &ListAnomalyGroupSummariesInput{} }
...
func (c *Client) addOperationListAnomalyGroupSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAnomalyGroupSummariesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAnomalyGroupSummariesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAnomalyGroupSummariesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAnomalyGroupSummariesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAnomalyGroupSummariesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAnomalyGroupSummariesResolveEndpointMiddleware{
