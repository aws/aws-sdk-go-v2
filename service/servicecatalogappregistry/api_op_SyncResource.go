...
func (c *Client) SyncResource(ctx context.Context, params *SyncResourceInput, optFns ...func(*Options)) (*SyncResourceOutput, error) {
	if params == nil { params = &SyncResourceInput{} }
...
func (c *Client) addOperationSyncResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSyncResourceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSyncResourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSyncResourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSyncResourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSyncResourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSyncResourceResolveEndpointMiddleware{
