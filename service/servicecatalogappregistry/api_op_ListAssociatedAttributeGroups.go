...
func (c *Client) addOperationListAssociatedAttributeGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAssociatedAttributeGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
