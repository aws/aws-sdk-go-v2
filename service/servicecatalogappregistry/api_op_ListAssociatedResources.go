...
import (
	...
	"github.com/Enflick/aws-sdk-go-v2/service/servicecatalogappregistry/types"
...
func (c *Client) addOperationListAssociatedResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "ListAssociatedResources"); err != nil {
