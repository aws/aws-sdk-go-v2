...
func (c *Client) addOperationListAssociatedResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAssociatedResources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
