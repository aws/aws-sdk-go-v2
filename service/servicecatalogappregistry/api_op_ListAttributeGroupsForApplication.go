...
func (c *Client) ListAttributeGroupsForApplication(ctx context.Context, params *ListAttributeGroupsForApplicationInput, optFns ...func(*Options)) (*ListAttributeGroupsForApplicationOutput, error) {
	if params == nil { params = &ListAttributeGroupsForApplicationInput{} }
...
func (c *Client) addOperationListAttributeGroupsForApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAttributeGroupsForApplicationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAttributeGroupsForApplicationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAttributeGroupsForApplicationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAttributeGroupsForApplicationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAttributeGroupsForApplicationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAttributeGroupsForApplicationResolveEndpointMiddleware{
