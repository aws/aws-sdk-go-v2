...
func (c *Client) addOperationAssociateAttributeGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateAttributeGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
