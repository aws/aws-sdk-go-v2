...
func (*ListAttributeGroupsInput) operationName() string {
...
func (c *Client) addOperationListAttributeGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAttributeGroupsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListAttributeGroupsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListAttributeGroupsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAttributeGroupsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAttributeGroupsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListAttributeGroupsResolveEndpointMiddleware{
