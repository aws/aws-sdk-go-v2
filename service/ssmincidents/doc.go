...
// of services. Incident Manager increases incident resolution by notifying
// responders of impact, highlighting relevant troubleshooting data, and providing
// collaboration tools to get services back up and running. To achieve the primary
// goal of reducing the time-to-resolution of critical incidents, Incident Manager
