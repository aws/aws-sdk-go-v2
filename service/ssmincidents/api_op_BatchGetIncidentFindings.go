...
func (c *Client) addOperationBatchGetIncidentFindingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetIncidentFindings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
