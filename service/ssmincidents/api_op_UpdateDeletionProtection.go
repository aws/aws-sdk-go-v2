...
func (c *Client) addOperationUpdateDeletionProtectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateDeletionProtection", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
