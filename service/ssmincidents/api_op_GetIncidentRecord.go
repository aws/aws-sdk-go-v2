...
func (c *Client) GetIncidentRecord(ctx context.Context, params *GetIncidentRecordInput, optFns ...func(*Options)) (*GetIncidentRecordOutput, error) {
	if params == nil { params = &GetIncidentRecordInput{} }
...
func (c *Client) addOperationGetIncidentRecordMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetIncidentRecordResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetIncidentRecordResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetIncidentRecordResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetIncidentRecordResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetIncidentRecordResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetIncidentRecordResolveEndpointMiddleware{
