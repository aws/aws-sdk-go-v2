...
func (*DeleteIncidentRecordInput) operationName() string {
...
func (c *Client) addOperationDeleteIncidentRecordMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteIncidentRecordResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteIncidentRecordResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteIncidentRecordResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteIncidentRecordResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteIncidentRecordResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteIncidentRecordResolveEndpointMiddleware{
