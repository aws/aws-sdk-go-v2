...
func (v *ConflictException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ConflictException, func(s *smithy.Schema) error {
		...
		case schemas.ConflictException_resourceIdentifier:
			v.ResourceIdentifier = new(string)
			return d.ReadString(schemas.ConflictException_resourceIdentifier, v.ResourceIdentifier)
		case schemas.ConflictException_resourceType:
			...
			return nil
		case schemas.ConflictException_retryAfter:
			v.RetryAfter = new(time.Time)
			return d.ReadTime(schemas.ConflictException_retryAfter, v.RetryAfter)
		}
		return nil
	})
}
...
func (v *ResourceNotFoundException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ResourceNotFoundException, func(s *smithy.Schema) error {
		...
		case schemas.ResourceNotFoundException_resourceIdentifier:
			v.ResourceIdentifier = new(string)
			return d.ReadString(schemas.ResourceNotFoundException_resourceIdentifier, v.ResourceIdentifier)
...
func (v *ServiceQuotaExceededException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ServiceQuotaExceededException, func(s *smithy.Schema) error {
		...
		case schemas.ServiceQuotaExceededException_resourceIdentifier:
			v.ResourceIdentifier = new(string)
			return d.ReadString(schemas.ServiceQuotaExceededException_resourceIdentifier, v.ResourceIdentifier)
		...
		case schemas.ServiceQuotaExceededException_serviceCode:
			var ev string
			if err := d.ReadString(schemas.ServiceQuotaExceededException_serviceCode, &ev); err != nil {
				return err
			}
			v.ServiceCode = ServiceCode(ev)
			return nil
		}
		return nil
	})
...
func (v *ThrottlingException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ThrottlingException, func(s *smithy.Schema) error {
		...
		case schemas.ThrottlingException_serviceCode:
			var ev string
			if err := d.ReadString(schemas.ThrottlingException_serviceCode, &ev); err != nil {
				return err
			}
			v.ServiceCode = ServiceCode(ev)
			return nil
