...
func (c *Client) GetTimelineEvent(ctx context.Context, params *GetTimelineEventInput, optFns ...func(*Options)) (*GetTimelineEventOutput, error) {
	if params == nil { params = &GetTimelineEventInput{} }
...
func (c *Client) addOperationGetTimelineEventMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTimelineEventResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetTimelineEventResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetTimelineEventResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTimelineEventResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTimelineEventResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetTimelineEventResolveEndpointMiddleware{
