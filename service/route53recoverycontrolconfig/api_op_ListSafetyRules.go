...
func (c *Client) ListSafetyRules(ctx context.Context, params *ListSafetyRulesInput, optFns ...func(*Options)) (*ListSafetyRulesOutput, error) {
	if params == nil { params = &ListSafetyRulesInput{} }
...
func (c *Client) addOperationListSafetyRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSafetyRulesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSafetyRulesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSafetyRulesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSafetyRulesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSafetyRulesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSafetyRulesResolveEndpointMiddleware{
