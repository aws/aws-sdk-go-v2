...
func (c *Client) UpdateControlPanel(ctx context.Context, params *UpdateControlPanelInput, optFns ...func(*Options)) (*UpdateControlPanelOutput, error) {
	if params == nil { params = &UpdateControlPanelInput{} }
...
func (c *Client) addOperationUpdateControlPanelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateControlPanelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateControlPanelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateControlPanelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateControlPanelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateControlPanelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateControlPanelResolveEndpointMiddleware{
