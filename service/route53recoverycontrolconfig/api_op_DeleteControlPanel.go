...
func (c *Client) DeleteControlPanel(ctx context.Context, params *DeleteControlPanelInput, optFns ...func(*Options)) (*DeleteControlPanelOutput, error) {
	if params == nil { params = &DeleteControlPanelInput{} }
...
func (c *Client) addOperationDeleteControlPanelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteControlPanelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteControlPanelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteControlPanelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteControlPanelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteControlPanelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteControlPanelResolveEndpointMiddleware{
