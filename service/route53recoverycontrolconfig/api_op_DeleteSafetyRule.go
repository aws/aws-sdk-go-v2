...
func (c *Client) DeleteSafetyRule(ctx context.Context, params *DeleteSafetyRuleInput, optFns ...func(*Options)) (*DeleteSafetyRuleOutput, error) {
	if params == nil { params = &DeleteSafetyRuleInput{} }
...
func (c *Client) addOperationDeleteSafetyRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteSafetyRuleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteSafetyRuleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteSafetyRuleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteSafetyRuleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteSafetyRuleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteSafetyRuleResolveEndpointMiddleware{
