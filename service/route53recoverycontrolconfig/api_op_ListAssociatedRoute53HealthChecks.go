...
func (c *Client) addOperationListAssociatedRoute53HealthChecksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAssociatedRoute53HealthChecks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
