...
func (c *Client) GetLayout(ctx context.Context, params *GetLayoutInput, optFns ...func(*Options)) (*GetLayoutOutput, error) {
	if params == nil { params = &GetLayoutInput{} }
...
func (c *Client) addOperationGetLayoutMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetLayoutResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetLayoutResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetLayoutResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetLayoutResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetLayoutResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetLayoutResolveEndpointMiddleware{
