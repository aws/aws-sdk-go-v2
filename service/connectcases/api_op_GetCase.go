...
func (c *Client) addOperationGetCaseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCaseResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetCaseResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetCaseResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCaseResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCaseResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetCaseResolveEndpointMiddleware{
