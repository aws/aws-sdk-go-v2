...
func (*UpdateFieldInput) operationName() string {
	return "UpdateField"
}
...
func (c *Client) addOperationUpdateFieldMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateFieldResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateFieldResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateFieldResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateFieldResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateFieldResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateFieldResolveEndpointMiddleware{
