...
func (c *Client) ListCasesForContact(ctx context.Context, params *ListCasesForContactInput, optFns ...func(*Options)) (*ListCasesForContactOutput, error) {
	if params == nil { params = &ListCasesForContactInput{} }
...
func (c *Client) addOperationListCasesForContactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCasesForContactResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCasesForContactResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCasesForContactResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCasesForContactResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCasesForContactResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCasesForContactResolveEndpointMiddleware{
