...
func (c *Client) CreateField(ctx context.Context, params *CreateFieldInput, optFns ...func(*Options)) (*CreateFieldOutput, error) {
	if params == nil { params = &CreateFieldInput{} }
...
func (c *Client) addOperationCreateFieldMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateFieldResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateFieldResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateFieldResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateFieldResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateFieldResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateFieldResolveEndpointMiddleware{
