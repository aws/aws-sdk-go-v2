...
func (c *Client) addOperationCreateEnvironmentConnectorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateEnvironmentConnector", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
