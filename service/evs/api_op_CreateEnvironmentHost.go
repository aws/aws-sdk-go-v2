...
func (c *Client) CreateEnvironmentHost(ctx context.Context, params *CreateEnvironmentHostInput, optFns ...func(*Options)) (*CreateEnvironmentHostOutput, error) {
	if params == nil { params = &CreateEnvironmentHostInput{} }
...
func (m *idempotencyToken_initializeOpCreateEnvironmentHost) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *CreateEnvironmentHostInput ")}
