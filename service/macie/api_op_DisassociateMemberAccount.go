...
func (*DisassociateMemberAccountInput) operationName() string {
...
func (c *Client) addOperationDisassociateMemberAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateMemberAccountResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDisassociateMemberAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDisassociateMemberAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateMemberAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateMemberAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDisassociateMemberAccountResolveEndpointMiddleware{
