...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-macie.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-macie.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-macie.dev",
			expectURL:     aws.String("https://env-macie.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-macie.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-macie.dev",
			expectURL:     aws.String("http://config-macie.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-macie.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-macie.dev",
			clientEndpoint: aws.String("https://client-macie.dev"),
			expectURL:      aws.String("https://client-macie.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MACIE", c.envService)
			}
