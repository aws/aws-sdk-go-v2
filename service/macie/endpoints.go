...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_MACIE")

	if g && !s {
		return
	}

	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "Macie", cfg.ConfigSources)
	if found && err == nil {
					...
					if true == _PartitionResult.SupportsFIPS {
						if true == _PartitionResult.SupportsDualStack {
							uriString := func() string {
								...
								out.WriteString("https://macie-fips.")
