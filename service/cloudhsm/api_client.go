...
// CloudHSM. See this package's package overview docs
...
const (
	ServiceName = "CloudHSM" // Service's name
	ServiceID   = "CloudHSM" // Service's identifier
	EndpointsID = "cloudhsm" // Service's Endpoint identifier
)
