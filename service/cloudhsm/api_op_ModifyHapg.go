...
func (c *Client) ModifyHapg(ctx context.Context, params *ModifyHapgInput, optFns ...func(*Options)) (*ModifyHapgOutput, error) {
	if params == nil { params = &ModifyHapgInput{} }
...
func (c *Client) addOperationModifyHapgMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addModifyHapgResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opModifyHapgResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opModifyHapgResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opModifyHapgResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addModifyHapgResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opModifyHapgResolveEndpointMiddleware{
