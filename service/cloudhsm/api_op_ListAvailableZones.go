...
func (c *Client) ListAvailableZones(ctx context.Context, params *ListAvailableZonesInput, optFns ...func(*Options)) (*ListAvailableZonesOutput, error) {
	if params == nil { params = &ListAvailableZonesInput{} }
...
func (c *Client) addOperationListAvailableZonesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAvailableZonesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAvailableZonesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAvailableZonesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAvailableZonesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAvailableZonesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAvailableZonesResolveEndpointMiddleware{
