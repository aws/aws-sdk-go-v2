...
func (c *Client) ListLunaClients(ctx context.Context, params *ListLunaClientsInput, optFns ...func(*Options)) (*ListLunaClientsOutput, error) {
	if params == nil { params = &ListLunaClientsInput{} }
...
func (c *Client) addOperationListLunaClientsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLunaClientsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListLunaClientsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListLunaClientsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLunaClientsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLunaClientsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListLunaClientsResolveEndpointMiddleware{
