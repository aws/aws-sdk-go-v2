...
func (v *CreateLunaClientOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.CreateLunaClientResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *CreateLunaClientOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ClientArn != nil {
		s.WriteString(schemas.CreateLunaClientResponse_ClientArn, *v.ClientArn)
	}
}
