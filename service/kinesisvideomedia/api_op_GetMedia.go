...
type GetMediaOutput struct {
	...
	// - AWS_KINESISVIDEO_ERROR_CODE
	// - String description of an error that caused GetMedia to stop.
	// -
	...
	// - 4000 - Requested fragment is not
	// found
	// - 4500 - Access denied for the stream's KMS key
	// - 4501 - Stream's KMS key
	// is disabled
	// - 4502 - Validation error on the stream's KMS key
	// - 4503 - KMS key
	// specified in the stream is unavailable
	// - 4504 - Invalid usage of the KMS key
