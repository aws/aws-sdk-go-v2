...
// Kinesis Video Media. See this package's package overview docs
...
const (
	ServiceName = "Kinesis Video Media" // Service's name
	ServiceID   = "KinesisVideoMedia"   // Service's identifier
