...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-kinesis-video-media.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kinesis-video-media.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kinesis-video-media.dev",
			expectURL:     aws.String("https://env-kinesis-video-media.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-kinesis-video-media.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kinesis-video-media.dev",
			expectURL:     aws.String("http://config-kinesis-video-media.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-kinesis-video-media.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-kinesis-video-media.dev",
			clientEndpoint: aws.String("https://client-kinesis-video-media.dev"),
			expectURL:      aws.String("https://client-kinesis-video-media.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_KINESIS_VIDEO_MEDIA", c.envService)
			}
