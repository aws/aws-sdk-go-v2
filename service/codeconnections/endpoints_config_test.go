...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-codeconnections.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeconnections.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeconnections.dev",
			expectURL:     aws.String("https://env-codeconnections.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-codeconnections.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeconnections.dev",
			expectURL:     aws.String("http://config-codeconnections.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-codeconnections.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-codeconnections.dev",
			clientEndpoint: aws.String("https://client-codeconnections.dev"),
			expectURL:      aws.String("https://client-codeconnections.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CODECONNECTIONS", c.envService)
			}
