...
func (c *Client) addOperationDeleteSyncConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteSyncConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
