...
func (c *Client) addOperationGetRepositorySyncStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRepositorySyncStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
