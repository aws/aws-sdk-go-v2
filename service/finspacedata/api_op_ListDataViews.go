...
func (c *Client) ListDataViews(ctx context.Context, params *ListDataViewsInput, optFns ...func(*Options)) (*ListDataViewsOutput, error) {
	if params == nil { params = &ListDataViewsInput{} }
...
func (c *Client) addOperationListDataViewsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDataViewsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDataViewsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDataViewsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDataViewsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDataViewsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDataViewsResolveEndpointMiddleware{
