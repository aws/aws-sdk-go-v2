...
func (c *Client) GetPermissionGroup(ctx context.Context, params *GetPermissionGroupInput, optFns ...func(*Options)) (*GetPermissionGroupOutput, error) {
	if params == nil { params = &GetPermissionGroupInput{} }
...
func (c *Client) addOperationGetPermissionGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPermissionGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPermissionGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPermissionGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPermissionGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPermissionGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPermissionGroupResolveEndpointMiddleware{
