...
func (c *Client) addOperationListPermissionGroupsByUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPermissionGroupsByUser", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
