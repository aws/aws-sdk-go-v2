...
func (c *Client) addOperationListAutomatedDiscoveryAccountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAutomatedDiscoveryAccounts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
