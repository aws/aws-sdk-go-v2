...
func (c *Client) addOperationCreateClassificationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateClassificationJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
