...
func (c *Client) addOperationUpdateAutomatedDiscoveryConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAutomatedDiscoveryConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
