...
func (c *Client) addOperationGetCustomDataIdentifierMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCustomDataIdentifier", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
