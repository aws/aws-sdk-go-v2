...
func (c *Client) GetMember(ctx context.Context, params *GetMemberInput, optFns ...func(*Options)) (*GetMemberOutput, error) {
	if params == nil { params = &GetMemberInput{} }
...
func (c *Client) addOperationGetMemberMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMemberResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetMemberResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetMemberResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMemberResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMemberResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetMemberResolveEndpointMiddleware{
