...
func (c *Client) ListResourceProfileDetections(ctx context.Context, params *ListResourceProfileDetectionsInput, optFns ...func(*Options)) (*ListResourceProfileDetectionsOutput, error) {
	if params == nil { params = &ListResourceProfileDetectionsInput{} }
...
func (c *Client) addOperationListResourceProfileDetectionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListResourceProfileDetectionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListResourceProfileDetectionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListResourceProfileDetectionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListResourceProfileDetectionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListResourceProfileDetectionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListResourceProfileDetectionsResolveEndpointMiddleware{
