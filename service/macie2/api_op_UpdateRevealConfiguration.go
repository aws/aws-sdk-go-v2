...
func (c *Client) addOperationUpdateRevealConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateRevealConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
