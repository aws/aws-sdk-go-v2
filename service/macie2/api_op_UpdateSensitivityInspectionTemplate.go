...
func (c *Client) addOperationUpdateSensitivityInspectionTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateSensitivityInspectionTemplate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
