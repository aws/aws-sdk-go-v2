...
func addOperationCreateCustomDataIdentifierStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateCustomDataIdentifierMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateCustomDataIdentifierStackSlots(stack); err != nil {
		return err
	}
