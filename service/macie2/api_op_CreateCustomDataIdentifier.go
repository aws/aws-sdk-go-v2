...
func (c *Client) addOperationCreateCustomDataIdentifierMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCustomDataIdentifier", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
