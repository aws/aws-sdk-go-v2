...
func (c *Client) addOperationBatchUpdateAutomatedDiscoveryAccountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchUpdateAutomatedDiscoveryAccounts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
