...
func (c *Client) GetClassificationScope(ctx context.Context, params *GetClassificationScopeInput, optFns ...func(*Options)) (*GetClassificationScopeOutput, error) {
	if params == nil { params = &GetClassificationScopeInput{} }
...
func (c *Client) addOperationGetClassificationScopeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetClassificationScopeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetClassificationScopeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetClassificationScopeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetClassificationScopeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetClassificationScopeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetClassificationScopeResolveEndpointMiddleware{
