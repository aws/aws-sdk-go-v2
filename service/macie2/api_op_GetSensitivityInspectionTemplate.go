...
func (c *Client) GetSensitivityInspectionTemplate(ctx context.Context, params *GetSensitivityInspectionTemplateInput, optFns ...func(*Options)) (*GetSensitivityInspectionTemplateOutput, error) {
	if params == nil { params = &GetSensitivityInspectionTemplateInput{} }
...
func (c *Client) addOperationGetSensitivityInspectionTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSensitivityInspectionTemplateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSensitivityInspectionTemplateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSensitivityInspectionTemplateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSensitivityInspectionTemplateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSensitivityInspectionTemplateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSensitivityInspectionTemplateResolveEndpointMiddleware{
