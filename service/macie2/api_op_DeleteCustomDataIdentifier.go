...
func (c *Client) DeleteCustomDataIdentifier(ctx context.Context, params *DeleteCustomDataIdentifierInput, optFns ...func(*Options)) (*DeleteCustomDataIdentifierOutput, error) {
	if params == nil { params = &DeleteCustomDataIdentifierInput{} }
...
func (c *Client) addOperationDeleteCustomDataIdentifierMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCustomDataIdentifierResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteCustomDataIdentifierResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteCustomDataIdentifierResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCustomDataIdentifierResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCustomDataIdentifierResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteCustomDataIdentifierResolveEndpointMiddleware{
