...
func (c *Client) addOperationDeleteCustomDataIdentifierMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteCustomDataIdentifier", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
