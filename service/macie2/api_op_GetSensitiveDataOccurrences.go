...
func (c *Client) addOperationGetSensitiveDataOccurrencesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSensitiveDataOccurrences", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
