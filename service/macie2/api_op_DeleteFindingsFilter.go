...
func (*DeleteFindingsFilterInput) operationName() string {
...
func (c *Client) addOperationDeleteFindingsFilterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteFindingsFilterResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteFindingsFilterResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteFindingsFilterResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteFindingsFilterResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteFindingsFilterResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteFindingsFilterResolveEndpointMiddleware{
