...
func (c *Client) addOperationTestCustomDataIdentifierMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "TestCustomDataIdentifier", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
