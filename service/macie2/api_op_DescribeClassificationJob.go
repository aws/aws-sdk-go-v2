...
func (c *Client) addOperationDescribeClassificationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeClassificationJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
