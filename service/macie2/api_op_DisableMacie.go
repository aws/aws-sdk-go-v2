...
func (c *Client) DisableMacie(ctx context.Context, params *DisableMacieInput, optFns ...func(*Options)) (*DisableMacieOutput, error) {
	if params == nil { params = &DisableMacieInput{} }
...
func (c *Client) addOperationDisableMacieMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableMacieResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisableMacieResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisableMacieResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableMacieResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableMacieResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisableMacieResolveEndpointMiddleware{
