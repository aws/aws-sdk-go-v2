...
func (c *Client) ListClassificationScopes(ctx context.Context, params *ListClassificationScopesInput, optFns ...func(*Options)) (*ListClassificationScopesOutput, error) {
	if params == nil { params = &ListClassificationScopesInput{} }
...
func (c *Client) addOperationListClassificationScopesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListClassificationScopesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListClassificationScopesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListClassificationScopesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListClassificationScopesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListClassificationScopesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListClassificationScopesResolveEndpointMiddleware{
