...
func (c *Client) addOperationListClassificationScopesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListClassificationScopes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
