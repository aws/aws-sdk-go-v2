...
func (c *Client) addOperationBatchGetCustomDataIdentifiersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetCustomDataIdentifiers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
