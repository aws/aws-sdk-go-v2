...
func addOperationBatchGetCustomDataIdentifiersStackSlots(stack *middleware.Stack) error {
...
func addOperationBatchGetCustomDataIdentifiersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationBatchGetCustomDataIdentifiersStackSlots(stack); err != nil {
		return err
	}
