...
func (c *Client) addOperationGetSensitiveDataOccurrencesAvailabilityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetSensitiveDataOccurrencesAvailability", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
