...
func (c *Client) addOperationListCustomDataIdentifiersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCustomDataIdentifiers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
