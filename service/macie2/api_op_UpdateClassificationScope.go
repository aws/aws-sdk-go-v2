...
func (c *Client) UpdateClassificationScope(ctx context.Context, params *UpdateClassificationScopeInput, optFns ...func(*Options)) (*UpdateClassificationScopeOutput, error) {
	if params == nil { params = &UpdateClassificationScopeInput{} }
...
func (c *Client) addOperationUpdateClassificationScopeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateClassificationScopeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateClassificationScopeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateClassificationScopeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateClassificationScopeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateClassificationScopeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateClassificationScopeResolveEndpointMiddleware{
