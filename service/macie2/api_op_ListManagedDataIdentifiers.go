...
func (c *Client) addOperationListManagedDataIdentifiersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListManagedDataIdentifiers", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
