...
func (c *Client) addOperationDeregisterMemberFromAddressListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeregisterMemberFromAddressList", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
