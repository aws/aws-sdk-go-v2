...
func (c *Client) addOperationRegisterMemberToAddressListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterMemberToAddressList", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
