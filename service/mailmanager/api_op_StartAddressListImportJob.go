...
func (c *Client) addOperationStartAddressListImportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartAddressListImportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
