...
func (c *Client) addOperationGetArchiveMessageContentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetArchiveMessageContent", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
