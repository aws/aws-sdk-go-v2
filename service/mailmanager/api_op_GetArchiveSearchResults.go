...
func (c *Client) addOperationGetArchiveSearchResultsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetArchiveSearchResults", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
