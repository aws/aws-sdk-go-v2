...
func (c *Client) addOperationGetAddressListImportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAddressListImportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
