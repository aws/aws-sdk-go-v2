...
func (c *Client) addOperationDeleteProcurementPortalPreferenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteProcurementPortalPreference", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
