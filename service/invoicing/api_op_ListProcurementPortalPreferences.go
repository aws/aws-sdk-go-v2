...
func (c *Client) addOperationListProcurementPortalPreferencesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListProcurementPortalPreferences", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
