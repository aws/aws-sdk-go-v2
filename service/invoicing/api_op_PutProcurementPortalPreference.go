...
func (c *Client) addOperationPutProcurementPortalPreferenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutProcurementPortalPreference", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
