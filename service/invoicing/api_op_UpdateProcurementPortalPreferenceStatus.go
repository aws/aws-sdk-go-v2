...
func (c *Client) addOperationUpdateProcurementPortalPreferenceStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateProcurementPortalPreferenceStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
