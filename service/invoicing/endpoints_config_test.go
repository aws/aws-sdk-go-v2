...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-invoicing.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-invoicing.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-invoicing.dev",
			expectURL:     aws.String("https://env-invoicing.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-invoicing.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-invoicing.dev",
			expectURL:     aws.String("http://config-invoicing.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-invoicing.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-invoicing.dev",
			clientEndpoint: aws.String("https://client-invoicing.dev"),
			expectURL:      aws.String("https://client-invoicing.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_INVOICING", c.envService)
			}
