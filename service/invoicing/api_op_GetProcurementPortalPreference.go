...
func (c *Client) addOperationGetProcurementPortalPreferenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetProcurementPortalPreference", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
