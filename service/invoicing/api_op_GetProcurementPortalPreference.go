...
func (c *Client) GetProcurementPortalPreference(ctx context.Context, params *GetProcurementPortalPreferenceInput, optFns ...func(*Options)) (*GetProcurementPortalPreferenceOutput, error) {
	if params == nil { params = &GetProcurementPortalPreferenceInput{} }
...
func (c *Client) addOperationGetProcurementPortalPreferenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetProcurementPortalPreference(options.Region, ), middleware.Before); err != nil {
	return err
	}
...
func newServiceMetadataMiddleware_opGetProcurementPortalPreference(region string) *awsmiddleware.RegisterServiceMetadata {
