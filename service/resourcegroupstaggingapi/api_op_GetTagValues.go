...
func (*GetTagValuesInput) operationName() string {
	return "GetTagValues"
}
...
func (c *Client) addOperationGetTagValuesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTagValuesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetTagValuesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetTagValuesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTagValuesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTagValuesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetTagValuesResolveEndpointMiddleware{
