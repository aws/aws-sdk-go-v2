...
func (c *Client) addOperationExportLicenseRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ExportLicenseRecommendations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
