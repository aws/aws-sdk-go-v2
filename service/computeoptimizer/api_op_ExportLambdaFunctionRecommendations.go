...
func (c *Client) addOperationExportLambdaFunctionRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ExportLambdaFunctionRecommendations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
