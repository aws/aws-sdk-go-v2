...
func (c *Client) addOperationGetAutoScalingGroupRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAutoScalingGroupRecommendations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
