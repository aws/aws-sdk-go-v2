...
func (c *Client) addOperationGetRDSDatabaseRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRDSDatabaseRecommendations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
