...
func (c *Client) addOperationGetEffectiveRecommendationPreferencesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetEffectiveRecommendationPreferences", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
