...
func (c *Client) addOperationGetRDSDatabaseRecommendationProjectedMetricsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRDSDatabaseRecommendationProjectedMetrics", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
