...
func (c *Client) addOperationDescribeRecommendationExportJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRecommendationExportJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
