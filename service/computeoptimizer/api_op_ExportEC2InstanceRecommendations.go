...
func (c *Client) addOperationExportEC2InstanceRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ExportEC2InstanceRecommendations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
