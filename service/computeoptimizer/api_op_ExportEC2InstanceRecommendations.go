...
func addOperationExportEC2InstanceRecommendationsStackSlots(stack *middleware.Stack) error {
...
func addOperationExportEC2InstanceRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationExportEC2InstanceRecommendationsStackSlots(stack); err != nil {
		return err
	}
