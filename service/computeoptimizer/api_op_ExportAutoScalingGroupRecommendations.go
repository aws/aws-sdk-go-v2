...
func addOperationExportAutoScalingGroupRecommendationsStackSlots(stack *middleware.Stack) error {
...
func addOperationExportAutoScalingGroupRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationExportAutoScalingGroupRecommendationsStackSlots(stack); err != nil {
		return err
	}
