...
func addOperationGetEC2RecommendationProjectedMetricsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetEC2RecommendationProjectedMetricsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetEC2RecommendationProjectedMetricsStackSlots(stack); err != nil {
		return err
	}
