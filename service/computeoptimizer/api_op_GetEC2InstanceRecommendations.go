...
func (c *Client) addOperationGetEC2InstanceRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetEC2InstanceRecommendations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
