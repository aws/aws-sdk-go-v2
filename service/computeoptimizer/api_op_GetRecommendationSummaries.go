...
func (c *Client) addOperationGetRecommendationSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRecommendationSummaries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
