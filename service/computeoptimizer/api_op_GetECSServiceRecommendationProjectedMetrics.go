...
func (c *Client) GetECSServiceRecommendationProjectedMetrics(ctx context.Context, params *GetECSServiceRecommendationProjectedMetricsInput, optFns ...func(*Options)) (*GetECSServiceRecommendationProjectedMetricsOutput, error) {
	if params == nil { params = &GetECSServiceRecommendationProjectedMetricsInput{} }
...
func (c *Client) addOperationGetECSServiceRecommendationProjectedMetricsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetECSServiceRecommendationProjectedMetricsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetECSServiceRecommendationProjectedMetricsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetECSServiceRecommendationProjectedMetricsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetECSServiceRecommendationProjectedMetricsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetECSServiceRecommendationProjectedMetricsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetECSServiceRecommendationProjectedMetricsResolveEndpointMiddleware{
