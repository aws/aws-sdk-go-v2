...
func (c *Client) addOperationGetLambdaFunctionRecommendationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetLambdaFunctionRecommendations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
