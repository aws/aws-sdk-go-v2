...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-compute-optimizer.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-compute-optimizer.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-compute-optimizer.dev",
			expectURL:     aws.String("https://env-compute-optimizer.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-compute-optimizer.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-compute-optimizer.dev",
			expectURL:     aws.String("http://config-compute-optimizer.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-compute-optimizer.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-compute-optimizer.dev",
			clientEndpoint: aws.String("https://client-compute-optimizer.dev"),
			expectURL:      aws.String("https://client-compute-optimizer.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_COMPUTE_OPTIMIZER", c.envService)
			}
