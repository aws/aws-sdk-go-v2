...
func (c *Client) addOperationDeleteAcmeDomainValidationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteAcmeDomainValidation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
