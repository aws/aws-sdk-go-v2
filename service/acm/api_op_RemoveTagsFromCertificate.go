...
func (c *Client) addOperationRemoveTagsFromCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RemoveTagsFromCertificate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
