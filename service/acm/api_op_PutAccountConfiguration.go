...
func (c *Client) addOperationPutAccountConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutAccountConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
