...
func (c *Client) ListTrackers(ctx context.Context, params *ListTrackersInput, optFns ...func(*Options)) (*ListTrackersOutput, error) {
	if params == nil { params = &ListTrackersInput{} }
...
func (c *Client) addOperationListTrackersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTrackersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTrackersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTrackersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTrackersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListTrackersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTrackersResolveEndpointMiddleware{
