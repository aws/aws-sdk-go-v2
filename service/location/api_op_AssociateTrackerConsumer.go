...
func (c *Client) addOperationAssociateTrackerConsumerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateTrackerConsumer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
