...
func (c *Client) ListMaps(ctx context.Context, params *ListMapsInput, optFns ...func(*Options)) (*ListMapsOutput, error) {
	if params == nil { params = &ListMapsInput{} }
...
func (c *Client) addOperationListMapsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMapsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListMapsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListMapsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMapsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListMapsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListMapsResolveEndpointMiddleware{
