...
func (c *Client) addOperationDisassociateTrackerConsumerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateTrackerConsumer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
