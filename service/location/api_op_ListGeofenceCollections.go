...
func (c *Client) addOperationListGeofenceCollectionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListGeofenceCollections", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
