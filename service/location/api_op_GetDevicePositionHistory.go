...
func (c *Client) addOperationGetDevicePositionHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDevicePositionHistory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
