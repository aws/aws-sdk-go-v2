...
type CalculateRouteMatrixInput struct {
	...
	// that use ferries or tolls. Requirements: TravelMode  must be specified as Car .
	...
	// If neither is set, the best time of day to travel with the best traffic
	// conditions is used to calculate the route matrix. Default Value: false Valid
	// Values: false  | true
	DepartNow *bool
...
type CalculateRouteMatrixOutput struct {
	...
	// in DeparturePositions. Each entry in the row corresponds to the route from
