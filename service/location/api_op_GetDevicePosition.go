...
func (c *Client) GetDevicePosition(ctx context.Context, params *GetDevicePositionInput, optFns ...func(*Options)) (*GetDevicePositionOutput, error) {
	if params == nil { params = &GetDevicePositionInput{} }
...
func (c *Client) addOperationGetDevicePositionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDevicePositionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDevicePositionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDevicePositionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDevicePositionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addGetDevicePositionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDevicePositionResolveEndpointMiddleware{
