...
func (c *Client) addOperationBatchUpdateDevicePositionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchUpdateDevicePosition", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
