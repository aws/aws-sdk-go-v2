...
type SearchPlaceIndexForSuggestionsInput struct {
	...
	// suggestions with the language  parameter set to en. The results found will
	// most likely be returned as Athens, Greece . If you set the language parameter
	// to el , for Greek, then the result found will more likely be returned as
	// Αθήνα, Ελλάδα. If the data provider does not have a value for Greek, the
