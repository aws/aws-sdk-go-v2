...
func (c *Client) addOperationSearchPlaceIndexForSuggestionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SearchPlaceIndexForSuggestions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
