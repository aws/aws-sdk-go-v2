...
func (c *Client) ListGeofences(ctx context.Context, params *ListGeofencesInput, optFns ...func(*Options)) (*ListGeofencesOutput, error) {
	if params == nil { params = &ListGeofencesInput{} }
...
func (c *Client) addOperationListGeofencesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListGeofencesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListGeofencesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListGeofencesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListGeofencesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListGeofencesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListGeofencesResolveEndpointMiddleware{
