...
func (c *Client) BatchPutGeofence(ctx context.Context, params *BatchPutGeofenceInput, optFns ...func(*Options)) (*BatchPutGeofenceOutput, error) {
	if params == nil { params = &BatchPutGeofenceInput{} }
...
func (c *Client) addOperationBatchPutGeofenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchPutGeofenceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchPutGeofenceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchPutGeofenceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchPutGeofenceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addBatchPutGeofenceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchPutGeofenceResolveEndpointMiddleware{
