...
type CalculateRouteInput struct {
	...
	// If you specify a departure that's not
	// located on a road, Amazon Location moves the position to the nearest road (https://docs.aws.amazon.com/location/latest/developerguide/snap-to-nearby-road.html)
	// . If Esri is the provider for your route calculator, specifying a route that is
	// longer than 400 km returns a 400 RoutesValidationException error. Valid
	...
	// If you specify a destination that's not
	// located on a road, Amazon Location moves the position to the nearest road (https://docs.aws.amazon.com/location/latest/developerguide/snap-to-nearby-road.html)
	...
	// Walking , Bicycle  or Motorcycle  as options for the TravelMode . Bicycle  and
	// Motorcycleare only valid when using Grab as a data provider, and only within
	// Southeast Asia. Truck is not available for Grab. For more details on the using
	// Grab for routing, including areas of coverage, see GrabMaps (https://docs.aws.amazon.com/location/latest/developerguide/grab.html)
	// in the Amazon Location Service Developer Guide. The TravelMode you specify
	// also determines how you specify route preferences:
...
type CalculateRouteOutput struct {
	...
	// than the total number of positions in the request. For example, a route with a
