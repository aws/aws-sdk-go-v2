...
func (c *Client) addOperationDescribeRouteCalculatorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRouteCalculator", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
