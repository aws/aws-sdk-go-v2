...
func (c *Client) GetMapSprites(ctx context.Context, params *GetMapSpritesInput, optFns ...func(*Options)) (*GetMapSpritesOutput, error) {
	if params == nil { params = &GetMapSpritesInput{} }
...
func (c *Client) addOperationGetMapSpritesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMapSpritesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetMapSpritesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetMapSpritesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMapSpritesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addGetMapSpritesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetMapSpritesResolveEndpointMiddleware{
