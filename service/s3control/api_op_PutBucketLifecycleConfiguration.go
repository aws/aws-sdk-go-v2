...
func (m *endpointPrefix_opPutBucketLifecycleConfigurationMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opPutBucketLifecycleConfigurationMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opPutBucketLifecycleConfigurationMiddleware{}, middleware.Before)
}
