...
func (m *endpointPrefix_opPutBucketTaggingMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opPutBucketTaggingMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opPutBucketTaggingMiddleware{}, middleware.Before)
}
