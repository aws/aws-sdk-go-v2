...
func (c *Client) addOperationAssociateAccessGrantsIdentityCenterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateAccessGrantsIdentityCenter", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
