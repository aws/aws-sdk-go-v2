...
func (c *Client) addOperationGetAccessPointPolicyForObjectLambdaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAccessPointPolicyForObjectLambda", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
