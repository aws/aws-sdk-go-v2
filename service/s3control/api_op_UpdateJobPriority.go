...
func (m *endpointPrefix_opUpdateJobPriorityMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opUpdateJobPriorityMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opUpdateJobPriorityMiddleware{}, middleware.Before)
}
