...
func (c *Client) addOperationUpdateJobPriorityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateJobPriorityEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opUpdateJobPriorityEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opUpdateJobPriorityEndpointDisableHTTPSMiddleware) ID() string {
	return "opUpdateJobPriorityEndpointDisableHTTPSMiddleware"
}

func (m *opUpdateJobPriorityEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateJobPriorityEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opUpdateJobPriorityEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opUpdateJobPriorityResolveEndpointMiddleware", middleware.After)
}
