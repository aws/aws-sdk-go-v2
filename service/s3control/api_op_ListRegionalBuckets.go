...
func (m *endpointPrefix_opListRegionalBucketsMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opListRegionalBucketsMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opListRegionalBucketsMiddleware{}, middleware.Before)
}
