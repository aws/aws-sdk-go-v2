...
func (c *Client) addOperationListAccessPointsForObjectLambdaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAccessPointsForObjectLambdaEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opListAccessPointsForObjectLambdaEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opListAccessPointsForObjectLambdaEndpointDisableHTTPSMiddleware) ID() string {
	return "opListAccessPointsForObjectLambdaEndpointDisableHTTPSMiddleware"
}

func (m *opListAccessPointsForObjectLambdaEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAccessPointsForObjectLambdaEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opListAccessPointsForObjectLambdaEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opListAccessPointsForObjectLambdaResolveEndpointMiddleware", middleware.After)
}
