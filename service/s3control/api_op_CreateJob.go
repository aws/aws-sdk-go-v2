...
func (c *Client) addOperationCreateJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateJobEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opCreateJobEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opCreateJobEndpointDisableHTTPSMiddleware) ID() string {
	return "opCreateJobEndpointDisableHTTPSMiddleware"
}

func (m *opCreateJobEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateJobEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opCreateJobEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opCreateJobResolveEndpointMiddleware", middleware.After)
}
