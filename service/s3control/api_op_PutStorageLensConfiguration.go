...
func (c *Client) addOperationPutStorageLensConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutStorageLensConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
