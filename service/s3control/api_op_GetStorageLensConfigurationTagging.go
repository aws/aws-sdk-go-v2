...
// must have permission to perform the s3:GetStorageLensConfigurationTagging
...
func (c *Client) GetStorageLensConfigurationTagging(ctx context.Context, params *GetStorageLensConfigurationTaggingInput, optFns ...func(*Options)) (*GetStorageLensConfigurationTaggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetStorageLensConfigurationTagging", params, optFns, addOperationGetStorageLensConfigurationTaggingMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetStorageLensConfigurationTaggingMiddlewares(stack *middleware.Stack, options Options) (err error) {
