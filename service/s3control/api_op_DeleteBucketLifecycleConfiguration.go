...
func (m *endpointPrefix_opDeleteBucketLifecycleConfigurationMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opDeleteBucketLifecycleConfigurationMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opDeleteBucketLifecycleConfigurationMiddleware{}, middleware.Before)
}
