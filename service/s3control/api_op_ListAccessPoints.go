...
func (m *endpointPrefix_opListAccessPointsMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opListAccessPointsMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opListAccessPointsMiddleware{}, middleware.Before)
}
