...
// on Outposts bucket. For more information about S3 on Outposts, see Using
...
// must also include the DeleteMarkerReplication , Status , and Priority
// elements. The response also returns those elements. For information about S3 on
// Outposts replication failure reasons, see Replication failure reasons (https://docs.aws.amazon.com/AmazonS3/latest/userguide/outposts-replication-eventbridge.html#outposts-replication-failure-codes)
...
type GetBucketReplicationOutput struct {
	...
	// a replication configuration is 128 KB.
