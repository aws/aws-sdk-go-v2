...
func (c *Client) addOperationGetBucketMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetBucketEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opGetBucketEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opGetBucketEndpointDisableHTTPSMiddleware) ID() string {
	return "opGetBucketEndpointDisableHTTPSMiddleware"
}

func (m *opGetBucketEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetBucketEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opGetBucketEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opGetBucketResolveEndpointMiddleware", middleware.After)
}
