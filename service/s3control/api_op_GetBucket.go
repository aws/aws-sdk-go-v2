...
// s3-outposts:GetBucketpermissions or you're not using an identity that belongs
// to the bucket owner's account, Amazon S3 returns a 403 Access Denied error.
// The following actions are related to GetBucket for Amazon S3 on Outposts: All
...
// the access point ARN, see the Examples (https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_GetBucket.html#API_control_GetBucket_Examples)
// section.
