...
func (c *Client) addOperationDeleteAccessPointForObjectLambdaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteAccessPointForObjectLambda", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
