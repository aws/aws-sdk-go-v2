...
func addOperationDeleteBucketPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addEndpointPrefix_opDeleteBucketPolicyMiddleware(stack)
...
func addEndpointPrefix_opDeleteBucketPolicyMiddleware(stack *middleware.Stack) (err error) {
	err = stack.Serialize.Insert(&endpointPrefix_opDeleteBucketPolicyMiddleware{}, `OperationSerializer`, middleware.Before)
	if err != nil {
		return err
	}
...
func (in DeleteBucketPolicyInput) updateARNMemberValue(v string) interface{} {
	in.Bucket = &v
	return &in
}
func (in DeleteBucketPolicyInput) backfillAccountID(v string) (interface{}, error) {
	if in.AccountId != nil {
