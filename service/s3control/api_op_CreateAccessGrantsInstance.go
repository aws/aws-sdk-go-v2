...
func (c *Client) addOperationCreateAccessGrantsInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateAccessGrantsInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
