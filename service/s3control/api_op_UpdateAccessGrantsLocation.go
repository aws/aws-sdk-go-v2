...
func (c *Client) addOperationUpdateAccessGrantsLocationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAccessGrantsLocation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
