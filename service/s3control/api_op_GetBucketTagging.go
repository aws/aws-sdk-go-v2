...
// permission to perform the GetBucketTagging action. By default, the bucket owner
// has this permission and can grant this permission to others. GetBucketTagging
