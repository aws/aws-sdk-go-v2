...
func (c *Client) addOperationListStorageLensConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListStorageLensConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
