...
func (c *Client) addOperationPutStorageLensConfigurationTaggingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutStorageLensConfigurationTagging", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
