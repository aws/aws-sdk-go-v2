...
func (m *endpointPrefix_opPutJobTaggingMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opPutJobTaggingMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opPutJobTaggingMiddleware{}, middleware.Before)
}
