...
func (c *Client) addOperationGetAccessPointPolicyStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAccessPointPolicyStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
