...
func (m *endpointPrefix_opGetJobTaggingMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opGetJobTaggingMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opGetJobTaggingMiddleware{}, middleware.Before)
}
