...
func (c *Client) addOperationDeleteAccessPointPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteAccessPointPolicyEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opDeleteAccessPointPolicyEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opDeleteAccessPointPolicyEndpointDisableHTTPSMiddleware) ID() string {
	return "opDeleteAccessPointPolicyEndpointDisableHTTPSMiddleware"
}

func (m *opDeleteAccessPointPolicyEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteAccessPointPolicyEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opDeleteAccessPointPolicyEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opDeleteAccessPointPolicyResolveEndpointMiddleware", middleware.After)
}
