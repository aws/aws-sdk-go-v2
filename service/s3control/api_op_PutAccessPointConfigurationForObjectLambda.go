...
func (c *Client) addOperationPutAccessPointConfigurationForObjectLambdaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutAccessPointConfigurationForObjectLambdaEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opPutAccessPointConfigurationForObjectLambdaEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opPutAccessPointConfigurationForObjectLambdaEndpointDisableHTTPSMiddleware) ID() string {
	return "opPutAccessPointConfigurationForObjectLambdaEndpointDisableHTTPSMiddleware"
}

func (m *opPutAccessPointConfigurationForObjectLambdaEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutAccessPointConfigurationForObjectLambdaEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opPutAccessPointConfigurationForObjectLambdaEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opPutAccessPointConfigurationForObjectLambdaResolveEndpointMiddleware", middleware.After)
}
...
func (*opPutAccessPointConfigurationForObjectLambdaResolveEndpointMiddleware) ID() string {
	return "opPutAccessPointConfigurationForObjectLambdaResolveEndpointMiddleware"
}
