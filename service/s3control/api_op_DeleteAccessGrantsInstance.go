...
func (c *Client) addOperationDeleteAccessGrantsInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteAccessGrantsInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
