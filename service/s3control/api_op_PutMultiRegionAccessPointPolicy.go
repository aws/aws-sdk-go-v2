...
func (c *Client) addOperationPutMultiRegionAccessPointPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutMultiRegionAccessPointPolicyEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opPutMultiRegionAccessPointPolicyEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opPutMultiRegionAccessPointPolicyEndpointDisableHTTPSMiddleware) ID() string {
	return "opPutMultiRegionAccessPointPolicyEndpointDisableHTTPSMiddleware"
}

func (m *opPutMultiRegionAccessPointPolicyEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutMultiRegionAccessPointPolicyEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opPutMultiRegionAccessPointPolicyEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opPutMultiRegionAccessPointPolicyResolveEndpointMiddleware", middleware.After)
}
...
func (*opPutMultiRegionAccessPointPolicyResolveEndpointMiddleware) ID() string {
	return "opPutMultiRegionAccessPointPolicyResolveEndpointMiddleware"
}
