...
func (c *Client) addOperationPutMultiRegionAccessPointPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutMultiRegionAccessPointPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
