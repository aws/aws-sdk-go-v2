...
func (c *Client) addOperationDeleteAccessGrantsInstanceResourcePolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteAccessGrantsInstanceResourcePolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
