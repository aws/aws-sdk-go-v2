...
func (c *Client) addOperationListAccessGrantsLocationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAccessGrantsLocations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
