...
func (m *endpointPrefix_opPutBucketPolicyMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opPutBucketPolicyMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opPutBucketPolicyMiddleware{}, middleware.Before)
}
