...
// to passive, or from passive to active. A value of 0 indicates a passive
...
// any Regions that aren’t specified remain unchanged. Updated routing
// configurations might not be immediately applied. It can take up to 2 minutes for
// your changes to take effect. To submit routing control changes and failover
// requests, use the Amazon S3 failover control infrastructure endpoints in these
// five Amazon Web Services Regions:
//   - us-east-1
//   - us-west-2
//   - ap-southeast-2
//   - ap-northeast-1
