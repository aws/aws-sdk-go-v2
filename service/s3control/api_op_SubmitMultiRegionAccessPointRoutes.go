...
func (c *Client) addOperationSubmitMultiRegionAccessPointRoutesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSubmitMultiRegionAccessPointRoutesEndpointDisableHTTPSMiddleware(stack, options); err != nil {
		return err
	}
	return nil
}
...
type opSubmitMultiRegionAccessPointRoutesEndpointDisableHTTPSMiddleware struct {
	EndpointDisableHTTPS bool
}

func (*opSubmitMultiRegionAccessPointRoutesEndpointDisableHTTPSMiddleware) ID() string {
	return "opSubmitMultiRegionAccessPointRoutesEndpointDisableHTTPSMiddleware"
}

func (m *opSubmitMultiRegionAccessPointRoutesEndpointDisableHTTPSMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSubmitMultiRegionAccessPointRoutesEndpointDisableHTTPSMiddleware(stack *middleware.Stack, o Options) error {
	return stack.Serialize.Insert(&opSubmitMultiRegionAccessPointRoutesEndpointDisableHTTPSMiddleware{
		EndpointDisableHTTPS: o.EndpointOptions.DisableHTTPS,
	}, "opSubmitMultiRegionAccessPointRoutesResolveEndpointMiddleware", middleware.After)
}
