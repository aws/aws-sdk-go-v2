...
func (c *Client) addOperationSubmitMultiRegionAccessPointRoutesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SubmitMultiRegionAccessPointRoutes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
