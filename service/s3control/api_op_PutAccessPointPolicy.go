...
func (m *endpointPrefix_opPutAccessPointPolicyMiddleware) HandleBuild(ctx context.Context, in middleware.BuildInput, next middleware.BuildHandler) (
...
func addEndpointPrefix_opPutAccessPointPolicyMiddleware(stack *middleware.Stack) (err error) {
	return stack.Build.Add(&endpointPrefix_opPutAccessPointPolicyMiddleware{}, middleware.Before)
}
