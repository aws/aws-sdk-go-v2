...
func addOperationGetBucketLifecycleConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	addEndpointPrefix_opGetBucketLifecycleConfigurationMiddleware(stack)
...
func (in GetBucketLifecycleConfigurationInput) updateARNMemberValue(v string) interface{} {
	in.Bucket = &v
	return &in
}
func (in GetBucketLifecycleConfigurationInput) backfillAccountID(v string) (interface{}, error) {
	if in.AccountId != nil {
