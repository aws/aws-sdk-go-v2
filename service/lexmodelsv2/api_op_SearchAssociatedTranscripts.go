...
func (c *Client) addOperationSearchAssociatedTranscriptsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SearchAssociatedTranscripts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
