...
func (c *Client) ListTestSets(ctx context.Context, params *ListTestSetsInput, optFns ...func(*Options)) (*ListTestSetsOutput, error) {
	if params == nil { params = &ListTestSetsInput{} }
...
func (c *Client) addOperationListTestSetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTestSetsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTestSetsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTestSetsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTestSetsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTestSetsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTestSetsResolveEndpointMiddleware{
