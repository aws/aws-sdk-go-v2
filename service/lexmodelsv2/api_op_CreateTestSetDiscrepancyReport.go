...
func (c *Client) addOperationCreateTestSetDiscrepancyReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateTestSetDiscrepancyReport", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
