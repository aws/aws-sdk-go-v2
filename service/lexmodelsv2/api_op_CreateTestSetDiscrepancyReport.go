...
func (c *Client) CreateTestSetDiscrepancyReport(ctx context.Context, params *CreateTestSetDiscrepancyReportInput, optFns ...func(*Options)) (*CreateTestSetDiscrepancyReportOutput, error) {
	if params == nil { params = &CreateTestSetDiscrepancyReportInput{} }
...
func (c *Client) addOperationCreateTestSetDiscrepancyReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateTestSetDiscrepancyReportResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateTestSetDiscrepancyReportResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateTestSetDiscrepancyReportResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateTestSetDiscrepancyReportResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateTestSetDiscrepancyReportResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateTestSetDiscrepancyReportResolveEndpointMiddleware{
