...
func (c *Client) addOperationBatchCreateCustomVocabularyItemMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchCreateCustomVocabularyItem", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
