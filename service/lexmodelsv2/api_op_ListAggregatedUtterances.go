...
func (c *Client) addOperationListAggregatedUtterancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAggregatedUtterances", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
