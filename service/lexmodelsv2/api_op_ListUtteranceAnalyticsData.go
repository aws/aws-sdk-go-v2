...
func (c *Client) addOperationListUtteranceAnalyticsDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListUtteranceAnalyticsData", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
