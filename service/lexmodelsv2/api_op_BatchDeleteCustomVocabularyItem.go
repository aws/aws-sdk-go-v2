...
func (c *Client) addOperationBatchDeleteCustomVocabularyItemMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchDeleteCustomVocabularyItem", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
