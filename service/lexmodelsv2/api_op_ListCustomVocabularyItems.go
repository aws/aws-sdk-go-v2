...
func (c *Client) addOperationListCustomVocabularyItemsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCustomVocabularyItems", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
