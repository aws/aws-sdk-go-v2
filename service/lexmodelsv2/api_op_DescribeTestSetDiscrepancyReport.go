...
func (*DescribeTestSetDiscrepancyReportInput) operationName() string {
...
func (c *Client) addOperationDescribeTestSetDiscrepancyReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeTestSetDiscrepancyReportResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeTestSetDiscrepancyReportResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeTestSetDiscrepancyReportResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeTestSetDiscrepancyReportResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeTestSetDiscrepancyReportResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeTestSetDiscrepancyReportResolveEndpointMiddleware{
