...
func (c *Client) ListUtteranceMetrics(ctx context.Context, params *ListUtteranceMetricsInput, optFns ...func(*Options)) (*ListUtteranceMetricsOutput, error) {
	if params == nil { params = &ListUtteranceMetricsInput{} }
...
func (c *Client) addOperationListUtteranceMetricsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListUtteranceMetricsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListUtteranceMetricsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListUtteranceMetricsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListUtteranceMetricsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListUtteranceMetricsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListUtteranceMetricsResolveEndpointMiddleware{
