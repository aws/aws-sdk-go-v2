...
func (c *Client) addOperationListBotResourceGenerationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListBotResourceGenerations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
