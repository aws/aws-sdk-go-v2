...
func (c *Client) addOperationBatchUpdateCustomVocabularyItemMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchUpdateCustomVocabularyItem", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
