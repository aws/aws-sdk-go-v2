...
func (c *Client) addOperationStartBotResourceGenerationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartBotResourceGeneration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
