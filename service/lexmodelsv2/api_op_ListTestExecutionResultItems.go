...
func (c *Client) addOperationListTestExecutionResultItemsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTestExecutionResultItems", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
