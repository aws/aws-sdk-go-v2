...
func (c *Client) ListTestExecutionResultItems(ctx context.Context, params *ListTestExecutionResultItemsInput, optFns ...func(*Options)) (*ListTestExecutionResultItemsOutput, error) {
	if params == nil { params = &ListTestExecutionResultItemsInput{} }
...
func (c *Client) addOperationListTestExecutionResultItemsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTestExecutionResultItemsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTestExecutionResultItemsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTestExecutionResultItemsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTestExecutionResultItemsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTestExecutionResultItemsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTestExecutionResultItemsResolveEndpointMiddleware{
