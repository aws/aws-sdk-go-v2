...
func (c *Client) DeleteTestSet(ctx context.Context, params *DeleteTestSetInput, optFns ...func(*Options)) (*DeleteTestSetOutput, error) {
	if params == nil { params = &DeleteTestSetInput{} }
...
func (c *Client) addOperationDeleteTestSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteTestSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteTestSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteTestSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteTestSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteTestSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteTestSetResolveEndpointMiddleware{
