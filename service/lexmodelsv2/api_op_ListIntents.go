...
func (c *Client) ListIntents(ctx context.Context, params *ListIntentsInput, optFns ...func(*Options)) (*ListIntentsOutput, error) {
	if params == nil { params = &ListIntentsInput{} }
...
func (c *Client) addOperationListIntentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListIntentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListIntentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListIntentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListIntentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListIntentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListIntentsResolveEndpointMiddleware{
