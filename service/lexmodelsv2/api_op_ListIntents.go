...
func (c *Client) ListIntents(ctx context.Context, params *ListIntentsInput, optFns ...func(*Options)) (*ListIntentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListIntents", params, optFns, addOperationListIntentsMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationListIntentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
