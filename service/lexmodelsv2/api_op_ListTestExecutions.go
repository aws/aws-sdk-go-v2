...
func (*ListTestExecutionsInput) operationName() string {
...
func (c *Client) addOperationListTestExecutionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTestExecutionsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListTestExecutionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListTestExecutionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTestExecutionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTestExecutionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListTestExecutionsResolveEndpointMiddleware{
