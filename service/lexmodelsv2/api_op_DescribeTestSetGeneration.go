...
func (c *Client) addOperationDescribeTestSetGenerationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeTestSetGeneration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
