...
// OpsWorksCM. See this package's package overview docs
...
const (
	ServiceName = "OpsWorksCM"  // Service's name
	ServiceID   = "OpsWorksCM"  // Service's identifier
	EndpointsID = "opsworks-cm" // Service's Endpoint identifier
)
