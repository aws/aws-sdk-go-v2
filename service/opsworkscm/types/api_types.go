...
type Backup struct {
	...
	Status enums.BackupStatus `type:"string" enum:"true"`
...
type Server struct {
	...
	MaintenanceStatus enums.MaintenanceStatus `type:"string" enum:"true"`
	...
	// health state.
	Status enums.ServerStatus `type:"string" enum:"true"`
