...
func addOperationDescribeNodeAssociationStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeNodeAssociationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeNodeAssociationStatusStackSlots(stack); err != nil {
		return err
	}
