...
func addOperationExportServerEngineAttributeStackSlots(stack *middleware.Stack) error {
...
func addOperationExportServerEngineAttributeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationExportServerEngineAttributeStackSlots(stack); err != nil {
		return err
	}
