...
func (c *Client) ListKxClusterNodes(ctx context.Context, params *ListKxClusterNodesInput, optFns ...func(*Options)) (*ListKxClusterNodesOutput, error) {
	if params == nil { params = &ListKxClusterNodesInput{} }
...
func (c *Client) addOperationListKxClusterNodesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListKxClusterNodesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListKxClusterNodesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListKxClusterNodesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListKxClusterNodesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListKxClusterNodesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListKxClusterNodesResolveEndpointMiddleware{
