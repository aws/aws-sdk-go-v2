...
func (c *Client) ListKxChangesets(ctx context.Context, params *ListKxChangesetsInput, optFns ...func(*Options)) (*ListKxChangesetsOutput, error) {
	if params == nil { params = &ListKxChangesetsInput{} }
...
func (c *Client) addOperationListKxChangesetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListKxChangesetsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListKxChangesetsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListKxChangesetsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListKxChangesetsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListKxChangesetsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListKxChangesetsResolveEndpointMiddleware{
