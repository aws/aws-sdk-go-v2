...
func (c *Client) ListKxClusters(ctx context.Context, params *ListKxClustersInput, optFns ...func(*Options)) (*ListKxClustersOutput, error) {
	if params == nil { params = &ListKxClustersInput{} }
...
func (c *Client) addOperationListKxClustersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListKxClustersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListKxClustersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListKxClustersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListKxClustersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListKxClustersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListKxClustersResolveEndpointMiddleware{
