...
func (c *Client) ListKxEnvironments(ctx context.Context, params *ListKxEnvironmentsInput, optFns ...func(*Options)) (*ListKxEnvironmentsOutput, error) {
	if params == nil { params = &ListKxEnvironmentsInput{} }
...
func (c *Client) addOperationListKxEnvironmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListKxEnvironmentsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListKxEnvironmentsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListKxEnvironmentsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListKxEnvironmentsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListKxEnvironmentsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListKxEnvironmentsResolveEndpointMiddleware{
