...
func (v *UpdateKxVolumeInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.UpdateKxVolumeRequest)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *UpdateKxVolumeInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.ClientToken != nil {
		s.WriteString(schemas.UpdateKxVolumeRequest_clientToken, *v.ClientToken)
	}
	if v.Description != nil {
		s.WriteString(schemas.UpdateKxVolumeRequest_description, *v.Description)
	}
	if v.EnvironmentId != nil {
		s.WriteString(schemas.UpdateKxVolumeRequest_environmentId, *v.EnvironmentId)
	}
	if v.Nas1Configuration != nil {
		s.WriteStruct(schemas.UpdateKxVolumeRequest_nas1Configuration)
		v.Nas1Configuration.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.VolumeName != nil {
		s.WriteString(schemas.UpdateKxVolumeRequest_volumeName, *v.VolumeName)
	}
}
...
func (v *UpdateKxVolumeOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.UpdateKxVolumeResponse, func(s *smithy.Schema) error {
		switch s {
		case schemas.UpdateKxVolumeResponse_attachedClusters:
			return deserializeKxAttachedClusters(d, schemas.UpdateKxVolumeResponse_attachedClusters, &v.AttachedClusters)
		case schemas.UpdateKxVolumeResponse_availabilityZoneIds:
			return deserializeAvailabilityZoneIds(d, schemas.UpdateKxVolumeResponse_availabilityZoneIds, &v.AvailabilityZoneIds)
		case schemas.UpdateKxVolumeResponse_azMode:
			var ev string
			if err := d.ReadString(schemas.UpdateKxVolumeResponse_azMode, &ev); err != nil {
				return err
			}
			v.AzMode = types.KxAzMode(ev)
			return nil
		case schemas.UpdateKxVolumeResponse_createdTimestamp:
			v.CreatedTimestamp = new(time.Time)
			return d.ReadTime(schemas.UpdateKxVolumeResponse_createdTimestamp, v.CreatedTimestamp)
		case schemas.UpdateKxVolumeResponse_description:
			v.Description = new(string)
			return d.ReadString(schemas.UpdateKxVolumeResponse_description, v.Description)
		case schemas.UpdateKxVolumeResponse_environmentId:
			v.EnvironmentId = new(string)
			return d.ReadString(schemas.UpdateKxVolumeResponse_environmentId, v.EnvironmentId)
		case schemas.UpdateKxVolumeResponse_lastModifiedTimestamp:
			v.LastModifiedTimestamp = new(time.Time)
			return d.ReadTime(schemas.UpdateKxVolumeResponse_lastModifiedTimestamp, v.LastModifiedTimestamp)
		case schemas.UpdateKxVolumeResponse_nas1Configuration:
			v.Nas1Configuration = &types.KxNAS1Configuration{}
			return v.Nas1Configuration.Deserialize(d)
		case schemas.UpdateKxVolumeResponse_status:
			var ev string
			if err := d.ReadString(schemas.UpdateKxVolumeResponse_status, &ev); err != nil {
				return err
			}
			v.Status = types.KxVolumeStatus(ev)
			return nil
		case schemas.UpdateKxVolumeResponse_statusReason:
			v.StatusReason = new(string)
			return d.ReadString(schemas.UpdateKxVolumeResponse_statusReason, v.StatusReason)
		case schemas.UpdateKxVolumeResponse_volumeArn:
			v.VolumeArn = new(string)
			return d.ReadString(schemas.UpdateKxVolumeResponse_volumeArn, v.VolumeArn)
		case schemas.UpdateKxVolumeResponse_volumeName:
			v.VolumeName = new(string)
			return d.ReadString(schemas.UpdateKxVolumeResponse_volumeName, v.VolumeName)
		case schemas.UpdateKxVolumeResponse_volumeType:
			var ev string
			if err := d.ReadString(schemas.UpdateKxVolumeResponse_volumeType, &ev); err != nil {
				return err
			}
...
func (c *Client) addOperationUpdateKxVolumeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.UpdateKxVolume, schemas.UpdateKxVolumeRequest, schemas.UpdateKxVolumeResponse)}, middleware.After); err != nil {
		return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.UpdateKxVolume, schemas.UpdateKxVolumeRequest, schemas.UpdateKxVolumeResponse), output: &UpdateKxVolumeOutput{}}, middleware.After); err != nil {
		return err
	}
