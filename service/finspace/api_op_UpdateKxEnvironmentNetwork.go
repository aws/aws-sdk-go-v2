...
func (c *Client) addOperationUpdateKxEnvironmentNetworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateKxEnvironmentNetwork", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
