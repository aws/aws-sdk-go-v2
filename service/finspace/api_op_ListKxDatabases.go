...
func (c *Client) ListKxDatabases(ctx context.Context, params *ListKxDatabasesInput, optFns ...func(*Options)) (*ListKxDatabasesOutput, error) {
	if params == nil { params = &ListKxDatabasesInput{} }
...
func (c *Client) addOperationListKxDatabasesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListKxDatabasesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListKxDatabasesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListKxDatabasesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListKxDatabasesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListKxDatabasesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListKxDatabasesResolveEndpointMiddleware{
