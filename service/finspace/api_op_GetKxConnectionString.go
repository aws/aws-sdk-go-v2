...
func (c *Client) GetKxConnectionString(ctx context.Context, params *GetKxConnectionStringInput, optFns ...func(*Options)) (*GetKxConnectionStringOutput, error) {
	if params == nil { params = &GetKxConnectionStringInput{} }
...
func (c *Client) addOperationGetKxConnectionStringMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetKxConnectionStringResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetKxConnectionStringResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetKxConnectionStringResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetKxConnectionStringResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetKxConnectionStringResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetKxConnectionStringResolveEndpointMiddleware{
