...
func (c *Client) ListKxUsers(ctx context.Context, params *ListKxUsersInput, optFns ...func(*Options)) (*ListKxUsersOutput, error) {
	if params == nil { params = &ListKxUsersInput{} }
...
func (c *Client) addOperationListKxUsersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListKxUsersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListKxUsersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListKxUsersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListKxUsersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListKxUsersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListKxUsersResolveEndpointMiddleware{
