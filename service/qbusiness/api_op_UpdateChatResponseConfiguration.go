...
func (c *Client) addOperationUpdateChatResponseConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateChatResponseConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
