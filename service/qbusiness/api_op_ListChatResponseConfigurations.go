...
func (c *Client) addOperationListChatResponseConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListChatResponseConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
