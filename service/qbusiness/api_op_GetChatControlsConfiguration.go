...
func (c *Client) addOperationGetChatControlsConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetChatControlsConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
