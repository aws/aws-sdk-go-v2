...
func (c *Client) addOperationUpdateChatControlsConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateChatControlsConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
