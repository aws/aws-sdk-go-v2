...
func (c *Client) addOperationCreateAnonymousWebExperienceUrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateAnonymousWebExperienceUrl", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
