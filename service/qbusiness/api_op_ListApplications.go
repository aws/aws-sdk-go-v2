...
type ListApplicationsOutput struct {
	...
	// this token in a subsequent request to retrieve the next set of applications.
	NextToken *string
...
func (c *Client) addOperationListApplicationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListApplications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
