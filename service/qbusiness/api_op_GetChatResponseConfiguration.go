...
func (c *Client) addOperationGetChatResponseConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetChatResponseConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
