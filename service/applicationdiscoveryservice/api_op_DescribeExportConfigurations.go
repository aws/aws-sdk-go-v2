...
func addOperationDescribeExportConfigurationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeExportConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeExportConfigurationsStackSlots(stack); err != nil {
		return err
	}
