...
func (c *Client) AssociateConfigurationItemsToApplication(ctx context.Context, params *AssociateConfigurationItemsToApplicationInput, optFns ...func(*Options)) (*AssociateConfigurationItemsToApplicationOutput, error) {
	if params == nil { params = &AssociateConfigurationItemsToApplicationInput{} }
...
func (c *Client) addOperationAssociateConfigurationItemsToApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateConfigurationItemsToApplicationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAssociateConfigurationItemsToApplicationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAssociateConfigurationItemsToApplicationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateConfigurationItemsToApplicationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateConfigurationItemsToApplicationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAssociateConfigurationItemsToApplicationResolveEndpointMiddleware{
