...
func (c *Client) addOperationStopDataCollectionByAgentIdsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopDataCollectionByAgentIds", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
