...
func (c *Client) StopDataCollectionByAgentIds(ctx context.Context, params *StopDataCollectionByAgentIdsInput, optFns ...func(*Options)) (*StopDataCollectionByAgentIdsOutput, error) {
	if params == nil { params = &StopDataCollectionByAgentIdsInput{} }
...
func (c *Client) addOperationStopDataCollectionByAgentIdsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopDataCollectionByAgentIdsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopDataCollectionByAgentIdsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopDataCollectionByAgentIdsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopDataCollectionByAgentIdsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopDataCollectionByAgentIdsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopDataCollectionByAgentIdsResolveEndpointMiddleware{
