...
func (c *Client) addOperationDescribeBatchDeleteConfigurationTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeBatchDeleteConfigurationTaskResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeBatchDeleteConfigurationTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeBatchDeleteConfigurationTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeBatchDeleteConfigurationTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeBatchDeleteConfigurationTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeBatchDeleteConfigurationTaskResolveEndpointMiddleware{
