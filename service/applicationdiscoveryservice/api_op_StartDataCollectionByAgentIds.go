...
func (c *Client) StartDataCollectionByAgentIds(ctx context.Context, params *StartDataCollectionByAgentIdsInput, optFns ...func(*Options)) (*StartDataCollectionByAgentIdsOutput, error) {
	if params == nil { params = &StartDataCollectionByAgentIdsInput{} }
...
func (c *Client) addOperationStartDataCollectionByAgentIdsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartDataCollectionByAgentIdsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartDataCollectionByAgentIdsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartDataCollectionByAgentIdsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartDataCollectionByAgentIdsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartDataCollectionByAgentIdsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartDataCollectionByAgentIdsResolveEndpointMiddleware{
