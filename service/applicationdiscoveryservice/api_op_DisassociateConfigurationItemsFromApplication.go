...
func (c *Client) DisassociateConfigurationItemsFromApplication(ctx context.Context, params *DisassociateConfigurationItemsFromApplicationInput, optFns ...func(*Options)) (*DisassociateConfigurationItemsFromApplicationOutput, error) {
	if params == nil { params = &DisassociateConfigurationItemsFromApplicationInput{} }
...
func (c *Client) addOperationDisassociateConfigurationItemsFromApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateConfigurationItemsFromApplicationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateConfigurationItemsFromApplicationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateConfigurationItemsFromApplicationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateConfigurationItemsFromApplicationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateConfigurationItemsFromApplicationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateConfigurationItemsFromApplicationResolveEndpointMiddleware{
