...
func (c *Client) addOperationDisassociateConfigurationItemsFromApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateConfigurationItemsFromApplication", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
