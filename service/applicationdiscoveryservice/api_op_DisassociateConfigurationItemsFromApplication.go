...
func addOperationDisassociateConfigurationItemsFromApplicationStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateConfigurationItemsFromApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateConfigurationItemsFromApplicationStackSlots(stack); err != nil {
		return err
	}
