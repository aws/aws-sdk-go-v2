...
// plan application migration projects. It automatically identifies servers,
// virtual machines (VMs), and network dependencies in your on-premises data
// centers. For more information, see the AWS Application Discovery Service FAQ
...
//
//         * Agentless discovery doesn't collect
...
//
//         * The agent captures
// infrastructure and application information, including an inventory of running
// processes, system performance information, resource utilization, and network
// dependencies.
//
...
// Service, enabling you to import details of your on-premises environment directly
// into Migration Hub without using the discovery connector or discovery agent.
//
//
...
//
//     * Remember that you must set your
// Migration Hub home region before you call any of these APIs.
//
//     * You must
...
// is returned.
//
//     * API calls for read actions (list, describe, stop, and
// delete) are permitted outside of your home region.
//
//     * Although it is
// unlikely, the Migration Hub home region could change. If you call APIs outside
// the home region, an InvalidInputException is returned.
//
//     * You must call
// GetHomeRegion to obtain the latest Migration Hub home region.
//
// This guide is
// intended for use with the AWS Application Discovery Service User Guide
