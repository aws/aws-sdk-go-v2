...
// collects a richer set of data than agentless discovery by using the AWS
...
// resource utilization, and network dependencies.
//
// * The information collected by
// agents is secured at rest and in transit to the Application Discovery Service
...
//
// * Third-party application discovery tools can
// query AWS Application Discovery Service, and they can write to the Application
// Discovery Service database using the public API.
//
// * In this way, you can import
// data into Migration Hub and view it, so that you can associate applications with
// servers and track migrations.
//
// Recommendations We recommend that you use
...
// hosts to collect additional information. Working With This Guide This API
...
//
// * You must make
// API calls for write actions (create, notify, associate, disassociate, import, or
// put) while in your home region, or a HomeRegionNotSetException error is
// returned.
//
...
//
// This guide is intended for use with the AWS
