...
func (c *Client) addOperationDescribeContinuousExportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeContinuousExports", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
