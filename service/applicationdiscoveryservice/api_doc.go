...
// Using the Client
//
// To use AWS Application Discovery Service with the SDK use the New function to create
...
//
// See the AWS Application Discovery Service client for more information on
