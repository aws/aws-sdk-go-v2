...
// Web Services account. For more information, see Amazon Web Services
...
type StartImportTaskInput struct {
	...
	// The URL for your import file that you've uploaded to Amazon S3. If you're
	...
	// automatically generated. Sending more than one StartImportTask request with
	// the same client request token will return information about the original import
