...
func (c *Client) StopPipe(ctx context.Context, params *StopPipeInput, optFns ...func(*Options)) (*StopPipeOutput, error) {
	if params == nil { params = &StopPipeInput{} }
...
func (c *Client) addOperationStopPipeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopPipeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopPipeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopPipeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopPipeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopPipeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopPipeResolveEndpointMiddleware{
