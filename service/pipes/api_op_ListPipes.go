...
func (c *Client) ListPipes(ctx context.Context, params *ListPipesInput, optFns ...func(*Options)) (*ListPipesOutput, error) {
	if params == nil { params = &ListPipesInput{} }
...
func (c *Client) addOperationListPipesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPipesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPipesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPipesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPipesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPipesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPipesResolveEndpointMiddleware{
