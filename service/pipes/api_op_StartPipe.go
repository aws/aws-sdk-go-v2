...
func (*StartPipeInput) operationName() string {
	return "StartPipe"
}
...
func (c *Client) addOperationStartPipeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartPipeResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStartPipeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStartPipeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartPipeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartPipeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStartPipeResolveEndpointMiddleware{
