...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-pipes.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pipes.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pipes.dev",
			expectURL:     aws.String("https://env-pipes.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-pipes.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pipes.dev",
			expectURL:     aws.String("http://config-pipes.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-pipes.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-pipes.dev",
			clientEndpoint: aws.String("https://client-pipes.dev"),
			expectURL:      aws.String("https://client-pipes.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PIPES", c.envService)
			}
