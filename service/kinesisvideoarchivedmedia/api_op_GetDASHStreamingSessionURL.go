...
func addOperationGetDASHStreamingSessionURLStackSlots(stack *middleware.Stack) error {
...
func addOperationGetDASHStreamingSessionURLMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetDASHStreamingSessionURLStackSlots(stack); err != nil {
		return err
	}
