...
//     token with the same measures that you use with your AWS credentials. The media
//     that is made available through the manifest consists only of the requested
//     stream, time range, and format. No other media data (such as frames outside the
...
func (c *Client) addOperationGetDASHStreamingSessionURLMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDASHStreamingSessionURLResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetDASHStreamingSessionURLResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetDASHStreamingSessionURLResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDASHStreamingSessionURLResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDASHStreamingSessionURLResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetDASHStreamingSessionURLResolveEndpointMiddleware{
