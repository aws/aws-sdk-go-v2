...
func (c *Client) addOperationGetDASHStreamingSessionURLMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDASHStreamingSessionURL", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
