...
// Kinesis Video Archived Media. See this package's package overview docs
...
const (
	ServiceName = "Kinesis Video Archived Media" // Service's name
	ServiceID   = "KinesisVideoArchivedMedia"    // Service's identifier
