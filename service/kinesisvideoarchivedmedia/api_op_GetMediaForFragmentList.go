...
func (c *Client) addOperationGetMediaForFragmentListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetMediaForFragmentList", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
