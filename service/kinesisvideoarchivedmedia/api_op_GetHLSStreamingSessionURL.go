...
type GetHLSStreamingSessionURLInput struct {
	...
	// FRAGMENTED_MP4container format packages the media into MP4 fragments (fMP4 or
	...
	// the media playlists. Media players typically build a timeline of media content
	// to play, based on the timestamps of each fragment. This means that if there is
	// any overlap or gap between fragments (as is typical if HLSFragmentSelector is
	// set to SERVER_TIMESTAMP), the media player timeline will also have small gaps
	...
	// Whether to retrieve live, live replay, or archived, on-demand data. Features
	// of the three types of sessions include the following:
