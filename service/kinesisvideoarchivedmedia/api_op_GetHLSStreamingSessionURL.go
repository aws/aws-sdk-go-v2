...
func (c *Client) GetHLSStreamingSessionURL(ctx context.Context, params *GetHLSStreamingSessionURLInput, optFns ...func(*Options)) (*GetHLSStreamingSessionURLOutput, error) {
	if params == nil { params = &GetHLSStreamingSessionURLInput{} }
...
func (c *Client) addOperationGetHLSStreamingSessionURLMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetHLSStreamingSessionURLResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetHLSStreamingSessionURLResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetHLSStreamingSessionURLResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetHLSStreamingSessionURLResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetHLSStreamingSessionURLResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetHLSStreamingSessionURLResolveEndpointMiddleware{
