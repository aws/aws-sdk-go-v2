...
func (c *Client) addOperationListSupportPermitRequestsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSupportPermitRequests", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
