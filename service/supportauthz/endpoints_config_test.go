...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-supportauthz.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-supportauthz.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-supportauthz.dev",
			expectURL:     aws.String("https://env-supportauthz.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-supportauthz.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-supportauthz.dev",
			expectURL:     aws.String("http://config-supportauthz.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-supportauthz.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-supportauthz.dev",
			clientEndpoint: aws.String("https://client-supportauthz.dev"),
			expectURL:      aws.String("https://client-supportauthz.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SUPPORTAUTHZ", c.envService)
			}
