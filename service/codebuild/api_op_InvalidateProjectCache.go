...
func (c *Client) InvalidateProjectCache(ctx context.Context, params *InvalidateProjectCacheInput, optFns ...func(*Options)) (*InvalidateProjectCacheOutput, error) {
	if params == nil { params = &InvalidateProjectCacheInput{} }
...
func (c *Client) addOperationInvalidateProjectCacheMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addInvalidateProjectCacheResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opInvalidateProjectCacheResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opInvalidateProjectCacheResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opInvalidateProjectCacheResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addInvalidateProjectCacheResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opInvalidateProjectCacheResolveEndpointMiddleware{
