...
func (c *Client) StopBuild(ctx context.Context, params *StopBuildInput, optFns ...func(*Options)) (*StopBuildOutput, error) {
	if params == nil { params = &StopBuildInput{} }
...
func (c *Client) addOperationStopBuildMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopBuildResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopBuildResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopBuildResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopBuildResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopBuildResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopBuildResolveEndpointMiddleware{
