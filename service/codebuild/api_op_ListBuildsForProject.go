...
func (c *Client) ListBuildsForProject(ctx context.Context, params *ListBuildsForProjectInput, optFns ...func(*Options)) (*ListBuildsForProjectOutput, error) {
	if params == nil { params = &ListBuildsForProjectInput{} }
...
func (c *Client) addOperationListBuildsForProjectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBuildsForProjectResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListBuildsForProjectResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListBuildsForProjectResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBuildsForProjectResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListBuildsForProjectResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListBuildsForProjectResolveEndpointMiddleware{
