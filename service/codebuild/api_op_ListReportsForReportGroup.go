...
func (c *Client) addOperationListReportsForReportGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListReportsForReportGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
