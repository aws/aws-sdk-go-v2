...
func (c *Client) ListReportsForReportGroup(ctx context.Context, params *ListReportsForReportGroupInput, optFns ...func(*Options)) (*ListReportsForReportGroupOutput, error) {
	if params == nil { params = &ListReportsForReportGroupInput{} }
...
func (c *Client) addOperationListReportsForReportGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListReportsForReportGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListReportsForReportGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListReportsForReportGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListReportsForReportGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListReportsForReportGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListReportsForReportGroupResolveEndpointMiddleware{
