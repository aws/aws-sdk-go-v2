...
func (c *Client) addOperationListSandboxesForProjectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSandboxesForProject", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
