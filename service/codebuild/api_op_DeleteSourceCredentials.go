...
func (c *Client) DeleteSourceCredentials(ctx context.Context, params *DeleteSourceCredentialsInput, optFns ...func(*Options)) (*DeleteSourceCredentialsOutput, error) {
	if params == nil { params = &DeleteSourceCredentialsInput{} }
...
func (c *Client) addOperationDeleteSourceCredentialsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteSourceCredentialsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteSourceCredentialsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteSourceCredentialsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteSourceCredentialsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteSourceCredentialsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteSourceCredentialsResolveEndpointMiddleware{
