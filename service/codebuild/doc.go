...
//
// * BatchDeleteBuilds: Deletes one or more
// builds.
//
...
//
// * BatchGetReportGroups: Returns an array
// of report groups.
//
...
//
// * CreateReportGroup: Creates a report
// group. A report group contains a collection of reports.
//
// * CreateWebhook: For an
...
//
// * DeleteResourcePolicy: Deletes a
...
//
// * DeleteWebhook: For an existing AWS CodeBuild
// build project that has its source code stored in a GitHub or Bitbucket
// repository, stops AWS CodeBuild from rebuilding the source code every time a
// code change is pushed to the repository.
//
// * DescribeTestCases: Returns a list of
// details about test cases for a report.
//
// * GetResourcePolicy: Gets a resource
// policy that is identified by its resource ARN.
//
...
//
// *
// ListBuilds: Gets a list of build IDs, with each build ID representing a single
// build.
//
...
//
// *
// ListReportGroups: Gets a list ARNs for the report groups in the current AWS
// account.
//
...
//
// * ListSharedProjects: Gets a list of ARNs
// associated with projects shared with the current AWS account or user.
//
// *
// ListSharedReportGroups: Gets a list of ARNs associated with report groups shared
// with the current AWS account or user
//
// * ListSourceCredentials: Returns a list of
// SourceCredentialsInfo objects. Each SourceCredentialsInfo object includes the
// authentication type, token ARN, and type of source provider for one set of
// credentials.
//
...
//
// * UpdateProject: Changes the
// settings of an existing build project.
//
// * UpdateReportGroup: Changes a report
// group.
//
