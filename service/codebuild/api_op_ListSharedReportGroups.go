...
func (*ListSharedReportGroupsInput) operationName() string {
...
func (c *Client) addOperationListSharedReportGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSharedReportGroupsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListSharedReportGroupsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListSharedReportGroupsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSharedReportGroupsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSharedReportGroupsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListSharedReportGroupsResolveEndpointMiddleware{
