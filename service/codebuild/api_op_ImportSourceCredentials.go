...
func (c *Client) addOperationImportSourceCredentialsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ImportSourceCredentials", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
