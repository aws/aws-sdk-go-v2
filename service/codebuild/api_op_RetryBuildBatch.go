...
func (c *Client) RetryBuildBatch(ctx context.Context, params *RetryBuildBatchInput, optFns ...func(*Options)) (*RetryBuildBatchOutput, error) {
	if params == nil { params = &RetryBuildBatchInput{} }
...
func (c *Client) addOperationRetryBuildBatchMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRetryBuildBatchResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRetryBuildBatchResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRetryBuildBatchResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRetryBuildBatchResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRetryBuildBatchResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRetryBuildBatchResolveEndpointMiddleware{
