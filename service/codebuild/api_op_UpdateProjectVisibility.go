...
func (c *Client) addOperationUpdateProjectVisibilityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateProjectVisibility", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
