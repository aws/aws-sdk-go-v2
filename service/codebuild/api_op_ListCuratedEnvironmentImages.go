...
func (c *Client) ListCuratedEnvironmentImages(ctx context.Context, params *ListCuratedEnvironmentImagesInput, optFns ...func(*Options)) (*ListCuratedEnvironmentImagesOutput, error) {
	if params == nil { params = &ListCuratedEnvironmentImagesInput{} }
...
func (c *Client) addOperationListCuratedEnvironmentImagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCuratedEnvironmentImagesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCuratedEnvironmentImagesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCuratedEnvironmentImagesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCuratedEnvironmentImagesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCuratedEnvironmentImagesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCuratedEnvironmentImagesResolveEndpointMiddleware{
