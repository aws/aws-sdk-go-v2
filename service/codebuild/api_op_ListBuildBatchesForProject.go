...
func (c *Client) addOperationListBuildBatchesForProjectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListBuildBatchesForProject", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
