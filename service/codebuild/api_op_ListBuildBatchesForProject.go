...
func (c *Client) ListBuildBatchesForProject(ctx context.Context, params *ListBuildBatchesForProjectInput, optFns ...func(*Options)) (*ListBuildBatchesForProjectOutput, error) {
	if params == nil { params = &ListBuildBatchesForProjectInput{} }
...
func (c *Client) addOperationListBuildBatchesForProjectMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBuildBatchesForProjectResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListBuildBatchesForProjectResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListBuildBatchesForProjectResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBuildBatchesForProjectResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListBuildBatchesForProjectResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListBuildBatchesForProjectResolveEndpointMiddleware{
