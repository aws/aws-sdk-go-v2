...
func (c *Client) StopBuildBatch(ctx context.Context, params *StopBuildBatchInput, optFns ...func(*Options)) (*StopBuildBatchOutput, error) {
	stack := middleware.NewStack("StopBuildBatch", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpStopBuildBatchMiddlewares(stack)
...
func addawsAwsjson11_serdeOpStopBuildBatchMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpStopBuildBatch{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpStopBuildBatch{}, middleware.After)
}
