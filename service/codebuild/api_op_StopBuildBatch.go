...
func (c *Client) StopBuildBatch(ctx context.Context, params *StopBuildBatchInput, optFns ...func(*Options)) (*StopBuildBatchOutput, error) {
	if params == nil { params = &StopBuildBatchInput{} }
...
func (c *Client) addOperationStopBuildBatchMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopBuildBatchResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopBuildBatchResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopBuildBatchResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopBuildBatchResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopBuildBatchResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopBuildBatchResolveEndpointMiddleware{
