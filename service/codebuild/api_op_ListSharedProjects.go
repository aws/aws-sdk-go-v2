...
func (c *Client) ListSharedProjects(ctx context.Context, params *ListSharedProjectsInput, optFns ...func(*Options)) (*ListSharedProjectsOutput, error) {
	if params == nil { params = &ListSharedProjectsInput{} }
...
func (c *Client) addOperationListSharedProjectsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSharedProjectsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSharedProjectsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSharedProjectsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSharedProjectsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSharedProjectsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSharedProjectsResolveEndpointMiddleware{
