...
type Build struct {
	...
	//
	// * If an Identity and Access Management user
	// started the build, the user's name (for example, MyUserName).
	//
	// * If the Jenkins
	// plugin for CodeBuild started the build, the string CodeBuild-Jenkins-Plugin.
	Initiator *string
...
type BuildBatch struct {
	...
	//
	// * If an Identity and Access Management user
	// started the build, the user's name.
	//
	// * If the Jenkins plugin for CodeBuild
	// started the build, the string CodeBuild-Jenkins-Plugin.
	Initiator *string
...
type EnvironmentVariable struct {
	...
	// can be displayed in plain text using the CodeBuild console and the AWS Command
...
type ProjectEnvironment struct {
	...
	//
	// For
	// more information, see Docker images provided by CodeBuild
...
type ProjectSource struct {
	...
	// must be in the same Region as the build project. Specify the buildspec file
	...
	// the buildspec file. You must connect your account to your GitHub account. Use
	// the CodeBuild console to start creating a build project. When you use the
...
// Private Registry with Secrets Manager Sample for CodeBuild
...
type S3ReportExportConfig struct {
	...
	// This allows report data to be exported to an Amazon S3 bucket that is owned by
