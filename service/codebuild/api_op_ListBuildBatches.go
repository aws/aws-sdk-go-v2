...
func (*ListBuildBatchesInput) operationName() string {
...
func (c *Client) addOperationListBuildBatchesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBuildBatchesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListBuildBatchesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListBuildBatchesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBuildBatchesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListBuildBatchesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListBuildBatchesResolveEndpointMiddleware{
