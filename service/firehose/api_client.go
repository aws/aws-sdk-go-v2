...
// Firehose. See this package's package overview docs
...
const (
	ServiceName = "Firehose" // Service's name
	ServiceID   = "Firehose" // Service's identifier
	EndpointsID = "firehose" // Service's Endpoint identifier
)
