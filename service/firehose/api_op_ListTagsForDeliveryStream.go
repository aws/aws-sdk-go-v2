...
func (c *Client) addOperationListTagsForDeliveryStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTagsForDeliveryStream", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
