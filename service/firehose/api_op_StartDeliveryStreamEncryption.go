...
// in DeliveryStreamEncryptionConfiguration. If the operation fails, the
...
// If the new CMK is of type CUSTOMER_MANAGED_CMK, Kinesis Data Firehose creates
...
// and you get ENABLING_FAILED, this only means that the attempt to change the
// CMK failed. In this case, encryption remains enabled with the old CMK. If the
