...
func addOperationStartDeliveryStreamEncryptionStackSlots(stack *middleware.Stack) error {
...
func addOperationStartDeliveryStreamEncryptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartDeliveryStreamEncryptionStackSlots(stack); err != nil {
		return err
	}
