...
// stream, use DescribeDeliveryStream. You can delete a delivery stream only if
// it is in one of the following states: ACTIVE , DELETING , CREATING_FAILED , or
...
// service might continue to accept records, but it doesn't make any guarantees
// with respect to delivering the data. Therefore, as a best practice, first stop
...
type DeleteDeliveryStreamInput struct {
	...
	// use the RevokeGrant (https://docs.aws.amazon.com/kms/latest/APIReference/API_RevokeGrant.html)
