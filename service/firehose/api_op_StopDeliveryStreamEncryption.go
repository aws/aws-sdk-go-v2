...
func addOperationStopDeliveryStreamEncryptionStackSlots(stack *middleware.Stack) error {
...
func addOperationStopDeliveryStreamEncryptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStopDeliveryStreamEncryptionStackSlots(stack); err != nil {
		return err
	}
