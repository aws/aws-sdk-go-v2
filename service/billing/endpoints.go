...
var bddNodes = [42]int32{
	-1, 1, -1, 0, 13, 3, 1, 4, 100000012, 2, 5, 100000012, 3, 9, 6, 4, 100000004, 7, 5, 8, 100000011, 6, 100000009, 100000010, 5, 11, 10, 7, 100000007, 100000008, 6, 12, 100000006, 7, 100000005, 100000006, 3, 100000001, 14, 5, 100000002, 100000003}
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 4:
		uriString := "https://billing.us-east-1.api.aws"
		uri, err := url.Parse(uriString)
		if err != nil {
			return smithyendpoints.Endpoint{}, fmt.Errorf("Failed to parse uri: %s", uriString)
		}
