...
func (c *Client) addOperationListSourceViewsForBillingViewMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSourceViewsForBillingView", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
