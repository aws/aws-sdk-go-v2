...
func addOperationListPackageVersionDependenciesStackSlots(stack *middleware.Stack) error {
...
func addOperationListPackageVersionDependenciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListPackageVersionDependenciesStackSlots(stack); err != nil {
		return err
	}
