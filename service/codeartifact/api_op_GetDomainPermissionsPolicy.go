...
func addOperationGetDomainPermissionsPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationGetDomainPermissionsPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetDomainPermissionsPolicyStackSlots(stack); err != nil {
		return err
	}
