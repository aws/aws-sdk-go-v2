...
func addOperationUpdatePackageVersionsStatusStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdatePackageVersionsStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdatePackageVersionsStatusStackSlots(stack); err != nil {
		return err
	}
