...
func (c *Client) addOperationUpdatePackageGroupOriginConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdatePackageGroupOriginConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
