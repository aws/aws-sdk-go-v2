...
func (c *Client) addOperationDeleteDomainPermissionsPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteDomainPermissionsPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
