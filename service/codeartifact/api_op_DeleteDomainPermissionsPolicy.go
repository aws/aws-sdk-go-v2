...
func addOperationDeleteDomainPermissionsPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteDomainPermissionsPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteDomainPermissionsPolicyStackSlots(stack); err != nil {
		return err
	}
