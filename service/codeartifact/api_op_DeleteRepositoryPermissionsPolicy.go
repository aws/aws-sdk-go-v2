...
func addOperationDeleteRepositoryPermissionsPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteRepositoryPermissionsPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteRepositoryPermissionsPolicyStackSlots(stack); err != nil {
		return err
	}
