...
func (c *Client) DeleteRepositoryPermissionsPolicy(ctx context.Context, params *DeleteRepositoryPermissionsPolicyInput, optFns ...func(*Options)) (*DeleteRepositoryPermissionsPolicyOutput, error) {
	if params == nil { params = &DeleteRepositoryPermissionsPolicyInput{} }
...
func (c *Client) addOperationDeleteRepositoryPermissionsPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteRepositoryPermissionsPolicyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteRepositoryPermissionsPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteRepositoryPermissionsPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteRepositoryPermissionsPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteRepositoryPermissionsPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteRepositoryPermissionsPolicyResolveEndpointMiddleware{
