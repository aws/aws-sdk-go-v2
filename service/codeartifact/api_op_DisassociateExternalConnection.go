...
func addOperationDisassociateExternalConnectionStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateExternalConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateExternalConnectionStackSlots(stack); err != nil {
		return err
	}
