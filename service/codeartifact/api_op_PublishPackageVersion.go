...
// unfinished flag can be used to keep the package version in the Unfinished
// state until all of its assets have been uploaded (see Package version status (https://docs.aws.amazon.com/codeartifact/latest/ug/packages-overview.html#package-version-status.html#package-version-status)
...
// to Unfinished. Only generic packages can be published using this API. For more
...
type PublishPackageVersionOutput struct {
	...
	// information, see Package version status (https://docs.aws.amazon.com/codeartifact/latest/ug/packages-overview.html#package-version-status.html#package-version-status)
	// in the CodeArtifact User Guide.
