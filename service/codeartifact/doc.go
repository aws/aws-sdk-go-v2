...
// entity known as a domain. All package assets and metadata are stored in the
// domain, but are consumed through repositories. A given package asset, such as a
// Maven JAR file, is stored once per domain, no matter how many repositories it's
...
// @types/node 12.6.9. The version number format and semantics vary for different
// package formats. For example, npm package versions must conform to the Semantic
...
// upstream of another when the package versions in it can be accessed from the
...
// authorization period has passed. The default authorization period is 12 hours
// and can be customized to any length with a maximum of 12 hours.
//
//     *
...
//
//     *
// ListRepositories: Returns a list of repositories owned by the AWS account that
// called this method.
//
