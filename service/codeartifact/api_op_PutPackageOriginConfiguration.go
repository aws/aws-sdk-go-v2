...
func (c *Client) addOperationPutPackageOriginConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutPackageOriginConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
