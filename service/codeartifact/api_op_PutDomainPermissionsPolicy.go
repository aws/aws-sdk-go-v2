...
func (c *Client) addOperationPutDomainPermissionsPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutDomainPermissionsPolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
