...
func (c *Client) addOperationListPackageVersionAssetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPackageVersionAssets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
