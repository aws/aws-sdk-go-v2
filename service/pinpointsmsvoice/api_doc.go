...
// requests to Pinpoint SMS Voice.
//
...
// Using the Client
//
// To use Pinpoint SMS Voice with the SDK use the New function to create
...
//
// See the Pinpoint SMS Voice client for more information on
