...
func (c *Client) addOperationGetConfigurationSetEventDestinationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetConfigurationSetEventDestinations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
