...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/networksecuritymanager/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_NETWORK_SECURITY_MANAGER")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Network Security Manager", cfg.ConfigSources)
	if found && err == nil {
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 3:
		uriString := func() string {
			...
			out.WriteString("https://network-security-manager-fips.")
	...
	case 4:
		uriString := func() string {
			var out strings.Builder
			out.WriteString("https://network-security-manager.")
			out.WriteString(*params.Region)
			out.WriteString(".")
			out.WriteString(c.PartitionResult.DualStackDnsSuffix)
			return out.String()
