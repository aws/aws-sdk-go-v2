...
func (c *Client) addOperationDescribeLaunchConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeLaunchConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
