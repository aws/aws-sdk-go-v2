...
func (c *Client) addOperationDescribeAutoScalingNotificationTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAutoScalingNotificationTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
