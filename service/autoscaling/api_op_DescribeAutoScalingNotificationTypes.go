...
func addOperationDescribeAutoScalingNotificationTypesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeAutoScalingNotificationTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeAutoScalingNotificationTypesStackSlots(stack); err != nil {
		return err
	}
