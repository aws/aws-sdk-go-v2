...
func (c *Client) addOperationDetachLoadBalancerTargetGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DetachLoadBalancerTargetGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
