...
func addOperationDetachLoadBalancerTargetGroupsStackSlots(stack *middleware.Stack) error {
...
func addOperationDetachLoadBalancerTargetGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDetachLoadBalancerTargetGroupsStackSlots(stack); err != nil {
		return err
	}
