...
func (*DeleteLaunchConfigurationInput) operationName() string {
...
func (c *Client) addOperationDeleteLaunchConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteLaunchConfigurationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteLaunchConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteLaunchConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteLaunchConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteLaunchConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteLaunchConfigurationResolveEndpointMiddleware{
