...
func (c *Client) DetachTrafficSources(ctx context.Context, params *DetachTrafficSourcesInput, optFns ...func(*Options)) (*DetachTrafficSourcesOutput, error) {
	if params == nil { params = &DetachTrafficSourcesInput{} }
...
func (c *Client) addOperationDetachTrafficSourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDetachTrafficSourcesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDetachTrafficSourcesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDetachTrafficSourcesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDetachTrafficSourcesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDetachTrafficSourcesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDetachTrafficSourcesResolveEndpointMiddleware{
