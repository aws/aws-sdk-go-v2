...
func addOperationDeleteNotificationConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteNotificationConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteNotificationConfigurationStackSlots(stack); err != nil {
		return err
	}
