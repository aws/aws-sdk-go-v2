...
// passes the health check. When the target group is in the InService state,
...
// target group doesn't enter the InService state. Target groups also have an
// InService state if you attach them in the CreateAutoScalingGroup API call. If
// your target group state is InService , but it is not working properly, check the
// scaling activities by calling DescribeScalingActivities and take any corrective
// actions necessary. For help with failed health checks, see Troubleshooting
