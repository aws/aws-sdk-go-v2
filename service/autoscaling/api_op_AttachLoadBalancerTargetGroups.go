...
func addOperationAttachLoadBalancerTargetGroupsStackSlots(stack *middleware.Stack) error {
...
func addOperationAttachLoadBalancerTargetGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAttachLoadBalancerTargetGroupsStackSlots(stack); err != nil {
		return err
	}
