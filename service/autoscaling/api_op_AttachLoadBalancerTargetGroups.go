...
// groups for an Auto Scaling group, call the DescribeLoadBalancerTargetGroups API.
// To detach the target group from the Auto Scaling group, call the
// DetachLoadBalancerTargetGroups API. This operation is additive and does not
// detach existing target groups or Classic Load Balancers from the Auto Scaling
