...
func (c *Client) addOperationAttachLoadBalancerTargetGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AttachLoadBalancerTargetGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
