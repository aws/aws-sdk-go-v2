...
func (c *Client) addOperationDescribeAdjustmentTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAdjustmentTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
