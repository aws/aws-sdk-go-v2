...
func (c *Client) SetDesiredCapacity(ctx context.Context, params *SetDesiredCapacityInput, optFns ...func(*Options)) (*SetDesiredCapacityOutput, error) {
	if params == nil { params = &SetDesiredCapacityInput{} }
...
func (c *Client) addOperationSetDesiredCapacityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetDesiredCapacityResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetDesiredCapacityResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetDesiredCapacityResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetDesiredCapacityResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetDesiredCapacityResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetDesiredCapacityResolveEndpointMiddleware{
