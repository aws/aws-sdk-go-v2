...
// are not used. For more information about using dynamic scaling, see Target
// tracking scaling policies (https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-scaling-target-tracking.html)
...
// an Auto Scaling group using the DescribePolicies API call. If you are no
// longer using a scaling policy, you can delete it by calling the DeletePolicy
// API.
...
type PutScalingPolicyInput struct {
	...
	// cooldown. Valid only if the policy type is SimpleScaling. For more
	// information, see Scaling cooldowns for Amazon EC2 Auto Scaling (https://docs.aws.amazon.com/autoscaling/ec2/userguide/Cooldown.html)
	...
	// policy type is TargetTrackingScaling  or StepScaling. The default is to use
	// the value for the default instance warmup defined for the group. If default
	// instance warmup is null, then EstimatedInstanceWarmup falls back to the value
	// of default cooldown.
	EstimatedInstanceWarmup *int32

	// The aggregation type for the CloudWatch metrics. The valid values are Minimum ,
	// Maximum , and Average. If the aggregation type is null, the value is treated
	// as Average . Valid only if the policy type is StepScaling .
	...
	// MinAdjustmentMagnitudeof 2. If the group has 4 instances and the scaling
	// policy is performed, 25 percent of 4 is 1. However, because you specified a
	// MinAdjustmentMagnitudeof 2, Amazon EC2 Auto Scaling scales out the group by 2
