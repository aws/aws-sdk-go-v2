...
// of your application. Note the following about changing DesiredCapacity ,
// MaxSize , or MinSize :
...
// DescribePoliciesAPI. If the group has scaling policies, you can update them by
...
type UpdateAutoScalingGroupInput struct {
	...
	// (default), ELB , and VPC_LATTICE . The VPC_LATTICE health check type is
	...
	// in your update request, you can't specify LaunchTemplate  or
	...
	// specify a new value of 0. For more information, see Replacing Auto Scaling
	...
	// specify VPCZoneIdentifier  with AvailabilityZones, the subnets that you
