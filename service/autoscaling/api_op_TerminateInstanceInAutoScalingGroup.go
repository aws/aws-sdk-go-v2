...
func (c *Client) addOperationTerminateInstanceInAutoScalingGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "TerminateInstanceInAutoScalingGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
