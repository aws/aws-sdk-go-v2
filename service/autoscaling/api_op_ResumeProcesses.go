...
func (*ResumeProcessesInput) operationName() string {
...
func (c *Client) addOperationResumeProcessesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResumeProcessesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opResumeProcessesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opResumeProcessesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResumeProcessesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResumeProcessesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opResumeProcessesResolveEndpointMiddleware{
