...
type DisableMetricsCollectionInput struct {
	...
	// Identifies the metrics to disable. You can specify one or more of the
	// following metrics:
	//     - GroupMinSize
	//     - GroupMaxSize
	...
	// disabled. For more information, see Auto Scaling group metrics (https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-cloudwatch-monitoring.html#as-group-metrics)
