...
func (*DisableMetricsCollectionInput) operationName() string {
...
func (c *Client) addOperationDisableMetricsCollectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableMetricsCollectionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDisableMetricsCollectionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDisableMetricsCollectionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableMetricsCollectionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableMetricsCollectionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDisableMetricsCollectionResolveEndpointMiddleware{
