...
func (c *Client) addOperationDescribeMetricCollectionTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMetricCollectionTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
