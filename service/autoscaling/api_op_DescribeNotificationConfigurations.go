...
func addOperationDescribeNotificationConfigurationsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeNotificationConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeNotificationConfigurationsStackSlots(stack); err != nil {
		return err
	}
