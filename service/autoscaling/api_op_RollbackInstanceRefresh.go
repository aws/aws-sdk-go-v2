...
func (c *Client) addOperationRollbackInstanceRefreshMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RollbackInstanceRefresh", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
