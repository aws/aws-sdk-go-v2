...
func (c *Client) RollbackInstanceRefresh(ctx context.Context, params *RollbackInstanceRefreshInput, optFns ...func(*Options)) (*RollbackInstanceRefreshOutput, error) {
	if params == nil { params = &RollbackInstanceRefreshInput{} }
...
type opRollbackInstanceRefreshResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRollbackInstanceRefreshResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRollbackInstanceRefreshResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRollbackInstanceRefreshResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRollbackInstanceRefreshResolveEndpointMiddleware{
