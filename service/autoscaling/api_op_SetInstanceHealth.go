...
func (c *Client) SetInstanceHealth(ctx context.Context, params *SetInstanceHealthInput, optFns ...func(*Options)) (*SetInstanceHealthOutput, error) {
	if params == nil { params = &SetInstanceHealthInput{} }
...
func (c *Client) addOperationSetInstanceHealthMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetInstanceHealthResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetInstanceHealthResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetInstanceHealthResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetInstanceHealthResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetInstanceHealthResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetInstanceHealthResolveEndpointMiddleware{
