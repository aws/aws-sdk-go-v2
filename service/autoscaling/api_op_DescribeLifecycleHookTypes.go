...
func (c *Client) addOperationDescribeLifecycleHookTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeLifecycleHookTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
