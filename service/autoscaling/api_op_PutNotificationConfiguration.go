...
func addOperationPutNotificationConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationPutNotificationConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutNotificationConfigurationStackSlots(stack); err != nil {
		return err
	}
