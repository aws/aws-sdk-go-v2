...
func addOperationDescribeAutoScalingInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeAutoScalingInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeAutoScalingInstancesStackSlots(stack); err != nil {
		return err
	}
