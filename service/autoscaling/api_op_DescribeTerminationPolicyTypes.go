...
func (c *Client) addOperationDescribeTerminationPolicyTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeTerminationPolicyTypes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
