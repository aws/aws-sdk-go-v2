...
func addOperationDescribeTerminationPolicyTypesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeTerminationPolicyTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeTerminationPolicyTypesStackSlots(stack); err != nil {
		return err
	}
