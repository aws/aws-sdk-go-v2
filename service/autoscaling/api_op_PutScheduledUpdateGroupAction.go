...
func addOperationPutScheduledUpdateGroupActionStackSlots(stack *middleware.Stack) error {
...
func addOperationPutScheduledUpdateGroupActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPutScheduledUpdateGroupActionStackSlots(stack); err != nil {
		return err
	}
