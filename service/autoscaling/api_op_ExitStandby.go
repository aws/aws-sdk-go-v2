...
func (c *Client) ExitStandby(ctx context.Context, params *ExitStandbyInput, optFns ...func(*Options)) (*ExitStandbyOutput, error) {
	if params == nil { params = &ExitStandbyInput{} }
...
func (c *Client) addOperationExitStandbyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addExitStandbyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opExitStandbyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opExitStandbyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opExitStandbyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addExitStandbyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opExitStandbyResolveEndpointMiddleware{
