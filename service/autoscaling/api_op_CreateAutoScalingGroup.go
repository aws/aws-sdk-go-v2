...
// creating an Auto Scaling group, see Getting started with Amazon EC2 Auto
...
type CreateAutoScalingGroupInput struct {
	...
	// The maximum size of the group. With a mixed instances policy that uses
	// instance weighting, Amazon EC2 Auto Scaling may need to go above MaxSize to
	...
	// Only needed if you use simple scaling policies. The amount of time, in
	// seconds, between one scaling activity ending and another one starting due to
	// simple scaling policies. For more information, see Scaling cooldowns for
	// Amazon EC2 Auto Scaling (https://docs.aws.amazon.com/autoscaling/ec2/userguide/Cooldown.html)
	...
	// the default instance warmup enabled by specifying a value of 0 or other
	...
	// specifies units , which translates into number of instances. Valid values:
	...
	// in the Amazon EC2 Auto Scaling User Guide. The valid values are EC2  (default),
	// ELB , and VPC_LATTICE . The VPC_LATTICE health check type is reserved for use
	// with VPC Lattice, which is in preview release and is subject to change.
	...
	// to or greater than 86,400 seconds (1 day). For more information, see Replacing
	...
	// AllocationStrategy | ClosestToNextInstanceHour  | NewestInstance  |
