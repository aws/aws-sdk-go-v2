...
func (c *Client) addOperationCompleteLifecycleActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CompleteLifecycleAction", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
