...
func (c *Client) addOperationBatchPutScheduledUpdateGroupActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchPutScheduledUpdateGroupAction", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
