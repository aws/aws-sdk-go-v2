...
func addOperationBatchPutScheduledUpdateGroupActionStackSlots(stack *middleware.Stack) error {
...
func addOperationBatchPutScheduledUpdateGroupActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationBatchPutScheduledUpdateGroupActionStackSlots(stack); err != nil {
		return err
	}
