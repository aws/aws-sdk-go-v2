...
func (*DeleteScheduledActionInput) operationName() string {
...
func (c *Client) addOperationDeleteScheduledActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteScheduledActionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteScheduledActionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteScheduledActionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteScheduledActionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteScheduledActionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteScheduledActionResolveEndpointMiddleware{
