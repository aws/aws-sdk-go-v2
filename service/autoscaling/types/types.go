...
type AutoScalingInstanceDetails struct {
	...
	// in the Amazon EC2 Auto Scaling User Guide. Valid values: Pending  |
	// Pending:Wait | Pending:Proceed  | Quarantined  | InService  | Terminating  |
	// Terminating:Wait | Terminating:Proceed  | Terminated  | Detaching  | Detached
...
type BlockDeviceMapping struct {
	...
	// instance at launch. The name must be in the form ephemeralX where X is a number
...
type Ebs struct {
	...
	// supported when the volume type is gp3  or io1 and required only when the
	// volume type is io1 . (Not used with standard , gp2 , st1 , or sc1  volumes.)
	Iops *int32

	// The snapshot ID of the volume to use. You must specify either a VolumeSize or
	// a SnapshotId .
	SnapshotId *string
...
type Filter struct {
	...
	// The name of the filter. The valid values for Name depend on which API
	// operation you're using with the filter ( DescribeAutoScalingGroups  or
	// DescribeTags ). DescribeAutoScalingGroups Valid values for Name include the
	// following:
...
type InstanceMetadataOptions struct {
	...
	// is optional, you can choose to retrieve instance metadata with or without a
	...
	// the IAM role credentials using a valid signed token, the version 2.0 role
...
// see Creating an Auto Scaling group using attribute-based instance type
...
type InstanceRequirements struct {
	...
	// m5.8xlarge , c5*.* , m5a.* , r* , *3* . For example, if you specify c5*,
	// Amazon EC2 Auto Scaling will allow the entire C5 instance family, which includes
	// all C5a and C5n instance types. If you specify m5a.*, Amazon EC2 Auto Scaling
	// will allow all the M5a instance types, but not the M5n instance types. If you
	// specify AllowedInstanceTypes , you can't specify ExcludedInstanceTypes.
	...
	// m5a.*, Amazon EC2 Auto Scaling will exclude all the M5a instance types, but
	// not the M5n instance types. If you specify ExcludedInstanceTypes, you can't
	// specify AllowedInstanceTypes . Default: No excluded instance types
	...
	// GiB. Default: No minimum or maximum limits
...
type InstancesDistribution struct {
	...
	// launched. Possible instance types are determined by the launch template
	// overrides that you specify. The following lists the valid values:
	...
	// use capacity-optimized-prioritized. capacity-optimized-prioritized You set the
	...
	// SpotInstancePoolsproperty. To ensure that your desired capacity is met, you
	...
	// the overrides. Valid only when the SpotAllocationStrategy  is lowest-price.
...
type LaunchConfiguration struct {
	...
	// assign a public IPv4 address on the subnet. For more information, see
	...
	// Auto Scaling group. For more information, see Security Groups for Your VPC (https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_SecurityGroups.html)
...
//
// Specify the instance types that you want,
// or define your instance requirements instead and let Amazon EC2 Auto Scaling
// provision the available instance types that meet your requirements. This can
// provide Amazon EC2 Auto Scaling with a larger selection of instance types to
...
// Auto Scaling group. After you define your instance requirements, you don't have
// to keep updating these settings to get new EC2 instance types automatically.
// Amazon EC2 Auto Scaling uses the instance requirements of the Auto Scaling group
// to determine whether a new EC2 instance type can be used.
type LaunchTemplateOverrides struct {
	...
	// is supported in your requested Region and Availability Zones. For more
...
type LifecycleHook struct {
	...
	// elapses or if an unexpected failure occurs. Valid values: CONTINUE  | ABANDON
...
// information and examples, see Advanced predictive scaling policy
...
type PredictiveScalingConfiguration struct {
	...
	// to HonorMaxCapacity  if not specified. The following are possible values:
...
type RefreshPreferences struct {
	...
	// must also specify a value for CheckpointPercentages. If you specify a value
	// for CheckpointPercentages  and not for CheckpointDelay , the CheckpointDelay
	...
	// last number in the array must be 100 . For usage examples, see Adding
	// checkpoints to an instance refresh (https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-adding-checkpoints-instance-refresh.html)
	// in the Amazon EC2 Auto Scaling User Guide.
	...
	// InServicestate. This property is not required for normal usage. Instead, use
	// the DefaultInstanceWarmup  property of the Auto Scaling group. The
	// InstanceWarmup and DefaultInstanceWarmup properties work the same way. Only
	// specify this property if you must override the DefaultInstanceWarmup property.
	// If you do not specify this property, the instance warmup by default is the value
	// of the DefaultInstanceWarmup property, if defined (which is recommended in all
	...
	// Amazon EC2 Auto Scaling ignores instances that are in Standby and continues to
	// replace instances that are in the InService state. Wait (default) Amazon EC2
	// Auto Scaling waits one hour for you to return the instances to service.
	// Otherwise, the instance refresh will fail.
...
//
// For
// more information, see Step adjustments (https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-scaling-simple-step.html#as-scaling-steps)
// in the Amazon EC2 Auto Scaling User Guide.
type StepAdjustment struct {
	...
	// the value that you specified in the AdjustmentType property (either an
	// absolute number or a percentage). A positive value adds to the current capacity
...
type TargetTrackingConfiguration struct {
	...
	// The target value for the metric. Some metrics are based on a count instead of
	// a percentage, such as the request count for an Application Load Balancer or the
	// number of messages in an SQS queue. If the scaling policy specifies one of these
	// metrics, specify the target utilization as the optimal average request or
	// message count per instance during any one-minute interval.
