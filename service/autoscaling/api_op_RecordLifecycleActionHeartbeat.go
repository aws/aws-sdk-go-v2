...
func addOperationRecordLifecycleActionHeartbeatStackSlots(stack *middleware.Stack) error {
...
func addOperationRecordLifecycleActionHeartbeatMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRecordLifecycleActionHeartbeatStackSlots(stack); err != nil {
		return err
	}
