...
func (c *Client) addOperationDescribeAutoScalingGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAutoScalingGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
