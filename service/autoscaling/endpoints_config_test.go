...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-auto-scaling.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-auto-scaling.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-auto-scaling.dev",
			expectURL:     aws.String("https://env-auto-scaling.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-auto-scaling.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-auto-scaling.dev",
			expectURL:     aws.String("http://config-auto-scaling.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-auto-scaling.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-auto-scaling.dev",
			clientEndpoint: aws.String("https://client-auto-scaling.dev"),
			expectURL:      aws.String("https://client-auto-scaling.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_AUTO_SCALING", c.envService)
			}
