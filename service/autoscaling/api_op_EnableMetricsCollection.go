...
func (c *Client) addOperationEnableMetricsCollectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableMetricsCollection", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
