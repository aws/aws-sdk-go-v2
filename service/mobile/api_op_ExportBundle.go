...
func (c *Client) ExportBundle(ctx context.Context, params *ExportBundleInput, optFns ...func(*Options)) (*ExportBundleOutput, error) {
	if params == nil { params = &ExportBundleInput{} }
...
func (c *Client) addOperationExportBundleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addExportBundleResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opExportBundleResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opExportBundleResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opExportBundleResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addExportBundleResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opExportBundleResolveEndpointMiddleware{
