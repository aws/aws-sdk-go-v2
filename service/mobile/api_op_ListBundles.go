...
func (c *Client) ListBundles(ctx context.Context, params *ListBundlesInput, optFns ...func(*Options)) (*ListBundlesOutput, error) {
	if params == nil { params = &ListBundlesInput{} }
...
func (c *Client) addOperationListBundlesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListBundlesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListBundlesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListBundlesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListBundlesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListBundlesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListBundlesResolveEndpointMiddleware{
