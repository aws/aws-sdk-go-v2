...
* **Bug Fix**: Fixes iotsecuretunneling and mobile API clients to use the correct name for signing requests, Fixes [#1686](https://github.com/Enflick/aws-sdk-go-v2/issues/1686).
* **Dependency Update**: Updated to the latest SDK module versions
