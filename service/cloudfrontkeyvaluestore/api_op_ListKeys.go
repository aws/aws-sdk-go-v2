...
func (v *ListKeysInput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.KvsARN != nil {
		s.WriteString(schemas.ListKeysRequest_KvsARN, *v.KvsARN)
	}
	if v.MaxResults != nil {
...
func (v *ListKeysOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ListKeysResponse, func(s *smithy.Schema) error {
		switch s {
		case schemas.ListKeysResponse_Items:
			return deserializeListKeysResponseList(d, schemas.ListKeysResponse_Items, &v.Items)
