...
func (c *Client) addOperationGetDocumentTextDetectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDocumentTextDetection", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
