...
func addOperationStartDocumentTextDetectionStackSlots(stack *middleware.Stack) error {
...
func addOperationStartDocumentTextDetectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartDocumentTextDetectionStackSlots(stack); err != nil {
		return err
	}
