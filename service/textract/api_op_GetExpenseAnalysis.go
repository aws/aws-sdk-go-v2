...
// invoice/receipt analysis operation, first ensure that the status value published
// to the Amazon SNS topic is SUCCEEDED . If so, call GetExpenseAnalysis, and
// pass the job identifier ( JobId ) from the initial call to StartExpenseAnalysis
...
// from the previous call to GetExpenseAnalysis . For more information, see
