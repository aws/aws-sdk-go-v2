...
func (*GetLendingAnalysisSummaryInput) operationName() string {
	return "GetLendingAnalysisSummary"
}
...
func (c *Client) addOperationGetLendingAnalysisSummaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetLendingAnalysisSummaryResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetLendingAnalysisSummaryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetLendingAnalysisSummaryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetLendingAnalysisSummaryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetLendingAnalysisSummaryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetLendingAnalysisSummaryResolveEndpointMiddleware{
