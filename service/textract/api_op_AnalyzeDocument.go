...
// information about a selection element, including the selection status. You can
// choose which type of analysis to perform by specifying the FeatureTypes list.
// The output is returned in a list of Block  objects. AnalyzeDocument is a
