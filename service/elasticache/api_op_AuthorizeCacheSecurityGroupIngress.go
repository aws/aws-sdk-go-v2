...
func addOperationAuthorizeCacheSecurityGroupIngressStackSlots(stack *middleware.Stack) error {
...
func addOperationAuthorizeCacheSecurityGroupIngressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAuthorizeCacheSecurityGroupIngressStackSlots(stack); err != nil {
		return err
	}
