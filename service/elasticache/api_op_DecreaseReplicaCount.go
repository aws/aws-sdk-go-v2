...
func (c *Client) DecreaseReplicaCount(ctx context.Context, params *DecreaseReplicaCountInput, optFns ...func(*Options)) (*DecreaseReplicaCountOutput, error) {
	if params == nil { params = &DecreaseReplicaCountInput{} }
...
func (c *Client) addOperationDecreaseReplicaCountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDecreaseReplicaCountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDecreaseReplicaCountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDecreaseReplicaCountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDecreaseReplicaCountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDecreaseReplicaCountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDecreaseReplicaCountResolveEndpointMiddleware{
