...
func (c *Client) addOperationDisassociateGlobalReplicationGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateGlobalReplicationGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
