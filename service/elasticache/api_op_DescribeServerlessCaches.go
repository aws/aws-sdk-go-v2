...
func (c *Client) addOperationDescribeServerlessCachesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeServerlessCaches", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
