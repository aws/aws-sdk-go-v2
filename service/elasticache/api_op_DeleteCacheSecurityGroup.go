...
func (c *Client) addOperationDeleteCacheSecurityGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteCacheSecurityGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
