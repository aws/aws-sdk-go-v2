...
func (c *Client) addOperationModifyReplicationGroupShardConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyReplicationGroupShardConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
