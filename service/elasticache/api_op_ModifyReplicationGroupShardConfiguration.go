...
func addOperationModifyReplicationGroupShardConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationModifyReplicationGroupShardConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationModifyReplicationGroupShardConfigurationStackSlots(stack); err != nil {
		return err
	}
