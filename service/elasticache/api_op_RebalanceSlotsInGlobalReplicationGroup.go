...
func (c *Client) addOperationRebalanceSlotsInGlobalReplicationGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RebalanceSlotsInGlobalReplicationGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
