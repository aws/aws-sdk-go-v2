...
func (c *Client) RebalanceSlotsInGlobalReplicationGroup(ctx context.Context, params *RebalanceSlotsInGlobalReplicationGroupInput, optFns ...func(*Options)) (*RebalanceSlotsInGlobalReplicationGroupOutput, error) {
	if params == nil { params = &RebalanceSlotsInGlobalReplicationGroupInput{} }
...
func (c *Client) addOperationRebalanceSlotsInGlobalReplicationGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRebalanceSlotsInGlobalReplicationGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRebalanceSlotsInGlobalReplicationGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRebalanceSlotsInGlobalReplicationGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRebalanceSlotsInGlobalReplicationGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRebalanceSlotsInGlobalReplicationGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRebalanceSlotsInGlobalReplicationGroupResolveEndpointMiddleware{
