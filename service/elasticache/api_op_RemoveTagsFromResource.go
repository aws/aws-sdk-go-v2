...
// to categorize and track all your ElastiCache resources. When you add or remove
// tags on replication groups, those actions will be replicated to all nodes in the
