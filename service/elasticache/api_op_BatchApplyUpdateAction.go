...
func (*BatchApplyUpdateActionInput) operationName() string {
...
func (c *Client) addOperationBatchApplyUpdateActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchApplyUpdateActionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opBatchApplyUpdateActionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opBatchApplyUpdateActionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchApplyUpdateActionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchApplyUpdateActionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opBatchApplyUpdateActionResolveEndpointMiddleware{
