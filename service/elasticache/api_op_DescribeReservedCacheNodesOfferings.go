...
func addOperationDescribeReservedCacheNodesOfferingsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeReservedCacheNodesOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeReservedCacheNodesOfferingsStackSlots(stack); err != nil {
		return err
	}
