...
func (c *Client) addOperationDescribeReservedCacheNodesOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReservedCacheNodesOfferings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
