...
func (c *Client) addOperationIncreaseNodeGroupsInGlobalReplicationGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "IncreaseNodeGroupsInGlobalReplicationGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
