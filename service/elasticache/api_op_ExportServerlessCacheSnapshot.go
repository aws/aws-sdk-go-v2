...
func (c *Client) addOperationExportServerlessCacheSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ExportServerlessCacheSnapshot", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
