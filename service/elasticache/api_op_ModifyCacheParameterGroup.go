...
func (c *Client) addOperationModifyCacheParameterGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ModifyCacheParameterGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
