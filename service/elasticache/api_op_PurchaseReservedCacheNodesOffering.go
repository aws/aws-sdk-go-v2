...
func (c *Client) addOperationPurchaseReservedCacheNodesOfferingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PurchaseReservedCacheNodesOffering", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
