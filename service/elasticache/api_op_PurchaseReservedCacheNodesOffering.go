...
func addOperationPurchaseReservedCacheNodesOfferingStackSlots(stack *middleware.Stack) error {
...
func addOperationPurchaseReservedCacheNodesOfferingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationPurchaseReservedCacheNodesOfferingStackSlots(stack); err != nil {
		return err
	}
