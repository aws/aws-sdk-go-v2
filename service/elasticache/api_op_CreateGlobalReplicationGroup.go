...
type CreateGlobalReplicationGroupInput struct {
	...
	// the Global datastore name across multiple regions. For a full list of Amazon
	// Regions and their respective Global datastore iD prefixes, see Using the
	// Amazon CLI with Global datastores  (http://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/Redis-Global-Datastores-CLI.html)
	// .
	//
