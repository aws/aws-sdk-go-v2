...
func addOperationDescribeReservedCacheNodesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeReservedCacheNodesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeReservedCacheNodesStackSlots(stack); err != nil {
		return err
	}
