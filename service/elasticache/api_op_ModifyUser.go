...
func (c *Client) ModifyUser(ctx context.Context, params *ModifyUserInput, optFns ...func(*Options)) (*ModifyUserOutput, error) {
	if params == nil { params = &ModifyUserInput{} }
...
func (c *Client) addOperationModifyUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addModifyUserResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opModifyUserResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opModifyUserResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opModifyUserResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addModifyUserResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opModifyUserResolveEndpointMiddleware{
