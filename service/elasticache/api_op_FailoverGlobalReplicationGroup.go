...
func (c *Client) addOperationFailoverGlobalReplicationGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "FailoverGlobalReplicationGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
