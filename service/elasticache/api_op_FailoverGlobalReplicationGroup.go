...
func addOperationFailoverGlobalReplicationGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationFailoverGlobalReplicationGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationFailoverGlobalReplicationGroupStackSlots(stack); err != nil {
		return err
	}
