...
func (c *Client) addOperationDescribeCacheParameterGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCacheParameterGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
