...
func addOperationDescribeCacheParameterGroupsStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeCacheParameterGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeCacheParameterGroupsStackSlots(stack); err != nil {
		return err
	}
