...
func (c *Client) addOperationCopyServerlessCacheSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CopyServerlessCacheSnapshot", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
