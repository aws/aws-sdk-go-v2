...
func (c *Client) addOperationResetCacheParameterGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ResetCacheParameterGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
