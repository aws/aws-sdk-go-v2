...
func addOperationDeleteGlobalReplicationGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteGlobalReplicationGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteGlobalReplicationGroupStackSlots(stack); err != nil {
		return err
	}
