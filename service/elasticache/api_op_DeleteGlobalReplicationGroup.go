...
func (c *Client) addOperationDeleteGlobalReplicationGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteGlobalReplicationGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
