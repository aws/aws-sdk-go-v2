...
func (c *Client) addOperationCreateServerlessCacheSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateServerlessCacheSnapshot", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
