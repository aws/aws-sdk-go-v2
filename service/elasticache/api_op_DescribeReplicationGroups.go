...
func (c *Client) addOperationDescribeReplicationGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReplicationGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
