...
func (c *Client) addOperationDescribeServerlessCacheSnapshotsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeServerlessCacheSnapshots", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
