...
func (*DecreaseNodeGroupsInGlobalReplicationGroupInput) operationName() string {
...
func (c *Client) addOperationDecreaseNodeGroupsInGlobalReplicationGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDecreaseNodeGroupsInGlobalReplicationGroupResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDecreaseNodeGroupsInGlobalReplicationGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDecreaseNodeGroupsInGlobalReplicationGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDecreaseNodeGroupsInGlobalReplicationGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDecreaseNodeGroupsInGlobalReplicationGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDecreaseNodeGroupsInGlobalReplicationGroupResolveEndpointMiddleware{
