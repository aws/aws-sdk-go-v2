...
func addOperationDecreaseNodeGroupsInGlobalReplicationGroupStackSlots(stack *middleware.Stack) error {
...
func addOperationDecreaseNodeGroupsInGlobalReplicationGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDecreaseNodeGroupsInGlobalReplicationGroupStackSlots(stack); err != nil {
		return err
	}
