...
func (c *Client) addOperationRevokeCacheSecurityGroupIngressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RevokeCacheSecurityGroupIngress", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
