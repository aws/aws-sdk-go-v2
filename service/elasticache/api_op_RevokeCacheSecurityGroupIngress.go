...
func (c *Client) RevokeCacheSecurityGroupIngress(ctx context.Context, params *RevokeCacheSecurityGroupIngressInput, optFns ...func(*Options)) (*RevokeCacheSecurityGroupIngressOutput, error) {
	if params == nil { params = &RevokeCacheSecurityGroupIngressInput{} }
...
func (c *Client) addOperationRevokeCacheSecurityGroupIngressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRevokeCacheSecurityGroupIngressResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRevokeCacheSecurityGroupIngressResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRevokeCacheSecurityGroupIngressResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRevokeCacheSecurityGroupIngressResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRevokeCacheSecurityGroupIngressResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRevokeCacheSecurityGroupIngressResolveEndpointMiddleware{
