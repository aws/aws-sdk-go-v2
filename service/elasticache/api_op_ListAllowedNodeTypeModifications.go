...
func addOperationListAllowedNodeTypeModificationsStackSlots(stack *middleware.Stack) error {
...
func addOperationListAllowedNodeTypeModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListAllowedNodeTypeModificationsStackSlots(stack); err != nil {
		return err
	}
