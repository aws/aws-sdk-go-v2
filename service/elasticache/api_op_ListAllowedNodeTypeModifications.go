...
func (c *Client) addOperationListAllowedNodeTypeModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAllowedNodeTypeModifications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
