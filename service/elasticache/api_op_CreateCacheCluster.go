...
type CreateCacheClusterInput struct {
	...
	// The name of the cache engine to be used for this cluster. Valid values for
	...
	// group (shard) is being created. This parameter is only valid if the Engine
	// parameter is redis .
	SnapshotName *string
	...
	// valid if the Engine  parameter is redis. Default: 0 (i.e., automatic backups
	...
	// A flag that enables in-transit encryption when set to true. Only available
	// when creating a cache cluster in an Amazon VPC using Memcached version 1.6.12 or
	// later.
