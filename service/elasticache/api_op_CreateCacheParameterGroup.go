...
func (c *Client) addOperationCreateCacheParameterGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCacheParameterGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
