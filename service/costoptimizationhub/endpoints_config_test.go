...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cost-optimization-hub.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cost-optimization-hub.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cost-optimization-hub.dev",
			expectURL:     aws.String("https://env-cost-optimization-hub.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cost-optimization-hub.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cost-optimization-hub.dev",
			expectURL:     aws.String("http://config-cost-optimization-hub.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cost-optimization-hub.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cost-optimization-hub.dev",
			clientEndpoint: aws.String("https://client-cost-optimization-hub.dev"),
			expectURL:      aws.String("https://client-cost-optimization-hub.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_COST_OPTIMIZATION_HUB", c.envService)
			}
