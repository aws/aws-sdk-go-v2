...
func (v *UpdatePreferencesOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.MemberAccountDiscountVisibility != "" {
		s.WriteString(schemas.UpdatePreferencesResponse_memberAccountDiscountVisibility, string(v.MemberAccountDiscountVisibility))
	}
	if v.PreferredCommitment != nil {
		s.WriteStruct(schemas.UpdatePreferencesResponse_preferredCommitment)
		v.PreferredCommitment.SerializeMembers(s)
		s.CloseStruct()
	}
	if v.SavingsEstimationMode != "" {
		s.WriteString(schemas.UpdatePreferencesResponse_savingsEstimationMode, string(v.SavingsEstimationMode))
	}
}
