...
func (c *Client) addOperationListRecommendationSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListRecommendationSummaries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
