...
func TestCheckRequestSnapshot_CalculateIsolines(t *testing.T) {
...
func TestCheckRequestSnapshot_CalculateRoutes(t *testing.T) {
...
func TestCheckRequestSnapshot_OptimizeWaypoints(t *testing.T) {
...
func TestCheckRequestSnapshot_SnapToRoads(t *testing.T) {
...
func TestUpdateRequestSnapshot_CalculateIsolines(t *testing.T) {
	input := &CalculateIsolinesInput{
		Allow: &types.IsolineAllowOptions{
			Hot: ptr.Bool(true),
			Hov: ptr.Bool(true),
...
func TestUpdateRequestSnapshot_CalculateRoutes(t *testing.T) {
	input := &CalculateRoutesInput{
		Allow: &types.RouteAllowOptions{
			Hot: ptr.Bool(true),
			Hov: ptr.Bool(true),
...
func TestUpdateRequestSnapshot_OptimizeWaypoints(t *testing.T) {
	input := &OptimizeWaypointsInput{
		Avoid: &types.WaypointOptimizationAvoidanceOptions{
			Areas: []types.WaypointOptimizationAvoidanceArea{
				{
...
func TestUpdateRequestSnapshot_SnapToRoads(t *testing.T) {
	input := &SnapToRoadsInput{
		Key:                   ptr.String("__Key__"),
		SnappedGeometryFormat: types.GeometryFormat("FlexiblePolyline"),
		SnapRadius:            1,
