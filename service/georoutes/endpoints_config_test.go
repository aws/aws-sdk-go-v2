...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-geo-routes.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-geo-routes.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-geo-routes.dev",
			expectURL:     aws.String("https://env-geo-routes.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-geo-routes.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-geo-routes.dev",
			expectURL:     aws.String("http://config-geo-routes.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-geo-routes.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-geo-routes.dev",
			clientEndpoint: aws.String("https://client-geo-routes.dev"),
			expectURL:      aws.String("https://client-geo-routes.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_GEO_ROUTES", c.envService)
			}
