...
func (c *Client) addOperationUpdateCisScanConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCisScanConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
