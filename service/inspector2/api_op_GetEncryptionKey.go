...
func (c *Client) GetEncryptionKey(ctx context.Context, params *GetEncryptionKeyInput, optFns ...func(*Options)) (*GetEncryptionKeyOutput, error) {
	if params == nil { params = &GetEncryptionKeyInput{} }
...
func (c *Client) addOperationGetEncryptionKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetEncryptionKeyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetEncryptionKeyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetEncryptionKeyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetEncryptionKeyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetEncryptionKeyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetEncryptionKeyResolveEndpointMiddleware{
