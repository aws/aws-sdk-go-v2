...
func (c *Client) addOperationUpdateCodeSecurityScanConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCodeSecurityScanConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
