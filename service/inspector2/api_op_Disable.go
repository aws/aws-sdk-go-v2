...
func (c *Client) Disable(ctx context.Context, params *DisableInput, optFns ...func(*Options)) (*DisableOutput, error) {
	if params == nil { params = &DisableInput{} }
...
func (c *Client) addOperationDisableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisableResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisableResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisableResolveEndpointMiddleware{
