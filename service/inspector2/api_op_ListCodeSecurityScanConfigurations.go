...
func (c *Client) addOperationListCodeSecurityScanConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCodeSecurityScanConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
