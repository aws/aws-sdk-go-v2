...
func (c *Client) addOperationDeleteCodeSecurityScanConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteCodeSecurityScanConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
