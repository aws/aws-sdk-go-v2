...
func (*ResetEncryptionKeyInput) operationName() string {
...
func (c *Client) addOperationResetEncryptionKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addResetEncryptionKeyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opResetEncryptionKeyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opResetEncryptionKeyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opResetEncryptionKeyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addResetEncryptionKeyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opResetEncryptionKeyResolveEndpointMiddleware{
