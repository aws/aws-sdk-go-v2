...
func (c *Client) EnableDelegatedAdminAccount(ctx context.Context, params *EnableDelegatedAdminAccountInput, optFns ...func(*Options)) (*EnableDelegatedAdminAccountOutput, error) {
	if params == nil { params = &EnableDelegatedAdminAccountInput{} }
...
func (c *Client) addOperationEnableDelegatedAdminAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableDelegatedAdminAccountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEnableDelegatedAdminAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEnableDelegatedAdminAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableDelegatedAdminAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableDelegatedAdminAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEnableDelegatedAdminAccountResolveEndpointMiddleware{
