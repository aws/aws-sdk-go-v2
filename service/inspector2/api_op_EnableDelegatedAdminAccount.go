...
func (c *Client) addOperationEnableDelegatedAdminAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EnableDelegatedAdminAccount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
