...
func (c *Client) ListCoverage(ctx context.Context, params *ListCoverageInput, optFns ...func(*Options)) (*ListCoverageOutput, error) {
	if params == nil { params = &ListCoverageInput{} }
...
func (c *Client) addOperationListCoverageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCoverageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCoverageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCoverageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCoverageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCoverageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCoverageResolveEndpointMiddleware{
