...
func (c *Client) addOperationListCisScanResultsAggregatedByChecksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCisScanResultsAggregatedByChecks", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
