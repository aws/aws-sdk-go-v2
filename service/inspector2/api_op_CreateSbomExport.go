...
func (c *Client) CreateSbomExport(ctx context.Context, params *CreateSbomExportInput, optFns ...func(*Options)) (*CreateSbomExportOutput, error) {
	if params == nil { params = &CreateSbomExportInput{} }
...
func (c *Client) addOperationCreateSbomExportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateSbomExportResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateSbomExportResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateSbomExportResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateSbomExportResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateSbomExportResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateSbomExportResolveEndpointMiddleware{
