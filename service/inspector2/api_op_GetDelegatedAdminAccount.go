...
func (c *Client) GetDelegatedAdminAccount(ctx context.Context, params *GetDelegatedAdminAccountInput, optFns ...func(*Options)) (*GetDelegatedAdminAccountOutput, error) {
	if params == nil { params = &GetDelegatedAdminAccountInput{} }
...
func (c *Client) addOperationGetDelegatedAdminAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDelegatedAdminAccountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDelegatedAdminAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDelegatedAdminAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDelegatedAdminAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDelegatedAdminAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDelegatedAdminAccountResolveEndpointMiddleware{
