...
func (c *Client) addOperationCreateCisScanConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateCisScanConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
