...
func (c *Client) addOperationListCodeSecurityScanConfigurationAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCodeSecurityScanConfigurationAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
