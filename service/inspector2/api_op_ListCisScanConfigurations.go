...
func (c *Client) addOperationListCisScanConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCisScanConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
