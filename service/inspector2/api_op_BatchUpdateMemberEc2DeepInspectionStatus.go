...
func (c *Client) BatchUpdateMemberEc2DeepInspectionStatus(ctx context.Context, params *BatchUpdateMemberEc2DeepInspectionStatusInput, optFns ...func(*Options)) (*BatchUpdateMemberEc2DeepInspectionStatusOutput, error) {
	if params == nil { params = &BatchUpdateMemberEc2DeepInspectionStatusInput{} }
...
func (c *Client) addOperationBatchUpdateMemberEc2DeepInspectionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchUpdateMemberEc2DeepInspectionStatusResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchUpdateMemberEc2DeepInspectionStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchUpdateMemberEc2DeepInspectionStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchUpdateMemberEc2DeepInspectionStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchUpdateMemberEc2DeepInspectionStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchUpdateMemberEc2DeepInspectionStatusResolveEndpointMiddleware{
