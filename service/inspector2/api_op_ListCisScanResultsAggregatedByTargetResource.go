...
func (c *Client) addOperationListCisScanResultsAggregatedByTargetResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCisScanResultsAggregatedByTargetResource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
