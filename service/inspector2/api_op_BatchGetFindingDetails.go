...
func (c *Client) BatchGetFindingDetails(ctx context.Context, params *BatchGetFindingDetailsInput, optFns ...func(*Options)) (*BatchGetFindingDetailsOutput, error) {
	if params == nil { params = &BatchGetFindingDetailsInput{} }
...
func (c *Client) addOperationBatchGetFindingDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchGetFindingDetailsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchGetFindingDetailsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchGetFindingDetailsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchGetFindingDetailsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchGetFindingDetailsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchGetFindingDetailsResolveEndpointMiddleware{
