...
func (c *Client) addOperationUpdateCodeSecurityIntegrationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCodeSecurityIntegration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
