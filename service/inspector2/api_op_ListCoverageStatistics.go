...
func (c *Client) ListCoverageStatistics(ctx context.Context, params *ListCoverageStatisticsInput, optFns ...func(*Options)) (*ListCoverageStatisticsOutput, error) {
	if params == nil { params = &ListCoverageStatisticsInput{} }
...
func (c *Client) addOperationListCoverageStatisticsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCoverageStatisticsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCoverageStatisticsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCoverageStatisticsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCoverageStatisticsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCoverageStatisticsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCoverageStatisticsResolveEndpointMiddleware{
