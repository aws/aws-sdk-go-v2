...
func (c *Client) addOperationListFindingAggregationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListFindingAggregations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
