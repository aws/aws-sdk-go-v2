...
func (c *Client) CancelFindingsReport(ctx context.Context, params *CancelFindingsReportInput, optFns ...func(*Options)) (*CancelFindingsReportOutput, error) {
	if params == nil { params = &CancelFindingsReportInput{} }
...
func (c *Client) addOperationCancelFindingsReportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelFindingsReportResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelFindingsReportResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelFindingsReportResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelFindingsReportResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelFindingsReportResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelFindingsReportResolveEndpointMiddleware{
