...
func (c *Client) BatchGetCodeSnippet(ctx context.Context, params *BatchGetCodeSnippetInput, optFns ...func(*Options)) (*BatchGetCodeSnippetOutput, error) {
	if params == nil { params = &BatchGetCodeSnippetInput{} }
...
func (c *Client) addOperationBatchGetCodeSnippetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchGetCodeSnippetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchGetCodeSnippetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchGetCodeSnippetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchGetCodeSnippetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchGetCodeSnippetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchGetCodeSnippetResolveEndpointMiddleware{
