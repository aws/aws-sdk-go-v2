...
func (c *Client) DisableDelegatedAdminAccount(ctx context.Context, params *DisableDelegatedAdminAccountInput, optFns ...func(*Options)) (*DisableDelegatedAdminAccountOutput, error) {
	if params == nil { params = &DisableDelegatedAdminAccountInput{} }
...
func (c *Client) addOperationDisableDelegatedAdminAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableDelegatedAdminAccountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisableDelegatedAdminAccountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisableDelegatedAdminAccountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableDelegatedAdminAccountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableDelegatedAdminAccountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisableDelegatedAdminAccountResolveEndpointMiddleware{
