...
func (c *Client) CancelSbomExport(ctx context.Context, params *CancelSbomExportInput, optFns ...func(*Options)) (*CancelSbomExportOutput, error) {
	if params == nil { params = &CancelSbomExportInput{} }
...
func (c *Client) addOperationCancelSbomExportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCancelSbomExportResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCancelSbomExportResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCancelSbomExportResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCancelSbomExportResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCancelSbomExportResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCancelSbomExportResolveEndpointMiddleware{
