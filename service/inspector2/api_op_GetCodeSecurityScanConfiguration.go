...
func (c *Client) addOperationGetCodeSecurityScanConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCodeSecurityScanConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
