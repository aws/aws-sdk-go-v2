...
func (c *Client) addOperationListDelegatedAdminAccountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDelegatedAdminAccounts", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
