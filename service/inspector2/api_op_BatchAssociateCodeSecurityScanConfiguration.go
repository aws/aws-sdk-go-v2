...
func (c *Client) addOperationBatchAssociateCodeSecurityScanConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchAssociateCodeSecurityScanConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
