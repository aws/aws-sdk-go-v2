...
func (c *Client) GetSbomExport(ctx context.Context, params *GetSbomExportInput, optFns ...func(*Options)) (*GetSbomExportOutput, error) {
	if params == nil { params = &GetSbomExportInput{} }
...
func (c *Client) addOperationGetSbomExportMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSbomExportResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSbomExportResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSbomExportResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSbomExportResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSbomExportResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSbomExportResolveEndpointMiddleware{
