...
// (https://docs.aws.amazon.com/AmazonMemoryDB/latest/devguide/IAM.ResourceLevelPermissions.html).
...
// (https://docs.aws.amazon.com/AmazonMemoryDB/latest/devguide/Tagging.html).
