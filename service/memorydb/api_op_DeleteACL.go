...
func (c *Client) DeleteACL(ctx context.Context, params *DeleteACLInput, optFns ...func(*Options)) (*DeleteACLOutput, error) {
	if params == nil { params = &DeleteACLInput{} }
...
func (c *Client) addOperationDeleteACLMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteACLResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteACLResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteACLResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteACLResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteACLResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteACLResolveEndpointMiddleware{
