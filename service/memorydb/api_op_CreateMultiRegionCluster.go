...
func (c *Client) addOperationCreateMultiRegionClusterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMultiRegionCluster", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
