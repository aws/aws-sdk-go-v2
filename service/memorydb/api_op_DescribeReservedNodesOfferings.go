...
func (*DescribeReservedNodesOfferingsInput) operationName() string {
...
func (c *Client) addOperationDescribeReservedNodesOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeReservedNodesOfferingsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeReservedNodesOfferingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeReservedNodesOfferingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeReservedNodesOfferingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeReservedNodesOfferingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeReservedNodesOfferingsResolveEndpointMiddleware{
