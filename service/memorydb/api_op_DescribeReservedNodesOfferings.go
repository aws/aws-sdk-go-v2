...
func (c *Client) addOperationDescribeReservedNodesOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReservedNodesOfferings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
