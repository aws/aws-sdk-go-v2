...
func (c *Client) addOperationUpdateMultiRegionClusterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateMultiRegionCluster", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
