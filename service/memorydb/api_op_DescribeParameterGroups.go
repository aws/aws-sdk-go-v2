...
func (c *Client) addOperationDescribeParameterGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeParameterGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
