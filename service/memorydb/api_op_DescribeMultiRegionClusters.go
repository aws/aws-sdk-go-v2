...
func (c *Client) addOperationDescribeMultiRegionClustersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeMultiRegionClusters", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
