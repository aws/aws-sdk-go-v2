...
func (c *Client) CreateACL(ctx context.Context, params *CreateACLInput, optFns ...func(*Options)) (*CreateACLOutput, error) {
	if params == nil { params = &CreateACLInput{} }
...
func (c *Client) addOperationCreateACLMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateACLResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCreateACLResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCreateACLResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateACLResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateACLResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCreateACLResolveEndpointMiddleware{
