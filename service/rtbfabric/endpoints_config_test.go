...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-rtbfabric.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rtbfabric.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rtbfabric.dev",
			expectURL:     aws.String("https://env-rtbfabric.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-rtbfabric.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rtbfabric.dev",
			expectURL:     aws.String("http://config-rtbfabric.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-rtbfabric.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-rtbfabric.dev",
			clientEndpoint: aws.String("https://client-rtbfabric.dev"),
			expectURL:      aws.String("https://client-rtbfabric.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_RTBFABRIC", c.envService)
			}
