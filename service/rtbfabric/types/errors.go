...
// The request could not be completed because of a conflict in the current state
// of the resource.
...
// The request could not be completed because of an internal server error. Try
// your call again.
