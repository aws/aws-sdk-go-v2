...
// QLDB Session. See this package's package overview docs
...
const (
	ServiceName = "QLDB Session" // Service's name
	ServiceID   = "QLDBSession"  // Service's identifier
	EndpointsID = "session.qldb" // Service's Endpoint identifier
)
