...
// StartTranscriptionJobrequest, you must first upload your media file into an
...
type StartTranscriptionJobInput struct {
	...
	// OutputKeyparameter. This name is case sensitive, cannot contain spaces, and
	...
	// include more than one of these parameters, your transcription job fails. For a
	...
	// value detected, your job fails. In most cases, you can omit
	...
	// your output to go to a sub-folder of this bucket, specify it using the
	...
	// your transcription job ( TranscriptionJobName). Here are some examples of how
	// you can use OutputKey :
	...
	// but do not want to use automatic language identification, use Settings with
	// the VocabularyName  or VocabularyFilterName (or both) sub-parameter. If you're
