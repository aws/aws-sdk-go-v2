...
func (c *Client) ListVocabularyFilters(ctx context.Context, params *ListVocabularyFiltersInput, optFns ...func(*Options)) (*ListVocabularyFiltersOutput, error) {
	if params == nil { params = &ListVocabularyFiltersInput{} }
...
func (c *Client) addOperationListVocabularyFiltersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListVocabularyFiltersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListVocabularyFiltersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListVocabularyFiltersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListVocabularyFiltersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListVocabularyFiltersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListVocabularyFiltersResolveEndpointMiddleware{
