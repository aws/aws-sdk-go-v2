...
func (*DeleteMedicalTranscriptionJobInput) operationName() string {
...
func (c *Client) addOperationDeleteMedicalTranscriptionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteMedicalTranscriptionJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteMedicalTranscriptionJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteMedicalTranscriptionJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteMedicalTranscriptionJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteMedicalTranscriptionJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteMedicalTranscriptionJobResolveEndpointMiddleware{
