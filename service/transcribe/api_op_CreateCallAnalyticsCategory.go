...
// Creates a new Call Analytics category. All categories are automatically
// applied to your Call Analytics transcriptions. Note that in order to apply
// categories to your transcriptions, you must create them before submitting your
// transcription request, as categories cannot be applied retroactively. When
// creating a new category, you can use the InputType parameter to label the
...
// category is created as a POST_CALL category by default. Call Analytics
// categories are composed of rules. For each category, you must create between 1
// and 20 rules. Rules can include these parameters: , , , and . To update an
// existing category, see . To learn more about Call Analytics categories, see
