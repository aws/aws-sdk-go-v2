...
func (c *Client) addOperationListMedicalVocabulariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMedicalVocabularies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
