...
// the file using the Media parameter. Note that job queuing is enabled by
// default for Call Analytics jobs. You must include the following parameters in
...
type StartCallAnalyticsJobInput struct {
	...
	// encryption. If you don't specify OutputLocation, your transcript is placed in
