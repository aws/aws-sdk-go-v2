...
func addOperationStartMedicalTranscriptionJobStackSlots(stack *middleware.Stack) error {
...
func addOperationStartMedicalTranscriptionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStartMedicalTranscriptionJobStackSlots(stack); err != nil {
		return err
	}
