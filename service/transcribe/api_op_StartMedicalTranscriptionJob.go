...
func (c *Client) addOperationStartMedicalTranscriptionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartMedicalTranscriptionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
