...
func (c *Client) addOperationGetCallAnalyticsCategoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCallAnalyticsCategory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
