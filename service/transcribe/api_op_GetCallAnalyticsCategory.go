...
func (c *Client) GetCallAnalyticsCategory(ctx context.Context, params *GetCallAnalyticsCategoryInput, optFns ...func(*Options)) (*GetCallAnalyticsCategoryOutput, error) {
	if params == nil { params = &GetCallAnalyticsCategoryInput{} }
...
func (c *Client) addOperationGetCallAnalyticsCategoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCallAnalyticsCategoryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCallAnalyticsCategoryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCallAnalyticsCategoryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCallAnalyticsCategoryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCallAnalyticsCategoryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCallAnalyticsCategoryResolveEndpointMiddleware{
