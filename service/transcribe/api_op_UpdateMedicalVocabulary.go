...
func (c *Client) addOperationUpdateMedicalVocabularyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateMedicalVocabulary", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
