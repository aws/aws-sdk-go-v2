...
func (c *Client) addOperationListCallAnalyticsCategoriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCallAnalyticsCategories", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
