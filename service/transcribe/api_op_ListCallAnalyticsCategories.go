...
func (c *Client) addOperationListCallAnalyticsCategoriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCallAnalyticsCategoriesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListCallAnalyticsCategoriesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListCallAnalyticsCategoriesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCallAnalyticsCategoriesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCallAnalyticsCategoriesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListCallAnalyticsCategoriesResolveEndpointMiddleware{
