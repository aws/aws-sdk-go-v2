...
func (c *Client) addOperationUpdateCallAnalyticsCategoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateCallAnalyticsCategory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
