...
func (c *Client) ListVocabularies(ctx context.Context, params *ListVocabulariesInput, optFns ...func(*Options)) (*ListVocabulariesOutput, error) {
	stack := middleware.NewStack("ListVocabularies", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsAwsjson11_serdeOpListVocabulariesMiddlewares(stack)
...
func addawsAwsjson11_serdeOpListVocabulariesMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpListVocabularies{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpListVocabularies{}, middleware.After)
}
