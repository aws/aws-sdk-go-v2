...
func (c *Client) ListVocabularies(ctx context.Context, params *ListVocabulariesInput, optFns ...func(*Options)) (*ListVocabulariesOutput, error) {
	if params == nil { params = &ListVocabulariesInput{} }
...
func (c *Client) addOperationListVocabulariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListVocabulariesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListVocabulariesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListVocabulariesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListVocabulariesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListVocabulariesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListVocabulariesResolveEndpointMiddleware{
