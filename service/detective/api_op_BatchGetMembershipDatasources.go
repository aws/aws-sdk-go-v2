...
func (c *Client) BatchGetMembershipDatasources(ctx context.Context, params *BatchGetMembershipDatasourcesInput, optFns ...func(*Options)) (*BatchGetMembershipDatasourcesOutput, error) {
	if params == nil { params = &BatchGetMembershipDatasourcesInput{} }
...
func (c *Client) addOperationBatchGetMembershipDatasourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchGetMembershipDatasourcesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchGetMembershipDatasourcesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchGetMembershipDatasourcesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchGetMembershipDatasourcesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchGetMembershipDatasourcesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchGetMembershipDatasourcesResolveEndpointMiddleware{
