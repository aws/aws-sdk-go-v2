...
func (c *Client) addOperationUpdateInvestigationStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateInvestigationState", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
