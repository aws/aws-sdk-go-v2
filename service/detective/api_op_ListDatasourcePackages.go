...
func (c *Client) ListDatasourcePackages(ctx context.Context, params *ListDatasourcePackagesInput, optFns ...func(*Options)) (*ListDatasourcePackagesOutput, error) {
	if params == nil { params = &ListDatasourcePackagesInput{} }
...
func (c *Client) addOperationListDatasourcePackagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDatasourcePackagesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDatasourcePackagesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDatasourcePackagesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDatasourcePackagesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDatasourcePackagesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDatasourcePackagesResolveEndpointMiddleware{
