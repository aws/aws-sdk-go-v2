...
func (c *Client) addOperationBatchGetGraphMemberDatasourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetGraphMemberDatasources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
