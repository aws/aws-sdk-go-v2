...
func (c *Client) BatchGetGraphMemberDatasources(ctx context.Context, params *BatchGetGraphMemberDatasourcesInput, optFns ...func(*Options)) (*BatchGetGraphMemberDatasourcesOutput, error) {
	if params == nil { params = &BatchGetGraphMemberDatasourcesInput{} }
...
func (c *Client) addOperationBatchGetGraphMemberDatasourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchGetGraphMemberDatasourcesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opBatchGetGraphMemberDatasourcesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opBatchGetGraphMemberDatasourcesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchGetGraphMemberDatasourcesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchGetGraphMemberDatasourcesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opBatchGetGraphMemberDatasourcesResolveEndpointMiddleware{
