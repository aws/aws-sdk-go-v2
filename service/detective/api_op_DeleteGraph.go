...
func (c *Client) DeleteGraph(ctx context.Context, params *DeleteGraphInput, optFns ...func(*Options)) (*DeleteGraphOutput, error) {
	stack := middleware.NewStack("DeleteGraph", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestjson1_serdeOpDeleteGraphMiddlewares(stack)
...
func addawsRestjson1_serdeOpDeleteGraphMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpDeleteGraph{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpDeleteGraph{}, middleware.After)
}
