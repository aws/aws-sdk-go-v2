...
func (c *Client) StartChannel(ctx context.Context, params *StartChannelInput, optFns ...func(*Options)) (*StartChannelOutput, error) {
	if params == nil { params = &StartChannelInput{} }
...
func (c *Client) addOperationStartChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartChannelResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartChannelResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartChannelResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartChannelResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartChannelResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartChannelResolveEndpointMiddleware{
