...
var bddNodes = [42]int32{
	-1, 1, -1, 0, 13, 3, 1, 4, 100000012, 2, 5, 100000012, 3, 9, 6, 5, 7, 100000011, 6, 100000004, 8, 7, 100000009, 100000010, 4, 11, 10, 5, 100000006, 100000008, 5, 12, 100000007, 7, 100000005, 100000006, 3, 100000001, 14, 5, 100000002, 100000003}
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 4:
		uriString := func() string {
			...
			out.WriteString("https://mediatailor.")
