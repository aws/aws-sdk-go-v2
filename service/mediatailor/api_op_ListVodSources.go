...
type ListVodSourcesInput struct {
	...
	//
	// For the first ListVodSources request, omit this value. For subsequent requests,
...
func (c *Client) addOperationListVodSourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListVodSources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
