...
// (https://docs.aws.amazon.com/mediatailor/latest/ug/). Through the SDKs and the
// CLI you manage AWS Elemental MediaTailor configurations and channels the same as
