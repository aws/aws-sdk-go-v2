...
func addOperationDeletePlaybackConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeletePlaybackConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeletePlaybackConfigurationStackSlots(stack); err != nil {
		return err
	}
