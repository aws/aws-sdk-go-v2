...
func (c *Client) addOperationDeletePlaybackConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeletePlaybackConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
