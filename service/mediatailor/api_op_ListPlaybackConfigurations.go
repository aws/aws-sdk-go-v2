...
func addOperationListPlaybackConfigurationsStackSlots(stack *middleware.Stack) error {
...
func addOperationListPlaybackConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListPlaybackConfigurationsStackSlots(stack); err != nil {
		return err
	}
