...
func (c *Client) addOperationListPlaybackConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPlaybackConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
