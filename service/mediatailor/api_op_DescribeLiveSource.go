...
func (c *Client) DescribeLiveSource(ctx context.Context, params *DescribeLiveSourceInput, optFns ...func(*Options)) (*DescribeLiveSourceOutput, error) {
	if params == nil { params = &DescribeLiveSourceInput{} }
...
func (c *Client) addOperationDescribeLiveSourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeLiveSourceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeLiveSourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeLiveSourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeLiveSourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeLiveSourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeLiveSourceResolveEndpointMiddleware{
