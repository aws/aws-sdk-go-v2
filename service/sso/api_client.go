...
// SSO. See this package's package overview docs
...
const (
	ServiceName = "SSO"        // Service's name
	ServiceID   = "SSO"        // Service's identifier
	EndpointsID = "portal.sso" // Service's Endpoint identifier
)
