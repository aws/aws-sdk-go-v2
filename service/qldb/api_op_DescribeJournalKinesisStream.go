...
func addOperationDescribeJournalKinesisStreamStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeJournalKinesisStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeJournalKinesisStreamStackSlots(stack); err != nil {
		return err
	}
