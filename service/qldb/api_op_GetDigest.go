...
func (c *Client) GetDigest(ctx context.Context, params *GetDigestInput, optFns ...func(*Options)) (*GetDigestOutput, error) {
	if params == nil { params = &GetDigestInput{} }
...
func (c *Client) addOperationGetDigestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDigestResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDigestResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDigestResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDigestResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDigestResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDigestResolveEndpointMiddleware{
