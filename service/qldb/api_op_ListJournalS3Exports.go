...
func (c *Client) ListJournalS3Exports(ctx context.Context, params *ListJournalS3ExportsInput, optFns ...func(*Options)) (*ListJournalS3ExportsOutput, error) {
	if params == nil { params = &ListJournalS3ExportsInput{} }
...
func (c *Client) addOperationListJournalS3ExportsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListJournalS3ExportsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListJournalS3ExportsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListJournalS3ExportsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListJournalS3ExportsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListJournalS3ExportsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListJournalS3ExportsResolveEndpointMiddleware{
