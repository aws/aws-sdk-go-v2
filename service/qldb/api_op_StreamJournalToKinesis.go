...
type StreamJournalToKinesisInput struct {
	...
	// names can help identify and indicate the purpose of a stream. Your stream name
	// must be unique among other active streams for a given ledger. Stream names have
