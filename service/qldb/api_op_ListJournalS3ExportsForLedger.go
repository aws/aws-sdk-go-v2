...
func addOperationListJournalS3ExportsForLedgerStackSlots(stack *middleware.Stack) error {
...
func addOperationListJournalS3ExportsForLedgerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListJournalS3ExportsForLedgerStackSlots(stack); err != nil {
		return err
	}
