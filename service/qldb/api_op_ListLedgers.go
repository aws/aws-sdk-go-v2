...
func (c *Client) ListLedgers(ctx context.Context, params *ListLedgersInput, optFns ...func(*Options)) (*ListLedgersOutput, error) {
	if params == nil { params = &ListLedgersInput{} }
...
func (c *Client) addOperationListLedgersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLedgersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListLedgersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListLedgersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLedgersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLedgersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListLedgersResolveEndpointMiddleware{
