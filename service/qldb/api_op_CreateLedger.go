...
type CreateLedgerInput struct {
	...
	// and PartiQL actions, in addition to the SendCommand API permission for the
	// ledger. For information, see Getting started with the standard permissions mode
	...
	// - Undefined: By default, use an Amazon Web
