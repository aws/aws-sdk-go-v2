...
func (c *Client) ListTerminologies(ctx context.Context, params *ListTerminologiesInput, optFns ...func(*Options)) (*ListTerminologiesOutput, error) {
	if params == nil { params = &ListTerminologiesInput{} }
...
func (c *Client) addOperationListTerminologiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTerminologiesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTerminologiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTerminologiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTerminologiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTerminologiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTerminologiesResolveEndpointMiddleware{
