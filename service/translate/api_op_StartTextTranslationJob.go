...
func (c *Client) addOperationStartTextTranslationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartTextTranslationJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
