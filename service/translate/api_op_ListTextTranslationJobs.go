...
func (c *Client) addOperationListTextTranslationJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTextTranslationJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
