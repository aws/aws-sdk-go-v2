...
func (c *Client) ListLanguages(ctx context.Context, params *ListLanguagesInput, optFns ...func(*Options)) (*ListLanguagesOutput, error) {
	if params == nil { params = &ListLanguagesInput{} }
...
func (c *Client) addOperationListLanguagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListLanguagesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListLanguagesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListLanguagesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListLanguagesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListLanguagesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListLanguagesResolveEndpointMiddleware{
