...
// Lists the tags that are assigned to an Amazon Cognito identity pool. A tag is
// a label that you can apply to identity pools to categorize and manage them in
