...
func (c *Client) addOperationSetPrincipalTagAttributeMapMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SetPrincipalTagAttributeMap", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
