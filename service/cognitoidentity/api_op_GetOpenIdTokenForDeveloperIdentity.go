...
func addOperationGetOpenIdTokenForDeveloperIdentityStackSlots(stack *middleware.Stack) error {
...
func addOperationGetOpenIdTokenForDeveloperIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetOpenIdTokenForDeveloperIdentityStackSlots(stack); err != nil {
		return err
	}
