...
func (c *Client) addOperationGetPrincipalTagAttributeMapMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPrincipalTagAttributeMap", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
