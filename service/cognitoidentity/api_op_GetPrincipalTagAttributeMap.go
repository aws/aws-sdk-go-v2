...
func (c *Client) GetPrincipalTagAttributeMap(ctx context.Context, params *GetPrincipalTagAttributeMapInput, optFns ...func(*Options)) (*GetPrincipalTagAttributeMapOutput, error) {
	if params == nil { params = &GetPrincipalTagAttributeMapInput{} }
...
func (c *Client) addOperationGetPrincipalTagAttributeMapMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetPrincipalTagAttributeMapResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetPrincipalTagAttributeMapResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetPrincipalTagAttributeMapResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetPrincipalTagAttributeMapResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetPrincipalTagAttributeMapResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetPrincipalTagAttributeMapResolveEndpointMiddleware{
