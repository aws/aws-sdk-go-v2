...
func (*UpdateIdentityPoolInput) operationName() string {
...
func (c *Client) addOperationUpdateIdentityPoolMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateIdentityPoolResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateIdentityPoolResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateIdentityPoolResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateIdentityPoolResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateIdentityPoolResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateIdentityPoolResolveEndpointMiddleware{
