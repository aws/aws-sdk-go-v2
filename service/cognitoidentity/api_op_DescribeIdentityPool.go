...
func (c *Client) DescribeIdentityPool(ctx context.Context, params *DescribeIdentityPoolInput, optFns ...func(*Options)) (*DescribeIdentityPoolOutput, error) {
	if params == nil { params = &DescribeIdentityPoolInput{} }
...
func (c *Client) addOperationDescribeIdentityPoolMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeIdentityPoolResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDescribeIdentityPoolResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDescribeIdentityPoolResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeIdentityPoolResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeIdentityPoolResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDescribeIdentityPoolResolveEndpointMiddleware{
