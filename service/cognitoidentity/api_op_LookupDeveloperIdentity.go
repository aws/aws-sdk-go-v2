...
func (c *Client) addOperationLookupDeveloperIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "LookupDeveloperIdentity", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
