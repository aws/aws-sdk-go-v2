...
func (c *Client) addOperationMergeDeveloperIdentitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "MergeDeveloperIdentities", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
