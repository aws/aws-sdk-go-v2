...
func (c *Client) ListImportFailures(ctx context.Context, params *ListImportFailuresInput, optFns ...func(*Options)) (*ListImportFailuresOutput, error) {
	if params == nil { params = &ListImportFailuresInput{} }
...
func (c *Client) addOperationListImportFailuresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListImportFailuresResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListImportFailuresResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListImportFailuresResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListImportFailuresResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListImportFailuresResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListImportFailuresResolveEndpointMiddleware{
