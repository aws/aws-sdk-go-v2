...
func (c *Client) ListEventDataStores(ctx context.Context, params *ListEventDataStoresInput, optFns ...func(*Options)) (*ListEventDataStoresOutput, error) {
	if params == nil { params = &ListEventDataStoresInput{} }
...
func (c *Client) addOperationListEventDataStoresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListEventDataStoresResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListEventDataStoresResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListEventDataStoresResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListEventDataStoresResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListEventDataStoresResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListEventDataStoresResolveEndpointMiddleware{
