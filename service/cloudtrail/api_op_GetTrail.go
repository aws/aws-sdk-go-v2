...
func (c *Client) GetTrail(ctx context.Context, params *GetTrailInput, optFns ...func(*Options)) (*GetTrailOutput, error) {
	if params == nil { params = &GetTrailInput{} }
...
func (c *Client) addOperationGetTrailMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTrailResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetTrailResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetTrailResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTrailResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTrailResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetTrailResolveEndpointMiddleware{
