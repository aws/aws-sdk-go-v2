...
func (v *UpdateTrailInput) SerializeMembers(s smithy.ShapeSerializer) {
	...
	if v.RecursiveLogging != nil {
		s.WriteBool(schemas.UpdateTrailRequest_RecursiveLogging, *v.RecursiveLogging)
	}
...
func (v *UpdateTrailOutput) SerializeMembers(s smithy.ShapeSerializer) {
	...
	if v.RecursiveLogging != nil {
		s.WriteBool(schemas.UpdateTrailResponse_RecursiveLogging, *v.RecursiveLogging)
	}
	if v.S3BucketName != nil {
...
func (v *UpdateTrailOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.UpdateTrailResponse, func(s *smithy.Schema) error {
		...
		case schemas.UpdateTrailResponse_RecursiveLogging:
			v.RecursiveLogging = new(bool)
			return d.ReadBool(schemas.UpdateTrailResponse_RecursiveLogging, v.RecursiveLogging)
