...
func (c *Client) RegisterOrganizationDelegatedAdmin(ctx context.Context, params *RegisterOrganizationDelegatedAdminInput, optFns ...func(*Options)) (*RegisterOrganizationDelegatedAdminOutput, error) {
	if params == nil { params = &RegisterOrganizationDelegatedAdminInput{} }
...
func (c *Client) addOperationRegisterOrganizationDelegatedAdminMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRegisterOrganizationDelegatedAdminResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRegisterOrganizationDelegatedAdminResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRegisterOrganizationDelegatedAdminResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRegisterOrganizationDelegatedAdminResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRegisterOrganizationDelegatedAdminResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRegisterOrganizationDelegatedAdminResolveEndpointMiddleware{
