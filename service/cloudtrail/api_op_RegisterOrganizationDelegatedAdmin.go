...
func (c *Client) addOperationRegisterOrganizationDelegatedAdminMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterOrganizationDelegatedAdmin", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
