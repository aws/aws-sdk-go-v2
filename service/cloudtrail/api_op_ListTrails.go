...
func (c *Client) ListTrails(ctx context.Context, params *ListTrailsInput, optFns ...func(*Options)) (*ListTrailsOutput, error) {
	if params == nil { params = &ListTrailsInput{} }
...
func (c *Client) addOperationListTrailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTrailsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTrailsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTrailsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTrailsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTrailsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTrailsResolveEndpointMiddleware{
