...
func (c *Client) addOperationStopEventDataStoreIngestionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopEventDataStoreIngestion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
