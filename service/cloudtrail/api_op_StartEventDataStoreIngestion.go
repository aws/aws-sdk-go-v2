...
func (c *Client) addOperationStartEventDataStoreIngestionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartEventDataStoreIngestion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
