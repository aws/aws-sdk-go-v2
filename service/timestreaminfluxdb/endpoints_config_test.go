...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-timestream-influxdb.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-timestream-influxdb.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-timestream-influxdb.dev",
			expectURL:     aws.String("https://env-timestream-influxdb.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-timestream-influxdb.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-timestream-influxdb.dev",
			expectURL:     aws.String("http://config-timestream-influxdb.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-timestream-influxdb.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-timestream-influxdb.dev",
			clientEndpoint: aws.String("https://client-timestream-influxdb.dev"),
			expectURL:      aws.String("https://client-timestream-influxdb.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_TIMESTREAM_INFLUXDB", c.envService)
			}
