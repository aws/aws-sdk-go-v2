...
func (c *Client) addOperationBatchGetCollectionGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetCollectionGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
