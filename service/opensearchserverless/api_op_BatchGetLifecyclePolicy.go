...
func (c *Client) addOperationBatchGetLifecyclePolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetLifecyclePolicy", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
