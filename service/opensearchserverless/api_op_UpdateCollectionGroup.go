...
func (c *Client) UpdateCollectionGroup(ctx context.Context, params *UpdateCollectionGroupInput, optFns ...func(*Options)) (*UpdateCollectionGroupOutput, error) {
	if params == nil { params = &UpdateCollectionGroupInput{} }
...
func (m *idempotencyToken_initializeOpUpdateCollectionGroup) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *UpdateCollectionGroupInput ")}
