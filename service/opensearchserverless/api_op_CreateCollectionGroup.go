...
func (c *Client) CreateCollectionGroup(ctx context.Context, params *CreateCollectionGroupInput, optFns ...func(*Options)) (*CreateCollectionGroupOutput, error) {
	if params == nil { params = &CreateCollectionGroupInput{} }
...
func (m *idempotencyToken_initializeOpCreateCollectionGroup) HandleInitialize(ctx context.Context, in middleware.InitializeInput, next middleware.InitializeHandler) (
	...
	if !ok { return out, metadata, fmt.Errorf("expected middleware input to be of type *CreateCollectionGroupInput ")}
