...
// Package opensearchserverless provides the API client, operations, and
// parameter types for OpenSearch Service Serverless.
//
...
// is an on-demand, pre-provisioned serverless configuration for Amazon OpenSearch
// Service. OpenSearch Serverless removes the operational complexities of
