...
func (c *Client) addOperationStopTelemetryEnrichmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopTelemetryEnrichment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
