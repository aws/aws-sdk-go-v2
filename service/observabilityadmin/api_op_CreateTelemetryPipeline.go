...
func (c *Client) addOperationCreateTelemetryPipelineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateTelemetryPipeline", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
