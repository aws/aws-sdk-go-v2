...
func (c *Client) addOperationUpdateTelemetryPipelineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateTelemetryPipeline", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
