...
func (c *Client) addOperationStartTelemetryEnrichmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartTelemetryEnrichment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
