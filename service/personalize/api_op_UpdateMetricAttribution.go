...
func (c *Client) addOperationUpdateMetricAttributionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateMetricAttribution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
