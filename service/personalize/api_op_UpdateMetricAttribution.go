...
func (*UpdateMetricAttributionInput) operationName() string {
...
func (c *Client) addOperationUpdateMetricAttributionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateMetricAttributionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateMetricAttributionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateMetricAttributionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateMetricAttributionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateMetricAttributionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateMetricAttributionResolveEndpointMiddleware{
