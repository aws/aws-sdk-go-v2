...
func (c *Client) addOperationStartRecommenderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartRecommenderResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStartRecommenderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStartRecommenderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartRecommenderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartRecommenderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStartRecommenderResolveEndpointMiddleware{
