...
func (c *Client) ListSchemas(ctx context.Context, params *ListSchemasInput, optFns ...func(*Options)) (*ListSchemasOutput, error) {
	...
	addawsAwsjson11_serdeOpListSchemasMiddlewares(stack)
...
func addawsAwsjson11_serdeOpListSchemasMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson11_serializeOpListSchemas{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson11_deserializeOpListSchemas{}, middleware.After)
}
