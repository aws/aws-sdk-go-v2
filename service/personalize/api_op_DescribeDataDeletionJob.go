...
func (c *Client) addOperationDescribeDataDeletionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDataDeletionJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
