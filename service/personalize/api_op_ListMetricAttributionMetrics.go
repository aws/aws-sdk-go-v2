...
func (c *Client) addOperationListMetricAttributionMetricsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMetricAttributionMetrics", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
