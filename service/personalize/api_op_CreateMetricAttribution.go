...
func (c *Client) addOperationCreateMetricAttributionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMetricAttribution", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
