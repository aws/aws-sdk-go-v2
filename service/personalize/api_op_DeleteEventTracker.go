...
func (*DeleteEventTrackerInput) operationName() string {
...
func (c *Client) addOperationDeleteEventTrackerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteEventTrackerResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteEventTrackerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteEventTrackerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteEventTrackerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteEventTrackerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteEventTrackerResolveEndpointMiddleware{
