...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/personalize/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalepconfig.ResolveServiceBaseEndpoint(context.Background(), "Personalize", cfg.ConfigSources)
	if found && err == nil {
