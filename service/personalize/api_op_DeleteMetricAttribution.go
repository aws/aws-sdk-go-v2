...
func (*DeleteMetricAttributionInput) operationName() string {
...
func (c *Client) addOperationDeleteMetricAttributionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteMetricAttributionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteMetricAttributionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteMetricAttributionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteMetricAttributionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteMetricAttributionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteMetricAttributionResolveEndpointMiddleware{
