...
func (c *Client) addOperationDescribeBatchSegmentJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeBatchSegmentJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
