...
func (c *Client) StopRecommender(ctx context.Context, params *StopRecommenderInput, optFns ...func(*Options)) (*StopRecommenderOutput, error) {
	if params == nil { params = &StopRecommenderInput{} }
...
func (c *Client) addOperationStopRecommenderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopRecommenderResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopRecommenderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopRecommenderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopRecommenderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopRecommenderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopRecommenderResolveEndpointMiddleware{
