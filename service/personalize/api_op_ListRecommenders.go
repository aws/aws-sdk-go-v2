...
func (c *Client) addOperationListRecommendersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRecommendersResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListRecommendersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListRecommendersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRecommendersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRecommendersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListRecommendersResolveEndpointMiddleware{
