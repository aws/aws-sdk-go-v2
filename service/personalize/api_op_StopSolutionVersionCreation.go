...
func (c *Client) StopSolutionVersionCreation(ctx context.Context, params *StopSolutionVersionCreationInput, optFns ...func(*Options)) (*StopSolutionVersionCreationOutput, error) {
	if params == nil { params = &StopSolutionVersionCreationInput{} }
...
func (c *Client) addOperationStopSolutionVersionCreationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopSolutionVersionCreationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopSolutionVersionCreationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopSolutionVersionCreationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopSolutionVersionCreationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopSolutionVersionCreationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopSolutionVersionCreationResolveEndpointMiddleware{
