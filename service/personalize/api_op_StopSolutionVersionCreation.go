...
func (c *Client) addOperationStopSolutionVersionCreationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StopSolutionVersionCreation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
