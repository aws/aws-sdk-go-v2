...
func (c *Client) addOperationGetPlanEvaluationStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPlanEvaluationStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
