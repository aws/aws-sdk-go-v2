...
func (c *Client) addOperationApprovePlanExecutionStepMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ApprovePlanExecutionStep", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
