...
var bddNodes = [30]int32{
	-1, 1, -1, 0, 10, 3, 1, 4, 100000009, 2, 5, 100000009, 3, 8, 6, 4, 7, 100000008, 5, 100000001, 100000004, 4, 9, 100000007, 5, 100000002, 100000003, 3, 100000005, 100000006}
...
func evalCondition(idx int, params *EndpointParameters, c *conditionContext) bool {
	...
	case 4:
		return func() bool {
			if v := params.UseControlPlaneEndpoint; v != nil {
				return *v
			}
			return false
		}() == true
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 2:
		return smithyendpoints.Endpoint{}, fmt.Errorf("endpoint rule error, %s", "Invalid Configuration: FIPS is not supported in this partition")
	case 3:
		uriString := func() string {
			var out strings.Builder
