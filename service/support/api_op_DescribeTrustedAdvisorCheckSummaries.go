...
func (c *Client) addOperationDescribeTrustedAdvisorCheckSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeTrustedAdvisorCheckSummaries", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
