...
func addOperationDescribeTrustedAdvisorCheckSummariesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeTrustedAdvisorCheckSummariesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeTrustedAdvisorCheckSummariesStackSlots(stack); err != nil {
		return err
	}
