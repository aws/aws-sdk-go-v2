...
//
// AddCommunicationToCaseoperation to add additional communication or attachments
// to an existing case. The caseId  is separate from the displayId that appears
// in the Amazon Web Services Support Center (https://console.aws.amazon.com/support)
...
type CreateCaseInput struct {
	...
	// values for severityCode . For more information, see SeverityLevel  and
