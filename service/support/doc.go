...
//
// You can also use the Amazon Web
// Services Support API to access features for Trusted Advisor
// (http://aws.amazon.com/premiumsupport/trustedadvisor/). You can return a list of
...
// (https://docs.aws.amazon.com/) in the Amazon Web Services Support User Guide.
...
// more information about this service and the endpoints to use, see About the
// Amazon Web Services Support API
// (https://docs.aws.amazon.com/awssupport/latest/user/about-support-api.html) in
