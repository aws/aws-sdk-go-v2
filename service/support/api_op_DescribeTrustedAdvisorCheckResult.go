...
func (c *Client) addOperationDescribeTrustedAdvisorCheckResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeTrustedAdvisorCheckResult", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
