...
func addOperationDescribeTrustedAdvisorCheckResultStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeTrustedAdvisorCheckResultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeTrustedAdvisorCheckResultStackSlots(stack); err != nil {
		return err
	}
