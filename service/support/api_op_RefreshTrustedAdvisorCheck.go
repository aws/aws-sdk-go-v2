...
func addOperationRefreshTrustedAdvisorCheckStackSlots(stack *middleware.Stack) error {
...
func addOperationRefreshTrustedAdvisorCheckMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRefreshTrustedAdvisorCheckStackSlots(stack); err != nil {
		return err
	}
