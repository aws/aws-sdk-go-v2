...
func (c *Client) RefreshTrustedAdvisorCheck(ctx context.Context, params *RefreshTrustedAdvisorCheckInput, optFns ...func(*Options)) (*RefreshTrustedAdvisorCheckOutput, error) {
	if params == nil { params = &RefreshTrustedAdvisorCheckInput{} }
...
func (c *Client) addOperationRefreshTrustedAdvisorCheckMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRefreshTrustedAdvisorCheckResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRefreshTrustedAdvisorCheckResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRefreshTrustedAdvisorCheckResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRefreshTrustedAdvisorCheckResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRefreshTrustedAdvisorCheckResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRefreshTrustedAdvisorCheckResolveEndpointMiddleware{
