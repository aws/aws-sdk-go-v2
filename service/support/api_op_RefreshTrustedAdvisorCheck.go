...
func (c *Client) addOperationRefreshTrustedAdvisorCheckMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RefreshTrustedAdvisorCheck", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
