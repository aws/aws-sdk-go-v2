...
func addOperationDescribeTrustedAdvisorCheckRefreshStatusesStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeTrustedAdvisorCheckRefreshStatusesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeTrustedAdvisorCheckRefreshStatusesStackSlots(stack); err != nil {
		return err
	}
