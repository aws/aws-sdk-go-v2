...
func addOperationDescribeTrustedAdvisorChecksStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeTrustedAdvisorChecksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeTrustedAdvisorChecksStackSlots(stack); err != nil {
		return err
	}
