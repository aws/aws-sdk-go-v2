...
func (c *Client) addOperationDescribeSupportedLanguagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeSupportedLanguages", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
