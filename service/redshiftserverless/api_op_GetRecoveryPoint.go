...
func (c *Client) GetRecoveryPoint(ctx context.Context, params *GetRecoveryPointInput, optFns ...func(*Options)) (*GetRecoveryPointOutput, error) {
	if params == nil { params = &GetRecoveryPointInput{} }
...
func (c *Client) addOperationGetRecoveryPointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRecoveryPointResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRecoveryPointResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRecoveryPointResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRecoveryPointResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRecoveryPointResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRecoveryPointResolveEndpointMiddleware{
