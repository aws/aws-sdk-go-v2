...
func (c *Client) RestoreFromRecoveryPoint(ctx context.Context, params *RestoreFromRecoveryPointInput, optFns ...func(*Options)) (*RestoreFromRecoveryPointOutput, error) {
	if params == nil { params = &RestoreFromRecoveryPointInput{} }
...
func (c *Client) addOperationRestoreFromRecoveryPointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRestoreFromRecoveryPointResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRestoreFromRecoveryPointResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRestoreFromRecoveryPointResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRestoreFromRecoveryPointResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRestoreFromRecoveryPointResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRestoreFromRecoveryPointResolveEndpointMiddleware{
