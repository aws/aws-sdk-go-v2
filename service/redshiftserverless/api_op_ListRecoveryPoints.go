...
func (c *Client) ListRecoveryPoints(ctx context.Context, params *ListRecoveryPointsInput, optFns ...func(*Options)) (*ListRecoveryPointsOutput, error) {
	if params == nil { params = &ListRecoveryPointsInput{} }
...
func (c *Client) addOperationListRecoveryPointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRecoveryPointsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListRecoveryPointsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListRecoveryPointsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRecoveryPointsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListRecoveryPointsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListRecoveryPointsResolveEndpointMiddleware{
