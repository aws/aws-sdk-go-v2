...
func (c *Client) ListTableRestoreStatus(ctx context.Context, params *ListTableRestoreStatusInput, optFns ...func(*Options)) (*ListTableRestoreStatusOutput, error) {
	if params == nil { params = &ListTableRestoreStatusInput{} }
...
func (c *Client) addOperationListTableRestoreStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListTableRestoreStatusResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListTableRestoreStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListTableRestoreStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListTableRestoreStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListTableRestoreStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListTableRestoreStatusResolveEndpointMiddleware{
