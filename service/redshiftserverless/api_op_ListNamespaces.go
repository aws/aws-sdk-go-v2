...
func (c *Client) ListNamespaces(ctx context.Context, params *ListNamespacesInput, optFns ...func(*Options)) (*ListNamespacesOutput, error) {
	if params == nil { params = &ListNamespacesInput{} }
...
func (c *Client) addOperationListNamespacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListNamespacesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListNamespacesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListNamespacesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListNamespacesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListNamespacesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListNamespacesResolveEndpointMiddleware{
