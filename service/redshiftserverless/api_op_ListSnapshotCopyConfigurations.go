...
func (c *Client) addOperationListSnapshotCopyConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListSnapshotCopyConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
