...
func (c *Client) addOperationRestoreTableFromRecoveryPointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RestoreTableFromRecoveryPoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
