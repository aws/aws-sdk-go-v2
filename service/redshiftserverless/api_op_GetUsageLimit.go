...
func (c *Client) GetUsageLimit(ctx context.Context, params *GetUsageLimitInput, optFns ...func(*Options)) (*GetUsageLimitOutput, error) {
	if params == nil { params = &GetUsageLimitInput{} }
...
func (c *Client) addOperationGetUsageLimitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetUsageLimitResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetUsageLimitResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetUsageLimitResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetUsageLimitResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetUsageLimitResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetUsageLimitResolveEndpointMiddleware{
