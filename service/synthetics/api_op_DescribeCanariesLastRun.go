...
func (c *Client) addOperationDescribeCanariesLastRunMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeCanariesLastRun", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
