...
// required to use the Names parameter if you are logged on to a user or role
// that has an IAM policy that restricts which canaries that you are allowed to
// view. For more information, see Limiting a user to viewing specific canaries (https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries_Restricted.html)
// .
