...
func (c *Client) addOperationDescribeRuntimeVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeRuntimeVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
