...
func (*StartCanaryInput) operationName() string {
	return "StartCanary"
}
...
func (c *Client) addOperationStartCanaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartCanaryResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStartCanaryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStartCanaryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartCanaryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartCanaryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStartCanaryResolveEndpointMiddleware{
