...
func (c *Client) addOperationAssumeRoleForPodIdentityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssumeRoleForPodIdentity", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
