...
func (c *Client) DeleteConnection(ctx context.Context, params *DeleteConnectionInput, optFns ...func(*Options)) (*DeleteConnectionOutput, error) {
	...
	addawsRestjson1_serdeOpDeleteConnectionMiddlewares(stack)
...
func addawsRestjson1_serdeOpDeleteConnectionMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpDeleteConnection{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpDeleteConnection{}, middleware.After)
}
