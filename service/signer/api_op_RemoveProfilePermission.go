...
func (c *Client) addOperationRemoveProfilePermissionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RemoveProfilePermission", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
