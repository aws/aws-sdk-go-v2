...
func (c *Client) addOperationGetVpcEndpointServiceNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetVpcEndpointServiceName", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
