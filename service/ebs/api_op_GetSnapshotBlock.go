...
func (c *Client) GetSnapshotBlock(ctx context.Context, params *GetSnapshotBlockInput, optFns ...func(*Options)) (*GetSnapshotBlockOutput, error) {
	if params == nil { params = &GetSnapshotBlockInput{} }
...
func (c *Client) addOperationGetSnapshotBlockMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSnapshotBlockResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSnapshotBlockResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSnapshotBlockResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSnapshotBlockResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSnapshotBlockResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSnapshotBlockResolveEndpointMiddleware{
