...
// Package ebs provides the API client, operations, and parameter types for
...
// create incremental snapshots directly from data on-premises into volumes and the
...
// Then after recovery, you can restore it back to Amazon Web Services or
// on-premises from the snapshot. You no longer need to build and maintain complex
// mechanisms to copy data to and from Amazon EBS. This API reference provides
...
// EBS direct APIs, and examples of how to use them effectively, see Accessing
// the Contents of an Amazon EBS Snapshot (https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-accessing-snapshot.html)
