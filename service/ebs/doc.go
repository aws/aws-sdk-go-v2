...
// Elastic Compute Cloud (Amazon EC2) instances to compare the differences. You can
// create incremental snapshots directly from data on-premises into EBS volumes and
// the cloud to use for quick disaster recovery. With the ability to write and read
// snapshots, you can write your on-premises data to an EBS snapshot during a
// disaster. Then after recovery, you can restore it back to AWS or on-premises
// from the snapshot. You no longer need to build and maintain complex mechanisms
// to copy data to and from Amazon EBS. This API reference provides detailed
// information about the actions, data types, parameters, and errors of the EBS
// direct APIs. For more information about the elements that make up the EBS direct
// APIs, and examples of how to use them effectively, see Accessing the Contents of
// an EBS Snapshot
