...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-signer-data.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-signer-data.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-signer-data.dev",
			expectURL:     aws.String("https://env-signer-data.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-signer-data.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-signer-data.dev",
			expectURL:     aws.String("http://config-signer-data.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-signer-data.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-signer-data.dev",
			clientEndpoint: aws.String("https://client-signer-data.dev"),
			expectURL:      aws.String("https://client-signer-data.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SIGNER_DATA", c.envService)
			}
