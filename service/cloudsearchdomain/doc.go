...
// and search those documents. The endpoints for submitting UploadDocuments ,
...
// action. The domain endpoints are also displayed on the domain dashboard in the
// Amazon CloudSearch console. You submit suggest requests to the search endpoint.
