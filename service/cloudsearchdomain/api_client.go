...
const (
	ServiceName = "Amazon CloudSearch Domain" // Service's name
	ServiceID   = "CloudSearchDomain"         // Service's identifier
	EndpointsID = "cloudsearchdomain"         // Service's Endpoint identifier
)
