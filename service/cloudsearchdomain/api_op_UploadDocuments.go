...
// domain's document service. The endpoint for submitting UploadDocuments
// requests is domain-specific. To get the document endpoint for your domain, use
// the Amazon CloudSearch configuration service DescribeDomains action. A
// domain's endpoints are also displayed on the domain dashboard in the Amazon
// CloudSearch console. For more information about formatting your data for Amazon
// CloudSearch, see Preparing Your Data (http://docs.aws.amazon.com/cloudsearch/latest/developerguide/preparing-data.html)
