...
func (c *Client) addOperationDeleteMessagingStreamingConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteMessagingStreamingConfigurations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
