...
func (c *Client) DisassociateChannelFlow(ctx context.Context, params *DisassociateChannelFlowInput, optFns ...func(*Options)) (*DisassociateChannelFlowOutput, error) {
	if params == nil { params = &DisassociateChannelFlowInput{} }
...
func (c *Client) addOperationDisassociateChannelFlowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateChannelFlowResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateChannelFlowResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateChannelFlowResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateChannelFlowResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateChannelFlowResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateChannelFlowResolveEndpointMiddleware{
