...
func (c *Client) addOperationDisassociateChannelFlowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateChannelFlow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
