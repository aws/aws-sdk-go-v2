...
func (c *Client) addOperationDescribeChannelModeratedByAppInstanceUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeChannelModeratedByAppInstanceUser", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
