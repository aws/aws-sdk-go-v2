...
func (c *Client) GetMessagingStreamingConfigurations(ctx context.Context, params *GetMessagingStreamingConfigurationsInput, optFns ...func(*Options)) (*GetMessagingStreamingConfigurationsOutput, error) {
	if params == nil { params = &GetMessagingStreamingConfigurationsInput{} }
...
func (c *Client) addOperationGetMessagingStreamingConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMessagingStreamingConfigurationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetMessagingStreamingConfigurationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetMessagingStreamingConfigurationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMessagingStreamingConfigurationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMessagingStreamingConfigurationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetMessagingStreamingConfigurationsResolveEndpointMiddleware{
