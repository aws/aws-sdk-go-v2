...
func (c *Client) ListChannelFlows(ctx context.Context, params *ListChannelFlowsInput, optFns ...func(*Options)) (*ListChannelFlowsOutput, error) {
	if params == nil { params = &ListChannelFlowsInput{} }
...
func (c *Client) addOperationListChannelFlowsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListChannelFlowsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListChannelFlowsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListChannelFlowsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListChannelFlowsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListChannelFlowsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListChannelFlowsResolveEndpointMiddleware{
