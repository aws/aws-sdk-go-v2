...
func (*UpdateChannelFlowInput) operationName() string {
...
func (c *Client) addOperationUpdateChannelFlowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateChannelFlowResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateChannelFlowResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateChannelFlowResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateChannelFlowResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateChannelFlowResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateChannelFlowResolveEndpointMiddleware{
