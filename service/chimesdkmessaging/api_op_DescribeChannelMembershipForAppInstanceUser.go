...
func (c *Client) addOperationDescribeChannelMembershipForAppInstanceUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeChannelMembershipForAppInstanceUser", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
