...
func (c *Client) PutChannelExpirationSettings(ctx context.Context, params *PutChannelExpirationSettingsInput, optFns ...func(*Options)) (*PutChannelExpirationSettingsOutput, error) {
	if params == nil { params = &PutChannelExpirationSettingsInput{} }
...
func (c *Client) addOperationPutChannelExpirationSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPutChannelExpirationSettingsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPutChannelExpirationSettingsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPutChannelExpirationSettingsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPutChannelExpirationSettingsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPutChannelExpirationSettingsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPutChannelExpirationSettingsResolveEndpointMiddleware{
