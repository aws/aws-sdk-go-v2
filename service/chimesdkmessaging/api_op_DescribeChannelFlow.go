...
func (*DescribeChannelFlowInput) operationName() string {
...
func (c *Client) addOperationDescribeChannelFlowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDescribeChannelFlowResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDescribeChannelFlowResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDescribeChannelFlowResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDescribeChannelFlowResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDescribeChannelFlowResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDescribeChannelFlowResolveEndpointMiddleware{
