...
func (c *Client) addOperationCreateChannelMembershipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateChannelMembership", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
