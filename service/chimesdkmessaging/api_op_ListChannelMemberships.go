...
func (c *Client) ListChannelMemberships(ctx context.Context, params *ListChannelMembershipsInput, optFns ...func(*Options)) (*ListChannelMembershipsOutput, error) {
	if params == nil { params = &ListChannelMembershipsInput{} }
...
func (c *Client) addOperationListChannelMembershipsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListChannelMembershipsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListChannelMembershipsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListChannelMembershipsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListChannelMembershipsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListChannelMembershipsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListChannelMembershipsResolveEndpointMiddleware{
