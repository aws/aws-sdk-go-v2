...
func (c *Client) addOperationPutChannelMembershipPreferencesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutChannelMembershipPreferences", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
