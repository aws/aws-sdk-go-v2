...
func (c *Client) ListSubChannels(ctx context.Context, params *ListSubChannelsInput, optFns ...func(*Options)) (*ListSubChannelsOutput, error) {
	if params == nil { params = &ListSubChannelsInput{} }
...
func (c *Client) addOperationListSubChannelsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSubChannelsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSubChannelsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSubChannelsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSubChannelsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSubChannelsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSubChannelsResolveEndpointMiddleware{
