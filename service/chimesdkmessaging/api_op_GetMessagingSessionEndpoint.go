...
func (c *Client) addOperationGetMessagingSessionEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetMessagingSessionEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
