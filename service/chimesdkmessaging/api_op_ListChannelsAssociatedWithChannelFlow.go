...
func (c *Client) addOperationListChannelsAssociatedWithChannelFlowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListChannelsAssociatedWithChannelFlow", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
