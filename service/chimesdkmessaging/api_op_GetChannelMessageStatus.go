...
func (c *Client) addOperationGetChannelMessageStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetChannelMessageStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
