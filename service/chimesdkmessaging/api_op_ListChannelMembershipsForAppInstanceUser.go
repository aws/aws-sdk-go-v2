...
func (c *Client) addOperationListChannelMembershipsForAppInstanceUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListChannelMembershipsForAppInstanceUser", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
