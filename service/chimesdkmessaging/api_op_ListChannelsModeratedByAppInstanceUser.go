...
func (c *Client) addOperationListChannelsModeratedByAppInstanceUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListChannelsModeratedByAppInstanceUser", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
