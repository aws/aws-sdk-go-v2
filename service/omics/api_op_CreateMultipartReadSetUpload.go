...
func (c *Client) addOperationCreateMultipartReadSetUploadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateMultipartReadSetUpload", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
