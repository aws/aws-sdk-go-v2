...
func (c *Client) addOperationDeleteAnnotationStoreVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteAnnotationStoreVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
