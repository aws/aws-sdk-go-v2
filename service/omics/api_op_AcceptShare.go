...
func (c *Client) AcceptShare(ctx context.Context, params *AcceptShareInput, optFns ...func(*Options)) (*AcceptShareOutput, error) {
	if params == nil { params = &AcceptShareInput{} }
...
func (c *Client) addOperationAcceptShareMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAcceptShareResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
func (m *endpointPrefix_opAcceptShareMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEndpointPrefix_opAcceptShareMiddleware(stack *middleware.Stack) error {
	return stack.Serialize.Insert(&endpointPrefix_opAcceptShareMiddleware{}, `OperationSerializer`, middleware.After)
}
...
type opAcceptShareResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAcceptShareResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAcceptShareResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addAcceptShareResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAcceptShareResolveEndpointMiddleware{
