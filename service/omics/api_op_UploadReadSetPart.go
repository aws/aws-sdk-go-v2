...
func (c *Client) UploadReadSetPart(ctx context.Context, params *UploadReadSetPartInput, optFns ...func(*Options)) (*UploadReadSetPartOutput, error) {
	if params == nil { params = &UploadReadSetPartInput{} }
...
func (c *Client) addOperationUploadReadSetPartMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUploadReadSetPartResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUploadReadSetPartResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUploadReadSetPartResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUploadReadSetPartResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addUploadReadSetPartResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUploadReadSetPartResolveEndpointMiddleware{
