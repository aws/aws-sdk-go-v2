...
func (c *Client) GetReference(ctx context.Context, params *GetReferenceInput, optFns ...func(*Options)) (*GetReferenceOutput, error) {
	if params == nil { params = &GetReferenceInput{} }
...
func (c *Client) addOperationGetReferenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetReferenceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetReferenceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetReferenceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetReferenceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addGetReferenceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetReferenceResolveEndpointMiddleware{
