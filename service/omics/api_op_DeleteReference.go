...
func (*DeleteReferenceInput) operationName() string {
...
func (c *Client) addOperationDeleteReferenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteReferenceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteReferenceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteReferenceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteReferenceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addDeleteReferenceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteReferenceResolveEndpointMiddleware{
