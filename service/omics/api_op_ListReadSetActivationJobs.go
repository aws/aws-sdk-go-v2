...
func (c *Client) addOperationListReadSetActivationJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListReadSetActivationJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
