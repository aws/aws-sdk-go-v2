...
func (c *Client) addOperationListAnnotationStoreVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListAnnotationStoreVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
