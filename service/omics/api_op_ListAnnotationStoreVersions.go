...
func (c *Client) ListAnnotationStoreVersions(ctx context.Context, params *ListAnnotationStoreVersionsInput, optFns ...func(*Options)) (*ListAnnotationStoreVersionsOutput, error) {
	if params == nil { params = &ListAnnotationStoreVersionsInput{} }
...
func (c *Client) addOperationListAnnotationStoreVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAnnotationStoreVersionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAnnotationStoreVersionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAnnotationStoreVersionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAnnotationStoreVersionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListAnnotationStoreVersionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAnnotationStoreVersionsResolveEndpointMiddleware{
