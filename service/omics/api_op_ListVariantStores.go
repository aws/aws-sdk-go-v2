...
func (c *Client) ListVariantStores(ctx context.Context, params *ListVariantStoresInput, optFns ...func(*Options)) (*ListVariantStoresOutput, error) {
	if params == nil { params = &ListVariantStoresInput{} }
...
func (c *Client) addOperationListVariantStoresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListVariantStoresResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListVariantStoresResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListVariantStoresResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListVariantStoresResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListVariantStoresResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListVariantStoresResolveEndpointMiddleware{
