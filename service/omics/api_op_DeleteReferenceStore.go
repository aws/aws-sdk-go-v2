...
func (c *Client) DeleteReferenceStore(ctx context.Context, params *DeleteReferenceStoreInput, optFns ...func(*Options)) (*DeleteReferenceStoreOutput, error) {
	if params == nil { params = &DeleteReferenceStoreInput{} }
...
func (c *Client) addOperationDeleteReferenceStoreMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteReferenceStoreResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteReferenceStoreResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteReferenceStoreResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteReferenceStoreResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addDeleteReferenceStoreResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteReferenceStoreResolveEndpointMiddleware{
