...
func (*UpdateAnnotationStoreVersionInput) operationName() string {
...
func (c *Client) addOperationUpdateAnnotationStoreVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateAnnotationStoreVersionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
func (m *endpointPrefix_opUpdateAnnotationStoreVersionMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEndpointPrefix_opUpdateAnnotationStoreVersionMiddleware(stack *middleware.Stack) error {
	return stack.Serialize.Insert(&endpointPrefix_opUpdateAnnotationStoreVersionMiddleware{}, `OperationSerializer`, middleware.After)
}
...
type opUpdateAnnotationStoreVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateAnnotationStoreVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateAnnotationStoreVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addUpdateAnnotationStoreVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateAnnotationStoreVersionResolveEndpointMiddleware{
