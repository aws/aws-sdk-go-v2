...
func (c *Client) addOperationListMultipartReadSetUploadsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListMultipartReadSetUploads", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
