...
func (c *Client) addOperationStartReferenceImportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartReferenceImportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
