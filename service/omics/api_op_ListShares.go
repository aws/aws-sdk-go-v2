...
func (c *Client) ListShares(ctx context.Context, params *ListSharesInput, optFns ...func(*Options)) (*ListSharesOutput, error) {
	if params == nil { params = &ListSharesInput{} }
...
func (c *Client) addOperationListSharesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSharesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
func (m *endpointPrefix_opListSharesMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEndpointPrefix_opListSharesMiddleware(stack *middleware.Stack) error {
	return stack.Serialize.Insert(&endpointPrefix_opListSharesMiddleware{}, `OperationSerializer`, middleware.After)
}
...
type opListSharesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSharesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSharesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListSharesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSharesResolveEndpointMiddleware{
