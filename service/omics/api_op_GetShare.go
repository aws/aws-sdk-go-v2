...
func (c *Client) GetShare(ctx context.Context, params *GetShareInput, optFns ...func(*Options)) (*GetShareOutput, error) {
	if params == nil { params = &GetShareInput{} }
...
func (c *Client) addOperationGetShareMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetShareResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetShareResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetShareResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetShareResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addGetShareResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetShareResolveEndpointMiddleware{
