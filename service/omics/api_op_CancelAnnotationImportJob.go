...
func (c *Client) addOperationCancelAnnotationImportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelAnnotationImportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
