...
func (c *Client) ListReadSets(ctx context.Context, params *ListReadSetsInput, optFns ...func(*Options)) (*ListReadSetsOutput, error) {
	if params == nil { params = &ListReadSetsInput{} }
...
func (c *Client) addOperationListReadSetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListReadSetsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListReadSetsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListReadSetsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListReadSetsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListReadSetsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListReadSetsResolveEndpointMiddleware{
