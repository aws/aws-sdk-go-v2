...
func (*GetReferenceStoreInput) operationName() string {
	return "GetReferenceStore"
}
...
func (c *Client) addOperationGetReferenceStoreMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetReferenceStoreResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetReferenceStoreResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetReferenceStoreResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetReferenceStoreResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addGetReferenceStoreResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetReferenceStoreResolveEndpointMiddleware{
