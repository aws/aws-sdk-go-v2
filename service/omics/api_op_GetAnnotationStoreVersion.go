...
func (c *Client) addOperationGetAnnotationStoreVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetAnnotationStoreVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
