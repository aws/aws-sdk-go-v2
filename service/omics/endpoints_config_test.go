...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-omics.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-omics.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-omics.dev",
			expectURL:     aws.String("https://env-omics.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-omics.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-omics.dev",
			expectURL:     aws.String("http://config-omics.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-omics.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-omics.dev",
			clientEndpoint: aws.String("https://client-omics.dev"),
			expectURL:      aws.String("https://client-omics.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_OMICS", c.envService)
			}
