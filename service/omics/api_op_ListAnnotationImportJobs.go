...
func (c *Client) ListAnnotationImportJobs(ctx context.Context, params *ListAnnotationImportJobsInput, optFns ...func(*Options)) (*ListAnnotationImportJobsOutput, error) {
	if params == nil { params = &ListAnnotationImportJobsInput{} }
...
func (c *Client) addOperationListAnnotationImportJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAnnotationImportJobsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListAnnotationImportJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListAnnotationImportJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAnnotationImportJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListAnnotationImportJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListAnnotationImportJobsResolveEndpointMiddleware{
