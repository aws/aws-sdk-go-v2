...
func (c *Client) addOperationListRunGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListRunGroupsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListRunGroupsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListRunGroupsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListRunGroupsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListRunGroupsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListRunGroupsResolveEndpointMiddleware{
