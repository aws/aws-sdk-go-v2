...
func (c *Client) CompleteMultipartReadSetUpload(ctx context.Context, params *CompleteMultipartReadSetUploadInput, optFns ...func(*Options)) (*CompleteMultipartReadSetUploadOutput, error) {
	if params == nil { params = &CompleteMultipartReadSetUploadInput{} }
...
func (c *Client) addOperationCompleteMultipartReadSetUploadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCompleteMultipartReadSetUploadResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCompleteMultipartReadSetUploadResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCompleteMultipartReadSetUploadResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCompleteMultipartReadSetUploadResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addCompleteMultipartReadSetUploadResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCompleteMultipartReadSetUploadResolveEndpointMiddleware{
