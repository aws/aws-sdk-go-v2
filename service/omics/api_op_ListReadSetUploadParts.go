...
func (c *Client) ListReadSetUploadParts(ctx context.Context, params *ListReadSetUploadPartsInput, optFns ...func(*Options)) (*ListReadSetUploadPartsOutput, error) {
	if params == nil { params = &ListReadSetUploadPartsInput{} }
...
func (c *Client) addOperationListReadSetUploadPartsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListReadSetUploadPartsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListReadSetUploadPartsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListReadSetUploadPartsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListReadSetUploadPartsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListReadSetUploadPartsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListReadSetUploadPartsResolveEndpointMiddleware{
