...
func (c *Client) addOperationStartAnnotationImportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartAnnotationImportJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
