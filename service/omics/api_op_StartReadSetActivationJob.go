...
func (c *Client) addOperationStartReadSetActivationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartReadSetActivationJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
