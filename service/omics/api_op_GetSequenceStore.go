...
func (c *Client) GetSequenceStore(ctx context.Context, params *GetSequenceStoreInput, optFns ...func(*Options)) (*GetSequenceStoreOutput, error) {
	if params == nil { params = &GetSequenceStoreInput{} }
...
func (c *Client) addOperationGetSequenceStoreMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSequenceStoreResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSequenceStoreResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSequenceStoreResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSequenceStoreResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addGetSequenceStoreResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSequenceStoreResolveEndpointMiddleware{
