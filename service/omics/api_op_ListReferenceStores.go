...
func (c *Client) ListReferenceStores(ctx context.Context, params *ListReferenceStoresInput, optFns ...func(*Options)) (*ListReferenceStoresOutput, error) {
	if params == nil { params = &ListReferenceStoresInput{} }
...
func (c *Client) addOperationListReferenceStoresMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListReferenceStoresResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListReferenceStoresResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListReferenceStoresResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListReferenceStoresResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
...
func addListReferenceStoresResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListReferenceStoresResolveEndpointMiddleware{
