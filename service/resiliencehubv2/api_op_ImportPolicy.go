...
func (v *ImportPolicyOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.ImportPolicyResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *ImportPolicyOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.Policy != nil {
		s.WriteStruct(schemas.ImportPolicyResponse_policy)
