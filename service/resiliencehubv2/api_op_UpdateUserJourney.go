...
func (v *UpdateUserJourneyOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.UpdateUserJourneyResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *UpdateUserJourneyOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.UserJourney != nil {
		s.WriteStruct(schemas.UpdateUserJourneyResponse_userJourney)
