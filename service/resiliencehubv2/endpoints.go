...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/resiliencehubv2/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_RESILIENCEHUBV2")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "resiliencehubv2", cfg.ConfigSources)
	if found && err == nil {
