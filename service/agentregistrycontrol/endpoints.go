...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/agentregistrycontrol/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_AGENT_REGISTRY_CONTROL")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Agent Registry Control", cfg.ConfigSources)
	if found && err == nil {
...
var bddNodes = [9]int32{
	-1, 1, -1, 0, 100000001, 3, 1, 100000002, 100000003}
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 2:
		uriString := func() string {
			...
			out.WriteString("https://agent-registry-control.")
	...
	case 3:
		return smithyendpoints.Endpoint{}, fmt.Errorf("endpoint rule error, %s", "Unable to resolve an Agent Registry Control endpoint: Region was not set and no explicit Endpoint override was provided.")
	}
