...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-agent-registry-control.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-agent-registry-control.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-agent-registry-control.dev",
			expectURL:     aws.String("https://env-agent-registry-control.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-agent-registry-control.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-agent-registry-control.dev",
			expectURL:     aws.String("http://config-agent-registry-control.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-agent-registry-control.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-agent-registry-control.dev",
			clientEndpoint: aws.String("https://client-agent-registry-control.dev"),
			expectURL:      aws.String("https://client-agent-registry-control.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_AGENT_REGISTRY_CONTROL", c.envService)
			}
