...
func (c *Client) DeleteOriginEndpointPolicy(ctx context.Context, params *DeleteOriginEndpointPolicyInput, optFns ...func(*Options)) (*DeleteOriginEndpointPolicyOutput, error) {
	if params == nil { params = &DeleteOriginEndpointPolicyInput{} }
...
func (c *Client) addOperationDeleteOriginEndpointPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteOriginEndpointPolicyResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteOriginEndpointPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteOriginEndpointPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteOriginEndpointPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteOriginEndpointPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteOriginEndpointPolicyResolveEndpointMiddleware{
