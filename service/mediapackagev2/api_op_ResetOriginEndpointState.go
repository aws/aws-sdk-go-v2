...
func (c *Client) addOperationResetOriginEndpointStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ResetOriginEndpointState", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
