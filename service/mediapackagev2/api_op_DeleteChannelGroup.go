...
func (*DeleteChannelGroupInput) operationName() string {
...
func (c *Client) addOperationDeleteChannelGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteChannelGroupResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteChannelGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteChannelGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteChannelGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteChannelGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteChannelGroupResolveEndpointMiddleware{
