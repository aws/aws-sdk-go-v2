...
// Access is denied because either you don't have permissions to perform the
// requested operation or MediaPackage is getting throttling errors with CDN
// authorization. The user or role that is making the request must have at least
// one IAM permissions policy attached that grants the required permissions. For
// more information, see Access Management in the IAM User Guide. Or, if you're
// using CDN authorization, you will receive this exception if MediaPackage
// receives a throttling error from Secrets Manager.
...
func (v *ConflictException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ConflictException, func(s *smithy.Schema) error {
		switch s {
		case schemas.ConflictException_ConflictExceptionType:
			var ev string
			if err := d.ReadString(schemas.ConflictException_ConflictExceptionType, &ev); err != nil {
				return err
			}
			v.ConflictExceptionType = ConflictExceptionType(ev)
			return nil
...
func (v *ResourceNotFoundException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ResourceNotFoundException, func(s *smithy.Schema) error {
		...
		case schemas.ResourceNotFoundException_ResourceTypeNotFound:
			var ev string
			if err := d.ReadString(schemas.ResourceNotFoundException_ResourceTypeNotFound, &ev); err != nil {
				return err
			}
			v.ResourceTypeNotFound = ResourceTypeNotFound(ev)
			return nil
		}
		return nil
	})
...
func (v *ValidationException) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ValidationException, func(s *smithy.Schema) error {
		...
		case schemas.ValidationException_ValidationExceptionType:
			var ev string
			if err := d.ReadString(schemas.ValidationException_ValidationExceptionType, &ev); err != nil {
				return err
			}
			v.ValidationExceptionType = ValidationExceptionType(ev)
			return nil
		}
		return nil
	})
