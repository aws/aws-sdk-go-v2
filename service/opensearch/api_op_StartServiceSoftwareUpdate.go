...
func (c *Client) addOperationStartServiceSoftwareUpdateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartServiceSoftwareUpdate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
