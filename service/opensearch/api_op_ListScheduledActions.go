...
func (c *Client) ListScheduledActions(ctx context.Context, params *ListScheduledActionsInput, optFns ...func(*Options)) (*ListScheduledActionsOutput, error) {
	if params == nil { params = &ListScheduledActionsInput{} }
...
func (c *Client) addOperationListScheduledActionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListScheduledActionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListScheduledActionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListScheduledActionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListScheduledActionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListScheduledActionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListScheduledActionsResolveEndpointMiddleware{
