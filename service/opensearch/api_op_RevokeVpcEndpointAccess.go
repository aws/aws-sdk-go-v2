...
func (c *Client) addOperationRevokeVpcEndpointAccessMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RevokeVpcEndpointAccess", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
