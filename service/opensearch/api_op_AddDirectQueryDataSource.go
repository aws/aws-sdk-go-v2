...
func (c *Client) addOperationAddDirectQueryDataSourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AddDirectQueryDataSource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
