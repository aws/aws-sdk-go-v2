...
func (v *AddDirectQueryDataSourceOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteStruct(schemas.AddDirectQueryDataSourceResponse)
	v.SerializeMembers(s)
	s.CloseStruct()
}

func (v *AddDirectQueryDataSourceOutput) SerializeMembers(s smithy.ShapeSerializer) {
	if v.DataSourceArn != nil {
		s.WriteString(schemas.AddDirectQueryDataSourceResponse_DataSourceArn, *v.DataSourceArn)
	}
}
