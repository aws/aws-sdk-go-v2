...
func (c *Client) addOperationGetDirectQueryDataSourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDirectQueryDataSource", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
