...
func (c *Client) addOperationGetPackageVersionHistoryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPackageVersionHistory", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
