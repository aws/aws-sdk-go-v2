...
func (c *Client) addOperationDescribeDomainChangeProgressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeDomainChangeProgress", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
