...
func (c *Client) addOperationListDirectQueryDataSourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDirectQueryDataSources", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
