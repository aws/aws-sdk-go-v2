...
func (c *Client) addOperationAcceptInboundConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AcceptInboundConnection", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
