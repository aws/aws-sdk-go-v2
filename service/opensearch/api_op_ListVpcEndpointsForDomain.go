...
func (c *Client) addOperationListVpcEndpointsForDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListVpcEndpointsForDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
