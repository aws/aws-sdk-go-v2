...
func (c *Client) addOperationGetDomainMaintenanceStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDomainMaintenanceStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
