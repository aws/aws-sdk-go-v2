...
func (c *Client) addOperationGetDefaultApplicationSettingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetDefaultApplicationSetting", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
