...
func (c *Client) addOperationListInstanceTypeDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListInstanceTypeDetails", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
