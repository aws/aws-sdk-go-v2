...
func (c *Client) addOperationPurchaseReservedInstanceOfferingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PurchaseReservedInstanceOffering", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
