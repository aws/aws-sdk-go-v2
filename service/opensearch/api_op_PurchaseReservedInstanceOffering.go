...
func (c *Client) PurchaseReservedInstanceOffering(ctx context.Context, params *PurchaseReservedInstanceOfferingInput, optFns ...func(*Options)) (*PurchaseReservedInstanceOfferingOutput, error) {
	if params == nil { params = &PurchaseReservedInstanceOfferingInput{} }
...
func (c *Client) addOperationPurchaseReservedInstanceOfferingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addPurchaseReservedInstanceOfferingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opPurchaseReservedInstanceOfferingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opPurchaseReservedInstanceOfferingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opPurchaseReservedInstanceOfferingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addPurchaseReservedInstanceOfferingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opPurchaseReservedInstanceOfferingResolveEndpointMiddleware{
