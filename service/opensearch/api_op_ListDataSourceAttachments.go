...
func (c *Client) addOperationListDataSourceAttachmentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListDataSourceAttachments", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
