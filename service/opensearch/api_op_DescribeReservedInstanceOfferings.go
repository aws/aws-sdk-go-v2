...
func (c *Client) addOperationDescribeReservedInstanceOfferingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeReservedInstanceOfferings", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
