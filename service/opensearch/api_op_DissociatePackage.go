...
func (c *Client) DissociatePackage(ctx context.Context, params *DissociatePackageInput, optFns ...func(*Options)) (*DissociatePackageOutput, error) {
	if params == nil { params = &DissociatePackageInput{} }
...
func (c *Client) addOperationDissociatePackageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDissociatePackageResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDissociatePackageResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDissociatePackageResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDissociatePackageResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDissociatePackageResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDissociatePackageResolveEndpointMiddleware{
