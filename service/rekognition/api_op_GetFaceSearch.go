...
// SUCCEEDED . If so, call GetFaceSearch  and pass the job identifier ( JobId)
// from the initial call to StartFaceSearch. For more information, see Searching
// Faces in a Collection in the Amazon Rekognition Developer Guide. The search
// results are retured in an array, Persons , of PersonMatch  objects. Each
// PersonMatchelement contains details about the matching faces in the input
...
// video. GetFaceSearch  only returns the default facial attributes ( BoundingBox
