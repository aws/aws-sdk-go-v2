...
func (c *Client) ListStreamProcessors(ctx context.Context, params *ListStreamProcessorsInput, optFns ...func(*Options)) (*ListStreamProcessorsOutput, error) {
	if params == nil { params = &ListStreamProcessorsInput{} }
...
func (c *Client) addOperationListStreamProcessorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListStreamProcessorsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListStreamProcessorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListStreamProcessorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListStreamProcessorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListStreamProcessorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListStreamProcessorsResolveEndpointMiddleware{
