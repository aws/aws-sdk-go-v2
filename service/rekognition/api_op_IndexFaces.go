...
func (c *Client) IndexFaces(ctx context.Context, params *IndexFacesInput, optFns ...func(*Options)) (*IndexFacesOutput, error) {
	if params == nil { params = &IndexFacesInput{} }
...
func (c *Client) addOperationIndexFacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addIndexFacesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opIndexFacesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opIndexFacesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opIndexFacesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addIndexFacesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opIndexFacesResolveEndpointMiddleware{
