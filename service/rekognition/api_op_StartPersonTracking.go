...
func (c *Client) StartPersonTracking(ctx context.Context, params *StartPersonTrackingInput, optFns ...func(*Options)) (*StartPersonTrackingOutput, error) {
	if params == nil { params = &StartPersonTrackingInput{} }
...
func (c *Client) addOperationStartPersonTrackingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartPersonTrackingResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartPersonTrackingResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartPersonTrackingResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartPersonTrackingResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartPersonTrackingResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartPersonTrackingResolveEndpointMiddleware{
