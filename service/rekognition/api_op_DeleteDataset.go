...
// dataset is still deleting if the value of Status  is DELETE_IN_PROGRESS. If
// you try to access the dataset after it is deleted, you get a
// ResourceNotFoundExceptionexception. You can't delete a dataset while it is
