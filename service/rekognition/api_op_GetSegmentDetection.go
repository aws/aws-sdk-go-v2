...
// returns detected segments in an array ( Segments ) of SegmentDetection
...
// than specified in MaxResults , the value of NextToken in the operation
// response contains a pagination token for getting the next set of results. To get
// the next page of results, call GetSegmentDetection  and populate the NextToken
...
type GetSegmentDetectionOutput struct {
	...
	// AudioMetadataobjects includes the audio codec, the number of audio channels,
	...
	// VideoMetadataarray. The object contains information about the video stream in
	// the input file that Amazon Rekognition Video chose to analyze. The
	// VideoMetadataobject includes the video codec, video format and other
