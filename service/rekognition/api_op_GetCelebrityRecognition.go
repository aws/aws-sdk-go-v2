...
func (c *Client) addOperationGetCelebrityRecognitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCelebrityRecognition", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
