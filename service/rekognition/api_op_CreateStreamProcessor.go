...
// - If you are creating a stream processor
// to detect labels, you provide as input a Kinesis video stream (Input), Amazon S3
// bucket information (Output), and an Amazon SNS topic ARN (NotificationChannel).
// You can also provide a KMS key ID to encrypt the data sent to your Amazon S3
// bucket. You specify what you want to detect in ConnectedHomeSettings, such as
// people, packages and people, or pets, people, and packages. You can also specify
...
//
// Use Name to assign an identifier for the
// stream processor. You use Name to manage the stream processor. For example, you
// can start processing the source video by calling StartStreamProcessor with the
// Name field. This operation requires permissions to perform the
