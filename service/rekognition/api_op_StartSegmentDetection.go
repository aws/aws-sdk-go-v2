...
// Notification Service topic that you specify in NotificationChannel. You can
// use the Filters  ( StartSegmentDetectionFilters) input parameter to specify
...
// to StartSegmentDetection. For more information, see Detecting video segments
// in stored video in the Amazon Rekognition Developer Guide.
