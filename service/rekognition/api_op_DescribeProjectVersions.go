...
func (c *Client) addOperationDescribeProjectVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeProjectVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
