...
func (c *Client) StartContentModeration(ctx context.Context, params *StartContentModerationInput, optFns ...func(*Options)) (*StartContentModerationOutput, error) {
	if params == nil { params = &StartContentModerationInput{} }
...
func (c *Client) addOperationStartContentModerationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartContentModerationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartContentModerationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartContentModerationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartContentModerationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartContentModerationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartContentModerationResolveEndpointMiddleware{
