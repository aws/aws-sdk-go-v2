...
func (c *Client) addOperationGetFaceLivenessSessionResultsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetFaceLivenessSessionResults", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
