...
func (*UpdateStreamProcessorInput) operationName() string {
...
func (c *Client) addOperationUpdateStreamProcessorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateStreamProcessorResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opUpdateStreamProcessorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opUpdateStreamProcessorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateStreamProcessorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateStreamProcessorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opUpdateStreamProcessorResolveEndpointMiddleware{
