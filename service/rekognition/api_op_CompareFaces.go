...
func (c *Client) CompareFaces(ctx context.Context, params *CompareFacesInput, optFns ...func(*Options)) (*CompareFacesOutput, error) {
	if params == nil { params = &CompareFacesInput{} }
...
func (c *Client) addOperationCompareFacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCompareFacesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opCompareFacesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opCompareFacesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCompareFacesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCompareFacesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opCompareFacesResolveEndpointMiddleware{
