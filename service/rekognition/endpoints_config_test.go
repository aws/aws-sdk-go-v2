...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-rekognition.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rekognition.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rekognition.dev",
			expectURL:     aws.String("https://env-rekognition.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-rekognition.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rekognition.dev",
			expectURL:     aws.String("http://config-rekognition.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-rekognition.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-rekognition.dev",
			clientEndpoint: aws.String("https://client-rekognition.dev"),
			expectURL:      aws.String("https://client-rekognition.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_REKOGNITION", c.envService)
			}
