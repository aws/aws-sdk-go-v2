...
func (c *Client) addOperationListMediaAnalysisJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListMediaAnalysisJobsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListMediaAnalysisJobsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListMediaAnalysisJobsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListMediaAnalysisJobsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListMediaAnalysisJobsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListMediaAnalysisJobsResolveEndpointMiddleware{
