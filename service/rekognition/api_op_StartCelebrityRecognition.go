...
func (c *Client) addOperationStartCelebrityRecognitionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartCelebrityRecognition", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
