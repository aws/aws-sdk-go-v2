...
func (*StopStreamProcessorInput) operationName() string {
...
func (c *Client) addOperationStopStreamProcessorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopStreamProcessorResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopStreamProcessorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopStreamProcessorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopStreamProcessorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopStreamProcessorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopStreamProcessorResolveEndpointMiddleware{
