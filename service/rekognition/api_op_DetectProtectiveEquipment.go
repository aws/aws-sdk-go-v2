...
func (c *Client) addOperationDetectProtectiveEquipmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DetectProtectiveEquipment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
