...
func (c *Client) GetCelebrityInfo(ctx context.Context, params *GetCelebrityInfoInput, optFns ...func(*Options)) (*GetCelebrityInfoOutput, error) {
	if params == nil { params = &GetCelebrityInfoInput{} }
...
func (c *Client) addOperationGetCelebrityInfoMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCelebrityInfoResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCelebrityInfoResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCelebrityInfoResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCelebrityInfoResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCelebrityInfoResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCelebrityInfoResolveEndpointMiddleware{
