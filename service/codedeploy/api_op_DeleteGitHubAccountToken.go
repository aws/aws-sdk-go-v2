...
func (c *Client) DeleteGitHubAccountToken(ctx context.Context, params *DeleteGitHubAccountTokenInput, optFns ...func(*Options)) (*DeleteGitHubAccountTokenOutput, error) {
	if params == nil { params = &DeleteGitHubAccountTokenInput{} }
...
func (c *Client) addOperationDeleteGitHubAccountTokenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteGitHubAccountTokenResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteGitHubAccountTokenResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteGitHubAccountTokenResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteGitHubAccountTokenResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteGitHubAccountTokenResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteGitHubAccountTokenResolveEndpointMiddleware{
