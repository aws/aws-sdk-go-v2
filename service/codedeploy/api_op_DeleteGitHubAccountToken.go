...
func (c *Client) addOperationDeleteGitHubAccountTokenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteGitHubAccountToken", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
