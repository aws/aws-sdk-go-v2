...
func (c *Client) addOperationBatchGetDeploymentTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetDeploymentTargets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
