...
func (c *Client) addOperationBatchGetApplicationRevisionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetApplicationRevisions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
