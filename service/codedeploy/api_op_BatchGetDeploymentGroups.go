...
func (*BatchGetDeploymentGroupsInput) operationName() string {
...
func (c *Client) addOperationBatchGetDeploymentGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addBatchGetDeploymentGroupsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opBatchGetDeploymentGroupsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opBatchGetDeploymentGroupsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opBatchGetDeploymentGroupsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addBatchGetDeploymentGroupsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opBatchGetDeploymentGroupsResolveEndpointMiddleware{
