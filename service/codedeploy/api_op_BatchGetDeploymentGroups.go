...
func (c *Client) addOperationBatchGetDeploymentGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetDeploymentGroups", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
