...
func addOperationDeregisterOnPremisesInstanceStackSlots(stack *middleware.Stack) error {
...
func addOperationDeregisterOnPremisesInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeregisterOnPremisesInstanceStackSlots(stack); err != nil {
		return err
	}
