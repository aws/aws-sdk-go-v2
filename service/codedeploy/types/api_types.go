...
type AutoRollbackConfiguration struct {
	...
	Events []enums.AutoRollbackEvent `locationName:"events" type:"list"`
}
...
type BlueInstanceTerminationOption struct {
	...
	Action enums.InstanceAction `locationName:"action" type:"string" enum:"true"`
...
type DeploymentInfo struct {
	...
	Creator enums.DeploymentCreator `locationName:"creator" type:"string" enum:"true"`
...
type DeploymentReadyOption struct {
	...
	ActionOnTimeout enums.DeploymentReadyAction `locationName:"actionOnTimeout" type:"string" enum:"true"`
...
type DeploymentStyle struct {
	...
	DeploymentOption enums.DeploymentOption `locationName:"deploymentOption" type:"string" enum:"true"`

	// Indicates whether to run an in-place deployment or a blue/green deployment.
	DeploymentType enums.DeploymentType `locationName:"deploymentType" type:"string" enum:"true"`
}
...
type DeploymentTarget struct {
	...
	DeploymentTargetType enums.DeploymentTargetType `locationName:"deploymentTargetType" type:"string" enum:"true"`
...
type Diagnostics struct {
	...
	ErrorCode enums.LifecycleErrorCode `locationName:"errorCode" type:"string" enum:"true"`
...
type EC2TagFilter struct {
	...
	Type enums.EC2TagFilterType `type:"string" enum:"true"`
...
type ECSTarget struct {
	...
	Status enums.TargetStatus `locationName:"status" type:"string" enum:"true"`
...
type ECSTaskSet struct {
	...
	TaskSetLabel enums.TargetLabel `locationName:"taskSetLabel" type:"string" enum:"true"`
...
type ErrorInformation struct {
	...
	Code enums.ErrorCode `locationName:"code" type:"string" enum:"true"`
...
type GreenFleetProvisioningOption struct {
	...
	Action enums.GreenFleetProvisioningAction `locationName:"action" type:"string" enum:"true"`
}
...
type InstanceSummary struct {
	...
	Status enums.InstanceStatus `locationName:"status" deprecated:"true" type:"string" enum:"true"`
}
...
type InstanceTarget struct {
	...
	// or a replacement target (GREEN).
	InstanceLabel enums.TargetLabel `locationName:"instanceLabel" type:"string" enum:"true"`
...
type MinimumHealthyHosts struct {
	...
	// in the AWS CodeDeploy User Guide.
	Type enums.MinimumHealthyHostsType `locationName:"type" type:"string" enum:"true"`
...
type RevisionLocation struct {
	...
	//    only).
	RevisionType enums.RevisionLocationType `locationName:"revisionType" type:"string" enum:"true"`
...
type S3Location struct {
	...
	BundleType enums.BundleType `locationName:"bundleType" type:"string" enum:"true"`
...
type TagFilter struct {
	...
	//
	//    * KEY_AND_VALUE: Key and value.
	Type enums.TagFilterType `type:"string" enum:"true"`
...
type TrafficRoutingConfig struct {
	...
	Type enums.TrafficRoutingType `locationName:"type" type:"string" enum:"true"`
}
...
type TriggerConfig struct {
	...
	TriggerEvents []enums.TriggerEventType `locationName:"triggerEvents" type:"list"`
