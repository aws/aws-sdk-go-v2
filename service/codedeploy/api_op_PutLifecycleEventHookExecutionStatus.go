...
func (c *Client) addOperationPutLifecycleEventHookExecutionStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutLifecycleEventHookExecutionStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
