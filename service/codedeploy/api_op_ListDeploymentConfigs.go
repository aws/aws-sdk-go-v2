...
func (*ListDeploymentConfigsInput) operationName() string {
...
func (c *Client) addOperationListDeploymentConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDeploymentConfigsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListDeploymentConfigsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListDeploymentConfigsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDeploymentConfigsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDeploymentConfigsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListDeploymentConfigsResolveEndpointMiddleware{
