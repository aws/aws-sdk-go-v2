...
func (c *Client) addOperationRegisterApplicationRevisionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RegisterApplicationRevision", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
