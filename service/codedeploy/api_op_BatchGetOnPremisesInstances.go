...
func addOperationBatchGetOnPremisesInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationBatchGetOnPremisesInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationBatchGetOnPremisesInstancesStackSlots(stack); err != nil {
		return err
	}
