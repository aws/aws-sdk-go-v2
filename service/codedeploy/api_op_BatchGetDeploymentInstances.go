...
func addOperationBatchGetDeploymentInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationBatchGetDeploymentInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationBatchGetDeploymentInstancesStackSlots(stack); err != nil {
		return err
	}
