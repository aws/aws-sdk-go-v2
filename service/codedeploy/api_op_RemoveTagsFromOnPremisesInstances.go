...
func (*RemoveTagsFromOnPremisesInstancesInput) operationName() string {
...
func (c *Client) addOperationRemoveTagsFromOnPremisesInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRemoveTagsFromOnPremisesInstancesResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opRemoveTagsFromOnPremisesInstancesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opRemoveTagsFromOnPremisesInstancesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRemoveTagsFromOnPremisesInstancesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRemoveTagsFromOnPremisesInstancesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opRemoveTagsFromOnPremisesInstancesResolveEndpointMiddleware{
