...
func awsAwsjson11_serializeDocumentAlarmConfiguration(v *types.AlarmConfiguration, value smithyjson.Value) error {
	...
	if v.IgnorePollAlarmFailure != nil {
...
func awsAwsjson11_serializeDocumentBlueInstanceTerminationOption(v *types.BlueInstanceTerminationOption, value smithyjson.Value) error {
	...
	if v.TerminationWaitTimeInMinutes != nil {
...
func awsAwsjson11_serializeDocumentCreateDeploymentInput(v *CreateDeploymentInput, value smithyjson.Value) error {
	...
	if v.IgnoreApplicationStopFailures != nil {
	...
	if v.UpdateOutdatedInstancesOnly != nil {
