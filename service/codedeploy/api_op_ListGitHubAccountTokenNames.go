...
func (c *Client) addOperationListGitHubAccountTokenNamesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListGitHubAccountTokenNames", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
