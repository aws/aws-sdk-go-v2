...
func (c *Client) ListGitHubAccountTokenNames(ctx context.Context, params *ListGitHubAccountTokenNamesInput, optFns ...func(*Options)) (*ListGitHubAccountTokenNamesOutput, error) {
	if params == nil { params = &ListGitHubAccountTokenNamesInput{} }
...
func (c *Client) addOperationListGitHubAccountTokenNamesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListGitHubAccountTokenNamesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListGitHubAccountTokenNamesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListGitHubAccountTokenNamesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListGitHubAccountTokenNamesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListGitHubAccountTokenNamesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListGitHubAccountTokenNamesResolveEndpointMiddleware{
