...
func (*CreateDeploymentConfigInput) operationName() string {
...
func (c *Client) addOperationCreateDeploymentConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateDeploymentConfigResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateDeploymentConfigResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateDeploymentConfigResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateDeploymentConfigResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateDeploymentConfigResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateDeploymentConfigResolveEndpointMiddleware{
