...
func (c *Client) addOperationSkipWaitTimeForInstanceTerminationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SkipWaitTimeForInstanceTermination", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
