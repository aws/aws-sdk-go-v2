...
func addOperationSkipWaitTimeForInstanceTerminationStackSlots(stack *middleware.Stack) error {
...
func addOperationSkipWaitTimeForInstanceTerminationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationSkipWaitTimeForInstanceTerminationStackSlots(stack); err != nil {
		return err
	}
