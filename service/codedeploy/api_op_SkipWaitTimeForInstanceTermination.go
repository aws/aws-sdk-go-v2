...
func (c *Client) SkipWaitTimeForInstanceTermination(ctx context.Context, params *SkipWaitTimeForInstanceTerminationInput, optFns ...func(*Options)) (*SkipWaitTimeForInstanceTerminationOutput, error) {
	if params == nil { params = &SkipWaitTimeForInstanceTerminationInput{} }
...
func (c *Client) addOperationSkipWaitTimeForInstanceTerminationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSkipWaitTimeForInstanceTerminationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSkipWaitTimeForInstanceTerminationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSkipWaitTimeForInstanceTerminationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSkipWaitTimeForInstanceTerminationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSkipWaitTimeForInstanceTerminationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSkipWaitTimeForInstanceTerminationResolveEndpointMiddleware{
