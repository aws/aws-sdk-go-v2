...
func (c *Client) GetApplicationRevision(ctx context.Context, params *GetApplicationRevisionInput, optFns ...func(*Options)) (*GetApplicationRevisionOutput, error) {
	if params == nil { params = &GetApplicationRevisionInput{} }
...
func (c *Client) addOperationGetApplicationRevisionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetApplicationRevisionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetApplicationRevisionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetApplicationRevisionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetApplicationRevisionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetApplicationRevisionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetApplicationRevisionResolveEndpointMiddleware{
