...
func (c *Client) GetOnPremisesInstance(ctx context.Context, params *GetOnPremisesInstanceInput, optFns ...func(*Options)) (*GetOnPremisesInstanceOutput, error) {
	if params == nil { params = &GetOnPremisesInstanceInput{} }
...
func (c *Client) addOperationGetOnPremisesInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetOnPremisesInstanceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetOnPremisesInstanceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetOnPremisesInstanceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetOnPremisesInstanceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetOnPremisesInstanceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetOnPremisesInstanceResolveEndpointMiddleware{
