...
func (c *Client) addOperationDeleteResourcesByExternalIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteResourcesByExternalId", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
