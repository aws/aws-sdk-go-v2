...
func addOperationDeleteResourcesByExternalIdStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteResourcesByExternalIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteResourcesByExternalIdStackSlots(stack); err != nil {
		return err
	}
