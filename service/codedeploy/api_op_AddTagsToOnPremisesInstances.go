...
func addOperationAddTagsToOnPremisesInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationAddTagsToOnPremisesInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAddTagsToOnPremisesInstancesStackSlots(stack); err != nil {
		return err
	}
