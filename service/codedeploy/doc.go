...
// Package codedeploy provides the API client, operations, and parameter types
// for AWS CodeDeploy.
//
...
// details about Amazon ECS service deployments. CodeDeploy Information Resources
