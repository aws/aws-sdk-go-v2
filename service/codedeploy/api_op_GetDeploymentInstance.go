...
func (*GetDeploymentInstanceInput) operationName() string {
	return "GetDeploymentInstance"
}
...
func (c *Client) addOperationGetDeploymentInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDeploymentInstanceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetDeploymentInstanceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetDeploymentInstanceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDeploymentInstanceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDeploymentInstanceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetDeploymentInstanceResolveEndpointMiddleware{
