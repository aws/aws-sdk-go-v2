...
func (c *Client) DeleteDataLakeExceptionSubscription(ctx context.Context, params *DeleteDataLakeExceptionSubscriptionInput, optFns ...func(*Options)) (*DeleteDataLakeExceptionSubscriptionOutput, error) {
	if params == nil { params = &DeleteDataLakeExceptionSubscriptionInput{} }
...
func (c *Client) addOperationDeleteDataLakeExceptionSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteDataLakeExceptionSubscriptionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteDataLakeExceptionSubscriptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteDataLakeExceptionSubscriptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteDataLakeExceptionSubscriptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteDataLakeExceptionSubscriptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteDataLakeExceptionSubscriptionResolveEndpointMiddleware{
