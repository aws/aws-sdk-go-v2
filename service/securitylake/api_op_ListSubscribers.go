...
func (c *Client) ListSubscribers(ctx context.Context, params *ListSubscribersInput, optFns ...func(*Options)) (*ListSubscribersOutput, error) {
	if params == nil { params = &ListSubscribersInput{} }
...
func (c *Client) addOperationListSubscribersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListSubscribersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListSubscribersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListSubscribersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListSubscribersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListSubscribersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListSubscribersResolveEndpointMiddleware{
