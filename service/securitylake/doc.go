...
// sources into a data lake that's stored in your Amazon Web Servicesaccount.
// Amazon Web Services Organizations is an account management service that lets you
// consolidate multiple Amazon Web Services accounts into an organization that you
// create and centrally manage. With Organizations, you can create member accounts
// and invite existing accounts to join your organization. Security Lake helps you
// analyze security data for a more complete understanding of your security posture
// across the entire organization. It can also help you improve the protection of
