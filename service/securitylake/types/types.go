...
type DataLakeReplicationConfiguration struct {
	...
	// parameter. Replication enables automatic, asynchronous copying of objects across
	// Amazon S3 buckets. S3 buckets that are configured for object replication can be
	...
	// buckets. The destination buckets can be in different Regions or within the same
