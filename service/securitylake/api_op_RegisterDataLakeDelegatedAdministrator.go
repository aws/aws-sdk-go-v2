...
func (c *Client) RegisterDataLakeDelegatedAdministrator(ctx context.Context, params *RegisterDataLakeDelegatedAdministratorInput, optFns ...func(*Options)) (*RegisterDataLakeDelegatedAdministratorOutput, error) {
	if params == nil { params = &RegisterDataLakeDelegatedAdministratorInput{} }
...
func (c *Client) addOperationRegisterDataLakeDelegatedAdministratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRegisterDataLakeDelegatedAdministratorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRegisterDataLakeDelegatedAdministratorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRegisterDataLakeDelegatedAdministratorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRegisterDataLakeDelegatedAdministratorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRegisterDataLakeDelegatedAdministratorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRegisterDataLakeDelegatedAdministratorResolveEndpointMiddleware{
