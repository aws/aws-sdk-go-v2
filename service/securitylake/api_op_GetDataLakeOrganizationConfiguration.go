...
func (c *Client) GetDataLakeOrganizationConfiguration(ctx context.Context, params *GetDataLakeOrganizationConfigurationInput, optFns ...func(*Options)) (*GetDataLakeOrganizationConfigurationOutput, error) {
	if params == nil { params = &GetDataLakeOrganizationConfigurationInput{} }
...
func (c *Client) addOperationGetDataLakeOrganizationConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDataLakeOrganizationConfigurationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDataLakeOrganizationConfigurationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDataLakeOrganizationConfigurationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDataLakeOrganizationConfigurationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDataLakeOrganizationConfigurationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDataLakeOrganizationConfigurationResolveEndpointMiddleware{
