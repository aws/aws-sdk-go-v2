...
func (c *Client) ListDataLakes(ctx context.Context, params *ListDataLakesInput, optFns ...func(*Options)) (*ListDataLakesOutput, error) {
	if params == nil { params = &ListDataLakesInput{} }
...
func (c *Client) addOperationListDataLakesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDataLakesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListDataLakesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListDataLakesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDataLakesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDataLakesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListDataLakesResolveEndpointMiddleware{
