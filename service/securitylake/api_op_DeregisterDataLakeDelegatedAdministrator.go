...
func (*DeregisterDataLakeDelegatedAdministratorInput) operationName() string {
...
func (c *Client) addOperationDeregisterDataLakeDelegatedAdministratorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeregisterDataLakeDelegatedAdministratorResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeregisterDataLakeDelegatedAdministratorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeregisterDataLakeDelegatedAdministratorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeregisterDataLakeDelegatedAdministratorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeregisterDataLakeDelegatedAdministratorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeregisterDataLakeDelegatedAdministratorResolveEndpointMiddleware{
