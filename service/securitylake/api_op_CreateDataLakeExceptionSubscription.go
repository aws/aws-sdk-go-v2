...
func (*CreateDataLakeExceptionSubscriptionInput) operationName() string {
...
func (c *Client) addOperationCreateDataLakeExceptionSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateDataLakeExceptionSubscriptionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateDataLakeExceptionSubscriptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateDataLakeExceptionSubscriptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateDataLakeExceptionSubscriptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateDataLakeExceptionSubscriptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateDataLakeExceptionSubscriptionResolveEndpointMiddleware{
