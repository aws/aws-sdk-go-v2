...
func (c *Client) addOperationCreateDataLakeExceptionSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateDataLakeExceptionSubscription", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
