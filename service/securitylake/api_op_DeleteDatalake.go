...
// security log and event data. DeleteDatalake does not delete the S3 bucket which
// is owned by the Amazon Web Services account. For more information, see the
