...
func (c *Client) GetSubscriber(ctx context.Context, params *GetSubscriberInput, optFns ...func(*Options)) (*GetSubscriberOutput, error) {
	if params == nil { params = &GetSubscriberInput{} }
...
func (c *Client) addOperationGetSubscriberMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSubscriberResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSubscriberResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSubscriberResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSubscriberResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSubscriberResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSubscriberResolveEndpointMiddleware{
