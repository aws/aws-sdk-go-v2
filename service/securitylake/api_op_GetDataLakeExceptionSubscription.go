...
func (c *Client) GetDataLakeExceptionSubscription(ctx context.Context, params *GetDataLakeExceptionSubscriptionInput, optFns ...func(*Options)) (*GetDataLakeExceptionSubscriptionOutput, error) {
	if params == nil { params = &GetDataLakeExceptionSubscriptionInput{} }
...
func (c *Client) addOperationGetDataLakeExceptionSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDataLakeExceptionSubscriptionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDataLakeExceptionSubscriptionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDataLakeExceptionSubscriptionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDataLakeExceptionSubscriptionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDataLakeExceptionSubscriptionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDataLakeExceptionSubscriptionResolveEndpointMiddleware{
