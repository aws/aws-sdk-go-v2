...
func (c *Client) addOperationGetRemainingFreeTrialDaysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRemainingFreeTrialDays", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
