...
func (c *Client) GetRemainingFreeTrialDays(ctx context.Context, params *GetRemainingFreeTrialDaysInput, optFns ...func(*Options)) (*GetRemainingFreeTrialDaysOutput, error) {
	if params == nil { params = &GetRemainingFreeTrialDaysInput{} }
...
func (c *Client) addOperationGetRemainingFreeTrialDaysMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetRemainingFreeTrialDaysResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetRemainingFreeTrialDaysResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetRemainingFreeTrialDaysResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetRemainingFreeTrialDaysResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetRemainingFreeTrialDaysResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetRemainingFreeTrialDaysResolveEndpointMiddleware{
