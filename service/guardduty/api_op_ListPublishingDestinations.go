...
func (c *Client) addOperationListPublishingDestinationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPublishingDestinations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
