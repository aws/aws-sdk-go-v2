...
func (c *Client) addOperationDescribePublishingDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribePublishingDestination", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
