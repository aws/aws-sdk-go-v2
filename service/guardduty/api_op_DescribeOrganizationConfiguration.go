...
func addOperationDescribeOrganizationConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeOrganizationConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeOrganizationConfigurationStackSlots(stack); err != nil {
		return err
	}
