...
func addOperationDisableOrganizationAdminAccountStackSlots(stack *middleware.Stack) error {
...
func addOperationDisableOrganizationAdminAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisableOrganizationAdminAccountStackSlots(stack); err != nil {
		return err
	}
