...
func (c *Client) StopMonitoringMembers(ctx context.Context, params *StopMonitoringMembersInput, optFns ...func(*Options)) (*StopMonitoringMembersOutput, error) {
	if params == nil { params = &StopMonitoringMembersInput{} }
...
func (c *Client) addOperationStopMonitoringMembersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopMonitoringMembersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopMonitoringMembersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopMonitoringMembersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopMonitoringMembersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopMonitoringMembersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopMonitoringMembersResolveEndpointMiddleware{
