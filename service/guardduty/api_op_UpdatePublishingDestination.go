...
func addOperationUpdatePublishingDestinationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdatePublishingDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdatePublishingDestinationStackSlots(stack); err != nil {
		return err
	}
