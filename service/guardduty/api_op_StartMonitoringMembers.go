...
func (c *Client) StartMonitoringMembers(ctx context.Context, params *StartMonitoringMembersInput, optFns ...func(*Options)) (*StartMonitoringMembersOutput, error) {
	if params == nil { params = &StartMonitoringMembersInput{} }
...
func (c *Client) addOperationStartMonitoringMembersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartMonitoringMembersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartMonitoringMembersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartMonitoringMembersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartMonitoringMembersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartMonitoringMembersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartMonitoringMembersResolveEndpointMiddleware{
