...
func addOperationCreatePublishingDestinationStackSlots(stack *middleware.Stack) error {
...
func addOperationCreatePublishingDestinationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreatePublishingDestinationStackSlots(stack); err != nil {
		return err
	}
