...
func (c *Client) addOperationCreateInvestigationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "CreateInvestigation"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opCreateInvestigation(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opCreateInvestigation(region string) *awsmiddleware.RegisterServiceMetadata {
