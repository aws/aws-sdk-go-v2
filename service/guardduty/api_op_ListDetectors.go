...
func (*ListDetectorsInput) operationName() string {
...
func (c *Client) addOperationListDetectorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListDetectorsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListDetectorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListDetectorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListDetectorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListDetectorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListDetectorsResolveEndpointMiddleware{
