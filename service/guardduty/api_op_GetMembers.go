...
func (c *Client) GetMembers(ctx context.Context, params *GetMembersInput, optFns ...func(*Options)) (*GetMembersOutput, error) {
	if params == nil { params = &GetMembersInput{} }
...
func (c *Client) addOperationGetMembersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetMembersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetMembersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetMembersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetMembersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetMembersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetMembersResolveEndpointMiddleware{
