...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-artifact.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-artifact.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-artifact.dev",
			expectURL:     aws.String("https://env-artifact.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-artifact.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-artifact.dev",
			expectURL:     aws.String("http://config-artifact.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-artifact.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-artifact.dev",
			clientEndpoint: aws.String("https://client-artifact.dev"),
			expectURL:      aws.String("https://client-artifact.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ARTIFACT", c.envService)
			}
