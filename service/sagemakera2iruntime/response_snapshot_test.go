...
func TestCheckResponseSnapshot_DeleteHumanLoop(t *testing.T) {
	want := &DeleteHumanLoopOutput{}
	status, header, body, err := serdeRespReadSnapshot("DeleteHumanLoop.response")
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "DeleteHumanLoop.response", err)
	}
}

func TestCheckResponseSnapshot_DescribeHumanLoop(t *testing.T) {
	want := &DescribeHumanLoopOutput{
		...
		HumanLoopStatus:   types.HumanLoopStatus("InProgress"),
	...
	status, header, body, err := serdeRespReadSnapshot("DescribeHumanLoop.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "DescribeHumanLoop.response", err)
	}
}

func TestCheckResponseSnapshot_ListHumanLoops(t *testing.T) {
	want := &ListHumanLoopsOutput{
	...
	status, header, body, err := serdeRespReadSnapshot("ListHumanLoops.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "ListHumanLoops.response", err)
	}
}

func TestCheckResponseSnapshot_StartHumanLoop(t *testing.T) {
	want := &StartHumanLoopOutput{
		HumanLoopArn: ptr.String("__HumanLoopArn__"),
	}
	status, header, body, err := serdeRespReadSnapshot("StartHumanLoop.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "StartHumanLoop.response", err)
	}
}

func TestCheckResponseSnapshot_StopHumanLoop(t *testing.T) {
	want := &StopHumanLoopOutput{}
	status, header, body, err := serdeRespReadSnapshot("StopHumanLoop.response")
	if errors.Is(err, fs.ErrNotExist) {
		t.Skip("no response snapshot fixture")
	}
	if err != nil {
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "StopHumanLoop.response", err)
	}
}
