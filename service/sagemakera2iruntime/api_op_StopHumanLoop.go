...
func (c *Client) StopHumanLoop(ctx context.Context, params *StopHumanLoopInput, optFns ...func(*Options)) (*StopHumanLoopOutput, error) {
	if params == nil { params = &StopHumanLoopInput{} }
...
func (c *Client) addOperationStopHumanLoopMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopHumanLoopResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopHumanLoopResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopHumanLoopResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopHumanLoopResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopHumanLoopResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopHumanLoopResolveEndpointMiddleware{
