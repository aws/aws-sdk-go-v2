...
func addOperationDescribeEventDetailsForOrganizationStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeEventDetailsForOrganizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeEventDetailsForOrganizationStackSlots(stack); err != nil {
		return err
	}
