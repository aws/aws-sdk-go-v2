...
// that appears in the Personal Health Dashboard (https://phd.aws.amazon.com/phd/home#/)
...
//     API. For more information, see Accessing the Health API (https://docs.aws.amazon.com/health/latest/ug/health-api.html)
