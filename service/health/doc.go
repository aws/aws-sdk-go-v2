...
// plan from Amazon Web Services Support (http://aws.amazon.com/premiumsupport/) to
...
// - You can use the
// Health endpoint health.us-east-1.amazonaws.com (HTTPS) to call the Health API
// operations. Health supports a multi-Region application architecture and has two
// regional endpoints in an active-passive configuration. You can use the high
...
// information, see Accessing the Health API
// (https://docs.aws.amazon.com/health/latest/ug/health-api.html) in the Health
// User Guide.
//
