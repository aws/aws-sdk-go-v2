...
// Enterprise support plan, you receive a SubscriptionRequiredException error. AWS
// Health has a single endpoint: health.us-east-1.amazonaws.com (HTTPS). Use this
// endpoint to call the AWS Health API operations. For authentication of requests,
// AWS Health uses the Signature Version 4 Signing Process
// (https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html). If
// your AWS account is part of AWS Organizations, you can use the AWS Health
