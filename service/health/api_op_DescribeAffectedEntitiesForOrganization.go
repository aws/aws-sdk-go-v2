...
func (c *Client) addOperationDescribeAffectedEntitiesForOrganizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeAffectedEntitiesForOrganization", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
