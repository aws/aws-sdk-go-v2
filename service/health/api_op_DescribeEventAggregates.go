...
func (c *Client) addOperationDescribeEventAggregatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeEventAggregates", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
