...
func addOperationChangeResourceRecordSetsStackSlots(stack *middleware.Stack) error {
	...
	if err := stack.Deserialize.InsertSlot(smithyid.OperationDeserializer, middleware.After,
		route53cust.CustomErrorResponseMiddlewareID,
	); err != nil {
		return err
	}
	return nil
...
func addOperationChangeResourceRecordSetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationChangeResourceRecordSetsStackSlots(stack); err != nil {
		return err
	}
