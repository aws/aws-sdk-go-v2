...
type UpdateHealthCheckInput struct {
	...
	// cases. If you don't specify a value for IPAddress: If you don't specify a
	// value for IPAddress, Route 53 sends a DNS request to the domain that you
	// specify in FullyQualifiedDomainName  at the interval you specify in
	// RequestInterval. Using an IPv4 address that is returned by DNS, Route 53 then
	// checks the health of the endpoint. If you don't specify a value for IPAddress,
	...
	// FullyQualifiedDomainNamematches the name of the resource record sets and you
	// then associate the health check with those resource record sets, health check
	// results will be unpredictable. In addition, if the value of Type  is HTTP ,
	// HTTPS , HTTP_STR_MATCH , or HTTPS_STR_MATCH , Route 53 passes the value of
	...
	// for IPAddress. This ensures that the IP address of your instance never
