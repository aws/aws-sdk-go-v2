...
type ListHealthChecksInput struct {
	...
	// in response to the current request. Amazon Route 53 returns a maximum of 100
	// items. If you set MaxItems to a value greater than 100, Route 53 returns only
