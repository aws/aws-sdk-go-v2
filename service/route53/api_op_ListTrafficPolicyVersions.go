...
func (c *Client) addOperationListTrafficPolicyVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListTrafficPolicyVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
