...
func (c *Client) GetDNSSEC(ctx context.Context, params *GetDNSSECInput, optFns ...func(*Options)) (*GetDNSSECOutput, error) {
	if params == nil { params = &GetDNSSECInput{} }
...
func (c *Client) addOperationGetDNSSECMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetDNSSECResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetDNSSECResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetDNSSECResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetDNSSECResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetDNSSECResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetDNSSECResolveEndpointMiddleware{
