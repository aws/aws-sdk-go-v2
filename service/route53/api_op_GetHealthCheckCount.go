...
func (c *Client) GetHealthCheckCount(ctx context.Context, params *GetHealthCheckCountInput, optFns ...func(*Options)) (*GetHealthCheckCountOutput, error) {
	if params == nil { params = &GetHealthCheckCountInput{} }
...
func (c *Client) addOperationGetHealthCheckCountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetHealthCheckCountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetHealthCheckCountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetHealthCheckCountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetHealthCheckCountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetHealthCheckCountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetHealthCheckCountResolveEndpointMiddleware{
