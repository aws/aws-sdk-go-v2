...
func (c *Client) DisableHostedZoneDNSSEC(ctx context.Context, params *DisableHostedZoneDNSSECInput, optFns ...func(*Options)) (*DisableHostedZoneDNSSECOutput, error) {
	if params == nil { params = &DisableHostedZoneDNSSECInput{} }
...
func (c *Client) addOperationDisableHostedZoneDNSSECMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableHostedZoneDNSSECResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisableHostedZoneDNSSECResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisableHostedZoneDNSSECResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableHostedZoneDNSSECResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableHostedZoneDNSSECResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisableHostedZoneDNSSECResolveEndpointMiddleware{
