...
func (c *Client) addOperationDisableHostedZoneDNSSECMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisableHostedZoneDNSSEC", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
