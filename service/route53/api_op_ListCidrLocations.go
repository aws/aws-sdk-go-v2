...
func (c *Client) ListCidrLocations(ctx context.Context, params *ListCidrLocationsInput, optFns ...func(*Options)) (*ListCidrLocationsOutput, error) {
	if params == nil { params = &ListCidrLocationsInput{} }
...
func (c *Client) addOperationListCidrLocationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCidrLocationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCidrLocationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCidrLocationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCidrLocationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCidrLocationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCidrLocationsResolveEndpointMiddleware{
