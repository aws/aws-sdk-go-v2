...
func (c *Client) GetAccountLimit(ctx context.Context, params *GetAccountLimitInput, optFns ...func(*Options)) (*GetAccountLimitOutput, error) {
	stack := middleware.NewStack("GetAccountLimit", smithyhttp.NewStackRequest)
	options := c.options.Copy()
	for _, fn := range optFns {
		fn(&options)
	}
	addawsRestxml_serdeOpGetAccountLimitMiddlewares(stack)
...
func addawsRestxml_serdeOpGetAccountLimitMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestxml_serializeOpGetAccountLimit{}, middleware.After)
	stack.Deserialize.Add(&awsRestxml_deserializeOpGetAccountLimit{}, middleware.After)
}
