...
func addOperationDeleteReusableDelegationSetStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteReusableDelegationSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteReusableDelegationSetStackSlots(stack); err != nil {
		return err
	}
