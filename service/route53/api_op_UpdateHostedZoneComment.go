...
func (c *Client) addOperationUpdateHostedZoneCommentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateHostedZoneComment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
