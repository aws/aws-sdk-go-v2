...
func (c *Client) addOperationCreateTrafficPolicyInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateTrafficPolicyInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
