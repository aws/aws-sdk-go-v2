...
func addOperationCreateTrafficPolicyInstanceStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateTrafficPolicyInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateTrafficPolicyInstanceStackSlots(stack); err != nil {
		return err
	}
