...
func (c *Client) addOperationDeactivateKeySigningKeyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeactivateKeySigningKey", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
