...
func (c *Client) GetHostedZone(ctx context.Context, params *GetHostedZoneInput, optFns ...func(*Options)) (*GetHostedZoneOutput, error) {
	if params == nil { params = &GetHostedZoneInput{} }
...
func (c *Client) addOperationGetHostedZoneMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetHostedZoneResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetHostedZoneResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetHostedZoneResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetHostedZoneResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetHostedZoneResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetHostedZoneResolveEndpointMiddleware{
