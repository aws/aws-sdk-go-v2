...
func addOperationCreateTrafficPolicyVersionStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateTrafficPolicyVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateTrafficPolicyVersionStackSlots(stack); err != nil {
		return err
	}
