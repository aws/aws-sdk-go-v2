...
func addOperationListTrafficPolicyInstancesByPolicyStackSlots(stack *middleware.Stack) error {
...
func addOperationListTrafficPolicyInstancesByPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListTrafficPolicyInstancesByPolicyStackSlots(stack); err != nil {
		return err
	}
