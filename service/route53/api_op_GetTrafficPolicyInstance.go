...
func (*GetTrafficPolicyInstanceInput) operationName() string {
...
func (c *Client) addOperationGetTrafficPolicyInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTrafficPolicyInstanceResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetTrafficPolicyInstanceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetTrafficPolicyInstanceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTrafficPolicyInstanceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTrafficPolicyInstanceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetTrafficPolicyInstanceResolveEndpointMiddleware{
