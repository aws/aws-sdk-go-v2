...
func (c *Client) addOperationGetTrafficPolicyInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetTrafficPolicyInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
