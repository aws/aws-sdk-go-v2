...
func (c *Client) ChangeTagsForResource(ctx context.Context, params *ChangeTagsForResourceInput, optFns ...func(*Options)) (*ChangeTagsForResourceOutput, error) {
	if params == nil { params = &ChangeTagsForResourceInput{} }
...
func (c *Client) addOperationChangeTagsForResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addChangeTagsForResourceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opChangeTagsForResourceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opChangeTagsForResourceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opChangeTagsForResourceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addChangeTagsForResourceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opChangeTagsForResourceResolveEndpointMiddleware{
