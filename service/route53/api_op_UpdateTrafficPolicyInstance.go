...
func (c *Client) addOperationUpdateTrafficPolicyInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateTrafficPolicyInstance", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
