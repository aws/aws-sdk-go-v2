...
func addOperationUpdateTrafficPolicyInstanceStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateTrafficPolicyInstanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateTrafficPolicyInstanceStackSlots(stack); err != nil {
		return err
	}
