...
// record sets.
// - When all of the new resource record sets have been created, Route
...
// - Route 53 deletes the
// old group of resource record sets that are associated with the root resource
// record set name.
