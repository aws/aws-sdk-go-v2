...
func (c *Client) UpdateTrafficPolicyComment(ctx context.Context, params *UpdateTrafficPolicyCommentInput, optFns ...func(*Options)) (*UpdateTrafficPolicyCommentOutput, error) {
	if params == nil { params = &UpdateTrafficPolicyCommentInput{} }
...
func (c *Client) addOperationUpdateTrafficPolicyCommentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateTrafficPolicyCommentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateTrafficPolicyCommentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateTrafficPolicyCommentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateTrafficPolicyCommentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateTrafficPolicyCommentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateTrafficPolicyCommentResolveEndpointMiddleware{
