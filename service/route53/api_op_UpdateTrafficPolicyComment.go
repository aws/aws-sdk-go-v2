...
func addOperationUpdateTrafficPolicyCommentStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateTrafficPolicyCommentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateTrafficPolicyCommentStackSlots(stack); err != nil {
		return err
	}
