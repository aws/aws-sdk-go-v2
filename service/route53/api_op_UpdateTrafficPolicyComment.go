...
func (c *Client) addOperationUpdateTrafficPolicyCommentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateTrafficPolicyComment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
