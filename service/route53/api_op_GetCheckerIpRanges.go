...
func (c *Client) GetCheckerIpRanges(ctx context.Context, params *GetCheckerIpRangesInput, optFns ...func(*Options)) (*GetCheckerIpRangesOutput, error) {
	if params == nil { params = &GetCheckerIpRangesInput{} }
...
func (c *Client) addOperationGetCheckerIpRangesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCheckerIpRangesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCheckerIpRangesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCheckerIpRangesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCheckerIpRangesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCheckerIpRangesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCheckerIpRangesResolveEndpointMiddleware{
