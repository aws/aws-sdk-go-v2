...
func addOperationListTrafficPolicyInstancesStackSlots(stack *middleware.Stack) error {
...
func addOperationListTrafficPolicyInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListTrafficPolicyInstancesStackSlots(stack); err != nil {
		return err
	}
