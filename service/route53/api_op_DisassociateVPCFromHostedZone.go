...
func addOperationDisassociateVPCFromHostedZoneStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateVPCFromHostedZoneMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateVPCFromHostedZoneStackSlots(stack); err != nil {
		return err
	}
