...
func (c *Client) addOperationDisassociateVPCFromHostedZoneMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateVPCFromHostedZone", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
