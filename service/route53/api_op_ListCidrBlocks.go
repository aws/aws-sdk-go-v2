...
func (c *Client) addOperationListCidrBlocksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCidrBlocksResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListCidrBlocksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListCidrBlocksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCidrBlocksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCidrBlocksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListCidrBlocksResolveEndpointMiddleware{
