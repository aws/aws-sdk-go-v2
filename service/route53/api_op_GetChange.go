...
func (c *Client) GetChange(ctx context.Context, params *GetChangeInput, optFns ...func(*Options)) (*GetChangeOutput, error) {
	if params == nil { params = &GetChangeInput{} }
...
func (c *Client) addOperationGetChangeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetChangeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetChangeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetChangeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetChangeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetChangeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetChangeResolveEndpointMiddleware{
