...
func addOperationGetTrafficPolicyInstanceCountStackSlots(stack *middleware.Stack) error {
...
func addOperationGetTrafficPolicyInstanceCountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetTrafficPolicyInstanceCountStackSlots(stack); err != nil {
		return err
	}
