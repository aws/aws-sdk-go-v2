...
func (c *Client) addOperationGetTrafficPolicyInstanceCountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetTrafficPolicyInstanceCount", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
