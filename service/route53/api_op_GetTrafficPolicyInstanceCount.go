...
func (c *Client) GetTrafficPolicyInstanceCount(ctx context.Context, params *GetTrafficPolicyInstanceCountInput, optFns ...func(*Options)) (*GetTrafficPolicyInstanceCountOutput, error) {
	if params == nil { params = &GetTrafficPolicyInstanceCountInput{} }
...
func (c *Client) addOperationGetTrafficPolicyInstanceCountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTrafficPolicyInstanceCountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetTrafficPolicyInstanceCountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetTrafficPolicyInstanceCountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTrafficPolicyInstanceCountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTrafficPolicyInstanceCountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetTrafficPolicyInstanceCountResolveEndpointMiddleware{
