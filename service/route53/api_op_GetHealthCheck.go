...
func (*GetHealthCheckInput) operationName() string {
...
func (c *Client) addOperationGetHealthCheckMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetHealthCheckResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetHealthCheckResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetHealthCheckResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetHealthCheckResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetHealthCheckResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetHealthCheckResolveEndpointMiddleware{
