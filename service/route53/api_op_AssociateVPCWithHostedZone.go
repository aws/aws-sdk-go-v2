...
func (c *Client) addOperationAssociateVPCWithHostedZoneMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateVPCWithHostedZone", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
