...
func (c *Client) addOperationDeleteVPCAssociationAuthorizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteVPCAssociationAuthorization", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
