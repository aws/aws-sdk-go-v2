...
func addOperationDeleteVPCAssociationAuthorizationStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteVPCAssociationAuthorizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteVPCAssociationAuthorizationStackSlots(stack); err != nil {
		return err
	}
