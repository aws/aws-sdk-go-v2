...
func (c *Client) addOperationGetHealthCheckLastFailureReasonMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetHealthCheckLastFailureReason", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
