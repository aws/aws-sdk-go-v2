...
func (c *Client) GetHealthCheckLastFailureReason(ctx context.Context, params *GetHealthCheckLastFailureReasonInput, optFns ...func(*Options)) (*GetHealthCheckLastFailureReasonOutput, error) {
	if params == nil { params = &GetHealthCheckLastFailureReasonInput{} }
...
func (c *Client) addOperationGetHealthCheckLastFailureReasonMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetHealthCheckLastFailureReasonResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetHealthCheckLastFailureReasonResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetHealthCheckLastFailureReasonResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetHealthCheckLastFailureReasonResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetHealthCheckLastFailureReasonResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetHealthCheckLastFailureReasonResolveEndpointMiddleware{
