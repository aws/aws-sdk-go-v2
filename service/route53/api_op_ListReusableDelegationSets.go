...
func (c *Client) addOperationListReusableDelegationSetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListReusableDelegationSets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
