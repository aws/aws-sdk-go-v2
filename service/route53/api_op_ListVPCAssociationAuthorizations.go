...
func addOperationListVPCAssociationAuthorizationsStackSlots(stack *middleware.Stack) error {
...
func addOperationListVPCAssociationAuthorizationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListVPCAssociationAuthorizationsStackSlots(stack); err != nil {
		return err
	}
