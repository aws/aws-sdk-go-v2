...
// Policy Before you create a query logging configuration, perform the following
...
//
// The name of each
// log stream is in the following format: hosted zone ID/edge location code  The
...
// information about how DNS works, see Routing Internet Traffic to Your Website
// or Web Application (https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/welcome-dns-service.html)
