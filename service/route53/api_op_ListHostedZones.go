...
func (c *Client) ListHostedZones(ctx context.Context, params *ListHostedZonesInput, optFns ...func(*Options)) (*ListHostedZonesOutput, error) {
	if params == nil { params = &ListHostedZonesInput{} }
...
func (c *Client) addOperationListHostedZonesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListHostedZonesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListHostedZonesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListHostedZonesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListHostedZonesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListHostedZonesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListHostedZonesResolveEndpointMiddleware{
