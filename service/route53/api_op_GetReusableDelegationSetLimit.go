...
func (c *Client) addOperationGetReusableDelegationSetLimitMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetReusableDelegationSetLimit", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
