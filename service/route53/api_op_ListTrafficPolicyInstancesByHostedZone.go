...
func addOperationListTrafficPolicyInstancesByHostedZoneStackSlots(stack *middleware.Stack) error {
...
func addOperationListTrafficPolicyInstancesByHostedZoneMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListTrafficPolicyInstancesByHostedZoneStackSlots(stack); err != nil {
		return err
	}
