...
func (c *Client) addOperationDeleteQueryLoggingConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteQueryLoggingConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
