...
func addOperationCreateReusableDelegationSetStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateReusableDelegationSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateReusableDelegationSetStackSlots(stack); err != nil {
		return err
	}
