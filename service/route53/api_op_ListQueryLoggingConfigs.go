...
func (c *Client) addOperationListQueryLoggingConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListQueryLoggingConfigs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
