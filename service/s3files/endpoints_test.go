...
func TestEndpointCase2(t *testing.T) {
	...
	uri, _ := url.Parse("https://s3files-fips.us-east-1.api.aws")
...
func TestEndpointCase3(t *testing.T) {
	...
	uri, _ := url.Parse("https://s3files.us-east-1.api.aws")
...
func TestEndpointCase4(t *testing.T) {
	...
	uri, _ := url.Parse("https://s3files-fips.cn-northwest-1.api.amazonwebservices.com.cn")
...
func TestEndpointCase5(t *testing.T) {
	...
	uri, _ := url.Parse("https://s3files.cn-northwest-1.api.amazonwebservices.com.cn")
...
func TestEndpointCase6(t *testing.T) {
	...
	uri, _ := url.Parse("https://s3files-fips.us-gov-west-1.api.aws")
...
func TestEndpointCase7(t *testing.T) {
	...
	uri, _ := url.Parse("https://s3files.us-gov-west-1.api.aws")
