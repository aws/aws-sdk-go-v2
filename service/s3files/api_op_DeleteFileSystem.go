...
// Deletes an S3 File System. You can optionally force deletion of a file system
...
type DeleteFileSystemInput struct {
	...
	// If true, allows deletion of a file system that contains data pending export to
	// S3. If false (the default), the deletion will fail if there is data that has not
	// yet been exported to the S3 bucket. Use this parameter with caution as it may
	// result in data loss.
	ForceDelete *bool
