...
func addOperationUpdateConfigurationSetTrackingOptionsStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateConfigurationSetTrackingOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateConfigurationSetTrackingOptionsStackSlots(stack); err != nil {
		return err
	}
