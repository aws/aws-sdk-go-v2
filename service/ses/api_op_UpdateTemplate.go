...
func (c *Client) UpdateTemplate(ctx context.Context, params *UpdateTemplateInput, optFns ...func(*Options)) (*UpdateTemplateOutput, error) {
	...
	addawsAwsquery_serdeOpUpdateTemplateMiddlewares(stack)
...
func addawsAwsquery_serdeOpUpdateTemplateMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpUpdateTemplate{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpUpdateTemplate{}, middleware.After)
}
