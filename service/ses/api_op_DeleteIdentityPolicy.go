...
func (*DeleteIdentityPolicyInput) operationName() string {
...
func (c *Client) addOperationDeleteIdentityPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteIdentityPolicyResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteIdentityPolicyResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteIdentityPolicyResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteIdentityPolicyResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteIdentityPolicyResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteIdentityPolicyResolveEndpointMiddleware{
