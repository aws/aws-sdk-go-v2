...
func (c *Client) addOperationSetActiveReceiptRuleSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SetActiveReceiptRuleSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
