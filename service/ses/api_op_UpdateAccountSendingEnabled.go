...
func addOperationUpdateAccountSendingEnabledStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateAccountSendingEnabledMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateAccountSendingEnabledStackSlots(stack); err != nil {
		return err
	}
