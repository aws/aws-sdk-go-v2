...
func (c *Client) addOperationUpdateAccountSendingEnabledMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateAccountSendingEnabled", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
