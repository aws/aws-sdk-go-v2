...
func addOperationSetIdentityFeedbackForwardingEnabledStackSlots(stack *middleware.Stack) error {
...
func addOperationSetIdentityFeedbackForwardingEnabledMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationSetIdentityFeedbackForwardingEnabledStackSlots(stack); err != nil {
		return err
	}
