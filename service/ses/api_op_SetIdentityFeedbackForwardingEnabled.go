...
func (c *Client) addOperationSetIdentityFeedbackForwardingEnabledMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SetIdentityFeedbackForwardingEnabled", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
