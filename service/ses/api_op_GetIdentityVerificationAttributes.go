...
func addOperationGetIdentityVerificationAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationGetIdentityVerificationAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetIdentityVerificationAttributesStackSlots(stack); err != nil {
		return err
	}
