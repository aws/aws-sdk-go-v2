...
func (c *Client) GetSendQuota(ctx context.Context, params *GetSendQuotaInput, optFns ...func(*Options)) (*GetSendQuotaOutput, error) {
	if params == nil { params = &GetSendQuotaInput{} }
...
func (c *Client) addOperationGetSendQuotaMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSendQuotaResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSendQuotaResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSendQuotaResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSendQuotaResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSendQuotaResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSendQuotaResolveEndpointMiddleware{
