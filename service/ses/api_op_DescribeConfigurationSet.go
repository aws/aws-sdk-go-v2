...
func (c *Client) addOperationDescribeConfigurationSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeConfigurationSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
