...
func (c *Client) SendBounce(ctx context.Context, params *SendBounceInput, optFns ...func(*Options)) (*SendBounceOutput, error) {
	if params == nil { params = &SendBounceInput{} }
...
func (c *Client) addOperationSendBounceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendBounceResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSendBounceResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSendBounceResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendBounceResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendBounceResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSendBounceResolveEndpointMiddleware{
