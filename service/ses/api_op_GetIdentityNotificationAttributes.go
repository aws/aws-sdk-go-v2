...
func addOperationGetIdentityNotificationAttributesStackSlots(stack *middleware.Stack) error {
...
func addOperationGetIdentityNotificationAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetIdentityNotificationAttributesStackSlots(stack); err != nil {
		return err
	}
