...
func (c *Client) addOperationUpdateConfigurationSetSendingEnabledMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateConfigurationSetSendingEnabled", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
