...
func (c *Client) UpdateConfigurationSetSendingEnabled(ctx context.Context, params *UpdateConfigurationSetSendingEnabledInput, optFns ...func(*Options)) (*UpdateConfigurationSetSendingEnabledOutput, error) {
	if params == nil { params = &UpdateConfigurationSetSendingEnabledInput{} }
...
func (c *Client) addOperationUpdateConfigurationSetSendingEnabledMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateConfigurationSetSendingEnabledResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateConfigurationSetSendingEnabledResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateConfigurationSetSendingEnabledResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateConfigurationSetSendingEnabledResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateConfigurationSetSendingEnabledResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateConfigurationSetSendingEnabledResolveEndpointMiddleware{
