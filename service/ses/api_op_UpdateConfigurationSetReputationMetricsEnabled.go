...
func (c *Client) addOperationUpdateConfigurationSetReputationMetricsEnabledMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateConfigurationSetReputationMetricsEnabled", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
