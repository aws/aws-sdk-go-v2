...
func (c *Client) addOperationDescribeActiveReceiptRuleSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeActiveReceiptRuleSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
