...
func addOperationDescribeActiveReceiptRuleSetStackSlots(stack *middleware.Stack) error {
...
func addOperationDescribeActiveReceiptRuleSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDescribeActiveReceiptRuleSetStackSlots(stack); err != nil {
		return err
	}
