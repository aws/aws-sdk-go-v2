...
func (c *Client) SetReceiptRulePosition(ctx context.Context, params *SetReceiptRulePositionInput, optFns ...func(*Options)) (*SetReceiptRulePositionOutput, error) {
	if params == nil { params = &SetReceiptRulePositionInput{} }
...
func (c *Client) addOperationSetReceiptRulePositionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetReceiptRulePositionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetReceiptRulePositionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetReceiptRulePositionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetReceiptRulePositionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetReceiptRulePositionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetReceiptRulePositionResolveEndpointMiddleware{
