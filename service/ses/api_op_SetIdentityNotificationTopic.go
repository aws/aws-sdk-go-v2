...
func addOperationSetIdentityNotificationTopicStackSlots(stack *middleware.Stack) error {
...
func addOperationSetIdentityNotificationTopicMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationSetIdentityNotificationTopicStackSlots(stack); err != nil {
		return err
	}
