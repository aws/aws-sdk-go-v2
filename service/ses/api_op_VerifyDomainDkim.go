...
// VerifyDomainDkimoperation, the domain that you specify is added to the list of
...
// VerifyDomainIdentityoperation. However, you can't send email from the domain
...
// with one of the tokens that are generated when you execute this operation.
// Replace example.com with your domain. Repeat this process for each token that's
