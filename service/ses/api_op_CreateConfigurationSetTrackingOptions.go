...
func (c *Client) addOperationCreateConfigurationSetTrackingOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateConfigurationSetTrackingOptions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
