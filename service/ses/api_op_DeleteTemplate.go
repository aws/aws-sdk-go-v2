...
func (c *Client) DeleteTemplate(ctx context.Context, params *DeleteTemplateInput, optFns ...func(*Options)) (*DeleteTemplateOutput, error) {
	...
	addawsAwsquery_serdeOpDeleteTemplateMiddlewares(stack)
...
func addawsAwsquery_serdeOpDeleteTemplateMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpDeleteTemplate{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpDeleteTemplate{}, middleware.After)
}
