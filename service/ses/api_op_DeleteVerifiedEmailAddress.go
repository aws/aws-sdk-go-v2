...
func addOperationDeleteVerifiedEmailAddressStackSlots(stack *middleware.Stack) error {
...
func addOperationDeleteVerifiedEmailAddressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDeleteVerifiedEmailAddressStackSlots(stack); err != nil {
		return err
	}
