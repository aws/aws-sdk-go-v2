...
func (c *Client) addOperationDeleteVerifiedEmailAddressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteVerifiedEmailAddress", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
