...
func (c *Client) CreateTemplate(ctx context.Context, params *CreateTemplateInput, optFns ...func(*Options)) (*CreateTemplateOutput, error) {
	...
	addawsAwsquery_serdeOpCreateTemplateMiddlewares(stack)
...
func addawsAwsquery_serdeOpCreateTemplateMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpCreateTemplate{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpCreateTemplate{}, middleware.After)
}
