...
// for email addresses.
//
// This operation is throttled at one request per second and
// can only get DKIM attributes for up to 100 identities at a time. For more
// information about creating DNS records using DKIM tokens, go to the Amazon SES
// Developer Guide
