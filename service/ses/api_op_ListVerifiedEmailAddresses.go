...
func addOperationListVerifiedEmailAddressesStackSlots(stack *middleware.Stack) error {
...
func addOperationListVerifiedEmailAddressesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListVerifiedEmailAddressesStackSlots(stack); err != nil {
		return err
	}
