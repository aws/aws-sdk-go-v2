...
func (c *Client) addOperationSetIdentityMailFromDomainMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "SetIdentityMailFromDomain", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
