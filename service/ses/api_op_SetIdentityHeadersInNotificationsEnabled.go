...
func addOperationSetIdentityHeadersInNotificationsEnabledStackSlots(stack *middleware.Stack) error {
...
func addOperationSetIdentityHeadersInNotificationsEnabledMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationSetIdentityHeadersInNotificationsEnabledStackSlots(stack); err != nil {
		return err
	}
