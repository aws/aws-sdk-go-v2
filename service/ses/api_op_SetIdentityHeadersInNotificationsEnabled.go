...
func (c *Client) SetIdentityHeadersInNotificationsEnabled(ctx context.Context, params *SetIdentityHeadersInNotificationsEnabledInput, optFns ...func(*Options)) (*SetIdentityHeadersInNotificationsEnabledOutput, error) {
	if params == nil { params = &SetIdentityHeadersInNotificationsEnabledInput{} }
...
func (c *Client) addOperationSetIdentityHeadersInNotificationsEnabledMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSetIdentityHeadersInNotificationsEnabledResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSetIdentityHeadersInNotificationsEnabledResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSetIdentityHeadersInNotificationsEnabledResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSetIdentityHeadersInNotificationsEnabledResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSetIdentityHeadersInNotificationsEnabledResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSetIdentityHeadersInNotificationsEnabledResolveEndpointMiddleware{
