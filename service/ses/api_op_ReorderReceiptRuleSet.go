...
func (c *Client) ReorderReceiptRuleSet(ctx context.Context, params *ReorderReceiptRuleSetInput, optFns ...func(*Options)) (*ReorderReceiptRuleSetOutput, error) {
	if params == nil { params = &ReorderReceiptRuleSetInput{} }
...
func (c *Client) addOperationReorderReceiptRuleSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addReorderReceiptRuleSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opReorderReceiptRuleSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opReorderReceiptRuleSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opReorderReceiptRuleSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addReorderReceiptRuleSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opReorderReceiptRuleSetResolveEndpointMiddleware{
