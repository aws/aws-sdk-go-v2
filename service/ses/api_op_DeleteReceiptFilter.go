...
func (*DeleteReceiptFilterInput) operationName() string {
...
func (c *Client) addOperationDeleteReceiptFilterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteReceiptFilterResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteReceiptFilterResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteReceiptFilterResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteReceiptFilterResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteReceiptFilterResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteReceiptFilterResolveEndpointMiddleware{
