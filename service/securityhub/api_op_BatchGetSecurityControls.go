...
func (c *Client) addOperationBatchGetSecurityControlsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetSecurityControls", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
