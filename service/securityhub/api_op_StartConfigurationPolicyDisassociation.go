...
func (c *Client) addOperationStartConfigurationPolicyDisassociationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartConfigurationPolicyDisassociation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
