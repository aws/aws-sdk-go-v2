...
func (c *Client) addOperationListConfigurationPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListConfigurationPolicies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
