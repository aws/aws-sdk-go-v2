...
//
// Other standards
// are not automatically enabled. To opt out of automatically enabled standards,
// set EnableDefaultStandards  to false. After you enable Security Hub, to enable
// a standard, use the BatchEnableStandards operation. To disable a standard, use
// the BatchDisableStandards  operation. To learn more, see the setup information (https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-settingup.html)
