...
func addOperationDisableImportFindingsForProductStackSlots(stack *middleware.Stack) error {
...
func addOperationDisableImportFindingsForProductMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisableImportFindingsForProductStackSlots(stack); err != nil {
		return err
	}
