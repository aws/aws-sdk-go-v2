...
func (c *Client) DisableImportFindingsForProduct(ctx context.Context, params *DisableImportFindingsForProductInput, optFns ...func(*Options)) (*DisableImportFindingsForProductOutput, error) {
	if params == nil { params = &DisableImportFindingsForProductInput{} }
...
func (c *Client) addOperationDisableImportFindingsForProductMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisableImportFindingsForProductResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisableImportFindingsForProductResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisableImportFindingsForProductResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisableImportFindingsForProductResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisableImportFindingsForProductResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisableImportFindingsForProductResolveEndpointMiddleware{
