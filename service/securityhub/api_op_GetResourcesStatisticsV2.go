...
func (c *Client) addOperationGetResourcesStatisticsV2Middlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetResourcesStatisticsV2", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
