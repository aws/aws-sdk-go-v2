...
func (c *Client) addOperationListStandardsControlAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListStandardsControlAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
