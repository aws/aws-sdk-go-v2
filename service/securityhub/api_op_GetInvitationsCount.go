...
func (c *Client) GetInvitationsCount(ctx context.Context, params *GetInvitationsCountInput, optFns ...func(*Options)) (*GetInvitationsCountOutput, error) {
	if params == nil { params = &GetInvitationsCountInput{} }
...
func (c *Client) addOperationGetInvitationsCountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetInvitationsCountResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetInvitationsCountResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetInvitationsCountResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetInvitationsCountResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetInvitationsCountResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetInvitationsCountResolveEndpointMiddleware{
