...
func (c *Client) EnableImportFindingsForProduct(ctx context.Context, params *EnableImportFindingsForProductInput, optFns ...func(*Options)) (*EnableImportFindingsForProductOutput, error) {
	if params == nil { params = &EnableImportFindingsForProductInput{} }
...
func (c *Client) addOperationEnableImportFindingsForProductMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addEnableImportFindingsForProductResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opEnableImportFindingsForProductResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opEnableImportFindingsForProductResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opEnableImportFindingsForProductResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEnableImportFindingsForProductResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opEnableImportFindingsForProductResolveEndpointMiddleware{
