...
// ARN for a standard, use the DescribeStandards operation. For more information,
// see the Security Standards (https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-standards.html)
