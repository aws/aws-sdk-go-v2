...
func (*AcceptInvitationInput) operationName() string {
...
func (c *Client) addOperationAcceptInvitationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAcceptInvitationResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAcceptInvitationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAcceptInvitationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAcceptInvitationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAcceptInvitationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAcceptInvitationResolveEndpointMiddleware{
