...
// practice. Security Hub CSPM runs checks against security controls and generates
...
// findings from other Amazon Web Services services, such as Amazon GuardDuty and
// Amazon Inspector, and supported third-party products. This gives you a single
// pane of glass into a variety of security-related issues. You can also send
// Security Hub CSPM findings to other Amazon Web Services services and supported
...
// findings.
//
// This guide, the Security Hub CSPM API Reference, provides information about the
// Security Hub CSPM API. This includes supported resources, HTTP methods,
// parameters, and schemas. If you're new to Security Hub CSPM, you might find it
// helpful to also review the [Security Hub CSPM User Guide]. The user guide explains key concepts and provides
// procedures that demonstrate how to use Security Hub CSPM features. It also
// provides information about topics such as integrating Security Hub CSPM with
// other Amazon Web Services services.
//
// In addition to interacting with Security Hub CSPM by making calls to the
// Security Hub CSPM API, you can use a current version of an Amazon Web Services
// command line tool or SDK. Amazon Web Services provides tools and SDKs that
// consist of libraries and sample code for various languages and platforms, such
// as PowerShell, Java, Go, Python, C++, and .NET. These tools and SDKs provide
// convenient, programmatic access to Security Hub CSPM and other Amazon Web
// Services services . They also handle tasks such as signing requests, managing
...
// Security Hub CSPM API requests are executed only in the Amazon Web Services
...
// change in other Regions, call the same API operation in each Region in which you
// want to apply the change. When you use central configuration, API requests for
// enabling Security Hub CSPM, standards, and controls are executed in the home
// Region and all linked Regions. For a list of central configuration operations,
// see the [Central configuration terms and concepts]section of the Security Hub CSPM User Guide.
//
