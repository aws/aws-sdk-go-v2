...
func (c *Client) addOperationBatchGetAutomationRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetAutomationRules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
