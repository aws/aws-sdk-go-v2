...
func (c *Client) addOperationListFindingAggregatorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListFindingAggregatorsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListFindingAggregatorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListFindingAggregatorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListFindingAggregatorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListFindingAggregatorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListFindingAggregatorsResolveEndpointMiddleware{
