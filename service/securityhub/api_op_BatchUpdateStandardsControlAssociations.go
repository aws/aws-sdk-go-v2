...
func (c *Client) addOperationBatchUpdateStandardsControlAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchUpdateStandardsControlAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
