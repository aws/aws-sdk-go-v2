...
func (c *Client) ListOrganizationAdminAccounts(ctx context.Context, params *ListOrganizationAdminAccountsInput, optFns ...func(*Options)) (*ListOrganizationAdminAccountsOutput, error) {
	if params == nil { params = &ListOrganizationAdminAccountsInput{} }
...
func (c *Client) addOperationListOrganizationAdminAccountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListOrganizationAdminAccountsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListOrganizationAdminAccountsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListOrganizationAdminAccountsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListOrganizationAdminAccountsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListOrganizationAdminAccountsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListOrganizationAdminAccountsResolveEndpointMiddleware{
