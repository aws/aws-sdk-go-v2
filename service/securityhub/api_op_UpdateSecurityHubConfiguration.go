...
func addOperationUpdateSecurityHubConfigurationStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateSecurityHubConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateSecurityHubConfigurationStackSlots(stack); err != nil {
		return err
	}
