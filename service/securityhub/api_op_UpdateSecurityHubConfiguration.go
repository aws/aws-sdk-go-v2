...
func (c *Client) addOperationUpdateSecurityHubConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateSecurityHubConfiguration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
