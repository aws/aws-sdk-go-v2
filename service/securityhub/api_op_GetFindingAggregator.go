...
func (*GetFindingAggregatorInput) operationName() string {
	return "GetFindingAggregator"
}
...
func (c *Client) addOperationGetFindingAggregatorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetFindingAggregatorResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetFindingAggregatorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetFindingAggregatorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetFindingAggregatorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetFindingAggregatorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetFindingAggregatorResolveEndpointMiddleware{
