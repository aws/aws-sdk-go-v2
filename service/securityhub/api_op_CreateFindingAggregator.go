...
func (c *Client) addOperationCreateFindingAggregatorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateFindingAggregator", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
