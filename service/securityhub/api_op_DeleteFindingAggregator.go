...
func (c *Client) addOperationDeleteFindingAggregatorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteFindingAggregator", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
