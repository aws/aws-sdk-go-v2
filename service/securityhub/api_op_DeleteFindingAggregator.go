...
func (c *Client) DeleteFindingAggregator(ctx context.Context, params *DeleteFindingAggregatorInput, optFns ...func(*Options)) (*DeleteFindingAggregatorOutput, error) {
	if params == nil { params = &DeleteFindingAggregatorInput{} }
...
func (c *Client) addOperationDeleteFindingAggregatorMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteFindingAggregatorResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteFindingAggregatorResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteFindingAggregatorResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteFindingAggregatorResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteFindingAggregatorResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteFindingAggregatorResolveEndpointMiddleware{
