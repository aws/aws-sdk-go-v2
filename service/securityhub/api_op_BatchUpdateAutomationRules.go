...
func (c *Client) addOperationBatchUpdateAutomationRulesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchUpdateAutomationRules", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
