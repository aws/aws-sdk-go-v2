...
func (c *Client) addOperationBatchGetConfigurationPolicyAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "BatchGetConfigurationPolicyAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
