...
// use GetAdministratorAccount. Any IAM policies that specifically control access
// to this function must continue to use GetMasterAccount . You should also add
// GetAdministratorAccountto your policies to ensure that the correct permissions
