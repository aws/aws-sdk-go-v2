...
func (c *Client) addOperationListPrivateGraphEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListPrivateGraphEndpoints", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
