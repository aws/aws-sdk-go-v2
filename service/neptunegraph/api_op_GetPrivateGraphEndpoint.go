...
func (c *Client) addOperationGetPrivateGraphEndpointMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetPrivateGraphEndpoint", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
