...
var bddNodes = [60]int32{
	-1, 1, -1, 0, 19, 3, 1, 4, 100000015, 2, 5, 100000015, 3, 12, 6, 4, 9, 7, 7, 100000013, 8, 8, 100000014, 100000006, 5, 10, 100000012, 7, 100000010, 11, 8, 100000011, 100000006, 4, 15, 13, 6, 14, 100000009, 7, 100000008, 18, 5, 16, 100000007, 6, 17, 100000007, 7, 100000004, 18, 8, 100000005, 100000006, 3, 100000001, 20, 4, 100000002, 100000003}
...
func evalCondition(idx int, params *EndpointParameters, c *conditionContext) bool {
	...
	case 7:
		return *params.ApiType == "ControlPlane"
	case 8:
		return *params.ApiType == "DataPlane"
	}
	return false
}
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 5:
		return smithyendpoints.Endpoint{}, fmt.Errorf("endpoint rule error, %s", "Invalid Configuration: fips endpoint is not supported for this API")
	case 6:
		return smithyendpoints.Endpoint{}, fmt.Errorf("endpoint rule error, %s", "Invalid Configuration: Unknown ApiType")
	case 7:
