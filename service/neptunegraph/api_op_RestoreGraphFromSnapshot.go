...
func (c *Client) addOperationRestoreGraphFromSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RestoreGraphFromSnapshot", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
