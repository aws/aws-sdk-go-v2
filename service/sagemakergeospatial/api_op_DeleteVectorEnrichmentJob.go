...
func (c *Client) addOperationDeleteVectorEnrichmentJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteVectorEnrichmentJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
