...
func (c *Client) addOperationExportEarthObservationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ExportEarthObservationJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
