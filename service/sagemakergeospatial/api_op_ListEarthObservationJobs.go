...
func (c *Client) addOperationListEarthObservationJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListEarthObservationJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
