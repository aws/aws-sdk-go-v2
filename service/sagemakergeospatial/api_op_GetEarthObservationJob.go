...
func (c *Client) GetEarthObservationJob(ctx context.Context, params *GetEarthObservationJobInput, optFns ...func(*Options)) (*GetEarthObservationJobOutput, error) {
	if params == nil { params = &GetEarthObservationJobInput{} }
...
func (c *Client) addOperationGetEarthObservationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetEarthObservationJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetEarthObservationJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetEarthObservationJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetEarthObservationJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetEarthObservationJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetEarthObservationJobResolveEndpointMiddleware{
