...
func (c *Client) addOperationStartVectorEnrichmentJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartVectorEnrichmentJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
