...
func (c *Client) addOperationListVectorEnrichmentJobsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListVectorEnrichmentJobs", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
