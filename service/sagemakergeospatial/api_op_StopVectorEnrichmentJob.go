...
func (c *Client) StopVectorEnrichmentJob(ctx context.Context, params *StopVectorEnrichmentJobInput, optFns ...func(*Options)) (*StopVectorEnrichmentJobOutput, error) {
	if params == nil { params = &StopVectorEnrichmentJobInput{} }
...
func (c *Client) addOperationStopVectorEnrichmentJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopVectorEnrichmentJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopVectorEnrichmentJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopVectorEnrichmentJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopVectorEnrichmentJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopVectorEnrichmentJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopVectorEnrichmentJobResolveEndpointMiddleware{
