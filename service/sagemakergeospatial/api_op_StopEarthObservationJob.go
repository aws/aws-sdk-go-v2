...
func (*StopEarthObservationJobInput) operationName() string {
...
func (c *Client) addOperationStopEarthObservationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopEarthObservationJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opStopEarthObservationJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opStopEarthObservationJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopEarthObservationJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopEarthObservationJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opStopEarthObservationJobResolveEndpointMiddleware{
