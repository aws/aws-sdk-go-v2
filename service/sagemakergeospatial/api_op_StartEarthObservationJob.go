...
func (c *Client) addOperationStartEarthObservationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartEarthObservationJob", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
