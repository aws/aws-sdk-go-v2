...
func (*GetVectorEnrichmentJobInput) operationName() string {
	return "GetVectorEnrichmentJob"
}
...
func (c *Client) addOperationGetVectorEnrichmentJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetVectorEnrichmentJobResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetVectorEnrichmentJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetVectorEnrichmentJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetVectorEnrichmentJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetVectorEnrichmentJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetVectorEnrichmentJobResolveEndpointMiddleware{
