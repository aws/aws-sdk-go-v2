...
func (c *Client) DeleteEarthObservationJob(ctx context.Context, params *DeleteEarthObservationJobInput, optFns ...func(*Options)) (*DeleteEarthObservationJobOutput, error) {
	if params == nil { params = &DeleteEarthObservationJobInput{} }
...
func (c *Client) addOperationDeleteEarthObservationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteEarthObservationJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteEarthObservationJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteEarthObservationJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteEarthObservationJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteEarthObservationJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteEarthObservationJobResolveEndpointMiddleware{
