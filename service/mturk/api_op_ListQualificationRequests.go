...
func (c *Client) addOperationListQualificationRequestsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListQualificationRequests", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
