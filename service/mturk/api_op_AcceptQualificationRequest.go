...
func addOperationAcceptQualificationRequestStackSlots(stack *middleware.Stack) error {
...
func addOperationAcceptQualificationRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAcceptQualificationRequestStackSlots(stack); err != nil {
		return err
	}
