...
func (c *Client) addOperationAssociateQualificationWithWorkerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AssociateQualificationWithWorker", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
