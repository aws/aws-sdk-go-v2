...
func addOperationAssociateQualificationWithWorkerStackSlots(stack *middleware.Stack) error {
...
func addOperationAssociateQualificationWithWorkerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAssociateQualificationWithWorkerStackSlots(stack); err != nil {
		return err
	}
