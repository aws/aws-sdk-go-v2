...
func (c *Client) ListHITsForQualificationTypeRequest(input *ListHITsForQualificationTypeInput) ListHITsForQualificationTypeRequest {
	op := &aws.Operation{
...
func (r ListHITsForQualificationTypeRequest) Send(ctx context.Context) (*ListHITsForQualificationTypeResponse, error) {
	...
	resp := &ListHITsForQualificationTypeResponse{
		ListHITsForQualificationTypeOutput: r.Request.Data.(*ListHITsForQualificationTypeOutput),
...
func (p *ListHITsForQualificationTypePaginator) CurrentPage() *ListHITsForQualificationTypeOutput {
