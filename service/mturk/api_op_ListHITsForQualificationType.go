...
func addOperationListHITsForQualificationTypeStackSlots(stack *middleware.Stack) error {
...
func addOperationListHITsForQualificationTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListHITsForQualificationTypeStackSlots(stack); err != nil {
		return err
	}
