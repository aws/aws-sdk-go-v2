...
func (c *Client) SendTestEventNotification(ctx context.Context, params *SendTestEventNotificationInput, optFns ...func(*Options)) (*SendTestEventNotificationOutput, error) {
	if params == nil { params = &SendTestEventNotificationInput{} }
...
func (c *Client) addOperationSendTestEventNotificationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addSendTestEventNotificationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opSendTestEventNotificationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opSendTestEventNotificationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opSendTestEventNotificationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addSendTestEventNotificationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opSendTestEventNotificationResolveEndpointMiddleware{
