...
func addOperationDisassociateQualificationFromWorkerStackSlots(stack *middleware.Stack) error {
...
func addOperationDisassociateQualificationFromWorkerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationDisassociateQualificationFromWorkerStackSlots(stack); err != nil {
		return err
	}
