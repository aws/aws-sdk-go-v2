...
func (c *Client) addOperationDisassociateQualificationFromWorkerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateQualificationFromWorker", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
