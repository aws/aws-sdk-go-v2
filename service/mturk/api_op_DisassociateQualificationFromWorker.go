...
func (c *Client) DisassociateQualificationFromWorker(ctx context.Context, params *DisassociateQualificationFromWorkerInput, optFns ...func(*Options)) (*DisassociateQualificationFromWorkerOutput, error) {
	if params == nil { params = &DisassociateQualificationFromWorkerInput{} }
...
func (c *Client) addOperationDisassociateQualificationFromWorkerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDisassociateQualificationFromWorkerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDisassociateQualificationFromWorkerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDisassociateQualificationFromWorkerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDisassociateQualificationFromWorkerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDisassociateQualificationFromWorkerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDisassociateQualificationFromWorkerResolveEndpointMiddleware{
