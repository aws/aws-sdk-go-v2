...
func addOperationCreateAdditionalAssignmentsForHITStackSlots(stack *middleware.Stack) error {
...
func addOperationCreateAdditionalAssignmentsForHITMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationCreateAdditionalAssignmentsForHITStackSlots(stack); err != nil {
		return err
	}
