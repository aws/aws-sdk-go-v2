...
func (c *Client) GetHIT(ctx context.Context, params *GetHITInput, optFns ...func(*Options)) (*GetHITOutput, error) {
	if params == nil { params = &GetHITInput{} }
...
func (c *Client) addOperationGetHITMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetHITResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetHITResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetHITResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetHITResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetHITResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetHITResolveEndpointMiddleware{
