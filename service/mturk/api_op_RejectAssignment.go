...
func (c *Client) RejectAssignment(ctx context.Context, params *RejectAssignmentInput, optFns ...func(*Options)) (*RejectAssignmentOutput, error) {
	if params == nil { params = &RejectAssignmentInput{} }
...
func (c *Client) addOperationRejectAssignmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRejectAssignmentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRejectAssignmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRejectAssignmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRejectAssignmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRejectAssignmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRejectAssignmentResolveEndpointMiddleware{
