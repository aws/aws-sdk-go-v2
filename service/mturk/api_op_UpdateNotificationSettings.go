...
func addOperationUpdateNotificationSettingsStackSlots(stack *middleware.Stack) error {
...
func addOperationUpdateNotificationSettingsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationUpdateNotificationSettingsStackSlots(stack); err != nil {
		return err
	}
