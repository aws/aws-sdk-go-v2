...
func (c *Client) GetQualificationType(ctx context.Context, params *GetQualificationTypeInput, optFns ...func(*Options)) (*GetQualificationTypeOutput, error) {
	if params == nil { params = &GetQualificationTypeInput{} }
...
func (c *Client) addOperationGetQualificationTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetQualificationTypeResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetQualificationTypeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetQualificationTypeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetQualificationTypeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetQualificationTypeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetQualificationTypeResolveEndpointMiddleware{
