...
func (c *Client) RejectQualificationRequest(ctx context.Context, params *RejectQualificationRequestInput, optFns ...func(*Options)) (*RejectQualificationRequestOutput, error) {
	if params == nil { params = &RejectQualificationRequestInput{} }
...
func (c *Client) addOperationRejectQualificationRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRejectQualificationRequestResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRejectQualificationRequestResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRejectQualificationRequestResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRejectQualificationRequestResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRejectQualificationRequestResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRejectQualificationRequestResolveEndpointMiddleware{
