...
func (c *Client) addOperationRejectQualificationRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RejectQualificationRequest", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
