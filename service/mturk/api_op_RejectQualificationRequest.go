...
func addOperationRejectQualificationRequestStackSlots(stack *middleware.Stack) error {
...
func addOperationRejectQualificationRequestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationRejectQualificationRequestStackSlots(stack); err != nil {
		return err
	}
