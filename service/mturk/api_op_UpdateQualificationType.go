...
func (c *Client) addOperationUpdateQualificationTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateQualificationType", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
