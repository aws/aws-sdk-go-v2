...
// Amazon MTurk. See this package's package overview docs
...
const (
	ServiceName = "Amazon MTurk"    // Service's name
	ServiceID   = "MTurk"           // Service's identifier
	EndpointsID = "mturk-requester" // Service's Endpoint identifier
)
