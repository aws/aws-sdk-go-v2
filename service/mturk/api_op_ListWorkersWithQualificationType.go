...
func addOperationListWorkersWithQualificationTypeStackSlots(stack *middleware.Stack) error {
...
func addOperationListWorkersWithQualificationTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationListWorkersWithQualificationTypeStackSlots(stack); err != nil {
		return err
	}
