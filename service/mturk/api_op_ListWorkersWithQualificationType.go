...
func (*ListWorkersWithQualificationTypeInput) operationName() string {
...
func (c *Client) addOperationListWorkersWithQualificationTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListWorkersWithQualificationTypeResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListWorkersWithQualificationTypeResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListWorkersWithQualificationTypeResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListWorkersWithQualificationTypeResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListWorkersWithQualificationTypeResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListWorkersWithQualificationTypeResolveEndpointMiddleware{
