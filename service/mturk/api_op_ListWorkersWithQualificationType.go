...
func (c *Client) addOperationListWorkersWithQualificationTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListWorkersWithQualificationType", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
