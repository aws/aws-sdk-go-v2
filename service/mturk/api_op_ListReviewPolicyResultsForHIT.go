...
func (c *Client) ListReviewPolicyResultsForHIT(ctx context.Context, params *ListReviewPolicyResultsForHITInput, optFns ...func(*Options)) (*ListReviewPolicyResultsForHITOutput, error) {
	if params == nil { params = &ListReviewPolicyResultsForHITInput{} }
...
func (c *Client) addOperationListReviewPolicyResultsForHITMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListReviewPolicyResultsForHITResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListReviewPolicyResultsForHITResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListReviewPolicyResultsForHITResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListReviewPolicyResultsForHITResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListReviewPolicyResultsForHITResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListReviewPolicyResultsForHITResolveEndpointMiddleware{
