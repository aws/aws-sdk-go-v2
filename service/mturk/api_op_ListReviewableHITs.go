...
func (c *Client) ListReviewableHITs(ctx context.Context, params *ListReviewableHITsInput, optFns ...func(*Options)) (*ListReviewableHITsOutput, error) {
	if params == nil { params = &ListReviewableHITsInput{} }
...
func (c *Client) addOperationListReviewableHITsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListReviewableHITsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListReviewableHITsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListReviewableHITsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListReviewableHITsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListReviewableHITsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListReviewableHITsResolveEndpointMiddleware{
