...
// you specify a link, it must be associated with the specified device. You can
// only associate customer gateways that are connected to a VPN attachment on a
