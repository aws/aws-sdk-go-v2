...
func (c *Client) addOperationExecuteCoreNetworkChangeSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ExecuteCoreNetworkChangeSet", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
