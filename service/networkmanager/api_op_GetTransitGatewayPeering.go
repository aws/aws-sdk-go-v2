...
func (c *Client) GetTransitGatewayPeering(ctx context.Context, params *GetTransitGatewayPeeringInput, optFns ...func(*Options)) (*GetTransitGatewayPeeringOutput, error) {
	if params == nil { params = &GetTransitGatewayPeeringInput{} }
...
func (c *Client) addOperationGetTransitGatewayPeeringMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTransitGatewayPeeringResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetTransitGatewayPeeringResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetTransitGatewayPeeringResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTransitGatewayPeeringResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTransitGatewayPeeringResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetTransitGatewayPeeringResolveEndpointMiddleware{
