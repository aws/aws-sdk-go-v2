...
func (c *Client) RejectAttachment(ctx context.Context, params *RejectAttachmentInput, optFns ...func(*Options)) (*RejectAttachmentOutput, error) {
	if params == nil { params = &RejectAttachmentInput{} }
...
func (c *Client) addOperationRejectAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addRejectAttachmentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opRejectAttachmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opRejectAttachmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opRejectAttachmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addRejectAttachmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opRejectAttachmentResolveEndpointMiddleware{
