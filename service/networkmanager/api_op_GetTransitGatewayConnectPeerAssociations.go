...
func (c *Client) GetTransitGatewayConnectPeerAssociations(ctx context.Context, params *GetTransitGatewayConnectPeerAssociationsInput, optFns ...func(*Options)) (*GetTransitGatewayConnectPeerAssociationsOutput, error) {
	if params == nil { params = &GetTransitGatewayConnectPeerAssociationsInput{} }
...
func (c *Client) addOperationGetTransitGatewayConnectPeerAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTransitGatewayConnectPeerAssociationsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetTransitGatewayConnectPeerAssociationsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetTransitGatewayConnectPeerAssociationsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTransitGatewayConnectPeerAssociationsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTransitGatewayConnectPeerAssociationsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetTransitGatewayConnectPeerAssociationsResolveEndpointMiddleware{
