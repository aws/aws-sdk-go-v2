...
func (c *Client) ListCoreNetworks(ctx context.Context, params *ListCoreNetworksInput, optFns ...func(*Options)) (*ListCoreNetworksOutput, error) {
	if params == nil { params = &ListCoreNetworksInput{} }
...
func (c *Client) addOperationListCoreNetworksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCoreNetworksResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCoreNetworksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCoreNetworksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCoreNetworksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCoreNetworksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCoreNetworksResolveEndpointMiddleware{
