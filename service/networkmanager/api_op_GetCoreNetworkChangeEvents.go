...
func (*GetCoreNetworkChangeEventsInput) operationName() string {
	return "GetCoreNetworkChangeEvents"
}
...
func (c *Client) addOperationGetCoreNetworkChangeEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCoreNetworkChangeEventsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetCoreNetworkChangeEventsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetCoreNetworkChangeEventsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCoreNetworkChangeEventsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCoreNetworkChangeEventsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetCoreNetworkChangeEventsResolveEndpointMiddleware{
