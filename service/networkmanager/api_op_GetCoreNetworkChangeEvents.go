...
func (c *Client) addOperationGetCoreNetworkChangeEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetCoreNetworkChangeEvents", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
