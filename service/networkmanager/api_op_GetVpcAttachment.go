...
func (c *Client) GetVpcAttachment(ctx context.Context, params *GetVpcAttachmentInput, optFns ...func(*Options)) (*GetVpcAttachmentOutput, error) {
	if params == nil { params = &GetVpcAttachmentInput{} }
...
func (c *Client) addOperationGetVpcAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetVpcAttachmentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetVpcAttachmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetVpcAttachmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetVpcAttachmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetVpcAttachmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetVpcAttachmentResolveEndpointMiddleware{
