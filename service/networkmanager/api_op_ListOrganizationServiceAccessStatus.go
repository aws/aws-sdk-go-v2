...
func (c *Client) ListOrganizationServiceAccessStatus(ctx context.Context, params *ListOrganizationServiceAccessStatusInput, optFns ...func(*Options)) (*ListOrganizationServiceAccessStatusOutput, error) {
	if params == nil { params = &ListOrganizationServiceAccessStatusInput{} }
...
func (c *Client) addOperationListOrganizationServiceAccessStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListOrganizationServiceAccessStatusResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListOrganizationServiceAccessStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListOrganizationServiceAccessStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListOrganizationServiceAccessStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListOrganizationServiceAccessStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListOrganizationServiceAccessStatusResolveEndpointMiddleware{
