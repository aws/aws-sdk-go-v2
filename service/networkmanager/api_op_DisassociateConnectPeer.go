...
func (c *Client) addOperationDisassociateConnectPeerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateConnectPeer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
