...
func (c *Client) GetSiteToSiteVpnAttachment(ctx context.Context, params *GetSiteToSiteVpnAttachmentInput, optFns ...func(*Options)) (*GetSiteToSiteVpnAttachmentOutput, error) {
	if params == nil { params = &GetSiteToSiteVpnAttachmentInput{} }
...
func (c *Client) addOperationGetSiteToSiteVpnAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSiteToSiteVpnAttachmentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSiteToSiteVpnAttachmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSiteToSiteVpnAttachmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSiteToSiteVpnAttachmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSiteToSiteVpnAttachmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSiteToSiteVpnAttachmentResolveEndpointMiddleware{
