...
func (c *Client) addOperationGetConnectPeerAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetConnectPeerAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
