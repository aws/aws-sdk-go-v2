...
func (c *Client) GetConnectPeer(ctx context.Context, params *GetConnectPeerInput, optFns ...func(*Options)) (*GetConnectPeerOutput, error) {
	if params == nil { params = &GetConnectPeerInput{} }
...
func (c *Client) addOperationGetConnectPeerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetConnectPeerResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetConnectPeerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetConnectPeerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetConnectPeerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetConnectPeerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetConnectPeerResolveEndpointMiddleware{
