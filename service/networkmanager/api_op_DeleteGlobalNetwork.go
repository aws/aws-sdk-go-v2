...
func (*DeleteGlobalNetworkInput) operationName() string {
...
func (c *Client) addOperationDeleteGlobalNetworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteGlobalNetworkResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteGlobalNetworkResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteGlobalNetworkResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteGlobalNetworkResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteGlobalNetworkResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteGlobalNetworkResolveEndpointMiddleware{
