...
func (*AssociateTransitGatewayConnectPeerInput) operationName() string {
...
func (c *Client) addOperationAssociateTransitGatewayConnectPeerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAssociateTransitGatewayConnectPeerResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAssociateTransitGatewayConnectPeerResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAssociateTransitGatewayConnectPeerResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAssociateTransitGatewayConnectPeerResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAssociateTransitGatewayConnectPeerResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAssociateTransitGatewayConnectPeerResolveEndpointMiddleware{
