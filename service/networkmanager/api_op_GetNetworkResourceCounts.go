...
func (c *Client) addOperationGetNetworkResourceCountsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetNetworkResourceCountsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetNetworkResourceCountsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetNetworkResourceCountsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetNetworkResourceCountsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetNetworkResourceCountsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetNetworkResourceCountsResolveEndpointMiddleware{
