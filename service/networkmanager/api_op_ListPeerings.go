...
func (c *Client) ListPeerings(ctx context.Context, params *ListPeeringsInput, optFns ...func(*Options)) (*ListPeeringsOutput, error) {
	if params == nil { params = &ListPeeringsInput{} }
...
func (c *Client) addOperationListPeeringsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListPeeringsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListPeeringsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListPeeringsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListPeeringsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListPeeringsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListPeeringsResolveEndpointMiddleware{
