...
func (c *Client) ListConnectPeers(ctx context.Context, params *ListConnectPeersInput, optFns ...func(*Options)) (*ListConnectPeersOutput, error) {
	if params == nil { params = &ListConnectPeersInput{} }
...
func (c *Client) addOperationListConnectPeersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListConnectPeersResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListConnectPeersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListConnectPeersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListConnectPeersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListConnectPeersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListConnectPeersResolveEndpointMiddleware{
