...
func (c *Client) DeletePeering(ctx context.Context, params *DeletePeeringInput, optFns ...func(*Options)) (*DeletePeeringOutput, error) {
	if params == nil { params = &DeletePeeringInput{} }
...
func (c *Client) addOperationDeletePeeringMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeletePeeringResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeletePeeringResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeletePeeringResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeletePeeringResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeletePeeringResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeletePeeringResolveEndpointMiddleware{
