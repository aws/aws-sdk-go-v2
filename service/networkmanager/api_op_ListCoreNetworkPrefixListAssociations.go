...
func (c *Client) addOperationListCoreNetworkPrefixListAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCoreNetworkPrefixListAssociations", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
