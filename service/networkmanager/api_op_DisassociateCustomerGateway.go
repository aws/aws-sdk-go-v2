...
func (c *Client) addOperationDisassociateCustomerGatewayMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateCustomerGateway", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
