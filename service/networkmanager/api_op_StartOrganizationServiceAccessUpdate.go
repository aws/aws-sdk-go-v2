...
func (c *Client) addOperationStartOrganizationServiceAccessUpdateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartOrganizationServiceAccessUpdate", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
