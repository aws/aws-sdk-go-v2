...
func (c *Client) StartOrganizationServiceAccessUpdate(ctx context.Context, params *StartOrganizationServiceAccessUpdateInput, optFns ...func(*Options)) (*StartOrganizationServiceAccessUpdateOutput, error) {
	if params == nil { params = &StartOrganizationServiceAccessUpdateInput{} }
...
func (c *Client) addOperationStartOrganizationServiceAccessUpdateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartOrganizationServiceAccessUpdateResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartOrganizationServiceAccessUpdateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartOrganizationServiceAccessUpdateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartOrganizationServiceAccessUpdateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartOrganizationServiceAccessUpdateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartOrganizationServiceAccessUpdateResolveEndpointMiddleware{
