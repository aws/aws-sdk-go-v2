...
func (c *Client) addOperationListCoreNetworkPolicyVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListCoreNetworkPolicyVersions", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
