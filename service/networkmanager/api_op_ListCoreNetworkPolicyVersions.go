...
func (c *Client) ListCoreNetworkPolicyVersions(ctx context.Context, params *ListCoreNetworkPolicyVersionsInput, optFns ...func(*Options)) (*ListCoreNetworkPolicyVersionsOutput, error) {
	if params == nil { params = &ListCoreNetworkPolicyVersionsInput{} }
...
func (c *Client) addOperationListCoreNetworkPolicyVersionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCoreNetworkPolicyVersionsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCoreNetworkPolicyVersionsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCoreNetworkPolicyVersionsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCoreNetworkPolicyVersionsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCoreNetworkPolicyVersionsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCoreNetworkPolicyVersionsResolveEndpointMiddleware{
