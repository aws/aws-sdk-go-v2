...
func (c *Client) GetSites(ctx context.Context, params *GetSitesInput, optFns ...func(*Options)) (*GetSitesOutput, error) {
	if params == nil { params = &GetSitesInput{} }
...
func (c *Client) addOperationGetSitesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSitesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetSitesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetSitesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSitesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSitesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetSitesResolveEndpointMiddleware{
