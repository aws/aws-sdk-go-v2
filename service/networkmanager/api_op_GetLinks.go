...
func (c *Client) GetLinks(ctx context.Context, params *GetLinksInput, optFns ...func(*Options)) (*GetLinksOutput, error) {
	if params == nil { params = &GetLinksInput{} }
...
func (c *Client) addOperationGetLinksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetLinksResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetLinksResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetLinksResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetLinksResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetLinksResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetLinksResolveEndpointMiddleware{
