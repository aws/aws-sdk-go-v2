...
func (c *Client) UpdateCoreNetwork(ctx context.Context, params *UpdateCoreNetworkInput, optFns ...func(*Options)) (*UpdateCoreNetworkOutput, error) {
	if params == nil { params = &UpdateCoreNetworkInput{} }
...
func (c *Client) addOperationUpdateCoreNetworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addUpdateCoreNetworkResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opUpdateCoreNetworkResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opUpdateCoreNetworkResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opUpdateCoreNetworkResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addUpdateCoreNetworkResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opUpdateCoreNetworkResolveEndpointMiddleware{
