...
func (c *Client) addOperationCreateConnectAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateConnectAttachment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
