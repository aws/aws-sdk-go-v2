...
func (*DeleteCoreNetworkInput) operationName() string {
...
func (c *Client) addOperationDeleteCoreNetworkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCoreNetworkResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteCoreNetworkResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteCoreNetworkResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCoreNetworkResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCoreNetworkResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteCoreNetworkResolveEndpointMiddleware{
