...
func (c *Client) addOperationCreateSiteToSiteVpnAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CreateSiteToSiteVpnAttachment", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
