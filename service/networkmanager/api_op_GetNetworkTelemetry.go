...
func (c *Client) GetNetworkTelemetry(ctx context.Context, params *GetNetworkTelemetryInput, optFns ...func(*Options)) (*GetNetworkTelemetryOutput, error) {
	if params == nil { params = &GetNetworkTelemetryInput{} }
...
func (c *Client) addOperationGetNetworkTelemetryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetNetworkTelemetryResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetNetworkTelemetryResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetNetworkTelemetryResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetNetworkTelemetryResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetNetworkTelemetryResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetNetworkTelemetryResolveEndpointMiddleware{
