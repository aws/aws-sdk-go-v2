...
func (c *Client) addOperationRemoveAttachmentRoutingPolicyLabelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "RemoveAttachmentRoutingPolicyLabel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
