...
func addOperationGetCustomerGatewayAssociationsStackSlots(stack *middleware.Stack) error {
...
func addOperationGetCustomerGatewayAssociationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetCustomerGatewayAssociationsStackSlots(stack); err != nil {
		return err
	}
