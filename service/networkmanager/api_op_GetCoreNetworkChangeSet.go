...
func (c *Client) GetCoreNetworkChangeSet(ctx context.Context, params *GetCoreNetworkChangeSetInput, optFns ...func(*Options)) (*GetCoreNetworkChangeSetOutput, error) {
	if params == nil { params = &GetCoreNetworkChangeSetInput{} }
...
func (c *Client) addOperationGetCoreNetworkChangeSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCoreNetworkChangeSetResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCoreNetworkChangeSetResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCoreNetworkChangeSetResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCoreNetworkChangeSetResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCoreNetworkChangeSetResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCoreNetworkChangeSetResolveEndpointMiddleware{
