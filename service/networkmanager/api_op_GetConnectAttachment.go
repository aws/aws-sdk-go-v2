...
func (c *Client) GetConnectAttachment(ctx context.Context, params *GetConnectAttachmentInput, optFns ...func(*Options)) (*GetConnectAttachmentOutput, error) {
	if params == nil { params = &GetConnectAttachmentInput{} }
...
func (c *Client) addOperationGetConnectAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetConnectAttachmentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetConnectAttachmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetConnectAttachmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetConnectAttachmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetConnectAttachmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetConnectAttachmentResolveEndpointMiddleware{
