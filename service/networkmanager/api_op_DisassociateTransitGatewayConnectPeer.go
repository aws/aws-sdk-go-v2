...
func (c *Client) addOperationDisassociateTransitGatewayConnectPeerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DisassociateTransitGatewayConnectPeer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
