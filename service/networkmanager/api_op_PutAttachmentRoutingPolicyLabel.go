...
func (c *Client) addOperationPutAttachmentRoutingPolicyLabelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "PutAttachmentRoutingPolicyLabel", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
