...
func (c *Client) addOperationDeleteCoreNetworkPolicyVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteCoreNetworkPolicyVersion", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
