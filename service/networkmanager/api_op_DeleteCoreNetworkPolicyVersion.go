...
func (c *Client) DeleteCoreNetworkPolicyVersion(ctx context.Context, params *DeleteCoreNetworkPolicyVersionInput, optFns ...func(*Options)) (*DeleteCoreNetworkPolicyVersionOutput, error) {
	if params == nil { params = &DeleteCoreNetworkPolicyVersionInput{} }
...
func (c *Client) addOperationDeleteCoreNetworkPolicyVersionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteCoreNetworkPolicyVersionResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opDeleteCoreNetworkPolicyVersionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opDeleteCoreNetworkPolicyVersionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteCoreNetworkPolicyVersionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteCoreNetworkPolicyVersionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opDeleteCoreNetworkPolicyVersionResolveEndpointMiddleware{
