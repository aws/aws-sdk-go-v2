...
func (c *Client) GetTransitGatewayRouteTableAttachment(ctx context.Context, params *GetTransitGatewayRouteTableAttachmentInput, optFns ...func(*Options)) (*GetTransitGatewayRouteTableAttachmentOutput, error) {
	if params == nil { params = &GetTransitGatewayRouteTableAttachmentInput{} }
...
func (c *Client) addOperationGetTransitGatewayRouteTableAttachmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetTransitGatewayRouteTableAttachmentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetTransitGatewayRouteTableAttachmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetTransitGatewayRouteTableAttachmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetTransitGatewayRouteTableAttachmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetTransitGatewayRouteTableAttachmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetTransitGatewayRouteTableAttachmentResolveEndpointMiddleware{
