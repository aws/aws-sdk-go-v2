...
func (c *Client) StopAssessment(ctx context.Context, params *StopAssessmentInput, optFns ...func(*Options)) (*StopAssessmentOutput, error) {
	if params == nil { params = &StopAssessmentInput{} }
...
func (c *Client) addOperationStopAssessmentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStopAssessmentResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStopAssessmentResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStopAssessmentResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStopAssessmentResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStopAssessmentResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStopAssessmentResolveEndpointMiddleware{
