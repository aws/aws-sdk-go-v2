...
func (c *Client) GetServerStrategies(ctx context.Context, params *GetServerStrategiesInput, optFns ...func(*Options)) (*GetServerStrategiesOutput, error) {
	if params == nil { params = &GetServerStrategiesInput{} }
...
func (c *Client) addOperationGetServerStrategiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetServerStrategiesResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetServerStrategiesResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetServerStrategiesResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetServerStrategiesResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetServerStrategiesResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetServerStrategiesResolveEndpointMiddleware{
