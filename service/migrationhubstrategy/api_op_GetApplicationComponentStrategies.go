...
func (c *Client) addOperationGetApplicationComponentStrategiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetApplicationComponentStrategies", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
