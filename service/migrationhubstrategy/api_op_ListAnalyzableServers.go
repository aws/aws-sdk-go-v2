...
func (c *Client) addOperationListAnalyzableServersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListAnalyzableServersResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListAnalyzableServersResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListAnalyzableServersResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListAnalyzableServersResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListAnalyzableServersResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListAnalyzableServersResolveEndpointMiddleware{
