...
func (c *Client) ListImportFileTask(ctx context.Context, params *ListImportFileTaskInput, optFns ...func(*Options)) (*ListImportFileTaskOutput, error) {
	if params == nil { params = &ListImportFileTaskInput{} }
...
func (c *Client) addOperationListImportFileTaskMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListImportFileTaskResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListImportFileTaskResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListImportFileTaskResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListImportFileTaskResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListImportFileTaskResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListImportFileTaskResolveEndpointMiddleware{
