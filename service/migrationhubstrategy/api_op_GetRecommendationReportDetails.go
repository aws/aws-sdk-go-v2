...
func (c *Client) addOperationGetRecommendationReportDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetRecommendationReportDetails", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
