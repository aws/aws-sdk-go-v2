...
func (c *Client) ListCollectors(ctx context.Context, params *ListCollectorsInput, optFns ...func(*Options)) (*ListCollectorsOutput, error) {
	if params == nil { params = &ListCollectorsInput{} }
...
func (c *Client) addOperationListCollectorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListCollectorsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opListCollectorsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opListCollectorsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListCollectorsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListCollectorsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opListCollectorsResolveEndpointMiddleware{
