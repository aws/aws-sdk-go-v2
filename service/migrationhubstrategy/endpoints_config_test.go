...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-migrationhubstrategy.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-migrationhubstrategy.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-migrationhubstrategy.dev",
			expectURL:     aws.String("https://env-migrationhubstrategy.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-migrationhubstrategy.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-migrationhubstrategy.dev",
			expectURL:     aws.String("http://config-migrationhubstrategy.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-migrationhubstrategy.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-migrationhubstrategy.dev",
			clientEndpoint: aws.String("https://client-migrationhubstrategy.dev"),
			expectURL:      aws.String("https://client-migrationhubstrategy.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MIGRATIONHUBSTRATEGY", c.envService)
			}
