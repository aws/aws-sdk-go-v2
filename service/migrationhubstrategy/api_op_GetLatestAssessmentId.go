...
func (c *Client) GetLatestAssessmentId(ctx context.Context, params *GetLatestAssessmentIdInput, optFns ...func(*Options)) (*GetLatestAssessmentIdOutput, error) {
	if params == nil { params = &GetLatestAssessmentIdInput{} }
...
func (c *Client) addOperationGetLatestAssessmentIdMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetLatestAssessmentIdResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetLatestAssessmentIdResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetLatestAssessmentIdResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetLatestAssessmentIdResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetLatestAssessmentIdResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetLatestAssessmentIdResolveEndpointMiddleware{
