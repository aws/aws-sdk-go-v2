...
func (c *Client) StartRecommendationReportGeneration(ctx context.Context, params *StartRecommendationReportGenerationInput, optFns ...func(*Options)) (*StartRecommendationReportGenerationOutput, error) {
	if params == nil { params = &StartRecommendationReportGenerationInput{} }
...
func (c *Client) addOperationStartRecommendationReportGenerationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartRecommendationReportGenerationResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartRecommendationReportGenerationResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartRecommendationReportGenerationResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartRecommendationReportGenerationResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartRecommendationReportGenerationResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartRecommendationReportGenerationResolveEndpointMiddleware{
