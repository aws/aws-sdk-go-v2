...
func (c *Client) addOperationStartRecommendationReportGenerationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StartRecommendationReportGeneration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
