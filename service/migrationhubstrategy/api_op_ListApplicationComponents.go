...
func (c *Client) addOperationListApplicationComponentsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListApplicationComponents", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
