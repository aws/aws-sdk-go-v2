...
func (c *Client) addOperationUpdateApplicationComponentConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateApplicationComponentConfig", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
