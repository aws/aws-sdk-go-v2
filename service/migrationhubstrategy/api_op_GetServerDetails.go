...
func (c *Client) GetServerDetails(ctx context.Context, params *GetServerDetailsInput, optFns ...func(*Options)) (*GetServerDetailsOutput, error) {
	if params == nil { params = &GetServerDetailsInput{} }
...
func (c *Client) addOperationGetServerDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetServerDetailsResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetServerDetailsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetServerDetailsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetServerDetailsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetServerDetailsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetServerDetailsResolveEndpointMiddleware{
