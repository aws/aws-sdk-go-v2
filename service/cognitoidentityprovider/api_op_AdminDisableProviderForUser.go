...
func addOperationAdminDisableProviderForUserStackSlots(stack *middleware.Stack) error {
...
func addOperationAdminDisableProviderForUserMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAdminDisableProviderForUserStackSlots(stack); err != nil {
		return err
	}
