...
type InitiateAuthInput struct {
	...
	//     - Pre authentication
	//     - User migration
	// When Amazon Cognito invokes the functions for these
	// triggers, it passes a JSON payload, which the function receives as input. This
	// payload contains a validationData attribute, which provides the data that you
	// assigned to the ClientMetadata parameter in your InitiateAuth request. In your
	// function code in Lambda, you can process the validationData value to enhance
	// your workflow for your specific needs. When you use the InitiateAuth API action,
