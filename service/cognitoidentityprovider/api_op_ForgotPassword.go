...
func (c *Client) ForgotPassword(ctx context.Context, params *ForgotPasswordInput, optFns ...func(*Options)) (*ForgotPasswordOutput, error) {
	if params == nil { params = &ForgotPasswordInput{} }
...
func (c *Client) addOperationForgotPasswordMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addForgotPasswordResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opForgotPasswordResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opForgotPasswordResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opForgotPasswordResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addForgotPasswordResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opForgotPasswordResolveEndpointMiddleware{
