...
func (c *Client) addOperationAddUserPoolClientSecretMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AddUserPoolClientSecret", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
