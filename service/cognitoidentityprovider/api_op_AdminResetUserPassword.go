...
// June 1, 2021, U.S. telecom carriers require that you register an origination
// phone number before you can send SMS messages to U.S. phone numbers. If you use
// SMS text messages in Amazon Cognito, you must register a phone number with
// Amazon Pinpoint (https://console.aws.amazon.com/pinpoint/home/). Cognito will
// use the the registered number automatically. Otherwise, Cognito users that must
...
// other AWS service, Amazon SNS might place your account in SMS sandbox. In
...
// numbers. After testing in the sandbox environment, you can move out of the SMS
// sandbox and into production. For more information, see  SMS message settings for
// Cognito User Pools
