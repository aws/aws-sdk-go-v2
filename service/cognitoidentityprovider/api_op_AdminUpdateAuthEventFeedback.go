...
func (*AdminUpdateAuthEventFeedbackInput) operationName() string {
...
func (c *Client) addOperationAdminUpdateAuthEventFeedbackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAdminUpdateAuthEventFeedbackResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opAdminUpdateAuthEventFeedbackResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opAdminUpdateAuthEventFeedbackResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAdminUpdateAuthEventFeedbackResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAdminUpdateAuthEventFeedbackResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opAdminUpdateAuthEventFeedbackResolveEndpointMiddleware{
