...
func (c *Client) addOperationAdminUpdateAuthEventFeedbackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AdminUpdateAuthEventFeedback", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
