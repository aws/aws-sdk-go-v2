...
func (c *Client) addOperationAdminSetUserMFAPreferenceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AdminSetUserMFAPreference", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
