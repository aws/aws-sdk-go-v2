...
func (c *Client) addOperationAdminListUserAuthEventsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AdminListUserAuthEvents", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
