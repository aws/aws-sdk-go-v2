...
func (*DeleteUserPoolClientInput) operationName() string {
...
func (c *Client) addOperationDeleteUserPoolClientMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addDeleteUserPoolClientResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opDeleteUserPoolClientResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opDeleteUserPoolClientResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opDeleteUserPoolClientResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addDeleteUserPoolClientResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opDeleteUserPoolClientResolveEndpointMiddleware{
