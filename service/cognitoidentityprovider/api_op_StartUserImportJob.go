...
func (c *Client) StartUserImportJob(ctx context.Context, params *StartUserImportJobInput, optFns ...func(*Options)) (*StartUserImportJobOutput, error) {
	if params == nil { params = &StartUserImportJobInput{} }
...
func (c *Client) addOperationStartUserImportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addStartUserImportJobResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opStartUserImportJobResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opStartUserImportJobResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opStartUserImportJobResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addStartUserImportJobResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opStartUserImportJobResolveEndpointMiddleware{
