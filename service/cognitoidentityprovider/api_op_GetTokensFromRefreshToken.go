...
func (c *Client) addOperationGetTokensFromRefreshTokenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetTokensFromRefreshToken", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
