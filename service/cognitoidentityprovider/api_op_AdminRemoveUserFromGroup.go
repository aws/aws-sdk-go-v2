...
func (c *Client) AdminRemoveUserFromGroup(ctx context.Context, params *AdminRemoveUserFromGroupInput, optFns ...func(*Options)) (*AdminRemoveUserFromGroupOutput, error) {
	if params == nil { params = &AdminRemoveUserFromGroupInput{} }
...
func (c *Client) addOperationAdminRemoveUserFromGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAdminRemoveUserFromGroupResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAdminRemoveUserFromGroupResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAdminRemoveUserFromGroupResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAdminRemoveUserFromGroupResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAdminRemoveUserFromGroupResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAdminRemoveUserFromGroupResolveEndpointMiddleware{
