...
func (c *Client) addOperationAdminRemoveUserFromGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AdminRemoveUserFromGroup", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
