...
func addOperationAdminRespondToAuthChallengeStackSlots(stack *middleware.Stack) error {
...
func addOperationAdminRespondToAuthChallengeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationAdminRespondToAuthChallengeStackSlots(stack); err != nil {
		return err
	}
