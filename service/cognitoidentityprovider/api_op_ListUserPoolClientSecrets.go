...
func (c *Client) addOperationListUserPoolClientSecretsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "ListUserPoolClientSecrets", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
