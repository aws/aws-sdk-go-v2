...
func (c *Client) addOperationListUserPoolsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListUserPoolsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListUserPoolsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListUserPoolsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListUserPoolsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListUserPoolsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListUserPoolsResolveEndpointMiddleware{
