...
func (c *Client) addOperationDeleteWebAuthnCredentialMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteWebAuthnCredential", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
