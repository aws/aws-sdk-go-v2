...
func (c *Client) addOperationUpdateManagedLoginBrandingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "UpdateManagedLoginBranding", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
