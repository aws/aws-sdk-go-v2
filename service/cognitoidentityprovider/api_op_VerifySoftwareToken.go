...
func (c *Client) VerifySoftwareToken(ctx context.Context, params *VerifySoftwareTokenInput, optFns ...func(*Options)) (*VerifySoftwareTokenOutput, error) {
	if params == nil { params = &VerifySoftwareTokenInput{} }
...
func (c *Client) addOperationVerifySoftwareTokenMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addVerifySoftwareTokenResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opVerifySoftwareTokenResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opVerifySoftwareTokenResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opVerifySoftwareTokenResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addVerifySoftwareTokenResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opVerifySoftwareTokenResolveEndpointMiddleware{
