...
func addOperationGetUserAttributeVerificationCodeStackSlots(stack *middleware.Stack) error {
...
func addOperationGetUserAttributeVerificationCodeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationGetUserAttributeVerificationCodeStackSlots(stack); err != nil {
		return err
	}
