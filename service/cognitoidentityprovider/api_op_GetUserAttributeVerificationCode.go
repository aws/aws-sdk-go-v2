...
func (c *Client) addOperationGetUserAttributeVerificationCodeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "GetUserAttributeVerificationCode", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
