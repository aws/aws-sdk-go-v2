...
func (c *Client) addOperationAdminUpdateDeviceStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AdminUpdateDeviceStatus", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
