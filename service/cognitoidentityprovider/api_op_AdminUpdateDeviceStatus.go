...
func (c *Client) AdminUpdateDeviceStatus(ctx context.Context, params *AdminUpdateDeviceStatusInput, optFns ...func(*Options)) (*AdminUpdateDeviceStatusOutput, error) {
	if params == nil { params = &AdminUpdateDeviceStatusInput{} }
...
func (c *Client) addOperationAdminUpdateDeviceStatusMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addAdminUpdateDeviceStatusResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opAdminUpdateDeviceStatusResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opAdminUpdateDeviceStatusResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opAdminUpdateDeviceStatusResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addAdminUpdateDeviceStatusResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opAdminUpdateDeviceStatusResolveEndpointMiddleware{
