...
func (c *Client) addOperationAdminDeleteUserAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "AdminDeleteUserAttributes", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
