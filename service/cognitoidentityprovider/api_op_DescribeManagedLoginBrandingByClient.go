...
func (c *Client) addOperationDescribeManagedLoginBrandingByClientMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeManagedLoginBrandingByClient", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
