...
func (c *Client) GetCSVHeader(ctx context.Context, params *GetCSVHeaderInput, optFns ...func(*Options)) (*GetCSVHeaderOutput, error) {
	if params == nil { params = &GetCSVHeaderInput{} }
...
func (c *Client) addOperationGetCSVHeaderMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetCSVHeaderResolveEndpointMiddleware(stack, options); err != nil {
	return err
	}
...
type opGetCSVHeaderResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver builtInParameterResolver
}

func (*opGetCSVHeaderResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetCSVHeaderResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetCSVHeaderResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
    return stack.Serialize.Insert(&opGetCSVHeaderResolveEndpointMiddleware{
