...
func (c *Client) addOperationCompleteWebAuthnRegistrationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CompleteWebAuthnRegistration", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
