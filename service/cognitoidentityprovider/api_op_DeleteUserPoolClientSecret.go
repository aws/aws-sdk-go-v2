...
func (c *Client) addOperationDeleteUserPoolClientSecretMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DeleteUserPoolClientSecret", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
