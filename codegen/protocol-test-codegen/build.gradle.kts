...
// Serde-benchmark services generate into service/serdbenchmark/ (not
// internal/protocoltest/). Map of service shape ID -> module folder. Their
// httpRequest/ResponseTests are tagged "serde-benchmark", which the protocol
// test generator turns into ser/deser benchmark functions.
val benchmarkModulePrefix = "github.com/aws/aws-sdk-go-v2/service/serdbenchmark"
