...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/signin v1.7.0
	github.com/aws/aws-sdk-go-v2/service/sso v1.35.0
	github.com/aws/aws-sdk-go-v2/service/ssooidc v1.40.0
