...
// Version                bool   // @DynamoDBAV = `dynamodbav:",version"`
// PreserveEmpty          bool   // @DynamoDBAV = `dynamodbav:",preserveempty"`
// JSON                   bool   // @DynamoDBAV = `dynamodbav:",json"`
// AutoGeneratedKey       bool   // @DynamoDBAV = `dynamodbav:",autogeneratedkey"`
// AtomicCounter          bool   // @DynamoDBAV = `dynamodbav:",atomiccounter"`
// AutoGeneratedTimestamp bool   // @DynamoDBAV = `dynamodbav:",autogeneratedtimestamp"`
// EnumAsString           bool   // @DynamoDBAV = `dynamodbav:",enumasstring"`
// Partition                bool   // @DynamoDBAV = `dynamodbav:",partition"`
// Sort                   bool   // @DynamoDBAV = `dynamodbav:",sort"`
...
func TestDecodeVersion(t *testing.T) {
	...
	for i, c := range cases {
		t.Run(fmt.Sprintf("%d", i), func(t *testing.T) {
			...
			if diff := cmpDiff(av, c.expected); len(diff) != 0 {
...
func TestDecodePreserveEmpty(t *testing.T)          {}
func TestDecodeJSON(t *testing.T)                   {}
func TestDecodeAutoGeneratedKey(t *testing.T)       {}
func TestDecodeAtomicCounter(t *testing.T)          {}
func TestDecodeAutoGeneratedTimestamp(t *testing.T) {}
