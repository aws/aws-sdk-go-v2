...
func Test_New_Unmarshal(t *testing.T) {
	...
	for name, test := range marshalerScalarInputs {
		t.Run(name, func(t *testing.T) {
			...
			if err := Unmarshal[any](test.expected.(types.AttributeValue), actual); err != nil {
...
func Test_New_UnmarshalError(t *testing.T) {
	...
	if err := Unmarshal[any](nil, nil); err == nil {
	...
	if err := Unmarshal[any](nil, actual); err == nil {
	...
	if err := Unmarshal[any](nil, actual2); err == nil {
...
func Test_New_UnmarshalMapError(t *testing.T) {
	...
	expected := &InvalidUnmarshalError{Type: reflect.TypeOf(nil)}
	if err := UnmarshalMap[any](nil, nil); err == nil {
...
func Test_New_UnmarshalListError(t *testing.T) {
	...
	expected := &InvalidUnmarshalError{Type: reflect.TypeOf(nil)}
	if err := UnmarshalList[any](nil, nil); err == nil {
...
func BenchmarkUnmarshalOneMember(b *testing.B) {
	...
	b.RunParallel(func(pb *testing.PB) {
		for pb.Next() {
			if err := Unmarshal[any](&types.AttributeValueMemberM{Value: avMap}, &out); err != nil {
				b.Error("unexpected error:", err)
			}
		}
	})
...
func Test_Encode_YAML_TagKey(t *testing.T) {
	...
	enc := NewEncoder[any](func(o *EncoderOptions) {
		o.TagKey = "yaml"
	})
