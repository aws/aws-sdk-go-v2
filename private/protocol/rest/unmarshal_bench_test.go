...
func BenchmarkRESTUnmarshal_Short(b *testing.B) {
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Unmarshal(getRESTResponse_ShortREST())
	}
}
...
func BenchmarkRESTUnmarshal_Long(b *testing.B) {
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Unmarshal(getRESTResponse_LongREST())
	}
}
...
func getRESTResponse_ShortREST() *aws.Request {
...
func getRESTResponse_LongREST() *aws.Request {
