...
// RESTJSONService. See this package's package overview docs
...
const (
	ServiceName = "RESTJSONService" // Service's name
	ServiceID   = "RESTJSONService" // Service's identifier
	EndpointsID = "restjsonservice" // Service's Endpoint identifier
)
...
//     svc := restjsonservice.New(myConfig)
