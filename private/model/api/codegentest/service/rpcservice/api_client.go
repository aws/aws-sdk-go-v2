...
// RPCService. See this package's package overview docs
...
const (
	ServiceName = "RPCService" // Service's name
	ServiceID   = "RPCService" // Service's identifier
	EndpointsID = "rpcservice" // Service's Endpoint identifier
)
