...
### SDK Enhancements
* `private/model/api`: Adds support for TimestampFormat in Protocols ([#358](https://github.com/aws/aws-sdk-go-v2/pull/358))
    * Adds code generation logic for TimestampFormat in protocols.
