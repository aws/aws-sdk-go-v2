...
func TestCheckSnapshot_GetStreamingResource(t *testing.T) {
	svc := New(Options{})
	_, err := svc.GetStreamingResource(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
			return testSnapshot(stack, "GetStreamingResource")
		})
	})
	if _, ok := err.(snapshotOK); !ok && err != nil {
		t.Fatal(err)
...
func TestUpdateSnapshot_GetStreamingResource(t *testing.T) {
	svc := New(Options{})
	_, err := svc.GetStreamingResource(context.Background(), nil, func(o *Options) {
		o.APIOptions = append(o.APIOptions, func(stack *middleware.Stack) error {
