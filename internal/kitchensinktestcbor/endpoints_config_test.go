...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-rpcv2cbor-kitchen-sink.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rpcv2cbor-kitchen-sink.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rpcv2cbor-kitchen-sink.dev",
			expectURL:     aws.String("https://env-rpcv2cbor-kitchen-sink.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-rpcv2cbor-kitchen-sink.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rpcv2cbor-kitchen-sink.dev",
			expectURL:     aws.String("http://config-rpcv2cbor-kitchen-sink.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-rpcv2cbor-kitchen-sink.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-rpcv2cbor-kitchen-sink.dev",
			clientEndpoint: aws.String("https://client-rpcv2cbor-kitchen-sink.dev"),
			expectURL:      aws.String("https://client-rpcv2cbor-kitchen-sink.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_RPCV2CBOR_KITCHEN_SINK", c.envService)
			}
