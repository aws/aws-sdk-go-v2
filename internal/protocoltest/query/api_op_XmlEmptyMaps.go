...
func (c *Client) XmlEmptyMaps(ctx context.Context, params *XmlEmptyMapsInput, optFns ...func(*Options)) (*XmlEmptyMapsOutput, error) {
	...
	addawsAwsquery_serdeOpXmlEmptyMapsMiddlewares(stack)
...
func addawsAwsquery_serdeOpXmlEmptyMapsMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsquery_serializeOpXmlEmptyMaps{}, middleware.After)
	stack.Deserialize.Add(&awsAwsquery_deserializeOpXmlEmptyMaps{}, middleware.After)
}
