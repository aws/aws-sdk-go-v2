...
func TestClient_QueryTimestamps_Serialize(t *testing.T) {
...
func BenchmarkClient_QueryTimestamps_Serialize(b *testing.B) {
	cases := map[string]struct {
		Params        *QueryTimestampsInput
		ExpectMethod  string
		ExpectURIPath string
	...
	for name, c := range cases {
		b.Run(name, func(b *testing.B) {
			...
			for i := 0; i < b.N; i++ {
				client.QueryTimestamps(context.Background(), c.Params)
			}
		})
	}
}
