...
func TestClient_QueryMaps_Serialize(t *testing.T) {
...
func BenchmarkClient_QueryMaps_Serialize(b *testing.B) {
	cases := map[string]struct {
	Params *QueryMapsInput
	ExpectMethod string
	ExpectURIPath string
	...
	for name, c := range cases {
		b.Run(name, func(b *testing.B) {
			...
			for i := 0; i < b.N; i++ {
				client.QueryMaps(context.Background(), c.Params)
			}
		})
	}
}
