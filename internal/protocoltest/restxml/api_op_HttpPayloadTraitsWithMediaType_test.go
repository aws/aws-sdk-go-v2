...
func TestClient_HttpPayloadTraitsWithMediaType_Serialize(t *testing.T) {
...
func BenchmarkClient_HttpPayloadTraitsWithMediaType_Serialize(b *testing.B) {
	cases := map[string]struct {
	Params *HttpPayloadTraitsWithMediaTypeInput
	ExpectMethod string
	ExpectURIPath string
	...
	for name, c := range cases {
		b.Run(name, func(b *testing.B) {
			...
			for i := 0; i < b.N; i++ {
				client.HttpPayloadTraitsWithMediaType(context.Background(), c.Params)
			}
		})
	}
}

func TestClient_HttpPayloadTraitsWithMediaType_Deserialize(t *testing.T) {
	cases := map[string]struct {
	StatusCode int
	Header http.Header
	BodyMediaType string
...
func BenchmarkClient_HttpPayloadTraitsWithMediaType_Deserialize(b *testing.B) {
	cases := map[string]struct {
	StatusCode int
	Header http.Header
	BodyMediaType string
	...
	for name, c := range cases {
		b.Run(name, func(b *testing.B) {
			...
			for i := 0; i < b.N; i++ {
				client.HttpPayloadTraitsWithMediaType(context.Background(), &params)
			}
		})
	}
}
