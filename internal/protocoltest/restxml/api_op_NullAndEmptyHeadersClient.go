...
func (c *Client) addOperationNullAndEmptyHeadersClientMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "NullAndEmptyHeadersClient", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
