...
func addOperationHttpPayloadWithXmlNamespaceStackSlots(stack *middleware.Stack) error {
...
func addOperationHttpPayloadWithXmlNamespaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationHttpPayloadWithXmlNamespaceStackSlots(stack); err != nil {
		return err
	}
