...
func (c *Client) addOperationHttpRequestWithFloatLabelsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "HttpRequestWithFloatLabels", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
