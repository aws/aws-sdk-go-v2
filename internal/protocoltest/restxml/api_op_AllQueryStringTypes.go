...
func (v *AllQueryStringTypesInput) SerializeMembers(s smithy.ShapeSerializer) {
	...
	serializeStringMap(s, schemas.AllQueryStringTypesInput_queryParamsMapOfStrings, v.QueryParamsMapOfStrings)
	if v.QueryShort != nil {
...
func (v *AllQueryStringTypesInput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.AllQueryStringTypesInput, func(s *smithy.Schema) error {
		...
		case schemas.AllQueryStringTypesInput_queryParamsMapOfStrings:
			return deserializeStringMap(d, schemas.AllQueryStringTypesInput_queryParamsMapOfStrings, &v.QueryParamsMapOfStrings)
