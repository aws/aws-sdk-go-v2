...
func addOperationQueryIdempotencyTokenAutoFillStackSlots(stack *middleware.Stack) error {
...
func addOperationQueryIdempotencyTokenAutoFillMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationQueryIdempotencyTokenAutoFillStackSlots(stack); err != nil {
		return err
	}
