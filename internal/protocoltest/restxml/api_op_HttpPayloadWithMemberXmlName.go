...
func (c *Client) addOperationHttpPayloadWithMemberXmlNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "HttpPayloadWithMemberXmlName", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
