...
func TestClient_XmlEmptyLists_Serialize(t *testing.T) {
...
func BenchmarkClient_XmlEmptyLists_Serialize(b *testing.B) {
	cases := map[string]struct {
	Params *XmlEmptyListsInput
	ExpectMethod string
	ExpectURIPath string
	...
	for name, c := range cases {
		b.Run(name, func(b *testing.B) {
			...
			for i := 0; i < b.N; i++ {
				client.XmlEmptyLists(context.Background(), c.Params)
			}
		})
	}
}
