...
func addOperationHttpRequestWithGreedyLabelInPathStackSlots(stack *middleware.Stack) error {
...
func addOperationHttpRequestWithGreedyLabelInPathMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationHttpRequestWithGreedyLabelInPathStackSlots(stack); err != nil {
		return err
	}
