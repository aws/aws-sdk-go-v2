...
func (c *Client) addOperationHttpRequestWithGreedyLabelInPathMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "HttpRequestWithGreedyLabelInPath", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
