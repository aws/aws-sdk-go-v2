...
func (c *Client) addOperationEmptyInputAndEmptyOutputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "EmptyInputAndEmptyOutput", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
