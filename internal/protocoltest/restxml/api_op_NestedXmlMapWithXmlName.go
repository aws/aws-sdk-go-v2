...
func (c *Client) addOperationNestedXmlMapWithXmlNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "NestedXmlMapWithXmlName", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
