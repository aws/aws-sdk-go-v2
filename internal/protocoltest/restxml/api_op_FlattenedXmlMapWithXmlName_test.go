...
func TestClient_FlattenedXmlMapWithXmlName_Serialize(t *testing.T) {
...
func BenchmarkClient_FlattenedXmlMapWithXmlName_Serialize(b *testing.B) {
	cases := map[string]struct {
	Params *FlattenedXmlMapWithXmlNameInput
	ExpectMethod string
	ExpectURIPath string
	...
	for name, c := range cases {
		b.Run(name, func(b *testing.B) {
			...
			for i := 0; i < b.N; i++ {
				client.FlattenedXmlMapWithXmlName(context.Background(), c.Params)
			}
		})
	}
}
