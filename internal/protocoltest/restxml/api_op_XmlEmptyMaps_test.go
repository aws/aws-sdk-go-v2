...
func TestClient_XmlEmptyMaps_Serialize(t *testing.T) {
...
func BenchmarkClient_XmlEmptyMaps_Serialize(b *testing.B) {
	cases := map[string]struct {
	Params *XmlEmptyMapsInput
	ExpectMethod string
	ExpectURIPath string
	...
	for name, c := range cases {
		b.Run(name, func(b *testing.B) {
			...
			for i := 0; i < b.N; i++ {
				client.XmlEmptyMaps(context.Background(), c.Params)
			}
		})
	}
}
