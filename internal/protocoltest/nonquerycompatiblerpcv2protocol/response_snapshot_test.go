...
func TestCheckResponseSnapshot_NonQueryCompatibleOperation(t *testing.T) {
	want := &NonQueryCompatibleOperationOutput{}
	status, header, body, err := serdeRespReadSnapshot("NonQueryCompatibleOperation.response")
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "NonQueryCompatibleOperation.response", err)
	}
}
