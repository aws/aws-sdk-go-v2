...
func TestUpdateResponseSnapshot_NonQueryCompatibleOperation(t *testing.T) {
	...
	if err := serdeRespWriteSnapshot("NonQueryCompatibleOperation.response", 200, built.Header, body); err != nil {
		t.Fatal(err)
	}
}
