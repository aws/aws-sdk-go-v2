...
func (c *Client) GreetingWithErrors(ctx context.Context, params *GreetingWithErrorsInput, optFns ...func(*Options)) (*GreetingWithErrorsOutput, error) {
	...
	addawsAwsjson10_serdeOpGreetingWithErrorsMiddlewares(stack)
...
func addawsAwsjson10_serdeOpGreetingWithErrorsMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson10_serializeOpGreetingWithErrors{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson10_deserializeOpGreetingWithErrors{}, middleware.After)
}
