...
func (c *Client) EmptyInputAndEmptyOutput(ctx context.Context, params *EmptyInputAndEmptyOutputInput, optFns ...func(*Options)) (*EmptyInputAndEmptyOutputOutput, error) {
	...
	addawsAwsjson10_serdeOpEmptyInputAndEmptyOutputMiddlewares(stack)
...
func addawsAwsjson10_serdeOpEmptyInputAndEmptyOutputMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsAwsjson10_serializeOpEmptyInputAndEmptyOutput{}, middleware.After)
	stack.Deserialize.Add(&awsAwsjson10_deserializeOpEmptyInputAndEmptyOutput{}, middleware.After)
}
