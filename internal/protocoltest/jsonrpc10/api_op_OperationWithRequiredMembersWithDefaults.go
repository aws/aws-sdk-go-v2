...
func (c *Client) addOperationOperationWithRequiredMembersWithDefaultsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "OperationWithRequiredMembersWithDefaults", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
