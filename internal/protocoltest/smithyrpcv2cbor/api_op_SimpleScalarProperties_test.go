...
func TestClient_SimpleScalarProperties_smithyRpcv2cborSerialize(t *testing.T) {
	cases := map[string]struct {
		...
		"RpcV2CborSimpleScalarProperties": {
			...
			ExpectMethod:  "POST",
			ExpectURIPath: "/service/aws.protocoltests.rpcv2Cbor.RpcV2Protocol/operation/SimpleScalarProperties",
			ExpectQuery:   []smithytesting.QueryItem{},
			ExpectHeader: http.Header{
...
func TestClient_SimpleScalarProperties_smithyRpcv2cborDeserialize(t *testing.T) {
	cases := map[string]struct {
		...
		"RpcV2CborSimpleScalarProperties": {
			...
			BodyMediaType: "application/cbor",
			Body: func() []byte {
				p, err := base64.StdEncoding.DecodeString(`v2lieXRlVmFsdWUFa2RvdWJsZVZhbHVl+z/+OVgQYk3TcWZhbHNlQm9vbGVhblZhbHVl9GpmbG9hdFZhbHVl+kDz989saW50ZWdlclZhbHVlGQEAaWxvbmdWYWx1ZRkmkWpzaG9ydFZhbHVlGSaqa3N0cmluZ1ZhbHVlZnNpbXBsZXB0cnVlQm9vbGVhblZhbHVl9f8=`)
				if err != nil {
					panic(err)
				}
