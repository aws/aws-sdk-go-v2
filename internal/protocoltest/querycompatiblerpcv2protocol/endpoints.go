...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/internal/protocoltest/querycompatiblerpcv2protocol/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_QUERY_COMPATIBLE_RPCV2_PROTOCOL")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Query Compatible RpcV2 Protocol", cfg.ConfigSources)
	if found && err == nil {
