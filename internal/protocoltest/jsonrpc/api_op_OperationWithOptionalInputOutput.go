...
func addOperationOperationWithOptionalInputOutputStackSlots(stack *middleware.Stack) error {
...
func addOperationOperationWithOptionalInputOutputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationOperationWithOptionalInputOutputStackSlots(stack); err != nil {
		return err
	}
