...
func (c *Client) addOperationOperationWithOptionalInputOutputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "OperationWithOptionalInputOutput", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
