...
func (c *Client) addOperationStreamingTraitsRequireLengthMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "StreamingTraitsRequireLength", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
