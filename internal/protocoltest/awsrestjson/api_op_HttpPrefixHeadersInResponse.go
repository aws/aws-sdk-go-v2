...
func (c *Client) addOperationHttpPrefixHeadersInResponseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "HttpPrefixHeadersInResponse", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
