...
func (c *Client) addOperationTestPostNoInputNoPayloadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "TestPostNoInputNoPayload", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
