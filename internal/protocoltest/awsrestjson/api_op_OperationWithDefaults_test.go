...
func TestClient_OperationWithDefaults_Serialize(t *testing.T) {
	...
	BodyAssert func(io.Reader) error
		...
		"RestJsonClientUsesExplicitlyProvidedMemberValuesOverDefaults": {
			...
			document.NewLazyDocument("bye"),
			DefaultDocumentBoolean:
			document.NewLazyDocument(true),
			DefaultDocumentList:
			document.NewLazyDocument([]interface{}{
			"b",
			}),
			DefaultNullDocument:
			document.NewLazyDocument("notNull"),
			DefaultTimestamp:
...
func TestClient_OperationWithDefaults_Deserialize(t *testing.T) {
	...
	ExpectResult *OperationWithDefaultsOutput
		...
		"RestJsonClientIgnoresDefaultValuesIfMemberValuesArePresentInResponse": {
			...
			document.NewLazyDocument("bye"),
			DefaultDocumentBoolean:
			document.NewLazyDocument(false),
			DefaultDocumentList:
			document.NewLazyDocument([]interface{}{
			"b",
			}),
