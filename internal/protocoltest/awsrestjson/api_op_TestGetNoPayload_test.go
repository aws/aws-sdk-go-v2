...
func TestClient_TestGetNoPayload_Serialize(t *testing.T) {
...
func BenchmarkClient_TestGetNoPayload_Serialize(b *testing.B) {
	cases := map[string]struct {
	Params *TestGetNoPayloadInput
	ExpectMethod string
	ExpectURIPath string
	...
	for name, c := range cases {
		b.Run(name, func(b *testing.B) {
			...
			for i := 0; i < b.N; i++ {
				client.TestGetNoPayload(context.Background(), c.Params)
			}
		})
	}
}
