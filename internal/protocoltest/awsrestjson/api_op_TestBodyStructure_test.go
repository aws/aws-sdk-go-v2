...
func TestClient_TestBodyStructure_Serialize(t *testing.T) {
...
func BenchmarkClient_TestBodyStructure_Serialize(b *testing.B) {
	cases := map[string]struct {
	Params *TestBodyStructureInput
	ExpectMethod string
	ExpectURIPath string
	...
	for name, c := range cases {
		b.Run(name, func(b *testing.B) {
			...
			for i := 0; i < b.N; i++ {
				client.TestBodyStructure(context.Background(), c.Params)
			}
		})
	}
}
