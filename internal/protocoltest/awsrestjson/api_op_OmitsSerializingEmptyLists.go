...
func (c *Client) addOperationOmitsSerializingEmptyListsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "OmitsSerializingEmptyLists", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
