...
func TestClient_QueryPrecedence_Serialize(t *testing.T) {
...
func BenchmarkClient_QueryPrecedence_Serialize(b *testing.B) {
	cases := map[string]struct {
	Params *QueryPrecedenceInput
	ExpectMethod string
	ExpectURIPath string
	...
	for name, c := range cases {
		b.Run(name, func(b *testing.B) {
			...
			for i := 0; i < b.N; i++ {
				client.QueryPrecedence(context.Background(), c.Params)
			}
		})
	}
}
