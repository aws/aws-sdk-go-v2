...
func (c *Client) addOperationOmitsNullSerializesEmptyStringMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "OmitsNullSerializesEmptyString", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
