...
func addOperationOmitsNullSerializesEmptyStringStackSlots(stack *middleware.Stack) error {
...
func addOperationOmitsNullSerializesEmptyStringMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationOmitsNullSerializesEmptyStringStackSlots(stack); err != nil {
		return err
	}
