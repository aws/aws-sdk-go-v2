...
func TestClient_NullAndEmptyHeadersClient_Serialize(t *testing.T) {
...
func BenchmarkClient_NullAndEmptyHeadersClient_Serialize(b *testing.B) {
	cases := map[string]struct {
	Params *NullAndEmptyHeadersClientInput
	ExpectMethod string
	ExpectURIPath string
	...
	for name, c := range cases {
		b.Run(name, func(b *testing.B) {
			...
			for i := 0; i < b.N; i++ {
				client.NullAndEmptyHeadersClient(context.Background(), c.Params)
			}
		})
	}
}
