...
func (c *Client) addOperationHttpRequestWithLabelsAndTimestampFormatMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "HttpRequestWithLabelsAndTimestampFormat", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
