...
func (c *Client) addOperationNullAndEmptyHeadersServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "NullAndEmptyHeadersServer", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
