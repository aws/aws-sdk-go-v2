...
func addOperationStreamingTraitsWithMediaTypeStackSlots(stack *middleware.Stack) error {
...
func addOperationStreamingTraitsWithMediaTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	if err := addOperationStreamingTraitsWithMediaTypeStackSlots(stack); err != nil {
		return err
	}
