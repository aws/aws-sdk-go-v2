...
func (c *Client) addOperationMalformedTimestampHeaderEpochMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "MalformedTimestampHeaderEpoch", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
