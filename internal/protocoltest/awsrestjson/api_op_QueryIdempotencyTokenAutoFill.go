...
func (c *Client) addOperationQueryIdempotencyTokenAutoFillMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "QueryIdempotencyTokenAutoFill", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
