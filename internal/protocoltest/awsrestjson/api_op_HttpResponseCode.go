...
func (c *Client) HttpResponseCode(ctx context.Context, params *HttpResponseCodeInput, optFns ...func(*Options)) (*HttpResponseCodeOutput, error) {
	...
	addawsRestjson1_serdeOpHttpResponseCodeMiddlewares(stack)
...
func addawsRestjson1_serdeOpHttpResponseCodeMiddlewares(stack *middleware.Stack) {
	stack.Serialize.Add(&awsRestjson1_serializeOpHttpResponseCode{}, middleware.After)
	stack.Deserialize.Add(&awsRestjson1_deserializeOpHttpResponseCode{}, middleware.After)
}
