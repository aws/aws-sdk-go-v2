...
func (c *Client) addOperationMalformedContentTypeWithBodyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "MalformedContentTypeWithBody", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
