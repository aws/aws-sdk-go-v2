...
func (v *InputAndOutputWithHeadersInput) SerializeMembers(s smithy.ShapeSerializer) {
	...
	if v.HeaderIntegerEnum != 0 {
		s.WriteInt32(schemas.InputAndOutputWithHeadersIO_headerIntegerEnum, int32(v.HeaderIntegerEnum))
	}
	serializeIntegerEnumList(s, schemas.InputAndOutputWithHeadersIO_headerIntegerEnumList, v.HeaderIntegerEnumList)
...
func (v *InputAndOutputWithHeadersInput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.InputAndOutputWithHeadersIO, func(s *smithy.Schema) error {
		...
		case schemas.InputAndOutputWithHeadersIO_headerIntegerEnum:
			var ev int32
			if err := d.ReadInt32(schemas.InputAndOutputWithHeadersIO_headerIntegerEnum, &ev); err != nil {
				return err
			}
			v.HeaderIntegerEnum = types.IntegerEnum(ev)
			return nil
		case schemas.InputAndOutputWithHeadersIO_headerIntegerEnumList:
			return deserializeIntegerEnumList(d, schemas.InputAndOutputWithHeadersIO_headerIntegerEnumList, &v.HeaderIntegerEnumList)
