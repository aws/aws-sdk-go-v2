...
func TestClient_EndpointOperation_Serialize(t *testing.T) {
...
func BenchmarkClient_EndpointOperation_Serialize(b *testing.B) {
	cases := map[string]struct {
	Params *EndpointOperationInput
	ExpectMethod string
	ExpectURIPath string
	...
	for name, c := range cases {
		b.Run(name, func(b *testing.B) {
			...
			for i := 0; i < b.N; i++ {
				client.EndpointOperation(context.Background(), c.Params)
			}
		})
	}
}
