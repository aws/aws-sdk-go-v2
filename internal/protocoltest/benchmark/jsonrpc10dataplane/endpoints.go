...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/internal/protocoltest/benchmark/jsonrpc10dataplane/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_JSONRPC10DATAPLANE")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "JsonRpc10DataPlane", cfg.ConfigSources)
	if found && err == nil {
