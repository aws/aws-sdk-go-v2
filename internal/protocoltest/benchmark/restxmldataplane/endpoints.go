...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/internal/protocoltest/benchmark/restxmldataplane/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_RESTXMLDATAPLANE")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "RestXmlDataPlane", cfg.ConfigSources)
	if found && err == nil {
