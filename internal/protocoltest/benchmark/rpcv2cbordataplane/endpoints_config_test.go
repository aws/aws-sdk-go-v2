...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-rpccbordataplane.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rpccbordataplane.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rpccbordataplane.dev",
			expectURL:     aws.String("https://env-rpccbordataplane.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-rpccbordataplane.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rpccbordataplane.dev",
			expectURL:     aws.String("http://config-rpccbordataplane.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-rpccbordataplane.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-rpccbordataplane.dev",
			clientEndpoint: aws.String("https://client-rpccbordataplane.dev"),
			expectURL:      aws.String("https://client-rpccbordataplane.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_RPCCBORDATAPLANE", c.envService)
			}
