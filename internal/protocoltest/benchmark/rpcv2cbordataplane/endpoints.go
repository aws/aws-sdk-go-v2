...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/internal/protocoltest/benchmark/rpcv2cbordataplane/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_RPCCBORDATAPLANE")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "RpcCborDataPlane", cfg.ConfigSources)
	if found && err == nil {
