...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/internal/kitchensinktestrestjson/internal/endpoints"
...
func (m *ResolveEndpoint) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	...
	if len(awsmiddleware.GetSigningName(ctx)) == 0 {
		...
		if len(signingName) == 0 {
			signingName = "restjson1kitchensink"
		}
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_RESTJSON1_KITCHEN_SINK")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "restJson1 kitchen sink", cfg.ConfigSources)
	if found && err == nil {
